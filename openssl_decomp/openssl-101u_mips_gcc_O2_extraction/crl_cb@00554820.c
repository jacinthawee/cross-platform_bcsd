...

{
  ...
  if (param_1 == 3) {
    if ((*(code **)(piStack_68[0x11] + 8) == (code *)0x0) ||
      ...
      if (piStack_68[5] != 0) {
        (**(code **)(local_38 + -0x60e0))();
      }
      if (piStack_68[6] != 0) {
        (**(code **)(local_38 + -0x60b0))();
      }
  ...
  if (param_1 == 5) {
    pEVar4 = EVP_sha1();
    (**(code **)(local_38 + -0x77ec))(piStack_68,pEVar4,piStack_68 + 0xb,0);
    puVar5 = (undefined4 *)(**(code **)(local_38 + -0x780c))(piStack_68,0x302,0,0);
    ...
    if (puVar5 != (undefined4 *)0x0) {
      ...
      if ((int)puVar5[2] < 1) {
        iVar8 = iVar9;
        if (0 < (int)puVar5[5]) goto LAB_0055498c;
        iVar8 = puVar5[4];
      }
      else {
        iVar11 = puVar5[5];
...
LAB_0055498c:
      ...
      (**(code **)(local_38 + -0x60bc))(*puVar5,*(undefined4 *)(*piStack_68 + 8));
    }
    iVar8 = (**(code **)(local_38 + -0x780c))(piStack_68,0x5a,0,0);
    piStack_68[5] = iVar8;
    iVar8 = (**(code **)(local_38 + -0x780c))(piStack_68,0x58,0,0);
    param_4 = 0;
    param_3 = (ASN1_INTEGER *)0x0;
    param_2 = (ASN1_ENUMERATED *)&DAT_0000008c;
    piStack_68[9] = iVar8;
    iVar8 = (**(code **)(local_38 + -0x780c))(piStack_68);
    piStack_68[10] = iVar8;
...
LAB_00554b0c:
    if (((iVar8 != 0x302) && (iVar8 != 0x5a)) && (iVar8 != 0x8c)) {
...
LAB_00554b30:
    ...
    if (0 < iVar8) {
      do {
        ...
        param_3 = unaff_s8;
        pAVar6 = (ASN1_ENUMERATED *)(**(code **)(local_38 + -0x60b8))(unaff_s0);
        if (pAVar6 != (ASN1_ENUMERATED *)0x0) {
          ...
          if (iVar8 == 0) {
            ...
            if (iVar8 != 0) goto LAB_00554ba8;
          }
          else {
LAB_00554ba8:
            param_2 = pAVar6;
            iVar8 = (**(code **)(local_38 + -0x7e38))(iVar8);
            if (iVar8 != 0) goto LAB_00554bbc;
          }
          uVar3 = 0;
          goto LAB_00554888;
        }
...
LAB_00554bbc:
        ...
        if (unaff_s7 == (ASN1_ENUMERATED *)0x0) {
          pAVar6 = unaff_s1;
          if (local_30 != (ASN1_ENUMERATED *)0xffffffff) goto LAB_00554dcc;
          unaff_s0[1].length = -1;
        }
        else {
...
LAB_00554888:
  ...
  pAStack_54 = unaff_s7;
  pAStack_50 = unaff_s8;
  iVar8 = (*(code *)PTR_sk_is_sorted_006a8d34)(*(undefined4 *)(*piVar13 + 0x14));
  if (iVar8 == 0) {
    (*(code *)PTR_CRYPTO_lock_006a8144)(9,6,"x_crl.c",0x1b8);
    (*(code *)PTR_sk_sort_006a83bc)(*(undefined4 *)(*piVar13 + 0x14));
    (*(code *)PTR_CRYPTO_lock_006a8144)(10,6,"x_crl.c",0x1ba);
  }
  pAVar16 = &AStack_8c;
  iVar8 = (*(code *)PTR_sk_find_006a8044)(*(undefined4 *)(*piVar13 + 0x14));
  if ((-1 < iVar8) &&
     (iVar9 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(*piVar13 + 0x14)), iVar8 < iVar9)) {
    while( true ) {
      ppAVar10 = (ASN1_INTEGER **)
                 (*(code *)PTR_sk_value_006a6e24)(*(undefined4 *)(*piVar13 + 0x14),iVar8);
      pAVar16 = param_3;
      ...
      if (ppAVar10[3] == (ASN1_INTEGER *)0x0) {
        if (param_4 != 0) {
          ...
          iVar9 = (*(code *)PTR_X509_NAME_cmp_006a8030)(param_4);
          if (iVar9 != 0) goto LAB_00554f40;
        }
LAB_00554fb8:
      ...
      iVar11 = (*(code *)PTR_sk_num_006a6e2c)();
      if (0 < iVar11) {
        do {
          pAVar16 = pAVar17;
          piVar12 = (int *)(*(code *)PTR_sk_value_006a6e24)(ppAVar10[3]);
          if (*piVar12 == 4) {
            pAVar16 = (ASN1_INTEGER *)piVar12[1];
            iVar11 = (*(code *)PTR_X509_NAME_cmp_006a8030)(iVar9);
            if (iVar11 == 0) goto LAB_00554fb8;
          }
          pAVar17 = (ASN1_INTEGER *)((int)&pAVar17->length + 1);
          iVar11 = (*(code *)PTR_sk_num_006a6e2c)(ppAVar10[3]);
        } while ((int)pAVar17 < iVar11);
      }
LAB_00554f40:
      iVar8 = iVar8 + 1;
      iVar9 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(*piVar13 + 0x14));
...
LAB_00554f60:
  ...
  piVar13 = *(int **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (X509_REVOKED_it._16_4_ == 0) {
    if (uVar3 < 7) {
      ...
      uVar3 = (*(code *)(&switchD_005619f8::switchdataD_0066a17c)[uVar3])();
      return uVar3;
    }
  }
  else if (uVar3 < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    uVar3 = (*(code *)(&switchD_00561550::switchdataD_0066a160)[uVar3])();
    return uVar3;
  }
  if (piVar13 == *(int **)PTR___stack_chk_guard_006a9ae8) {
    return 0;
  }
  (*(code *)PTR___stack_chk_fail_006a9ab0)();
