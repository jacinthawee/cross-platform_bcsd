...
joined_r0x0046800c:
        if (pcVar10 == (char *)0x0) {
LAB_00468014:
          (*(code *)PTR_BIO_printf_006a6e38)(*(undefined4 *)puVar3,"Usage pkeyparam [options]\n");
        ...
        iVar6 = (*(code *)PTR_strcmp_006a9b18)(pcVar10,&DAT_00632514);
        if (iVar6 == 0) {
          pcVar9 = ppcVar12[1];
          pcVar10 = pcVar9;
          goto joined_r0x0046800c;
        }
        iVar6 = (*(code *)PTR_strcmp_006a9b18)(pcVar10,"-engine");
        if (iVar6 == 0) {
          pcVar11 = ppcVar12[1];
          if (pcVar11 == (char *)0x0) goto LAB_00468014;
          ppcVar12 = ppcVar12 + 2;
        }
        else {
          iVar6 = (*(code *)PTR_strcmp_006a9b18)(pcVar10,"-text");
          if (iVar6 == 0) {
            ppcVar12 = ppcVar12 + 1;
            bVar2 = true;
          }
            ...
            ppcVar12 = ppcVar12 + 1;
            iVar6 = (*(code *)PTR_strcmp_006a9b18)(pcVar10,"-noout");
            if (iVar6 == 0) {
              bVar1 = true;
            }
          }
    ...
    if (pcVar7 == (char *)0x0) {
      iVar6 = (*(code *)PTR_BIO_new_fp_006a7248)(*(undefined4 *)PTR_stdin_006a9a14,0);
    }
    else {
      iVar6 = (*(code *)PTR_BIO_new_file_006a6eac)(pcVar7,"r");
      if (iVar6 == 0) {
        uVar8 = 1;
        iVar5 = 0;
        iVar4 = 0;
        (*(code *)PTR_BIO_printf_006a6e38)
                  (*(undefined4 *)PTR_bio_err_006a6e3c,"Can\'t open input file %s\n",pcVar7);
        goto LAB_00468150;
      }
    }
    if (pcVar9 == (char *)0x0) {
      ...
      iVar4 = (*(code *)PTR_BIO_new_file_006a6eac)(pcVar9,"w");
      if (iVar4 == 0) {
        uVar8 = 1;
        (*(code *)PTR_BIO_printf_006a6e38)
    ...
    iVar5 = (*(code *)PTR_PEM_read_bio_Parameters_006a6fc8)(iVar6,0);
    if (iVar5 == 0) {
      uVar8 = 1;
      (*(code *)PTR_BIO_printf_006a6e38)(*(undefined4 *)puVar3,"Error reading parameters\n");
      (*(code *)PTR_ERR_print_errors_006a6e40)(*(undefined4 *)puVar3);
    }
    else {
      if (!bVar1) {
        (*(code *)PTR_PEM_write_bio_Parameters_006a774c)(iVar4,iVar5);
      }
      if (bVar2) {
        (*(code *)PTR_EVP_PKEY_print_params_006a7754)(iVar4,iVar5,0,0);
        uVar8 = 0;
      }
      else {
        uVar8 = 0;
