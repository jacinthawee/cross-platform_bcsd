...

{
  ...
  uVar1 = (*(code *)PTR_BIO_f_base64_006a74bc)();
  iVar2 = (*(code *)PTR_BIO_new_006a6ea4)(uVar1);
  if (iVar2 != 0) {
    out = (BIO *)(*(code *)PTR_BIO_push_006a74c4)(iVar2,param_1);
    if ((param_4 & 0x1000) == 0) {
      out_00 = (BIO *)0x1;
      (*(code *)PTR_ASN1_item_i2d_bio_006a7720)(param_5,out,param_2);
    }
    else {
      ...
      if (out_00 == (BIO *)0x0) {
        ...
        (*(code *)PTR_BIO_ctrl_006a6e18)(out_00,0xb,0,0);
        do {
          pBVar3 = (BIO *)(*(code *)PTR_BIO_pop_006a79c8)(out_00);
    ...
    (*(code *)PTR_BIO_pop_006a79c8)(out);
    (*(code *)PTR_BIO_free_006a6e70)(iVar2);
    return out_00;
  }
  (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0xd2,0x41,"asn_mime.c",0x9b);
  return (BIO *)0x0;
}
