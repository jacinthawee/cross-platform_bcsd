...

{
  ...
  if ((uVar4 - 1 < 2) && (param_4 == 0)) {
    iVar2 = (*(code *)PTR_AES_set_decrypt_key_006a8a1c)(param_2,param_1[0x16] << 3,iVar5);
    puVar1 = PTR_AES_decrypt_006a84d8;
    puVar3 = PTR_AES_cbc_encrypt_006a7a3c;
    if (uVar4 != 2) {
    ...
    *(undefined **)(iVar5 + 0xf4) = puVar1;
    ...
    iVar2 = (*(code *)PTR_AES_set_encrypt_key_006a79ec)(param_2,param_1[0x16] << 3,iVar5);
