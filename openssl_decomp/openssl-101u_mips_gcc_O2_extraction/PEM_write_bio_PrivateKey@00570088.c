...

{
  ...
  if ((pEVar2 == (EVP_PKEY_ASN1_METHOD *)0x0) || (*(int *)(pEVar2 + 0x28) != 0)) {
    ...
    iVar3 = PEM_ASN1_write_bio(PTR_i2d_PrivateKey_006a8eb0,(char *)pEStack_110,bp,x,enc,kstr,klen,cb
                               ,u);
  }
  ...
  pBStack_d8 = (BIO *)0x0;
  pBStack_d4 = (BIO *)0x0;
  pBStack_cc = *(BIO **)PTR___stack_chk_guard_006a9ae8;
  pEStack_c0 = x;
  pEStack_bc = enc;
  ...
  if (((int)enc < 1) ||
     (pcVar4 = (char *)(*(code *)PTR_EVP_PKEY_new_006a7620)(), pcVar4 == (char *)0x0)) {
LAB_005702e8:
    ...
    iVar3 = (*(code *)PTR_EVP_PKEY_set_type_str_006a8eb4)(pcVar4,pBStack_dc,enc);
    if ((iVar3 == 0) || (*(code **)(*(int *)(pcVar4 + 0xc) + 0x38) == (code *)0x0)) {
LAB_005702d8:
      (*(code *)PTR_EVP_PKEY_free_006a6e78)(pcVar4);
      goto LAB_005702e8;
    }
    x_00 = &pBStack_d8;
    iVar3 = (**(code **)(*(int *)(pcVar4 + 0xc) + 0x38))(pcVar4);
    if (iVar3 == 0) goto LAB_005702d8;
  ...
  (*(code *)PTR_CRYPTO_free_006a6e88)(pBStack_dc);
  (*(code *)PTR_CRYPTO_free_006a6e88)(pBStack_d4);
  pBVar7 = pBStack_d0;
  pcStack_11c = pcVar4;
LAB_00570338:
  ...
  if (iStack_124 != *(int *)puVar1) {
    ...
    pBVar7 = (BIO *)(*(code *)PTR_BIO_new_006a6ea4)(uVar6);
    if (pBVar7 == (BIO *)0x0) {
      (*(code *)PTR_ERR_put_error_006a7f34)(9,0x7c,7,"pem_pkey.c",0xda);
      pEVar8 = (EVP_PKEY *)0x0;
    }
    else {
      (*(code *)PTR_BIO_ctrl_006a6e18)(pBVar7,0x6a,0,iVar3);
