...

{
  ...
  local_48 = 0;
  local_58 = *param_5;
  iVar2 = (*(code *)PTR_sk_num_006a6e2c)(param_7);
  if (iVar2 < 1) {
LAB_00578e9c:
    if (local_50 != (int *)0x0) {
      if (*param_2 != (int *)0x0) {
        (*(code *)PTR_X509_CRL_free_006a7060)();
      }
      ...
      *param_5 = local_58;
      *param_6 = local_48;
      (*(code *)puVar1)(local_50 + 3,1,6,"x509_vfy.c",0x3de);
      if (*param_3 != (int *)0x0) {
        (*(code *)PTR_X509_CRL_free_006a7060)();
        *param_3 = (int *)0x0;
      }
      if (((*(uint *)(*(int *)(param_1 + 0x14) + 0xc) & 0x2000) != 0) &&
        ...
        iVar2 = 0;
        while( true ) {
          iVar16 = (*(code *)PTR_sk_num_006a6e2c)(param_7);
          if (iVar16 <= iVar2) {
            *param_3 = (int *)0x0;
            return 0x1bf < (int)local_58;
          }
          piVar3 = (int *)(*(code *)PTR_sk_value_006a6e24)(param_7,iVar2);
          if (((piVar3[10] != 0) && (local_50[9] != 0)) &&
             ((iVar16 = X509_NAME_cmp(*(X509_NAME **)(*local_50 + 8),*(X509_NAME **)(*piVar3 + 8)),
              ...
              ((((iVar16 = crl_extension_match(piVar3,local_50,0x5a), iVar16 != 0 &&
                ...
                (iVar16 = (*(code *)PTR_ASN1_INTEGER_cmp_006a8d38)(piVar3[10],local_50[9]),
                iVar16 < 1)) &&
               (iVar16 = (*(code *)PTR_ASN1_INTEGER_cmp_006a8d38)(piVar3[9],local_50[9]), 0 < iVar16
               )))))) break;
          iVar2 = iVar2 + 1;
        }
        ...
        (*(code *)PTR_CRYPTO_add_lock_006a805c)(piVar3 + 3,1,6,"x509_vfy.c",0x442);
        *param_3 = piVar3;
      }
    }
    return 0x1bf < (int)local_58;
...
LAB_00578c9c:
  piVar3 = (int *)(*(code *)PTR_sk_value_006a6e24)(param_7,iVar16);
  local_54 = *param_6;
  uVar4 = piVar3[7];
  uVar15 = 0;
  if ((uVar4 & 2) == 0) {
    if ((*(uint *)(*(int *)(param_1 + 0x14) + 0xc) & 0x1000) == 0) {
      if ((uVar4 & 0x60) == 0) goto LAB_00578cf4;
      goto LAB_00578e64;
    }
    if ((uVar4 & 0x40) != 0) {
...
LAB_00578cf4:
      ...
      if (iVar2 == 0) {
        ...
        if ((*(uint *)(iVar2 + 0xc) & 2) != 0) goto LAB_00578d4c;
LAB_0057920c:
        ptVar12 = (time_t *)0x0;
        iVar2 = X509_cmp_time(*(ASN1_TIME **)(*piVar3 + 0xc),(time_t *)0x0);
        if (iVar2 < 0) goto LAB_00579228;
LAB_00578d68:
        iVar2 = *piVar3;
      }
      else {
        uVar15 = 0x100;
        if ((piVar3[7] & 0x20U) == 0) goto LAB_00578e58;
        iVar2 = *(int *)(param_1 + 0x14);
        if ((piVar3[4] & 0x200U) != 0) {
          uVar15 = 0;
        }
        if ((*(uint *)(iVar2 + 0xc) & 2) == 0) goto LAB_0057920c;
LAB_00578d4c:
        ptVar12 = (time_t *)(iVar2 + 4);
        iVar2 = X509_cmp_time(*(ASN1_TIME **)(*piVar3 + 0xc),ptVar12);
        if (-1 < iVar2) goto LAB_00578d68;
LAB_00579228:
        iVar2 = *piVar3;
        if (*(ASN1_TIME **)(iVar2 + 0x10) != (ASN1_TIME *)0x0) {
          iVar2 = X509_cmp_time(*(ASN1_TIME **)(iVar2 + 0x10),ptVar12);
          if (iVar2 == 0) goto LAB_00578d68;
          if (iVar2 < 0) {
            if ((*(uint *)(param_1 + 0x74) & 2) == 0) goto LAB_00578d68;
            iVar2 = *piVar3;
          }
          else {
            iVar2 = *piVar3;
      ...
      iVar6 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(param_1 + 0x54));
      iVar2 = iVar6 + -1;
      if (iVar13 != iVar6 + -1) {
        iVar2 = iVar13 + 1;
      }
      pXVar7 = (X509 *)(*(code *)PTR_sk_value_006a6e24)(*(undefined4 *)(param_1 + 0x54),iVar2);
      ...
      do {
        ...
        if (iVar6 <= iVar2) {
          iVar2 = 0;
          if ((*(uint *)(*(int *)(param_1 + 0x14) + 0xc) & 0x1000) == 0) goto LAB_00578fe8;
          goto LAB_00579168;
        }
        pXVar7 = (X509 *)(*(code *)PTR_sk_value_006a6e24)(*(undefined4 *)(param_1 + 0x54),iVar2);
    ...
    if (piVar3[10] == 0) goto LAB_00578cf4;
    goto LAB_00578e58;
  }
  goto LAB_00578e64;
  while( true ) {
    pXVar7 = (X509 *)(*(code *)PTR_sk_value_006a6e24)(*(undefined4 *)(param_1 + 0xc),iVar2);
    pXVar8 = X509_get_subject_name(pXVar7);
    iVar6 = X509_NAME_cmp(pXVar8,pXVar5);
    iVar2 = iVar13;
    ...
    break;
LAB_00579168:
    iVar6 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(param_1 + 0xc));
    iVar13 = iVar2 + 1;
    if (iVar6 <= iVar2) goto LAB_00578fe8;
  }
  uVar15 = uVar15 | 4;
  local_4c = pXVar7;
LAB_00578fe8:
...
LAB_00578ff4:
    uVar4 = piVar3[7];
    if ((uVar4 & 0x10) != 0) goto LAB_00578e64;
    ...
    if (uVar4 != 0) goto LAB_00578e64;
    local_3c = piVar3[8];
    iVar6 = 0;
    iVar2 = (*(code *)PTR_sk_num_006a6e2c)(a->crldp);
    if (0 < iVar2) {
      do {
        ppiVar9 = (int **)(*(code *)PTR_sk_value_006a6e24)(a->crldp,iVar6);
...
LAB_005794dc:
                    iVar13 = 0;
                    while (iVar11 = (*(code *)PTR_sk_num_006a6e2c)(iVar2), iVar13 < iVar11) {
                      iVar11 = iVar13 + 1;
                      piVar10 = (int *)(*(code *)PTR_sk_value_006a6e24)(iVar2,iVar13);
                      iVar13 = iVar11;
                      if ((*piVar10 == 4) &&
                  ...
                  for (local_38 = 0; iVar2 = (*(code *)PTR_sk_num_006a6e2c)(piVar14[1]),
                      local_38 < iVar2; local_38 = local_38 + 1) {
                    a_00 = (GENERAL_NAME *)(*(code *)PTR_sk_value_006a6e24)(piVar14[1],local_38);
                    iVar2 = 0;
                    while( true ) {
                      iVar13 = (*(code *)PTR_sk_num_006a6e2c)(piVar10[1]);
                      if (iVar13 <= iVar2) break;
                      b = (GENERAL_NAME *)(*(code *)PTR_sk_value_006a6e24)(piVar10[1],iVar2);
                      iVar13 = GENERAL_NAME_cmp(a_00,b);
                      iVar2 = iVar2 + 1;
                      if (iVar13 == 0) goto LAB_00579480;
                    }
                  }
                }
                goto LAB_005790e0;
...
LAB_00579480:
          ...
          iVar13 = (*(code *)PTR_sk_num_006a6e2c)();
          iVar2 = 0;
          if (0 < iVar13) {
            do {
              iVar13 = iVar2 + 1;
              piVar10 = (int *)(*(code *)PTR_sk_value_006a6e24)(ppiVar9[2],iVar2);
              if ((*piVar10 == 4) &&
                 (iVar2 = X509_NAME_cmp((X509_NAME *)piVar10[1],pXVar5), iVar2 == 0))
              goto LAB_00579390;
              iVar11 = (*(code *)PTR_sk_num_006a6e2c)(ppiVar9[2]);
              iVar2 = iVar13;
            } while (iVar13 < iVar11);
          }
        }
...
LAB_00578e64:
  ...
  iVar16 = iVar16 + 1;
  iVar2 = (*(code *)PTR_sk_num_006a6e2c)(param_7);
  if (iVar2 <= iVar16) goto LAB_00578e9c;
  goto LAB_00578c9c;
}
