...

{
  ...
  local_40 = (int *)PTR___stack_chk_guard_006a9ae8;
  local_58 = &_gp;
...
LAB_004e4f38:
  ...
  switch(unaff_s6) {
  default:
    goto switchD_004e4dc0_caseD_7;
  case (uchar *)0xfffffff9:
    goto LAB_004e4e0c;
  case (uchar *)0xfffffffa:
    goto switchD_004e4dc0_caseD_fffffffa;
  case (uchar *)0xfffffffb:
    goto LAB_004e4df4;
  case (uchar *)0xfffffffc:
    goto switchD_004e4dc0_caseD_fffffffc;
  case (uchar *)0xfffffffd:
    break;
  case (uchar *)0xffffffff:
    puVar4 = puStack_7c + -1;
...
LAB_004e4e54:
  ...
  puStack_78 = unaff_s6;
  (*(code *)PTR_memset_006a99f4)(&uStack_154,0,0x40);
  ...
  *puVar10 = uStack_114;
  ...
  if (iStack_94 != *(int *)puVar3) {
    ...
    uVar13 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar11 * 0x10000 >> 0x18) * 4) ^
             *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar11 & 0xff) * 4)) +
             (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar11 * 0x100 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar11 >> 0x18) * 4)) ^ *puStack_dc;
    uVar11 = uVar13 ^ piStack_e0[2];
    uVar11 = (uVar11 >> (-piStack_e0[3] & 0x1fU)) + (uVar11 << 0x20 - (-piStack_e0[3] & 0x1fU));
    uVar41 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar11 * 0x10000 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar11 & 0xff) * 4)) +
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar11 >> 0x18) * 4) ^
             puStack_dc[1] ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar11 * 0x100 >> 0x18) * 4);
    uVar11 = piStack_e0[4] - uVar41;
    uVar11 = (uVar11 >> (-piStack_e0[5] & 0x1fU)) + (uVar11 << 0x20 - (-piStack_e0[5] & 0x1fU));
    uVar13 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar11 * 0x10000 >> 0x18) * 4) +
              *(int *)(PTR_CAST_S_table1_006a8500 + (uVar11 & 0xff) * 4) ^
             *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar11 >> 0x18) * 4)) -
             *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar11 * 0x100 >> 0x18) * 4) ^ uVar13;
    uVar11 = uVar13 + piStack_e0[6];
    uVar11 = (uVar11 >> (-piStack_e0[7] & 0x1fU)) + (uVar11 << 0x20 - (-piStack_e0[7] & 0x1fU));
    uVar41 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar11 * 0x10000 >> 0x18) * 4) ^
             *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar11 & 0xff) * 4)) +
             (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar11 * 0x100 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar11 >> 0x18) * 4)) ^ uVar41;
    uVar11 = uVar41 ^ piStack_e0[8];
    uVar11 = (uVar11 >> (-piStack_e0[9] & 0x1fU)) + (uVar11 << 0x20 - (-piStack_e0[9] & 0x1fU));
    uVar11 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar11 * 0x10000 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar11 & 0xff) * 4)) +
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar11 >> 0x18) * 4) ^
             uVar13 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar11 * 0x100 >> 0x18) * 4);
    uVar13 = piStack_e0[10] - uVar11;
    uVar13 = (uVar13 >> (-piStack_e0[0xb] & 0x1fU)) + (uVar13 << 0x20 - (-piStack_e0[0xb] & 0x1fU));
    uVar41 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar13 * 0x10000 >> 0x18) * 4) +
              *(int *)(PTR_CAST_S_table1_006a8500 + (uVar13 & 0xff) * 4) ^
             *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar13 >> 0x18) * 4)) -
             *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar13 * 0x100 >> 0x18) * 4) ^ uVar41;
    uVar13 = uVar41 + piStack_e0[0xc];
    uVar13 = (uVar13 >> (-piStack_e0[0xd] & 0x1fU)) + (uVar13 << 0x20 - (-piStack_e0[0xd] & 0x1fU));
    uVar11 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar13 * 0x10000 >> 0x18) * 4) ^
             *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar13 & 0xff) * 4)) +
             (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar13 * 0x100 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar13 >> 0x18) * 4)) ^ uVar11;
    uVar13 = uVar11 ^ piStack_e0[0xe];
    uVar13 = (uVar13 >> (-piStack_e0[0xf] & 0x1fU)) + (uVar13 << 0x20 - (-piStack_e0[0xf] & 0x1fU));
    uVar13 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar13 * 0x10000 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar13 & 0xff) * 4)) +
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar13 >> 0x18) * 4) ^
             uVar41 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar13 * 0x100 >> 0x18) * 4);
    uVar41 = piStack_e0[0x10] - uVar13;
    uVar41 = (uVar41 >> (-piStack_e0[0x11] & 0x1fU)) +
             (uVar41 << 0x20 - (-piStack_e0[0x11] & 0x1fU));
    uVar11 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar41 * 0x10000 >> 0x18) * 4) +
              *(int *)(PTR_CAST_S_table1_006a8500 + (uVar41 & 0xff) * 4) ^
             *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar41 >> 0x18) * 4)) -
             *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar41 * 0x100 >> 0x18) * 4) ^ uVar11;
    uVar41 = uVar11 + piStack_e0[0x12];
    uVar41 = (uVar41 >> (-piStack_e0[0x13] & 0x1fU)) +
             (uVar41 << 0x20 - (-piStack_e0[0x13] & 0x1fU));
    uVar13 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar41 * 0x10000 >> 0x18) * 4) ^
             *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar41 & 0xff) * 4)) +
             (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar41 * 0x100 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar41 >> 0x18) * 4)) ^ uVar13;
    uVar41 = uVar13 ^ piStack_e0[0x14];
    uVar41 = (uVar41 >> (-piStack_e0[0x15] & 0x1fU)) +
             (uVar41 << 0x20 - (-piStack_e0[0x15] & 0x1fU));
    uVar11 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar41 * 0x10000 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar41 & 0xff) * 4)) +
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar41 >> 0x18) * 4) ^
             uVar11 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar41 * 0x100 >> 0x18) * 4);
    uVar41 = (piStack_e0[0x16] - uVar11 >> (-piStack_e0[0x17] & 0x1fU)) +
             (piStack_e0[0x16] - uVar11 << 0x20 - (-piStack_e0[0x17] & 0x1fU));
    uVar13 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar41 * 0x10000 >> 0x18) * 4) +
              *(int *)(PTR_CAST_S_table1_006a8500 + (uVar41 & 0xff) * 4) ^
             *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar41 >> 0x18) * 4)) -
             *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar41 * 0x100 >> 0x18) * 4) ^ uVar13;
    if (piStack_e0[0x20] == 0) {
      uVar41 = (uVar13 + piStack_e0[0x18] >> (-piStack_e0[0x19] & 0x1fU)) +
               (uVar13 + piStack_e0[0x18] << 0x20 - (-piStack_e0[0x19] & 0x1fU));
      uVar11 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar41 * 0x10000 >> 0x18) * 4) ^
               *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar41 & 0xff) * 4)) +
               (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar41 * 0x100 >> 0x18) * 4) -
               *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar41 >> 0x18) * 4)) ^ uVar11;
      ...
      uVar13 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar41 * 0x10000 >> 0x18) * 4) -
               *(int *)(PTR_CAST_S_table1_006a8500 + (uVar41 & 0xff) * 4)) +
               *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar41 >> 0x18) * 4) ^
               uVar13 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar41 * 0x100 >> 0x18) * 4);
