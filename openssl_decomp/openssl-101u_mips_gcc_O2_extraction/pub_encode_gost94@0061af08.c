...

{
  ...
  iVar6 = (**(code **)(local_38 + -0x7dd8))(pcVar14,"gost_ameth.c",0x288);
  (**(code **)(local_38 + -0x7be0))(*(undefined4 *)(iVar3 + 0x18),iVar6);
  uVar4 = (**(code **)(local_38 + -0x6778))();
  pcVar13 = pcVar14;
  (**(code **)(local_38 + -0x70c4))(uVar4,0);
  ...
  puStack_b4 = &local_30;
  iStack_68 = (**(code **)(local_38 + -0x6a00))(uVar4);
  (**(code **)(local_38 + -0x6770))(uVar4);
  if (iStack_68 < 0) {
    iVar3 = 0;
  }
  else {
    ...
    pcVar13 = pcStack_58;
    local_3c = iStack_68;
    iVar3 = (**(code **)(local_38 + -0x6638))(param_1,puStack_5c,pcStack_58,uStack_a0);
  }
  ...
  puVar12 = puStack_b4;
  iStack_60 = param_1;
  uVar4 = (*(code *)PTR_EVP_PKEY_base_id_006a6f0c)(puStack_b4);
  ...
  if (iVar3 == 0) {
    ...
    if (iVar6 == 0x32b) {
      iVar6 = (**(code **)(puStack_78 + -0x5808))(puStack_b4);
      if (iVar6 == 0) goto LAB_0061b1b4;
      uVar4 = (**(code **)(puStack_78 + -0x6e68))(iVar6);
    }
    else if ((iVar6 == 0x32c) &&
            (iVar6 = (**(code **)(puStack_78 + -0x5808))(puStack_b4), iVar6 != 0)) {
...
LAB_0061b1b4:
    ...
    puStack_b4 = (undefined4 *)(**(code **)(puStack_78 + -0x6a04))(uVar4,&uStack_70);
    ...
    iVar6 = (**(code **)(puStack_78 + -0x6648))(iStack_a8,puStack_a4,0,0x10);
    param_1 = iVar3;
  }
  ...
  iVar6 = (*(code *)PTR_EVP_PKEY_base_id_006a6f0c)(puVar12);
  if (iVar6 == 0x32b) {
    iVar6 = (*(code *)PTR_EVP_PKEY_get0_006a95d8)(puVar12);
...
LAB_0061b370:
    ...
    if ((iVar6 != 0x32c) ||
       ((iVar6 = (*(code *)PTR_EVP_PKEY_get0_006a95d8)(puVar12), iVar6 == 0 ||
...
LAB_0061b4fc:
  ...
  (*(code *)PTR_BIO_indent_006a86ac)(iVar3,pcVar13,0x80);
  (*(code *)PTR_BIO_printf_006a6e38)(iVar3,"Public key: ");
  (*(code *)PTR_BN_print_006a6f24)(iVar3,uVar4);
  (*(code *)PTR_BIO_printf_006a6e38)(iVar3,"\n");
  iVar6 = (*(code *)PTR_EVP_PKEY_get0_006a95d8)(puVar12);
  uStack_c0 = (*(code *)PTR_BN_new_006a71b4)();
  if (*(int *)(PTR_R3410_paramset_006a95fc + 0xc) != 0) {
    puVar12 = (undefined4 *)PTR_R3410_paramset_006a95fc;
    do {
      (*(code *)PTR_BN_dec2bn_006a7e30)(&uStack_c0);
      iVar5 = (*(code *)PTR_BN_cmp_006a7960)(uStack_c0,*(undefined4 *)(iVar6 + 0x10));
      if (iVar5 == 0) {
        (*(code *)PTR_BN_free_006a701c)(uStack_c0);
        uVar4 = *puVar12;
        goto LAB_0061b494;
      }
      piVar2 = puVar12 + 7;
...
LAB_0061b494:
  (*(code *)PTR_BIO_indent_006a86ac)(iVar3,pcVar13,0x80);
  iVar5 = (*(code *)PTR_OBJ_nid2ln_006a711c)(uVar4);
...
LAB_0061b304:
  ...
  if (iVar6 != 0) {
    ...
    uVar8 = (*(code *)PTR_BN_CTX_get_006a852c)(iVar6);
    uVar9 = (*(code *)PTR_EVP_PKEY_get0_006a95d8)(pcVar14);
    uVar9 = (*(code *)PTR_EC_KEY_get0_public_key_006a7ae4)(uVar9);
    uVar10 = (*(code *)PTR_EVP_PKEY_get0_006a95d8)(pcVar14);
    ...
    iVar11 = (*(code *)PTR_BIO_indent_006a86ac)(iVar3,iVar5,0x80);
    if (iVar11 != 0) {
      (*(code *)PTR_BIO_printf_006a6e38)(iVar3,"Public key:\n");
      iVar11 = (*(code *)PTR_BIO_indent_006a86ac)(iVar3,iVar5 + 3,0x80);
      if (iVar11 != 0) {
        (*(code *)PTR_BIO_printf_006a6e38)(iVar3,&DAT_0067a7b4);
        (*(code *)PTR_BN_print_006a6f24)(iVar3,uVar4);
        (*(code *)PTR_BIO_printf_006a6e38)(iVar3,"\n");
        (*(code *)PTR_BIO_indent_006a86ac)(iVar3,iVar5 + 3,0x80);
        (*(code *)PTR_BIO_printf_006a6e38)(iVar3,&DAT_0067a7b8);
        (*(code *)PTR_BN_print_006a6f24)(iVar3,uVar8);
        (*(code *)PTR_BIO_printf_006a6e38)(iVar3,"\n");
        (*(code *)PTR_BN_CTX_end_006a8530)(iVar6);
        (*(code *)PTR_BN_CTX_free_006a7954)(iVar6);
        uVar4 = (*(code *)PTR_EVP_PKEY_get0_006a95d8)(pcVar14);
        uVar4 = (*(code *)PTR_EC_KEY_get0_group_006a7690)(uVar4);
        uVar4 = (*(code *)PTR_EC_GROUP_get_curve_name_006a7f7c)(uVar4);
        iVar6 = (*(code *)PTR_BIO_indent_006a86ac)(iVar3,iVar5,0x80);
        if (iVar6 != 0) {
