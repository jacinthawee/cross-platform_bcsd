...

{
  ...
  pcVar10 = (code *)PTR_CRYPTO_lock_006a8144;
  ...
  if (((psVar4 == (size_t *)0x0) || (sVar8 != *psVar4)) ||
    ...
    psVar3 = (size_t *)(*(code *)PTR_CRYPTO_malloc_006a7008)(sVar8,"s3_both.c",0x2b6);
    if (psVar3 == (size_t *)0x0) {
      (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x123,0x41,"s3_both.c",0x31d);
      return 0;
    }
  }
  else {
    ...
    (*pcVar10)(10,0xc,"s3_both.c",0x2b4);
  }
  psVar5 = param_1->s3;
