...

{
  ...
  local_5c = (int *)PTR___stack_chk_guard_006a9ae8;
  local_70 = &_gp;
  ...
  if (iVar12 == 0) {
    ...
    *(int *)puVar7 = iVar12;
    if (iVar12 != 0) {
      ...
      (**(code **)(local_70 + -0x7fc8))(iVar12,0x6a,0x10,**(undefined4 **)(local_70 + -0x52e8));
      iVar12 = *(int *)puVar7;
    }
  }
...
LAB_00429504:
      do {
        ...
        iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,"-inform");
        if (iVar12 == 0) {
...
LAB_004296b4:
        ...
        iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,"-outform");
        if (iVar12 != 0) {
          ...
          if ((((unaff_s6 == (undefined4 *)0x0) && (*(char *)((int)param_2 + 1) == 'i')) &&
            ...
            puStack_b8 = puVar18 + -1;
            param_2 = unaff_s7 + 1;
            if (puStack_b8 == (undefined *)0x0) goto LAB_004296b4;
            local_64 = (char *)unaff_s7[1];
          }
          else {
            iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,local_60);
            if (iVar12 == 0) {
              puStack_b8 = puVar18 + -1;
              param_2 = unaff_s7 + 1;
              if (puStack_b8 == (undefined *)0x0) goto LAB_004296b4;
              ...
              iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,local_54 + 0x1eb4);
              if (iVar12 == 0) {
                puStack_b8 = puVar18 + -1;
                param_2 = unaff_s7 + 1;
                if (puStack_b8 == (undefined *)0x0) goto LAB_004296b4;
                ...
                iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,local_48);
                puStack_b8 = puVar18;
                if (iVar12 == 0) {
                  local_44 = 1;
                  param_2 = unaff_s7;
                  ...
                  iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,local_40 + 0x27ac);
                  if (iVar12 == 0) {
                    local_3c = 1;
                    param_2 = unaff_s7;
                  }
                    ...
                    iVar12 = (**(code **)(local_70 + -0x52c8))(param_2,"-noout");
                    if (iVar12 != 0) {
                      (**(code **)(local_70 + -0x7fa8))
...
LAB_004294f8:
        ...
        puStack_b8 = puVar18 + -1;
        if (puVar18 + -1 == (undefined *)0x0) goto LAB_004296b4;
        puVar14 = unaff_s7 + 1;
        puVar18 = puVar18 + -2;
        unaff_s7 = unaff_s7 + 2;
    ...
    if (param_1 == (undefined4 *)0x0) {
      ...
      puStack_b8 = puVar18;
      if (param_2 == (undefined4 *)0x0) goto LAB_004297c0;
      unaff_s2 = (char *)0x0;
      uStack_cc = 1;
LAB_00429670:
      ...
      if (param_2 == (undefined4 *)0x0) {
        ...
        if (local_64 == (char *)0x0) {
          (**(code **)(local_70 + -0x7fc8))(param_1,0x6a,0,**(undefined4 **)(local_70 + -0x53cc));
        }
        else {
          ...
          if (iVar12 < 1) {
            uStack_cc = 1;
            unaff_s2 = (char *)0x0;
            (**(code **)(local_70 + -0x5360))(local_64);
            goto LAB_0042965c;
          }
        }
        if (local_58 == 0) {
          param_3 = (undefined4 *)0x0;
          (**(code **)(local_70 + -0x7fc8))(param_2,0x6a,0,**(undefined4 **)(local_70 + -0x5418));
        }
        else {
        ...
        if (unaff_s4 == 1) {
          ...
          unaff_s2 = (char *)(**(code **)(local_70 + -0x7c1c))
                                       (*(undefined4 *)(local_70 + -0x78c4),
                                        *(undefined4 *)(local_70 + -0x78c8),param_1,0);
        }
        else {
          if (unaff_s4 != 3) {
            unaff_s2 = (char *)0x0;
          ...
          param_3 = (undefined4 *)0x0;
          unaff_s2 = (char *)(**(code **)(local_70 + -0x78d4))(param_1,0,0,0);
        }
        if ((undefined4 *)unaff_s2 == (undefined4 *)0x0) {
          ...
          if (local_3c != 0) {
            (**(code **)(local_70 + -0x78d0))(param_2,unaff_s2);
          }
          if (local_44 != 0) {
            iVar12 = (**(code **)(local_70 + -0x78cc))(unaff_s2,&local_30);
            if (iVar12 == 0) {
              uStack_cc = 1;
              (**(code **)(local_70 + -0x7fa0))(*(undefined4 *)puVar7);
              goto LAB_0042965c;
            ...
            if ((local_30 & 1) != 0) {
              (**(code **)(local_70 + -0x538c))("p value is not prime");
            }
            if ((local_30 & 2) != 0) {
              (**(code **)(local_70 + -0x538c))("p value is not a safe prime");
            }
            if ((local_30 & 4) != 0) {
              (**(code **)(local_70 + -0x538c))("unable to check the generator value");
            }
            if ((local_30 & 8) != 0) {
              (**(code **)(local_70 + -0x538c))("the g value is not a generator");
            }
            if (local_30 == 0) {
              (**(code **)(local_70 + -0x538c))("DH parameters appear to be ok.");
            }
          }
          if (local_34 != 0) {
            ...
            param_3 = (undefined4 *)0x10d;
            unaff_s4 = (**(code **)(local_70 + -0x7dd8))(iVar12 >> 3,&DAT_0063409c);
            if (unaff_s4 == 0) {
              uStack_cc = 1;
              (**(code **)(local_70 + -0x5360))("OPENSSL_malloc");
              goto LAB_0042965c;
            }
            iVar12 = (**(code **)(local_70 + -0x7be0))(*(undefined4 *)((int)unaff_s2 + 8),unaff_s4);
            (**(code **)(local_70 + -0x541c))(1,"static unsigned char dh%d_p[]={",unaff_s6);
            local_30 = 0;
            if (0 < iVar12) {
              local_64 = "0x%02X,";
              local_60 = &DAT_006340fc;
              unaff_s7 = (undefined4 *)0x2aaaaaab;
              do {
                if (local_30 == ((int)local_30 / 0xc) * 0xc) {
                  (**(code **)(local_70 + -0x541c))(1,local_60);
                }
                (**(code **)(local_70 + -0x541c))(1,local_64,*(undefined *)(unaff_s4 + local_30));
                local_30 = local_30 + 1;
              } while ((int)local_30 < iVar12);
            }
            (**(code **)(local_70 + -0x538c))(&DAT_006340d4);
            puVar18 = (undefined *)
                      (**(code **)(local_70 + -0x7be0))
                                (*(undefined4 *)((int)unaff_s2 + 0xc),unaff_s4);
            (**(code **)(local_70 + -0x541c))(1,"static unsigned char dh%d_g[]={",unaff_s6);
            local_30 = 0;
            if (0 < (int)puVar18) {
              local_64 = "0x%02X,";
              local_60 = &DAT_006340fc;
            ...
            (**(code **)(local_70 + -0x538c))("\n\t};\n");
            (**(code **)(local_70 + -0x541c))(1,"DH *get_dh%d()\n\t{\n",unaff_s6);
            (**(code **)(local_70 + -0x538c))("\tDH *dh;\n");
            (**(code **)(local_70 + -0x538c))("\tif ((dh=DH_new()) == NULL) return(NULL);");
            (**(code **)(local_70 + -0x541c))
                      (1,"\tdh->p=BN_bin2bn(dh%d_p,sizeof(dh%d_p),NULL);\n",unaff_s6,unaff_s6);
            param_3 = unaff_s6;
            (**(code **)(local_70 + -0x541c))
                      (1,"\tdh->g=BN_bin2bn(dh%d_g,sizeof(dh%d_g),NULL);\n",unaff_s6,unaff_s6);
            (**(code **)(local_70 + -0x538c))("\tif ((dh->p == NULL) || (dh->g == NULL))");
            (**(code **)(local_70 + -0x538c))("\t\treturn(NULL);");
            (**(code **)(local_70 + -0x538c))("\treturn(dh);\n\t}");
          ...
          if (local_38 == 0) {
            if (unaff_s5 == 1) {
              ...
              local_30 = (**(code **)(local_70 + -0x7c48))
                                   (*(undefined4 *)(local_70 + -0x78c0),param_2);
            }
            else {
              if (unaff_s5 != 3) {
                uStack_cc = 1;
              ...
              local_30 = (**(code **)(local_70 + -0x78bc))(param_2,unaff_s2);
            }
            if (local_30 == 0) {
              (**(code **)(local_70 + -0x7fa8))
...
LAB_0042965c:
      ...
      if (param_2 != (undefined4 *)0x0) goto LAB_00429670;
    }
    puStack_b8 = puVar18;
    if ((undefined4 *)unaff_s2 != (undefined4 *)0x0) {
      (**(code **)(local_70 + -0x78d8))(unaff_s2);
    }
  }
  ...
  puStack_8c = param_2;
  puStack_88 = param_1;
  (*(code *)PTR_BIO_write_006a6e14)(param_3[1],&uStack_95,1);
  ...
  if (iVar13 == 0) {
    ...
    iVar13 = (*(code *)PTR_BIO_new_006a6ea4)(uVar8);
    *(int *)puVar7 = iVar13;
    if (iVar13 != 0) {
...
LAB_0042a1ec:
    do {
      ...
      iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-inform");
      if (iVar9 == 0) {
        iVar12 = iVar12 + -1;
        if (iVar12 != 0) {
          iVar13 = (*(code *)PTR_str2fmt_006a6e4c)(puVar10[1]);
          puVar10 = puVar10 + 1;
          goto LAB_0042a1e0;
        }
LAB_0042a584:
      ...
      iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-outform");
      if (iVar9 == 0) {
        if (iVar12 == 1) goto LAB_0042a584;
        iVar12 = iVar12 + -2;
        iVar17 = (*(code *)PTR_str2fmt_006a6e4c)(puVar10[1]);
        puVar14 = puVar10 + 1;
        puVar10 = puVar10 + 2;
        if (iVar12 == 0) break;
        goto LAB_0042a1ec;
      ...
      if ((((cVar1 == '-') && (*(char *)((int)puVar14 + 1) == 'i')) &&
        ...
        iVar12 = iVar12 + -1;
        if (iVar12 == 0) goto LAB_0042a584;
        iStack_134 = puVar10[1];
        puVar10 = puVar10 + 1;
      }
      else {
        iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,&DAT_00632514);
        if (iVar9 == 0) {
          iVar12 = iVar12 + -1;
          if (iVar12 == 0) goto LAB_0042a584;
          ...
          iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-engine");
          if (iVar9 == 0) {
            iVar12 = iVar12 + -1;
            if (iVar12 == 0) goto LAB_0042a584;
            ...
            iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-check");
            if (iVar9 == 0) {
              bVar4 = true;
            }
            else {
              iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-text");
              if (iVar9 == 0) {
                bVar3 = true;
              }
              else {
                iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-dsaparam");
                if (iVar9 == 0) {
                  bVar2 = true;
                }
                else if (cVar1 == '-') {
                  ...
                  if ((cVar1 == 'C') && (*(char *)((int)puVar14 + 2) == '\0')) {
                    ...
                    iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-noout");
                    if (iVar9 == 0) {
                      bVar6 = true;
                    }
                    else if (cVar1 == '2') {
...
LAB_0042a520:
                        iVar9 = (*(code *)PTR_strcmp_006a9b18)(puVar14,"-rand");
                        if (iVar9 == 0) {
                          iVar12 = iVar12 + -1;
                          if (iVar12 != 0) {
                          ...
                          iVar9 = (*(code *)PTR___isoc99_sscanf_006a9a04)(puVar14,"%d",&iStack_ec);
                          if ((iVar9 != 0) && (0 < iStack_ec)) goto LAB_0042a1e0;
                        }
                        goto LAB_0042a584;
                      }
                      iStack_118 = 2;
...
LAB_0042a1e0:
  ...
  (*(code *)PTR_setup_engine_006a6ec4)(*(undefined4 *)puVar7,uStack_120,0);
  if (iStack_118 == 0) {
    if (!bVar2) {
      if (iStack_ec == 0) goto LAB_0042a764;
      iStack_118 = 2;
      goto LAB_0042a29c;
    }
    if (iStack_ec != 0) goto LAB_0042a29c;
LAB_0042a764:
    uVar8 = (*(code *)PTR_BIO_s_file_006a6ea0)();
    iVar12 = (*(code *)PTR_BIO_new_006a6ea4)(uVar8);
    if (iVar12 == 0) goto LAB_0042a38c;
    if (iStack_134 != 0) {
      iVar9 = (*(code *)PTR_BIO_ctrl_006a6e18)(iVar12,0x6c,3,iStack_134);
      if (0 < iVar9) goto LAB_0042a7b4;
      (*(code *)PTR_perror_006a9a80)(iStack_134);
      goto LAB_0042a7dc;
    }
    (*(code *)PTR_BIO_ctrl_006a6e18)(iVar12,0x6a,0,*(undefined4 *)PTR_stdin_006a9a14);
LAB_0042a7b4:
    if (iVar13 != 1) {
      if (iVar13 == 3) {
        if (!bVar2) {
          puVar14 = (undefined4 *)(*(code *)PTR_PEM_read_bio_DHparams_006a750c)(iVar12,0,0,0);
          goto LAB_0042ab0c;
        }
        iVar13 = (*(code *)PTR_PEM_read_bio_DSAparams_006a7538)(iVar12,0,0,0);
LAB_0042aa10:
        if (iVar13 != 0) {
...
LAB_0042ab24:
        ...
        (*(code *)PTR_BIO_printf_006a6e38)(uVar8,pcVar15);
        (*(code *)PTR_ERR_print_errors_006a6e40)(*(undefined4 *)puVar7);
      }
      else {
...
LAB_0042a7e0:
    ...
    if (bVar2) {
      iVar13 = (*(code *)PTR_ASN1_d2i_bio_006a71c4)
                         (PTR_DSA_new_006a7528,PTR_d2i_DSAparams_006a7540,iVar12,0);
      goto LAB_0042aa10;
    }
    puVar14 = (undefined4 *)
              (*(code *)PTR_ASN1_d2i_bio_006a71c4)
                        (PTR_DH_new_006a751c,PTR_d2i_DHparams_006a7518,iVar12,0);
LAB_0042ab0c:
...
LAB_0042a29c:
    ...
    uStack_e8 = 2;
    pcStack_e0 = dh_cb;
    iVar12 = (*(code *)PTR_app_RAND_load_file_006a6ecc)(0,uStack_e4,1);
    if (iVar12 == 0) {
      if (iStack_108 == 0) {
        (*(code *)PTR_BIO_printf_006a6e38)
...
LAB_0042a2e0:
        ...
        uVar8 = (*(code *)PTR_app_RAND_load_files_006a6f38)(iStack_108);
        (*(code *)PTR_BIO_printf_006a6e38)(uVar16,"%ld semi-random bytes loaded\n",uVar8);
      }
    }
    else if (iStack_108 != 0) goto LAB_0042a2e0;
    if (bVar2) {
      puVar10 = (undefined4 *)(*(code *)PTR_DSA_new_006a7528)();
      (*(code *)PTR_BIO_printf_006a6e38)
                (*(undefined4 *)puVar7,"Generating DSA parameters, %d bit long prime\n",iStack_ec);
      puVar14 = puVar10;
      if (puVar10 != (undefined4 *)0x0) {
        iVar12 = (*(code *)PTR_DSA_generate_parameters_ex_006a752c)
                           (puVar10,iStack_ec,0,0,0,0,&uStack_e8);
        if (iVar12 != 0) {
          puVar14 = (undefined4 *)(*(code *)PTR_DSA_dup_DH_006a753c)(puVar10);
          (*(code *)PTR_DSA_free_006a7530)(puVar10);
          if (puVar14 == (undefined4 *)0x0) {
...
LAB_0042a7f8:
    ...
    if ((puVar14 == (undefined4 *)0x0) ||
       (iVar12 = (*(code *)PTR_DH_generate_parameters_ex_006a7534)
...
LAB_0042a8d8:
  ...
  if (iStack_128 == 0) {
    ...
    iVar9 = (*(code *)PTR_BIO_ctrl_006a6e18)(iVar13,0x6c,5,iStack_128);
    if (iVar9 < 1) {
      uVar8 = 1;
      (*(code *)PTR_perror_006a9a80)(iStack_128);
      goto LAB_0042a99c;
    }
  }
  if (bVar3) {
  ...
  if (bVar4) {
    iVar9 = (*(code *)PTR_DH_check_006a7514)(puVar14,&uStack_e8);
    if (iVar9 == 0) {
      uVar8 = 1;
      (*(code *)PTR_ERR_print_errors_006a6e40)(*(undefined4 *)puVar7);
      goto LAB_0042a99c;
  ...
  if (bVar5) {
    iVar11 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar14[2]);
    uVar8 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar14[2]);
    iVar9 = iVar11 + 7;
    if (iVar11 + 7 < 0) {
      iVar9 = iVar11 + 0xe;
    }
    iVar9 = (*(code *)PTR_CRYPTO_malloc_006a7008)(iVar9 >> 3,"dhparam.c",0x1c0);
    if (iVar9 == 0) {
      uVar8 = 1;
    ...
    iVar11 = (*(code *)PTR_BN_bn2bin_006a7200)(puVar14[2],iVar9);
    (*(code *)PTR___printf_chk_006a99c4)(1,"\tstatic unsigned char dh%d_p[]={",uVar8);
    uStack_e8 = 0;
    if (0 < iVar11) {
      do {
        ...
        (*(code *)PTR___printf_chk_006a99c4)(1,"0x%02X,",*(undefined *)(iVar9 + uStack_e8));
        uStack_e8 = uStack_e8 + 1;
      } while ((int)uStack_e8 < iVar11);
    }
    (*(code *)PTR_puts_006a9a54)("\n\t\t};");
    iVar11 = (*(code *)PTR_BN_bn2bin_006a7200)(puVar14[3],iVar9);
    (*(code *)PTR___printf_chk_006a99c4)(1,"\tstatic unsigned char dh%d_g[]={",uVar8);
    uStack_e8 = 0;
    if (0 < iVar11) {
      do {
        if (uStack_e8 == ((int)uStack_e8 / 0xc) * 0xc) {
  ...
  if (!bVar6) {
    if (iVar17 == 1) {
      uStack_e8 = (*(code *)PTR_ASN1_i2d_bio_006a7198)(PTR_i2d_DHparams_006a7520,iVar13,puVar14);
    }
    else {
      if (iVar17 != 3) {
        uVar8 = 1;
      ...
      uStack_e8 = (*(code *)PTR_PEM_write_bio_DHparams_006a7524)(iVar13,puVar14);
    }
    if (uStack_e8 == 0) {
