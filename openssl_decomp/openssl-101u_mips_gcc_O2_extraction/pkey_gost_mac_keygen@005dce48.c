...

{
  ...
  piVar29 = (int *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006a95d0)();
  if (*piVar29 != 0) {
    piVar30 = (int *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x20,"gost_pmeth.c",0x20f);
    ...
    *piVar30 = piVar29[2];
    ...
    (*(code *)PTR_EVP_PKEY_assign_006a83cc)(param_2,0x32f,piVar30);
    return 1;
  }
  (*(code *)PTR_ERR_GOST_error_006a95e4)(0x82,0x74,"gost_pmeth.c",0x20c);
  return 0;
}
