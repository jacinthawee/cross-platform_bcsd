...

{
  ...
  if ((flags & 0x40) == 0) {
    ...
    if ((out != (BIO *)0x0) &&
       ((iVar6 = (*(code *)PTR_BIO_write_006a6e14)(out,pcVar4,iVar7), iVar7 != iVar6 ||
        (iVar6 = (*(code *)PTR_BIO_write_006a6e14)(out,":",1), iVar6 != 1)))) goto LAB_0054d710;
    uStack_74 = iVar7 + 1;
  }
  if ((flags & 0x80) != 0) {
LAB_0054d6e8:
    if (out == (BIO *)0x0) {
      ...
      if ((flags & 0x200) != 0) {
        ...
        str = (ASN1_STRING *)(*(code *)PTR_CRYPTO_malloc_006a7008)(iVar10,"a_strex.c",0x13d);
      ...
      iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&DAT_006695a8,1);
      if (iVar10 != 1) goto LAB_0054d710;
      if ((flags & 0x200) != 0) goto LAB_0054e604;
      ...
      if (str != pAVar14) {
        do {
          ...
          iVar7 = (*(code *)PTR_BIO_write_006a6e14)(out,&cStack_38,2);
          if (iVar7 != 2) goto LAB_0054d710;
  ...
  if ((flags & 0x20) == 0) {
    if ((0x1d < iVar10 - 1U) || (uVar11 = (uint)(char)tag2nbyte[iVar10], uVar11 == 0xffffffff)) {
      if ((flags & 0x100) != 0) goto LAB_0054d6e8;
      goto LAB_0054d824;
    }
    if ((flags & 0x10) != 0) {
      if (uVar11 == 0) {
  ...
  if (puVar12 == puVar15) {
    ...
    do {
      ...
      if (uVar18 == 1) {
        ...
        if ((uVar18 != 0) ||
           (iVar10 = (*(code *)PTR_UTF8_getc_006a8ccc)(puVar13,iVar7,&AStack_48), iVar10 < 0))
        goto LAB_0054d710;
      ...
      if ((uVar11 & 8) == 0) {
        ...
        if (iVar10 < 0) goto LAB_0054d710;
        iStack_78 = iStack_78 + iVar10;
      }
      else {
        iVar10 = (*(code *)PTR_UTF8_putc_006a8cc8)(abStack_40,6,AStack_48.type);
        if (0 < iVar10) {
          uVar8 = uVar2 | uVar8;
...
LAB_0054e198:
              ...
              if ((uVar9 & 0x61) == 0) goto LAB_0054e198;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e17c:
              ...
              if ((uVar9 & 0x61) == 0) goto LAB_0054e17c;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e1b4:
              ...
              if ((uVar9 & 0x61) == 0) goto LAB_0054e1b4;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e160:
              ...
              if ((uVar9 & 0x61) == 0) goto LAB_0054e160;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e1d8:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_0054e144;
LAB_0054dad0:
              if ((uVar8 & 8) == 0) {
...
LAB_0054e320:
              ...
              uVar9 = uVar8 & (byte)char_type[abStack_40[1]];
              if ((uVar9 & 0x61) == 0) goto LAB_0054e320;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e2fc:
              ...
              uVar9 = uVar8 & (byte)char_type[abStack_40[2]];
              if ((uVar9 & 0x61) == 0) goto LAB_0054e2fc;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e2d8:
              ...
              uVar9 = uVar8 & (byte)char_type[abStack_40[3]];
              if ((uVar9 & 0x61) == 0) goto LAB_0054e2d8;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054e2b4:
              ...
              uVar9 = uVar8 & (byte)char_type[bStack_3c];
              if ((uVar9 & 0x61) == 0) goto LAB_0054e2b4;
              if ((uVar9 & 8) == 0) {
                iVar6 = 2;
              }
              else {
            ...
            if (iVar10 != 5) {
              if ((char)bStack_3b < '\0') {
                ...
                uVar8 = uVar8 & (byte)char_type[bStack_3b];
                if ((uVar8 & 0x61) != 0) goto LAB_0054dad0;
              }
              iVar10 = 1;
              if ((uVar8 & 6) != 0) goto LAB_0054e1d8;
              if (bStack_3b == 0x5c) {
                iVar10 = 2;
              }
              iStack_78 = iStack_78 + iVar10;
...
LAB_0054dae8:
  ...
  if (cStack_4d == '\0') {
    iVar10 = iStack_78;
    if (out == (BIO *)0x0) goto LAB_0054d718;
  }
  else {
    iStack_78 = iStack_78 + 2;
    iVar10 = iStack_78;
    if (out == (BIO *)0x0) goto LAB_0054d718;
    iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&DAT_00679c10,1);
    if (iVar10 != 1) goto LAB_0054d710;
  }
  iVar7 = str->length;
    ...
    do {
      while( true ) {
        ...
        if (str == (ASN1_STRING *)0x1) {
          ...
          iVar10 = -1;
          if (str != (ASN1_STRING *)&SUB_00000004) goto LAB_0054d718;
          AStack_48.type =
               (uint)*(byte *)((int)puVar13 + 3) |
               (uint)*(byte *)(puVar13 + 1) << 8 |
               (uint)*(byte *)((int)puVar13 + 1) << 0x10 | (uint)*(byte *)puVar13 << 0x18;
        ...
        if (iVar10 < 0) goto LAB_0054d710;
        if (puVar12 == puVar13) goto LAB_0054dccc;
      }
      pbVar19 = abStack_40;
      iVar10 = (*(code *)PTR_UTF8_putc_006a8cc8)(pbVar19,6,AStack_48.type);
      if (0 < iVar10) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar18 & 8) == 0) {
              iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&DAT_00669598,1);
              if (iVar10 != 1) goto LAB_0054d710;
              iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&_Stack_4c,1);
            }
            else {
LAB_0054dc98:
              iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&_Stack_4c,1);
...
joined_r0x0054deb8:
            pbVar19 = pbVar19 + 1;
            if (pbVar16 == pbVar19) goto LAB_0054dcc0;
          }
          uVar18 = flags & 4;
LAB_0054dd08:
          if ((uVar18 & 6) == 0) {
            if ((bVar1 != 0x5c) || (uVar2 == 0)) goto LAB_0054dc98;
            iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&DAT_006695a4,2);
            if (iVar10 == 2) goto joined_r0x0054deb8;
            goto LAB_0054d710;
          }
          (*(code *)PTR_BIO_snprintf_006a6f60)(&cStack_38,0xb,"\\%02X");
          iVar10 = (*(code *)PTR_BIO_write_006a6e14)(out,&cStack_38,3);
          if (iVar10 != 3) goto LAB_0054d710;
          pbVar19 = pbVar19 + 1;
...
LAB_0054dccc:
  iVar10 = iStack_78;
  if (cStack_4d == '\0') goto LAB_0054d718;
  iVar7 = (*(code *)PTR_BIO_write_006a6e14)(out,&DAT_00679c10,1);
