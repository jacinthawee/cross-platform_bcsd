...

{
  ...
  if ((((param_1 == 0) || (param_2 == 0)) || (param_3 == 0)) || (param_4 == 0)) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0x10,200,0x43,"ecp_nist.c",0xb1);
  }
  else if (param_5 == 0) {
    iVar1 = (*(code *)PTR_BN_CTX_new_006a794c)(param_1,param_3,param_4);
    if (iVar1 != 0) {
      bVar3 = false;
      iVar2 = (*(code *)PTR_BN_mul_006a853c)(param_2,param_3,param_4,iVar1);
      if (iVar2 != 0) {
    ...
    iVar1 = (*(code *)PTR_BN_mul_006a853c)(param_2,param_3,param_4,param_5);
    if (iVar1 != 0) {
