...

{
  ...
  iVar1 = (*(code *)PTR_EC_KEY_get_key_method_data_006a976c)(d,ecdsa_data_dup,ecdsa_data_free);
  if (iVar1 == 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar1 = iVar3;
                    ...
                    /* WARNING: Could not recover jumptable at 0x005fee4c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  pvVar2 = (void *)(*(code *)PTR_CRYPTO_get_ex_data_006a8364)(iVar1 + 0x10,idx);
  return pvVar2;
}
