...

{
    ...
    if (length != 0) {
      do {
        ...
        if (uStack_78 == 0) {
          ...
          local_34 = pDStack_c8;
          (**(code **)((int)pDVar29 + -0x6918))(unaff_s8,schedule);
    ...
    do {
      if (uStack_78 == 0) {
        ...
        pDStack_c8 = (DES_key_schedule *)
                     ...
                     (uint)(*ivec)[1] << 8 | (uint)(*ivec)[2] << 0x10 | (uint)(*ivec)[0]);
        local_34 = pDStack_c8;
        (*(code *)local_40[-0xd3].ks[0xd].deslong[0])(unaff_s8,schedule,1);
        length = (uint)local_34 >> 0x10;
        (*ivec)[0] = (uchar)local_34;
        out = (uchar *)(local_30 >> 8);
        (*ivec)[4] = (uchar)local_30;
  ...
  *num = uStack_78;
  ...
  pDStack_150 = (DES_key_schedule *)PTR___stack_chk_guard_006a9ae8;
  pDVar29 = (DES_key_schedule *)&_gp;
  piStack_68 = num;
  pDStack_8c = local_34;
  pauStack_74 = ivec;
  ...
  if (local_30 == 0) {
    ...
    for (; pDStack_90 = pDVar16, pDStack_14c != (DES_key_schedule *)0x0;
      ...
      if (pDStack_d0 == (DES_key_schedule *)0x0) {
        ...
        (**(code **)((int)pDVar29 + -0x5770))(pDStack_90,pDStack_c8,pDStack_1ec);
    ...
    do {
      ...
      if (pDStack_d0 == (DES_key_schedule *)0x0) {
        ...
        uStack_84 = (uint)*(byte *)((int)puStack_38 + 3) << 0x18 |
                    (uint)*(byte *)((int)puStack_38 + 1) << 8 |
                    (uint)*(byte *)((int)puStack_38 + 2) << 0x10 | (uint)*(byte *)puStack_38;
        (*(code *)pDStack_98[-0xaf].ks[2].deslong[0])(pDStack_90,pDStack_c8,pDStack_1ec,pDStack_3c);
        pDVar14 = (DES_key_schedule *)(uStack_84 >> 0x10);
        *(byte *)puStack_38 = (byte)uStack_84;
        length = uStack_80 >> 8;
        *(byte *)(puStack_38 + 1) = (byte)uStack_80;
  ...
  piStack_10c = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (length < 0x41) {
    ...
    if (iStack_88 == 0) {
      if (pDVar26 <= pDVar14) {
        ...
        ppDStack_114 = (DES_key_schedule **)(&PTR_LAB_00674c14 + (int)pDVar26);
        puStack_110 = &UNK_00674c5c + (int)pDVar26 * 4;
        ...
        do {
          ...
          pDStack_ec = pDVar13;
          pDStack_e8 = pDVar29;
          (*(code *)puStack_130[-0x15dc])(ppDStack_118,pDStack_124,uStack_120,pDStack_11c);
          ...
          if (pDStack_a0 == (DES_key_schedule *)&DAT_00000020) {
            ...
            if (pDStack_a0 != (DES_key_schedule *)&DAT_00000040) {
              ...
              if (uStack_104 == 0) {
                ...
                (*(code *)puStack_130[-0x14bb])(puStack_100,iStack_108,8);
              }
              else {
                uStack_f4 = 0;
                pDStack_f8 = (DES_key_schedule *)0x0;
                (*(code *)puStack_130[-0x14bb])(puStack_100,iStack_108,9);
      ...
      pDStack_150 = (DES_key_schedule *)(&UNK_00674bf0 + (int)pDVar26 * 4);
      puStack_110 = &UNK_00674c38 + (int)pDVar26 * 4;
      ...
      do {
        ...
        pDStack_ec = pDVar27;
        pDStack_e8 = pDVar29;
        (*(code *)puStack_130[-0x15dc])(ppDStack_114,pDStack_124,uStack_120);
  ...
  uStack_144 = 0x5e3ffc;
  (*(code *)puStack_130[-0x14cc])();
  puStack_1b4 = puStack_130;
  piStack_198 = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if ((undefined *)((int)pDVar29[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_128 == 0) {
      ...
      if (pDStack_24c <= pDVar14) {
        ppcStack_19c = (code **)(&PTR_LAB_00674ca4 + (int)pDStack_24c);
        ...
        pDStack_248 = (DES_key_schedule *)(&PTR_LAB_00674cc8 + (int)pDStack_24c);
        ...
        do {
          ...
          pDStack_184 = pDVar27;
          pDStack_180 = pDVar16;
          (*(code *)pDStack_1c0[-0xd3].ks[0xd].deslong[0])(pDVar26,puStack_1b4);
          if (pDStack_1d8 != (DES_key_schedule *)0x0) {
          ...
          if (pDStack_1a4 != (DES_key_schedule *)&DAT_00000020) {
            if (pDStack_1a4 == (DES_key_schedule *)&DAT_00000040) {
              ...
              if (pDStack_1ac == (DES_key_schedule *)0x0) {
                ...
                pDStack_1a8 = pDVar8;
                (**(code **)((int)pDStack_1c0[-0xa6].ks + 0x14))
      ...
      pDStack_1dc = (DES_key_schedule *)(&switchD_005e4168::switchdataD_00674c80 + (int)pDStack_24c)
      ;
      pDStack_248 = (DES_key_schedule *)(&PTR_LAB_00674cec + (int)pDStack_24c);
      ...
      while (pDVar8 = pDVar15, pDVar16 = pDVar27, pDStack_1f8 = pDStack_244, pDStack_24c <= pDVar14)
      {
        ...
        pDStack_184 = pDVar16;
        pDStack_180 = pDVar8;
        (*(code *)pDStack_1c0[-0xd3].ks[0xd].deslong[0])(pDStack_21c,puStack_1b4);
        pDVar29 = pDStack_1a4;
        pDVar26 = pDStack_1a8;
...
LAB_005e45e4:
  ...
  (*(code *)pDStack_1c0[-0xa7].ks[10].deslong[0])();
  pDStack_258 = pDStack_1c0;
  pbVar30 = &_gp;
  piStack_214 = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (pDVar13 != (DES_key_schedule *)0x0) {
    ...
    do {
      if (uStack_260 == 0) {
        ...
        pDVar13 = pDStack_258;
        (**(code **)(pbVar30 + -0x5770))(puStack_38,pDStack_21c,pDStack_258,uStack_1bc);
        uVar24 = uStack_20c >> 8;
  ...
  *puStack_218 = uStack_260;
  if (iStack_1fc != iVar5) {
    ...
    if (pDVar13 != (DES_key_schedule *)0x0) {
      ...
      do {
        if (uVar7 == 0) {
          (*(code *)PTR_DES_encrypt1_006a84c8)(&uStack_274,uVar18,1);
          iVar5 = iVar5 + 1;
    ...
    *puStack_224 = uVar7;
    if (iStack_264 != iVar5) {
      ...
      do {
        ...
        uVar7 = *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar23 & 0xfc)) ^
                ...
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar18 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar18 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar7
        ;
        ...
        uVar21 = uVar19 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 ...
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar20 & 0xfc) + 0x100) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar18 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar18 * 0x100 >> 0x1a) + 0x140) * 4);
        ...
        uVar20 = uVar7 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar23 & 0xfc)) ^
        ...
        uVar7 = (uVar7 << 0x10 ^ uVar18) >> 4;
        uVar18 = uVar7 + uVar18 * 0x10000000;
        uVar18 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar23 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar21 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar23 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar18 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar19 = uVar18 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar23 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar21 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar23 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar7 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
