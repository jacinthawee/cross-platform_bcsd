...

{
  ...
  ppiVar8 = param_2;
  iVar3 = (*(code *)PTR_ASN1_TYPE_get_006a74b0)(param_2);
  if (iVar3 != 0x10) {
    iVar3 = -1;
    goto LAB_0061dcc8;
  }
  ...
  iVar3 = (*(code *)PTR_OBJ_obj2nid_006a712c)(param_2[1]);
  if ((iVar3 == 0) || (iVar3 = (*(code *)PTR_OBJ_nid2obj_006a7140)(iVar3), iVar3 == 0)) {
...
LAB_0061dc70:
    ...
    iVar3 = (*(code *)PTR_OBJ_txt2nid_006a6f5c)(pcVar4);
    if (iVar3 != 0) goto LAB_0061dd1c;
    ppiVar8 = (int **)&DAT_0000006b;
    ERR_GOST_error(0x67,0x6b,"gost_crypt.c",0x97);
  }
  else {
    iVar3 = (*(code *)PTR_OBJ_obj2nid_006a712c)(iVar3);
LAB_0061dd1c:
...
LAB_0061dc74:
      *piVar11 = iVar9;
      ...
      (*(code *)PTR_memcpy_006a9aec)(param_1 + 4,ppiVar8,unaff_s4);
      GOST_CIPHER_PARAMS_free(param_2);
      iVar3 = 1;
      goto LAB_0061dcc8;
    }
...
LAB_0061de70:
  ...
  if (*(int *)(iVar10 + 0x1030) != 0) {
    if (piVar11 == (int *)0x0) goto LAB_0061de70;
  ...
  if (&DAT_00000008 <= piVar11) {
    unaff_s5 = iVar10 + 0x1028;
    if (piVar11 == (int *)&DAT_00000008) goto LAB_0061e01c;
    *(int **)(iVar10 + 0x1038) = piVar11;
    goto LAB_0061decc;
  }
