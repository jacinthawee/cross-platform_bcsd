...

{
  ...
  pXStack_2c = *(X509_NAME **)PTR___stack_chk_guard_006a9ae8;
  pXVar6 = a;
  pXStack_34 = a;
  if (uVar3 == 0) {
    ...
    puVar7 = (undefined1 *)X509_CRL_INFO_it._16_4_;
    if (a == (X509_CRL_INFO *)0x0) goto switchD_0055c4c0_caseD_0;
    if (X509_CRL_INFO_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
...
switchD_0055c4c0_caseD_0:
  ...
  (*(code *)PTR_memcmp_006a9ad0)(pXVar6->version,*(undefined4 *)puVar7,pXVar5,in_a3,&_gp);
  return;
}
