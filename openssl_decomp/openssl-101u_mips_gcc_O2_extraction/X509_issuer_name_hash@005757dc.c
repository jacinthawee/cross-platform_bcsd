...

{
  ...
  (*(code *)PTR_i2d_X509_NAME_006a76ec)(pXVar7,0);
  puStack_50 = pXVar7->canon_enc;
  iStack_58 = pXVar7->canon_enclen;
  local_38 = (**(code **)(local_30 + -0x7810))();
  local_34 = 0;
  iVar2 = (**(code **)(local_30 + -0x73cc))(puStack_50,iStack_58,local_28,0);
  if (iVar2 == 0) {
    uVar3 = 0;
  }
  else {
  ...
  (*(code *)PTR_i2d_X509_NAME_006a76ec)(iVar8,0);
  ...
  iVar2 = (*(code *)PTR_EVP_DigestInit_ex_006a757c)(auStack_84,uVar4,0);
  if (iVar2 != 0) {
    puVar5 = *(undefined4 **)(iVar8 + 8);
    iVar2 = (*(code *)PTR_EVP_DigestUpdate_006a7580)(auStack_84,puVar5[1],*puVar5);
    if (iVar2 != 0) {
      iVar2 = (*(code *)PTR_EVP_DigestFinal_ex_006a7584)(auStack_84,auStack_6c,0);
      if (iVar2 != 0) {
