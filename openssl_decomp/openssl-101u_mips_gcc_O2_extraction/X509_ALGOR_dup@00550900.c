...

{
  ...
  X509_ALGOR *pXStack_248;
  code *pcStack_244;
  undefined *puStack_240;
  ASN1_VALUE **ppAStack_23c;
  undefined *puStack_238;
  int iStack_234;
  ASN1_TYPE **ppAStack_230;
  code *pcStack_22c;
  ASN1_VALUE **ppAStack_208;
  code *pcStack_204;
  undefined *puStack_200;
  X509_ALGOR *pXStack_1fc;
  undefined *puStack_1f8;
  ASN1_VALUE **ppAStack_1f4;
  ASN1_ITEM *pAStack_1f0;
  X509_ALGOR *pXStack_1ec;
  ASN1_TYPE **ppAStack_1e8;
  ...
  X509_ALGOR *pXStack_13c;
  int iStack_134;
  int iStack_130;
  ASN1_ITEM *pAStack_12c;
  ASN1_OBJECT *pAStack_128;
  X509_ALGOR *pXStack_124;
  ...
  X509_ALGOR *pXStack_e4;
  ASN1_TYPE *pAStack_e0;
  X509_ALGOR *pXStack_dc;
  X509_ALGOR **ppXStack_d8;
  code *pcStack_d4;
  int iStack_b0;
  X509_ALGOR *pXStack_ac;
  ...
  pXStack_e4 = (X509_ALGOR *)PTR___stack_chk_guard_006a9ae8;
  pAStack_1c = (ASN1_OBJECT *)0x0;
  XStack_18.parameter = *(ASN1_TYPE **)PTR___stack_chk_guard_006a9ae8;
  if (xn == (X509_ALGOR *)0x0) {
    ...
    if (pAStack_1c == (ASN1_OBJECT *)0x0) {
      ...
      pAVar5 = (ASN1_OBJECT *)0x0;
      unaff_s0 = (ASN1_OBJECT *)X509_ALGOR_it;
    }
    else {
      xn = &XStack_18;
  ...
  if (XStack_18.parameter == *(ASN1_TYPE **)pXStack_e4) {
    return (X509_ALGOR *)pAVar5;
  }
  pAStack_e0 = XStack_18.parameter;
  ...
  if (pAVar5 != (ASN1_OBJECT *)0x0) {
    ...
    ERR_clear_error();
    iStack_b0 = 0;
    pXVar22 = (X509_ALGOR *)0x0;
    unaff_s5 = (X509_ALGOR *)0x0;
    pXVar19 = (X509_ALGOR *)0x0;
LAB_0054c08c:
    unaff_s0 = pAVar5;
    if ((X509_ALGOR *)&DAT_00000008 < unaff_s5) goto LAB_0054c0f0;
    while ((unaff_s3 = (X509_ALGOR *)((int)(pXVar19 + 1) - (int)pXVar22), pXVar22 <= pXVar19 + 1 &&
           (iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(pAVar5), iVar4 != 0))) {
      iVar4 = (*(code *)PTR_BIO_read_006a74c0)
                        (pAStack_e0,
                         (undefined *)
                         ((int)&pXVar22->algorithm + (int)&((ASN1_TYPE *)pAVar5->ln)->type),unaff_s3
                        );
      if (iVar4 < 0) {
        if (pXVar22 == pXVar19) {
          pXStack_124 = (X509_ALGOR *)0x8e;
          iVar4 = 0xad;
          goto LAB_0054c284;
        }
      }
      else {
        pXVar6 = (X509_ALGOR *)((int)&pXVar22->algorithm + iVar4);
        if ((iVar4 != 0) &&
           (bVar1 = pXVar6 < pXVar22, unaff_s5 = (X509_ALGOR *)((int)pXVar6 - (int)pXVar19),
           pXVar22 = pXVar6, bVar1)) {
          pXStack_124 = (X509_ALGOR *)&DAT_0000009b;
          iVar4 = 0xb2;
          goto LAB_0054c284;
        }
      }
LAB_0054c0f0:
      pAVar20 = (ASN1_TYPE *)pAVar5->ln;
      while( true ) {
        puStack_1a4 = auStack_80;
        unaff_s3 = (X509_ALGOR *)((int)&pXVar19->algorithm + (int)&pAVar20->type);
        pXStack_124 = &XStack_88;
        pcStack_1a0 = (char *)unaff_s6;
        apXStack_98[0] = unaff_s3;
        uStack_8c = ASN1_get_object((uchar **)unaff_s4,(long *)puStack_1a4,(int *)&XStack_88,
        ...
        unaff_s3 = (X509_ALGOR *)((int)apXStack_98[0] - (int)unaff_s3);
        pXVar19 = (X509_ALGOR *)((int)pXVar19 + (int)unaff_s3);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_b0 != 0) && (auStack_80[0] == 0)) {
            unaff_s5 = (X509_ALGOR *)((int)pXVar22 - (int)pXVar19);
            if ((XStack_88.algorithm != (ASN1_OBJECT *)0x0) ||
               (iStack_b0 = iStack_b0 + -1, iStack_b0 != 0)) goto LAB_0054c08c;
            goto LAB_0054c324;
          }
          pXVar6 = (X509_ALGOR *)((int)&pXVar19->algorithm + auStack_80[0]);
          if (auStack_80[0] <= (uint)((int)pXVar22 - (int)pXVar19)) goto LAB_0054c220;
          unaff_s5 = (X509_ALGOR *)((int)pXVar6 - (int)pXVar22);
          if ((-1 < (int)unaff_s5) && (pXVar22 <= pXVar6)) {
            pXStack_ac = (X509_ALGOR *)&DAT_00004000;
            if (unaff_s5 != (X509_ALGOR *)0x0) goto LAB_0054c1a0;
            goto LAB_0054c220;
          }
          pXStack_124 = (X509_ALGOR *)&DAT_0000009b;
          iVar4 = 0xe2;
        ...
        if (unaff_s5 < (X509_ALGOR *)&DAT_00000009) break;
        pAVar20 = (ASN1_TYPE *)pAVar5->ln;
      }
    }
    pXStack_124 = (X509_ALGOR *)&DAT_00000041;
    iVar4 = 0xa8;
    goto LAB_0054c284;
  }
  pXStack_124 = (X509_ALGOR *)&DAT_00000041;
...
LAB_0054c2ac:
  ...
  if (pAVar5 == (ASN1_OBJECT *)0x0) {
    ...
    if ((int)ppAVar9 < 0) {
      ...
      pXVar19 = (X509_ALGOR *)(*(code *)puStack_1a4)(pcStack_1a0);
  ...
  if ((int)ppAVar9 < 0) {
    ...
    pXVar19 = (X509_ALGOR *)(*(code *)piStack_164)(pcStack_160,piVar15);
    ppAStack_1ac = ppAVar9;
  }
  if (iStack_134 != 0) {
    pXStack_13c = pXVar19;
  ...
  pXStack_1fc = (X509_ALGOR *)auStack_174;
  puStack_188 = &_gp;
  ...
  if ((int)ppAVar9 < 0) {
    ...
    pXStack_1fc = (X509_ALGOR *)(auStack_174 + 4);
    auStack_174._4_4_ = (ASN1_TYPE *)(auStack_174._0_4_)->ln;
    pXVar19 = (X509_ALGOR *)
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar19 = (X509_ALGOR *)ASN1_item_d2i(ppAStack_23c,in,iVar4,pAStack_1f0);
      iStack_234 = iVar4;
    }
...
LAB_0054c974:
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    while( true ) {
      ...
      pXVar19 = pXStack_288;
      pXVar22 = (X509_ALGOR *)(*(code *)PTR_BIO_write_006a6e14)(pcStack_27c,puVar17);
      ...
      pXStack_288 = (X509_ALGOR *)((int)pXStack_288 - (int)pXVar22);
    }
    pXVar22 = (X509_ALGOR *)0x1;
LAB_0054cb14:
  ...
  if (piStack_30c != (int *)0x0) {
    ...
    if (pbVar16 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar19 = (X509_ALGOR *)(uint)*pbVar16;
        if (iVar4 != 1) {
          uVar2 = CONCAT11(*pbVar16,pbVar16[1]);
          pXVar19 = (X509_ALGOR *)(uint)uVar2;
          if (iVar4 != 2) {
            uVar3 = CONCAT21(uVar2,pbVar16[2]);
            pXVar19 = (X509_ALGOR *)(uint)uVar3;
            if (iVar4 == 4) {
              pXVar19 = (X509_ALGOR *)CONCAT31(uVar3,pbVar16[3]);
            }
          }
        }
      }
      ...
      return (X509_ALGOR *)-(int)pXVar19;
    }
  }
  return (X509_ALGOR *)0x0;
  while( true ) {
    do {
      puStack_1a4 = (uint *)((int)&pXVar22->algorithm + (int)&((ASN1_TYPE *)pAVar5->ln)->type);
      pXStack_124 = pXVar21;
      ...
      unaff_s3 = (X509_ALGOR *)((int)pXVar21 - iVar4);
      pXVar22 = (X509_ALGOR *)((int)&pXVar22->algorithm + iVar4);
      pXVar21 = unaff_s3;
    } while (unaff_s3 != (X509_ALGOR *)0x0);
    unaff_s5 = (X509_ALGOR *)((int)unaff_s5 - (int)pXVar6);
    pXStack_ac = (X509_ALGOR *)((int)pXStack_ac << (pXStack_ac < (X509_ALGOR *)0x3fffffff));
    if (unaff_s5 == (X509_ALGOR *)0x0) break;
LAB_0054c1a0:
    unaff_s3 = (X509_ALGOR *)(uint)(pXStack_ac < unaff_s5);
    pXVar6 = pXStack_ac;
    if (unaff_s3 == (X509_ALGOR *)0x0) {
      pXVar6 = unaff_s5;
    }
    iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)
                      (pAVar5,(undefined *)((int)&pXVar22->algorithm + (int)&pXVar6->algorithm));
    pXVar21 = pXVar6;
    if (iVar4 == 0) {
      pXStack_124 = (X509_ALGOR *)&DAT_00000041;
      iVar4 = 0xef;
  ...
  pXVar6 = (X509_ALGOR *)((int)&pXVar19->algorithm + auStack_80[0]);
LAB_0054c220:
  pXVar19 = (X509_ALGOR *)(uint)(pXVar6 < pXVar19);
  if (pXVar19 != (X509_ALGOR *)0x0) {
    pXStack_124 = (X509_ALGOR *)&DAT_0000009b;
    iVar4 = 0x106;
    goto LAB_0054c284;
  }
  ...
  unaff_s5 = (X509_ALGOR *)((int)pXVar22 - (int)pXVar6);
  goto LAB_0054c08c;
LAB_0054c324:
  if ((int)pXVar19 < 0) {
    pXStack_124 = (X509_ALGOR *)&DAT_0000009b;
