...

{
  ...
  local_44 = (byte **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (((uint)puStack_70 & 7) == 0) {
    if (puStack_70 < &DAT_00000008) {
      ...
      (*(code *)PTR_memcpy_006a9aec)(out,in + 8,puStack_70);
      inlen = inlen - 0x10;
      unaff_s6 = &local_34;
      local_4c = 6;
      do {
        ...
        do {
          ...
          (**(code **)(local_58 + -0x6908))(unaff_s7,unaff_s7,key);
          *unaff_s0 = local_34;
          unaff_s0[1] = local_30;
      ...
      iv = (uchar *)local_48;
      iVar7 = (**(code **)(local_58 + -0x5310))(unaff_s7,local_48,8);
      puVar8 = puStack_70;
      puStack_bc = out;
      pAStack_b8 = key;
      if (iVar7 != 0) {
  ...
  pbStack_90 = &_gp;
  pbStack_7c = *(byte **)PTR___stack_chk_guard_006a9ae8;
  ...
  puStack_74 = unaff_s0;
  if ((uint *)in == (uint *)0x0) {
    (*(code *)PTR_RC2_decrypt_006a9678)(&uStack_84);
  }
  else {
    (*(code *)PTR_RC2_encrypt_006a967c)(&uStack_84,puVar12);
  }
  *iv = (char)uStack_84;
      ...
      do {
        if (uStack_118 == 0) {
          ...
          uStack_d0 = (uint)pbStack_174[7] << 0x18 |
                      ...
                      (uint)pbStack_174[4];
          (**(code **)(pbStack_e0 + -0x5764))(puStack_158,in);
          pbVar13 = (byte *)(uStack_d4 >> 0x10);
          *pbStack_174 = (byte)uStack_d4;
          puStack_160 = (uint *)(uStack_d0 >> 8);
          pbStack_174[4] = (byte)uStack_d0;
  ...
  if (pbVar13 != (byte *)0x0) {
    ...
    do {
      if (uStack_178 == 0) {
        ...
        (**(code **)((int)puVar18 + -0x5764))(in,puStack_170);
  ...
  if (iStack_138 == 0) {
    for (; puStack_1a8 = &uStack_184, pbStack_1b4 != (byte *)0x0; pbStack_1b4 = pbStack_1b4 + -1) {
      ...
      if (uStack_1c8 == 0) {
        ...
        (**(code **)((int)puVar19 + -0x68f8))(&uStack_184);
    ...
    if (pbVar13 != (byte *)0x0) {
      ...
      do {
        if (uStack_1c8 == 0) {
          uStack_184 = *puStack_1c4;
          uStack_180 = puStack_1c4[1];
          (*(code *)puStack_190[-0x1a3e])(puStack_1a8,pbStack_1c0);
          pbVar13 = (byte *)(uStack_184 >> 0x10);
          *(char *)((int)puStack_1c4 + 3) = (char)uStack_184;
          pbVar17 = (byte *)(uStack_180 >> 0x18);
          *(char *)((int)puStack_1c4 + 7) = (char)uStack_180;
  ...
  if (iStack_17c != iVar7) {
    ...
    if (pbVar13 != (byte *)0x0) {
      ...
      do {
        if (uVar16 == 0) {
          iVar7 = iVar7 + 1;
          (*(code *)PTR_idea_encrypt_006a84e8)(&uStack_1dc,pbVar14);
          abStack_1d4[3] = (char)uStack_1dc;
          uStack_1cd = (char)uStack_1d8;
          abStack_1d4[0] = (byte)((uint)uStack_1dc >> 0x18);
          abStack_1d4[1] = (char)((uint)uStack_1dc >> 0x10);
    ...
    *puStack_18c = uVar16;
    ...
    if (uVar15 != 1) {
      ...
      iVar7 = (*(code *)PTR_Camellia_decrypt_006a8514)();
      return iVar7;
    }
                    /* WARNING: Could not recover jumptable at 0x005e6c90. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    iVar7 = (*(code *)PTR_Camellia_encrypt_006a8518)();
    return iVar7;
  }
  return iVar7;
}
