...

{
  ...
  if (pdVar1 != (dtls1_state_st *)0x0) {
    ...
    uVar9 = (pdVar1->w_msg_hdr).msg_len;
    uVar10 = *(undefined4 *)&pdVar1->w_msg_hdr;
    dtls1_clear_queues();
    (*(code *)PTR_memset_006a99f4)(param_1->d1,0,0x2ec);
    if (param_1->server != 0) {
    ...
    if ((uVar2 & 0x1000) == 0) {
      ...
      pdVar1 = param_1->d1;
      (pdVar1->w_msg_hdr).msg_len = uVar9;
      *(undefined4 *)&pdVar1->w_msg_hdr = uVar10;
    }
