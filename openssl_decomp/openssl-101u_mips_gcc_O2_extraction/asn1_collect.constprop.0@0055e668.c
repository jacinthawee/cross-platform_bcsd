...

{
  ...
  if (param_1 == (int *)0x0) {
    ...
    if (0 < param_3) goto LAB_0055e6e0;
  }
  else {
    if (0 < param_3) {
LAB_0055e6e0:
LAB_0055e740:
      do {
        ...
        if (((param_3 != 1) && (*local_40 == '\0')) && (local_40[1] == '\0')) {
          local_40 = local_40 + 2;
          if (param_4 != 0) goto LAB_0055e914;
          uVar6 = 0x9f;
          uVar4 = 0x435;
          goto LAB_0055e838;
        }
        ...
        if ((uVar3 & 0x20) == 0) {
          if (iVar7 != 0) {
            if (param_1 != (int *)0x0) {
              iVar5 = *param_1;
              uVar8 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(param_1,iVar5 + iVar7);
              if (uVar8 == 0) {
                (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0x8c,0x41,s_tasn_dec_c_0066a0bc,0x45c);
                goto LAB_0055e8b0;
              }
              (*(code *)PTR_memcpy_006a9aec)(param_1[1] + iVar5,local_40,iVar7);
            }
...
LAB_0055e838:
  uVar8 = 0;
  (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0x6a,uVar6,s_tasn_dec_c_0066a0bc,uVar4);
LAB_0055e8b0:
