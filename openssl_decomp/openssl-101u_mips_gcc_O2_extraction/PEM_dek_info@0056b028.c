...

{
  ...
  (*(code *)PTR_BUF_strlcat_006a6f68)(buf,"DEK-Info: ",0x400);
  (*(code *)PTR_BUF_strlcat_006a6f68)(buf,type,0x400);
  (*(code *)PTR_BUF_strlcat_006a6f68)(buf,",",0x400);
  iVar1 = (*(code *)PTR_strlen_006a9a24)(buf);
  iVar5 = len * 2;
