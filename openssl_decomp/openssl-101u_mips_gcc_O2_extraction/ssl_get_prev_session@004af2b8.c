...

{
  ...
  iVar7 = -1;
  if (param_4 - param_2 < param_3) goto LAB_004af350;
  unaff_s4 = param_1;
  if (param_3 == 0) {
    ...
    case 2:
    case 3:
      goto switchD_004af3c0_caseD_2;
    default:
      goto switchD_004af3c0_caseD_5;
    case 0xffffffff:
      iVar7 = -1;
      bVar1 = false;
    }
    ...
    case 1:
      if (local_128 == (SSL_SESSION *)0x0) {
        ...
        if ((*(uint *)(iVar7 + 0x20) & 0x100) == 0) {
          ...
          local_dc = param_3;
          (*(code *)PTR___memcpy_chk_006a9a48)(auStack_d8,param_2,param_3,0xac,ppSVar10);
          CRYPTO_lock(5,0xc,"ssl_sess.c",0x282);
          local_128 = (SSL_SESSION *)
                      (*(code *)PTR_lh_retrieve_006a73b0)
                                (*(undefined4 *)(param_1[0x5c] + 0x10),local_120);
          if (local_128 != (SSL_SESSION *)0x0) {
            CRYPTO_add_lock((int *)(local_128->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x286);
          }
          CRYPTO_lock(6,0xc,"ssl_sess.c",0x288);
          if (local_128 != (SSL_SESSION *)0x0) goto LAB_004af504;
          iVar7 = param_1[0x5c];
        ...
        if (local_128 != (SSL_SESSION *)0x0) {
          ...
          if (local_124 != 0) {
            unaff_s5 = "-check_ss_sig";
            CRYPTO_add_lock((int *)(local_128->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x29c);
            s = (SSL_CTX *)param_1[0x5c];
          }
...
LAB_004af504:
    ...
    case 2:
    case 3:
switchD_004af3c0_caseD_2:
      bVar1 = false;
LAB_004af3d0:
      iVar7 = 0;
      unaff_s3 = local_128;
      if (local_128 == (SSL_SESSION *)0x0) goto LAB_004af350;
      break;
    default:
switchD_004af3c0_caseD_5:
      iVar7 = (*(code *)PTR_abort_006a9964)();
      return iVar7;
    case 0xffffffff:
      iVar7 = -1;
      bVar1 = true;
    ...
    if ((uVar8 != param_1[0x27]) ||
       (iVar7 = (*(code *)PTR_memcmp_006a9ad0)(local_128->sid_ctx,param_1 + 0x28,uVar8), iVar7 != 0)
       ) {
      iVar7 = 0;
LAB_004af3ec:
      unaff_s5 = "-check_ss_sig";
    ...
    if (((param_1[0x32] & 1) != 0) && (uVar8 == 0)) {
      unaff_s5 = "-check_ss_sig";
      iVar7 = -1;
      (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0xd9,0x115,"ssl_sess.c",0x2c7);
      unaff_s3 = local_128;
      goto joined_r0x004af444;
    }
    if (*(int *)(unaff_s3->krb5_client_princ + 0x24) == 0) {
      uVar3 = *(undefined4 *)(unaff_s3->krb5_client_princ + 0x28);
      ...
      if (unaff_s3->ssl_version < 0x300) {
        uVar3 = (**(code **)(param_1[2] + 0x48))(&local_2b);
        *(undefined4 *)(unaff_s3->krb5_client_princ + 0x24) = uVar3;
      }
      else {
    ...
    iVar6 = *(int *)(unaff_s3->krb5_client_princ + 0x18);
    iVar5 = (*(code *)PTR_time_006a9adc)(0);
    unaff_s3 = local_128;
    ...
    if (unaff_s5 == (char *)0x0) {
      ...
      *(int *)(param_1[0x5c] + 0x58) = *(int *)(param_1[0x5c] + 0x58) + 1;
      if ((iVar7 != 0) &&
         (iVar5 = CRYPTO_add_lock((int *)(iVar7 + 0xa4),-1,0xe,"ssl_sess.c",0x36c), iVar5 < 1)) {
    ...
    *(int *)(unaff_s6 + 0x50) = *(int *)(unaff_s6 + 0x50) + 1;
    ...
    pSVar4 = (SSL_SESSION *)
             (*(code *)PTR_lh_retrieve_006a73b0)(*(undefined4 *)(unaff_s6 + 0x10),unaff_s3);
    if (unaff_s3 == pSVar4) goto LAB_004af820;
    bVar1 = true;
...
joined_r0x004af444:
  while( true ) {
    param_1 = unaff_s4;
    local_128 = unaff_s3;
    if (unaff_s3 != (SSL_SESSION *)0x0) {
LAB_004af3f0:
      iVar5 = CRYPTO_add_lock((int *)(unaff_s3->krb5_client_princ + 0x14),-1,0xe,unaff_s5 + 0x7d54,
                              0x36c);
      if (iVar5 < 1) {
        SSL_SESSION_free_part_2(unaff_s3);
      }
      unaff_s4 = param_1;
      if (!bVar1) {
        param_1[0x50] = 1;
...
LAB_004af820:
    pSVar4 = (SSL_SESSION *)
             (*(code *)PTR_lh_delete_006a8390)(*(undefined4 *)(unaff_s6 + 0x10),unaff_s3);
    iVar5 = *(int *)(unaff_s3->krb5_client_princ + 0x3c);
    if (iVar5 != 0) {
      iVar6 = *(int *)(unaff_s3->krb5_client_princ + 0x38);
      if (iVar6 != 0) {
        if (iVar5 == unaff_s6 + 0x1c) {
          ...
          *(int *)(iVar5 + 200) = iVar6;
          *(int *)(*(int *)(unaff_s3->krb5_client_princ + 0x38) + 0xcc) = iVar5;
        }
        *(undefined4 *)(unaff_s3->krb5_client_princ + 0x3c) = 0;
        *(undefined4 *)(unaff_s3->krb5_client_princ + 0x38) = 0;
      }
    }
    CRYPTO_lock(10,0xc,unaff_s5 + 0x7d54,0x358);
