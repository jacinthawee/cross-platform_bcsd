    ...
    do {
      ...
      if ((((cVar1 == '\x02') || (iVar6 = 5, cVar1 == '\x03')) || (iVar6 = 1, cVar1 == '\x01')) &&
        ...
        case '\x02':
          ...
          break;
        case '\x03':
          iVar3 = (*(code *)PTR_EVP_sha224_006a81d8)();
          break;
        case '\x04':
          iVar3 = (*(code *)PTR_EVP_sha256_006a8000)();
          break;
        case '\x05':
          iVar3 = (*(code *)PTR_EVP_sha384_006a81dc)();
          break;
        case '\x06':
          iVar3 = (*(code *)PTR_EVP_sha512_006a81d4)();
        }
...
LAB_004942b8:
    ...
    if (*(int *)(iVar7 + 0x50) != 0) goto LAB_00494318;
  }
