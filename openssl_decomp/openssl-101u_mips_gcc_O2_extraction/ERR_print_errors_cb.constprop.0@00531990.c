...
void ERR_print_errors_cb_constprop_0(char **param_1)

{
  ...
  do {
    ...
    *(undefined **)((int)register0x00000074 + -0x118c) = PTR___stack_chk_guard_006a9ae8;
    ...
    *(undefined4 *)((int)register0x00000074 + -0x2c) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8
    ...
    uVar1 = (**(code **)(*(int *)((int)register0x00000074 + -0x11a0) + -0x695c))(a);
    *(undefined4 *)((int)register0x00000074 + -0x1194) = uVar1;
    *(char **)((int)register0x00000074 + -0x1190) = "-check_ss_sig";
    do {
      pBVar4 = file;
      unaff_s2 = line;
      ...
      if ((*(uint *)((int)register0x00000074 + -0x1178) & 2) == 0) {
        iVar3 = *(int *)((int)register0x00000074 + -0x1190) + -0x7274;
      }
      else {
    ...
    *(undefined4 *)((int)register0x00000074 + -0x11ec) =
    ...
    unaff_s0 = "%lu:%s:%s:%d:%s\n";
    unaff_s1 = (char *)(**(code **)(*(int *)((int)register0x00000074 + -0x2320) + -0x695c))
                                 ((undefined *)((int)register0x00000074 + -0x22f4));
    *(char **)((int)register0x00000074 + -0x2310) = "-check_ss_sig";
    do {
      ...
      *(char **)((int)register0x00000074 + -0x2330) = unaff_s7;
      ...
      uVar1 = (**(code **)(*(int *)((int)register0x00000074 + -0x2320) + -0x53bc))(unaff_s6);
      param_1 = unaff_s6;
