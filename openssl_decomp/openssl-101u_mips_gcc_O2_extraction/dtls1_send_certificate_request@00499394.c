...

{
  ...
  if (param_1->state == 0x2160) {
    ...
    if (psVar5 == (stack_st_X509_NAME *)0x0) {
      ...
      iVar11 = 0;
      iVar8 = (*(code *)PTR_sk_num_006a6e2c)(psVar5);
      if (0 < iVar8) {
        do {
          uVar3 = (*(code *)PTR_sk_value_006a6e24)(psVar5,iVar11);
          iVar8 = (*(code *)PTR_i2d_X509_NAME_006a76ec)(uVar3,0);
          iVar6 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(pBVar12,iVar8 + iVar7 + 0xc + 2);
          puVar1 = PTR_i2d_X509_NAME_006a76ec;
          if (iVar6 == 0) {
            (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x104,7,"d1_srvr.c",0x611);
            uVar3 = 0xffffffff;
            goto LAB_00499408;
          }
          ...
          if ((param_1->references & 0x20000000U) == 0) {
            *pcVar10 = (char)((uint)iVar8 >> 8);
            ...
            local_30 = pcVar10;
            (*(code *)PTR_i2d_X509_NAME_006a76ec)(uVar3,&local_30);
...
LAB_00499408:
  ...
  if ((iVar7 == 0) &&
    ...
    iVar7 = dtls1_output_cert_chain(iVar4,iVar7);
    if (iVar7 != 0) {
      *(int *)(iVar4 + 0x44) = iVar7;
  ...
  (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x109,0x44,"d1_srvr.c",uVar3);
  return 0;
}
