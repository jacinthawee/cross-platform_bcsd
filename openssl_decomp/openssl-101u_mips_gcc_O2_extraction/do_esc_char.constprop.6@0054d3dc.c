...
LAB_0054d4b8:
        if ((uVar2 & 6) == 0) {
          ...
          if (param_4 != 0) {
            ...
            param_2 = "\\\\";
            iVar3 = (*(code *)PTR_BIO_write_006a6e14)(param_4);
            if (iVar3 != 2) goto LAB_0054d488;
          }
LAB_0054d500:
          puVar4 = &SUB_00000002;
        }
        ...
        if ((uVar2 & 0x61) == 0) goto LAB_0054d4b8;
        if ((uVar2 & 8) == 0) {
          param_2 = (char *)0x0;
          if (param_4 == 0) goto LAB_0054d500;
          param_3 = (char *)0x1;
          param_2 = "\\";
          unaff_s2 = (char *)(*(code *)PTR_BIO_write_006a6e14)(param_4);
...
LAB_0054d48c:
  ...
  if (((uint)param_2 & 0x40) == 0) {
    ...
    if ((a != (ASN1_TYPE *)0x0) &&
       ((iVar8 = (*(code *)PTR_BIO_write_006a6e14)(a,pcVar6,iVar9), iVar9 != iVar8 ||
        (iVar8 = (*(code *)PTR_BIO_write_006a6e14)(a,":",1), iVar8 != 1)))) goto LAB_0054d710;
    uStack_b4 = iVar9 + 1;
  }
...
LAB_0054d6e8:
    if (a == (ASN1_TYPE *)0x0) {
      ...
      iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_006695a8,1);
      if (iVar3 != 1) goto LAB_0054d710;
      if (((uint)param_2 & 0x200) != 0) goto LAB_0054e604;
      ...
      if ((byte *)param_3 != pbVar16) {
        do {
          ...
          iVar9 = (*(code *)PTR_BIO_write_006a6e14)(a,&cStack_78,2);
          if (iVar9 != 2) goto LAB_0054d710;
          pbVar16 = pbVar16 + 1;
  ...
  if (((uint)param_2 & 0x20) == 0) {
    if ((0x1d < iVar3 - 1U) || (uVar13 = (uint)(char)tag2nbyte[iVar3], uVar13 == 0xffffffff)) {
      if (((uint)param_2 & 0x100) != 0) goto LAB_0054d6e8;
      goto LAB_0054d824;
    }
...
LAB_0054e198:
              ...
              if ((uVar12 & 0x61) == 0) goto LAB_0054e198;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e17c:
              ...
              if ((uVar12 & 0x61) == 0) goto LAB_0054e17c;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e1b4:
              ...
              if ((uVar12 & 0x61) == 0) goto LAB_0054e1b4;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e160:
              ...
              if ((uVar12 & 0x61) == 0) goto LAB_0054e160;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e1d8:
              ...
              if ((uVar11 & 0x61) == 0) goto LAB_0054e144;
LAB_0054dad0:
              if ((uVar11 & 8) == 0) {
                iVar3 = iVar3 + 2;
              }
...
LAB_0054e120:
              ...
              if ((uVar7 & 0x61) == 0) goto LAB_0054e120;
              if ((uVar7 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e320:
              ...
              uVar12 = uVar11 & (byte)char_type[abStack_80[1]];
              if ((uVar12 & 0x61) == 0) goto LAB_0054e320;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e2fc:
              ...
              uVar12 = uVar11 & (byte)char_type[abStack_80[2]];
              if ((uVar12 & 0x61) == 0) goto LAB_0054e2fc;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e2d8:
              ...
              uVar12 = uVar11 & (byte)char_type[abStack_80[3]];
              if ((uVar12 & 0x61) == 0) goto LAB_0054e2d8;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
...
LAB_0054e2b4:
              ...
              uVar12 = uVar11 & (byte)char_type[bStack_7c];
              if ((uVar12 & 0x61) == 0) goto LAB_0054e2b4;
              if ((uVar12 & 8) == 0) {
                iVar8 = 2;
              }
              else {
            ...
            if (iVar9 != 5) {
              if ((char)bStack_7b < '\0') {
                ...
                uVar11 = uVar11 & (byte)char_type[bStack_7b];
                if ((uVar11 & 0x61) != 0) goto LAB_0054dad0;
              }
              iVar9 = 1;
              if ((uVar11 & 6) != 0) goto LAB_0054e1d8;
              if (bStack_7b == 0x5c) {
                iVar9 = 2;
              }
              iVar3 = iVar3 + iVar9;
...
LAB_0054dae8:
  ...
  if (cStack_8d == '\0') {
    ...
    puVar5 = puStack_b8;
    if (a == (ASN1_TYPE *)0x0) goto LAB_0054d718;
    iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_00679c10,1);
    if (iVar3 != 1) goto LAB_0054d710;
  }
  pcVar6 = *(char **)param_3;
    ...
    do {
      while( true ) {
        ...
        if ((byte *)param_3 == (byte *)0x1) {
          ...
          puVar5 = (undefined *)0xffffffff;
          if (param_3 != &SUB_00000004) goto LAB_0054d718;
          AStack_88.type =
               (uint)*(byte *)((int)puVar15 + 3) |
               (uint)*(byte *)(puVar15 + 1) << 8 |
               (uint)*(byte *)((int)puVar15 + 1) << 0x10 | (uint)*(byte *)puVar15 << 0x18;
        ...
        if (iVar3 < 0) goto LAB_0054d710;
        if (puVar14 == puVar15) goto LAB_0054dccc;
      }
      pbVar16 = abStack_80;
      ...
      if (0 < iVar3) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar20 & 0x61) == 0) goto LAB_0054dd08;
            if ((uVar20 & 8) == 0) {
              iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_00669598,1);
              if (iVar3 != 1) goto LAB_0054d710;
              iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&_Stack_8c,1);
            }
            else {
LAB_0054dc98:
              iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&_Stack_8c,1);
...
joined_r0x0054deb8:
            pbVar16 = pbVar16 + 1;
            if (pbVar18 == pbVar16) goto LAB_0054dcc0;
          }
          uVar20 = (uint)param_2 & 4;
LAB_0054dd08:
          if ((uVar20 & 6) == 0) {
            if ((bVar1 != 0x5c) || (uVar2 == 0)) goto LAB_0054dc98;
            iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_006695a4,2);
            if (iVar3 == 2) goto joined_r0x0054deb8;
            goto LAB_0054d710;
          }
          (*(code *)PTR_BIO_snprintf_006a6f60)(&cStack_78,0xb,"\\%02X");
          iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&cStack_78,3);
          if (iVar3 != 3) goto LAB_0054d710;
          pbVar16 = pbVar16 + 1;
...
LAB_0054dccc:
  puVar5 = puStack_b8;
  if (cStack_8d == '\0') goto LAB_0054d718;
  iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_00679c10,1);
  if (iVar3 == 1) goto LAB_0054d718;
LAB_0054d710:
  do {
    puVar5 = (undefined *)0xffffffff;
LAB_0054d718:
