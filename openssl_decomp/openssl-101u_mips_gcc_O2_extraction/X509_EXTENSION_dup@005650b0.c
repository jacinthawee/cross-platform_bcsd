...

{
  ...
  X509_EXTENSION *unaff_s3;
  X509_EXTENSION **unaff_s4;
  X509_EXTENSION *unaff_s5;
  ASN1_BOOLEAN *unaff_s6;
  X509_EXTENSION *pXVar22;
  undefined auStack_316 [10];
  int *piStack_30c;
  X509_EXTENSION *pXStack_304;
  ...
  X509_EXTENSION *pXStack_248;
  code *pcStack_244;
  undefined *puStack_240;
  ASN1_VALUE **ppAStack_23c;
  undefined *puStack_238;
  int iStack_234;
  ASN1_BOOLEAN *pAStack_230;
  code *pcStack_22c;
  ASN1_VALUE **ppAStack_208;
  code *pcStack_204;
  undefined *puStack_200;
  X509_EXTENSION *pXStack_1fc;
  undefined *puStack_1f8;
  ASN1_VALUE **ppAStack_1f4;
  ASN1_ITEM *pAStack_1f0;
  X509_EXTENSION *pXStack_1ec;
  ASN1_BOOLEAN *pAStack_1e8;
  ...
  ASN1_OCTET_STRING **ppAStack_1a4;
  char *pcStack_1a0;
  code *pcStack_19c;
  undefined *puStack_188;
  X509_EXTENSION *pXStack_17c;
  ...
  X509_EXTENSION *pXStack_13c;
  int iStack_134;
  int iStack_130;
  ASN1_ITEM *pAStack_12c;
  ASN1_OBJECT *pAStack_128;
  X509_EXTENSION *pXStack_124;
  ...
  X509_EXTENSION *pXStack_e4;
  int iStack_e0;
  X509_EXTENSION *pXStack_dc;
  X509_EXTENSION **ppXStack_d8;
  code *pcStack_d4;
  int iStack_b0;
  X509_EXTENSION *pXStack_ac;
  X509_EXTENSION *apXStack_98 [3];
  uint uStack_8c;
  X509_EXTENSION aXStack_88 [2];
  int iStack_6c;
  ASN1_OBJECT *pAStack_68;
  undefined *puStack_64;
  ASN1_OBJECT *pAStack_1c;
  X509_EXTENSION XStack_18;
  
  pXStack_e4 = (X509_EXTENSION *)PTR___stack_chk_guard_006a9ae8;
  pAStack_1c = (ASN1_OBJECT *)0x0;
  XStack_18.critical = *(ASN1_BOOLEAN *)PTR___stack_chk_guard_006a9ae8;
  if (ex == (X509_EXTENSION *)0x0) {
    pAVar5 = (ASN1_OBJECT *)0x0;
  }
  else {
    iVar4 = ASN1_item_i2d((ASN1_VALUE *)ex,(uchar **)&pAStack_1c,(ASN1_ITEM *)X509_EXTENSION_it);
    if (pAStack_1c == (ASN1_OBJECT *)0x0) {
      ex = (X509_EXTENSION *)0xbf;
      ERR_put_error(0xd,0xbf,0x41,"a_dup.c",0x6e);
      pAVar5 = (ASN1_OBJECT *)0x0;
      unaff_s0 = (ASN1_OBJECT *)X509_EXTENSION_it;
    }
    else {
      ex = &XStack_18;
      XStack_18.object = pAStack_1c;
      pAVar5 = (ASN1_OBJECT *)
               ASN1_item_d2i((ASN1_VALUE **)0x0,(uchar **)ex,iVar4,(ASN1_ITEM *)X509_EXTENSION_it);
      (*(code *)PTR_CRYPTO_free_006a6e88)(pAStack_1c);
      unaff_s0 = pAVar5;
    }
  }
  if (XStack_18.critical == *(int *)pXStack_e4) {
    return (X509_EXTENSION *)pAVar5;
  }
  iStack_e0 = XStack_18.critical;
  ...
  if (pAVar5 != (ASN1_OBJECT *)0x0) {
    ...
    unaff_s6 = &aXStack_88[0].critical;
    ERR_clear_error();
    iStack_b0 = 0;
    pXVar22 = (X509_EXTENSION *)0x0;
    unaff_s5 = (X509_EXTENSION *)0x0;
    pXVar19 = (X509_EXTENSION *)0x0;
LAB_0054c08c:
    unaff_s0 = pAVar5;
    if ((X509_EXTENSION *)&DAT_00000008 < unaff_s5) goto LAB_0054c0f0;
    while ((unaff_s3 = (X509_EXTENSION *)((int)&pXVar19->value - (int)pXVar22),
      ...
      if (iVar4 < 0) {
        if (pXVar22 == pXVar19) {
          pXStack_124 = (X509_EXTENSION *)0x8e;
          iVar4 = 0xad;
          goto LAB_0054c284;
        }
      }
      else {
        pXVar6 = (X509_EXTENSION *)((int)&pXVar22->object + iVar4);
        if ((iVar4 != 0) &&
           (bVar1 = pXVar6 < pXVar22, unaff_s5 = (X509_EXTENSION *)((int)pXVar6 - (int)pXVar19),
           pXVar22 = pXVar6, bVar1)) {
          pXStack_124 = (X509_EXTENSION *)&DAT_0000009b;
          iVar4 = 0xb2;
          goto LAB_0054c284;
        }
      }
LAB_0054c0f0:
      ppcVar20 = pAVar5->ln;
      while( true ) {
        ppAStack_1a4 = &aXStack_88[0].value;
        unaff_s3 = (X509_EXTENSION *)((int)&pXVar19->object + (int)ppcVar20);
        pXStack_124 = aXStack_88;
        pcStack_1a0 = (char *)unaff_s6;
        apXStack_98[0] = unaff_s3;
        uStack_8c = ASN1_get_object((uchar **)unaff_s4,(long *)ppAStack_1a4,(int *)aXStack_88,
        ...
        unaff_s3 = (X509_EXTENSION *)((int)apXStack_98[0] - (int)unaff_s3);
        pXVar19 = (X509_EXTENSION *)((int)pXVar19 + (int)unaff_s3);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_b0 != 0) && (aXStack_88[0].value == (ASN1_OCTET_STRING *)0x0)) {
            unaff_s5 = (X509_EXTENSION *)((int)pXVar22 - (int)pXVar19);
            if ((aXStack_88[0].object != (ASN1_OBJECT *)0x0) ||
               (iStack_b0 = iStack_b0 + -1, iStack_b0 != 0)) goto LAB_0054c08c;
            goto LAB_0054c324;
          }
          pXVar6 = (X509_EXTENSION *)((int)aXStack_88[0].value + (int)pXVar19);
          if (aXStack_88[0].value <= (ASN1_OCTET_STRING *)((int)pXVar22 - (int)pXVar19))
          goto LAB_0054c220;
          unaff_s5 = (X509_EXTENSION *)((int)pXVar6 - (int)pXVar22);
          if ((-1 < (int)unaff_s5) && (pXVar22 <= pXVar6)) {
            pXStack_ac = (X509_EXTENSION *)&DAT_00004000;
            if (unaff_s5 != (X509_EXTENSION *)0x0) goto LAB_0054c1a0;
            goto LAB_0054c220;
          }
          pXStack_124 = (X509_EXTENSION *)&DAT_0000009b;
          iVar4 = 0xe2;
        ...
        if (unaff_s5 < (X509_EXTENSION *)&DAT_00000009) break;
        ppcVar20 = pAVar5->ln;
      }
    }
    pXStack_124 = (X509_EXTENSION *)&DAT_00000041;
    iVar4 = 0xa8;
    goto LAB_0054c284;
  }
  pXStack_124 = (X509_EXTENSION *)&DAT_00000041;
  pcStack_1a0 = "a_d2i_fp.c";
  ppAStack_1a4 = (ASN1_OCTET_STRING **)&DAT_0000006b;
  ERR_put_error(0xd,0x6b,0x41,"a_d2i_fp.c",0x9e);
  pXVar19 = (X509_EXTENSION *)0xffffffff;
LAB_0054c2ac:
  ...
  if (pAVar5 == (ASN1_OBJECT *)0x0) {
    ...
    if ((int)ppAVar9 < 0) {
      ...
      pXVar19 = (X509_EXTENSION *)(*(code *)ppAStack_1a4)(pcStack_1a0);
  ...
  if ((int)ppAVar9 < 0) {
    ...
    pXVar19 = (X509_EXTENSION *)(*(code *)piStack_164)(pcStack_160,piVar15);
    ppAStack_1ac = ppAVar9;
  }
  if (iStack_134 != 0) {
    pXStack_13c = pXVar19;
  ...
  pXStack_1fc = (X509_EXTENSION *)auStack_174;
  puStack_188 = &_gp;
  ...
  if ((int)ppAVar9 < 0) {
    ...
    pXStack_1fc = (X509_EXTENSION *)(auStack_174 + 4);
    auStack_174._4_4_ = (auStack_174._0_4_)->ln;
    pXVar19 = (X509_EXTENSION *)
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar19 = (X509_EXTENSION *)ASN1_item_d2i(ppAStack_23c,in,iVar4,pAStack_1f0);
      iStack_234 = iVar4;
    }
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    if (ppAStack_23c == (ASN1_VALUE **)0x0) {
      ...
      pXStack_248 = (X509_EXTENSION *)0x1;
LAB_0054c974:
  ...
  pAStack_230 = unaff_s6;
  pXStack_288 = (X509_EXTENSION *)(*pcStack_284)(iVar4,0);
  puVar10 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a7008)(pXStack_288,"a_i2d_fp.c",0x5a);
  if (puVar10 == (undefined *)0x0) {
    pXVar19 = (X509_EXTENSION *)&DAT_00000041;
    ...
    while( true ) {
      ...
      pXVar19 = pXStack_288;
      pXVar22 = (X509_EXTENSION *)(*(code *)PTR_BIO_write_006a6e14)(pcStack_27c,puVar17);
      ...
      pXStack_288 = (X509_EXTENSION *)((int)pXStack_288 - (int)pXVar22);
    }
    pXVar22 = (X509_EXTENSION *)0x1;
LAB_0054cb14:
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    pXStack_304 = (X509_EXTENSION *)0x0;
    ...
    if (puStack_290 == (uchar *)0x0) {
      ...
      pXStack_304 = (X509_EXTENSION *)0x1;
LAB_0054cc80:
...
LAB_0054cf88:
  ...
  if (piStack_30c != (int *)0x0) {
    if (piStack_30c[1] == 0x10a) {
      ...
      bVar1 = false;
      if (piStack_30c[1] != 10) {
        return (X509_EXTENSION *)0xffffffff;
      }
    }
    iVar4 = *piStack_30c;
    if (4 < iVar4) {
    ...
    if (pbVar16 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar19 = (X509_EXTENSION *)(uint)*pbVar16;
        if (iVar4 != 1) {
          uVar2 = CONCAT11(*pbVar16,pbVar16[1]);
          pXVar19 = (X509_EXTENSION *)(uint)uVar2;
          if (iVar4 != 2) {
            uVar3 = CONCAT21(uVar2,pbVar16[2]);
            pXVar19 = (X509_EXTENSION *)(uint)uVar3;
            if (iVar4 == 4) {
              pXVar19 = (X509_EXTENSION *)CONCAT31(uVar3,pbVar16[3]);
            }
          }
        }
      }
      ...
      return (X509_EXTENSION *)-(int)pXVar19;
    }
  }
  return (X509_EXTENSION *)0x0;
  while( true ) {
    do {
      ppAStack_1a4 = (ASN1_OCTET_STRING **)((int)&pXVar22->object + (int)pAVar5->ln);
      pXStack_124 = pXVar21;
      ...
      unaff_s3 = (X509_EXTENSION *)((int)pXVar21 - iVar4);
      pXVar22 = (X509_EXTENSION *)((int)&pXVar22->object + iVar4);
      pXVar21 = unaff_s3;
    } while (unaff_s3 != (X509_EXTENSION *)0x0);
    unaff_s5 = (X509_EXTENSION *)((int)unaff_s5 - (int)pXVar6);
    pXStack_ac = (X509_EXTENSION *)((int)pXStack_ac << (pXStack_ac < (X509_EXTENSION *)0x3fffffff));
    if (unaff_s5 == (X509_EXTENSION *)0x0) break;
LAB_0054c1a0:
    unaff_s3 = (X509_EXTENSION *)(uint)(pXStack_ac < unaff_s5);
    pXVar6 = pXStack_ac;
    if (unaff_s3 == (X509_EXTENSION *)0x0) {
      pXVar6 = unaff_s5;
    }
  ...
  pXVar6 = (X509_EXTENSION *)((int)&(aXStack_88[0].value)->length + (int)&pXVar19->object);
LAB_0054c220:
  pXVar19 = (X509_EXTENSION *)(uint)(pXVar6 < pXVar19);
  if (pXVar19 != (X509_EXTENSION *)0x0) {
    pXStack_124 = (X509_EXTENSION *)&DAT_0000009b;
    iVar4 = 0x106;
    goto LAB_0054c284;
  }
  ...
  unaff_s5 = (X509_EXTENSION *)((int)pXVar22 - (int)pXVar6);
  goto LAB_0054c08c;
LAB_0054c324:
  if ((int)pXVar19 < 0) {
    pXStack_124 = (X509_EXTENSION *)&DAT_0000009b;
