...

{
  ...
  iVar8 = param_2 + 4;
  iVar4 = (*(code *)PTR_BN_GF2m_add_006a96a8)(iVar3,iVar8,param_1 + 0x1d);
  if ((iVar4 == 0) || (iVar4 = (*pcVar6)(param_1,iVar3,iVar3,iVar8,param_3), iVar4 == 0)) {
LAB_005f2fbc:
    uVar5 = 0xffffffff;
  }
  else {
    iVar4 = (*(code *)PTR_BN_GF2m_add_006a96a8)(iVar3,iVar3,param_2 + 0x18);
    if (((iVar4 == 0) ||
        (((iVar4 = (*pcVar6)(param_1,iVar3,iVar3,iVar8,param_3), iVar4 == 0 ||
          (iVar4 = (*(code *)PTR_BN_GF2m_add_006a96a8)(iVar3,iVar3,param_1 + 0x22), iVar4 == 0)) ||
         (iVar4 = (*pcVar7)(param_1,uVar2,param_2 + 0x18,param_3), iVar4 == 0)))) ||
       (iVar4 = (*(code *)PTR_BN_GF2m_add_006a96a8)(iVar3,iVar3,uVar2), iVar4 == 0))
    goto LAB_005f2fbc;
