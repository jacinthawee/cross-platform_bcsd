...

{
  ...
  local_2c = DAT_00673460;
  local_28 = DAT_00673464;
  local_4c = param_1;
  local_3c = (*(code *)PTR_RSA_size_006a7640)(param_4);
  puVar2 = (undefined4 *)(**(code **)(local_60 + -0x58ac))(param_4,hndidx);
  local_6c = puVar2 + 1;
  local_38 = *puVar2;
  puVar6 = auStack_34;
  puVar2 = &local_48;
  ...
  uStack_c4 = DAT_00673460;
  uStack_c0 = DAT_00673464;
  uStack_a8 = param_4;
  uStack_a4 = param_2;
  uStack_a0 = param_3;
  uStack_d4 = (*(code *)PTR_RSA_size_006a7640)(puVar6);
  puVar3 = (undefined4 *)(*(code *)PTR_RSA_get_ex_data_006a9534)(puVar6,hndidx);
  uStack_d0 = *puVar3;
  ...
  if (iStack_b4 != *(int *)puVar1) {
    ...
    if (dso == 0) {
      ...
      (*(code *)PTR_ERR_put_error_006a7f34)(CCA4758_lib_error_code,0x65,0x6a,"e_4758cca.c",0x15b);
      return 0;
    }
    iVar5 = (*(code *)PTR_DSO_free_006a8874)();
    if (iVar5 == 0) {
      if (CCA4758_lib_error_code == 0) {
        CCA4758_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006a9538)();
      }
      (*(code *)PTR_ERR_put_error_006a7f34)(CCA4758_lib_error_code,0x65,0x6c,"e_4758cca.c",0x15f);
      return 0;
    }
    dso = 0;
    keyRecordRead = 0;
