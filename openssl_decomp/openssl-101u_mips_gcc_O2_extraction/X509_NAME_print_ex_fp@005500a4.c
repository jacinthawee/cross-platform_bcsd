...

{
  ...
  local_a0 = (ASN1_TYPE **)PTR___stack_chk_guard_006a9ae8;
  local_e0 = &_gp;
  local_2c = *(ASN1_TYPE **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (flags == 0) {
    _Var10.ptr = (char *)0x0;
    fp = (FILE *)(*(code *)PTR_BIO_new_fp_006a7248)();
    unaff_s2 = nm;
    if (fp == (FILE *)0x0) goto LAB_00550310;
    _Var10 = (_union_257)nm;
    ...
    if (indent < 0) {
      ...
      if ((indent != 0) && (unaff_s3 = "-check_ss_sig", fp != (FILE *)0x0)) {
        unaff_s2 = (X509_NAME *)0x0;
        unaff_s3 = (char *)&DAT_0063eb84;
        do {
          puVar11 = (undefined *)0x1;
          _Var10.boolean = 1;
          iVar14 = (**(code **)(local_e0 + -0x536c))(&DAT_0063eb84,1,1,fp);
          if (iVar14 != 1) goto LAB_00550310;
...
LAB_00550310:
        ...
        if (uVar9 != 0x40000) goto LAB_00550310;
        local_a4 = (undefined *)0x1;
        local_90 = (undefined *)0x3;
        local_94 = 3;
        local_98 = 1;
    ...
    if ((int)(flags << 8) < 0) {
      ...
      local_b4 = 3;
      local_ac = &DAT_006695c4;
    }
    else {
      local_b0 = (undefined *)0x1;
      local_b4 = 1;
      local_ac = &DAT_0066935c;
    }
    local_cc = flags & 0x600000;
    iVar14 = (**(code **)(local_e0 + -0x7e70))(local_c8);
    puStack_118 = puVar6;
    if (0 < iVar14) {
      unaff_s6 = iVar14 + -1;
      local_d4 = 0;
      ...
      unaff_s8 = auStack_7c;
      local_84 = "";
      unaff_s2 = (X509_NAME *)&DAT_0063eb84;
      ...
      do {
        if (local_c0 == 0) {
          unaff_s3 = (char *)(**(code **)(local_e0 + -0x7cc0))(local_c8,local_d4);
          if (unaff_s7 == -1) goto LAB_005503fc;
LAB_00550294:
          unaff_s5 = local_90;
          puVar8 = local_a4;
          iStack_fc = *(int *)((int)unaff_s3 + 8);
          indent = (int)puVar6;
          if (iStack_fc == unaff_s7) {
            _Var10.boolean = 1;
            if (fp != (FILE *)0x0) {
              puVar11 = local_90;
              puVar8 = (undefined *)(**(code **)(local_e0 + -0x536c))(local_8c,1,local_90,fp);
              if (unaff_s5 != puVar8) goto LAB_00550310;
              iStack_fc = *(int *)((int)unaff_s3 + 8);
            }
            ...
            if (fp == (FILE *)0x0) {
              ...
              puVar11 = local_a4;
              puVar7 = (undefined *)(**(code **)(local_e0 + -0x536c))(local_a8,1,local_a4,fp);
              unaff_s5 = puVar8;
              if (puVar7 != puVar8) goto LAB_00550310;
          ...
          unaff_s3 = (char *)(**(code **)(local_e0 + -0x7cc0))(local_c8,unaff_s6);
          if (unaff_s7 != -1) goto LAB_00550294;
LAB_005503fc:
          iStack_fc = *(int *)((int)unaff_s3 + 8);
        }
        unaff_s5 = (undefined *)(**(code **)(local_e0 + -0x7cb8))(unaff_s3);
        local_d0 = (undefined *)(**(code **)(local_e0 + -0x7cbc))(unaff_s3);
        unaff_s3 = (char *)(**(code **)(local_e0 + -0x7cb4))(unaff_s5);
        puVar11 = local_9c;
        unaff_s7 = iStack_fc;
        if (local_cc != 0x600000) {
          indent = (int)puVar6;
          unaff_s8 = puVar11;
          if ((local_cc == 0x400000) || ((undefined4 *)unaff_s3 == (undefined4 *)0x0)) {
            (**(code **)(local_e0 + -0x6144))(local_9c,0x50,unaff_s5,1);
            unaff_s5 = (undefined *)0x0;
            local_c4 = (undefined *)(**(code **)(local_e0 + -0x53bc))(puVar11);
LAB_00550588:
            if (fp == (FILE *)0x0) {
              if ((int)local_c4 < (int)unaff_s5) {
                unaff_s5 = unaff_s5 + -(int)local_c4;
                if (local_88 != 0) goto LAB_005505c8;
                unaff_s5 = unaff_s5 + (int)local_c4;
              }
            }
            else {
              ...
              puVar11 = local_c4;
              local_b8 = local_c4;
              puVar8 = (undefined *)(**(code **)(local_e0 + -0x536c))(unaff_s8,1,local_c4,fp);
              if (puVar8 != local_b8) goto LAB_00550310;
...
LAB_005505c8:
                if ((0 < (int)unaff_s5) && (unaff_s8 = (undefined *)0x0, fp != (FILE *)0x0)) {
                  pcVar24 = *(code **)(local_e0 + -0x536c);
                  do {
                    puVar11 = (undefined *)0x1;
                    _Var10.boolean = 1;
                    iVar14 = (*pcVar24)(&DAT_0063eb84,1,1,fp);
                    if (iVar14 != 1) goto LAB_00550310;
                    unaff_s8 = unaff_s8 + 1;
                    pcVar24 = *(code **)(local_e0 + -0x536c);
                ...
                if (fp == (FILE *)0x0) goto LAB_005504f8;
              }
LAB_005504d0:
              unaff_s5 = local_b0;
              _Var10.boolean = 1;
              puVar11 = local_b0;
              puVar8 = (undefined *)(**(code **)(local_e0 + -0x536c))(local_ac,1,local_b0,fp);
              indent = (int)puVar6;
              if (unaff_s5 != puVar8) goto LAB_00550310;
            }
          }
            ...
            if (local_cc == 0) {
              ...
              local_c4 = (undefined *)(**(code **)(local_e0 + -0x53bc))(unaff_s8);
              goto LAB_00550588;
            }
            ...
            if (fp != (FILE *)0x0) {
              ...
              _Var10.boolean = 1;
              iVar14 = (**(code **)(local_e0 + -0x536c))(local_84,1,0,fp);
              if (iVar14 == 0) {
...
LAB_00550314:
  ...
  puStack_10c = (undefined4 *)unaff_s3;
  ...
  if (((uint)puVar11 & 0x40) == 0) {
    ...
    iVar5 = (*(code *)PTR_strlen_006a9a24)(pcVar2);
    if ((a != (ASN1_TYPE *)0x0) &&
       ((iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,pcVar2,iVar5), iVar5 != iVar3 ||
        (iVar3 = (*(code *)PTR_BIO_write_006a6e14)(a,":",1), iVar3 != 1)))) goto LAB_0054d710;
    uStack_164 = iVar5 + 1;
  }
...
LAB_0054d6e8:
    if (a == (ASN1_TYPE *)0x0) {
      ...
      if (((uint)puVar11 & 0x200) != 0) {
        ...
        _Var10.ptr = (char *)(*(code *)PTR_CRYPTO_malloc_006a7008)(iVar14,"a_strex.c",0x13d);
      ...
      iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_006695a8,1);
      if (iVar14 != 1) goto LAB_0054d710;
      if (((uint)puVar11 & 0x200) != 0) goto LAB_0054e604;
      ...
      if ((X509_NAME *)_Var10.ptr != pXVar19) {
        do {
          ...
          iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&cStack_128,2);
          if (iVar14 != 2) goto LAB_0054d710;
  ...
  if (((uint)puVar11 & 0x20) == 0) {
    if ((0x1d < iVar14 - 1U) || (uVar15 = (uint)(char)tag2nbyte[iVar14], uVar15 == 0xffffffff)) {
      if (((uint)puVar11 & 0x100) != 0) goto LAB_0054d6e8;
      goto LAB_0054d824;
    }
  ...
  if (pBVar17 == pBVar21) {
    ...
    do {
      ...
      if (uVar23 == 1) {
        ...
        if ((uVar23 != 0) ||
           (iVar14 = (*(code *)PTR_UTF8_getc_006a8ccc)(pBVar18,psVar16,&AStack_138), iVar14 < 0))
        goto LAB_0054d710;
      ...
      if ((uVar15 & 8) == 0) {
        ...
        if (iVar14 < 0) goto LAB_0054d710;
        iStack_168 = iStack_168 + iVar14;
      }
      else {
        iVar14 = (*(code *)PTR_UTF8_putc_006a8cc8)(abStack_130,6,AStack_138.type);
        if (0 < iVar14) {
          uVar12 = uVar9 | uVar12;
          ...
          if (uVar9 == 0) {
            ...
            if (((char)abStack_130[0] < '\0') ||
              ...
              if ((uVar4 & 6) == 0) {
                ...
                (*(code *)PTR_BIO_snprintf_006a6f60)(&cStack_128,0xb,"\\%02X");
                iVar5 = 3;
              }
            }
            else if ((uVar4 & 8) == 0) {
...
LAB_0054e198:
              ...
              if ((uVar13 & 0x61) == 0) goto LAB_0054e198;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e17c:
              ...
              if ((uVar13 & 0x61) == 0) goto LAB_0054e17c;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e1b4:
              ...
              if ((uVar13 & 0x61) == 0) goto LAB_0054e1b4;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e160:
              ...
              if ((uVar13 & 0x61) == 0) goto LAB_0054e160;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e1d8:
              ...
              if ((uVar12 & 0x61) == 0) goto LAB_0054e144;
LAB_0054dad0:
              if ((uVar12 & 8) == 0) {
...
LAB_0054e120:
              ...
              if ((uVar4 & 0x61) == 0) goto LAB_0054e120;
              if ((uVar4 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e320:
              ...
              uVar13 = uVar12 & (byte)char_type[abStack_130[1]];
              if ((uVar13 & 0x61) == 0) goto LAB_0054e320;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e2fc:
              ...
              uVar13 = uVar12 & (byte)char_type[abStack_130[2]];
              if ((uVar13 & 0x61) == 0) goto LAB_0054e2fc;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e2d8:
              ...
              uVar13 = uVar12 & (byte)char_type[abStack_130[3]];
              if ((uVar13 & 0x61) == 0) goto LAB_0054e2d8;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
...
LAB_0054e2b4:
              ...
              uVar13 = uVar12 & (byte)char_type[bStack_12c];
              if ((uVar13 & 0x61) == 0) goto LAB_0054e2b4;
              if ((uVar13 & 8) == 0) {
                iVar5 = 2;
              }
              else {
            ...
            if (iVar14 != 5) {
              if ((char)bStack_12b < '\0') {
                ...
                uVar12 = uVar12 & (byte)char_type[bStack_12b];
                if ((uVar12 & 0x61) != 0) goto LAB_0054dad0;
              }
              iVar14 = 1;
              if ((uVar12 & 6) != 0) goto LAB_0054e1d8;
              if (bStack_12b == 0x5c) {
                iVar14 = 2;
              }
              iStack_168 = iStack_168 + iVar14;
...
LAB_0054dae8:
  ...
  if (cStack_13d == '\0') {
    ...
    iVar14 = iStack_168;
    if (a == (ASN1_TYPE *)0x0) goto LAB_0054d718;
    iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_00679c10,1);
    if (iVar14 != 1) goto LAB_0054d710;
  }
  psVar16 = (stack_st_X509_NAME_ENTRY *)(_Var10.object)->sn;
    ...
    do {
      while( true ) {
        ...
        if ((X509_NAME *)_Var10.ptr == (X509_NAME *)0x1) {
          ...
          iVar14 = -1;
          if ((X509_NAME *)_Var10.ptr != (X509_NAME *)&SUB_00000004) goto LAB_0054d718;
          AStack_138.type =
               (uint)*(byte *)((int)&pBVar18->length + 3) |
               (uint)*(byte *)((int)&pBVar18->length + 2) << 8 |
               (uint)*(byte *)((int)&pBVar18->length + 1) << 0x10 |
        ...
        if (iVar14 < 0) goto LAB_0054d710;
        if (pBVar17 == pBVar18) goto LAB_0054dccc;
      }
      pbVar25 = abStack_130;
      iVar14 = (*(code *)PTR_UTF8_putc_006a8cc8)(pbVar25,6,AStack_138.type);
      if (0 < iVar14) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar23 & 8) == 0) {
              iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_00669598,1);
              if (iVar14 != 1) goto LAB_0054d710;
              iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&_Stack_13c,1);
            }
            else {
LAB_0054dc98:
              iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&_Stack_13c,1);
...
joined_r0x0054deb8:
            pbVar25 = pbVar25 + 1;
            if (pbVar20 == pbVar25) goto LAB_0054dcc0;
          }
          uVar23 = (uint)puVar11 & 4;
LAB_0054dd08:
          if ((uVar23 & 6) == 0) {
            if ((bVar1 != 0x5c) || (uVar9 == 0)) goto LAB_0054dc98;
            iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_006695a4,2);
            if (iVar14 == 2) goto joined_r0x0054deb8;
            goto LAB_0054d710;
          }
          (*(code *)PTR_BIO_snprintf_006a6f60)(&cStack_128,0xb,"\\%02X");
          iVar14 = (*(code *)PTR_BIO_write_006a6e14)(a,&cStack_128,3);
          if (iVar14 != 3) goto LAB_0054d710;
          pbVar25 = pbVar25 + 1;
...
LAB_0054dccc:
  iVar14 = iStack_168;
  if (cStack_13d == '\0') goto LAB_0054d718;
  iVar5 = (*(code *)PTR_BIO_write_006a6e14)(a,&DAT_00679c10,1);
  if (iVar5 == 1) goto LAB_0054d718;
LAB_0054d710:
  do {
    iVar14 = -1;
LAB_0054d718:
...
LAB_0054e604:
      ...
      if ((X509_NAME *)(_Var10.ptr + iVar14) != (X509_NAME *)_Var10.ptr) {
        ...
        do {
          ...
          iVar5 = (*(code *)PTR_BIO_write_006a6e14)(a,&cStack_128,2);
          if (iVar5 != 2) {
            (*(code *)PTR_CRYPTO_free_006a6e88)(_Var10.ptr);
            goto LAB_0054d710;
          }
