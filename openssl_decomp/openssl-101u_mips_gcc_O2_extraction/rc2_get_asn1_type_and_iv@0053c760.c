...

{
  ...
  if ((char *)0x10 < pcStack_6c) {
    (*(code *)PTR_OpenSSLDie_006a7c5c)("e_rc2.c",0xb3,"l <= sizeof(iv)");
  }
  piVar5 = &local_38;
  param_3 = auStack_34;
  param_4 = pcStack_6c;
  pcVar2 = (char *)(*(code *)PTR_ASN1_TYPE_get_int_octetstring_006a8a88)(param_2,piVar5,auStack_34);
  unaff_s2 = param_2;
  unaff_s3 = param_1;
...
LAB_0053c868:
  ...
  if (param_2 == (int *)0x0) {
    ...
    param_3 = ctx->oiv;
    pcVar2 = (char *)(*(code *)PTR_ASN1_TYPE_set_int_octetstring_006a8a90)(param_2,piVar5,param_3);
    param_2 = piVar5;
  }
