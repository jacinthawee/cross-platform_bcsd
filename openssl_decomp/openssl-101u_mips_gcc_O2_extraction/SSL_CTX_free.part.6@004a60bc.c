...

{
  ...
  if (param_1->cert_store != (x509_store_st *)0x0) {
    (*(code *)PTR_X509_STORE_free_006a7274)();
  }
  ...
  if (param_1->client_CA != (stack_st_X509_NAME *)0x0) {
    (*(code *)PTR_sk_pop_free_006a7058)(param_1->client_CA,PTR_X509_NAME_free_006a6ff8);
  }
  if (param_1->extra_certs != (stack_st_X509 *)0x0) {
    (*(code *)PTR_sk_pop_free_006a7058)(param_1->extra_certs,PTR_X509_free_006a6e90);
  }
