...

{
  ...
  local_1ec = (code **)PTR___stack_chk_guard_006a9ae8;
  local_230 = &_gp;
  ...
  if ((int)local_204 < 1) {
    ...
    do {
      ...
      BIO_snprintf(unaff_s8,0x14,(char *)(local_200 + 0x7810),unaff_s2);
      ...
      if (iStack_264 < 1) {
        ...
        do {
          while (pbVar8 = pbVar5, (int)pbStack_26c <= iVar10 + unaff_s2) {
            ...
            pbVar5 = pbVar8 + 1;
            if (iVar10 == iStack_264) goto LAB_00526950;
          }
...
LAB_00526950:
      ...
      pbVar8 = (byte *)(**(code **)(local_230 + -0x53bc))(unaff_s7);
      param_3 = (byte *)0x1;
      param_4 = local_20c;
      iVar10 = (**(code **)(local_230 + -0x536c))(unaff_s7);
  ...
  if (local_1f0 != (byte *)0x0) {
    ...
    pbVar8 = (byte *)(**(code **)(local_230 + -0x53bc))(pbStack_270);
    param_3 = (byte *)0x1;
    param_4 = local_20c;
    iVar10 = (**(code **)(local_230 + -0x536c))(pbStack_270);
    local_218 = local_218 + iVar10;
  }
      ...
      if (iVar10 < 1) {
        ...
        do {
          while ((int)param_4 <= (int)(pbVar14 + iVar11)) {
            ...
            pbVar5 = pbVar5 + 1;
            BUF_strlcat(acStack_398,"   ",0x121);
            if (iVar11 == iVar10) goto LAB_00526df4;
          }
...
LAB_00526df4:
      ...
      pbVar12 = (byte *)(*(code *)PTR_strlen_006a9a24)(acStack_398);
      pbVar5 = pbVar8;
