...

{
  ...
  iVar1 = (*(code *)PTR_EVP_MD_CTX_copy_006a8200)(&dctx->i_ctx,&sctx->i_ctx);
  if ((iVar1 != 0) &&
     (iVar1 = (*(code *)PTR_EVP_MD_CTX_copy_006a8200)(&dctx->o_ctx,&sctx->o_ctx), iVar1 != 0)) {
    iVar1 = (*(code *)PTR_EVP_MD_CTX_copy_006a8200)(&dctx->md_ctx,&sctx->md_ctx);
    puVar3 = sctx->key;
    if (iVar1 != 0) {
      puVar2 = dctx->key;
      do {
