...
int BIO_dump_indent_cb_constprop_1(BIO *param_1,byte ***param_2,byte ***param_3,byte ***param_4)

{
  ...
  local_1ec = (byte **)PTR___stack_chk_guard_006a9ae8;
  local_230 = &_gp;
  ...
  if ((int)param_4 < 1) {
    ...
    local_1d4[0]._0_1_ = 0;
    local_204 = (byte ***)
                ((int)pppbVar7 / 0x10 + (uint)(((int)pppbVar7 / 0x10) * 0x10 < (int)pppbVar7));
  }
  else {
    ...
    param_3 = pppbVar12;
    (*(code *)PTR___memset_chk_006a998c)(local_1d4);
    ...
    *(byte *)((int)local_1d4 + (int)pppbVar12) = 0;
    local_204 = (byte ***)
  ...
  if ((int)local_204 < 1) {
    ...
    local_1fc = "-check_ss_sig";
    local_208 = "-check_ss_sig";
    local_224 = "%02x%c";
    local_21c = "   ";
    local_1f4 = "encrypt";
    local_220 = local_210;
    ...
    do {
      ...
      param_4 = unaff_s2;
      BIO_snprintf(unaff_s8,0x14,(char *)(local_200 + 0x7810));
      BUF_strlcat((char *)unaff_s7,unaff_s8,0x121);
      if (iStack_264 < 1) {
        BUF_strlcat((char *)unaff_s7,local_208 + -0x4da8,0x121);
      }
      else {
        iVar9 = 0;
        pppbVar12 = local_220;
        do {
          while (pppbVar10 = pppbVar12, (int)((int)unaff_s2 + iVar9) < (int)pppbVar7) {
            ...
            iVar9 = iVar9 + 1;
            BIO_snprintf(unaff_s8,0x14,local_224);
            BUF_strlcat((char *)unaff_s7,unaff_s8,0x121);
...
LAB_005264bc:
        ...
        if ((int)unaff_s2 < (int)pppbVar7) {
          unaff_s5 = 0x2e;
          unaff_s6 = (byte ***)((int)local_210 + (int)pppbVar7);
          pppbVar10 = (byte ***)((int)local_210 + (int)((int)unaff_s2 + iStack_264 + -1));
          unaff_s4 = (byte *)(local_1f4 + -0x6680);
          pppbVar12 = local_220;
          do {
      ...
      BUF_strlcat((char *)unaff_s7,local_1fc + -0x4d1c,0x121);
      pppbStack_270 = (byte ***)((int)local_214 + 1);
      local_220 = (byte ***)((int)local_220 + iStack_264);
      local_214 = pppbStack_270;
      param_3 = (byte ***)(**(code **)(local_230 + -0x53bc))(unaff_s7);
      pppbStack_458 = unaff_s7;
      iVar9 = BIO_write(local_20c,unaff_s7,(int)param_3);
      local_218 = local_218 + iVar9;
    } while (pppbStack_270 != local_204);
  }
  pbStack_26c = (byte *)((int)local_1f0 + (int)pppbVar7);
  if (local_1f0 != (byte ***)0x0) {
    ...
    param_3 = (byte ***)(**(code **)(local_230 + -0x53bc))(pppbStack_270);
    pppbStack_458 = pppbStack_270;
    iVar9 = BIO_write(local_20c,pppbStack_270,(int)param_3);
    local_218 = local_218 + iVar9;
  }
  if (local_2c == (byte ***)*local_1ec) {
    return local_218;
  }
  pcStack_24c = BIO_dump_indent_cb_constprop_0;
  pppbStack_454 = local_2c;
  (**(code **)(local_230 + -0x5330))();
