...

{
  ...
  if (uVar3 == 0) {
      ...
      if (X509_NAME_ENTRY_it._8_4_ == (uint *)0x0) {
        ...
        if ((*X509_NAME_ENTRY_it._8_4_ & 6) == 0) {
          ...
          for (; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(a), iVar8 < iVar4; iVar8 = iVar8 + 1) {
            pAStack_30 = (ASN1_STRING *)(*(code *)PTR_sk_value_006a6e24)(a,iVar8);
    ...
    puVar7 = (undefined1 *)X509_NAME_ENTRY_it._16_4_;
    if (a == (X509_NAME_ENTRY *)0x0) goto switchD_0055c4c0_caseD_0;
    if (X509_NAME_ENTRY_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
...
switchD_0055c4c0_caseD_0:
  ...
  (*(code *)PTR_memcmp_006a9ad0)(pXVar6->object,*(undefined4 *)puVar7,pAVar5,in_a3,&_gp);
  return;
}
