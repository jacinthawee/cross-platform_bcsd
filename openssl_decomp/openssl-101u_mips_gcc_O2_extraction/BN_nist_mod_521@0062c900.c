...

{
  ...
  if (uVar8 == 0) {
    iVar11 = a->top;
    puVar10 = a->d;
    iVar4 = (*(code *)PTR_BN_ucmp_006a7fb4)(a,_bignum_nist_p_521_sqr_6243);
    if (iVar4 < 0) {
      iVar4 = (*(code *)PTR_BN_ucmp_006a7fb4)(_bignum_nist_p_521,a);
      if (iVar4 == 0) {
        uVar8 = 1;
      ...
      if (0 < iVar4) {
        if (a == r) {
          ...
          iVar4 = (*(code *)PTR_BN_copy_006a8450)(r,a);
          uVar8 = (uint)(iVar4 != 0);
        }
        goto LAB_0062c9a0;
      }
      ...
      if (a != r) {
        if (r->dmax < 0x11) {
          iVar4 = (*(code *)PTR_bn_expand2_006a8524)(r,0x11);
...
LAB_0062cb08:
        ...
        (*(code *)PTR_memset_006a99f4)(local_70 + iVar11,0,iVar4);
      }
      else {
        puVar6 = local_70;
        do {
      ...
      iVar4 = (*(code *)PTR_bn_sub_words_006a8580)(local_70,puVar7,_nist_p_521,0x11);
                            ...
                            if (puVar10[5] == 0) {
                              if (puVar10[4] == 0) {
                                if (puVar10[3] == 0) {
                                  uVar8 = 1;
                                  if (puVar10[2] == 0) {
                                    if (puVar10[1] != 0) goto LAB_0062cfd4;
  ...
  uVar8 = (*(code *)PTR_BN_nnmod_006a8548)(r,a,_bignum_nist_p_521);
LAB_0062c9a0:
  while( true ) {
