...

{
  ...
  *param_2 = local_54;
  ...
  while( true ) {
    ...
    *(undefined4 *)(puVar22 + -0x24) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8;
    puVar8 = puVar6;
    puVar10 = puVar9;
    puVar4 = (uint *)(*(code *)PTR_DH_new_006a751c)();
    ...
    if (puVar4 == (uint *)0x0) {
      ...
      (**(code **)(puVar19 + -0x53ec))(param_2,0,0x80);
      puVar13 = puVar22 + -0xa4;
      uVar3 = (**(code **)(*(int *)(puVar22 + -0x1a0) + -0x6bc8))(*(undefined4 *)(puVar6[5] + 0x14))
      ;
      iVar20 = *(int *)(puVar22 + -0x1a0);
      puVar4[3] = uVar3;
      uVar3 = (**(code **)(iVar20 + -0x6bc8))(*(undefined4 *)(puVar6[5] + 0xc));
      pcVar18 = *(code **)(*(int *)(puVar22 + -0x1a0) + -0x6bc8);
      puVar4[2] = uVar3;
      uVar3 = (*pcVar18)(uVar7);
      pcVar18 = *(code **)(*(int *)(puVar22 + -0x1a0) + -0x5808);
      puVar4[6] = uVar3;
      iVar5 = (*pcVar18)(puVar6);
      puVar8 = *(uint **)(iVar5 + 0x18);
      puVar10 = puVar4;
      puVar16 = (uint *)(**(code **)(*(int *)(puVar22 + -0x1a0) + -0x6e3c))(puVar13);
      param_1 = puVar4;
      if (puVar16 == (uint *)0x0) {
        (**(code **)(*(int *)(puVar22 + -0x1a0) + -0x78d8))(puVar4);
        uVar3 = 0;
        puVar19 = *(undefined **)(puVar22 + -0x1a0);
      }
      else {
        (**(code **)(*(int *)(puVar22 + -0x1a0) + -0x53ec))(param_2,0,0x80);
        ...
        (**(code **)(iVar21 + -0x78d8))(puVar4);
        init_gost_hash_ctx(puVar13,*(undefined4 *)(*(int *)(puVar22 + -0x1a0) + -0x5814));
        start_hash(puVar13);
    ...
    *(undefined **)(puVar22 + -0x1c8) = &_gp;
    puVar6 = (uint *)(*(code *)PTR_EVP_PKEY_CTX_get0_peerkey_006a9824)();
    uVar23 = (**(code **)(*(int *)(puVar22 + -0x1c8) + -0x580c))(iVar5);
    *puVar10 = 0x20;
    if (puVar8 == (uint *)0x0) {
      return 1;
    }
