...
void print_leak_doall_arg(CRYPTO_THREADID *param_1,CRYPTO_THREADID *param_2)

{
  ...
  do {
    ...
    *(undefined **)((int)register0x00000074 + -0x43c) = PTR___stack_chk_guard_006a9ae8;
    ...
    *(undefined **)((int)register0x00000074 + -0x450) = &_gp;
    pCVar4 = *(CRYPTO_THREADID **)PTR___stack_chk_guard_006a9ae8;
    pvVar1 = param_2->ptr;
    *(CRYPTO_THREADID **)((int)register0x00000074 + -0x2c) = pCVar4;
    ...
    if (pvVar3 != pvVar1) {
      if ((options & 1) == 0) {
        ...
        puVar9 = (undefined *)((int)register0x00000074 + -0x42c);
        puVar2 = (undefined4 *)(*(code *)PTR_localtime_006a9a34)(&param_1[3].val);
        uVar8 = puVar2[2];
        ...
        *(undefined4 *)((int)register0x00000074 + -0x458) = puVar2[1];
        ...
        iVar5 = (**(code **)(*(int *)((int)register0x00000074 + -0x450) + -0x53bc))(puVar9);
      ...
      *(void **)((int)register0x00000074 + -0x458) = pvVar1;
      ...
      if ((options & 2) != 0) {
        ...
        iVar5 = (**(code **)(*(int *)((int)register0x00000074 + -0x450) + -0x53bc))(unaff_s2);
        puVar12 = *(undefined **)((int)register0x00000074 + -0x450);
      ...
      *(void **)((int)register0x00000074 + -0x458) = param_1->ptr;
      ...
      if (unaff_s0 != (CRYPTO_THREADID *)0x0) {
        *(CRYPTO_THREADID **)((int)register0x00000074 + -0x440) =
        ...
        do {
          unaff_s2 = unaff_s2 + 1;
          (**(code **)(puVar11 + -0x5454))(unaff_s1,0x3e,unaff_s2,0x400);
          unaff_s8 = 0x400;
          ...
          *(void **)((int)register0x00000074 + -0x458) = unaff_s0[1].ptr;
          ...
          unaff_s6 = (**(code **)(*(int *)((int)register0x00000074 + -0x450) + -0x53bc))(unaff_s1);
          pvVar1 = unaff_s0[2].ptr;
          pcVar10 = *(code **)(*(int *)((int)register0x00000074 + -0x450) + -0x53bc);
          *(void **)((int)register0x00000074 + -0x444) = pvVar1;
          iVar5 = (*pcVar10)(pvVar1);
          if (0x7d - unaff_s6 < iVar5) {
            (**(code **)(*(int *)((int)register0x00000074 + -0x450) + -0x52f4))
            ...
            iVar5 = (**(code **)(*(int *)((int)register0x00000074 + -0x450) + -0x53bc))(unaff_s1);
            puVar13 = *(undefined **)((int)register0x00000074 + -0x450);
            iVar6 = 0x400 - iVar5;
          }
