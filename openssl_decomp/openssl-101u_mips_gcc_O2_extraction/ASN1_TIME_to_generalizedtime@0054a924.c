  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 == 0x18) {
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = t->length + 3;
        if (*t->data < 0x35) {
          (*(code *)PTR_BUF_strlcpy_006a6f64)(puVar2,&DAT_00669550,iVar1);
        }
        else {
          (*(code *)PTR_BUF_strlcpy_006a6f64)(puVar2,&DAT_0066954c);
        }
        (*(code *)PTR_BUF_strlcat_006a6f68)(puVar2,t->data,iVar1);
        return str;
      }
    }
  }
