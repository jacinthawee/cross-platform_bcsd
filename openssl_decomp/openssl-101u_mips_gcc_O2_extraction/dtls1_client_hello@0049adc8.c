...

{
  ...
  if (psVar23->client_random[0] == '\0') {
    ...
    do {
      ...
      iVar22 = iVar22 + 1;
      if (*puVar24 != '\0') {
        if (iVar22 != 0x20) goto LAB_0049aeb8;
        break;
      }
    } while (iVar22 != 0x20);
    param_4 = 0x20;
  ...
  *(undefined4 *)(pcVar32 + 0x2a) = uVar20;
  if (param_1->new_session == 0) {
    ...
    if (uVar29 != 0) {
      ...
      (*(code *)PTR_memcpy_006a9aec)(pcVar33,param_1->session->session_id);
    }
  }
  else {
    ...
    if (iVar22 == 0) {
      ...
      *pcVar34 = (char)((uint)iVar22 >> 8);
      if (*(int *)(param_1->psk_server_callback + 0x98) == 0) {
        ...
        pcVar33 = pcVar34 + iVar22 + 3;
        iVar26 = (*(code *)PTR_sk_num_006a6e2c)();
      ...
      *pcVar33 = '\0';
      iVar22 = ssl_prepare_clienthello_tlsext(param_1);
      if (iVar22 < 1) {
        uVar28 = 0xe2;
        uVar20 = 0x37d;
      }
...
LAB_0049b1c8:
  (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0xf8,uVar28,"d1_clnt.c",uVar20);
  return 0xffffffff;
}
