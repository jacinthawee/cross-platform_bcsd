...

{
  ...
  if (param_3 != 0) {
    ...
    local_98 = param_1[4];
    do {
      uVar15 = (uint)param_2[1] << 8 | (uint)param_2[2] << 0x10 | (uint)*param_2 |
               (uint)param_2[3] << 0x18;
      uVar11 = (uint)param_2[0x15] << 8 | (uint)param_2[0x16] << 0x10 | (uint)param_2[0x14] |
               (uint)param_2[0x17] << 0x18;
      uVar5 = ((~uVar3 | local_9c) ^ uVar2) + iVar1 + 0x50a28be6 + uVar11;
      uVar4 = (uVar2 ^ local_9c ^ uVar3) + iVar1 + uVar15;
      uVar12 = (local_9c >> 0x16) + local_9c * 0x400;
      uVar36 = (uint)param_2[9] << 8 | (uint)param_2[10] << 0x10 | (uint)param_2[8] |
               (uint)param_2[0xb] << 0x18;
      uVar4 = (uVar4 >> 0x15) + uVar4 * 0x800 + local_98;
      uVar6 = (uVar5 >> 0x18) + uVar5 * 0x100 + local_98;
      uVar7 = (uint)param_2[5] << 8 | (uint)param_2[6] << 0x10 | (uint)param_2[4] |
              (uint)param_2[7] << 0x18;
      uVar13 = (uint)param_2[0x39] << 8 | (uint)param_2[0x3a] << 0x10 | (uint)param_2[0x38] |
               (uint)param_2[0x3b] << 0x18;
      uVar8 = (uVar12 ^ uVar2 ^ uVar4) + uVar7 + local_98;
      uVar10 = ((~uVar12 | uVar2) ^ uVar6) + local_98 + 0x50a28be6 + uVar13;
      uVar27 = (uVar2 >> 0x16) + uVar2 * 0x400;
      uVar21 = (uint)param_2[0x1d] << 8 | (uint)param_2[0x1e] << 0x10 | (uint)param_2[0x1c] |
      ...
      uVar18 = (uint)param_2[0xd] << 8 | (uint)param_2[0xe] << 0x10 | (uint)param_2[0xc] |
      ...
      uVar34 = (uint)param_2[0x11] << 8 | (uint)param_2[0x12] << 0x10 | (uint)param_2[0x10] |
               (uint)param_2[0x13] << 0x18;
      uVar16 = (uint)param_2[0x25] << 8 | (uint)param_2[0x26] << 0x10 | (uint)param_2[0x24] |
      ...
      uVar28 = (uint)param_2[0x2d] << 8 | (uint)param_2[0x2e] << 0x10 | (uint)param_2[0x2c] |
      ...
      uVar35 = (uint)param_2[0x19] << 8 | (uint)param_2[0x1a] << 0x10 | (uint)param_2[0x18] |
      ...
      uVar38 = (uint)param_2[0x35] << 8 | (uint)param_2[0x36] << 0x10 | (uint)param_2[0x34] |
               (uint)param_2[0x37] << 0x18;
      uVar39 = (uVar5 >> 0x16) + uVar5 * 0x400;
      uVar27 = (uVar4 >> 0x16) + uVar4 * 0x400;
      uVar4 = (uint)param_2[0x21] << 8 | (uint)param_2[0x22] << 0x10 | (uint)param_2[0x20] |
      ...
      uVar14 = (uint)param_2[0x3f] << 0x18 |
               (uint)param_2[0x3d] << 8 | (uint)param_2[0x3e] << 0x10 | (uint)param_2[0x3c];
      uVar25 = (uVar24 >> 0x16) + uVar24 * 0x400;
      uVar31 = (uint)param_2[0x29] << 8 | (uint)param_2[0x2a] << 0x10 | (uint)param_2[0x28] |
      ...
      uVar26 = (uint)param_2[0x31] << 8 | (uint)param_2[0x32] << 0x10 | (uint)param_2[0x30] |
      ...
      iVar9 = uVar5 + iVar1;
      iVar22 = uVar12 + local_9c;
      iVar1 = (uVar27 >> 0x16) + uVar27 * 0x400 + uVar2;
      local_9c = uVar4 + uVar3 + uVar14;
      uVar2 = (uVar11 >> 0x16) + uVar11 * 0x400 + iVar22;
      param_1[1] = uVar2;
      iVar1 = uVar10 + iVar1;
      uVar3 = (uVar7 >> 0x15) + uVar7 * 0x800 + uVar5 + uVar4 + local_98;
      local_98 = (uVar6 >> 0x1a) + uVar6 * 0x40 + iVar9 + uVar8;
      local_90 = local_90 + -1;
      param_1[2] = local_9c;
      param_1[3] = uVar3;
      param_1[4] = local_98;
