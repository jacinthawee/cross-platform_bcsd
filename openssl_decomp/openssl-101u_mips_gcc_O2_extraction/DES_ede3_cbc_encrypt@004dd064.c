...
DES_fcrypt:
  ...
  *(undefined **)(puVar33 + -0xc0) = &_gp;
  uVar23 = *puVar17;
  *(undefined4 *)(puVar33 + -0x1c) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8;
  ...
  (*(code *)PTR_memset_006a99f4)(puVar33 + iVar7 + -0x30,0,8 - iVar7);
LAB_004dd844:
  pDVar27 = (DES_key_schedule *)(puVar33 + -0xb0);
  DES_set_key_unchecked((const_DES_cblock *)(puVar33 + -0x30),pDVar27);
  (**(code **)(*(int *)(puVar33 + -0xc0) + -0x6914))(puVar33 + -0xb8,pDVar27,pDVar28,unaff_s4);
...
LAB_004ddb3c:
    ...
    iVar12 = iVar11;
    if ((uVar6 & bVar4) == 0) {
      if (uVar16 == 0) goto LAB_004dd92c;
LAB_004ddaf4:
      uVar8 = uVar8 << 1;
      uVar6 = uVar16 >> 1;
      if ((uVar16 & (byte)puVar24[-0x10]) != 0) goto LAB_004ddb14;
LAB_004dda14:
...
LAB_004ddab4:
    ...
    if (uVar16 != 0) {
      uVar19 = uVar19 << 1;
      uVar22 = uVar16 >> 1;
      if ((uVar16 & (byte)puVar24[-0x10]) == 0) goto LAB_004dda58;
      goto LAB_004ddad8;
    }
    uVar19 = uVar19 << 1;
