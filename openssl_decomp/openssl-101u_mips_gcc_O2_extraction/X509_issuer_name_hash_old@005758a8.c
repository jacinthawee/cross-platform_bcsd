...

{
  ...
  (*(code *)PTR_i2d_X509_NAME_006a76ec)(pXVar5,0);
  (*(code *)PTR_EVP_MD_CTX_init_006a6e1c)(auStack_3c);
  (*(code *)PTR_EVP_MD_CTX_set_flags_006a7504)(auStack_3c,8);
  uVar2 = (*(code *)PTR_EVP_md5_006a70c8)();
  iVar3 = (*(code *)PTR_EVP_DigestInit_ex_006a757c)(auStack_3c,uVar2,0);
  if (iVar3 != 0) {
    pBVar4 = pXVar5->bytes;
    iVar3 = (*(code *)PTR_EVP_DigestUpdate_006a7580)(auStack_3c,pBVar4->data,pBVar4->length);
    if (iVar3 != 0) {
      iVar3 = (*(code *)PTR_EVP_DigestFinal_ex_006a7584)(auStack_3c,local_24,0);
      if (iVar3 != 0) {
