...

{
  ...
  local_14 = *(DES_key_schedule **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (enc == 0) {
    (*(code *)PTR_DES_decrypt3_006a966c)(&local_1c);
  }
  else {
    (*(code *)PTR_DES_encrypt3_006a9670)(&local_1c,ks1,ks2);
  }
  ...
  if (iStack_20 == 0) {
    ...
    for (; pDStack_a8 != (DES_key_schedule *)0x0;
      ...
      if (uStack_b0 == 0) {
        uStack_68 = (uint)DAT_006aede7 << 0x18 |
                    (uint)DAT_006aede5 << 8 | (uint)DAT_006aede6 << 0x10 | (uint)DAT_006aede4;
        pDStack_100 = (DES_key_schedule *)
                      ((uint)DAT_006aede3 << 0x18 |
                      (uint)DAT_006aede1 << 8 | (uint)DAT_006aede2 << 0x10 | (uint)_gp);
        pDStack_6c = pDStack_100;
        (**(code **)((int)pDVar29 + -0x6918))(unaff_s8,ks3);
        pDStack_18c = (DES_key_schedule *)((uint)pDStack_6c >> 0x10);
        _gp = (byte)pDStack_6c;
        puVar11 = (uint *)(uStack_68 >> 8);
        DAT_006aede4 = (byte)uStack_68;
        DAT_006aede1 = (byte)((uint)pDStack_6c >> 8);
        DAT_006aede2 = (byte)((uint)pDStack_6c >> 0x10);
        DAT_006aede5 = (byte)(uStack_68 >> 8);
        DAT_006aede3 = (byte)((uint)pDStack_6c >> 0x18);
        DAT_006aede6 = (byte)(uStack_68 >> 0x10);
        DAT_006aede7 = (byte)(uStack_68 >> 0x18);
        pDVar29 = pDStack_78;
      }
    ...
    do {
      if (uStack_b0 == 0) {
        ...
        pDStack_100 = (DES_key_schedule *)
                      ...
                      (uint)DAT_006aede1 << 8 | (uint)DAT_006aede2 << 0x10 | (uint)_gp);
        pDStack_6c = pDStack_100;
        (*(code *)pDStack_78[-0xd3].ks[0xd].deslong[0])(unaff_s8,ks3,1);
        pDStack_18c = (DES_key_schedule *)((uint)pDStack_6c >> 0x10);
        _gp = (byte)pDStack_6c;
        puVar11 = (uint *)(uStack_68 >> 8);
        DAT_006aede4 = (byte)uStack_68;
  ...
  *puStack_24 = uStack_b0;
  ...
  uStack_8c = 0x5e33a8;
  (*(code *)pDVar29[-0xa7].ks[10].deslong[0])();
  pDStack_224 = pDStack_78;
  pDStack_188 = (DES_key_schedule *)PTR___stack_chk_guard_006a9ae8;
  pDVar29 = (DES_key_schedule *)&_gp;
  ...
  if (uStack_68 == 0) {
    ...
    for (; pDStack_c8 = pDVar17, pDStack_184 != (DES_key_schedule *)0x0;
      ...
      if (pDStack_108 == (DES_key_schedule *)0x0) {
        ...
        (**(code **)((int)pDVar29 + -0x5770))(pDStack_c8,pDStack_100,pDStack_224);
    ...
    do {
      ...
      if (pDStack_108 == (DES_key_schedule *)0x0) {
        ...
        uStack_bc = (uint)*(byte *)((int)puStack_70 + 3) << 0x18 |
                    (uint)*(byte *)((int)puStack_70 + 1) << 8 |
                    (uint)*(byte *)((int)puStack_70 + 2) << 0x10 | (uint)*(byte *)puStack_70;
        (*(code *)pDStack_d0[-0xaf].ks[2].deslong[0])(pDStack_c8,pDStack_100,pDStack_224,pDStack_74)
        ;
        pDVar15 = (DES_key_schedule *)(uStack_bc >> 0x10);
        *(byte *)puStack_70 = (byte)uStack_bc;
        pDStack_18c = (DES_key_schedule *)(uStack_b8 >> 8);
  ...
  piStack_144 = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if ((int)pDStack_18c < 0x41) {
    ...
    if (iStack_c0 == 0) {
      if (pDVar27 <= pDVar15) {
        ...
        ppDStack_14c = (DES_key_schedule **)(&PTR_LAB_00674c14 + (int)pDVar27);
        puStack_148 = &UNK_00674c5c + (int)pDVar27 * 4;
        ...
        do {
          ...
          pDStack_124 = pDVar14;
          pDStack_120 = pDVar29;
          (*(code *)puStack_168[-0x15dc])(ppDStack_150,pDStack_15c,uStack_158,pDStack_154);
          ...
          if (pDStack_d8 == (DES_key_schedule *)&DAT_00000020) {
            ...
            if (pDStack_d8 != (DES_key_schedule *)&DAT_00000040) {
              ...
              if (uStack_13c == 0) {
                ...
                (*(code *)puStack_168[-0x14bb])(puStack_138,iStack_140,8);
              }
              else {
                uStack_12c = 0;
                pDStack_130 = (DES_key_schedule *)0x0;
                (*(code *)puStack_168[-0x14bb])(puStack_138,iStack_140,9);
      ...
      pDStack_188 = (DES_key_schedule *)(&UNK_00674bf0 + (int)pDVar27 * 4);
      puStack_148 = &UNK_00674c38 + (int)pDVar27 * 4;
      ...
      do {
        ...
        pDStack_124 = pDVar28;
        pDStack_120 = pDVar29;
        (*(code *)puStack_168[-0x15dc])(ppDStack_14c,pDStack_15c,uStack_158);
  ...
  uStack_17c = 0x5e3ffc;
  (*(code *)puStack_168[-0x14cc])();
  puStack_1ec = puStack_168;
  piStack_1d0 = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if ((undefined *)((int)pDVar29[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_160 == 0) {
      ...
      if (pDStack_284 <= pDVar15) {
        ppcStack_1d4 = (code **)(&PTR_LAB_00674ca4 + (int)pDStack_284);
        ...
        pDStack_280 = (DES_key_schedule *)(&PTR_LAB_00674cc8 + (int)pDStack_284);
        ...
        do {
          ...
          pDStack_1bc = pDVar28;
          pDStack_1b8 = pDVar17;
          (*(code *)pDStack_1f8[-0xd3].ks[0xd].deslong[0])(pDVar27,puStack_1ec);
          if (pDStack_210 != (DES_key_schedule *)0x0) {
          ...
          if (pDStack_1dc != (DES_key_schedule *)&DAT_00000020) {
            if (pDStack_1dc == (DES_key_schedule *)&DAT_00000040) {
              ...
              if (pDStack_1e4 == (DES_key_schedule *)0x0) {
                ...
                pDStack_1e0 = pDVar8;
                (*(code *)*(DES_key_schedule **)((int)pDStack_1f8[-0xa6].ks + 0x14))
      ...
      pDStack_214 = (DES_key_schedule *)(&switchD_005e4168::switchdataD_00674c80 + (int)pDStack_284)
      ;
      pDStack_280 = (DES_key_schedule *)(&PTR_LAB_00674cec + (int)pDStack_284);
      ...
      while (pDVar8 = pDVar16, pDVar17 = pDVar28, pDStack_230 = pDStack_27c, pDStack_284 <= pDVar15)
      {
        ...
        pDStack_1bc = pDVar17;
        pDStack_1b8 = pDVar8;
        (*(code *)pDStack_1f8[-0xd3].ks[0xd].deslong[0])(pDStack_254,puStack_1ec);
        pDVar29 = pDStack_1dc;
        pDVar27 = pDStack_1e0;
...
LAB_005e45e4:
  ...
  (*(code *)pDStack_1f8[-0xa7].ks[10].deslong[0])();
  pDStack_290 = pDStack_1f8;
  pbVar30 = &_gp;
  piStack_24c = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  uVar25 = uVar7 >> 8;
  iStack_234 = *(int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (pDVar14 != (DES_key_schedule *)0x0) {
    ...
    do {
      if (uStack_298 == 0) {
        ...
        pDVar14 = pDStack_290;
        (**(code **)(pbVar30 + -0x5770))(puStack_70,pDStack_254,pDStack_290,uStack_1f4);
        uVar25 = uStack_244 >> 8;
  ...
  *puStack_250 = uStack_298;
  if (iStack_234 != iVar5) {
    ...
    iStack_29c = *(int *)PTR___stack_chk_guard_006a9ae8;
    ...
    if (pDVar14 != (DES_key_schedule *)0x0) {
      ...
      do {
        if (uVar7 == 0) {
          (*(code *)PTR_DES_encrypt1_006a84c8)(&uStack_2ac,uVar19,1);
          iVar5 = iVar5 + 1;
    ...
    *puStack_25c = uVar7;
    if (iStack_29c != iVar5) {
      ...
      do {
        ...
        uVar7 = *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar21 >> 0x1a) + 0x1c0) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar21 & 0xfc) + 0x100) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar7
        ;
        ...
        uVar19 = (uVar19 << 0x10 ^ uVar21) >> 4;
        uVar21 = uVar19 + uVar21 * 0x10000000;
        uVar22 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar21 >> 0x1a) + 0x1c0) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar21 & 0xfc) + 0x100) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 * 0x100 >> 0x1a) + 0x140) * 4);
        ...
        uVar21 = uVar7 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
        ...
        uVar20 = uVar22 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 ...
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x100 >> 0x1a) + 0x140) * 4);
        ...
        uVar7 = (uVar7 << 0x10 ^ uVar19) >> 4;
        uVar19 = uVar7 + uVar19 * 0x10000000;
        uVar19 = uVar21 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar21 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar21 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar20 = uVar19 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar20 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar7 = (uVar7 << 0x10 ^ uVar19) >> 4;
        uVar19 = uVar7 + uVar19 * 0x10000000;
        uVar21 = uVar21 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar7 = (uVar7 << 0x10 ^ uVar19) >> 4;
        uVar19 = uVar7 + uVar19 * 0x10000000;
        uVar20 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar22 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar7 = uVar21 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar25 >> 0x1a) + 0x180) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar25 & 0xfc)) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar24 << 0x10) >> 0x1a) + 0x80) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar25 << 8) >> 0x1a) + 0x100) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar22 >> 0x1a) + 0x1c0) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar22 & 0xfc) + 0x100) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x100 >> 0x1a) + 0x140) * 4);
      } while (iVar5 != 0);
