...
void ssl3_peek(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  *puVar1 = 0;
  if (((*(int *)(iVar4 + 0x194) != 0) && (*(int *)(iVar4 + 0xf8) == 0)) &&
     (*(int *)(iVar4 + 0x108) == 0)) {
    uVar3 = (*(code *)PTR_SSL_state_006a7808)(param_1);
    iVar4 = *(int *)(param_1 + 0x58);
    if ((uVar3 & 0x3000) == 0) {
  ...
  *(undefined4 *)(iVar4 + 0x1a0) = 1;
  iVar4 = (**(code **)(iVar2 + 0x34))(param_1,0x17,param_2,param_3,1);
  if (iVar4 == -1) {
    iVar4 = *(int *)(param_1 + 0x58);
    if (*(int *)(iVar4 + 0x1a0) == 2) {
      pcVar5 = *(code **)(*(int *)(param_1 + 8) + 0x34);
      *(int *)(param_1 + 0x1c) = *(int *)(param_1 + 0x1c) + 1;
      (*pcVar5)(param_1,0x17,param_2,param_3,1);
      *(int *)(param_1 + 0x1c) = *(int *)(param_1 + 0x1c) + -1;
      return;
    }
  }
