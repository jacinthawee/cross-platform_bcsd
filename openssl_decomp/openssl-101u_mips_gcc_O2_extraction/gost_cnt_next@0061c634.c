...
LAB_0061c7ac:
    ...
    if (*(int *)(param_1 + 4) == 0) goto LAB_0061c7ac;
LAB_0061c694:
    local_2c = *param_2;
    local_28 = param_2[1];
  }
              ...
              *(byte *)(puVar8 + 1) = *(byte *)(iVar3 + uVar5 + 0x30) ^ param_3[4];
              if (uVar7 == 8) {
                ...
                *(undefined4 *)(iVar3 + 0x50) = 0;
                ...
                if (uVar9 == 5) goto LAB_0061cb70;
                *(byte *)((int)puVar8 + 5) = *(byte *)(iVar3 + uVar7 + 0x30) ^ param_3[5];
                if (uVar4 == 1) {
                  if (uVar9 == 6) goto LAB_0061cbe0;
                  uVar5 = 7;
                  uVar4 = 0xf;
...
LAB_0061ca40:
    ...
    if (uVar9 <= uVar5) goto LAB_0061ca40;
    gost_cnt_next(*(undefined4 *)(iVar3 + 0x60),iVar3 + 0x20,iVar3 + 0x30);
    bVar1 = *param_3;
  }
