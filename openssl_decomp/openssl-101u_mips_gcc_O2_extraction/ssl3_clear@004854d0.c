...

{
  ...
  if (*(int *)(iVar2 + 0x36c) != 0) {
    (*(code *)PTR_sk_pop_free_006a7058)(*(int *)(iVar2 + 0x36c),PTR_X509_NAME_free_006a6ff8);
    iVar2 = param_1[0x16];
  }
  ...
  *(undefined *)(iVar2 + 0x420) = 0;
  ...
  if (*(int *)(iVar2 + 0x178) != 0) {
    (*(code *)PTR_BIO_free_006a6e70)(*(int *)(iVar2 + 0x178));
    iVar2 = param_1[0x16];
  ...
  (*(code *)PTR_memset_006a99f4)(iVar2,0,0x424);
  puVar1 = PTR_ssl_free_wbio_buffer_006a801c;
  iVar2 = param_1[0x16];
