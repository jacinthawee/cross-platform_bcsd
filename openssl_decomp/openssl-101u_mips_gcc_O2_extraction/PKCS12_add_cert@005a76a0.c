...

{
  ...
  local_1c = *(X509_ALGOR **)PTR___stack_chk_guard_006a9ae8;
  name = cert;
  ...
  name = (X509 *)(*(code *)PTR_X509_alias_get0_006a7708)(cert,&local_24);
  if ((name == (X509 *)0x0) ||
     (in_a2 = local_24,
     iVar2 = PKCS12_add_friendlyname_asc((PKCS12_SAFEBAG *)bag,(char *)name,(int)local_24),
     iVar2 != 0)) {
    pXVar6 = (X509 *)&local_20;
    name = (X509 *)(*(code *)PTR_X509_keyid_get0_006a91fc)(cert,pXVar6);
    if ((name == (X509 *)0x0) ||
       (in_a2 = local_20,
       iVar2 = PKCS12_add_localkeyid((PKCS12_SAFEBAG *)bag,(uchar *)name,(int)local_20),
       pXVar6 = name, iVar2 != 0)) {
      name = pXVar6;
      if (pbags == (stack_st_PKCS12_SAFEBAG **)0x0) goto LAB_005a7748;
      if (*pbags == (stack_st_PKCS12_SAFEBAG *)0x0) {
        psVar3 = (stack_st_PKCS12_SAFEBAG *)(*(code *)PTR_sk_new_null_006a6fa4)();
        *pbags = psVar3;
        if (psVar3 != (stack_st_PKCS12_SAFEBAG *)0x0) {
          name = bag;
          iVar2 = (*(code *)PTR_sk_push_006a6fa8)(psVar3,bag);
          if (iVar2 != 0) goto LAB_005a7748;
          (*(code *)PTR_sk_free_006a6e80)(*pbags);
          *pbags = (stack_st_PKCS12_SAFEBAG *)0x0;
        }
      }
      else {
        name = bag;
        iVar2 = (*(code *)PTR_sk_push_006a6fa8)(*pbags,bag);
        if (iVar2 != 0) goto LAB_005a7748;
      }
    }
  }
  ...
  if ((p8 != (PKCS8_PRIV_KEY_INFO *)0x0) &&
    ...
    if (a != (PKCS12_SAFEBAG *)0x0) {
      ...
      if (pXVar5->algorithm == (ASN1_OBJECT *)0x0) {
        pAVar4 = (ASN1_OBJECT *)(*(code *)PTR_sk_new_null_006a6fa4)();
        pXVar5->algorithm = pAVar4;
        if (pAVar4 != (ASN1_OBJECT *)0x0) {
          iVar2 = (*(code *)PTR_sk_push_006a6fa8)(pAVar4,a);
          if (iVar2 != 0) {
            return a;
          }
          (*(code *)PTR_sk_free_006a6e80)(pXVar5->algorithm);
          pXVar5->algorithm = (ASN1_OBJECT *)0x0;
        }
      }
      else {
        iVar2 = (*(code *)PTR_sk_push_006a6fa8)(pXVar5->algorithm,a);
        if (iVar2 != 0) {
          return a;
        }
      }
