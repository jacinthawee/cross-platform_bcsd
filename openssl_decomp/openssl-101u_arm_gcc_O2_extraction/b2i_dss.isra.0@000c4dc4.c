...

{
  ...
  if (r == (DSA *)0x0 || pkey == (DSA *)0x0) {
    ERR_put_error(9,0x7f,0x41,"pvkfmt.c",0x15c);
    if (r == (DSA *)0x0) goto LAB_000c4f6a;
    ctx = (DSA *)0x0;
  }
  else {
    num = param_2 + 7U >> 3;
    iVar7 = num - 1;
    puVar1 = (uchar *)CRYPTO_malloc(num,"pvkfmt.c",100);
    if (puVar1 == (uchar *)0x0) {
LAB_000c4f82:
      ctx = (DSA *)0x0;
    }
      ...
      r->p = pBVar2;
      CRYPTO_free(puVar1);
      if (r->p == (BIGNUM *)0x0) goto LAB_000c4f82;
      puVar1 = (uchar *)CRYPTO_malloc(0x14,"pvkfmt.c",100);
      iVar6 = iVar6 + num;
      if (puVar1 == (uchar *)0x0) goto LAB_000c4f82;
      puVar3 = puVar1 + -1;
      ...
      CRYPTO_free(puVar1);
      if ((r->q == (BIGNUM *)0x0) ||
         (puVar1 = (uchar *)CRYPTO_malloc(num,"pvkfmt.c",100), puVar1 == (uchar *)0x0))
      goto LAB_000c4f82;
      ...
      r->g = pBVar2;
      CRYPTO_free(puVar1);
      if (r->g == (BIGNUM *)0x0) goto LAB_000c4f82;
...
LAB_000c4f32:
      ...
      r->priv_key = pBVar2;
      CRYPTO_free(puVar1);
      if (r->priv_key == (BIGNUM *)0x0) goto LAB_000c4f82;
      pBVar2 = BN_new();
      r->pub_key = pBVar2;
