...
LAB_000d3f74:
      ...
      val = (int **)ASN1_item_new((ASN1_ITEM *)PTR_DIST_POINT_it_000d3f88);
      if (val == (int **)0x0) {
LAB_000d3dbc:
...
joined_r0x000d3e58:
              if (piVar10 == (int *)0x0) {
                piVar6 = (int *)ASN1_item_new((ASN1_ITEM *)PTR_DIST_POINT_NAME_it_000d3f8c);
                *val = piVar6;
                if (piVar6 != (int *)0x0) {
                  if (p_Var5 == (_STACK *)0x0) {
                    piVar6[1] = (int)p_Var4;
...
LAB_000d3db4:
          ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)PTR_DIST_POINT_it_000d3f88);
          goto LAB_000d3dbc;
        }
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            if (p_Var4 == (_STACK *)0x0) {
              ...
              val[2] = (int *)pGVar7;
              if (pGVar7 != (GENERAL_NAMES *)0x0) goto LAB_000d3d04;
            }
            goto LAB_000d3db4;
          }
        }
LAB_000d3d04:
      ...
      if (p_Var2 == (_STACK *)0x0) goto LAB_000d3f74;
      p_Var4 = (_STACK *)GENERAL_NAMES_new();
      if (((p_Var4 == (_STACK *)0x0) || (iVar1 = sk_push(p_Var4,p_Var2), iVar1 == 0)) ||
         (p_Var5 = (_STACK *)ASN1_item_new((ASN1_ITEM *)PTR_DIST_POINT_it_000d3f88), p_Var2 = p_Var5
         , p_Var5 == (_STACK *)0x0)) goto LAB_000d3f24;
      p_Var2 = (_STACK *)sk_push(st,p_Var5);
      if (p_Var2 == (_STACK *)0x0) {
        ASN1_item_free((ASN1_VALUE *)p_Var5,(ASN1_ITEM *)PTR_DIST_POINT_it_000d3fdc);
        goto LAB_000d3f24;
      }
      p_Var2 = (_STACK *)ASN1_item_new((ASN1_ITEM *)PTR_DIST_POINT_NAME_it_000d3f8c);
      p_Var5->num = (int)p_Var2;
      if (p_Var2 == (_STACK *)0x0) goto LAB_000d3f24;
