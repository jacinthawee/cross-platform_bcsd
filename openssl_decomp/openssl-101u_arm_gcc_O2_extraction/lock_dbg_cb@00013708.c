...

{
  ...
  if (uVar1 == 8 || uVar1 == 4) {
    ...
    if ((param_1 & 1) != 0) {
      if (*(int *)(&modes_20077 + param_2 * 4) == 0) {
        *(uint *)(&modes_20077 + param_2 * 4) = uVar1;
        return;
      }
    ...
    if ((int)(param_1 << 0x1e) < 0) {
      if (*(uint *)(&modes_20077 + param_2 * 4) == 0) {
        pcVar2 = "not locked";
      }
      else {
        if (uVar1 == *(uint *)(&modes_20077 + param_2 * 4)) {
          *(undefined4 *)(&modes_20077 + param_2 * 4) = 0;
          return;
        }
