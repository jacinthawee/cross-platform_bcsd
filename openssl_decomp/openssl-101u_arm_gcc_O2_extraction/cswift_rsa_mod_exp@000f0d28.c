...

{
  ...
  if (iVar3 == 0) {
    ...
    if (a_02 != (BIGNUM *)0x0 && a_01 != (BIGNUM *)0x0) {
      ...
      local_60 = CRYPTO_malloc(local_64,"e_cswift.c",0x24d);
      if (local_60 == (void *)0x0) {
        ...
        local_58 = CRYPTO_malloc(local_5c,"e_cswift.c",0x24d);
        if (local_58 == (void *)0x0) {
          ...
          local_50 = CRYPTO_malloc(local_54,"e_cswift.c",0x24d);
          if (local_50 == (void *)0x0) {
            ...
            local_48 = CRYPTO_malloc(local_4c,"e_cswift.c",0x24d);
            if (local_48 != (void *)0x0) {
              ...
              pvVar5 = CRYPTO_malloc(local_44,"e_cswift.c",0x24d);
              local_40 = pvVar5;
              if (pvVar5 == (void *)0x0) {
                pvVar9 = (void *)0x1;
                ERR_CSWIFT_error_constprop_3(0x6a,0x67,0x29a);
              }
              else {
                ...
                if (((a_01->dmax < param_2->top) &&
                  ...
                  pvVar9 = (void *)0x1;
                  ERR_CSWIFT_error_constprop_3(0x6a,0x67,0x29e);
                  pvVar5 = (void *)0x0;
                }
                else {
                  ...
                  if (iVar3 == -0x2716) {
                    pvVar9 = (void *)0x1;
                    ERR_CSWIFT_error_constprop_3(0x6a,0x65,0x2a8);
                    pvVar5 = (void *)0x0;
                  }
                  else {
                    if (iVar3 == 0) {
