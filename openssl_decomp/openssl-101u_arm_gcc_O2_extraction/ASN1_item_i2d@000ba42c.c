...

{
  ...
  if ((out != (uchar **)0x0) && (*out == (uchar *)0x0)) {
    iVar1 = ASN1_item_ex_i2d(&local_30,(uchar **)0x0,it,-1,0);
    if (iVar1 < 1) {
      return iVar1;
    }
    ...
    local_2c[0] = puVar2;
    ASN1_item_ex_i2d(&local_30,local_2c,it,-1,0);
    *out = puVar2;
    return iVar1;
  }
  ...
  if ((it->itype == '\0') || (val != (ASN1_VALUE *)0x0)) {
    ...
    case '\0':
      if (it->templates == (ASN1_TEMPLATE *)0x0) {
        iVar1 = asn1_i2d_ex_primitive(&local_30,out,it,0xffffffff,0);
        return iVar1;
      }
      iVar1 = asn1_template_ex_i2d(&local_30,out,it->templates,0xffffffff,0);
      return iVar1;
    case '\x01':
    case '\x06':
        ...
        if ((pcVar9 == (code *)0x0) || (iVar1 = (*pcVar9)(6,&local_30,it,0), iVar1 != 0)) {
          ...
          if (0 < it->tcount) {
            do {
              ...
              iVar1 = asn1_template_ex_i2d(ppAVar3,0,pAVar4,0xffffffff,0);
              if (iVar1 == -1) {
                return -1;
              }
          ...
          iVar1 = ASN1_object_size(1,(int)local_2c[0],0x10);
          xclass = (uint)(out == (uchar **)0x0 || iVar1 == -1);
          if (out == (uchar **)0x0 || iVar1 == -1) {
            return iVar1;
          }
          ASN1_put_object(out,1,(int)local_2c[0],0x10,xclass);
          pAVar7 = it->templates;
          if (0 < it->tcount) {
            do {
              puVar2 = puVar2 + 1;
              ...
              ppAVar3 = asn1_get_field_ptr(&local_30,pAVar4);
              asn1_template_ex_i2d(ppAVar3,out,pAVar4,0xffffffff,xclass);
    ...
    case '\x02':
      if ((pcVar9 == (code *)0x0) || (iVar1 = (*pcVar9)(6,&local_30,it,0), iVar1 != 0)) {
        ...
        if ((-1 < iVar1) && (iVar1 < it->tcount)) {
          ...
          iVar1 = asn1_template_ex_i2d(ppAVar3,out,pAVar7 + iVar1,0xffffffff,0);
          return iVar1;
        }
        if (pcVar9 != (code *)0x0) {
    ...
    case '\x03':
      ...
      return iVar1;
    case '\x04':
      iVar1 = (**(code **)(pcVar6 + 0x14))(&local_30,out,it,0xffffffff,0);
      return iVar1;
    case '\x05':
      iVar1 = asn1_i2d_ex_primitive(&local_30,out,it,0xffffffff,0);
      return iVar1;
