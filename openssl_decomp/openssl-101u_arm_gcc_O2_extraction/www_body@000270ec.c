...
LAB_00027228:
      ...
      while( true ) {
        if (iVar3 < 0) {
          ...
          if (iVar3 == 0) {
            if (s_quiet != 0) goto LAB_00027138;
            ERR_print_errors(bio_err);
            goto LAB_0002769e;
          }
          BIO_printf(bio_s_out,"read R BLOCK\n");
          iVar3 = BIO_test_flags(bp,4);
          if ((iVar3 == 0) || (iVar3 = BIO_get_retry_reason(bp), iVar3 != 1)) {
            sleep(1);
          }
          else {
        ...
        if (iVar3 == 0) goto LAB_00027696;
        if (www == 1) break;
        if (www == 2) {
          iVar3 = strncmp("GET /stats ",buf,0xb);
          if (iVar3 == 0) goto LAB_0002734a;
LAB_0002754c:
          iVar3 = strncmp("GET /",buf,5);
          if (iVar3 != 0) goto LAB_00027224;
          uVar7 = (uint)(byte)buf[5];
          filename = (byte *)(buf + 5);
          if (uVar7 == 0) goto LAB_000277a0;
          if (uVar7 != 0x20) {
            uVar14 = 1;
            pbVar15 = filename;
            goto LAB_0002759a;
        ...
        if (www == 3) goto LAB_0002754c;
        if (hack == 0) goto LAB_00027228;
LAB_00027254:
        while (iVar3 = SSL_accept(ssl), iVar3 < 1) {
          while( true ) {
            iVar6 = SSL_get_error(ssl,iVar3);
            if (iVar6 != 4) goto LAB_000272a8;
...
LAB_000272a8:
        ...
        if (iVar3 - 1U < 6) {
          ...
          if ((uVar7 & 0x31) != 0) goto LAB_00027138;
          if ((uVar7 & 0xe) != 0) goto LAB_00027224;
        }
        SSL_renegotiate(ssl);
      ...
      if (pcVar10 != (char *)0x0) {
        ...
        if (cVar16 != '\0') {
          ...
          do {
            if (cVar16 == ':') {
              iVar3 = iVar3 + 1;
              BIO_write(bp,&DAT_0012d478,0x1a - iVar6);
              iVar6 = 0;
              pcVar11 = local_38;
              if (iVar3 % 3 != 0) {
                pcVar11 = " ";
...
LAB_0002759a:
    if (uVar14 == 2) {
      if (uVar7 != 0x2e) goto LAB_000275a4;
      uVar14 = 3;
    }
    else if (uVar14 == 3) {
      if (uVar7 != 0x2f) goto LAB_000275a4;
      uVar14 = 0xffffffff;
    }
    else if (uVar14 == 1) {
      if (uVar7 != 0x2e) goto LAB_000275a4;
