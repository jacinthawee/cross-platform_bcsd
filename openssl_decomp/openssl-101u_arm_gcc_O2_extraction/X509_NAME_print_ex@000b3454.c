...

{
  ...
  if ((uVar8 != 0) && (out != (BIO *)0x0)) {
    uVar9 = 0;
    do {
      iVar1 = BIO_write(out,&DAT_00130f00,1);
      if (iVar1 != 1) goto LAB_000b3494;
      uVar9 = uVar9 + 1;
    } while (uVar9 != uVar8);
  }
  uVar9 = flags & 0xf0000;
  if (uVar9 == 0x20000) {
    local_84 = &DAT_00160dac;
    local_94 = ", ";
    local_88 = 3;
    uVar9 = 0;
    local_9c = 2;
...
LAB_000b3494:
    ...
    if (uVar9 != 0x40000) goto LAB_000b3494;
    local_84 = &DAT_00160dac;
    local_94 = "\n";
    local_88 = 3;
    local_9c = 1;
  ...
  if (0 < iVar2) {
    ...
    do {
      if ((flags & 0x100000) == 0) {
        ...
        if (local_b8 == -1) goto LAB_000b36e8;
LAB_000b358e:
        iVar7 = ne->set;
        if (local_b8 == iVar7) {
          if (out != (BIO *)0x0) {
            iVar7 = BIO_write(out,local_84,local_88);
            if (local_88 != iVar7) goto LAB_000b3494;
            local_b8 = ne->set;
          }
          ...
          if (out != (BIO *)0x0) {
            ...
            if (local_9c != iVar7) goto LAB_000b3494;
            uVar10 = 0;
            if (uVar9 != 0) {
              do {
                iVar7 = BIO_write(out,&DAT_00130f00,1);
                if (iVar7 != 1) goto LAB_000b3494;
                uVar10 = uVar10 + 1;
              } while (uVar10 != uVar9);
            }
            iVar7 = ne->set;
        ...
        if (local_b8 != -1) goto LAB_000b358e;
LAB_000b36e8:
        local_b8 = ne->set;
      }
      ...
      if (uVar6 != 0x600000) {
        ...
        if (((int)len < (int)sVar13) && ((flags & 0x2000000) != 0)) {
          ...
          if ((0 < iVar12) && (out != (BIO *)0x0)) {
            iVar11 = 0;
            do {
              iVar5 = BIO_write(out,&DAT_00130f00,1);
              if (iVar5 != 1) goto LAB_000b3494;
              iVar11 = iVar11 + 1;
            } while (iVar11 != iVar12);
          }
          uVar8 = uVar8 + iVar12;
