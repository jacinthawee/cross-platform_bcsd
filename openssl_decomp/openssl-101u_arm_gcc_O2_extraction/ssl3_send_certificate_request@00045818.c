  ...
  if (param_1->state == 0x2160) {
    ...
    if (p_Var3 != (_STACK *)0x0) {
      ...
      while( true ) {
        ...
        pcVar7 = str->data;
        puVar11 = (uchar *)(pcVar7 + iVar9);
        if (param_1->references << 2 < 0) {
          local_2c[0] = puVar11;
          i2d_X509_NAME(a,local_2c);
          pcVar7[iVar9] = (char)((uint)(iVar4 + -2) >> 8);
          puVar11[1] = (uchar)(iVar4 + -2);
        }
        else {
          pcVar7[iVar9] = (char)((uint)iVar4 >> 8);
          puVar11[1] = (uchar)iVar4;
          iVar4 = iVar4 + 2;
          local_2c[0] = puVar11 + 2;
          i2d_X509_NAME(a,local_2c);
        }
      ...
      p_Var10 = (_STACK *)(local_38 & 0xff);
    }
    pcVar7 = str->data;
    pcVar7[local_34 + 4] = (char)p_Var3;
    pcVar7[local_34 + 5] = (char)p_Var10;
    pcVar6 = str->data;
    local_2c[0] = (uchar *)(pcVar7 + local_34 + 6);
    pcVar6[3] = (char)iVar2;
    *pcVar6 = '\r';
    ...
    param_1->init_off = 0;
    iVar2 = BUF_MEM_grow_clean(str,iVar2 + 8);
    if (iVar2 == 0) {
      iVar2 = 0x869;
LAB_000459d2:
    ...
    pcVar7[iVar2 + 1] = '\0';
    pcVar7[iVar2 + 2] = '\0';
    local_2c[0] = (uchar *)(pcVar7 + iVar2 + 4);
    pcVar7[iVar2 + 3] = '\0';
