...
void __sha1_block_data_order_from_thumb(uint *param_1,uint *param_2,int param_3)
  ...
  do {
    ...
    do {
      ...
      uVar9 = uVar9 << 0x18 | (uVar9 >> 8 & 0xff) << 0x10 | (uVar9 >> 0x10 & 0xff) << 8 |
              uVar9 >> 0x18;
      puVar13[-1] = uVar9;
      uVar7 = DAT_000709cc + (uVar7 >> 2 | uVar7 << 0x1e) + (uVar3 >> 0x1b | uVar3 << 5) + uVar9 +
      ...
      uVar9 = uVar9 << 0x18 | (uVar9 >> 8 & 0xff) << 0x10 | (uVar9 >> 0x10 & 0xff) << 8 |
              uVar9 >> 0x18;
      puVar13[-2] = uVar9;
      uVar6 = DAT_000709cc + (uVar6 >> 2 | uVar6 << 0x1e) + (uVar7 >> 0x1b | uVar7 * 0x20) + uVar9 +
      ...
      uVar9 = uVar9 << 0x18 | (uVar9 >> 8 & 0xff) << 0x10 | (uVar9 >> 0x10 & 0xff) << 8 |
              uVar9 >> 0x18;
      puVar13[-3] = uVar9;
      uVar5 = DAT_000709cc + (uVar5 >> 2 | uVar5 << 0x1e) + (uVar6 >> 0x1b | uVar6 * 0x20) + uVar9 +
      ...
      uVar9 = uVar9 << 0x18 | (uVar9 >> 8 & 0xff) << 0x10 | (uVar9 >> 0x10 & 0xff) << 8 |
              uVar9 >> 0x18;
      puVar13[-4] = uVar9;
      uVar4 = DAT_000709cc + (uVar4 >> 2 | uVar4 << 0x1e) + (uVar5 >> 0x1b | uVar5 * 0x20) + uVar9 +
      ...
      puVar12 = puVar13 + -5;
      *puVar12 = uVar9;
      uVar3 = DAT_000709cc + (uVar3 >> 2 | uVar3 << 0x1e) + (uVar4 >> 0x1b | uVar4 * 0x20) + uVar9 +
    ...
    uVar9 = uVar9 << 0x18 | (uVar9 >> 8 & 0xff) << 0x10 | (uVar9 >> 0x10 & 0xff) << 8 |
            uVar9 >> 0x18;
    puVar13[-6] = uVar9;
    uVar7 = DAT_000709cc + (uVar7 >> 2 | uVar7 * 0x40000000) + (uVar3 >> 0x1b | uVar3 * 0x20) +
    ...
    puVar13[-7] = uVar9;
    uVar6 = DAT_000709cc + (uVar6 >> 2 | uVar6 * 0x40000000) + (uVar7 >> 0x1b | uVar7 * 0x20) +
    ...
    puVar13[-8] = uVar9;
    uVar5 = DAT_000709cc + (uVar5 >> 2 | uVar5 * 0x40000000) + (uVar6 >> 0x1b | uVar6 * 0x20) +
    ...
    puVar13[-9] = uVar9;
    uVar4 = DAT_000709cc + (uVar4 >> 2 | uVar4 * 0x40000000) + (uVar5 >> 0x1b | uVar5 * 0x20) +
    ...
    puVar13 = puVar13 + -10;
    *puVar13 = uVar9;
    uVar3 = DAT_000709cc + (uVar3 >> 2 | uVar3 * 0x40000000) + (uVar4 >> 0x1b | uVar4 * 0x20) +
    ...
    while( true ) {
      ...
      do {
        uVar9 = ((puVar13[0xf] ^ puVar13[0xd]) >> 0x1f | (puVar13[0xf] ^ puVar13[0xd]) << 1) ^
                ((puVar13[7] ^ puVar13[2]) >> 0x1f | (puVar13[7] ^ puVar13[2]) << 1);
        puVar13[-1] = uVar9;
        uVar7 = DAT_000709d4 + (uVar7 >> 2 | uVar7 << 0x1e) + (uVar3 >> 0x1b | uVar3 << 5) + uVar9 +
                (uVar4 & ((uVar5 ^ uVar6) >> 2 | (uVar5 ^ uVar6) << 0x1e)) +
                ((uVar5 & uVar6) >> 2 | (uVar5 & uVar6) << 0x1e);
        uVar9 = ((puVar13[0xe] ^ puVar13[0xc]) >> 0x1f | (puVar13[0xe] ^ puVar13[0xc]) << 1) ^
                ((puVar13[6] ^ puVar13[1]) >> 0x1f | (puVar13[6] ^ puVar13[1]) << 1);
        puVar13[-2] = uVar9;
        uVar6 = DAT_000709d4 + (uVar6 >> 2 | uVar6 << 0x1e) + (uVar7 >> 0x1b | uVar7 * 0x20) + uVar9
                + (uVar3 & ((uVar4 ^ uVar5) >> 2 | (uVar4 ^ uVar5) << 0x1e)) +
                ((uVar4 & uVar5) >> 2 | (uVar4 & uVar5) << 0x1e);
        uVar9 = ((puVar13[0xd] ^ puVar13[0xb]) >> 0x1f | (puVar13[0xd] ^ puVar13[0xb]) << 1) ^
                ((puVar13[5] ^ *puVar13) >> 0x1f | (puVar13[5] ^ *puVar13) << 1);
        puVar13[-3] = uVar9;
        uVar5 = DAT_000709d4 + (uVar5 >> 2 | uVar5 << 0x1e) + (uVar6 >> 0x1b | uVar6 * 0x20) + uVar9
                + (uVar7 & ((uVar3 ^ uVar4) >> 2 | (uVar3 ^ uVar4) << 0x1e)) +
                ((uVar3 & uVar4) >> 2 | (uVar3 & uVar4) << 0x1e);
        uVar9 = ((puVar13[0xc] ^ puVar13[10]) >> 0x1f | (puVar13[0xc] ^ puVar13[10]) << 1) ^
                ((puVar13[4] ^ puVar13[-1]) >> 0x1f | (puVar13[4] ^ puVar13[-1]) << 1);
        puVar13[-4] = uVar9;
        uVar4 = DAT_000709d4 + (uVar4 >> 2 | uVar4 << 0x1e) + (uVar5 >> 0x1b | uVar5 * 0x20) + uVar9
                + (uVar6 & ((uVar7 ^ uVar3) >> 2 | (uVar7 ^ uVar3) << 0x1e)) +
        ...
        puVar13 = puVar13 + -5;
        *puVar13 = uVar9;
        uVar3 = DAT_000709d4 + (uVar3 >> 2 | uVar3 << 0x1e) + (uVar4 >> 0x1b | uVar4 * 0x20) + uVar9
                + (uVar5 & ((uVar6 ^ uVar7) >> 2 | (uVar6 ^ uVar7) << 0x1e)) +
