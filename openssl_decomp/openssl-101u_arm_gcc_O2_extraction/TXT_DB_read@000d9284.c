...

{
  ...
  if (((str == (BUF_MEM *)0x0) || (iVar1 = BUF_MEM_grow(str,0x200), iVar1 == 0)) ||
    ...
    if (p_Var2 != (_STACK *)0x0) {
      pplVar3 = (lhash_st_OPENSSL_STRING **)CRYPTO_malloc(num << 2,"txt_db.c",0x60);
      ptr->index = pplVar3;
      if (pplVar3 != (lhash_st_OPENSSL_STRING **)0x0) {
        p_Var4 = (_func_4743 *)CRYPTO_malloc(num << 2,"txt_db.c",0x62);
        ptr->qual = p_Var4;
...
LAB_000d93f2:
          ...
          pcVar10 = __s;
          if (*__s == '#') goto LAB_000d93b4;
          do {
            sVar5 = strlen(__s);
            uVar12 = uVar12 + sVar5;
            if (pcVar10[uVar12 - 1] == '\n') {
              pcVar10[uVar12 - 1] = '\0';
              data = (undefined4 *)CRYPTO_malloc((num + 1) * 4 + uVar12,"txt_db.c",0x7f);
...
LAB_000d93b4:
            ...
            pcVar10 = str->data;
            __s = pcVar10 + uVar12;
            if (pcVar10[uVar12] == '\0') goto LAB_000d93f2;
          } while( true );
        }
      }
    }
