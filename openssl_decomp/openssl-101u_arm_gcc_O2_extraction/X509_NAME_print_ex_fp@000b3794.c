...
LAB_000b37ce:
    ...
    if ((uVar1 != 0) && (fp != (FILE *)0x0)) {
      uVar9 = 0;
      do {
        sVar2 = fwrite(&DAT_00130f00,1,1,fp);
        if (sVar2 != 1) goto LAB_000b37ce;
        uVar9 = uVar9 + 1;
      } while (uVar9 != uVar1);
    }
    uVar9 = flags & 0xf0000;
    if (uVar9 == 0x20000) {
      ...
      local_84 = 2;
      local_88 = 3;
      local_8c = &DAT_00160dac;
      uVar9 = 0;
      local_9c = ", ";
    }
    else if (uVar9 < 0x20001) {
      if (uVar9 != 0x10000) goto LAB_000b37ce;
      local_a4 = 1;
      local_90 = 1;
      uVar9 = 0;
      local_88 = 1;
      local_84 = 1;
      local_8c = &DAT_00160db0;
      local_9c = ",";
    }
      ...
      if (uVar9 != 0x40000) goto LAB_000b37ce;
      local_a4 = 1;
      local_90 = 3;
      local_84 = 1;
      local_88 = 3;
    ...
    if (0 < iVar3) {
      ...
      do {
        if ((flags & 0x100000) == 0) {
          ...
          if (local_c0 == -1) goto LAB_000b3a50;
LAB_000b38f4:
          iVar8 = ne->set;
          if (local_c0 == iVar8) {
            if (fp != (FILE *)0x0) {
              sVar4 = fwrite(local_8c,1,local_90,fp);
              if (sVar4 != local_90) goto LAB_000b37ce;
              local_c0 = ne->set;
            }
            ...
            if (fp != (FILE *)0x0) {
              ...
              if (sVar4 != local_a4) goto LAB_000b37ce;
              uVar10 = 0;
              if (uVar9 != 0) {
                do {
                  sVar4 = fwrite(&DAT_00130f00,1,1,fp);
                  if (sVar4 != 1) goto LAB_000b37ce;
                  uVar10 = uVar10 + 1;
                } while (uVar10 != uVar9);
              }
              iVar8 = ne->set;
          ...
          if (local_c0 != -1) goto LAB_000b38f4;
LAB_000b3a50:
          local_c0 = ne->set;
        }
