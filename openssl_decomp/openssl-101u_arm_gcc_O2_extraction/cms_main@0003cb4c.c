...
LAB_0003cbf0:
    ppXVar17 = local_50;
    pXVar22 = *local_50;
    if ((pXVar22 == (X509 *)0x0) || (*(char *)&pXVar22->cert_info != '-')) goto LAB_0003ce78;
            ...
            if (iVar4 == 0) {
              ...
              if (iVar4 == 0) {
                ...
                if (iVar4 == 0) {
                  ...
                  if (iVar4 == 0) {
                    local_d0 = ppXVar17[1];
                    if (local_d0 == (X509 *)0x0) goto LAB_0003cf00;
                    pXVar16 = (X509 *)0x30;
                    ppXVar17 = ppXVar17 + 1;
                  }
                  else {
                                            ...
                                            if (iVar4 == 0) {
                                              ...
                                              if (iVar4 == 0) {
                                                ...
                                                if (iVar4 == 0) {
                                                  ...
                                                  pXVar19 = local_48;
                                                  iVar6 = local_b4;
                                                  if (local_74 != (EVP_MD *)0x0) goto LAB_0003ce6c;
...
joined_r0x0003e95a:
                                                  if (pXVar22 == (X509 *)0x0) goto LAB_0003cf00;
                                                  ppXVar17 = ppXVar17 + 1;
                                                  iVar6 = local_b4;
                                                  }
                                                  }
...
LAB_0003ce6c:
    local_b4 = iVar6;
    local_50 = ppXVar17 + 1;
    if (pXVar19 != (X509 *)0x0) goto LAB_0003ce78;
    goto LAB_0003cbf0;
  }
LAB_0003ce78:
  pXVar18 = st;
...
LAB_0003cefa:
    local_f4 = pXVar23;
    if (pXVar19 != (X509 *)0x0) goto LAB_0003cf00;
    ...
    if (pXVar23 == (X509 *)0x0) {
      ...
      local_c0 = pXVar23;
      if (pXVar16 != (X509 *)0x11) goto LAB_0003d418;
      if (local_a8 == (EVP_CIPHER *)0x0) {
        local_a8 = EVP_des_ede3_cbc();
      }
...
LAB_0003d778:
          if (local_f0 == (X509 *)0x0) {
            local_c8 = (X509 *)0x0;
            local_f0 = local_bc;
            goto joined_r0x0003db1c;
          }
          local_c8 = (X509 *)0x0;
          goto LAB_0003d784;
        }
        if (pXVar19 != (X509 *)0x0) goto LAB_0003d7ee;
        bp = pXVar19;
        local_dc = pXVar19;
        local_c8 = pXVar19;
        if (pXVar16 == (X509 *)0x53) goto LAB_0003d778;
      }
      else {
...
joined_r0x0003db1c:
          bp = local_f0;
          if (local_f0 == (X509 *)0x0) goto LAB_0003d484;
        }
        else {
          local_dc = (X509 *)0x0;
        }
...
LAB_0003d70e:
          if (local_d0 == (X509 *)0x0) {
            ...
            if (iVar24 == 1) {
              ...
              if (local_cc == (X509 *)0x0) goto LAB_0003daf0;
              ...
              if (pXVar16 == (X509 *)0x1e) {
                ...
                if (pXVar22 != (X509 *)0x0) {
                  if (pXVar16 == (X509 *)0x53) {
                    ...
                    if (pXVar23 == (X509 *)0x0) goto LAB_0003e022;
                    if (oid != (X509 *)0x0) {
              ...
              if (pXVar22 == (X509 *)0x0) {
                ...
                local_e4 = (X509 *)CMS_add0_recipient_password
                                             ((CMS_ContentInfo *)pXVar23,-1,0,0,(uchar *)pXVar22,-1,
                                              (EVP_CIPHER *)0x0);
                if (local_e4 != (X509 *)0x0) goto LAB_0003dc9a;
                local_68 = (X509 *)0x3;
                pXVar19 = pXVar22;
                pXVar22 = local_e4;
              }
...
joined_r0x0003e096:
              ...
              if (pXVar20 != (X509 *)0x0) {
                ...
                if (local_9c == (X509 *)0x0) {
                  ...
                  if (local_68 == (X509 *)0x0) goto LAB_0003d226;
                }
                goto LAB_0003d220;
              }
              if (uVar21 >> 5 == 0) {
...
LAB_0003d6b4:
          ...
          local_4c = bp;
          if (bp != (X509 *)0x0) goto LAB_0003d6b4;
...
LAB_0003db04:
        ...
        local_e0 = bp;
        if (bp != (X509 *)0x0) goto LAB_0003d49a;
