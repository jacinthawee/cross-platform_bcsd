...

{
  ...
  if (iVar5 == 0) {
    ...
    sk_pop_free(st,(func *)0x3ef55);
    sk_pop_free(st_00,(func *)0x3ef55);
    sk_pop_free(st_01,(func *)0x3ef55);
    return 1;
  }
  param_1 = param_1 + -1;
    ...
    do {
      ...
      if (uVar6 != 0) {
        ...
        if (uVar6 == 0) {
          ...
          if ((uVar6 < sVar18) || (local_60 = sVar18 - 1, 1 < local_60)) goto LAB_0003f2d0;
          bVar4 = true;
          goto LAB_0003f146;
        }
        ...
        if (iVar5 == 0) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_0003f2d0;
...
LAB_0003f2d0:
      ...
      if ((uVar6 < sVar24) || (4 < (int)sVar24)) goto LAB_0003f2d0;
LAB_0003f146:
      param_1 = param_1 + -1;
      ppcVar28 = ppcVar29 + 1;
    } while (0 < param_1);
  ...
  if (bVar3) {
    ...
    if (pRVar9 == (RSA_METHOD *)0x0) {
      ...
      if (pDVar10 != (DSA_METHOD *)0x0) {
        dst = (RAND_METHOD *)CRYPTO_malloc(0x100,"engine.c",0x68);
...
LAB_0003f2f4:
      ...
      if (pDVar11 == (DH_METHOD *)0x0) {
        ...
        if (dst != (RAND_METHOD *)0x0) goto LAB_0003f6ee;
        goto LAB_0003f42a;
      }
      dst = (RAND_METHOD *)CRYPTO_malloc(0x100,"engine.c",0x68);
      if (dst == (RAND_METHOD *)0x0) goto LAB_0003f2f4;
      sVar18 = 0x100;
      *(undefined *)&dst->seed = 0;
LAB_0003f3d6:
      ...
      if (sVar18 <= sVar12 + 2) {
        sVar18 = sVar18 + 0x100;
        dst = (RAND_METHOD *)CRYPTO_realloc(dst,sVar18,"engine.c",0x70);
        if (dst == (RAND_METHOD *)0x0) goto LAB_0003f2f4;
      }
      if (*(char *)&dst->seed != '\0') {
      ...
      if (pRVar13 != (RAND_METHOD *)0x0) goto LAB_0003f404;
    }
    else {
      dst = (RAND_METHOD *)CRYPTO_malloc(0x100,"engine.c",0x68);
      if (dst == (RAND_METHOD *)0x0) goto LAB_0003f2f4;
...
LAB_0003f39c:
        ...
        if (sVar18 + 3 < 0x100) {
          ...
          dst = (RAND_METHOD *)CRYPTO_realloc(dst,0x200,"engine.c",0x70);
          if (dst == (RAND_METHOD *)0x0) goto LAB_0003f2f4;
          sVar18 = 0x200;
        }
        if (*(char *)&dst->seed != '\0') {
      ...
      pDVar11 = ENGINE_get_DH(pEVar7);
      if (pDVar11 != (DH_METHOD *)0x0) goto LAB_0003f3d6;
      pRVar13 = ENGINE_get_RAND(pEVar7);
...
LAB_0003f42a:
    ...
    if ((pEVar21 == (ENGINE_PKEY_METHS_PTR)0x0) ||
      ...
      if (dst != (RAND_METHOD *)0x0) goto LAB_0003fad4;
    }
    else {
      iVar17 = 0;
      do {
...
LAB_0003fad4:
  ...
  if (((0 < (int)sVar24) && (iVar5 = ENGINE_ctrl(pEVar7,10,0,(void *)0x0,(f *)0x0), iVar5 != 0)) &&
    ...
    st_02 = sk_new_null();
    if (st_02 == (_STACK *)0x0) goto LAB_0003f2f4;
    uVar6 = 0;
    do {
...
LAB_0003faa8:
      ...
      if (((uVar16 & 8) == 0) || (3 < (int)sVar24)) {
        ...
        if ((iVar17 < 1) ||
           (pcVar30 = (char *)CRYPTO_malloc(iVar17 + 1,"engine.c",0xda), pcVar30 == (char *)0x0))
        goto LAB_0003faa8;
...
LAB_0003fb24:
          ...
          if ((int)pcVar8 < 0) goto LAB_0003fb24;
          if ((pcVar8 == (char *)0x0) ||
             ((pcVar8 = (char *)CRYPTO_malloc((int)(pcVar8 + 1),"engine.c",0xe4),
              pcVar8 != (char *)0x0 &&
            ...
            if (sVar24 == 1) {
              ...
              if (sVar24 == 2) {
                ...
                BIO_printf(bio,"%s%s(input flags): ",&DAT_00130efc,&DAT_00130efc);
                if (uVar16 == 0) {
...
LAB_0003fa66:
                      ...
                      if ((int)(uVar16 * 0x20000000) < 0) goto LAB_0003fac0;
                      goto joined_r0x0003fa7c;
                    }
                    uVar6 = uVar16 & 4;
                    if (uVar6 != 0) goto LAB_0003f856;
LAB_0003f8c0:
...
LAB_0003f878:
        ...
        sk_pop_free(st_02,(func *)0x3ef55);
        CRYPTO_free(pcVar30);
        if (pcVar8 != (char *)0x0) {
          CRYPTO_free(pcVar8);
        }
...
LAB_0003faaa:
    sk_pop_free(st_02,(func *)0x3ef55);
    if (!bVar2) goto LAB_0003f2f4;
  }
  ENGINE_free(pEVar7);
LAB_0003f202:
  local_54 = local_54 + 1;
  iVar5 = sk_num(st);
  if (iVar5 <= local_54) goto LAB_0003f214;
  goto LAB_0003f188;
}
