...
LAB_0009e4ac:
    ...
    if (param_2 < 4) {
      if (param_2 == 1) goto LAB_0009e494;
      if (param_2 == 2) {
...
LAB_0009e482:
    ...
    if (param_2 < 0x6c) {
      if (param_2 == 0xc) goto LAB_0009e482;
      if (param_2 == 0x6a) {
...
LAB_0009e494:
      ...
      if (param_2 == 0x85) goto LAB_0009e4ac;
      if (param_2 == 0x6c) {
        ...
        if (pFVar1 == (FILE *)0x0) {
          ...
          ERR_add_error_data(5,"fopen(\'",param_4,&DAT_0015dc6c,acStack_20,&DAT_00139dd8);
