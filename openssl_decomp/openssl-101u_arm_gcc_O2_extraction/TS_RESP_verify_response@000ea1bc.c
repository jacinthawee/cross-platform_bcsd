...
LAB_000ea428:
    ...
    if (iVar7 < 1) {
      pAVar10 = ppAVar5[2];
      local_148 = (char *)0x0;
      puVar2 = PTR_TS_failure_info_000ea558;
    }
    else {
      iVar12 = 0;
      ...
      local_148 = (char *)CRYPTO_malloc(iVar12,"ts_rsp_verify.c",0x232);
    ...
    PTR_TS_failure_info_000ea558 = puVar2;
    if (pAVar10 != (ASN1_INTEGER *)0x0) {
      iVar7 = 0;
      bVar1 = true;
      while( true ) {
    ...
    if ((char)local_130 == '\0') {
      local_130 = s_unspecified_00127424._0_4_;
      uStack_12c = s_unspecified_00127424._4_4_;
      uStack_128 = s_unspecified_00127424._8_4_;
    }
