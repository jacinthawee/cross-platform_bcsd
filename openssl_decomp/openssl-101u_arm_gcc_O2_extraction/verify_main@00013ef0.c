...
LAB_00014120:
            ...
            if ((local_44 == (_STACK *)0x0) ||
              ...
              if (((local_40 != (_STACK *)0x0) &&
                 ...
                 ((local_3c != (_STACK *)0x0 &&
                  ...
                  p_Var7 = local_40, local_3c == (_STACK *)0x0)))) goto LAB_00013fe0;
              if (local_34 < 1) {
      ...
      if (iVar3 == 0) {
        ...
        ppcVar11 = local_38;
        if (iVar2 != 0) {
          if (local_30 != 0) goto LAB_00013fdc;
          goto LAB_00013f80;
        }
        pcVar12 = *local_38;
        ...
        if (iVar2 == 0) {
          ...
          if (iVar2 == 0) {
            ...
            if (iVar2 == 0) {
              ...
              if (iVar2 == 0) goto LAB_00013fdc;
              iVar2 = strcmp(pcVar12,"-verbose");
              if (iVar2 != 0) {
                if (*pcVar12 != '-') goto LAB_00014120;
                goto LAB_00013fdc;
              }
              v_verbose = 1;
              iVar2 = local_34;
