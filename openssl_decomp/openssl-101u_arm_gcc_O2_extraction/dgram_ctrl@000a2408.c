...

{
  ...
  case 9:
    *(size_t *)(param_1 + 0x10) = param_3;
    ...
    break;
  default:
    goto switchD_000a2428_caseD_a;
  case 0xb:
  case 0xc:
    goto switchD_000a2428_caseD_b;
  case 0x1f:
  case 0x2c:
...
LAB_000a2548:
  ...
  case 0x2a:
    ...
    break;
  case 0x2b:
    if (__src[8] == 0x5a) goto LAB_000a25aa;
switchD_000a2428_caseD_a:
    param_3 = 0;
    break;
  case 0x2d:
    param_3 = 1;
  ...
  case 0x2f:
    ...
    if (__src[2] == 0) {
      if (__src[3] == 0) {
        ...
        iVar2 = 0x30;
        if (__src[3] != 0) goto LAB_000a261a;
      }
      if (__src[4] == -0x10000) {
        param_3 = 0x240 - iVar2;
        break;
