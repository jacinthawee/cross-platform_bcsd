...
LAB_08168db3:
      ...
      if (iVar9 != -1) {
        if (uVar8 == 0) {
LAB_08168e5a:
          if (to->depth != -1) goto LAB_08168dc6;
        }
        to->depth = iVar9;
      }
    }
      ...
      iVar9 = from->trust;
      if (iVar9 == 0) goto LAB_08168db3;
LAB_08168e43:
      if (to->trust == 0) goto LAB_08168db0;
      iVar9 = from->depth;
      if (iVar9 != -1) goto LAB_08168e5a;
    }
LAB_08168dc6:
    uVar7 = to->flags;
    if ((uVar7 & 2) == 0) {
...
LAB_08168ccb:
    ...
    if (p_Var4 == (_STACK *)0x0) goto LAB_08168cfe;
LAB_08168ce5:
...
LAB_08168cb4:
    ...
    to->flags = uVar7 | from->flags;
    if (!bVar2) goto LAB_08168ccb;
    p_Var4 = (_STACK *)to->policies;
    p_Var10 = (_STACK *)from->policies;
    if (p_Var4 != (_STACK *)0x0) goto LAB_08168ce5;
  }
  if (p_Var10 == (_STACK *)0x0) {
