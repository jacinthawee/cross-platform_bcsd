    ...
    *ppLVar9 = (LHASH_NODE *)0x0;
    ...
    while (plVar10 != (LHASH_NODE *)0x0) {
      while (uVar6 == plVar10->hash % uVar5) {
        ...
        plVar10 = *pplVar11;
        if (plVar10 == (lhash_node_st *)0x0) goto LAB_0812271c;
      }
      *pplVar11 = plVar10->next;
...
LAB_0812271c:
    if (uVar4 <= uVar6 + 1) {
      uVar6 = uVar5 * 2;
      ppLVar9 = (LHASH_NODE **)CRYPTO_realloc(lh->b,uVar5 << 3,"lhash.c",0x15b);
...
LAB_08122790:
      plVar10 = (lhash_node_st *)CRYPTO_malloc(0xc,"lhash.c",0xc1);
