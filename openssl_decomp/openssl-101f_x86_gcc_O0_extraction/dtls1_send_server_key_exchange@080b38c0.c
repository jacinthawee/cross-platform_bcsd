          ...
          if (((*(byte *)(*(int *)(*(int *)(param_1 + 0x58) + 0x344) + 0x20) & 2) == 0) ||
            ...
            if (local_90 != 0) {
              ...
              sVar13 = EC_POINT_point2oct(group,pEVar8,POINT_CONVERSION_UNCOMPRESSED,(uchar *)0x0,0,
                                          (BN_CTX *)0x0);
              local_9c = (uchar *)CRYPTO_malloc(sVar13,"d1_srvr.c",0x4df);
              ctx = BN_CTX_new();
              if ((local_9c == (uchar *)0x0) || (ctx == (BN_CTX *)0x0)) {
                ERR_put_error(0x14,0x10b,0x41,"d1_srvr.c",0x4e3);
                goto LAB_080b40f0;
              }
              pEVar8 = EC_KEY_get0_public_key(pEVar7);
              local_a0 = EC_POINT_point2oct(group,pEVar8,POINT_CONVERSION_UNCOMPRESSED,local_9c,
                                            sVar13,ctx);
              if (local_a0 != 0) {
                BN_CTX_free(ctx);
                local_64[0] = (BIGNUM *)0x0;
...
LAB_080b39d2:
      ...
      if (iVar3 == 0) {
        ...
        if ((uVar15 & 0x80) != 0) {
          *puVar14 = '\x03';
          puVar14[1] = '\0';
          puVar14[3] = (uchar)local_a0;
          puVar14[2] = (uchar)local_90;
          memcpy(puVar14 + 4,local_9c,local_a0);
          CRYPTO_free(local_9c);
          puVar14 = puVar14 + 4 + local_a0;
        }
        if ((uVar15 & 0x100) != 0) {
