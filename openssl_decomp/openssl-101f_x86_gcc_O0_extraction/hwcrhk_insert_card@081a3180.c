...

{
  ...
  if (param_4 == 0) {
    ...
    if (param_3 != (UI_METHOD **)0x0) goto LAB_081a31d0;
LAB_081a332c:
    if (HWCRHK_lib_error_code == 0) {
      HWCRHK_lib_error_code = ERR_get_next_error_library();
    }
    ERR_put_error(HWCRHK_lib_error_code,0x68,0x6c,"e_chil.c",0x502);
    uVar2 = 0xffffffff;
    goto LAB_081a326f;
  }
...
LAB_081a336c:
    if (method == (UI_METHOD *)0x0) goto LAB_081a332c;
  }
  else {
LAB_081a31d0:
    method = *param_3;
