...
joined_r0x08157669:
          ...
          if (!bVar12) {
            if (*name == 'C') {
              ...
              if (((bVar10) && (bVar10 = name[2] == 'S', bVar10)) &&
                 (bVar10 = name[3] == '\0', bVar10)) goto LAB_08157420;
              iVar1 = 6;
              pbVar7 = __s;
              pbVar5 = (byte *)0x822eff8;
              do {
                if (iVar1 == 0) break;
                iVar1 = iVar1 + -1;
                bVar10 = *pbVar7 == *pbVar5;
      ...
      if ((bVar10) && (*name == 'C')) {
LAB_08157405:
        if ((name[1] == 'M') && ((name[2] == 'S' && (name[3] == '\0')))) goto LAB_08157420;
      }
    }
LAB_081573a0:
    CRYPTO_free(__s);
