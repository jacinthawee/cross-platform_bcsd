...
LAB_0819da13:
      ...
      param_2 = (uchar *)CRYPTO_malloc(iVar2 + 1,"e_4758cca.c",0x345);
...
LAB_0819d934:
      ...
      uVar3 = 0;
      if (param_1 != 4) goto LAB_0819d8d8;
      param_2 = (uchar *)CRYPTO_malloc(iVar2 + 1,"e_4758cca.c",0x337);
      if (param_2 != (uchar *)0x0) goto LAB_0819d91f;
      local_5c = param_2;
      if (CCA4758_lib_error_code == 0) {
        CCA4758_lib_error_code = ERR_get_next_error_library();
      }
