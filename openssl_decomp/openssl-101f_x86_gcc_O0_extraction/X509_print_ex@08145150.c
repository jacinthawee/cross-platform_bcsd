...

{
  ...
  if (((cflag & 1) != 0) ||
    ...
    if ((cflag & 2) == 0) {
      ...
      iVar7 = BIO_printf(bp,"%8sVersion: %lu (0x%lx)\n",&DAT_081ec74a,lVar9 + 1,lVar9);
      if (iVar7 < 1) goto LAB_08145280;
    }
    if ((cflag & 4) == 0) {
      ...
      if (0 < iVar7) {
        ...
        if (a->length < 5) {
          ...
          puVar11 = &DAT_081ec74a;
          if (a->type == 0x102) {
            lVar9 = -lVar9;
            puVar11 = &DAT_0823b414;
          }
        ...
        iVar7 = BIO_printf(bp,"\n%12s%s",&DAT_081ec74a,pcVar4);
        if (0 < iVar7) {
          iVar7 = 0;
          do {
            if (a->length <= iVar7) goto LAB_081451bc;
            uVar5 = 10;
            if (a->length != iVar7 + 1) {
              uVar5 = 0x3a;
            }
...
LAB_081451bc:
      if ((cflag & 8) == 0) {
        ...
        if ((0 < iVar7) && (iVar7 = i2a_ASN1_OBJECT(bp,pXVar2->algorithm), 0 < iVar7)) {
          ...
          if (0 < iVar7) goto LAB_081451c8;
        }
      }
      else {
LAB_081451c8:
        if ((cflag & 0x10) == 0) {
          iVar7 = BIO_printf(bp,"        Issuer:%c",(int)local_39);
          if (0 < iVar7) {
            pXVar8 = X509_get_issuer_name(x);
            iVar7 = X509_NAME_print_ex(bp,pXVar8,uVar12,nmflag);
            if ((-1 < iVar7) && (iVar7 = BIO_write(bp,&DAT_081f11d3,1), 0 < iVar7))
            goto LAB_081451d4;
          }
        }
        else {
...
LAB_0814565d:
            ...
            if (pAVar3->type == 0x17) {
              ...
              if (pAVar3->type != 0x18) goto LAB_08145522;
              iVar7 = ASN1_GENERALIZEDTIME_print(bp,pAVar3);
            }
            if (iVar7 == 0) goto LAB_08145280;
            iVar7 = BIO_write(bp,&DAT_081f11d3,1);
            if (iVar7 < 1) {
              uVar12 = 0;
              goto LAB_08145228;
            }
          ...
          if ((cflag & 0x40) == 0) {
            iVar7 = BIO_printf(bp,"        Subject:%c",(int)local_39);
            if (0 < iVar7) {
...
LAB_081451ec:
            if ((cflag & 0x80) == 0) {
              ...
              if ((((iVar7 < 1) ||
                   (iVar7 = BIO_printf(bp,"%12sPublic Key Algorithm: ",&DAT_081ec74a), iVar7 < 1))
                  || (iVar7 = i2a_ASN1_OBJECT(bp,pXVar1->key->algor->algorithm), iVar7 < 1)) ||
                 (iVar7 = BIO_puts(bp,"\n"), iVar7 < 1)) goto LAB_08145280;
