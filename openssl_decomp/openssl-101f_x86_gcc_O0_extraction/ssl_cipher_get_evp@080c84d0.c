        ...
        if (0x40 < uVar7) {
          if (uVar7 == 0x400) {
            ...
            if (uVar7 == 0x100) {
              ...
              if (uVar7 != 0x80) goto LAB_080c8676;
              iVar2 = 7;
            }
          }
            ...
            if (uVar7 != 0x800) goto LAB_080c8676;
            iVar2 = 0xb;
          }
          goto LAB_080c86d0;
        }
...
LAB_080c86d9:
      ...
      if ((iVar2 - 1U < 0x20) && (uVar7 = (uint)(char)(&DAT_082001ff)[iVar2], uVar7 < 7)) {
...
LAB_080c8764:
                if (iVar2 == 0x40) {
                  if (*(int *)(iVar1 + 0x18) != 2) goto LAB_080c8780;
                  pEVar6 = EVP_get_cipherbyname("AES-128-CBC-HMAC-SHA1");
                  if (pEVar6 != (EVP_CIPHER *)0x0) goto LAB_080c885e;
                  iVar2 = *(int *)(iVar1 + 0x14);
                }
...
LAB_080c860b:
          ...
          if ((uVar4 & 0x200000) != 0) goto LAB_080c8737;
        }
      }
    }
  }
