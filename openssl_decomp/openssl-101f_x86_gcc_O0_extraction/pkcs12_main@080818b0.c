...
LAB_08081a18:
      ...
      if (pcVar24 == (char *)0x0) goto LAB_08081a58;
      iVar11 = iVar11 + 4;
    } while( true );
  }
  local_171 = false;
...
LAB_08082549:
    ...
    if ((local_171 != false) || (local_172 != '\0')) goto LAB_080823ed;
  }
  else {
LAB_080823d1:
    local_16c = local_110;
    if (local_110 == (char *)0x0) goto LAB_08082549;
    local_160 = local_110;
    bVar9 = true;
LAB_080823ed:
  ...
  if (local_168 != (char *)0x0) {
    ...
    pcVar25 = local_168;
    if (local_188 != (BIO *)0x0) goto LAB_080820c5;
LAB_080826e5:
    bp = (BIO *)0x0;
...
LAB_08082737:
  ...
  if (local_172 == '\0') {
    ...
    if ((bVar9) ||
      ...
      if (bVar10) {
        if ((*local_160 == '\0') && (iVar11 = PKCS12_verify_mac(p12,(char *)0x0,0), iVar11 != 0)) {
          pcVar24 = (char *)0x0;
          if (bVar6) {
            pcVar24 = local_16c;
          }
LAB_08082657:
        ...
        iVar11 = PKCS12_verify_mac(p12,local_160,-1);
        pcVar24 = local_16c;
        if (iVar11 != 0) goto LAB_08082657;
        pcVar24 = "Mac verify error: invalid password?\n";
      }
      else {
LAB_0808266d:
        uVar19 = 0;
        iVar11 = dump_certs_keys_p12(bp,p12,local_16c,0xffffffff,local_184,local_110);
        if (iVar11 != 0) goto LAB_08082379;
...
LAB_080824ba:
      ...
      if (local_184 == (EVP_PKEY *)0x0) goto LAB_08081f0b;
      if (uVar18 != 0) {
        st = (_STACK *)0x0;
        local_180 = (X509 *)0x0;
        goto LAB_0808216b;
      ...
      if (st == (_STACK *)0x0) {
        ...
        for (iVar11 = 0; iVar16 = sk_num(st), iVar11 < iVar16; iVar11 = iVar11 + 1) {
          ...
          if (iVar16 != 0) {
            ...
            sk_delete(st,iVar11);
            if (local_180 != (X509 *)0x0) goto LAB_0808216b;
            break;
          }
        }
        uVar19 = 1;
...
LAB_08082339:
      ...
      if (st == (_STACK *)0x0) goto LAB_08081f0b;
      local_184 = (EVP_PKEY *)0x0;
      local_180 = (X509 *)0x0;
LAB_0808216b:
      if (local_148 == 0) {
LAB_080821d1:
        if (bVar7) {
          ...
          if (ctx != (X509_STORE *)0x0) {
            ...
            X509_STORE_CTX_init(&local_10c,ctx,local_180,(stack_st_X509 *)0x0);
...
LAB_080821dd:
          ...
          p12 = PKCS12_create(local_16c,local_134,local_184,local_180,(stack_st_X509 *)st,0x92,
                              local_11c,local_130,-1,local_17c);
          if (p12 == (PKCS12 *)0x0) {
            uVar19 = 1;
            ERR_print_errors(bio_err);
          }
            ...
            if (local_144 != -1) {
              PKCS12_set_mac(p12,local_160,-1,(uchar *)0x0,0,local_144,md_type);
            }
            uVar19 = 0;
        ...
        p_Var12 = (_STACK *)load_certs(bio_err,local_148,3,0,uVar19,"certificates from certfile");
        if (p_Var12 != (_STACK *)0x0) goto LAB_080821b5;
        uVar19 = 1;
        p12 = (PKCS12 *)0x0;
      }
LAB_08082331:
      if (local_184 != (EVP_PKEY *)0x0) goto LAB_08082339;
    }
    if (st != (_STACK *)0x0) {
    ...
    if (p12 != (PKCS12 *)0x0) goto LAB_08082379;
  }
LAB_08081f10:
...
LAB_08081de9:
  uVar19 = 1;
LAB_08081dee:
  if ((local_172 != '\0') || (local_171 != false)) goto LAB_08081f10;
  goto LAB_08081e04;
}
