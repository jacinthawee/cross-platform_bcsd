...
LAB_08085420:
        usage();
        if (local_5c == (EVP_PKEY_CTX *)0x0) goto LAB_08084fe6;
        bp = (BIO *)0x0;
        pBVar11 = (BIO *)0x0;
        goto LAB_08085435;
      }
      ...
      if (bVar15) {
        if (param_1 == 1) goto LAB_08085420;
        local_58 = ppcVar10[1];
        param_1 = param_1 + -2;
        ppcVar10 = ppcVar10 + 2;
joined_r0x0808511d:
        if (param_1 < 1) goto LAB_08085158;
        goto LAB_0808511f;
      }
      iVar7 = 9;
      pcVar12 = pcVar18;
      ...
      if (bVar15) {
        param_1 = param_1 + -1;
        if (param_1 == 0) goto LAB_08085420;
        ppcVar1 = ppcVar10 + 1;
        local_24 = (void *)0x0;
        pcVar18 = ppcVar10[1];
...
LAB_08085870:
                  ...
                  if (0x20 < local_50) {
                    if (local_50 == 0x200) {
                      ...
                      if (local_50 != 0x100) goto LAB_08085361;
...
LAB_08085361:
            ...
            else if (local_48 == 1) goto LAB_080858cf;
        ...
        if (param_1 != 0) {
          ...
          if (local_5c == (EVP_PKEY_CTX *)0x0) {
            ...
            if (pEVar8 == (EVP_PKEY *)0x0) {
              ...
              EVP_PKEY_free(pEVar8);
              ppcVar10 = ppcVar1;
              if ((0 < iVar7) || (ERR_print_errors(pBVar11), iVar7 != 0)) goto LAB_08085115;
            }
          }
        }
        goto LAB_08085420;
...
LAB_08084ff7:
  ...
  a = (BIO *)0x0;
  uVar13 = 1;
  if (local_2c == (uchar *)0x0) goto LAB_0808502a;
LAB_0808500e:
...
LAB_08085ab1:
  ...
  if ((local_54 == (char *)0x0) || (local_50 == 0x10)) {
    ...
    if (local_50 != 0x400) {
      ...
      if (pBVar11 != (BIO *)0x0) goto LAB_0808563a;
      uVar13 = 1;
      bp = (BIO *)0x0;
...
LAB_0808563a:
    ...
    if (local_54 != (char *)0x0) {
      ...
      if (a == (BIO *)0x0) {
        ...
        BIO_free(a);
        if (0 < (int)local_58) goto LAB_080856b9;
        uVar13 = 1;
        a = (BIO *)0x0;
...
LAB_08085797:
        if ((iVar7 < 1) ||
           (a = (BIO *)CRYPTO_malloc((int)local_24,"pkeyutl.c",0x15b), a == (BIO *)0x0))
        goto LAB_0808593f;
        if (local_50 == 0x100) {
...
LAB_08085809:
          ...
          if (0x100 < local_50) {
            if (local_50 == 0x200) {
              ...
              if (local_50 != 0x400) goto LAB_08085941;
        ...
        if (0x100 < local_50) {
          if (local_50 == 0x200) {
            ...
            if (local_50 != 0x400) goto LAB_0808593f;
...
LAB_080851af:
  ...
  BIO_free(pBVar11);
  BIO_free_all(bp);
  if (local_2c != (uchar *)0x0) goto LAB_0808500e;
  goto LAB_0808501a;
}
