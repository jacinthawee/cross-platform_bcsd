...

{
  ...
  iVar3 = 0;
  if (a == (RSA *)0x0) goto LAB_0814fdcc;
...
LAB_0814fda0:
    ...
    if (val_00 == (ASN1_STRING **)0x0) goto LAB_0814fda0;
...
LAB_0814fdf0:
      ...
      *ppAVar1 = pAVar4;
      ...
      pAVar5 = ASN1_TYPE_new();
      *(ASN1_TYPE **)(iVar3 + 4) = pAVar5;
      if (pAVar5 == (ASN1_TYPE *)0x0) goto LAB_0814fdf0;
      **(undefined4 **)(val_00[1]->length + 4) = 5;
      ...
      local_1f0 = (uchar *)CRYPTO_malloc(sVar6,"n_pkey.c",0xac);
...
LAB_0814fd8b:
        ...
        *(uchar **)(val[2] + 8) = local_1f0;
        ...
        local_1f0 = (uchar *)CRYPTO_malloc(iVar7,"n_pkey.c",0xb6);
        if (local_1f0 == (uchar *)0x0) {
          iVar16 = 0xb8;
          iVar7 = 0x41;
          goto LAB_0814fd8b;
