...

{
  ...
  if (local_24 == (_STACK *)0x0) {
    ...
    while( true ) {
      ...
      if (local_34 == (_STACK *)0x0) goto LAB_0817327d;
        ...
        if (bVar14) {
          ...
          if (bVar14) {
            ...
            if (p_Var6 == (_STACK *)0x0) {
              ...
              if (pGVar8 != (GENERAL_NAMES *)0x0) goto LAB_0817315c;
            }
            goto LAB_08173256;
          }
        }
...
LAB_0817327d:
    ...
    if ((p_Var6 == (_STACK *)0x0) || (iVar3 = sk_push(p_Var6,a), iVar3 == 0)) goto LAB_081734a8;
