...

{
  ...
  if (param_1->blinding == (BN_BLINDING *)0x0) {
    ...
    pBVar2 = param_1->blinding;
    if (param_1->blinding != (BN_BLINDING *)0x0) goto LAB_0810952e;
    mode_00 = RSA_setup_blinding(param_1,param_3);
    param_1->blinding = mode_00;
    pBVar2 = mode_00;
    if (mode_00 != (BN_BLINDING *)0x0) goto LAB_0810952e;
  }
  else {
LAB_0810952e:
      ...
      *param_2 = 0;
      if (pBVar2 == (BN_BLINDING *)0x0) {
        if (!bVar1) {
          ...
          pBVar2 = param_1->mt_blinding;
          if (param_1->mt_blinding != (BN_BLINDING *)0x0) goto LAB_081095b2;
        }
        mode_00 = RSA_setup_blinding(param_1,param_3);
