...

{
  ...
  *param_3 = uVar1;
  ...
  uVar20 = *(uint *)(&DAT_08236640 + (uVar5 & 0xff) * 4) ^
           *(uint *)(&Camellia_SBOX + (uVar5 >> 0x18) * 4) ^
           *(uint *)(&DAT_08236e40 + (uVar5 >> 8 & 0xff) * 4) ^
           *(uint *)(&DAT_08236a40 + (uVar5 >> 0x10 & 0xff) * 4);
  uVar5 = uVar20 ^ *(uint *)(&Camellia_SBOX + (uVar19 & 0xff) * 4) ^
                   *(uint *)(&DAT_08236a40 + (uVar19 >> 0x18) * 4) ^
                   *(uint *)(&DAT_08236640 + (uVar19 >> 8 & 0xff) * 4) ^
                   *(uint *)(&DAT_08236e40 + (uVar19 >> 0x10 & 0xff) * 4);
  uVar10 = uVar10 ^ uVar5;
  uVar5 = (uVar20 >> 8 | uVar20 << 0x18) ^ uVar14 ^ uVar5;
  uVar14 = uVar10 ^ 0xb67ae858;
  uVar19 = uVar5 ^ 0x4caa73b2;
  uVar14 = *(uint *)(&DAT_08236640 + (uVar14 & 0xff) * 4) ^
           *(uint *)(&Camellia_SBOX + (uVar14 >> 0x18) * 4) ^
           *(uint *)(&DAT_08236e40 + (uVar14 >> 8 & 0xff) * 4) ^
           *(uint *)(&DAT_08236a40 + (uVar14 >> 0x10 & 0xff) * 4);
  ...
  uVar20 = uVar14 ^ *(uint *)(&Camellia_SBOX + (uVar20 & 0xff) * 4) ^
                    *(uint *)(&DAT_08236a40 + (uVar20 >> 0x18) * 4) ^
                    *(uint *)(&DAT_08236640 + (uVar20 >> 8 & 0xff) * 4) ^
                    *(uint *)(&DAT_08236e40 + (uVar20 >> 0x10 & 0xff) * 4);
  uVar10 = uVar10 ^ uVar3 ^ uVar20;
  uVar20 = (uVar14 >> 8 | uVar14 << 0x18) ^ uVar4 ^ uVar5 ^ uVar20;
  uVar23 = uVar20 ^ 0xf1d36f1c;
  uVar5 = uVar10 ^ 0x54ff53a5;
  uVar14 = *(uint *)(&DAT_08236640 + (uVar5 & 0xff) * 4) ^
           *(uint *)(&Camellia_SBOX + (uVar5 >> 0x18) * 4) ^
           *(uint *)(&DAT_08236e40 + (uVar5 >> 8 & 0xff) * 4) ^
           *(uint *)(&DAT_08236a40 + (uVar5 >> 0x10 & 0xff) * 4);
  uVar5 = *(uint *)(&Camellia_SBOX + (uVar23 & 0xff) * 4) ^
          *(uint *)(&DAT_08236a40 + (uVar23 >> 0x18) * 4) ^
          *(uint *)(&DAT_08236640 + (uVar23 >> 8 & 0xff) * 4) ^
          *(uint *)(&DAT_08236e40 + (uVar23 >> 0x10 & 0xff) * 4) ^ uVar14;
  ...
  if (param_1 != 0x80) {
    ...
    uVar23 = *(uint *)(&DAT_08236640 + (uVar14 & 0xff) * 4) ^
             *(uint *)(&Camellia_SBOX + (uVar14 >> 0x18) * 4) ^
             *(uint *)(&DAT_08236e40 + (uVar14 >> 8 & 0xff) * 4) ^
             *(uint *)(&DAT_08236a40 + (uVar14 >> 0x10 & 0xff) * 4);
    uVar14 = *(uint *)(&Camellia_SBOX + (uVar19 & 0xff) * 4) ^
             *(uint *)(&DAT_08236a40 + (uVar19 >> 0x18) * 4) ^
             *(uint *)(&DAT_08236640 + (uVar19 >> 8 & 0xff) * 4) ^
             *(uint *)(&DAT_08236e40 + (uVar19 >> 0x10 & 0xff) * 4) ^ uVar23;
    ...
    uVar25 = uVar23 ^ *(uint *)(&Camellia_SBOX + (uVar25 & 0xff) * 4) ^
                      *(uint *)(&DAT_08236a40 + (uVar25 >> 0x18) * 4) ^
             *(uint *)(&DAT_08236640 + (uVar25 >> 8 & 0xff) * 4) ^
             *(uint *)(&DAT_08236e40 + (uVar25 >> 0x10 & 0xff) * 4);
    param_3[7] = uVar24;
