...

{
  ...
  cVar1 = it->itype;
  if (cVar1 != '\0') {
    if (val == (ASN1_VALUE *)0x0) goto switchD_08148a20_caseD_0;
    if (pvVar2 != (void *)0x0) goto LAB_0814894a;
    switch(cVar1) {
    default:
      goto switchD_08148a20_caseD_0;
    case '\x01':
    case '\x06':
      goto switchD_08148a20_caseD_1;
    case '\x02':
      goto switchD_08148a20_caseD_2;
    case '\x05':
      goto switchD_08148a20_caseD_5;
    }
  }
  if (pvVar2 == (void *)0x0) {
switchD_08148c00_caseD_0:
...
LAB_0814894a:
    ...
    if (local_40 == (code *)0x0) {
      switch(cVar1) {
      case '\0':
        goto switchD_08148c00_caseD_0;
      case '\x01':
      case '\x06':
switchD_08148a20_caseD_1:
        iVar6 = asn1_do_lock(local_30,-1,it);
        if (0 < iVar6) goto switchD_08148a20_caseD_0;
...
LAB_08148be3:
          if (local_40 != (code *)0x0) goto LAB_08148a6d;
        }
        break;
      case '\x03':
        goto switchD_08148c00_caseD_3;
      case '\x04':
        goto switchD_08148c00_caseD_4;
      case '\x05':
        goto switchD_08148a20_caseD_5;
      default:
        goto switchD_08148a20_caseD_0;
...
LAB_08148b2f:
      ...
      case '\x02':
        ...
        if (iVar6 == 2) goto switchD_08148a20_caseD_0;
        iVar6 = asn1_get_choice_selector(local_30,it);
        if ((-1 < iVar6) && (iVar6 < it->tcount)) goto LAB_08148c38;
        break;
      case '\x03':
switchD_08148c00_caseD_3:
        if (*(code **)((int)pvVar2 + 4) != (code *)0x0) {
          (**(code **)((int)pvVar2 + 4))(val);
        }
        goto switchD_08148a20_caseD_0;
      case '\x04':
switchD_08148c00_caseD_4:
