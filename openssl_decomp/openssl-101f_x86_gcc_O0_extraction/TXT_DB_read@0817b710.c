...

{
  ...
  if (((str == (BUF_MEM *)0x0) || (iVar2 = BUF_MEM_grow(str,0x200), iVar2 == 0)) ||
    ...
    if (p_Var3 != (_STACK *)0x0) {
      pplVar4 = (lhash_st_OPENSSL_STRING **)CRYPTO_malloc(num * 4,"txt_db.c",0x5e);
      ptr->index = pplVar4;
      if (pplVar4 != (lhash_st_OPENSSL_STRING **)0x0) {
        p_Var5 = (_func_4743 *)CRYPTO_malloc(num * 4,"txt_db.c",0x60);
        ptr->qual = p_Var5;
          ...
          do {
            if (iVar2 == 0) {
              *str->data = '\0';
              ...
              pcVar7 = str->data;
              if (*pcVar7 == '\0') goto LAB_0817ba40;
              pcVar9 = pcVar7;
              if (*pcVar7 != '#') goto LAB_0817b8eb;
            }
            else {
              len = len + 0x200;
...
LAB_0817b8eb:
              ...
              if (pcVar9[iVar2 + -1] == '\n') {
                pcVar9[iVar2 + -1] = '\0';
                data = (undefined4 *)CRYPTO_malloc(iVar2 + num * 4 + 4,"txt_db.c",0x7e);
