...
LAB_0813c63f:
    if ((param_2 & 0x80) == 0) {
      if ((param_2 & 0x20) == 0) {
        if (0x1d < iVar3 - 1U) {
LAB_0813c7e0:
          if ((param_2 & 0x100) != 0) goto LAB_0813c64b;
          goto LAB_0813c7f0;
        }
        local_64 = (uint)(char)tag2nbyte[iVar3];
        if (local_64 == 0xffffffff) goto LAB_0813c7e0;
        if ((param_2 & 0x10) != 0) {
          if (local_64 == 0) {
            local_64 = 1;
          }
...
LAB_0813c912:
                  ...
                  if ((bVar9 & 0x61) == 0) goto LAB_0813c912;
                  if ((bVar9 & 8) == 0) {
                    iVar11 = 2;
                  }
                  else {
...
LAB_0813cf95:
                    ...
                    if ((bVar9 & 0x61) == 0) goto LAB_0813cf95;
                    if ((bVar9 & 8) == 0) {
                      iVar11 = 2;
                    }
                    else {
...
LAB_0813cf5d:
                      ...
                      if ((bVar9 & 0x61) == 0) goto LAB_0813cf5d;
                      if ((bVar9 & 8) == 0) {
                        iVar11 = 2;
                      }
                      else {
...
LAB_0813cf25:
                        ...
                        if ((bVar9 & 0x61) == 0) goto LAB_0813cf25;
                        if ((bVar9 & 8) == 0) {
                          iVar11 = 2;
                        }
                        else {
...
LAB_0813ceed:
                          ...
                          if ((bVar9 & 0x61) == 0) goto LAB_0813ceed;
                          if ((bVar9 & 8) == 0) {
                            iVar11 = 2;
                          }
                          else {
...
LAB_0813ceb3:
                            ...
                            if ((bVar12 & 0x61) == 0) goto LAB_0813ceb3;
                            if ((bVar12 & 8) == 0) {
                              local_60 = local_60 + 2;
                              goto LAB_0813ca53;
                            }
...
LAB_0813ce8d:
                  ...
                  if ((bVar9 & 0x61) == 0) goto LAB_0813ce8d;
                  if ((bVar9 & 8) == 0) {
                    iVar11 = 2;
                  }
                  else {
...
LAB_0813d211:
                  ...
                  bVar9 = bVar12 & char_type[local_31[1]];
                  if ((bVar9 & 0x61) == 0) goto LAB_0813d211;
                  if ((bVar9 & 8) == 0) {
                    iVar11 = 2;
                  }
                  else {
...
LAB_0813d1d5:
                  ...
                  bVar9 = bVar12 & char_type[local_31[2]];
                  if ((bVar9 & 0x61) == 0) goto LAB_0813d1d5;
                  if ((bVar9 & 8) == 0) {
                    iVar11 = 2;
                  }
                  else {
...
LAB_0813d1f3:
                  ...
                  bVar9 = bVar12 & char_type[local_31[3]];
                  if ((bVar9 & 0x61) == 0) goto LAB_0813d1f3;
                  if ((bVar9 & 8) == 0) {
                    iVar11 = 2;
                  }
                  else {
...
LAB_0813d1b7:
                  ...
                  bVar9 = bVar12 & char_type[local_2d];
                  if ((bVar9 & 0x61) == 0) goto LAB_0813d1b7;
                  if ((bVar9 & 8) == 0) {
                    iVar11 = 2;
                  }
                  else {
...
LAB_0813ca53:
            if (pbVar15 == pbVar14) goto LAB_0813ca61;
          }
          iVar6 = do_esc_char_constprop_6(0);
          if (iVar6 < 0) goto LAB_0813c6f8;
...
LAB_0813ca61:
      ...
      if (bVar2) {
        local_60 = local_60 + 2;
        if (param_1 == (BIO *)0x0) goto LAB_0813c6fd;
        iVar3 = BIO_write(param_1,&DAT_0823b5a9,1);
        if (iVar3 != 1) goto LAB_0813c6f8;
      }
      else if (param_1 == (BIO *)0x0) goto LAB_0813c6fd;
      iVar3 = (param_3.asn1_string)->length;
      pbVar8 = (param_3.asn1_string)->data;
      pbVar15 = pbVar8 + iVar3;
      if (pbVar8 != pbVar15) {
            ...
            if (0 < iVar6) {
              ...
              do {
                while( true ) {
                  ...
                  break;
                  if (((bVar10 & 8) == 0) &&
                     (iVar6 = BIO_write(param_1,&DAT_08226cb6,1), iVar6 != 1)) goto LAB_0813c6f8;
LAB_0813cbdb:
                  iVar6 = BIO_write(param_1,&local_40,1);
                  if (iVar6 != 1) goto LAB_0813c6f8;
                  pbVar13 = pbVar13 + 1;
                  if (pbVar16 == pbVar13) goto LAB_0813cc04;
                }
                if ((bVar10 & 6) == 0) {
                  if ((bVar9 != 0x5c) || ((param_2 & 0xf) == 0)) goto LAB_0813cbdb;
                  iVar6 = BIO_write(param_1,&DAT_08226cb5,2);
                  if (iVar6 != 2) goto LAB_0813c6f8;
                }
                else {
                  BIO_snprintf(&local_2b,0xb,"\\%02X",(uint)bVar9);
                  iVar6 = BIO_write(param_1,&local_2b,3);
                  if (iVar6 != 3) goto LAB_0813c6f8;
                }
                pbVar13 = pbVar13 + 1;
...
LAB_0813cc04:
      ...
      if ((!bVar2) || (iVar3 = BIO_write(param_1,&DAT_0823b5a9,1), iVar3 == 1)) goto LAB_0813c6fd;
    }
    else {
LAB_0813c64b:
      if (param_1 == (BIO *)0x0) {
        if ((param_2 & 0x200) == 0) {
          ...
          pbVar8 = (byte *)CRYPTO_malloc(local_74,"a_strex.c",0x119);
          if (pbVar8 == (byte *)0x0) goto LAB_0813c6f8;
          local_40 = pbVar8;
...
LAB_0813d2c3:
        ...
        iVar3 = BIO_write(param_1,&DAT_08226cb8,1);
        local_60 = -1;
        if (iVar3 != 1) goto LAB_0813c6fd;
        if ((param_2 & 0x200) != 0) {
          local_3c.type = (param_3.asn1_string)->type;
          local_3c.value = param_3;
          local_74 = i2d_ASN1_TYPE(&local_3c,(uchar **)0x0);
