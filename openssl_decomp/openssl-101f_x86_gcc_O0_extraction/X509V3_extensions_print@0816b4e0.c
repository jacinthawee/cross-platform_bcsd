...

{
  ...
  if (0 < iVar1) {
    ...
    for (iVar1 = 0; iVar2 = sk_num(&exts->stack), iVar1 < iVar2; iVar1 = iVar1 + 1) {
      ...
      if (iVar2 == 0) {
        BIO_printf(out,"%*s",indent + 4,&DAT_081ec74a);
        ASN1_STRING_print(out,ex->value);
      }
      iVar2 = BIO_write(out,&DAT_081f11d3,1);
      if (iVar2 < 1) {
        return 0;
      }
    }
