...

{
  ...
  if (param_2_00 == (byte **)0x0) {
    ...
    __assert_fail("salt_p != NULL","passwd.c",0x1a7,"do_passwd");
  }
  if (param_3_00 == (byte **)0x0) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("salt_malloc_p != NULL","passwd.c",0x1a8,"do_passwd");
  }
  if (param_1_00 == 0) {
    if (param_7 != 0) {
      if (*param_3_00 == (byte *)0x0) {
        pbVar9 = (byte *)CRYPTO_malloc(3,"passwd.c",0x1b2);
        *param_3_00 = pbVar9;
        *param_2_00 = pbVar9;
        if (*param_3_00 != (byte *)0x0) goto LAB_080554d7;
      }
      else {
        pbVar9 = *param_2_00;
LAB_080554d7:
        iVar1 = RAND_pseudo_bytes(pbVar9,2);
        if (-1 < iVar1) {
...
LAB_0805551d:
    if ((param_8 | param_9) != 0) {
      if (*param_3_00 == (byte *)0x0) {
        pbVar9 = (byte *)CRYPTO_malloc(9,"passwd.c",0x1c9);
        *param_3_00 = pbVar9;
        *param_2_00 = pbVar9;
        if (*param_3_00 == (byte *)0x0) {
          uVar8 = 0;
      ...
      iVar1 = RAND_pseudo_bytes(pbVar9,8);
      if (iVar1 < 0) goto LAB_08055e28;
      **param_2_00 = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzpasswd.c"
                     [**param_2_00 & 0x3f];
      (*param_2_00)[1] =
           "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzpasswd.c"
  ...
  if (*param_2_00 == (byte *)0x0) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("*salt_p != NULL","passwd.c",0x1d7,"do_passwd");
  }
  ...
  if (param_6 < local_78) {
    ...
    if (param_6 < local_78) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("strlen(passwd) <= pw_maxlen","passwd.c",0x1e1,"do_passwd");
    }
  }
  if (param_7 == 0) {
    if ((param_8 | param_9) == 0) {
LAB_08055dba:
                    /* WARNING: Subroutine does not return */
      __assert_fail("hash != NULL","passwd.c",0x1ec,"do_passwd");
    }
LAB_08055629:
    pbVar9 = *param_2_00;
    __s = "1";
    ...
    out_buf_16045[0] = 0x24;
    out_buf_16045[1] = 0;
    __strncat_chk(out_buf_16045,__s,4,0x29);
    __strcat_chk(out_buf_16045,&DAT_081ed0d2,0x29);
    __strncat_chk(out_buf_16045,pbVar9,8,0x29);
    puVar11 = (uint *)out_buf_16045;
    do {
      puVar10 = puVar11;
    ...
    if (0xe < (int)puVar11 + (-0x82fbec3 - (uint)CARRY1((byte)uVar3,(byte)uVar3))) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("strlen(out_buf) <= 6 + 8","passwd.c",0x147,__PRETTY_FUNCTION___16054);
    }
    sVar4 = strlen(__s);
    pcVar6 = out_buf_16045 + sVar4 + 2;
    cnt = strlen(pcVar6);
    if (8 < cnt) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("salt_len <= 8","passwd.c",0x14a,__PRETTY_FUNCTION___16054);
    }
    EVP_MD_CTX_init(&local_60);
    pEVar5 = EVP_md5();
    EVP_DigestInit_ex(&local_60,pEVar5,(ENGINE *)0x0);
    EVP_DigestUpdate(&local_60,param_1,local_78);
    EVP_DigestUpdate(&local_60,&DAT_081ed0d2,1);
    ...
    if (pcVar6 != (char *)((int)puVar11 + (-3 - (uint)CARRY1((byte)uVar3,(byte)uVar3)))) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("output == out_buf + strlen(out_buf)","passwd.c",0x187,__PRETTY_FUNCTION___16054
                   );
    }
    *pcVar6 = '$';
    ...
    if (0x28 < (int)puVar11 + (-0x82fbec3 - (uint)CARRY1((byte)uVar3,(byte)uVar3))) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("strlen(out_buf) < sizeof(out_buf)","passwd.c",0x198,__PRETTY_FUNCTION___16054);
    }
    EVP_MD_CTX_cleanup(&local_60);
    puVar7 = out_buf_16045;
  }
  else {
    ...
    if (puVar7 == (byte *)0x0) goto LAB_08055dba;
  }
