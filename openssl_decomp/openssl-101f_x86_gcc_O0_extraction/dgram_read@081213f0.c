...

{
  ...
  local_40 = 0x1c;
  pvVar1 = param_1->ptr;
  if (param_2 == (void *)0x0) goto LAB_08121578;
  ...
  *piVar2 = 0;
  ...
  if ((0 < *(int *)((int)pvVar1 + 0x28)) || (0 < *(int *)((int)pvVar1 + 0x2c))) {
    ...
    local_48 = *(int *)((int)pvVar1 + 0x28) - local_50.tv_sec;
    local_44 = *(int *)((int)pvVar1 + 0x2c) - local_50.tv_usec;
    if (local_44 < 0) {
      local_48 = local_48 + -1;
...
LAB_081214d8:
        if ((local_48 != iVar4) || (*(int *)((int)pvVar1 + 0x34) < local_44)) goto LAB_081214e0;
      }
    }
    else if (iVar4 <= local_48) goto LAB_081214d8;
...
LAB_0812162b:
          ...
          *(int *)((int)pvVar1 + 0x20) = *piVar2;
          ...
          if ((iVar4 == 4) || (iVar4 == 0xb)) goto LAB_0812162b;
        }
        else if (iVar4 - 0x72U < 2) goto LAB_0812162b;
      }
    }
    else {
