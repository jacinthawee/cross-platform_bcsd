...
LAB_080b66c5:
    ...
    if (key_00 == (rsa_st *)0x0) {
      local_2bc = X509_get_pubkey(*(X509 **)(*(int *)(param_1[0x30] + 0x98) + 0x48));
      if (((local_2bc != (EVP_PKEY *)0x0) && (local_2bc->type == 0x198)) &&
         (key_00 = (local_2bc->pkey).rsa, key_00 != (rsa_st *)0x0)) goto LAB_080b6039;
      iVar15 = 0x504;
LAB_080b669b:
...
LAB_080b6760:
      ...
      *(undefined4 *)(iVar2 + 0x10) = uVar3;
      ...
      sVar5 = EC_POINT_point2oct(group,pEVar4,POINT_CONVERSION_UNCOMPRESSED,(uchar *)0x0,0,
                                 (BN_CTX *)0x0);
      puVar6 = (uchar *)CRYPTO_malloc(sVar5,"d1_clnt.c",0x56b);
      c = BN_CTX_new();
