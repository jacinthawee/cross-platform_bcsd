...

{
  ...
  if (param_1 == (_STACK **)0x0) goto switchD_0814848e_caseD_0;
  cVar1 = param_2->itype;
  if (cVar1 != '\0') {
    if (*param_1 == (_STACK *)0x0) goto switchD_0814848e_caseD_0;
    if (pvVar2 != (void *)0x0) goto LAB_08148427;
    switch(cVar1) {
    default:
      goto switchD_0814848e_caseD_0;
    case '\x01':
    case '\x06':
      goto switchD_0814848e_caseD_1;
    case '\x02':
      goto switchD_0814848e_caseD_2;
    case '\x05':
      goto switchD_0814848e_caseD_5;
    }
  }
  if (pvVar2 == (void *)0x0) {
switchD_081486f0_caseD_0:
...
LAB_08148427:
    ...
    if (local_38 == (code *)0x0) {
      switch(cVar1) {
      case '\0':
        goto switchD_081486f0_caseD_0;
      case '\x01':
      case '\x06':
switchD_0814848e_caseD_1:
        iVar7 = asn1_do_lock((ASN1_VALUE **)param_1,-1,param_2);
        if (0 < iVar7) goto switchD_0814848e_caseD_0;
...
joined_r0x081487f6:
          if (local_38 != (code *)0x0) goto LAB_081484cc;
        }
        break;
      case '\x03':
        goto switchD_081486f0_caseD_3;
      case '\x04':
        goto switchD_081486f0_caseD_4;
      case '\x05':
        goto switchD_0814848e_caseD_5;
      default:
        goto switchD_0814848e_caseD_0;
