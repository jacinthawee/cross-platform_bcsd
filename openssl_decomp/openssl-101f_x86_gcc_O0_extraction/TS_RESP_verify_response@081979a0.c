...

{
  ...
  if (1 < uVar6) {
    ...
    if (iVar11 < 1) {
      ...
      local_140 = (char *)CRYPTO_malloc(iVar11,"ts_rsp_verify.c",0x225);
    ...
    if (pAVar9 != (ASN1_INTEGER *)0x0) {
      ...
      while( true ) {
        ...
        if (iVar11 != 0) {
          if (!bVar2) {
            local_120 = CONCAT22(local_120._2_2_,0x2c);
          }
          bVar2 = false;
...
LAB_08197c48:
    ...
    if ((uVar6 & 8) != 0) {
      ...
      if (iVar12 == 0) goto LAB_08197d40;
      uVar6 = *param_1;
    }
    if ((uVar6 & 0x10) != 0) {
      iVar12 = TS_compute_imprint(&local_128,&local_124);
      if ((iVar12 == 0) || (iVar12 = TS_check_imprints(uVar4), iVar12 == 0)) goto LAB_08197d40;
      uVar6 = *param_1;
    }
    if ((uVar6 & 0x20) == 0) {
LAB_08197c70:
