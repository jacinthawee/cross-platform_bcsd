...

{
  ...
  if (((*(byte *)&a->flags & 4) == 0) && ((*(byte *)&n->flags & 4) == 0)) {
    ...
    if (pBVar5 == (BIGNUM *)0x0) goto LAB_081ba20b;
    if (ret != (BIGNUM *)0x0) {
...
joined_r0x081ba05c:
                if ((iVar8 != 0) && (iVar8 = BN_sub(pBVar10,pBVar7,pBVar3), iVar8 != 0)) {
                  if (pBVar2->top == 1) goto LAB_081ba082;
LAB_081b9fd2:
                  iVar8 = BN_mul(pBVar4,pBVar2,local_6c,ctx);
                  goto joined_r0x081b9fe6;
                }
                goto LAB_081b9d16;
              }
              iVar8 = BN_num_bits(pBVar4);
                ...
                if (iVar8 != 0) {
                  ...
                  if ((iVar8 != 0) && (iVar8 = BN_add(pBVar2,pBVar5,pBVar3), iVar8 != 0)) {
                    ...
                    if (-1 < iVar8) {
                      ...
                      pBVar7 = pBVar10;
                      goto joined_r0x081ba05c;
                    }
                    iVar8 = BN_set_word(pBVar2,2);
                    if (iVar8 != 0) goto LAB_081b9fc8;
                  }
                }
                goto LAB_081b9d16;
              }
              iVar8 = BN_div(pBVar2,pBVar10,pBVar4,pBVar3,ctx);
              if (iVar8 == 0) goto LAB_081b9d16;
LAB_081b9fc8:
              if (pBVar2->top != 1) goto LAB_081b9fd2;
LAB_081ba082:
              uVar1 = *pBVar2->d;
              if (uVar1 == 1) {
                pBVar7 = local_6c;
                if (pBVar2->neg != 0) goto LAB_081ba0a1;
              }
              else {
                if (uVar1 == 2) {
                  if (pBVar2->neg != 0) goto LAB_081ba0a1;
...
LAB_081ba0a1:
                  ...
                  if (pBVar7 == (BIGNUM *)0x0) goto LAB_081b9d16;
...
joined_r0x081b9fe6:
              ...
              if (iVar8 == 0) goto LAB_081b9d16;
              local_50 = -local_50;
              if (pBVar10->top == 0) goto LAB_081ba360;
              local_70 = local_6c;
              pBVar7 = pBVar3;
              pBVar3 = pBVar10;
              local_6c = pBVar4;
        ...
        while( true ) {
          if (pBVar4->top == 0) goto LAB_081ba4de;
          iVar8 = 0;
          while (iVar9 = BN_is_bit_set(pBVar4,iVar8), iVar9 == 0) {
            ...
            if ((((0 < local_6c->top) && ((*(byte *)local_6c->d & 1) != 0)) &&
               ...
               (iVar9 = BN_rshift1(local_6c,local_6c), iVar9 == 0)) goto LAB_081b9d16;
          }
          ...
          while (iVar9 = BN_is_bit_set(pBVar3,iVar8), iVar9 == 0) {
            ...
            if ((((0 < local_70->top) && ((*(byte *)local_70->d & 1) != 0)) &&
               ...
               (iVar9 = BN_rshift1(local_70,local_70), iVar9 == 0)) goto LAB_081b9d16;
          }
...
LAB_081ba2da:
      ...
      do {
        ...
        local_48.flags = pBVar4->flags & 0xfffffffeU | local_48.flags & 1U | 6;
        iVar8 = BN_div(pBVar5,pBVar3,&local_48,pBVar2,ctx);
        if (((iVar8 == 0) || (iVar8 = BN_mul(pBVar4,pBVar5,local_70,ctx), iVar8 == 0)) ||
           (iVar8 = BN_add(pBVar4,pBVar4,pBVar10), iVar8 == 0)) goto LAB_081b9d16;
        local_64 = -local_64;
        pBVar6 = pBVar10;
        pBVar7 = pBVar2;
        pBVar10 = local_70;
      } while (pBVar3->top != 0);
      if (local_64 == -1) goto LAB_081ba2da;
    }
    if (((pBVar2->top == 1) && (*pBVar2->d == 1)) && (pBVar2->neg == 0)) {
      local_6c = local_70;
      if ((local_70->neg == 0) && (iVar8 = BN_ucmp(local_70,n), iVar8 < 0)) goto LAB_081ba135;
      goto LAB_081ba159;
    }
...
LAB_081ba159:
    ...
    if (pBVar6 != (BIGNUM *)0x0) goto LAB_081b9d2a;
  }
  else {
