          ...
          if (iVar3 != 0) {
            if (md == (EVP_MD *)0x0) {
              ...
              if (0 < iVar3) {
                ...
                if (local_34 != (EVP_MD *)0x0) goto LAB_08190cda;
...
LAB_08190d8d:
                if ((flags & 0x100) == 0) {
                  if (puVar4[3] == 0) {
                    p_Var10 = sk_new_null();
                    puVar4[3] = p_Var10;
                    if (p_Var10 == (_STACK *)0x0) goto LAB_08190de9;
                  }
                  if ((flags & 0x200) == 0) {
                    local_28 = (_STACK *)0x0;
