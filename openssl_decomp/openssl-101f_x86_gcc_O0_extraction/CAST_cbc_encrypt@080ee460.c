...
LAB_080ee796:
  ...
  switch(uVar9) {
  default:
    goto switchD_080ee69f_caseD_7;
  case 0xfffffff9:
    goto LAB_080ee6e4;
  case 0xfffffffa:
    goto switchD_080ee69f_caseD_fffffffa;
  case 0xfffffffb:
    puVar11 = local_3c;
    goto LAB_080ee6ce;
  case 0xfffffffc:
    goto switchD_080ee69f_caseD_fffffffc;
  case 0xfffffffd:
    puVar11 = local_3c;
    break;
  case 0xffffffff:
