...
LAB_000b5824:
      if ((param_1 == (FILE *)0x0) || (sVar1 = fwrite(&DAT_001621b8,1,1,param_1), sVar1 == 1)) {
...
LAB_000b5ad4:
      ...
      if (local_60[0] == '\0') {
        ...
        local_70 = local_70 + 2;
        if (param_1 == (FILE *)0x0) goto LAB_000b5848;
        sVar1 = fwrite(&DAT_00176720,1,1,param_1);
              ...
              do {
                ...
                if ((uVar9 & 0x61) == 0) {
                  if ((uVar9 & 6) == 0) {
                    ...
                    sVar1 = fwrite(&DAT_001621b4,1,2,param_1);
...
LAB_000b5e6e:
                    ...
                    sVar1 = fwrite(&DAT_001621a8,1,1,param_1);
                    if (sVar1 != 1) goto switchD_000b5b44_caseD_3;
                  }
      ...
      if ((local_60[0] == '\0') || (sVar1 = fwrite(&DAT_00176720,1,1,param_1), sVar1 == 1))
      goto LAB_000b5848;
    }
  }
  else {
