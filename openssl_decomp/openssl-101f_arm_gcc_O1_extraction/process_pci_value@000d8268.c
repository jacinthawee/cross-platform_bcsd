...

{
  ...
  if (pAVar1 == (ASN1_OBJECT *)0x0) {
    if (*param_2 == (ASN1_OBJECT *)0x0) {
      ...
      *param_2 = pAVar1;
      if (pAVar1 != (ASN1_OBJECT *)0x0) goto LAB_000d844c;
      iVar8 = 0x5b;
      iVar5 = 0x6e;
    }
    else {
      ...
      if (pAVar2 == (ASN1_OBJECT *)0x0) {
        ...
        if (*param_4 == (ASN1_OBJECT *)0x0) {
          ...
          *param_4 = pAVar1;
          ...
          if (pAVar1 == (ASN1_OBJECT *)0x0) {
            ERR_put_error(0x22,0x96,0x41,"v3_pci.c",0x78);
        ...
        if (iVar5 == 0) {
          ...
          if (puVar3 == (uchar *)0x0) {
            ...
            puVar4 = (uchar *)CRYPTO_realloc((uchar *)(*param_4)->nid,
                                             (int)((*param_4)->sn + local_830 + 1),"v3_pci.c",0x8b);
            if (puVar4 != (uchar *)0x0) {
          ...
          if (puVar3 == (uchar *)0x0) {
            ...
            if (b == (BIO *)0x0) {
              ...
              do {
                while( true ) {
                  ...
                  puVar3 = (uchar *)CRYPTO_realloc((uchar *)(*param_4)->nid,
                                                   (int)((*param_4)->sn + __n + 1),"v3_pci.c",0xb1);
                  if (puVar3 == (uchar *)0x0) {
                    BIO_free_all(b);
                    goto LAB_000d8570;
                  }
              ...
              BIO_free_all(b);
              if (puVar3 != (uchar *)0x0) goto LAB_000d844c;
LAB_000d8570:
              iVar8 = 0xe4;
              iVar5 = 0x41;
            }
            ...
            if (iVar5 == 0) {
              ...
              puVar3 = (uchar *)CRYPTO_realloc((uchar *)pAVar7->nid,
                                               (int)(pAVar7->sn + local_830 + 1),"v3_pci.c",0xc9);
              if (puVar3 != (uchar *)0x0) {
                pcVar6 = param_1->value;
                (*param_4)->nid = (int)puVar3;
