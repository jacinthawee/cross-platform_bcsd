...

{
  ...
  while (piVar1 = (int *)PTR_ERR_str_reasons_000a7238, iVar8 = ERR_str_reasons._0_4_, iVar6 != 0) {
    (**(code **)(err_fns + 0xc))(puVar7);
    puVar7 = (undefined1 *)((int)puVar7 + 8);
    iVar6 = *(int *)puVar7;
  }
  while (puVar2 = (uint *)PTR_ERR_str_functs_000a723c, puVar7 = err_fns,
  ...
  if (init_8046 == 0) {
    ...
    puVar2 = (uint *)PTR_SYS_str_reasons_000a7244;
    puVar7 = err_fns;
    ...
    puVar4 = PTR_strerror_tab_8044_000a7240;
    if (init_8046 == 0) {
      ...
      iVar8 = 0;
      iVar6 = 1;
      __dest = PTR_strerror_tab_8044_000a7240;
      do {
        while( true ) {
...
LAB_000a7132:
          ...
          iVar8 = iVar8 + 8;
          __dest = __dest + 0x20;
          if (iVar6 == 0x80) goto LAB_000a7188;
        }
        ...
        if (pcVar5 != (char *)0x0) goto LAB_000a7132;
        iVar6 = iVar6 + 1;
