...

{
  ...
  local_64 = s_ENGINE_modexp_001704e4._0_4_;
  uStack_60 = s_ENGINE_modexp_001704e4._4_4_;
  uStack_5c = s_ENGINE_modexp_001704e4._8_4_;
  local_58 = (undefined2)ram0x001704f0;
    ...
    if (param_1 != (BIGNUM *)0x0) {
      if (param_1->dmax == param_4[1]) {
        ...
        if (pBVar1 == (BIGNUM *)0x1) {
          ...
          param_1->top = iVar3;
          if (0 < iVar3) {
            puVar2 = param_1->d + iVar3 + 0x3fffffff;
            do {
              if (*puVar2 != 0) break;
              iVar3 = iVar3 + -1;
              puVar2 = puVar2 + -1;
