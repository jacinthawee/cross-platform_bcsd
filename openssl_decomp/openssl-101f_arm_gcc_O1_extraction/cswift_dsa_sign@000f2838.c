...

{
  ...
  if (ctx == (DSA_SIG *)0x0) goto LAB_000f2898;
  ...
  if (iVar1 == 0) {
    ...
    if (a_02 == (BIGNUM *)0x0) {
      ...
      pDVar6 = (DSA_SIG *)0x0;
      ERR_put_error(CSWIFT_lib_error_code,0x65,0x66,"e_cswift.c",0x348);
      goto LAB_000f2a22;
    }
    ...
    if (pBVar2->dmax < iVar1) {
      ...
      if (pBVar3 != (BIGNUM *)0x0) {
        ...
        if (a->dmax < iVar1) goto LAB_000f2aa0;
        goto LAB_000f28fa;
      }
LAB_000f2a34:
      if (CSWIFT_lib_error_code == 0) {
      ...
      pDVar6 = (DSA_SIG *)0x0;
      ERR_put_error(CSWIFT_lib_error_code,0x65,0x67,"e_cswift.c",0x351);
    }
    else {
      iVar1 = *(int *)(*(int *)(param_3 + 0x10) + 4);
      if (a->dmax < iVar1) {
LAB_000f2aa0:
        ...
        if (pBVar3 == (BIGNUM *)0x0) goto LAB_000f2a34;
      }
LAB_000f28fa:
      ...
      if (a_01->dmax < iVar1) {
        ...
        iVar1 = pBVar3->top;
        if (a_02->dmax < iVar1) goto LAB_000f2a7a;
      }
      else {
        pBVar3 = *(BIGNUM **)(param_3 + 0xc);
        iVar1 = pBVar3->top;
...
LAB_000f2a7a:
      ...
      if (iVar1 == -0x2716) {
        ...
        pDVar6 = (DSA_SIG *)0x0;
        ERR_put_error(CSWIFT_lib_error_code,0x65,0x65,"e_cswift.c",0x368);
      }
      else {
        if (iVar1 == 0) {
          local_78 = param_2;
