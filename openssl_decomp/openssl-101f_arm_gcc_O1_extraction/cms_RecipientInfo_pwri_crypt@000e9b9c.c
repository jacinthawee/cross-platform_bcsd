  ...
  if (ppAVar7[1]->sn == (char *)0x10) {
    ...
    if (a != (X509_ALGOR *)0x0) {
      ...
      if (cipher == (EVP_CIPHER *)0x0) {
        ERR_put_error(0x2e,0xa7,0x94,"cms_pwri.c",0x175);
LAB_000e9c74:
...
LAB_000e9c70:
        ...
        if (iVar1 < 0) {
          cipher = (EVP_CIPHER *)0x0;
          ERR_put_error(0x2e,0xa7,0x66,"cms_pwri.c",0x180);
          goto LAB_000e9c74;
        }
        ...
        if (iVar1 < 0) {
          cipher = (EVP_CIPHER *)0x0;
          ERR_put_error(0x2e,0xa7,6,"cms_pwri.c",0x18c);
          goto LAB_000e9c74;
        }
        if (param_3 == 0) {
          cipher = (EVP_CIPHER *)CRYPTO_malloc(**(int **)(iVar8 + 0xc),"cms_pwri.c",0x1a4);
          if (cipher == (EVP_CIPHER *)0x0) {
            ERR_put_error(0x2e,0xa7,0x41,"cms_pwri.c",0x1a9);
            goto LAB_000e9c74;
          }
          ...
          if (((uint)(iVar8 * 2) <= uVar9) && (__aeabi_uidivmod(uVar9,iVar8), extraout_r1 == 0)) {
            iVar1 = uVar9 + iVar8 * -2;
            pbVar10 = (byte *)CRYPTO_malloc(uVar9,"cms_pwri.c",0xf0);
            EVP_DecryptUpdate(&EStack_b8,pbVar10 + iVar1,&iStack_bc,in + iVar1,iVar8 * 2);
            EVP_DecryptUpdate(&EStack_b8,pbVar10,&iStack_bc,pbVar10 + iVar1 + iVar8,iVar8);
            EVP_DecryptUpdate(&EStack_b8,pbVar10,&iStack_bc,in,iVar1 + iVar8);
            EVP_DecryptInit_ex(&EStack_b8,(EVP_CIPHER *)0x0,(ENGINE *)0x0,(uchar *)0x0,(uchar *)0x0)
            ;
            EVP_DecryptUpdate(&EStack_b8,pbVar10,&iStack_bc,pbVar10,uVar9);
            if (((byte)((pbVar10[3] ^ pbVar10[6]) &
                       (pbVar10[4] ^ pbVar10[1]) & (pbVar10[5] ^ pbVar10[2])) == 0xff) &&
               (uVar11 = (uint)*pbVar10, uVar11 - 4 <= uVar9)) {
              memcpy(cipher,pbVar10 + 4,uVar11);
              OPENSSL_cleanse(pbVar10,uVar9);
              CRYPTO_free(pbVar10);
              *(EVP_CIPHER **)(iVar5 + 0x10) = cipher;
              *(uint *)(iVar5 + 0x14) = uVar11;
          ...
          if ((((uint)(iVar1 * iVar2) < (uint)(iVar1 << 1)) || (0xff < uVar9)) ||
             (cipher = (EVP_CIPHER *)CRYPTO_malloc(iVar1 * iVar2,"cms_pwri.c",0x198),
             cipher == (EVP_CIPHER *)0x0)) goto LAB_000e9c70;
          uVar9 = *(uint *)(iVar5 + 0x14);
          pbVar10 = *(byte **)(iVar5 + 0x10);
          iVar5 = EVP_CIPHER_CTX_block_size(&EStack_b8);
          iVar1 = __udivsi3(uVar9 + 3 + iVar5,iVar5);
          uVar11 = iVar5 * iVar1;
          if (((uint)(iVar5 << 1) <= uVar11) && (uVar9 < 0x100)) {
            *(char *)&cipher->nid = (char)uVar9;
            *(byte *)((int)&cipher->nid + 1) = ~*pbVar10;
            *(byte *)((int)&cipher->nid + 2) = ~pbVar10[1];
            *(byte *)((int)&cipher->nid + 3) = ~pbVar10[2];
            memcpy(&cipher->block_size,pbVar10,uVar9);
            if (uVar9 + 4 <= uVar11 && uVar11 - (uVar9 + 4) != 0) {
              RAND_pseudo_bytes((uchar *)((int)&cipher->block_size + uVar9),(-4 - uVar9) + uVar11);
            }
            EVP_EncryptUpdate(&EStack_b8,(uchar *)cipher,&iStack_bc,(uchar *)cipher,uVar11);
            EVP_EncryptUpdate(&EStack_b8,(uchar *)cipher,&iStack_bc,(uchar *)cipher,uVar11);
  ...
  ERR_put_error(0x2e,0xa7,0xb0,"cms_pwri.c",0x16c);
  pEVar6 = (EVP_CIPHER *)0x0;
LAB_000e9bfa:
