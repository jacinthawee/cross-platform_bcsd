...

{
  ...
  pRVar2 = a;
  if (a == (RSA *)0x0) goto LAB_000c0352;
  val = (undefined4 *)ASN1_item_new((ASN1_ITEM *)&NETSCAPE_PKEY_it);
  if ((val == (undefined4 *)0x0) ||
     (val_00 = (ASN1_STRING **)ASN1_item_new((ASN1_ITEM *)PTR_NETSCAPE_ENCRYPTED_PKEY_it_000c04e0),
        ...
        **(undefined4 **)(val_00[1]->length + 4) = 5;
        if (pp == (uchar **)0x0) {
          pRVar2 = (RSA *)ASN1_item_i2d((ASN1_VALUE *)val_00,(uchar **)0x0,
                                        (ASN1_ITEM *)PTR_NETSCAPE_ENCRYPTED_PKEY_it_000c04e0);
          ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)&NETSCAPE_PKEY_it);
          ASN1_item_free((ASN1_VALUE *)val_00,(ASN1_ITEM *)PTR_NETSCAPE_ENCRYPTED_PKEY_it_000c04e0);
          goto LAB_000c0352;
        }
        pRVar2 = (RSA *)CRYPTO_malloc(sVar3,"n_pkey.c",0xac);
        local_1fc = pRVar2;
        if (pRVar2 == (RSA *)0x0) {
          ERR_put_error(0xd,0xa2,0x41,"n_pkey.c",0xae);
        }
        else {
          *(RSA **)(val[2] + 8) = pRVar2;
          i2d_RSAPrivateKey(a,(uchar **)&local_1fc);
          pRVar2 = (RSA *)CRYPTO_malloc(iVar9,"n_pkey.c",0xb6);
          iVar8 = 0xb8;
          local_1fc = pRVar2;
          if (pRVar2 != (RSA *)0x0) {
              ...
              if (local_204 == 0) {
                ...
                if (sgckey != 0) {
                  ...
                  pRVar2 = (RSA *)EVP_Digest(auStack_12c,sVar3,auStack_12c,(uint *)0x0,pEVar5,
                                             (ENGINE *)0x0);
                  if (pRVar2 == (RSA *)0x0) goto LAB_000c0336;
                  local_11c = s_SGCKEYSALT_00163858._0_4_;
                  uStack_118 = s_SGCKEYSALT_00163858._4_4_;
                  local_204 = 0x1a;
                  local_114 = (undefined2)ram0x00163860;
                }
                pEVar4 = EVP_rc4();
                pEVar5 = EVP_md5();
                ...
                if (pRVar2 != (RSA *)0x0) {
                  ...
                  if (((pRVar2 != (RSA *)0x0) &&
                    ...
                    pRVar2 = (RSA *)ASN1_item_i2d((ASN1_VALUE *)val_00,pp,
                                                  (ASN1_ITEM *)
                                                  PTR_NETSCAPE_ENCRYPTED_PKEY_it_000c04e0);
                  }
                }
              }
              else {
                pRVar2 = (RSA *)0x0;
                ERR_put_error(0xd,0xa2,0x67,"n_pkey.c",0xcc);
              }
              goto LAB_000c0336;
            }
            iVar8 = 0xbe;
