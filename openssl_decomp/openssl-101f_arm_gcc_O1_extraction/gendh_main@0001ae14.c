...
LAB_0001af60:
    ...
    if (iVar4 == 0) {
      ...
      if (*__s1 == '-') {
        if (__s1[1] == '2') {
          if (__s1[2] != '\0') goto LAB_0001af7a;
          iVar1 = 2;
        }
        else {
          if ((__s1[1] != '5') || (__s1[2] != '\0')) goto LAB_0001af7a;
          iVar1 = 5;
        }
LAB_0001af58:
        param_1 = param_1 + -1;
        ppcVar6 = ppcVar6 + 1;
        if (param_1 < 1) goto LAB_0001ae72;
        goto LAB_0001af60;
      }
LAB_0001af7a:
      ...
      if (iVar4 == 0) {
        ...
        if (iVar4 != 0) {
          ...
          if ((iVar4 == 0) || (local_38 < 0)) goto LAB_0001aff2;
          goto LAB_0001ae72;
        }
        param_1 = param_1 + -1;
        if (param_1 != 0) {
...
LAB_0001aece:
    ...
    else if (pcVar8 != (char *)0x0) goto LAB_0001aece;
