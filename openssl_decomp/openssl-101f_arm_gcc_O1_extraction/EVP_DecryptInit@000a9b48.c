...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher != (EVP_CIPHER *)0x0) {
      if (pEVar5 != (EVP_CIPHER *)0x0) goto LAB_000a9b80;
      goto LAB_000a9bb8;
    }
    if (pEVar5 == (EVP_CIPHER *)0x0) goto LAB_000a9d38;
LAB_000a9bf4:
...
LAB_000a9c32:
      if (iVar1 == 0x10) goto LAB_000a9bfe;
    ...
    if (-1 < (int)(uVar6 << 0x1b)) {
      ...
      case 5:
        ...
        break;
      default:
        goto switchD_000a9c6c_caseD_6;
      }
    }
    pEVar5 = ctx->cipher;
    if ((key != (uchar *)0x0) || ((int)(pEVar5->flags << 0x1a) < 0)) {
      iVar1 = (*pEVar5->init)(ctx,key,iv,0);
      if (iVar1 == 0) {
        return 0;
      }
      pEVar5 = ctx->cipher;
...
LAB_000a9d38:
      ...
      if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar5->nid)) goto LAB_000a9bf4;
LAB_000a9b80:
      uVar6 = ctx->flags;
...
LAB_000a9bd6:
      ...
      ctx->flags = 0;
      ctx->key_len = iVar1;
      if (-1 < (int)(uVar6 << 0x19)) goto LAB_000a9bf4;
      if (pEVar5->ctrl == (_func_1094 *)0x0) {
        ...
        if (iVar1 == -1) {
          ...
          if (iVar1 != 1 && iVar1 != 8) goto LAB_000a9c32;
          goto LAB_000a9bfe;
        }
      }
      iVar1 = 0xc4;
      ...
      iVar1 = 0x9e;
      if (cipher != (EVP_CIPHER *)0x0) goto LAB_000a9bd6;
    }
    ERR_put_error(6,0x7b,0x86,"evp_enc.c",iVar1);
switchD_000a9c6c_caseD_6:
    iVar1 = 0;
  }
  return iVar1;
}
