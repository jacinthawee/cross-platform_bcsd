...
LAB_000b4f24:
    if ((int)(flags << 0x18) < 0) {
LAB_000b4f28:
      if ((out == (BIO *)0x0) || (iVar13 = BIO_write(out,&DAT_001621b8,1), iVar13 == 1)) {
        if ((int)(flags << 0x16) < 0) {
...
LAB_000b4f66:
        ...
        if ((0x1d < iVar13 - 1U) || (bVar7 = tag2nbyte[iVar13], bVar7 == 0xff)) {
          if ((int)(flags << 0x17) < 0) goto LAB_000b4f28;
          goto LAB_000b4f60;
        }
        if ((int)(flags << 0x1b) < 0) {
...
LAB_000b51d0:
      ...
      if (acStack_60[0] == '\0') {
        if (out == (BIO *)0x0) goto LAB_000b4f4a;
      }
      else {
        uStack_70 = uStack_70 + 2;
        if (out == (BIO *)0x0) goto LAB_000b4f4a;
        iVar13 = BIO_write(out,&DAT_00176720,1);
              ...
              do {
                ...
                if ((uVar9 & 0x61) == 0) {
                  if ((uVar9 & 6) == 0) {
                    ...
                    iVar4 = BIO_write(out,&DAT_001621b4,2);
...
LAB_000b5562:
                    ...
                    iVar4 = BIO_write(out,&DAT_001621a8,1);
      ...
      if ((acStack_60[0] == '\0') || (iVar13 = BIO_write(out,&DAT_00176720,1), iVar13 == 1))
      goto LAB_000b4f4a;
    }
  }
  else {
