...

{
  ...
  if (param_3 == 0) {
    ...
    param_1[1] = (int)xn;
    if (xn == (X509_NAME **)0x0) goto LAB_000e6f32;
    name = X509_get_issuer_name(param_2);
    iVar2 = X509_NAME_set(xn,name);
    if (iVar2 == 0) goto LAB_000e6f32;
    ...
    if (param_3 != 1) {
      ERR_put_error(0x2e,0x92,0x96,"cms_sd.c",0xf1);
      return 0;
    }
    if (param_2->skid == (ASN1_STRING *)0x0) {
      ERR_put_error(0x2e,0x92,0xa0,"cms_sd.c",0xe8);
      return 0;
    }
...
LAB_000e6f32:
  ERR_put_error(0x2e,0x92,0x41,"cms_sd.c",0xfa);
  return 0;
}
