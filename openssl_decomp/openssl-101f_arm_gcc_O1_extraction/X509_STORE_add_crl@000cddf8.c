...

{
  ...
  x_00 = (X509_OBJECT *)CRYPTO_malloc(8,"x509_lu.c",0x175);
  if (x_00 != (X509_OBJECT *)0x0) {
    (x_00->data).crl = x;
    x_00->type = 2;
    CRYPTO_lock(9,0xb,"x509_lu.c",0x17e);
    if (x_00->type == 1) {
    ...
    if (pXVar1 == (X509_OBJECT *)0x0) {
      ...
      iVar2 = 0;
      CRYPTO_free(x_00);
      ERR_put_error(0xb,0x7d,0x65,"x509_lu.c",0x186);
    }
    CRYPTO_lock(10,0xb,"x509_lu.c",0x18b);
    return iVar2;
  }
  ERR_put_error(0xb,0x7d,0x41,"x509_lu.c",0x178);
  return 0;
}
