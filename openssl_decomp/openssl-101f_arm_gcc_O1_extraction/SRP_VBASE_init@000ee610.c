...

{
  ...
  for (iVar10 = 0; iVar3 = sk_num((_STACK *)db->data), iVar10 < iVar3; iVar10 = iVar10 + 1) {
    ...
    if (**ppcVar4 == 'I') {
      ...
      if (ppcVar5 == (char **)0x0) goto LAB_000ee80c;
...
LAB_000ee920:
        ...
        if (ppcVar5 == (char **)0x0) goto LAB_000ee688;
      }
      else {
        pcVar13 = pcVar6;
        if (pcVar6 == (char *)0x0) {
          for (; iVar3 = sk_num(sk), (int)pcVar13 < iVar3; pcVar13 = pcVar13 + 1) {
            ...
            if (ppcVar5 != (char **)0x0) goto LAB_000ee878;
          }
          goto LAB_000ee920;
        }
        iVar3 = 0;
        do {
          iVar7 = sk_num(sk);
          iVar12 = iVar3 + 1;
          if (iVar7 <= iVar3) goto LAB_000ee920;
...
LAB_000ee8b4:
        if (pcVar6 != (char *)0x0) {
          ...
          ppcVar9[5] = pcVar6;
          if (pcVar6 == (char *)0x0) goto LAB_000ee8ee;
        }
        ...
        if (iVar3 == 0) {
          ...
          local_3c = (_STACK *)0x2;
          if (iVar3 != 0) goto LAB_000ee688;
        }
      }
      else {
        pcVar13 = BUF_strdup(ppcVar4[3]);
        *ppcVar9 = pcVar13;
        if (pcVar13 != (char *)0x0) goto LAB_000ee8b4;
LAB_000ee8ee:
        local_3c = (_STACK *)&DAT_00000004;
      }
...
LAB_000ee94a:
      ...
      do {
        iVar3 = sk_num(sk);
        iVar7 = iVar10 + 1;
        if (iVar3 <= iVar10) goto LAB_000ee94a;
