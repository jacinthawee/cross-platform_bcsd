...

{
  ...
  if ((iVar1 != 0x16) && (iVar1 = OBJ_obj2nid(p7->type), iVar1 != 0x18)) {
    ...
    ERR_put_error(0x21,0x71,0x72,"pk7_doit.c",0x406);
    goto LAB_000ddb48;
  }
  ...
  if (bio != (BIO *)0x0) {
    do {
      ...
      if (local_90 == (EVP_MD_CTX *)0x0) {
        ERR_put_error(0x21,0x71,0x44,"pk7_doit.c",0x41a);
        goto LAB_000ddb48;
      }
...
LAB_000ddb60:
        ...
        if (iVar3 == 0) goto LAB_000ddbc4;
        val = (_STACK *)si->auth_attr;
        if ((val == (_STACK *)0x0) || (iVar3 = sk_num(val), iVar3 == 0)) goto LAB_000ddb78;
        iVar8 = 0;
        local_8c = (uchar *)0x0;
        iVar3 = EVP_DigestFinal_ex(&EStack_84,auStack_6c,&local_88);
        if (iVar3 == 0) goto LAB_000ddbc4;
        b = OBJ_nid2obj(0x33);
        if (b == (ASN1_OBJECT *)0x0) goto LAB_000ddc20;
        goto LAB_000ddc16;
      }
      pEVar2 = EVP_MD_CTX_md(local_90);
      iVar3 = EVP_MD_pkey_type(pEVar2);
      if (iVar3 == iVar1) goto LAB_000ddb60;
      bio = BIO_next(bp);
    } while (bio != (BIO *)0x0);
  }
  iVar1 = 0x413;
...
LAB_000ddc16:
  iVar3 = sk_num(val);
  if (iVar3 <= iVar8) goto LAB_000ddc20;
...
LAB_000ddb78:
            ...
            if (pkey == (EVP_PKEY *)0x0) {
              ...
              if (iVar1 < 1) {
                local_90 = (EVP_MD_CTX *)0xffffffff;
                ERR_put_error(0x21,0x71,0x69,"pk7_doit.c",0x46c);
              }
              else {
...
LAB_000ddbc4:
        ...
        local_90 = (EVP_MD_CTX *)0xffffffff;
        ERR_put_error(0x21,0x71,0x65,"pk7_doit.c",0x449);
      }
      goto LAB_000ddb48;
    }
    goto LAB_000ddc20;
