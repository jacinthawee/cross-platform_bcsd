...

{
  ...
  if (pEVar10 == (EVP_CIPHER_CTX *)0x0) {
    ...
    if (local_a8 == (EVP_CIPHER_CTX *)0x0) {
      pEVar3 = (EVP_CIPHER_CTX *)CRYPTO_malloc(0x8c,"s3_enc.c",0x11d);
      *(EVP_CIPHER_CTX **)(param_1 + 0x8c) = pEVar3;
      if (pEVar3 == (EVP_CIPHER_CTX *)0x0) goto LAB_0004fbf0;
    ...
    if (meth != (COMP_METHOD *)0x0) {
      ...
      *(COMP_CTX **)(param_1 + 0x94) = pCVar2;
      if (pCVar2 != (COMP_CTX *)0x0) goto LAB_0004fa62;
      iVar7 = 0x130;
LAB_0004fc38:
...
LAB_0004fa62:
    ...
    *(undefined *)(iVar7 + 0x5b) = 0;
    ...
    if (pEVar10 == (EVP_CIPHER_CTX *)0x0) {
      pEVar3 = (EVP_CIPHER_CTX *)CRYPTO_malloc(0x8c,"s3_enc.c",0xf8);
...
LAB_0004fbf0:
      ...
      ERR_put_error(0x14,0x81,0x41,"s3_enc.c",0x17f);
      goto LAB_0004fa12;
    }
    pEVar3 = (EVP_CIPHER_CTX *)0x1;
    local_a8 = pEVar10;
...
LAB_0004faca:
    ...
    if (*(int *)(iVar6 + 0x374) < iVar4 + iVar7) goto LAB_0004faca;
  }
