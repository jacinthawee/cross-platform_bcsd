  ...
  if (local_28 != (_STACK *)0x0) {
    ...
    while( true ) {
      ...
      if (*(int *)((int)data + 8) != iVar5) {
        st = sk_new_null();
        if ((st == (_STACK *)0x0) || (iVar5 = sk_push(local_28,st), iVar5 == 0)) goto LAB_000b7bee;
        iVar5 = *(int *)((int)data + 8);
      }
      iVar1 = sk_push(st,data);
      iVar2 = iVar2 + 1;
      if (iVar1 == 0) goto LAB_000b7bee;
    }
    sVar3 = ASN1_item_ex_i2d((ASN1_VALUE **)&local_28,(uchar **)0x0,
                             (ASN1_ITEM *)PTR_X509_NAME_INTERNAL_it_000b7c20,-1,-1);
...
LAB_000b7bee:
  sk_pop_free(local_28,local_sk_X509_NAME_ENTRY_free + 1);
  ERR_put_error(0xd,0xcb,0x41,"x_name.c",0x122);
  return 0xffffffff;
}
