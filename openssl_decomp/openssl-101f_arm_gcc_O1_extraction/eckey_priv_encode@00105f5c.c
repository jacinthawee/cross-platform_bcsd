...
LAB_00105fa8:
      ...
      if (num == 0) {
        ...
        ERR_put_error(0x10,0xd6,0x10,"ec_ameth.c",0x153);
        return (uchar *)0x0;
      }
      penc = (uchar *)CRYPTO_malloc(num,"ec_ameth.c",0x156);
      if (penc == (uchar *)0x0) {
        EC_KEY_set_enc_flags(key,flags);
        ERR_put_error(0x10,0xd6,0x41,"ec_ameth.c",0x15a);
      }
      else {
        local_24 = penc;
  ...
  ERR_put_error(0x10,0xd6,0x8e,"ec_ameth.c",0x144);
  return (uchar *)0x0;
}
