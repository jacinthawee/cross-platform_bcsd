...

{
  ...
  if (param_4 == 0) {
    ERR_put_error(0x10,0x67,100,"ecp_oct.c",0x151);
    return 0;
  }
  bVar1 = *param_3;
  y_bit = bVar1 & 1;
...
LAB_00106d36:
  ...
  if ((bVar1 & 0xfa) == 0) {
    iVar4 = 0x160;
    if ((bVar1 & 1) != 0) goto LAB_00106d36;
    if ((bVar1 & 0xfe) == 0) {
      if (param_4 == 1) {
        uVar5 = EC_POINT_set_to_infinity(param_1,param_2);
        return uVar5;
      }
      ERR_put_error(0x10,0x67,0x66,"ecp_oct.c",0x168);
      return uVar5;
    }
  }
  ...
  if ((ret_00 != (BIGNUM *)0x0) &&
    ...
    if (uVar5 == 2) {
      ...
      if (pBVar3 == (BIGNUM *)0x0) goto LAB_00106e56;
...
LAB_00106e26:
    ...
    if (iVar4 != 0) {
      uVar5 = EC_POINT_is_on_curve(param_1,param_2,param_5);
      if (uVar5 == 0) {
        ERR_put_error(0x10,0x67,0x6b,"ecp_oct.c",0x1a5);
      }
      else {
        uVar5 = 1;
      }
