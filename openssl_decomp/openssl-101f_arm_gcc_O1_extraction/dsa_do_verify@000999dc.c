...

{
  ...
  if (((*(int *)(param_4 + 0xc) == 0) || (*(BIGNUM **)(param_4 + 0x10) == (BIGNUM *)0x0)) ||
     (*(int *)(param_4 + 0x14) == 0)) {
    ERR_put_error(10,0x71,0x65,"dsa_ossl.c",0x13c);
    return 0xffffffff;
  }
  uVar1 = BN_num_bits(*(BIGNUM **)(param_4 + 0x10));
  if (((uVar1 & 0xffffffbf) != 0xa0) && (uVar1 != 0x100)) {
    ERR_put_error(10,0x71,0x66,"dsa_ossl.c",0x144);
    return 0xffffffff;
  }
  iVar2 = BN_num_bits(*(BIGNUM **)(param_4 + 0xc));
  if (10000 < iVar2) {
    ERR_put_error(10,0x71,0x67,"dsa_ossl.c",0x14a);
    return 0xffffffff;
  }
  BN_init(&BStack_5c);
  BN_init(&BStack_48);
  BN_init(&BStack_34);
  ctx = BN_CTX_new();
  if (ctx == (BN_CTX *)0x0) goto LAB_00099b5e;
  pBVar3 = *param_3;
...
LAB_00099a4e:
    ...
    if (ctx == (BN_CTX *)0x0) goto LAB_00099a6e;
  }
  else {
    ...
    if (((pBVar3 == (BIGNUM *)0x0) ||
       ...
       ((iVar2 = BN_mod_mul(&BStack_48,*param_3,&BStack_48,*(BIGNUM **)(param_4 + 0x10),ctx),
        ...
        ((m_ctx = (BN_MONT_CTX *)(*(uint *)(param_4 + 0x28) & 1), m_ctx != (BN_MONT_CTX *)0x0 &&
         ...
         m_ctx == (BN_MONT_CTX *)0x0)))))) goto LAB_00099b5e;
