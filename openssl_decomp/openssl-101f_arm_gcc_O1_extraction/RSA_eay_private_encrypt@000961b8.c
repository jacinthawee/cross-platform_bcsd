...
LAB_0009636a:
      ...
      if (iVar4 < 0) {
        ...
        if (local_44 == (BIGNUM *)0x0) {
          ...
          if (b == (BN_BLINDING *)0x0) {
            ERR_put_error(4,0x66,0x44,"rsa_eay.c",0x198);
            sVar7 = 0xffffffff;
            goto LAB_00096252;
          }
          if (local_40 == 0) {
            ...
            if (local_44 == (BIGNUM *)0x0) {
              ERR_put_error(4,0x66,0x41,"rsa_eay.c",0x1a1);
              sVar7 = 0xffffffff;
              goto LAB_00096252;
            }
          ...
          if (((int)(uVar6 << 0x1e) < 0) &&
             (pBVar3 = BN_MONT_CTX_set_locked
                                 ((BN_MONT_CTX **)(param_4 + 0x40),9,*(BIGNUM **)(param_4 + 0x10),
                                  ctx), pBVar3 == (BN_MONT_CTX *)0x0)) goto LAB_0009636a;
        ...
        if ((iVar4 == 0) ||
           ((b != (BN_BLINDING *)0x0 &&
            (iVar4 = BN_BLINDING_invert_ex(n,local_44,b,ctx), iVar4 == 0)))) goto LAB_0009636a;
        if (param_5 == 5) {
        ...
        ERR_put_error(4,0x66,0x84,"rsa_eay.c",399);
        sVar7 = 0xffffffff;
      }
    }
  }
    ...
    ERR_put_error(4,0x66,0x76,"rsa_eay.c",0x185);
    sVar7 = 0xffffffff;
  }
LAB_00096252:
  BN_CTX_end(ctx);
