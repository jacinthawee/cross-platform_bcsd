...

{
  ...
  if (uVar1 == 0) {
    ERR_put_error(0x27,0x73,0x7b,"ocsp_cl.c",0x140);
  }
  else {
    local_24[0] = local_28 + sec;
    iVar3 = X509_cmp_time(thisupd,local_24);
    if (iVar3 >= 1) {
      ERR_put_error(0x27,0x73,0x7e,"ocsp_cl.c",0x148);
    }
    uVar1 = (uint)(iVar3 < 1);
    if (-1 < maxsec) {
      ...
      if (iVar3 < 0) {
        uVar1 = 0;
        ERR_put_error(0x27,0x73,0x7f,"ocsp_cl.c",0x152);
      }
    }
  }
  if (nextupd != (ASN1_GENERALIZEDTIME *)0x0) {
    ...
    if (uVar2 == 0) {
      ERR_put_error(0x27,0x73,0x7a,"ocsp_cl.c",0x15e);
      ...
      if (iVar3 < 0) {
        uVar1 = 0;
        ERR_put_error(0x27,0x73,0x7d,"ocsp_cl.c",0x166);
      }
      iVar3 = ASN1_STRING_cmp(nextupd,thisupd);
    }
    if (iVar3 < 0) {
      ERR_put_error(0x27,0x73,0x7c,"ocsp_cl.c",0x16e);
      return 0;
    }
  }
  return uVar1;
