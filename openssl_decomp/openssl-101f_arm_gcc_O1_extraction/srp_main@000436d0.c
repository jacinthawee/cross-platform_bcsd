...
LAB_00043b7a:
          ...
          iVar28 = (int)&pCVar27->meth +
                   (int)&local_70->meth + (int)&local_78->meth + (int)&local_68->meth;
          pCVar16 = (CONF *)((int)&local_70->meth + (int)local_68 * 2);
          pCVar18 = (CONF *)0x1;
          if (pCVar20 != (CONF *)0x0 && local_74 != (CONF *)0x0) goto LAB_00043bb8;
          goto LAB_000437d2;
        }
        param_1 = param_1 + -2;
        pCVar20 = ppCVar19[1];
        ...
        pCVar18 = local_78;
        pCVar17 = local_68;
        if (param_1 < 1) goto LAB_000437aa;
      }
      ...
      if (iVar3 != 0) {
        ...
        pCVar18 = local_68;
        pCVar17 = local_78;
        if (cVar1 == '-') goto LAB_00043b7a;
        break;
      }
      if (param_1 + -1 == 0) goto LAB_00043b72;
      local_74 = ppCVar19[1];
      ppCVar19 = ppCVar19 + 1;
...
LAB_000437aa:
    if (pCVar20 != (CONF *)0x0 && local_74 != (CONF *)0x0) {
      iVar3 = 1;
    }
    if (pCVar20 == (CONF *)0x0 || local_74 == (CONF *)0x0) {
      iVar3 = 0;
    ...
    pCVar16 = (CONF *)((int)&local_70->meth + (int)local_68 * 2);
    iVar28 = (int)&pCVar27->meth + (int)&local_70->meth + (int)&pCVar17->meth + (int)&pCVar18->meth;
    pCVar18 = (CONF *)0x0;
    if (iVar3 != 0) {
LAB_00043bb8:
      pCVar18 = (CONF *)0x1;
...
LAB_000437d2:
  ...
  if ((local_50 == 0 && local_4c == 0) || (param_1 == 1)) {
    if (pCVar18 != (CONF *)0x0) goto LAB_00043816;
    ERR_load_crypto_strings();
    setup_engine(bio_err,pCVar23,0);
    iVar3 = app_passwd(bio_err,local_6c,local_64,&local_50,&local_4c);
    if (iVar3 == 0) {
      ...
      if ((pCVar20 == (CONF *)0x0) &&
         (local_58 = (CONF *)getenv("OPENSSL_CONF"), pCVar20 = local_58, local_58 == (CONF *)0x0)) {
        pCVar20 = (CONF *)getenv("SSLEAY_CONF");
        if (pCVar20 == (CONF *)0x0) {
          pcVar9 = X509_get_default_cert_area();
          sVar10 = strlen(pcVar9);
          sVar10 = sVar10 + 0xd;
          local_58 = (CONF *)CRYPTO_malloc(sVar10,"srp.c",0x1c4);
      ...
      iVar3 = NCONF_load(conf,(char *)pCVar20,&local_48);
      if (iVar3 < 1) {
        if (local_48 < 1) {
          local_6c = (CONF *)0x0;
        ...
        if (pCVar18 != (CONF *)0x0) {
          ...
          local_6c = conf;
          if (conf != (CONF *)0x0) {
            local_6c = (CONF *)NCONF_get_string(conf,"srp","RANDFILE");
          }
          if (pCVar22 != (CONF *)0x0) {
          ...
          if (local_74 != (CONF *)0x0) {
            if (local_6c == (CONF *)0x0) goto LAB_00043982;
            app_RAND_load_file(local_6c,bio_err,0);
            goto LAB_0004398a;
          }
          BIO_printf(bio_err,"variable lookup failed for %s::%s\n",section,"srpvfile");
          pCVar18 = local_74;
...
LAB_0004398a:
      ...
      if (pCVar18 != (CONF *)0x0) {
        ...
        if ((int)uVar21 < 0) {
          ...
          pBVar2 = bio_err;
          if ((int)pCVar22 < 2) goto LAB_00043de4;
...
LAB_00043dfe:
        ...
        if (uVar21 == 0) {
          if (pCVar22 != (CONF *)0x0) {
            ...
            if (bVar30) goto LAB_000443ca;
            goto LAB_00044264;
          }
          pCVar27 = pCVar22;
          if (bVar30) goto LAB_00044222;
          goto LAB_00044264;
        }
        if (pCVar16 != (CONF *)0x0) {
          if (1 < (int)pCVar22) {
          ...
          for (iVar3 = 0; iVar28 = sk_num(*(_STACK **)((int)pCVar18->meth_data + 4)), iVar3 < iVar28
            ...
            if ((**ppcVar4 != 'I') && (iVar28 = strcmp((char *)pCVar23,ppcVar4[3]), iVar28 == 0)) {
              if (iVar3 < 0) goto LAB_00043e6c;
              pCVar16 = pCVar20;
              if (0 < (int)pCVar22) {
                pCVar16 = (CONF *)((uint)pCVar20 | 1);
              }
              if (pCVar16 == (CONF *)0x0) goto LAB_00043e98;
                      ...
                      **ppcVar4 = 'v';
                      ...
                      if ((((ppcVar4[3] != (char *)0x0) && (pcVar9 != (char *)0x0)) &&
                        ...
                        if (local_5c == (CONF *)0x0) {
                          ...
                          ppcVar4[5] = pcVar9;
                          if (pcVar9 == (char *)0x0) goto LAB_00044352;
                          bVar30 = true;
                          pCVar27 = (CONF *)0x0;
                        }
                        goto LAB_00043e80;
...
LAB_00044352:
            ...
            if (local_34 == (char *)0x0) goto LAB_0004413c;
...
LAB_00044222:
  ...
  if ((iVar3 == 0) || (iVar3 = rotate_index(local_74,"new","old"), iVar3 == 0)) goto LAB_00044162;
LAB_00044264:
  pCVar27 = local_58;
  if (local_58 != (CONF *)0x0) {
    pCVar27 = (CONF *)0x1;
...
LAB_00044166:
  if (local_58 == (CONF *)0x0) {
joined_r0x00044170:
    if (pCVar22 != (CONF *)0x0) goto LAB_00043b5e;
  }
  else {
LAB_00043b42:
    if (pCVar22 == (CONF *)0x0) goto LAB_0004388c;
...
LAB_0004388c:
  ...
  if (local_6c != (CONF *)0x0) {
    app_RAND_write_file(local_6c,bio_err);
  }
  if (conf != (CONF *)0x0) {
    NCONF_free(conf);
  }
