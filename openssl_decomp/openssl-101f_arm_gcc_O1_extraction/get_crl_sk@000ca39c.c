...
LAB_000ca4f6:
    if (local_5c != (X509_CRL *)0x0) {
      ...
      *param_5 = local_64;
      *param_6 = local_58;
      CRYPTO_add_lock(&local_5c->references,1,6,"x509_vfy.c",0x35f);
      ...
      if ((*(int *)(*(int *)(param_1 + 0x14) + 0xc) << 0x12 < 0) &&
        ...
        for (iVar1 = 0; iVar17 = sk_num(param_7), iVar1 < iVar17; iVar1 = iVar1 + 1) {
          ...
          if ((((pXVar2->base_crl_number != (ASN1_INTEGER *)0x0) &&
            ...
            CRYPTO_add_lock(&pXVar2->references,1,6,"x509_vfy.c",0x3ca);
            *param_3 = pXVar2;
            return;
          }
        }
...
LAB_000ca3ce:
  ...
  if (-1 < (int)(uVar10 << 0x1e)) {
    ...
    if (pAVar16 != (ASN1_INTEGER *)0x0) goto LAB_000ca4d2;
    ...
    if (iVar1 == 0) {
      ...
      if (pAVar9 == (ASN1_INTEGER *)0x0) goto LAB_000ca4d2;
...
LAB_000ca44e:
    ...
    if ((iVar1 == 0) && (((uint)pAVar16 & 0x20) != 0)) {
      ...
      do {
        ...
        iVar13 = iVar1 + 1;
        if (iVar12 <= iVar1) {
          if (-1 < *(int *)(*(int *)(param_1 + 0x14) + 0xc) << 0x13) goto LAB_000ca4c8;
          iVar1 = 0;
          goto LAB_000ca754;
        }
...
LAB_000ca754:
    ...
    iVar13 = iVar1 + 1;
    if (iVar12 <= iVar1) goto LAB_000ca4c8;
  }
...
LAB_000ca4d2:
  ...
  iVar17 = iVar17 + 1;
  iVar1 = sk_num(param_7);
  if (iVar1 <= iVar17) goto LAB_000ca4f6;
  goto LAB_000ca3ce;
}
