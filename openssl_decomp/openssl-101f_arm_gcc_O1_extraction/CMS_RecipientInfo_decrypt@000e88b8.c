...

{
  ...
  if (puVar2 == (uchar *)0x2) {
    ...
    if (iVar3 == 0) {
      ERR_put_error(0x2e,0x87,0x82,"cms_env.c",0x2d3);
    }
    else {
      ...
      if (*(int *)(iVar4 + 0x14) == iVar3) {
        if (**(int **)(iVar4 + 0xc) < 0x10) {
          ...
          if (puVar2 == (uchar *)0x0) {
            out = (uchar *)CRYPTO_malloc(**(int **)(iVar4 + 0xc) + -8,"cms_env.c",0x2ef);
            if (out == (uchar *)0x0) {
              ERR_put_error(0x2e,0x87,0x41,"cms_env.c",0x2f4);
            }
            else {
            ...
            out = (uchar *)0x0;
            ERR_put_error(0x2e,0x87,0x73,"cms_env.c",0x2eb);
          }
        }
      ...
      iVar3 = 0;
      ERR_put_error(0x2e,0x87,0x76,"cms_env.c",0x2db);
    }
    return iVar3;
  }
  if (puVar2 == (uchar *)0x3) {
  ...
  if (0 < iVar1) {
    ...
    if (iVar1 < 1) {
      ERR_put_error(0x2e,0x8c,0x6e,"cms_env.c",0x189);
      goto LAB_000e8a2e;
    }
    iVar1 = EVP_PKEY_decrypt(ctx,(uchar *)0x0,local_114.rd_key,
                             (uchar *)(*(size_t **)(iVar3 + 0xc))[2],**(size_t **)(iVar3 + 0xc));
    if (0 < iVar1) {
      puVar2 = (uchar *)CRYPTO_malloc(local_114.rd_key[0],"cms_env.c",0x192);
      if (puVar2 == (uchar *)0x0) {
        ERR_put_error(0x2e,0x8c,0x41,"cms_env.c",0x197);
      }
      else {
