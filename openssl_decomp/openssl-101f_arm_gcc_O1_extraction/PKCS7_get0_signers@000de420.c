...

{
  ...
  if (p7 == (PKCS7 *)0x0) {
    ERR_put_error(0x21,0x7c,0x8f,"pk7_smime.c",0x1b8);
  }
  else {
    iVar1 = OBJ_obj2nid(p7->type);
    if (iVar1 != 0x16) {
      ERR_put_error(0x21,0x7c,0x71,"pk7_smime.c",0x1bd);
      return (stack_st_X509 *)0x0;
    }
    p_Var2 = (_STACK *)PKCS7_get_signer_info(p7);
    iVar1 = sk_num(p_Var2);
    if (iVar1 < 1) {
      ERR_put_error(0x21,0x7c,0x8e,"pk7_smime.c",0x1c6);
      p7 = (PKCS7 *)0x0;
    }
    else {
...
LAB_000de4ec:
          ...
          do {
            ...
            if ((psVar6 == (stack_st_X509 *)0x0) ||
               ...
               pXVar4 == (X509 *)0x0)) goto LAB_000de4ec;
          ...
          do {
            ...
            pXVar4 = X509_find_by_issuer_and_serial
                               (certs,**(X509_NAME ***)((int)pvVar3 + 4),
                                (ASN1_INTEGER *)(*(X509_NAME ***)((int)pvVar3 + 4))[1]);
            if (pXVar4 == (X509 *)0x0) goto LAB_000de4ec;
      ...
      ERR_put_error(0x21,0x7c,0x41,"pk7_smime.c",0x1cb);
      p7 = st;
    }
  }
