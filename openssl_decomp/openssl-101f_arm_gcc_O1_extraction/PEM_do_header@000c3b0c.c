...

{
  ...
  if (callback == (undefined1 *)0x0) {
    ...
    iVar1 = (*(code *)callback)(auStack_42c,0x400,0);
  }
  if (iVar1 < 1) {
    ERR_put_error(9,0x6a,0x68,"pem_lib.c",0x1ca);
    iVar1 = 0;
    goto LAB_000c3b84;
  }
  type = cipher->cipher;
...
LAB_000c3bb6:
  ...
  ERR_put_error(9,0x6a,0x65,"pem_lib.c",0x1e3);
  iVar1 = 0;
LAB_000c3b84:
