    ...
    if (0x74 < param_2) {
      if (param_2 == 0x75) {
        ...
        if ((((int)sVar8 < 0x1001) || (*psVar6 == sVar8)) ||
           (pvVar2 = CRYPTO_malloc(param_3,"bf_buff.c",0x163), pvVar2 != (void *)0x0)) {
          if ((((int)sVar1 < 0x1001) || (psVar6[1] == sVar1)) ||
             (pvVar7 = CRYPTO_malloc(param_3,"bf_buff.c",0x168), pvVar7 != (void *)0x0)) {
...
LAB_000a0bda:
      ...
      if (param_2 == 0x7a) {
        if ((int)*psVar6 < (int)param_3) {
          pvVar2 = CRYPTO_malloc(param_3,"bf_buff.c",0x141);
          if (pvVar2 == (void *)0x0) goto LAB_000a0bda;
