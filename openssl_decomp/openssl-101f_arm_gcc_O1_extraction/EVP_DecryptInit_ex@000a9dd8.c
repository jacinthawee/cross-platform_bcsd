...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_000a9fa4;
      goto LAB_000a9e80;
    }
    if (pEVar4 != (EVP_CIPHER *)0x0) goto LAB_000a9e06;
  }
...
LAB_000a9fa4:
    ...
    if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_000a9e80;
LAB_000a9e06:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_000a9e52;
  }
  else {
