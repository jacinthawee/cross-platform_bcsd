...
void * dlfcn_bind_func(int param_1,int param_2)

{
  ...
  if (param_2 != 0 && param_1 != 0) {
    ...
    if (iVar1 < 1) {
      ERR_put_error(0x25,100,0x69,"dso_dlfcn.c",0x115);
    }
    else {
      ...
      if (pvVar4 == (void *)0x0) {
        ERR_put_error(0x25,100,0x68,"dso_dlfcn.c",0x11b);
      }
      else {
  ...
  ERR_put_error(0x25,100,0x43,"dso_dlfcn.c",0x110);
  return (void *)0x0;
}
