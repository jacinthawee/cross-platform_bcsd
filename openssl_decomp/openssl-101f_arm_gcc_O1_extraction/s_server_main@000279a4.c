...

{
  ...
  s_cert_file = s_server_pem_0012e96c;
  s_cert_file2 = s_server2_pem_0012e978;
  if (bio_err == (BIO *)0x0) {
...
LAB_00027b12:
    ...
    if (local_64 < 1) {
      ...
      if (local_b0 == (X509 *)0x0) {
        local_c4 = (X509 *)load_key(bio_err,s_key_file,local_7c,0,local_48,uVar10,
        ...
        local_c8 = (X509 *)load_cert(bio_err,s_cert_file,local_ac,0,uVar10,"server certificate file"
                                    );
        ...
        if (local_34 == (char *)0x0) {
          ...
          local_cc = (X509 *)load_key(bio_err,s_key_file2,local_7c,0,local_48,uVar10,
          ...
          pXVar8 = (X509 *)load_cert(bio_err,s_cert_file2,local_ac,0,uVar10,
      ...
      if (local_a8 == (X509 *)0x0) {
        ...
        local_40 = (X509 *)next_protos_parse(local_58,local_a8);
      ...
      if (s_dcert_file != (X509 *)0x0) {
        ...
        a = (X509 *)load_cert(bio_err,s_dcert_file,local_78,0,uVar10,
                              "second server certificate file");
        if (a == (X509 *)0x0) {
          iVar16 = 1;
          ERR_print_errors(bio_err);
...
LAB_000282e6:
          uVar10 = app_RAND_load_files(local_90);
          BIO_printf(pBVar12,"%ld semi-random bytes loaded\n",uVar10);
        }
      }
      else if (local_90 != (char *)0x0) goto LAB_000282e6;
...
LAB_00028380:
      ...
      iVar16 = SSL_CTX_load_verify_locations(ctx,local_a4,local_8c);
      ...
      if (pXVar8 == (X509 *)0x0) {
        if (ctx2 != (SSL_CTX *)0x0) goto LAB_0002842e;
      }
      else {
        ctx2 = SSL_CTX_new(local_bc);
        if (ctx2 == (SSL_CTX *)0x0) goto LAB_00028a9e;
LAB_0002842e:
        ...
        iVar16 = SSL_CTX_load_verify_locations(ctx2,local_a4,local_8c);
...
LAB_00028bae:
          ...
          dh = DH_new();
          if (dh != (DH *)0x0) {
            pBVar13 = BN_bin2bn(PTR_dh512_p_00028c58,0x40,(BIGNUM *)0x0);
            dh->p = pBVar13;
            pBVar13 = BN_bin2bn(PTR_dh512_g_00028c5c,1,(BIGNUM *)0x0);
            dh->g = pBVar13;
            if ((dh->p != (BIGNUM *)0x0) && (pBVar13 != (BIGNUM *)0x0)) goto LAB_0002857c;
          }
          dh = (DH *)0x0;
        }
        else {
          pBVar12 = BIO_new_file(local_a0,"r");
          if (pBVar12 == (BIO *)0x0) goto LAB_00028bae;
          dh = PEM_read_bio_DHparams(pBVar12,(DH **)0x0,(undefined1 *)0x0,(void *)0x0);
          BIO_free(pBVar12);
LAB_00028566:
          if (dh == (DH *)0x0) goto LAB_00028bae;
...
LAB_0002857c:
        ...
        if (ctx2 != (SSL_CTX *)0x0) {
          if ((local_a0 == (char *)0x0) &&
             (pDVar14 = (DH *)load_dh_param(s_cert_file2), pDVar14 != (DH *)0x0)) {
            BIO_printf(bio_s_out,"Setting temp DH parameters\n");
            BIO_ctrl(bio_s_out,0xb,0,(void *)0x0);
            DH_free(dh);
            dh = pDVar14;
      ...
      iVar16 = SSL_CTX_use_psk_identity_hint(ctx,psk_identity_hint_21094);
      if (iVar16 == 0) {
        iVar16 = 1;
      ...
      if ((cipher != (char *)0x0) &&
         ((iVar16 = SSL_CTX_set_cipher_list(ctx,cipher), iVar16 == 0 ||
          ((ctx2 != (SSL_CTX *)0x0 && (iVar16 = SSL_CTX_set_cipher_list(ctx2,cipher), iVar16 == 0)))
          ))) {
        iVar16 = 1;
      ...
      SSL_CTX_set_session_id_context(ctx,PTR_s_server_session_id_context_00028c54,4);
      ...
      if (ctx2 != (SSL_CTX *)0x0) {
        ...
        SSL_CTX_set_session_id_context(ctx2,PTR_s_server_session_id_context_00028c54,4);
        local_30 = bio_s_out;
      ...
      if (pcVar21 == (char *)0x0) {
        if (local_a4 != (char *)0x0) {
          psVar15 = SSL_load_client_CA_file(local_a4);
          SSL_CTX_set_client_CA_list(pSVar11,psVar15);
          pSVar11 = ctx2;
          if (ctx2 != (SSL_CTX *)0x0) {
            psVar15 = SSL_load_client_CA_file(local_a4);
            SSL_CTX_set_client_CA_list(pSVar11,psVar15);
        ...
        SSL_CTX_set_srp_username_callback(ctx,0x27591);
      }
      BIO_printf(bio_s_out,"ACCEPT\n");
      BIO_ctrl(bio_s_out,0xb,0,(void *)0x0);
      if (www == 0) {
        do_server((int)local_60[0],local_98,PTR_accept_socket_0002913c,0x26535,local_b8);
      }
      else {
        do_server((int)local_60[0],local_98,PTR_accept_socket_0002913c,0x26d45,local_b8);
      }
      iVar16 = 0;
    ...
    if ((iVar9 == 0) || (iVar9 = strcmp(pcVar22,"-accept"), iVar9 == 0)) {
      local_64 = iVar16 + -1;
      if (local_64 == 0) goto LAB_00027d2c;
      local_68 = ppcVar20 + 1;
      iVar9 = extract_port(ppcVar20[1],local_60);
joined_r0x00027b52:
      ppcVar20 = local_68;
      iVar16 = local_64;
      if (iVar9 == 0) goto LAB_00027d2c;
    }
    else {
      ...
      ppcVar20 = local_68;
      if (iVar16 != 0) {
        if (local_4c != 0) goto LAB_00027d2c;
        goto LAB_00027b12;
      }
      pcVar22 = *local_68;
      ...
      if (iVar16 == 0) {
        ...
        if (iVar16 == 0) {
          ...
          if (iVar16 == 0) {
            local_64 = local_64 + -1;
            if (local_64 < 1) goto LAB_00027d2c;
            cipher = ppcVar20[1];
            ppcVar20 = ppcVar20 + 1;
            iVar16 = local_64;
          }
                        ...
                        if (iVar16 == 0) {
                          ...
                          if (iVar16 == 0) {
                            ...
                            if (iVar16 == 0) {
                              ...
                              if (local_64 < 1) goto LAB_00027d2c;
                              local_68 = ppcVar20 + 1;
                              iVar9 = OCSP_parse_url(ppcVar20[1],(char **)(DAT_00027d28 + -3),
                                                     (char **)(DAT_00027d28 + -1),
                                                     (char **)(DAT_00027d28 + -2),DAT_00027d28);
                              ppcVar20 = local_68;
                              iVar16 = local_64;
                              if (iVar9 == 0) {
                                            ...
                                            if (iVar16 == 0) {
                                              ...
                                              if (iVar16 == 0) {
                                                ...
                                                if (iVar16 == 0) {
                                                  local_64 = local_64 + -1;
                                                  if (local_64 < 1) goto LAB_00027d2c;
                                                  psk_identity_hint_21094 = ppcVar20[1];
                                                  ppcVar20 = ppcVar20 + 1;
                                                  iVar16 = local_64;
                                                }
                                                else {
...
LAB_00029310:
                                                      ...
                                                      iVar16 = strcmp(pcVar22,"-ssl2");
                                                      if (iVar16 == 0) {
                                                        local_bc = SSLv2_server_method();
                                                        ppcVar20 = local_68;
                                                        iVar16 = local_64;
                                                        goto LAB_00027b06;
                                                      }
