...

{
  ...
  if ((*(int *)(*(int *)(param_1 + 0x58) + 0x178) == 0) ||
    ...
    iVar2 = __aeabi_idiv(uVar6,iVar2);
    *param_4 = 0;
    param_4[1] = 0;
    param_4[2] = 0;
    param_4[3] = 0;
    ...
    param_4[0xb] = 0;
    iVar7 = iVar4;
    while (iVar5 = ssl_get_handshake_digest(iVar7,&local_d8,&local_d4), iVar5 != 0) {
      if ((uVar3 & local_d8 << 10) != 0) {
        if (local_d4 == 0) {
          ...
          iVar5 = tls1_P_hash_constprop_3
                            (local_d4,iVar8,iVar2 + (uVar9 & 1),param_2,param_3,auStack_ac,
                             (int)md - (int)auStack_ac,0,0,0,0,&local_b8,0xc);
          if (iVar5 != 0) {
            iVar8 = iVar8 + iVar2;
