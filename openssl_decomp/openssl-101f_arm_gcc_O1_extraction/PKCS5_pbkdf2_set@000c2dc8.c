...

{
  ...
  val = (undefined4 *)ASN1_item_new((ASN1_ITEM *)PTR_PBKDF2PARAM_it_000c2ef4);
      ...
      if (iVar2 != 0) {
        if (0 < keylen) {
          ...
          if ((pAVar1 == (ASN1_STRING *)0x0) ||
             (iVar2 = ASN1_INTEGER_set(pAVar1,keylen), iVar2 == 0)) goto LAB_000c2ec4;
        }
        ...
        if ((!bVar8 && prf_nid != 0) && bVar7 == (bVar8 && SBORROW4(prf_nid,0xa3))) {
          ...
          val[3] = pXVar3;
          if (pXVar3 == (X509_ALGOR *)0x0) goto LAB_000c2ec4;
        ...
        if (pXVar3 != (X509_ALGOR *)0x0) {
          ...
          if ((pAVar5 != (ASN1_TYPE *)0x0) &&
             (pAVar1 = ASN1_item_pack(val,(ASN1_ITEM *)PTR_PBKDF2PARAM_it_000c2ef4,
                                      &(pAVar5->value).octet_string),
             it = PTR_PBKDF2PARAM_it_000c2ef4, pAVar1 != (ASN1_STRING *)0x0)) {
...
LAB_000c2ec6:
  ...
  ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)PTR_PBKDF2PARAM_it_000c2ef4);
