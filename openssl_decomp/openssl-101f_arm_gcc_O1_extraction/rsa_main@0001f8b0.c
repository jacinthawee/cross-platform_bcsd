...
LAB_0001fb36:
        ...
        if (iVar4 == 0) {
          if (param_1 == 1) goto LAB_0001fb36;
          param_1 = param_1 + -2;
        ...
        if ((((*__s1 == '-') && (__s1[1] == 'i')) && (__s1[2] == 'n')) && (__s1[3] == '\0')) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_0001fb36;
          pcVar14 = ppcVar12[1];
          ppcVar12 = ppcVar12 + 1;
        }
        else {
...
LAB_0001fe7c:
          ...
          if (key == (rsa_st *)0x0) goto LAB_0001fe7c;
                ...
                if (local_54 == 0) {
                  ...
                  if (iVar3 == 1) {
                    ...
                    if (iVar3 == 4) {
                      ...
                      data = (uchar *)CRYPTO_malloc(iVar3,"rsa.c",0x187);
                      local_2c[0] = data;
                      if (data == (uchar *)0x0) {
                        local_54 = 1;
