...

{
  ...
  if (0x300 < param_1->version) {
    ...
    puVar4 = (undefined *)CRYPTO_malloc(3,"t1_lib.c",0x6e0);
    param_1->tlsext_ecpointformatlist_length = (size_t)puVar4;
    if (puVar4 == (undefined *)0x0) {
      ERR_put_error(0x14,0x119,0x41,"t1_lib.c",0x6e2);
      return 0xffffffff;
    }
    ...
    *(undefined *)(param_1->tlsext_ecpointformatlist_length + 2) = 2;
    ...
    puVar4 = (undefined *)CRYPTO_malloc(0x32,"t1_lib.c",0x6ed);
    param_1->tlsext_ellipticcurvelist_length = (size_t)puVar4;
    if (puVar4 == (undefined *)0x0) {
      param_1->tlsext_ecpointformatlist = (uchar *)0x0;
      ERR_put_error(0x14,0x119,0x41,"t1_lib.c",0x6f0);
      return 0xffffffff;
    }
    piVar5 = (int *)(PTR_DAT_000563b8 + 100);
    piVar6 = (int *)PTR_DAT_000563b8;
    do {
      piVar6 = piVar6 + 1;
      iVar8 = *piVar6;
      if (iVar8 == 0x2d2) {
        ...
        if (iVar8 == 0x2c7) {
          ...
          if (iVar8 == 0x2c4) {
            ...
            if (iVar8 == 0x199) {
              ...
              if (iVar8 != 0x19f) goto LAB_000562bc;
              uVar7 = 0x17;
            }
          }
          else if (iVar8 == 0x2c5) {
            ...
            if (iVar8 != 0x2c6) goto LAB_000562bc;
            uVar7 = 0x11;
          }
        }
        else if (iVar8 == 0x2ca) {
          ...
          if (iVar8 == 0x2c8) {
            ...
            if (iVar8 != 0x2c9) goto LAB_000562bc;
            uVar7 = 0x15;
          }
        }
        else if (iVar8 == 0x2cc) {
          ...
          if (iVar8 != 0x2d1) goto LAB_000562bc;
          uVar7 = 1;
        }
      }
      else if (iVar8 == 0x2d8) {
...
LAB_000562bc:
          ...
          if (iVar8 != 0x2d7) goto LAB_000562bc;
          uVar7 = 7;
        }
      }
      else if (iVar8 == 0x2db) {
        ...
        if (iVar8 == 0x2d9) {
          ...
          if (iVar8 != 0x2da) goto LAB_000562bc;
          uVar7 = 10;
        }
      }
      else if (iVar8 == 0x2dd) {
        ...
        if (iVar8 != 0x2de) goto LAB_000562bc;
        uVar7 = 0xe;
      }
      *puVar4 = 0;
      puVar4[1] = uVar7;
