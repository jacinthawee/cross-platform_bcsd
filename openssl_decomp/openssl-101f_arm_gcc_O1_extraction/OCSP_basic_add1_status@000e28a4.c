...

{
  ...
  if (pOVar6->responses == (stack_st_OCSP_SINGLERESP *)0x0) {
    ...
    if (p_Var5 != (_STACK *)0x0) goto LAB_000e28bc;
  }
  else {
LAB_000e28bc:
        ...
        if (pOVar2 != (OCSP_CERTID *)0x0) {
          ...
          if (status == 1) {
            ...
            if ((out == (OCSP_REVOKEDINFO *)0x0) ||
               ...
               pAVar1 == (ASN1_GENERALIZEDTIME *)0x0)) goto LAB_000e28fe;
            if (reason != -1) {
              a_00 = ASN1_ENUMERATED_new();
              out->revocationReason = a_00;
              if ((a_00 == (ASN1_ENUMERATED *)0x0) ||
                 (iVar4 = ASN1_ENUMERATED_set(a_00,reason), iVar4 == 0)) goto LAB_000e28fe;
            }
          }
          else {
            if ((status != 2) && (status != 0)) goto LAB_000e28fe;
