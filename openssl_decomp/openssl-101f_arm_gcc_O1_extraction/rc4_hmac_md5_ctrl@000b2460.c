...

{
  ...
  if (param_2 == 0x16) {
    uVar2 = (uint)CONCAT11(*(undefined *)((int)param_4 + (param_3 - 2)),
                           *(undefined *)((int)param_4 + (param_3 - 1)));
    if (*(int *)(param_1 + 8) == 0) {
      uVar2 = uVar2 - 0x10;
      *(char *)((int)param_4 + (param_3 - 2)) = (char)(uVar2 >> 8);
      *(char *)((int)param_4 + (param_3 - 1)) = (char)uVar2;
    }
