      ...
      do {
        ...
        if (type->pkey_type == 0x71) {
          ...
          if ((pAVar1 == (ASN1_TYPE *)0x0) || (pAVar1->type != 5)) {
            ...
            if (pAVar1 == (ASN1_TYPE *)0x0) goto LAB_081cb1e9;
            pAVar1->type = 5;
          }
        }
        ...
        if (pAVar2 == (ASN1_OBJECT *)0x0) goto LAB_081cb200;
        if (pAVar2->length == 0) goto LAB_081cb1c8;
      } while (iVar3 != 2);
    }
  }
  else {
...
LAB_081cb200:
          ...
          if (pAVar2->length != 0) goto LAB_081caeee;
LAB_081cb1c8:
        ...
        if ((pAVar1 != (ASN1_TYPE *)0x0) && (pAVar1->type == 5)) goto LAB_081cb198;
        ASN1_TYPE_free(pAVar1);
        pAVar1 = ASN1_TYPE_new();
...
LAB_081caeee:
  ...
  if ((d == (void *)0x0) || (md == (uchar *)0x0)) {
    ...
    EVP_MD_CTX_cleanup(&local_38);
    if (d != (void *)0x0) goto LAB_081cb007;
  }
  else {
    local_40 = d;
