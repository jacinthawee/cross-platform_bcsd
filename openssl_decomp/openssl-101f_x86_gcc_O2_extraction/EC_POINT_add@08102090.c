...

{
  ...
  if (*(code **)(iVar1 + 0x58) == (code *)0x0) {
    ERR_put_error(0x10,0x70,0x42,"ec_lib.c",0x393);
  }
  else {
    if (((iVar1 == *(int *)r) && (iVar1 == *(int *)a)) && (iVar1 == *(int *)b)) {
                    /* WARNING: Could not recover jumptable at 0x08102103. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      iVar1 = (**(code **)(iVar1 + 0x58))();
      return iVar1;
    }
    ERR_put_error(0x10,0x70,0x65,"ec_lib.c",0x398);
  }
  return 0;
}
