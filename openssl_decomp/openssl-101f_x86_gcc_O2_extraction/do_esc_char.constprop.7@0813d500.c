  ...
  if (param_1_00 < 0x10000) {
    if (param_1_00 < 0x100) {
      ...
      if ((local_1c < '\0') || (bVar3 = char_type[param_1_00] & param_2, (bVar3 & 0x61) == 0)) {
        if ((bVar3 & 6) == 0) {
          if ((param_1_00 != 0x5c) || ((param_2 & 0xf) == 0)) goto LAB_0813d559;
          if ((param_1 == (FILE *)0x0) || (sVar1 = fwrite(&DAT_08226cb5,1,2,param_1), sVar1 == 2))
          goto LAB_0813d5b0;
        }
        else {
        ...
        if ((param_1 == (FILE *)0x0) ||
           ((sVar1 = fwrite(&DAT_08226cb6,1,1,param_1), sVar1 == 1 &&
