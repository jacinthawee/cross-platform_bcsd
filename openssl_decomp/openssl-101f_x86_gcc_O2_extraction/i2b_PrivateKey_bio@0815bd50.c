...
LAB_0815bdc0:
    iVar7 = iVar7 + 0x10;
    data = (undefined *)CRYPTO_malloc(iVar7,"pvkfmt.c",0x1ff);
...
LAB_0815c800:
          ...
          iVar8 = iVar8 >> 4;
          if (0 < iVar8) goto LAB_0815c210;
LAB_0815c236:
          local_48 = local_48 + local_38;
          if (0 < iVar9) goto LAB_0815c24e;
          pBVar4 = prVar3->iqmp;
          iVar10 = BN_num_bits(pBVar4);
          iVar19 = iVar10 + 7;
          iVar8 = iVar10 + 0xe;
...
LAB_0815c323:
      ...
      if (-1 < iVar7) {
        ...
        CRYPTO_free(data);
        if (iVar18 == iVar7) goto LAB_0815c3ea;
      }
    }
  }
  iVar7 = -1;
