...
LAB_08173a81:
      ...
      if (a == (ASN1_INTEGER *)0x0) goto LAB_08173f7c;
      if (a->type == 0x102) goto LAB_08173a81;
  ...
  if (a_02 == (PROXY_CERT_INFO_EXTENSION *)0x0) goto LAB_08173af1;
  uVar6 = param_1->ex_flags;
  if ((uVar6 & 0x10) == 0) {
    iVar4 = X509_get_ext_by_NID(param_1,0x55,0);
    if ((-1 < iVar4) || (iVar4 = X509_get_ext_by_NID(param_1,0x56,0), -1 < iVar4)) {
      uVar6 = param_1->ex_flags;
      goto LAB_08173ac0;
    }
  }
...
LAB_08173eeb:
        ...
        if (iVar4 == 0x89) goto LAB_08173eeb;
      }
      else if (iVar4 == 0xb4) {
    ...
    if ((*ppDVar15 != (DIST_POINT_NAME *)0x0) && (iVar14 = 0, (*ppDVar15)->type == 1)) {
      for (; iVar18 = sk_num((_STACK *)ppDVar15[2]), iVar14 < iVar18; iVar14 = iVar14 + 1) {
        ...
        if (*piVar17 == 4) {
          ...
          if (pXVar3 != (X509_NAME *)0x0) goto LAB_08173d75;
          break;
        }
      }
      pXVar3 = X509_get_issuer_name(param_1);
...
LAB_08173e45:
    ...
    if (iVar4 != 0) {
      ...
      if ((local_24 == 0) ||
         (pvVar19 = OBJ_bsearch_(&local_24,supported_nids_13609,0xb,4,nid_cmp_BSEARCH_CMP_FN),
         pvVar19 == (void *)0x0)) {
