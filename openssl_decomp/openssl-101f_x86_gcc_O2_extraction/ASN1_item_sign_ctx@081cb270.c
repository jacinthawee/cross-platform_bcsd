...
LAB_081cb323:
    ...
    local_28 = len;
    sigret = (uchar *)CRYPTO_malloc(len,"a_sign.c",0x12e);
    if ((sigret == (uchar *)0x0) || (local_2c == (uchar *)0x0)) {
      local_28 = 0;
      ERR_put_error(0xd,0xdc,0x41,"a_sign.c",0x132);
      EVP_MD_CTX_cleanup(ctx);
      if (local_2c != (uchar *)0x0) goto LAB_081cb3e3;
      goto LAB_081cb3fa;
    }
    ...
    local_28 = 0;
    ERR_put_error(0xd,0xdc,6,"a_sign.c",0x13a);
    EVP_MD_CTX_cleanup(ctx);
    if (local_2c != (uchar *)0x0) goto LAB_081cb3e3;
  }
  else {
...
LAB_081cb3cd:
      EVP_MD_CTX_cleanup(ctx);
      sVar2 = local_28;
      if (local_2c == (uchar *)0x0) goto LAB_081cb450;
      sigret = (uchar *)0x0;
    }
    else {
      if (0 < iVar1) {
        if (iVar1 == 2) {
          piVar3 = (int *)pkey->ameth;
          if ((*(byte *)&md->flags & 4) != 0) {
            if (piVar3 != (int *)0x0) goto LAB_081cb540;
            goto LAB_081cb600;
          }
          goto LAB_081cb47a;
        }
      ...
      ERR_put_error(0xd,0xdc,6,"a_sign.c",0x108);
      EVP_MD_CTX_cleanup(ctx);
      sVar2 = local_28;
      if (local_2c == (uchar *)0x0) goto LAB_081cb450;
      len = 0;
...
LAB_081cb3fa:
    sVar2 = local_28;
    if (sigret == (uchar *)0x0) goto LAB_081cb450;
  }
