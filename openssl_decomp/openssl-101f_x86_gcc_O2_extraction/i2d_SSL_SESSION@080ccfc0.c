...

{
  ...
  if (in == (SSL_SESSION *)0x0) {
    ...
    if (*(int *)(in->krb5_client_princ + 0x54) != 0) {
      local_194 = i2d_ASN1_OCTET_STRING(&local_94,(uchar **)0x0);
      iVar3 = ASN1_object_size(1,local_194,10);
      iVar8 = iVar8 + iVar3;
    }
    local_198 = 0;
    if (*(int *)(in->krb5_client_princ + 0x40) != 0) {
      local_198 = i2d_ASN1_OCTET_STRING(&local_b4,(uchar **)0x0);
      iVar3 = ASN1_object_size(1,local_198,6);
      iVar8 = iVar8 + iVar3;
    }
    local_178 = 0;
    if (*(int *)(in->krb5_client_princ + 0x20) != 0) {
    ...
    if (in->krb5_client_princ_len != 0) {
      local_1a0 = i2d_ASN1_OCTET_STRING(&local_84,(uchar **)0x0);
      iVar3 = ASN1_object_size(1,local_1a0,7);
      iVar8 = iVar8 + iVar3;
    }
    local_19c = 0;
    if (*(int *)in->krb5_client_princ != 0) {
      local_19c = i2d_ASN1_OCTET_STRING(&local_74,(uchar **)0x0);
      iVar3 = ASN1_object_size(1,local_19c,8);
      iVar8 = iVar8 + iVar3;
    }
    local_190 = 0;
    ...
    if (pp != (uchar **)0x0) {
      ...
      if (*(int *)(in->krb5_client_princ + 0x40) != 0) {
        ASN1_put_object(&local_168,1,local_198,6,0x80);
        i2d_ASN1_OCTET_STRING(&local_b4,&local_168);
      }
      if (in->krb5_client_princ_len != 0) {
        ASN1_put_object(&local_168,1,local_1a0,7,0x80);
        i2d_ASN1_OCTET_STRING(&local_84,&local_168);
      }
      if (*(int *)in->krb5_client_princ != 0) {
        ASN1_put_object(&local_168,1,local_19c,8,0x80);
      ...
      if (*(int *)(in->krb5_client_princ + 0x54) != 0) {
        ASN1_put_object(&local_168,1,local_194,10,0x80);
