...

{
  ...
  iVar5 = CRYPTO_add_lock((int *)(c->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x281);
  ...
  if ((pSVar6 == (SSL_SESSION *)0x0) || (c == pSVar6)) {
    if (pSVar6 != (SSL_SESSION *)0x0) {
      ...
      psVar7 = (ssl_session_st *)
               CRYPTO_add_lock((int *)(pSVar6->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
      if ((int)psVar7 < 1) {
    ...
    iVar5 = CRYPTO_add_lock((int *)(pSVar6->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
    if (iVar5 < 1) {
