...
LAB_08124c9f:
  ...
  sVar5 = strlen(buf);
  if ((len - 1 != sVar5) || (len < 5)) goto LAB_08124dac;
...
LAB_08124d58:
    *pcVar8 = ':';
    ...
    pcVar8 = buf + (len - 4);
    if (pcVar8 < pcVar6) goto LAB_08124d58;
  }
  pcVar6 = strchr(pcVar6 + 1,0x3a);
  if (pcVar6 == (char *)0x0) {
    pcVar8 = buf + (len - 3);
LAB_08124d85:
    *pcVar8 = ':';
    ...
    pcVar8 = buf + (len - 3);
    if (pcVar8 < pcVar6) goto LAB_08124d85;
  }
  pcVar6 = strchr(pcVar6 + 1,0x3a);
  if (pcVar6 == (char *)0x0) {
    pcVar8 = buf + (len - 2);
    ...
    pcVar8 = buf + (len - 2);
    if (pcVar6 <= pcVar8) goto LAB_08124dac;
  }
  *pcVar8 = ':';
LAB_08124dac:
