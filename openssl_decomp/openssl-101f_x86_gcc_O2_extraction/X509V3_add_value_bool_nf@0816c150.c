...
LAB_0816c18d:
      ...
      if (ptr_00 == (char *)0x0) {
        ...
        if (ptr == (char *)0x0) goto LAB_0816c258;
      }
      else {
        ...
        if (data == (undefined4 *)0x0) {
          ...
          if (*extlist == (stack_st_CONF_VALUE *)0x0) {
            ...
            *extlist = (stack_st_CONF_VALUE *)p_Var2;
            if (p_Var2 != (_STACK *)0x0) goto LAB_0816c1d3;
          }
          else {
LAB_0816c1d3:
            *data = 0;
            ...
            if (iVar1 != 0) goto LAB_0816c15b;
          }
          ERR_put_error(0x22,0x69,0x41,"v3_utl.c",0x60);
          CRYPTO_free(data);
        }
        if (ptr == (char *)0x0) goto LAB_0816c22e;
      }
      CRYPTO_free(ptr);
      if (ptr_00 != (char *)0x0) {
LAB_0816c22e:
      ...
      ptr = BUF_strdup(name);
      if (ptr != (char *)0x0) goto LAB_0816c18d;
      ERR_put_error(0x22,0x69,0x41,"v3_utl.c",0x60);
    }
LAB_0816c258:
    iVar1 = 0;
