...

{
  ...
  case 6:
    ...
    CRYPTO_add_lock(&((bio_st *)param_2->server)->references,1,0x15,"bio_ssl.c",0x191);
    return (SSL *)0x1;
  case 7:
    if (param_2 == param_5) {
      ...
      if ((bio_st *)param_2->server != (bio_st *)0x0) {
        CRYPTO_add_lock(&((bio_st *)param_2->server)->references,-1,0x15,"bio_ssl.c",0x19e);
      }
      pSVar8->wbio = (BIO *)0x0;
      pSVar8->rbio = (BIO *)0x0;
    }
  ...
  case 0x6d:
    if (pSVar8 != (SSL *)0x0) {
      ...
      ppSVar4 = (SSL **)CRYPTO_malloc(0x18,"bio_ssl.c",0x6c);
      if (ppSVar4 == (SSL **)0x0) {
    ...
    *ppSVar4 = param_5;
    ...
    if (pBVar5 != (BIO *)0x0) {
      ...
      CRYPTO_add_lock(&pBVar5->references,1,0x15,"bio_ssl.c",0x16d);
    }
