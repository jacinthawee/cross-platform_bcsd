...

{
  ...
  iVar9 = 0;
  while (iVar4 = ssl_get_handshake_digest(iVar9,&local_28,&local_24), iVar4 != 0) {
    iVar9 = iVar9 + 1;
  }
  ...
  iVar9 = 0;
  do {
    iVar4 = ssl_get_handshake_digest(iVar9,&local_28,&local_24);
    if (iVar4 == 0) {
      uVar7 = 1;
LAB_080b18c5:
    ...
    if ((param_1_00 & local_28 << 10) == 0) goto LAB_080b17f7;
    if (local_24 == 0) {
    ...
    if (0 < (int)param_11) {
      if ((param_11 < 7 || param_10 < param_9 + 4 && param_9 < param_10 + 4) ||
        ...
        if (2 < param_11 - 1) {
          ...
          uVar5 = uVar2;
          if (param_11 == uVar2) goto LAB_080b17f7;
        }
