...

{
  ...
  if (param_1 == 0) {
    ...
    switch(n) {
    default:
      goto switchD_0807d64d_caseD_0;
    case 2:
      goto switchD_0807d64d_caseD_2;
    case 9:
    case 0xd:
      goto switchD_0807d64d_caseD_9;
    case 10:
    case 0xe:
      goto switchD_0807d64d_caseD_a;
    case 0x2b:
      goto switchD_0807d64d_caseD_2b;
    }
  }
  switch(n) {
  case 2:
...
LAB_0807d526:
    ...
    break;
  case 0x2b:
switchD_0807d64d_caseD_2b:
    policies_print(bio_err,param_2);
  }
switchD_0807d4fb_caseD_0:
  if ((n == 0) && (param_1 == 2)) {
    policies_print(bio_err,param_2);
  }
switchD_0807d64d_caseD_0:
  BIO_printf(bio_err,"verify return:%d\n",param_1);
  return param_1;
switchD_0807d64d_caseD_2:
  BIO_puts(bio_err,"issuer= ");
  pXVar2 = X509_get_issuer_name(a);
  X509_NAME_print_ex(bio_err,pXVar2,0,0x82031f);
  BIO_puts(bio_err,"\n");
  goto switchD_0807d4fb_caseD_0;
}
