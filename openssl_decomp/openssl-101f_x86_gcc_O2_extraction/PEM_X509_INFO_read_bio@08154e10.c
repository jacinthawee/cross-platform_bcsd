...
LAB_08154e75:
      ...
      if (!bVar13) {
        do {
          ...
          if (bVar13) {
LAB_08154f18:
            if (pXVar2->x509 == (X509 *)0x0) goto code_r0x08154f1f;
          }
          else {
            iVar3 = 0x11;
            pcVar10 = local_48;
