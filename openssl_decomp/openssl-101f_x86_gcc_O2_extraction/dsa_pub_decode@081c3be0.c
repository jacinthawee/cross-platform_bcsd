...

{
  ...
  if (iVar1 != 0) {
    ...
    if (local_1c == 0x10) {
      ...
      if (r == (DSA *)0x0) {
        ERR_put_error(10,0x75,0x68,"dsa_ameth.c",0x5e);
      }
      else {
LAB_081c3c97:
        ai = d2i_ASN1_INTEGER((ASN1_INTEGER **)0x0,&local_28,local_20);
        if (ai == (ASN1_INTEGER *)0x0) {
          ERR_put_error(10,0x75,0x68,"dsa_ameth.c",0x73);
        }
        else {
          ...
          *(BIGNUM **)&r->field_0x18 = pBVar3;
          ...
          ERR_put_error(10,0x75,0x6c,"dsa_ameth.c",0x79);
          ASN1_INTEGER_free(ai);
        }
        DSA_free(r);
      }
      ...
      r = DSA_new();
      if (r != (DSA *)0x0) goto LAB_081c3c97;
      ERR_put_error(10,0x75,0x41,"dsa_ameth.c",0x67);
    }
    else {
      ERR_put_error(10,0x75,0x69,"dsa_ameth.c",0x6d);
    }
  }
  uVar2 = 0;
LAB_081c3c19:
