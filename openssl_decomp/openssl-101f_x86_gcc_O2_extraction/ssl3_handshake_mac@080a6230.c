  ...
  if (pEVar1 != (EVP_MD_CTX *)0x0) {
    ...
    if (iVar2 == param_2_00) {
      ...
      if (pEVar1 != (EVP_MD_CTX *)0x0) {
        ...
        if (iVar2 < 0) goto LAB_080a62e9;
        cnt = (int)(0x30 / (longlong)iVar2) * iVar2;
        if (param_3 != (void *)0x0) {
          EVP_DigestUpdate(&local_78,param_3,param_1);
        }
        EVP_DigestUpdate(&local_78,(void *)(*(int *)(param_1_00 + 0xc0) + 0x14),
                         *(size_t *)(*(int *)(param_1_00 + 0xc0) + 0x10));
        EVP_DigestUpdate(&local_78,ssl3_pad_1,cnt);
        EVP_DigestFinal_ex(&local_78,local_60,&local_7c);
        pEVar3 = EVP_MD_CTX_md(&local_78);
        EVP_DigestInit_ex(&local_78,pEVar3,(ENGINE *)0x0);
        EVP_DigestUpdate(&local_78,(void *)(*(int *)(param_1_00 + 0xc0) + 0x14),
                         *(size_t *)(*(int *)(param_1_00 + 0xc0) + 0x10));
        EVP_DigestUpdate(&local_78,
                         "\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"
                         ,cnt);
        EVP_DigestUpdate(&local_78,local_60,local_7c);
        EVP_DigestFinal_ex(&local_78,param_2,&local_80);
...
LAB_080a62eb:
  ...
  local_7c = local_7c + 1;
  if (5 < local_7c) goto LAB_080a62c8;
  iVar2 = *(int *)(param_1_00 + 0x58);
  goto LAB_080a6293;
}
