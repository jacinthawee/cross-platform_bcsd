...

{
  ...
  if (((s->wbio != (BIO *)0x0) && (iVar2 = BIO_method_type(s->wbio), iVar2 == 0x505)) &&
    ...
    if ((pBVar3 == (BIO *)0x0) || (pBVar4 != pBVar3)) {
      pBVar3 = s->rbio;
      if ((pBVar3 == (BIO *)0x0) || (pBVar4 == pBVar3)) goto LAB_080c007c;
LAB_080c0054:
      BIO_free_all(pBVar3);
    }
    else {
      ...
      pBVar3 = s->rbio;
      if ((pBVar3 != (BIO *)0x0) && (pBVar4 != pBVar3)) goto LAB_080c0054;
    }
    pBVar3 = s->wbio;
...
LAB_080c007c:
  ...
  pBVar3 = BIO_new(type);
  if (pBVar3 == (BIO *)0x0) {
    ERR_put_error(0x14,0xc2,7,"ssl_lib.c",0x2cd);
    return 0;
  }
  ...
  if ((pBVar4 == (BIO *)0x0) || (pBVar1 != pBVar4)) {
    pBVar4 = s->rbio;
    if ((pBVar4 == (BIO *)0x0) || (pBVar3 == pBVar4)) goto LAB_080bffc2;
LAB_080bff9a:
    BIO_free_all(pBVar4);
  }
  else {
    ...
    pBVar4 = s->rbio;
    if ((pBVar3 != pBVar4) && (pBVar4 != (BIO *)0x0)) goto LAB_080bff9a;
  }
  pBVar4 = s->wbio;
