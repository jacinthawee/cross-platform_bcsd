  ...
  if ((val != (undefined4 *)0x0) && (pAVar2 = ASN1_STRING_type_new(4), pAVar2 != (ASN1_STRING *)0x0)
    ...
    *puVar1 = 4;
    ...
    if (buf != (uchar *)0x0) {
      ...
      if (salt == (uchar *)0x0) {
        iVar3 = RAND_bytes(buf,saltlen);
        if (iVar3 < 1) goto LAB_08151fa8;
      }
      else {
      ...
      if (iVar3 != 0) {
        if (0 < keylen) {
          ...
          if ((pAVar2 == (ASN1_STRING *)0x0) ||
             (iVar3 = ASN1_INTEGER_set(pAVar2,keylen), iVar3 == 0)) goto LAB_08151fa8;
        }
        if ((0 < prf_nid) && (prf_nid != 0xa3)) {
          pXVar4 = X509_ALGOR_new();
          val[3] = pXVar4;
          if (pXVar4 == (X509_ALGOR *)0x0) goto LAB_08151fa8;
