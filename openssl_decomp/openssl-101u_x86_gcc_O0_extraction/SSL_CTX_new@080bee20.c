...
LAB_080bf2a9:
  ...
  if (obj == (SSL_CTX *)0x0) goto LAB_080bf2a9;
  ...
  if (pcVar3 != (cert_st *)0x0) {
    ...
    if (p_Var4 != (_LHASH *)0x0) {
      ...
      if (pXVar5 != (X509_STORE *)0x0) {
        pcVar6 = "SSLv2";
        if (meth->version != 2) {
          pcVar6 = "ALL:!EXPORT:!LOW:!aNULL:!eNULL:!SSLv2";
        }
        ...
        if (pXVar7 != (X509_VERIFY_PARAM *)0x0) {
          ...
          if (p_Var9 != (_STACK *)0x0) {
            ...
            iVar1 = RAND_bytes(obj->tlsext_tick_key_name,0x10);
            ...
            puVar12 = (undefined4 *)CRYPTO_malloc(0xc,"ssl_lib.c",0x743);
            obj->rbuf_freelist = (ssl3_buf_freelist_st *)puVar12;
            if (puVar12 != (undefined4 *)0x0) {
              *puVar12 = 0;
              puVar12[1] = 0;
              puVar12[2] = 0;
              puVar12 = (undefined4 *)CRYPTO_malloc(0xc,"ssl_lib.c",0x749);
              ...
              if (puVar12 != (undefined4 *)0x0) {
                *puVar12 = 0;
                ...
                obj->options = obj->options | 0x1000004;
                return obj;
              }
  ...
  ERR_put_error(0x14,0xa9,0x41,"ssl_lib.c",0x774);
LAB_080bf24e:
  iVar1 = CRYPTO_add_lock(&obj->references,-1,0xc,"ssl_lib.c",0x795);
  if (iVar1 < 1) {
    SSL_CTX_free_part_6();
  }
  return (SSL_CTX *)0x0;
