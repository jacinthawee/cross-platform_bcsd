...
LAB_0808e4c7:
        ...
        if (-1 < lVar2) goto LAB_0808e3df;
LAB_0808e4e1:
        BIO_puts(bio_err,"Can\'t get connection fd\n");
        goto LAB_0808e457;
      }
      iVar3 = BIO_test_flags(bp,8);
      if (iVar3 == 0) goto LAB_0808e633;
      lVar2 = BIO_ctrl(bp,0x69,0,&local_b0);
      if (lVar2 < 0) goto LAB_0808e4e1;
...
LAB_0808e3df:
      ...
      if (rctx != (OCSP_REQ_CTX *)0x0) {
        for (iVar3 = 0; iVar5 = sk_num(param_7), iVar3 < iVar5; iVar3 = iVar3 + 1) {
          ...
          if (iVar5 == 0) goto LAB_0808e44b;
        }
        iVar3 = OCSP_REQ_CTX_set1_req(rctx,param_2);
        if (iVar3 != 0) {
          do {
            if (param_8 == -1) goto LAB_0808e66b;
            iVar3 = OCSP_sendreq_nbio(&local_ac,rctx);
            if (iVar3 != -1) goto LAB_0808e44b;
            p_Var7 = (__fd_mask *)local_a0;
            for (iVar3 = 0x20; iVar3 != 0; iVar3 = iVar3 + -1) {
              *p_Var7 = 0;
              p_Var7 = p_Var7 + 1;
...
LAB_0808e647:
  ...
  if (bp != (BIO *)0x0) goto LAB_0808e467;
LAB_0808e473:
  if (local_c8 != (SSL_CTX *)0x0) {
