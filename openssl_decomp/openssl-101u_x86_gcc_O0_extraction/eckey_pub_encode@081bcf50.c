  ...
  if ((key == (EC_KEY *)0x0) || (group = EC_KEY_get0_group(key), group == (EC_GROUP *)0x0)) {
    ...
    if ((iVar1 != 0) && (iVar1 = EC_GROUP_get_curve_name(group), iVar1 != 0)) {
      ...
      if (iVar1 < 1) {
        ...
        penc = (uchar *)CRYPTO_malloc(iVar1,"ec_ameth.c",0x74);
        if ((penc != (uchar *)0x0) &&
...
LAB_081bd124:
          ...
          if (iVar1 != 0) goto LAB_081bd00f;
          if (local_30 != 6) goto LAB_081bcff1;
        }
      }
      ASN1_OBJECT_free(a);
LAB_081bcffd:
    ...
    if (a != (ASN1_OBJECT *)0x0) {
      ...
      if (0 < (int)pcVar2) {
        ...
        iVar1 = i2o_ECPublicKey(key,(uchar **)0x0);
        if (((0 < iVar1) &&
            (penc = (uchar *)CRYPTO_malloc(iVar1,"ec_ameth.c",0x74), penc != (uchar *)0x0)) &&
           (local_24 = penc, iVar1 = i2o_ECPublicKey(key,&local_24), 0 < iVar1)) {
          local_30 = 0x10;
          goto LAB_081bd124;
        }
LAB_081bcff1:
  ...
  uVar3 = 0;
  ERR_put_error(0x10,0xd8,0x10,"ec_ameth.c",0x6e);
LAB_081bd00f:
