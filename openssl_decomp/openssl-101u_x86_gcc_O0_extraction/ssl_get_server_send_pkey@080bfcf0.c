...

{
  ...
  if (iVar1 != 0) {
    ...
    if ((*(int *)(iVar1 + 0x30) == 0) || (*(EVP_PKEY **)(iVar1 + 0x34) == (EVP_PKEY *)0x0)) {
      uVar13 = 0;
      local_48 = 0;
      if (*(int *)(iVar1 + 0x3c) == 0) goto LAB_080c01c5;
LAB_080bfdea:
      local_64 = 1;
      if (*(int *)(iVar1 + 0x40) == 0) {
        local_64 = uVar13;
      ...
      if (*(int *)(iVar1 + 0x48) != 0) goto LAB_080bfe13;
LAB_080c01e0:
      bVar19 = false;
      if (*(int *)(iVar1 + 0x54) != 0) goto LAB_080bfe2c;
LAB_080c01f8:
      bVar5 = false;
      bVar2 = false;
      if (*(int *)(iVar1 + 0x60) == 0) goto LAB_080c0218;
LAB_080bfe65:
      if (*(EVP_PKEY **)(iVar1 + 100) == (EVP_PKEY *)0x0) goto LAB_080c0218;
      iVar6 = EVP_PKEY_size(*(EVP_PKEY **)(iVar1 + 100));
      local_58 = *(X509 **)(iVar1 + 0x6c);
      bVar4 = true;
      bVar3 = iVar6 * 8 <= iVar10;
      if (local_58 == (X509 *)0x0) goto LAB_080c022b;
LAB_080bfe9a:
      bVar20 = *(int *)(iVar1 + 0x70) != 0;
      if (*(int *)(iVar1 + 0x84) != 0) goto LAB_080bfeb6;
LAB_080c0248:
      uVar11 = 0;
      uVar9 = 0x100;
      if (*(int *)(iVar1 + 0x78) != 0) goto LAB_080bfee7;
      uVar11 = 0;
      uVar12 = uVar11;
    }
    else {
      ...
      if (*(int *)(iVar1 + 0x3c) != 0) goto LAB_080bfdea;
LAB_080c01c5:
      bVar14 = false;
      local_64 = uVar13;
      if (*(int *)(iVar1 + 0x48) == 0) goto LAB_080c01e0;
LAB_080bfe13:
      bVar19 = *(int *)(iVar1 + 0x4c) != 0;
      if (*(int *)(iVar1 + 0x54) == 0) goto LAB_080c01f8;
LAB_080bfe2c:
      if (*(EVP_PKEY **)(iVar1 + 0x58) == (EVP_PKEY *)0x0) goto LAB_080c01f8;
      iVar6 = EVP_PKEY_size(*(EVP_PKEY **)(iVar1 + 0x58));
      bVar5 = true;
      bVar2 = iVar6 * 8 <= iVar10;
      if (*(int *)(iVar1 + 0x60) != 0) goto LAB_080bfe65;
LAB_080c0218:
      local_58 = *(X509 **)(iVar1 + 0x6c);
      bVar4 = false;
      bVar3 = false;
      if (local_58 != (X509 *)0x0) goto LAB_080bfe9a;
LAB_080c022b:
      bVar20 = false;
      if (*(int *)(iVar1 + 0x84) == 0) goto LAB_080c0248;
LAB_080bfeb6:
    ...
    if (bVar20) {
      ...
      if (local_4c != 0) {
        if ((local_28 == 6) || (local_28 == 0x13)) {
          ...
          uVar9 = uVar12 | 0x20;
          if (0xa3 < local_50) goto LAB_080c0180;
          uVar13 = uVar13 | 0x20;
          local_64 = local_48 | 0x14;
          if (local_28 != 0x198) goto LAB_080c018b;
          uVar9 = uVar12 | 0x60;
LAB_080c03c6:
          uVar13 = uVar13 | 0x40;
...
LAB_080c0180:
          if (local_28 == 0x198) {
            ...
            if (local_50 < 0xa4) goto LAB_080c03c6;
          }
        }
      }
LAB_080c018b:
