...
LAB_081a06fc:
      ...
      if (pBVar2->dmax < iVar1) {
        ...
        if (pBVar5 != (BIGNUM *)0x0) goto LAB_081a0498;
LAB_081a0725:
        if (CSWIFT_lib_error_code == 0) {
          CSWIFT_lib_error_code = ERR_get_next_error_library();
        }
...
LAB_081a0498:
      ...
      if (a->dmax < iVar1) {
        ...
        if (pBVar5 != (BIGNUM *)0x0) {
          ...
          if (a_00->dmax < iVar1) goto LAB_081a076b;
          goto LAB_081a04b9;
        }
        goto LAB_081a0725;
      }
...
LAB_081a076b:
        ...
        if (pBVar5 == (BIGNUM *)0x0) goto LAB_081a0725;
        iVar1 = *(int *)(*(int *)(param_3 + 0x1c) + 4);
        if (a_01->dmax < iVar1) goto LAB_081a0792;
LAB_081a04cc:
...
LAB_081a04b9:
        iVar1 = *(int *)(*(int *)(param_3 + 0x1c) + 4);
        if (iVar1 <= a_01->dmax) goto LAB_081a04cc;
LAB_081a0792:
        pBVar5 = bn_expand2(a_01,iVar1);
        if (pBVar5 == (BIGNUM *)0x0) goto LAB_081a0725;
        pBVar5 = *(BIGNUM **)(param_3 + 0xc);
        iVar1 = pBVar5->top;
        if (a_02->dmax < iVar1) goto LAB_081a07bd;
      }
      local_5c = 3;
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 != 0) {
          ...
          ERR_put_error(CSWIFT_lib_error_code,0x65,0x6b,"e_cswift.c",0x36a);
          goto LAB_081a0678;
        }
        pDVar4 = DSA_SIG_new();
        ...
        ERR_put_error(CSWIFT_lib_error_code,0x65,0x6b,"e_cswift.c",0x359);
LAB_081a0678:
