...

{
  ...
  if (iVar2 != 0) {
    ...
    if ((*(int *)(iVar2 + 0x30) == 0) || (*(EVP_PKEY **)(iVar2 + 0x34) == (EVP_PKEY *)0x0)) {
      uVar15 = 0;
      local_48 = 0;
      if (*(int *)(iVar2 + 0x3c) != 0) goto LAB_080c053a;
LAB_080c098d:
      bVar16 = false;
      local_64 = uVar15;
      if (*(int *)(iVar2 + 0x48) != 0) goto LAB_080c0563;
LAB_080c09a8:
      bVar21 = false;
    }
    else {
      ...
      if (*(int *)(iVar2 + 0x3c) == 0) goto LAB_080c098d;
LAB_080c053a:
      local_64 = 1;
      if (*(int *)(iVar2 + 0x40) == 0) {
        local_64 = uVar15;
      ...
      if (*(int *)(iVar2 + 0x48) == 0) goto LAB_080c09a8;
LAB_080c0563:
    ...
    if ((*(int *)(iVar2 + 0x60) == 0) || (*(EVP_PKEY **)(iVar2 + 100) == (EVP_PKEY *)0x0)) {
      ...
      bVar5 = false;
      bVar4 = false;
      if (local_58 != (X509 *)0x0) goto LAB_080c05ea;
LAB_080c0923:
      bVar22 = false;
      if (*(int *)(iVar2 + 0x84) != 0) goto LAB_080c0606;
LAB_080c0940:
      uVar13 = 0;
      uVar11 = 0x100;
      if (*(int *)(iVar2 + 0x78) != 0) goto LAB_080c0637;
      uVar13 = 0;
      uVar14 = uVar13;
    }
    else {
      ...
      if (local_58 == (X509 *)0x0) goto LAB_080c0923;
LAB_080c05ea:
      bVar22 = *(int *)(iVar2 + 0x70) != 0;
      if (*(int *)(iVar2 + 0x84) == 0) goto LAB_080c0940;
LAB_080c0606:
    ...
    if (bVar22) {
      ...
      if (local_4c != 0) {
        if ((local_28 == 6) || (local_28 == 0x13)) {
          ...
          uVar11 = uVar14 | 0x20;
          if (0xa3 < local_50) goto LAB_080c08e0;
          uVar15 = uVar15 | 0x20;
          local_64 = local_48 | 0x14;
          if (local_28 != 0x198) goto LAB_080c08eb;
          uVar11 = uVar14 | 0x60;
LAB_080c0b16:
          uVar15 = uVar15 | 0x40;
...
LAB_080c08e0:
          if (local_28 == 0x198) {
            ...
            if (local_50 < 0xa4) goto LAB_080c0b16;
          }
        }
      }
LAB_080c08eb:
