...

{
  ...
  if ((uVar1 & 4) != 0) {
    if ((uVar1 & 8) == 0) {
      if (*(int *)(param_1 + 0x7c) != 0) goto LAB_0815ddf0;
      local_40 = 0;
    }
    else {
      local_40 = sk_num(*(_STACK **)(param_1 + 0x54));
      local_40 = local_40 + -1;
      if (local_40 < 0) goto LAB_0815ddf0;
    }
    local_44 = 0;
    do {
...
LAB_0815e050:
        ...
        if (iVar4 == 0) {
          ...
          if ((st != (_STACK *)0x0) || (local_28 == (X509_CRL *)0x0)) {
            ...
            goto joined_r0x0815e042;
          }
        }
        else {
joined_r0x0815e042:
          if (local_28 == (X509_CRL *)0x0) goto LAB_0815e050;
        }
