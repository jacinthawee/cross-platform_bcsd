...
LAB_0807a358:
    ...
    if (bVar4) {
      pwdbio_16718 = BIO_new_file(param_2 + 5,"r");
      if (pwdbio_16718 == (BIO *)0x0) {
      ...
      if (bVar4) {
        ...
        if (-1 < fd) {
          pwdbio_16718 = BIO_new_fd(fd,0);
          if (pwdbio_16718 != (BIO *)0x0) {
            type = BIO_f_buffer();
            b = BIO_new(type);
            pwdbio_16718 = BIO_push(b,pwdbio_16718);
            goto LAB_0807a2d2;
          }
        }
      ...
      pwdbio_16718 = BIO_new_fp(stdin,0);
      if (pwdbio_16718 == (BIO *)0x0) {
    ...
    bVar4 = pwdbio_16718 == (BIO *)0x0;
    if (bVar4) goto LAB_0807a358;
  }
LAB_0807a2d2:
  iVar1 = BIO_gets(pwdbio_16718,local_420,0x400);
  if (param_3 != 1) {
    BIO_free_all(pwdbio_16718);
    pwdbio_16718 = (BIO *)0x0;
  }
  if (iVar1 < 1) {
