...

{
  ...
  iVar2 = iVar2 + 1;
  ptr = CRYPTO_malloc(iVar2 * 4,"bn_gf2m.c",0x40e);
  if (ptr == (void *)0x0) {
    return 0;
  }
  if (param_4->top != 0) {
...
LAB_081e1d78:
      ...
      if ((iVar6 <= iVar2) && (!bVar9)) {
        iVar6 = BN_GF2m_mod_exp_arr(param_1,param_2,param_3,ptr,param_5);
        goto LAB_081e1db2;
      }
    }
  }
  ERR_put_error(3,0x84,0x6a,"bn_gf2m.c",0x412);
LAB_081e1db2:
  CRYPTO_free(ptr);
  return iVar6;
}
