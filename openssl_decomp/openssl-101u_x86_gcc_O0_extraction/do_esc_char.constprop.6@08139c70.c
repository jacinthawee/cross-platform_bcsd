  ...
  if (param_1_00 < 0x10000) {
    if (param_1_00 < 0x100) {
      ...
      if ((local_1c < '\0') || (bVar3 = char_type[param_1_00] & param_2, (bVar3 & 0x61) == 0)) {
        if ((bVar3 & 6) == 0) {
          if ((param_1_00 != 0x5c) || ((param_2 & 0xf) == 0)) goto LAB_08139cc9;
          if ((param_1 == (BIO *)0x0) || (iVar1 = BIO_write(param_1,&DAT_08226f15,2), iVar1 == 2))
          goto LAB_08139d20;
        }
        else {
        ...
        if ((param_1 == (BIO *)0x0) ||
           ((iVar1 = BIO_write(param_1,&DAT_08226f16,1), iVar1 == 1 &&
