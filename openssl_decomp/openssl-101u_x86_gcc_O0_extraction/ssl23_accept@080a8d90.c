...
LAB_080a8ea0:
    SSL_clear(param_1);
    iVar5 = param_1->state;
    if (iVar5 < 0x2212) goto LAB_080a8e20;
LAB_080a8ebb:
    if ((iVar5 == 0x4000) || (iVar5 == 0x6000)) goto LAB_080a8ecf;
LAB_080a8e44:
    iVar5 = -1;
    ...
    uVar2 = SSL_state(param_1);
    if ((uVar2 & 0x4000) != 0) goto LAB_080a8ea0;
    iVar5 = param_1->state;
    if (0x2211 < iVar5) goto LAB_080a8ebb;
LAB_080a8e20:
    if (iVar5 < 0x2210) {
      if ((iVar5 != 0x2000) && (iVar5 != 0x2003)) goto LAB_080a8e44;
LAB_080a8ecf:
      param_1->server = 1;
      if (p_Var4 != (_func_3152 *)0x0) {
...
LAB_080a8ef9:
        ...
        *(int *)(param_1->psk_server_callback + 0x40) =
        ...
        param_1->init_num = 0;
        if ((iVar5 != 0x2210) && (p_Var4 != (_func_3152 *)0x0)) {
          param_1->state = iVar5;
