...

{
  ...
  if ((ameth == (EVP_PKEY_ASN1_METHOD *)0x0) ||
     (iVar1 = EVP_PKEY_asn1_get0_info
                        (&local_14,(int *)0x0,(int *)0x0,(char **)0x0,(char **)0x0,ameth), 0 < iVar1
     )) {
    if (local_18 != (ENGINE *)0x0) goto LAB_080c5ff5;
  }
  else {
    local_14 = 0;
    if (local_18 == (ENGINE *)0x0) goto LAB_080c6018;
LAB_080c5ff5:
...
LAB_080c6018:
  ssl_mac_pkey_id._12_4_ = local_14;
