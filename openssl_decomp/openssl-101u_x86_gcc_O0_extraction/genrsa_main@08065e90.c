...
LAB_08066015:
            ...
            if (bVar12) {
              if (param_1 == 1) goto LAB_08066250;
              local_4c = ppcVar9[1];
              param_1 = param_1 + -2;
              ppcVar9 = ppcVar9 + 2;
              goto joined_r0x08066042;
            }
            iVar3 = 6;
            pcVar10 = pcVar14;
            pcVar11 = "-rand";
            ...
            if (bVar12) {
              param_1 = param_1 + -1;
              if (param_1 == 0) goto LAB_08066250;
              local_48 = ppcVar9[1];
              ppcVar9 = ppcVar9 + 1;
            }
            else {
                            ...
                            if (bVar12) {
                              ...
                              if (!bVar12) {
                                ...
                                if (bVar12) {
                                  ...
                                  if ((iVar3 != 0) && (-1 < local_3c)) goto LAB_08066048;
                                }
LAB_08066250:
...
joined_r0x08066042:
  ...
  bVar12 = true;
  if (local_38 != (void *)0x0) goto LAB_08065f45;
  goto LAB_08066181;
LAB_08066048:
  ERR_load_crypto_strings();
...
LAB_08065f12:
    bVar12 = true;
    BN_free(a);
    if (local_54 != (BIO *)0x0) goto LAB_08065f2e;
  }
  else {
...
LAB_080660db:
    ...
    else if (local_48 != (char *)0x0) goto LAB_080660db;
    BIO_printf(bio_err,"Generating RSA private key, %d bit long modulus\n",local_3c);
    rsa = RSA_new_method(engine);
    if (rsa == (RSA *)0x0) goto LAB_08065f12;
    bVar12 = true;
...
LAB_08065f45:
  ...
  if (bVar12 == false) goto LAB_08065f59;
LAB_08066181:
