...
LAB_080670f2:
  ...
  while ((bio_err = pBVar4, pcVar12 != (char *)0x0 && (bVar10 = *pcVar12 == '-', bVar10))) {
    ...
    if (bVar10) {
      ppcVar1 = ppcVar5 + 1;
      if (*ppcVar1 == (char *)0x0) goto LAB_08067450;
      ppcVar5 = ppcVar5 + 1;
      ...
      if (bVar10) {
        pcVar6 = ppcVar5[1];
        if (pcVar6 == (char *)0x0) goto LAB_08067450;
LAB_0806732b:
        ppcVar5 = ppcVar5 + 1;
      }
      else {
        ...
        if (bVar10) {
          ...
          if (bVar10) {
            pcVar12 = ppcVar5[1];
            if ((pcVar12 == (char *)0x0) || (local_44 == 1)) goto LAB_08067450;
          ...
          if (bVar10) {
            local_40 = ppcVar5[1];
            if (local_40 != (char *)0x0) goto LAB_0806732b;
            goto LAB_08067450;
          }
          iVar3 = 0xb;
          pcVar8 = pcVar12;
          ...
          if (bVar10) {
            ...
            if (bVar10) {
              ...
              if (bVar10) {
                if (local_28 != (EVP_PKEY_CTX *)0x0) goto LAB_08067450;
                local_44 = 1;
              }
              else {
                iVar3 = 6;
                ...
                if (bVar10) {
                  ...
                  if (local_44 == 1) goto LAB_08067450;
                }
              }
            }
          }
