  ...
  if (param_3 == 9) {
    ...
    if (param_3 < 10) {
      ...
      if (param_3 < 5) {
        ...
        if (param_3 == 1) goto LAB_0807eb70;
        if (param_3 < 2) {
          pcVar4 = "server name";
          if (param_3 == 0) goto LAB_0807eb70;
        }
        else {
          pcVar4 = "client certificate URL";
          if ((param_3 == 2) || (pcVar4 = "trusted CA keys", param_3 == 3)) goto LAB_0807eb70;
        }
      }
      else {
        pcVar4 = "user mapping";
      ...
      if (param_3 < 0xf) {
        ...
        if (((param_3 == 0xb) || (pcVar4 = "elliptic curves", param_3 < 0xb)) ||
           ((pcVar4 = "SRP", param_3 == 0xc || (pcVar4 = "signature algorithms", param_3 == 0xd))))
        goto LAB_0807eb70;
      }
      else {
        if (param_3 == 0x23) {
        ...
        if (param_3 < 0x24) {
          pcVar4 = "heartbeat";
          if ((param_3 == 0xf) || (pcVar4 = "TLS padding", param_3 == 0x15)) goto LAB_0807eb70;
        }
        else {
