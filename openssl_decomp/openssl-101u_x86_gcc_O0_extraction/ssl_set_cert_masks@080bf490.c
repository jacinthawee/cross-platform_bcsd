...

{
  ...
  local_28 = 0;
  local_24 = 0;
  if (param_1 == 0) goto LAB_080bf770;
  ...
  if (*(RSA **)(param_1 + 0x18) == (RSA *)0x0) {
    ...
    dh = *(DH **)(param_1 + 0x20);
    if (dh != (DH *)0x0) goto LAB_080bf50c;
LAB_080bf9e0:
    ...
    dh = *(DH **)(param_1 + 0x20);
    if (dh == (DH *)0x0) goto LAB_080bf9e0;
LAB_080bf50c:
    bVar16 = true;
    bVar17 = true;
  ...
  if ((*(int *)(param_1 + 0x30) == 0) || (*(EVP_PKEY **)(param_1 + 0x34) == (EVP_PKEY *)0x0)) {
    uVar12 = 0;
    local_50 = 0;
    if (*(int *)(param_1 + 0x3c) != 0) goto LAB_080bf57b;
LAB_080bf96d:
    bVar13 = false;
    local_60 = uVar12;
    if (*(int *)(param_1 + 0x48) != 0) goto LAB_080bf5a4;
LAB_080bf988:
    bVar18 = false;
  }
  else {
    ...
    if (*(int *)(param_1 + 0x3c) == 0) goto LAB_080bf96d;
LAB_080bf57b:
    local_60 = 1;
    ...
    if (*(int *)(param_1 + 0x48) == 0) goto LAB_080bf988;
LAB_080bf5a4:
  ...
  if ((*(int *)(param_1 + 0x60) == 0) || (*(EVP_PKEY **)(param_1 + 100) == (EVP_PKEY *)0x0)) {
    ...
    bVar3 = false;
    bVar2 = false;
    if (local_5c != (X509 *)0x0) goto LAB_080bf62b;
LAB_080bf903:
    bVar19 = false;
    if (*(int *)(param_1 + 0x84) != 0) goto LAB_080bf647;
LAB_080bf920:
    uVar10 = 0;
    uVar8 = 0x100;
    if (*(int *)(param_1 + 0x78) != 0) goto LAB_080bf678;
    uVar10 = 0;
    uVar11 = uVar10;
  }
  else {
    ...
    bVar3 = true;
    bVar2 = iVar5 * 8 <= iVar9;
    if (local_5c == (X509 *)0x0) goto LAB_080bf903;
LAB_080bf62b:
    bVar19 = *(int *)(param_1 + 0x70) != 0;
    if (*(int *)(param_1 + 0x84) == 0) goto LAB_080bf920;
LAB_080bf647:
  ...
  if (bVar19) {
    ...
    if (local_48 != 0) {
      if ((local_28 == 6) || (local_28 == 0x13)) {
        ...
        uVar6 = uVar11 | 0x20;
        if (0xa3 < (int)local_50) goto LAB_080bf8c8;
        uVar12 = uVar12 | 0x20;
        uVar8 = local_54 | 0x14;
        if (local_28 != 0x198) goto LAB_080bf8d3;
        uVar6 = uVar11 | 0x60;
LAB_080bfac6:
        uVar12 = uVar12 | 0x40;
        uVar8 = uVar8 | 0x10;
...
LAB_080bf8c8:
        if (local_28 == 0x198) {
          ...
          if ((int)local_50 < 0xa4) goto LAB_080bfac6;
        }
      }
    }
LAB_080bf8d3:
