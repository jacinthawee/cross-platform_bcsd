...

{
  ...
  if (point == (EC_POINT *)0x0) goto LAB_081bbdc3;
...
LAB_081bc07d:
      ...
      while (point != pEVar1) {
        if (((iVar2 == 0) || (*(int *)(iVar2 + 4) == 0)) ||
          ...
          if (*(int *)(pEVar1 + 0x40) == 0) goto LAB_081bbe70;
        ...
        if ((iVar2 == 0) ||
           (((*(int *)(param_6[uVar3] + 0xc) != 0 &&
            ...
            iVar2 == 0)))) goto LAB_081bbe8c;
        uVar3 = uVar3 + 1;
        if (param_4 == uVar3) goto LAB_081bc07d;
        iVar2 = param_6[uVar3];
...
LAB_081bc036:
      ...
      if (point == pEVar1) goto LAB_081bc036;
