...
LAB_080667d3:
    ...
    if (bVar9) {
      param_1 = param_1 + -1;
      if (param_1 == 0) goto LAB_080668d8;
      local_48 = ppcVar4[1];
      ppcVar4 = ppcVar4 + 1;
    }
    else {
      ...
      if (bVar9) {
        if (param_1 == 1) goto LAB_080668d8;
        local_44 = ppcVar4[1];
        param_1 = param_1 + -2;
        ppcVar4 = ppcVar4 + 2;
        goto joined_r0x08066812;
      }
      iVar1 = 8;
      pcVar6 = pcVar11;
      pcVar8 = "-engine";
      ...
      if (bVar9) {
        ...
        bVar9 = *pcVar11 == '-';
        if ((bVar9) && (bVar9 = pcVar11[1] == '\0', bVar9)) goto LAB_080668d8;
        iVar1 = 5;
        pcVar6 = pcVar11;
        pcVar8 = "-des";
        do {
                        ...
                        if (bVar9) {
                          ...
                          if (bVar9) {
                            local_38 = EVP_camellia_256_cbc();
                                  ...
                                  (local_34 = pcVar11, *pcVar11 == '-')) goto LAB_080668d8;
                        }
                      }
                    }
                  }
...
LAB_0806686c:
  ...
  if (pBVar7 != (BIO *)0x0) goto LAB_08066886;
LAB_08066892:
  if (a != (DSA *)0x0) {
    DSA_free(a);
  }
LAB_080668a2:
  ...
  __stack_chk_fail();
LAB_08066814:
  if (local_34 == (char *)0x0) goto LAB_080668d8;
...
LAB_08066d5f:
  ...
  pBVar2 = BIO_s_file();
  pBVar7 = BIO_new(pBVar2);
  if (pBVar7 == (BIO *)0x0) goto LAB_0806686c;
...
LAB_08066c74:
  ...
  else if (local_3c != (char *)0x0) goto LAB_08066c74;
  iVar1 = BN_num_bits(a->p);
  BIO_printf(bio_err,"Generating DSA key, %d bits\n",iVar1);
  iVar1 = DSA_generate_key(a);
  if (iVar1 == 0) goto LAB_0806686c;
  uVar5 = 0;
