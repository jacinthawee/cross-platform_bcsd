...

{
  ...
  buf = (uchar *)CRYPTO_malloc(uVar3 + 10,"dsa_ameth.c",0x224);
  if (buf == (uchar *)0x0) {
    uVar3 = 0;
    ERR_put_error(10,0x7d,0x41,"dsa_ameth.c",0x226);
  }
  else {
    iVar2 = BIO_write(param_1,&DAT_081f15cb,1);
    if (iVar2 == 1) {
      iVar2 = ASN1_bn_print(param_1,"r:   ",a->r,buf,param_4);
      if (iVar2 == 0) goto LAB_081c1ff7;
