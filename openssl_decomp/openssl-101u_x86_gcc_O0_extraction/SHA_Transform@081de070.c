...

{
  ...
  do {
    ...
    uVar4 = puStack_80[2];
    uVar23 = uStack_34 << 0x1e | uStack_34 >> 2;
    uVar15 = ((uStack_74 ^ uStack_70) & uStack_34 ^ uStack_70) +
             uVar22 + 0x5a827999 + (uStack_78 << 5 | uStack_78 >> 0x1b) + uStack_1c;
    uVar3 = puStack_80[3];
    uVar2 = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
    uVar8 = uStack_70 + 0x5a827999 + uVar1 + (uVar15 * 0x20 | uVar15 >> 0x1b) +
            ((uStack_74 ^ uVar23) & uStack_78 ^ uStack_74);
    uVar6 = uStack_78 << 0x1e | uStack_78 >> 2;
    uVar5 = uVar3 >> 0x18 | (uVar3 & 0xff0000) >> 8 | (uVar3 & 0xff00) << 8 | uVar3 << 0x18;
    uVar3 = uStack_74 + 0x5a827999 + uVar2 + (uVar8 * 0x20 | uVar8 >> 0x1b) +
    ...
    uVar4 = puStack_80[0xf];
    puStack_80 = puStack_80 + 0x10;
    ...
    uStack_34 = uStack_34 + uVar5;
    uStack_74 = uStack_74 + (uVar1 * 0x40000000 | uVar1 >> 2);
    c->h0 = uStack_78;
    c->h1 = uStack_34;
    c->h2 = uStack_74;
    uStack_70 = uStack_70 + uVar2;
    uStack_1c = uStack_1c + uVar8;
