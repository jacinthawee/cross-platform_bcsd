  ...
  if (-1 < (int)cnt) {
    if (sLen != -1) {
      if (sLen == -2) {
        ...
        local_54 = iVar1 - 1U & 7;
        iVar1 = RSA_size(rsa);
        if (local_54 == 0) goto LAB_081e3fd2;
LAB_081e3ff4:
        sLen = (iVar1 - cnt) + -2;
        local_58 = EM;
        if (sLen < 1) goto LAB_081e400f;
LAB_081e3edd:
        ...
        if (0 < iVar2) {
          ...
          if (iVar2 == 0) goto LAB_081e3f50;
          iVar5 = 0;
          iVar2 = EVP_DigestUpdate(&local_38,&zeroes,8);
          if (iVar2 == 0) goto LAB_081e3f52;
...
LAB_081e3f50:
        ...
        local_54 = iVar1 - 1U & 7;
        iVar1 = RSA_size(rsa);
        if (local_54 != 0) goto LAB_081e3ec1;
LAB_081e3fd2:
        iVar1 = iVar1 + -1;
        *EM = '\0';
        EM = EM + 1;
        ...
        local_54 = 0;
        local_58 = EM;
        if (iVar1 <= (int)(cnt + 1 + sLen)) goto LAB_081e414c;
LAB_081e3ed1:
        if (0 < sLen) goto LAB_081e3edd;
LAB_081e400f:
        local_44 = (iVar1 - cnt) + -1;
        local_48 = local_58 + local_44;
        EVP_MD_CTX_init(&local_38);
        ...
        iVar5 = 0;
        iVar2 = EVP_DigestUpdate(&local_38,mHash,cnt);
        if (iVar2 == 0) goto LAB_081e3f83;
        buf = (byte *)0x0;
        if (sLen == 0) {
LAB_081e40b5:
          local_50 = &local_38;
          iVar2 = EVP_DigestFinal_ex(local_50,local_48,(uint *)0x0);
          if (iVar2 == 0) goto LAB_081e40da;
...
LAB_081e4095:
          ...
          if (iVar2 != 0) goto LAB_081e40b5;
LAB_081e40da:
          iVar5 = 0;
        }
        if (buf == (byte *)0x0) goto LAB_081e3f83;
      }
LAB_081e3f52:
      CRYPTO_free(buf);
      goto LAB_081e3f83;
    ...
    if (local_54 == 0) goto LAB_081e3fd2;
LAB_081e3ec1:
    if ((int)(cnt + 1 + sLen) < iVar1) goto LAB_081e3ed1;
LAB_081e414c:
