...

{
  ...
  if (enc == -1) {
    enc_00 = ctx->encrypt;
    pEVar2 = ctx->cipher;
    if (ctx->engine != (ENGINE *)0x0) goto LAB_08125e26;
LAB_08125fd0:
...
LAB_08125e40:
    ...
    if (pEVar2 != (EVP_CIPHER *)0x0) goto LAB_08125f3c;
LAB_081260c0:
    iVar1 = 0xc2;
    reason = 0x83;
LAB_081260d8:
    ERR_put_error(6,0x7b,reason,"evp_enc.c",iVar1);
switchD_08126002_caseD_6:
    iVar1 = 0;
  }
  else {
    enc_00 = (uint)(enc != 0);
    ctx->encrypt = enc_00;
    pEVar2 = ctx->cipher;
    if (ctx->engine == (ENGINE *)0x0) goto LAB_08125fd0;
LAB_08125e26:
    if (pEVar2 != (EVP_CIPHER *)0x0) {
      if ((cipher != (EVP_CIPHER *)0x0) && (cipher->nid != pEVar2->nid)) goto LAB_08125e40;
      goto LAB_08125f3c;
    }
    if (cipher == (EVP_CIPHER *)0x0) goto LAB_081260c0;
LAB_08125eca:
    if (impl != (ENGINE *)0x0) {
...
LAB_081261ee:
    ...
    if (impl != (ENGINE *)0x0) goto LAB_08125eed;
...
LAB_08125f3c:
    ...
    if ((uVar3 & 0x10) != 0) goto switchD_08126002_caseD_0;
    uVar3 = EVP_CIPHER_CTX_flags(ctx);
    ...
    case 5:
      ...
      break;
    default:
      goto switchD_08126002_caseD_6;
    }
switchD_08126002_caseD_0:
    pEVar2 = ctx->cipher;
