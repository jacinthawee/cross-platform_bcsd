...
LAB_000b4f28:
      if ((param_1 == (BIO *)0x0) || (iVar13 = BIO_write(param_1,&DAT_001621c0,1), iVar13 == 1)) {
...
LAB_000b51d0:
      ...
      if (local_60[0] == '\0') {
        ...
        local_70 = local_70 + 2;
        if (param_1 == (BIO *)0x0) goto LAB_000b4f4a;
        iVar13 = BIO_write(param_1,&DAT_00176744,1);
              ...
              do {
                ...
                if ((uVar9 & 0x61) == 0) {
                  if ((uVar9 & 6) == 0) {
                    ...
                    iVar4 = BIO_write(param_1,&DAT_001621bc,2);
...
LAB_000b5562:
                    ...
                    iVar4 = BIO_write(param_1,&DAT_001621b0,1);
      ...
      if ((local_60[0] == '\0') || (iVar13 = BIO_write(param_1,&DAT_00176744,1), iVar13 == 1))
      goto LAB_000b4f4a;
    }
  }
  else {
