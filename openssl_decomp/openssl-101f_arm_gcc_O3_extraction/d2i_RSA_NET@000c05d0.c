...

{
  ...
  val = (RSA *)ASN1_item_d2i((ASN1_VALUE **)0x0,&local_1c,length,
                             (ASN1_ITEM *)PTR_NETSCAPE_ENCRYPTED_PKEY_it_000c06b4);
  if (val == (RSA *)0x0) {
    ...
    if ((*(int *)val->pad != 0xb) ||
      ...
      ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)PTR_NETSCAPE_ENCRYPTED_PKEY_it_000c06b4);
      return (RSA *)0x0;
    }
    ...
    if (iVar2 == 5) {
      ...
      pRVar1 = (RSA *)d2i_RSA_NET_2_isra_0(a,iVar2,iVar2 + 8,pcVar3,sgckey);
      if (pRVar1 != (RSA *)0x0) {
        *pp = local_1c;
      }
    }
