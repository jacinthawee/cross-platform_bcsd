...

{
  ...
  if (sVar1 < 0x41) {
    ...
    arg = (undefined4 *)CRYPTO_malloc(0x9c8,"e_4758cca.c",0x1af);
    if (arg == (undefined4 *)0x0) {
      if (CCA4758_lib_error_code == 0) {
        CCA4758_lib_error_code = ERR_get_next_error_library();
      }
      ERR_put_error(CCA4758_lib_error_code,0x67,0x41,"e_4758cca.c",0x1b3);
      pkey = (EVP_PKEY *)0x0;
    }
    else {
      ...
      if (local_c50 == 0) {
        ...
        if (local_c50 == 0) {
          ...
          ERR_put_error(CCA4758_lib_error_code,0x67,0x68,"e_4758cca.c",0x1d2);
        }
        else {
          if (CCA4758_lib_error_code == 0) {
            CCA4758_lib_error_code = ERR_get_next_error_library();
          }
          ERR_put_error(CCA4758_lib_error_code,0x67,0x68,"e_4758cca.c",0x1c9);
        }
      }
      else {
        if (CCA4758_lib_error_code == 0) {
        ...
        ERR_put_error(CCA4758_lib_error_code,0x67,0x68,"e_4758cca.c",0x1be);
      }
      CRYPTO_free(arg);
      pkey = (EVP_PKEY *)0x0;
    }
    ...
    ERR_put_error(CCA4758_lib_error_code,0x67,0x6b,"e_4758cca.c",0x1a8);
    pkey = (EVP_PKEY *)0x0;
  }
LAB_000ef64e:
