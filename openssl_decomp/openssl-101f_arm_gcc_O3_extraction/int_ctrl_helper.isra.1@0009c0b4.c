...
LAB_0009c192:
      ERR_put_error(0x26,0xac,0x89,"eng_ctrl.c",0x86);
      return 0xffffffff;
    }
  }
  else if ((param_2 == 0x11) && (param_4 == (char *)0x0)) goto LAB_0009c12a;
  puVar4 = *param_1;
  if (puVar4 == (uint *)0x0) {
LAB_0009c100:
  ...
  if (param_3 != uVar6) goto LAB_0009c100;
  switch(param_2) {
  case 0xc:
    ...
    break;
  default:
    ERR_put_error(0x26,0xac,0x6e,"eng_ctrl.c",0xb2);
    uVar6 = 0xffffffff;
    break;
  case 0xe:
    uVar6 = puVar4[uVar7 * 4 + 1];
LAB_0009c204:
    uVar7 = (*(code *)PTR_strlen_0018a12c)(uVar6);
    return uVar7;
  case 0xf:
