...
LAB_000a014c:
  ...
  case 2:
    ...
    if (iVar3 < 1) goto switchD_000a0152_caseD_8;
    *param_2 = 3;
    uVar6 = 3;
    break;
  case 3:
  ...
  case 4:
    ...
    *param_2 = 4;
    ...
    if (iVar9 == -1) {
      ...
      ERR_put_error(2,4,*piVar5,"bss_conn.c",0xd7);
  ...
  case 5:
    ...
    if (iVar9 < 0) {
      ...
      if (iVar3 == 0) {
        piVar5 = __errno_location();
        ERR_put_error(2,2,*piVar5,"bss_conn.c",0x10d);
        ERR_add_error_data(4,"host=",param_2[1],":",param_2[2]);
  ...
  case 7:
    ...
    if (local_2c[0] != 0) {
      BIO_clear_flags(param_1,0xf);
      ERR_put_error(2,2,local_2c[0],"bss_conn.c",0x11e);
      iVar9 = 0;
      ERR_add_error_data(4,"host=",param_2[1],":",param_2[2]);
...
LAB_000a01ce:
  ...
  case 8:
    ...
    *param_2 = 5;
    ...
    if ((int)local_2c[0] < 0) {
      piVar5 = __errno_location();
      ERR_put_error(2,4,*piVar5,"bss_conn.c",0xf4);
      ERR_add_error_data(4,"host=",param_2[1],":",param_2[2]);
  ...
  goto joined_r0x000a01b0;
joined_r0x000a0300:
  if (bVar2 == 0) goto LAB_000a0318;
  if (bVar2 == 0x2f) {
    *pbVar1 = 0;
    goto LAB_000a0318;
  }
...
switchD_000a0152_caseD_8:
  ...
  *param_2 = 2;
  uVar6 = 2;
joined_r0x000a01b0:
  if (pcVar8 != (code *)0x0) goto LAB_000a01b2;
  goto LAB_000a014c;
LAB_000a01b2:
