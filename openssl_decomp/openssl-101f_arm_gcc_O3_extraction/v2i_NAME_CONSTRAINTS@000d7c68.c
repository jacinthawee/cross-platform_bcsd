...

{
  ...
  if (val == (_STACK **)0x0) {
    ERR_put_error(0x22,0x93,0x41,"v3_ncons.c",0x98);
  }
  else {
    for (iVar4 = 0; iVar2 = sk_num(param_3), iVar4 < iVar2; iVar4 = iVar4 + 1) {
      ...
      if ((iVar2 == 0) && (__s1[9] != '\0')) {
        ...
        if ((iVar2 != 0) || (__s1[8] == '\0')) {
          val_00 = (_STACK **)0x0;
          ERR_put_error(0x22,0x93,0x8f,"v3_ncons.c",0x87);
          goto LAB_000d7d2c;
        }
      ...
      val_00 = (_STACK **)ASN1_item_new((ASN1_ITEM *)PTR_GENERAL_SUBTREE_it_000d7d90);
      pGVar1 = v2i_GENERAL_NAME_ex((GENERAL_NAME *)*val_00,param_1,param_2,&CStack_34,1);
      if (pGVar1 == (GENERAL_NAME *)0x0) goto LAB_000d7d2c;
      st = *pp_Var5;
      if (st == (_STACK *)0x0) {
        st = sk_new_null();
        *pp_Var5 = st;
        if (st != (_STACK *)0x0) goto LAB_000d7cbe;
LAB_000d7d58:
        ERR_put_error(0x22,0x93,0x41,"v3_ncons.c",0x98);
LAB_000d7d2c:
        ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)&NAME_CONSTRAINTS_it);
        if (val_00 != (_STACK **)0x0) {
          ASN1_item_free((ASN1_VALUE *)val_00,(ASN1_ITEM *)PTR_GENERAL_SUBTREE_it_000d7d90);
          val_00 = (_STACK **)0x0;
        }
        return val_00;
      }
