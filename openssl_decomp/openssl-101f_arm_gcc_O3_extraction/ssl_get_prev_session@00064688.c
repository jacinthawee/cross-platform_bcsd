...
void ssl_get_prev_session(uint *param_1,undefined4 param_2,int param_3)
...
LAB_000646ce:
  ...
  case 0:
  case 1:
    if (iVar8 == 0) goto switchD_000646c4_caseD_2;
    if (local_120 == (SSL_SESSION *)0x0) {
      ...
      if (uVar7 == 0) {
        local_118 = *param_1;
        local_d4 = param_3;
        if (param_3 == 0) goto LAB_000646d0;
        ...
        if (local_120 != (SSL_SESSION *)0x0) {
          CRYPTO_add_lock((int *)(local_120->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x203);
        }
        CRYPTO_lock(6,0xc,"ssl_sess.c",0x205);
        if (local_120 != (SSL_SESSION *)0x0) goto LAB_00064708;
        uVar6 = param_1[0x5c];
        *(int *)(uVar6 + 0x4c) = *(int *)(uVar6 + 0x4c) + 1;
      }
      if (*(code **)(uVar6 + 0x30) == (code *)0x0) goto LAB_000646ce;
      local_11c = 1;
      ...
      if (local_120 != (SSL_SESSION *)0x0) {
        ...
        if (local_11c != 0) {
          CRYPTO_add_lock((int *)(local_120->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x21a);
          pSVar4 = (SSL_CTX *)param_1[0x5c];
        }
...
LAB_00064708:
  ...
  case 2:
  case 3:
switchD_000646c4_caseD_2:
    iVar8 = 0;
LAB_000646e8:
    if (local_120 == (SSL_SESSION *)0x0) goto LAB_000646ce;
    break;
  default:
    ...
    if (((int)(param_1[0x32] << 0x1f) < 0) && (__n == 0)) {
      ...
      if (*(int *)(pSVar5->krb5_client_princ + 0x24) == 0) {
        ...
        *(undefined4 *)(pSVar5->krb5_client_princ + 0x24) = uVar1;
        pSVar5 = local_120;
        if (*(int *)(local_120->krb5_client_princ + 0x24) == 0) goto LAB_00064718;
      }
      ...
      pSVar5 = local_120;
      if (iVar8 == 0) goto LAB_00064718;
      SSL_CTX_remove_session(pSVar4,local_120);
      iVar8 = 1;
    }
joined_r0x00064856:
    pSVar5 = local_120;
    if (local_120 == (SSL_SESSION *)0x0) goto LAB_000646d0;
  }
  else {
    uVar7 = 0;
  }
LAB_00064718:
  iVar2 = CRYPTO_add_lock((int *)(pSVar5->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
  if (iVar2 < 1) {
