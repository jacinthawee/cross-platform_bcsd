...

{
  ...
  CRYPTO_lock(9,0x1e,"eng_table.c",0x87);
    ...
    do {
      while( true ) {
        ...
        if (ptr == (undefined4 *)0x0) {
          ptr = (undefined4 *)CRYPTO_malloc(0x10,"eng_table.c",0x95);
          if (ptr == (undefined4 *)0x0) goto LAB_0010bb06;
          ptr[3] = 1;
          *ptr = *param_4;
          p_Var3 = sk_new_null();
          ptr[1] = p_Var3;
        ...
        ptr[3] = 1;
        param_4 = param_4 + 1;
        if (param_5 == 0) goto LAB_0010baca;
      }
      param_5 = param_5 + -1;
      param_4 = param_4 + 1;
    } while (param_5 != 0);
...
LAB_0010baca:
  p_Var3 = (_STACK *)0x1;
LAB_0010bb08:
  CRYPTO_lock(10,0x1e,"eng_table.c",0xba);
  return p_Var3;
}
