...

{
  ...
  if (dso == (DSO *)0x0) {
    ERR_put_error(0x25,0x6e,0x43,"dso_lib.c",0x139);
    lVar1 = -1;
  }
  else {
    if (cmd == 2) {
    ...
    if (cmd == 3) {
      ...
      {
                    /* WARNING: Could not recover jumptable at 0x0010b566. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        lVar1 = (*UNRECOVERED_JUMPTABLE)(dso,cmd,larg,parg);
        return lVar1;
      }
      ERR_put_error(0x25,0x6e,0x6c,"dso_lib.c",0x14e);
      lVar1 = -1;
    }
  }
  return lVar1;
