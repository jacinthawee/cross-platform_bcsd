...

{
  ...
  if (param_2 != 200) {
    ...
    ERR_put_error(UBSEC_lib_error_code,100,0x66,"e_ubsec.c",0x228);
    return (char *)0x0;
  }
  if (param_4 == (char *)0x0) {
    if (UBSEC_lib_error_code == 0) {
    ...
    ERR_put_error(UBSEC_lib_error_code,100,0x43,"e_ubsec.c",0x21c);
  }
  else {
    if (ubsec_dso == 0) {
    ...
    ERR_put_error(UBSEC_lib_error_code,100,100,"e_ubsec.c",0x221);
  }
  return (char *)0x0;
}
