...

{
  ...
  if (a != (stack_st_OPENSSL_BLOCK *)0x0) {
    ...
    if (pp != (uchar **)0x0) {
      ...
      if ((is_set == 0) || (iVar1 = sk_num(&a->stack), __dest = local_2c[0], iVar1 < 2)) {
        iVar1 = 0;
        while( true ) {
        ...
        *pp = (uchar *)local_2c[0];
        ...
        iVar1 = sk_num(&a->stack);
        __base = (uchar **)CRYPTO_malloc(iVar1 << 3,"a_set.c",0x7b);
        if (__base == (uchar **)0x0) {
          ...
          *pp = (uchar *)local_2c[0];
          ...
          ppuVar5 = (uchar **)CRYPTO_malloc(__n,"a_set.c",0x90);
          if (ppuVar5 == (uchar **)0x0) {
            ERR_put_error(0xd,0xbc,0x41,"a_set.c",0x92);
            __base = ppuVar5;
          }
          else {
            ppuVar6 = __base;
