...

{
  ...
  if (param_1 == 0) {
    ...
    if (param_2 == (uint *)0x0) goto LAB_000ec8dc;
LAB_000ec7ae:
    ...
    if (param_2 != (uint *)0x0) goto LAB_000ec7ae;
LAB_000ec8dc:
    __s = (uint *)CRYPTO_malloc(0x28,"ts_verify_ctx.c",0x42);
    if (__s == (uint *)0x0) {
  ...
  *__s = 0x6e;
  ...
  if (pAVar1 == (ASN1_OBJECT *)0x0) {
    *__s = *__s & 0xfffffffb;
    ...
    __s[3] = (uint)pAVar1;
    if (pAVar1 == (ASN1_OBJECT *)0x0) goto LAB_000ec868;
  }
  ...
  if (pXVar3 != (X509_ALGOR *)0x0) {
    ...
    __s[6] = num;
    __dest = CRYPTO_malloc(num,"ts_verify_ctx.c",0x8d);
    __s[5] = (uint)__dest;
    if (__dest != (void *)0x0) {
