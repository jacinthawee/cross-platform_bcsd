...
int aep_mod_exp_dh(undefined4 param_1,BIGNUM *param_2,BIGNUM *param_3,BIGNUM *param_4,
...

{
  ...
  if (iVar2 < 0x881) {
    ...
    if (iVar2 == 0) {
      iVar2 = (*p_AEP_ModExp)(local_2c[0],param_3,param_4,param_5,param_2,0);
      if (iVar2 == 0) {
      ...
      puVar1 = PTR_aep_app_conn_table_000f0800;
