...

{
  ...
  if (aep_dso == 0) {
    ...
    ERR_put_error(AEPHK_lib_error_code,0x6b,0x6f,"e_aep.c",0x307);
    uVar3 = 0;
  }
  else {
    pBVar7 = param_3->q;
    if ((((pBVar7 != (BIGNUM *)0x0) && (pBVar8 = param_3->dmp1, pBVar8 != (BIGNUM *)0x0)) &&
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          CRYPTO_lock(9,0x1e,"e_aep.c",0x3cc);
          do {
            iVar9 = iVar1 * 8;
            iVar1 = iVar1 + 1;
          ...
          CRYPTO_lock(10,0x1e,"e_aep.c",0x3d8);
          return 1;
        }
        if (AEPHK_lib_error_code == 0) {
          AEPHK_lib_error_code = ERR_get_next_error_library();
        }
        ERR_put_error(AEPHK_lib_error_code,0x69,0x6d,"e_aep.c",0x29e);
        CRYPTO_lock(9,0x1e,"e_aep.c",0x3e2);
        iVar1 = 0;
        do {
          iVar9 = iVar1 * 8;
          iVar1 = iVar1 + 1;
          if (local_2c[0] == *(int *)(PTR_aep_app_conn_table_000f1094 + iVar9 + 4)) {
        ...
        CRYPTO_lock(10,0x1e,"e_aep.c",0x3f3);
      }
      else {
        if (AEPHK_lib_error_code == 0) {
          AEPHK_lib_error_code = ERR_get_next_error_library();
        }
        ERR_put_error(AEPHK_lib_error_code,0x69,0x69,"e_aep.c",0x295);
      }
