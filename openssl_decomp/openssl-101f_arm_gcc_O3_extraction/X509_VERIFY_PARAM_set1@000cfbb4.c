...

{
  ...
  if (from == (X509_VERIFY_PARAM *)0x0) goto LAB_000cfc5a;
  ...
  if ((int)(uVar6 << 0x1c) < 0) goto LAB_000cfc5a;
  if ((int)(uVar6 << 0x1e) < 0) {
    uVar1 = 1;
    iVar9 = from->purpose;
    iVar7 = from->trust;
    ...
    if (p_Var10 != (_STACK *)0x0) {
      ...
      if (p_Var2 != (_STACK *)0x0) {
        ...
        do {
          ...
          if (pAVar3 == (ASN1_OBJECT *)0x0) goto LAB_000cfc8c;
