...

{
  ...
  if (pXVar4 != (X509 *)0x0) {
    ...
    if (pXVar4 != (X509 *)0x0) {
      ...
      do {
        iVar6 = local_140;
        if (*(char *)&bp->cert_info != '-') goto LAB_00038816;
                                            ...
                                            if (iVar6 == 0) {
                                              ...
                                              if (iVar6 == 0) {
                                                ...
                                                if (iVar6 == 0) {
                                                  ...
                                                  + 4);
                                                  if (*ppXVar1 == (X509 *)0x0) goto LAB_00038816;
                                                  param_2 = param_2 + 4;
                                                  local_17c = *ppXVar1;
                                                  iVar6 = local_140;
                                                  }
...
LAB_0003881a:
        ...
        if (bp == (X509 *)0x0) goto LAB_00038848;
        param_2 = param_2 + 4;
      } while( true );
    }
    local_184 = 0x800;
...
LAB_00038848:
  ...
  pXVar4 = (X509 *)((uint)local_188 | (uint)local_194);
  if (bVar2) {
    ...
    local_188 = pXVar4;
joined_r0x00038b1a:
    if (local_188 == (X509 *)0x0) goto LAB_00038b1c;
  }
  else {
LAB_00038bf2:
...
LAB_00038d02:
      ...
      if ((int)local_198 << 0x1f < 0) {
        ...
        if (local_198 == (X509 *)0x0) goto LAB_00038d02;
      }
      if (pXVar14 == (X509 *)0x0) {
        ...
        local_194 = local_198;
        if (local_198 == (X509 *)0x0) goto LAB_00038db4;
        for (; iVar6 = sk_num((_STACK *)local_190), (int)pXVar14 < iVar6;
          ...
          if (iVar6 != 0) {
            ...
            if (local_194 != (X509 *)0x0) goto LAB_00038db4;
            break;
          }
        }
        uVar15 = 1;
...
LAB_00038e0a:
          ...
          if (pXVar14 == (X509 *)0x0) {
            ...
            X509_STORE_CTX_init(&XStack_11c,(X509_STORE *)pXVar14,local_194,(stack_st_X509 *)0x0);
...
LAB_00038f04:
        if (local_198 != (X509 *)0x0) goto LAB_00038f08;
      }
      if (local_190 != (X509 *)0x0) {
      ...
      local_188 = pXVar4;
      if (pXVar14 != (X509 *)0x0) goto LAB_00038f48;
    }
  }
