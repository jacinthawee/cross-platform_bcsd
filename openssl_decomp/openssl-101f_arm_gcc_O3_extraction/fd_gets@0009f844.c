    ...
    while( true ) {
      *piVar2 = 0;
      ...
      if (((*__buf == '\n') || (__buf = pcVar5, pcVar5 == param_2 + param_3 + -1)) ||
         (pcVar5 == (char *)0x0)) goto LAB_0009f89c;
    }
    if (sVar3 + 1U < 2) {
      iVar4 = *piVar2;
      if (iVar4 == 0x47) {
...
LAB_0009f8ce:
        *__buf = '\0';
        cVar1 = *param_2;
        goto joined_r0x0009f8d8;
      }
      if (iVar4 < 0x48) {
        if (iVar4 == 4) goto LAB_0009f8c6;
        if (iVar4 == 0xb) {
          BIO_set_flags(param_1,9);
          goto LAB_0009f8ce;
        }
      }
      else if ((iVar4 == 0x6b) || ((0x6a < iVar4 && (iVar4 - 0x72U < 2)))) goto LAB_0009f8c6;
    }
  }
LAB_0009f89c:
  *__buf = '\0';
...
joined_r0x0009f8d8:
  ...
  (*(code *)PTR_strlen_0018a12c)(param_2);
  return;
}
