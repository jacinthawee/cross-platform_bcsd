...
LAB_0007d390:
  ...
  switch(uVar25) {
  default:
    goto switchD_0007d308_caseD_7;
  case 0xfffffff9:
    goto LAB_0007d340;
  case 0xfffffffa:
    goto switchD_0007d308_caseD_fffffffa;
  case 0xfffffffb:
    goto LAB_0007d330;
  case 0xfffffffc:
    goto switchD_0007d308_caseD_fffffffc;
  case 0xfffffffd:
    break;
  case 0xffffffff:
    puVar14 = local_48 + -1;
