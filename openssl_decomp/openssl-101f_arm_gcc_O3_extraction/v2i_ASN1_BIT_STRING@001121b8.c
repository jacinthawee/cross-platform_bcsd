...

{
  ...
  if (a == (ASN1_STRING *)0x0) {
    ERR_put_error(0x22,0x65,0x41,"v3_bitst.c",0x71);
  ...
  if (0 < iVar1) {
    do {
      ...
      if (__s1 == (char *)0x0) {
LAB_00112232:
        ERR_put_error(0x22,0x65,0x6f,"v3_bitst.c",0x84);
      ...
      while ((iVar1 = strcmp((char *)piVar3[2],__s2), iVar1 != 0 &&
        ...
        __s1 = (char *)piVar3[4];
        piVar3 = piVar3 + 3;
        if (__s1 == (char *)0x0) goto LAB_00112232;
      }
      iVar1 = ASN1_BIT_STRING_set_bit(a,*piVar3,1);
      if (iVar1 == 0) {
        ERR_put_error(0x22,0x65,0x41,"v3_bitst.c",0x7b);
        ASN1_STRING_free(a);
        return (ASN1_BIT_STRING *)0x0;
      }
      if (piVar3[1] == 0) goto LAB_00112232;
      iVar4 = iVar4 + 1;
      iVar1 = sk_num(&nval->stack);
    } while (iVar4 < iVar1);
  }
