...
LAB_00021050:
        param_1 = param_1 + -1;
        ppcVar14 = ppcVar14 + 1;
        if (param_1 < 1) goto LAB_000210a8;
      }
      ...
      if (iVar9 != 0) {
        ...
        if ((((cVar3 == '-') && (__s1[1] == 'i')) && (__s1[2] == 'n')) && (__s1[3] == '\0')) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_000211e0;
          local_60 = ppcVar14[1];
          ppcVar14 = ppcVar14 + 1;
        }
        else {
      ...
      if (param_1 == 1) goto LAB_000211e0;
      param_1 = param_1 + -2;
...
LAB_000210a8:
  ...
  if (r == (DSA *)0x0 || bp == (BIO *)0x0) {
    ...
    local_50 = 1;
    if (r == (DSA *)0x0) goto LAB_000213ba;
    local_50 = 1;
    dsa = (DSA *)0x0;
  }
  else {
...
LAB_00021196:
        ...
        if (bVar5) {
          ...
          to = (uchar *)CRYPTO_malloc((iVar8 >> 3) + 0x14,"dsaparam.c",0x16a);
          if (to == (uchar *)0x0) {
            local_50 = 1;
          ...
          if (0 < iVar8) {
            ...
            do {
              if (iVar9 == (iVar9 / 0xc) * 0xc) {
                __printf_chk(1,&DAT_001275ec,(iVar9 / 0xc) * 3,iVar9 * 0x2aaaaaab);
              }
              puVar2 = to + iVar9;
              iVar9 = iVar9 + 1;
        ...
        if (bVar7) {
          if (local_50 == 0) {
            ...
            __assert_fail("need_rand","dsaparam.c",0x1af,"dsaparam_main");
          }
          a = DSAparams_dup(dsa);
          if (a == (DSA *)0x0) goto LAB_00021466;
...
LAB_000215c0:
      ...
      if (local_50 == 0) {
                    /* WARNING: Subroutine does not return */
        __assert_fail("need_rand","dsaparam.c",0x125,"dsaparam_main");
      }
      dsa = DSA_new();
      if (dsa == (DSA *)0x0) {
