      ...
      if (iVar3 == 0xcc) {
        ...
        if ((ppAVar5 == (ASN1_OCTET_STRING **)0x0) || (*ppAVar5 == (ASN1_STRING *)0x0)) {
          ...
          if (pAVar6 == (ASN1_OBJECT *)0x0) {
            ...
            if (pAVar8 == pAVar7) {
              ERR_put_error(0x2e,0xa0,0xa6,"cms_ess.c",0x120);
              pAVar8 = (ASN1_OBJECT *)0x0;
            }
            else {
              ...
              if (pAVar8 == (ASN1_OBJECT *)0x0) {
                ...
                if ((type == (EVP_MD *)0x0) ||
                   ...
                   iVar3 == 0)) {
                  ERR_put_error(0x2e,0xa0,0xac,"cms_ess.c",0x134);
                  pAVar8 = (ASN1_OBJECT *)0x0;
                }
                  ...
                  if (pAVar7 == (ASN1_OBJECT *)0x0) {
                    ...
                    if (pAVar8 == (ASN1_OBJECT *)0x0) {
                      ERR_put_error(0x2e,0xa0,0xad,"cms_ess.c",0x14d);
                    }
                    else {
                      ...
                      if (pAVar8 == (ASN1_OBJECT *)0x0) {
                        ...
                        if (iVar3 < 1) {
                          ERR_put_error(0x2e,0xa0,0xa8,"cms_ess.c",0x15d);
                        }
                        else {
                          ...
                          if (iVar3 == 0) {
                            ...
                            ERR_put_error(0x2e,0xa0,0xaa,"cms_ess.c",0x165);
                            pAVar8 = (ASN1_OBJECT *)0x0;
                          }
                        }
                      }
                      else {
                        ERR_put_error(0x2e,0xa0,0xab,"cms_ess.c",0x155);
                        pAVar8 = pAVar7;
                      }
                    }
                  }
                  else {
                    ERR_put_error(0x2e,0xa0,0xa2,"cms_ess.c",0x142);
                    pAVar8 = (ASN1_OBJECT *)0x0;
                  }
                }
                else {
                  ERR_put_error(0x2e,0xa0,0xa3,"cms_ess.c",0x13b);
                  pAVar8 = (ASN1_OBJECT *)0x0;
                }
              }
            }
