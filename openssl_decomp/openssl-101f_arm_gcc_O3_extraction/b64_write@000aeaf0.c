        ...
        if (0 < iVar7) {
          do {
            ...
            if (iVar7 < (int)puVar6) {
              ...
              outl[1] = (int)puVar4;
              if (0x5de < (int)puVar4) goto LAB_000aece2;
LAB_000aec98:
              if (*outl < (int)puVar4) goto LAB_000aed02;
            }
            else {
              puVar4 = puVar6 + outl[1];
              outl[1] = (int)puVar4;
              if ((int)puVar4 < 0x5df) goto LAB_000aec98;
LAB_000aece2:
...
LAB_000aed02:
  ...
  do {
    ...
    if (iVar7 < (int)puVar3) {
      ...
      outl[1] = (int)puVar6;
      if (0x5de < (int)puVar6) goto LAB_000aeb9e;
LAB_000aeb56:
      if (*outl < (int)puVar6) goto LAB_000aebbe;
    }
    else {
      puVar6 = puVar3 + outl[1];
      outl[1] = (int)puVar6;
      if ((int)puVar6 < 0x5df) goto LAB_000aeb56;
LAB_000aeb9e:
...
LAB_000aebbe:
    ...
    if (iVar7 - (int)puVar3 < 1) goto LAB_000aebda;
    iVar5 = outl[1];
