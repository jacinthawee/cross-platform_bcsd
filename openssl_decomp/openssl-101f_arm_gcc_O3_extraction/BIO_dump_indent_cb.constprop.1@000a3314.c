...
void BIO_dump_indent_cb_constprop_1(BIO *param_1,byte *param_2,int param_3,int param_4)
      ...
      if (iVar6 < 1) {
        ...
        do {
          while (iVar4 <= iVar5 + iVar7) {
            iVar7 = iVar7 + 1;
            BUF_strlcat(local_150,"   ",0x121);
            if (iVar7 == iVar6) goto LAB_000a3448;
          }
...
LAB_000a3448:
      ...
      iVar5 = iVar5 + iVar6;
      pbVar8 = pbVar8 + iVar6;
      iVar7 = BIO_write(param_1,local_150,sVar1);
      local_204 = local_204 + iVar7;
    } while (iVar9 != local_1fc);
  }
  if (local_1ec != 0) {
    BIO_snprintf(local_150,0x121,"%s%04x - <SPACES/NULS>\n",local_1d4,iVar4 + local_1ec);
    sVar1 = strlen(local_150);
    iVar4 = BIO_write(param_1,local_150,sVar1);
