    ...
    if (iVar5 == -1) {
      ...
      do {
        while( true ) {
          ...
          __fd = iVar4;
          if (param_2 == 1) {
            puVar7 = DAT_00036bd4 + 1;
            puVar6 = DAT_00036bd4 + 2;
            while( true ) {
              __addr = PTR_from_20706_00036bd8;
              local_40 = 0x10;
              *(undefined4 *)PTR_from_20706_00036bd8 = 0;
              *puVar1 = 0;
              *puVar7 = 0;
              *puVar6 = 0;
            ...
            ptr = gethostbyaddr(DAT_00036bd4,4,2);
            if (ptr == (hostent *)0x0) {
              BIO_printf(bio_err,"bad gethostbyaddr\n");
            }
            else {
              sVar3 = strlen(ptr->h_name);
              dst = (hostent *)CRYPTO_malloc(sVar3 + 1,"s_socket.c",0x1c2);
              if (dst == (hostent *)0x0) {
