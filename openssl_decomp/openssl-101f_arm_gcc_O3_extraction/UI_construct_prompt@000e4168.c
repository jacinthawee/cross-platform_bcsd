...

{
  ...
  if (*(code **)(*(int *)ui_method + 0x18) == (code *)0x0) {
    local_24 = s_Enter_0016bfa8._0_4_;
    local_30[0] = 0x3a;
    local_20 = (undefined2)ram0x0016bfac;
    local_2c = DAT_0016bfb0;
    local_1e = (undefined)((uint)ram0x0016bfac >> 0x10);
    local_28 = (undefined2)DAT_0016bfb4;
