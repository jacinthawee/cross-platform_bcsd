...

{
  ...
  ptr = (X509_NAME *)CRYPTO_malloc(sVar3 + 1,"apps.c",0x84b);
  iVar10 = ((sVar3 + 1 >> 1) + 1) * 4;
  ptr_00 = (char **)CRYPTO_malloc(iVar10,"apps.c",0x84d);
  ptr_01 = CRYPTO_malloc(iVar10,"apps.c",0x84e);
  ptr_02 = (X509_NAME **)CRYPTO_malloc(iVar10,"apps.c",0x84f);
...
LAB_00034fa2:
          ...
          *ppXVar13 = pXVar6;
          do {
            ...
            bVar7 = *pbVar9;
            if (bVar7 == 0) goto LAB_00034fe6;
            if (bVar7 == 0x5c) {
              bVar7 = pbVar9[1];
              pbVar9 = pbVar9 + 2;
              if (bVar7 == 0) goto LAB_00034fca;
            }
            else {
              if (bVar7 == 0x3d) goto LAB_00035004;
              pbVar9 = pbVar9 + 1;
            }
        ...
        name = X509_NAME_new();
        if (name != (X509_NAME *)0x0) goto LAB_00035134;
      }
      else {
  ...
  if (param_3 == 0) {
    while( true ) {
      ...
      if (bVar7 == 0x5c) {
        pbVar1 = pbVar9 + 1;
        pbVar9 = pbVar9 + 2;
        if (*pbVar1 == 0) goto LAB_00034fca;
        pcVar5[-1] = *pbVar1;
      }
      else {
        if (bVar7 == 0x2f) goto LAB_0003506c;
        pbVar9 = pbVar9 + 1;
        pcVar5[-1] = bVar7;
      }
      pcVar5 = pcVar5 + 1;
...
LAB_00035072:
  *pcVar14 = bVar2;
  ...
  ppXVar4 = ppXVar4 + 1;
  if (pXVar8 == (X509_NAME *)0x0) goto code_r0x00035086;
  goto LAB_00034fa2;
LAB_0003506c:
  pbVar9 = pbVar9 + 1;
  ppXVar4[1] = name;
