...

{
  ...
  if ((pkey == (EVP_PKEY *)0x0 && cert == (X509 *)0x0) && (ca == (stack_st_X509 *)0x0)) {
    ERR_put_error(0x23,0x69,0x68,"p12_crt.c",0x6e);
    goto LAB_000df960;
  }
  pEVar12 = pkey;
...
LAB_000df8e6:
      ...
      if (0 < iVar3) {
        do {
          ...
          if (pPVar2 == (PKCS12_SAFEBAG *)0x0) goto LAB_000df94e;
...
LAB_000df948:
          ...
          if (local_7c == (EVP_PKEY *)0x0) {
            ...
            if (local_7c != (EVP_PKEY *)0x0) {
              ...
              if (pEVar9 != (EVP_PKEY *)0x0) goto LAB_000df986;
...
LAB_000dfa2a:
        ...
        local_7c = (EVP_PKEY *)0x0;
        if (pEVar12 == (EVP_PKEY *)0x0) goto LAB_000dfb02;
        ...
        if (pPVar2 != (PKCS12_SAFEBAG *)0x0) {
          ...
          if (-1 < iVar3) {
            ...
            if (psVar8 == (stack_st_X509_ATTRIBUTE *)0x0) goto LAB_000dfaea;
          }
          ...
          if (((name == (char *)0x0) ||
            ...
            if (local_7c != (EVP_PKEY *)0x0) {
              ...
              if (pEVar5 == (EVP_PKEY *)0x0) {
                ...
                if (pEVar9 == (EVP_PKEY *)0x0) goto LAB_000df94e;
                bVar1 = true;
              }
              ...
              if (iVar3 != 0) {
                ...
                if ((mac_iter == -1) ||
                   (iVar3 = PKCS12_set_mac((PKCS12 *)ca,pass,-1,(uchar *)0x0,0,mac_iter,
                                           (EVP_MD *)0x0), iVar3 != 0)) goto LAB_000df960;
