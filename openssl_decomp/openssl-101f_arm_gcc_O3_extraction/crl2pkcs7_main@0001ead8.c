...

{
  ...
  if (param_1 < 1) {
    ...
    pBVar3 = BIO_s_file();
    bp = BIO_new(pBVar3);
    if (bp == (BIO *)0x0 || a == (X509_CRL *)0x0) goto LAB_0001ed40;
    iVar13 = 3;
    local_34 = (char *)0x0;
    iVar12 = 3;
    local_3c = (_STACK *)0x0;
...
LAB_0001eb3e:
    do {
      ...
      if (iVar2 == 0) {
        param_1 = param_1 + -1;
        if (param_1 == 0) goto LAB_0001ec5e;
        ppcVar1 = ppcVar11 + 1;
        ppcVar11 = ppcVar11 + 1;
        ...
        if (iVar2 == 0) {
          if (param_1 == 1) goto LAB_0001ec5e;
          param_1 = param_1 + -2;
...
LAB_0001ed40:
      ...
      if (st != (X509_CRL *)0x0) goto LAB_0001ed94;
      if (__s == (char *)0x0) goto LAB_0001ee06;
      lVar4 = BIO_ctrl((BIO *)a,0x6c,3,__s);
      if (0 < lVar4) goto LAB_0001ebcc;
      perror(__s);
      pXVar10 = (X509_CRL *)0x1;
      p7 = st;
    }
