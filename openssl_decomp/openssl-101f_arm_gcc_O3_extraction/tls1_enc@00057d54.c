...
LAB_00058062:
        ...
        *(char *)((int)puVar10 + 7) = cVar9;
        ...
        if (iVar6 != 0xfeff && iVar6 != 0x100) goto LAB_00058062;
...
LAB_00057fc0:
      ...
      local_4c = EVP_CIPHER_CTX_ctrl(ctx,0x16,0xd,&local_3c);
      if (param_2 != 0) {
        puVar12[1] = puVar12[1] + local_4c;
        uVar7 = uVar13 + local_4c;
LAB_00057f8c:
        if (param_2 != 0) goto LAB_00057efc;
      }
      uVar13 = uVar7;
      if (uVar7 == 0) goto LAB_00057e58;
      __aeabi_uidivmod(uVar7,iVar4);
      uVar13 = 0;
      if (extraout_r1_00 != 0) goto LAB_00057e58;
    }
    else {
...
LAB_00057efc:
    ...
    if (uVar7 == 0) {
      ...
      if (uVar11 != 0) {
        uVar13 = tls1_cbc_remove_padding(param_1,puVar12,iVar4,pEVar3);
      }
      if (local_4c == 0) {
        uVar7 = 0;
      }
    ...
    if ((((ctx == (EVP_CIPHER_CTX *)0x0) ||
       ...
       (iVar6 = EVP_CIPHER_iv_length((EVP_CIPHER *)cipher), iVar6 < 2)) goto LAB_00057e36;
