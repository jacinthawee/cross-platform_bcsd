...

{
  ...
  if (fl < 10) {
    ERR_put_error(4,0x72,0x6f,"rsa_ssl.c",0x72);
  }
  else {
    if ((fl + 1 != rsa_len) || (*f != '\x02')) {
      ERR_put_error(4,0x72,0x6b,"rsa_ssl.c",0x77);
      return -1;
    }
    iVar2 = fl + -1;
    iVar4 = 0;
    ...
    if ((iVar4 == iVar2 || iVar4 == 7) || iVar1 < 0 != bVar5) {
      ...
      ERR_put_error(4,0x72,0x6d,"rsa_ssl.c",0x93);
    }
  }
  return -1;
}
