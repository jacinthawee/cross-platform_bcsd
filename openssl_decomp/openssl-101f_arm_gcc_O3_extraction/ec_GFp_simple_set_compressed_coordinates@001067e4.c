                  ...
                  if (iVar2 != 0) {
                    ...
                    if (pBVar1 == (BIGNUM *)0x0) {
                      ...
                      if ((uVar3 >> 0x18 == 3) && ((uVar3 & 0xfff) == 0x6f)) {
                        ERR_clear_error();
                        ERR_put_error(0x10,0xa9,0x6e,"ecp_oct.c",0x9c);
                      }
                      else {
                        pBVar1 = (BIGNUM *)0x0;
                        ERR_put_error(0x10,0xa9,3,"ecp_oct.c",0x9f);
                      }
                      goto LAB_0010683c;
                    }
...
LAB_00106a1a:
                      ...
                      if (uVar4 == param_4) {
                        ...
                        pBVar1 = (BIGNUM *)0x0;
                        ERR_put_error(0x10,0xa9,0x44,"ecp_oct.c",0xb7);
                      }
                      goto LAB_0010683c;
                    }
                    if (pBVar1 == (BIGNUM *)0x0) {
                      ...
                      if (iVar2 != -2) {
                        if (iVar2 == 1) {
                          ERR_put_error(0x10,0xa9,0x6d,"ecp_oct.c",0xad);
                        }
                        else {
                          ERR_put_error(0x10,0xa9,0x6e,"ecp_oct.c",0xb0);
                        }
                        goto LAB_0010683c;
                      }
                    }
