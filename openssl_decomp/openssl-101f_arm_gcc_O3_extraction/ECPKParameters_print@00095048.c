            ...
            if (b == (BIGNUM *)0x0) {
              ...
              if (order == (BIGNUM *)0x0) {
                ...
                if (cofactor == (BIGNUM *)0x0) {
                  ...
                  if (uVar7 >> 5 == 0) {
                    iVar8 = EC_GROUP_get_curve_GFp(x,p,a,b,(BN_CTX *)ctx);
                    if (iVar8 != 0) goto LAB_00095230;
                    iVar2 = 0x10;
                    local_d4 = (BIGNUM *)0x0;
                    local_d8 = (BIGNUM *)0x0;
                    x = (EC_GROUP *)cofactor;
                      ...
                      if (local_d8 == (BIGNUM *)0x0) {
                        ...
                        if ((local_d4 == (BIGNUM *)0x0) ||
                          ...
                          if (local_d4 == (BIGNUM *)0x0) {
                            ...
                            local_d8 = (BIGNUM *)CRYPTO_malloc(uVar10 + 10,"eck_prn.c",0x10a);
                            if (local_d8 == (BIGNUM *)0x0) {
                              iVar2 = 0x41;
                              x = (EC_GROUP *)cofactor;
                            }
...
LAB_000953d8:
                                      ...
                                      if (((iVar2 != 0) &&
                                          (iVar2 = ASN1_bn_print(bp,"Order: ",order,
                                                                 (uchar *)local_d8,off), iVar2 != 0)
                                                                      ...
                                                                      (uchar *)local_d8,off),
                                               iVar2 != 0)) {
                                        if (puVar6 == (uchar *)0x0) goto LAB_000951fe;
                                        local_cc = off;
                                        if (off != 0) {
                                          if (0x80 < off) {
                                            local_cc = 0x80;
                                          }
                                          __memset_chk(&local_b0,0x20,local_cc,0x80);
                                          iVar2 = BIO_write(bp,&local_b0,local_cc);
                                          if (iVar2 < 1) goto LAB_00095390;
                                        }
                                        ...
                                        if (0 < iVar2) {
                                          ...
                                          do {
                                            if (puVar9 == local_b8) {
                                              iVar2 = BIO_write(bp,"\n",1);
                                              if (0 < iVar2) goto LAB_000951fe;
                                              break;
                                            }
                                            __aeabi_uidivmod(puVar9,0xf);
                                            if (extraout_r1 == 0) {
                                              local_b0 = 10;
                                              __memset_chk(auStack_af,0x20,local_cc + 4,0x7f);
                                              iVar2 = BIO_write(bp,&local_b0,local_cc + 5);
                                              if (iVar2 < 1) break;
                                            }
                                            pbVar1 = puVar6 + (int)puVar9;
                                            puVar9 = puVar9 + 1;
                                            pcVar3 = local_c8;
                                            if (local_b8 != puVar9) {
                                              pcVar3 = ":";
                                    ...
                                    if ((iVar2 != 0) &&
                                       (iVar8 = BIO_indent(bp,off,0x80), iVar8 != 0)) {
                                      pcVar3 = OBJ_nid2sn(iVar2);
...
LAB_000951fe:
  ...
  iVar8 = 0;
  ERR_put_error(0x10,0x95,iVar2,"eck_prn.c",0x150);
  cofactor = (BIGNUM *)x;
LAB_000950c2:
  if (p != (BIGNUM *)0x0) {
    BN_free(p);
