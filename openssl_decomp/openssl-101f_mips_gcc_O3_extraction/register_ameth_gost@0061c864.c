...

{
  ...
  iVar1 = (*(code *)PTR_EVP_PKEY_asn1_new_006aa980)(param_1,4);
  *param_2 = iVar1;
  if (iVar1 == 0) {
    return 0;
  }
  if (param_1 == 0x32c) {
    (*(code *)PTR_EVP_PKEY_asn1_set_free_006aa984)(iVar1,pkey_free_gost94);
    (*(code *)PTR_EVP_PKEY_asn1_set_private_006aa98c)
              (*param_2,priv_decode_gost,priv_encode_gost,priv_print_gost94);
    (*(code *)PTR_EVP_PKEY_asn1_set_param_006aa990)
    ...
    if (param_1 == 0x32f) {
      (*(code *)PTR_EVP_PKEY_asn1_set_free_006aa984)(iVar1,mackey_free_gost);
      (*(code *)PTR_EVP_PKEY_asn1_set_ctrl_006aa988)(*param_2,mac_ctrl_gost);
      return 1;
    }
    if (param_1 != 0x32b) {
      return 1;
    }
    (*(code *)PTR_EVP_PKEY_asn1_set_free_006aa984)(iVar1,pkey_free_gost01);
    (*(code *)PTR_EVP_PKEY_asn1_set_private_006aa98c)
  ...
  (*(code *)PTR_EVP_PKEY_asn1_set_public_006aa994)
            (iVar1,pcVar3,pcVar4,pcVar5,pcVar2,pkey_size_gost,pkey_bits_gost);
  (*(code *)PTR_EVP_PKEY_asn1_set_ctrl_006aa988)(*param_2,pkey_ctrl_gost);
  return 1;
}
