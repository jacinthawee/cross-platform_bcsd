...

{
  ...
  local_98 = &_gp;
  local_8c = (int *)PTR___stack_chk_guard_006aabf0;
  local_2c = *(int *)PTR___stack_chk_guard_006aabf0;
  iVar2 = (*(code *)PTR_OBJ_obj2nid_006a822c)(*param_1);
  if (iVar2 == 0x16) {
    uStack_b8 = 0;
    if (param_1[1] != 0) {
    ...
    local_a0 = 0x47;
    uStack_b8 = 0;
    (**(code **)(local_98 + -0x6eb0))(0x2e,0x85,0x6c,"cms_sd.c");
  }
  iStack_c0 = 0;
  ...
  if (0 < iVar2) {
    do {
      ...
      if (*(int *)(unaff_s2 + 0x20) == 0) {
        local_a0 = 0x275;
        (**(code **)(local_98 + -0x6eb0))(0x2e,0x96,0x85,"cms_sd.c");
        iVar2 = 0;
        goto LAB_005bc2c8;
      }
...
LAB_005bc2b4:
      ...
      iVar2 = (**(code **)(local_98 + -0x5aa0))(unaff_s2);
      if (-1 < iVar2) {
        uVar3 = **(undefined4 **)(param_1[1] + 8);
        iVar2 = (**(code **)(local_98 + -0x7868))(puStack_c4,auStack_6c,&local_88);
        if (iVar2 != 0) {
          local_a0 = local_88;
          iVar2 = (**(code **)(local_98 + -0x5a44))(unaff_s2,0x33,4,auStack_6c);
          if (iVar2 != 0) {
            local_a0 = 0xffffffff;
            iVar2 = (**(code **)(local_98 + -0x5a44))(unaff_s2,0x32,6,uVar3);
      ...
      uVar3 = (**(code **)(local_98 + -0x78ec))(*(undefined4 *)(unaff_s2 + 0x20));
      iVar2 = (**(code **)(local_98 + -0x7dd8))(uVar3,local_90,0x295);
      if (iVar2 == 0) {
        local_a0 = 0x299;
        (**(code **)(local_98 + -0x6eb0))(0x2e,0x96,0x41,local_90);
        goto LAB_005bc2b4;
      }
      iVar4 = (**(code **)(local_98 + -0x6e4c))
                        (puStack_c4,iVar2,&local_88,*(undefined4 *)(unaff_s2 + 0x20));
      if (iVar4 == 0) {
        local_a0 = 0x29f;
        (**(code **)(local_98 + -0x6eb0))(0x2e,0x96,0x8b,local_90);
        (**(code **)(local_98 + -0x7f58))(iVar2);
        goto LAB_005bc2b4;
      }
      (**(code **)(local_98 + -0x5c80))(*(undefined4 *)(unaff_s2 + 0x14),iVar2,local_88);
      pcVar10 = *(code **)(local_98 + -0x7fac);
LAB_005bc448:
...
LAB_005bc2c8:
  ...
  iStack_e8 = 0;
  puStack_cc = *(undefined4 **)PTR___stack_chk_guard_006aabf0;
  pCStack_bc = unaff_s2;
  if (*(int *)(iVar2 + 0x20) == 0) {
  ...
  uVar3 = (*(code *)PTR_OBJ_obj2nid_006a822c)(**(undefined4 **)(iVar2 + 8));
  ...
  iVar4 = (*(code *)PTR_EVP_DigestVerifyInit_006a85f0)
                    (auStack_e4,auStack_ec,iVar4,0,*(undefined4 *)(iVar2 + 0x20));
  if ((iVar4 < 1) ||
     (uVar3 = (*(code *)PTR_ASN1_item_i2d_006a979c)
                        (*(undefined4 *)(iVar2 + 0xc),&iStack_e8,
                         PTR_CMS_Attributes_Verify_it_006aa4a4), iStack_e8 == 0)) {
LAB_005bc674:
    iVar2 = -1;
  }
  else {
    iVar4 = (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_e4,iStack_e8,uVar3);
    (*(code *)PTR_CRYPTO_free_006a7f88)(iStack_e8);
    if (iVar4 < 1) goto LAB_005bc674;
    iVar2 = (*(code *)PTR_EVP_DigestVerifyFinal_006a85c8)
...
LAB_005bc68c:
  ...
  iVar2 = (*(code *)PTR_OBJ_obj2nid_006a822c)(*puVar7);
  if (iVar2 == 0x16) {
    piVar8 = (int *)puVar7[1];
    if (piVar8 == (int *)0x0) {
      return 0;
    ...
    iVar2 = 0;
    if (*(int *)(piVar8[2] + 8) != 0) {
      iVar4 = (*(code *)PTR_sk_num_006a7f2c)(piVar8[3]);
      if (0 < iVar4) {
        do {
          piVar6 = (int *)(*(code *)PTR_sk_value_006a7f24)(piVar8[3],iVar2);
          iVar4 = *piVar6;
          if (iVar4 == 4) {
            if (*piVar8 < 5) {
              *piVar8 = 5;
      ...
      iVar2 = 0;
      while( true ) {
        iVar4 = (*(code *)PTR_sk_num_006a7f2c)(piVar8[4]);
        iVar5 = iVar2 + 1;
      ...
      iVar2 = (*(code *)PTR_OBJ_obj2nid_006a822c)(*(undefined4 *)piVar8[2],iVar2);
      if ((iVar2 != 0x15) && (*piVar8 < 3)) {
        *piVar8 = 3;
      }
      iVar4 = 0;
      iVar2 = (*(code *)PTR_sk_num_006a7f2c)(piVar8[5]);
      if (0 < iVar2) {
        do {
          piVar6 = (int *)(*(code *)PTR_sk_value_006a7f24)(piVar8[5],iVar4);
          if (*(int *)piVar6[1] == 1) {
            if (*piVar6 < 3) {
              *piVar6 = 3;
            }
    ...
    iVar9 = 0;
    iVar2 = 0;
    iVar5 = (*(code *)PTR_sk_num_006a7f2c)(piVar8[1]);
    iVar4 = iVar2;
    if (0 < iVar5) {
      do {
        uVar3 = (*(code *)PTR_sk_value_006a7f24)(piVar8[1],iVar9);
