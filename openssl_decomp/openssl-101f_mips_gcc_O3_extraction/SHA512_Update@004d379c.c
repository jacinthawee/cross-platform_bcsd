...
LAB_004d3894:
    ...
    uVar1 = 0x80 - uVar4;
    if (len < uVar1) {
      (*(code *)PTR_memcpy_006aabf4)((int)p_Var13 + uVar4,data,len);
      c->num = c->num + len;
      return 1;
    }
    (*(code *)PTR_memcpy_006aabf4)((int)p_Var13 + uVar4,data,uVar1);
    len = len - uVar1;
    c->num = 0;
    sha512_block_data_order(c,p_Var13,1);
    ...
    if (0x7f < len) {
      ...
      puVar12 = (undefined4 *)data;
      uVar1 = len;
      if (((uint)data & 7) != 0) goto LAB_004d3894;
LAB_004d39e8:
...
LAB_004d392c:
  (*(code *)PTR_memcpy_006aabf4)(p_Var13,data,len);
  c->num = len;
  return 1;
}
