  ...
  if (st != (_STACK *)0x0) {
    ...
    if (st->comp == (_func_257 *)0x0) {
      ...
      if (0 < st->num) {
        ...
        if ((char *)data == *ppcVar3) {
          ...
          do {
            ppcVar3 = ppcVar3 + 1;
            iVar2 = iVar2 + 1;
            if (st->num == iVar2) goto LAB_0052e254;
      ...
      if (local_18 != (char **)0x0) {
        ...
        data = st->data;
        local_24 = 2;
        iVar2 = (**(code **)(local_20 + -0x64b0))(&local_18,data,st->num,4);
        if (iVar2 != 0) {
...
LAB_0052e1d4:
  ...
  piStack_4c = *(int **)PTR___stack_chk_guard_006aabf0;
  iVar2 = -1;
  ...
  if (piVar6 != (int *)0x0) {
    if (piVar6[4] == 0) {
      ...
      if (0 < *piVar6) {
        ...
        if ((char **)data == (char **)*piVar4) {
          ...
          do {
            piVar4 = piVar4 + 1;
            iVar2 = iVar2 + 1;
            if (*piVar6 == iVar2) goto LAB_0052e37c;
      ...
      if (piVar6[2] == 0) {
        (*(code *)PTR_qsort_006aaa94)(piVar6[1],*piVar6,4);
        piVar6[2] = 1;
      }
      data = ppcStack_50;
      if (ppcStack_50 != (char **)0x0) {
        data = (void *)piVar6[1];
        iVar2 = (*(code *)PTR_OBJ_bsearch_ex__006a9a30)(&ppcStack_50,data,*piVar6,4,piVar6[4],1);
        if (iVar2 != 0) {
...
LAB_0052e2fc:
  ...
  if (iVar2 < piVar6[3]) {
    ...
    iVar5 = (*(code *)PTR_CRYPTO_realloc_006a8c44)(piVar6[1],piVar6[3] << 3,"stack.c",0x96);
    if (iVar5 == 0) {
      return 0;
    }
    iVar7 = *piVar6;
