...

{
  ...
  iVar13 = (*(code *)PTR_X509_PUBKEY_get_006a9e84)(ppiVar12[1][1]);
  if (iVar13 == 0) {
    param_4 = 2;
    iVar14 = (*(code *)PTR_EVP_PKEY_CTX_ctrl_006a80ec)(param_1,0xffffffff,0xffffffff,2,3,0);
    if (0 < iVar14) goto LAB_00619404;
    ERR_GOST_error(0x7a,0x84,"gost94_keyx.c",0xfb);
  }
  else {
    iVar14 = (*(code *)PTR_EVP_PKEY_derive_set_peer_006a8de0)(param_1,iVar13);
    if (iVar14 < 1) {
      ERR_GOST_error(0x7a,0x83,"gost94_keyx.c",0xf1);
    }
    else {
LAB_00619404:
      iVar14 = (*(code *)PTR_EVP_PKEY_CTX_get0_peerkey_006aa934)(param_1);
      if (iVar14 == 0) {
        ...
        if (iVar15 != 0) {
          ...
          if (iVar14 != 0) {
            (*(code *)PTR_EVP_PKEY_free_006a7f78)(iVar13);
