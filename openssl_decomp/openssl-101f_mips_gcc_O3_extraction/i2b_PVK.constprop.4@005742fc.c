...
LAB_00574d84:
  ...
  if (puVar3 == (undefined *)0x0) {
    puVar3 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar15,FUN_0066ce6c,0x362);
    if (puVar3 == (undefined *)0x0) {
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x89,0x41,FUN_0066ce6c,0x365);
      iVar2 = -1;
      goto LAB_00574c4c;
    }
    *param_1 = puVar3;
...
LAB_00574bbc:
      ...
      param_1 = auStack_42c;
      if (iVar2 < 1) {
        (*(code *)PTR_ERR_put_error_006a9030)(9,0x89,0x68,FUN_0066ce6c,0x389);
        piVar17 = unaff_s4;
      }
      else {
        unaff_s4 = local_4e4;
