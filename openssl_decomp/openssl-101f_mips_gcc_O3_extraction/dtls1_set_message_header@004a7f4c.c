...

{
  ...
  if ((param_5 == 0) && (*(int *)(iVar2 + 0x254) == 0)) {
    ...
    *(undefined *)(iVar2 + 0x25c) = param_3;
    *(undefined4 *)(iVar2 + 0x260) = param_4;
    *(undefined4 *)(iVar2 + 0x268) = 0;
    *(short *)(iVar2 + 0x224) = sVar1;
    *(short *)(iVar2 + 0x264) = sVar1;
    *(short *)(iVar2 + 0x226) = sVar1 + 1;
    *(undefined4 *)(iVar2 + 0x26c) = param_6;
    return param_2 + 0xc;
  }
  *(undefined *)(iVar2 + 0x25c) = param_3;
  *(undefined4 *)(iVar2 + 0x260) = param_4;
  *(int *)(iVar2 + 0x268) = param_5;
  *(undefined2 *)(iVar2 + 0x264) = *(undefined2 *)(iVar2 + 0x224);
  *(undefined4 *)(iVar2 + 0x26c) = param_6;
  return param_2 + 0xc;
}
