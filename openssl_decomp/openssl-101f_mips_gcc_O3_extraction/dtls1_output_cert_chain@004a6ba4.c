...

{
  ...
  iVar3 = (*(code *)PTR_BUF_MEM_grow_clean_006a8c2c)(iVar12,10);
  if (iVar3 == 0) {
    iVar12 = 0xff;
...
LAB_004a6d60:
      ...
      iVar3 = 0xf;
      while( true ) {
        iVar4 = (*(code *)PTR_sk_num_006a7f2c)(local_60);
        if (iVar4 <= iVar11) break;
        uVar5 = (*(code *)PTR_sk_value_006a7f24)(local_60,iVar11);
        iVar4 = (*(code *)PTR_i2d_X509_006a87d4)(uVar5,0);
        iVar10 = iVar4 + 3 + iVar3;
        iVar6 = (*(code *)PTR_BUF_MEM_grow_clean_006a8c2c)(iVar12,iVar10);
        puVar1 = PTR_i2d_X509_006a87d4;
        if (iVar6 == 0) {
          iVar12 = 0x127;
    ...
    while( true ) {
      ...
      if (iVar4 <= iVar11) break;
      uVar5 = (*(code *)PTR_sk_value_006a7f24)
    ...
    *(char *)(iVar12 + 0xd) = (char)((uint)iVar11 >> 8);
    ...
    iVar12 = 0xb;
    *(short *)(iVar11 + 0x264) = sVar9;
    *(int *)(iVar11 + 0x260) = iVar3 + -0xc;
    *(undefined4 *)(iVar11 + 0x268) = 0;
    *(undefined *)(iVar11 + 0x25c) = 0xb;
    *(int *)(iVar11 + 0x26c) = iVar3 + -0xc;
  }
LAB_004a6d64:
  ...
  if (iVar12 < 1) {
    ...
    (*(code *)PTR_BIO_set_flags_006a8660)(pBVar8,1);
  }
  else {
