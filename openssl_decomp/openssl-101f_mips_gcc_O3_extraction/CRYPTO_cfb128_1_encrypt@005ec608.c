...
/* WARNING: Heritage AFTER dead removal. Example location: r0x006aabb8 : 0x005ec94c */
...

{
  ...
  if (puVar15 != (uint *)0x0) {
    ...
    if (iStack_a0 == 0) {
      do {
        uVar4 = _DAT_006afeec;
        puVar18 = _DAT_006afee8;
        puVar16 = _DAT_006afee4;
        puVar15 = __gp;
        ...
        _DAT_006afee8 = (uint *)CONCAT31(uStack_ff,uStack_fc);
        uStack_fb = (undefined3)uVar4;
        _DAT_006afeec = CONCAT31(uStack_fb,*(byte *)puVar22);
        *(byte *)puVar24 = *(byte *)puVar22 ^ _gp;
        puVar16 = __gp;
        puVar22 = puVar17;
        puVar24 = (uint *)((int)puVar24 + 1);
        _DAT_006afee4 = puVar15;
      } while (puVar17 != puVar21);
    }
    else {
      do {
        uVar4 = _DAT_006afeec;
        puVar7 = _DAT_006afee8;
        puVar8 = _DAT_006afee4;
        puVar15 = __gp;
        ...
        uStack_fb = (undefined3)uVar4;
        _DAT_006afeec = CONCAT31(uStack_fb,*(byte *)puVar22 ^ _gp);
        *(byte *)puVar24 = *(byte *)puVar22 ^ _gp;
        puVar16 = _DAT_006afee4;
        puVar22 = puVar18;
        puVar24 = (uint *)((int)puVar24 + 1);
        __gp = puVar15;
        _DAT_006afee4 = puVar8;
        _DAT_006afee8 = puVar7;
  ...
  for (puVar9 = *ppuStack_10c; puVar9 != (uint *)0x0;
    ...
    if (puVar15 == (uint *)0x0) {
      if ((((uint)puVar8 | (uint)puVar7) & 3) != 0) goto LAB_005ecc40;
      goto LAB_005ecca4;
    }
    bVar1 = *(byte *)puVar7;
    puVar7 = (uint *)((int)puVar7 + 1);
    puVar15 = (uint *)((int)puVar15 + -1);
    *(byte *)puVar8 = *(byte *)(puVar9 + 0x1abfb8) ^ bVar1;
  ...
  if (puVar15 < &SUB_00000010) {
    ...
    do {
      ...
      *puVar24 = *puVar22 ^ (uint)__gp;
      puVar24[1] = puVar22[1] ^ (uint)_DAT_006afee4;
      puVar24[2] = puVar22[2] ^ (uint)_DAT_006afee8;
      puVar24[3] = puVar22[3] ^ _DAT_006afeec;
      puVar22 = puVar22 + 4;
      puVar24 = puVar24 + 4;
...
LAB_005ecdac:
      ...
      if ((puVar9 < &DAT_00000007 ||
           (puVar8 < &DAT_006afee4 && &_gp < puVar8 + 1 ||
           puVar8 < puVar7 + 1 && puVar7 < puVar8 + 1)) ||
         ((((uint)puVar8 | (uint)puVar7) & 3) != 0)) {
        *(byte *)puVar8 = _gp ^ *(byte *)puVar7;
        if (pbVar14 != (byte *)0x0) {
          *(byte *)((int)puVar8 + 1) = *(byte *)((int)puVar7 + 1) ^ DAT_006afee1;
          if (pbVar14 != (byte *)0x1) {
            *(byte *)((int)puVar8 + 2) = *(byte *)((int)puVar7 + 2) ^ DAT_006afee2;
            if (pbVar14 != &SUB_00000002) {
              *(byte *)((int)puVar8 + 3) = *(byte *)((int)puVar7 + 3) ^ DAT_006afee3;
              if (pbVar14 != (byte *)0x3) {
                *(byte *)(puVar8 + 1) = *(byte *)(puVar7 + 1) ^ DAT_006afee4;
                if (pbVar14 != &SUB_00000004) {
                  *(byte *)((int)puVar8 + 5) = *(byte *)((int)puVar7 + 5) ^ DAT_006afee5;
                  if (pbVar14 != &DAT_00000005) {
                    *(byte *)((int)puVar8 + 6) = *(byte *)((int)puVar7 + 6) ^ DAT_006afee6;
                    if (pbVar14 != &DAT_00000006) {
                      *(byte *)((int)puVar8 + 7) = *(byte *)((int)puVar7 + 7) ^ DAT_006afee7;
                      if (pbVar14 != &DAT_00000007) {
                        *(byte *)(puVar8 + 2) = *(byte *)(puVar7 + 2) ^ DAT_006afee8;
                        if (pbVar14 != &DAT_00000008) {
                          *(byte *)((int)puVar8 + 9) = *(byte *)((int)puVar7 + 9) ^ DAT_006afee9;
                          if (pbVar14 != &DAT_00000009) {
                            *(byte *)((int)puVar8 + 10) = *(byte *)((int)puVar7 + 10) ^ DAT_006afeea
                            ;
                            if (pbVar14 != &DAT_0000000a) {
                              *(byte *)((int)puVar8 + 0xb) =
                                   *(byte *)((int)puVar7 + 0xb) ^ DAT_006afeeb;
                              if (pbVar14 != &DAT_0000000b) {
                                *(byte *)(puVar8 + 3) = *(byte *)(puVar7 + 3) ^ DAT_006afeec;
                                if (pbVar14 != &SUB_0000000c) {
                                  *(byte *)((int)puVar8 + 0xd) =
                                       *(byte *)((int)puVar7 + 0xd) ^ DAT_006afeed;
                                  if (pbVar14 != &DAT_0000000d) {
                                    *(byte *)((int)puVar8 + 0xe) =
                                         *(byte *)((int)puVar7 + 0xe) ^ DAT_006afeee;
                                    *ppuStack_10c = puVar9;
                                    return;
                                  }
                                }
