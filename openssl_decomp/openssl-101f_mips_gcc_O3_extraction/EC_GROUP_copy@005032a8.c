  ...
  if (*(int *)(*(int *)dst + 0x14) == 0) {
    ...
    if (*(int *)dst == *(int *)src) {
      ...
      for (piVar8 = *(int **)(src + 0x44); piVar8 != (int *)0x0; piVar8 = (int *)*piVar8) {
        ...
        puVar3 = (undefined4 *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x14,"ec_lib.c",0x23a);
      ...
      if (piVar8 == (int *)0x0) {
        ...
        if (piVar8 != (int *)0x0) {
          ...
          (*(code *)PTR_OPENSSL_cleanse_006a8174)(piVar8,0x44);
          (*(code *)PTR_CRYPTO_free_006a7f88)(piVar8);
          *(undefined4 *)(dst + 4) = 0;
        }
LAB_0050351c:
        ...
        *(undefined4 *)(dst + 0x38) = uVar1;
        if (iVar7 == 0) {
          ...
          *(undefined4 *)(dst + 0x40) = 0;
          ...
          iVar7 = (*(code *)PTR_CRYPTO_malloc_006a8108)(*(undefined4 *)(src + 0x40),"ec_lib.c",0xe6)
          ;
          *(int *)(dst + 0x3c) = iVar7;
          if (iVar7 == 0) {
            return 0;
          ...
          *(undefined4 *)(dst + 0x40) = *(undefined4 *)(src + 0x40);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00503600. Too many branches */
...
LAB_005036fc:
        ...
        piVar2 = (int *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x44,"ec_lib.c",0x2c4);
        if (piVar2 == (int *)0x0) {
  ...
  (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x6a,uVar5,"ec_lib.c",uVar1);
  return 0;
}
