...

{
  ...
  bool bVar3;
  int iVar4;
  X509_NAME_ENTRY *pXVar5;
  ASN1_OBJECT *pAVar6;
  char **ppcVar7;
  ulong uVar8;
  undefined4 uVar9;
  ASN1_VALUE **ppAVar10;
  X509_NAME_ENTRY *pXVar11;
  undefined *puVar12;
  int iVar13;
  int iVar14;
  ASN1_VALUE *pAVar15;
  ...
  X509_NAME_ENTRY *pXStack_1f4;
  undefined *puStack_1f0;
  ASN1_VALUE **ppAStack_1ec;
  ASN1_ITEM *pAStack_1e8;
  X509_NAME_ENTRY **ppXStack_1e4;
  int *piStack_1e0;
  code *pcStack_1dc;
  uchar *puStack_1b4;
  uchar *puStack_1b0;
  ...
  X509_NAME_ENTRY *pXStack_19c;
  char *pcStack_198;
  code *pcStack_194;
  undefined *puStack_180;
  X509_NAME_ENTRY *pXStack_174;
  ...
  X509_NAME_ENTRY *pXStack_134;
  int iStack_12c;
  int iStack_128;
  ASN1_ITEM *pAStack_124;
  X509_NAME_ENTRY *pXStack_120;
  X509_NAME_ENTRY *pXStack_11c;
  undefined *puStack_118;
  code *pcStack_114;
  int iStack_ec;
  int iStack_e8;
  int iStack_e4;
  X509_NAME_ENTRY *pXStack_e0;
  X509_NAME_ENTRY *pXStack_dc;
  X509_NAME_ENTRY *pXStack_d8;
  ...
  int iStack_6c;
  X509_NAME_ENTRY *pXStack_68;
  undefined *puStack_64;
  ASN1_OBJECT *pAStack_1c;
  ASN1_OBJECT *pAStack_18;
  ASN1_STRING *pAStack_14;
  
  pXStack_dc = (X509_NAME_ENTRY *)PTR___stack_chk_guard_006aabf0;
  pAStack_1c = (ASN1_OBJECT *)0x0;
  pAStack_14 = *(ASN1_STRING **)PTR___stack_chk_guard_006aabf0;
  if (ne == (X509_NAME_ENTRY *)0x0) {
    pXVar5 = (X509_NAME_ENTRY *)0x0;
  }
  else {
  ...
  if (pAVar6 != (ASN1_OBJECT *)0x0) {
    ...
    ERR_clear_error();
    unaff_s0 = (X509_NAME_ENTRY *)0x0;
    iStack_a8 = 0;
    pXStack_dc = (X509_NAME_ENTRY *)0x0;
    pXVar5 = (X509_NAME_ENTRY *)0x0;
LAB_0054f334:
    pXVar11 = unaff_s0;
    pXVar21 = pXVar5;
    unaff_s3 = pAVar6;
    if ((X509_NAME_ENTRY *)&DAT_00000008 < pXStack_dc) goto LAB_0054f39c;
    while ((unaff_s0 <= &pXVar21->set &&
           (iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a8c2c)(pAVar6), iVar4 != 0))) {
      iVar4 = (*(code *)PTR_BIO_read_006a85bc)
                        (pAStack_d0,(undefined *)((int)&unaff_s0->object + (int)pAVar6->ln),
                         (int)&pXVar21->set - (int)unaff_s0);
      pXVar11 = unaff_s0;
      if (iVar4 < 0) {
        if (unaff_s0 == pXVar21) {
          pXStack_11c = (X509_NAME_ENTRY *)0x8e;
          iVar4 = 0xaf;
          goto LAB_0054f554;
        }
      }
      else {
        pXVar5 = (X509_NAME_ENTRY *)((int)&unaff_s0->object + iVar4);
        if (iVar4 != 0) {
          unaff_s0 = (X509_NAME_ENTRY *)(uint)(pXVar5 < unaff_s0);
          pXStack_dc = (X509_NAME_ENTRY *)((int)pXVar5 - (int)pXVar21);
          pXVar11 = pXVar5;
          if (unaff_s0 != (X509_NAME_ENTRY *)0x0) {
            pXStack_11c = (X509_NAME_ENTRY *)0x9b;
            iVar4 = 0xb6;
            goto LAB_0054f554;
          }
        }
...
LAB_0054f39c:
      ...
      ppcVar7 = pAVar6->ln;
      while( true ) {
        pXVar5 = (X509_NAME_ENTRY *)((int)&pXVar21->object + (int)ppcVar7);
        pXStack_19c = (X509_NAME_ENTRY *)(auStack_88 + 8);
        pXStack_11c = (X509_NAME_ENTRY *)auStack_88;
        pcStack_198 = (char *)unaff_s6;
        apXStack_98[0] = pXVar5;
        uStack_8c = ASN1_get_object((uchar **)unaff_s5,(long *)(X509_NAME_ENTRY *)(auStack_88 + 8),
                                    (int *)(X509_NAME_ENTRY *)auStack_88,unaff_s6,(long)pXStack_dc);
        if ((uStack_8c & 0x80) != 0) {
        ...
        pXStack_dc = (X509_NAME_ENTRY *)((int)apXStack_98[0] - (int)pXVar5);
        pXVar21 = (X509_NAME_ENTRY *)((int)pXVar21 + (int)pXStack_dc);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_a8 != 0) && (auStack_88._8_4_ == 0)) {
            pXStack_dc = (X509_NAME_ENTRY *)((int)unaff_s0 - (int)pXVar21);
            pXVar5 = pXVar21;
            if ((auStack_88._0_4_ != (ASN1_OBJECT *)0x0) ||
               (iStack_a8 = iStack_a8 + -1, iStack_a8 != 0)) goto LAB_0054f334;
            goto LAB_0054f43c;
          }
          if (auStack_88._8_4_ <= (uint)((int)unaff_s0 - (int)pXVar21)) goto LAB_0054f4cc;
          pXVar5 = (X509_NAME_ENTRY *)((int)&pXVar21->object + auStack_88._8_4_);
          pXStack_dc = (X509_NAME_ENTRY *)((int)pXVar5 - (int)unaff_s0);
          if (((int)pXStack_dc < 0) || (pXVar5 < unaff_s0)) {
            pXStack_11c = (X509_NAME_ENTRY *)0x9b;
            iVar4 = 0xed;
          }
          else {
            ...
            pXStack_11c = (X509_NAME_ENTRY *)&DAT_00000041;
            iVar4 = 0xf2;
          }
          goto LAB_0054f554;
        }
        ...
        if (pXStack_dc < (X509_NAME_ENTRY *)&DAT_00000009) break;
        ppcVar7 = pAVar6->ln;
      }
    }
    pXStack_11c = (X509_NAME_ENTRY *)&DAT_00000041;
  ...
  pXStack_19c = (X509_NAME_ENTRY *)&DAT_0000006b;
  ERR_put_error(0xd,0x6b,0x41,"a_d2i_fp.c",0x9c);
  pXVar21 = (X509_NAME_ENTRY *)0xffffffff;
LAB_0054f57c:
  ...
  pXVar5 = (X509_NAME_ENTRY *)(*(code *)PTR_BIO_new_006a7fa4)(uVar9);
  if (pXVar5 == (X509_NAME_ENTRY *)0x0) {
    ...
    if ((int)ppAVar10 < 0) {
      ...
      pXVar11 = (X509_NAME_ENTRY *)(*(code *)pXStack_19c)(pcStack_198);
  ...
  if ((int)ppAVar10 < 0) {
    ...
    pXVar5 = (X509_NAME_ENTRY *)(*(code *)piStack_15c)(pcStack_158,piVar17);
    ppAStack_1a4 = ppAVar10;
  }
  if (iStack_12c != 0) {
    pXStack_134 = pXVar5;
  ...
  pXStack_1f4 = (X509_NAME_ENTRY *)auStack_16c;
  puStack_180 = &_gp;
  ...
  if ((int)ppAVar10 < 0) {
    ...
    pXStack_1f4 = (X509_NAME_ENTRY *)(auStack_16c + 4);
    auStack_16c._4_4_ = (ASN1_STRING *)(auStack_16c._0_4_)->ln;
    pXVar5 = (X509_NAME_ENTRY *)
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar5 = (X509_NAME_ENTRY *)ASN1_item_d2i(ppAStack_234,in,iVar4,pAStack_1e8);
      iStack_22c = iVar4;
    }
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    pXStack_240 = (X509_NAME_ENTRY *)0x0;
    ...
    if (ppAStack_234 == (ASN1_VALUE **)0x0) {
      ...
      pXStack_240 = (X509_NAME_ENTRY *)0x1;
LAB_0054fbe4:
  ...
  pXStack_280 = (X509_NAME_ENTRY *)(*pcStack_27c)(iVar4,0);
  puVar12 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(pXStack_280,"a_i2d_fp.c",0x5b);
  if (puVar12 == (undefined *)0x0) {
    pXVar5 = (X509_NAME_ENTRY *)&DAT_00000041;
    ...
    while( true ) {
      ...
      pXVar5 = pXStack_280;
      pXVar11 = (X509_NAME_ENTRY *)(*(code *)PTR_BIO_write_006a7f14)(pcStack_274,puVar19);
      ...
      pXStack_280 = (X509_NAME_ENTRY *)((int)pXStack_280 - (int)pXVar11);
    }
    pXVar11 = (X509_NAME_ENTRY *)0x1;
LAB_0054fd84:
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    pXStack_2fc = (X509_NAME_ENTRY *)0x0;
    ...
    if (puStack_288 == (uchar *)0x0) {
      ...
      pXStack_2fc = (X509_NAME_ENTRY *)0x1;
LAB_0054fef0:
  ...
  if (piStack_304 != (int *)0x0) {
    ...
    if (pbVar18 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar5 = (X509_NAME_ENTRY *)(uint)*pbVar18;
        if (iVar4 != 1) {
          uVar1 = CONCAT11(*pbVar18,pbVar18[1]);
          pXVar5 = (X509_NAME_ENTRY *)(uint)uVar1;
          if (iVar4 != 2) {
            uVar2 = CONCAT21(uVar1,pbVar18[2]);
            pXVar5 = (X509_NAME_ENTRY *)(uint)uVar2;
            if (iVar4 == 4) {
              pXVar5 = (X509_NAME_ENTRY *)CONCAT31(uVar2,pbVar18[3]);
            }
          }
        }
      }
      ...
      return (X509_NAME_ENTRY *)-(int)pXVar5;
    }
  }
  return (X509_NAME_ENTRY *)0x0;
joined_r0x0054f494:
  if (pXStack_dc == (X509_NAME_ENTRY *)0x0) goto LAB_0054f4cc;
  ...
  pXStack_dc = (X509_NAME_ENTRY *)((int)pXStack_dc - iVar4);
  unaff_s0 = (X509_NAME_ENTRY *)((int)&unaff_s0->object + iVar4);
  goto joined_r0x0054f494;
LAB_0054f4cc:
  pXVar5 = (X509_NAME_ENTRY *)(auStack_88._8_4_ + (int)&pXVar21->object);
  pXVar21 = (X509_NAME_ENTRY *)(uint)(pXVar5 < pXVar21);
  if (pXVar21 != (X509_NAME_ENTRY *)0x0) {
    pXStack_11c = (X509_NAME_ENTRY *)0x9b;
    iVar4 = 0x106;
    goto LAB_0054f554;
  }
  ...
  pXStack_dc = (X509_NAME_ENTRY *)((int)unaff_s0 - (int)pXVar5);
  goto LAB_0054f334;
LAB_0054f43c:
