...
/* WARNING: Removing unreachable block (ram,0x0060661c) */
/* WARNING: Could not reconcile some variable overlaps */

undefined4 ssleay_rand_pseudo_bytes(undefined *param_1,int param_2)

{
  ...
  do {
    ...
    *(undefined4 *)(puStack_c8 + -0xa04) = 0;
    (*(code *)puVar8)(10,0x12,puStack_c0 + -0x6318,0x1d5);
    iVar11 = param_2;
    do {
      iVar6 = 10;
      if (iVar11 < 0xb) {
...
LAB_0060610c:
    ...
    (*(code *)PTR_EVP_DigestUpdate_006a8674)(unaff_s2,piStack_e0,8);
    (*(code *)PTR_EVP_DigestUpdate_006a8674)(unaff_s2,&uStack_50,0x14);
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x12,puStack_c0 + -0x6318,0x20c);
    (*(code *)PTR_EVP_DigestUpdate_006a8674)(unaff_s2,md,0x14);
    (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(unaff_s2,md,0);
    (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x12,puStack_c0 + -0x6318,0x212);
    (*(code *)PTR_EVP_MD_CTX_cleanup_006a7f34)(unaff_s2);
    param_1 = puStack_c0;
    if (in_f20_21 < *(double *)(iStack_bc + -0x6270)) {
...
LAB_006061ac:
    ...
    iStack_e4 = 0x34;
    puVar8 = puStack_c0 + -0x6318;
    do {
      if (*(int *)(puStack_c8 + -0xa04) == 0) {
LAB_0060624c:
        bVar2 = false;
        ...
        iVar4 = (*(code *)PTR_CRYPTO_THREADID_cmp_006a95a0)(puStack_a4 + -0xa0c,auStack_70);
        bVar2 = iVar4 == 0;
...
LAB_00606300:
      ...
      if (*(double *)(puStack_cc + -0x9f8) < dVar14) {
        entropy = *(double *)(puStack_cc + -0x9f8) + 0.0;
      }
      if (!bVar2) {
    ...
    if (*(double *)(iStack_bc + -0x6270) <= in_f20_21) {
      *(undefined4 *)(puStack_a0 + -0xa10) = 1;
    }
  } while( true );
}
