...

{
  ...
  iVar4 = 0;
  while( true ) {
    iVar2 = (*(code *)PTR_sk_num_006a7f2c)(psVar5);
    if (iVar2 <= iVar4) break;
    pXVar3 = (X509_LOOKUP *)(*(code *)PTR_sk_value_006a7f24)(psVar5,iVar4);
    iVar4 = iVar4 + 1;
    if (pXVar3->method == m) {
      return pXVar3;
    }
  }
  pXVar3 = (X509_LOOKUP *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x14,"x509_lu.c",0x45);
  if (pXVar3 != (X509_LOOKUP *)0x0) {
    ...
    if ((p_Var6 == (_func_1834 *)0x0) || (iVar4 = (*p_Var6)(pXVar3), iVar4 != 0)) {
      ...
      (*(code *)PTR_CRYPTO_free_006a7f88)(pXVar3);
