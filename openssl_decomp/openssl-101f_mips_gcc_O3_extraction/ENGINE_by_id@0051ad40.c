...

{
  ...
  if (id == (char *)0x0) {
    ERR_put_error(0x26,0x6a,0x43,"eng_list.c",0x165);
    return (ENGINE *)0x0;
  }
  (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x1e,"eng_list.c",0x168);
  for (puVar15 = engine_list_head; puVar15 != (undefined4 *)0x0;
      puVar15 = (undefined4 *)puVar15[0x1b]) {
    iVar2 = (*(code *)PTR_strcmp_006aac20)(id,*puVar15);
    if (iVar2 == 0) {
      if ((puVar15[0x15] & 4) == 0) {
      ...
      (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_list.c",0x182);
      return (ENGINE *)puVar1;
    }
  }
  (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_list.c",0x182);
  iVar2 = (*(code *)PTR_strcmp_006aac20)(id,"dynamic");
  if (iVar2 != 0) {
    arg = (char *)(*(code *)PTR_getenv_006aab6c)("OPENSSL_ENGINES");
    if (arg == (char *)0x0) {
      arg = "/usr/local/openssl101fmipso3/lib/engines";
    }
...
LAB_0051af2c:
  ENGINE_free(e);
  ERR_put_error(0x26,0x6a,0x74,"eng_list.c",0x1a1);
  ERR_add_error_data(2,&DAT_006679b0,id);
  return (ENGINE *)0x0;
}
