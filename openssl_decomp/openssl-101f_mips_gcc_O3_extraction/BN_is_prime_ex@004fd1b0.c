...
LAB_004fd29c:
    ...
    if (((rnd == (BIGNUM *)0x0) || (pBVar3 = BN_copy(a,pBVar1), pBVar3 == (BIGNUM *)0x0)) ||
       (iVar2 = BN_sub_word(a,1), iVar2 == 0)) goto LAB_004fd488;
    iVar2 = 1;
    if (a->top == 0) {
      iVar2 = 0;
      goto LAB_004fd48c;
    ...
    if ((iVar4 == 0) || (mont = BN_MONT_CTX_new(), mont == (BN_MONT_CTX *)0x0)) goto LAB_004fd488;
      ...
      if (0 < nchecks) {
        ...
        do {
          ...
          if (((iVar4 == 0) || (iVar4 = BN_add_word(rnd,1), iVar4 == 0)) ||
             (iVar4 = witness(rnd,pBVar1,a,r,iVar2,ctx_00,mont), iVar4 == -1)) goto LAB_004fd5e0;
          if (iVar4 != 0) {
            iVar2 = 0;
            goto LAB_004fd5b0;
          }
          if (cb != (BN_GENCB *)0x0) {
            if (cb->ver == 1) {
              ...
              if (cb->ver != 2) {
                iVar2 = -1;
                BN_CTX_end(ctx_00);
                goto joined_r0x004fd428;
              }
              iVar4 = (*(cb->cb).cb_1)(1,local_2c,cb);
              if (iVar4 == 0) goto LAB_004fd5e0;
            }
          }
          local_2c = local_2c + 1;
...
LAB_004fd5b0:
    BN_CTX_end(ctx_00);
joined_r0x004fd428:
    if (ctx != (BN_CTX *)0x0) goto LAB_004fd4b8;
  }
  else {
