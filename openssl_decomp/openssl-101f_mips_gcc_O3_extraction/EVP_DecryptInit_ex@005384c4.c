...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    ...
    if (pEVar1 == (EVP_CIPHER *)0x0) goto LAB_00538844;
LAB_00538618:
    ...
    if ((uVar4 & 0x10) == 0) {
      ...
      case 5:
        ...
        break;
      default:
        goto switchD_00538724_caseD_6;
      }
    }
    pEVar1 = ctx->cipher;
    if (key == (uchar *)0x0) {
      if ((pEVar1->flags & 0x20) == 0) goto LAB_00538680;
      p_Var8 = pEVar1->init;
    }
    else {
      p_Var8 = pEVar1->init;
...
LAB_00538844:
    ...
    if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar1->nid)) goto LAB_00538618;
    p_Var7 = pEVar1->cleanup;
LAB_00538530:
    uVar6 = ctx->flags;
...
LAB_005385b4:
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_005385cc;
...
LAB_00538600:
    ...
    ctx->flags = 0;
    ctx->key_len = iVar2;
    if ((uVar4 & 0x40) == 0) goto LAB_00538618;
