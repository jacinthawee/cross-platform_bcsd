...

{
  ...
  if (bs != (OCSP_BASICRESP *)0x0) {
    ...
    for (iVar5 = 0; iVar2 = (*(code *)PTR_sk_num_006a7f2c)(psVar6), iVar5 < iVar2; iVar5 = iVar5 + 1
        ) {
      ppOVar1 = (OCSP_CERTID **)(*(code *)PTR_sk_value_006a7f24)(psVar6,iVar5);
      iVar2 = OCSP_id_cmp(id,*ppOVar1);
      if (iVar2 == 0) {
        if (iVar5 < 0) {
          return 0;
        }
        iVar5 = (*(code *)PTR_sk_value_006a7f24)(bs->tbsResponseData->responses,iVar5);
        if (iVar5 == 0) {
          iVar2 = -1;
        }
        else {
            ...
            if (reason != (int *)0x0) {
              if (ppAVar3[1] == (ASN1_GENERALIZEDTIME *)0x0) {
                *reason = -1;
                ...
                iVar4 = (*(code *)PTR_ASN1_ENUMERATED_get_006a9e4c)();
                *reason = iVar4;
              }
            }
          }
