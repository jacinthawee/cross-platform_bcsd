...

{
  ...
  uVar31 = param_1;
  piVar29 = param_4;
  piVar26 = (int *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006aa6dc)();
  switch(param_2) {
  default:
    return 0xfffffffe;
  case 1:
  ...
  case 7:
    piVar29 = piVar26 + 2;
    if (*piVar26 == 0) {
      iVar28 = (*(code *)PTR_EVP_PKEY_CTX_get0_pkey_006aa6e0)(param_1);
      if (iVar28 == 0) {
        uVar27 = 0x1eb;
      }
      else {
      ...
      (*(code *)PTR_ERR_GOST_error_006aa6f0)(0x80,0x74,"gost_pmeth.c",uVar27);
      return 0;
    }
LAB_005de93c:
