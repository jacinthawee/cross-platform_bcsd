...

{
  ...
  if (((s->wbio == (BIO *)0x0) ||
      (iVar1 = (*(code *)PTR_BIO_method_type_006a9444)(), iVar1 != 0x505)) ||
     (iVar1 = (*(code *)PTR_BIO_ctrl_006a7f18)(s->wbio,0x69,0,0), iVar1 != fd)) {
    uVar2 = (*(code *)PTR_BIO_s_socket_006a9440)();
    pBVar3 = (BIO *)(*(code *)PTR_BIO_new_006a7fa4)(uVar2);
    if (pBVar3 == (BIO *)0x0) {
      (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xc2,7,"ssl_lib.c",0x2cd);
      return 0;
    }
    (*(code *)PTR_BIO_int_ctrl_006a8948)(pBVar3,0x68,0,fd);
    pBVar5 = s->wbio;
