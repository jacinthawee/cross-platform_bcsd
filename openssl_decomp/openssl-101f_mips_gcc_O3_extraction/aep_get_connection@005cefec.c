...

{
  ...
  (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x1e,"e_aep.c",0x365);
  iVar1 = (*(code *)PTR_getpid_006aab70)();
      ...
      if (iVar1 == 0) {
        ...
        if (iVar2 == 0) {
          ...
          *(undefined4 *)(aep_app_conn_table + iVar6 * 8 + 4) = uVar5;
          ...
          (*(code *)PTR_ERR_put_error_006a9030)(AEPHK_lib_error_code,0x66,0x73,"e_aep.c",0x3b8);
        }
        goto LAB_005cf140;
      }
      iVar6 = iVar6 + 1;
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          ...
          (*(code *)PTR_ERR_put_error_006a9030)(AEPHK_lib_error_code,0x66,0x73,"e_aep.c",0x39a);
          recorded_pid = 0;
        }
      }
      else {
        ...
        (*(code *)PTR_ERR_put_error_006a9030)(AEPHK_lib_error_code,0x66,0x72,"e_aep.c",900);
        recorded_pid = 0;
      }
    }
    else {
      ...
      (*(code *)PTR_ERR_put_error_006a9030)(AEPHK_lib_error_code,0x66,0x6b,"e_aep.c",0x379);
      recorded_pid = 0;
    }
  }
LAB_005cf140:
  (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"e_aep.c",0x3c3);
  return iVar2;
}
