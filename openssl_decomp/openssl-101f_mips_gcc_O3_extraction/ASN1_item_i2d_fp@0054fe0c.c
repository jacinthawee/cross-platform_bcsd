...

{
  ...
  local_1c = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  ...
  if (iVar6 == 0) {
    ...
    if (local_20 == (uchar *)0x0) {
      ...
      while( true ) {
        ...
        val = pAVar7;
        pAVar8 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(iVar6);
...
LAB_0054fef0:
  ...
  if (puStack_60 == (uchar *)0x0) {
    ...
    while( true ) {
      ...
      iVar9 = (*(code *)PTR_BIO_write_006a7f14)(puStack_8c,puVar15,iVar6);
    ...
    iVar6 = 1;
LAB_00550050:
    (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_60);
    iStack_94 = iVar6;
  }
  ...
  if (*piVar12 < 5) {
    ...
    puVar10 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(5,"a_enum.c",0x51);
