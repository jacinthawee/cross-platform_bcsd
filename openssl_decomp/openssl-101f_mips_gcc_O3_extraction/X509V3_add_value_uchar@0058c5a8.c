...

{
  ...
  if (name == (char *)0x0) {
    iVar2 = 0;
    if (value != (uchar *)0x0) goto LAB_0058c5fc;
LAB_0058c740:
    iVar3 = 0;
LAB_0058c614:
    ...
    if (puVar4 != (undefined4 *)0x0) {
      if (*extlist == (stack_st_CONF_VALUE *)0x0) {
        ...
        *extlist = psVar6;
        if (psVar6 != (stack_st_CONF_VALUE *)0x0) goto LAB_0058c644;
      }
      else {
LAB_0058c644:
    ...
    if (iVar2 == 0) {
      ...
      if (value == (uchar *)0x0) goto LAB_0058c740;
LAB_0058c5fc:
      iVar3 = (*(code *)PTR_BUF_strdup_006a80dc)(value);
      if (iVar3 != 0) goto LAB_0058c614;
    }
  }
  (*(code *)PTR_ERR_put_error_006a9030)(0x22,0x69,0x41,"v3_utl.c",0x60);
LAB_0058c69c:
