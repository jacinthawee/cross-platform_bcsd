...

{
  ...
  pBVar2 = (BIO *)(*(code *)PTR_BIO_new_fp_006a835c)(fp,0);
  if (pBVar2 == (BIO *)0x0) {
    plStack_d8 = (long *)&DAT_00000007;
    local_38 = 0x78;
    pBStack_160 = (BIO *)0x67;
    plStack_60 = (lhash_st_CONF_VALUE *)0x0;
    (**(code **)(local_30 + -0x6eb0))(0xe,0x67,7,"conf_lib.c");
  }
  else {
  ...
  BStack_b0.retry_reason = (int)PTR___stack_chk_guard_006aabf0;
  BStack_b0.ex_data.sk = (stack_st_void *)&_gp;
  pcStack_64 = *(char **)PTR___stack_chk_guard_006aabf0;
  pBStack_5c = unaff_s1;
  plStack_54 = conf;
  plStack_50 = eline;
  if (default_CONF_method == (CONF_METHOD *)0x0) {
  ...
  pcVar8 = pcStack_64;
  (*(code *)BStack_b0.ex_data.sk[-0x429].stack.num_alloc)();
  puStack_e8 = PTR___stack_chk_guard_006aabf0;
  puStack_b8 = &_gp;
  BStack_b0.init = *(int *)PTR___stack_chk_guard_006aabf0;
  ...
  if (pcVar8 != (char *)0x0) {
    ...
    if (pBVar6 == (BIO *)0x0) {
      ...
      (**(code **)(puStack_b8 + -0x6eb0))(0xe,0x6c,0x6b,"conf_lib.c");
      psVar4 = (stack_st_CONF_VALUE *)0x0;
    }
    else {
  ...
  if ((BIO *)BStack_b0.init != *(BIO **)puStack_e8) {
    ...
    puStack_108 = &_gp;
    pCStack_ec = *(CONF **)PTR___stack_chk_guard_006aabf0;
    pCStack_130 = (CONF *)&_ITM_registerTMCloneTable;
    ...
    if (pBVar2 == (BIO *)0x0) {
      ...
      if (plVar5 == (lhash_st_CONF_VALUE *)0x0) {
        plStack_110 = (long *)0x14b;
        pcVar8 = &DAT_0000006d;
        (**(code **)(puStack_108 + -0x6eb0))(0xe,0x6d,0x6a,"conf_lib.c");
      ...
      pBStack_160 = pBVar6;
      if (plVar5 == (lhash_st_CONF_VALUE *)0x0) {
        plStack_110 = (long *)0x14f;
        plStack_fc = plVar5;
        (**(code **)(puStack_108 + -0x6eb0))(0xe,0x6d,0x6c,"conf_lib.c");
        pcVar8 = "group=";
        plStack_110 = name;
        (**(code **)(puStack_108 + -0x6c7c))(4,"group=",pBVar6," name=");
        plVar5 = plStack_fc;
      }
    }
    ...
    puStack_148 = &_gp;
    plStack_134 = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006aabf0;
    if (default_CONF_method == (CONF_METHOD *)0x0) {
      default_CONF_method = NCONF_default();
    }
    ...
    puStack_188 = &_gp;
    plStack_174 = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006aabf0;
    pCStack_164 = pCStack_1ac;
    pBStack_1b4 = (BIO *)(*(code *)PTR_BIO_new_fp_006a835c)(pcVar8,0);
    if (pBStack_1b4 == (BIO *)0x0) {
      uStack_190 = 0xd4;
      pBVar2 = (BIO *)&DAT_00000068;
      (**(code **)(puStack_188 + -0x6eb0))(0xe,0x68,7,"conf_lib.c");
    }
    else {
      if (default_CONF_method == (CONF_METHOD *)0x0) {
        default_CONF_method = NCONF_default();
    ...
    if (plStack_174 != *(lhash_st_CONF_VALUE **)puStack_1b0) {
      ...
      pCStack_1bc = *(CONF_METHOD **)PTR___stack_chk_guard_006aabf0;
      if (default_CONF_method == (CONF_METHOD *)0x0) {
        default_CONF_method = NCONF_default();
      }
