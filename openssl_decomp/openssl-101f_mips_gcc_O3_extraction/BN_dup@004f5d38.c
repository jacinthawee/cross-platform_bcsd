...

{
  ...
  pBVar1 = (BIGNUM *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x14,"bn_lib.c",0x11b);
  ...
  if (0 < (int)uVar12) {
    ...
    if (puVar11 == (ulong *)0x0) {
      if (pBVar1->d != (ulong *)0x0) {
        uVar12 = pBVar1->flags;
        if ((uVar12 & 2) != 0) goto LAB_004f5ecc;
...
LAB_004f5ecc:
      ...
      (*(code *)PTR_CRYPTO_free_006a7f88)(pBVar1);
      return (BIGNUM *)0x0;
    }
    if (pBVar1->d != (ulong *)0x0) {
      (*(code *)PTR_CRYPTO_free_006a7f88)();
