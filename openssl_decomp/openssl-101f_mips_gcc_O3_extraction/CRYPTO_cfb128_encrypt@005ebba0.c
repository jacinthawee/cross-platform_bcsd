...

{
  ...
  if (param_7 == 0) {
    for (; uVar2 != 0; uVar2 = uVar2 + 1 & 0xf) {
      if (param_3 == 0) goto LAB_005ebd8c;
      bVar6 = *(byte *)param_1;
      ...
      if (param_3 != 0) {
        ...
        do {
          ...
          do {
            ...
            *pbVar4 = bVar6;
            if (param_1 == puVar12) goto LAB_005ebc8c;
            puVar11 = param_2;
          } while (param_3 != 0);
        } while( true );
      }
    ...
    puVar11 = param_2;
    if (param_3 < 0x10) {
      if (param_3 == 0) goto LAB_005ebe90;
      (*param_8)(param_5,param_5,param_4);
      iVar5 = param_3 - 1;
    }
    else {
      ...
      if ((param_3 & 0xf) == 0) goto LAB_005ebe90;
...
LAB_005ebd8c:
  param_3 = uVar2;
  if ((((uint)param_5 | (uint)param_1 | (uint)param_2) & 3) != 0) goto LAB_005ebc8c;
LAB_005ebda0:
  *param_6 = uVar2;
  return;
}
