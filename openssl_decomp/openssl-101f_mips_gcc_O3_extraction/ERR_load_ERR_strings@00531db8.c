...

{
  ...
  (*(code *)PTR_CRYPTO_lock_006a926c)(5,1,"err.c",0x244);
  if (init_5412 == 0) {
    (*(code *)PTR_CRYPTO_lock_006a926c)(6,1,"err.c",0x247);
  }
  else {
    (*(code *)PTR_CRYPTO_lock_006a926c)(6,1,"err.c",0x24b);
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,1,"err.c",0x24c);
    if (init_5412 == 0) {
      (*(code *)PTR_CRYPTO_lock_006a926c)(10,1,"err.c",0x24f);
    }
    else {
...
LAB_00531f2c:
          ...
          ppcVar5 = ppcVar5 + 2;
          puVar7 = puVar7 + 0x20;
          if (pcVar6 == (char *)0x80) goto LAB_00531f8c;
        }
        iVar3 = (*(code *)PTR_strerror_006aab58)(pcVar6);
        if (iVar3 == 0) {
          if (*ppcVar5 == (char *)0x0) {
            *ppcVar5 = "unknown";
          }
        ...
        pcVar6 = pcVar6 + 1;
        (*(code *)PTR_strncpy_006aaaec)(puVar7,iVar3,0x20);
        puVar7[0x1f] = '\0';
        *ppcVar5 = puVar7;
        puVar7 = puVar7 + 0x20;
        ppcVar5 = ppcVar5 + 2;
...
LAB_00531f8c:
      init_5412 = 0;
      (*(code *)PTR_CRYPTO_lock_006a926c)(10,1,"err.c",0x26c);
    }
  }
