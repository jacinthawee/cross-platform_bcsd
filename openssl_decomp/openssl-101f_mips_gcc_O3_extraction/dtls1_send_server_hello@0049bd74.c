...

{
  ...
  iVar33 = *(int *)(param_1[0xf] + 4);
  ssl_fill_hello_random();
  *(char *)(iVar33 + 0xc) = (char)((uint)*param_1 >> 8);
  *(char *)(iVar33 + 0xd) = (char)*param_1;
  iVar29 = param_1[0x16];
  uVar25 = iVar29 + 0xa0U & 3;
  uVar1 = iVar29 + 0xa4U & 3;
  iVar34 = *(int *)((iVar29 + 0xa4U) - uVar1);
  ...
  *(uint *)(iVar33 + 0x12) =
       (iVar34 << uVar1 * 8 | in_t2 & 0xffffffffU >> (4 - uVar1) * 8) & -1 << (uVar12 + 1) * 8 |
       uVar18 >> (3 - uVar12) * 8;
  *(uint *)(iVar33 + 0x16) =
  ...
  *(uint *)(iVar33 + 0x1a) =
       ...
       uVar20 >> (3 - uVar14) * 8;
  *(uint *)(iVar33 + 0x1e) =
       (iVar8 << uVar4 * 8 | uVar32 & 0xffffffffU >> (4 - uVar4) * 8) & -1 << (uVar15 + 1) * 8 |
       uVar21 >> (3 - uVar15) * 8;
  *(uint *)(iVar33 + 0x22) =
  ...
  *(undefined4 *)(iVar33 + 0x2a) = uVar24;
  ...
  puVar27 = PTR_memcpy_006aabf4;
  *(undefined *)(iVar33 + 0x2e) = uVar28;
  iVar34 = iVar33 + 0x2f + uVar25;
  (*(code *)puVar27)(iVar33 + 0x2f,param_1[0x30] + 0x48);
  if (*(int *)(param_1[0x16] + 0x344) == 0) {
    return 0xffffffff;
  }
  iVar26 = ssl3_put_cipher_by_char(*(int *)(param_1[0x16] + 0x344),iVar34);
  puVar27 = (undefined *)(iVar34 + iVar26);
  uVar25 = *(uint *)(param_1[0x16] + 0x38c);
  if (uVar25 != 0) {
    uVar25 = (uint)*(byte *)(uVar25 + 3);
  }
  *puVar27 = (char)uVar25;
  iVar34 = ssl_add_serverhello_tlsext(param_1,puVar27 + 1,iVar33 + 0x4000);
  if (iVar34 != 0) {
    iVar26 = iVar34 - (iVar33 + 0xc);
    dtls1_set_message_header(param_1,iVar33,2,iVar26,0,iVar26);
    param_1[0x12] = 0;
    param_1[0x11] = iVar34 - iVar33;
    param_1[0xd] = 0x2131;
  ...
  uVar24 = 0x3d9;
LAB_0049bfc8:
  (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x10a,0x44,"d1_srvr.c",uVar24);
  return 0xffffffff;
}
