...
LAB_00555e34:
  ...
  if (uVar6 == 0) {
    ...
    if (X509_NAME_ENTRY_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar6 & 0xff) < 7) {
        ...
        iVar5 = (*(code *)(&switchD_0055fb90::switchdataD_0066aa70)[uVar6 & 0xff])();
        return iVar5;
      }
      goto switchD_0055fb90_caseD_0;
    }
  ...
  if (X509_NAME_ENTRY_it._16_4_[4] == 0) {
    ...
    if ((uVar6 & 0xff) < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      iVar5 = (*(code *)(&switchD_0055fdcc::switchdataD_0066aa8c)[uVar6 & 0xff])();
      return iVar5;
    }
  }
  else {
    ...
    if ((uVar6 & 0xff) < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      iVar5 = (*(code *)(&switchD_0055fa8c::switchdataD_0066aa54)[uVar6 & 0xff])();
      return iVar5;
    }
  }
