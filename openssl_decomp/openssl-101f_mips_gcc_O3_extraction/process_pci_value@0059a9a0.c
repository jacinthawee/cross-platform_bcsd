...
LAB_0059aa34:
    ...
    if (pPStack_888 == (PROXY_CERT_INFO_EXTENSION *)0x0) {
      ...
      iVar5 = (*(code *)local_840[-0xa8d].rdi)(puStack_878,&DAT_0066f690,4);
      if (iVar5 == 0) {
...
LAB_0059b328:
  ...
  if (pAStack_898 == (ASN1_OBJECT *)0x0) {
    ...
    if (((uVar7 & 0xfffffffd) == 0x299) &&
       (pcVar17 = "7 datafinal", pAStack_890 != (ASN1_OCTET_STRING *)0x0)) {
      line = (X509 *)0x9f;
      uVar15 = 0x131;
    }
    else {
