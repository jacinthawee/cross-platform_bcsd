...

{
  ...
  if (param_1 != 0) {
    uVar1 = (*(code *)PTR_EVP_CIPHER_nid_006a84d0)();
    uVar1 = (*(code *)PTR_OBJ_nid2sn_006a819c)(uVar1);
                    /* WARNING: Could not recover jumptable at 0x00422238. Too many branches */
  ...
  if (param_3 == (char *)0x0) {
    param_3 = "<undefined>";
                    ...
                    /* WARNING: Could not recover jumptable at 0x00422270. Too many branches */
                    /* WARNING: Treating indirect jump as call */
