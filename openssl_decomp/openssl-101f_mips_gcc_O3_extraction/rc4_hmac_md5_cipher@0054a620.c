...

{
  ...
  if (iVar11 == -1) {
    if (*(int *)(param_1 + 8) == 0) {
      (*(code *)PTR_RC4_006a8b20)(iVar18,param_4,param_3,param_2);
      (*(code *)PTR_MD5_Update_006a9bcc)(iVar18 + 0x1bc,param_2,param_4);
      param_4 = param_2;
    }
    else {
      (*(code *)PTR_MD5_Update_006a9bcc)(iVar18 + 0x1bc,param_3,param_4);
      (*(code *)PTR_RC4_006a8b20)(iVar18,param_4,param_3,param_2);
    }
  }
  else {
    ...
    iVar15 = 0;
    param_4 = param_2;
    if (bVar1) goto LAB_0054a684;
    iVar15 = *(int *)(param_1 + 8);
    if (iVar15 == 0) {
      (*(code *)PTR_RC4_006a8b20)(iVar18,puVar17,param_3,param_2);
      puVar13 = (undefined4 *)(iVar18 + 0x1bc);
      param_4 = auStack_34;
      (*(code *)PTR_MD5_Update_006a9bcc)(puVar13,param_2,iVar11);
      (*(code *)PTR_MD5_Final_006a9bc8)(param_4,puVar13);
      ...
      do {
        ...
        *puVar5 = *puVar7;
        ...
        puVar5[2] = uVar9;
        puVar5[3] = uVar8;
        puVar17 = PTR_MD5_Update_006a9bcc;
        puVar4 = puVar5 + 4;
      ...
      (*(code *)PTR_MD5_Final_006a9bc8)(param_4,puVar13);
      iVar11 = (*(code *)PTR_memcmp_006aabd8)(param_2 + iVar11,param_4,0x10);
      if (iVar11 != 0) goto LAB_0054a684;
    }
    else {
      puVar16 = (undefined4 *)(iVar18 + 0x1bc);
      (*(code *)PTR_MD5_Update_006a9bcc)(puVar16,param_3,iVar11);
      if (param_3 != param_2) {
        (*(code *)PTR_memcpy_006aabf4)(param_2,param_3,iVar11);
      }
      puVar12 = param_2 + iVar11;
      (*(code *)PTR_MD5_Final_006a9bc8)(puVar12,puVar16);
      ...
      do {
        ...
        *puVar5 = *puVar7;
        ...
        puVar5[2] = uVar9;
        puVar5[3] = uVar8;
        puVar2 = PTR_MD5_Update_006a9bcc;
        puVar13 = puVar5 + 4;
      ...
      (*(code *)PTR_MD5_Final_006a9bc8)(puVar12,puVar16);
      (*(code *)PTR_RC4_006a8b20)(iVar18,puVar17,param_2,param_2);
      param_4 = puVar17;
    }
  }
  iVar15 = 1;
...
LAB_0054a684:
  if (local_24 != *(EVP_CIPHER_CTX **)puVar3) {
    ...
    (*(code *)PTR_RC4_set_key_006a8aec)(pvVar14,iVar11,param_4);
    (*(code *)PTR_MD5_Init_006a9294)(puVar13);
