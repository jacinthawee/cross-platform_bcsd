...

{
  ...
  if (uVar3 != 0) {
    ...
    if (NETSCAPE_PKEY_it._16_4_ != (ASN1_ITEM_EXP *)0x0) goto LAB_0055fa60;
    switch(uVar3 & 0xff) {
    default:
...
joined_r0x0055ff4c:
      ...
      case 6:
        ...
        asn1_enc_free((ASN1_VALUE **)(ASN1_ITEM_EXP *)&pAStack_34,(ASN1_ITEM *)NETSCAPE_PKEY_it);
        pAStack_3c = (ASN1_ITEM_EXP *)(NETSCAPE_PKEY_it._8_4_ + NETSCAPE_PKEY_it._12_4_ * 5 + -5);
        if (0 < NETSCAPE_PKEY_it._12_4_) goto LAB_0055fcc4;
        break;
      case 2:
        param_1 = (ASN1_ITEM_EXP *)&SUB_00000002;
        pAVar6 = (ASN1_ITEM_EXP *)&pAStack_34;
        ...
        if ((-1 < iVar5) && (iVar5 < NETSCAPE_PKEY_it._12_4_)) goto LAB_0055fe08;
        break;
      case 3:
