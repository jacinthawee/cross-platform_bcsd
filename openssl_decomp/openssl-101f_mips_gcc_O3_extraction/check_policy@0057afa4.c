  ...
  if (iVar1 == 0) {
    ...
    do {
      do {
        ...
        if (iVar3 <= iVar1) goto LAB_0057b030;
        iVar4 = iVar1 + 1;
        iVar3 = (*(code *)PTR_sk_value_006a7f24)(*(undefined4 *)(param_1 + 0x54),iVar1);
        iVar1 = iVar4;
    ...
    if (iVar1 == -2) {
      ...
      *(undefined4 *)(param_1 + 100) = 0x2b;
                    /* WARNING: Could not recover jumptable at 0x0057b124. Too many branches */
