...

{
  ...
  if (iVar3 < 1) {
    ...
    iVar3 = (*(code *)PTR_PEM_read_bio_X509_AUX_006a8c6c)
    ...
    if (iVar3 != 0) {
      ...
      if (iVar4 == 0) {
        ...
        iVar5 = (*(code *)PTR_ERR_peek_error_006a8054)();
        if ((iVar5 == 0) && (iVar4 != 0)) {
          if (ctx->extra_certs != (stack_st_X509 *)0x0) {
            (*(code *)PTR_sk_pop_free_006a8158)(ctx->extra_certs,PTR_X509_free_006a7f90);
          ...
          do {
            ...
            if (parg == (void *)0x0) {
              uVar7 = (*(code *)PTR_ERR_peek_last_error_006a8508)();
              if ((uVar7 >> 0x18 != 9) || ((uVar7 & 0xfff) != 0x6c)) goto LAB_004b9dcc;
              (*(code *)PTR_ERR_clear_error_006a7fe0)();
              goto LAB_004b9dd0;
            }
...
LAB_004b9dd0:
  ...
  iVar4 = 0;
  (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xdc,uVar8,&DAT_00649ed0,uVar1);
LAB_004b9e10:
