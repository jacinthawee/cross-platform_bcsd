...

{
  ...
  ipasc_00 = (uint *)0x2f;
  local_24 = *(X509_NAME **)PTR___stack_chk_guard_006aabf0;
  iVar6 = (*(code *)PTR_strchr_006aab34)(ipasc,0x2f);
  if ((iVar6 == 0) ||
     (list = (char *)(*(code *)PTR_BUF_strdup_006a80dc)(ipasc), puVar3 = PTR_strchr_006aab34,
     list == (char *)0x0)) {
LAB_0058ea6c:
    puVar11 = ipasc_00;
    ...
    if (iVar7 == 0) {
      in_a2 = &local_70;
      puVar11 = (uint *)0x66f5b0;
      iVar7 = (*(code *)PTR___isoc99_sscanf_006aab10)
...
LAB_0058ea38:
        ...
        if (((iVar6 != 0) && (iVar6 == iVar7)) &&
           (pAVar9 = (ASN1_OCTET_STRING *)(*(code *)PTR_ASN1_OCTET_STRING_new_006a978c)(),
           in_a2 = local_64, pAVar9 != (ASN1_OCTET_STRING *)0x0)) {
          in_a2 = (uint *)(iVar7 << 1);
          iVar6 = (*(code *)PTR_ASN1_OCTET_STRING_set_006a9790)(pAVar9,puVar11);
          if (iVar6 == 0) {
            (*(code *)PTR_ASN1_OCTET_STRING_free_006a9e1c)(pAVar9);
            pAVar9 = (ASN1_OCTET_STRING *)0x0;
          }
          goto LAB_0058ead4;
        }
...
LAB_0058ea34:
          ...
          if (local_48 == 3) {
            if (local_50 < 1) {
              if (local_4c < 0) goto LAB_0058eb1c;
LAB_0058ebd8:
              (*(code *)PTR___memcpy_chk_006aab54)(local_44,local_60,local_4c,0x20);
              local_64 = (uint *)(0x10 - iVar7);
              (*(code *)PTR_memset_006aab00)((int)local_44 + iVar10,0);
              if (iVar10 == iVar7) goto LAB_0058ea34;
LAB_0058ea18:
            ...
            if (local_4c == 0) goto LAB_0058ebd8;
            ...
            if (local_4c < 0) goto LAB_0058eb1c;
            (*(code *)PTR___memcpy_chk_006aab54)(local_44,local_60,local_4c,0x20);
            (*(code *)PTR_memset_006aab00)((int)local_44 + iVar10,0,0x10 - iVar7);
            goto LAB_0058ea18;
          }
        }
      }
...
LAB_0058ead4:
  ...
  iVar7 = 0;
  iVar6 = (*(code *)PTR_sk_num_006a7f2c)(puVar11);
  if (0 < iVar6) {
    do {
      iVar6 = (*(code *)PTR_sk_value_006a7f24)(puVar11,iVar7);
...
LAB_0058ed54:
          ...
          pbVar12 = pbVar13 + 2;
          if (pbVar13[2] != 0x2b) goto LAB_0058ed54;
          pbVar13 = pbVar13 + 3;
        }
LAB_0058edd4:
        iVar10 = -1;
