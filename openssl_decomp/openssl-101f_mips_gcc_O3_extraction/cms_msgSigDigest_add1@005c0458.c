...
LAB_005c0524:
    ...
    (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0xa2,0xac,s_cms_ess_c_00672acc);
    piVar5 = (int *)0x0;
  }
  else {
    ...
    if (piVar5 == (int *)0x0) {
      cms_00 = (CMS_ContentInfo *)&DAT_000000a2;
      (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0xa2,0x41,s_cms_ess_c_00672acc);
    }
    else {
      piVar5 = (int *)0x1;
    }
      ...
      if (ppAVar9 != (ASN1_OCTET_STRING **)0x0) {
        if (*ppAVar9 != (ASN1_OCTET_STRING *)0x0) {
          ...
          if (unaff_s4 != 0) {
            ...
            if (piVar5 == (int *)0x0) {
              (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0xa0,0xa7,s_cms_ess_c_00672acc,0x12e);
              goto LAB_005c0888;
            }
...
LAB_005c0654:
  (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0xa0,uVar11,s_cms_ess_c_00672acc,uVar3);
LAB_005c0668:
