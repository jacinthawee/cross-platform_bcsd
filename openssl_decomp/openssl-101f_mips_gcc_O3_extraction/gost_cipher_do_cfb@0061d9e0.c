...
LAB_0061de88:
      ...
      *(byte *)param_2 = bVar3;
      ...
      if (uVar1 == 8) {
        ...
        if (param_4 < 2) goto LAB_0061de88;
        if (iVar6 == 0) {
        ...
        if (uVar1 == 8) {
          ...
          *(byte *)((int)param_2 + 2) = bVar3;
          ...
          if (uVar1 == 8) {
            ...
            if (param_4 == 3) goto LAB_0061de88;
            if (iVar6 == 0) {
            ...
            *(byte *)((int)param_2 + 3) = bVar3;
            ...
            if (uVar1 == 8) {
              ...
              if (param_4 == 4) goto LAB_0061de88;
              if (iVar6 == 0) {
              ...
              *(byte *)(param_2 + 1) = bVar3;
              ...
              if (uVar1 == 8) {
                ...
                if (param_4 == 5) goto LAB_0061de88;
                if (iVar6 == 0) {
                ...
                *(byte *)((int)param_2 + 5) = bVar3;
                ...
                if (uVar4 == 1) {
                  uVar1 = 7;
                  if (param_4 == 6) goto LAB_0061de88;
                  if (iVar6 == 0) {
  ...
  *(uint *)(iVar5 + 4) = (*(uint *)(iVar5 + 4) & 0x3ff) + 8;
  if (iVar6 == 0) {
    uVar1 = param_4 - uVar4;
    (*(code *)PTR_memcpy_006aabf4)(param_1 + 0x38,param_3,uVar1);
  }
  else {
    uVar1 = param_4 - uVar4;
  }
    ...
    *(byte *)param_2 = *(byte *)(param_1 + 0x30) ^ *(byte *)param_3;
    ...
    if ((param_4 - 1) - uVar4 < 3) {
      ...
      *param_2 = *param_3 ^ *(uint *)(param_1 + 0x30);
      ...
      uVar4 = uVar4 + uVar2;
      if (uVar1 == uVar2) goto LAB_0061e050;
    }
    iVar5 = uVar2 + 1;
...
LAB_0061e050:
  *(uint *)(param_1 + 0x50) = uVar1;
  if (*(int *)(param_1 + 8) != 0) {
    (*(code *)PTR_memcpy_006aabf4)(param_1 + 0x38,param_2,uVar1);
  }
  return 1;
}
