...
LAB_00551c7c:
    if (param_1 == (ASN1_TYPE *)0x0) {
      ...
      iVar9 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a078,1,1,param_1);
...
LAB_00552088:
  ...
  if (local_4d == '\0') {
    ...
    iVar9 = local_78;
    if (param_1 == (ASN1_TYPE *)0x0) goto LAB_00551cb0;
    iVar9 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0067a4e0,1,1,param_1);
    if (iVar9 != 1) goto LAB_00551ca8;
  }
  pcVar4 = (param_3.object)->sn;
      ...
      if (0 < iVar9) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar18 & 8) == 0) {
              iVar9 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a068,1,1,param_1);
              if (iVar9 != 1) goto LAB_00551ca8;
...
LAB_005522b4:
          if ((uVar18 & 6) == 0) {
            ...
            iVar9 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a074,1,2,param_1);
...
LAB_00552274:
  ...
  iVar6 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0067a4e0,1,1,param_1);
