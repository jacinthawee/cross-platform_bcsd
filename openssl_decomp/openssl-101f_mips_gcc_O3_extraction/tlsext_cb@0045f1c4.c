...
joined_r0x0045f248:
  ...
  (*(code *)PTR_BIO_dump_006a8738)(param_6,param_4,param_5);
                    /* WARNING: Could not recover jumptable at 0x0045f2b4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR_BIO_ctrl_006a7f18)(param_6,0xb,0,0);
  return;
}
