...
LAB_004f85b4:
    ...
    if (-1 < param_5 + param_6) {
      return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x004f8984. Too many branches */
  ...
  iVar15 = param_4 >> 1;
  if (param_4 < 0x10) goto LAB_004f85b4;
  iVar12 = -param_5;
...
joined_r0x004f8618:
  if (((iVar15 == 8) && (param_5 == 0)) && (param_6 == 0)) {
    if (bVar1) {
      (*(code *)PTR_memset_006aab00)(param_7 + param_4,0,0x40);
    }
    else {
    ...
    if (bVar1) {
      (*(code *)PTR_memset_006aab00)(param_7 + param_4,0,param_4 * 4);
    }
    else {
