...

{
  ...
  if ((tt->flags & 6) == 0) {
    ...
    unaff_s3 = &local_28;
    it = (ASN1_ITEM_EXP *)tt;
    for (unaff_s0 = 0; iVar2 = (*(code *)PTR_sk_num_006a7f2c)(unaff_s1), unaff_s0 < iVar2;
        unaff_s0 = unaff_s0 + 1) {
      local_28 = (*(code *)PTR_sk_value_006a7f24)(unaff_s1,unaff_s0);
      it = tt->item;
  ...
  AStack_74.templates = *(ASN1_TEMPLATE **)PTR___stack_chk_guard_006aabf0;
  ...
  ppAStack_54 = pval;
  if (uVar3 != 0) {
    if (pAVar5 == (ASN1_ITEM_EXP *)0x0) goto switchD_0055fb90_caseD_0;
    if (pAVar8 != (ASN1_ITEM_EXP *)0x0) goto LAB_0055fa60;
    switch(uVar3 & 0xff) {
    default:
...
switchD_0055fdcc_caseD_0:
    ...
    if (pAVar10 != (ASN1_TEMPLATE *)0x0) {
      ...
      if ((pAVar10->flags & 6) == 0) {
        ...
        for (; iVar4 = (*(code *)PTR_sk_num_006a7f2c)(pAVar5), iVar2 < iVar4; iVar2 = iVar2 + 1) {
          AStack_74.utype = (*(code *)PTR_sk_value_006a7f24)(pAVar5,iVar2);
          pAVar8 = pAVar10->item;
...
switchD_0055fb90_caseD_1:
        ...
        if (0 < iVar2) goto switchD_0055fb90_caseD_0;
        pAVar8 = it;
          ...
          do {
            ...
            if (pAVar5 != (ASN1_ITEM_EXP *)0x0) {
              ...
              if ((*(uint *)pAVar5 & 6) == 0) {
                ...
                pAVar9 = *ppAVar6;
                for (iVar4 = 0; iVar7 = (*(code *)PTR_sk_num_006a7f2c)(pAVar9), iVar4 < iVar7;
                    iVar4 = iVar4 + 1) {
                  AStack_74.utype = (*(code *)PTR_sk_value_006a7f24)(pAVar9,iVar4);
                  pAVar8 = (ASN1_ITEM_EXP *)pAVar5->funcs;
                  asn1_item_combine_free((int)&AStack_74 + 4,pAVar8,0);
                }
...
LAB_0055fe08:
          ...
          if ((*(uint *)pAVar5 & 6) == 0) {
            ...
            pAVar9 = *ppAVar6;
            for (iVar2 = 0; iVar4 = (*(code *)PTR_sk_num_006a7f2c)(pAVar9), iVar2 < iVar4;
                iVar2 = iVar2 + 1) {
              AStack_74.utype = (*(code *)PTR_sk_value_006a7f24)(pAVar9,iVar2);
              pAVar8 = (ASN1_ITEM_EXP *)pAVar5->funcs;
              asn1_item_combine_free((int)&AStack_74 + 4,pAVar8,0);
            }
            (*(code *)PTR_sk_free_006a7f80)(pAVar9);
...
joined_r0x0055ff4c:
      ...
      case 6:
        ...
        if (iVar2 == 2) goto switchD_0055fb90_caseD_0;
        asn1_enc_free((ASN1_VALUE **)&AStack_74,it);
        pAStack_7c = (ASN1_ITEM_EXP *)(it->templates + it->tcount + -1);
      ...
      case 2:
        ...
        if (iVar2 == 2) goto switchD_0055fb90_caseD_0;
        iVar2 = asn1_get_choice_selector((ASN1_VALUE **)&AStack_74,it);
        if ((-1 < iVar2) && (iVar2 < it->tcount)) goto LAB_0055fe08;
        break;
      case 3:
...
switchD_0055fb90_caseD_0:
  ...
  (*(code *)PTR_memcmp_006aabd8)(*(undefined4 *)pAVar5,*(undefined4 *)pAVar8,iVar2);
  return;
}
