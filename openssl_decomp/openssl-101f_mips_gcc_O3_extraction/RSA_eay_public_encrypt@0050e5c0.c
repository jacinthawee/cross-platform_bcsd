...

{
  ...
  if (0x4000 < iVar1) {
    ...
    uVar4 = 0xa3;
LAB_0050e7f8:
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x68,uVar7,&DAT_006675d8,uVar4);
    return -1;
  }
  ...
  iVar1 = iVar1 >> 3;
  to = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar1,&DAT_006675d8,0xbc);
  if (((ret == (BIGNUM *)0x0) || (a == (BIGNUM *)0x0)) || (to == (uchar *)0x0)) {
    iVar2 = -1;
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x68,0x41,&DAT_006675d8,0xbf);
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    if (to == (uchar *)0x0) {
      return -1;
