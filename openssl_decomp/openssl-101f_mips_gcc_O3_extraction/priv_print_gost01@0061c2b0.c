...

{
  ...
  iVar1 = (*(code *)PTR_EVP_PKEY_base_id_006a800c)(param_2);
  if (iVar1 == 0x32b) {
    iVar1 = (*(code *)PTR_EVP_PKEY_get0_006aa6e4)(param_2);
    if (iVar1 != 0) {
      iVar1 = (*(code *)PTR_EC_KEY_get0_private_key_006a910c)(iVar1);
      goto joined_r0x0061c698;
    }
  }
  else if ((iVar1 == 0x32c) && (iVar1 = (*(code *)PTR_EVP_PKEY_get0_006aa6e4)(param_2), iVar1 != 0))
  {
    iVar1 = *(int *)(iVar1 + 0x1c);
joined_r0x0061c698:
    if (iVar1 != 0) {
      (*(code *)PTR_BN_print_006a8024)(param_1,iVar1);
      goto LAB_0061c38c;
    }
  }
...
LAB_0061c38c:
  ...
  if (iVar6 != 0) {
    ...
    if (iVar6 != 0) {
      (*(code *)PTR_BIO_printf_006a7f38)(param_1,&DAT_0067b064);
      (*(code *)PTR_BN_print_006a8024)(param_1,uVar2);
      (*(code *)PTR_BIO_printf_006a7f38)(param_1,"\n");
      (*(code *)PTR_BIO_indent_006a97d0)(param_1,param_3 + 3,0x80);
      (*(code *)PTR_BIO_printf_006a7f38)(param_1,&DAT_0067b068);
