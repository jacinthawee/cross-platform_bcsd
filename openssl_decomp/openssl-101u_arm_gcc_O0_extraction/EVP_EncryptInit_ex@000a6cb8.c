...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_000a6e84;
      goto LAB_000a6d60;
    }
    if (pEVar4 != (EVP_CIPHER *)0x0) goto LAB_000a6ce6;
  }
...
LAB_000a6e84:
    ...
    if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_000a6d60;
LAB_000a6ce6:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_000a6d32;
  }
  else {
...
LAB_000a6d60:
    ...
    if ((key != (uchar *)0x0) || ((int)(pEVar4->flags << 0x1a) < 0)) {
      iVar1 = (*pEVar4->init)(ctx,key,iv,1);
      if (iVar1 == 0) {
        return 0;
      }
      pEVar4 = ctx->cipher;
