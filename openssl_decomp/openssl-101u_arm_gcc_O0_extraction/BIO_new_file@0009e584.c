...

{
  ...
  if (__stream == (FILE *)0x0) {
    ...
    ERR_add_error_data(5,"fopen(\'",filename,&DAT_0015dc6c,mode,&DAT_00139dd8);
    if (*piVar1 != 2) {
      ERR_put_error(0x20,0x6d,2,"bss_file.c",0xb4);
      return (BIO *)0x0;
    }
    ERR_put_error(0x20,0x6d,0x80,"bss_file.c",0xb2);
  }
  else {
