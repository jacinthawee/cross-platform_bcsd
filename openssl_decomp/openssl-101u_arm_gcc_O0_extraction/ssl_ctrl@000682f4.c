...
LAB_00068424:
  ...
  case 6:
    ...
    if ((pBVar1 != (BIO *)0x0) && (pBVar1 != pSVar6->rbio)) {
      ...
      CRYPTO_add_lock(&((bio_st *)param_1->server)->references,1,0x15,"bio_ssl.c",0x183);
      return (SSL *)0x1;
    }
    goto LAB_000684e2;
  case 7:
    if (param_1 == param_4) {
      ...
      if ((bio_st *)param_1->server != (bio_st *)0x0) {
        CRYPTO_add_lock(&((bio_st *)param_1->server)->references,-1,0x15,"bio_ssl.c",400);
      }
      pSVar6->wbio = (BIO *)0x0;
      pSVar6->rbio = (BIO *)0x0;
      return (SSL *)0x1;
...
LAB_000684c8:
  ...
  case 0x6d:
    if (pSVar6 != (SSL *)0x0) {
      ...
      ppSVar8 = (SSL **)CRYPTO_malloc(0x18,"bio_ssl.c",0x6a);
      if (ppSVar8 == (SSL **)0x0) {
    ...
    *ppSVar8 = param_4;
    ...
    if (pBVar1 != (BIO *)0x0) {
      ...
      CRYPTO_add_lock(&pBVar1->references,1,0x15,"bio_ssl.c",0x162);
    }
    ret_code = (SSL *)0x1;
