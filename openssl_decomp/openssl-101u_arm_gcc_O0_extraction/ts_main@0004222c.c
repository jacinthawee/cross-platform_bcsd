...
LAB_000422ca:
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
        ...
        pcVar24 = ppcVar17[1];
        ppcVar17 = ppcVar17 + 2;
        goto joined_r0x00042306;
      }
      iVar2 = strcmp(pcVar19,"-query");
      if (iVar2 == 0) {
        if (pcVar20 != (char *)0x0) goto switchD_00042346_caseD_0;
        pcVar20 = (char *)0x1;
      }
      else {
...
LAB_000422be:
    ...
    ppcVar17 = ppcVar17 + 1;
joined_r0x00042306:
    if (param_1 < 1) goto LAB_00042308;
    goto LAB_000422ca;
  }
...
LAB_000428e8:
    ...
    else if (local_90 != (char *)0x0) goto LAB_000428e8;
  }
  pcVar19 = pcVar20;
  if ((uVar18 != 0) &&
    ...
    if (local_98 == (char *)0x0 || local_9c == (BIO *)0x0) {
      ...
      if (local_80 == (BIO *)0x0) {
        if (local_98 == (char *)0x0) {
          ...
          if (local_80 == (BIO *)0x0) goto LAB_00042b82;
        }
        local_44 = (void *)0x0;
        if (((local_74 == (EVP_MD *)0x0) &&
...
LAB_00042ae6:
          ...
          if (((pAVar11 == (ASN1_OBJECT *)0x0) ||
             ...
             pAVar14 = (ASN1_OBJECT *)local_9c, local_9c == (BIO *)0x0)) goto LAB_00042ae6;
          iVar2 = EVP_MD_type(local_74);
          pAVar13 = OBJ_nid2obj(iVar2);
          ((ASN1_OBJECT *)local_9c)->sn = (char *)pAVar13;
          pAVar14 = pAVar13;
          if (pAVar13 == (ASN1_OBJECT *)0x0) goto LAB_00042ae6;
          ...
          if (((pAVar13 == (ASN1_OBJECT *)0x0) ||
             ...
             pAVar14 = pAVar13, pAVar13 == (ASN1_OBJECT *)0x0)) goto LAB_00042ae6;
          ...
          if (local_7c != (ASN1_OBJECT *)0x0) {
            ...
            if (pAVar14 == (ASN1_OBJECT *)0x0) {
              ...
              local_7c = pAVar14;
              if (pAVar13 != (ASN1_OBJECT *)0x0) goto LAB_00042d92;
            }
            goto LAB_00042ae6;
          }
LAB_00042d92:
      ...
      if ((conf != (CONF *)0x0 && local_88 != (BIO *)0x0) && (local_78 == (PKCS7 *)0x0)) {
        ...
        if (pBVar21 != (BIO *)0x0) {
          ...
          if ((iVar2 == 0) || (local_78 = (PKCS7 *)TS_RESP_CTX_new(), local_78 == (PKCS7 *)0x0)) {
            ...
            iVar10 = TS_CONF_set_serial(conf,iVar2,0x421b1,local_78);
            if ((((((iVar10 != 0) &&
...
LAB_000426bc:
          ...
          if (pBVar6 == (BIO *)0x0) goto LAB_00042a7a;
          local_88 = pBVar16;
          if (bVar1) {
...
LAB_00042762:
      ...
      if (pBVar5 == (BIO *)0x0) goto LAB_00042762;
...
LAB_000429b8:
        ...
        if (pPVar9 == (PKCS7 *)0x0) goto LAB_000429a4;
        pcVar20 = local_98;
        if (local_98 != (char *)0x0) {
          pcVar20 = (char *)0x1;
        }
...
LAB_00042aa0:
        ...
        if (pBVar21 == (BIO *)0x0) {
          ...
          pBVar5 = pBVar21;
          if (pBVar21 == (BIO *)0x0) goto LAB_00042aa0;
          pBVar21 = (BIO *)0x0;
          pBVar3 = (BIO_METHOD *)((uint)pBVar6->method | 1);
          pBVar5 = (BIO *)0x0;
        }
...
LAB_00042840:
        if (local_68 != (char *)0x0) {
          ...
          pXVar8 = X509_STORE_add_lookup(ctx,pXVar7);
          if (pXVar8 == (X509_LOOKUP *)0x0) goto LAB_00042e4e;
        ...
        if (ctx == (X509_STORE *)0x0) goto LAB_00042aa0;
        if (local_60 != (char *)0x0) {
          pcVar20 = (char *)TS_CONF_load_certs(local_60);
          pBVar6->cb_arg = pcVar20;
          if (pcVar20 == (char *)0x0) goto LAB_00042aa0;
        }
        BIO_free_all(pBVar5);
        TS_REQ_free(pBVar21);
        if (local_78 == (PKCS7 *)0x0) {
