...
LAB_0011ddce:
  ...
  uVar9 = *n->d;
  if ((uVar9 & 1) == 0) {
    if ((iVar8 != 1) || (uVar9 != 2)) goto LAB_0011ddce;
    if (ret != (BIGNUM *)0x0) {
    ...
    if ((iVar8 == 1) && (uVar9 == 1)) goto LAB_0011ddce;
    iVar8 = a->top;
...
LAB_0011ded4:
                  ...
                  if (r_01->top == 0) goto LAB_0011ded4;
                }
                iVar5 = BN_kronecker(r_01,pBVar3,ctx);
                if (iVar5 + 1 < 0 != SCARRY4(iVar5,1)) goto LAB_0011de4a;
                if (iVar5 == 0) {
                  iVar8 = 0xf9;
LAB_0011e08c:
...
joined_r0x0011e156:
  if (iVar5 == 0) goto LAB_0011de4a;
  if (((pBVar4->top == 1) && (*pBVar4->d == 1)) && (pBVar4->neg == 0)) goto LAB_0011dfde;
  ...
  if (pBVar3 == (BIGNUM *)0x0) goto LAB_0011de4a;
  iVar8 = iVar8 - iVar10;
  ...
  if ((iVar8 == 0) || (iVar8 = BN_mod_mul(r_00,r_00,r,n,ctx), iVar8 == 0)) goto LAB_0011de4a;
