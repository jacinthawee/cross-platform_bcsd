  ...
  if (0xf < param_2) {
    ...
    if (param_2 < 0x67) {
      if (param_2 == 100) {
        ...
        if (param_2 != 0x65) goto LAB_0009ee2c;
        if (*piVar3 != 6) {
      ...
      if (param_2 != 0x7b) goto LAB_0009ee2c;
      if (param_4 == (BIO *)0x0) {
        uVar1 = *(uint *)(param_1 + 0xc);
        if (uVar1 == 0) goto LAB_0009edb6;
        uVar1 = 1;
LAB_0009ef68:
        if (param_3 == 3) {
          uVar1 = (uint)*(ushort *)(piVar3 + 5);
        }
        goto LAB_0009edb6;
      }
      uVar1 = *(uint *)(param_1 + 0xc);
...
LAB_0009ee2c:
    ...
    if (param_2 != 0xb) {
      if (param_2 != 0xc) goto LAB_0009ee2c;
      if ((void *)piVar3[2] != (void *)0x0) {
