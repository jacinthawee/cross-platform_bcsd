...

{
  ...
  if ((in != (SSL_SESSION *)0x0) &&
    ...
    local_19c = *(int *)(in->krb5_client_princ + 0x54);
    if (local_19c != 0) {
      local_19c = i2d_ASN1_OCTET_STRING(&local_a0,(uchar **)0x0);
      iVar6 = ASN1_object_size(1,local_19c,10);
      iVar3 = iVar3 + iVar6;
    }
    ...
    if (pp != (uchar **)0x0) {
      ...
      if (*(int *)(in->krb5_client_princ + 0x54) != 0) {
        ASN1_put_object(&local_174,1,local_19c,10,0x80);
