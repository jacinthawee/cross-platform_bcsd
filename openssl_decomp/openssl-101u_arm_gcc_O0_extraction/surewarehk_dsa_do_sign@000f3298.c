...

{
  ...
  local_64 = *(undefined4 *)PTR_s_ENGINE_dsa_do_sign_000f3450;
  uStack_60 = *(undefined4 *)(PTR_s_ENGINE_dsa_do_sign_000f3450 + 4);
  uStack_5c = *(undefined4 *)(PTR_s_ENGINE_dsa_do_sign_000f3450 + 8);
  uStack_58 = *(undefined4 *)(PTR_s_ENGINE_dsa_do_sign_000f3450 + 0xc);
  uStack_54 = (undefined2)*(undefined4 *)(PTR_s_ENGINE_dsa_do_sign_000f3450 + 0x10);
  local_24 = __stack_chk_guard;
  local_52 = (undefined)((uint)*(undefined4 *)(PTR_s_ENGINE_dsa_do_sign_000f3450 + 0x10) >> 0x10);
    ...
    if (pvVar1 == (void *)0x0) {
      ...
      if (a == (DSA_SIG *)0x0) {
        ...
        if ((a->r != (BIGNUM *)0x0) && (pBVar2 != (BIGNUM *)0x0)) {
          ...
          bn_expand2(a->s,5);
          if (a->r->dmax == 5) {
            puVar7 = (undefined *)a->s->dmax;
            if (puVar7 == (undefined *)0x5) {
              uVar3 = (*p_surewarehk_Dsa_Sign)(&local_64,param_2,param_1,a->r->d,a->s->d,pvVar1);
