        ...
        if (iVar1 == 0) {
          if (policy == (ASN1_OBJECT *)0x0) {
            ...
            *param_3 = 1;
            ...
            iVar1 = __isoc99_sscanf(policy,&DAT_00132324,local_2c);
            if (iVar1 == 1) {
              iVar1 = *param_3;
            }
            else {
                              ...
                              if (policy == (ASN1_OBJECT *)0x0) {
                                ...
                                if (policy == (ASN1_OBJECT *)0x0) {
                                  ...
                                  if (policy == (ASN1_OBJECT *)0x0) {
                                    ...
                                    policy = (ASN1_OBJECT *)strcmp(__s1,"-no_alt_chains");
                                    if (policy == (ASN1_OBJECT *)0x0) {
                                      iVar1 = *param_3;
                                      depth = -1;
                                      flags = (ASN1_OBJECT *)0x100000;
                                      local_2c[0] = policy;
                                      pAVar2 = policy;
                                    }
                                    else {
                                      policy = (ASN1_OBJECT *)strcmp(__s1,"-allow_proxy_certs");
                                      if (policy != (ASN1_OBJECT *)0x0) {
                                        return 0;
                                      }
                                      iVar1 = *param_3;
                                      depth = -1;
                                      flags = (ASN1_OBJECT *)0x40;
                                      local_2c[0] = policy;
                                      pAVar2 = policy;
                                    }
                                  }
