...

{
  ...
  *pexplicit_policy = 0;
  ...
  tree[5] = (void *)0x0;
  pvVar4 = CRYPTO_malloc((int)pvVar1 << 4,"pcy_tree.c",0xe5);
  tree[1] = (void *)0x0;
  tree[2] = (void *)0x0;
  tree[3] = (void *)0x0;
  tree[4] = (void *)0x0;
              ...
              if (puVar10 != puVar9) {
                for (; iVar12 = sk_num(p_Var3), (int)uVar11 < iVar12; uVar11 = uVar11 + 1) {
                  ...
                  if (iVar12 == 0) {
                    ...
                    if (puVar9 == (uint *)0x0) goto LAB_000d6c7c;
...
LAB_000d7096:
  ...
  if ((_STACK *)tree[3] == (_STACK *)0x0) {
    ...
    tree[3] = p_Var3;
    if (p_Var3 == (_STACK *)0x0) goto LAB_000d6c80;
LAB_000d73d8:
    iVar12 = sk_push(p_Var3,pvVar14);
    if (iVar12 == 0) goto LAB_000d6c7c;
  }
  else {
...
LAB_000d725e:
    do {
      ...
      iVar21 = iVar18 + 1;
      if (iVar19 <= iVar18) goto LAB_000d729e;
      ...
      if (iVar12 == *(int *)((int)pvVar4 + 4)) {
        if (*pp_Var17 == (_STACK *)0x0) {
          p_Var3 = (_STACK *)policy_node_cmp_new();
          *pp_Var17 = p_Var3;
          if (p_Var3 == (_STACK *)0x0) goto LAB_000d6c7c;
        }
        else {
          iVar19 = sk_find(*pp_Var17,pvVar4);
          if (iVar19 != -1) goto LAB_000d725e;
          p_Var3 = *pp_Var17;
        }
        iVar19 = sk_push(p_Var3,pvVar4);
        if (iVar19 == 0) goto LAB_000d6c7c;
      }
    } while( true );
  }
LAB_000d72b2:
...
LAB_000d729e:
  iVar15 = iVar15 + 1;
  if ((int)tree[1] <= iVar15) goto LAB_000d72b2;
  iVar12 = *(int *)((int)pvVar1 + 0x18);
  pvVar1 = (void *)((int)pvVar1 + 0x10);
  if (iVar12 == 0) goto LAB_000d72b2;
  goto LAB_000d725c;
  while( true ) {
    if (st == (_STACK *)0x0) {
      st = sk_new_null();
      tree[4] = st;
      if (st == (_STACK *)0x0) goto LAB_000d6d42;
    }
