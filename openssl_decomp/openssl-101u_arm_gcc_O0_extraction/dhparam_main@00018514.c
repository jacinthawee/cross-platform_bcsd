...
LAB_0001879e:
        ...
        if (iVar8 == 0) {
          if (param_1 == 1) goto LAB_0001879e;
          param_1 = param_1 + -2;
        ...
        if ((((cVar2 == '-') && (__s1[1] == 'i')) && (__s1[2] == 'n')) && (__s1[3] == '\0')) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_0001879e;
          __s = ppcVar15[1];
          ppcVar15 = ppcVar15 + 1;
        }
        else {
...
LAB_00018e48:
                          ...
                          if (iVar8 == 0) {
                            ...
                            if ((iVar8 != 0) && (0 < local_38)) goto LAB_00018590;
                          }
                          goto LAB_0001879e;
                        }
                        local_50 = (char *)0x5;
...
LAB_000189e6:
        ...
        if (pBVar17 == (BIO *)0x0) goto LAB_000186a4;
        if (__s == (char *)0x0) {
...
LAB_00018a0c:
          ...
          if (bVar3) {
            ...
            DSA_free(pDVar9);
            if (dh == (DH *)0x0) goto LAB_00018a46;
          }
          else {
            if (uVar16 == 1) {
...
LAB_00018990:
      ...
      if (local_38 == 0) goto LAB_000189e6;
LAB_00018614:
...
LAB_00018644:
      ...
      else if (local_48 != (char *)0x0) goto LAB_00018644;
      if (bVar3) {
        pDVar9 = DSA_new();
        ...
        if (pDVar9 != (DSA *)0x0) {
          ...
          if (iVar8 != 0) {
            dh = DSA_dup_DH(pDVar9);
            DSA_free(pDVar9);
            if (dh != (DH *)0x0) goto LAB_00018916;
            ERR_print_errors(bio_err);
            goto LAB_000186b0;
          }
          DSA_free(pDVar9);
...
LAB_00018948:
            ...
            if (bVar6) {
              ...
              to = (uchar *)CRYPTO_malloc(iVar8 >> 3,"dhparam.c",0x1c0);
              if (to == (uchar *)0x0) {
                uVar14 = 1;
            ...
            if (0 < lVar11) goto LAB_00018948;
            uVar14 = 1;
            perror(local_60);
          }
LAB_00018988:
          if (pBVar17 != (BIO *)0x0) goto LAB_0001898a;
          goto LAB_00018990;
        }
        ERR_print_errors(bio_err);
      }
