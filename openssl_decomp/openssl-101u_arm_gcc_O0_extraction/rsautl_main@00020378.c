...
LAB_00020510:
      ...
      if (iVar5 == 0) {
        if (param_1 == 1) goto LAB_00020510;
        param_1 = param_1 + -2;
        local_54 = ppcVar12[1];
        ppcVar12 = ppcVar12 + 2;
        if (param_1 < 1) break;
      ...
      if (iVar5 == 0) {
        param_1 = param_1 + -1;
        if (param_1 == 0) goto LAB_00020510;
        pcVar10 = ppcVar12[1];
        ppcVar12 = ppcVar12 + 1;
      }
      else {
...
LAB_00020400:
  ...
  iVar5 = RSA_size(rsa);
  from = (uchar *)CRYPTO_malloc(iVar5 << 1,"rsautl.c",0x10d);
  to = (uchar *)CRYPTO_malloc(iVar5,"rsautl.c",0x10e);
  if (from == (uchar *)0x0 || to == (uchar *)0x0) {
    ...
    BIO_free((BIO *)b);
    BIO_free_all(bp);
    if (from != (uchar *)0x0) goto LAB_000208b2;
  }
  else {
    ...
    case 4:
      ...
      break;
    default:
      goto switchD_0002090c_caseD_4;
    }
    if (iVar11 < 1) {
switchD_0002090c_caseD_4:
