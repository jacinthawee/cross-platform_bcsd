...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_000a646c;
      goto LAB_000a634a;
    }
    if (pEVar4 != (EVP_CIPHER *)0x0) goto LAB_000a62d0;
  }
...
LAB_000a646c:
    ...
    if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_000a634a;
LAB_000a62d0:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_000a631c;
  }
  else {
