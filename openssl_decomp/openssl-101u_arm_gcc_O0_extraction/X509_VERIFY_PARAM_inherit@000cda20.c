...
LAB_000cdad6:
    iVar8 = from->trust;
    if (iVar8 != 0) {
      if (uVar1 == 0) goto LAB_000cdadc;
LAB_000cdae0:
      to->trust = iVar8;
    }
LAB_000cdae2:
    iVar8 = from->depth;
    if (iVar8 == -1) goto LAB_000cdaf0;
    if (uVar1 == 0) {
LAB_000cdaea:
      if (to->depth != -1) goto LAB_000cdaf0;
    }
    to->depth = iVar8;
    uVar5 = to->flags;
    uVar7 = uVar5 & 2;
    if (uVar7 == 0) goto LAB_000cda52;
    uVar7 = 0;
  }
  else {
    ...
    iVar8 = from->trust;
    if (iVar8 == 0) goto LAB_000cdae2;
LAB_000cdadc:
    if (to->trust == 0) goto LAB_000cdae0;
    iVar8 = from->depth;
    if (iVar8 != -1) goto LAB_000cdaea;
LAB_000cdaf0:
    uVar5 = to->flags;
    uVar7 = uVar5 & 2;
    if (uVar7 == 0) goto LAB_000cda52;
