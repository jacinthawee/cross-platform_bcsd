...
LAB_00025c2a:
    ...
    if (pcVar8 != (char *)0x0) {
      do {
        ...
        if (iVar3 == 0) {
          if (ppcVar4[1] == (char *)0x0) goto LAB_00025dec;
          iVar2 = str2fmt();
          ppcVar4 = ppcVar4 + 1;
        }
        else {
          ...
          if (iVar3 == 0) {
            pcVar6 = ppcVar4[1];
            if (pcVar6 == (char *)0x0) goto LAB_00025dec;
LAB_00025d42:
            ppcVar4 = ppcVar4 + 1;
          }
          else {
            ...
            if (iVar3 == 0) {
              ...
              if (iVar3 == 0) {
                pcVar8 = ppcVar4[1];
                if ((pcVar8 == (char *)0x0) || (iVar7 != 0)) goto LAB_00025dec;
              ...
              if (iVar3 == 0) {
                filename = ppcVar4[1];
                if (filename != (char *)0x0) goto LAB_00025d42;
                goto LAB_00025dec;
              }
              iVar3 = strcmp(pcVar8,"-algorithm");
              if (iVar3 == 0) {
                ppcVar1 = ppcVar4 + 1;
                if (*ppcVar1 == (char *)0x0) goto LAB_00025dec;
                ppcVar4 = ppcVar4 + 1;
                iVar3 = init_gen_str(bio_err,&local_30,*ppcVar1,e,iVar7);
                if (iVar3 == 0) goto LAB_00025bde;
              }
              else {
                ...
                if (iVar3 == 0) {
                  ...
                  if (iVar3 == 0) {
                    if (local_30 != (EVP_PKEY_CTX *)0x0) goto LAB_00025dec;
                    iVar7 = 1;
                  }
                  else {
                    iVar3 = strcmp(pcVar8,"-text");
                    if (iVar3 != 0) goto LAB_0002605c;
                    local_48 = 1;
                  }
                }
              }
...
LAB_0002605c:
  ...
  if ((iVar7 != 0) || (ppcVar4 = ppcVar4 + 1, local_44 == (EVP_CIPHER *)0x0)) goto LAB_00025dec;
  goto LAB_00025c2a;
}
