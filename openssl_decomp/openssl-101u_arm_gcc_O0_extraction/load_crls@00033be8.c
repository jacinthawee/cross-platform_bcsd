...
_STACK * load_crls(BIO *param_1,char *param_2,int param_3,undefined4 param_4,undefined4 param_5,
                  undefined4 param_6)
...
LAB_00033c7e:
    ...
    while( true ) {
      ...
      if (*(void **)((int)pvVar3 + 4) != (void *)0x0) {
        iVar2 = sk_push(st_00,*(void **)((int)pvVar3 + 4));
        if (iVar2 == 0) goto LAB_00033c7e;
