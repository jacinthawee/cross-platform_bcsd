...
LAB_000d06e8:
        ...
        if (local_20 == 3) {
          if ((int)local_28 < 1) {
LAB_000d06b6:
            if ((int)local_24 < 0) goto LAB_000d0708;
LAB_000d06ba:
          ...
          if (local_24 == 0) goto LAB_000d06ba;
          if (local_24 == local_28) goto LAB_000d06b6;
        }
        else if ((local_24 != 0) && (local_24 != local_28)) goto LAB_000d06b6;
      }
    }
  }
  iVar4 = 0;
