...
joined_r0x00094178:
    if ((int)(uVar2 << 0x1e) < 0) {
      ...
      if (pBVar4 == (BN_MONT_CTX *)0x0) goto LAB_00094142;
      uVar2 = *(uint *)(param_3 + 0x3c);
    }
    if ((uVar2 & 0x100) == 0) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        if ((*(uint *)(param_3 + 0x3c) & 0x100) == 0) {
          ...
          if (iVar3 != 0) {
            if (*(int *)(param_3 + 0x3c) << 0x17 < 0) goto LAB_0009423a;
LAB_00093f6a:
          ...
          if (iVar3 != 0) {
            if (-1 < *(int *)(param_3 + 0x3c) << 0x17) goto LAB_00093f6a;
LAB_0009423a:
