    ...
    if (0x40 < uVar5) {
      if (uVar5 == 0x400) {
        ...
        if (uVar5 == 0x100) {
          ...
          if (uVar5 != 0x80) goto LAB_000638c8;
          iVar1 = 7;
        }
      }
        ...
        if (uVar5 != 0x800) goto LAB_000638c8;
        iVar1 = 0xb;
      }
      goto LAB_000637f2;
    }
...
LAB_00063802:
  ...
  if ((iVar1 - 1U < 0x20) && (uVar5 = (uint)(char)(&UNK_00139dff)[iVar1], uVar5 < 6)) {
...
LAB_00063880:
  ...
  if (iVar1 == 0x40) {
    ...
    if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_000638f8;
    iVar1 = *(int *)(iVar6 + 0x14);
  }
