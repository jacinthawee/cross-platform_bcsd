...
LAB_0003a9b4:
        ...
        pBVar9 = (BIO *)0x0;
        pBVar7 = (BIO *)0x0;
        if (a_00 != (BIO *)0x0) goto LAB_0003a9ca;
        local_40 = (BIO *)0x1;
        pBVar9 = a_00;
        a = a_00;
        goto LAB_0003a658;
      ...
      if (iVar3 == 0) {
        if (param_1 == 1) goto LAB_0003a9b4;
        param_1 = param_1 + -2;
        filename = ppcVar13[1];
        ppcVar13 = ppcVar13 + 2;
      }
        ...
        if (pvVar5 == (void *)0x0) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_0003a9b4;
          pcVar11 = ppcVar13[1];
          local_2c[0] = pvVar5;
...
LAB_0003abec:
                    ...
                    if (0x20 < local_68) {
                      if (local_68 == 0x200) {
                        ...
                        if (local_68 != 0x100) goto LAB_0003ab02;
...
LAB_0003ab02:
              ...
              else if (local_60 == 1) goto LAB_0003aa92;
            ...
            if (param_1 != 0) {
              ...
              if (a_00 == (BIO *)0x0) {
                ...
                if (peer == (EVP_PKEY *)0x0) {
                  ...
                  EVP_PKEY_free(peer);
                  if ((0 < iVar3) || (ERR_print_errors(pBVar7), iVar3 != 0)) goto LAB_0003a6e0;
                }
              }
            }
            goto LAB_0003a9b4;
...
LAB_0003a6e0:
      ...
      if (param_1 < 1) goto LAB_0003a720;
      goto LAB_0003a6ea;
    }
    goto LAB_0003ad42;
  }
...
LAB_0003a87e:
              if ((iVar3 < 1) ||
                 (a = (BIO *)CRYPTO_malloc((int)local_2c[0],"pkeyutl.c",0x136), a == (BIO *)0x0))
              goto LAB_0003ac90;
              if (local_68 == 0x100) {
...
LAB_0003a8c8:
                ...
                if (0x100 < local_68) {
                  if (local_68 == 0x200) {
                    ...
                    if (local_68 != 0x400) goto LAB_0003ac92;
              ...
              if (0x100 < local_68) {
                if (local_68 == 0x200) {
                  ...
                  if (local_68 != 0x400) goto LAB_0003ac90;
...
LAB_0003ac92:
            ...
            if (pBVar4 == (BIO *)0x0) {
              ...
              if ((int)pBVar4 < 0) goto LAB_0003ac90;
              a = (BIO *)0x0;
              local_40 = (BIO *)0x1;
            }
          }
          ...
          if (a == (BIO *)0x0) {
            ...
            BIO_free(a);
            if (0 < (int)siglen) goto LAB_0003a7fc;
            local_40 = (BIO *)0x1;
