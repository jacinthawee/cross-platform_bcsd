...

{
  ...
  local_34 = *(undefined4 *)PTR_DAT_000ee0a0;
  uStack_30 = *(undefined4 *)(PTR_DAT_000ee0a0 + 4);
  puVar4 = &local_34;
  local_7c = param_5;
  local_74 = 1;
...
LAB_000edf92:
  ...
  if (param_1 == 0x40) {
    param_2 = (uchar *)CRYPTO_malloc(iVar3 + 1,"e_4758cca.c",0x2b7);
...
LAB_000edee8:
    ...
    if (param_1 == 4) {
      param_2 = (uchar *)CRYPTO_malloc(iVar3 + 1,"e_4758cca.c",0x2ab);
      if (param_2 != (uchar *)0x0) goto LAB_000edede;
      local_68 = param_2;
      if (CCA4758_lib_error_code == 0) {
        CCA4758_lib_error_code = ERR_get_next_error_library();
      }
