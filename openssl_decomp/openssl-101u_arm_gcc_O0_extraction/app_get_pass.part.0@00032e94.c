...

{
  ...
  if ((param_3 == 0) || (pwdbio_19330 == (BIO *)0x0)) {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        if ((fd < 0) || (pwdbio_19330 = BIO_new_fd(fd,0), pwdbio_19330 == (BIO *)0x0)) {
        ...
        type = BIO_f_buffer();
        pBVar3 = BIO_new(type);
        pwdbio_19330 = BIO_push(pBVar3,pwdbio_19330);
      }
      else {
  ...
  iVar1 = BIO_gets(pwdbio_19330,acStack_41c,0x400);
  if (param_3 != 1) {
    BIO_free_all(pwdbio_19330);
    pwdbio_19330 = (BIO *)0x0;
  }
  if (iVar1 < 1) {
