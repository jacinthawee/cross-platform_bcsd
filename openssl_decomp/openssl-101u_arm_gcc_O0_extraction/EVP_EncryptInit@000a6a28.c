...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher != (EVP_CIPHER *)0x0) {
      if (pEVar5 != (EVP_CIPHER *)0x0) goto LAB_000a6a60;
      goto LAB_000a6a98;
    }
    if (pEVar5 == (EVP_CIPHER *)0x0) goto LAB_000a6c18;
LAB_000a6ad4:
...
LAB_000a6b12:
      if (iVar1 == 0x10) goto LAB_000a6ade;
...
LAB_000a6c18:
      ...
      if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar5->nid)) goto LAB_000a6ad4;
LAB_000a6a60:
      uVar6 = ctx->flags;
...
LAB_000a6ab6:
      ...
      ctx->flags = 0;
      ctx->key_len = iVar1;
      if (-1 < (int)(uVar6 << 0x19)) goto LAB_000a6ad4;
      if (pEVar5->ctrl == (_func_1094 *)0x0) {
        ...
        if (iVar1 == -1) {
          ...
          if (iVar1 != 1 && iVar1 != 8) goto LAB_000a6b12;
          goto LAB_000a6ade;
        }
      }
      iVar1 = 0xbd;
      ...
      iVar1 = 0x9d;
      if (cipher != (EVP_CIPHER *)0x0) goto LAB_000a6ab6;
    }
    ERR_put_error(6,0x7b,0x86,"evp_enc.c",iVar1);
switchD_000a6b4c_caseD_6:
    iVar1 = 0;
  }
  return iVar1;
}
