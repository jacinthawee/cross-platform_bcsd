...
LAB_0003b76a:
      ppXVar14 = local_3c;
      pXVar18 = *local_3c;
      if ((pXVar18 == (X509 *)0x0) || (*(char *)&pXVar18->cert_info != '-')) goto LAB_0003b7ec;
                                            ...
                                            if (iVar4 == 0) {
                                              ...
                                              if (iVar4 == 0) {
                                                ...
                                                if (iVar4 == 0) {
                                                  ...
                                                  if (iVar6 == 0) {
                                                    local_98 = ppXVar14[1];
                                                    if (local_98 == (X509 *)0x0) goto LAB_0003b824;
                                                    bVar2 = true;
                                                    ppXVar14 = ppXVar14 + 1;
                                                    iVar6 = local_68;
                                                  }
...
joined_r0x0003c888:
                                                  if (pXVar18 == (X509 *)0x0) goto LAB_0003b824;
                                                  ppXVar14 = ppXVar14 + 1;
                                                  iVar6 = local_68;
                                                  }
                                                  }
...
LAB_0003b7e4:
      local_68 = iVar6;
      local_3c = ppXVar14 + 1;
      if (pXVar3 != (X509 *)0x0) goto LAB_0003b7ec;
      goto LAB_0003b76a;
    }
LAB_0003b7ec:
...
LAB_0003bd1e:
      if (pXVar3 != (X509 *)0x0) goto LAB_0003b824;
...
LAB_0003c056:
              ...
              if (pXVar13 == (X509 *)0x53) {
                if (((int)(local_8c << 0x13) < 0) ||
                   ...
                   pXVar12 != (X509 *)0x0)) goto LAB_0003c2c4;
                pXVar17 = (X509 *)0x3;
              }
              else {
LAB_0003c128:
                pXVar3 = store;
                if (local_a8 == (X509 *)0x0) goto LAB_0003c2cc;
                if (pXVar17 == (X509 *)0x0) {
                  pXVar12 = pXVar17;
                  if (pXVar13 == (X509 *)&DAT_00000024) {
                    ...
                    if (pXVar13 != (X509 *)0x35) goto LAB_0003c144;
...
LAB_0003c144:
            ...
            if (store == (X509 *)0x0) goto LAB_0003c128;
            if (pXVar13 != (X509 *)0x53) {
              pXVar3 = (X509 *)0x0;
              goto LAB_0003c04e;
            }
...
LAB_0003c538:
          ...
          local_9c = pXVar3;
          if (pXVar3 != (X509 *)0x0) goto joined_r0x0003c1d6;
          pXVar17 = (X509 *)0x2;
...
LAB_0003baea:
    ...
    if (pXVar17 == (X509 *)0x0) goto LAB_0003bb20;
  }
  ERR_print_errors(bio_err);
LAB_0003bb20:
