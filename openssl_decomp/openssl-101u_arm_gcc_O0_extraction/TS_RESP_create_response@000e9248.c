...
LAB_000e93c2:
    ...
    if (pAVar6 == (ASN1_BIT_STRING *)0x0) {
      ...
      *(ASN1_BIT_STRING **)(iVar4 + 8) = pAVar6;
      if (pAVar6 == (ASN1_BIT_STRING *)0x0) goto LAB_000e9366;
    }
    iVar4 = ASN1_BIT_STRING_set_bit(pAVar6,5,1);
    goto joined_r0x000e93e0;
  }
      ...
      if ((iVar9 == iVar10) && (pEVar11 != (EVP_MD *)0x0)) {
        ...
        if ((pAVar13 == (ASN1_OBJECT *)0x0) ||
           ((iVar4 = OBJ_cmp(pAVar13,(ASN1_OBJECT *)pXVar2), iVar4 == 0 &&
            (pXVar2 = param_1[4], pXVar2 != (X509 *)0x0)))) goto LAB_000e9530;
        iVar4 = 1;
        goto LAB_000e94de;
      }
      iVar4 = iVar4 + 1;
...
LAB_000e935a:
  ...
  pAVar6 = ASN1_BIT_STRING_new();
  *(ASN1_BIT_STRING **)(iVar4 + 8) = pAVar6;
  if (pAVar6 != (ASN1_BIT_STRING *)0x0) goto LAB_000e935a;
  goto LAB_000e9366;
LAB_000e94de:
  iVar9 = sk_num((_STACK *)param_1[3]);
  if (iVar9 <= iVar4 + -1) goto code_r0x000e94ea;
  pXVar2 = (X509 *)sk_value((_STACK *)param_1[3],iVar4 + -1);
  iVar9 = OBJ_cmp(pAVar13,(ASN1_OBJECT *)pXVar2);
  if ((iVar9 == 0) && (pXVar2 != (X509 *)0x0)) goto LAB_000e9530;
  iVar4 = iVar4 + 1;
  goto LAB_000e94de;
LAB_000e9530:
    ...
    if ((((iVar4 == 0) || (iVar4 = TS_TST_INFO_set_policy_id(pXVar14,pXVar2), iVar4 == 0)) ||
      ...
      if ((s != (X509 *)0x0) &&
        ...
        if ((pXVar2 < (X509 *)0x7) && (ptVar16 = gmtime((time_t *)&local_48), ptVar16 != (tm *)0x0))
        {
          ...
          if (pXVar2 != (X509 *)0x0) {
            BIO_snprintf(pcVar26,(size_t)((int)&pXVar2->cert_info + 2),".%06ld",local_4c,iVar9,
                         iVar10,iVar28,iVar29,iVar30);
...
LAB_000e97ac:
                  ...
                  if (iVar4 < iVar9) goto LAB_000e9792;
                  ...
                  p7 = (BIO *)PKCS7_new();
                  if (p7 == (BIO *)0x0) {
                    ERR_put_error(0x2f,0x88,0x41,"ts_rsp_sign.c",0x2d9);
                    p7si = p7;
                    bio = p7;
                    goto LAB_000e97de;
                  }
                  ...
                  if ((p7si == (BIO *)0x0) ||
                     ...
                     bio = p7si, p7si == (BIO *)0x0)) goto LAB_000e97de;
                  ...
                  if (p7si == (BIO *)0x0) {
                    ERR_put_error(0x2f,0x88,0x76,"ts_rsp_sign.c",0x2f1);
                    bio = p7si;
                  }
                  else {
                    ...
                    if (bio == (BIO *)0x0) {
                      ERR_put_error(0x2f,0x88,0x77,"ts_rsp_sign.c",0x2f9);
                      p7si = bio;
                    }
                    else {
                      pXVar15 = *param_1;
                      ...
                      if (pBVar20 != (BIO *)0x0) {
                        if (pBVar20->method == (BIO_METHOD *)0x0) {
                          ...
                          if (pBVar24 == (BIO_METHOD *)0x0) goto LAB_000e99a4;
                        }
                          ...
                          if (iVar4 != 0) {
                            ...
                            do {
                              ...
                              if (iVar9 <= iVar4) {
                                ...
                                pAVar21 = (ASN1_STRING *)CRYPTO_malloc(iVar4,"ts_rsp_sign.c",0x3a0);
...
LAB_000e99f2:
                              ...
                              if (data[1] == (ASN1_STRING *)0x0) {
                                ...
                                data[1] = pAVar21;
                                if (pAVar21 == (ASN1_STRING *)0x0) goto LAB_000e99f2;
                              }
                              a_00 = GENERAL_NAME_new();
                              if (a_00 == (GENERAL_NAME *)0x0) goto LAB_000e99f2;
...
LAB_000e99a4:
                      ESS_SIGNING_CERT_free(pBVar20);
                      ERR_put_error(0x2f,0x72,0x41,"ts_rsp_sign.c",0x34e);
                      p7si = (BIO *)0x0;
                      bio = (BIO *)0x0;
                    }
                  }
LAB_000e97de:
                ...
                if (a != (X509 *)0x0) {
                  ...
                  if ((pXVar22 != (X509_NAME *)0x0) &&
                     (iVar4 = TS_TST_INFO_set_tsa(pXVar14,a), iVar4 != 0)) goto LAB_000e976a;
                }
              }
              goto LAB_000e9548;
            }
