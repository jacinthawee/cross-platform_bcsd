...

{
  ...
  if (0 < iVar2) {
    ...
    iVar3 = CRYPTO_gcm128_aad(iVar2,a,*(undefined4 *)((int)pvVar1 + 0x284));
    if (iVar3 == 0) {
      ...
      if (param_1->encrypt == 0) {
        ...
        if (iVar4 == 0) {
          CRYPTO_gcm128_tag(iVar2,a,0x10);
          iVar2 = CRYPTO_memcmp(a,(void *)(iVar3 + len),0x10);
          if (iVar2 == 0) goto LAB_0812bee7;
