...

{
  ...
  if (local_44 < 1) {
    ...
    if (pBVar5 == (BIO *)0x0) goto LAB_08080806;
    local_30 = (byte *)0x0;
    local_24 = (byte *)0x0;
    local_2c = 0;
    local_20 = 0;
...
LAB_080802ca:
    do {
      ...
      if (bVar11) {
        local_44 = local_44 + -1;
        if (local_44 == 0) goto LAB_080804c8;
        ppbVar1 = ppbVar3 + 1;
        ppbVar3 = ppbVar3 + 1;
...
LAB_080804c8:
      ...
      if (local_44 == 1) goto LAB_080804c8;
...
LAB_08080806:
    ...
    if (local_34 == (byte *)0x0) goto LAB_08080780;
...
LAB_080805c5:
  if ((local_2c == 0) && (pBVar5 = (BIO *)0x0, local_20 != 0)) goto LAB_080805e6;
  pBVar4 = BIO_s_file();
  pBVar5 = BIO_new(pBVar4);
  if (pBVar5 == (BIO *)0x0) {
    ERR_print_errors(bio_err);
...
LAB_080805e6:
      if ((local_28 | local_20) == 0) goto LAB_08080667;
...
LAB_08080845:
      ...
      if ((local_28 | local_20) != 0) goto LAB_0808063b;
LAB_08080667:
      if (local_3c == 1) {
...
LAB_08080633:
    if (pBVar5 == (BIO *)0x0) goto LAB_080803ec;
  }
  else {
    lVar6 = BIO_ctrl(pBVar5,0x6c,5,local_30);
    if (0 < lVar6) goto LAB_080806e9;
    x = (X509 *)0x1;
