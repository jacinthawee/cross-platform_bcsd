...
LAB_08192367:
          if (pXVar2 == (X509_ALGOR *)0x0) goto LAB_081922c6;
        }
        else {
...
LAB_081920f0:
              ...
              if (val == (int *)0x0) goto LAB_08192340;
...
LAB_08192378:
                ...
                *val = 3;
                ...
                puVar6[2] = pXVar7;
                if (pXVar7 == (X509_ALGOR *)0x0) goto LAB_08192378;
                ...
                *(ASN1_TYPE **)(iVar3 + 4) = pAVar4;
                if ((*(int *)(puVar6[2] + 4) == 0) ||
                   ...
                   pAVar8 == (ASN1_STRING *)0x0)) goto LAB_08192378;
...
LAB_0819232e:
      ...
      if ((kekciph == (EVP_CIPHER *)0x0) &&
         (kekciph = *(EVP_CIPHER **)(*(int *)(iVar1 + 0xc) + 0xc), kekciph == (EVP_CIPHER *)0x0))
      goto LAB_0819232e;
      if (wrap_nid == 0x37d) goto LAB_08192047;
      iVar3 = 0x76;
      iVar1 = 0xb3;
    }
