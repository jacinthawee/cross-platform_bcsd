          ...
          if ((0 < iVar4) && (iVar4 = i2a_ASN1_OBJECT(bp,pXVar2->algorithm), 0 < iVar4)) {
            ...
            if ((iVar4 == 0) ||
               (((iVar4 = OBJ_find_sigid_algs(iVar4,&local_24,&local_28), iVar4 == 0 ||
                 ...
                 pEVar9 == (EVP_PKEY_ASN1_METHOD *)0x0)) ||
                (*(code **)(pEVar9 + 0x50) == (code *)0x0)))) {
              iVar4 = BIO_puts(bp,"\n");
            }
            else {
              iVar4 = (**(code **)(pEVar9 + 0x50))(bp,pXVar2,0,9,0);
            }
            if ((0 < iVar4) && (iVar4 = BIO_printf(bp,"        Issuer:%c",0x20), 0 < iVar4)) {
              pXVar10 = X509_get_issuer_name(x);
              iVar4 = X509_NAME_print_ex(bp,pXVar10,0x10,0);
              if (((-1 < iVar4) &&
...
LAB_0814361d:
                if ((iVar4 != 0) &&
                  ...
                  if (pAVar3->type == 0x17) {
                    ...
                    if (pAVar3->type != 0x18) goto LAB_081435e0;
                    iVar4 = ASN1_GENERALIZEDTIME_print(bp,pAVar3);
                  }
                  if (((iVar4 != 0) && (iVar4 = BIO_write(bp,&DAT_081f15cb,1), 0 < iVar4)) &&
                     (iVar4 = BIO_printf(bp,"        Subject:%c",0x20), 0 < iVar4)) {
                    pXVar10 = X509_get_subject_name(x);
                    iVar4 = X509_NAME_print_ex(bp,pXVar10,0x10,0);
                    if ((((-1 < iVar4) && (iVar4 = BIO_write(bp,&DAT_081f15cb,1), 0 < iVar4)) &&
                        ((iVar4 = BIO_write(bp,"        Subject Public Key Info:\n",0x21), 0 < iVar4
                         && ((iVar4 = BIO_printf(bp,"%12sPublic Key Algorithm: ",&DAT_081eca46),
                             0 < iVar4 &&
        ...
        iVar4 = BIO_printf(bp,"\n%12s%s",&DAT_081eca46,pcVar6);
        if (0 < iVar4) {
          iVar4 = 0;
          do {
            if (a->length <= iVar4) goto LAB_081434db;
            uVar7 = 10;
            if (iVar4 + 1 != a->length) {
              uVar7 = 0x3a;
            }
