...

{
  ...
  if ((uVar1 & 1) == 0) {
    ...
    goto switchD_08144dec_caseD_1;
  }
  if ((uVar1 & 0x306) != 0) goto switchD_08144dec_caseD_1;
  ...
  default:
    goto switchD_08144dec_caseD_1;
  case '\x04':
    if (pAVar2->funcs == (void *)0x0) goto switchD_08144dec_caseD_1;
    pcVar3 = *(code **)((int)pAVar2->funcs + 0xc);
    goto joined_r0x08144e04;
  case '\x05':
    pvVar6 = pAVar2->funcs;
    if (pvVar6 == (void *)0x0) goto switchD_08144dec_caseD_1;
  }
