...

{
  ...
  if (st == (_STACK *)0x0) {
    ...
    for (local_48 = 0; iVar3 = sk_num(*param_1), local_48 < iVar3; local_48 = local_48 + 1) {
      ...
      if (val == (ASN1_OBJECT **)0x0) goto LAB_0813ed97;
...
LAB_0813ec30:
            ...
            if (-1 < (char)bVar1) {
              ...
              do {
                ...
                pbVar11 = pbVar11 + 1;
                pcVar7 = pcVar7 + -1;
                if (pcVar7 == (char *)0x0) goto LAB_0813ec30;
                bVar1 = *pbVar11;
              } while (-1 < (char)bVar1);
            }
            ...
            if (-1 < (char)bVar1) {
              ...
              do {
                if ((*(byte *)((int)*ppuVar8 + (uint)bVar1 * 2 + 1) & 0x20) == 0) break;
                pcVar14 = pcVar14 + -1;
                if (pcVar14 == (char *)0x0) goto LAB_0813ec30;
...
LAB_0813ec38:
    ...
    param_1[4] = num;
    local_28 = (_STACK *)CRYPTO_malloc((int)num,"x_name.c",0x188);
