...

{
  ...
  if ((a == (ASN1_INTEGER **)0x0) || (a_00 = *a, a_00 == (ASN1_INTEGER *)0x0)) {
    ...
    a_00->type = 2;
    __src = *pp;
    __dest = (uchar *)CRYPTO_malloc(length + 1,"a_int.c",0xd0);
    if (__dest == (uchar *)0x0) {
      ERR_put_error(0xd,0xc2,0x41,"a_int.c",0x10d);
      if (a == (ASN1_INTEGER **)0x0) goto LAB_08138296;
      goto LAB_0813828e;
    }
  }
  else {
...
LAB_08138296:
  ...
  if (uVar1 == 0xff) {
    if (length == 1) {
      ...
      length = sVar2;
      puVar3 = puVar4;
      if (uVar1 == '\0') goto joined_r0x081382c7;
LAB_0813822c:
      puVar3 = puVar4;
      length = sVar2;
      if (sVar2 == 0) goto LAB_081382d0;
    }
  }
  else {
