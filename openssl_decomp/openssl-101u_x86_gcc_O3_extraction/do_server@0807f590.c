...

{
  ...
  if (__fd != -1) {
    ...
    if (iVar1 == -1) {
      ...
      do {
        while (param_2 != 1) {
          iVar1 = (*param_4)(pcVar5,__fd,param_5);
          if (pcVar5 != (char *)0x0) {
            CRYPTO_free(pcVar5);
          }
          if (iVar1 < 0) goto LAB_0807f810;
        }
        while( true ) {
          local_34 = 0x10;
          from_18106._0_4_ = 0;
          ...
          from_18106._8_4_ = 0;
          from_18106._12_4_ = 0;
          __fd_00 = accept(__fd,(sockaddr *)from_18106,&local_34);
          if (__fd_00 != -1) break;
        ...
        phVar3 = gethostbyaddr(from_18106 + 4,4,2);
        if (phVar3 != (hostent *)0x0) {
          sVar4 = strlen(phVar3->h_name);
          pcVar5 = (char *)CRYPTO_malloc(sVar4 + 1,"s_socket.c",0x1c5);
          if (pcVar5 == (char *)0x0) {
            ...
            __s = phVar3->h_name;
            sVar4 = strlen(__s);
            BUF_strlcpy(pcVar5,__s,sVar4 + 1);
            iVar1 = GetHostByName();
            if (iVar1 == 0) {
              pcVar5 = "gethostbyname failure\n";
            }
            else {
              if (*(int *)(iVar1 + 8) == 2) {
                iVar1 = (*param_4)(pcVar5,__fd_00,param_5);
                CRYPTO_free(pcVar5);
                goto LAB_0807f7e7;
              }
              pcVar5 = "gethostbyname addr is not AF_INET\n";
            }
