...
LAB_08089560:
    ppbVar21 = local_48;
    pbVar1 = *local_48;
    if (pbVar1 == (byte *)0x0) goto LAB_0808996a;
    bVar26 = *pbVar1 < 0x2d;
    bVar27 = *pbVar1 == 0x2d;
    if (!bVar27) goto LAB_0808996a;
    iVar7 = 9;
    pbVar23 = pbVar1;
            ...
            if (bVar27) {
              ...
              if (bVar27) {
                ...
                if (bVar27) {
                  ...
                  if (bVar27) {
                    local_a0 = local_48[1];
                    if (local_a0 == (byte *)0x0) goto LAB_08089a34;
                    local_104 = 0x30;
                    local_48 = local_48 + 1;
                  }
                  else {
                                                  ...
                                                  if (uVar8 == 0) {
                                                    ...
                                                    if (uVar8 == 0) {
                                                      ...
                                                      if (uVar8 == 0) {
                                                        local_58 = ppbVar21[1];
                                                        pbVar1 = local_58;
                                                        goto joined_r0x0808c101;
                                                      }
                                                      if (((uVar22 == 0x69) && (pbVar1[2] == 0x6e))
                                                         && (pbVar1[3] == 0)) {
                                                        local_9c = ppbVar21[1];
                                                        pbVar1 = local_9c;
                                                        goto joined_r0x0808c246;
                                                      }
                                                      pcVar30 = "-inform";
                                                      uVar32 = uVar8;
...
joined_r0x0808c1ea:
                                                  if (pbVar1 != (byte *)0x0) goto LAB_0808c107;
                                                  goto LAB_08089a34;
                                                  }
                                                  local_d0 = (X509 *)ppbVar21[1];
                                                  if (local_d0 == (X509 *)0x0) goto LAB_08089a34;
                                                  bVar2 = true;
                                                  local_48 = ppbVar21 + 1;
                                                  }
                                                  }
...
LAB_0808a3fe:
    ...
    if (local_104 != 0x22) {
      if (local_104 == 0x11) {
        ...
        if (local_104 != 0) goto LAB_0808a169;
        local_f8 = (_STACK *)0x0;
      }
LAB_0808a139:
      local_40 = 1;
...
LAB_08089a2c:
    ...
    if ((local_104 & 0x10) == 0) {
      if ((uVar22 & 0x80) == 0) {
        if ((local_104 & 0x20) == 0) {
          local_dc = (X509_STORE *)&DAT_081f0118;
          mode = "r";
          goto LAB_0808a498;
        }
        local_dc = (X509_STORE *)&DAT_081f0118;
      ...
      if ((local_104 & 0x20) != 0) {
        local_dc = (X509_STORE *)&DAT_081eaada;
        goto LAB_0808a25d;
      }
      local_dc = (X509_STORE *)&DAT_081eaada;
      mode = "rb";
LAB_0808a498:
      if (local_104 != 0x11) goto LAB_0808a271;
      if (local_ac == (EVP_CIPHER *)0x0) {
        local_ac = EVP_des_ede3_cbc();
      }
      ...
      if (*local_48 == (byte *)0x0) goto LAB_0808a271;
      ...
      if (local_e0 != (CMS_ContentInfo *)0x0) goto LAB_0808a285;
      local_c8 = (_STACK *)0x0;
LAB_0808a2eb:
...
LAB_0808a285:
        ...
        if (local_c8 != (_STACK *)0x0) goto LAB_0808a2b6;
...
LAB_0808a2b6:
      ...
      if ((local_e8 == (BIO *)0x0) || (!bVar26)) {
        if (local_104 == 0x3f) {
          ...
          ;
          if (local_d0 != (X509 *)0x0) goto LAB_0808a79d;
          ERR_print_errors(bio_err);
          goto LAB_0808a521;
        }
        if (local_104 != 0x22) goto LAB_0808a2eb;
        local_c4 = (X509 *)0x0;
      }
      else {
...
LAB_0808a322:
    if (local_9c != (byte *)0x0) {
      ...
      if (local_e8 != (BIO *)0x0) goto LAB_0808a347;
...
LAB_0808a619:
    if (local_a0 == (byte *)0x0) {
      ...
      if (local_88 == 1) {
        ...
        if (local_d4 == (BIO *)0x0) goto LAB_0808aa81;
               ...
               (iVar7 = CMS_decrypt_set1_password((CMS_ContentInfo *)cms,local_98,-1), iVar7 != 0))
            {
              pEVar17 = (EVP_PKEY *)
                        CMS_decrypt((CMS_ContentInfo *)cms,(EVP_PKEY *)0x0,(X509 *)0x0,local_44,
                                    local_ec,local_b4);
              if (pEVar17 != (EVP_PKEY *)0x0) goto LAB_0808aebe;
...
LAB_0808b420:
        ...
        if (pass == (EVP_PKEY *)0x0) {
          ...
          if (local_104 == 0x53) {
            ...
            if (cms == (EVP_PKEY *)0x0) goto LAB_0808b420;
            if (local_c0 != (X509_VERIFY_PARAM *)0x0) {
    ...
    if (local_e4 != (uchar *)0x0) {
      pCVar14 = CMS_add0_recipient_key
                          ((CMS_ContentInfo *)cms,0,local_e4,(size_t)local_90,local_cc,
                           ...
                           (ASN1_TYPE *)0x0);
      if (pCVar14 == (CMS_RecipientInfo *)0x0) goto LAB_0808b420;
      local_cc = (uchar *)0x0;
