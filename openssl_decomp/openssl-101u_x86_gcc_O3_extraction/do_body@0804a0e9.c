...
LAB_0804a3cb:
          ...
          if (iVar19 == 0x14) {
            if (unaff_ESI->modified == 0x14) goto LAB_0804a3cb;
          }
          else if ((iVar19 != 0x16) || (unaff_ESI->modified != 0x13)) goto LAB_0804a3cb;
...
LAB_0804a49b:
          do {
            ...
            pXVar8 = unaff_ESI;
            if (iVar4 == 0) {
              if (pXVar5 != (X509 *)0x0) goto LAB_0804a677;
            }
            else {
...
LAB_0804a5c2:
                ...
                unaff_EDI = pXVar17;
                if (pXVar17 == (X509 *)0x0) goto LAB_0804a49b;
              }
LAB_0804a677:
              puVar25 = (undefined *)0x0;
...
LAB_0804a761:
          ...
          if ((X509_NAME *)pcVar21 == (X509_NAME *)0x0) goto LAB_0804a7a4;
          if ((*param_4 == 0) ||
                ...
                if (pAVar11 != (ASN1_INTEGER *)0x0) {
                  ...
                  if (iVar19 != 0) {
                    ...
                    if (iVar19 != 0) {
                      ...
                      if (iVar19 != 0) {
                        if (param_16 == (char *)0x0) goto LAB_0804ad2b;
                        if (pXVar2->version == (ASN1_INTEGER *)0x0) {
                          pAVar11 = ASN1_INTEGER_new();
                          pXVar2->version = pAVar11;
                          if (pAVar11 != (ASN1_INTEGER *)0x0) goto LAB_0804abc1;
LAB_0804b01b:
                          iVar4 = -1;
                        }
                        else {
                          ...
                          if (iVar4 == 0) {
                            ...
                            if (param_13 == 0) {
                              ...
                              if (pcVar21 == (char *)0x0) {
                                ...
                                if ((char)(local_39[0] & 0xffffffdf) == 'Y') goto LAB_0804aed6;
                                iVar4 = 0;
...
LAB_0804aed6:
                              ...
                              if (iVar19 != 0) {
                                local_54[0] = (OPENSSL_STRING)CRYPTO_malloc(2,"ca.c",0x82f);
                                pAVar3 = pXVar5->cert_info->validity->notAfter;
                                local_54[1] = (OPENSSL_STRING)
                                              CRYPTO_malloc(pAVar3->length + 1,"ca.c",0x832);
                                puVar10 = pAVar3->data;
                                ...
                                local_54[2] = (char *)0x0;
                                local_44 = (char *)CRYPTO_malloc(8,"ca.c",0x839);
                                ...
                                *local_54[0] = 'V';
                                local_54[0][1] = '\0';
                                ppcVar9 = (OPENSSL_STRING *)CRYPTO_malloc(0x1c,"ca.c",0x846);
                                iVar19 = 0;
                                if (ppcVar9 == (OPENSSL_STRING *)0x0) {
                                  BIO_printf(bio_err,"Memory allocation failure\n",puVar16,puVar16);
                                }
