...

{
  ...
  case 8:
    ...
    if (*(int *)(iVar2 + 0x270) != 0) {
      if (*(int *)(iVar2 + 0x270) != iVar2) {
        return 0;
      }
      *(int *)(iVar5 + 0x270) = iVar5;
    }
    if (*(int **)(iVar2 + 0x274) == param_1 + 8) {
      *(int **)(iVar5 + 0x274) = param_4 + 8;
      uVar7 = 1;
    }
    else {
      pvVar6 = CRYPTO_malloc(*(int *)(iVar2 + 0x278),"e_aes.c",0x312);
      *(void **)(iVar5 + 0x274) = pvVar6;
      if (pvVar6 == (void *)0x0) {
        return 0;
      }
      memcpy(pvVar6,*(void **)(iVar2 + 0x274),*(size_t *)(iVar2 + 0x278));
      uVar7 = 1;
    }
    break;
  case 9:
    ...
    if ((0x10 < (int)param_3) && (*(int *)(iVar2 + 0x278) < (int)param_3)) {
      ...
      pvVar6 = CRYPTO_malloc(param_3,"e_aes.c",0x2b4);
  ...
  case 0x12:
    if (param_3 == 0xffffffff) {
      ...
      *(undefined4 *)(iVar2 + 0x280) = 1;
      ...
      if ((param_1[2] != 0) &&
         (iVar5 = RAND_bytes((uchar *)(*(int *)(iVar2 + 0x274) + param_3),
          ...
          if (*pcVar1 == '\0') {
            ...
            *pcVar1 = *pcVar1 + '\x01';
            if (*pcVar1 == '\0') {
              ...
              *pcVar1 = *pcVar1 + '\x01';
              if ((*pcVar1 == '\0') &&
                 (pcVar1 = (char *)(iVar3 + -7 + iVar5), cVar8 = *pcVar1 + '\x01', *pcVar1 = cVar8,
                 cVar8 == '\0')) {
