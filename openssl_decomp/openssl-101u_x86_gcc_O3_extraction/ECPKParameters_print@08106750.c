...
LAB_08106831:
    iVar1 = 0;
    ERR_put_error(0x10,0x95,local_b0,"eck_prn.c",0x139);
    if (p != (BIGNUM *)0x0) goto LAB_08106854;
  }
  else {
    ctx = BN_CTX_new();
    if (ctx == (BN_CTX *)0x0) {
...
LAB_081069ce:
    ...
    local_d0 = (uchar *)CRYPTO_malloc(uVar8 + 10,"eck_prn.c",0xf9);
    ...
    local_b0 = 0x20;
    if (iVar2 == 0) goto LAB_08106831;
    local_b0 = 0x20;
    pcVar4 = OBJ_nid2sn(iVar1);
    iVar2 = BIO_printf(bp,"Field Type: %s\n",pcVar4,puVar10);
    if (iVar2 < 1) goto LAB_08106831;
    local_c0 = 0x20;
    if (iVar1 == 0x197) {
...
LAB_08106fd1:
    ...
    if (puVar7 != (uchar *)0x0) {
      if (off < 1) {
        ...
        if (iVar2 < 1) goto LAB_08106fd1;
      }
      iVar2 = BIO_printf(bp,"%s","Seed:",uVar9);
      if (0 < iVar2) {
        uVar8 = 0;
        do {
          if (local_bc == uVar8) {
            iVar1 = BIO_write(bp,&DAT_081f15cb,1);
            if (0 < iVar1) goto LAB_08106f6b;
            break;
          }
          if (uVar8 % 0xf == 0) {
            local_a0 = 10;
            __memset_chk(local_9f,0x20,iVar1 + 4,0x7f);
            iVar2 = BIO_write(bp,&local_a0,iVar1 + 5);
            if (iVar2 < 1) break;
          }
          pcVar4 = "";
          if (local_bc != uVar8 + 1) {
          ...
          iVar2 = BIO_printf(bp,"%02x%s",(uint)puVar7[uVar8],pcVar4);
          uVar8 = uVar8 + 1;
        } while (0 < iVar2);
      }
      goto LAB_08106fd1;
