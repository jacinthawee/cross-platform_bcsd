...

{
  ...
  if (pXVar1 == (X509_VERIFY_PARAM *)0x0) {
    ERR_put_error(0xb,0x8f,0x41,"x509_vfy.c",0x86a);
    return 0;
  }
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        if (store->check_crl == (_func_1849 *)0x0) {
          ...
          ctx->check_crl = check_crl;
          if (p_Var4 == (_func_1862 *)0x0) goto LAB_0815f980;
LAB_0815f94b:
          ctx->cert_crl = p_Var4;
        }
        else {
          ...
          p_Var4 = (_func_1862 *)store->cert_crl;
          if (p_Var4 != (_func_1862 *)0x0) goto LAB_0815f94b;
LAB_0815f980:
          ctx->cert_crl = cert_crl;
        }
        ...
        if (pcVar3 == (_func_1865 *)0x0) goto LAB_0815f84d;
        goto LAB_0815f852;
      }
    }
LAB_0815f72d:
