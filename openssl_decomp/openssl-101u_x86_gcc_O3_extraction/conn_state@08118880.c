...
/* WARNING: Removing unreachable block (ram,0x08118bb7) */
...
LAB_081189e2:
      ...
      if (pcVar6 != (char *)0x0) {
        *param_2 = 2;
        if (pcVar2 == (code *)0x0) goto switchD_081188b4_caseD_2;
        uVar3 = 2;
        goto LAB_0811897d;
      }
    ...
    break;
  case 2:
switchD_081188b4_caseD_2:
    iVar4 = BIO_get_host_ip((char *)param_2[1],(uchar *)(param_2 + 4));
    if (0 < iVar4) {
      *param_2 = 3;
      if (pcVar2 == (code *)0x0) goto switchD_081188b4_caseD_3;
      uVar3 = 3;
      goto LAB_0811897d;
    }
    break;
  case 3:
switchD_081188b4_caseD_3:
    if (((char *)param_2[2] != (char *)0x0) &&
       (iVar4 = BIO_get_port((char *)param_2[2],(ushort *)(param_2 + 5)), 0 < iVar4)) {
      *param_2 = 4;
      if (pcVar2 == (code *)0x0) goto switchD_081188b4_caseD_4;
      uVar3 = 4;
      goto LAB_0811897d;
    }
    break;
  case 4:
switchD_081188b4_caseD_4:
    ...
    *param_2 = 4;
    ...
    if (i != -1) {
      param_1->num = i;
      *param_2 = 8;
      if (pcVar2 == (code *)0x0) goto switchD_081188b4_caseD_8;
      uVar3 = 8;
      goto LAB_0811897d;
    }
    piVar7 = __errno_location();
    ERR_put_error(2,4,*piVar7,"bss_conn.c",200);
...
LAB_0811896a:
    ...
    if (iVar4 == 0) {
      piVar7 = __errno_location();
      ERR_put_error(2,2,*piVar7,"bss_conn.c",0xf6);
      ERR_add_error_data(4,"host=",param_2[1],":",param_2[2]);
  ...
  case 7:
    ...
    if (local_24 == 0) goto LAB_0811896a;
    i = 0;
    BIO_clear_flags(param_1,0xf);
    ERR_put_error(2,2,local_24,"bss_conn.c",0x104);
    ERR_add_error_data(4,"host=",param_2[1],":",param_2[2]);
    ERR_put_error(0x20,0x73,0x6e,"bss_conn.c",0x107);
    break;
  case 8:
switchD_081188b4_caseD_8:
    ...
    *param_2 = 5;
    ...
    if (local_24 < 0) {
      piVar7 = __errno_location();
      ERR_put_error(2,4,*piVar7,"bss_conn.c",0xe2);
      ERR_add_error_data(4,"host=",param_2[1],":",param_2[2]);
      ERR_put_error(0x20,0x73,0x6d,"bss_conn.c",0xe5);
      break;
    }
    uVar3 = *param_2;
    if (pcVar2 != (code *)0x0) goto LAB_0811897d;
    goto LAB_081188af;
  }
  if (pcVar2 != (code *)0x0) {
