...
LAB_0807d344:
    purpose = 0;
    param = *param_5;
    if (iVar4 != 0) goto LAB_0807d352;
LAB_0807d422:
    if (param == (X509_VERIFY_PARAM *)0x0) {
      param = X509_VERIFY_PARAM_new();
      *param_5 = param;
      if (param != (X509_VERIFY_PARAM *)0x0) goto LAB_0807d42a;
      *param_3 = 1;
      goto LAB_0807d36c;
    }
LAB_0807d42a:
    ...
    if (local_34 == 0) goto LAB_0807d36c;
        ...
        if (bVar9) {
          if (pcVar7 == (char *)0x0) {
            ...
            *param_3 = 1;
            ...
            iVar4 = __isoc99_sscanf(pcVar7,&DAT_081f7cd5,&local_24);
            if (iVar4 == 1) {
              iVar4 = *param_3;
            }
            else {
                              ...
                              if (iVar4 == 0) {
                                ...
                                if (iVar4 == 0) {
                                  ...
                                  if (iVar4 == 0) {
                                    ...
                                    iVar4 = strcmp(__s1,"-no_alt_chains");
                                    if (iVar4 == 0) {
                                      local_34 = 0;
                                      depth = -1;
                                      flags = 0x100000;
                                      ...
                                      iVar4 = strcmp(__s1,"-allow_proxy_certs");
                                      uVar2 = 0;
                                      if (iVar4 != 0) goto LAB_0807d38d;
                                      local_34 = 0;
                                      depth = -1;
                                      flags = 0x40;
                                      policy = (ASN1_OBJECT *)0x0;
