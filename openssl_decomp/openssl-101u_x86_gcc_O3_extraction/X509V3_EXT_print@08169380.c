...

{
  ...
  if (method == (X509V3_EXT_METHOD *)0x0) {
    ...
    if (bVar5) {
      BIO_printf(out,"%*s<Not Supported>",indent,&DAT_081eca46);
      uVar4 = 1;
      goto LAB_08169447;
    }
LAB_0816952a:
    ...
    if (val != (ASN1_VALUE *)0x0) {
      if (method->i2s == (X509V3_EXT_I2S)0x0) {
        if (method->i2v == (X509V3_EXT_I2V)0x0) {
          if (method->i2r == (X509V3_EXT_I2R)0x0) goto LAB_08169460;
...
LAB_08169460:
        ...
        BIO_printf(out,"%*s%s",indent,&DAT_081eca46,ptr);
    ...
    bVar5 = (flag & 0xf0000) == 0x10000;
    if (!bVar5) goto LAB_0816952a;
    BIO_printf(out,"%*s<Parse Error>",indent,&DAT_081eca46);
  }
  uVar4 = 1;
LAB_08169447:
