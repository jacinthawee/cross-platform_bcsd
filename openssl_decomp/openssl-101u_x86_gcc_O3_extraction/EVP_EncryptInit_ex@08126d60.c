...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_08126e93;
LAB_08126ff0:
      line = 0xc2;
      iVar2 = 0x83;
    }
...
LAB_08126e2f:
      if (impl == (ENGINE *)0x0) {
        ...
        if (impl != (ENGINE *)0x0) goto LAB_08126e4b;
...
LAB_08126e66:
        ...
        ctx->flags = 0;
        ctx->key_len = iVar2;
        if ((bVar9 & 0x40) == 0) goto LAB_08126e93;
...
switchD_08126f32_caseD_6:
    iVar2 = 0;
  }
  else {
    if (pEVar3 == (EVP_CIPHER *)0x0) {
      if (cipher == (EVP_CIPHER *)0x0) goto LAB_08126ff0;
      goto LAB_08126e2f;
    }
    if ((cipher != (EVP_CIPHER *)0x0) && (cipher->nid != pEVar3->nid)) goto LAB_08126da1;
LAB_08126e93:
