...
LAB_08056bc1:
      ...
      if ((!bVar9 && !bVar10) == bVar9) {
        ...
        if (bVar9) {
          if (pbVar1[1] == 0x32) {
            bVar9 = pbVar1[2] == 0;
            if (!bVar9) goto LAB_08056be8;
            local_48 = 2;
          }
          else {
            bVar9 = pbVar1[1] == 0x35;
            if ((!bVar9) || (bVar9 = pbVar1[2] == 0, !bVar9)) goto LAB_08056be8;
            local_48 = 5;
          }
LAB_08056bb4:
          bVar9 = local_4c == 0;
...
LAB_08056be8:
        ...
        if (bVar9) {
          ...
          if ((iVar2 != 0) && (-1 < local_30)) goto LAB_08056d81;
        }
      }
LAB_08056c2c:
...
LAB_08056df6:
      ...
      else if (local_44 != (byte *)0x0) goto LAB_08056df6;
