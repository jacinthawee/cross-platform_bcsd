...
LAB_00015036:
      ...
      if (iVar8 == 0) {
        if (param_1 == 1) goto LAB_00015036;
        param_1 = param_1 + -2;
      ...
      if (iVar8 == 0) {
        param_1 = param_1 + -1;
        if (param_1 == 0) goto LAB_00015036;
        ...
        if (iVar8 == 0) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_00015036;
          bp = (X509 *)ENGINE_by_id(ppcVar31[1]);
          ppcVar32 = ppcVar31 + 1;
          local_57c = bp;
          if (bp == (X509 *)0x0) {
...
joined_r0x00016e1e:
                                    ...
                                    ppcVar32 = ppcVar31 + 1;
                                    iVar20 = local_504;
                                    if (pAVar17 != (ASN1_INTEGER *)0x0) goto LAB_00014ee0;
                                  }
                                }
                                else {
...
LAB_00014ee0:
  ...
  bp = (X509 *)app_passwd(bio_err,local_564,local_560,&local_4bc,&local_4b8);
  if (bp == (X509 *)0x0) {
...
LAB_00014f7e:
      if (req_conf != (CONF *)0x0) goto LAB_00014f86;
    }
    else {
      if (bVar2) {
...
LAB_00014f86:
      bp = (X509 *)load_config(bio_err);
      pXVar9 = bp;
      pXVar10 = bp;
      pXVar34 = bp;
      local_574 = bp;
      if (bp == (X509 *)0x0) goto LAB_000152dc;
    ...
    bp = (X509 *)add_oid_section(bio_err,req_conf);
    pXVar9 = bp;
    pXVar10 = bp;
    pXVar34 = bp;
    local_574 = bp;
...
LAB_000154da:
        ...
        local_548 = (X509 *)(uint)(bVar37 || bVar1);
        pXVar10 = pXVar9;
        pXVar34 = pXVar9;
        if (!bVar37 && !bVar1) {
          uVar27 = setup_engine(bio_err,local_580,local_548);
          if (local_558 != (char *)0x0) {
            local_4c8 = (X509 *)load_key(bio_err,local_558,local_570,local_548,local_4bc,uVar27,
                                         "Private Key");
            pXVar9 = local_4c8;
            pXVar10 = local_4c8;
            pXVar34 = local_4c8;
            if (local_4c8 == (X509 *)0x0) goto LAB_000152dc;
...
LAB_00015a20:
                ...
                if (((uint)pcVar33 & (local_538 ^ 1)) != 0) {
                  ...
                  pXVar9 = (X509 *)build_subject(local_580,local_550,local_528,local_4fc);
                  if (pXVar9 == (X509 *)0x0) {
                ...
                if (((local_538 ^ 1) & local_4f4) != 0) {
                  if (local_4c8 == (X509 *)0x0) {
                    ...
                    local_4c8 = pXVar9;
                    if (pXVar9 == (X509 *)0x0) goto LAB_000152dc;
                ...
                if (((local_510 & (local_500 ^ 1)) == 0) || ((bool)(bVar5 | bVar4 | bVar3))) {
                  if (local_51c == (char *)0x0) {
                    ...
                    if ((local_530 == (char *)0x0) ||
                       (iVar35 = strcmp(local_51c,local_530), iVar35 != 0)) {
                      pXVar9 = (X509 *)BIO_ctrl((BIO *)bp,0x6c,5,local_51c);
                    }
                    else {
                      pXVar9 = (X509 *)BIO_ctrl((BIO *)bp,0x6c,9,local_51c);
                    }
                    if (pXVar9 == (X509 *)0x0) {
                      perror(local_51c);
                      goto LAB_000152dc;
                  ...
                  if (local_500 == 0) {
                    if (bVar3) {
                      if (local_548 == (X509 *)0x0) goto LAB_00015c92;
LAB_00015b34:
                      pXVar14 = X509_get_subject_name(pXVar10);
                      print_name(bp,"subject=",pXVar14,local_4d4);
                      if (bVar5) goto LAB_00015b50;
                    }
                    else if (bVar5) {
                      if (local_548 != (X509 *)0x0) goto LAB_00015b50;
                      goto LAB_00015cb0;
                    }
                  }
                  else {
                    if (local_548 == (X509 *)0x0) {
...
LAB_00015c92:
                      ...
                      if (!bVar5) goto LAB_00015ba4;
LAB_00015cb0:
                      pXVar9 = (X509 *)X509_REQ_get_pubkey((X509_REQ *)local_580);
                    }
                    else {
                      X509_print_ex((BIO *)bp,pXVar10,local_4d4,local_4d0);
                      if (bVar3) goto LAB_00015b34;
                      if (!bVar5) goto LAB_00015ba4;
LAB_00015b50:
...
LAB_00015ba4:
                  ...
                  if ((((uint)local_548 & (local_510 ^ 1)) != 0) && (pXVar10 != (X509 *)0x0)) {
                    if (iVar24 == 1) {
                            ...
                            do {
                              do {
                                ...
                                if (iVar35 <= (int)local_53c) {
                                  ...
                                  if (iVar35 == 0) goto LAB_00016942;
                                  if (((local_538 ^ 1) == 0) || (local_570 == (X509 *)0x0))
                                  goto LAB_0001628e;
                                  iVar35 = sk_num((_STACK *)local_570);
                                  if ((iVar35 < 1) || (batch != 0)) {
                                    if (local_570 == (X509 *)0x0) goto LAB_0001628e;
                                  }
                                  else {
                                    BIO_printf(bio_err,
                                ...
                                iVar35 = check_end(pbVar18,&DAT_00125780);
                              } while ((((iVar35 == 0) ||
                                        (iVar35 = check_end(pbVar18,&DAT_00125788), iVar35 == 0)) ||
                                       (iVar35 = check_end(pbVar18,"_default"), iVar35 == 0)) ||
                                      (iVar35 = check_end(pbVar18,"_value"), iVar35 == 0));
                              local_534 = (EVP_MD *)(uint)*pbVar18;
                              if (local_534 != (EVP_MD *)0x0) {
                                pbVar26 = pbVar18;
                                if (local_534 != (EVP_MD *)0x3a && ((uint)local_534 & 0xfd) != 0x2c)
                                {
                                  do {
                                    pbVar26 = pbVar26 + 1;
                                    bVar25 = *pbVar26;
                                    if (bVar25 == 0) goto LAB_000163d8;
                              ...
                              do {
                                ...
                                if (pcVar21 == (char *)0x0) {
                                  ...
                                  if (batch == 0) {
                                    ...
                                    if (pcVar23 != (char *)0x0) goto LAB_00016514;
                                    goto LAB_000161ea;
                                  }
                                  auStack_431[2] = '\0';
                                  auStack_431[1] = '\n';
LAB_00016668:
                                  if (*pcVar33 == '\0') goto LAB_00016338;
...
LAB_00016514:
                                  if (auStack_431[1] == '\0') goto LAB_000161ea;
                                  if (auStack_431[1] == '\n') goto LAB_00016668;
                                ...
                                if (iVar8 != 0) goto LAB_00016612;
                                if ((batch != 0) || (pcVar21 != (char *)0x0)) goto LAB_000161ea;
LAB_00016552:
                          ...
                          iVar35 = build_subject(local_580,local_550,local_528,local_4fc);
                          if (iVar35 != 0) goto LAB_0001628e;
                        }
                      }
                      else {
                        pXVar14 = (X509_NAME *)local_580->cert_info->validity;
...
LAB_0001599c:
            ...
            if (local_514 != (char *)0x0) {
              app_RAND_load_files(local_514);
            }
            iVar35 = NCONF_get_number_e(req_conf,"req","default_bits",&local_4c0);
            if (iVar35 == 0) {
              local_4c0 = 0x200;
            }
            if ((local_540 == (X509 *)0x0) ||
              ...
              if ((local_4c0 < 0x180) && (local_4c4 == 6 || local_4c4 == 0x74)) {
                local_580 = (X509 *)0x0;
                ...
                if (0 < iVar35) {
                  ...
                  if (pcVar33 == (char *)0x0) {
                    ...
                    if (pcVar33 != (char *)0x0) goto LAB_00015f0a;
                    ERR_clear_error();
                  }
                  else {
LAB_00015f0a:
                    if (((*pcVar33 == 'n') && (pcVar33[1] == 'o')) && (pcVar33[2] == '\0')) {
                      local_54c = (EVP_CIPHER *)0x0;
                    }
                  }
                  ...
                  while (pXVar9 = (X509 *)PEM_write_bio_PrivateKey
                                                    ((BIO *)bp,(EVP_PKEY *)local_4c8,local_54c,
        ...
        if (pXVar10 != (X509 *)0x0) goto LAB_000154da;
...
LAB_00015808:
    ...
    pXVar9 = (X509 *)NCONF_load(req_conf,(char *)local_548,&local_4b0.flags);
    if (pXVar9 != (X509 *)0x0) goto LAB_00014f7e;
    BIO_printf(bio_err,"error on line %ld of %s\n",local_4b0.flags,local_548);
    pXVar10 = pXVar9;
    bp = pXVar9;
    pXVar34 = pXVar9;
    local_574 = pXVar9;
...
LAB_000168f4:
  ...
  if ((int)local_540 < iVar35) {
    ...
    if (iVar20 < 100) {
      ...
      lVar12 = local_4b4;
      uVar27 = *(undefined4 *)((int)pvVar19 + 8);
      if (batch == 0) goto LAB_00016b1a;
      do {
        BIO_ctrl(bio_err,0xb,0,(void *)0x0);
        if (pcVar23 == (char *)0x0) {
          buf_19362[0] = '\0';
          if (batch == 0) {
            pcVar33 = fgets(PTR_buf_19362_00016df0,0x400,stdin);
            if (pcVar33 != (char *)0x0) goto LAB_00016ad8;
            goto LAB_000161ea;
          }
          buf_19362[1] = '\0';
          buf_19362[0] = '\n';
LAB_00016be0:
          if (*pcVar21 == '\0') goto LAB_0001691a;
          BUF_strlcpy(PTR_buf_19362_00016df0,pcVar21,0x400);
          BUF_strlcat(PTR_buf_19362_00016df0,"\n",0x400);
        }
        else {
          BUF_strlcpy(PTR_buf_19362_00016df0,pcVar23,0x400);
          BUF_strlcat(PTR_buf_19362_00016df0,"\n",0x400);
          BIO_printf(bio_err,"%s\n",pcVar23);
LAB_00016ad8:
          if (buf_19362[0] == '\0') goto LAB_000161ea;
          if (buf_19362[0] == '\n') goto LAB_00016be0;
          if ((buf_19362[0] == '.') && (buf_19362[1] == '\n')) goto LAB_0001691a;
        }
        sVar22 = strlen(PTR_buf_19362_00016df0);
        if (*(char *)((int)&batch + sVar22 + 3) != '\n') goto LAB_0001663e;
        *(undefined *)((int)&batch + sVar22 + 3) = 0;
        iVar8 = req_check_len(sVar22 - 1,lVar12,iVar20);
        if (iVar8 != 0) goto LAB_00016b8e;
        if ((batch != 0) || (pcVar23 != (char *)0x0)) goto LAB_000161ea;
LAB_00016b1a:
...
LAB_00016b8e:
  iVar35 = X509_REQ_add1_attr_by_NID
                     ((X509_REQ *)local_580,iVar35,local_528,PTR_buf_19362_00016df0,-1);
  if (iVar35 == 0) {
...
LAB_0001663e:
  ...
  goto LAB_000161ea;
LAB_00016612:
  iVar35 = X509_NAME_add_entry_by_NID(pXVar14,iVar35,local_528,bytes,-1,-1,(int)local_534);
  if (iVar35 == 0) goto LAB_000161ea;
  goto LAB_00016338;
}
