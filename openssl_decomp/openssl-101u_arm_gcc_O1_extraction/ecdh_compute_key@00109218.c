...
LAB_001092f4:
        ...
        if (iVar4 == 0x196) {
          ...
          iVar4 = 0x9a;
          if (__s == (void *)0x0) goto LAB_001092f4;
        }
        else {
        ...
        if (uVar5 < uVar1) {
          __s = (void *)0x0;
          ERR_put_error(0x2b,100,0x44,"ech_ossl.c",0xaa);
          uVar5 = 0xffffffff;
        }
        else {
          __s = CRYPTO_malloc(uVar5,"ech_ossl.c",0xad);
          if (__s == (void *)0x0) {
            uVar5 = 0xffffffff;
            ERR_put_error(0x2b,100,0x41,"ech_ossl.c",0xae);
          }
          else {
            ...
            if (uVar3 == uVar1) {
              if (param_5 == (code *)0x0) {
                ...
                if (iVar4 == 0) {
                  uVar5 = 0xffffffff;
                  ERR_put_error(0x2b,100,0x66,"ech_ossl.c",0xba);
                }
              }
            }
            else {
              ERR_put_error(0x2b,100,3,"ech_ossl.c",0xb4);
              uVar5 = 0xffffffff;
            }
          }
        }
