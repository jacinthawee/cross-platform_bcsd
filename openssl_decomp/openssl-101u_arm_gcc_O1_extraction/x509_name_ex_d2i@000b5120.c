...

{
  ...
  iVar1 = ASN1_item_ex_d2i((ASN1_VALUE **)local_24,&local_28,param_3,
                           (ASN1_ITEM *)PTR_X509_NAME_INTERNAL_it_000b52a0,param_5,param_6,param_7,
                           param_8);
  if (iVar1 < 1) {
    return iVar1;
  }
  ...
  pp_Var5 = (_STACK **)CRYPTO_malloc(0x14,"x_name.c",0x8f);
  if (pp_Var5 == (_STACK **)0x0) {
...
LAB_000b51ca:
        ASN1_item_free((ASN1_VALUE *)pp_Var5,(ASN1_ITEM *)PTR_X509_NAME_it_000b52a4);
        goto LAB_000b51d2;
      }
    }
    ERR_put_error(0xd,0xab,0x41,"x_name.c",0x9d);
