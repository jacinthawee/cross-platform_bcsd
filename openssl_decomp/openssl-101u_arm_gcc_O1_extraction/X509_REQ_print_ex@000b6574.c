            ...
            do {
              ...
              if (pAVar5 == (ASN1_OBJECT *)0x0) {
                ...
                while( true ) {
                  ...
                  if (0 < iVar16) {
                    do {
                      iVar2 = BIO_write(bp,&DAT_00130f00,1);
                      if (iVar2 != 1) goto LAB_000b663a;
                      iVar16 = iVar16 + -1;
                    } while (iVar16 != 0);
                  }
                  ...
                  if (bVar17 && (pAVar12 != (ASN1_OBJECT *)0x16 &&
                    ...
                    if (pcVar6 != pAVar13->sn) goto LAB_000b663a;
                    BIO_puts(bp,"\n");
                  }
