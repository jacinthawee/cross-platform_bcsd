...

{
  ...
  if (param_2 == (byte **)0x0) {
    ...
    __assert_fail("salt_p != NULL","passwd.c",0x197,PTR___PRETTY_FUNCTION___18711_0001a85c);
  }
  if (param_3 == (byte **)0x0) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("salt_malloc_p != NULL","passwd.c",0x198,PTR___PRETTY_FUNCTION___18711_0001a85c);
  }
  if (param_1 == 0) {
    if (param_10 != 0) {
      if (*param_3 == (byte *)0x0) {
        pbVar12 = (byte *)CRYPTO_malloc(3,"passwd.c",0x19f);
        *param_3 = pbVar12;
        *param_2 = pbVar12;
        if (*param_3 != (byte *)0x0) goto LAB_0001a0aa;
      }
      else {
        pbVar12 = *param_2;
LAB_0001a0aa:
        iVar13 = RAND_bytes(pbVar12,2);
        if (0 < iVar13) {
...
LAB_0001a0e0:
    if ((param_11 | param_12) != 0) {
      if (*param_3 == (byte *)0x0) {
        pbVar12 = (byte *)CRYPTO_malloc(9,"passwd.c",0x1b4);
        *param_3 = pbVar12;
        *param_2 = pbVar12;
        if (*param_3 == (byte *)0x0) goto LAB_0001a758;
      }
      else {
        pbVar12 = *param_2;
      }
      iVar13 = RAND_bytes(pbVar12,8);
      if (iVar13 < 1) goto LAB_0001a758;
      **param_2 = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzmd5crypt"
                  [**param_2 & 0x3f];
      (*param_2)[1] =
           "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzmd5crypt"
  ...
  if (*param_2 == (byte *)0x0) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("*salt_p != NULL","passwd.c",0x1c2,PTR___PRETTY_FUNCTION___18711_0001a85c);
  }
  ...
  if (param_9 < sVar14) {
    ...
    if (param_9 < sVar14) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("strlen(passwd) <= pw_maxlen","passwd.c",0x1cf,
                    PTR___PRETTY_FUNCTION___18711_0001a85c);
    }
  }
  if (param_10 == 0) {
    if ((param_11 | param_12) == 0) {
LAB_0001a6ee:
                    /* WARNING: Subroutine does not return */
      __assert_fail("hash != NULL","passwd.c",0x1da,PTR___PRETTY_FUNCTION___18711_0001a85c);
    }
LAB_0001a1bc:
    pcVar20 = "1";
    if (param_11 == 0) {
    ...
    out_buf_18667 = 0x24;
    DAT_0019519d = 0;
    __strncat_chk(&out_buf_18667,pcVar20,4,0x29);
    __strcat_chk(&out_buf_18667,&DAT_00126f54,0x29);
    __strncat_chk(&out_buf_18667,pbVar12,8,0x29);
    sVar15 = strlen(&out_buf_18667);
    if (0xe < sVar15) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("strlen(out_buf) <= 6 + 8","passwd.c",0x138,
                    PTR___PRETTY_FUNCTION___18676_0001a860);
    }
    sVar15 = strlen(pcVar20);
    __s = (char *)(sVar15 + 0x19519e);
    cnt = strlen(__s);
    if (8 < cnt) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("salt_len <= 8","passwd.c",0x13b,PTR___PRETTY_FUNCTION___18676_0001a860);
    }
    EVP_MD_CTX_init(&EStack_7c);
    pEVar16 = EVP_md5();
    EVP_DigestInit_ex(&EStack_7c,pEVar16,(ENGINE *)0x0);
    EVP_DigestUpdate(&EStack_7c,param_4,sVar14);
    EVP_DigestUpdate(&EStack_7c,&DAT_00126f54,1);
    ...
    local_2f = local_42;
    local_2e = local_47;
    sVar14 = strlen(&out_buf_18667);
    if (pcVar20 != &out_buf_18667 + sVar14) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("output == out_buf + strlen(out_buf)","passwd.c",0x178,
                    PTR___PRETTY_FUNCTION___18676_0001a860);
    }
    ...
    if (0x28 < sVar14) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("strlen(out_buf) < sizeof(out_buf)","passwd.c",0x188,"md5crypt");
    }
    EVP_MD_CTX_cleanup(&EStack_7c);
    pcVar20 = &out_buf_18667;
  }
  else {
    pcVar20 = DES_crypt((char *)param_4,(char *)*param_2);
    if ((param_11 | param_12) != 0) goto LAB_0001a1bc;
    if (pcVar20 == (char *)0x0) goto LAB_0001a6ee;
  }
  if (param_7 != 0) {
    param_7 = 1;
  }
