...

{
  ...
  if (a != (BASIC_CONSTRAINTS *)0x0) {
    ...
    if (iVar3 == 0) {
      a_00 = a->pathlen;
      if (a_00 != (ASN1_INTEGER *)0x0) goto LAB_000d489c;
LAB_000d4bb8:
      ...
      if (a_00 == (ASN1_INTEGER *)0x0) goto LAB_000d4bb8;
LAB_000d489c:
  ...
  if (a_01 == (PROXY_CERT_INFO_EXTENSION *)0x0) goto LAB_000d4900;
...
LAB_000d4b90:
        ...
        if (iVar3 == 0x89) goto LAB_000d4b90;
      }
      else if (iVar3 == 0xb4) {
  ...
  do {
    ...
    if (iVar12 <= iVar3) {
      ...
      do {
        ...
        if (iVar3 != 0) {
          ...
          if ((local_1c == 0) ||
             (pvVar16 = OBJ_bsearch_(&local_1c,&supported_nids_16270,0xb,4,
    ...
    if ((*ppDVar13 != (DIST_POINT_NAME *)0x0) && ((*ppDVar13)->type == 1)) {
      ...
      do {
        ...
        if (iVar15 <= iVar12) goto LAB_000d4abe;
