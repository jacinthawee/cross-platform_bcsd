...

{
  ...
  if (local_1fc != 0) {
    pRVar4 = (RSA *)0x0;
    ERR_put_error(0xd,0xc9,0x67,"n_pkey.c",0x126);
    val = (RSA *)0x0;
    goto LAB_000bda0c;
  }
...
LAB_000bd940:
      ...
      if (iVar3 != 0) {
        ...
        if ((iVar3 != 0) &&
          ...
          *param_2 = local_1f8 + local_1fc;
          ...
          if (val == (RSA *)0x0) {
            ERR_put_error(0xd,0xc9,0x9e,"n_pkey.c",0x142);
            pRVar4 = val;
          }
          else {
            ...
            if (pRVar4 == (RSA *)0x0) {
              ERR_put_error(0xd,0xc9,0x9d,"n_pkey.c",0x148);
            }
          }
          goto LAB_000bda0c;
        }
    ...
    if (iVar3 != 0) {
      local_114 = s_SGCKEYSALT_0016243c._0_4_;
      uStack_110 = s_SGCKEYSALT_0016243c._4_4_;
      local_1fc = 0x1a;
      local_10c = (undefined2)ram0x00162444;
      goto LAB_000bd940;
    }
  }
  pRVar4 = (RSA *)0x0;
