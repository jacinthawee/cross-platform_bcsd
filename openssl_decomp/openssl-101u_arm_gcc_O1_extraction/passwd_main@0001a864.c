...
LAB_0001aa7c:
    ...
    pBVar4 = BIO_s_file();
    bp = BIO_new(pBVar4);
    if (bp == (BIO *)0x0) goto LAB_0001aa7c;
...
LAB_0001aad4:
              ...
              if (pBVar5 == (BIO *)0x0) {
                if (local_2044 != (BIO *)0x0) goto LAB_0001aad4;
                local_2044 = (BIO *)0x1;
                local_2040 = 1;
                pBVar5 = pBVar11;
                __s1 = pBVar11;
                  ...
                  if (pBVar5 == (BIO *)0x0) {
                    ...
                    if (pBVar5 == (BIO *)0x0) {
                      ...
                      if (pBVar5 == (BIO *)0x0) {
                        ...
                        if ((cVar1 == '-') || (local_2044 != (BIO *)0x0)) goto LAB_0001ab38;
                        pBVar5 = (BIO *)0x1;
                        local_2044 = (BIO *)0x1;
                        __s1 = pBVar11;
                        local_2064 = puVar13;
...
LAB_0001ab66:
      ...
      if (local_2064 == (undefined8 *)0x0) {
        __s1 = (BIO *)CRYPTO_malloc(iVar14,"passwd.c",0xd1);
        if (__s1 == (BIO *)0x0) goto LAB_0001abf6;
      }
      else {
        iVar14 = 0;
        __s1 = (BIO *)0x0;
      ...
      if ((uVar9 & uVar10) >> 5 == 0) {
        if (uVar9 >> 5 != 0) {
          if (uVar10 >> 5 != 0) {
            ...
            __assert_fail("passwds != NULL","passwd.c",0xe4,PTR___PRETTY_FUNCTION___18650_0001aed4);
          }
        ...
        if (__s1 == (BIO *)0x0) {
                    /* WARNING: Subroutine does not return */
          __assert_fail("passwd != NULL","passwd.c",0xf4,PTR___PRETTY_FUNCTION___18650_0001aed4);
        }
        do {
          iVar14 = BIO_gets(pBVar5,(char *)__s1,iVar3);
          while( true ) {
            if (iVar14 < 1) goto LAB_0001ace6;
...
LAB_0001ace6:
        ...
        if (iVar3 == 0) {
          local_2064 = &passwds_static_18651;
          pBVar11 = __s1;
          passwds_static_18651._0_4_ = __s1;
LAB_0001ac0a:
          if (pBVar11 == (BIO *)0x0) {
                    /* WARNING: Subroutine does not return */
            __assert_fail("*passwds != NULL","passwd.c",0xe5,PTR___PRETTY_FUNCTION___18650_0001aed4)
            ;
          }
          do {
      ...
      if (pBVar5 != (BIO *)0x0) {
        if (pvVar12 == (void *)0x0) {
          if (local_2040 == 0) {
                    /* WARNING: Subroutine does not return */
            __assert_fail("in_stdin","passwd.c",0xbf,PTR___PRETTY_FUNCTION___18650_0001aed4);
          }
          ...
          if (local_2040 != 0) {
                    /* WARNING: Subroutine does not return */
            __assert_fail("in_stdin == 0","passwd.c",0xbb,PTR___PRETTY_FUNCTION___18650_0001aed4);
          }
          lVar6 = BIO_ctrl(pBVar5,0x6c,3,local_2048);
          if (lVar6 < 1) goto LAB_0001abf6;
        }
        goto LAB_0001ab66;
      }
LAB_0001abf6:
