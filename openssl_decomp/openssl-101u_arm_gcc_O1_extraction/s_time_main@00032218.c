...

{
  ...
  maxTime = 0x1e;
  host = s_localhost_4433_00131710;
  ...
  for (param_1 = param_1 + -1; 0 < param_1; param_1 = param_1 + -1) {
    ...
    if (iVar3 == 0) {
      param_1 = param_1 + -1;
      if (param_1 == 0) goto LAB_00032470;
      host = ppcVar11[1];
      ppcVar11 = ppcVar11 + 1;
    }
    else {
...
LAB_00032470:
    ...
    __printf_chk(1,PTR_umsg_20687_000327ec,0x1e);
    goto LAB_00032370;
  }
  SSL_library_init();
...
LAB_00032370:
    ...
    if (perform << 0x1f < 0) {
      ...
      app_tminterval(0,1);
      while (tVar6 = time((time_t *)0x0), dVar13 = DAT_00032a38, tVar6 <= iVar12) {
        pSVar4 = (SSL *)doConnection(0);
        if (pSVar4 == (SSL *)0x0) goto LAB_00032370;
      ...
      __printf_chk(1,"\n\n%d connections in %.2fs; %.2f connections/user sec, bytes read %ld\n",
                   iVar3,bytes_read,dVar14 + dVar13,(double)(longlong)iVar3 / (dVar14 + dVar13),
                   bytes_read);
      tVar6 = time((time_t *)0x0);
    ...
    if (-1 < perform << 0x1e) goto LAB_00032370;
    ...
    dVar13 = dVar13 + DAT_00032a38;
    dVar14 = (double)(longlong)iVar3 / dVar13;
    iVar16 = bytes_read;
    __printf_chk(1,"\n\n%d connections in %.2fs; %.2f connections/user sec, bytes read %ld\n",iVar3,
                 bytes_read,dVar13,dVar14,bytes_read);
    ...
    iVar12 = (tVar6 - iVar12) + maxTime;
    uVar9 = __aeabi_idiv(bytes_read,iVar7);
    __printf_chk(1,"%d connections in %ld real seconds, %ld bytes read per connection\n",iVar3,
                 iVar12,uVar9,uVar15,dVar14,iVar16);
LAB_0003294c:
    SSL_free(pSVar4);
  }
  if (tm_ctx != (SSL_CTX *)0x0) {
