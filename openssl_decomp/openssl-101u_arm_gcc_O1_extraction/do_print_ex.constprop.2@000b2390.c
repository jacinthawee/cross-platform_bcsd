...
LAB_000b23cc:
      if ((param_1 == (BIO *)0x0) || (iVar13 = BIO_write(param_1,&DAT_00160d9c,1), iVar13 == 1)) {
...
LAB_000b240a:
        ...
        if ((0x1d < iVar13 - 1U) || (bVar7 = tag2nbyte[iVar13], bVar7 == 0xff)) {
          if ((int)(param_2 << 0x17) < 0) goto LAB_000b23cc;
          goto LAB_000b2404;
        }
        if ((int)(param_2 << 0x1b) < 0) {
...
LAB_000b2674:
      ...
      if (local_60[0] == '\0') {
        if (param_1 == (BIO *)0x0) goto LAB_000b23ee;
      }
      else {
        local_70 = local_70 + 2;
        if (param_1 == (BIO *)0x0) goto LAB_000b23ee;
        iVar13 = BIO_write(param_1,&DAT_00175478,1);
              ...
              do {
                ...
                if ((uVar9 & 0x61) == 0) {
                  if ((uVar9 & 6) == 0) {
                    ...
                    iVar4 = BIO_write(param_1,&DAT_00160d98,2);
...
LAB_000b2a06:
                    ...
                    iVar4 = BIO_write(param_1,&DAT_00160d8c,1);
      ...
      if ((local_60[0] == '\0') || (iVar13 = BIO_write(param_1,&DAT_00175478,1), iVar13 == 1))
      goto LAB_000b23ee;
    }
  }
  else {
