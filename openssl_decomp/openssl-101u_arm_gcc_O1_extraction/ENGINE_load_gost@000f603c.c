                ...
                if (iVar1 == 0) {
                  ...
                  if (iVar1 == 0) {
                    ...
                    if (((((iVar1 != 0) &&
                        ...
                        && (((iVar1 = register_ameth_gost(0x32c,PTR_ameth_GostR3410_94_000f62d8,
                                                          "GOST94","GOST R 34.10-94"), iVar1 != 0 &&
                             (iVar1 = register_ameth_gost(0x32b,PTR_ameth_GostR3410_2001_000f62dc,
                                                          "GOST2001","GOST R 34.10-2001"),
                             iVar1 != 0)) &&
                            ((iVar1 = register_ameth_gost(0x32f,PTR_ameth_Gost28147_MAC_000f62e0,
                                                          "GOST-MAC","GOST 28147-89 MAC"),
                             iVar1 != 0 &&
                             ((iVar1 = register_pmeth_gost(0x32c,&pmeth_GostR3410_94,0), iVar1 != 0
                              && (iVar1 = register_pmeth_gost(0x32b,
                                                  PTR_pmeth_GostR3410_2001_000f62e4,0), iVar1 != 0))
                             )))))) &&
                       ((iVar1 = register_pmeth_gost(0x32f,PTR_pmeth_Gost28147_MAC_000f62e8,0),
                        iVar1 != 0 &&
