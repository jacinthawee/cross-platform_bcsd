...
int __private_AES_set_encrypt_key_from_thumb(uchar *userKey,int bits,AES_KEY *key)

{
  ...
  if (userKey == (uchar *)0x0) {
    ...
    if (bits == 0x80) {
      ...
      do {
        puVar13 = puVar8;
        uVar3 = uVar3 ^ ((uint)(byte)(&DAT_0007c620)[uVar5 >> 0x18] |
                         (uint)(byte)(&DAT_0007c620)[uVar5 >> 0x10 & 0xff] << 0x18 |
                         (uint)(byte)(&DAT_0007c620)[uVar5 >> 8 & 0xff] << 0x10 |
                        (uint)(byte)(&DAT_0007c620)[uVar5 & 0xff] << 8) ^ *puVar7;
        uVar2 = uVar2 ^ uVar3;
        *puVar13 = uVar3;
        uVar4 = uVar4 ^ uVar2;
        puVar13[1] = uVar2;
      ...
      if (bits == 0xc0) {
        ...
        puVar8 = key->rd_key + 6;
        while( true ) {
          uVar3 = uVar3 ^ ((uint)(byte)(&DAT_0007c620)[uVar9 >> 0x18] |
        ...
        while( true ) {
          ...
          uVar3 = uVar3 ^ ((uint)(byte)(&DAT_0007c620)[uVar9 >> 0x18] |
                           (uint)(byte)(&DAT_0007c620)[uVar9 >> 0x10 & 0xff] << 0x18 |
                           (uint)(byte)(&DAT_0007c620)[uVar9 >> 8 & 0xff] << 0x10 |
                          (uint)(byte)(&DAT_0007c620)[uVar9 & 0xff] << 8) ^ *puVar8;
          uVar2 = uVar2 ^ uVar3;
          *puVar7 = uVar3;
          uVar4 = uVar4 ^ uVar2;
          puVar7[1] = uVar2;
