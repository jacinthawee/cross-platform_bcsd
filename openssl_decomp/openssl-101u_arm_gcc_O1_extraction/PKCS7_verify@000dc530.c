...

{
  ...
  if (p7 == (PKCS7 *)0x0) {
    ERR_put_error(0x21,0x75,0x8f,"pk7_smime.c",0x107);
    pBVar4 = (BIO *)p7;
    goto LAB_000dc588;
  }
  iVar1 = OBJ_obj2nid(p7->type);
  if (iVar1 != 0x16) {
    ERR_put_error(0x21,0x75,0x71,"pk7_smime.c",0x10c);
    pBVar4 = (BIO *)0x0;
    goto LAB_000dc588;
  }
  lVar2 = PKCS7_ctrl(p7,2,0,(char *)0x0);
  if ((lVar2 != 0) && (indata == (BIO *)0x0)) {
    ERR_put_error(0x21,0x75,0x7a,"pk7_smime.c",0x112);
    pBVar4 = indata;
    goto LAB_000dc588;
  }
  p_Var3 = (_STACK *)PKCS7_get_signer_info(p7);
  if ((p_Var3 == (_STACK *)0x0) || (iVar1 = sk_num(p_Var3), iVar1 == 0)) {
    ERR_put_error(0x21,0x75,0x7b,"pk7_smime.c",0x125);
    pBVar4 = (BIO *)0x0;
    goto LAB_000dc588;
  }
  pBVar4 = (BIO *)PKCS7_get0_signers(p7,certs,flags);
  if (pBVar4 == (BIO *)0x0) goto LAB_000dc588;
  ...
  if ((indata != (BIO *)0x0) && (iVar1 = BIO_method_type(indata), iVar1 == 0x401)) {
    ...
    if (pBVar7 == (BIO *)0x0) {
      ERR_put_error(0x21,0x75,0x41,"pk7_smime.c",0x15e);
      pBVar4 = pBVar7;
      goto LAB_000dc588;
    }
  }
  ...
  if (b != (BIO *)0x0) {
    ...
    if ((flags & 1U) != 0) {
      ...
      pBVar9 = BIO_new(type);
      if (pBVar9 == (BIO *)0x0) {
        ERR_put_error(0x21,0x75,0x41,"pk7_smime.c",0x169);
        goto LAB_000dc7fa;
      }
    ...
    if ((flags & 1U) != 0) {
      ...
      if (pBVar9 == (BIO *)0x0) {
        ERR_put_error(0x21,0x75,0x81,"pk7_smime.c",0x17b);
        BIO_free(b_00);
        goto LAB_000dc7fa;
      }
      BIO_free(b_00);
    ...
    if (uVar8 == 0) {
      for (; iVar1 = sk_num(p_Var3), (int)uVar8 < iVar1; uVar8 = uVar8 + 1) {
        ...
        if (iVar1 < 1) {
          pBVar9 = (BIO *)0x0;
          ERR_put_error(0x21,0x75,0x69,"pk7_smime.c",0x189);
          goto LAB_000dc7fa;
        }
      }
    }
...
LAB_000dc66c:
  ...
  X509_STORE_CTX_cleanup(&XStack_10b4);
  ERR_put_error(0x21,0x75,0x75,"pk7_smime.c",0x148);
