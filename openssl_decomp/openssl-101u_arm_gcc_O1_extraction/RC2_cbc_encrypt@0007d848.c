...
LAB_0007db98:
  ...
  switch(uVar14) {
  default:
    goto switchD_0007db0c_caseD_7;
  case 0xfffffff9:
    goto LAB_0007db4a;
  case 0xfffffffa:
    goto switchD_0007db0c_caseD_fffffffa;
  case 0xfffffffb:
    puVar11 = local_48;
    goto LAB_0007db36;
  case 0xfffffffc:
    goto switchD_0007db0c_caseD_fffffffc;
  case 0xfffffffd:
    puVar11 = local_48;
    break;
  case 0xffffffff:
