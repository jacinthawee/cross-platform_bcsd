...
LAB_0001240c:
          ...
          if (iVar2 == 0x14) {
            if (pAVar4->type == 0x14) goto LAB_0001240c;
          }
          else if ((iVar2 != 0x16) || (pAVar4->type != 0x13)) goto LAB_0001240c;
...
LAB_000124c8:
          do {
            ...
            pXVar16 = x;
            if (iVar12 == 0) {
              if (x != (X509 *)0x0) goto LAB_00012614;
            }
            else {
              ...
              if (iVar12 == 0) {
                ...
                if (pXVar16 == (X509 *)0x0) goto LAB_000124c8;
              }
LAB_00012614:
                      ...
                      if (iVar18 != 0) {
                        if (param_19 != (char *)0x0) {
                          if (pXVar17->version == (ASN1_INTEGER *)0x0) {
                            ...
                            if (pAVar9 == (ASN1_INTEGER *)0x0) goto LAB_00012406;
                          }
                        ...
                        if ((param_12 != (X509 *)0x0) ||
                          ...
                          if (param_16 == (ASN1_UTCTIME *)0x0) {
                            ...
                            if (pcVar11 == (char *)0x0) {
                              ...
                              if ((local_48[0] & 0xdf) == 0x59) goto LAB_00012c44;
...
LAB_00012c44:
                            ...
                            if (iVar18 == 0) goto LAB_00012406;
                            local_7c = (OPENSSL_STRING)CRYPTO_malloc(2,"ca.c",0x82f);
                            iVar18 = 0;
                            pAVar20 = x->cert_info->validity->notAfter;
                            local_78 = CRYPTO_malloc(pAVar20->length + 1,"ca.c",0x832);
                            memcpy(local_78,pAVar20->data,pAVar20->length);
                            *(undefined *)((int)local_78 + pAVar20->length) = 0;
                            local_74 = 0;
                            local_6c = (char *)CRYPTO_malloc(8,"ca.c",0x839);
                            ...
                            if ((((local_7c == (OPENSSL_STRING)0x0) || (local_78 == (void *)0x0)) ||
                              ...
                              *local_7c = 'V';
                              local_7c[1] = '\0';
                              ppcVar8 = (OPENSSL_STRING *)CRYPTO_malloc(0x1c,"ca.c",0x846);
                              if (ppcVar8 == (OPENSSL_STRING *)0x0) {
                                param_16 = (ASN1_UTCTIME *)0xffffffff;
                                BIO_printf(bio_err,"Memory allocation failure\n");
                              }
