    ...
    do {
      while (pbVar7 = pbVar1, __s != (byte *)0x3a) {
        if (__s == (byte *)0x2f) {
          *pbVar7 = 0;
          pbVar7 = pbVar8;
          goto joined_r0x000a11ec;
        }
        __s = (byte *)(uint)pbVar7[1];
        pbVar1 = pbVar7 + 1;
        pbVar7 = pbVar8;
        if (__s == (byte *)0x0) goto joined_r0x000a11ec;
      }
      __s = (byte *)(uint)pbVar7[1];
      pbVar1 = pbVar7 + 1;
      pbVar8 = pbVar7;
...
LAB_000a11c8:
    ...
    if (p_getaddrinfo_9267 == (code *)0xffffffff) goto LAB_000a11ba;
    local_8c = 0;
    local_88 = 0;
    local_84 = 0;
    local_80 = 0;
...
LAB_000a1218:
    ...
    while (iVar3 = socket(__domain,1,6), iVar3 != -1) {
      ...
      if (iVar5 != -1) {
        ...
        if (iVar5 != -1) goto LAB_000a11cc;
        piVar6 = __errno_location();
        ERR_put_error(2,6,*piVar6,"b_sock.c",0x311);
...
LAB_000a12ec:
        ERR_put_error(2,6,iVar5,"b_sock.c",0x30b);
        ERR_add_error_data(3,"port=\'",host_port,"\'");
      ...
      if ((__s == (byte *)0x0) || ((*__s == 0x2a && (__s[1] == 0)))) {
        if ((local_68._0_4_ & 0xffff) == 10) {
          ...
          if ((local_68._0_4_ & 0xffff) != 2) goto LAB_000a1332;
...
LAB_000a12ea:
      ...
      close(iVar5);
      if (iVar4 != -1) goto LAB_000a12ea;
      mode = 2;
      close(iVar3);
      __domain = local_68._0_4_ & 0xffff;
    }
    piVar6 = __errno_location();
    ERR_put_error(2,4,*piVar6,"b_sock.c",0x2d4);
    ERR_add_error_data(3,"port=\'",host_port,"\'");
