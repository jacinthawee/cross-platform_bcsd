...

{
  ...
  case 8:
    iVar4 = param_4[0x18];
    if (*(int *)(iVar8 + 0x274) != 0) {
      if (*(int *)(iVar8 + 0x274) != iVar8) {
        return 0;
      }
      *(int *)(iVar4 + 0x274) = iVar4;
    }
    bVar10 = *(int **)(iVar8 + 0x278) == param_1 + 8;
    if (bVar10) {
      param_4 = param_4 + 8;
    }
    if (bVar10) {
      *(int **)(iVar4 + 0x278) = param_4;
      uVar2 = 1;
    }
    else {
      pvVar3 = CRYPTO_malloc(*(int *)(iVar8 + 0x27c),"e_aes.c",0x312);
      *(void **)(iVar4 + 0x278) = pvVar3;
      if (pvVar3 == (void *)0x0) {
        return 0;
      }
      memcpy(pvVar3,*(void **)(iVar8 + 0x278),*(size_t *)(iVar8 + 0x27c));
      uVar2 = 1;
    }
    break;
  case 9:
    ...
    if ((0x10 < (int)param_3) && (*(int *)(iVar8 + 0x27c) < (int)param_3)) {
      ...
      pvVar3 = CRYPTO_malloc(param_3,"e_aes.c",0x2b4);
