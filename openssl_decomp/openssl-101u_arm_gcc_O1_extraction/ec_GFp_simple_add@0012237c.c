...
LAB_001224ce:
    ...
    if (*(int *)(param_4 + 0x40) == 0) {
      ...
      if ((((iVar1 != 0) && (iVar1 = (*pcVar5)(param_1,a_00,param_3 + 4,a,param_5), iVar1 != 0)) &&
         ...
         (iVar1 = (*pcVar5)(param_1,a_01,param_3 + 0x18,a,param_5), iVar1 != 0)) goto LAB_00122426;
      goto LAB_001224ce;
    }
