...

{
  ...
  if (a == (EVP_MD *)0x0) {
    ERR_put_error(6,0xa4,0x83,"p5_crpt2.c",0x10b);
    len = a;
    pEVar1 = a;
  }
  else {
    ...
    if ((EVP_MD *)0x40 < len) {
      OpenSSLDie("p5_crpt2.c",0x10f,"keylen <= sizeof key");
    }
    if ((param_4 == (int *)0x0) || (*param_4 != 0x10)) {
      a = (EVP_MD *)0x0;
      ERR_put_error(6,0xa4,0x72,"p5_crpt2.c",0x115);
      pEVar1 = (EVP_MD *)0x0;
    }
    else {
      ...
      if (a == (EVP_MD *)0x0) {
        ERR_put_error(6,0xa4,0x72,"p5_crpt2.c",0x11d);
        pEVar1 = a;
      }
      else {
        len = (EVP_MD *)EVP_CIPHER_CTX_key_length(param_1);
        if (((ASN1_INTEGER *)a->md_size == (ASN1_INTEGER *)0x0) ||
          ...
          if (pEVar1 == (EVP_MD *)0x0) {
            ERR_put_error(6,0xa4,0x7d,"p5_crpt2.c",0x132);
          }
          else {
            name = OBJ_nid2sn(local_70);
            pEVar1 = EVP_get_digestbyname(name);
            if (pEVar1 == (EVP_MD *)0x0) {
              ERR_put_error(6,0xa4,0x7d,"p5_crpt2.c",0x139);
            }
              ...
              ERR_put_error(6,0xa4,0x7e,"p5_crpt2.c",0x13f);
              pEVar1 = (EVP_MD *)0x0;
            }
          }
        }
        else {
          ERR_put_error(6,0xa4,0x7b,"p5_crpt2.c",0x127);
          pEVar1 = (EVP_MD *)0x0;
        }
      }
    }
