...

{
  ...
  if (hwcrhk_dso == (DSO *)0x0) {
    ...
    if (hwcrhk_dso == (DSO *)0x0) {
      ...
      ERR_put_error(HWCRHK_lib_error_code,0x67,0x68,"e_chil.c",0x215);
    }
    else {
      ...
      if (((((pDVar1 == (DSO_FUNC_TYPE)0x0) ||
        ...
        ERR_put_error(HWCRHK_lib_error_code,0x67,0x68,"e_chil.c",0x22d);
      }
      else {
        ...
        if ((((disable_mutex_callbacks == 0) &&
           ...
           l != (CRYPTO_dynlock_value *)0x0)) {
          hwcrhk_globals._32_4_ = 0xf3305;
          hwcrhk_globals._36_4_ = 0xf3299;
          hwcrhk_globals._40_4_ = 0xf3285;
          hwcrhk_globals._44_4_ = 0xf32fd;
        }
        ...
        ERR_put_error(HWCRHK_lib_error_code,0x67,0x71,"e_chil.c",0x250);
      }
    }
  }
  else {
    ...
    ERR_put_error(HWCRHK_lib_error_code,0x67,100,"e_chil.c",0x20e);
  }
  if (hwcrhk_dso != (DSO *)0x0) {
    DSO_free(hwcrhk_dso);
  }
