...
LAB_00070d7e:
    ...
    uVar31 = local_30 + 1;
    *puVar29 = 0x80;
    if (uVar31 < 0x39) goto LAB_00070b84;
  ...
  if (local_2c == 0x20) {
    ...
    *puVar32 = uVar17;
    ...
    if ((0x20 < local_2c) || (uVar31 = local_2c >> 2, uVar31 == 0)) goto LAB_00070c9e;
    puVar32[3] = uVar1;
    *puVar32 = uVar17;
    puVar32[1] = uVar16;
    puVar32[2] = uVar15;
    if (uVar31 < 2) goto LAB_00070c9e;
    puVar32[7] = uVar2;
    puVar32[4] = uVar20;
    puVar32[5] = uVar19;
    puVar32[6] = uVar18;
    if (uVar31 < 3) goto LAB_00070c9e;
    puVar32[0xb] = uVar3;
    puVar32[8] = uVar22;
    puVar32[9] = uVar21;
    puVar32[10] = uVar4;
    if (uVar31 < 4) goto LAB_00070c9e;
    puVar32[0xf] = uVar5;
    puVar32[0xc] = uVar6;
    puVar32[0xd] = uVar24;
    puVar32[0xe] = uVar23;
    if (uVar31 < 5) goto LAB_00070c9e;
    puVar32[0x13] = uVar7;
    puVar32[0x10] = uVar27;
    puVar32[0x11] = uVar26;
    puVar32[0x12] = uVar25;
    if (uVar31 < 6) goto LAB_00070c9e;
    puVar32[0x17] = uVar8;
    puVar32[0x14] = uVar28;
    puVar32[0x15] = uVar10;
    puVar32[0x16] = uVar9;
    if (uVar31 < 7) goto LAB_00070c9e;
    puVar32[0x1b] = uVar11;
    puVar32[0x18] = uVar14;
    puVar32[0x19] = uVar13;
    puVar32[0x1a] = uVar12;
    if (uVar31 < 8) goto LAB_00070c9e;
  }
