...

{
  ...
  local_6c = *(undefined4 *)PTR_s_ENGINE_init_000f6154;
  uStack_68 = *(undefined4 *)(PTR_s_ENGINE_init_000f6154 + 4);
  uStack_64 = *(undefined4 *)(PTR_s_ENGINE_init_000f6154 + 8);
  local_60 = 0;
  ...
  if (surewarehk_dso == (DSO *)0x0) {
    ...
    if (surewarehk_dso == (DSO *)0x0) {
      ...
      ERR_put_error(SUREWARE_lib_error_code,0x68,0x68,"e_sureware.c",0x1ce);
    }
    else {
                    ...
                    if (pDVar11 != (DSO_FUNC_TYPE)0x0) {
                      ...
                      if (pDVar12 != (DSO_FUNC_TYPE)0x0) {
                        ...
                        if (pDVar13 != (DSO_FUNC_TYPE)0x0) {
                          ...
                          if (iVar14 == -3) {
                            ERR_SUREWARE_error_constprop_5(0x68,0x68,499);
                          }
                          else {
                            ...
                            ERR_SUREWARE_error_constprop_5(0x68,0x68,0x1f8);
                          }
                          goto LAB_000f5eb6;
                        }
                      }
