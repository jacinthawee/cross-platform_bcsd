...

{
  ...
  *param_3 = pXVar1;
  if (pXVar1 != (X509_ALGOR *)0x0) {
    ...
    if (md == (EVP_MD *)0x0) {
      ERR_put_error(0x2f,0x91,0x7e,"ts_rsp_verify.c",0x25a);
      pXVar1 = *param_3;
    }
    else {
      ...
      if (-1 < iVar2) {
        *param_5 = iVar2;
        puVar3 = (uchar *)CRYPTO_malloc(iVar2,"ts_rsp_verify.c",0x263);
        *param_4 = puVar3;
        if (puVar3 == (uchar *)0x0) {
          ERR_put_error(0x2f,0x91,0x41,"ts_rsp_verify.c",0x265);
          pXVar1 = *param_3;
          goto LAB_000ebcf2;
        }
