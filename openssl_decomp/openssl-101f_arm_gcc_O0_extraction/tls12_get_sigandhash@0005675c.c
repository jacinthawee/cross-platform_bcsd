...

{
  ...
  if (param_3 != (EVP_MD *)0x0) {
    ...
    if (iVar1 == tls12_md._0_4_) {
      ...
      puVar2 = (undefined1 *)0x18defc;
    }
    else if (iVar1 == tls12_md._16_4_) {
      puVar2 = (undefined1 *)0x18df04;
    }
    else if (iVar1 == tls12_md._24_4_) {
      puVar2 = (undefined1 *)0x18df0c;
    }
    else if (iVar1 == tls12_md._32_4_) {
      puVar2 = (undefined1 *)0x18df14;
    }
    else {
      if (iVar1 != tls12_md._40_4_) {
        return 0;
      }
      puVar2 = (undefined1 *)0x18df1c;
    }
    if (*(int *)(puVar2 + 4) != -1) {
      iVar1 = *param_2;
      if (iVar1 == tls12_sig._0_4_) {
        ...
        puVar3 = (undefined1 *)0x18df2c;
      }
      else {
        if (iVar1 != tls12_sig._16_4_) {
          return 0;
        }
        puVar3 = (undefined1 *)0x18df34;
      }
      iVar1 = *(int *)(puVar3 + 4);
      if (iVar1 != -1) {
