...
LAB_00024c50:
      uVar9 = 1;
      BN_free(a);
      if (bp == (BIO *)0x0) goto LAB_00024e2c;
    }
    else {
      pBVar2 = BIO_s_file();
      bp = BIO_new(pBVar2);
...
LAB_00024cfa:
          ...
          if (iVar3 == 0) {
            if (param_1 == 1) goto LAB_00024f74;
            local_58 = ppcVar11[1];
            param_1 = param_1 + -2;
            ppcVar11 = ppcVar11 + 2;
            goto joined_r0x00024cda;
          }
          iVar3 = strcmp(__s1,"-rand");
          if (iVar3 == 0) {
            param_1 = param_1 + -1;
            if (param_1 == 0) goto LAB_00024f74;
            pcVar10 = ppcVar11[1];
            ppcVar11 = ppcVar11 + 1;
          }
          else {
                          ...
                          if (iVar3 == 0) {
                            ...
                            if (iVar3 != 0) {
                              ...
                              if (iVar3 == 0) {
                                ...
                                if ((iVar3 != 0) && (-1 < local_44)) goto LAB_00024d32;
                              }
LAB_00024f74:
...
LAB_00024cce:
        ...
        ppcVar11 = ppcVar11 + 1;
joined_r0x00024cda:
        if (param_1 < 1) goto LAB_00024d32;
        goto LAB_00024cdc;
      }
LAB_00024d32:
...
LAB_00024dbe:
      ...
      else if (pcVar10 != (char *)0x0) goto LAB_00024dbe;
      BIO_printf(bio_err,"Generating RSA private key, %d bit long modulus\n",local_44);
      rsa = RSA_new_method(engine);
      if (rsa == (RSA *)0x0) goto LAB_00024c50;
