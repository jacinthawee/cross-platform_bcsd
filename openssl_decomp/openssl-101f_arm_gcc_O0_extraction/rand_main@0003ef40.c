...
LAB_0003efa4:
    do {
      ...
      while( true ) {
        iVar3 = iVar4;
        if (pbVar10 == (byte *)0x0) goto LAB_0003efda;
        iVar13 = iVar3 * 4;
        iVar4 = strcmp((char *)pbVar10,"-out");
        if (iVar4 == 0) {
          pvVar9 = *(void **)(iVar13 + param_2 + 4);
          if ((pvVar9 == (void *)0x0) || (local_1044 != (void *)0x0)) goto LAB_0003efd8;
          iVar3 = iVar7 + 2;
          local_1044 = pvVar9;
          goto LAB_0003efa4;
        }
        ...
        if ((iVar3 == 0) || (iVar12 != 0)) goto LAB_0003efd8;
      ...
      if (iVar4 != 0) {
        ...
        if (iVar7 == 0) {
          if (bVar2) goto LAB_0003efd8;
          bVar2 = true;
        }
        else {
          iVar7 = strcmp((char *)pbVar10,"-hex");
          if (iVar7 == 0) {
            if (bVar1) goto LAB_0003efd8;
            bVar1 = true;
          }
          else {
            ...
            local_1038 = local_1030;
            if ((iVar7 == 0) || (local_1030 < 0)) goto LAB_0003efd8;
          }
        }
        goto LAB_0003efa4;
      }
      iVar4 = *(int *)(iVar13 + param_2 + 4);
      if ((iVar4 == 0) || (local_1040 != 0)) goto LAB_0003efd8;
      iVar3 = iVar7 + 2;
      local_1040 = iVar4;
    } while( true );
  }
...
LAB_0003f2b6:
        ...
        if (bVar2) {
          pBVar5 = BIO_f_base64();
          b = BIO_new(pBVar5);
          if (b == (BIO *)0x0) goto LAB_0003f2b6;
        ...
        if (0 < local_1030) {
          do {
            while( true ) {
              ...
              if (local_1030 < 1) goto LAB_0003f148;
            }
...
LAB_0003f166:
        ERR_print_errors(bio_err);
        if (pBVar6 == (BIO *)0x0) goto LAB_0003f060;
      }
      BIO_free_all(pBVar6);
      goto LAB_0003f060;
    }
