...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (type != (EVP_MD *)0x0) goto LAB_000a856a;
    pEVar3 = ctx->digest;
LAB_000a8672:
    type = (EVP_MD *)0x0;
...
LAB_000a8592:
    ...
    pEVar3 = ctx->digest;
    if (pEVar3 == (EVP_MD *)0x0) {
      if (type == (EVP_MD *)0x0) goto LAB_000a8672;
    }
    else if ((type == (EVP_MD *)0x0) || (type->type == pEVar3->type)) goto LAB_000a85a4;
    ENGINE_finish(ctx->engine);
LAB_000a856a:
    if (impl == (ENGINE *)0x0) {
      impl = ENGINE_get_digest_engine(type->type);
      if (impl != (ENGINE *)0x0) goto LAB_000a857a;
    }
    else {
...
LAB_000a857a:
    ...
    pEVar3 = ctx->digest;
    ctx->engine = impl;
    if (pEVar3 == type) goto LAB_000a85a4;
    if (pEVar3 != (EVP_MD *)0x0) goto LAB_000a8592;
  }
  ctx->digest = type;
...
LAB_000a85a4:
  ...
  if ((int)(ctx->flags << 0x17) < 0) {
    return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000a85e6. Too many branches */
