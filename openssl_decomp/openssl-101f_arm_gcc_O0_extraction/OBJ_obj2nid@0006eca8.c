  ...
  if (o != (ASN1_OBJECT *)0x0) {
    ...
    do {
      while( true ) {
        ...
        if (__n == *(size_t *)(&DAT_00140f98 + iVar1)) break;
        if (-1 < (int)(__n - *(size_t *)(&DAT_00140f98 + iVar1))) goto LAB_0006ed08;
LAB_0006ed30:
        iVar4 = iVar5;
        if (iVar5 <= iVar6) {
          return 0;
      ...
      iVar3 = memcmp(o->data,(&PTR_lvalues_00140f9c)[*(int *)(obj_objs + iVar5 * 4) * 6],__n);
      if (iVar3 < 0) goto LAB_0006ed30;
      if (iVar3 == 0) {
        return *(int *)(&DAT_00140f94 + iVar1);
      }
LAB_0006ed08:
      iVar6 = iVar5 + 1;
    } while (iVar6 < iVar4);
