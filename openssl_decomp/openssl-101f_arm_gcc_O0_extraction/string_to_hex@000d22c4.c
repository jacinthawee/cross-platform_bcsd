...

{
  ...
  if (str == (char *)0x0) {
    ERR_put_error(0x22,0x71,0x6b,"v3_utl.c",0x18d);
    ptr = (byte *)str;
  }
  else {
    sVar2 = strlen(str);
    ptr = (byte *)CRYPTO_malloc((int)sVar2 >> 1,"v3_utl.c",400);
    pbVar11 = ptr;
    if (ptr == (byte *)0x0) {
      ERR_put_error(0x22,0x71,0x41,"v3_utl.c",0x1b4);
    }
    else {
      while( true ) {
        pbVar5 = (byte *)str;
        ...
        if (uVar7 != 0x3a) {
          ...
          uVar8 = (uint)bVar1;
          if (uVar8 == 0) {
            ERR_put_error(0x22,0x71,0x70,"v3_utl.c",0x19c);
            CRYPTO_free(ptr);
            return (uchar *)0x0;
          }
          ...
          if (9 < uVar10) {
            if (5 < uVar7 - 0x61) goto LAB_000d23b0;
...
LAB_000d23b0:
              CRYPTO_free(ptr);
              ERR_put_error(0x22,0x71,0x71,"v3_utl.c",0x1b9);
              return (uchar *)0x0;
            }
