...

{
  ...
  if (keylen == 0 || key == (uchar *)0x0) {
    ERR_put_error(0x2e,0x7b,0x82,"cms_enc.c",0x107);
    return 0;
  }
  if (ciph == (EVP_CIPHER *)0x0) {
    iVar4 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
    if (iVar4 != 0x1a) {
      ERR_put_error(0x2e,0x7b,0x7a,"cms_enc.c",0x119);
      return 0;
    }
    ...
    *(ASN1_VALUE **)(cms + 4) = pAVar1;
    if (pAVar1 == (ASN1_VALUE *)0x0) {
      ERR_put_error(0x2e,0x7b,0x41,"cms_enc.c",0x110);
      return 0;
    }
  ...
  pAVar2 = (ASN1_OBJECT *)CRYPTO_malloc(keylen,"cms_enc.c",0xf6);
  ppAVar6[4] = pAVar2;
