...

{
  ...
  local_34 = *(undefined4 *)PTR_DAT_000efc28;
  uStack_30 = *(undefined4 *)(PTR_DAT_000efc28 + 4);
  ...
  if (param_1 == 4 || param_1 == 0x40) {
    ...
    if (local_54.algorithm == (ASN1_OBJECT *)0x0) {
      ...
      ERR_put_error(CCA4758_lib_error_code,0x69,0x6d,"e_4758cca.c",0x308);
      local_98 = 0;
      goto LAB_000efa2c;
    }
    ...
    if (local_98 == 0) {
      ...
      ERR_put_error(CCA4758_lib_error_code,0x69,0x65,"e_4758cca.c",0x30f);
      goto LAB_000efa2c;
    }
...
LAB_000efb18:
  ...
  if (param_1 == 0x40) {
    param_2 = (uchar *)CRYPTO_malloc(iVar3 + 1,"e_4758cca.c",0x345);
...
LAB_000efa64:
    ...
    *param_5 = local_74;
    ...
    if (param_1 == 4) {
      param_2 = (uchar *)CRYPTO_malloc(iVar3 + 1,"e_4758cca.c",0x337);
      if (param_2 != (uchar *)0x0) goto LAB_000efa5a;
      local_68 = param_2;
      if (CCA4758_lib_error_code == 0) {
        CCA4758_lib_error_code = ERR_get_next_error_library();
      }
