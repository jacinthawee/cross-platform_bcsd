...

{
  ...
  uint uVar15;
  uint uVar16;
  SSL_METHOD *local_238;
  char *local_234;
  char acStack_22c [512];
  int local_2c;
  
  local_2c = __TMC_END__;
  local_238 = SSLv23_server_method();
...
LAB_00037720:
    ...
    if (param_1 < 1) {
      SSL_library_init();
      ctx = SSL_CTX_new(local_238);
      if (ctx == (SSL_CTX *)0x0) goto LAB_00037716;
      s = SSL_new(ctx);
      if (s != (SSL *)0x0) {
LAB_000376de:
        iVar6 = 0;
...
LAB_000377ac:
      ...
      do {
        while( true ) {
          ...
          if (cVar1 == '-') break;
LAB_0003761e:
          iVar6 = strcmp(pcVar12,"-ssl2");
          if (iVar6 != 0) {
            iVar6 = strcmp(pcVar12,"-ssl3");
            if (iVar6 == 0) {
              local_238 = SSLv3_client_method();
              goto LAB_0003767e;
            }
            iVar6 = strcmp(pcVar12,"-tls1");
            if (iVar6 == 0) {
              local_238 = TLSv1_client_method();
              goto LAB_0003767e;
            }
            iVar6 = strncmp(pcVar12,"-h",2);
            if ((iVar6 != 0) &&
               (((local_234 = pcVar12, cVar1 != '-' || (pcVar12[1] != '?')) || (pcVar12[2] != '\0'))
               )) goto LAB_0003767e;
          ...
          local_238 = SSLv2_client_method();
LAB_0003767e:
          param_1 = param_1 + -1;
          bVar5 = bVar2;
          bVar4 = bVar3;
          if (param_1 == 0) goto LAB_000376ac;
        }
        if (pcVar12[1] == 'v') {
          if (pcVar12[2] != '\0') goto LAB_0003761e;
          bVar3 = true;
          goto LAB_0003767e;
        }
        if ((pcVar12[1] != 'V') || (pcVar12[2] != '\0')) goto LAB_0003761e;
        param_1 = param_1 + -1;
        bVar2 = true;
        bVar5 = true;
        bVar3 = bVar2;
...
LAB_00037716:
      ...
      if ((local_234 == (char *)0x0) || (iVar6 = SSL_CTX_set_cipher_list(ctx,local_234), iVar6 != 0)
         ) {
        s = SSL_new(ctx);
        if (s != (SSL *)0x0) {
          if (!bVar4) goto LAB_000376de;
