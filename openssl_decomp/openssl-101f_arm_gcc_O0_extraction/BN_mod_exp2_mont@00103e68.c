...
LAB_00103f20:
  ...
  if (m_ctx == (BN_MONT_CTX *)0x0) {
    ...
    if (local_150 == (BN_MONT_CTX *)0x0) goto LAB_00103f20;
    iVar6 = BN_MONT_CTX_set(local_150,m,ctx);
    if (iVar6 != 0) goto LAB_00103eec;
  }
  else {
    local_150 = m_ctx;
LAB_00103eec:
      ...
      if (a1->top != 0) {
        ...
        if (iVar6 != 0) {
          ...
          if (((a2->neg == 0) && (iVar6 = BN_ucmp(a2,m), local_15c = a2, iVar6 < 0)) ||
            ...
            if (local_15c->top == 0) goto LAB_001040a0;
...
LAB_00104090:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_00103f22;
  }
