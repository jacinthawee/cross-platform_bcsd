    ...
    if (pbVar6[1] != 0) {
      ...
      if (iVar4 != 0) {
        ...
        while ((int)((uint)uVar1 << 0x12) < 0) {
          if (pbVar9 == pbVar11) goto LAB_00111f80;
          pbVar11 = pbVar11 + -1;
          uVar1 = puVar10[*pbVar11];
        }
        pbVar11 = pbVar11 + (1 - (int)pbVar9);
        __dest = (char **)CRYPTO_malloc((int)(pbVar11 + 1),"asn_moid.c",0x94);
        if (__dest != (char **)0x0) {
...
LAB_00111f80:
    ERR_put_error(0xd,0xae,0xab,"asn_moid.c",0x58);
    p_Var3 = (_STACK *)0x0;
  }
  return p_Var3;
}
