...

{
  ...
  if (e == (ENGINE *)0x0) {
    ...
    CRYPTO_lock(9,0x1e,"eng_pkey.c",0x8f);
    pEVar1 = *(EVP_PKEY **)(e + 0x5c);
    if (pEVar1 == (EVP_PKEY *)0x0) {
      CRYPTO_lock(10,0x1e,"eng_pkey.c",0x92);
      ERR_put_error(0x26,0x97,0x75,"eng_pkey.c",0x94);
      e = (ENGINE *)pEVar1;
    }
    else {
      CRYPTO_lock(10,0x1e,"eng_pkey.c",0x97);
      pEVar1 = *(EVP_PKEY **)(e + 0x48);
      if (pEVar1 == (EVP_PKEY *)0x0) {
        ERR_put_error(0x26,0x97,0x7d,"eng_pkey.c",0x9b);
        e = (ENGINE *)pEVar1;
      }
      else {
