...
joined_r0x000f79aa:
    ...
    if (((a_00->dmax < 5) && (pBVar3 = bn_expand2(a_00,5), pBVar3 == (BIGNUM *)0x0)) ||
      ...
      ERR_put_error(UBSEC_lib_error_code,0x66,0x65,"e_ubsec.c",0x2f6);
      goto joined_r0x000f79aa;
    }
    ...
    if (pBVar3 == (BIGNUM *)0x0) {
      ...
      ERR_put_error(UBSEC_lib_error_code,0x66,0x65,"e_ubsec.c",0x2fb);
      goto joined_r0x000f79aa;
    }
    ...
    if (iVar4 < 1) {
      ...
      ERR_put_error(UBSEC_lib_error_code,0x66,0x6c,"e_ubsec.c",0x302);
    }
    else {
      puVar10 = param_3->p->d;
      ...
      if (iVar5 == 0) {
        ...
        ERR_put_error(UBSEC_lib_error_code,0x66,0x65,"e_ubsec.c",0x322);
        goto joined_r0x000f79aa;
      }
      if (UBSEC_lib_error_code == 0) {
        UBSEC_lib_error_code = ERR_get_next_error_library();
      }
      ERR_put_error(UBSEC_lib_error_code,0x66,0x6a,"e_ubsec.c",0x313);
      (*p_UBSEC_ubsec_close)(iVar4);
    }
    pDVar9 = DSA_OpenSSL();
    pBVar3 = (BIGNUM *)(*pDVar9->dsa_do_sign)(param_1,param_2,param_3);
    if (pBVar3 != (BIGNUM *)0x0) goto LAB_000f78de;
    BN_free(a_00);
  }
  pBVar3 = a;
  if (a != (BIGNUM *)0x0) {
