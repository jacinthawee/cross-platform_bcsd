...

{
  ...
  if (iVar1 == 1) {
    ...
    if (iVar2 == 0) {
      ...
      CRYPTO_lock(9,0xb,"x509_lu.c",0x291);
...
LAB_000cdfd4:
        ...
        *issuer = (X509 *)piVar3[1];
        if (iVar1 == 1) {
          CRYPTO_add_lock((int *)(piVar3[1] + 0x10),1,3,"x509_lu.c",0x195);
        }
        else {
          bVar5 = iVar1 == 2;
          iVar1 = iVar2;
          if (bVar5) {
            CRYPTO_add_lock((int *)(piVar3[1] + 0xc),1,6,"x509_lu.c",0x198);
          }
        }
      }
      CRYPTO_lock(10,0xb,"x509_lu.c",0x2a7);
    }
    else {
    ...
    ERR_put_error(0xb,0x92,0x6a,"x509_lu.c",0x27c);
    iVar1 = -1;
  }
  else if (iVar1 != 0) {
    if (local_28.type == 1) {
