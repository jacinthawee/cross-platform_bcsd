...
LAB_0007cf30:
  ...
  switch(uVar14) {
  default:
    goto switchD_0007cea4_caseD_7;
  case 0xfffffff9:
    goto LAB_0007cee2;
  case 0xfffffffa:
    goto switchD_0007cea4_caseD_fffffffa;
  case 0xfffffffb:
    puVar11 = local_48;
    goto LAB_0007cece;
  case 0xfffffffc:
    goto switchD_0007cea4_caseD_fffffffc;
  case 0xfffffffd:
    puVar11 = local_48;
    break;
  case 0xffffffff:
