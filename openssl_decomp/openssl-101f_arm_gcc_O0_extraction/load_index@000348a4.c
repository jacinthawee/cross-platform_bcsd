...
LAB_0003490a:
        pTVar4 = (TXT_DB *)CRYPTO_malloc(8,"apps.c",0x731);
        if (pTVar4 != (TXT_DB *)0x0) {
          ...
          if (conf_00 == (CONF *)0x0) goto joined_r0x00034a04;
...
LAB_00034992:
              ...
              if (bVar1 < 0x4f) {
                if ((bVar1 == 0x30) || (bVar1 == 0x46)) goto LAB_00034992;
              }
              else if ((bVar1 == 0x66) || (bVar1 == 0x6e)) goto LAB_00034992;
              iVar3 = 1;
            }
