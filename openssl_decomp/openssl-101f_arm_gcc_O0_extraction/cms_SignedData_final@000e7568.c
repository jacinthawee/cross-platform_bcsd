...

{
  ...
  if (0 < iVar1) {
    do {
      ...
      iVar1 = *(int *)(si + 0x20);
      if (iVar1 == 0) {
        ERR_put_error(0x2e,0x96,0x85,"cms_sd.c",0x275);
        goto LAB_000e75ca;
      }
...
LAB_000e75c2:
      ...
      if (iVar1 < 0) {
        ...
        md = (uchar *)CRYPTO_malloc(iVar1,"cms_sd.c",0x295);
        if (md == (uchar *)0x0) {
          ERR_put_error(0x2e,0x96,0x41,"cms_sd.c",0x299);
        }
        else {
          ...
          ERR_put_error(0x2e,0x96,0x8b,"cms_sd.c",0x29f);
          CRYPTO_free(md);
        }
        goto LAB_000e75c2;
      }
      ...
      if ((((iVar1 == 0) ||
         ...
         (iVar1 = CMS_SignerInfo_sign(si), iVar1 == 0)) goto LAB_000e75c2;
LAB_000e7682:
      iVar2 = iVar2 + 1;
      EVP_MD_CTX_cleanup(&EStack_84);
      iVar1 = sk_num((_STACK *)pAVar3);
