...
LAB_0008e084:
              ...
              if (((pBVar4 == (BIGNUM *)0x0) ||
                 ...
                 (iVar7 = BN_sub_word(pBVar2,1), iVar7 == 0)) goto LAB_0008e0ee;
              uVar11 = pBVar2->top;
              iVar7 = 1;
              if (uVar11 == 0) goto LAB_0008e0be;
...
LAB_0008e0be:
            ...
            if (uVar11 == 0xffffffff) goto LAB_0008ddb4;
          }
          else {
...
LAB_0008e11a:
              ...
              if (((pBVar4 == (BIGNUM *)0x0) ||
                  (pBVar8 = BN_copy(pBVar2,local_4c), pBVar8 == (BIGNUM *)0x0)) ||
                 (iVar7 = BN_sub_word(pBVar2,1), iVar7 == 0)) goto LAB_0008e184;
              uVar11 = pBVar2->top;
              iVar7 = 1;
              if (uVar11 == 0) goto LAB_0008e154;
              while (iVar9 = BN_is_bit_set(pBVar2,iVar7), iVar9 == 0) {
                iVar7 = iVar7 + 1;
              }
              iVar9 = BN_rshift(pBVar3,pBVar2,iVar7);
...
LAB_0008e154:
          ...
          iVar5 = iVar5 + 1;
          if (iVar12 <= iVar5) goto LAB_0008e05a;
        }
      }
      local_48 = local_48 + 1;
    } while( true );
