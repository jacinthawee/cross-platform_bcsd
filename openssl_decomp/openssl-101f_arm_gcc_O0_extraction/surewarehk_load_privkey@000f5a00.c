...

{
  ...
  puVar1 = PTR_s_ENGINE_load_privkey_000f5d08;
  local_ac = *(undefined4 *)PTR_s_ENGINE_load_privkey_000f5d08;
  uStack_a8 = *(undefined4 *)(PTR_s_ENGINE_load_privkey_000f5d08 + 4);
  uStack_a4 = *(undefined4 *)(PTR_s_ENGINE_load_privkey_000f5d08 + 8);
  uStack_a0 = *(undefined4 *)(PTR_s_ENGINE_load_privkey_000f5d08 + 0xc);
  local_9c = *(undefined4 *)(PTR_s_ENGINE_load_privkey_000f5d08 + 0x10);
  local_b4 = 0;
  ...
  if (p_surewarehk_Load_Privkey == (code *)0x0) {
    ...
    pkey = (EVP_PKEY *)0x0;
    ERR_put_error(SUREWARE_lib_error_code,0x69,0x75,"e_sureware.c",0x310);
  }
  else {
    ...
    if (iVar3 == 1) {
      ...
      ERR_put_error(SUREWARE_lib_error_code,0x69,0x80,"e_sureware.c",0x317);
      pkey = (EVP_PKEY *)0x0;
