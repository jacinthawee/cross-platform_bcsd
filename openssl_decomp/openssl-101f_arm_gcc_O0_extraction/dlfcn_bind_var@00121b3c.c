...

{
  ...
  if (param_2 != 0 && param_1 != 0) {
    ...
    if (iVar1 < 1) {
      ERR_put_error(0x25,0x65,0x69,"dso_dlfcn.c",0xf3);
    }
    else {
      ...
      if (pvVar4 == (void *)0x0) {
        ERR_put_error(0x25,0x65,0x68,"dso_dlfcn.c",0xf9);
      }
      else {
        pvVar4 = (void *)dlsym(pvVar4,param_2);
        if (pvVar4 == (void *)0x0) {
          ERR_put_error(0x25,0x65,0x6a,"dso_dlfcn.c",0xff);
          uVar2 = dlerror();
  ...
  ERR_put_error(0x25,0x65,0x43,"dso_dlfcn.c",0xee);
  return (void *)0x0;
}
