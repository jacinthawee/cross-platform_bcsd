    ...
    if ((iVar2 == 0x400 || iVar2 == 0x100) || (iVar2 == 0x200)) {
      ...
      if (0 < iVar1) {
        if (iVar1 == 2) {
          ...
          ERR_put_error(6,0x9b,0x9a,"pmeth_fn.c",0x137);
          iVar1 = -1;
        }
          ...
          if ((iVar1 == 0) &&
            ...
            ERR_put_error(6,0x9b,0x99,"pmeth_fn.c",0x14b);
            iVar1 = -1;
          }
          else {
          ...
          ERR_put_error(6,0x9b,0x65,"pmeth_fn.c",0x13e);
          iVar1 = -1;
        }
      }
    }
    else {
      ERR_put_error(6,0x9b,0x97,"pmeth_fn.c",0x129);
      iVar1 = -1;
    }
  }
  return iVar1;
