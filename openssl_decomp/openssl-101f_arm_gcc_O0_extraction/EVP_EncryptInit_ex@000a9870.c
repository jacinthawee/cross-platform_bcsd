...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_000a9a3c;
      goto LAB_000a9918;
    }
    if (pEVar4 != (EVP_CIPHER *)0x0) goto LAB_000a989e;
  }
...
LAB_000a9a3c:
    ...
    if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_000a9918;
LAB_000a989e:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_000a98ea;
  }
  else {
