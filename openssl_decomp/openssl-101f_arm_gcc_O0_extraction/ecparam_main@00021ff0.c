...
LAB_00022368:
      ...
      if (iVar11 != 0) {
        ...
        if ((((cVar2 == '-') && (pcVar24[1] == 'i')) && (pcVar24[2] == 'n')) && (pcVar24[3] == '\0')
          ...
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_00022368;
          pcVar25 = ppcVar23[1];
          ppcVar23 = ppcVar23 + 1;
        }
        else {
                    ...
                    if (iVar11 == 0) {
                      ...
                      if (iVar11 == 0) {
                        ...
                        if (iVar11 == 0) {
                          ...
                          if (local_40 != 0) goto LAB_00022368;
                          bVar4 = true;
                        }
                      }
                      else {
...
LAB_0002207a:
      ...
      if (param_1 == 1) goto LAB_00022368;
      param_1 = param_1 + -2;
  ...
  if (local_4c != (BIO *)0x0) {
    ...
    local_4c = (BIO *)CRYPTO_malloc(nitems << 3,"ecparam.c",0x15f);
    if (local_4c == (BIO *)0x0) {
      uVar21 = 1;
    }
    else {
...
LAB_000228ea:
      ...
      pEVar19 = EC_KEY_new();
      if ((pEVar19 == (EC_KEY *)0x0) ||
         (iVar26 = EC_KEY_set_group(pEVar19,(EC_GROUP *)local_4c), iVar26 == 0)) goto LAB_00022d2e;
      iVar26 = EC_KEY_generate_key(pEVar19);
      if (iVar26 != 0) {
        if (iVar22 == 1) {
          i2d_ECPrivateKey_bio(bp,pEVar19);
        }
        else {
          if (iVar22 != 3) {
            uVar21 = 1;
          ...
          PEM_write_bio_ECPrivateKey
                    (bp,pEVar19,(EVP_CIPHER *)0x0,(uchar *)0x0,0,(undefined1 *)0x0,(void *)0x0);
        }
        EC_KEY_free(pEVar19);
        goto LAB_000228ea;
      }
      ...
      if (bVar10) {
        ...
        if (pEVar19 != (EC_KEY *)0x0) {
          ...
          __assert_fail("need_rand","ecparam.c",0x287,"ecparam_main");
        }
LAB_00022d2e:
        uVar21 = 1;
        goto LAB_00022262;
...
LAB_00022262:
    if (local_60 != (BIGNUM *)0x0) goto LAB_00022266;
  }
  else {
...
LAB_0002287c:
    ...
    if ((((local_6c == (BIGNUM *)0x0) ||
       ...
       (cofactor = BN_new(), cofactor == (BIGNUM *)0x0)) goto LAB_0002287c;
    iVar26 = EC_METHOD_get_field_type(meth);
    if (((iVar26 == 0x196) &&
        (iVar26 = EC_GROUP_get_curve_GFp
                            ((EC_GROUP *)local_4c,local_60,local_64,local_6c,(BN_CTX *)0x0),
        iVar26 != 0)) &&
       (pEVar15 = EC_GROUP_get0_generator((EC_GROUP *)local_4c), pEVar15 != (EC_POINT *)0x0)) {
      form = EC_GROUP_get_point_conversion_form((EC_GROUP *)local_4c);
      pBVar16 = EC_POINT_point2bn((EC_GROUP *)local_4c,pEVar15,form,local_68,(BN_CTX *)0x0);
         ...
         (iVar26 = EC_GROUP_get_cofactor((EC_GROUP *)local_4c,cofactor,(BN_CTX *)0x0), iVar26 != 0))
      {
        ...
        iVar17 = BN_num_bits(local_60);
        iVar26 = iVar17 + 0xe;
        if (-1 < iVar17 + 7) {
          iVar26 = iVar17 + 7;
        }
        iVar18 = BN_num_bits(local_64);
        iVar17 = iVar18 + 0xe;
        if (-1 < iVar18 + 7) {
          iVar17 = iVar18 + 7;
        }
        iVar18 = BN_num_bits(local_6c);
        uVar28 = iVar17 >> 3;
        if ((uint)(iVar17 >> 3) < (uint)(iVar26 >> 3)) {
          uVar28 = iVar26 >> 3;
        }
        iVar26 = iVar18 + 0xe;
        if (-1 < iVar18 + 7) {
        ...
        local_58 = (BIGNUM *)CRYPTO_malloc(num,"ecparam.c",0x21a);
        if (local_58 != (BIGNUM *)0x0) {
          ecparam_print_var(bp,local_60,&DAT_0012c0a8,iVar11,local_58);
          ecparam_print_var(bp,local_64,&DAT_0012c0b0,iVar11,local_58);
          ecparam_print_var(bp,local_6c,&DAT_0012c0b8,iVar11,local_58);
