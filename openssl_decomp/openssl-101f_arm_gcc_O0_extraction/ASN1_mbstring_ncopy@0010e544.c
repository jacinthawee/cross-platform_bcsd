...

{
  ...
  case 0x1000:
    if (len != 0) {
      ...
      do {
        ...
        if (iVar5 < 0) {
          ERR_put_error(0xd,0x7a,0x86,"a_mbstr.c",0x84);
          iVar5 = -1;
          goto LAB_0010e75e;
        }
        uVar9 = uVar9 - iVar5;
  ...
  case 0x1002:
    if ((len & 1U) != 0) {
      ERR_put_error(0xd,0x7a,0x81,"a_mbstr.c",0x6f);
      iVar5 = -1;
      goto LAB_0010e75e;
    }
    uVar10 = len >> 1;
    break;
  default:
    ERR_put_error(0xd,0x7a,0xa0,"a_mbstr.c",0x8e);
    iVar5 = -1;
    goto LAB_0010e75e;
  case 0x1004:
    if ((len & 3U) != 0) {
      ERR_put_error(0xd,0x7a,0x85,"a_mbstr.c",0x78);
      iVar5 = -1;
      goto LAB_0010e75e;
    }
    uVar10 = len >> 2;
...
joined_r0x0010e5aa:
      do {
        if (uVar9 == 0) {
          ...
          if (out == (ASN1_STRING **)0x0) goto LAB_0010e75e;
          str = *out;
          if (str == (ASN1_STRING *)0x0) {
            str = ASN1_STRING_type_new(iVar5);
            line = 0xc5;
            if (str == (ASN1_STRING *)0x0) goto LAB_0010ea90;
            bVar3 = true;
            *out = str;
          }
          else {
          ...
          if (inform == iVar6) {
            ...
            line = 0xcd;
            if (iVar6 == 0) goto LAB_0010ea90;
            goto LAB_0010e75e;
          }
          switch(iVar6) {
          case 0x1000:
            goto switchD_0010e69c_caseD_1000;
          case 0x1001:
            iVar6 = uVar10 + 1;
            pcVar11 = cpy_asc + 1;
            goto LAB_0010e83a;
...
LAB_0010e774:
        ...
        if ((int)(mask << 0x14) < 0) {
          ...
          goto joined_r0x0010e5aa;
        }
LAB_0010e648:
      } while (mask != 0);
      ERR_put_error(0xd,0x7a,0x7c,"a_mbstr.c",0xa2);
      iVar5 = -1;
    }
    else {
  ...
  goto LAB_0010e75e;
switchD_0010e69c_caseD_1000:
  iVar6 = 1;
  uVar10 = len;
  if (len == 0) goto LAB_0010e92a;
  if (inform == 0x1001) {
    uVar10 = 0;
    uVar9 = len;
    pbVar7 = in;
...
LAB_0010e92a:
  pcVar11 = cpy_utf8 + 1;
LAB_0010e83a:
  local_50 = (uchar *)CRYPTO_malloc(iVar6,"a_mbstr.c",0xea);
