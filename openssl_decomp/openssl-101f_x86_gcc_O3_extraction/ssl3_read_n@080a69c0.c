...

{
  ...
  if ((((iVar4 != 0xfeff) && (iVar4 = SSL_version(param_1), iVar4 != 0x100)) || ((int)__n < 1)) ||
     (iVar4 = 0, (int)param_2 <= (int)__n)) {
    if ((int)__n < (int)param_2) {
      ...
      if ((param_1->read_ahead == 0) || ((int)param_3 < (int)param_2)) {
        local_24 = param_2;
      }
      ...
      while( true ) {
        ...
        *piVar6 = 0;
        ...
        if ((int)sVar7 < 1) goto LAB_080a6bde;
        __n = __n + sVar7;
        iVar4 = SSL_version(param_1);
