...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_08129fd3;
LAB_0812a130:
      line = 0xcb;
      iVar2 = 0x83;
    }
...
LAB_08129f6f:
      if (impl == (ENGINE *)0x0) {
        ...
        if (impl != (ENGINE *)0x0) goto LAB_08129f8b;
...
LAB_08129fa6:
        ...
        ctx->flags = 0;
        ctx->key_len = iVar2;
        if ((bVar9 & 0x40) == 0) goto LAB_08129fd3;
...
switchD_0812a072_caseD_6:
    iVar2 = 0;
  }
  else {
    if (pEVar3 == (EVP_CIPHER *)0x0) {
      if (cipher == (EVP_CIPHER *)0x0) goto LAB_0812a130;
      goto LAB_08129f6f;
    }
    if ((cipher != (EVP_CIPHER *)0x0) && (cipher->nid != pEVar3->nid)) goto LAB_08129ee1;
LAB_08129fd3:
