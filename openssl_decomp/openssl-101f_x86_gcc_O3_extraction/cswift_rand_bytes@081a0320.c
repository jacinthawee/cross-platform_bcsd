  ...
  if (iVar1 == 0) {
    if (0x3ff < (int)param_2) {
      do {
        ...
        if (iVar1 != 0) {
          ...
          ERR_put_error(CSWIFT_lib_error_code,0x6c,0x6b,"e_cswift.c",0x433);
          puVar3 = local_420;
          goto LAB_081a046e;
        }
    ...
    if (param_2 != 0) {
      ...
      if (iVar1 == 0) {
        ...
        ERR_put_error(CSWIFT_lib_error_code,0x6c,0x6b,"e_cswift.c",0x443);
        puVar3 = local_434;
LAB_081a046e:
        uVar4 = 0;
    ...
    uVar4 = 0;
    ERR_put_error(CSWIFT_lib_error_code,0x6c,0x6c,"e_cswift.c",0x41d);
  }
