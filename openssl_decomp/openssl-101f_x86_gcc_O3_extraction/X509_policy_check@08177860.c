...
LAB_08177bd0:
      ...
      if (tree != (void **)0x0) {
        tree[5] = (void *)0x0;
        pvVar7 = CRYPTO_malloc((int)pvVar3 << 4,"pcy_tree.c",0xe4);
        *tree = pvVar7;
        tree[1] = (void *)0x0;
        tree[2] = (void *)0x0;
        tree[3] = (void *)0x0;
          ...
          if ((iVar16 == 0) || (iVar16 = level_add_node(ppvVar21,iVar16,0,tree), iVar16 == 0)) {
            ...
            if (-1 < iVar4) {
              do {
                ...
                CRYPTO_add_lock((int *)((int)pvVar3 + 0x10),1,3,"pcy_tree.c",0x102);
                ppvVar21[4] = pvVar3;
                if (*piVar9 == 0) {
                    ...
                    if (puVar11 != puVar6) {
                      for (iVar4 = 0; iVar15 = sk_num(p_Var14), iVar4 < iVar15; iVar4 = iVar4 + 1) {
                        ...
                        if (iVar15 == 0) {
                          ...
                          if (puVar11 == (uint *)0x0) goto LAB_08177a88;
...
LAB_08178008:
              ...
              if (puVar22[-2] != 0) goto code_r0x0817804b;
              sk_free((_STACK *)tree[3]);
              sk_pop_free((_STACK *)tree[4],exnode_free);
              ppXVar17 = (X509 **)*tree;
              iVar4 = 0;
              ...
              CRYPTO_free(*tree);
              CRYPTO_free(tree);
              if (*pexplicit_policy != 0) goto LAB_08178263;
              goto LAB_08177ba3;
            }
LAB_08178066:
                  ...
                  for (iVar15 = 0; iVar23 = sk_num((_STACK *)puVar13[5]), iVar15 < iVar23;
                    ...
                    if (*(int *)((int)pvVar3 + 4) == iVar4) {
                      if (*pp_Var20 == (_STACK *)0x0) {
                        ...
                        *pp_Var20 = p_Var14;
                        if (p_Var14 == (_STACK *)0x0) goto LAB_08177a88;
                      }
                      else {
                        iVar23 = sk_find(*pp_Var20,pvVar3);
                        if (iVar23 != -1) goto LAB_081780d0;
                        p_Var14 = *pp_Var20;
                      }
                      iVar23 = sk_push(p_Var14,pvVar3);
                      if (iVar23 == 0) goto LAB_08177a88;
                    }
LAB_081780d0:
                  }
                  local_50 = local_50 + 1;
...
LAB_08177930:
          iVar15 = iVar1;
          iVar16 = iVar16 + -1;
          if (iVar16 == -1) goto LAB_08177980;
        }
        iVar1 = *(int *)(iVar5 + 0xc);
        iVar15 = iVar15 - (uint)((x->ex_flags & 0x20) == 0);
        if ((iVar1 != -1) && (iVar1 < iVar15)) goto LAB_08177930;
        iVar16 = iVar16 + -1;
      } while (iVar16 != -1);
LAB_08177980:
      if (iVar18 == 1) goto LAB_08177bd0;
      if ((iVar18 == 2) && (iVar15 == 0)) {
        *pexplicit_policy = 1;
        iVar4 = -2;
        goto LAB_08177b3e;
      }
      if (iVar18 == 1) goto LAB_08177ba3;
      iVar4 = 1;
      if (iVar18 == 2) goto LAB_08177b3e;
      if (iVar18 != 0) {
        iVar4 = -1;
        goto LAB_08177b3e;
      }
...
code_r0x0817804b:
  ...
  pvVar3 = tree[1];
  puVar22 = puVar19;
  if ((int)pvVar3 <= local_3c) goto LAB_08178066;
  goto LAB_08177db8;
}
