...

{
  ...
  if ((0 < iVar4) && (iVar4 = BIO_write(bp,"    Data:\n",10), 0 < iVar4)) {
    ...
    if (((((0 < iVar4) && (iVar4 = BIO_printf(bp,"        Subject:%c",0x20), 0 < iVar4)) &&
       ...
       ((iVar4 = BIO_printf(bp,"%12sPublic Key Algorithm: ",&DAT_081ec74a), 0 < iVar4 &&
          ...
          for (; iVar4 = sk_num(p_Var6), iVar13 < iVar4; iVar13 = iVar13 + 1) {
            ...
            if (iVar4 == 0) {
              ...
              while( true ) {
                ...
                if (0 < iVar4) {
                  do {
                    iVar7 = BIO_write(bp,&DAT_081f84a7,1);
                    if (iVar7 != 1) goto LAB_081443a0;
                    iVar4 = iVar4 + -1;
                  } while (iVar4 != 0);
                }
                iVar7 = BIO_puts(bp,":");
                ...
                if ((local_24 + -0x13 < (char *)0x2) || (local_24 == (char *)0x16)) {
                  ...
                  if (pcVar9 != *local_28) goto LAB_081443a0;
                  BIO_puts(bp,"\n");
                }
                else {
...
LAB_08144617:
        ...
        if (p_Var6 != (_STACK *)0x0) {
          ...
          for (iVar4 = 0; iVar13 = sk_num(p_Var6), iVar4 < iVar13; iVar4 = iVar4 + 1) {
            ...
            iVar13 = BIO_printf(bp,"%12s",&DAT_081ec74a);
            if (iVar13 < 1) goto LAB_081443a0;
            ...
            iVar13 = BIO_write(bp,&DAT_081f11d3,1);
            if (iVar13 < 1) goto LAB_081443a0;
          }
