...

{
  ...
  if (ppVar13 == (pitem *)0x0) {
    ...
    *param_4 = 1;
    ...
    iVar6 = *(int *)(puVar5 + 4);
    uVar17 = *(uint *)(puVar5 + 0x10);
    pdVar15 = param_1->d1;
    param_1->init_num = iVar16 + iVar6;
    uVar2 = *(undefined2 *)(puVar5 + 8);
    uVar1 = *puVar5;
    (pdVar15->w_msg_hdr).is_ccs = uVar17;
    *(int *)&(pdVar15->w_msg_hdr).seq = iVar6;
    (pdVar15->w_msg_hdr).frag_len = 0;
    *(undefined2 *)&(pdVar15->w_msg_hdr).frag_off = uVar2;
    *(undefined *)&(pdVar15->w_msg_hdr).msg_len = uVar1;
