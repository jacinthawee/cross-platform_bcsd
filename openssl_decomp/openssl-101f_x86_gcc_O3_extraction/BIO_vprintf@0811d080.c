...
LAB_0811d211:
      ...
      local_84c = uVar15 + 1;
      puVar7[uVar15] = bVar19;
      bVar19 = *local_880;
      local_880 = local_880 + 1;
      if (bVar19 == 0) goto LAB_0811d118;
    }
    bVar19 = *local_880;
    if (bVar19 != 0) {
      local_874 = 0;
...
switchD_0811d320_caseD_1:
  ...
  if ((char)uVar15 == '.') {
    ...
    while( true ) {
      ...
      local_888 = (int *)((char)bVar19 + -0x30 + (int)local_888 * 10);
      bVar19 = *local_880;
      pbVar20 = local_880;
      if (bVar19 == 0) goto LAB_0811d118;
    }
...
LAB_0811db6a:
  ...
  case 0x53:
    ...
    if (iVar8 == 2) {
      ...
      piVar22 = (int *)(uint)*(ushort *)local_884;
      local_884 = (double *)((int)local_884 + 4);
      piVar17 = (int *)0x0;
    }
    else {
...
LAB_0811d564:
    fmtint(&local_854,piVar22,piVar17,uVar10,local_878,local_888,local_874);
    pdVar1 = local_884;
    break;
  case 0x3e:
    piVar22 = *(int **)local_884;
...
LAB_0811d967:
    ...
    if (local_858 == (undefined *)0x0) {
      local_850[local_84c] = (char)piVar22;
      local_84c = local_84c + 1;
    }
    else {
      local_858[local_84c] = (char)piVar22;
      local_84c = local_84c + 1;
    }
    break;
  case 0x3f:
  case 0x44:
    if (iVar8 == 2) {
      ...
      piVar22 = (int *)(int)*(short *)local_884;
      local_884 = (double *)((int)local_884 + 4);
      piVar17 = (int *)((int)piVar22 >> 0x1f);
    }
    else {
  ...
  case 0x41:
    ...
    do {
      ...
      iVar12 = iVar21 + 1;
      iVar13 = iVar8 / 10;
      local_848[iVar21] = "0123456789abcdef"[iVar8 % 10];
      iVar8 = iVar13;
    ...
    (acStack_835 + 1)[(int)piVar22] = '\0';
    iVar8 = (int)local_870 - (int)piVar22;
    if (iVar8 < 0) {
      iVar8 = 0;
    }
...
LAB_0811d875:
    ...
    if ((local_870 != (int *)0x0) || ((local_874 & 8) != 0)) {
      ...
      do {
        ...
        doapr_outch(&local_854,(int)(acStack_835 + 1)[(int)piVar22]);
  ...
  case 0x4e:
    pdVar1 = (double *)((int)local_884 + 4);
    pcVar18 = *(char **)local_884;
    if ((int)local_888 < 0) {
      local_888 = (int *)0x7fffffff;
    }
    bVar4 = piVar22 != (int *)0x0;
...
LAB_0811da87:
      ...
      do {
        ...
        cVar14 = *(char *)((int)pcVar18 + (iVar16 - iVar8));
        iVar12 = (int)cVar14;
