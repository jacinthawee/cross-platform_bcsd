...

{
  ...
  if (((count & 0xfffffff7) != 0x14) && (uVar3 = 0, count != 0x20)) goto LAB_0810dfe0;
  if (param_4 == (EVP_MD *)0x0) {
    local_10c = EVP_sha1();
  }
  uVar13 = 0x200;
  if (param_2 < 0x200) {
    if (param_6 == 0) goto LAB_0810e3b5;
LAB_0810e02a:
    if (count <= param_6) goto LAB_0810e3b5;
    local_110 = param_6;
    if (count <= param_6) {
      local_110 = count;
    }
    ...
    if (param_6 != 0) goto LAB_0810e02a;
LAB_0810e3b5:
    if (count <= param_6) {
      param_6 = count;
    }
  ...
  if (ctx != (BN_CTX *)0x0) {
    ...
    if (mont != (BN_MONT_CTX *)0x0) {
      ...
      if (iVar7 != 0) {
        ...
        iVar7 = (count - 4 >> 2) + 1;
        local_cc = 0;
        while (iVar8 = BN_GENCB_call(param_10,0,local_cc), iVar8 != 0) {
          if (local_110 == 0) {
            RAND_pseudo_bytes(local_60,count);
          }
          ...
          iVar8 = EVP_Digest(local_60,count,(uchar *)&local_a0,(uint *)0x0,local_10c,(ENGINE *)0x0);
          if ((iVar8 == 0) ||
             (iVar8 = EVP_Digest(acStack_42 + 2,count,(uchar *)&local_80,(uint *)0x0,local_10c,
          ...
          if (count != 0) {
            if (uVar1 < 3) {
              ...
              uVar11 = iVar7 * 4;
              if (count == iVar7 * 4) goto LAB_0810e339;
            }
...
LAB_0810e339:
          ...
          iVar8 = BN_is_prime_fasttest_ex(ret,0x32,ctx,(uint)(local_110 == 0),param_10);
          if (0 < iVar8) {
            ...
            if ((iVar8 != 0) && (iVar8 = BN_GENCB_call(param_10,3,0), iVar8 != 0)) {
              ...
              do {
                ...
                do {
                  ...
                  iVar10 = EVP_Digest(acStack_42 + 2,count,(uchar *)&local_a0,(uint *)0x0,local_10c,
                                      (ENGINE *)0x0);
                  if ((((iVar10 == 0) ||
                       (pBVar6 = BN_bin2bn((uchar *)&local_a0,count,pBVar4), pBVar6 == (BIGNUM *)0x0
                       )) || (iVar10 = BN_lshift(pBVar4,pBVar4,iVar8), iVar10 == 0)) ||
                     (iVar10 = BN_add(pBVar5,pBVar5,pBVar4), iVar10 == 0)) goto LAB_0810e640;
                  local_110 = local_110 + 1;
                  iVar8 = iVar8 + (param_3 & 0xfffffff8);
                } while ((int)local_110 <= (int)(uVar13 / 0xa0));
                ...
                local_d0 = local_d0 + 1;
                if (local_d0 == 0x1000) goto LAB_0810e388;
                iVar8 = BN_GENCB_call(param_10,0,local_d0);
                if (iVar8 == 0) break;
              } while( true );
            }
            break;
