            ...
            if (0 < iVar16) {
              ...
              do {
                ...
                local_160 = local_40[uVar6 >> 0x1b & 7] << 0x1b ^
                            ...
                            local_40[uVar6 >> 0x12 & 7] << 0x12 ^
                            local_40[uVar6 >> 0x15 & 7] << 0x15 ^
      ...
      if (*param_4 == 0) {
        ...
        if (param_1 != pBVar5) {
          if (param_1->dmax < iVar12) {
            ...
            if (pBVar8 == (BIGNUM *)0x0) goto LAB_081e0a3a;
            iVar12 = pBVar5->top;
          }
          if (0 < iVar12) {
            puVar2 = pBVar5->d;
...
LAB_081e0b31:
  ...
  if (iVar4 != *(int *)(in_GS_OFFSET + 0x14)) goto LAB_081e0b31;
  local_30 = 0x81dfd00;
  BN_CTX_start(param_5);
  local_30 = 0x81dfd0a;
  pBVar5 = BN_CTX_get(param_5);
...
LAB_081dfd2a:
    ...
    if (-1 < iVar12) {
      ...
      do {
        ...
        puVar2[iVar12 * 2] =
             ...
             *(uint *)(SQR_tb + (uVar1 & 0xf) * 4) | *(int *)(SQR_tb + (uVar1 >> 4 & 0xf) * 4) << 8;
        iVar12 = iVar12 + -1;
      } while (iVar12 != -1);
      iVar4 = param_2[1];
    }
    ...
    if (pBVar5 != param_1) {
      if (param_1->dmax < iVar4) {
        ...
        if (pBVar8 == (BIGNUM *)0x0) goto LAB_081dfea9;
        iVar4 = pBVar5->top;
      }
      if (0 < iVar4) {
        puVar2 = pBVar5->d;
