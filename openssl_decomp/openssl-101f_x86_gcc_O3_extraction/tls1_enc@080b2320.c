...
LAB_080b24d0:
        if ((param_1[0x30] == 0) || (local_48 == (EVP_CIPHER *)0x0)) goto LAB_080b2483;
        uVar11 = puVar10[1];
        ...
        if ((uVar5 & 0x200000) == 0) {
          ...
          if (param_2 == 0) {
            ...
            if ((local_4c != 0xfeff) && (local_4c != 0x100)) goto LAB_080b253c;
...
LAB_080b27a3:
            ...
            if ((local_4c == 0x100) || (local_4c == 0xfeff)) {
...
LAB_080b253c:
          ...
          if (param_2 != 0) {
            ...
            local_44 = uVar11 + iVar4;
LAB_080b25fc:
            if (param_2 != 0) goto LAB_080b2691;
          }
          local_4c = 0;
          if ((local_44 == 0) || (local_44 % uVar7 != 0)) goto LAB_080b24a4;
        }
LAB_080b2691:
