...

{
  ...
  if (uVar1 < 6) {
    BIO_printf(param_1,"%s\n",*(undefined4 *)(status_map_14092 + uVar1 * 4));
  }
  else {
  ...
  a = param_2[2];
  if ((a != (ASN1_BIT_STRING *)0x0) && (-1 < failure_map_14093._0_4_)) {
    puVar4 = failure_map_14093;
    iVar2 = 0;
    iVar3 = failure_map_14093._0_4_;
    do {
