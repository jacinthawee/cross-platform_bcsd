      ...
      if ((uVar7 & 8) == 0) {
        if (param_1->parent == (X509_STORE_CTX *)0x0) {
          ...
          if (iVar6 != 0) {
            ...
            if (local_b4 == 1) goto LAB_08161b03;
          }
        }
        param_1->error = 0x36;
        iVar6 = (*param_1->verify_cb)(0,param_1);
...
LAB_08161968:
      ...
      if (s != (ASN1_TIME *)0x0) {
        ...
        if (iVar6 == 0) {
          ...
          if ((-1 < iVar6) || ((*(byte *)&param_1->current_crl_score & 2) != 0)) goto LAB_081619b5;
