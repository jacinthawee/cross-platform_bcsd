...

{
  ...
  if ((a->type == 0x10) && (pAVar1 = (a->value).asn1_string, pAVar1 != (ASN1_STRING *)0x0)) {
    ...
    if (a_00 == (ASN1_INTEGER *)0x0) goto LAB_08153d98;
    ...
    if (a_01 == (ASN1_OCTET_STRING *)0x0) goto LAB_08153d9a;
    ...
    if (bVar5) {
      sVar4 = 0xffffffff;
      ERR_put_error(0xd,0x86,0x6d,"evp_asn1.c",0xb7);
    }
    else {
      if (num != (long *)0x0) {
...
LAB_08153d9a:
    sVar4 = 0xffffffff;
    ERR_put_error(0xd,0x86,0x6d,"evp_asn1.c",0xb7);
    if (a_00 == (ASN1_INTEGER *)0x0) goto LAB_08153d7a;
  }
