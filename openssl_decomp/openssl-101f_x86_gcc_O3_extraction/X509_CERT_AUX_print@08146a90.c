...

{
  ...
  if (x == (X509_CERT_AUX *)0x0) goto LAB_08146c1e;
  if (x->trust == (stack_st_ASN1_OBJECT *)0x0) {
    BIO_printf(bp,"%*sNo Trusted Uses.\n",indent,&DAT_081ec74a);
    if (x->reject != (stack_st_ASN1_OBJECT *)0x0) goto LAB_08146c5c;
LAB_08146d28:
    BIO_printf(bp,"%*sNo Rejected Uses.\n",indent,&DAT_081ec74a);
  }
  else {
    BIO_printf(bp,"%*sTrusted Uses:\n%*s",indent,&DAT_081ec74a,indent + 2,&DAT_081ec74a);
    bVar2 = true;
    ...
    BIO_puts(bp,"\n");
    if (x->reject == (stack_st_ASN1_OBJECT *)0x0) goto LAB_08146d28;
LAB_08146c5c:
  ...
  if (x->alias != (ASN1_UTF8STRING *)0x0) {
    BIO_printf(bp,"%*sAlias: %s\n",indent,&DAT_081ec74a,x->alias->data);
  }
  if (x->keyid != (ASN1_OCTET_STRING *)0x0) {
    BIO_printf(bp,"%*sKey Id: ",indent,&DAT_081ec74a);
    if (0 < x->keyid->length) {
      iVar7 = 0;
