...

{
  ...
  if (it == (ASN1_ITEM *)0x0) {
    ...
    if (iVar3 < 2) goto LAB_081482a9;
    if (iVar3 == 5) goto LAB_08148265;
    if (iVar3 == 6) goto LAB_08148259;
  }
  else {
    if ((it->funcs != (void *)0x0) &&
       (UNRECOVERED_JUMPTABLE = *(code **)((int)it->funcs + 0xc),
       UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x08148230. Too many branches */
...
LAB_081483cc:
                      ...
                      if (pcVar2 != (char *)0x6) goto LAB_081483cc;
                      ASN1_OBJECT_free(a);
                    }
                    a_01->ln = (char **)0x0;
                    a_01 = (ASN1_OBJECT *)a_00->ln;
...
LAB_08148390:
              ...
              if (pcVar2 != (char *)0x6) goto LAB_08148390;
