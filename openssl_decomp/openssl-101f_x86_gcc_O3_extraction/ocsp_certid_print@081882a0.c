...

{
  ...
  BIO_printf(param_1,"%*sHash Algorithm: ",iVar1,&DAT_081ec74a);
  i2a_ASN1_OBJECT(param_1,*(ASN1_OBJECT **)*param_2);
  BIO_printf(param_1,"\n%*sIssuer Name Hash: ",iVar1,&DAT_081ec74a);
  i2a_ASN1_STRING(param_1,(ASN1_STRING *)param_2[1],4);
  BIO_printf(param_1,"\n%*sIssuer Key Hash: ",iVar1,&DAT_081ec74a);
  i2a_ASN1_STRING(param_1,(ASN1_STRING *)param_2[2],4);
  BIO_printf(param_1,"\n%*sSerial Number: ",iVar1,&DAT_081ec74a);
