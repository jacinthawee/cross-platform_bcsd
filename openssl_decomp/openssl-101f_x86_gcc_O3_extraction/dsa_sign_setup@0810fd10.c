...
LAB_0810ff70:
        pBVar6 = BN_MONT_CTX_set_locked
                           ((BN_MONT_CTX **)(param_1 + 0x2c),(int)(BN_MONT_CTX **)(param_1 + 0x2c),
                            (BIGNUM *)&DAT_00000008,*(BN_CTX **)(param_1 + 0xc));
        if (pBVar6 != (BN_MONT_CTX *)0x0) {
          if ((*(byte *)(param_1 + 0x28) & 2) != 0) goto LAB_0810feba;
          goto LAB_0810fe54;
        }
      }
    }
    else {
      if ((uVar1 & 1) != 0) goto LAB_0810ff70;
LAB_0810feba:
