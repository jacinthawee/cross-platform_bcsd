...
LAB_0818dc2c:
  ...
  if ((flags & 8) == 0) {
    for (; iVar8 = sk_num(p_Var1), iVar2 < iVar8; iVar2 = iVar2 + 1) {
      ...
      if ((-1 < iVar8) && (iVar8 = CMS_SignerInfo_verify(pCVar5), iVar8 < 1)) goto LAB_0818df06;
    }
  }
  if (dcont == (BIO *)0x0) {
...
LAB_0818dc54:
  st = p_Var7;
  if ((dcont != (BIO *)0x0) && (bVar9)) goto LAB_0818dc78;
LAB_0818de30:
  BIO_free_all(chain);
  goto LAB_0818dc98;
}
