...

{
  ...
  if (param_3 != (EVP_MD *)0x0) {
    ...
    if (iVar2 == tls12_md._0_4_) {
      ...
      puVar3 = (undefined1 *)0x82f3068;
    }
    else if (iVar2 == tls12_md._16_4_) {
      puVar3 = (undefined1 *)0x82f3070;
    }
    else if (iVar2 == tls12_md._24_4_) {
      puVar3 = (undefined1 *)0x82f3078;
    }
    else if (iVar2 == tls12_md._32_4_) {
      puVar3 = (undefined1 *)0x82f3080;
    }
    else {
      if (iVar2 != tls12_md._40_4_) {
        return 0;
      }
      puVar3 = (undefined1 *)0x82f3088;
    }
    iVar2 = *(int *)(puVar3 + 4);
    if (iVar2 != -1) {
      iVar1 = *param_2;
      if (iVar1 == tls12_sig._0_4_) {
        ...
        puVar3 = (undefined1 *)0x82f3048;
      }
      else {
        if (iVar1 != tls12_sig._16_4_) {
          return 0;
        }
        puVar3 = (undefined1 *)0x82f3050;
      }
      if (*(int *)(puVar3 + 4) != -1) {
