    ...
    if (*param_3 == 0) {
      ...
      if (param_2 != pBVar3) {
        ...
        if (pBVar3->dmax < iVar5) {
          ...
          if (pBVar6 == (BIGNUM *)0x0) goto LAB_081e1ea6;
          iVar5 = param_2->top;
        }
        if (0 < iVar5) {
          puVar1 = pBVar3->d;
    ...
    if ((*(byte *)param_3 & 1) == 0) {
      ...
      if (pBVar8 != (BIGNUM *)0x0) {
        ...
        do {
          ...
          if (pBVar9 == (BIGNUM *)0x0) goto LAB_081e1ea6;
          iVar5 = *param_3;
          if (1 < iVar5) {
            local_2c = 1;
            do {
              ...
              if ((((iVar5 == 0) ||
                 ...
                 || ((iVar5 = BN_GF2m_add(a,a,pBVar8), iVar5 == 0 ||
                     (iVar5 = BN_GF2m_add(a_00,pBVar7,pBVar6), iVar5 == 0)))) goto LAB_081e1ea6;
              local_2c = local_2c + 1;
              iVar5 = *param_3;
            } while (local_2c < iVar5);
          }
          if (a_00->top != 0) goto LAB_081e2116;
          local_20 = local_20 + -1;
        } while (local_20 != 0);
        iVar4 = 0x3ec;
        iVar5 = 0x71;
        ...
        if (2 < *param_3) {
          ...
          do {
            ...
            if (((iVar4 == 0) || (iVar4 = BN_GF2m_mod_sqr_arr(a,a,param_3,param_4), iVar4 == 0)) ||
               (iVar4 = BN_GF2m_add(a,a,pBVar3), iVar4 == 0)) goto LAB_081e1ea6;
            iVar5 = iVar5 + 1;
