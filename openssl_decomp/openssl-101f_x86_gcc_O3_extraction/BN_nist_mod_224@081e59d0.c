...

{
  ...
  if (uVar2 == 0) {
    iVar5 = a->top;
    puVar6 = a->d;
    iVar1 = BN_ucmp(a,(BIGNUM *)_bignum_nist_p_224_sqr_6132);
    if (iVar1 < 0) {
      ...
      rp = puVar6;
      if (a != r) {
        if ((r->dmax < 7) && (pBVar3 = bn_expand2(r,7), pBVar3 == (BIGNUM *)0x0)) goto LAB_081e5a34;
        rp = r->d;
        *rp = *puVar6;
        rp[1] = puVar6[1];
        rp[2] = puVar6[2];
      ...
      *rp = uVar2 - local_48;
      ...
      if (((int)uVar2 >> 0x1f < 0) || (uVar2 == 0)) {
        ...
        if (((int)uVar2 >> 0x1f | uVar2) != 0) {
          ...
          uVar4 = -uVar7;
          local_8c = (code *)(uVar4 & 0x290 ^ 0x80fddf0);
        }
      }
      else {
        local_8c = bn_sub_words;
