...

{
  ...
  if ((*(int *)(param_1_00[0x16] + 0x18c) != 0) &&
...
LAB_080a71fe:
    local_30 = 0;
    if ((iVar5 == 0 | param_2) == 0) goto LAB_080a7218;
LAB_080a7079:
    if (param_2 == 0) goto LAB_080a7243;
...
LAB_080a708e:
    ...
    *(uint *)(iVar6 + 0x104) = -iVar5 & 7U;
    ...
    if (param_2 != 0) goto LAB_080a7079;
LAB_080a7218:
...
LAB_080a7243:
  ...
  *(int *)(iVar9 + 0x130) = param_2_00;
  ...
  if ((param_1_00[0xd] == 0x1111) && (param_1_00[100] == 0)) {
    iVar5 = *param_1_00;
    if ((iVar5 >> 8 != 3) || (iVar5 < 0x302)) goto LAB_080a70c5;
    uVar2 = 1;
  }
  else {
    iVar5 = *param_1_00;
...
LAB_080a70ec:
    ...
    if ((uVar7 & 0xf0007) == 2) {
      ...
      if (local_2c < 2) goto LAB_080a70ec;
    }
    else {
      if ((uVar7 & 0xf0007) != 6) goto LAB_080a70ec;
      local_2c = 8;
    }
  }
...
LAB_080a73c2:
  ...
  *(undefined **)(iVar9 + 0x13c) = puVar1;
  ...
  (***(code ***)(param_1_00[2] + 100))(param_1_00,1);
