  ...
  if (((cflag & 1) != 0) ||
    ...
    if (((cflag & 0x40) != 0) ||
      ...
      if ((cflag & 0x80) == 0) {
        ...
        if (((iVar4 < 1) ||
            (iVar4 = BIO_printf(bp,"%12sPublic Key Algorithm: ",&DAT_081ec74a), iVar4 < 1)) ||
           ((iVar4 = i2a_ASN1_OBJECT(bp,pXVar2->pubkey->algor->algorithm), iVar4 < 1 ||
            (iVar4 = BIO_puts(bp,"\n"), iVar4 < 1)))) goto LAB_08143c66;
      ...
      if ((cflag & 0x800) == 0) {
        ...
        if (iVar4 == 0) {
          ...
          for (; iVar4 = sk_num(p_Var6), iVar7 < iVar4; iVar7 = iVar7 + 1) {
            ...
            if (iVar4 == 0) {
              iVar4 = BIO_printf(bp,"%12s",&DAT_081ec74a);
              if (iVar4 < 1) goto LAB_08143c66;
              ...
              while( true ) {
                ...
                if (0 < iVar4) {
                  do {
                    iVar9 = BIO_write(bp,&DAT_081f84a7,1);
                    if (iVar9 != 1) goto LAB_08143c66;
                    iVar4 = iVar4 + -1;
                  } while (iVar4 != 0);
                }
                iVar9 = BIO_puts(bp,":");
                ...
                if ((local_24 + -0x13 < (char *)0x2) || (local_24 == (char *)0x16)) {
                  ...
                  if (pcVar8 != *local_28) goto LAB_08143c66;
                  BIO_puts(bp,"\n");
                }
                else {
...
LAB_081440a1:
      ...
      if (((cflag & 0x100) == 0) &&
        ...
        for (iVar4 = 0; iVar7 = sk_num(p_Var6), iVar4 < iVar7; iVar4 = iVar4 + 1) {
          ...
          iVar7 = BIO_printf(bp,"%12s",&DAT_081ec74a);
          if (iVar7 < 1) goto LAB_08143c66;
          ...
          if (iVar7 == 0) {
            BIO_printf(bp,"%16s",&DAT_081ec74a);
