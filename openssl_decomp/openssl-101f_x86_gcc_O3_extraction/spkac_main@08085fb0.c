...

{
  ...
  if (iVar6 != 0) {
    ...
    if (0 < local_60) {
      ...
      pbVar9 = (byte *)0x0;
      local_4c = (byte *)0x0;
      local_40 = (byte *)0x822e390;
      local_44 = (byte *)0x8227806;
      local_58 = (byte *)0x0;
      local_5c = (byte *)0x0;
      bVar3 = false;
      bVar1 = false;
...
LAB_080860a9:
      ...
      if (bVar15) {
        ...
        if (!bVar15) goto LAB_080860b0;
        local_60 = local_60 + -1;
        if (local_60 == 0) goto LAB_080860f7;
        pbVar9 = ppbVar7[1];
        ppbVar7 = ppbVar7 + 1;
      }
      else {
LAB_080860b0:
        ...
        if (bVar13) {
          if (local_60 == 1) goto LAB_080860f7;
          local_60 = local_60 + -2;
          local_5c = ppbVar7[1];
          ppbVar7 = ppbVar7 + 2;
          goto joined_r0x080860e9;
        }
        iVar6 = 8;
        pbVar10 = pbVar11;
        pbVar12 = (byte *)"-passin";
...
LAB_0808609f:
      ...
      bVar5 = bVar4;
joined_r0x080860e9:
      if (local_60 == 0) goto LAB_080860eb;
      goto LAB_080860a9;
    }
    local_44 = (byte *)0x8227806;
    bVar1 = false;
