...

{
  ...
  do {
    iVar4 = open(*(char **)(randomfiles_9965 + uVar5 * 4),0x900);
    if (-1 < iVar4) {
  ...
  if (egdsockets_9969._0_4_ == (char *)0x0) {
LAB_081c950b:
    if (len == 0) goto LAB_081c950f;
  }
  else if ((int)len < 0x20) {
    puVar6 = egdsockets_9969;
    path = egdsockets_9969._0_4_;
    do {
      ...
      path = *(char **)puVar6;
      if (path == (char *)0x0) goto LAB_081c950b;
    } while ((int)len < 0x20);
  }
