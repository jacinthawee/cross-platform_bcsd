...
LAB_080c62e8:
      ...
      if (uVar7 < local_24) goto LAB_080c62e8;
      ...
      if (iVar11 == 0) goto LAB_080c6112;
      line = 0x17e;
      iVar11 = 0x12e;
    }
    ERR_put_error(0x14,0xb5,iVar11,"ssl_sess.c",line);
    iVar11 = CRYPTO_add_lock((int *)(obj->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
    if (iVar11 < 1) {
      SSL_SESSION_free_part_2();
      goto LAB_080c600a;
    }
...
LAB_080c5fc2:
        ...
        *(char **)(obj->krb5_client_princ + 0x40) = pcVar5;
        if (pcVar5 != (char *)0x0) goto LAB_080c6136;
        iVar11 = 0x187;
      }
      iVar3 = 0x44;
    }
...
LAB_080c60af:
    ...
    iVar3 = CRYPTO_add_lock((int *)(obj->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
    if (iVar3 < 1) {
      iVar3 = 0;
      SSL_SESSION_free_part_2();
      goto LAB_080c600a;
