...
LAB_080601f0:
        ...
        if (bVar18) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_080601f0;
          ppbVar15 = param_2 + 2;
...
LAB_0806010e:
  ...
  if ((a == (BIO *)0x0) || (bp == (BIO *)0x0)) {
    ...
    if (bp == (BIO *)0x0) goto LAB_080602e2;
    uVar14 = 1;
    dsa = (DSA *)0x0;
  }
  else {
...
LAB_08060034:
      ...
      if (bVar4) {
        ...
        if (local_4c < 1) goto LAB_08060088;
        local_2c.ver = 2;
...
LAB_0806054c:
        ...
        if (bVar6) {
          ...
          to = (uchar *)CRYPTO_malloc((iVar9 >> 3) + 0x14,"dsaparam.c",0x16a);
          if (to == (uchar *)0x0) {
            uVar14 = 1;
          ...
          if (0 < iVar9) {
            do {
              if (iVar12 == ((iVar12 / 6 + (iVar12 >> 0x1f) >> 1) - (iVar12 >> 0x1f)) * 0xc) {
                __printf_chk(1,&DAT_081ec45f,uVar13);
              }
...
LAB_08060088:
        ...
        if (dsa != (DSA *)0x0) goto LAB_0806054c;
