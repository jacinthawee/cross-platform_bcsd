...
LAB_081a16e8:
    ...
    local_58 = iVar2 >> 3;
    if ((local_58 & 0x1f) == 0) {
      local_54 = (uchar *)CRYPTO_malloc(local_58,"e_cswift.c",0x252);
...
LAB_081a172b:
    ...
    local_54 = (uchar *)CRYPTO_malloc(local_58,"e_cswift.c",0x252);
    if (local_54 == (uchar *)0x0) goto LAB_081a1710;
...
LAB_081a126f:
    ...
    local_50 = iVar2 >> 3;
    if ((local_50 & 0x1f) == 0) {
      local_4c = (uchar *)CRYPTO_malloc(local_50,"e_cswift.c",0x252);
...
LAB_081a1734:
      ...
      local_4c = (uchar *)CRYPTO_malloc(local_50,"e_cswift.c",0x252);
      if (local_4c == (uchar *)0x0) goto LAB_081a1734;
    ...
    local_48 = iVar2 >> 3;
    if ((local_48 & 0x1f) == 0) {
      local_44 = (uchar *)CRYPTO_malloc(local_48,"e_cswift.c",0x252);
...
LAB_081a1751:
      ...
      local_44 = (uchar *)CRYPTO_malloc(local_48,"e_cswift.c",0x252);
      if (local_44 == (uchar *)0x0) goto LAB_081a1751;
    ...
    local_40 = iVar2 >> 3;
    if ((local_40 & 0x1f) == 0) {
      local_3c = (uchar *)CRYPTO_malloc(local_40,"e_cswift.c",0x252);
...
LAB_081a17d8:
      ...
      local_3c = (uchar *)CRYPTO_malloc(local_40,"e_cswift.c",0x252);
      if (local_3c == (uchar *)0x0) goto LAB_081a17d8;
    ...
    local_38 = iVar2 >> 3;
    if ((local_38 & 0x1f) == 0) {
      local_34 = (uchar *)CRYPTO_malloc(local_38,"e_cswift.c",0x252);
      if (local_34 == (uchar *)0x0) goto LAB_081a1866;
