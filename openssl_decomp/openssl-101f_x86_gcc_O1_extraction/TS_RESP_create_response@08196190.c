...
LAB_081963e8:
    ...
    if (a == (ASN1_BIT_STRING *)0x0) {
      ...
      *(ASN1_BIT_STRING **)(iVar5 + 8) = a;
      if (a == (ASN1_BIT_STRING *)0x0) goto LAB_08196364;
    }
    iVar5 = 5;
    goto LAB_08196353;
  }
      ...
      if ((iVar5 == iVar9) && (pEVar10 != (EVP_MD *)0x0)) {
        ...
        if ((pAVar12 == (ASN1_OBJECT *)0x0) ||
           ((iVar22 = OBJ_cmp(pAVar12,(ASN1_OBJECT *)pXVar3), iVar22 == 0 &&
            (pXVar3 = param_1[4], pXVar3 != (X509 *)0x0)))) goto LAB_08196600;
        iVar5 = 1;
        goto LAB_08196595;
      }
      iVar22 = iVar22 + 1;
...
LAB_0819634c:
  ...
  a = ASN1_BIT_STRING_new();
  *(ASN1_BIT_STRING **)(iVar5 + 8) = a;
  if (a != (ASN1_BIT_STRING *)0x0) goto LAB_0819634c;
  goto LAB_08196364;
LAB_08196595:
  iVar22 = sk_num((_STACK *)param_1[3]);
  if (iVar22 <= iVar5 + -1) goto code_r0x081965aa;
  pXVar3 = (X509 *)sk_value((_STACK *)param_1[3],iVar5 + -1);
  iVar22 = OBJ_cmp(pAVar12,(ASN1_OBJECT *)pXVar3);
  if ((iVar22 == 0) && (pXVar3 != (X509 *)0x0)) goto LAB_08196600;
  iVar5 = iVar5 + 1;
  goto LAB_08196595;
LAB_08196600:
  ...
  if ((pXVar13 == (X509 *)0x0) ||
    ...
    if ((iVar5 == 0) ||
      ...
      if ((pXVar3 < (X509 *)0x7) && (ptVar14 = gmtime((time_t *)&local_3c), ptVar14 != (tm *)0x0)) {
        ...
        if (pXVar3 != (X509 *)0x0) {
          BIO_snprintf(pcVar27,(size_t)((int)&pXVar3->cert_info + 2),".%ld",local_40);
          uVar21 = 0xffffffff;
          do {
            if (uVar21 == 0) break;
            uVar21 = uVar21 - 1;
...
LAB_081969e2:
                    ...
                    if (iVar5 < iVar22) goto LAB_081969c0;
...
LAB_08196cd9:
                      ...
                      if (*pp_Var24 == (_STACK *)0x0) {
                        p_Var15 = sk_new_null();
                        *pp_Var24 = p_Var15;
                        if (p_Var15 == (_STACK *)0x0) goto LAB_08196cd9;
                      }
                      pXVar28 = (X509 *)0x0;
...
LAB_08196cba:
                      ...
                      if (iVar5 == 0) goto LAB_08196e78;
                      iVar5 = sk_push(*pp_Var24,pcVar27);
                      if (iVar5 == 0) goto LAB_08196cd9;
...
LAB_08196cae:
                        ...
                        if ((pXVar17 == (X509_NAME *)0x0) ||
                           ...
                           iVar5 = sk_push((_STACK *)(*(X509_ALGOR **)((int)pcVar27 + 4))->algorithm
                                           ,pXVar28), iVar5 == 0)) goto LAB_08196cae;
                        ...
                        if (pAVar23 == (ASN1_STRING *)0x0) goto LAB_08196d2b;
                        iVar5 = sk_push(*pp_Var24,pcVar27);
                        if (iVar5 == 0) goto LAB_08196cd9;
                      }
                      ...
                      pXVar13 = (X509 *)CRYPTO_malloc((int)pXVar3,"ts_rsp_sign.c",0x39d);
                      if (pXVar13 == (X509 *)0x0) {
...
LAB_08196a2b:
              ...
              if (iVar5 != 0) {
                ...
                if (param_1[6] != (X509 *)0x0) {
                  ...
                  if ((int)uVar26 == 0) goto LAB_081968d7;
                }
