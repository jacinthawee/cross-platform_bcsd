...

{
  ...
  if ((uVar1 - 4 & 0xfffffff8) == 0) {
    ...
    if ((param_1 & 1) != 0) {
      if (*(int *)(modes_17455 + param_2 * 4) == 0) {
        *(uint *)(modes_17455 + param_2 * 4) = uVar1;
        return;
      }
    ...
    if ((param_1 & 2) != 0) {
      if (*(uint *)(modes_17455 + param_2 * 4) == 0) {
        pcVar2 = "not locked";
      }
      else {
        if (uVar1 == *(uint *)(modes_17455 + param_2 * 4)) {
          *(undefined4 *)(modes_17455 + param_2 * 4) = 0;
          return;
        }
