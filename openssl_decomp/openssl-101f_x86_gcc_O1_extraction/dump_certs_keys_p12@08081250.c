  ...
  if (st == (_STACK *)0x0) {
    ...
    for (local_50 = 0; iVar6 = sk_num(st), local_50 < iVar6; local_50 = local_50 + 1) {
      ...
      if (iVar6 == 0x15) {
        ...
        if (uVar5 == 0) goto LAB_08081346;
        BIO_printf(bio_err,"PKCS7 Data\n");
        if (local_5c != (_STACK *)0x0) goto LAB_08081351;
LAB_080817ed:
        uVar17 = 0;
        goto LAB_08081686;
      }
...
LAB_08081346:
        if (local_5c == (_STACK *)0x0) goto LAB_080817ed;
LAB_08081351:
...
LAB_08081670:
            ...
            if (iVar7 == 0x96) {
              ...
              if ((param_5 & 1) == 0) {
                ...
                pEVar10 = EVP_PKCS82PKEY(pPVar11);
                if (pEVar10 == (EVP_PKEY *)0x0) goto LAB_08081670;
                print_attribs(param_1,pPVar11->attributes,"Key Attributes");
                PEM_write_bio_PrivateKey
                          (param_1,pEVar10,enc,(uchar *)0x0,0,(undefined1 *)0x0,param_6);
                EVP_PKEY_free(pEVar10);
...
LAB_08081580:
            ...
            if ((param_5 & 2) == 0) {
              ...
              if (uVar16 == 0) {
                ...
                if (iVar7 == 0x9e) {
                  ...
                  if (x == (X509 *)0x0) goto LAB_08081670;
            ...
            if (iVar7 != 0x9b) goto LAB_08081580;
            if (uVar5 != 0) {
