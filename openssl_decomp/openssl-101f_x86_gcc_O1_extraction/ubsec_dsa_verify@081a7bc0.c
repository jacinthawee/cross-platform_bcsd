...

{
  ...
  if (local_34.dmax < pBVar15->top) {
    ...
    if (pBVar15 == (BIGNUM *)0x0) {
      ...
      iVar9 = 0;
      ERR_put_error(UBSEC_lib_error_code,0x67,0x65,"e_ubsec.c",0x33d);
      goto LAB_081a7d35;
    }
    pBVar15 = param_4->p;
  }
  ...
  if (iVar8 < 1) {
    ...
    ERR_put_error(UBSEC_lib_error_code,0x67,0x6c,"e_ubsec.c",0x348);
    pDVar16 = DSA_OpenSSL();
    ...
    if (iVar9 == 0) {
      ...
      ERR_put_error(UBSEC_lib_error_code,0x67,0x6a,"e_ubsec.c",0x358);
      (*p_UBSEC_ubsec_close)(iVar8);
      pDVar16 = DSA_OpenSSL();
      iVar9 = (*pDVar16->dsa_do_verify)(param_1,param_2,param_3,param_4);
    }
