...

{
  ...
  bp_00 = BIO_new(type);
  if (bp_00 == (BIO *)0x0) {
    ERR_put_error(0xb,0x7a,7,"t_req.c",0x51);
    return 0;
  }
      ...
      if (0 < iVar4) {
        ...
        if (iVar4 == 0) {
          ...
          for (; iVar4 = sk_num(p_Var6), iVar13 < iVar4; iVar13 = iVar13 + 1) {
            ...
            if (iVar4 == 0) {
              iVar4 = BIO_printf(bp_00,"%12s",&DAT_081ec74a);
              if (iVar4 < 1) goto LAB_081437e0;
              ...
              while( true ) {
                ...
                if (0 < iVar4) {
                  do {
                    iVar7 = BIO_write(bp_00,&DAT_081f84a7,1);
                    if (iVar7 != 1) goto LAB_081437e0;
                    iVar4 = iVar4 + -1;
                  } while (iVar4 != 0);
                }
                ...
                if ((local_24 + -0x13 < (char *)0x2) || (local_24 == (char *)0x16)) {
                  ...
                  if (pcVar9 != *local_28) goto LAB_081437e0;
                  BIO_puts(bp_00,"\n");
                }
                else {
...
LAB_08143a87:
        ...
        if (p_Var6 != (_STACK *)0x0) {
          ...
          for (iVar4 = 0; iVar13 = sk_num(p_Var6), iVar4 < iVar13; iVar4 = iVar4 + 1) {
            ...
            iVar13 = BIO_printf(bp_00,"%12s",&DAT_081ec74a);
            if (iVar13 < 1) goto LAB_081437e0;
            ...
            if (iVar13 == 0) {
              BIO_printf(bp_00,"%16s",&DAT_081ec74a);
              ASN1_STRING_print(bp_00,ex->value);
            }
            iVar13 = BIO_write(bp_00,&DAT_081f11d3,1);
            if (iVar13 < 1) goto LAB_081437e0;
          }
