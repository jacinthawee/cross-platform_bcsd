...

{
  ...
  if (uVar2 == 0) {
    iVar10 = a->top;
    puVar11 = a->d;
    iVar1 = BN_ucmp(a,(BIGNUM *)_bignum_nist_p_256_sqr_6163);
    if (iVar1 < 0) {
      ...
      rp = puVar11;
      if (a != r) {
        if ((r->dmax < 8) && (pBVar3 = bn_expand2(r,8), pBVar3 == (BIGNUM *)0x0)) goto LAB_081e5e9a;
        rp = r->d;
        *rp = *puVar11;
        rp[1] = puVar11[1];
        rp[2] = puVar11[2];
      ...
      *rp = uVar7 - local_48;
      ...
      if (((int)uVar2 >> 0x1f < 0) || (uVar2 == 0)) {
        ...
        if (((int)uVar2 >> 0x1f | uVar2) != 0) {
          ...
          uVar4 = -uVar12;
          local_ac = (code *)(uVar4 & 0x290 ^ 0x80fddf0);
        }
      }
      else {
        local_ac = bn_sub_words;
