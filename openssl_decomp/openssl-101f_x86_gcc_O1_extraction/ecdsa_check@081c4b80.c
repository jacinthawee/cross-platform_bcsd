...
EC_KEY * __regparm1 ecdsa_check(EC_KEY *param_1_00,dup_func *param_1)

{
  ...
  pEVar1 = (EC_KEY *)EC_KEY_get_key_method_data(param_1_00,param_1,ecdsa_data_dup,ecdsa_data_free);
  if (pEVar1 == (EC_KEY *)0x0) {
    key = (EC_KEY *)ECDSA_DATA_new_method_constprop_1();
    if (key != (EC_KEY *)0x0) {
      pEVar2 = (EC_KEY *)
               EC_KEY_insert_key_method_data
                         (key,param_1,(dup_func *)key,ecdsa_data_dup,ecdsa_data_free);
      pEVar1 = key;
