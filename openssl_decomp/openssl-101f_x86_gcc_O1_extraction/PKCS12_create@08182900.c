...

{
  ...
  if ((pkey == (EVP_PKEY *)0x0) || (cert == (X509 *)0x0)) {
    if (cert != (X509 *)0x0) goto LAB_081829f2;
LAB_08182a33:
    iVar9 = 0;
    ...
    if (0 < iVar2) {
      do {
        ...
        if (pPVar1 == (PKCS12_SAFEBAG *)0x0) goto LAB_08182afc;
...
LAB_08182e1f:
        ...
        if (pPVar1 != (PKCS12_SAFEBAG *)0x0) {
          ...
          if (-1 < iVar5) {
            ...
            if (psVar7 == (stack_st_X509_ATTRIBUTE *)0x0) goto LAB_08182dff;
          }
          ...
          if (((name == (char *)0x0) ||
            ...
            sk = local_70;
            if (local_70 == (_STACK *)0x0) goto LAB_08182e1f;
            if (st == (_STACK *)0x0) {
              p_Var8 = sk_new_null();
