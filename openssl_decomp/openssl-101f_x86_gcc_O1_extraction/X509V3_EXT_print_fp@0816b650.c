...
LAB_0816b8b7:
        ...
        if (uVar3 != 0x30000) goto LAB_0816b8b7;
        pAVar4 = (ASN1_VALUE *)
    ...
    if (val == (ASN1_VALUE *)0x0) {
      bVar5 = (flag & 0xf0000U) == 0x10000;
      pAVar4 = val;
      if (!bVar5) goto LAB_0816b838;
      BIO_printf(bio,"%*s<Parse Error>",indent,&DAT_081ec74a);
      goto LAB_0816b8b7;
    }
    if (method->i2s == (X509V3_EXT_I2S)0x0) {
      if (method->i2v == (X509V3_EXT_I2V)0x0) {
        if (method->i2r == (X509V3_EXT_I2R)0x0) goto LAB_0816b7b0;
...
LAB_0816b7b0:
      ...
      BIO_printf(bio,"%*s%s",indent,&DAT_081ec74a,ptr);
