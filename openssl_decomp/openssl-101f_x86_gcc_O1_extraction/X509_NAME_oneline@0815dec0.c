...

{
  ...
  if (buf == (char *)0x0) {
    ...
    iVar6 = BUF_MEM_grow(local_94,200);
    if (iVar6 == 0) {
LAB_0815e231:
      ERR_put_error(0xb,0x74,0x41,"x509_obj.c",0xde);
  ...
  for (local_a8 = 0; iVar6 = sk_num((_STACK *)a->entries), local_a8 < iVar6; local_a8 = local_a8 + 1
    ...
    if ((pAVar4->ln == (char **)0x1b) && (((uint)pcVar5 & 3) == 0)) {
      ...
      if (0 < (int)pcVar5) {
        ...
        if ((local_80[0] | local_80[1] | local_80[2]) != 0) goto LAB_0815dfa5;
      }
      uVar12 = 0;
      local_80[2] = 0;
      local_80[1] = 0;
      local_80[0] = 0;
      local_80[3] = 1;
      if ((int)pcVar5 < 1) goto LAB_0815e1b7;
LAB_0815dfd2:
      pcVar8 = (char *)0x0;
      iVar10 = 0;
      uVar9 = uVar12;
...
LAB_0815dfa5:
      ...
      local_80[0] = 1;
      uVar12 = 1;
      if (0 < (int)pcVar5) goto LAB_0815dfd2;
LAB_0815e1b7:
      iVar10 = 0;
    }
    local_80[3] = 1;
    ...
    if (local_94 == (BUF_MEM *)0x0) {
      pcVar8 = buf;
      if (size <= iVar6) goto LAB_0815e1d9;
    }
    else {
      iVar10 = BUF_MEM_grow(local_94,iVar6 + 1);
      if (iVar10 == 0) goto LAB_0815e231;
