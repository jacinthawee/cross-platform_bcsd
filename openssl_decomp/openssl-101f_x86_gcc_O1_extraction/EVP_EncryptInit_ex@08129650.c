...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_08129783;
LAB_081298e0:
      line = 0xcb;
      iVar2 = 0x83;
    }
...
LAB_0812971f:
      if (impl == (ENGINE *)0x0) {
        ...
        if (impl != (ENGINE *)0x0) goto LAB_0812973b;
...
LAB_08129756:
        ...
        if (iVar2 == 0) {
          ...
          pvVar5 = CRYPTO_malloc(iVar2,"evp_enc.c",0xb3);
        ...
        ctx->flags = 0;
        ctx->key_len = iVar2;
        if ((bVar9 & 0x40) == 0) goto LAB_08129783;
...
switchD_08129822_caseD_6:
    iVar2 = 0;
  }
  else {
    if (pEVar3 == (EVP_CIPHER *)0x0) {
      if (cipher == (EVP_CIPHER *)0x0) goto LAB_081298e0;
      goto LAB_0812971f;
    }
    if ((cipher != (EVP_CIPHER *)0x0) && (cipher->nid != pEVar3->nid)) goto LAB_08129691;
LAB_08129783:
    ...
    if ((uVar4 & 0x10) == 0) {
      ...
      case 5:
        ...
        break;
      default:
        goto switchD_08129822_caseD_6;
      }
    }
    pEVar3 = ctx->cipher;
    if ((key != (uchar *)0x0) || ((*(byte *)&pEVar3->flags & 0x20) != 0)) {
      iVar2 = (*pEVar3->init)(ctx,key,iv,1);
      if (iVar2 == 0) {
        return 0;
      }
      pEVar3 = ctx->cipher;
