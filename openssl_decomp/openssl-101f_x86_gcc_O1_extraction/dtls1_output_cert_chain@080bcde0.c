...

{
  ...
  if (iVar3 == 0) {
    ERR_put_error(0x14,0xff,7,"d1_both.c",0x407);
    sVar7 = 0;
  }
  else {
    if (param_2 == (X509 *)0x0) {
      ...
      iVar3 = X509_STORE_CTX_init(&local_a8,*(X509_STORE **)(*(int *)(param_1 + 0xe4) + 0xc),param_2
                                  ,(stack_st_X509 *)0x0);
      if (iVar3 == 0) {
        ERR_put_error(0x14,0xff,0xb,"d1_both.c",0x410);
LAB_080bcf2e:
        sVar7 = 0;
        goto LAB_080bcf30;
      }
      ...
      while( true ) {
        ...
        if (iVar6 == 0) {
          ERR_put_error(0x14,0x127,7,"d1_both.c",0x3f2);
    ...
    *(undefined *)(iVar3 + 0x25c) = 0xb;
    *(size_t *)(iVar3 + 0x260) = sVar7 - 0xc;
    *(short *)(iVar3 + 0x264) = sVar8;
    *(undefined4 *)(iVar3 + 0x268) = 0;
    *(size_t *)(iVar3 + 0x26c) = sVar7 - 0xc;
  }
LAB_080bcf30:
