...
LAB_08129395:
    ...
    if ((uVar3 & 0x10) != 0) goto switchD_08129432_caseD_0;
    uVar3 = EVP_CIPHER_CTX_flags(ctx);
    ...
    case 5:
      ...
      break;
    default:
      goto switchD_08129432_caseD_6;
    }
switchD_08129432_caseD_0:
    pEVar2 = ctx->cipher;
    ...
    *(undefined4 *)(ctx->final + 0x1c) = 0;
    ...
    if (ctx->engine == (ENGINE *)0x0) {
      pEVar2 = ctx->cipher;
      if (pEVar2 != (EVP_CIPHER *)0x0) goto LAB_081292a7;
    }
    else {
      pEVar2 = ctx->cipher;
      if (pEVar2 != (EVP_CIPHER *)0x0) {
        if (cipher->nid == pEVar2->nid) goto LAB_08129395;
LAB_081292a7:
        uVar3 = ctx->flags;
...
LAB_0812937e:
      ...
      ctx->flags = 0;
      ctx->key_len = iVar1;
      if ((bVar8 & 0x40) == 0) goto LAB_08129395;
