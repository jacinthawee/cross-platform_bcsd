    ...
    do {
      ...
      if (!bVar28) {
        ...
        if (bVar28) {
          ...
          if ((uVar24 < sVar19) || (local_3c = sVar19 - 1, 1 < local_3c)) goto LAB_0808c832;
          bVar4 = true;
          goto LAB_0808c5d0;
        }
        iVar5 = 5;
        pbVar25 = data;
        pbVar26 = &DAT_081fbcd5;
        do {
          if (iVar5 == 0) break;
          iVar5 = iVar5 + -1;
        ...
        if (bVar28) {
          param_1 = param_1 + -1;
          ppbVar22 = param_2 + 2;
          if (param_1 == 0) goto LAB_0808c832;
...
LAB_0808c832:
      ...
      if ((uVar24 < local_64) || (4 < (int)local_64)) goto LAB_0808c832;
LAB_0808c5d0:
      param_1 = param_1 + -1;
      bVar28 = param_1 == 0;
      param_2 = ppbVar22;
      ...
      if (bVar3) {
        ...
        if (pRVar9 == (RSA_METHOD *)0x0) {
          ...
          if (pDVar10 != (DSA_METHOD *)0x0) {
            pcVar6 = (char *)CRYPTO_malloc(0x100,"engine.c",0x6b);
            if (pcVar6 != (char *)0x0) {
              *pcVar6 = '\0';
              sVar19 = 0x100;
              local_60 = (void *)0x100;
          ...
          pcVar6 = (char *)CRYPTO_malloc(0x100,"engine.c",0x6b);
          if (pcVar6 == (char *)0x0) goto LAB_0808c860;
          *pcVar6 = '\0';
          ...
          if (pDVar10 == (DSA_METHOD *)0x0) {
            ...
            local_60 = (void *)0x100;
            if (0xff < sVar11 + 3) {
              pcVar6 = (char *)CRYPTO_realloc(pcVar6,0x200,"engine.c",0x77);
              if (pcVar6 == (char *)0x0) goto LAB_0808c860;
              sVar19 = 0x200;
              local_60 = (void *)0x200;
            }
...
LAB_0808c955:
          ...
          if (pDVar12 != (DH_METHOD *)0x0) {
            ...
            if (sVar19 <= sVar11 + 2) {
              ...
              pcVar6 = (char *)CRYPTO_realloc(pcVar6,sVar19,"engine.c",0x77);
...
LAB_0808ca9a:
                pcVar6 = (char *)CRYPTO_realloc(pcVar6,(int)local_60,"engine.c",0x77);
                if (pcVar6 == (char *)0x0) goto LAB_0808c860;
                cVar2 = *pcVar6;
              }
              if (cVar2 != '\0') {
        ...
        if ((pEVar18 == (ENGINE_DIGESTS_PTR)0x0) ||
          ...
          if (pEVar20 != (ENGINE_PKEY_METHS_PTR)0x0) goto LAB_0808cee7;
LAB_0808d5dd:
          if (pcVar6 != (char *)0x0) goto LAB_0808d2cf;
        }
        else {
          iVar17 = 0;
          do {
...
LAB_0808d2cf:
      ...
      if (bVar4) {
        puVar31 = &DAT_08227ea1;
        pEVar15 = (ENGINE *)BIO_printf(bio,"%s",&DAT_08227ea1);
      ...
      if (((0 < (int)local_64) &&
        ...
        st_02 = sk_new_null();
        if (st_02 == (_STACK *)0x0) goto LAB_0808c860;
        local_38 = 0;
        do {
...
LAB_0808d3f4:
          ...
          if ((3 < (int)local_64) || ((uVar16 & 8) == 0)) {
            ...
            if ((iVar17 < 1) ||
               (pcVar6 = (char *)CRYPTO_malloc(iVar17 + 1,"engine.c",0xe6), pcVar6 == (char *)0x0))
            goto LAB_0808d3f4;
...
LAB_0808d0b4:
                  CRYPTO_free(pcVar6);
                  if (local_60 == (void *)0x0) goto LAB_0808cbbb;
                }
                else {
...
LAB_0808d0fa:
                    puVar32 = &DAT_08227ea1;
                    puVar31 = &DAT_08227ea1;
                    BIO_printf(bio,"%s%s(input flags): ",&DAT_08227ea1,&DAT_08227ea1);
                    if (uVar16 == 0) {
...
LAB_0808d359:
                          ...
                          if ((uVar16 & 4) != 0) goto LAB_0808d58f;
                          if ((uVar16 & 0xfffffff0) != 0) goto LAB_0808d530;
                          goto LAB_0808d382;
                        }
                        if ((uVar16 & 4) == 0) {
                          if ((uVar16 & 0xfffffff0) == 0) goto LAB_0808d172;
                          goto LAB_0808d544;
                        }
...
LAB_0808d172:
                  ...
                  BIO_printf(bio,"%s: %s\n",pcVar6,local_60);
                  if (local_64 != 2) goto LAB_0808d0fa;
                  CRYPTO_free(pcVar6);
                  local_38 = 0;
                }
              ...
              local_60 = CRYPTO_malloc(iVar17 + 1,"engine.c",0xf1);
              if ((local_60 != (void *)0x0) &&
