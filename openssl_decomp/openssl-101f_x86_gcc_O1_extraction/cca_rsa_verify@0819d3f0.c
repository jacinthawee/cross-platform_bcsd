...
LAB_0819d653:
      ...
      param_2 = (uchar *)CRYPTO_malloc(iVar2 + 1,"e_4758cca.c",0x2ca);
...
LAB_0819d58c:
      ...
      uVar3 = 0;
      if (param_1 != 4) goto LAB_0819d530;
      param_2 = (uchar *)CRYPTO_malloc(iVar2 + 1,"e_4758cca.c",699);
      if (param_2 != (uchar *)0x0) goto LAB_0819d577;
      local_5c = param_2;
      if (CCA4758_lib_error_code == 0) {
        CCA4758_lib_error_code = ERR_get_next_error_library();
      }
