  ...
  if (cVar2 == '\0') {
    ...
    do {
      while (pcVar9 = pcVar4, cVar2 == ':') {
        ...
        pcVar4 = pcVar9 + 1;
        __s = pcVar9;
        if (cVar2 == '\0') goto joined_r0x0811f6d5;
      }
      if (cVar2 == '/') {
        *pcVar9 = '\0';
        break;
...
joined_r0x0811f6d5:
  ...
  if ((p_getaddrinfo_6653 != (code *)0x0) ||
    ...
    if (p_getaddrinfo_6653 == (code *)0xffffffff) goto LAB_0811f688;
    uVar3 = 0;
    do {
...
LAB_0811f57f:
    while( true ) {
      ...
      if (mode == 2) {
        ...
        if (iVar6 != -1) goto LAB_0811f7a0;
        piVar8 = __errno_location();
        bVar11 = iVar7 == 0;
        iVar7 = *piVar8;
LAB_0811f805:
        ERR_put_error(2,6,iVar7,"b_sock.c",0x324);
...
LAB_0811f7a0:
        ...
        if (iVar6 == -1) {
          piVar8 = __errno_location();
          ERR_put_error(2,6,*piVar8,"b_sock.c",0x32b);
          ERR_add_error_data(3,"port=\'",host_port,"\'");
...
LAB_0811f800:
      ...
      close(iVar7);
      if (iVar6 != -1) goto LAB_0811f800;
      mode = 2;
      close(iVar5);
      uVar3 = local_5c._0_4_ & 0xffff;
    }
    piVar8 = __errno_location();
    ERR_put_error(2,4,*piVar8,"b_sock.c",0x2e5);
    ERR_add_error_data(3,"port=\'",host_port,"\'");
