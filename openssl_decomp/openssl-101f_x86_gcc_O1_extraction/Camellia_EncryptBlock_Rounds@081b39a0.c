...

{
  ...
  while( true ) {
    ...
    uVar2 = *(uint *)(&DAT_08236640 + (uVar2 & 0xff) * 4) ^
            *(uint *)(&Camellia_SBOX + (uVar2 >> 0x18) * 4) ^
            *(uint *)(&DAT_08236e40 + (uVar2 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_08236a40 + (uVar2 >> 0x10 & 0xff) * 4);
    uVar4 = uVar2 ^ *(uint *)(&Camellia_SBOX + (uVar4 & 0xff) * 4) ^
                    *(uint *)(&DAT_08236a40 + (uVar4 >> 0x18) * 4) ^
                    *(uint *)(&DAT_08236640 + (uVar4 >> 8 & 0xff) * 4) ^
                    *(uint *)(&DAT_08236e40 + (uVar4 >> 0x10 & 0xff) * 4);
    uVar3 = uVar3 ^ uVar4;
    ...
    uVar2 = *(uint *)(&DAT_08236640 + (uVar4 & 0xff) * 4) ^
            *(uint *)(&Camellia_SBOX + (uVar4 >> 0x18) * 4) ^
            *(uint *)(&DAT_08236e40 + (uVar4 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_08236a40 + (uVar4 >> 0x10 & 0xff) * 4);
    ...
    uVar2 = *(uint *)(&DAT_08236a40 + (uVar2 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_08236640 + (uVar2 & 0xff) * 4) ^
            *(uint *)(&Camellia_SBOX + (uVar2 >> 0x18) * 4) ^
            *(uint *)(&DAT_08236e40 + (uVar2 >> 8 & 0xff) * 4);
    uVar4 = uVar2 ^ *(uint *)(&Camellia_SBOX + (uVar4 & 0xff) * 4) ^
                    *(uint *)(&DAT_08236a40 + (uVar4 >> 0x18) * 4) ^
    ...
    local_18 = uVar2 ^ *(uint *)(&Camellia_SBOX + (uVar7 & 0xff) * 4) ^
                       *(uint *)(&DAT_08236a40 + (uVar7 >> 0x18) * 4) ^
                       *(uint *)(&DAT_08236640 + (uVar7 >> 8 & 0xff) * 4) ^
                       *(uint *)(&DAT_08236e40 + (uVar7 >> 0x10 & 0xff) * 4);
