...
LAB_08183fc8:
      ...
      if (((iVar1 == 0x96) && (param_3 != (EVP_PKEY **)0x0)) && (*param_3 == (EVP_PKEY *)0x0)) {
        ...
        *param_3 = pEVar3;
joined_r0x08183efe:
        if (pEVar3 == (EVP_PKEY *)0x0) goto LAB_08183fc8;
      }
    }
    else if (iVar1 == 0x98) {
