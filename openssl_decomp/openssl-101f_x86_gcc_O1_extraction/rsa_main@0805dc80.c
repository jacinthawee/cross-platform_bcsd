...
LAB_0805df50:
        ...
        if (!bVar16) {
          ...
          if ((((bVar16) && (bVar16 = pcVar11[1] == 'i', bVar16)) &&
            ...
            param_1 = param_1 + -1;
            if (param_1 == 0) goto LAB_0805df50;
            local_68 = ppcVar13[1];
            ppcVar13 = ppcVar13 + 1;
          }
          else {
...
LAB_0805dd9e:
        ...
        if (param_1 == 1) goto LAB_0805df50;
                ...
                if (!bVar5) {
                  ...
                  if (local_6c == 1) {
                    ...
                    if (local_6c == 4) {
                      ...
                      data = (uchar *)CRYPTO_malloc(iVar6,"rsa.c",0x187);
                      local_24 = data;
                      if (data == (uchar *)0x0) {
                        uVar7 = 1;
