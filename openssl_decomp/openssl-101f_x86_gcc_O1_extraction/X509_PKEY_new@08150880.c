...

{
  ...
  pXVar1 = (X509_PKEY *)CRYPTO_malloc(0x34,"x_pkey.c",0x70);
  if (pXVar1 == (X509_PKEY *)0x0) {
    ...
    if (pXVar2 != (X509_ALGOR *)0x0) {
      ...
      if (pAVar3 != (ASN1_STRING *)0x0) {
        ...
        *(undefined4 *)(pXVar1->cipher).iv = 0;
        *(undefined4 *)((pXVar1->cipher).iv + 4) = 0;
        *(undefined4 *)((pXVar1->cipher).iv + 8) = 0;
        *(undefined4 *)((pXVar1->cipher).iv + 0xc) = 0;
        pXVar1->references = 1;
        return pXVar1;
      }
    }
