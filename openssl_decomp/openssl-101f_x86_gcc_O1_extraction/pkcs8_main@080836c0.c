...
LAB_08083892:
          ...
          if (bVar10) {
            if (*(int *)(param_2 + 8) == 0) goto LAB_080838d0;
            iVar4 = param_2 + 8;
...
LAB_08083a30:
        ...
        if (__s1[2] != 0x32) {
          ...
          if (bVar11) {
            ...
            bVar11 = __s1[3] == 0;
            if (bVar11) {
              if (*(char **)(param_2 + 8) == (char *)0x0) goto LAB_080838d0;
              iVar4 = param_2 + 8;
...
LAB_08083866:
    ...
    if (iVar4 != 0) {
      ...
      if (local_64 != (X509_SIG *)0x0) {
        ...
        if (bp != (BIO *)0x0) goto LAB_08083c8c;
...
LAB_08083cba:
          ...
          if (local_8c == (EVP_PKEY *)0x3) {
            ...
            if (local_8c != (EVP_PKEY *)0x1) goto LAB_08083cba;
...
LAB_08084303:
            ...
            if (local_68 != (X509_SIG *)&DAT_00000004) goto LAB_08084303;
