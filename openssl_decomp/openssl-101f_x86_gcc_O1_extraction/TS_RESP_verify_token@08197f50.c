...
joined_r0x081980dc:
      if ((uVar3 & 8) != 0) {
        ...
        if (iVar5 == 0) goto LAB_081980ae;
        uVar3 = *param_1;
      }
      if ((uVar3 & 0x10) != 0) {
        iVar5 = TS_compute_imprint(&local_28,&local_24);
        if ((iVar5 == 0) || (iVar5 = TS_check_imprints(iVar1), iVar5 == 0)) goto LAB_081980ae;
        uVar3 = *param_1;
      }
      if ((uVar3 & 0x20) == 0) {
LAB_08197fe0:
