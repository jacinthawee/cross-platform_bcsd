...
int ssl_get_prev_session(undefined4 *param_1,undefined4 param_2,int param_3,undefined4 param_4)
...
LAB_080c6aa0:
  ...
  if (param_3 == 0) {
    ...
    case 2:
    case 3:
switchD_080c6ae8_caseD_2:
      bVar4 = false;
LAB_080c6af6:
      if (local_124 == (SSL_SESSION *)0x0) goto LAB_080c6aa0;
LAB_080c6afa:
      pSVar10 = local_124;
      ...
      if (__n == param_1[0x27]) {
        ...
        if (iVar12 == 0) {
          if ((__n == 0) && ((*(byte *)(param_1 + 0x32) & 1) != 0)) {
            iVar12 = -1;
            ERR_put_error(0x14,0xd9,0x115,"ssl_sess.c",0x23e);
          }
          else {
            ...
            if (iVar8 <= iVar6) {
              ...
              *(int *)(param_1[0x5c] + 0x58) = *(int *)(param_1[0x5c] + 0x58) + 1;
              if ((iVar6 != 0) &&
                 (iVar6 = CRYPTO_add_lock((int *)(iVar6 + 0xa4),-1,0xe,"ssl_sess.c",0x2e4),
                 iVar6 < 1)) {
          ...
          goto joined_r0x080c6eaa;
        }
        iVar12 = 0;
      }
      break;
    default:
switchD_080c6ae8_caseD_5:
    ...
    case 1:
      if (local_124 == (SSL_SESSION *)0x0) {
        ...
        if ((*(byte *)(iVar6 + 0x21) & 1) == 0) {
          local_11c[0] = *param_1;
          local_d8 = param_3;
          iVar6 = __memcpy_chk(local_d4,param_2,param_3,0xac);
          CRYPTO_lock(iVar6,5,&DAT_0000000c,(int)"ssl_sess.c");
          ...
          if (local_124 != (SSL_SESSION *)0x0) goto LAB_080c6b8d;
          *(int *)(param_1[0x5c] + 0x4c) = *(int *)(param_1[0x5c] + 0x4c) + 1;
          iVar6 = param_1[0x5c];
        }
        iVar12 = 0;
        if (*(code **)(iVar6 + 0x30) == (code *)0x0) goto LAB_080c6aa2;
        local_120 = 1;
        ...
        if (local_124 != (SSL_SESSION *)0x0) {
          ...
          *piVar1 = *piVar1 + 1;
          if (local_120 != 0) {
            CRYPTO_add_lock((int *)(local_124->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x21a);
            s = (SSL_CTX *)param_1[0x5c];
          }
...
LAB_080c6b8d:
    ...
    case 2:
    case 3:
      goto switchD_080c6ae8_caseD_2;
    default:
      goto switchD_080c6ae8_caseD_5;
    case 0xffffffff:
      iVar12 = -1;
      bVar4 = true;
    }
joined_r0x080c6eaa:
    pSVar10 = local_124;
    if (local_124 == (SSL_SESSION *)0x0) goto LAB_080c6aa2;
  }
  iVar6 = CRYPTO_add_lock((int *)(pSVar10->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
  if (iVar6 < 1) {
    SSL_SESSION_free_part_2();
  }
  if (!bVar4) {
