...

{
  ...
  *(undefined4 *)(param_1 + 0x20) = 0;
  if (param_2 == 0) {
    if (param_3 == 0) goto LAB_08195bc3;
LAB_08195c90:
    ...
    *(ASN1_INTEGER **)(param_1 + 0x18) = pAVar1;
    if (pAVar1 == (ASN1_INTEGER *)0x0) goto LAB_08195c03;
    iVar2 = ASN1_INTEGER_set(pAVar1,param_2);
    if (iVar2 == 0) goto LAB_08195c00;
    if (param_3 != 0) goto LAB_08195c90;
LAB_08195bc3:
    if (param_4 == 0) {
      return 1;
    }
...
LAB_08195c03:
  ...
  *(undefined4 *)(param_1 + 0x1c) = 0;
  ASN1_INTEGER_free(*(ASN1_INTEGER **)(param_1 + 0x20));
  *(undefined4 *)(param_1 + 0x20) = 0;
  ERR_put_error(0x2f,0x80,0x41,"ts_rsp_sign.c",0x13b);
  return 0;
}
