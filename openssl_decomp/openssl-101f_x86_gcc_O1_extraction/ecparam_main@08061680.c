...
LAB_08061bd0:
      ...
      if (!bVar31) {
        ...
        if (bVar31) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_08061bd0;
                ...
                if (bVar31) {
                  ...
                  if (bVar31) {
                    ...
                    if (bVar31) {
                      param_1 = param_1 + -1;
                      bVar31 = param_1 == 0;
                      if (bVar31) goto LAB_08061bd0;
                      pbVar35 = ppbVar25[1];
                      iVar12 = 0xb;
                      ppbVar24 = ppbVar25 + 1;
                      pbVar26 = pbVar35;
                      pbVar29 = (byte *)0x81f04e3;
                      do {
                        if (iVar12 == 0) break;
                        iVar12 = iVar12 + -1;
                        bVar31 = *pbVar26 == *pbVar29;
...
LAB_080617a6:
      ...
      if (param_1 == 1) goto LAB_08061bd0;
  ...
  if (bVar2) {
    ...
    r = (EC_builtin_curve *)CRYPTO_malloc(nitems << 3,"ecparam.c",0x15f);
...
LAB_080623e6:
    ...
    if (((iVar12 == 0x196) &&
      ...
      if (((pBVar19 != (BIGNUM *)0x0) &&
        ...
        local_70 = CRYPTO_malloc(num,"ecparam.c",0x21a);
...
LAB_080621f3:
      if (bVar10) {
        ...
        if (bVar11) {
          pEVar17 = EC_KEY_new();
          if (pEVar17 == (EC_KEY *)0x0) goto LAB_0806221a;
          uVar27 = 1;
...
LAB_08061a08:
    if (local_60 != (BIGNUM *)0x0) goto LAB_08061a10;
  }
