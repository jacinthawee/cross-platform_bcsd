...

{
  ...
  if (((ctx == (EVP_PKEY_CTX *)0x0) || (iVar2 = *(int *)ctx, iVar2 == 0)) ||
    ...
    ERR_put_error(6,0x69,0x96,"pmeth_fn.c",0xd9);
    iVar2 = -2;
  }
  else if (*(int *)(ctx + 0x10) == 0x100) {
    if ((*(byte *)(iVar2 + 4) & 2) == 0) {
LAB_08136c7e:
                    /* WARNING: Could not recover jumptable at 0x08136c99. Too many branches */
    ...
    if (out == (uchar *)0x0) {
      *outlen = uVar1;
      ...
      ERR_put_error(6,0x69,0x9b,"pmeth_fn.c",0xe1);
      iVar2 = 0;
    }
  }
  else {
    ERR_put_error(6,0x69,0x97,"pmeth_fn.c",0xde);
    iVar2 = -1;
  }
  return iVar2;
}
