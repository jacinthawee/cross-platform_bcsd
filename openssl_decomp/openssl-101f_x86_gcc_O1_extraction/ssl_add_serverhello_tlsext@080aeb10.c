...

{
  ...
  if (puVar6 < param_3) {
    if (((param_1->hit == 0) && (param_1->tlsext_hostname == (char *)0x1)) &&
      ...
      if ((int)param_3 - (int)puVar6 < 4) goto LAB_080aee1e;
      param_2[2] = 0;
      param_2[3] = 0;
      puVar6 = param_2 + 6;
      param_2[4] = 0;
...
LAB_080aeb62:
      ...
      if ((param_1->tlsext_ocsp_resplen != 0) &&
         (uVar4 = SSL_ctrl(param_1,0x20,0,(void *)0x0), (uVar4 & 0x4000) == 0)) {
        if ((int)param_3 - (int)puVar6 < 4) goto LAB_080aee1e;
        *puVar6 = 0;
        puVar6[1] = 0x23;
        puVar7 = puVar6 + 4;
      ...
      if (param_1->tlsext_status_type != 0) {
        if ((int)param_3 - (int)puVar7 < 4) goto LAB_080aee1e;
        *puVar7 = 0;
        puVar7[1] = 5;
        puVar6 = puVar7 + 4;
        puVar7[2] = 0;
      ...
      if (param_1->srtp_profiles != (stack_st_SRTP_PROTECTION_PROFILE *)0x0) {
        ...
        if ((int)(param_3 + ((-4 - (int)param_2) - local_24)) < 0) goto LAB_080aee1e;
        *puVar6 = 0;
        puVar6[1] = 0xe;
        puVar6[3] = (char)local_24;
        puVar6[2] = (char)(local_24 >> 8);
        iVar2 = ssl_add_serverhello_use_srtp_ext(param_1,puVar6 + 4,&local_24,local_24);
      ...
      if ((*(ushort *)&((param_1->s3->tmp).new_cipher)->id - 0x80 < 2) &&
        ...
        if ((int)param_3 - (int)puVar6 < 0x24) goto LAB_080aee1e;
        *puVar6 = 0xfd;
        puVar6[1] = 0xe8;
        puVar7 = puVar6 + 0x24;
        puVar6[2] = 0;
      ...
      iVar2 = param_1->s3->next_proto_neg_seen;
      ...
      if (iVar2 != 0) {
        ...
        if ((pcVar1 != (code *)0x0) &&
          ...
          if ((int)(param_3 + (-local_24 - (int)puVar7) + -4) < 0) goto LAB_080aed81;
      ...
      puVar3 = puVar7 + (-2 - (int)param_2);
      puVar6 = param_2;
      if (puVar3 != (undefined *)0x0) {
        param_2[1] = (char)puVar3;
        *param_2 = (char)((uint)puVar3 >> 8);
        puVar6 = puVar7;
      }
      goto LAB_080aed81;
    }
    iVar2 = ssl_add_serverhello_renegotiate_ext(param_1,0,&local_24,0);
    if (iVar2 == 0) {
      iVar2 = 0x2bd;
    }
    else {
      ...
      *puVar6 = 0xff;
      ...
      puVar6[3] = (char)local_24;
      puVar6[2] = (char)(local_24 >> 8);
      iVar2 = ssl_add_serverhello_renegotiate_ext(param_1,puVar6 + 4,&local_24,local_24);
      puVar6 = puVar6 + 4 + local_24;
      if (iVar2 != 0) goto LAB_080aeb62;
      iVar2 = 0x2c8;
    }
LAB_080aee08:
    ERR_put_error(0x14,0x116,0x44,"t1_lib.c",iVar2);
  }
LAB_080aee1e:
  puVar6 = (undefined *)0x0;
LAB_080aed81:
