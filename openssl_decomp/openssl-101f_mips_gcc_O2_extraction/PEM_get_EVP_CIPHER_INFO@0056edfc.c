...
LAB_0056ef40:
    ...
    iVar3 = (*(code *)PTR_strncmp_006aaa7c)(header,"Proc-Type: ",0xb);
    if (iVar3 != 0) {
      uVar12 = 0x6b;
      uVar8 = 500;
LAB_0056ef78:
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x6b,uVar12,"pem_lib.c",uVar8);
      return 0;
    }
    if (header[0xb] != '4') {
      return 0;
    ...
    pcVar13 = header + 0xd;
    iVar4 = (*(code *)PTR_strncmp_006aaa7c)(pcVar13,"ENCRYPTED",9);
    if (iVar4 == 0) {
      cVar1 = header[0xd];
      while (cVar1 != '\n') {
        if (cVar1 == '\0') {
      ...
      iVar3 = (*(code *)PTR_strncmp_006aaa7c)(pcVar13 + 1,"DEK-Info: ",10);
      ...
      *pcVar13 = cVar1;
      if (pEVar6 != (EVP_CIPHER *)0x0) {
        iVar3 = pEVar6->iv_len;
        if (0 < iVar3) {
          (*(code *)PTR_memset_006aab00)(cipher->iv,0,iVar3);
        }
        uVar5 = 0;
        if (0 < iVar3 << 1) {
          do {
