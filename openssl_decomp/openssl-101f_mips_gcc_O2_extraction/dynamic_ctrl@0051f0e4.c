...

{
  ...
  local_9c[28] = *(int *)PTR___stack_chk_guard_006aabf0;
  if (dynamic_ex_data_idx < 0) {
    iVar4 = ENGINE_get_ex_new_index
                      (0,(void *)0x0,(undefined1 *)0x0,(undefined1 *)0x0,dynamic_data_ctx_free_func)
    ;
    if (iVar4 != -1) {
      (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x1e,"eng_dyn.c",0xf7);
      if (dynamic_ex_data_idx < 0) {
        dynamic_ex_data_idx = iVar4;
      }
      (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_dyn.c",0xff);
      goto LAB_0051f148;
    }
...
LAB_0051f148:
  ...
  if (piVar3 == (int *)0x0) {
    piVar3 = (int *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x2c,"eng_dyn.c",0xbd);
    if (piVar3 == (int *)0x0) {
      ERR_put_error(0x26,0xb7,0x41,"eng_dyn.c",0xc0);
    }
    else {
      (*(code *)PTR_memset_006aab00)(piVar3,0,0x2c);
      *piVar3 = 0;
      piVar3[1] = 0;
      piVar3[2] = 0;
      ...
      if (p_Var5 != (_STACK *)0x0) {
        (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x1e,"eng_dyn.c",0xd5);
        ...
        if (piVar6 == (int *)0x0) {
          ...
          (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_dyn.c",0xde);
        }
        else {
          (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_dyn.c",0xde);
...
LAB_0051f190:
    ...
    break;
  case 0xce:
    iVar4 = (*(code *)PTR_DSO_new_006a99a0)();
    iVar14 = piVar3[3];
    *piVar3 = iVar4;
    if (iVar14 != 0) {
LAB_0051f3b8:
...
LAB_0051f3cc:
        ...
        if (0 < iVar4) {
          ...
          do {
            ...
            iVar8 = (*(code *)PTR_DSO_merge_006a99a8)(*piVar3,piVar3[3],pvVar7);
            if (iVar8 == 0) break;
            iVar9 = (*(code *)PTR_DSO_load_006a99a4)(*piVar3,iVar8,0,0);
            if (iVar9 != 0) {
        ...
        iVar4 = (*(code *)PTR_DSO_load_006a99a4)(*piVar3,iVar14,0,0);
        if (iVar4 != 0) {
LAB_0051f5fc:
          iVar4 = (*(code *)PTR_DSO_bind_func_006a99ac)(*piVar3,piVar3[8]);
          piVar3[2] = iVar4;
          if (iVar4 == 0) {
            uVar15 = 0;
            (*(code *)PTR_DSO_free_006a9994)(*piVar3);
            *piVar3 = 0;
          ...
          uVar15 = piVar3[4];
          if (uVar15 == 0) {
            pcVar10 = (code *)(*(code *)PTR_DSO_bind_func_006a99ac)(*piVar3,piVar3[7]);
            piVar3[1] = (int)pcVar10;
            if ((pcVar10 != (code *)0x0) && (uVar11 = (*pcVar10)(0x20000), 0x1ffff < uVar11))
            goto LAB_0051f660;
            puVar1 = PTR_DSO_free_006a9994;
            piVar3[2] = 0;
            piVar3[1] = 0;
            (*(code *)puVar1)(*piVar3);
            iVar14 = 0x91;
...
LAB_0051f660:
            ...
            local_c0 = (*(code *)PTR_CRYPTO_get_ex_data_implementation_006a99b8)();
            (*(code *)PTR_CRYPTO_get_mem_functions_006a99bc)(auStack_bc,auStack_b8,auStack_b4);
            local_b0 = (*(code *)PTR_CRYPTO_get_locking_callback_006a99c0)();
            local_ac = (*(code *)PTR_CRYPTO_get_add_lock_callback_006a99c4)();
            local_a8 = (*(code *)PTR_CRYPTO_get_dynlock_create_callback_006a99c8)();
            local_a4 = (*(code *)PTR_CRYPTO_get_dynlock_lock_callback_006a99cc)();
            local_a0 = (*(code *)PTR_CRYPTO_get_dynlock_destroy_callback_006a99d0)();
        ...
        if (piVar3[9] != 0) goto LAB_0051f3cc;
      }
      uVar15 = 0;
    ...
    if (piVar3[5] != 0) {
      iVar14 = (*(code *)PTR_DSO_convert_filename_006a99dc)(iVar4);
      piVar3[3] = iVar14;
      goto LAB_0051f3b8;
    }
    goto LAB_0051f190;
