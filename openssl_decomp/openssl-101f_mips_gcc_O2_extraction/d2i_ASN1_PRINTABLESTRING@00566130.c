...

{
  ...
  if (ASN1_PRINTABLESTRING_it._16_4_ == 0) {
    if (uVar2 < 7) {
      ...
      pAVar3 = (ASN1_PRINTABLESTRING *)(*(code *)(&switchD_00565630::switchdataD_0066abc0)[uVar2])()
      ;
      return pAVar3;
    }
  }
                    ...
                    /* WARNING: Treating indirect jump as call */
    pAVar3 = (ASN1_PRINTABLESTRING *)(*(code *)(&switchD_005651a0::switchdataD_0066aba4)[uVar2])();
    return pAVar3;
  }
