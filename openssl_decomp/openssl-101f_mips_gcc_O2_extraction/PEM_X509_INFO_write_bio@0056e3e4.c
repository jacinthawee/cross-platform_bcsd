...

{
  ...
  if (enc != (EVP_CIPHER *)0x0) {
    uVar2 = (*(code *)PTR_EVP_CIPHER_nid_006a84d0)(enc);
    iVar3 = (*(code *)PTR_OBJ_nid2sn_006a819c)(uVar2);
    if (iVar3 != 0) goto LAB_0056e468;
...
LAB_0056e628:
      pcVar9 = "pem_info.c";
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x75,pEVar7,"pem_info.c",uVar2);
LAB_0056e640:
      uVar8 = 0;
      enc = pEVar7;
      goto LAB_0056e564;
    }
    uVar2 = (*(code *)PTR_EVP_CIPHER_nid_006a84d0)((xi->enc_cipher).cipher);
    type = (char *)(*(code *)PTR_OBJ_nid2sn_006a819c)(uVar2);
    if (type == (char *)0x0) {
      pEVar7 = (EVP_CIPHER *)0x71;
      uVar2 = 0x16b;
      goto LAB_0056e628;
    }
    iVar4 = (*(code *)PTR_strlen_006aab30)(type);
    if (0x400 < (uint)(enc->iv_len * 2 + 0x24 + iVar4)) {
      (*(code *)PTR_OpenSSLDie_006a8d4c)
                ("pem_info.c",0x170,"strlen(objstr)+23+2*enc->iv_len+13 <= sizeof buf");
    }
    ...
    if (iVar3 < 1) goto LAB_0056e640;
    x = xi->x509;
    uVar8 = 1;
    enc = pEVar7;
    if (x == (X509 *)0x0) goto LAB_0056e564;
  }
  iVar3 = PEM_write_bio_X509(bp,x);
  uVar8 = (uint)(0 < iVar3);
LAB_0056e564:
  (*(code *)PTR_OPENSSL_cleanse_006a8174)(auStack_4b8,0x8c);
  iVar3 = 0x400;
  (*(code *)PTR_OPENSSL_cleanse_006a8174)((EVP_CIPHER *)&local_42c);
  ...
  if ((uchar *)pcVar9 == (uchar *)0x0) {
    pcVar9 = (char *)(*(code *)PTR_EVP_get_pw_prompt_006a9f4c)();
    puVar1 = PTR_stderr_006aac00;
    if (pcVar9 == (char *)0x0) {
      pcVar9 = "Enter PEM pass phrase:";
    }
    while( true ) {
      iVar6 = (*(code *)PTR_EVP_read_pw_string_min_006a9f50)(iVar4,4,iVar3,pcVar9,enc);
      if (iVar6 != 0) {
        (*(code *)PTR_ERR_put_error_006a9030)(9,100,0x6d,"pem_lib.c",0x6f);
        (*(code *)PTR_memset_006aab00)(iVar4,0,iVar3);
        return -1;
      }
      iVar6 = (*(code *)PTR_strlen_006aab30)(iVar4);
      if (3 < iVar6) break;
    ...
    iVar5 = (*(code *)PTR_strlen_006aab30)(pcVar9);
    iVar6 = iVar3;
    if (iVar5 <= iVar3) {
      iVar6 = iVar5;
    }
    (*(code *)PTR_memcpy_006aabf4)(iVar4,pcVar9,iVar6);
  }
  return iVar6;
}
