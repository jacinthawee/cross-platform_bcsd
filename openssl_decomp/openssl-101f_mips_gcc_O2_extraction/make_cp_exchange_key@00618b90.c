...

{
  ...
  while( true ) {
    ...
    *(undefined4 *)((int)register0x00000074 + -0x24) = *(undefined4 *)PTR___stack_chk_guard_006aabf0
    ...
    param_3 = param_2;
    puVar10 = puVar9;
    puVar3 = (undefined4 *)(*(code *)PTR_DH_new_006a8618)();
    ...
    if (puVar3 == (undefined4 *)0x0) {
      ...
      (**(code **)(puVar12 + -0x53e0))(unaff_s3,0,0x80);
      unaff_s0 = (undefined *)((int)register0x00000074 + -0xa4);
      uVar4 = (**(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x6de0))
                        (*(undefined4 *)(param_2[5] + 0x14));
      iVar13 = *(int *)((int)register0x00000074 + -0x1a0);
      puVar3[3] = uVar4;
      uVar4 = (**(code **)(iVar13 + -0x6de0))(*(undefined4 *)(param_2[5] + 0xc));
      pcVar11 = *(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x6de0);
      puVar3[2] = uVar4;
      uVar4 = (*pcVar11)(uVar8);
      pcVar11 = *(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x57fc);
      puVar3[6] = uVar4;
      ...
      if (unaff_s5 == (undefined4 *)0x0) {
        (**(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x78dc))(puVar3);
        uVar4 = 0;
        puVar12 = *(undefined **)((int)register0x00000074 + -0x1a0);
      }
      else {
    ...
    *(undefined **)((int)register0x00000074 + -0x1c8) = &_gp;
    param_2 = (undefined4 *)(*(code *)PTR_EVP_PKEY_CTX_get0_peerkey_006aa934)();
    uVar4 = (**(code **)(*(int *)((int)register0x00000074 + -0x1c8) + -0x5800))(iVar5);
    *puVar10 = 0x20;
