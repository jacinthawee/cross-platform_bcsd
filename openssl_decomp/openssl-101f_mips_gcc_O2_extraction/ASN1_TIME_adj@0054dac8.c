...

{
  ...
  local_res4[0] = t;
  iVar5 = (*(code *)PTR_OPENSSL_gmtime_006a9dc0)(local_res4,auStack_48);
  if (iVar5 == 0) {
    ERR_put_error(0xd,0xd9,0xad,"a_time.c",0x73);
    pAVar6 = (ASN1_TIME *)0x0;
  }
  else if (((offset_day == 0) && (offset_sec == 0)) ||
          (iVar4 = (*(code *)PTR_OPENSSL_gmtime_adj_006a9dc4)(iVar5,offset_day,offset_sec),
          iVar4 != 0)) {
    pcVar13 = (code *)PTR_ASN1_UTCTIME_adj_006a9dc8;
    if (99 < *(int *)(iVar5 + 0x14) - 0x32U) {
      pcVar13 = (code *)PTR_ASN1_GENERALIZEDTIME_adj_006a9dcc;
    }
  ...
  iVar3 = iVar4 + 3;
  if (iVar8 != 0x2e) goto LAB_0054d1a0;
  if (iVar5 < iVar3) {
    return (ASN1_TIME *)0x0;
  }
