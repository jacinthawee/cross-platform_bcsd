...
LAB_005657fc:
              ...
              (*(code *)PTR_ERR_add_error_data_006a9264)
                        (4,&DAT_0066ab40,tt->field_name,", Type=",it->sname);
              goto switchD_00565630_caseD_7;
            }
            goto LAB_0056529c;
          }
...
LAB_00565288:
  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x78,uVar12,s_tasn_dec_c_0066ab2c,uVar5);
LAB_0056529c:
  ASN1_item_ex_free(pval,it);
LAB_005652b4:
  pcVar10 = s_Type__0066ab48;
  (*(code *)PTR_ERR_add_error_data_006a9264)(2,s_Type__0066ab48,it->sname);
  in = (uchar **)pcVar10;
