...

{
  ...
  local_34 = 0;
  local_30 = 0;
  local_6c = s_ENGINE_init_00674eb0._0_4_;
  local_68 = s_ENGINE_init_00674eb0._4_4_;
  local_64 = s_ENGINE_init_00674eb0._8_4_;
  if (surewarehk_dso == 0) {
  ...
  while( true ) {
    ...
    uVar2 = 0;
    surewarehk_dso = 0;
    *(undefined4 *)(local_8c + -0xadc) = 0;
    *(undefined4 *)(local_a0 + -0xae0) = 0;
    *(undefined4 *)(local_90 + -0xae4) = 0;
    *(undefined4 *)(local_9c + -0xae8) = 0;
    *(undefined4 *)(local_94 + -0xaec) = 0;
    *(undefined4 *)(puVar17 + -0xaf4) = 0;
    p_surewarehk_Free = 0;
