...

{
  ...
  if (aep_dso == 0) {
    ...
    aep_dso = (*(code *)PTR_DSO_load_006a99a4)(0,puVar8,0,0);
    if (aep_dso == 0) {
      ...
      iVar1 = (*(code *)PTR_DSO_bind_func_006a99ac)(aep_dso,"AEP_ModExp");
      if ((((iVar1 != 0) &&
         ...
         (((iVar4 = (*(code *)PTR_DSO_bind_func_006a99ac)(aep_dso,"AEP_Initialize"), iVar4 != 0 &&
           (iVar5 = (*(code *)PTR_DSO_bind_func_006a99ac)(aep_dso,"AEP_OpenConnection"), iVar5 != 0)
           ) && ((iVar6 = (*(code *)PTR_DSO_bind_func_006a99ac)(aep_dso,"AEP_SetBNCallBacks"),
                 iVar6 != 0 &&
                 (iVar7 = (*(code *)PTR_DSO_bind_func_006a99ac)(aep_dso,"AEP_CloseConnection"),
                 iVar7 != 0)))))) {
