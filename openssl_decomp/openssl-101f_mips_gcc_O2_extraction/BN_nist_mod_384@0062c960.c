...

{
  ...
  if (uStack_cc == 0) {
    ...
    unaff_s5 = (BIGNUM *)a->d;
    local_94 = ctx;
    iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(a,_bignum_nist_p_384_sqr_6214);
    if (-1 < iVar3) goto LAB_0062c9e0;
    iVar3 = (**(code **)(local_a0 + -0x6868))(_bignum_nist_p_384);
    if (iVar3 == 0) {
      pBVar7 = (BIGNUM *)0x0;
      uStack_cc = 1;
      (**(code **)(local_a0 + -0x76c0))(r);
    }
    else if (iVar3 < 1) {
      pBVar8 = unaff_s5;
      if (a != r) {
...
LAB_0062cb38:
        ...
        (**(code **)(local_a0 + -0x53e0))(puVar4 + (int)puVar13,0,iVar3);
      }
      else {
        puVar13 = unaff_s4 + -0xc;
        puVar4 = (uint *)(**(code **)(local_a0 + -0x52ec))
      ...
      if (((int)uVar11 < 0) || (uVar11 == 0)) {
        if (((int)uVar11 >> 0x1f | uVar11) == 0) {
          ...
          iVar3 = (**(code **)(local_a0 + -0x6838))(pBVar8,pBVar8,_nist_p_384 + ~uVar11 * 0x30,0xc);
          unaff_s5 = (BIGNUM *)-iVar3;
          pcVar10 = (code *)(((uint)pcVar10 ^ *(uint *)(local_a0 + -0x6838)) & (uint)unaff_s5 ^
                            *(uint *)(local_a0 + -0x6838));
        }
      }
      else {
        iVar3 = (**(code **)(local_a0 + -0x683c))
      ...
      pBVar7 = a;
      iVar3 = (**(code **)(local_a0 + -0x6970))(r);
      uStack_cc = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062c9e0:
    uStack_cc = (**(code **)(local_a0 + -0x687c))(r,a,_bignum_nist_p_384);
  }
LAB_0062ca00:
  ...
  if (uVar11 == 0) {
    iVar17 = pBVar7->top;
    puVar15 = pBVar7->d;
    iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(pBVar7,_bignum_nist_p_521_sqr_6238);
    if (iVar3 < 0) {
      iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(_bignum_nist_p_521,pBVar7);
      if (iVar3 == 0) {
        uVar11 = 1;
      ...
      if (0 < iVar3) {
        if (pBVar7 == pBVar8) {
          ...
          iVar3 = (*(code *)PTR_BN_copy_006a9570)(pBVar8,pBVar7);
          uVar11 = (uint)(iVar3 != 0);
        }
        goto LAB_0062d320;
      }
...
LAB_0062d488:
        ...
        (*(code *)PTR_memset_006aab00)(auStack_120 + iVar17,0,iVar3);
      }
      else {
        puVar18 = auStack_120;
        do {
      ...
      iVar3 = (*(code *)PTR_bn_sub_words_006a96a4)(auStack_120,puVar9,_nist_p_521,0x11);
                            ...
                            if (puVar15[5] == 0) {
                              if (puVar15[4] == 0) {
                                if (puVar15[3] == 0) {
                                  uVar11 = 1;
                                  if (puVar15[2] == 0) {
                                    if (puVar15[1] != 0) goto LAB_0062d954;
  ...
  uVar11 = (*(code *)PTR_BN_nnmod_006a9664)(pBVar8,pBVar7,_bignum_nist_p_521);
LAB_0062d320:
  while( true ) {
