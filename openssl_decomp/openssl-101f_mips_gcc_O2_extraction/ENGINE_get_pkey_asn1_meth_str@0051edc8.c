...

{
  ...
  if (pcStack_60 != (code *)0x0) {
    unaff_s1 = (int *)len;
    if (len == -1) {
      unaff_s1 = (int *)(*(code *)PTR_strlen_006aab30)(str);
    }
    len = (int)&local_34;
    ...
    if (0 < (int)unaff_s2) {
      ...
      do {
        ...
        piVar4 = (int *)(**(code **)(local_40 + -0x53b0))(uVar6);
        if ((unaff_s1 == piVar4) &&
           (ppEStack_6c = (EVP_PKEY_ASN1_METHOD **)str, len = (int)unaff_s1,
           iVar5 = (**(code **)(local_40 + -0x5400))(uVar6), iVar5 == 0)) break;
...
LAB_0051eed0:
  ...
  (*(code *)PTR_engine_table_doall_006a9990)(pkey_asn1_meth_table,look_str_cb,&iStack_74);
  if (iStack_74 != 0) {
