...

{
  ...
  BIO *pBStack_1168;
  BIO_METHOD *pBStack_1164;
  char *pcStack_1160;
  _func_603 *p_Stack_115c;
  undefined *puStack_1158;
  char *pcStack_1150;
  int *piStack_114c;
  undefined auStack_1144 [12];
  _func_603 *p_Stack_1138;
  undefined auStack_1134 [8];
  BIO aBStack_112c [4];
  char acStack_102c [4096];
  int iStack_2c;
  
  pBVar9 = (BIO *)(auStack_1144 + 8);
  file = (BIO *)auStack_1144;
  piStack_114c = (int *)PTR___stack_chk_guard_006aabf0;
  buf_01 = aBStack_112c;
  data_00 = (char **)(auStack_1144 + 4);
  data = &p_Stack_1138;
  buf = acStack_102c;
  puStack_1158 = &_gp;
  iStack_2c = *(int *)PTR___stack_chk_guard_006aabf0;
  (*(code *)PTR_CRYPTO_THREADID_current_006a95ac)(auStack_1134);
  buf_00 = "%lu:%s:%s:%d:%s\n";
  piVar1 = (int *)(**(code **)(puStack_1158 + -0x693c))(auStack_1134);
  pcStack_1150 = "s\n";
  do {
    parg = file;
    ...
    p_Stack_115c = auStack_1144._4_4_;
    if (((uint)p_Stack_1138 & 2) == 0) {
      p_Stack_115c = (_func_603 *)(pcStack_1150 + -0x6a30);
    }
    pBStack_1164 = auStack_1144._0_4_;
    pcStack_1160 = auStack_1144._8_4_;
    pBStack_1168 = buf_01;
    BIO_snprintf(buf,0x1000,"%lu:%s:%s:%d:%s\n",piVar1);
    iVar2 = (**(code **)(puStack_1158 + -0x53b0))(buf);
    parg = param_1;
    iVar2 = BIO_write(param_1,buf,iVar2);
  } while (0 < iVar2);
  if (iStack_2c == *piStack_114c) {
    return;
  }
  pcVar10 = ERR_print_errors_cb_constprop_0;
  (**(code **)(puStack_1158 + -0x5328))();
  puVar8 = auStack_1178;
  do {
    ...
    *(undefined **)(puVar8 + -0x118c) = PTR___stack_chk_guard_006aabf0;
    ...
    *(undefined4 *)(puVar8 + -0x2c) = *(undefined4 *)PTR___stack_chk_guard_006aabf0;
    (*(code *)PTR_CRYPTO_THREADID_current_006a95ac)(a);
    uVar4 = (**(code **)(*(int *)(puVar8 + -0x11a0) + -0x693c))(a);
    *(undefined4 *)(puVar8 + -0x1194) = uVar4;
    *(char **)(puVar8 + -0x1190) = "s\n";
    do {
      pBVar5 = pBVar9;
      piVar1 = line;
      ...
      if ((*(uint *)(puVar8 + -0x1178) & 2) == 0) {
        iVar2 = *(int *)(puVar8 + -0x1190) + -0x6a30;
      }
      else {
    ...
    *(undefined **)(puVar8 + -0x230c) = PTR___stack_chk_guard_006aabf0;
    ...
    *(undefined4 *)(puVar8 + -0x11ec) = *(undefined4 *)PTR___stack_chk_guard_006aabf0;
    (*(code *)PTR_CRYPTO_THREADID_current_006a95ac)(puVar8 + -0x22f4);
    buf = "%lu:%s:%s:%d:%s\n";
    buf_00 = (char *)(**(code **)(*(int *)(puVar8 + -0x2320) + -0x693c))(puVar8 + -0x22f4);
    *(char **)(puVar8 + -0x2310) = "s\n";
    do {
      parg = pBVar9;
      ...
      if ((*(uint *)(puVar8 + -0x22f8) & 2) == 0) {
        iVar2 = *(int *)(puVar8 + -0x2310) + -0x6a30;
      }
      else {
      ...
      *(BIO **)(puVar8 + -0x2330) = file;
      ...
      uVar4 = (**(code **)(*(int *)(puVar8 + -0x2320) + -0x53b0))(buf_01);
      parg = buf_01;
