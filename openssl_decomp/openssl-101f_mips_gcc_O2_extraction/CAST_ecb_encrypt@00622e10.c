...

{
  ...
  if (enc == 0) {
    (*(code *)PTR_CAST_decrypt_006aa9d8)(&local_1c);
  }
  else {
    (*(code *)PTR_CAST_encrypt_006aa9dc)(&local_1c,key);
  }
  ...
  *out = (uchar)((uint)local_1c >> 0x18);
  ...
  if (iStack_20 == 0) {
    ...
    for (; uStack_9c != 0; uStack_9c = uStack_9c - 1) {
      ...
      if (uStack_b0 == 0) {
        uStack_6c = __gp;
        uStack_68 = _DAT_006afee4;
        (**(code **)((int)puVar19 + -0x5504))(unaff_s8);
    ...
    do {
      ...
      uStack_6c = uVar18;
      __gp = uStack_6c;
      _DAT_006afee4 = uStack_68;
      if (uStack_b0 == 0) {
        (*(code *)puStack_78[-0x1541])(unaff_s8,enc);
        uVar15 = uStack_6c >> 0x10;
        pbVar13 = (byte *)(uStack_68 >> 0x18);
        __gp = uStack_6c & 0xff000000 | (uStack_6c >> 0x10 & 0xff) << 0x10 | uStack_6c & 0xffff;
        _DAT_006afee4 =
  ...
  *puStack_24 = uStack_b0;
  ...
  if (uVar15 != 0) {
    ...
    do {
      if (uVar17 == 0) {
        iVar7 = iVar7 + 1;
        (*(code *)PTR_CAST_encrypt_006aa9dc)(&uStack_c4,pbVar16);
  ...
  *puStack_74 = uVar17;
  ...
  ppuVar8 = (uint **)(*(code *)PTR_BN_CTX_get_006a9648)(uVar15);
  ppuVar9 = (uint **)(*(code *)PTR_BN_CTX_get_006a9648)(uVar15);
  if (ppuVar9 == (uint **)0x0) {
    (*(code *)PTR_BN_CTX_end_006a9654)(uVar15);
    return;
  }
  iVar7 = (*(code *)PTR_BN_copy_006a9570)(ppuVar8,puStack_74);
  if (iVar7 == 0) {
LAB_00623404:
    (*(code *)PTR_BN_CTX_end_006a9654)(uVar15);
    return;
  }
  iVar7 = (*(code *)PTR_BN_copy_006a9570)(ppuVar9,uVar14);
  if (iVar7 != 0) {
    if (ppuVar9[1] != (uint *)0x0) {
      if (((int)ppuVar8[1] < 1) || (iVar7 = 0, (**ppuVar8 & 1) == 0)) {
        if (((int)ppuVar9[1] < 1) || ((**ppuVar9 & 1) == 0)) goto LAB_006233cc;
        iVar7 = 0;
      }
      while (iVar10 = (*(code *)PTR_BN_is_bit_set_006a9650)(ppuVar9,iVar7), iVar10 == 0) {
        iVar7 = iVar7 + 1;
      }
      iVar7 = (*(code *)PTR_BN_rshift_006a96f8)(ppuVar9,ppuVar9,iVar7);
      if (iVar7 != 0) {
        puVar19 = ppuVar8[1];
        ...
        while (ppuVar4 = ppuVar8, puVar19 != (uint *)0x0) {
          iVar7 = 0;
          while (iVar10 = (*(code *)PTR_BN_is_bit_set_006a9650)(ppuVar4,iVar7), iVar10 == 0) {
            iVar7 = iVar7 + 1;
          }
          iVar7 = (*(code *)PTR_BN_rshift_006a96f8)(ppuVar4,ppuVar4,iVar7);
          if (iVar7 == 0) goto LAB_00623404;
          iVar7 = (*(code *)PTR_BN_nnmod_006a9664)(ppuVar9,ppuVar9,ppuVar4,uVar15);
          if (iVar7 == 0) break;
          puVar19 = ppuVar9[1];
          ppuVar4[3] = (uint *)0x0;
          ppuVar8 = ppuVar9;
