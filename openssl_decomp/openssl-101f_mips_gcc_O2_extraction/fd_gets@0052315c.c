...

{
  ...
  if (param_2 < param_2 + param_3 + -1) {
    if (param_2 != (char *)0x0) {
      ...
      do {
        puVar2 = PTR_read_006aac18;
        *piVar3 = 0;
        iVar4 = (*(code *)puVar2)(param_1->num,pcVar6,1);
        BIO_clear_flags(param_1,0xf);
        if (iVar4 < 1) {
          if (1 < iVar4 + 1U) goto LAB_0052322c;
          iVar4 = *piVar3;
          if (iVar4 != 0x47) {
            if (iVar4 < 0x48) {
              if (iVar4 != 4) {
            ...
            else if ((iVar4 != 0x86) && ((iVar4 < 0x86 || (1 < iVar4 - 0x95U)))) goto LAB_0052322c;
          }
          BIO_set_flags(param_1,9);
          goto LAB_0052322c;
        }
...
LAB_0052322c:
  ...
  if (cVar1 == '\0') {
    return 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00523260. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  uVar5 = (*(code *)PTR_strlen_006aab30)(param_2);
  return uVar5;
}
