...

{
  ...
  if (param_4[1] == (void *)0x0) {
    while( true ) {
      ...
      pvVar5 = (void *)(*(code *)PTR_strlen_006aab30)(p_Var7);
      if (pvVar5 == param_4[3]) {
        iVar3 = (*(code *)PTR_strncasecmp_006aaae0)(p_Var7,param_4[2],pvVar5);
        if (iVar3 == 0) {
          *param_4 = pvVar4;
          param_4[1] = pvVar2;
          break;
  ...
  (*(code *)PTR___stack_chk_fail_006aabb8)();
                    /* WARNING: Could not recover jumptable at 0x0051e9ac. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR_engine_table_unregister_006a997c)(&pkey_asn1_meth_table,p_Var7);
  return;
}
