...

{
  ...
  if (meth == (SSL_METHOD *)0x0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0xc4,"ssl_lib.c",0x695);
    return (SSL_CTX *)0x0;
  }
  iVar2 = SSL_get_ex_data_X509_STORE_CTX_idx();
  if (iVar2 < 0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0x10d,"ssl_lib.c",0x6a3);
LAB_004ac748:
    (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0x41,"ssl_lib.c",0x754);
    return (SSL_CTX *)0x0;
  }
  obj = (SSL_CTX *)CRYPTO_malloc(0x1b8,"ssl_lib.c",0x6a6);
  if (obj == (SSL_CTX *)0x0) goto LAB_004ac748;
  (*(code *)PTR_memset_006aab00)(obj,0,0x1b8);
  ...
  if (pcVar4 != (cert_st *)0x0) {
    ...
    if (plVar5 != (lhash_st_SSL_SESSION *)0x0) {
      pxVar6 = (x509_store_st *)(*(code *)PTR_X509_STORE_new_006a8364)();
      ...
      if (pxVar6 != (x509_store_st *)0x0) {
        ...
        if ((obj->cipher_list == (stack_st_SSL_CIPHER *)0x0) ||
           (iVar2 = (*(code *)PTR_sk_num_006a7f2c)(), iVar2 < 1)) {
          (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0xa1,"ssl_lib.c",0x6ea);
          goto LAB_004ac6dc;
        }
        pXVar7 = (X509_VERIFY_PARAM *)(*(code *)PTR_X509_VERIFY_PARAM_new_006a8cec)();
        obj->param = pXVar7;
        if (pXVar7 != (X509_VERIFY_PARAM *)0x0) {
          pEVar8 = (EVP_MD *)(*(code *)PTR_EVP_get_digestbyname_006a802c)("ssl2-md5");
          obj->rsa_md5 = pEVar8;
          if (pEVar8 == (EVP_MD *)0x0) {
            (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0xf1,"ssl_lib.c",0x6f4);
            goto LAB_004ac6dc;
          }
          pEVar8 = (EVP_MD *)(*(code *)PTR_EVP_get_digestbyname_006a802c)("ssl3-md5");
          obj->md5 = pEVar8;
          if (pEVar8 == (EVP_MD *)0x0) {
            (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0xf2,"ssl_lib.c",0x6f9);
            goto LAB_004ac6dc;
          }
          pEVar8 = (EVP_MD *)(*(code *)PTR_EVP_get_digestbyname_006a802c)("ssl3-sha1");
          obj->sha1 = pEVar8;
          if (pEVar8 == (EVP_MD *)0x0) {
            (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0xf3,"ssl_lib.c",0x6fe);
            goto LAB_004ac6dc;
          }
          psVar9 = (stack_st_X509_NAME *)(*(code *)PTR_sk_new_null_006a80a4)();
          ...
          if (psVar9 != (stack_st_X509_NAME *)0x0) {
            ...
            if (((iVar2 < 1) ||
                (iVar2 = (*(code *)PTR_RAND_bytes_006a8d44)(obj->tlsext_tick_hmac_key,0x10),
                iVar2 < 1)) ||
               (iVar2 = (*(code *)PTR_RAND_bytes_006a8d44)(obj->tlsext_tick_aes_key,0x10), iVar2 < 1
               )) {
            ...
            puVar11 = (undefined4 *)CRYPTO_malloc(0xc,"ssl_lib.c",0x729);
            obj->rbuf_freelist = (ssl3_buf_freelist_st *)puVar11;
            if (puVar11 != (undefined4 *)0x0) {
              *puVar11 = 0;
              puVar11[1] = 0;
              puVar11[2] = 0;
              puVar11 = (undefined4 *)CRYPTO_malloc(0xc,"ssl_lib.c",0x72f);
  ...
  (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xa9,0x41,"ssl_lib.c",0x754);
LAB_004ac6dc:
  iVar2 = CRYPTO_add_lock(&obj->references,-1,0xc,"ssl_lib.c",0x773);
  if (0 < iVar2) {
    return (SSL_CTX *)0x0;
  }
