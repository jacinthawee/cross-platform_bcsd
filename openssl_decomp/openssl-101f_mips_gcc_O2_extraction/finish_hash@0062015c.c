...

{
  ...
  if (param_1[3] != 0) {
    ...
    local_74 = 0;
    local_70 = 0;
    (*(code *)PTR___memcpy_chk_006aab54)(puStack_b4,param_1 + 0x14,param_1[3],0x20);
...
LAB_006206b0:
    ...
    if (pbStack_10c == pbVar42) {
      ...
      puVar9 = puStack_f0;
      puVar43 = PTR___stack_chk_guard_006aabf0;
      puStack_170 = auStack_144;
      uStack_110 = 0xffffff80;
      uStack_114 = 4;
      puStack_150 = &_gp;
      uStack_124 = *(uint *)PTR___stack_chk_guard_006aabf0;
      ...
      *puVar9 = (*(int *)((int)puStack_17c - uVar6) << uVar6 * 8 |
      ...
      if (uStack_124 != *(uint *)puVar43) {
        ...
        puVar43 = PTR___stack_chk_guard_006aabf0;
        piStack_184 = *(int **)PTR___stack_chk_guard_006aabf0;
        keyDiversifyCryptoPro();
        puVar35 = auStack_1a8;
        ...
        iStackY_1c0 = 4;
        puVar9 = puVar14 + 10;
        iVar13 = (*(code *)PTR_memcmp_006aabd8)(puVar35);
