...
LAB_00550958:
    if (out == (BIO *)0x0) {
      ...
      iVar10 = (*(code *)PTR_BIO_write_006a7f14)(out,&DAT_0066a078,1);
...
LAB_00550d58:
  ...
  if (cStack_4d == '\0') {
    ...
    iVar10 = iStack_78;
    if (out == (BIO *)0x0) goto LAB_00550988;
    iVar10 = (*(code *)PTR_BIO_write_006a7f14)(out,&DAT_0067a4e0,1);
    if (iVar10 != 1) goto LAB_00550980;
  }
  iVar7 = str->length;
      ...
      if (0 < iVar10) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar18 & 8) == 0) {
              iVar10 = (*(code *)PTR_BIO_write_006a7f14)(out,&DAT_0066a068,1);
              if (iVar10 != 1) goto LAB_00550980;
...
LAB_00550f78:
          if ((uVar18 & 6) == 0) {
            ...
            iVar10 = (*(code *)PTR_BIO_write_006a7f14)(out,&DAT_0066a074,2);
...
LAB_00550f3c:
  ...
  iVar7 = (*(code *)PTR_BIO_write_006a7f14)(out,&DAT_0067a4e0,1);
