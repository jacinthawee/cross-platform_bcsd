      ...
      if (iVar18 < iVar10) {
        if (puVar19 == (uchar *)0x0) {
          puVar5 = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)
                                      (iVar3 + iVar10,s_f_int_c_0066adb4,0xaa);
        }
        else {
          puVar5 = (uchar *)(*(code *)PTR_CRYPTO_realloc_clean_006a9a00)
                                      (puVar19,iVar18,iVar3 + iVar10,s_f_int_c_0066adb4,0xac);
        }
        iVar18 = iVar3 + iVar10;
        if (puVar5 == (uchar *)0x0) {
...
LAB_005674b4:
  ...
  uVar7 = 0xd7;
LAB_00567588:
  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x66,uVar12,s_f_int_c_0066adb4,uVar7);
  return 0;
}
