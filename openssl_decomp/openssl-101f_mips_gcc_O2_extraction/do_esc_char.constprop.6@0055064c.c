...
LAB_00550958:
    if (a == (ASN1_TYPE *)0x0) {
      ...
      iVar3 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a078,1);
...
LAB_00550d58:
  ...
  if (cStack_8d == '\0') {
    ...
    puVar5 = puStack_b8;
    if (a == (ASN1_TYPE *)0x0) goto LAB_00550988;
    iVar3 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0067a4e0,1);
    if (iVar3 != 1) goto LAB_00550980;
  }
  pcVar6 = *(char **)param_3;
      ...
      if (0 < iVar3) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar20 & 8) == 0) {
              iVar3 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a068,1);
              if (iVar3 != 1) goto LAB_00550980;
...
LAB_00550f78:
          if ((uVar20 & 6) == 0) {
            ...
            iVar3 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a074,2);
