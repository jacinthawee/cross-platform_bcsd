...

{
  ...
  if (pBVar2 == (BIGNUM *)0x0) {
    ...
    unaff_s6 = (BIGNUM *)(CAST_S_table6 + 0x350);
    ...
    unaff_s4 = (uchar *)(**(code **)(local_58 + -0x7dd8))(unaff_s0,&DAT_006675d8,0x171);
    unaff_s1 = pBVar2;
    if (((unaff_s3 == (BIGNUM *)0x0) || (unaff_s5 == (BIGNUM *)0x0)) || (unaff_s4 == (uchar *)0x0))
    {
      pBVar9 = (BIGNUM *)&DAT_006675d8;
...
LAB_0050ebe4:
        ...
        if (((uint)puVar8 & 0x80) == 0) {
          ...
          if (local_44 == 0) {
            ...
            (**(code **)(local_58 + -0x6c74))(9,0x19,&DAT_006675d8,0x149);
            pBVar4 = (BIGNUM *)(**(code **)(local_58 + -0x66b0))(unaff_s3,local_50,param_1,pBVar2);
            param_3 = (BIGNUM *)&DAT_006675d8;
            pBVar9 = (BIGNUM *)0x14b;
...
LAB_0050eba0:
  ...
  iVar3 = iVar3 >> 3;
  to = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar3,&DAT_006675d8,0x200);
  if (((pBVar2 == (BIGNUM *)0x0) || (pBVar4 == (BIGNUM *)0x0)) || (to == (uchar *)0x0)) {
    pBVar9 = (BIGNUM *)0xffffffff;
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x65,0x41,&DAT_006675d8,0x203);
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
...
LAB_0050f47c:
      pBVar9 = (BIGNUM *)0xffffffff;
      (*(code *)PTR_ERR_put_error_006a9030)(4,0x65,uVar14,&DAT_006675d8,uVar11);
    }
    else {
...
LAB_0050f34c:
        ...
        if (((uint)puVar8 & 0x80) == 0) {
          ...
          if (iStack_b4 == 0) {
            ...
            (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x19,&DAT_006675d8,0x149);
            iVar5 = (*(code *)PTR_BN_BLINDING_convert_ex_006a9830)(pBVar2,pBVar6,iVar7,ctx);
            (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x19,&DAT_006675d8,0x14b);
          }
          else {
...
LAB_0050f468:
        ...
        if ((int)pBVar9 < 0) {
          (*(code *)PTR_ERR_put_error_006a9030)(4,0x65,0x72,&DAT_006675d8,0x268);
        }
      }
    }
    BN_CTX_end(ctx);
