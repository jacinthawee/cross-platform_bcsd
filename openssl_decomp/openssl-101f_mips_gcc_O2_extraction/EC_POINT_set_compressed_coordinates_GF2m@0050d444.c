...

{
  ...
  if ((code *)puVar1[0x13] == (code *)0x0) {
    ...
    if ((*puVar1 & 1) == 0) {
                    /* WARNING: Could not recover jumptable at 0x0050d52c. Too many branches */
...
LAB_0050d4cc:
    ...
    if (uVar3 != 0x196) {
      UNRECOVERED_JUMPTABLE = (code *)PTR_ec_GF2m_simple_set_compressed_coordinates_006a97e4;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0050d4f4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  uVar2 = 0x74;
LAB_0050d498:
  (*(code *)PTR_ERR_put_error_006a9030)(0x10,0xba,uVar4,"ec_oct.c",uVar2);
  return 0;
}
