...
LAB_005cf5b0:
    ...
    pcStack_cc = param_3;
    pcStack_160 = param_4;
    uVar5 = (**(code **)(local_38 + -0x7498))(param_1);
    local_30 = param_1;
  }
  ...
  pcStack_64 = param_4;
  iStack_5c = unaff_s7;
  (*(code *)PTR_BN_init_006a96a0)(pcStack_dc);
...
LAB_005cf700:
    ...
    if (iVar3 < 0x881) {
      ...
      if (iVar3 == 0) goto LAB_005cf6a8;
      pcVar6 = *(code **)(puStack_a0 + -0x6848);
    }
    else {
      pcStack_cc = &_ITM_registerTMCloneTable;
      if (AEPHK_lib_error_code == 0) {
      ...
      pcStack_a8 = pcStack_34;
      pcVar13 = pcStack_128;
      iVar3 = (**(code **)(puStack_a0 + -0x7498))(pcStack_dc);
      if (iVar3 == 0) goto LAB_005cf6a8;
      pcVar6 = *(code **)(puStack_a0 + -0x6848);
    }
    pcStack_a8 = pcStack_34;
    ...
    if (AEPHK_lib_error_code == 0) {
      puStack_94 = &_ITM_registerTMCloneTable;
      iVar3 = (**(code **)(puStack_a0 + -0x589c))();
      *(int *)(puStack_94 + -0xba8) = iVar3;
    }
    pcStack_a8 = (char *)0x266;
    (**(code **)(puStack_a0 + -0x6eb0))(iVar3,0x68,0x74,"e_aep.c");
    pcStack_a8 = pcStack_34;
    iVar3 = (**(code **)(puStack_a0 + -0x7498))(pcStack_d0);
    if (iVar3 != 0) {
      pcVar6 = *(code **)(puStack_a0 + -0x7bec);
      goto LAB_005cf700;
    }
LAB_005cf6a8:
  ...
  iVar3 = (*(code *)PTR_BN_num_bits_006a82f4)(pcStack_128);
  if (iVar3 < 0x881) {
      ...
      do {
        ...
        if (pcStack_e8 == *ppcVar11) {
          ...
          if (iVar3 == 0) {
            ...
            *(undefined4 *)(pcStack_164 + 0x6aec58) = 0;
            *(undefined4 *)(pcStack_164 + 0x6aec5c) = 0;
          }
          break;
        }
        ppcVar11 = ppcVar11 + 2;
...
LAB_005cf9cc:
    ...
    uVar5 = (**(code **)(puStack_f0 + -0x7498))(pcStack_124);
  }
  ...
  iVar3 = (*(code *)PTR_BN_num_bits_006a82f4)(pcStack_f8);
  if (iVar3 < 0x881) {
    iVar3 = aep_get_connection(&pcStack_138);
    if (iVar3 != 0) {
      pcStack_17c = &_ITM_registerTMCloneTable;
      if (AEPHK_lib_error_code == 0) {
        AEPHK_lib_error_code = (**(code **)(puStack_140 + -0x589c))();
      }
      pcStack_148 = (char *)0x26e;
      (**(code **)(puStack_140 + -0x6eb0))(AEPHK_lib_error_code,0x68,0x69,"e_aep.c");
      goto LAB_005cfcf0;
    }
    uStack_144 = 0;
    ...
    if (iVar3 != 0) {
      ...
      pcStack_17c = "7 datafinal";
      pcStack_148 = (char *)0x277;
      (**(code **)(puStack_140 + -0x6eb0))(AEPHK_lib_error_code,0x68,0x6e,"e_aep.c");
      (**(code **)(puStack_140 + -0x6c74))(9,0x1e,"e_aep.c",0x3e2);
      ppcVar11 = (char **)(aep_app_conn_table + 4);
      pcVar13 = (char *)0x0;
      do {
        pcStack_164 = pcVar13 + 1;
      ...
      (**(code **)(puStack_140 + -0x6c74))(10,0x1e,"e_aep.c",0x3f3);
      pcStack_160 = pcStack_138;
      goto LAB_005cfcf0;
    }
    pcStack_17c = "7 datafinal";
    (**(code **)(puStack_140 + -0x6c74))(9,0x1e,"e_aep.c",0x3cc);
    ppcVar11 = (char **)(aep_app_conn_table + 4);
    iVar3 = 0;
    do {
      iVar4 = iVar3 + 1;
    ...
    pcStack_148 = (char *)0x266;
    (**(code **)(puStack_140 + -0x6eb0))(AEPHK_lib_error_code,0x68,0x74,"e_aep.c");
LAB_005cfcf0:
    pcStack_148 = pcStack_168;
    pcVar13 = pcStack_170;
    pcVar15 = pcStack_16c;
    pcVar16 = pcStack_178;
    uVar5 = (**(code **)(puStack_140 + -0x7498))(pcStack_174);
  }
  ...
  iVar3 = (*(code *)PTR_BN_num_bits_006a82f4)(pcStack_148);
  if (iVar3 < 0x881) {
  ...
  uVar5 = (*(code *)PTR_BN_mod_exp_006a8a48)(pcVar13,pcVar15,pcVar16,pcVar1,uVar2);
LAB_005d0034:
