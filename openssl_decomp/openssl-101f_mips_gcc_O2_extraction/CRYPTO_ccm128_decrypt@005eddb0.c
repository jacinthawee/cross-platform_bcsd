...

{
  ...
  local_48 = (code **)PTR___stack_chk_guard_006aabf0;
        ...
        *(byte *)local_50 = bVar21 ^ local_40._0_1_;
        ...
        if ((byte *)((int)local_58 + -1) < (byte *)0x3) {
          ...
          *(uint *)(param_1 + 0x10) = uVar11 ^ local_40 ^ *(uint *)(param_1 + 0x10);
          ...
          if (local_58 == puVar24) goto LAB_005ee3e0;
        }
...
LAB_005ee3e0:
    ...
    (*(code *)local_60[-0x14f8])(param_1 + (0xf - uStack_88),0,0x10 - local_44);
    (*pcStack_94)(param_1,unaff_s5,puStack_90);
    puVar13 = (uint *)0x0;
  ...
  pbStack_9c = *(byte **)PTR___stack_chk_guard_006aabf0;
  puVar13 = puStack_f8;
  puVar24 = puStack_f4;
  puStack_98 = unaff_s0;
  pbStack_8c = unaff_s3;
  ...
  if (puStack_100 == param_4) {
    ...
    *(uint *)(pcStack_110 + 0x20) = uVar18;
    if ((uVar18 < 0x20000001) && ((uVar18 != 0x20000000 || (uVar11 == 0)))) {
      ...
      puVar13 = (uint *)(pcStack_110 + 0x10);
      if (puVar24 == (uint *)0x0) {
        if (puStack_100 != (uint *)0x0) goto LAB_005ee834;
      }
      else {
        ...
        if ((((uint)puStack_bc & (puStack_f8 < pcStack_110 + 0x14 ^ 1 | puVar13 < puStack_b8 ^ 1))
          ...
          if (puStack_100 < &SUB_00000004) {
            ...
            *(uint *)(pcStack_110 + 0x10) = *puStack_f8 ^ *(uint *)(pcStack_110 + 0x10);
            ...
            if (puVar24 == puVar14) goto LAB_005ee948;
          }
            ...
            *puStack_f4 = *puStack_f8 ^ uStack_b0;
            ...
            if (puVar24 != puVar13) {
              ...
              *(byte *)(puStack_f4 + iVar12) =
              ...
              if (puVar13 < puStack_100) goto LAB_005eea68;
            }
          }
        }
      }
LAB_005eeb10:
      ...
      (**(code **)(puStack_d0 + -0x53e0))(pcStack_110 + (0xf - uStack_fc),0,0x10 - (int)puVar26);
  ...
  pbStack_114 = *(byte **)PTR___stack_chk_guard_006aabf0;
  ...
  *pbVar19 = (byte)uVar11;
  ...
  if (uVar18 == 0) {
    if (param_4 != (uint *)0x0) goto LAB_005ef3c4;
  }
  else {
      ...
      *(byte *)puVar24 = bVar16 ^ uStack_128._0_1_;
      ...
      if (puVar15 < &SUB_00000004) {
        ...
        *(uint *)(pbVar19 + 0x10) = uStack_128 ^ uVar18 ^ *(uint *)(pbVar19 + 0x10);
        ...
        if (puVar17 == puVar23) goto LAB_005ef5c4;
      }
...
LAB_005ef1e4:
  (*(code *)PTR_memset_006aab00)(pbVar19 + (0xf - uVar11),0,0x10 - iVar12);
  (*pcVar27)(pbVar19,&uStack_128,puVar14);
  puVar13 = (uint *)0x0;
...
LAB_005ef260:
  ...
  if (puVar13 <= puVar26) {
    (*(code *)PTR_memcpy_006aabf4)(pbVar22,pbVar19 + 0x10,puVar13);
    return puVar13;
  }
  return (uint *)0x0;
}
