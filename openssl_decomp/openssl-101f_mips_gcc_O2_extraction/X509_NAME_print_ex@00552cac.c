...
LAB_00553580:
    ...
    if ((int)(uStack_d4 << 8) < 0) {
      ...
      iStack_194 = 3;
      puStack_18c = &DAT_0066a094;
    }
    else {
      _Stack_190.boolean = 1;
      iStack_194 = 1;
      puStack_18c = &DAT_00669e38;
    }
...
LAB_00550958:
    if (a == (ASN1_TYPE *)0x0) {
      ...
      iVar8 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a078,1);
...
LAB_00550d58:
  ...
  if (cStack_21d == '\0') {
    ...
    iVar8 = iStack_248;
    if (a == (ASN1_TYPE *)0x0) goto LAB_00550988;
    iVar8 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0067a4e0,1);
    if (iVar8 != 1) goto LAB_00550980;
  }
  psVar16 = (stack_st_X509_NAME_ENTRY *)(_Var9.object)->sn;
      ...
      if (0 < iVar8) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar23 & 8) == 0) {
              iVar8 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a068,1);
              if (iVar8 != 1) goto LAB_00550980;
...
LAB_00550f78:
          if ((uVar23 & 6) == 0) {
            ...
            iVar8 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a074,2);
...
LAB_00550f3c:
  ...
  iVar7 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0067a4e0,1);
