...

{
  ...
  if (cookie_initialized != 0) {
    uVar20 = (*(code *)PTR_SSL_get_rbio_006a8924)();
    (*(code *)PTR_BIO_ctrl_006a7f18)(uVar20,0x2e,0,&local_80);
    if (local_80 == 2) {
      uVar20 = 6;
      uVar31 = 6;
    }
    ...
    puVar21 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(uVar20,"s_cb.c",0x378);
    ...
    (*(code *)PTR_HMAC_006a8d50)
              (uVar20,PTR_cookie_secret_006a8d48,0x10,puVar21,uVar31,auStack_64,&local_84);
    (*(code *)PTR_CRYPTO_free_006a7f88)(puVar21);
    if ((local_84 == param_3) &&
       (iVar22 = (*(code *)PTR_memcmp_006aabd8)(auStack_64,param_2,param_3), iVar22 == 0)) {
      uVar19 = 1;
      goto LAB_0045f728;
    }
  }
...
LAB_0045f728:
  ...
  if (((ghbn_cache._148_4_ == 0xffffffff) || (ghbn_cache._148_4_ != 0)) &&
     (iVar22 = (*(code *)PTR_strncmp_006aaa7c)(uVar27,ghbn_cache,0x80), iVar22 == 0)) {
    iVar22 = 0;
  }
  else {
    uVar23 = uVar19;
    ...
    if ((ghbn_cache._300_4_ == 0) ||
       (iVar22 = (*(code *)PTR_strncmp_006aaa7c)(uVar27,0x6abac0,0x80), iVar22 != 0)) {
      uVar24 = uVar23;
      ...
      if ((ghbn_cache._452_4_ == 0) ||
         (iVar22 = (*(code *)PTR_strncmp_006aaa7c)(uVar27,0x6abb58,0x80), iVar22 != 0)) {
        if (ghbn_cache._604_4_ < uVar24) {
          uVar19 = 3;
        }
        if ((ghbn_cache._604_4_ == 0) ||
           (iVar22 = (*(code *)PTR_strncmp_006aaa7c)(uVar27,0x6abbf0,0x80), iVar22 != 0)) {
          ghbn_miss = ghbn_miss + 1;
          uVar23 = (*(code *)PTR_gethostbyname_006aaa70)(uVar27);
          if (uVar23 == 0) {
            uVar23 = 0;
          }
          else {
            uVar24 = (*(code *)PTR_strlen_006aab30)(uVar27);
            if (uVar24 < 0x80) {
              uVar28 = 0x80;
              uVar24 = uVar24 + 1;
              iVar30 = uVar19 * 0x98;
              puVar29 = ghbn_cache + iVar30;
              iVar25 = (*(code *)PTR___memcpy_chk_006aab54)();
              uVar19 = uVar23 & 3;
              uVar2 = uVar23 + 4 & 3;
