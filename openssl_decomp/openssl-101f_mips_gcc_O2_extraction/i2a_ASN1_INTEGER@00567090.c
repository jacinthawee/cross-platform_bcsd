...
LAB_005670f4:
    if (a->length == 0) {
      ...
      iVar20 = 0;
      local_34 = (ASN1_INTEGER *)&DAT_0066adb0;
      while( true ) {
        iVar4 = iVar19;
        in_a2 = &SUB_00000002;
    ...
    in_a2 = (byte *)0x1;
    pAVar10 = (ASN1_INTEGER *)&DAT_00662b94;
      ...
      if (iVar21 < iVar12) {
        if (puVar22 == (uchar *)0x0) {
          puVar6 = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)
                                      (iVar19 + iVar12,s_f_int_c_0066adb4,0xaa);
        }
        else {
          puVar6 = (uchar *)(*(code *)PTR_CRYPTO_realloc_clean_006a9a00)
                                      (puVar22,iVar21,iVar19 + iVar12,s_f_int_c_0066adb4,0xac);
        }
        iVar21 = iVar19 + iVar12;
        if (puVar6 == (uchar *)0x0) {
          (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x66,0x41,s_f_int_c_0066adb4,0xaf);
          if (puVar22 != (uchar *)0x0) {
...
LAB_005674b4:
  ...
  uVar8 = 0xd7;
LAB_00567588:
  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x66,uVar14,s_f_int_c_0066adb4,uVar8);
  return 0;
}
