...

{
  ...
  if (iVar3 < 1) {
    ...
    (*(code *)PTR_BIO_printf_006a7f38)(param_7,"Pass %s\n",auStack_424);
    puVar5 = &local_430;
    puVar9 = &local_434;
    local_450 = param_5;
    puStack_488 = (undefined4 *)(*(code *)PTR_SRP_create_verifier_006a9018)(param_1,auStack_424);
    uVar2 = local_430;
    local_44c = param_4;
    if (puStack_488 == (undefined4 *)0x0) {
      ...
      pcVar7 = (char *)param_2;
      iVar3 = (*(code *)PTR_strcmp_006aac20)(local_430);
      if (iVar3 != 0) {
        puStack_488 = (undefined4 *)0x0;
      }
  ...
  if (iVar4 < 1) {
    ...
    if (puVar5 == (undefined4 *)0x0) {
      (*(code *)PTR_BIO_printf_006a7f38)(local_448,"Internal error creating SRP verifier\n");
    }
    else {
      *puVar9 = uStack_898;
    }
  ...
  if (iStack_48c != *(int *)puVar1) {
    ...
    if (puVar10 == (undefined4 *)0x49) {
      while (iVar4 = (*(code *)PTR_sk_num_006a7f2c)(*(undefined4 *)(*(int *)(iVar3 + 4) + 4)),
            (int)puVar9 < iVar4) {
        ppcVar6 = (char **)(*(code *)PTR_sk_value_006a7f24)
                                     (*(undefined4 *)(*(int *)(iVar3 + 4) + 4),puVar9);
        if (**ppcVar6 == 'I') {
          iVar4 = (*(code *)PTR_strcmp_006aac20)(pcVar8,ppcVar6[3]);
          if (iVar4 == 0) {
            return puVar9;
          }
      ...
      for (; iVar4 = (*(code *)PTR_sk_num_006a7f2c)(*(undefined4 *)(*(int *)(iVar3 + 4) + 4)),
          (int)puVar9 < iVar4; puVar9 = (undefined4 *)((int)puVar9 + 1)) {
        ppcVar6 = (char **)(*(code *)PTR_sk_value_006a7f24)
                                     (*(undefined4 *)(*(int *)(iVar3 + 4) + 4),puVar9);
        if ((**ppcVar6 != 'I') &&
           (iVar4 = (*(code *)PTR_strcmp_006aac20)(pcVar8,ppcVar6[3]), iVar4 == 0)) {
          return puVar9;
        }
      }
    }
