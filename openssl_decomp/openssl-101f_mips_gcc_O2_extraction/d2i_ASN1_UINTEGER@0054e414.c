...
LAB_0054e470:
    ...
    if ((uVar5 & 0x80) == 0) {
      ...
      if (local_2c == 2) {
        pcVar13 = "a_int.c";
        puVar6 = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)(local_30 + 1,"a_int.c",0x131);
        if (puVar6 != (uchar *)0x0) {
          pAStack_6c->type = 2;
          if (local_30 != 0) {
            ...
            (*(code *)PTR_memcpy_006aabf4)(puVar6);
      ...
      pcVar13 = (char *)0x96;
      ERR_put_error(0xd,0x96,iVar14,"a_int.c",0x149);
    }
    else {
      pcVar13 = (char *)0x96;
...
LAB_0054e4f8:
  ...
  if (*piVar10 < 5) {
    ...
    puVar7 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(5,"a_int.c",0x15b);
...
LAB_0054e748:
        ...
        iVar14 = 0;
        if ((uchar **)pcVar13 != (uchar **)0x0) goto LAB_0054e70c;
      }
LAB_0054e770:
