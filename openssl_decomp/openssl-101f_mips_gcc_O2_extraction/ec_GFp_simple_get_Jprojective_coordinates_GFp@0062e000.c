...

{
  ...
  if (*(int *)(*param_1 + 0x94) == 0) {
    if (((param_3 == 0) ||
        (iVar2 = (*(code *)PTR_BN_copy_006a9570)(param_3,param_2 + 4), iVar2 != 0)) &&
       ((param_4 == 0 ||
        (iVar2 = (*(code *)PTR_BN_copy_006a9570)(param_4,param_2 + 0x18), iVar2 != 0)))) {
      if (param_5 != 0) {
        iVar2 = (*(code *)PTR_BN_copy_006a9570)(param_5,param_2 + 0x2c);
        return iVar2 != 0;
      }
      return true;
    }
    ...
    iVar2 = 0;
    if ((param_6 != 0) ||
       (param_6 = (*(code *)PTR_BN_CTX_new_006a8a38)(), iVar2 = param_6, param_6 != 0)) {
      if (((param_3 == 0) ||
