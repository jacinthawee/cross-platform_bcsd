...

{
  ...
  auStack_fc._80_4_ = (stack_st_IPAddressFamily *)PTR___stack_chk_guard_006aabf0;
  local_78 = &_gp;
  ...
  if (subject == (X509 *)0x0) {
    ...
    auStack_fc._88_4_ = (**(code **)(local_78 + -0x7710))(subject);
    auStack_fc._92_4_ = (**(code **)(local_78 + -0x7e44))(subject);
  }
  auStack_fc._96_4_ = (X509 **)(**(code **)(local_78 + -0x6fc8))(issuer);
...
LAB_005afbd0:
    ...
    if (iVar3 == 0) {
      pcVar17 = *(code **)(local_78 + -0x6eb0);
      pXVar14 = (X509 *)&DAT_00000078;
      local_80 = (EVP_MD *)&DAT_00000074;
LAB_005afbac:
      in_a3 = "ocsp_lib.c";
...
LAB_005afbc0:
    ...
    if (pXVar4 == (X509_CINF *)0x0) goto LAB_005afbc0;
    pXVar16 = (X509_ALGOR *)(**(code **)(local_78 + -0x6f24))();
    issuer->sig_alg = pXVar16;
    if (pXVar16 == (X509_ALGOR *)0x0) goto LAB_005afbc0;
    pcVar17 = *(code **)(local_78 + -0x5b68);
    unaff_s7 = local_70;
    ...
    if (iVar3 == 0) {
      pcVar17 = *(code **)(local_78 + -0x6eb0);
      pXVar14 = (X509 *)0x66;
      local_80 = (EVP_MD *)&DAT_0000008b;
      goto LAB_005afbac;
    }
    pXVar12 = issuer;
    pXVar14 = local_70[0];
    iVar3 = (**(code **)(local_78 + -0x6750))((auStack_fc._72_4_)->issuerNameHash);
    ...
    in_a3 = (char *)unaff_s7;
    local_80 = dgst;
    iVar3 = (**(code **)(local_78 + -0x73dc))(auStack_fc._96_4_[2]);
    if ((iVar3 == 0) ||
       (pXVar12 = issuer,
       iVar3 = (**(code **)(local_78 + -0x6750))((auStack_fc._72_4_)->issuerKeyHash),
       pXVar14 = local_70[0], iVar3 == 0)) goto LAB_005afbc0;
    pOVar5 = auStack_fc._72_4_;
    if (auStack_fc._92_4_ != 0) {
      (**(code **)(local_78 + -0x7f4c))((auStack_fc._72_4_)->serialNumber);
      pAVar10 = (ASN1_INTEGER *)(**(code **)(local_78 + -0x5b64))(auStack_fc._92_4_);
  ...
  auStack_fc._64_4_ = *(undefined4 **)PTR___stack_chk_guard_006aabf0;
  pXVar14 = pXVar12;
        ...
        if (pAVar9 != (ASN1_TYPE *)0x0) {
          ...
          if (iVar6 != 0) {
            ...
            if ((iVar3 != 0) &&
               ...
               iVar3 != 0)) {
              if ((X509 **)in_a3 == (X509 **)0x0) goto LAB_005afe28;
              (*(code *)PTR_ASN1_INTEGER_free_006a7f94)(pOVar5->serialNumber);
              pAVar10 = (ASN1_INTEGER *)(*(code *)PTR_ASN1_INTEGER_dup_006aa37c)(in_a3);
...
LAB_005afe28:
  ...
  pOVar5 = (OCSP_CERTID *)
           (*(code *)PTR_OBJ_cmp_006a9de4)(*(undefined4 *)*puVar11,pXVar14->cert_info->version);
  if ((pOVar5 == (OCSP_CERTID *)0x0) &&
     (pOVar5 = (OCSP_CERTID *)
               (*(code *)PTR_ASN1_OCTET_STRING_cmp_006a9ffc)(puVar11[1],pXVar14->sig_alg),
     pOVar5 == (OCSP_CERTID *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x005b0000. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    pOVar5 = (OCSP_CERTID *)
             (*(code *)PTR_ASN1_OCTET_STRING_cmp_006a9ffc)(puVar11[2],pXVar14->signature);
    return pOVar5;
  }
  return pOVar5;
}
