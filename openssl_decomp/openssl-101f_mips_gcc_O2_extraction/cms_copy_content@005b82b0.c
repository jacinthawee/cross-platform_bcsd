...

{
  ...
  local_1030 = &_gp;
  local_24 = *(CMS_SignerInfo **)PTR___stack_chk_guard_006aabf0;
  if (param_1 == (undefined *)0x0) {
    uVar10 = (*(code *)PTR_BIO_s_null_006a89ec)();
...
joined_r0x005b84cc:
    if (puStack_105c == (undefined *)0x0) {
      ...
      puVar7 = &DAT_0000006b;
      uStack_1060 = 0;
      (**(code **)(local_1030 + -0x6eb0))(0x2e,0x6b,0x41);
      goto LAB_005b8360;
    }
  }
  else {
    ...
    if ((param_3 & 1) != 0) {
      ...
      goto joined_r0x005b84cc;
    }
  }
  do {
    iVar9 = 0x1000;
    puVar7 = auStack_1024;
    iVar2 = (**(code **)(local_1030 + -0x7924))(param_2,auStack_1024,0x1000);
    if (iVar2 < 1) {
      iVar3 = (**(code **)(local_1030 + -0x6a9c))(param_2);
      if (iVar3 == 0x20a) {
        param_4 = (char *)0x0;
        iVar9 = 0;
      ...
      if (iVar2 == 0) {
        param_3 = param_3 & 1;
        if ((param_3 == 0) ||
           (puVar7 = param_1, iVar2 = (**(code **)(local_1030 + -0x5c2c))(puStack_105c,param_1),
           iVar2 != 0)) {
          uStack_1060 = 1;
        }
        else {
          ...
          puVar7 = &DAT_0000006b;
          uStack_1060 = 0;
          (**(code **)(local_1030 + -0x6eb0))(0x2e,0x6b,0x8c);
        }
        goto LAB_005b834c;
      }
      break;
...
LAB_005b8360:
  ...
  puVar1 = PTR___stack_chk_guard_006aabf0;
  pCStack_1064 = *(CMS_ContentInfo **)PTR___stack_chk_guard_006aabf0;
  uStack_1058 = param_2;
  puStack_1054 = param_1;
  uStack_1050 = param_3;
  CMS_SignerInfo_get0_algs(si,(EVP_PKEY **)0x0,&pXStack_10f0,(X509_ALGOR **)0x0,(X509_ALGOR **)0x0);
  iVar9 = (*(code *)PTR_X509_STORE_CTX_init_006a8304)(auStack_10ec,puVar7,pXStack_10f0,iVar9);
  if (iVar9 == 0) {
    ...
    pcVar8 = "smime_sign";
    (*(code *)PTR_X509_STORE_CTX_set_default_006a9498)(auStack_10ec,"smime_sign");
    if (param_4 != (char *)0x0) {
      (*(code *)PTR_X509_STORE_CTX_set0_crls_006a8568)(auStack_10ec,param_4);
      pcVar8 = param_4;
    }
    iVar9 = (*(code *)PTR_X509_verify_cert_006a8308)(auStack_10ec);
    if (iVar9 < 1) {
      uVar4 = (*(code *)PTR_X509_STORE_CTX_get_error_006a8314)(auStack_10ec);
      (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0x99,100,"cms_smime.c",0x130);
      uVar10 = 0;
      pXStack_10f0 = (X509 *)(*(code *)PTR_X509_verify_cert_error_string_006a839c)(uVar4);
      pcVar8 = "Verify error:";
      (*(code *)PTR_ERR_add_error_data_006a9264)(2,"Verify error:",pXStack_10f0);
    }
    else {
      uVar10 = 1;
    }
  }
  (*(code *)PTR_X509_STORE_CTX_cleanup_006a8310)(auStack_10ec);
