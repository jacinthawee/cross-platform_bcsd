...

{
  ...
  if (param_1 == (ASN1_TEMPLATE *)0x0) {
    ...
    param_3 = unaff_s7;
LAB_00563154:
    pcStack_1c4 = s_tasn_dec_c_0066ab2c;
              ...
              if (0 < (int)pAVar8) {
                ...
                do {
                  ...
                  if (((pAVar8 == (ASN1_ITEM_EXP *)0x1) || (param_5->itype != '\0')) ||
                    ...
                    cVar19 = (char)in_stack_fffffed8;
                    if ((uVar5 & 0x80) != 0) {
                      (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x68,0x66,s_tasn_dec_c_0066ab2c);
                      pcStack_1c4 = s_tasn_dec_c_0066ab2c;
                      pAVar12 = (ASN1_ITEM_EXP *)&DAT_0000003a;
...
LAB_00562f3c:
        ...
        uVar13 = 0x66;
LAB_00562d40:
        (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x68,uVar13,s_tasn_dec_c_0066ab2c);
      }
      else {
        if (param_8->itype == '\0') {
          pcStack_1c4 = local_44 + 4;
...
switchD_005634b4_caseD_1:
                ...
                if ((pAStack_cc == (ASN1_ITEM *)0x0) &&
                  ...
                  uVar13 = 0x3a;
LAB_00563954:
                  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x78,uVar13,s_tasn_dec_c_0066ab2c);
                  goto LAB_00563968;
                }
...
LAB_00563d8c:
                    ...
                    (*(code *)PTR_ERR_add_error_data_006a9264)
                              (4,&DAT_0066ab40,param_3->tcount,", Type=");
                    goto switchD_005634b4_caseD_7;
                  }
                  goto LAB_00563968;
                }
...
LAB_0056397c:
                AStack_16c.size = (long)(auStack_d0 + 4);
                (*(code *)PTR_ERR_add_error_data_006a9264)(2,s_Type__0066ab48,pAStack_1a8->sname);
              default:
...
LAB_005640c0:
  ...
  if (pAVar12 != (ASN1_ITEM_EXP *)0x0) {
    ...
    if (bVar1 < 7) {
      ...
      pAVar12 = (ASN1_ITEM_EXP *)(*(code *)(&PTR_LAB_0066ab88)[bVar1])();
      return pAVar12;
    }
  }
...
LAB_005657e8:
              ASN1_item_ex_free((ASN1_VALUE **)pAVar8,(ASN1_ITEM *)it);
LAB_005657fc:
              pcVar15 = &DAT_0066ab40;
              (*(code *)PTR_ERR_add_error_data_006a9264)
                        (4,&DAT_0066ab40,tt->field_name,", Type=",*(char **)((int)it + 0x18));
              goto switchD_00565630_caseD_7;
            }
            goto LAB_0056529c;
          }
...
LAB_00565288:
  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x78,uVar14,s_tasn_dec_c_0066ab2c,uVar13);
LAB_0056529c:
  ASN1_item_ex_free((ASN1_VALUE **)pAVar8,(ASN1_ITEM *)it);
LAB_005652b4:
  pcVar15 = s_Type__0066ab48;
  (*(code *)PTR_ERR_add_error_data_006a9264)(2,s_Type__0066ab48,*(char **)((int)it + 0x18));
