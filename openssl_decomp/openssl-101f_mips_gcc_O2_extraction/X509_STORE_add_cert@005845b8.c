...

{
  ...
  x_00 = (X509_OBJECT *)(*(code *)PTR_CRYPTO_malloc_006a8108)(8,"x509_lu.c",0x154);
  puVar1 = PTR_CRYPTO_lock_006a926c;
  if (x_00 != (X509_OBJECT *)0x0) {
    (x_00->data).x509 = x;
    x_00->type = 1;
    (*(code *)puVar1)(9,0xb,"x509_lu.c",0x15d);
    if (x_00->type == 1) {
    ...
    if (pXVar2 == (X509_OBJECT *)0x0) {
      ...
      (*(code *)PTR_ERR_put_error_006a9030)(0xb,0x7c,0x65,"x509_lu.c",0x165);
    }
    (*(code *)PTR_CRYPTO_lock_006a926c)(10,0xb,"x509_lu.c",0x16a);
    return iVar3;
  }
  (*(code *)PTR_ERR_put_error_006a9030)(0xb,0x7c,0x41,"x509_lu.c",0x157);
  return 0;
}
