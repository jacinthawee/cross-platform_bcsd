...

{
  ...
  local_58 = &_gp;
  uVar13 = param_3 & 3;
  local_48 = (uint **)PTR___stack_chk_guard_006aabf0;
  local_38 = *(uint *)(param_3 + 4);
  puVar7 = *(uint **)PTR___stack_chk_guard_006aabf0;
  uVar12 = param_3 + 3 & 3;
  ...
  if (param_5 < &DAT_00000008) {
    if (param_5 == (uint *)0x0) goto LAB_0061880c;
    puVar7 = (uint *)0x0;
    puVar11 = (uint *)&DAT_00000008;
LAB_006188a0:
    local_34 = 0;
    local_30 = 0;
    uVar27 = (*(code *)PTR___memcpy_chk_006aab54)
    ...
    if (puVar7 < param_5) goto LAB_006188a0;
  }
...
LAB_0061880c:
  ...
  if ((int)puVar15 < 1) {
    ...
    puVar7 = &local_3c;
    (**(code **)(local_58 + -0x52ec))(local_4c,puVar7,puVar15);
  }
  puStack_90 = puVar15;
  if (uStack_8c != 0) {
  ...
  puVar11 = (uint *)PTR___stack_chk_guard_006aabf0;
  puVar26 = auStack_d8;
  pbVar19 = &bStack_b4;
  puStack_c8 = &_gp;
  ...
  *puVar7 = uStack_bc;
  ...
  while( true ) {
    ...
    *(undefined4 *)(puVar26 + -0x24) = *(undefined4 *)PTR___stack_chk_guard_006aabf0;
    puVar8 = puVar4;
    puVar11 = puVar10;
    puVar2 = (uint *)(*(code *)PTR_DH_new_006a8618)();
    ...
    if (puVar2 == (uint *)0x0) {
      ...
      (**(code **)(puVar23 + -0x53e0))(puVar7,0,0x80);
      puVar15 = puVar26 + -0xa4;
      uVar13 = (**(code **)(*(int *)(puVar26 + -0x1a0) + -0x6de0))
                         (*(undefined4 *)(puVar4[5] + 0x14));
      iVar24 = *(int *)(puVar26 + -0x1a0);
      puVar2[3] = uVar13;
      uVar13 = (**(code **)(iVar24 + -0x6de0))(*(undefined4 *)(puVar4[5] + 0xc));
      pcVar22 = *(code **)(*(int *)(puVar26 + -0x1a0) + -0x6de0);
      puVar2[2] = uVar13;
      uVar13 = (*pcVar22)(uVar9);
      pcVar22 = *(code **)(*(int *)(puVar26 + -0x1a0) + -0x57fc);
      puVar2[6] = uVar13;
      iVar3 = (*pcVar22)(puVar4);
      puVar8 = *(uint **)(iVar3 + 0x18);
      puVar11 = puVar2;
      puVar20 = (uint *)(**(code **)(*(int *)(puVar26 + -0x1a0) + -0x6db4))(puVar15);
      puVar18 = puVar2;
      if (puVar20 == (uint *)0x0) {
        (**(code **)(*(int *)(puVar26 + -0x1a0) + -0x78dc))(puVar2);
        uVar13 = 0;
        puVar23 = *(undefined **)(puVar26 + -0x1a0);
      }
      else {
        (**(code **)(*(int *)(puVar26 + -0x1a0) + -0x53e0))(puVar7,0,0x80);
        ...
        (**(code **)(iVar25 + -0x78dc))(puVar2);
        init_gost_hash_ctx(puVar15,*(undefined4 *)(*(int *)(puVar26 + -0x1a0) + -0x5808));
        start_hash(puVar15);
    ...
    *(undefined **)(puVar26 + -0x1c8) = &_gp;
    puVar4 = (uint *)(*(code *)PTR_EVP_PKEY_CTX_get0_peerkey_006aa934)();
    uVar27 = (**(code **)(*(int *)(puVar26 + -0x1c8) + -0x5800))(iVar3);
    *puVar11 = 0x20;
    if (puVar8 == (uint *)0x0) {
      return 1;
    }
