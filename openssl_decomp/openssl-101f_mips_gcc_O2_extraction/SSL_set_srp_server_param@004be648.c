...

{
  ...
  if (param_2 != 0) {
    if (*(int *)(param_1 + 0x1a8) == 0) {
      uVar2 = (*(code *)PTR_BN_dup_006a9100)(param_2);
      *(undefined4 *)(param_1 + 0x1a8) = uVar2;
    }
    else {
      iVar1 = (*(code *)PTR_BN_copy_006a9570)();
      if (iVar1 == 0) {
  ...
  if (param_3 != 0) {
    if (*(int *)(param_1 + 0x1ac) == 0) {
      uVar2 = (*(code *)PTR_BN_dup_006a9100)(param_3);
      *(undefined4 *)(param_1 + 0x1ac) = uVar2;
    }
    else {
      iVar1 = (*(code *)PTR_BN_copy_006a9570)(*(int *)(param_1 + 0x1ac),param_3);
      if (iVar1 == 0) {
  ...
  if (param_4 != 0) {
    if (*(int *)(param_1 + 0x1b0) == 0) {
      uVar2 = (*(code *)PTR_BN_dup_006a9100)(param_4);
      *(undefined4 *)(param_1 + 0x1b0) = uVar2;
    }
    else {
      iVar1 = (*(code *)PTR_BN_copy_006a9570)(*(int *)(param_1 + 0x1b0),param_4);
      if (iVar1 == 0) {
  ...
  if (param_5 != 0) {
    if (*(int *)(param_1 + 0x1c4) == 0) {
      uVar2 = (*(code *)PTR_BN_dup_006a9100)(param_5);
      *(undefined4 *)(param_1 + 0x1c4) = uVar2;
    }
    else {
      iVar1 = (*(code *)PTR_BN_copy_006a9570)(*(int *)(param_1 + 0x1c4),param_5);
      if (iVar1 == 0) {
