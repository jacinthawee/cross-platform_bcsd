...

{
  ...
  if ((uVar7 & 4) != 0) {
    ...
    if ((pBVar6 == (BN_MONT_CTX *)0x0) ||
       ...
       pBVar6 == (BN_MONT_CTX *)0x0)) goto LAB_0050dcd0;
    uVar7 = *(uint *)(param_3 + 0x3c);
  }
  if ((uVar7 & 2) != 0) {
    pBVar6 = BN_MONT_CTX_set_locked
                       ((BN_MONT_CTX **)(param_3 + 0x40),9,*(BIGNUM **)(param_3 + 0x10),param_4);
    if (pBVar6 == (BN_MONT_CTX *)0x0) goto LAB_0050dcd0;
    uVar7 = *(uint *)(param_3 + 0x3c);
  }
  if ((uVar7 & 0x100) == 0) {
    local_68 = *param_2;
    ...
    iVar5 = (*(code *)PTR_BN_div_006a967c)(0,pBVar2,param_2,*(undefined4 *)(param_3 + 0x20),param_4)
    ;
  }
  if (iVar5 == 0) goto LAB_0050dcd0;
  ...
  if ((*(uint *)(param_3 + 0x3c) & 0x100) == 0) {
    ...
    if (iVar5 == 0) goto LAB_0050dcd0;
    if ((*(uint *)(param_3 + 0x3c) & 0x100) != 0) goto LAB_0050dee0;
LAB_0050d9a8:
    ...
    iVar5 = (*(code *)PTR_BN_div_006a967c)(0,pBVar2,param_2,*(undefined4 *)(param_3 + 0x1c),param_4)
    ;
    if (iVar5 == 0) goto LAB_0050dcd0;
    if ((*(uint *)(param_3 + 0x3c) & 0x100) == 0) goto LAB_0050d9a8;
LAB_0050dee0:
  ...
  if ((((iVar5 != 0) && (iVar5 = (*(code *)PTR_BN_sub_006a96cc)(param_1,param_1,pBVar3), iVar5 != 0)
       ) && ((param_1->neg == 0 ||
    ...
    if (((iVar5 != 0) &&
        (((param_1->neg == 0 ||
          (iVar5 = (*(code *)PTR_BN_add_006a96c8)(param_1,param_1,*(undefined4 *)(param_3 + 0x1c)),
          iVar5 != 0)) &&
         (iVar5 = BN_mul(pBVar2,param_1,*(BIGNUM **)(param_3 + 0x20),param_4), iVar5 != 0)))) &&
       (iVar5 = (*(code *)PTR_BN_add_006a96c8)(param_1,pBVar2,pBVar3), iVar5 != 0)) {
      if (*(int *)(param_3 + 0x14) == 0) goto LAB_0050dee8;
      if (*(int *)(param_3 + 0x10) == 0) goto LAB_0050dee8;
      iVar5 = (**(code **)(*(int *)(param_3 + 8) + 0x18))
                        (pBVar4,param_1,*(int *)(param_3 + 0x14),*(int *)(param_3 + 0x10),param_4,
                         *(undefined4 *)(param_3 + 0x40));
      if (((iVar5 != 0) &&
          (iVar5 = (*(code *)PTR_BN_sub_006a96cc)(pBVar4,pBVar4,param_2), iVar5 != 0)) &&
         (iVar5 = (*(code *)PTR_BN_div_006a967c)
                            (0,pBVar4,pBVar4,*(undefined4 *)(param_3 + 0x10),param_4), iVar5 != 0))
      {
        pcVar12 = (code *)PTR_BN_add_006a96c8;
        if (pBVar4->neg != 0) goto LAB_0050defc;
        goto LAB_0050dbe0;
      }
    }
  }
