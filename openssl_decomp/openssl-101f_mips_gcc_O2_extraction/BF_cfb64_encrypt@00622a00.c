...

{
  ...
  if (enc == 0) {
    ...
    if (length != 0) {
      do {
        ...
        if (uStack_78 == 0) {
          ...
          (**(code **)((int)puVar18 + -0x68d4))(unaff_s8);
    ...
    do {
      if (uStack_78 == 0) {
        local_34 = *(uint *)ivec;
        local_30 = *(uint *)(ivec + 4);
        (*(code *)local_40[-0x1a35])(unaff_s8,schedule);
        length = local_34 >> 0x10;
        ivec[3] = (uchar)local_34;
        out = (uchar *)(local_30 >> 0x18);
        ivec[7] = (uchar)local_30;
  ...
  if ((uchar *)length != (uchar *)0x0) {
    ...
    do {
      if (uStack_bc == 0) {
        ...
        (**(code **)(puVar19 + -0x68d4))(num,pBStack_108);
  ...
  *puStack_94 = uStack_bc;
  ...
  uStack_cc = *puVar18;
  uStack_c8 = puVar18[1];
  pbStack_c4 = *(byte **)PTR___stack_chk_guard_006aabf0;
  puStack_b8 = ivec;
  if (pbStack_158 == (byte *)0x0) {
    (*(code *)PTR_CAST_decrypt_006aa9d8)(&uStack_cc);
  }
  else {
    (*(code *)PTR_CAST_encrypt_006aa9dc)(&uStack_cc,length);
  }
  ...
  if (iStack_d0 == 0) {
    for (; puStack_140 = &uStack_11c, uStack_14c != 0; uStack_14c = uStack_14c - 1) {
      ...
      if (uStack_160 == 0) {
        ...
        (**(code **)((int)puVar18 + -0x5504))(&uStack_11c);
    ...
    if (uVar13 != 0) {
      ...
      do {
        if (uStack_160 == 0) {
          uStack_11c = *puStack_15c;
          uStack_118 = puStack_15c[1];
          (*(code *)puStack_128[-0x1541])(puStack_140,pbStack_158);
          uVar13 = uStack_11c >> 0x10;
          *(char *)((int)puStack_15c + 3) = (char)uStack_11c;
          pbVar11 = (byte *)(uStack_118 >> 0x18);
          *(char *)((int)puStack_15c + 7) = (char)uStack_118;
  ...
  *puStack_d4 = uStack_160;
  ...
  (*(code *)puVar18[-0x14ca])();
  puVar18 = puStack_128;
  puVar19 = PTR___stack_chk_guard_006aabf0;
  ...
  if (uVar13 != 0) {
    ...
    do {
      if (uVar15 == 0) {
        iVar5 = iVar5 + 1;
        (*(code *)PTR_CAST_encrypt_006aa9dc)(&uStack_174,pbVar14);
  ...
  *puStack_124 = uVar15;
  ...
  iVar5 = (*(code *)PTR_BN_copy_006a9570)(ppuVar6,puStack_124);
  if (iVar5 == 0) {
LAB_00623404:
    (*(code *)PTR_BN_CTX_end_006a9654)(uVar13);
    return;
