...

{
  ...
  local_54 = (undefined4 *)PTR___stack_chk_guard_006aabf0;
  ppbStack_dc = *(byte ***)PTR___stack_chk_guard_006aabf0;
  ppbStack_d8 = param_3;
  local_60 = param_2;
  local_5c = param_3;
        ...
        if ((((uint)local_6c & (local_60 < param_1 + 0x14 ^ 1 | ppbVar13 < local_48 ^ 1)) == 0) ||
          ...
          if ((byte *)((int)local_64 + -1) < (byte *)0x3) {
            ...
            *(uint *)(param_1 + 0x10) = (uint)*local_60 ^ (uint)in_t3;
            ...
            if (local_64 == ppbVar20) goto LAB_005ed818;
          }
          ...
          *(byte *)local_5c = local_40._0_1_ ^ *(byte *)local_60;
          ...
          if ((byte *)((int)local_64 + -1) < (byte *)0x3) {
            ...
            *local_5c = (byte *)(local_40 ^ (uint)*local_60);
            ...
            if (local_64 == ppbVar13) goto LAB_005ed99c;
          }
...
LAB_005ed99c:
      (**(code **)(local_78 + -0x53e0))(param_1 + (0xf - local_50),0,0x10 - local_4c);
      (*local_70)(param_1,local_68,ppbStack_ac);
      ppbVar13 = (byte **)0x0;
  ...
  pcStack_b4 = *(code **)PTR___stack_chk_guard_006aabf0;
  ppcStack_d0 = (code **)PTR___stack_chk_guard_006aabf0;
        ...
        *(byte *)(ppbStack_100 + 4) = bVar25 ^ uStack_c8._0_1_ ^ *(byte *)(ppbStack_100 + 4);
        ...
        if ((byte *)((int)ppbStack_e0 + -1) < (byte *)0x3) {
          ...
          *ppbStack_d8 = (byte *)((uint)pbVar19 ^ (uint)uStack_c8);
          ...
          if (ppbStack_e0 == ppbVar20) goto LAB_005ee3e0;
        }
        ppbVar21 = (byte **)((int)ppbVar20 + 1);
...
LAB_005ee3e0:
  ...
  pbStack_124 = *(byte **)PTR___stack_chk_guard_006aabf0;
    ...
    *(uint *)(pcStack_198 + 0x20) = uVar22;
    if ((uVar22 < 0x20000001) && ((uVar22 != 0x20000000 || (uVar12 == 0)))) {
      ...
      if (ppbVar20 == (byte **)0x0) {
        if (ppbStack_188 != (byte **)0x0) goto LAB_005ee834;
      }
      else {
        ...
        if ((((uint)ppbStack_144 &
          ...
          if (ppbStack_188 < &SUB_00000004) {
            ...
            *(uint *)(pcStack_198 + 0x10) = (uint)*ppbStack_180 ^ *(uint *)(pcStack_198 + 0x10);
            ...
            if (ppbVar20 == ppbVar15) goto LAB_005ee948;
          }
            ...
            *ppbStack_17c = (byte *)((uint)*ppbStack_180 ^ uStack_138);
            ...
            if (ppbVar20 != ppbVar13) {
              ...
              *(byte *)(ppbStack_17c + iVar14) =
              ...
              if (ppbVar13 < ppbStack_188) goto LAB_005eea68;
            }
          }
        }
      }
LAB_005eeb10:
      ...
      (**(code **)(puStack_158 + -0x53e0))(pcStack_198 + (0xf - uStack_184),0,0x10 - (int)ppbVar21);
  ...
  pbStack_19c = *(byte **)PTR___stack_chk_guard_006aabf0;
  ...
  *pbVar19 = (byte)uVar12;
  ...
  if (uVar22 == 0) {
    if (param_4 != (byte **)0x0) goto LAB_005ef3c4;
  }
  else {
...
LAB_005ef354:
      ...
      if ((uint)param_4 >> 0x14 == 0) goto LAB_005ef33c;
      uVar22 = (uint)pbVar19[0xd] + ((uint)param_4 >> 0x14 & 0xff) + uVar28;
      uVar28 = uVar22 >> 8;
      pbVar19[0xd] = (byte)uVar22;
      if ((uint)param_4 >> 0x1c == 0) goto LAB_005ef354;
      ...
      *(byte *)ppbVar20 = bVar17 ^ uStack_1b0._0_1_;
      ...
      if (ppbVar16 < &SUB_00000004) {
        ...
        *(uint *)(pbVar19 + 0x10) =
        ...
        if (ppbVar18 == ppbVar27) goto LAB_005ef5c4;
      }
...
LAB_005ef1e4:
  (*(code *)PTR_memset_006aab00)(pbVar19 + (0xf - uVar12),0,0x10 - iVar14);
  (*pcVar29)(pbVar19,&uStack_1b0,ppbVar15);
  ppbVar13 = (byte **)0x0;
...
LAB_005ef260:
  ...
  if (ppbVar13 <= ppbVar21) {
    (*(code *)PTR_memcpy_006aabf4)(pbVar26,pbVar19 + 0x10,ppbVar13);
    return ppbVar13;
  }
  return (byte **)0x0;
}
