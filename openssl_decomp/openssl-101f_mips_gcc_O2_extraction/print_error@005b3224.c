...
/* WARNING: Removing unreachable block (ram,0x005b3428) */
...

{
  ...
  if (pcVar7 == (char *)0x0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0x28,0x6c,0x43,"ui_lib.c",0xca);
    return -1;
  }
  cVar1 = *pcVar7;
  pcVar8 = pcVar7;
  while (cVar1 != '\0') {
    while( true ) {
      pcVar8 = pcVar8 + 1;
      iVar4 = (*(code *)PTR_strchr_006aab34)(&_gp);
      if (iVar4 == 0) break;
      (*(code *)PTR_ERR_put_error_006a9030)(0x28,0x6c,0x68,"ui_lib.c",0xd7);
      if (*pcVar8 == '\0') goto LAB_005b3378;
    }
    cVar1 = *pcVar8;
  }
LAB_005b3378:
  ...
  if (local_2c != 0) {
    piVar5 = (int *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x20,"ui_lib.c",0x9a);
    if (piVar5 == (int *)0x0) {
      return -1;
    }
    piVar5[1] = (int)piVar6;
    *piVar5 = 3;
    ...
    if (iVar4 == 0) {
      ...
      *(int *)(iVar3 + 4) = iVar4;
      if (iVar4 == 0) {
        if (((piVar5[7] & 1U) != 0) &&
           ((*(code *)PTR_CRYPTO_free_006a7f88)(piVar5[1]), *piVar5 == 3)) {
          (*(code *)PTR_CRYPTO_free_006a7f88)(piVar5[4]);
          (*(code *)PTR_CRYPTO_free_006a7f88)(piVar5[5]);
          (*(code *)PTR_CRYPTO_free_006a7f88)(piVar5[6]);
        }
