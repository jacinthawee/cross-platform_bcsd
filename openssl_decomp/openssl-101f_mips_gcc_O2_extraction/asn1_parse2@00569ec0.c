...

{
  ...
  local_ec = &local_b4;
  local_f0 = &local_b8;
  local_e8 = "7 datafinal";
  local_f4 = &local_bc;
  unaff_s8 = &local_c4;
  local_d4 = "d=%-2d hl=%ld l=inf  ";
  local_e0 = "7 datafinal";
  ...
  do {
    ...
    if (uVar13 == 0) {
      ...
      iVar6 = (*(code *)PTR_BIO_printf_006a7f38)
                        (param_1,local_e8 + -0x4ee0,pbVar11 + (param_4 - (int)*unaff_s7));
...
LAB_0056a6a8:
    ...
    if (uVar13 != 2) {
      if (uVar13 == 10) {
        ...
        if (0 < iVar6) {
          if ((a_00->type != 0x10a) ||
             (iVar6 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_00662b94,1), 0 < iVar6)) {
            iVar6 = a_00->length;
            iVar12 = 0;
            if (0 < iVar6) {
              do {
...
LAB_0056a204:
    ...
    if (iVar6 < 1) goto LAB_0056a204;
    if ((a_00->type == 0x102) &&
       (iVar6 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_00662b94,1), iVar6 < 1)) {
      param_1 = (BIO *)0x0;
      goto joined_r0x0056a074;
    }
    iVar6 = a_00->length;
