    ...
    do {
      while( true ) {
        ...
        *piVar4 = 0;
        ...
        piVar4[1] = 0;
        piVar4 = piVar5;
        if (piVar5 == &AEPHK_lib_error_code) goto LAB_005cec60;
      }
      piVar4 = piVar4 + 2;
      if (iVar1 == 2) {
        iVar6 = iVar6 + 1;
...
LAB_005cec60:
    if (iVar6 == 0) {
      ...
      if (iVar6 == 0) {
        iVar6 = (*(code *)PTR_DSO_free_006a9994)(aep_dso);
        if (iVar6 == 0) {
          if (AEPHK_lib_error_code == 0) {
            AEPHK_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006aa644)();
          }
          (*(code *)PTR_ERR_put_error_006a9030)(AEPHK_lib_error_code,0x65,0x73,"e_aep.c",0x22a);
          uVar2 = 0;
        }
        else {
...
LAB_005ced40:
  (*(code *)PTR_ERR_put_error_006a9030)(AEPHK_lib_error_code,0x65,uVar3,"e_aep.c",uVar2);
  return 0;
}
