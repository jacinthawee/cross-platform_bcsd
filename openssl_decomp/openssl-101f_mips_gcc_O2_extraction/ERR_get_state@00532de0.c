...

{
  ...
  if (err_fns == (undefined1 *)0x0) {
    ...
    in_a3 = (char *)0x12a;
    in_a2 = "err.c";
    (*(code *)PTR_CRYPTO_lock_006a926c)(10,1);
  }
  (*(code *)PTR_CRYPTO_THREADID_current_006a95ac)(acStack_1b4);
  pcVar9 = acStack_1b4;
  (*(code *)PTR_CRYPTO_THREADID_cpy_006a95a8)(auStack_1ac);
  puVar3 = (undefined1 *)(**(code **)(err_fns + 0x1c))(auStack_1ac);
  if ((ERR_STATE *)puVar3 == (ERR_STATE *)0x0) {
    in_a2 = (char *)0x3fb;
    pcVar9 = "err.c";
    puVar3 = (undefined1 *)(*(code *)PTR_CRYPTO_malloc_006a8108)(400);
    if ((ERR_STATE *)puVar3 == (ERR_STATE *)0x0) {
      puVar3 = fallback_5580;
    }
    else {
      (*(code *)PTR_CRYPTO_THREADID_cpy_006a95a8)(puVar3,acStack_1b4);
      ...
      *(int *)((int)puVar3 + 0x18c) = 0;
      ...
      in_a2 = (char *)0x40;
      pcVar9 = (char *)0x0;
      (*(code *)PTR_memset_006aab00)((int *)((int)puVar3 + 200));
