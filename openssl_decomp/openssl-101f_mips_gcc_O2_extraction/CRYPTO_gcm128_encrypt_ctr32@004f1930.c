...

{
  ...
  uVar1 = (uint)(uVar3 < param_4) + *(int *)(param_1 + 0x38);
  uVar8 = *(undefined4 *)(param_1 + 0x174);
  if ((0xf < uVar1) || ((uVar1 == 0xf && (0xffffffe0 < uVar3)))) {
    return 0xffffffff;
  }
...
LAB_004f1af0:
    ...
    param_4 = param_4 - 1;
    bVar2 = *(byte *)param_2 ^ *(byte *)(iVar4 + 0x10);
    *(byte *)param_3 = bVar2;
    *(byte *)(iVar4 + 0x40) = bVar2 ^ *(byte *)(iVar4 + 0x40);
    param_3 = (uint *)((int)param_3 + 1);
    param_2 = (uint *)((int)param_2 + 1);
    while (uVar1 = uVar1 + 1 & 0xf, uVar1 != 0) {
      iVar4 = param_1 + uVar1;
      if (param_4 == 0) goto LAB_004f1af0;
      param_4 = param_4 - 1;
      bVar2 = *(byte *)param_2 ^ *(byte *)(iVar4 + 0x10);
      *(byte *)param_3 = bVar2;
      *(byte *)(iVar4 + 0x40) = bVar2 ^ *(byte *)(iVar4 + 0x40);
  ...
  if (0xbff < param_4) {
    do {
      ...
      *(int *)(param_1 + 0xc) = iVar7;
      gcm_ghash_4bit(param_1 + 0x40,param_1 + 0x60,param_3,0xc00);
  ...
  if (uVar1 != 0) {
    iVar7 = iVar7 + (param_4 >> 4);
    (*param_5)(param_2,param_3,param_4 >> 4,uVar8,param_1);
    param_4 = param_4 - uVar1;
    *(int *)(param_1 + 0xc) = iVar7;
    gcm_ghash_4bit(param_1 + 0x40,param_1 + 0x60,param_3,uVar1);
    param_2 = (uint *)((int)param_2 + uVar1);
    param_3 = (uint *)((int)param_3 + uVar1);
  }
  if (param_4 != 0) {
    ...
    if (((param_4 < 5 ||
      ...
      *(byte *)(param_1 + 0x40) = bVar2 ^ *(byte *)(param_1 + 0x40);
      ...
      if (uVar1 < 3) {
        ...
        uVar5 = *(uint *)(param_1 + 0x10) ^ *param_2;
        *param_3 = uVar5;
        *(uint *)(param_1 + 0x40) = uVar5 ^ *(uint *)(param_1 + 0x40);
        if (iVar7 != 1) {
          uVar5 = *(uint *)(param_1 + 0x14) ^ param_2[1];
          param_3[1] = uVar5;
          *(uint *)(param_1 + 0x44) = uVar5 ^ *(uint *)(param_1 + 0x44);
          if (iVar7 != 2) {
            uVar5 = param_2[2] ^ *(uint *)(param_1 + 0x18);
            param_3[2] = uVar5;
            *(uint *)(param_1 + 0x48) = uVar5 ^ *(uint *)(param_1 + 0x48);
            if (iVar7 != 3) {
              uVar5 = param_2[3] ^ *(uint *)(param_1 + 0x1c);
              param_3[3] = uVar5;
        ...
        uVar1 = uVar1 + iVar7 * -4;
        if (param_4 == uVar3) goto LAB_004f1ab8;
      }
      iVar4 = param_1 + uVar3;
      iVar7 = uVar3 + 1;
      bVar2 = *(byte *)((int)param_2 + uVar3) ^ *(byte *)(iVar4 + 0x10);
      *(byte *)((int)param_3 + uVar3) = bVar2;
      *(byte *)(iVar4 + 0x40) = bVar2 ^ *(byte *)(iVar4 + 0x40);
      if (uVar1 != 0) {
        iVar6 = param_1 + iVar7;
        iVar4 = uVar3 + 2;
        bVar2 = *(byte *)((int)param_2 + iVar7) ^ *(byte *)(iVar6 + 0x10);
        *(byte *)((int)param_3 + iVar7) = bVar2;
        *(byte *)(iVar6 + 0x40) = bVar2 ^ *(byte *)(iVar6 + 0x40);
        if (uVar1 != 1) {
          iVar7 = param_1 + iVar4;
          bVar2 = *(byte *)((int)param_2 + iVar4) ^ *(byte *)(iVar7 + 0x10);
          *(byte *)((int)param_3 + iVar4) = bVar2;
