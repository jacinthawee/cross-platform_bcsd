...
undefined4 rc2_cbc_cipher(int param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      (*(code *)PTR_RC2_cbc_encrypt_006a8b44)
                (iVar2,iVar1,0x40000000,*(int *)(param_1 + 0x60) + 4,param_1 + 0x20,
  ...
  if (param_4 != 0) {
    (*(code *)PTR_RC2_cbc_encrypt_006a8b44)
              (param_3,param_2,param_4,*(int *)(param_1 + 0x60) + 4,param_1 + 0x20,
               *(undefined4 *)(param_1 + 8));
  }
  return 1;
}
