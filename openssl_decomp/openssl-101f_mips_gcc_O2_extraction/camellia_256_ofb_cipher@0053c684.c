...
undefined4 camellia_256_ofb_cipher(int param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      (*(code *)PTR_Camellia_ofb128_encrypt_006a9b10)
                (iVar3,iVar1,0x40000000,*(undefined4 *)(param_1 + 0x60),param_1 + 0x20,
                 param_1 + 0x50);
