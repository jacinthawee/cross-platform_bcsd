    ...
    *(undefined4 *)((int)register0x00000074 + -0x2c) = *(undefined4 *)PTR___stack_chk_guard_006aabf0
    ...
    if (hwcrhk_context == 0) {
      ...
      *(undefined4 *)((int)register0x00000074 + -0x478) = 0x390;
      ...
      (*(code *)PTR_bn_expand2_006a9680)(param_1,*unaff_s3);
      iVar3 = *unaff_s8;
      iVar2 = *unaff_s3;
      piVar9 = *ppiVar6;
      pcVar8 = *param_4;
      ...
      *(undefined4 *)((int)register0x00000074 + -0x43c) = uVar7;
      ...
      if (iVar2 < 0) {
        if (iVar2 == -2) {
          if (HWCRHK_lib_error_code == 0) {
            HWCRHK_lib_error_code = (**(code **)(puVar13 + -0x589c))();
            puVar13 = *(undefined **)((int)register0x00000074 + -0x460);
          }
          pcVar11 = *(code **)(puVar13 + -0x6eb0);
