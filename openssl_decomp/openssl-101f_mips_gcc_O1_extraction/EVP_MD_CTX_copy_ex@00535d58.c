...

{
  ...
  if ((in->md_data != (void *)0x0) && (iVar20 = out->digest->ctx_size, iVar20 != 0)) {
    if (pvVar25 == (void *)0x0) {
      pvVar25 = (void *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar20,"digest.c",0x143);
      out->md_data = pvVar25;
      if (pvVar25 == (void *)0x0) {
    ...
    (*(code *)PTR_memcpy_006aabf4)(pvVar25,in->md_data,iVar20);
  }
  pEVar22 = in->pctx;
  ...
  if (UNRECOVERED_JUMPTABLE == (_func_1081 *)0x0) {
    return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00535eac. Too many branches */
