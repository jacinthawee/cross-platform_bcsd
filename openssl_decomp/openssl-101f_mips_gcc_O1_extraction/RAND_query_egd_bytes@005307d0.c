...

{
  ...
  (*(code *)PTR_memset_006aab00)(&local_1a0,0,0x6e);
  local_1a0 = 1;
  uVar2 = (*(code *)PTR_strlen_006aab30)(path);
  if (uVar2 < 0x6c) {
    BUF_strlcpy(acStack_19e,path,0x6c);
    iVar3 = (*(code *)PTR_strlen_006aab30)(path);
    bytes_00 = (undefined2 *)&SUB_00000002;
    iVar4 = (*(code *)PTR_socket_006aaa90)(1,2,0);
    if (iVar4 != -1) {
LAB_005308c4:
      do {
        bytes_00 = &local_1a0;
        iVar5 = (*(code *)PTR_connect_006aaa60)(iVar4,&local_1a0,iVar3 + 2);
        if (iVar5 == 0) {
LAB_005308d8:
          puVar8 = (uchar *)0x0;
          if (bytes < 1) goto LAB_00530994;
          goto LAB_005308f4;
        }
        piVar6 = (int *)(*(code *)PTR___errno_location_006aaaf4)();
        iVar5 = *piVar6;
        if (iVar5 == 0x85) goto LAB_005308d8;
        if (iVar5 < 0x86) {
...
LAB_005308f4:
    ...
    do {
      while( true ) {
        ...
        iVar5 = (*(code *)PTR_write_006aab28)(iVar4,bytes_00,2 - iVar3);
        if (iVar5 < 0) break;
        iVar3 = iVar3 + iVar5;
LAB_0053092c:
        if (iVar3 == 2) {
      ...
      piVar6 = (int *)(*(code *)PTR___errno_location_006aaaf4)();
      if (*piVar6 == 4) goto LAB_0053092c;
      if (*piVar6 != 0xb) goto LAB_0053098c;
    } while (iVar3 != 2);
    iVar3 = 0;
LAB_0053094c:
    do {
      bytes_00 = (undefined2 *)&local_130;
      iVar5 = (*(code *)PTR_read_006aac18)(iVar4,&local_130,1);
      if (iVar5 == 0) goto LAB_00530994;
      if (iVar5 < 1) {
        piVar6 = (int *)(*(code *)PTR___errno_location_006aaaf4)();
        if ((*piVar6 != 4) && (*piVar6 != 0xb)) goto LAB_0053098c;
      }
      else {
        iVar3 = iVar3 + iVar5;
      }
    ...
    while (num != puVar7) {
      ...
      iVar3 = (*(code *)PTR_read_006aac18)(iVar4,bytes_00,(int)puVar7 - (int)num);
      if (iVar3 == 0) goto LAB_00530994;
      if (iVar3 < 1) {
        piVar6 = (int *)(*(code *)PTR___errno_location_006aaaf4)();
        if (*piVar6 == 4) goto LAB_00530ab4;
        puVar7 = (undefined2 *)(uint)local_130;
        if (*piVar6 != 0xb) goto LAB_0053098c;
      }
      else {
