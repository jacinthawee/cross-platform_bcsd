...
LAB_00569024:
    ...
    (*(code *)PTR_ERR_add_error_data_006a9264)(2,&DAT_0066ae9c,pcVar6);
    uVar3 = 0xffffffff;
    goto LAB_00568fe4;
  }
...
LAB_00569194:
  ...
  case (uchar *)0x10008:
    ...
    if (iVar4 == 0) {
      ...
      iVar4 = (*(code *)PTR_strncmp_006aaa7c)(pcVar13,&DAT_0066aeac,4);
      if (iVar4 == 0) {
        uVar3 = 1;
        pAVar10->flags = 2;
      }
      else {
        iVar4 = (*(code *)PTR_strncmp_006aaa7c)(pcVar13,&DAT_0066aeb4,3);
        if (iVar4 == 0) {
          uVar3 = 1;
          pAVar10->flags = 3;
        }
