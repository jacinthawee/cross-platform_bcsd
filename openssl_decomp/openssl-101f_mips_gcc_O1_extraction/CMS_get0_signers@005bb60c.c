...

{
  ...
  do {
    do {
      iVar2 = (*(code *)PTR_sk_num_006a7f2c)(uVar6);
      iVar4 = iVar1 + 1;
      if (iVar2 <= iVar1) {
        return psVar5;
      }
      iVar2 = (*(code *)PTR_sk_value_006a7f24)(uVar6,iVar1);
      iVar3 = *(int *)(iVar2 + 0x1c);
      iVar1 = iVar4;
    } while (iVar3 == 0);
    if (psVar5 == (stack_st_X509 *)0x0) {
      psVar5 = (stack_st_X509 *)(*(code *)PTR_sk_new_null_006a80a4)();
      if (psVar5 == (stack_st_X509 *)0x0) {
        return (stack_st_X509 *)0x0;
      }
      iVar3 = *(int *)(iVar2 + 0x1c);
    }
    iVar2 = (*(code *)PTR_sk_push_006a80a8)(psVar5,iVar3);
  } while (iVar2 != 0);
