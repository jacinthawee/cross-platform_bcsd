...

{
  ...
  if ((int)piVar2 < 0) {
    ...
    local_5c = "7 datafinal";
    local_68 = (**(code **)(local_80 + -0x7dd8))(iStack_ac,s_p12_key_c_00670674,0x8a);
    unaff_s2 = (**(code **)(local_80 + -0x7dd8))(piVar2,s_p12_key_c_00670674,0x8b);
    local_6c = (undefined *)
               (**(code **)(local_80 + -0x7dd8))(iStack_ac + 1,s_p12_key_c_00670674,0x8c);
    if (iStack_ac == 0) {
      trap(7);
    }
    ...
    unaff_s5 = (uchar *)(**(code **)(local_80 + -0x7dd8))(local_58,local_5c + 0x674,0x91);
...
LAB_005abba4:
    salt = &DAT_00000041;
    iVar4 = 0x6f;
    piStack_10c = (int *)(local_5c + 0x674);
    iVar22 = 0;
    local_88 = 0xd1;
