...

{
  ...
  local_38 = (char ******)&_gp;
  local_24 = *(long ***)PTR___stack_chk_guard_006aabf0;
  local_2c = val;
  if ((out == (uchar **)0x0) || (*out != (uchar *)0x0)) {
    in_a3 = (char ******)0xffffffff;
    in_stack_ffffffc0 = &DAT_00000800;
    pcStack_c4 = (char *)out;
    pAStack_c0 = it;
    iVar4 = ASN1_item_ex_i2d((ASN1_VALUE **)&local_2c,out,it,-1,0x800);
  }
  else {
    unaff_s4 = (ASN1_VALUE **)&local_2c;
    pAStack_c0 = (ASN1_ITEM *)&DAT_00000800;
    pcStack_c4 = &it->itype;
    unaff_s2 = ASN1_item_ex_i2d_constprop_0(unaff_s4);
    iVar4 = unaff_s2;
    if (0 < unaff_s2) {
      pAStack_c0 = (ASN1_ITEM *)0x71;
      ...
      if (unaff_s5 == (uchar *)0x0) {
        ...
        pAStack_c0 = it;
        local_28 = unaff_s5;
        ASN1_item_ex_i2d(unaff_s4,(uchar **)pcStack_c4,it,-1,0x800);
        *out = unaff_s5;
      }
    }
  }
  ...
  puStack_7c = *(undefined4 **)PTR___stack_chk_guard_006aabf0;
...
LAB_00562004:
      if (-1 < (int)pppppcStack_34) {
        if ((pppppcStack_34 != pppppcStack_8c) || (ppppppcStack_88 != ppppppcStack_30)) {
          uVar5 = 0xffffffff;
          if (iStack_cc != 0) goto LAB_0056205c;
          if (puStack_e0 != (uchar *)0x0) {
            *puStack_e0 = '\0';
          }
          ppppppcStack_130 = (char ******)&DAT_000000a8;
          ppppppcStack_128 = (char ******)&DAT_00000527;
          goto LAB_00562044;
        }
        if (puStack_e0 != (uchar *)0x0) {
          *puStack_e0 = '\0';
      ...
      if (in_a3 != (char ******)0x0) {
        *(char *)in_a3 = (char)(uVar8 & 1);
      }
      if (in_stack_ffffffc0 != (byte *)0x0) {
        *in_stack_ffffffc0 = (byte)uVar8 & 0x20;
      }
      ...
      if ((ASN1_ITEM *)pcStack_c4 != (ASN1_ITEM *)0x0) {
      ...
      *pplStack_3c = (long *)ppppppcStack_80;
      ...
      ppppppcStack_128 = (char ******)0x51a;
LAB_00562044:
      pcStack_12c = s_tasn_dec_c_0066ab2c;
    ...
    *puStack_e0 = '\x01';
    ...
    if ((uVar5 != 0) ||
       (ppppppcStack_134 = local_38,
       (int)((int)ppppppcStack_84 + ((int)ppppppcStack_80 - (int)ppppppcStack_dc)) < 0x6afee1))
    goto LAB_00561ff8;
    ppppppcStack_130 = (char ******)0x9b;
    pcStack_12c = s_tasn_dec_c_0066ab2c;
    ppppppcStack_128 = (char ******)0x511;
    ppppppcStack_134 = (char ******)&DAT_00000068;
    (*(code *)PTR_ERR_put_error_006a9030)(0xd);
    *puStack_e0 = '\0';
  }
...
LAB_0056205c:
  ...
  piStack_e4 = *(int **)PTR___stack_chk_guard_006aabf0;
  pppppcStack_e8 = pppppcStack_144;
  ppppppcStack_d0 = in_a3;
  if (pcStack_98 == (char *)0x0) {
    ...
    uVar8 = ASN1_get_object((uchar **)&pppppcStack_e8,(long *)&pppppcStack_ec,(int *)ptag,
                            (int *)pclass,(long)&_gp);
    if ((uVar8 & 0x80) == 0) goto LAB_005622fc;
    ptag = (char *****)0x66;
    pclass = (char ******)0x0;
    in_stack_fffffef0 = (char *****)0x51a;
    ...
    if (*pcStack_98 == '\0') {
      ...
      *pcStack_98 = '\x01';
      ptag = pppppcVar11;
      if ((uVar5 == 0) &&
         (ptag = pppppcStack_a0, 0x6afee0 < (int)((int)pppppcStack_ec + (int)pppppcVar11))) {
        ptag = (char *****)0x9b;
        pclass = (char ******)0x0;
        in_stack_fffffef0 = (char *****)0x511;
        pppppcStack_a0 = (char *****)&DAT_00000068;
        (*(code *)PTR_ERR_put_error_006a9030)(0xd);
        *pcStack_98 = '\0';
        goto LAB_00562358;
...
LAB_00562358:
  ...
  uStack_14c = *(uint *)PTR___stack_chk_guard_006aabf0;
  if (piVar10 == (int *)0x0) {
    if (uVar8 == 0) {
      uVar5 = 1;
...
LAB_005625b0:
      do {
        ...
        if (uVar5 != 0) {
          uVar5 = 0;
          (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x68,0x66,s_tasn_dec_c_0066ab2c,0x51a);
          (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x6a,0x3a,s_tasn_dec_c_0066ab2c,0x4a6);
          goto LAB_00562720;
        }
        ...
        if ((uVar6 & 0x20) == 0) {
          if (iVar4 != 0) {
            if (piVar10 != (int *)0x0) {
              iVar9 = *piVar10;
              uVar5 = (*(code *)PTR_BUF_MEM_grow_clean_006a8c2c)(piVar10,iVar9 + iVar4);
              if (uVar5 == 0) {
                (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x8c,0x41,s_tasn_dec_c_0066ab2c,0x4cc);
                goto LAB_00562720;
              }
              (*(code *)PTR_memcpy_006aabf4)(piVar10[1] + iVar9,ppppcStack_160,iVar4);
            }
...
LAB_005626a8:
  uVar5 = 0;
  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x6a,uVar12,s_tasn_dec_c_0066ab2c,uVar7);
LAB_00562720:
