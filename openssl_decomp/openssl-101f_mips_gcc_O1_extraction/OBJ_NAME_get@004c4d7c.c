...

{
  ...
  pcVar2 = (char *)0x0;
  if (name == (char *)0x0) goto LAB_004c4e28;
  if (names_lh == 0) {
    CRYPTO_mem_ctrl(3);
    pcVar6 = obj_name_LHASH_COMP;
    names_lh = (*(code *)PTR_lh_new_006a850c)(obj_name_LHASH_HASH);
    CRYPTO_mem_ctrl(2);
    if (names_lh != 0) goto LAB_004c4dcc;
  }
  else {
LAB_004c4dcc:
    ...
    if ((type & 0x8000U) == 0) {
      iVar7 = 0xb;
      while (pcVar6 = (code *)local_2c, iVar3 = (*(code *)PTR_lh_retrieve_006a84b0)(names_lh),
            iVar3 != 0) {
        if (*(int *)(iVar3 + 4) == 0) goto LAB_004c4e64;
        iVar7 = iVar7 + -1;
        if (iVar7 == 0) break;
...
LAB_004c4e28:
  ...
  puVar4 = (uint *)CRYPTO_malloc(0x10,"o_names.c",0xc3);
  iVar3 = names_lh;
  ...
  *puVar4 = type & 0xffff7fff;
  ...
  if (ptr != (int *)0x0) {
    if ((name_funcs_stack != 0) && (iVar3 = (*(code *)PTR_sk_num_006a7f2c)(), *ptr < iVar3)) {
      iVar3 = (*(code *)PTR_sk_value_006a7f24)(name_funcs_stack);
