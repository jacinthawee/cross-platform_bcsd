...

{
  ...
  if (p_Var11 == (_func_1628 *)0x0) {
    ...
    if (unaff_s6 != (BN_CTX *)0x0) {
      ...
      if (pBVar8 == (BIGNUM *)0x0) goto LAB_0050f8dc;
      iVar7 = (bits + 1) / 2;
      if (rsa->n == (BIGNUM *)0x0) {
        pBVar8 = BN_new();
        rsa->n = pBVar8;
      ...
      while( true ) {
        ...
        if (iVar4 == 0) goto LAB_0050f8dc;
        pBVar10 = rsa->p;
        pBVar8 = BN_value_one();
        iVar4 = (*(code *)PTR_BN_sub_006a96cc)(unaff_s4,pBVar10,pBVar8);
        if (iVar4 == 0) goto LAB_0050f8dc;
        iVar4 = (*(code *)PTR_BN_gcd_006a9840)(unaff_s3,unaff_s4,rsa->e,unaff_s6);
        if (iVar4 == 0) goto LAB_0050f8dc;
      ...
      if (iVar7 == 0) goto LAB_0050f8dc;
      iVar7 = BN_cmp(rsa->p,rsa->q);
      if (iVar7 < 0) goto LAB_0050fcf0;
      pBVar10 = rsa->p;
      pBVar8 = rsa->q;
      goto LAB_0050fac8;
    }
    rsa = (RSA *)0x0;
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x81,3,"rsa_gen.c",0xdf);
    pRVar3 = (RSA *)0x0;
  }
  else {
...
LAB_0050f8ec:
      pRVar3 = (RSA *)0x0;
      (*(code *)PTR_ERR_put_error_006a9030)(4,0x81,uVar9,"rsa_gen.c",uVar6);
    }
    else {
      pBVar10 = rsa->p;
      pBVar8 = BN_value_one();
      iVar7 = (*(code *)PTR_BN_sub_006a96cc)(unaff_s3,pBVar10,pBVar8);
      if (iVar7 == 0) goto LAB_0050f8dc;
      pBVar10 = rsa->q;
      pBVar8 = BN_value_one();
      iVar7 = (*(code *)PTR_BN_sub_006a96cc)(unaff_s4,pBVar10,pBVar8);
      ...
      iVar7 = (*(code *)PTR_BN_mod_inverse_006a9714)(rsa->d,rsa->e,local_6c,unaff_s6);
      if (iVar7 == 0) goto LAB_0050f8dc;
      if ((rsa->flags & 0x100U) == 0) {
        pBVar10 = rsa->d;
        pBVar8 = &local_54;
      ...
      iVar7 = (*(code *)PTR_BN_div_006a967c)(0,rsa->dmp1,pBVar8,unaff_s3,unaff_s6);
      if ((iVar7 == 0) ||
         (iVar7 = (*(code *)PTR_BN_div_006a967c)(0,rsa->dmq1,pBVar8,unaff_s4,unaff_s6), iVar7 == 0))
      goto LAB_0050f8dc;
      if ((rsa->flags & 0x100U) == 0) {
        pBVar10 = rsa->p;
        pBVar8 = &local_40;
      ...
      iVar7 = (*(code *)PTR_BN_mod_inverse_006a9714)(rsa->iqmp,rsa->q,pBVar8,unaff_s6);
      if (iVar7 == 0) goto LAB_0050f8dc;
      pRVar3 = (RSA *)0x1;
    }
    BN_CTX_end(unaff_s6);
