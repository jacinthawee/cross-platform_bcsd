...

{
  ...
  if (id == (uchar *)0x0) {
    while (iVar2 = (*(code *)PTR_sk_num_006a7f2c)(psVar1), iVar4 < iVar2) {
      pCVar3 = (CMS_RecipientInfo *)(*(code *)PTR_sk_value_006a7f24)(psVar1,iVar4);
    ...
    while (iVar2 = (*(code *)PTR_sk_num_006a7f2c)(psVar1), iVar4 < iVar2) {
      ...
      if ((iVar2 == 2) && (iVar2 = CMS_RecipientInfo_kekri_id_cmp(pCVar3,id,idlen), iVar2 == 0)) {
        ...
        (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0x71,0x70,"cms_smime.c",0x2b8);
        return 0;
      }
    }
  }
  (*(code *)PTR_ERR_put_error_006a9030)(0x2e,0x71,0x84,"cms_smime.c",0x2bf);
  return 0;
}
