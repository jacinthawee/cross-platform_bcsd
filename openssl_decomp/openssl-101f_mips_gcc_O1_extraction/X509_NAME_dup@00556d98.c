...

{
  ...
  X509_NAME *pXVar21;
  X509_NAME *unaff_s2;
  stack_st_X509_NAME_ENTRY *unaff_s3;
  X509_NAME **unaff_s5;
  int *unaff_s6;
  undefined auStack_30e [10];
  int *piStack_304;
  X509_NAME *pXStack_2fc;
  ...
  X509_NAME *pXStack_19c;
  char *pcStack_198;
  code *pcStack_194;
  undefined *puStack_180;
  X509_NAME *pXStack_174;
  ...
  X509_NAME *pXStack_134;
  int iStack_12c;
  int iStack_128;
  ASN1_ITEM *pAStack_124;
  X509_NAME *pXStack_120;
  X509_NAME *pXStack_11c;
  undefined *puStack_118;
  code *pcStack_114;
  int iStack_ec;
  int iStack_e8;
  int iStack_e4;
  X509_NAME *pXStack_e0;
  X509_NAME *pXStack_dc;
  X509_NAME *pXStack_d8;
  stack_st_X509_NAME_ENTRY *psStack_d4;
  int iStack_d0;
  code *pcStack_cc;
  int iStack_a8;
  ...
  pXStack_dc = (X509_NAME *)PTR___stack_chk_guard_006aabf0;
  ...
  if (xn == (X509_NAME *)0x0) {
    ...
    if (psStack_1c == (stack_st_X509_NAME_ENTRY *)0x0) {
      ...
      (*(code *)PTR_CRYPTO_free_006a7f88)(psStack_1c);
      unaff_s0 = pXVar5;
    }
  }
  if (iStack_14 == *(int *)pXStack_dc) {
    return pXVar5;
  }
  iStack_d0 = iStack_14;
  ...
  pXStack_68 = unaff_s0;
  psVar6 = (stack_st_X509_NAME_ENTRY *)(*(code *)PTR_BUF_MEM_new_006a859c)();
  if (psVar6 != (stack_st_X509_NAME_ENTRY *)0x0) {
    unaff_s5 = apXStack_98;
    unaff_s6 = (int *)(auStack_88 + 4);
    ERR_clear_error();
    unaff_s0 = (X509_NAME *)0x0;
    iStack_a8 = 0;
    pXStack_dc = (X509_NAME *)0x0;
    pXVar5 = (X509_NAME *)0x0;
LAB_0054f334:
    pXVar11 = unaff_s0;
    pXVar21 = pXVar5;
    unaff_s3 = psVar6;
    if ((X509_NAME *)&DAT_00000008 < pXStack_dc) goto LAB_0054f39c;
    while ((unaff_s0 <= &pXVar21->bytes &&
           (iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a8c2c)(psVar6), iVar4 != 0))) {
      iVar4 = (*(code *)PTR_BIO_read_006a85bc)
                        (iStack_d0,
                         (undefined *)((int)&unaff_s0->entries + (int)(psVar6->stack).data),
                         (int)&pXVar21->bytes - (int)unaff_s0);
      pXVar11 = unaff_s0;
      if (iVar4 < 0) {
        if (unaff_s0 == pXVar21) {
          pXStack_11c = (X509_NAME *)0x8e;
          iVar4 = 0xaf;
          goto LAB_0054f554;
        }
      }
      else {
        pXVar5 = (X509_NAME *)((int)&unaff_s0->entries + iVar4);
        if (iVar4 != 0) {
          unaff_s0 = (X509_NAME *)(uint)(pXVar5 < unaff_s0);
          pXStack_dc = (X509_NAME *)((int)pXVar5 - (int)pXVar21);
          pXVar11 = pXVar5;
          if (unaff_s0 != (X509_NAME *)0x0) {
            pXStack_11c = (X509_NAME *)0x9b;
            iVar4 = 0xb6;
            goto LAB_0054f554;
          }
        }
...
LAB_0054f39c:
      unaff_s0 = pXVar11;
      ppcVar7 = (psVar6->stack).data;
      while( true ) {
        pXVar5 = (X509_NAME *)((int)&pXVar21->entries + (int)ppcVar7);
        pXStack_19c = (X509_NAME *)(auStack_88 + 8);
        pXStack_11c = (X509_NAME *)auStack_88;
        pcStack_198 = (char *)unaff_s6;
        apXStack_98[0] = pXVar5;
        uStack_8c = ASN1_get_object((uchar **)unaff_s5,(long *)(X509_NAME *)(auStack_88 + 8),
                                    (int *)(X509_NAME *)auStack_88,unaff_s6,(long)pXStack_dc);
        if ((uStack_8c & 0x80) != 0) {
        ...
        pXStack_dc = (X509_NAME *)((int)apXStack_98[0] - (int)pXVar5);
        pXVar21 = (X509_NAME *)((int)pXVar21 + (int)pXStack_dc);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_a8 != 0) && (auStack_88._8_4_ == (BUF_MEM *)0x0)) {
            pXStack_dc = (X509_NAME *)((int)unaff_s0 - (int)pXVar21);
            pXVar5 = pXVar21;
            if ((auStack_88._0_4_ != (stack_st_X509_NAME_ENTRY *)0x0) ||
               (iStack_a8 = iStack_a8 + -1, iStack_a8 != 0)) goto LAB_0054f334;
            goto LAB_0054f43c;
          }
          if (auStack_88._8_4_ <= (BUF_MEM *)((int)unaff_s0 - (int)pXVar21)) goto LAB_0054f4cc;
          pXStack_dc = (X509_NAME *)
                       ((int)(X509_NAME *)((int)auStack_88._8_4_ + (int)pXVar21) - (int)unaff_s0);
          if (((int)pXStack_dc < 0) ||
             ((X509_NAME *)((int)auStack_88._8_4_ + (int)pXVar21) < unaff_s0)) {
            pXStack_11c = (X509_NAME *)0x9b;
            iVar4 = 0xed;
          }
          else {
            iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a8c2c)(psVar6);
            if (iVar4 != 0) goto joined_r0x0054f494;
            pXStack_11c = (X509_NAME *)&DAT_00000041;
            iVar4 = 0xf2;
          }
          goto LAB_0054f554;
        }
        ...
        if (pXStack_dc < (X509_NAME *)&DAT_00000009) break;
        ppcVar7 = (psVar6->stack).data;
      }
    }
    pXStack_11c = (X509_NAME *)&DAT_00000041;
  ...
  pXStack_19c = (X509_NAME *)&DAT_0000006b;
  ERR_put_error(0xd,0x6b,0x41,"a_d2i_fp.c",0x9c);
  pXVar21 = (X509_NAME *)0xffffffff;
LAB_0054f57c:
  ...
  pXVar5 = (X509_NAME *)(*(code *)PTR_BIO_new_006a7fa4)(uVar9);
  if (pXVar5 == (X509_NAME *)0x0) {
    ...
    if ((int)ppAVar10 < 0) {
      ...
      pXVar11 = (X509_NAME *)(*(code *)pXStack_19c)(pcStack_198);
  ...
  if ((int)ppAVar10 < 0) {
    ...
    pXVar5 = (X509_NAME *)(*(code *)piStack_15c)(pcStack_158,piVar17);
    ppAStack_1a4 = ppAVar10;
  }
  if (iStack_12c != 0) {
    pXStack_134 = pXVar5;
  ...
  pXStack_1f4 = (X509_NAME *)auStack_16c;
  puStack_180 = &_gp;
  auStack_16c._0_4_ = (stack_st_X509_NAME_ENTRY *)0x0;
  ...
  if ((int)ppAVar10 < 0) {
    ...
    pXStack_1f4 = (X509_NAME *)(auStack_16c + 4);
    auStack_16c._4_4_ = ((auStack_16c._0_4_)->stack).data;
    pXVar5 = (X509_NAME *)
             ASN1_item_d2i(ppAStack_1a4,(uchar **)pXStack_1f4,(long)ppAVar10,pAStack_1a0);
    ppAStack_234 = ppAVar10;
  }
  if (auStack_16c._0_4_ != (stack_st_X509_NAME_ENTRY *)0x0) {
    pXStack_174 = pXVar5;
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar5 = (X509_NAME *)ASN1_item_d2i(ppAStack_234,in,iVar4,pAStack_1e8);
      iStack_22c = iVar4;
    }
...
LAB_0054fbe4:
  ...
  pXStack_280 = (X509_NAME *)(*pcStack_27c)(iVar4,0);
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    while( true ) {
      ...
      pXVar5 = pXStack_280;
      pXVar11 = (X509_NAME *)(*(code *)PTR_BIO_write_006a7f14)(pcStack_274,puVar19);
      ...
      pXStack_280 = (X509_NAME *)((int)pXStack_280 - (int)pXVar11);
    }
    pXVar11 = (X509_NAME *)0x1;
LAB_0054fd84:
  ...
  if (piStack_304 != (int *)0x0) {
    ...
    if (pbVar18 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar5 = (X509_NAME *)(uint)*pbVar18;
        if (iVar4 != 1) {
          uVar1 = CONCAT11(*pbVar18,pbVar18[1]);
          pXVar5 = (X509_NAME *)(uint)uVar1;
          if (iVar4 != 2) {
            uVar2 = CONCAT21(uVar1,pbVar18[2]);
            pXVar5 = (X509_NAME *)(uint)uVar2;
            if (iVar4 == 4) {
              pXVar5 = (X509_NAME *)CONCAT31(uVar2,pbVar18[3]);
            }
          }
        }
      }
...
joined_r0x0054f494:
  if (pXStack_dc == (X509_NAME *)0x0) goto LAB_0054f4cc;
  pXStack_11c = pXStack_dc;
  iVar4 = (*(code *)PTR_BIO_read_006a85bc)
                    (iStack_d0,(undefined *)((int)&unaff_s0->entries + (int)(psVar6->stack).data));
  if (iVar4 < 1) {
    pXStack_11c = (X509_NAME *)0x8e;
    iVar4 = 0xfb;
    goto LAB_0054f554;
  }
  pXStack_dc = (X509_NAME *)((int)pXStack_dc - iVar4);
  unaff_s0 = (X509_NAME *)((int)&unaff_s0->entries + iVar4);
  goto joined_r0x0054f494;
LAB_0054f4cc:
  pXVar5 = (X509_NAME *)((int)&(auStack_88._8_4_)->length + (int)&pXVar21->entries);
  pXVar21 = (X509_NAME *)(uint)(pXVar5 < pXVar21);
  ...
  pXStack_dc = (X509_NAME *)((int)unaff_s0 - (int)pXVar5);
  goto LAB_0054f334;
LAB_0054f43c:
...
LAB_0054f554:
    ...
    unaff_s2 = pXVar21;
LAB_0054f568:
    (*(code *)PTR_BUF_MEM_free_006a8594)(psVar6);
    pXVar21 = (X509_NAME *)0xffffffff;
  }
  else {
    xn->entries = psVar6;
