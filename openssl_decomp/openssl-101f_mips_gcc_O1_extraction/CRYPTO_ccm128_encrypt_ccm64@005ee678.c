  ...
  if (puStack_90 == param_4) {
    ...
    *(uint *)(param_1 + 0x20) = uVar15;
    if ((uVar15 < 0x20000001) && ((uVar15 != 0x20000000 || (uVar9 == 0)))) {
      ...
      puVar18 = (uint *)(param_1 + 0x10);
      if (puVar21 == (uint *)0x0) {
        if (puStack_90 != (uint *)0x0) goto LAB_005ee834;
      }
      else {
        local_68 = param_1;
        local_64 = puVar18;
        ...
        if ((((uint)local_4c & (param_2 < param_1 + 0x14 ^ 1 | puVar18 < local_48 ^ 1)) == 0) ||
          ...
          if (puStack_90 < &SUB_00000004) {
            ...
            *(uint *)(param_1 + 0x10) = *param_2 ^ *(uint *)(param_1 + 0x10);
            ...
            if (puVar21 == puVar10) goto LAB_005ee948;
          }
            ...
            *param_3 = *param_2 ^ local_40;
            ...
            if (puVar21 != puVar18) {
              ...
              *(byte *)(param_3 + iVar13) =
              ...
              if (puVar18 < puStack_90) goto LAB_005eea68;
            }
          }
        }
      }
LAB_005eeb10:
      param_5 = &local_40;
      (**(code **)(local_60 + -0x53e0))(param_1 + (0xf - uStack_8c),0,0x10 - (int)puVar23);
  ...
  pbStack_a4 = *(byte **)PTR___stack_chk_guard_006aabf0;
      ...
      *(byte *)puVar21 = bVar12 ^ uStack_b8._0_1_;
      ...
      if (puVar11 < &SUB_00000004) {
        ...
        *(uint *)(pbVar16 + 0x10) = uStack_b8 ^ uVar15 ^ *(uint *)(pbVar16 + 0x10);
        ...
        if (puVar14 == puVar20) goto LAB_005ef5c4;
      }
...
LAB_005ef1e4:
  (*(code *)PTR_memset_006aab00)(pbVar16 + (0xf - uVar9),0,0x10 - iVar13);
  (*pcVar24)(pbVar16,&uStack_b8,puVar10);
  puVar18 = (uint *)0x0;
...
LAB_005ef260:
  ...
  if (puVar18 <= puVar23) {
    (*(code *)PTR_memcpy_006aabf4)(pbVar19,pbVar16 + 0x10,puVar18);
    return puVar18;
  }
  return (uint *)0x0;
}
