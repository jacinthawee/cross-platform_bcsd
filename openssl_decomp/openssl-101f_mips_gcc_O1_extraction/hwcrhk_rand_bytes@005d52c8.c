...

{
  ...
  if (hwcrhk_context == 0) {
    ...
    (**(code **)(local_428 + -0x6eb0))(HWCRHK_lib_error_code);
    uVar3 = 0;
  }
  else {
    ...
    if (iVar2 < 0) {
      ...
      if (iVar2 == -2) {
        if (HWCRHK_lib_error_code == 0) {
          HWCRHK_lib_error_code = (**(code **)(local_428 + -0x589c))();
        }
        param_2 = (int **)&DAT_00000070;
        pcVar9 = "e_chil.c";
        local_430 = 0x469;
        (**(code **)(local_428 + -0x6eb0))(HWCRHK_lib_error_code,0x6c);
      }
      else {
        if (HWCRHK_lib_error_code == 0) {
          HWCRHK_lib_error_code = (**(code **)(local_428 + -0x589c))();
  ...
  piVar8 = local_14;
  (**(code **)(local_428 + -0x5328))();
  puVar17 = auStack_440;
  do {
    ppiVar7 = param_1;
    puVar1 = PTR___stack_chk_guard_006aabf0;
    puVar14 = &_gp;
    *(undefined1 **)(puVar17 + -0x24) = unaff_s1;
    *(int ***)(puVar17 + -0x14) = unaff_s5;
    *(undefined1 **)(puVar17 + -0x20) = unaff_s2;
    ...
    *(undefined4 *)(puVar17 + -0x2c) = *(undefined4 *)PTR___stack_chk_guard_006aabf0;
    if (hwcrhk_context == 0) {
      if (HWCRHK_lib_error_code == 0) {
        HWCRHK_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006aa644)();
        puVar14 = *(undefined **)(puVar17 + -0x460);
      }
      pcVar18 = *(code **)(puVar14 + -0x6eb0);
      param_1 = (int **)&DAT_0000006a;
      pcVar10 = "e_chil.c";
      *(undefined4 *)(puVar17 + -0x478) = 0x390;
      ...
      *(undefined4 *)(puVar17 + -0x43c) = uVar3;
      ...
      if (iVar2 < 0) {
        if (iVar2 == -2) {
          if (HWCRHK_lib_error_code == 0) {
            HWCRHK_lib_error_code = (**(code **)(puVar15 + -0x589c))();
            puVar15 = *(undefined **)(puVar17 + -0x460);
          }
          pcVar18 = *(code **)(puVar15 + -0x6eb0);
          param_1 = (int **)&DAT_00000070;
          pcVar10 = "e_chil.c";
          *(undefined4 *)(puVar17 + -0x478) = 0x3a8;
          ...
          pcVar10 = "e_chil.c";
          *(undefined4 *)(puVar17 + -0x478) = 0x3ac;
          (*pcVar18)(HWCRHK_lib_error_code,0x6b);
          puVar16 = *(undefined **)(puVar17 + -0x460);
        }
        piVar8 = *(int **)(puVar17 + -0x454);
        (**(code **)(puVar16 + -0x6c7c))(1);
        uVar3 = 0;
        puVar15 = *(undefined **)(puVar17 + -0x460);
      }
      else {
