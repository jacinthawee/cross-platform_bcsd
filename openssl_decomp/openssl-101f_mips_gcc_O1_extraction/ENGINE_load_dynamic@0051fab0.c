...

{
  ...
  if ((((iVar1 != 0) && (iVar1 = ENGINE_set_name(e,"Dynamic engine loading support"), iVar1 != 0))
      && (iVar1 = ENGINE_set_init_function(e,dynamic_init), iVar1 != 0)) &&
     (((iVar1 = ENGINE_set_finish_function(e,dynamic_finish), iVar1 != 0 &&
       (iVar1 = ENGINE_set_ctrl_function(e,dynamic_ctrl), iVar1 != 0)) &&
