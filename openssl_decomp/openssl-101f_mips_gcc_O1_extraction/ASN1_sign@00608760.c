...
LAB_0060888c:
    ...
    algor1 = (X509_ALGOR *)(**(code **)(local_68 + -0x7dd8))(pAStack_8c,s_a_sign_c_0067a014,0xaf);
    unaff_s5 = (ASN1_BIT_STRING *)(**(code **)(local_68 + -0x78ec))(local_58);
    local_48._0_4_ = unaff_s5;
    algor2 = (X509_ALGOR *)(**(code **)(local_68 + -0x7dd8))(unaff_s5,s_a_sign_c_0067a014,0xb1);
    if (algor1 == (X509_ALGOR *)0x0) {
      pcStack_f0 = s_a_sign_c_0067a014;
      local_48._0_4_ = (ASN1_BIT_STRING *)0x0;
...
LAB_006090b0:
    pcStack_14c = s_a_sign_c_0067a014;
...
LAB_00608da4:
      ...
      pEStack_fc = (EVP_PKEY *)
                   (*(code *)pXStack_c0[-0xfbb].algorithm)(pEStack_f4,s_a_sign_c_0067a014,0x12e);
...
LAB_00608edc:
  ...
  pEVar6 = (EVP_MD_CTX *)
           (**(code **)(puStack_178 + -0x7dd8))(pcStack_19c,s_a_digest_c_0067a020,0x52);
  if (pEVar6 == (EVP_MD_CTX *)0x0) {
    pcStack_1f0 = s_a_digest_c_0067a020;
