...

{
  ...
  local_44 = t;
  iVar5 = (*(code *)PTR_OPENSSL_gmtime_006a9dc0)(&local_44,auStack_40);
  if (iVar5 == 0) {
    iVar5 = 0xad;
    pcVar9 = "a_time.c";
    atStack_64[0] = 0xd9;
    ...
    pcVar14 = (code *)PTR_ASN1_UTCTIME_adj_006a9dc8;
    if (99 < *(int *)(iVar5 + 0x14) - 0x32U) {
      pcVar14 = (code *)PTR_ASN1_GENERALIZEDTIME_adj_006a9dcc;
    }
    pcVar9 = (char *)0x0;
    iVar5 = 0;
  ...
  pAStack_84 = *(ASN1_UTCTIME **)PTR___stack_chk_guard_006aabf0;
  pAStack_7c = s;
  iVar7 = (*(code *)PTR_OPENSSL_gmtime_006a9dc0)(atStack_64,auStack_b0);
  if (iVar7 == 0) {
    ERR_put_error(0xd,0xd9,0xad,"a_time.c",0x73);
    pAVar6 = (ASN1_TIME *)0x0;
  }
  else if (((iVar5 == 0) && (pcVar9 == (char *)0x0)) ||
          (iVar13 = (*(code *)PTR_OPENSSL_gmtime_adj_006a9dc4)(iVar7,iVar5,pcVar9), iVar13 != 0)) {
    pcVar14 = (code *)PTR_ASN1_UTCTIME_adj_006a9dc8;
  ...
  iVar3 = iVar4 + 3;
  if (iVar7 != 0x2e) goto LAB_0054d1a0;
  if (iVar5 < iVar3) {
    return (ASN1_TIME *)0x0;
  }
