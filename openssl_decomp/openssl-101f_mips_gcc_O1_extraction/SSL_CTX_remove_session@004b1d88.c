...

{
  ...
  pSVar1 = (SSL_SESSION *)(*(code *)PTR_lh_retrieve_006a84b0)(param_1->sessions,c);
  if (c == pSVar1) {
    pSVar1 = (SSL_SESSION *)(*(code *)PTR_lh_delete_006a94ac)(param_1->sessions,c);
    ...
    *(undefined4 *)(pSVar1->krb5_client_princ + 4) = 1;
    ...
    iVar2 = CRYPTO_add_lock((int *)(pSVar1->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
    if (0 < iVar2) {
      return 1;
    }
