...

{
  ...
  if (PKCS8_PRIV_KEY_INFO_it._16_4_ == 0) {
    if (uVar2 < 7) {
      ...
      pPVar3 = (PKCS8_PRIV_KEY_INFO *)(*(code *)(&switchD_00565630::switchdataD_0066abc0)[uVar2])();
      return pPVar3;
    }
  }
  else if (uVar2 < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    pPVar3 = (PKCS8_PRIV_KEY_INFO *)(*(code *)(&switchD_005651a0::switchdataD_0066aba4)[uVar2])();
    return pPVar3;
  }
