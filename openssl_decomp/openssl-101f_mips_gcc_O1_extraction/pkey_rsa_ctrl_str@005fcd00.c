      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          ...
          if (iVar2 == 0) {
            ...
            iVar2 = (*(code *)PTR_strcmp_006aac20)(param_3,&DAT_006787bc);
            if ((iVar2 == 0) ||
               (iVar2 = (*(code *)PTR_strcmp_006aac20)(param_3,&DAT_006787c4), iVar2 == 0)) {
              in_stack_ffffffc8 = 4;
            }
            else {
              iVar2 = (*(code *)PTR_strcmp_006aac20)(param_3,&DAT_006787cc);
              if (iVar2 == 0) {
                in_stack_ffffffc8 = 5;
              }
