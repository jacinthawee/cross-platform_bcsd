...
LAB_00550958:
    if (param_1 == (ASN1_TYPE *)0x0) {
      ...
      iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0066a078,1);
...
LAB_00550d58:
  ...
  if (local_4d == '\0') {
    ...
    iVar9 = local_78;
    if (param_1 == (ASN1_TYPE *)0x0) goto LAB_00550988;
    iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0067a4e0,1);
    if (iVar9 != 1) goto LAB_00550980;
  }
  pcVar4 = (param_3.object)->sn;
      ...
      if (0 < iVar9) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar18 & 8) == 0) {
              iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0066a068,1);
              if (iVar9 != 1) goto LAB_00550980;
...
LAB_00550f78:
          if ((uVar18 & 6) == 0) {
            ...
            iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0066a074,2);
...
LAB_00550f3c:
  ...
  iVar6 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0067a4e0,1);
