...

{
  ...
  uVar11 = 0xffffffff;
  uVar22 = in_t4;
  if (param_5 < 0x10) goto LAB_005efc50;
  uVar22 = param_2 & 3;
  uVar14 = param_2 + 4 & 3;
  ...
  if (((param_6 != 0) || ((param_5 & 0xf) == 0)) ||
    ...
    if (param_6 != 0) {
      if ((param_5 >= 6 && (puVar20 + 5 <= param_3 || puVar21 + 5 <= unaff_s0)) &&
        ...
        if (param_5 < 4) {
          ...
          *unaff_s0 = local_50;
          ...
          uVar22 = local_44;
          if (uVar16 == uVar14) goto LAB_005f01ec;
        }
        uVar14 = uVar16 + 1;
      ...
      *(byte *)unaff_s0 = local_50._0_1_;
      if (param_5 == 1) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x11) = local_50._1_1_;
      if (param_5 == 2) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x12) = local_50._2_1_;
      if (param_5 == 3) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x13) = (byte)local_50;
      if (param_5 == 4) goto LAB_005f01ec;
      ...
      *(byte *)(puVar20 + 5) = local_4c._0_1_;
      if (param_5 < 6) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x15) = local_4c._1_1_;
      if (param_5 < 7) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x17) = (byte)local_4c;
      if (param_5 == 8) goto LAB_005f01ec;
      ...
      *(byte *)(puVar20 + 6) = local_48._0_1_;
      if (param_5 == 9) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x19) = local_48._1_1_;
      if (param_5 == 10) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x1a) = local_48._2_1_;
      if (param_5 == 0xb) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x1b) = (byte)local_48;
      if (param_5 == 0xc) goto LAB_005f01ec;
      ...
      *(byte *)(puVar20 + 7) = local_44._0_1_;
      uVar22 = local_44;
      if (param_5 == 0xd) goto LAB_005f01ec;
      ...
      *(byte *)((int)puVar20 + 0x1d) = local_44._1_1_;
      uVar22 = local_44;
      if (param_5 != 0xf) goto LAB_005f01ec;
  ...
  if (param_5 != 0) {
    if ((5 < param_5 && (param_3 + 5 <= unaff_s0 + 4 || unaff_s0 + 5 <= param_3 + 4)) &&
      ...
      if (param_5 - 1 < 3) {
        ...
        uVar22 = local_44;
        if (param_5 == uVar14) goto LAB_005f0008;
      }
