...

{
  ...
  if ((unaff_s2 < 1) ||
     (pEVar3 = (EVP_PKEY *)(*(code *)PTR_EVP_PKEY_new_006a8710)(), pEVar3 == (EVP_PKEY *)0x0)) {
LAB_00573bb8:
    ...
    iVar2 = (*(code *)PTR_EVP_PKEY_set_type_str_006a9fd0)(pEVar3,local_2c,unaff_s2);
...
LAB_00573ba8:
  ...
  (*(code *)PTR_CRYPTO_free_006a7f88)(local_2c);
