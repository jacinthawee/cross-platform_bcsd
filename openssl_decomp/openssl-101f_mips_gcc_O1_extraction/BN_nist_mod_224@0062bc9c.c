...

{
  ...
  if (uStack_9c == 0) {
    ...
    unaff_s5 = (BIGNUM *)a->d;
    iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(a,_bignum_nist_p_224_sqr_6152);
    ...
    if (iVar3 == 0) {
      ...
      if (a != r) {
        if (r->dmax < 7) {
          ...
          iVar3 = (*(code *)PTR_bn_expand2_006a9680)(r);
          a = unaff_s5;
...
LAB_0062be34:
      ...
      if (((int)uVar16 < 0) || (uVar16 == 0)) {
        if (((int)uVar16 >> 0x1f | uVar16) == 0) {
          ...
          iVar3 = (*(code *)PTR_bn_add_words_006a96a8)(pBVar9,pBVar9,_nist_p_224 + ~uVar16 * 0x1c,7)
          ;
          unaff_s5 = (BIGNUM *)-iVar3;
          pcVar15 = (code *)(((uint)pcVar15 ^ (uint)PTR_bn_add_words_006a96a8) & (uint)unaff_s5 ^
      ...
      pBStack_130 = a;
      iVar3 = (*(code *)PTR_BN_copy_006a9570)(r);
      uStack_9c = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062bd10:
    uStack_9c = (*(code *)PTR_BN_nnmod_006a9664)(r,a,_bignum_nist_p_224);
  }
LAB_0062bd30:
  ...
  pBStack_a4 = *(BIGNUM **)PTR___stack_chk_guard_006aabf0;
  ...
  if (uStack_12c == 0) {
    ...
    iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(pBStack_130,_bignum_nist_p_256_sqr_6183);
    if (-1 < iVar3) goto LAB_0062c278;
    iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(_bignum_nist_p_256);
    if (iVar3 == 0) {
      pBStack_1d8 = (BIGNUM *)0x0;
      uStack_12c = 1;
      (*(code *)PTR_BN_set_word_006a8820)(pBStack_124);
    }
    else if (iVar3 < 1) {
      ...
      if (pBStack_130 != pBStack_124) {
        if (pBStack_124->dmax < 8) {
          ...
          iVar3 = (*(code *)PTR_bn_expand2_006a9680)(pBStack_124);
...
LAB_0062c3a8:
      ...
      if (((int)uVar16 < 0) || (uVar16 == 0)) {
        if (((int)uVar16 >> 0x1f | uVar16) == 0) {
          ...
          pcVar15 = (code *)(((uint)pcVar15 ^ (uint)PTR_bn_add_words_006a96a8) & (uint)pBStack_11c ^
                            (uint)PTR_bn_add_words_006a96a8);
        }
      }
      else {
      ...
      pBStack_1d8 = pBStack_130;
      iVar3 = (*(code *)PTR_BN_copy_006a9570)(pBStack_124);
      uStack_12c = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062c278:
    uStack_12c = (*(code *)PTR_BN_nnmod_006a9664)(pBStack_124,pBStack_130,_bignum_nist_p_256);
  }
LAB_0062c298:
  ...
  puStack_1a8 = &_gp;
  pBStack_134 = *(BIGNUM **)PTR___stack_chk_guard_006aabf0;
  ...
  if (uStack_1d4 == 0) {
    ...
    pBStack_19c = ctx;
    iVar3 = (*(code *)PTR_BN_ucmp_006a9678)(pBStack_1d8,_bignum_nist_p_384_sqr_6214);
    if (-1 < iVar3) goto LAB_0062c9e0;
    iVar3 = (**(code **)(puStack_1a8 + -0x6868))(_bignum_nist_p_384);
    if (iVar3 == 0) {
      pBVar9 = (BIGNUM *)0x0;
      uStack_1d4 = 1;
      (**(code **)(puStack_1a8 + -0x76c0))(pBStack_1dc);
    }
    else if (iVar3 < 1) {
      ...
      if (pBStack_1d8 != pBStack_1dc) {
        if (pBStack_1dc->dmax < 0xc) {
          ...
          iVar3 = (**(code **)(puStack_1a8 + -0x6860))(pBStack_1dc);
...
LAB_0062cb38:
        ...
        (**(code **)(puStack_1a8 + -0x53e0))(puVar5 + (int)piVar20,0,iVar3);
      }
      else {
        piVar20 = &pBStack_1d0[-1].dmax;
        puVar5 = (uint *)(**(code **)(puStack_1a8 + -0x52ec))
      ...
      pcVar15 = *(code **)(puStack_1a8 + -0x683c);
      ...
      if (((int)uVar16 < 0) || (uVar16 == 0)) {
        if (((int)uVar16 >> 0x1f | uVar16) == 0) {
          ...
          iVar3 = (**(code **)(puStack_1a8 + -0x6838))
                            (pBStack_1d8,pBStack_1d8,_nist_p_384 + ~uVar16 * 0x30,0xc);
          pBStack_1cc = (BIGNUM *)-iVar3;
          pcVar15 = (code *)(((uint)pcVar15 ^ *(uint *)(puStack_1a8 + -0x6838)) & (uint)pBStack_1cc
                            ^ *(uint *)(puStack_1a8 + -0x6838));
        }
      }
      else {
        iVar3 = (**(code **)(puStack_1a8 + -0x683c))
      ...
      pBVar9 = pBStack_1d8;
      iVar3 = (**(code **)(puStack_1a8 + -0x6970))(pBStack_1dc);
      uStack_1d4 = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062c9e0:
    uStack_1d4 = (**(code **)(puStack_1a8 + -0x687c))(pBStack_1dc,pBStack_1d8,_bignum_nist_p_384);
  }
LAB_0062ca00:
...
LAB_0062d488:
        ...
        (*(code *)PTR_memset_006aab00)(auStack_228 + iVar23,0,iVar3);
      }
      else {
        puVar25 = auStack_228;
        do {
      ...
      iVar3 = (*(code *)PTR_bn_sub_words_006a96a4)(auStack_228,puVar14,_nist_p_521,0x11);
