...

{
  ...
  puVar7 = auStack_34;
  iVar2 = (*(code *)PTR_X509_PUBKEY_get0_param_006a98cc)(0,auStack_34,reason,&local_20,param_2);
  if (iVar2 == 0) {
LAB_00518f38:
    uVar3 = 0;
  }
...
LAB_00518fa0:
    ...
    iVar2 = (*(code *)PTR_d2i_ASN1_INTEGER_006a950c)(0,auStack_34,local_2c);
    if (iVar2 == 0) {
      reason = (DH *)&DAT_00000068;
      puVar7 = &DAT_0000006c;
...
LAB_00519088:
      ...
      pBVar4 = (BIGNUM *)(*(code *)PTR_ASN1_INTEGER_to_BN_006a8114)(iVar2,0);
      dh->pub_key = pBVar4;
  ...
  if (*(int *)(iVar2 + 8) != 0) {
    ...
    iVar5 = (*(code *)PTR_BN_num_bits_006a82f4)();
    iVar6 = iVar5 + 7;
    if (iVar5 + 7 < 0) {
      iVar6 = iVar5 + 0xe;
    }
    ...
    if (uVar8 != 0) {
      ...
      if (iVar10 != 0) {
        iVar5 = (*(code *)PTR_BN_num_bits_006a82f4)(iVar10);
        iVar6 = iVar5 + 7;
        if (iVar5 + 7 < 0) {
          iVar6 = iVar5 + 0xe;
        }
      ...
      iVar6 = (*(code *)PTR_CRYPTO_malloc_006a8108)(uVar8 + 10,"dh_ameth.c",0x164);
      if (iVar6 != 0) {
        BIO_indent(b,(int)reason,0x80);
        uVar3 = (*(code *)PTR_BN_num_bits_006a82f4)(*(undefined4 *)(iVar2 + 8));
        iVar5 = BIO_printf(b,"%s: (%d bit)\n","PKCS#3 DH Private-Key",uVar3);
        if (0 < iVar5) {
          indent = &reason->version;
          iVar5 = (*(code *)PTR_ASN1_bn_print_006a97dc)(b,"private-key:",iVar9,iVar6,indent);
          if (iVar5 != 0) {
            iVar5 = (*(code *)PTR_ASN1_bn_print_006a97dc)(b,"public-key:",iVar10,iVar6,indent);
            if (iVar5 != 0) {
