...

{
  ...
  local_78 = ks2;
  local_64 = (int *)PTR___stack_chk_guard_006aabf0;
  local_74 = ks3;
  local_88 = (uint *)&_gp;
  ...
  if (numbits < 0x41) {
    ...
    if (enc == 0) {
      if (pDVar27 <= (uint)length) {
        ...
        local_6c = (DES_key_schedule **)(&PTR_LAB_00675524 + (int)pDVar27);
        local_68 = &UNK_0067556c + (int)pDVar27 * 4;
        ...
        do {
          ...
          local_44 = pDVar24;
          local_40 = pDVar15;
          (*(code *)local_88[-0x15d9])(local_70,local_7c,local_78,local_74);
          ...
          if (numbits == 0x20) {
            ...
            if (numbits != 0x40) {
              ...
              if (local_5c == 0) {
                ...
                (*(code *)local_88[-0x14b9])(local_58,local_60,8);
              }
              else {
                local_4c = 0;
                local_50 = (DES_key_schedule *)0x0;
                (*(code *)local_88[-0x14b9])(local_58,local_60,9);
      ...
      unaff_s6 = (DES_key_schedule *)(&DAT_00675500 + (int)pDVar27 * 4);
      local_68 = &UNK_00675548 + (int)pDVar27 * 4;
      local_6c = &local_44;
      ...
      do {
        ...
        local_44 = pDVar24;
        local_40 = pDVar15;
        (*(code *)local_88[-0x15d9])(local_6c,local_7c,local_78);
  ...
  uStack_9c = 0x5e637c;
  (*(code *)local_88[-0x14ca])();
  puStack_10c = local_88;
  piStack_f0 = (int *)PTR___stack_chk_guard_006aabf0;
  ...
  if ((undefined *)((int)ks1[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_80 == 0) {
      ...
      if (pDStack_1a4 <= (uint)length) {
        ppcStack_f4 = (code **)(&PTR_LAB_006755b4 + (int)pDStack_1a4);
        ...
        pDStack_1a0 = (DES_key_schedule *)(&PTR_LAB_006755d8 + (int)pDStack_1a4);
        ...
        do {
          ...
          pDStack_dc = pDVar12;
          pDStack_d8 = pDVar8;
          (*(code *)pDStack_118[-0xd2].ks[1].deslong[0])(pDVar24,puStack_10c);
          ...
          if (pDStack_fc != (DES_key_schedule *)&DAT_00000020) {
            if (pDStack_fc == (DES_key_schedule *)&DAT_00000040) {
              ...
              if (pDStack_104 == (DES_key_schedule *)0x0) {
                ...
                pDStack_100 = pDVar27;
                (*(code *)*(DES_key_schedule **)((int)pDStack_118[-0xa6].ks + 0x1c))
      ...
      pDStack_134 = (DES_key_schedule *)(&switchD_005e64e8::switchdataD_00675590 + (int)pDStack_1a4)
      ;
      pDStack_1a0 = (DES_key_schedule *)(&PTR_LAB_006755fc + (int)pDStack_1a4);
      ...
      while (pDVar27 = pDVar12, pDVar8 = pDVar24, puStack_150 = (uchar *)ivec,
        ...
        pDStack_dc = pDVar8;
        pDStack_d8 = pDVar27;
        (*(code *)pDStack_118[-0xd2].ks[1].deslong[0])(pDStack_174,puStack_10c);
        pDVar13 = pDStack_fc;
        pDVar15 = pDStack_100;
...
LAB_005e6964:
  ...
  (*(code *)pDStack_118[-0xa7].ks[0xb].deslong[0])();
  pDStack_1b0 = pDStack_118;
  pbVar29 = &_gp;
  pDStack_144 = unaff_s3;
  piStack_16c = (int *)PTR___stack_chk_guard_006aabf0;
  uStack_148 = unaff_s2;
  ...
  if (pDVar14 != (DES_key_schedule *)0x0) {
    ...
    do {
      if (uStack_1b8 == 0) {
        ...
        pDVar14 = pDStack_1b0;
        (**(code **)(pbVar29 + -0x5764))(unaff_s1,pDStack_174,pDStack_1b0,uStack_114);
        uVar25 = uStack_164 >> 8;
  ...
  *puStack_170 = uStack_1b8;
  if (iStack_154 != iVar7) {
    ...
    iStack_1bc = *(int *)PTR___stack_chk_guard_006aabf0;
    ...
    if (pDVar14 != (DES_key_schedule *)0x0) {
      ...
      do {
        if (uVar6 == 0) {
          (*(code *)PTR_DES_encrypt1_006a95e8)(&uStack_1cc,uVar17,1);
          iVar7 = iVar7 + 1;
    ...
    *puStack_17c = uVar6;
    if (iStack_1bc != iVar7) {
      ...
      do {
        ...
        uVar6 = *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar23 & 0xfc)) ^
                ...
                *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar6
        ;
        ...
        uVar21 = uVar19 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 ...
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc) + 0x100) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 * 0x100 >> 0x1a) + 0x140) * 4);
        ...
        uVar20 = uVar6 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar23 & 0xfc)) ^
        ...
        uVar6 = (uVar6 << 0x10 ^ uVar17) >> 4;
        uVar17 = uVar6 + uVar17 * 0x10000000;
        uVar17 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar23 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar21 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar23 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar19 = uVar17 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar23 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar23 & 0xfc)) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar21 << 0x10) >> 0x1a) + 0x80) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar23 << 8) >> 0x1a) + 0x100) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar19 >> 0x1a) + 0x1c0) * 4) ^
        ...
        uVar6 = uVar20 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar25 >> 0x1a) + 0x180) * 4) ^
