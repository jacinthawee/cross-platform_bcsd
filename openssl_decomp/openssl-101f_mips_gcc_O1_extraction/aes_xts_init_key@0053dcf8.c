...

{
  ...
  else if (param_2 == 0) goto LAB_0053dda4;
  iVar4 = *(int *)(param_1 + 0x58);
  *(undefined4 *)(iVar6 + 0x1f8) = 0;
  puVar1 = PTR_AES_encrypt_006a8b90;
  if (param_4 == 0) {
    (*(code *)PTR_AES_set_decrypt_key_006a9b38)(param_2,iVar4 << 2);
    *(undefined **)(iVar6 + 0x1f0) = PTR_AES_decrypt_006a95f8;
  }
  else {
    (*(code *)PTR_AES_set_encrypt_key_006a8adc)(param_2,iVar4 << 2,iVar6);
