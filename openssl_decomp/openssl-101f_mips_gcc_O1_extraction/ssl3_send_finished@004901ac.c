...

{
  ...
  if (param_1[0xd] == param_2) {
    ...
    *(int *)(iVar3 + 0x2b4) = iVar4;
    ...
    if (param_1[1] == 0x1000) {
      if (0x40 < iVar4) {
        (*(code *)PTR_OpenSSLDie_006a8d4c)("s3_both.c",0xaf,"i <= EVP_MAX_MD_SIZE");
      }
      (*(code *)PTR_memcpy_006aabf4)(param_1[0x16] + 0x394,param_1[0x16] + 0x234,iVar4);
      *(undefined *)(param_1[0x16] + 0x3d4) = uVar1;
    }
    else {
      if (0x40 < iVar4) {
        (*(code *)PTR_OpenSSLDie_006a8d4c)("s3_both.c",0xb6,"i <= EVP_MAX_MD_SIZE");
      }
      (*(code *)PTR_memcpy_006aabf4)(param_1[0x16] + 0x3d5,param_1[0x16] + 0x234,iVar4);
