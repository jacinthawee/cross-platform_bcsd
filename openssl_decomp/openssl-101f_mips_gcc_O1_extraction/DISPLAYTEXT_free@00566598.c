...

{
  ...
  puVar1 = DISPLAYTEXT_it._8_4_;
  puVar6 = DISPLAYTEXT_it;
  uVar3 = (uint)DISPLAYTEXT_it[0];
  puStack_2c = *(uchar **)PTR___stack_chk_guard_006aabf0;
  pAVar5 = a;
  pAStack_34 = a;
  if (uVar3 == 0) {
    if (DISPLAYTEXT_it._16_4_ == (undefined4 *)0x0) {
      pAVar5 = (ASN1_STRING *)&pAStack_34;
      if (DISPLAYTEXT_it._8_4_ == (uint *)0x0) {
        ASN1_primitive_free((ASN1_VALUE **)pAVar5,(ASN1_ITEM *)DISPLAYTEXT_it);
      }
      else {
        iVar7 = 0;
        if ((*DISPLAYTEXT_it._8_4_ & 6) == 0) {
          puVar6 = (undefined1 *)DISPLAYTEXT_it._8_4_[4];
          pAVar5 = (ASN1_STRING *)&pAStack_34;
          asn1_item_combine_free(pAVar5,puVar6,*DISPLAYTEXT_it._8_4_ & 0x400);
        }
        else {
          puVar6 = (undefined1 *)DISPLAYTEXT_it._16_4_;
