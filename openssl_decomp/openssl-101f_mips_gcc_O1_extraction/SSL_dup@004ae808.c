...

{
  ...
  if (pSVar8 == (SSL_SESSION *)0x0) {
    ...
    if (pcVar13 != (cert_st *)0x0) {
      ...
      s->cert = pcVar13;
      if (pcVar13 == (cert_st *)0x0) goto LAB_004ae90c;
    }
  ...
  uVar4 = (*(code *)PTR_X509_VERIFY_PARAM_get_depth_006a9448)(ssl->param);
  (*(code *)PTR_X509_VERIFY_PARAM_set_depth_006a8cfc)(s->param,uVar4);
  ...
  if ((iVar10 != 0) &&
     ((ssl->rbio == (BIO *)0x0 ||
      (iVar10 = (*(code *)PTR_BIO_ctrl_006a7f18)(ssl->rbio,0xc,0,&s->rbio), iVar10 != 0)))) {
    pBVar12 = ssl->wbio;
    if (pBVar12 != (BIO *)0x0) {
      if (pBVar12 == ssl->rbio) {
        s->wbio = s->rbio;
        ...
        iVar10 = (*(code *)PTR_BIO_ctrl_006a7f18)(pBVar12,0xc,0,&s->wbio);
        if (iVar10 == 0) goto LAB_004ae90c;
      }
    }
    puVar1 = PTR_X509_VERIFY_PARAM_inherit_006a942c;
    ...
    if (ssl->cipher_list != (stack_st_SSL_CIPHER *)0x0) {
      psVar6 = (stack_st_SSL_CIPHER *)(*(code *)PTR_sk_dup_006a9074)();
      s->cipher_list = psVar6;
      if (psVar6 == (stack_st_SSL_CIPHER *)0x0) goto LAB_004ae90c;
    }
    ...
    iVar10 = (*(code *)PTR_sk_dup_006a9074)();
    if (iVar10 != 0) {
      (s->ex_data).dummy = iVar10;
      iVar16 = 0;
      do {
        iVar17 = (*(code *)PTR_sk_num_006a7f2c)(iVar10);
        if (iVar17 <= iVar16) {
          return s;
        }
        uVar4 = (*(code *)PTR_sk_value_006a7f24)(iVar10,iVar16);
        uVar7 = (*(code *)PTR_X509_NAME_dup_006a823c)(uVar4);
        iVar17 = (*(code *)PTR_sk_set_006a9478)(iVar10,iVar16,uVar7);
        iVar16 = iVar16 + 1;
      } while (iVar17 != 0);
      (*(code *)PTR_X509_NAME_free_006a80f8)(uVar4);
    }
  }
LAB_004ae90c:
  SSL_free(s);
