...

{
  ...
  iVar1 = iVar1 + 1;
  iVar2 = (*(code *)PTR_CRYPTO_malloc_006a8108)(iVar1 * 4,"bn_gf2m.c",0x411);
  if (iVar2 == 0) {
    return 0;
  }
  iVar3 = param_3[1];
...
LAB_006275d0:
    ...
    else if (iVar4 == 0) goto LAB_00627554;
    if (iVar4 <= iVar1) {
      iVar4 = BN_GF2m_mod_solve_quad_arr(param_1,param_2,iVar2,param_4);
      goto LAB_0062757c;
    }
  }
  (*(code *)PTR_ERR_put_error_006a9030)(3,0x86,0x6a,"bn_gf2m.c",0x415);
LAB_0062757c:
