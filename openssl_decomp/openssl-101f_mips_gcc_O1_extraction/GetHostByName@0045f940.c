...

{
  ...
  if (((ghbn_cache._148_4_ == 0xffffffff) || (ghbn_cache._148_4_ != 0)) &&
     (iVar17 = (*(code *)PTR_strncmp_006aaa7c)(param_1,ghbn_cache,0x80), iVar17 == 0)) {
    iVar17 = 0;
  }
  else {
    uVar18 = uVar24;
    ...
    if ((ghbn_cache._300_4_ == 0) ||
       (iVar17 = (*(code *)PTR_strncmp_006aaa7c)(param_1,0x6abac0,0x80), iVar17 != 0)) {
      uVar19 = uVar18;
      ...
      if ((ghbn_cache._452_4_ == 0) ||
         (iVar17 = (*(code *)PTR_strncmp_006aaa7c)(param_1,0x6abb58,0x80), iVar17 != 0)) {
        if (ghbn_cache._604_4_ < uVar19) {
          uVar24 = 3;
        }
        if ((ghbn_cache._604_4_ == 0) ||
           (iVar17 = (*(code *)PTR_strncmp_006aaa7c)(param_1,0x6abbf0,0x80), iVar17 != 0)) {
          ghbn_miss = ghbn_miss + 1;
          uVar18 = (*(code *)PTR_gethostbyname_006aaa70)(param_1);
          if (uVar18 == 0) {
            uVar18 = 0;
          }
          else {
            uVar19 = (*(code *)PTR_strlen_006aab30)(param_1);
            if (uVar19 < 0x80) {
              uVar22 = 0x80;
              uVar19 = uVar19 + 1;
              iVar25 = uVar24 * 0x98;
              puVar23 = ghbn_cache + iVar25;
              iVar20 = (*(code *)PTR___memcpy_chk_006aab54)();
              uVar24 = uVar18 & 3;
              uVar1 = uVar18 + 4 & 3;
