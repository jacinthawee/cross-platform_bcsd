...

{
  ...
  if (numbits - 1U < 0x40) {
    ...
    if (enc == 0) {
      ...
      unaff_s7 = &switchD_005e64e8::switchdataD_00675590 + (int)unaff_s5;
      unaff_s6 = (code **)(&PTR_LAB_006755fc + (int)unaff_s5);
