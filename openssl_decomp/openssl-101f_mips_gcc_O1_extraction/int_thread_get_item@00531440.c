...
char * int_thread_get_item(void *param_1)

{
  ...
  pcStack_4c = "7 datafinal";
  if (err_fns == (char *)0x0) {
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,1,"err.c",0x127);
    if (err_fns == (char *)0x0) {
      err_fns = err_defaults;
    }
    (**(code **)(local_28 + -0x6c74))(10,1,"err.c",0x12a);
  }
  ...
  if (local_20 == (_LHASH *)0x0) {
    ...
    (**(code **)(local_28 + -0x6c74))(5,1,"err.c",0x1ef);
    pcVar3 = (char *)lh_retrieve(local_20,param_1);
    (**(code **)(local_28 + -0x6c74))(6,1,"err.c",0x1f1);
  ...
  puStack_48 = &_ITM_registerTMCloneTable;
  pvStack_54 = *(void **)PTR___stack_chk_guard_006aabf0;
  pcStack_88 = "7 datafinal";
  pvStack_40 = param_1;
  if (err_fns == (char *)0x0) {
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,1,"err.c",0x127);
    if (err_fns == (char *)0x0) {
  ...
  if (p_Stack_58 == (_LHASH *)0x0) {
    ...
    pcVar3 = (char *)lh_insert(p_Stack_58,pvStack_7c);
  ...
  puStack_84 = &_ITM_registerTMCloneTable;
  ...
  if (p_Stack_90 == (_LHASH *)0x0) goto LAB_00531994;
