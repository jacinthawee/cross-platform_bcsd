  ...
  *param_2 = 0x50;
  if (iVar2 != 0) {
    ...
    if (*(int *)(param_1 + 0x1c4) != 0) {
      ...
      iVar2 = (*(code *)PTR_RAND_bytes_006a8d44)(auStack_44,0x30);
      if (0 < iVar2) {
        uVar3 = (*(code *)PTR_BN_bin2bn_006a89f0)(auStack_44,0x30,0);
        *(undefined4 *)(param_1 + 0x1c0) = uVar3;
        ...
        iVar2 = (*(code *)PTR_SRP_Calc_B_006a9568)
...
LAB_004be510:
  ...
  iVar4 = (*(code *)PTR_SRP_get_default_gN_006a901c)(param_4);
  if (iVar4 == 0) {
    iVar2 = -1;
  }
  else {
    uVar3 = (*(code *)PTR_BN_dup_006a9100)(*(undefined4 *)(iVar4 + 8));
    ...
    *(undefined4 *)(iVar2 + 0x1ac) = uVar3;
    ...
    iVar4 = (*(code *)PTR_SRP_create_verifier_BN_006a956c)
