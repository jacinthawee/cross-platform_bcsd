...

{
  ...
  if ((in == (EVP_MD_CTX *)0x0) || (pEVar21 = in->digest, pEVar21 == (EVP_MD *)0x0)) {
    ERR_put_error(6,0x6e,0x6f,"digest.c",0x128);
    return 0;
  }
  ...
  out->flags = uVar25;
  out->md_data = (void *)((iVar8 << uVar5 * 8 | uVar24 & 0xffffffffU >> (4 - uVar5) * 8) &
                          -1 << (uVar13 + 1) * 8 | uVar17 >> (3 - uVar13) * 8);
  out->pctx = (EVP_PKEY_CTX *)
              ((iVar9 << uVar6 * 8 | uVar23 & 0xffffffffU >> (4 - uVar6) * 8) &
  ...
  if ((in->md_data != (void *)0x0) && (iVar20 = out->digest->ctx_size, iVar20 != 0)) {
    if (pvVar26 == (void *)0x0) {
      pvVar26 = (void *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar20,"digest.c",0x143);
      out->md_data = pvVar26;
      if (pvVar26 == (void *)0x0) {
        ERR_put_error(6,0x6e,0x41,"digest.c",0x146);
        return 0;
      }
    ...
    (*(code *)PTR_memcpy_006aabf4)(pvVar26,in->md_data,iVar20);
  }
  pEVar22 = in->pctx;
  ...
  if (UNRECOVERED_JUMPTABLE != (_func_1081 *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00536144. Too many branches */
