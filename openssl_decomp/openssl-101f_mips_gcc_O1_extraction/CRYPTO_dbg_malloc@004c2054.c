...

{
  ...
  local_58 = &_gp;
  ppvVar8 = *(void ***)PTR___stack_chk_guard_006aabf0;
  addr_00 = (void **)num;
  num_00 = file;
  file_00 = (char *)line;
  pcStack_e4 = unaff_s4;
  ...
  if (((before_p & 0x7fU) == 1) && (addr != (void *)0x0)) {
    ...
    if ((mh_mode & 1) != 0) {
      ...
      if ((mh_mode & 2) == 0) {
        ...
        if (unaff_s1 == (void **)0x0) goto LAB_004c20cc;
      }
      else {
        CRYPTO_lock(6,0x14,"mem_dbg.c",299);
      }
      CRYPTO_mem_ctrl_constprop_5();
      unaff_s1 = (void **)CRYPTO_malloc(0x24,"mem_dbg.c",0x1f2);
      if (unaff_s1 == (void **)0x0) {
        ...
        if ((mh == 0) &&
          ...
          *unaff_s1 = addr;
          ...
          unaff_s1[1] = (void *)num;
          uVar2 = options;
          local_4c = &_ITM_registerTMCloneTable;
          if ((options & 2) == 0) {
          ...
          if ((uVar2 & 1) == 0) {
            ...
            order = (void *)((int)order + 1);
            pvVar3 = (void *)(**(code **)(local_58 + -0x52fc))(0);
            unaff_s1[7] = pvVar3;
          }
          addr = local_50;
...
LAB_004c20cc:
  ...
  if (((addr_00 == (void **)0x0) && (ppvStack_f0 = ppvVar8, ppvVar8 != (void **)0x0)) &&
     (pCStack_ec = (CRYPTO_THREADID *)&_ITM_registerTMCloneTable, (mh_mode & 1) != 0)) {
    ...
    if ((mh_mode & 2) == 0) {
      ...
      CRYPTO_lock(6,0x14,"mem_dbg.c",299);
      if (pcStack_e4 == (char *)0x0) goto LAB_004c24ac;
    }
    else {
      file_00 = (char *)0x12b;
      num_00 = "mem_dbg.c";
    ...
    pcStack_e4 = &_ITM_registerTMCloneTable;
    if (mh != 0) {
      CRYPTO_mem_ctrl_constprop_5();
      aCStack_b0[0].ptr = ppvVar8;
      pvVar3 = (void *)(**(code **)(puStack_c0 + -0x6a34))(mh,pCStack_e0);
      if (pvVar3 != (void *)0x0) {
...
LAB_004c24ac:
  ...
  puStackY_158 = PTR___stack_chk_guard_006aabf0;
  ppvStack_fc = *(void ***)PTR___stack_chk_guard_006aabf0;
  ppvVar8 = ppvStack_fc;
  ...
  if ((iStack_bc == 1) && (ppvStackY_154 = addr_00, addr_00 != (void **)0x0)) {
    ...
    if (ppvStackY_150 == (void **)0x0) {
      ...
      pcStackY_14c = &_ITM_registerTMCloneTable;
      if ((mh_mode & 1) != 0) {
        ...
        puVar4 = (undefined4 *)(*(code *)PTR_lh_delete_006a94ac)(mh,aCStack_120);
        iVar5 = mh;
...
LAB_004c27cc:
  ...
  iStackY_15c = *(int *)PTR___stack_chk_guard_006aabf0;
  if ((mh != 0) || (amih != 0)) {
    CRYPTO_mem_ctrl_constprop_5();
    uStackY_160 = 0;
    iStackY_164 = 0;
    ...
    if ((mh == 0) ||
       ((*(code *)PTR_lh_doall_arg_006a94bc)(mh,print_leak_LHASH_DOALL_ARG,&ppvStackY_168),
       iStackY_164 == 0)) {
      ...
      if ((amih != 0) && (iVar5 = (*(code *)PTR_lh_num_items_006a9450)(), iVar5 == 0)) {
      ...
      (*(code *)PTR_BIO_printf_006a7f38)(ppvVar8,"%ld bytes leaked in %d chunks\n",uStackY_160);
    }
    CRYPTO_lock(9,0x14,"mem_dbg.c",0xdc);
    if ((((mh_mode & 1) != 0) && (iVar5 = num_disable + -1, num_disable != 0)) &&
       (num_disable = iVar5, iVar5 == 0)) {
  ...
  if (iStackY_15c != *(int *)puVar1) {
    ...
    if (mh != 0) {
      ...
      bio = (bio_st *)(*(code *)PTR_BIO_new_006a7fa4)(uVar6);
      CRYPTO_lock(9,0x14,"mem_dbg.c",0xdc);
      if ((((mh_mode & 1) == 0) || (iVar5 = num_disable + -1, num_disable == 0)) ||
         (num_disable = iVar5, iVar5 != 0)) {
        CRYPTO_lock(10,0x14,"mem_dbg.c",0x11a);
      ...
      if (bio != (bio_st *)0x0) {
        (*(code *)PTR_BIO_ctrl_006a7f18)(bio,0x6a,0,ppvVar8);
