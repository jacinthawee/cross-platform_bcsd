...

{
  ...
  uVar29 = param_4;
  iVar20 = (*(code *)PTR_CRYPTO_malloc_006a8108)(param_3,&DAT_00647bcc,0x471);
  if (iVar20 == 0) {
    uVar36 = 0;
    ...
    iVar37 = param_5 + 0x40;
    if (param_8 == 0) {
      iVar21 = (*(code *)PTR_CRYPTO_malloc_006a8108)(iVar37,&DAT_00647bcc,0x47f);
      iVar38 = iVar37;
    }
    else {
      iVar38 = param_7 + 2 + iVar37;
      iVar21 = (*(code *)PTR_CRYPTO_malloc_006a8108)(iVar38,&DAT_00647bcc,0x47f);
    }
    if (iVar21 == 0) {
      (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x13a,0x41,&DAT_00647bcc,0x4b5);
      (*(code *)PTR_CRYPTO_free_006a7f88)(iVar20);
      return 0;
    }
    uVar27 = param_5;
    (*(code *)PTR_memcpy_006aabf4)(iVar21);
    ...
    if (param_8 != 0) {
      ...
      *(undefined *)((int)puVar23 + 0x41) = (undefined)param_7;
      if ((param_7 != 0) || (param_6 != 0)) {
        (*(code *)PTR_memcpy_006aabf4)(iVar21 + param_5 + 0x42,param_6,param_7);
      }
    }
    iVar37 = (*(code *)PTR_memcmp_006aabd8)(iVar21,"client finished",0xf);
    if ((((iVar37 == 0) ||
         (iVar37 = (*(code *)PTR_memcmp_006aabd8)(iVar21,"server finished",0xf), iVar37 == 0)) ||
        (iVar37 = (*(code *)PTR_memcmp_006aabd8)(iVar21,"master secret",0xd), iVar37 == 0)) ||
       (iVar37 = (*(code *)PTR_memcmp_006aabd8)(iVar21,"key expansion",0xd), iVar37 == 0)) {
      uVar36 = 0;
      (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x13a,0x16f,&DAT_00647bcc,0x4b1);
    }
    else {
      uVar36 = tls1_PRF_constprop_1
                         (*(undefined4 *)(*(int *)(*(int *)(param_1 + 0x58) + 0x344) + 0x24),iVar21,
                          iVar38,0,0,0,0,0,0,*(int *)(param_1 + 0xc0) + 0x14,
