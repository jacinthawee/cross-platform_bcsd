...

{
  ...
  if ((pAStack_74 == (ASN1_ITEM *)0x0) || (unaff_s1 = pAStack_7c, pAStack_7c == (ASN1_ITEM *)0x0)) {
    ...
    pAStack_7c = unaff_s1;
LAB_006090b0:
    pcStack_cc = s_a_sign_c_0067a014;
...
LAB_00608da4:
      ...
      pAStack_7c = (ASN1_ITEM *)
                   (*(code *)local_40[-0xfbb].algorithm)(pAStack_74,s_a_sign_c_0067a014,0x12e);
...
LAB_00608edc:
  ...
  pEVar4 = (EVP_MD_CTX *)(**(code **)(puStack_f8 + -0x7dd8))(pcStack_11c,s_a_digest_c_0067a020,0x52)
  ;
  if (pEVar4 == (EVP_MD_CTX *)0x0) {
    pcStack_170 = s_a_digest_c_0067a020;
