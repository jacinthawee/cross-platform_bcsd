...
LAB_004b675c:
      ...
      if (iVar1 < 0x11a1) {
        ...
        if (iVar1 < 0x11e1) {
          if (iVar1 == 0x11c0) goto LAB_004b6768;
          if (iVar1 < 0x11c1) {
            if (iVar1 == 0x11b0) goto LAB_004b645c;
            if (iVar1 == 0x11b1) goto LAB_004b65dc;
            if (iVar1 == 0x11a1) goto LAB_004b630c;
          }
          else {
            if (iVar1 == 0x11d0) goto LAB_004b65a0;
            if (iVar1 == 0x11d1) goto LAB_004b6594;
            if (iVar1 == 0x11c1) goto LAB_004b6348;
          }
        }
        else {
          if (iVar1 == 0x1220) {
      ...
      if (iVar1 < 0x2072) {
        ...
        if (iVar1 < 0x2112) {
          ...
          if (iVar1 < 0x2081) {
            ...
            if (iVar1 == 0x2100) goto LAB_004b64c8;
            if (iVar1 == 0x2110) {
...
LAB_004b6768:
      ...
      if (iVar1 < 0x21b1) {
        ...
        if (iVar1 < 0x21f1) {
          if (iVar1 == 0x21d0) goto LAB_004b675c;
          if (iVar1 < 0x21d1) {
            if (iVar1 == 0x21c0) {
LAB_004b65a0:
