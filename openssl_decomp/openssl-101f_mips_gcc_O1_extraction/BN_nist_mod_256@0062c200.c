...

{
  ...
  if (uStack_ac == 0) {
    ...
    unaff_s4 = (BIGNUM *)a->d;
    iVar4 = (*(code *)PTR_BN_ucmp_006a9678)(a,_bignum_nist_p_256_sqr_6183);
    if (-1 < iVar4) goto LAB_0062c278;
    iVar4 = (*(code *)PTR_BN_ucmp_006a9678)(_bignum_nist_p_256);
    if (iVar4 == 0) {
      pBStack_158 = (BIGNUM *)0x0;
      uStack_ac = 1;
      (*(code *)PTR_BN_set_word_006a8820)(r);
    }
    else if (iVar4 < 1) {
      pBVar10 = unaff_s4;
      if (a != r) {
        if (r->dmax < 8) {
          ...
          iVar4 = (*(code *)PTR_bn_expand2_006a9680)(r);
          a = unaff_s4;
          if (iVar4 == 0) goto LAB_0062c298;
          puVar21 = unaff_s4->d;
        }
        else {
          puVar21 = unaff_s4->d;
...
LAB_0062c3a8:
        ...
        (*(code *)PTR_memset_006aab00)(ppiVar5 + (int)piVar20,0,iVar4);
      }
      else {
        piVar20 = &unaff_s5[-1].neg;
        ppiVar5 = (int **)(*(code *)PTR_memcpy_006aabf4)
                                    (&local_64,&unaff_s4[1].neg,(int)unaff_s5 * 4 + -0x20);
        bVar1 = (int)piVar20 < 8;
        if (bVar1) goto LAB_0062c3a8;
      }
      pcVar16 = (code *)PTR_bn_sub_words_006a96a4;
      puVar18 = pBVar10->d;
      ...
      if (((int)uVar17 < 0) || (uVar17 == 0)) {
        if (((int)uVar17 >> 0x1f | uVar17) == 0) {
          ...
          iVar4 = (*(code *)PTR_bn_add_words_006a96a8)
                            (pBVar10,pBVar10,_nist_p_256 + ~uVar17 * 0x20,8);
          unaff_s5 = (BIGNUM *)-iVar4;
          pcVar16 = (code *)(((uint)pcVar16 ^ (uint)PTR_bn_add_words_006a96a8) & (uint)unaff_s5 ^
                            (uint)PTR_bn_add_words_006a96a8);
        }
      }
      else {
        iVar4 = (*(code *)PTR_bn_sub_words_006a96a4)
      ...
      pBStack_158 = a;
      iVar4 = (*(code *)PTR_BN_copy_006a9570)(r);
      uStack_ac = (uint)(iVar4 != 0);
    }
  }
  else {
LAB_0062c278:
    uStack_ac = (*(code *)PTR_BN_nnmod_006a9664)(r,a,_bignum_nist_p_256);
  }
LAB_0062c298:
  ...
  puStack_128 = &_gp;
  pBStack_b4 = *(BIGNUM **)PTR___stack_chk_guard_006aabf0;
  ...
  if (uStack_154 == 0) {
    ...
    pBStack_11c = ctx;
    iVar4 = (*(code *)PTR_BN_ucmp_006a9678)(pBStack_158,_bignum_nist_p_384_sqr_6214);
    if (-1 < iVar4) goto LAB_0062c9e0;
    iVar4 = (**(code **)(puStack_128 + -0x6868))(_bignum_nist_p_384);
    if (iVar4 == 0) {
      pBVar10 = (BIGNUM *)0x0;
      uStack_154 = 1;
      (**(code **)(puStack_128 + -0x76c0))(pBStack_15c);
    }
    else if (iVar4 < 1) {
      ...
      if (pBStack_158 != pBStack_15c) {
        if (pBStack_15c->dmax < 0xc) {
          ...
          iVar4 = (**(code **)(puStack_128 + -0x6860))(pBStack_15c);
          if (iVar4 == 0) goto LAB_0062ca00;
...
LAB_0062cb38:
        ...
        (**(code **)(puStack_128 + -0x53e0))(puVar6 + (int)piVar20,0,iVar4);
      }
      else {
        piVar20 = &pBStack_150[-1].dmax;
        puVar6 = (uint *)(**(code **)(puStack_128 + -0x52ec))
      ...
      pcVar16 = *(code **)(puStack_128 + -0x683c);
      ...
      if (((int)uVar17 < 0) || (uVar17 == 0)) {
        if (((int)uVar17 >> 0x1f | uVar17) == 0) {
          ...
          iVar4 = (**(code **)(puStack_128 + -0x6838))
                            (pBStack_158,pBStack_158,_nist_p_384 + ~uVar17 * 0x30,0xc);
          pBStack_14c = (BIGNUM *)-iVar4;
          pcVar16 = (code *)(((uint)pcVar16 ^ *(uint *)(puStack_128 + -0x6838)) & (uint)pBStack_14c
                            ^ *(uint *)(puStack_128 + -0x6838));
        }
      }
      else {
        iVar4 = (**(code **)(puStack_128 + -0x683c))
      ...
      pBVar10 = pBStack_158;
      iVar4 = (**(code **)(puStack_128 + -0x6970))(pBStack_15c);
      uStack_154 = (uint)(iVar4 != 0);
    }
  }
  else {
LAB_0062c9e0:
    uStack_154 = (**(code **)(puStack_128 + -0x687c))(pBStack_15c,pBStack_158,_bignum_nist_p_384);
  }
LAB_0062ca00:
  ...
  if (uVar17 == 0) {
    iVar23 = pBVar10->top;
    puVar21 = pBVar10->d;
    iVar4 = (*(code *)PTR_BN_ucmp_006a9678)(pBVar10,_bignum_nist_p_521_sqr_6238);
    if (iVar4 < 0) {
      iVar4 = (*(code *)PTR_BN_ucmp_006a9678)(_bignum_nist_p_521,pBVar10);
      if (iVar4 == 0) {
        uVar17 = 1;
        (*(code *)PTR_BN_set_word_006a8820)(pBVar9,0);
        goto LAB_0062d320;
      }
      if (0 < iVar4) {
        if (pBVar10 == pBVar9) {
          ...
          iVar4 = (*(code *)PTR_BN_copy_006a9570)(pBVar9,pBVar10);
          uVar17 = (uint)(iVar4 != 0);
        }
        goto LAB_0062d320;
      }
      ...
      if (pBVar10 != pBVar9) {
        if (pBVar9->dmax < 0x11) {
          iVar4 = (*(code *)PTR_bn_expand2_006a9680)(pBVar9,0x11);
...
LAB_0062d488:
        ...
        (*(code *)PTR_memset_006aab00)(auStack_1a8 + iVar23,0,iVar4);
      }
      else {
        puVar25 = auStack_1a8;
        do {
      ...
      iVar4 = (*(code *)PTR_bn_sub_words_006a96a4)(auStack_1a8,puVar15,_nist_p_521,0x11);
  ...
  uVar17 = (*(code *)PTR_BN_nnmod_006a9664)(pBVar9,pBVar10,_bignum_nist_p_521);
LAB_0062d320:
  while( true ) {
