...
LAB_00553580:
    ...
    if ((int)(flags << 8) < 0) {
      ...
      local_b4 = 3;
      local_ac = &DAT_0066a094;
    }
    else {
      local_b0 = (undefined *)0x1;
      local_b4 = 1;
      local_ac = &DAT_00669e38;
    }
...
LAB_00550958:
    if (a == (ASN1_TYPE *)0x0) {
      ...
      iVar14 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a078,1);
...
LAB_00550d58:
  ...
  if (cStack_13d == '\0') {
    ...
    iVar14 = iStack_168;
    if (a == (ASN1_TYPE *)0x0) goto LAB_00550988;
    iVar14 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0067a4e0,1);
    if (iVar14 != 1) goto LAB_00550980;
  }
  psVar16 = (stack_st_X509_NAME_ENTRY *)(_Var10.object)->sn;
      ...
      if (0 < iVar14) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar23 & 8) == 0) {
              iVar14 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a068,1);
              if (iVar14 != 1) goto LAB_00550980;
...
LAB_00550f78:
          if ((uVar23 & 6) == 0) {
            ...
            iVar14 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0066a074,2);
...
LAB_00550f3c:
  ...
  iVar5 = (*(code *)PTR_BIO_write_006a7f14)(a,&DAT_0067a4e0,1);
