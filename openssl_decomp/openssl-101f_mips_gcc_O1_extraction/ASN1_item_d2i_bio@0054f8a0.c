...

{
  ...
  local_1c = (uchar *)0x0;
  local_14 = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  ...
  pcStack_5c = *(code **)PTR___stack_chk_guard_006aabf0;
  pvStack_54 = x;
  pAStack_50 = it;
  uVar5 = (*(code *)PTR_BIO_s_file_006a7fa0)();
  puVar6 = (undefined *)(*(code *)PTR_BIO_new_006a7fa4)(uVar5);
  if (puVar6 == (undefined *)0x0) {
    ...
    iStack_dc = 0;
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar6,0x6a,0,ppuStack_a4);
    in_00 = &puStack_64;
    ...
    (*(code *)PTR_BIO_free_006a7f70)(puVar6);
    puStack_a8 = puVar6;
    ppuStack_a4 = ppuVar8;
  }
  ...
  pcStack_ac = *(code **)PTR___stack_chk_guard_006aabf0;
  ...
  if (puVar6 == (undefined *)0x0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar6,0x6a,0,in_00);
    iVar9 = (*pcStack_ec)(iStack_dc,0);
    unaff_s6 = "7 datafinal";
    ppAStack_e4 = (ASN1_VALUE **)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar9,"a_i2d_fp.c",0x5b);
    if (ppAStack_e4 == (ASN1_VALUE **)0x0) {
      ...
      while( true ) {
        ...
        iVar7 = iVar9;
        iVar10 = (*(code *)PTR_BIO_write_006a7f14)(puVar6,pcStack_124,iVar9);
      ...
      pvStack_f0 = (void *)0x1;
LAB_0054fbe4:
      (*(code *)PTR_CRYPTO_free_006a7f88)(ppAStack_e4);
    }
    (*(code *)PTR_BIO_free_006a7f70)(puVar6);
    puStack_164 = puVar6;
  }
  ...
  pAStack_f4 = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  puStack_e8 = puStack_164;
  pcStack_d8 = unaff_s6;
  pAStack_130 = (ASN1_VALUE *)(*pcStack_12c)(iVar7,0);
  puVar6 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(pAStack_130,"a_i2d_fp.c",0x5b);
  if (puVar6 == (undefined *)0x0) {
    ...
    while( true ) {
      ...
      pAVar4 = pAStack_130;
      pAVar11 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(pcStack_124,puVar15);
...
LAB_0054fd84:
  ...
  pAStack_134 = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  ...
  if (puVar6 == (undefined *)0x0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar6,0x6a,0,puVar15);
    ...
    if (puStack_138 == (uchar *)0x0) {
      ...
      while( true ) {
        ...
        pAVar4 = pAVar11;
        pAVar12 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(puVar6);
...
LAB_0054fef0:
      (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_138);
    }
    (*(code *)PTR_BIO_free_006a7f70)(puVar6);
    puStack_164 = puVar6;
  }
  ...
  piStack_174 = *(int **)PTR___stack_chk_guard_006aabf0;
  ...
  if (puStack_178 == (uchar *)0x0) {
    ...
    while( true ) {
      ...
      iVar9 = (*(code *)PTR_BIO_write_006a7f14)(puStack_1a4,puVar16,iVar7);
    ...
    pvVar17 = (void *)0x1;
LAB_00550050:
    (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_178);
    pvStack_1ac = pvVar17;
  }
  ...
  if (*piVar13 < 5) {
    ...
    puVar15 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(5,"a_enum.c",0x51);
...
LAB_005501c8:
        ...
        iVar7 = 0;
        if (puVar16 != (uchar *)0x0) goto LAB_0055018c;
      }
LAB_005501f0:
      pvVar17 = (void *)0x1;
      *piVar13 = iVar7;
