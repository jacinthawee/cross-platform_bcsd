...

{
  ...
  (*(code *)PTR_memset_006aab00)(&local_94,0,0x70);
  local_84 = 0x510e527f;
  local_80 = 0x9b05688c;
  local_94 = 0x6a09e667;
  local_90 = 0xbb67ae85;
...
LAB_004cc610:
  ...
  do {
    puVar6 = local_6c;
    (*(code *)PTR_memset_006aab00)(puVar5,0,iVar10);
    ...
    local_2c = 0;
    (*(code *)PTR_memset_006aab00)(puVar6,0,0x40);
...
LAB_004cc93c:
    local_2c = n;
    (*(code *)PTR___memcpy_chk_006aab54)(local_6c,d,n,0x48);
    puVar6 = local_6c + local_2c;
LAB_004cc96c:
    puVar5 = local_6c;
    uVar2 = local_2c + 1;
    *puVar6 = 0x80;
    if (uVar2 < 0x39) goto LAB_004cc610;
    (*(code *)PTR_memset_006aab00)(puVar5 + uVar2,0,0x40 - uVar2);
