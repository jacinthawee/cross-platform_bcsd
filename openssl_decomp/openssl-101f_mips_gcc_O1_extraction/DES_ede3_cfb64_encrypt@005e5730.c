  ...
  if (length < 0x41) {
    ...
    if (iStack_38 == 0) {
      if (pDVar27 <= pDVar15) {
        ...
        ppDStack_c4 = (DES_key_schedule **)(&PTR_LAB_00675524 + (int)pDVar27);
        puStack_c0 = &UNK_0067556c + (int)pDVar27 * 4;
      ...
      pDStack_100 = (DES_key_schedule *)(&DAT_00675500 + (int)pDVar27 * 4);
      puStack_c0 = &UNK_00675548 + (int)pDVar27 * 4;
  ...
  if ((undefined *)((int)pDVar30[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_d8 == 0) {
      ...
      if (pDStack_1fc <= pDVar15) {
        ppcStack_14c = (code **)(&PTR_LAB_006755b4 + (int)pDStack_1fc);
        ...
        pDStack_1f8 = (DES_key_schedule *)(&PTR_LAB_006755d8 + (int)pDStack_1fc);
      ...
      pDStack_18c = (DES_key_schedule *)(&switchD_005e64e8::switchdataD_00675590 + (int)pDStack_1fc)
      ;
      pDStack_1f8 = (DES_key_schedule *)(&PTR_LAB_006755fc + (int)pDStack_1fc);
