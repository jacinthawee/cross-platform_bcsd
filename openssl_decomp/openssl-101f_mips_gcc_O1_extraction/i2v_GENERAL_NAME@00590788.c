...

{
  ...
  local_24 = *(X509V3_EXT_METHOD **)PTR___stack_chk_guard_006aabf0;
  value = (char *)gen;
  psVar4 = ret;
  local_134._0_4_ = ret;
  switch(gen->type) {
  ...
  case 7:
    ...
    if (psVar5 == (stack_st_X509_NAME_ENTRY *)0x4) {
      ...
      puVar8 = local_134 + 8;
      (*(code *)PTR_BIO_snprintf_006a8060)(puVar8,5,&DAT_0066ecd4,*(undefined2 *)&pBVar9->length);
      puVar7 = (undefined2 *)((int)&pBVar9->length + 2);
      (*(code *)PTR___strcat_chk_006aac2c)(local_124,puVar8,0x100);
      do {
        (*(code *)PTR___strcat_chk_006aac2c)(local_124,":",0x100);
        uVar1 = *puVar7;
        puVar7 = puVar7 + 1;
        (*(code *)PTR_BIO_snprintf_006a8060)(puVar8,5,&DAT_0066ecd4,uVar1);
        (*(code *)PTR___strcat_chk_006aac2c)(local_124,puVar8,0x100);
  ...
  case 8:
    value = (char *)local_124;
    (*(code *)PTR_i2t_ASN1_OBJECT_006a9d64)(value,0x100,(gen->d).ptr);
    psVar4 = (stack_st_CONF_VALUE *)local_134;
  ...
  iVar6 = 0;
  while( true ) {
    iVar3 = (*(code *)PTR_sk_num_006a7f2c)(value);
    if (iVar3 <= iVar6) break;
    gen_00 = (GENERAL_NAME *)(*(code *)PTR_sk_value_006a7f24)(value,iVar6);
