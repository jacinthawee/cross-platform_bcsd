...

{
  ...
  if ((len != 0) &&
     (buf = (byte *)(*(code *)PTR_CRYPTO_malloc_006a8108)(len,"ec_print.c",0x95), buf != (byte *)0x0
     )) {
    sVar3 = EC_POINT_point2oct(param_1,param_2,form,buf,len,param_4);
    if (sVar3 != 0) {
      pcVar4 = (char *)(*(code *)PTR_CRYPTO_malloc_006a8108)((len + 1) * 2,"ec_print.c",0x9e);
      if (pcVar4 != (char *)0x0) {
        pcVar5 = pcVar4;
        pbVar7 = buf;
        do {
          ...
          *pcVar5 = "0123456789ABCDEF"[(int)(uint)*pbVar7 >> 4];
          pcVar5[1] = cVar1;
          puVar2 = PTR_CRYPTO_free_006a7f88;
          pcVar5 = pcVar5 + 2;
          pbVar7 = pbVar6;
