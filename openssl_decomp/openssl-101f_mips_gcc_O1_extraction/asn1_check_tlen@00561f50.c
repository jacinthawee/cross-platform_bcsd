...
LAB_00562004:
      if (-1 < (int)param_8) {
        if ((param_8 != local_3c) || (local_38 != param_9)) {
          uVar4 = 0xffffffff;
          if (iStack_7c != 0) goto LAB_0056205c;
          if (param_11 != (char *)0x0) {
            *param_11 = '\0';
          }
          ppppppcStack_e0 = (char ******)&DAT_000000a8;
          ppppppcStack_d8 = (char ******)&DAT_00000527;
          goto LAB_00562044;
        }
        if (param_11 != (char *)0x0) {
          *param_11 = '\0';
      ...
      *param_6 = (long *)local_30;
      ...
      ppppppcStack_d8 = (char ******)0x51a;
LAB_00562044:
      pcStack_dc = s_tasn_dec_c_0066ab2c;
    ...
    *param_11 = '\x01';
    ...
    goto LAB_00561ff8;
    ppppppcStack_e0 = (char ******)0x9b;
    pcStack_dc = s_tasn_dec_c_0066ab2c;
    ppppppcStack_d8 = (char ******)0x511;
    ppppppcStack_e4 = (char ******)&DAT_00000068;
    (*(code *)PTR_ERR_put_error_006a9030)(0xd);
    *param_11 = '\0';
  }
...
LAB_00561ff8:
    ...
    if ((uVar7 & 0x80) == 0) goto LAB_00562004;
    ppppppcStack_e0 = (char ******)0x66;
    pcStack_dc = s_tasn_dec_c_0066ab2c;
    ppppppcStack_d8 = (char ******)0x51a;
    ppppppcStack_e4 = (char ******)&DAT_00000068;
...
LAB_0056205c:
  ...
  piStack_94 = *(int **)PTR___stack_chk_guard_006aabf0;
  ...
  if (pcStack_48 == (char *)0x0) {
    ...
    if (*pcStack_48 == '\0') {
      ...
      *pcStack_48 = '\x01';
      ptag = pppppcVar10;
      if ((uVar4 == 0) &&
         (ptag = local_50, 0x6afee0 < (int)((int)pppppcStack_9c + (int)pppppcVar10))) {
        ptag = (char *****)0x9b;
        pclass = (char ******)0x0;
        in_stack_ffffff40 = (char *****)0x511;
        local_50 = (char *****)&DAT_00000068;
        (*(code *)PTR_ERR_put_error_006a9030)(0xd);
        *pcStack_48 = '\0';
        goto LAB_00562358;
        ...
        if ((uVar5 & 0x20) == 0) {
          if (iVar12 != 0) {
            if (piVar9 != (int *)0x0) {
              ...
              (*(code *)PTR_memcpy_006aabf4)(piVar9[1] + iVar8,ppppcStack_110,iVar12);
            }
...
LAB_005626a8:
  uVar4 = 0;
  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x6a,uVar11,s_tasn_dec_c_0066ab2c,uVar6);
LAB_00562720:
