...

{
  ...
  iVar4 = (*(code *)PTR_accept_006aab80)(sock,&local_464,&local_468);
  if (iVar4 == -1) {
    iVar4 = BIO_sock_should_retry(-1);
    if (iVar4 == 0) {
      piVar7 = (int *)(*(code *)PTR___errno_location_006aaaf4)();
      ERR_put_error(2,8,*piVar7,"b_sock.c",0x36f);
    ...
    if ((p_getnameinfo_6687 == (code *)0x0) &&
      ...
      if (iVar5 == 0) {
        iVar5 = (*(code *)PTR_strlen_006aab30)(auStack_428);
        iVar6 = (*(code *)PTR_strlen_006aab30)(auStack_448);
        puVar1 = PTR_CRYPTO_realloc_006a8c44;
        pcVar8 = *ip_port;
        n = iVar5 + iVar6 + 2;
        if (pcVar8 == (char *)0x0) {
          pcVar8 = (char *)(*(code *)PTR_CRYPTO_malloc_006a8108)(n,"b_sock.c",0x390);
        }
        else {
          *pcVar8 = '\0';
          pcVar8 = (char *)(*(code *)puVar1)(pcVar8,n,"b_sock.c",0x38f);
        }
        if (pcVar8 == (char *)0x0) {
    ...
    if (local_464._0_2_ == 2) {
      ...
      if (pcVar8 == (char *)0x0) {
        pcVar8 = (char *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x18,"b_sock.c",0x3a0);
        if (pcVar8 == (char *)0x0) {
