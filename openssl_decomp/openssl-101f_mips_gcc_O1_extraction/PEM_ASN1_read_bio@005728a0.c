...

{
  ...
  if (iVar2 == 0) {
    ...
    if (puVar3 == (undefined1 *)0x0) {
      ...
      bp = (BIO *)0x53;
      plen = (uchar **)0x67;
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x67);
    }
  ...
  puStack_70 = d2i;
  ppvStack_68 = x;
  p8inf = (PKCS8_PRIV_KEY_INFO *)(*(code *)PTR_EVP_PKEY2PKCS8_006a9fb8)(plen);
  if (p8inf == (PKCS8_PRIV_KEY_INFO *)0x0) {
    ...
    if (puVar5 == (uchar *)0x0) {
      pvVar4 = (void *)PEM_ASN1_write_bio(PTR_i2d_PKCS8_PRIV_KEY_INFO_006a9fc0,"PRIVATE KEY",bp_00,
    ...
    if (cb == (undefined1 *)0x0) {
      ...
      p8 = (X509_SIG *)(*(code *)PTR_PKCS8_encrypt_006a8dac)(name,bp,acStack_474,iVar2,0,0,0,p8inf);
      (*(code *)PTR_OPENSSL_cleanse_006a8174)(acStack_474,iVar2);
    }
    else {
      p8 = (X509_SIG *)(*(code *)PTR_PKCS8_encrypt_006a8dac)(name,bp,cb,u,0,0,0,p8inf);
    }
    PKCS8_PRIV_KEY_INFO_free(p8inf);
    if (puVar5 == (uchar *)0x0) {
      pvVar4 = (void *)PEM_ASN1_write_bio(PTR_i2d_X509_SIG_006a9858,"ENCRYPTED PRIVATE KEY",bp_00,p8
                                          ,(EVP_CIPHER *)0x0,(uchar *)0x0,0,(undefined1 *)0x0,
                                          (void *)0x0);
    }
    else {
