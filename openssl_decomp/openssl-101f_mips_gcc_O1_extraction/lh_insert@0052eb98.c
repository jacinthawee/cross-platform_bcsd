    ...
    *ppLVar9 = (LHASH_NODE *)0x0;
    ...
    while (pLVar14 = *pplVar7, pLVar14 != (lhash_node_st *)0x0) {
      while( true ) {
        ...
        *ppLVar9 = pLVar14;
        pLVar14 = *pplVar7;
        if (pLVar14 == (lhash_node_st *)0x0) goto LAB_0052ed74;
      }
      pplVar7 = &pLVar14->next;
    }
LAB_0052ed74:
    if (uVar13 <= uVar11 + 1) {
      uVar5 = uVar12 * 2;
      ppLVar3 = (LHASH_NODE **)
                (*(code *)PTR_CRYPTO_realloc_006a8c44)(lh->b,uVar12 << 3,"lhash.c",0x15b);
      if (ppLVar3 == (LHASH_NODE **)0x0) {
        ...
        if (uVar11 < uVar5) {
          (*(code *)PTR_memset_006aab00)(ppLVar3 + uVar11,0,(uVar5 - uVar11) * 4);
        }
        lh->pmax = uVar11;
...
LAB_0052edf8:
      plVar4 = (lhash_node_st *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0xc,"lhash.c",0xc1);
