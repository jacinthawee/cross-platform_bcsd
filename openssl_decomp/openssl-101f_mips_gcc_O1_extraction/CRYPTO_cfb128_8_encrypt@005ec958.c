...

{
  ...
  for (uVar6 = *puStack_54; uVar6 != 0; uVar6 = uVar6 + 1 & 0xf) {
    if (param_3 == 0) {
      if ((((uint)param_2 | (uint)param_1) & 3) != 0) goto LAB_005ecc40;
      goto LAB_005ecca4;
    }
    bVar1 = *(byte *)param_1;
  ...
  if (param_3 < 0x10) {
    ...
    do {
      ...
      *puVar15 = *puVar14 ^ __gp;
      puVar15[1] = puVar14[1] ^ _DAT_006afee4;
      puVar15[2] = puVar14[2] ^ _DAT_006afee8;
      puVar15[3] = puVar14[3] ^ _DAT_006afeec;
      puVar14 = puVar14 + 4;
      puVar15 = puVar15 + 4;
    } while (0xf < uVar6);
...
LAB_005ecdac:
      uVar6 = iVar5 + 1;
      if ((uVar6 < 7 ||
           (param_2 < &DAT_006afee4 && &_gp < param_2 + 1 ||
           param_2 < param_1 + 1 && param_1 < param_2 + 1)) ||
         ((((uint)param_2 | (uint)param_1) & 3) != 0)) {
        *(byte *)param_2 = _gp ^ *(byte *)param_1;
        if (iVar5 != 0) {
          *(byte *)((int)param_2 + 1) = *(byte *)((int)param_1 + 1) ^ DAT_006afee1;
          if (iVar5 != 1) {
            *(byte *)((int)param_2 + 2) = *(byte *)((int)param_1 + 2) ^ DAT_006afee2;
            if (iVar5 != 2) {
              *(byte *)((int)param_2 + 3) = *(byte *)((int)param_1 + 3) ^ DAT_006afee3;
              if (iVar5 != 3) {
                *(byte *)(param_2 + 1) = *(byte *)(param_1 + 1) ^ DAT_006afee4;
                if (iVar5 != 4) {
                  *(byte *)((int)param_2 + 5) = *(byte *)((int)param_1 + 5) ^ DAT_006afee5;
                  if (iVar5 != 5) {
                    *(byte *)((int)param_2 + 6) = *(byte *)((int)param_1 + 6) ^ DAT_006afee6;
                    if (iVar5 != 6) {
                      *(byte *)((int)param_2 + 7) = *(byte *)((int)param_1 + 7) ^ DAT_006afee7;
                      if (iVar5 != 7) {
                        *(byte *)(param_2 + 2) = *(byte *)(param_1 + 2) ^ DAT_006afee8;
                        if (iVar5 != 8) {
                          *(byte *)((int)param_2 + 9) = *(byte *)((int)param_1 + 9) ^ DAT_006afee9;
                          if (iVar5 != 9) {
                            *(byte *)((int)param_2 + 10) =
                                 *(byte *)((int)param_1 + 10) ^ DAT_006afeea;
                            if (iVar5 != 10) {
                              *(byte *)((int)param_2 + 0xb) =
                                   *(byte *)((int)param_1 + 0xb) ^ DAT_006afeeb;
                              if (iVar5 != 0xb) {
                                *(byte *)(param_2 + 3) = *(byte *)(param_1 + 3) ^ DAT_006afeec;
                                if (iVar5 != 0xc) {
                                  *(byte *)((int)param_2 + 0xd) =
                                       *(byte *)((int)param_1 + 0xd) ^ DAT_006afeed;
                                  if (iVar5 != 0xd) {
                                    *(byte *)((int)param_2 + 0xe) =
                                         *(byte *)((int)param_1 + 0xe) ^ DAT_006afeee;
                                    *puStack_54 = uVar6;
                                    return;
                                  }
                                }
        ...
        *param_2 = __gp ^ *param_1;
        uVar9 = iVar10 * 4;
        if ((iVar10 != 1) && (param_2[1] = param_1[1] ^ _DAT_006afee4, iVar10 == 3)) {
          param_2[2] = param_1[2] ^ _DAT_006afee8;
        }
          ...
          *(byte *)(param_2 + iVar10) = *(byte *)(param_1 + iVar10) ^ (&_gp)[uVar9];
          if (iVar5 != 0) {
            *(byte *)((int)param_2 + uVar9 + 1) =
                 *(byte *)((int)param_1 + uVar9 + 1) ^ (&DAT_006afee1)[uVar9];
            if (iVar5 != 1) {
              *(byte *)((int)param_2 + uVar9 + 2) =
                   *(byte *)((int)param_1 + uVar9 + 2) ^ (&DAT_006afee2)[uVar9];
              *puStack_54 = uVar6;
              return;
            }
          }
