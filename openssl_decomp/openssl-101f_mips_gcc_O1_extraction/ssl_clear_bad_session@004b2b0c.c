  ...
  if (((uVar1 & 0x3000) == 0) && (uVar1 = SSL_state(param_1), (uVar1 & 0x4000) == 0)) {
    ...
    if (pSVar8 != (SSL_SESSION *)0x0) {
      if (pSVar8->session_id_length != 0) {
        ...
        pSVar3 = (SSL_SESSION *)
                 (*(code *)PTR_lh_retrieve_006a84b0)(*(undefined4 *)(p_Var9 + 0x10),pSVar8);
        if (pSVar8 != pSVar3) {
          CRYPTO_lock(10,0xc,"ssl_sess.c",0x2ce);
          return 1;
        }
        iVar4 = (*(code *)PTR_lh_delete_006a94ac)(*(undefined4 *)(p_Var9 + 0x10),pSVar8);
        ...
        *(undefined4 *)(iVar4 + 0x94) = 1;
        ...
        iVar6 = CRYPTO_add_lock((int *)(iVar4 + 0xa4),-1,0xe,"ssl_sess.c",0x2e4);
        if (iVar6 < 1) {
