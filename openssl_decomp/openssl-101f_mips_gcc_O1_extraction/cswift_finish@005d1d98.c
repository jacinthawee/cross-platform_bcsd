...

{
  ...
  if (cswift_dso != 0) {
    ...
    (*(code *)PTR_ERR_put_error_006a9030)(CSWIFT_lib_error_code,0x67,0x6c,"e_cswift.c",0x1c2);
    return 0;
  }
  if (CSWIFT_lib_error_code == 0) {
    CSWIFT_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006aa644)();
  }
  (*(code *)PTR_ERR_put_error_006a9030)(CSWIFT_lib_error_code,0x67,0x6a,"e_cswift.c",0x1bd);
  return 0;
}
