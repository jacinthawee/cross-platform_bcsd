...

{
  ...
  uVar6 = (*(code *)PTR_EVP_MD_CTX_md_006a85fc)(uVar16);
  uVar7 = (*(code *)PTR_EVP_MD_size_006a8f2c)(uVar6);
  if ((int)uVar7 < 0) {
    uVar7 = 0xffffffff;
  }
  else {
    ...
    *puVar15 = uVar12 & 0xff;
    ...
    local_98 = uVar7;
    if (((param_3 == 0) &&
        (uVar9 = (*(code *)PTR_EVP_CIPHER_CTX_flags_006a9230)(*(undefined4 *)(param_1 + 0x80)),
        (uVar9 & 0xf0007) == 2)) &&
       (iVar10 = ssl3_cbc_record_digest_supported(uVar16), uVar9 = local_98, iVar10 != 0)) {
      iVar10 = (*(code *)PTR___memcpy_chk_006aab54)(auStack_78,iVar17,local_98,0x4b);
      (*(code *)PTR_memcpy_006aabf4)
                (iVar10 + uVar9,"666666666666666666666666666666666666666666666666",iVar13);
      ...
      *(uint *)(iVar10 + iVar13) =
      ...
      ((uint *)(iVar10 + iVar13))[1] = uVar11;
      auStack_70[iVar13] = (char)*puVar15;
      auStack_70[iVar13 + 1] = (char)(puVar15[1] >> 8);
      auStack_70[iVar13 + 2] = (char)puVar15[1];
      ssl3_cbc_digest_record
                (uVar16,param_2,&local_98,iVar10,puVar15[4],uVar9 + puVar15[1],
                 (uVar12 >> 8) + uVar8 + uVar7,iVar17,uVar9,1);
    }
    else {
      (*(code *)PTR_EVP_MD_CTX_init_006a7f1c)(auStack_90);
      (*(code *)PTR_EVP_MD_CTX_copy_ex_006a922c)(auStack_90,uVar16);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_90,iVar17,local_98);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)
                (auStack_90,"666666666666666666666666666666666666666666666666",iVar13);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_90,pcVar14,8);
      local_99 = (undefined)*puVar15;
      (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_90,&local_99,1);
      puVar4 = PTR_EVP_DigestUpdate_006a8674;
      *param_2 = (char)(puVar15[1] >> 8);
      param_2[1] = (char)puVar15[1];
      (*(code *)puVar4)(auStack_90,param_2,2);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_90,puVar15[4],puVar15[1]);
      (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(auStack_90,param_2,0);
      (*(code *)PTR_EVP_MD_CTX_copy_ex_006a922c)(auStack_90,uVar16);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_90,iVar17,local_98);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)
                (auStack_90,
                 ...
                 ,iVar13);
      (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_90,param_2,local_98);
      (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(auStack_90,param_2,&local_94);
      local_98 = local_94;
      (*(code *)PTR_EVP_MD_CTX_cleanup_006a7f34)(auStack_90);
    }
    cVar1 = pcVar14[7];
    pcVar14[7] = cVar1 + '\x01';
    uVar7 = local_98;
