...

{
  ...
  piVar3 = (int *)(*(code *)PTR_BUF_MEM_new_006a859c)();
  if (piVar3 == (int *)0x0) {
    return 0;
  }
  iVar4 = (*(code *)PTR_strlen_006aab30)(param_4);
  iVar4 = (*(code *)PTR_BUF_MEM_grow_006a85a0)(piVar3,iVar4 + 1);
  if (iVar4 == 0) {
LAB_0059ed9c:
    (*(code *)PTR_BUF_MEM_free_006a8594)(piVar3);
    return 0;
  }
  iVar4 = 0;
  ...
  do {
    while ((uVar10 & 0x40) != 0) {
      ...
      while( true ) {
        ...
        if ((*puVar5 & 8) != 0) break;
        if (uVar7 == uVar12) goto LAB_0059ef28;
        if ((*puVar5 & 0x20) != 0) {
          cVar11 = param_4[2];
          uVar12 = (uint)cVar11;
          puVar5 = (ushort *)((int)pvVar14 + (uVar12 & 0xff) * 2);
...
LAB_0059ef28:
    ...
    if ((uVar10 & 0x400) == 0) {
      if ((uVar10 & 0x20) == 0) {
        if ((uVar10 & 8) != 0) goto LAB_0059f030;
        if (uVar7 == 0x24) {
...
LAB_0059ed74:
            ...
            *pcVar18 = '\0';
            ...
            if (uVar12 == 0) {
              ...
              if (uVar7 != uVar12) goto LAB_0059ed74;
              pcVar16 = _CONF_get_string(param_1,param_2,pcVar16);
              pcVar13 = pcVar18 + 1;
            }
LAB_0059f0c8:
            *pcVar17 = (char)uVar7;
            if (pcVar16 != (char *)0x0) {
              iVar9 = (*(code *)PTR_strlen_006aab30)(pcVar16);
          ...
          (*(code *)PTR_ERR_put_error_006a9030)(0xe,0x65,uVar15,"conf_def.c",uVar6);
          goto LAB_0059ed9c;
        }
        pcVar13 = param_4 + 1;
...
LAB_0059f030:
          *(undefined *)(piVar3[1] + iVar4) = 0;
          ...
          puVar8 = PTR_CRYPTO_free_006a7f88;
          *param_3 = piVar3[1];
          (*(code *)puVar8)(piVar3);
          return 1;
        }
...
LAB_0059ef10:
    ...
    while (param_4 = pcVar16 + 1, (uVar10 & 8) == 0) {
      if (uVar7 == uVar12) {
        ...
        param_4 = pcVar16 + 2;
        if (uVar7 != uVar12) goto LAB_0059ee60;
      }
      iVar4 = iVar4 + 1;
