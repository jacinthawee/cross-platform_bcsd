...

{
  ...
  if (param_3 == 3) {
    if (param_2 == (undefined4 *******)0x0) {
      unaff_s1 = (char **)(*(code *)PTR_BIO_new_fp_006a835c)(*(undefined4 *)PTR_stdin_006aab20);
      if (unaff_s1 != (char **)0x0) goto LAB_0045aaf8;
...
LAB_0045ac70:
    ...
    unaff_s1 = (char **)(*(code *)PTR_BIO_new_file_006a7fac)(param_2,"r");
    param_4 = param_2;
    if (unaff_s1 == (char **)0x0) goto LAB_0045ac88;
LAB_0045aaf8:
    param_4 = &local_2c;
    pcVar13 = password_callback;
    pcVar11 = (char *)0x0;
    param_6 = (code *)(**(code **)(local_38 + -0x782c))(unaff_s1);
    (**(code **)(local_38 + -0x7f70))(unaff_s1);
    unaff_s3 = (**(code **)(local_38 + -0x7e3c))();
    if (unaff_s3 == 0) {
LAB_0045ac24:
      if (param_6 != (code *)0x0) {
        (**(code **)(local_38 + -0x7d88))(param_6,*(undefined4 *)(local_38 + -0x7828));
      }
      (**(code **)(local_38 + -0x7d88))(unaff_s3,*(undefined4 *)(local_38 + -0x7f50));
      pcVar13 = (code *)0x6328f4;
...
LAB_0045abf0:
  ...
  puStack_6c = *(uint **)PTR___stack_chk_guard_006aabf0;
...
LAB_0045ad6c:
      ...
      if (iVar6 != 0) {
        ...
        if (0 < iVar8) {
          do {
            iVar8 = (*(code *)PTR_sk_value_006a7f24)(iVar7,iVar14);
