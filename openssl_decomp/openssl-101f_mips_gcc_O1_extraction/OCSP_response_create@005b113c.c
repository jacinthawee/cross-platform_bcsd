...

{
  ...
  iVar1 = (*(code *)PTR_ASN1_ENUMERATED_set_006a8148)(a->responseStatus,status);
  if (iVar1 != 0) {
    ...
    if (pOVar2 != (OCSP_RESPBYTES *)0x0) {
      pAVar3 = (ASN1_OBJECT *)(*(code *)PTR_OBJ_nid2obj_006a8240)(0x16d);
      pOVar4 = a->responseBytes;
      pOVar2->responseType = pAVar3;
      iVar1 = (*(code *)PTR_ASN1_item_pack_006a9f14)
                        (bs,PTR_OCSP_BASICRESP_it_006aa398,&pOVar4->response);
      if (iVar1 != 0) {
        return a;
      }
    }
