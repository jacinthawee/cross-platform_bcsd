...

{
  ...
  if (((*(int *)PTR_sig_app_006a95d0 == 0) ||
      ...
      puStack_64 = (undefined1 *)
                   (*(code *)PTR_sk_find_006a906c)(*(int *)PTR_sig_app_006a95d0,local_28),
      (int)puStack_64 < 0)) ||
     (pvVar4 = (void *)(*(code *)PTR_sk_value_006a7f24)(*(undefined4 *)puVar2),
     pvVar4 == (void *)0x0)) {
    piVar11 = (int *)0x1e;
    puStack_64 = sigoid_srt;
    pvVar4 = OBJ_bsearch_(local_28,sigoid_srt,0x1e,0xc,sig_cmp_BSEARCH_CMP_FN);
    iVar7 = 0;
    if (pvVar4 != (void *)0x0) goto LAB_004c7658;
  }
  else {
LAB_004c7658:
    if (pdig_nid != (int *)0x0) {
  ...
  if ((*(int *)PTR_sigx_app_006a95d4 == 0) ||
     (iVar7 = (*(code *)PTR_sk_find_006a906c)(*(int *)PTR_sigx_app_006a95d4,puStack_6c), iVar7 < 0))
  {
    piVar11 = (int *)0x1e;
    ppuVar5 = (undefined **)OBJ_bsearch_(&puStack_6c,sigoid_srt_xref,0x1e,4,sigx_cmp_BSEARCH_CMP_FN)
    ;
    iVar7 = 0;
    if (ppuVar5 == (undefined **)0x0) goto LAB_004c778c;
  }
  else {
    puStack_6c = (undefined *)(*(code *)PTR_sk_value_006a7f24)(*(undefined4 *)puVar2,iVar7);
    ppuVar5 = &puStack_6c;
  }
  iVar7 = 1;
...
LAB_004c778c:
  ...
  if (ptr != (int *)0x0) {
    ...
    *ptr = iVar7;
    ...
    iVar7 = (*(code *)PTR_sk_push_006a80a8)(*(undefined4 *)puVar3,ptr);
    if (iVar7 != 0) {
