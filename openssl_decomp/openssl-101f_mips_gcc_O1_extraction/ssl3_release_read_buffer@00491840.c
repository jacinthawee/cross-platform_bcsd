...

{
  ...
  puVar4 = *(uint **)(*(int *)(param_1 + 0x58) + 0xec);
  if (puVar4 != (uint *)0x0) {
    iVar5 = *(int *)(param_1 + 0xe4);
    uVar6 = *(uint *)(*(int *)(param_1 + 0x58) + 0xf0);
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,0xc,"s3_both.c",0x2ce);
    puVar1 = PTR_CRYPTO_lock_006a926c;
    puVar2 = *(uint **)(iVar5 + 0x160);
    if (((puVar2 == (uint *)0x0) ||
        (((uVar6 != *puVar2 && (*puVar2 != 0)) ||
         (uVar3 = puVar2[1], *(uint *)(iVar5 + 0x158) <= uVar3)))) || (uVar6 < 4)) {
      (*(code *)PTR_CRYPTO_lock_006a926c)(10,0xc,"s3_both.c",0x2dd);
