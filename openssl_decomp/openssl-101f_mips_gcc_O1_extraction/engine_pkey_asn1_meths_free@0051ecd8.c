    ...
    if (0 < (int)unaff_s2) {
      ...
      do {
        while( true ) {
          ...
          unaff_s0 = unaff_s0 + 1;
          piVar6 = local_24;
          (*(code *)PTR_EVP_PKEY_asn1_free_006a998c)();
          if (unaff_s2 == unaff_s0) goto LAB_0051ed90;
        }
        unaff_s0 = unaff_s0 + 1;
...
LAB_0051ed90:
  ...
  if (pcStack_a0 != (code *)0x0) {
    ...
    if (param_3 == (int *)0xffffffff) {
      piStack_9c = (int *)(*(code *)PTR_strlen_006aab30)(param_2);
    }
    param_3 = &iStack_74;
    ppiStack_ac = (int **)0x0;
    ...
    if (0 < (int)unaff_s2) {
      ...
      do {
        ...
        piVar4 = piStack_70;
        iVar3 = piStack_70[3];
        piVar5 = (int *)(**(code **)(puStack_80 + -0x53b0))(iVar3);
        if ((piStack_9c == piVar5) &&
           (ppiStack_ac = param_2, param_3 = piStack_9c,
           iVar3 = (**(code **)(puStack_80 + -0x5400))(iVar3), iVar3 == 0)) break;
...
LAB_0051eed0:
  ...
  (*(code *)PTR_engine_table_doall_006a9990)(pkey_asn1_meth_table,look_str_cb,&iStack_b4);
  if (iStack_b4 != 0) {
