...

{
  ...
  do {
    ...
    ppGVar4 = (GENERAL_NAME **)(*(code *)PTR_sk_value_006a7f24)(param_1,iVar2);
    (*(code *)PTR_BIO_printf_006a7f38)(param_2,&DAT_0066dfa4,param_3 + 2,"");
    gen = *ppGVar4;
    if (gen->type == 7) {
      psVar6 = ((gen->d).directoryName)->entries;
      pBVar5 = ((gen->d).directoryName)->bytes;
      (*(code *)PTR_BIO_puts_006a8058)(param_2,&DAT_0066f5a0);
      if (psVar6 == (stack_st_X509_NAME_ENTRY *)0x8) {
        ...
        while( true ) {
          while( true ) {
            ...
            (*(code *)PTR_BIO_printf_006a7f38)(param_2,&DAT_0066ecd4,*(undefined2 *)psVar1);
            if (iVar3 != 7) break;
            iVar3 = 8;
            iVar7 = iVar7 + 1;
            (*(code *)PTR_BIO_puts_006a8058)(param_2,&DAT_0063ba98);
          }
          if (iVar3 == 0xf) break;
        ...
        (*(code *)PTR_BIO_printf_006a7f38)(param_2,"IP Address:<invalid>");
      }
    }
    else {
