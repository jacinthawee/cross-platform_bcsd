...

{
  ...
  if (iVar2 == 1) {
    ...
    if (iVar2 == 0) {
      ...
      (*(code *)PTR_CRYPTO_lock_006a926c)(9,0xb,"x509_lu.c",0x291);
      iVar2 = x509_object_idx_cnt_constprop_1(ctx->ctx->objs,1,name);
      if (iVar2 != -1) {
        while ((iVar3 = (*(code *)PTR_sk_num_006a7f2c)(ctx->ctx->objs), iVar2 < iVar3 &&
               (piVar4 = (int *)(*(code *)PTR_sk_value_006a7f24)(ctx->ctx->objs,iVar2), *piVar4 == 1
               ))) {
          ...
          if (iVar3 != 0) {
            ...
            *issuer = (X509 *)piVar4[1];
            if (iVar2 == 1) {
              iVar3 = 1;
              (*(code *)PTR_CRYPTO_add_lock_006a9080)(piVar4[1] + 0x10,1,3,"x509_lu.c",0x195);
            }
            else if (iVar2 == 2) {
              iVar3 = 1;
              (*(code *)PTR_CRYPTO_add_lock_006a9080)(piVar4[1] + 0xc,1,6,"x509_lu.c",0x198);
            }
            else {
              iVar3 = 1;
            }
...
LAB_00584bb4:
      ...
      (*(code *)PTR_CRYPTO_lock_006a926c)(10,0xb,"x509_lu.c",0x2a7);
    }
    else {
      iVar3 = 1;
    ...
    flags = (X509 *)0x92;
    (*(code *)PTR_ERR_put_error_006a9030)(0xb,0x92,0x6a,"x509_lu.c",0x27c);
    iVar3 = -1;
  }
  else {
    iVar3 = 0;
