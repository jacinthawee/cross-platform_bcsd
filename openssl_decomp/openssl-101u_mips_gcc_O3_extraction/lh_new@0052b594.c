...

{
  ...
  p_Var2 = (_LHASH *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x60,"lhash.c",0x78);
  if (p_Var2 == (_LHASH *)0x0) {
    p_Var2 = (_LHASH *)0x0;
  }
  else {
    ppLVar3 = (LHASH_NODE **)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x40,"lhash.c",0x7a);
    p_Var2->b = ppLVar3;
