...
LAB_004d2958:
    ...
    uVar7 = uVar10 & 0xff;
    c->data[uVar3] = (byte)((int)uVar7 >> uVar9) | c->data[uVar3];
    if (uVar6 == 0x200) goto LAB_004d2a98;
  }
  else {
    if (bits == 0) {
      return;
...
LAB_004d2b00:
      ...
      do {
        ...
        if (bits < uVar3) {
          uVar6 = uVar6 + bits;
          (*(code *)PTR_memcpy_006a9aec)(puVar8 + uVar10,inp,bits >> 3);
          bits = 0;
          c->bitoff = uVar6;
        }
        else {
          bits = bits - uVar3;
          (*(code *)PTR_memcpy_006a9aec)(puVar8 + uVar10,inp,uVar3 >> 3);
          uVar6 = 0;
    ...
    if (uVar6 != 0x200) goto LAB_004d2a40;
LAB_004d2a98:
    whirlpool_block(c,c->data,1);
    uVar6 = 0;
    if (uVar9 == 0) goto LAB_004d2a40;
    iVar5 = 0;
    uVar7 = uVar10 & 0xff;
  }
  c->data[iVar5] = (uchar)(uVar7 << (8 - uVar9 & 0x1f));
