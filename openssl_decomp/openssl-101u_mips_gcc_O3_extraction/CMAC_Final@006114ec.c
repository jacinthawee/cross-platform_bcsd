  ...
  if (out != (uchar *)0x0) {
    ...
    if (uVar1 == uVar2) {
      ...
      if (1 < (int)(uVar1 - uVar2)) {
        (*(code *)PTR_memset_006a99f4)(ctx + uVar2 + 0xed,0,(uVar1 - uVar2) + -1);
      }
      if (0 < (int)uVar1) {
    ...
    iVar3 = (*(code *)PTR_EVP_Cipher_006a80f4)(ctx,out,out,uVar1);
    if (iVar3 == 0) {
      (*(code *)PTR_OPENSSL_cleanse_006a7074)(out,uVar1);
      return 0;
    }
  }
  return 1;
