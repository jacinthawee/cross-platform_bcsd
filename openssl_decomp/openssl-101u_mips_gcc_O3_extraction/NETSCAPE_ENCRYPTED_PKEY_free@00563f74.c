...

{
  ...
  if (uVar3 != 0) {
    ...
    if (NETSCAPE_ENCRYPTED_PKEY_it._16_4_ != (ASN1_ITEM_EXP *)0x0) goto LAB_0055c390;
    switch(uVar3 & 0xff) {
    default:
...
joined_r0x0055c87c:
      ...
      case 6:
        ...
        ;
        if (0 < NETSCAPE_ENCRYPTED_PKEY_it._12_4_) goto LAB_0055c5f4;
        break;
      case 2:
        param_1 = (ASN1_ITEM_EXP *)&SUB_00000002;
        pAVar6 = (ASN1_ITEM_EXP *)&pAStack_34;
        ...
        iVar5 = asn1_get_choice_selector
                          ((ASN1_VALUE **)(ASN1_ITEM_EXP *)&pAStack_34,
                           (ASN1_ITEM *)NETSCAPE_ENCRYPTED_PKEY_it);
        if ((-1 < iVar5) && (iVar5 < NETSCAPE_ENCRYPTED_PKEY_it._12_4_)) goto LAB_0055c738;
        break;
      case 3:
