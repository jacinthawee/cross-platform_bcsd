...

{
  ...
  if (iVar1 == 0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0xb,0x6c,0x6d,"x509_v3.c",0xc2);
  }
  else {
    if (((ex == (X509_EXTENSION **)0x0) || (a = *ex, a == (X509_EXTENSION *)0x0)) &&
       (a = X509_EXTENSION_new(), a == (X509_EXTENSION *)0x0)) {
      (*(code *)PTR_ERR_put_error_006a7f34)(0xb,0x6d,0x41,"x509_v3.c",0xd4);
    }
    else {
      (*(code *)PTR_ASN1_OBJECT_free_006a7004)(a->object);
