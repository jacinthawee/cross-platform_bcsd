...

{
  ...
  if ((param_1 != (uint *)0x0) &&
    ...
    ptr = (int *)(*(code *)PTR_lh_delete_006a8390)(names_lh,local_24);
    if (ptr != (int *)0x0) {
      if ((name_funcs_stack != 0) && (iVar2 = (*(code *)PTR_sk_num_006a6e2c)(), *ptr < iVar2)) {
        iVar2 = (*(code *)PTR_sk_value_006a6e24)(name_funcs_stack);
