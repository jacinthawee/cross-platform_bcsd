...

{
  ...
  case 0:
    ...
    break;
  default:
    (*(code *)PTR_BIO_snprintf_006a6f60)(buf_12410,100,"error number %ld",n,&_gp);
    puVar1 = buf_12410;
    break;
  case 2:
  ...
  case 0x36:
    ...
    break;
  case 0x41:
    puVar1 = "Invalid certificate verification context";
    break;
  case 0x42:
    puVar1 = "Issuer certificate lookup error";
    break;
  case 0x43:
    puVar1 = "proxy subject name violation";
  }
  return puVar1;
}
