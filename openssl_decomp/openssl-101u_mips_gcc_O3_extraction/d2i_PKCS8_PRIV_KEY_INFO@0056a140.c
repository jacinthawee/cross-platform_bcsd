...

{
  ...
  if (PKCS8_PRIV_KEY_INFO_it._16_4_ == 0) {
    if (uVar2 < 7) {
      ...
      pPVar3 = (PKCS8_PRIV_KEY_INFO *)(*(code *)(&switchD_005619f8::switchdataD_0066a17c)[uVar2])();
      return pPVar3;
    }
  }
  else if (uVar2 < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    pPVar3 = (PKCS8_PRIV_KEY_INFO *)(*(code *)(&switchD_00561550::switchdataD_0066a160)[uVar2])();
    return pPVar3;
  }
