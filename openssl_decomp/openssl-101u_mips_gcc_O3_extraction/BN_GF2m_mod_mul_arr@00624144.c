...

{
  ...
  ppuVar14 = param_4;
  if (param_2 == param_3) {
    if (local_2c == *(uint ***)PTR___stack_chk_guard_006a9ae8) {
      (*(code *)PTR_BN_CTX_start_006a8528)(param_5);
      ppuVar14 = (uint **)(*(code *)PTR_BN_CTX_get_006a852c)(param_5);
...
LAB_006240cc:
        ...
        if ((int)ppuVar14[2] < (int)puVar22) {
          iVar21 = (*(code *)PTR_bn_expand2_006a8524)(ppuVar14);
          if (iVar21 == 0) goto LAB_006240cc;
          puVar7 = param_2[1];
          puVar22 = (uint *)((int)puVar7 << 1);
        }
        if (0 < (int)puVar7) {
          ...
          puVar22 = (uint *)((int)param_2[1] << 1);
        }
        ppuVar14[1] = puVar22;
        if (0 < (int)puVar22) {
          puVar7 = *ppuVar14 + (int)puVar22 + -2;
          do {
            if (puVar7[1] != 0) break;
        ...
        if (ppuVar14 != param_1) {
          if ((int)param_1[2] < (int)puVar22) {
            iVar21 = (*(code *)PTR_bn_expand2_006a8524)(param_1);
            if (iVar21 == 0) goto LAB_006240cc;
            puVar22 = ppuVar14[1];
          }
          iVar21 = 0;
...
LAB_006240d0:
    ...
    ppuVar13 = param_3;
    (*(code *)PTR_BN_CTX_start_006a8528)(param_5);
    ppuVar2 = (uint **)(*(code *)PTR_BN_CTX_get_006a852c)(param_5);
    if ((ppuVar2 == (uint **)0x0) ||
       ((ppuVar20 = (uint **)((int)param_2[1] + (int)param_3[1] + 4),
        (int)ppuVar2[2] < (int)ppuVar20 &&
        (ppuVar4 = ppuVar20, iVar21 = (*(code *)PTR_bn_expand2_006a8524)(ppuVar2,ppuVar20),
        iVar21 == 0)))) {
LAB_00624bdc:
      uVar3 = 0;
    }
      ...
      if ((int)ppuVar20 < 1) {
        puVar7 = param_3[1];
        if (0 < (int)puVar7) goto LAB_00624230;
      }
      else {
        ppuVar13 = (uint **)((int)ppuVar20 * 4);
        (*(code *)PTR_memset_006a99f4)(*ppuVar2,0,ppuVar13);
        puVar7 = param_3[1];
        if (0 < (int)puVar7) {
LAB_00624230:
          local_6c = 0;
      ...
      if (*param_4 == (uint *)0x0) {
        ...
        if (param_1 != ppuVar2) {
          if ((int)param_1[2] < (int)ppuVar20) {
            iVar21 = (*(code *)PTR_bn_expand2_006a8524)(param_1,ppuVar20);
            ppuVar4 = ppuVar20;
            if (iVar21 == 0) goto LAB_00624bdc;
            ppuVar20 = (uint **)ppuVar2[1];
          }
          iVar21 = 0;
          if (0 < (int)ppuVar20) {
  ...
  iVar21 = (*(code *)PTR_BN_num_bits_006a71f4)(ppuVar14);
  iVar21 = iVar21 + 1;
  iVar5 = (*(code *)PTR_CRYPTO_malloc_006a7008)(iVar21 * 4,"bn_gf2m.c",0x22a);
  if (iVar5 == 0) {
    return 0;
  }
  puVar7 = ppuVar14[1];
...
LAB_00624e3c:
    ...
    else if (uVar3 == 0) goto LAB_00624dc0;
    if ((int)uVar3 <= iVar21) {
