...
LAB_0052f058:
  ...
  if ((iVar2 != len - 1) || (len < 5)) goto LAB_0052f0cc;
  pcVar4 = (char *)(*(code *)PTR_strchr_006a9a28)(buf,0x3a);
  if ((pcVar4 == (char *)0x0) || (buf + (len - 5) < pcVar4)) {
    pcVar4 = buf + (len - 5);
    *pcVar4 = ':';
  }
  pcVar4 = (char *)(*(code *)PTR_strchr_006a9a28)(pcVar4 + 1,0x3a);
  if (pcVar4 == (char *)0x0) {
    pcVar5 = buf + (len - 4);
LAB_0052f178:
    *pcVar5 = ':';
    ...
    pcVar5 = buf + (len - 4);
    if (pcVar5 < pcVar4) goto LAB_0052f178;
  }
  pcVar4 = (char *)(*(code *)PTR_strchr_006a9a28)(pcVar4 + 1,0x3a);
  if (pcVar4 == (char *)0x0) {
    pcVar5 = buf + (len - 3);
LAB_0052f1b0:
    *pcVar5 = ':';
    ...
    pcVar5 = buf + (len - 3);
    if (pcVar5 < pcVar4) goto LAB_0052f1b0;
  }
  buf_00 = &DAT_0000003a;
  pcVar4 = pcVar4 + 1;
  pcVar5 = (char *)(*(code *)PTR_strchr_006a9a28)();
