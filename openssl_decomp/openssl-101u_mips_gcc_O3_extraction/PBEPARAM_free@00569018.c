...

{
  ...
  if (uVar3 != 0) {
    if (a == (PBEPARAM *)0x0) goto switchD_0055c4c0_caseD_0;
    if (PBEPARAM_it._16_4_ != (ASN1_ITEM_EXP *)0x0) goto LAB_0055c390;
    switch(uVar3 & 0xff) {
    default:
...
switchD_0055c6fc_caseD_0:
    if (PBEPARAM_it._8_4_ != (uint *)0x0) {
      ...
      if ((*PBEPARAM_it._8_4_ & 6) == 0) {
        ...
        for (; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(a), iVar10 < iVar4; iVar10 = iVar10 + 1) {
          uStack_30 = (*(code *)PTR_sk_value_006a6e24)(a,iVar10);
...
switchD_0055c4c0_caseD_1:
        ...
        if (0 < iVar10) goto switchD_0055c4c0_caseD_0;
          ...
          do {
            ...
            if (pAVar5 != (ASN1_ITEM_EXP *)0x0) {
              ...
              if ((*(uint *)pAVar5 & 6) == 0) {
                ...
                pAVar11 = *ppAVar6;
                for (iVar4 = 0; iVar7 = (*(code *)PTR_sk_num_006a6e2c)(pAVar11), iVar4 < iVar7;
                    iVar4 = iVar4 + 1) {
                  uStack_30 = (*(code *)PTR_sk_value_006a6e24)(pAVar11,iVar4);
                  puVar9 = *(undefined1 **)&pAVar5->field_0x10;
                  asn1_item_combine_free(&uStack_30,puVar9,0);
                }
                (*(code *)PTR_sk_free_006a6e80)(pAVar11);
...
LAB_0055c738:
          ...
          if ((*(uint *)pAVar5 & 6) == 0) {
            ...
            pAVar11 = *ppAVar6;
            for (iVar10 = 0; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(pAVar11), iVar10 < iVar4;
                iVar10 = iVar10 + 1) {
              uStack_30 = (*(code *)PTR_sk_value_006a6e24)(pAVar11,iVar10);
              puVar9 = *(undefined1 **)&pAVar5->field_0x10;
              asn1_item_combine_free(&uStack_30,puVar9,0);
            }
            (*(code *)PTR_sk_free_006a6e80)(pAVar11);
...
joined_r0x0055c87c:
          if (pAVar12 != (ASN1_ITEM_EXP *)0x0) goto LAB_0055c51c;
        }
        break;
      case 3:
      ...
      case 6:
        ...
        if (iVar10 == 2) goto switchD_0055c4c0_caseD_0;
        asn1_enc_free((ASN1_VALUE **)(ASN1_ITEM_EXP *)&pAStack_34,(ASN1_ITEM *)PBEPARAM_it);
        pAStack_3c = (ASN1_ITEM_EXP *)(PBEPARAM_it._8_4_ + PBEPARAM_it._12_4_ * 5 + -5);
        if (0 < PBEPARAM_it._12_4_) goto LAB_0055c5f4;
        break;
      case 2:
        pAVar5 = (ASN1_ITEM_EXP *)&SUB_00000002;
        pAVar8 = (ASN1_ITEM_EXP *)&pAStack_34;
        ...
        if ((-1 < iVar10) && (iVar10 < PBEPARAM_it._12_4_)) goto LAB_0055c738;
        break;
      case 3:
...
switchD_0055c4c0_caseD_0:
  ...
  (*(code *)PTR_memcmp_006a9ad0)(*(undefined4 *)pAVar5,*(undefined4 *)pAVar8,iVar10);
  return;
}
