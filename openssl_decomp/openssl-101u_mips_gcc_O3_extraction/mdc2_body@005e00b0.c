...

{
  ...
  if (param_3 != 0) {
    ...
    pbVar16 = param_2;
    do {
      puVar9 = PTR_DES_set_odd_parity_006a89b8;
      bVar1 = *pbVar16;
      pbVar17 = pbVar16 + 8;
      bVar2 = pbVar16[1];
      bVar3 = pbVar16[2];
      ...
      *(byte *)(param_1 + 5) = (byte)uVar11 & 0x9f | 0x20;
      ...
      (*(code *)PTR_DES_set_key_unchecked_006a79e8)(param_1 + 3,auStack_ac);
      (*(code *)PTR_DES_encrypt1_006a84c8)(&local_bc,auStack_ac,1);
      (*(code *)PTR_DES_set_odd_parity_006a89b8)(param_1 + 5);
      (*(code *)PTR_DES_set_key_unchecked_006a79e8)(param_1 + 5,auStack_ac);
      (*(code *)PTR_DES_encrypt1_006a84c8)(&local_b4,auStack_ac,1);
