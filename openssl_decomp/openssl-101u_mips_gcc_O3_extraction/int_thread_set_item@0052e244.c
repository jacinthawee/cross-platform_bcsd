...
undefined1 * int_thread_set_item(void *param_1)

{
  ...
  puStack_50 = CAST_S_table3 + 0x110;
  ...
  if (local_20 == (_LHASH *)0x0) {
    ...
    puVar3 = (undefined1 *)lh_insert(local_20,param_1);
  ...
  puStack_4c = &_gp_1;
  puStack_54 = *(undefined1 **)PTR___stack_chk_guard_006a9ae8;
  pvStack_44 = param_1;
  if (err_fns == (undefined1 *)0x0) {
    (*(code *)PTR_CRYPTO_lock_006a8144)(9,1,"err.c",0x127);
    if (err_fns == (undefined1 *)0x0) {
  ...
  if (p_Stack_58 == (_LHASH *)0x0) goto LAB_0052e644;
...
LAB_0052e618:
  ...
  *(undefined4 *)((int)pvVar4 + 0x104) = 0;
  (*(code *)puVar1)(pvVar4);
LAB_0052e644:
  if (puStack_54 == *(undefined1 **)puVar2) {
