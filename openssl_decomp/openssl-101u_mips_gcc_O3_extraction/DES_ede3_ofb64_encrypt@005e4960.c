...

{
  ...
  pbVar17 = &_gp;
  local_44 = (int *)PTR___stack_chk_guard_006a9ae8;
  local_58 = &_gp;
  local_4c = ks1;
  uVar10 = (uint)(*ivec)[3];
  uVar9 = (uint)(*ivec)[7];
  ...
  if (length != 0) {
    ...
    do {
      if (uStack_90 == 0) {
        unaff_s5 = unaff_s5 + 1;
        length = (long)ks2;
        (**(code **)(pbVar17 + -0x5770))(unaff_s1,local_4c,ks2,ks3);
        uVar14 = local_3c >> 8;
  ...
  *local_48 = uStack_90;
  ...
  if ((DES_key_schedule *)length != (DES_key_schedule *)0x0) {
    ...
    do {
      if (uVar6 == 0) {
        (*(code *)PTR_DES_encrypt1_006a84c8)(&uStack_a4,uVar9,1);
        iVar4 = iVar4 + 1;
  ...
  *puStack_54 = uVar6;
  if (iStack_94 != iVar4) {
    ...
    do {
      ...
      uVar6 = *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x1c0) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc) + 0x100) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar6;
      ...
      uVar9 = (uVar9 << 0x10 ^ uVar11) >> 4;
      uVar11 = uVar9 + uVar11 * 0x10000000;
      uVar12 = uVar10 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x1c0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc) + 0x100) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 * 0x100 >> 0x1a) + 0x140) * 4);
      ...
      uVar11 = uVar6 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
      ...
      uVar10 = uVar12 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
      ...
      uVar6 = (uVar6 << 0x10 ^ uVar9) >> 4;
      uVar9 = uVar6 + uVar9 * 0x10000000;
      uVar9 = uVar11 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar11 = uVar10 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar10 = uVar9 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar10 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar6 = (uVar6 << 0x10 ^ uVar9) >> 4;
      uVar9 = uVar6 + uVar9 * 0x10000000;
      uVar11 = uVar11 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar6 = (uVar6 << 0x10 ^ uVar9) >> 4;
      uVar9 = uVar6 + uVar9 * 0x10000000;
      uVar10 = uVar10 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar13 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar13 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar12 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar6 = uVar11 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar14 >> 0x1a) + 0x180) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar14 & 0xfc)) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar13 << 0x10) >> 0x1a) + 0x80) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar14 << 8) >> 0x1a) + 0x100) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar12 >> 0x1a) + 0x1c0) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar12 & 0xfc) + 0x100) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar6 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar6 * 0x100 >> 0x1a) + 0x140) * 4);
    } while (iVar4 != 0);
