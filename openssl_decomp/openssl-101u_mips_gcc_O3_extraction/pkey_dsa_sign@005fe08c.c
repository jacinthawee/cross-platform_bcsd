...

{
  ...
  uVar5 = param_4;
  local_2c = uStack_48;
  iVar3 = (**(code **)(local_28 + -0x7350))(uVar2,param_4,param_5,param_2);
  if (0 < iVar3) {
    iVar3 = 1;
    *param_3 = local_20;
  }
  if (local_1c != *(int *)puStack_58) {
    ...
    if (*(int *)(iVar3 + 0x1c) == 0) {
      ...
      puVar6 = auStack_68;
      (*(code *)PTR_evp_pkey_set_cb_translate_006a9734)(puVar6,iVar3);
      iVar3 = (*(code *)PTR_DSA_new_006a7528)();
    }
    if (iVar3 == 0) {
      iVar4 = 0;
      ...
      iVar4 = (*(code *)PTR_dsa_builtin_paramgen_006a975c)
      ...
      if (iVar4 == 0) {
        ...
        (*(code *)PTR_EVP_PKEY_assign_006a83cc)(uVar5,0x74,iVar3);
      }
    }
    if (iStack_5c != *(int *)puVar1) {
      ...
      iVar3 = (*(code *)PTR_CRYPTO_free_006a6e88)();
      return iVar3;
    }
    return iVar4;
  }
