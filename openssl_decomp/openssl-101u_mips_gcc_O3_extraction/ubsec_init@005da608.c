...

{
  ...
  if (ubsec_dso == 0) {
    ...
    ubsec_dso = (*(code *)PTR_DSO_load_006a8884)(0,pcVar14,0,0);
    if (ubsec_dso == 0) {
      ...
      iVar2 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"ubsec_bytes_to_bits");
      if ((((((iVar2 != 0) &&
             (iVar3 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"ubsec_bits_to_bytes"),
             iVar3 != 0)) &&
            (pcVar4 = (code *)(*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"ubsec_open"),
            pcVar4 != (code *)0x0)) &&
           (((pcVar5 = (code *)(*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"ubsec_close"),
             pcVar5 != (code *)0x0 &&
             (iVar6 = (*(code *)PTR_DSO_bind_func_006a888c)
                                (ubsec_dso,"diffie_hellman_generate_ioctl"), iVar6 != 0)) &&
            ((iVar7 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"diffie_hellman_agree_ioctl"),
             iVar7 != 0 &&
             ((iVar8 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"rsa_mod_exp_ioctl"),
              iVar8 != 0 &&
              (iVar9 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"rsa_mod_exp_crt_ioctl"),
              iVar9 != 0)))))))) &&
          (iVar10 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"dsa_sign_ioctl"), iVar10 != 0))
         && ((((iVar11 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"dsa_verify_ioctl"),
               iVar11 != 0 &&
               (iVar12 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"math_accelerate_ioctl"),
               iVar12 != 0)) &&
              (iVar12 = (*(code *)PTR_DSO_bind_func_006a888c)(ubsec_dso,"rng_ioctl"), iVar12 != 0))
             && (pcVar13 = (code *)(*(code *)PTR_DSO_bind_func_006a888c)
        ...
        (*(code *)PTR_ERR_put_error_006a7f34)(UBSEC_lib_error_code,0x69,0x6c,"e_ubsec.c",0x1e1);
        goto LAB_005da6ac;
      }
      if (UBSEC_lib_error_code == 0) {
        UBSEC_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006a9538)();
  ...
  (*(code *)PTR_ERR_put_error_006a7f34)(UBSEC_lib_error_code,0x69,uVar15,"e_ubsec.c",uVar1);
LAB_005da6ac:
  if (ubsec_dso != 0) {
