...

{
  ...
  int *piVar15;
  byte *pbVar16;
  stack_st_GENERAL_NAMES **ppsVar17;
  uchar **in;
  undefined *puVar18;
  uchar *puVar19;
  ASN1_VALUE *val;
  ...
  X509_CRL *pXStack_13c;
  stack_st_GENERAL_NAMES *psStack_134;
  stack_st_GENERAL_NAMES *psStack_130;
  ASN1_ITEM *pAStack_12c;
  X509_CRL *pXStack_128;
  X509_CRL *pXStack_124;
  ...
  pXStack_e4 = (X509_CRL *)PTR___stack_chk_guard_006a9ae8;
  ...
  pAStack_64 = (ASN1_INTEGER *)pXStack_e4;
  iStack_6c = *(int *)PTR___stack_chk_guard_006a9ae8;
  pXStack_68 = unaff_s0;
  pXVar5 = (X509_CRL *)(*(code *)PTR_BUF_MEM_new_006a749c)();
  if (pXVar5 != (X509_CRL *)0x0) {
    unaff_s4 = apXStack_98;
    unaff_s6 = &iStack_84;
    ERR_clear_error();
    iStack_b0 = 0;
    pXVar23 = (X509_CRL *)0x0;
    unaff_s5 = (X509_CRL *)0x0;
    pXVar20 = (X509_CRL *)0x0;
LAB_0054c08c:
    unaff_s0 = pXVar5;
    if ((X509_CRL *)&DAT_00000008 < unaff_s5) goto LAB_0054c0f0;
    while ((unaff_s3 = (X509_CRL *)((int)&pXVar20->signature - (int)pXVar23),
           pXVar23 <= &pXVar20->signature &&
           (iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(pXVar5), iVar4 != 0))) {
      iVar4 = (*(code *)PTR_BIO_read_006a74c0)
                        (pXStack_e0,pXVar23->sha1_hash + (int)(&pXVar5->sig_alg->algorithm + -0xb),
                         unaff_s3);
      if (iVar4 < 0) {
        if (pXVar23 == pXVar20) {
          pXStack_124 = (X509_CRL *)0x8e;
          iVar4 = 0xad;
          goto LAB_0054c284;
        }
      }
      else {
        pXVar6 = (X509_CRL *)(pXVar23->sha1_hash + iVar4 + -0x2c);
        if ((iVar4 != 0) &&
           (bVar1 = pXVar6 < pXVar23, unaff_s5 = (X509_CRL *)((int)pXVar6 - (int)pXVar20),
           pXVar23 = pXVar6, bVar1)) {
          pXStack_124 = (X509_CRL *)&DAT_0000009b;
          iVar4 = 0xb2;
          goto LAB_0054c284;
        }
      }
LAB_0054c0f0:
      pXVar21 = pXVar5->sig_alg;
      while( true ) {
        puStack_1a4 = (uchar *)&pAStack_80;
        unaff_s3 = (X509_CRL *)(pXVar20->sha1_hash + (int)(&pXVar21->algorithm + -0xb));
        pXStack_124 = (X509_CRL *)&pXStack_88;
        pcStack_1a0 = (char *)unaff_s6;
        apXStack_98[0] = unaff_s3;
        uStack_8c = ASN1_get_object((uchar **)unaff_s4,(long *)puStack_1a4,
                                    (int *)(X509_CRL *)&pXStack_88,unaff_s6,(long)unaff_s5);
        if ((uStack_8c & 0x80) != 0) {
        ...
        unaff_s3 = (X509_CRL *)((int)apXStack_98[0] - (int)unaff_s3);
        pXVar20 = (X509_CRL *)((int)pXVar20 + (int)unaff_s3);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_b0 != 0) && (pAStack_80 == (ASN1_BIT_STRING *)0x0)) {
            unaff_s5 = (X509_CRL *)((int)pXVar23 - (int)pXVar20);
            if ((pXStack_88 != (X509_CRL_INFO *)0x0) || (iStack_b0 = iStack_b0 + -1, iStack_b0 != 0)
               ) goto LAB_0054c08c;
            goto LAB_0054c324;
          }
          pXVar6 = (X509_CRL *)((int)pAStack_80 + (int)pXVar20);
          if (pAStack_80 <= (ASN1_BIT_STRING *)((int)pXVar23 - (int)pXVar20)) goto LAB_0054c220;
          unaff_s5 = (X509_CRL *)((int)pXVar6 - (int)pXVar23);
          if ((-1 < (int)unaff_s5) && (pXVar23 <= pXVar6)) {
            pXStack_ac = (X509_CRL *)&DAT_00004000;
            if (unaff_s5 != (X509_CRL *)0x0) goto LAB_0054c1a0;
            goto LAB_0054c220;
          }
          pXStack_124 = (X509_CRL *)&DAT_0000009b;
          iVar4 = 0xe2;
        ...
        if (unaff_s5 < (X509_CRL *)&DAT_00000009) break;
        pXVar21 = pXVar5->sig_alg;
      }
    }
    pXStack_124 = (X509_CRL *)&DAT_00000041;
    iVar4 = 0xa8;
    goto LAB_0054c284;
  }
  pXStack_124 = (X509_CRL *)&DAT_00000041;
  pcStack_1a0 = "a_d2i_fp.c";
  puStack_1a4 = &DAT_0000006b;
  ERR_put_error(0xd,0x6b,0x41,"a_d2i_fp.c",0x9e);
  pXVar20 = (X509_CRL *)0xffffffff;
LAB_0054c2ac:
  ...
  pXVar5 = (X509_CRL *)(*(code *)PTR_BIO_new_006a6ea4)(uVar8);
  if (pXVar5 == (X509_CRL *)0x0) {
    ...
    if ((int)ppAVar9 < 0) {
      ...
      pXVar20 = (X509_CRL *)(*(code *)puStack_1a4)(pcStack_1a0);
  ...
  ppsVar17 = &psStack_134;
  puStack_148 = &_gp;
  psStack_134 = (stack_st_GENERAL_NAMES *)0x0;
  pAStack_12c = *(ASN1_ITEM **)PTR___stack_chk_guard_006a9ae8;
  pXStack_128 = unaff_s0;
  ppAVar9 = (ASN1_VALUE **)asn1_d2i_read_bio_constprop_0(ppAStack_1ac,ppsVar17);
  if ((int)ppAVar9 < 0) {
    pXVar5 = (X509_CRL *)0x0;
  }
  else {
    ppsVar17 = &psStack_130;
    psStack_130 = (stack_st_GENERAL_NAMES *)(psStack_134->stack).data;
    pXVar5 = (X509_CRL *)(*(code *)piStack_164)(pcStack_160,ppsVar17);
    ppAStack_1ac = ppAVar9;
  }
  if (psStack_134 != (stack_st_GENERAL_NAMES *)0x0) {
    pXStack_13c = pXVar5;
  ...
  pXStack_1fc = (X509_CRL *)auStack_174;
  puStack_188 = &_gp;
  auStack_174._0_4_ = (X509_CRL_INFO *)0x0;
  pAStack_16c = *(ASN1_ITEM **)PTR___stack_chk_guard_006a9ae8;
  ppAStack_23c = ppAStack_1ac;
  ppAVar9 = (ASN1_VALUE **)asn1_d2i_read_bio_constprop_0(ppsVar17);
  if ((int)ppAVar9 < 0) {
    pXVar5 = (X509_CRL *)0x0;
  }
  else {
    pXStack_1fc = (X509_CRL *)(auStack_174 + 4);
    auStack_174._4_4_ = (auStack_174._0_4_)->sig_alg;
    pXVar5 = (X509_CRL *)ASN1_item_d2i(ppAStack_1ac,(uchar **)pXStack_1fc,(long)ppAVar9,pAStack_1a8)
    ;
    ppAStack_23c = ppAVar9;
  }
  if (auStack_174._0_4_ != (X509_CRL_INFO *)0x0) {
    pXStack_17c = pXVar5;
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar5 = (X509_CRL *)ASN1_item_d2i(ppAStack_23c,in,iVar4,pAStack_1f0);
      iStack_234 = iVar4;
    }
...
LAB_0054c974:
  ...
  pXStack_288 = (X509_CRL *)(*pcStack_284)(iVar4,0);
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    while( true ) {
      puVar18 = puVar10 + (int)pcStack_284;
      pXVar5 = pXStack_288;
      pXVar20 = (X509_CRL *)(*(code *)PTR_BIO_write_006a6e14)(pcStack_27c,puVar18);
      if (pXStack_288 == pXVar20) break;
      if ((int)pXVar20 < 1) {
        pXVar20 = (X509_CRL *)0x0;
        goto LAB_0054cb14;
      }
      pcStack_284 = pcStack_284 + (int)pXVar20;
      pXStack_288 = (X509_CRL *)((int)pXStack_288 - (int)pXVar20);
    }
    pXVar20 = (X509_CRL *)0x1;
LAB_0054cb14:
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    pXStack_304 = (X509_CRL *)0x0;
    ERR_put_error(0xd,0xc1,7,"a_i2d_fp.c",0x7b);
  }
  else {
    (*(code *)PTR_BIO_ctrl_006a6e18)(puVar10,0x6a,0,puVar18);
...
LAB_0054cc80:
  ...
  if (puStack_2d0 == (uchar *)0x0) {
    ...
    pAStack_300 = (ASN1_ITEM *)0x0;
    while( true ) {
      puVar19 = puStack_2d0 + (int)pAStack_300;
      iVar11 = (*(code *)PTR_BIO_write_006a6e14)(puStack_2fc,puVar19,iVar4);
...
LAB_0054cde0:
  ...
  if (*piVar15 < 5) {
    ...
    puVar18 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a7008)(5,"a_enum.c",0x51);
    piVar15[2] = (int)puVar18;
...
LAB_0054cf00:
    puVar18 = (undefined *)piVar15[2];
    if (puVar18 != (undefined *)0x0) {
      if ((int)puVar19 < 0) {
        puVar19 = (uchar *)-(int)puVar19;
        piVar15[1] = 0x10a;
LAB_0054cf1c:
        auStack_316[2] = (char)puVar19;
        if ((int)puVar19 >> 8 == 0) {
          iVar4 = 1;
LAB_0054cff0:
          iVar11 = iVar4 + -1;
          *puVar18 = auStack_316[iVar4 + 1];
          if (iVar4 != 1) {
            iVar12 = iVar4 + -3;
          ...
          auStack_316[3] = (char)((uint)puVar19 >> 8);
          if ((int)puVar19 >> 0x10 == 0) {
            iVar4 = 2;
            goto LAB_0054cff0;
          }
          auStack_316[4] = (undefined)((uint)puVar19 >> 0x10);
          if ((int)puVar19 >> 0x18 == 0) {
            iVar4 = 3;
            goto LAB_0054cff0;
          }
          auStack_316[5] = (undefined)((uint)puVar19 >> 0x18);
          *puVar18 = auStack_316[5];
          iVar11 = 3;
          iVar12 = 1;
...
LAB_0054cf58:
        ...
        iVar4 = 0;
        if (puVar19 != (uchar *)0x0) goto LAB_0054cf1c;
      }
LAB_0054cf80:
      pXVar5 = (X509_CRL *)0x1;
      *piVar15 = iVar4;
...
LAB_0054cf88:
  ...
  if (piStack_30c != (int *)0x0) {
    ...
    if (pbVar16 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar5 = (X509_CRL *)(uint)*pbVar16;
        if (iVar4 != 1) {
          uVar2 = CONCAT11(*pbVar16,pbVar16[1]);
          pXVar5 = (X509_CRL *)(uint)uVar2;
          if (iVar4 != 2) {
            uVar3 = CONCAT21(uVar2,pbVar16[2]);
            pXVar5 = (X509_CRL *)(uint)uVar3;
            if (iVar4 == 4) {
              pXVar5 = (X509_CRL *)CONCAT31(uVar3,pbVar16[3]);
            }
          }
        }
      }
  ...
  while( true ) {
    do {
      puStack_1a4 = pXVar23->sha1_hash + (int)(&pXVar5->sig_alg->algorithm + -0xb);
      pXStack_124 = pXVar22;
      ...
      unaff_s3 = (X509_CRL *)((int)pXVar22 - iVar4);
      pXVar23 = (X509_CRL *)(pXVar23->sha1_hash + iVar4 + -0x2c);
      pXVar22 = unaff_s3;
    } while (unaff_s3 != (X509_CRL *)0x0);
    unaff_s5 = (X509_CRL *)((int)unaff_s5 - (int)pXVar6);
    pXStack_ac = (X509_CRL *)((int)pXStack_ac << (pXStack_ac < (X509_CRL *)0x3fffffff));
    if (unaff_s5 == (X509_CRL *)0x0) break;
LAB_0054c1a0:
    unaff_s3 = (X509_CRL *)(uint)(pXStack_ac < unaff_s5);
    pXVar6 = pXStack_ac;
    if (unaff_s3 == (X509_CRL *)0x0) {
      pXVar6 = unaff_s5;
    }
    iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)
                      (pXVar5,pXVar23->sha1_hash + (int)(pXVar6->sha1_hash + -0x58));
    pXVar22 = pXVar6;
    if (iVar4 == 0) {
      pXStack_124 = (X509_CRL *)&DAT_00000041;
      iVar4 = 0xef;
  ...
  pXVar6 = (X509_CRL *)
           (((X509_CRL *)(pXVar20->sha1_hash + -0x2c))->sha1_hash +
           (int)(&pAStack_80->length + -0xb));
LAB_0054c220:
  pXVar20 = (X509_CRL *)(uint)(pXVar6 < pXVar20);
  if (pXVar20 != (X509_CRL *)0x0) {
    pXStack_124 = (X509_CRL *)&DAT_0000009b;
    iVar4 = 0x106;
    goto LAB_0054c284;
  }
  ...
  unaff_s5 = (X509_CRL *)((int)pXVar23 - (int)pXVar6);
  goto LAB_0054c08c;
LAB_0054c324:
  if ((int)pXVar20 < 0) {
    pXStack_124 = (X509_CRL *)&DAT_0000009b;
