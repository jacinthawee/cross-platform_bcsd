...

{
  ...
  if (puStack_ec == (undefined *)0x0) {
    (*(code *)PTR_OpenSSLDie_006a7c5c)("s3_enc.c",0xeb,&DAT_00679b60);
    iVar2 = *(int *)(param_1 + 0x58);
  }
  ...
  if (uStack_f0 == 0) {
    ...
    iStack_e0 = 1;
    if (iStack_fc == 0) {
      local_b0 = "-check_ss_sig";
      iVar2 = (**(code **)(local_c0 + -0x7dd8))(0x8c,"s3_enc.c",0x11e);
      *(int *)(param_1 + 0x8c) = iVar2;
      if (iVar2 == 0) goto LAB_00487978;
      iStack_e0 = 0;
      (**(code **)(local_c0 + -0x737c))(iVar2);
      iStack_fc = *(int *)(param_1 + 0x8c);
    }
    iVar2 = (**(code **)(local_c0 + -0x6d04))(param_1 + 0x90,puStack_ec);
    if (iVar2 == 0) {
      pcVar14 = *(code **)(local_c0 + -0x6eac);
      uVar9 = 0x44;
      local_c8 = (undefined *)0x127;
LAB_00487a0c:
      (*pcVar14)(0x14,0x81,uVar9,"s3_enc.c");
      goto LAB_004876d8;
    }
    if (*(int *)(param_1 + 0x94) != 0) {
      (**(code **)(local_c0 + -0x6d00))();
      *(undefined4 *)(param_1 + 0x94) = 0;
    }
    if (puStack_e4 != (undefined *)0x0) {
      iVar2 = (**(code **)(local_c0 + -0x6cfc))(puStack_e4);
      *(int *)(param_1 + 0x94) = iVar2;
      if (iVar2 == 0) {
        pcVar14 = *(code **)(local_c0 + -0x6eac);
        uVar9 = 0x8e;
        local_c8 = (undefined *)0x134;
        goto LAB_00487a0c;
      }
    }
    iVar2 = *(int *)(param_1 + 0x58);
    ...
    *(undefined *)(iVar2 + 0x5b) = 0;
    ...
    if (iStack_e0 == 0) goto LAB_00487480;
LAB_004876a4:
    (**(code **)(local_c0 + -0x736c))(iStack_fc);
    puVar13 = *(undefined **)(*(int *)(param_1 + 0x58) + 0x378);
    puStack_e4 = (undefined *)(**(code **)(local_c0 + -0x6fa4))(puStack_ec);
    puStack_ec = puVar13;
joined_r0x004876cc:
    if ((int)puStack_e4 < 0) {
      uStack_f0 = 0;
    ...
    uVar12 = local_b4 & 2;
    iStack_e0 = (**(code **)(local_c0 + -0x788c))(uStack_e8);
    if (uVar12 != 0) {
    ...
    pcVar4 = (char *)(**(code **)(local_c0 + -0x7890))(uStack_e8);
    if ((param_2 == 0x12) || (iVar2 = iStack_e0 + (int)puStack_e4 * 2, param_2 == 0x21)) {
      ...
      local_ac = iVar3 + 0xa0;
      puVar13 = puStack_ec;
      if (*(int *)(iVar3 + 0x374) < (int)(pcVar5 + (int)pcVar4 * 2)) goto LAB_00487758;
    }
    else {
      iVar3 = *(int *)(param_1 + 0x58);
      local_b4 = iVar3 + 0xa0;
...
LAB_00487758:
    ...
    (**(code **)(local_c0 + -0x52f4))(local_b0,local_a8,puStack_e4);
    pcVar4 = local_a4;
    local_c8 = local_a0;
    if (uVar12 != 0) {
      local_a4 = local_9c;
      ...
      (**(code **)(local_c0 + -0x7864))(puStack_ec,uVar9,0);
      (**(code **)(local_c0 + -0x7860))(puStack_ec,local_b0,iStack_e0);
      (**(code **)(local_c0 + -0x7860))(puStack_ec,local_b4,0x20);
      iStack_e0 = local_ac;
      (**(code **)(local_c0 + -0x7860))(puStack_ec,local_ac,0x20);
      (**(code **)(local_c0 + -0x785c))(puStack_ec,acStack_6c,0);
      local_c8 = local_a8;
      pcVar4 = acStack_6c;
      if (0 < (int)local_a4) {
        uVar9 = (**(code **)(local_c0 + -0x7d18))();
        (**(code **)(local_c0 + -0x7864))(puStack_ec,uVar9,0);
        (**(code **)(local_c0 + -0x7860))(puStack_ec,local_b4,0x20);
        (**(code **)(local_c0 + -0x7860))(puStack_ec,iStack_e0,0x20);
        (**(code **)(local_c0 + -0x785c))(puStack_ec,auStack_7c,0);
        local_c8 = auStack_7c;
      }
    }
    puStack_e4 = auStack_7c;
    param_2 = param_2 & 2;
    pcVar14 = *(code **)(local_c0 + -0x7880);
    *(undefined4 *)(*(int *)(param_1 + 0xc0) + 4) = 0;
    ...
    if (iStack_fc == 0) {
      local_b0 = "-check_ss_sig";
      iVar2 = (**(code **)(local_c0 + -0x7dd8))(0x8c,"s3_enc.c",0xf7);
...
LAB_00487978:
      local_c8 = (undefined *)0x184;
      uStack_f0 = 0;
      (**(code **)(local_c0 + -0x6eac))(0x14,0x81,0x41,local_b0 + 0x71d0);
      goto LAB_004876d8;
    }
LAB_004873f0:
    iVar2 = (**(code **)(local_c0 + -0x6d04))(param_1 + 0x84,puStack_ec);
    if (iVar2 != 0) {
      ...
      if (puStack_e4 == (undefined *)0x0) {
        ...
        *(int *)(param_1 + 0x88) = iVar2;
        if (iVar2 == 0) {
          pcVar14 = *(code **)(local_c0 + -0x6eac);
          uVar9 = 0x8e;
          local_c8 = (undefined *)0x10e;
          goto LAB_0048776c;
        }
        puStack_e4 = *(undefined **)(param_1 + 0x58);
        if (*(int *)(puStack_e4 + 0x120) == 0) {
          local_b0 = "-check_ss_sig";
          uVar9 = (**(code **)(local_c0 + -0x7dd8))(0x4000,"s3_enc.c",0x113);
          *(undefined4 *)(puStack_e4 + 0x120) = uVar9;
          puStack_e4 = *(undefined **)(param_1 + 0x58);
          if (*(int *)(puStack_e4 + 0x120) == 0) goto LAB_00487978;
        }
      }
      puStack_e4[8] = 0;
      puStack_e4[9] = 0;
      ...
      if (iStack_e0 != 0) goto LAB_004876a4;
LAB_00487480:
...
LAB_004876d8:
  ...
  uStack_f8 = param_2;
  if (uVar12 == 0) {
    iVar3 = (*(code *)PTR_ssl_cipher_get_evp_006a80e8)
    ...
    if (iVar3 == 0) {
      ...
      *(undefined4 *)(iVar3 + 0x38c) = uStack_15c;
      ...
      if (-1 < iVar3) {
        iVar6 = (*(code *)PTR_EVP_CIPHER_key_length_006a7554)(uStack_164);
        iVar7 = (*(code *)PTR_EVP_CIPHER_iv_length_006a7550)(uStack_164);
        ...
        if (*(int *)(iVar10 + 0x378) != 0) {
          ...
          (*(code *)PTR_CRYPTO_free_006a6e88)(*(undefined4 *)(*(int *)(iVar2 + 0x58) + 0x378));
          iVar10 = *(int *)(iVar2 + 0x58);
          *(undefined4 *)(iVar10 + 0x378) = 0;
        }
        puVar1 = PTR_CRYPTO_malloc_006a7008;
        *(undefined4 *)(iVar10 + 0x374) = 0;
        iVar6 = (*(code *)puVar1)(iVar3,"s3_enc.c",0x1ab);
        ...
        if (iVar6 == 0) {
          ...
          *(int *)(iVar7 + 0x378) = iVar6;
          ...
          (*(code *)PTR_EVP_MD_CTX_set_flags_006a7504)(auStack_158,8);
          (*(code *)PTR_EVP_MD_CTX_init_006a6e1c)(auStack_140);
          if (iVar3 < 1) {
LAB_00487f48:
            uVar12 = 1;
            (*(code *)PTR_OPENSSL_cleanse_006a7074)(auStack_118,0x14);
            (*(code *)PTR_EVP_MD_CTX_cleanup_006a6e34)(auStack_158);
            (*(code *)PTR_EVP_MD_CTX_cleanup_006a6e34)(auStack_140);
          }
          else {
            iVar10 = 1;
            cStack_128 = 'A';
            ...
            while( true ) {
              ...
              (*(code *)PTR_EVP_DigestInit_ex_006a757c)(auStack_140,uVar9,0);
              (*(code *)PTR_EVP_DigestUpdate_006a7580)(auStack_140,&cStack_128,iVar10);
              ...
              (*(code *)PTR_EVP_DigestFinal_ex_006a7584)(auStack_140,auStack_118,0);
              uVar9 = (*(code *)PTR_EVP_md5_006a70c8)();
              (*(code *)PTR_EVP_DigestInit_ex_006a757c)(auStack_158,uVar9,0);
              (*(code *)PTR_EVP_DigestUpdate_006a7580)
                        (auStack_158,*(int *)(iVar2 + 0xc0) + 0x14,
                         *(undefined4 *)(*(int *)(iVar2 + 0xc0) + 0x10));
              (*(code *)PTR_EVP_DigestUpdate_006a7580)(auStack_158,auStack_118,0x14);
              if (iVar3 < iVar7) {
                (*(code *)PTR_EVP_DigestFinal_ex_006a7584)(auStack_158,auStack_118,0);
                (*(code *)PTR_memcpy_006a9aec)(iVar8,auStack_118,(iVar3 + 0x10) - iVar7);
              }
              else {
                (*(code *)PTR_EVP_DigestFinal_ex_006a7584)(auStack_158,iVar8);
              }
              if (iVar3 <= iVar7) goto LAB_00487f48;
              iVar10 = iVar10 + 1;
