...
/* WARNING: Removing unreachable block (ram,0x00526794) */
/* WARNING: Removing unreachable block (ram,0x0052679c) */
/* WARNING: Removing unreachable block (ram,0x005267a0) */
/* WARNING: Removing unreachable block (ram,0x005267c0) */
/* WARNING: Removing unreachable block (ram,0x005267c4) */
/* WARNING: Removing unreachable block (ram,0x005267d4) */
/* WARNING: Removing unreachable block (ram,0x005267d8) */
/* WARNING: Removing unreachable block (ram,0x005267e8) */
/* WARNING: Removing unreachable block (ram,0x005267ec) */
/* WARNING: Removing unreachable block (ram,0x00526b50) */
/* WARNING: Removing unreachable block (ram,0x00526fe4) */
/* WARNING: Removing unreachable block (ram,0x00526b28) */
...

{
  ...
  pFVar11 = (FILE *)0x0;
  ppcStack_1ec = (code **)PTR___stack_chk_guard_006a9ae8;
  puStack_230 = &_gp;
  pcStack_2c = *(code **)PTR___stack_chk_guard_006a9ae8;
  pcVar5 = s + len;
  iVar2 = len;
  if (len < 1) {
  ...
  if ((int)pcStack_204 < 1) {
    ...
    do {
      ...
      BIO_snprintf(unaff_s8,0x14,(char *)(iStack_200 + 0x7810),unaff_s2);
      ...
      do {
        while (pbVar12 = pbVar8, iVar14 + unaff_s2 < iVar2) {
          ...
          BUF_strlcat(unaff_s7,unaff_s8,0x121);
          pbVar8 = pbVar12 + 1;
          if (iVar14 == 0x10) goto LAB_00526950;
        }
        iVar14 = iVar14 + 1;
...
LAB_00526950:
      unaff_s4 = pbVar12 + 1;
      BUF_strlcat(unaff_s7,pcStack_208 + -0x4da8,0x121);
      if (unaff_s2 < iVar2) {
        unaff_s5 = 0x2e;
      ...
      BUF_strlcat(unaff_s7,pcStack_1fc + -0x4d1c,0x121);
      pcStack_270 = pcStack_214 + 1;
      pbStack_220 = pbStack_220 + 0x10;
      pcStack_214 = pcStack_270;
      pbVar8 = (byte *)(**(code **)(puStack_230 + -0x53bc))(unaff_s7);
      len = 1;
      pFVar11 = pFStack_20c;
      iVar14 = (**(code **)(puStack_230 + -0x536c))(unaff_s7);
  ...
  if (pbStack_1f0 != (byte *)0x0) {
    ...
    pbVar8 = (byte *)(**(code **)(puStack_230 + -0x53bc))(pcStack_270);
    len = 1;
    pFVar11 = pFStack_20c;
    iVar2 = (**(code **)(puStack_230 + -0x536c))(pcStack_270);
  ...
  pcStack_274 = *(cb **)PTR___stack_chk_guard_006a9ae8;
  ...
  if ((int)pbStack_238 < 1) {
    ...
    pbVar9 = &DAT_00000020;
    pbVar12 = pbVar16;
    (*(code *)PTR___memset_chk_006a998c)(abStack_41c);
    pbVar6 = &DAT_00000006;
    if ((int)pbVar16 < 7) {
      pbVar6 = pbVar16;
    }
      ...
      if (iVar2 < 1) {
        ...
        do {
          while ((int)(pbVar16 + iVar13) < (int)pFVar11) {
            ...
            BUF_strlcat(acStack_398,acStack_430,0x121);
            if (iVar13 == iVar2) goto LAB_00526df4;
          }
          iVar13 = iVar13 + 1;
          pbVar12 = pbVar12 + 1;
          BUF_strlcat(acStack_398,"   ",0x121);
...
LAB_00526df4:
      ...
      pbVar9 = (byte *)(*(code *)PTR_strlen_006a9a24)(acStack_398);
      pbVar12 = pbVar8;
