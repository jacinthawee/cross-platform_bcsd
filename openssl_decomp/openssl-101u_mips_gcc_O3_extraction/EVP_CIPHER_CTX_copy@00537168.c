...
LAB_005371fc:
    ...
    if ((p_Var12 != (_func_1091 *)0x0) && (iVar2 = (*p_Var12)(out), iVar2 == 0)) goto LAB_00537244;
    if (out->cipher_data != (void *)0x0) {
      (*(code *)PTR_OPENSSL_cleanse_006a7074)(out->cipher_data,out->cipher->ctx_size);
      goto LAB_005371fc;
    }
  }
  ...
  (*(code *)PTR_memset_006a99f4)(out,0,0x8c);
LAB_00537244:
  pEVar1 = out;
  pEVar6 = in;
  do {
  ...
  *(undefined4 *)(pEVar3->oiv + 8) = uVar8;
  ...
  if ((in->cipher_data != (void *)0x0) && (pEVar7->ctx_size != 0)) {
    pvVar4 = (void *)(*(code *)PTR_CRYPTO_malloc_006a7008)(pEVar7->ctx_size,"evp_enc.c",0x282);
    out->cipher_data = pvVar4;
    if (pvVar4 == (void *)0x0) {
      ERR_put_error(6,0xa3,0x41,"evp_enc.c",0x284);
      return 0;
    }
    (*(code *)PTR_memcpy_006a9aec)(pvVar4,in->cipher_data,in->cipher->ctx_size);
    pEVar7 = in->cipher;
  }
  if ((pEVar7->flags & 0x400) == 0) {
    return 1;
  }
                    /* WARNING: Could not recover jumptable at 0x00537330. Too many branches */
