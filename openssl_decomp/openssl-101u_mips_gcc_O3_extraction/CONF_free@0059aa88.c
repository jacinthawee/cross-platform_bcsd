...

{
  ...
  puStack_68 = &_gp;
  plStack_54 = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
  plStack_44 = conf;
  pBStack_94 = (BIO *)(*(code *)PTR_BIO_new_fp_006a7248)(in_a1,0);
  if (pBStack_94 == (BIO *)0x0) {
    uStack_70 = 0xcc;
    bp = (BIO *)&DAT_00000068;
    (**(code **)(puStack_68 + -0x6eac))(0xe,0x68,7,"conf_lib.c");
  }
  else {
    if (default_CONF_method == (CONF_METHOD *)0x0) {
      default_CONF_method = NCONF_default();
  ...
  pCStack_9c = *(CONF_METHOD **)PTR___stack_chk_guard_006a9ae8;
