...

{
  ...
  if (iVar8 != 0) {
    iVar1 = (*(code *)PTR_BN_num_bits_006a71f4)(iVar8);
    iVar2 = iVar1 + 7;
    if (iVar1 + 7 < 0) {
      iVar2 = iVar1 + 0xe;
    }
  ...
  iVar2 = (*(code *)PTR_CRYPTO_malloc_006a7008)(uVar4 + 10,"dsa_ameth.c",0x1be);
  if (iVar2 == 0) {
  ...
  if (iVar7 == 0) {
LAB_005fc8d4:
    iVar7 = (*(code *)PTR_ASN1_bn_print_006a86b8)(param_1,"priv:",iVar7,iVar2,param_3);
    if ((((iVar7 != 0) &&
         (iVar7 = (*(code *)PTR_ASN1_bn_print_006a86b8)(param_1,"pub: ",iVar8,iVar2,param_3),
         iVar7 != 0)) &&
    ...
    if (iVar1 != 0) {
      uVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(*(undefined4 *)(iVar5 + 0xc));
      iVar1 = (*(code *)PTR_BIO_printf_006a6e38)(param_1,"%s: (%d bit)\n","Private-Key",uVar3);
      if (0 < iVar1) goto LAB_005fc8d4;
    }
  }
  bVar6 = false;
LAB_005fc864:
