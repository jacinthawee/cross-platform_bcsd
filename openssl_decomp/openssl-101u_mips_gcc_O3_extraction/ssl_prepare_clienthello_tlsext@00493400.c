...

{
  ...
  do {
    ...
    iVar2 = (*(code *)PTR_sk_value_006a6e24)(psVar1,iVar5);
  ...
  if (0x300 < param_1->version) {
    ...
    puVar4 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a7008)(3,"t1_lib.c",0x6c3);
    param_1->tlsext_ecpointformatlist_length = (size_t)puVar4;
    if (puVar4 == (undefined *)0x0) {
      uVar3 = 0x6c5;
      pcVar8 = (code *)PTR_ERR_put_error_006a7f34;
    }
    else {
      ...
      *(undefined *)(param_1->tlsext_ecpointformatlist_length + 2) = 2;
      ...
      puVar4 = PTR_CRYPTO_malloc_006a7008;
      param_1->tlsext_ecpointformatlist = &DAT_00000032;
      puVar4 = (undefined *)(*(code *)puVar4)(0x32,"t1_lib.c",0x6d5);
                    ...
                    if (iVar5 < 0x2cb) {
                      ...
                      if (iVar5 != 0x2cc) {
                        if (iVar5 < 0x2cc) {
                          ...
                          uVar7 = 1;
                          if (iVar5 != 0x2d1) goto LAB_0049369c;
                        }
                      }
                    }
                  }
