...

{
  ...
  if (((a == (stack_st_OPENSSL_BLOCK **)0x0) ||
     ...
     (psVar7 = (stack_st_OPENSSL_BLOCK *)(*(code *)PTR_sk_new_null_006a6fa4)(),
  ...
  local_4c = (*(code *)PTR_ASN1_get_object_006a7fb0)
...
LAB_0062a26c:
            ...
            if ((local_4c & 1) == 0) {
              ...
              local_54 = (*(code *)PTR_ASN1_const_check_infinite_end_006a8400)(&local_58,local_40);
              bVar1 = local_54 != 0;
            }
            ...
            if (iVar5 == 0) {
              ...
              (*(code *)PTR_asn1_add_error_006a83f0)(*pp,(int)local_58 - (int)*pp);
              break;
            }
            iVar5 = (*(code *)PTR_sk_push_006a6fa8)(psVar7,iVar5);
          } while (iVar5 != 0);
          goto LAB_0062a0b8;
        }
        uVar6 = 0x88;
    ...
    (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0x94,uVar6,"a_set.c",uVar3);
  }
LAB_0062a0b8:
  if ((a == (stack_st_OPENSSL_BLOCK **)0x0) ||
    ...
    if (free_func == (free_func *)0x0) {
      ...
      (*(code *)PTR_sk_pop_free_006a7058)(psVar7,free_func);
      psVar4 = (stack_st_OPENSSL_BLOCK *)0x0;
    }
  }
LAB_0062a0e8:
  ...
  psVar7 = (stack_st_OPENSSL_BLOCK *)(*(code *)PTR_BIO_callback_ctrl_006a8428)();
  return psVar7;
}
