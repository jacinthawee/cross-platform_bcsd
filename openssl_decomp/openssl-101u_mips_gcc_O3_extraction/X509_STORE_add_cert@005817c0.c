...

{
  ...
  x_00 = (X509_OBJECT *)(*(code *)PTR_CRYPTO_malloc_006a7008)(8,"x509_lu.c",0x14c);
  puVar1 = PTR_CRYPTO_lock_006a8144;
  if (x_00 != (X509_OBJECT *)0x0) {
    (x_00->data).x509 = x;
    x_00->type = 1;
    (*(code *)puVar1)(9,0xb,"x509_lu.c",0x154);
    if (x_00->type == 1) {
    ...
    if (pXVar2 == (X509_OBJECT *)0x0) {
      ...
      (*(code *)PTR_ERR_put_error_006a7f34)(0xb,0x7c,0x65,"x509_lu.c",0x15c);
    }
    (*(code *)PTR_CRYPTO_lock_006a8144)(10,0xb,"x509_lu.c",0x161);
    return iVar3;
  }
  (*(code *)PTR_ERR_put_error_006a7f34)(0xb,0x7c,0x41,"x509_lu.c",0x14e);
  return 0;
}
