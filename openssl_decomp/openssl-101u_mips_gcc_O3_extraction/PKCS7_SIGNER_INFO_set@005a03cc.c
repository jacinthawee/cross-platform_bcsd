...

{
  ...
  iVar2 = (*(code *)PTR_ASN1_INTEGER_set_006a7164)(p7i->version,1);
  if (iVar2 == 0) {
    return 0;
  }
  pPVar7 = p7i->issuer_and_serial;
  uVar3 = (*(code *)PTR_X509_get_issuer_name_006a76e4)(x509);
  iVar2 = (*(code *)PTR_X509_NAME_set_006a8f2c)(pPVar7,uVar3);
  if (iVar2 == 0) {
    return 0;
  }
  ...
  uVar3 = (*(code *)PTR_OBJ_nid2obj_006a7140)(uVar3);
  (*(code *)PTR_X509_ALGOR_set0_006a8ce4)(pXVar6,uVar3,5,0);
  ...
  uVar3 = 0x18c;
LAB_005a0560:
  (*(code *)PTR_ERR_put_error_006a7f34)(0x21,0x81,uVar5,"pk7_lib.c",uVar3);
  return 0;
}
