...

{
  ...
  *param_1 = (byte)uVar16;
  ...
  if (uVar8 == 0) {
    if (param_4 != 0) goto LAB_005ed344;
  }
  else {
    ...
    if (uVar6 == 0) goto LAB_005ed164;
    uVar8 = (uVar8 & 0xff) + (uint)param_1[0xf];
    uVar9 = uVar8 >> 8;
    param_1[0xf] = (byte)uVar8;
    if (param_4 >> 0xc == 0) {
      if (uVar9 == 0) goto LAB_005ed344;
...
LAB_005ed2d4:
      ...
      if (param_4 >> 0x14 == 0) goto LAB_005ed2bc;
      uVar8 = (uint)param_1[0xd] + (param_4 >> 0x14 & 0xff) + uVar9;
      uVar9 = uVar8 >> 8;
      param_1[0xd] = (byte)uVar8;
      if (param_4 >> 0x1c == 0) goto LAB_005ed2d4;
      ...
      *(byte *)param_3 = bVar7 ^ local_40._0_1_;
      ...
      if (uVar6 < 4) {
        ...
        *(uint *)(param_1 + 0x10) = local_40 ^ uVar15 ^ *(uint *)(param_1 + 0x10);
        ...
        if (uVar9 == uVar8) goto LAB_005ed544;
      }
      uVar8 = uVar9 + 1;
...
LAB_005ed164:
  (*(code *)PTR_memset_006a99f4)(param_1 + (0xf - uVar16),0,0x10 - iVar14);
  (*pcVar18)(param_1,&local_40,puVar17);
  puVar17 = (uint *)0x0;
...
LAB_005ed1e0:
  ...
  if (puVar17 <= puVar13) {
    (*(code *)PTR_memcpy_006a9aec)(pbVar12,pbVar11 + 0x10,puVar17);
    return puVar17;
  }
  return (uint *)0x0;
}
