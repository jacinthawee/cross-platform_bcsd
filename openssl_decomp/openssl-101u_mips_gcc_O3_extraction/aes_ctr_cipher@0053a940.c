...

{
  ...
  if (*(int *)(iVar2 + 0xf8) == 0) {
    (*(code *)PTR_CRYPTO_ctr128_encrypt_006a8a18)(param_3);
  }
  else {
    (*(code *)PTR_CRYPTO_ctr128_encrypt_ctr32_006a8a14)();
  }
  iVar3 = *(int *)puVar1;
  *(int *)(param_1 + 0x50) = iVar9;
  ...
  else if (iVar9 == 0) goto LAB_0053aac8;
  iVar6 = *(int *)(iVar8 + 0x58);
  *(undefined4 *)(iVar3 + 0x1f8) = 0;
  puVar1 = PTR_AES_encrypt_006a7ac0;
  if (iVar2 == 0) {
    (*(code *)PTR_AES_set_decrypt_key_006a8a1c)(iVar9,iVar6 << 2);
    *(undefined **)(iVar3 + 0x1f0) = PTR_AES_decrypt_006a84d8;
  }
  else {
    (*(code *)PTR_AES_set_encrypt_key_006a79ec)(iVar9,iVar6 << 2,iVar3);
