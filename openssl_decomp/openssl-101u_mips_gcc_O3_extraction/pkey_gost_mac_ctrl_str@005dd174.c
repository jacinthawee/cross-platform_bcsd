...

{
  ...
  if ((((*param_2 == 'k') && (param_2[1] == 'e')) && (param_2[2] == 'y')) && (param_2[3] == '\0')) {
    puVar36 = param_3;
    iVar27 = (*(code *)PTR_strlen_006a9a24)(param_3);
    if (iVar27 == 0x20) {
      iVar39 = 1;
      puVar30 = (undefined4 *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006a95d0)();
      ...
      *puVar30 = 1;
      ...
      pcVar34 = (char *)0x6f;
      iVar39 = 0;
      (*(code *)PTR_ERR_GOST_error_006a95e4)(0x81,0x6f,"gost_pmeth.c",0x1ef);
    }
  }
  else {
    pcVar34 = "hexkey";
    puVar36 = param_3;
    iVar39 = (*(code *)PTR_strcmp_006a9b18)(param_2,"hexkey");
    if (iVar39 == 0) {
      piVar35 = &local_20;
      puVar30 = (undefined4 *)(*(code *)PTR_string_to_hex_006a738c)(param_3);
      if ((puVar30 == (undefined4 *)0x0) || (local_20 != 0x20)) {
        pcVar34 = (char *)0x6f;
        (*(code *)PTR_ERR_GOST_error_006a95e4)(0x81,0x6f,"gost_pmeth.c",0x1fb);
        (*(code *)PTR_CRYPTO_free_006a6e88)(puVar30);
      }
      else {
        iVar39 = 1;
        puVar29 = (undefined4 *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006a95d0)(param_1);
        ...
        puVar29[9] = pcVar34;
        puVar25 = PTR_CRYPTO_free_006a6e88;
        *puVar29 = 1;
  ...
  if (local_1c != *(int *)puVar26) {
    ...
    iVar28 = (*(code *)PTR_CRYPTO_malloc_006a7008)(0x28,"gost_pmeth.c",0x196);
    if (iVar28 == 0) {
      return 0;
    }
    (*(code *)PTR_memset_006a99f4)(iVar28,0,0x28);
    (*(code *)PTR_EVP_PKEY_CTX_set_data_006a95e0)(iVar27,iVar28);
    puVar29 = (undefined4 *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006a95d0)(pcVar34);
    puVar30 = (undefined4 *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006a95d0)(iVar27);
    puVar36 = puVar29;
    do {
      puVar33 = puVar30;
      puVar32 = puVar36;
