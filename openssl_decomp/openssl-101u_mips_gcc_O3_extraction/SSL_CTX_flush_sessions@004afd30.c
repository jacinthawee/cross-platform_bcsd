...

{
  ...
  if (local_18 != (lhash_st_SSL_SESSION *)0x0) {
    local_1c = tm;
    CRYPTO_lock(9,0xc,"ssl_sess.c",0x475);
    ...
    CRYPTO_lock(10,0xc,"ssl_sess.c",0x47b);
  }
  if (local_14 != *(int *)puVar2) {
    ...
    if ((((SSL *)ctx)->session != (SSL_SESSION *)0x0) && ((((SSL *)ctx)->shutdown & 1U) == 0)) {
      ...
      if (((((uVar3 & 0x3000) == 0) && (uVar3 = SSL_state((SSL *)ctx), (uVar3 & 0x4000) == 0)) &&
        ...
        pSVar4 = (SSL_SESSION *)
                 (*(code *)PTR_lh_retrieve_006a73b0)(*(undefined4 *)(p_Var10 + 0x10),pSVar8);
        if (pSVar8 == pSVar4) {
          iVar9 = (*(code *)PTR_lh_delete_006a8390)(*(undefined4 *)(p_Var10 + 0x10),pSVar8);
          ...
          *(undefined4 *)(iVar9 + 0x94) = 1;
          ...
          iVar6 = CRYPTO_add_lock((int *)(iVar9 + 0xa4),-1,0xe,"ssl_sess.c",0x36c);
          if (iVar6 < 1) {
