...

{
  ...
  if (ASN1_PRINTABLESTRING_it._16_4_ == 0) {
    if (uVar2 < 7) {
      ...
      pAVar3 = (ASN1_PRINTABLESTRING *)(*(code *)(&switchD_005619f8::switchdataD_0066a17c)[uVar2])()
      ;
      return pAVar3;
    }
  }
                    ...
                    /* WARNING: Treating indirect jump as call */
    pAVar3 = (ASN1_PRINTABLESTRING *)(*(code *)(&switchD_00561550::switchdataD_0066a160)[uVar2])();
    return pAVar3;
  }
