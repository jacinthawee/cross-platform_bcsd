...

{
  ...
  if (*(int *)(param_1 + 0x34) == 0x1190) {
    ...
    if (iVar3 == 6) {
      ...
      iVar3 = (*(code *)PTR_RSA_sign_006a7a78)(0x72,auStack_48,0x24,iVar6 + 0xe,&local_50,piVar5[5])
      ;
      if (iVar3 < 1) goto LAB_0049c020;
      ...
      *(char *)(iVar6 + 0xc) = (char)((uint)local_50 >> 8);
      ...
      if (iVar3 == 0x74) {
        iVar3 = (*(code *)PTR_DSA_sign_006a7a90)
        ...
        iVar3 = (*(code *)PTR_ECDSA_sign_006a7a88)
                          (piVar5[1],auStack_38,0x14,iVar6 + 0xe,&local_4c,piVar5[5]);
        if (iVar3 == 0) {
          uVar4 = 0x2a;
          uVar2 = 0x647;
...
LAB_0049c020:
    ...
    uVar2 = 0x62d;
LAB_0049bf30:
    (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x107,uVar4,"d1_clnt.c",uVar2);
    uVar2 = 0xffffffff;
  }
  return uVar2;
}
