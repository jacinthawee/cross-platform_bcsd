...

{
  ...
  puVar3 = (undefined *)(*(code *)PTR_strchr_006a9a28)(param_1,0x3a);
  ...
  *puVar3 = 0;
  if (param_3 != (undefined *)0x0) {
    iVar4 = (*(code *)PTR___isoc99_sscanf_006a9a04)
  ...
  if (iVar4 == 0) {
    pcVar7 = &DAT_00641018;
    iVar5 = (*(code *)PTR_getservbyname_006a99f0)(puVar3);
    if (iVar5 == 0) {
...
LAB_00460fd0:
  ...
  iVar5 = (*(code *)PTR_strtol_006a9958)();
  if (iVar5 == 0) {
    iVar6 = (*(code *)PTR_getservbyname_006a99f0)(iVar4,&DAT_00641018);
    if (iVar6 != 0) {
