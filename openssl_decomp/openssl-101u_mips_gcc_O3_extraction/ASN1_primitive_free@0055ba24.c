...

{
  ...
  if (it == (ASN1_ITEM *)0x0) {
    ...
    if (iVar3 < 2) goto joined_r0x0055bc14;
    if (iVar3 == 5) goto LAB_0055bb10;
    if (iVar3 == 6) goto LAB_0055bb88;
  }
  else {
    if ((it->funcs != (void *)0x0) &&
       (UNRECOVERED_JUMPTABLE = *(code **)((int)it->funcs + 0xc),
       UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x0055ba70. Too many branches */
                ...
                if (pcVar1 == (char *)0x1) {
                  ...
                  if ((int)pcVar1 < 2) {
                    if (pcVar1 == (char *)0xfffffffc) {
                      ...
                      (*(code *)PTR_CRYPTO_free_006a6e88)(a_01->ln);
                    }
                    else {
LAB_0055bc80:
                    ...
                    if (pcVar1 != (char *)0x6) goto LAB_0055bc80;
                    ASN1_OBJECT_free(a);
                  }
                  a_01->ln = (char **)0x0;
                  a_01 = (ASN1_OBJECT *)a_00->ln;
              ...
              (*(code *)PTR_CRYPTO_free_006a6e88)(a_01);
              a_00->ln = (char **)0x0;
              a_00 = (ASN1_OBJECT *)*pval;
            }
            else {
LAB_0055bc28:
            ...
            if (pcVar1 != (char *)0x5) {
              if (pcVar1 != (char *)0x6) goto LAB_0055bc28;
