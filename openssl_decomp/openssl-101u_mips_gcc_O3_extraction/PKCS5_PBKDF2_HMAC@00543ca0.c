...

{
  ...
  if ((int)pEVar3 < 0) {
    ...
    (*(code *)PTR_HMAC_CTX_init_006a7a1c)(auStack_210);
    if (pass == (char *)0x0) {
      salt_00 = (EVP_MD *)0x0;
    }
    else {
      ...
      if (passlen == -1) {
        salt_00 = (EVP_MD *)(*(code *)PTR_strlen_006a9a24)(pass);
      }
    }
    local_240 = 0;
    iVar4 = (*(code *)PTR_HMAC_Init_ex_006a7acc)(auStack_210);
    if (iVar4 == 0) {
LAB_00544204:
      (*(code *)PTR_HMAC_CTX_cleanup_006a7adc)(auStack_210);
      iVar4 = 0;
      ...
      if (keylen != 0) {
        ...
        do {
          ...
          salt_00 = pEVar3;
          digest = pEVar12;
          iVar4 = (*(code *)PTR_HMAC_CTX_copy_006a8c74)(auStack_140);
          if (iVar4 == 0) goto LAB_00544204;
          pass = (char *)salt;
          salt_00 = (EVP_MD *)saltlen;
          iVar4 = (*(code *)PTR_HMAC_Update_006a7ad0)(auStack_140);
          if (iVar4 == 0) {
LAB_005441dc:
            (*(code *)PTR_HMAC_CTX_cleanup_006a7adc)(auStack_210);
            (*(code *)PTR_HMAC_CTX_cleanup_006a7adc)(auStack_140);
            iVar4 = 0;
            puVar11 = (undefined4 *)pass;
            pEVar12 = digest;
            goto LAB_0054419c;
          ...
          pass = &local_70;
          iVar4 = (*(code *)PTR_HMAC_Update_006a7ad0)(auStack_140);
          if (iVar4 == 0) goto LAB_005441dc;
          salt_00 = (EVP_MD *)0x0;
          pass = (char *)&local_6c;
          iVar4 = (*(code *)PTR_HMAC_Final_006a7ad4)(auStack_140);
          if (iVar4 == 0) goto LAB_005441dc;
          (*(code *)PTR_HMAC_CTX_cleanup_006a7adc)(auStack_140);
          pass = (char *)&local_6c;
          salt_00 = pEVar12;
          (*(code *)PTR_memcpy_006a9aec)(out);
          if (1 < iter) {
...
LAB_005440ac:
            do {
              pass = (char *)auStack_210;
              iVar6 = (*(code *)PTR_HMAC_CTX_copy_006a8c74)(auStack_140);
              if (iVar6 == 0) goto LAB_00544204;
              pass = (char *)&local_6c;
              salt_00 = pEVar3;
              iVar6 = (*(code *)PTR_HMAC_Update_006a7ad0)(auStack_140);
              if (iVar6 == 0) goto LAB_005441dc;
              salt_00 = (EVP_MD *)0x0;
              pass = (char *)&local_6c;
              iVar6 = (*(code *)PTR_HMAC_Final_006a7ad4)(auStack_140);
              if (iVar6 == 0) goto LAB_005441dc;
              (*(code *)PTR_HMAC_CTX_cleanup_006a7adc)(auStack_140);
              if (0 < (int)pEVar12) {
                puVar9 = (uint *)out;
                ...
                if (&SUB_00000002 < (undefined *)((int)&pEVar12[-1].md_ctrl + 3)) {
                  *(uint *)out = local_6c ^ *(uint *)out;
                  ...
                  if (pEVar12 == (EVP_MD *)(iVar4 * 4)) goto LAB_00544098;
                }
