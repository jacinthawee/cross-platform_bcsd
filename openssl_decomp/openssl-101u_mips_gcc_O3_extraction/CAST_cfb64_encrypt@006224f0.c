...

{
  ...
  if (enc == 0) {
    ...
    if (length != 0) {
      do {
        ...
        if (uStack_78 == 0) {
          ...
          (**(code **)((int)puVar15 + -0x5514))(unaff_s8);
    ...
    do {
      if (uStack_78 == 0) {
        local_34 = *(uint *)ivec;
        local_30 = *(uint *)(ivec + 4);
        (*(code *)local_40[-0x1545])(unaff_s8,schedule);
        length = local_34 >> 0x10;
        ivec[3] = (uchar)local_34;
        out = (uchar *)(local_30 >> 0x18);
        ivec[7] = (uchar)local_30;
  ...
  *num = uStack_78;
  ...
  if (length != 0) {
    ...
    do {
      if (uVar12 == 0) {
        iVar5 = iVar5 + 1;
        (*(code *)PTR_CAST_encrypt_006a98cc)(&uStack_8c,pCVar11);
  ...
  *puStack_3c = uVar12;
  ...
  ppuVar7 = (uint **)(*(code *)PTR_BN_CTX_get_006a852c)(length);
  if (ppuVar7 == (uint **)0x0) {
    (*(code *)PTR_BN_CTX_end_006a8530)(length);
    return;
  }
  iVar5 = (*(code *)PTR_BN_copy_006a8450)(ppuVar6,puStack_3c);
  if (iVar5 == 0) {
LAB_00622a04:
    (*(code *)PTR_BN_CTX_end_006a8530)(length);
    return;
  }
  iVar5 = (*(code *)PTR_BN_copy_006a8450)(ppuVar7,uVar10);
  if (iVar5 != 0) {
    if (ppuVar7[1] != (uint *)0x0) {
      ...
      if (iVar5 != 0) {
        ...
        while (ppuVar3 = ppuVar6, puVar15 != (uint *)0x0) {
          iVar5 = 0;
          while (iVar8 = (*(code *)PTR_BN_is_bit_set_006a8538)(ppuVar3,iVar5), iVar8 == 0) {
            iVar5 = iVar5 + 1;
          }
          iVar5 = (*(code *)PTR_BN_rshift_006a85d4)(ppuVar3,ppuVar3,iVar5);
          if (iVar5 == 0) goto LAB_00622a04;
          iVar5 = (*(code *)PTR_BN_nnmod_006a8548)(ppuVar7,ppuVar7,ppuVar3,length);
          if (iVar5 == 0) break;
          puVar15 = ppuVar7[1];
          ppuVar3[3] = (uint *)0x0;
          ppuVar6 = ppuVar7;
