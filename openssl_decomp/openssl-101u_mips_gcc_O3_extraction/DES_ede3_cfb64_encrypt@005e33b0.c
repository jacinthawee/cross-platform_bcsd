...

{
  ...
  pDStack_100 = (DES_key_schedule *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (enc == 0) {
    ...
    if (length != 0) {
      do {
        ...
        if (pDStack_80 == (DES_key_schedule *)0x0) {
          ...
          local_40 = pDVar14;
          (**(code **)((int)pDVar30 + -0x5770))(pDVar14,ks1,ks2);
    ...
    do {
      ...
      if (pDStack_80 == (DES_key_schedule *)0x0) {
        ...
        local_34 = (uint)(*ivec)[3] << 0x18 |
                   (uint)(*ivec)[1] << 8 | (uint)(*ivec)[2] << 0x10 | (uint)(*ivec)[0];
        (*(code *)local_48[-0xaf].ks[2].deslong[0])(local_40,ks1,ks2,ks3);
        pDVar15 = (DES_key_schedule *)(local_34 >> 0x10);
        (*ivec)[0] = (uchar)local_34;
        length = local_30 >> 8;
        (*ivec)[4] = (uchar)local_30;
  ...
  pDVar14 = local_3c;
  (*(code *)pDVar30[-0xa7].ks[10].deslong[0])();
  uStack_d0 = uStack_44;
  ...
  if (length < 0x41) {
    ...
    if (iStack_38 == 0) {
      if (pDVar27 <= pDVar15) {
        ...
        ppDStack_c4 = (DES_key_schedule **)(&PTR_LAB_00674c14 + (int)pDVar27);
        puStack_c0 = &UNK_00674c5c + (int)pDVar27 * 4;
        ...
        do {
          ...
          pDStack_9c = pDVar14;
          pDStack_98 = pDVar30;
          (*(code *)puStack_e0[-0x15dc])(ppDStack_c8,pDStack_d4,uStack_d0,pDStack_cc);
          ...
          if (pDStack_50 == (DES_key_schedule *)&DAT_00000020) {
            ...
            if (pDStack_50 != (DES_key_schedule *)&DAT_00000040) {
              ...
              if (uStack_b4 == 0) {
                ...
                (*(code *)puStack_e0[-0x14bb])(puStack_b0,iStack_b8,8);
              }
              else {
                uStack_a4 = 0;
                pDStack_a8 = (DES_key_schedule *)0x0;
                (*(code *)puStack_e0[-0x14bb])(puStack_b0,iStack_b8,9);
      ...
      pDStack_100 = (DES_key_schedule *)(&UNK_00674bf0 + (int)pDVar27 * 4);
      puStack_c0 = &UNK_00674c38 + (int)pDVar27 * 4;
      ...
      do {
        ...
        pDStack_9c = pDVar28;
        pDStack_98 = pDVar30;
        (*(code *)puStack_e0[-0x15dc])(ppDStack_c4,pDStack_d4,uStack_d0);
  ...
  uStack_f4 = 0x5e3ffc;
  (*(code *)puStack_e0[-0x14cc])();
  puStack_164 = puStack_e0;
  piStack_148 = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if ((undefined *)((int)pDVar30[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_d8 == 0) {
      ...
      if (pDStack_1fc <= pDVar15) {
        ppcStack_14c = (code **)(&PTR_LAB_00674ca4 + (int)pDStack_1fc);
        ...
        pDStack_1f8 = (DES_key_schedule *)(&PTR_LAB_00674cc8 + (int)pDStack_1fc);
        ...
        do {
          ...
          pDStack_134 = pDVar28;
          pDStack_130 = pDVar17;
          (*(code *)pDStack_170[-0xd3].ks[0xd].deslong[0])(pDVar27,puStack_164);
          if (pDStack_188 != (DES_key_schedule *)0x0) {
          ...
          if (pDStack_154 != (DES_key_schedule *)&DAT_00000020) {
            if (pDStack_154 == (DES_key_schedule *)&DAT_00000040) {
              ...
              if (pDStack_15c == (DES_key_schedule *)0x0) {
                ...
                pDStack_158 = pDVar9;
                (**(code **)((int)pDStack_170[-0xa6].ks + 0x14))
      ...
      pDStack_18c = (DES_key_schedule *)(&switchD_005e4168::switchdataD_00674c80 + (int)pDStack_1fc)
      ;
      pDStack_1f8 = (DES_key_schedule *)(&PTR_LAB_00674cec + (int)pDStack_1fc);
      ...
      while (pDVar9 = pDVar16, pDVar17 = pDVar28, pDStack_1a8 = pDStack_1f4, pDStack_1fc <= pDVar15)
      {
        ...
        pDStack_134 = pDVar17;
        pDStack_130 = pDVar9;
        (*(code *)pDStack_170[-0xd3].ks[0xd].deslong[0])(pDStack_1cc,puStack_164);
        pDVar30 = pDStack_154;
        pDVar27 = pDStack_158;
...
LAB_005e45e4:
  ...
  (*(code *)pDStack_170[-0xa7].ks[10].deslong[0])();
  pDStack_208 = pDStack_170;
  pbVar31 = &_gp;
  pDStack_19c = ks2;
  piStack_1c4 = (int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (pDVar14 != (DES_key_schedule *)0x0) {
    ...
    do {
      if (uStack_210 == 0) {
        ...
        pDVar14 = pDStack_208;
        (**(code **)(pbVar31 + -0x5770))(ivec,pDStack_1cc,pDStack_208,uStack_16c);
        uVar25 = uStack_1bc >> 8;
  ...
  *puStack_1c8 = uStack_210;
  if (iStack_1ac != iVar6) {
    ...
    if (pDVar14 != (DES_key_schedule *)0x0) {
      ...
      do {
        if (uVar8 == 0) {
          (*(code *)PTR_DES_encrypt1_006a84c8)(&uStack_224,uVar19,1);
          iVar6 = iVar6 + 1;
    ...
    *puStack_1d4 = uVar8;
    if (iStack_214 != iVar6) {
      ...
      do {
        ...
        uVar8 = *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
                ...
                *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar19 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar8
        ;
        ...
        uVar21 = uVar8 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar24 & 0xfc)) ^
        ...
        uVar20 = uVar22 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar24 >> 0x1a) + 0x180) * 4) ^
                 ...
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar8 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
                 *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar8 * 0x100 >> 0x1a) + 0x140) * 4);
        ...
        uVar8 = uVar21 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar25 >> 0x1a) + 0x180) * 4) ^
