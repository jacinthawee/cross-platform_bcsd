...

{
  ...
  uVar2 = (uint)X509_CRL_INFO_it[0];
  if (X509_CRL_INFO_it._16_4_ == 0) {
    if (uVar2 < 7) {
                    /* WARNING: Could not recover jumptable at 0x005619f8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      pXVar3 = (X509_CRL_INFO *)(*(code *)(&switchD_005619f8::switchdataD_0066a17c)[uVar2])();
      return pXVar3;
    }
  }
  else if (uVar2 < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    pXVar3 = (X509_CRL_INFO *)(*(code *)(&switchD_00561550::switchdataD_0066a160)[uVar2])();
    return pXVar3;
  }
  if (piVar1 == *(int **)PTR___stack_chk_guard_006a9ae8) {
    return (X509_CRL_INFO *)0x0;
  }
  (*(code *)PTR___stack_chk_fail_006a9ab0)();
  return *(X509_CRL_INFO **)(in[1] + *piVar1);
}
