...

{
  ...
  if (uVar2 < c->Nl) {
    ...
    if (uVar3 != 0) goto LAB_004c5a60;
LAB_004c5b28:
    uVar2 = len >> 6;
    if (uVar2 == 0) goto LAB_004c5b34;
LAB_004c5b78:
    md5_block_data_order(c,data,uVar2);
