...

{
  ...
  local_78 = (int *)PTR___stack_chk_guard_006a9ae8;
  local_88 = &_gp;
  ...
  if ((((in == (uchar *)0x0) || (out == (uchar *)0x0)) || (key == (AES_KEY *)0x0)) ||
    ...
    puVar25 = (uchar *)0x56;
    pcVar21 = "aes_ige.c";
    (*(code *)PTR_OpenSSLDie_006a7c5c)("aes_ige.c",0x56,"in && out && key && ivec");
  ...
  if (1 < (uint)enc) {
    ...
    puVar25 = (uchar *)0x57;
    pcVar21 = "aes_ige.c";
    (**(code **)(local_88 + -0x7184))();
    in_v1 = extraout_v1;
  }
  if ((length & 0xf) == 0) {
    if (enc == 1) goto LAB_004de140;
LAB_004ddd0c:
...
LAB_004de0b0:
  ...
  if ((((ppppppppbVar23 == (byte ********)0x0) || (ppppppppbVar26 == (byte ********)0x0)) ||
    ...
    ppppppppbVar6 = (byte ********)0xde;
    pcVar21 = "aes_ige.c";
    (*(code *)PTR_OpenSSLDie_006a7c5c)("aes_ige.c",0xde,"in && out && key && ivec");
  }
  if (1 < uStack_80) {
    ppppppppbVar6 = (byte ********)0xdf;
    pcVar21 = "aes_ige.c";
    (*(code *)PTR_OpenSSLDie_006a7c5c)
              ("aes_ige.c",0xdf,"(AES_ENCRYPT == enc) || (AES_DECRYPT == enc)");
  }
  pcVar28 = CAST_S_table3 + 0x110;
  if (((uint)ppppppppbStack_90 & 0xf) != 0) {
    pcVar28 = "(length % AES_BLOCK_SIZE) == 0";
    ppppppppbVar6 = (byte ********)0xe0;
    pcVar21 = "aes_ige.c";
    (*(code *)PTR_OpenSSLDie_006a7c5c)();
  }
  if (uStack_80 == 1) {
    ...
    if (&DAT_0000000f < ppppppppbStack_90) {
      ...
      do {
        ...
        (*(code *)PTR_AES_decrypt_006a84d8)(&pppppppbStack_f4,ppppppppbVar17,pAVar29);
        *(byte *)ppppppppbVar17 = *(byte *)ppppppppbVar17 ^ *(byte *)ppppppppbVar9;
      ...
      while( true ) {
        ...
        (*(code *)PTR_AES_decrypt_006a84d8)(&pppppppbStack_f4,ppppppppbVar9,pAVar29);
