...

{
  ...
  do {
    ...
    *(undefined **)((int)register0x00000074 + -0x114c) = PTR___stack_chk_guard_006a9ae8;
    ...
    *(undefined4 *)((int)register0x00000074 + -0x2c) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8
    ;
    (*(code *)PTR_CRYPTO_THREADID_current_006a848c)
              ((undefined *)((int)register0x00000074 + -0x1134));
    unaff_s1 = (char *)(**(code **)(*(int *)((int)register0x00000074 + -0x1160) + -0x695c))
                                 ((undefined *)((int)register0x00000074 + -0x1134));
    *(char **)((int)register0x00000074 + -0x1150) = "-check_ss_sig";
    do {
      unaff_s5 = file;
      ...
      if ((*(uint *)((int)register0x00000074 + -0x1138) & 2) == 0) {
        iVar3 = *(int *)((int)register0x00000074 + -0x1150) + -0x7274;
      }
      else {
      ...
      *(char **)((int)register0x00000074 + -0x1170) = buf_00;
      ...
      uVar1 = (**(code **)(*(int *)((int)register0x00000074 + -0x1160) + -0x53bc))(buf);
      unaff_s5 = buf;
    ...
    *(undefined **)((int)register0x00000074 + -0x230c) = PTR___stack_chk_guard_006a9ae8;
    ...
    *(char **)((int)register0x00000074 + -0x11a4) = unaff_s1;
    unaff_s3 = "%lu:%s:%s:%d:%s\n";
    unaff_s2 = (int *)0x670dcc;
    *(undefined4 *)((int)register0x00000074 + -0x11ac) =
         *(undefined4 *)PTR___stack_chk_guard_006a9ae8;
    (*(code *)PTR_CRYPTO_THREADID_current_006a848c)(unaff_s0);
    uVar1 = (**(code **)(*(int *)((int)register0x00000074 + -0x2320) + -0x695c))(unaff_s0);
    *(undefined4 *)((int)register0x00000074 + -0x2314) = uVar1;
    *(char **)((int)register0x00000074 + -0x2310) = "-check_ss_sig";
    do {
      cb = (cb *)unaff_s8;
      u = unaff_s7;
      ...
      if ((*(uint *)((int)register0x00000074 + -0x22f8) & 2) == 0) {
        iVar3 = *(int *)((int)register0x00000074 + -0x2310) + -0x7274;
      }
      else {
