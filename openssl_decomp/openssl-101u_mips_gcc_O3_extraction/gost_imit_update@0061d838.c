      ...
      if (uVar7 < 8) {
        if (param_3 != 0) {
          ...
          *(undefined *)(iStack_70 + uVar7 + 0x1028) = *(undefined *)param_2;
          ...
          if (uVar4 != 8) {
            iVar10 = uVar7 + 2;
            if (unaff_s1 == 0) goto LAB_0061daec;
            unaff_s1 = param_3 - 2;
...
LAB_0061d980:
      ...
      else if (uVar7 == 8) goto LAB_0061d980;
LAB_0061daec:
...
LAB_0061daa4:
  ...
  iStack_64 = unaff_s3;
  iStack_60 = unaff_s4;
  iVar10 = (*(code *)PTR_ASN1_TYPE_get_006a74b0)(ppiStack_b0);
  if (iVar10 != 0x10) {
    iVar10 = -1;
    goto LAB_0061dcc8;
  }
...
LAB_0061dc74:
      *piVar14 = iVar12;
      ...
      (**(code **)(puStack_80 + -0x52f4))(piStack_a8 + 4,ppiVar11,unaff_s4);
      GOST_CIPHER_PARAMS_free(ppiStack_b0);
      iVar10 = 1;
      goto LAB_0061dcc8;
    }
...
LAB_0061dcc8:
  ...
  puStack_9c = puVar15;
  piStack_b4 = *(int **)PTR___stack_chk_guard_006a9ae8;
...
LAB_0061de70:
  ...
  if (*(int *)(iVar13 + 0x1030) != 0) {
    if (piVar14 == (int *)0x0) goto LAB_0061de70;
  ...
  if (&DAT_00000008 <= piVar14) {
    puVar15 = (undefined *)(iVar13 + 0x1028);
    if (piVar14 == (int *)&DAT_00000008) goto LAB_0061e01c;
    *(int **)(iVar13 + 0x1038) = piVar14;
    goto LAB_0061decc;
  }
