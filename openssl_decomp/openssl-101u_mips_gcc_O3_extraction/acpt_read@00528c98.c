...
int acpt_read(BIO *param_1,void *param_2,BIO *param_3,int param_4)
...
LAB_00528fcc:
    ...
    if ((((BIO *)piVar5[7] != (BIO *)0x0) &&
       ...
       (pBVar2 = BIO_push(param_1,b), pBVar4 = b, pBVar2 == (BIO *)0x0)) goto LAB_00528fcc;
    *piVar5 = 3;
  } while( true );
}
