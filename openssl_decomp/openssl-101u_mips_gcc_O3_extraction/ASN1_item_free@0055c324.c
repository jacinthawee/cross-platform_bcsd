...

{
  ...
  if (uVar2 != 0) {
    if (val == (ASN1_VALUE *)0x0) goto switchD_0055c4c0_caseD_0;
    if (pAVar7 != (ASN1_ITEM *)0x0) goto LAB_0055c390;
    switch(uVar2 & 0xff) {
    default:
...
switchD_0055c6fc_caseD_0:
    ...
    if (pAVar10 != (ASN1_TEMPLATE *)0x0) {
      ...
      if ((pAVar10->flags & 6) == 0) {
        ...
        for (; iVar3 = (*(code *)PTR_sk_num_006a6e2c)(val), iVar8 < iVar3; iVar8 = iVar8 + 1) {
          local_30 = (*(code *)PTR_sk_value_006a6e24)(val,iVar8);
          pAVar7 = pAVar10->item;
...
switchD_0055c4c0_caseD_1:
        ...
        if (0 < iVar8) goto switchD_0055c4c0_caseD_0;
        pAVar7 = it;
          ...
          do {
            ...
            if (pAVar4 != (ASN1_ITEM *)0x0) {
              ...
              if ((*(uint *)pAVar4 & 6) == 0) {
                ...
                pAVar9 = *ppAVar5;
                for (iVar3 = 0; iVar6 = (*(code *)PTR_sk_num_006a6e2c)(pAVar9), iVar3 < iVar6;
                    iVar3 = iVar3 + 1) {
                  local_30 = (*(code *)PTR_sk_value_006a6e24)(pAVar9,iVar3);
                  pAVar7 = (ASN1_ITEM *)pAVar4->funcs;
                  asn1_item_combine_free(&local_30,pAVar7,0);
                }
...
LAB_0055c738:
          ...
          if ((*(uint *)pAVar4 & 6) == 0) {
            ...
            pAVar9 = *ppAVar5;
            for (iVar8 = 0; iVar3 = (*(code *)PTR_sk_num_006a6e2c)(pAVar9), iVar8 < iVar3;
                iVar8 = iVar8 + 1) {
              local_30 = (*(code *)PTR_sk_value_006a6e24)(pAVar9,iVar8);
              pAVar7 = (ASN1_ITEM *)pAVar4->funcs;
              asn1_item_combine_free(&local_30,pAVar7,0);
            }
            (*(code *)PTR_sk_free_006a6e80)(pAVar9);
...
joined_r0x0055c87c:
      ...
      case 6:
        ...
        if (iVar8 == 2) goto switchD_0055c4c0_caseD_0;
        asn1_enc_free((ASN1_VALUE **)(ASN1_ITEM *)&local_34,it);
        local_3c = (ASN1_ITEM *)(it->templates + it->tcount + -1);
      ...
      case 2:
        ...
        if ((-1 < iVar8) && (iVar8 < it->tcount)) goto LAB_0055c738;
        break;
      case 3:
...
switchD_0055c4c0_caseD_0:
  ...
  (*(code *)PTR_memcmp_006a9ad0)(*(undefined4 *)pAVar4,*(undefined4 *)pAVar7,iVar8);
  return;
}
