    ...
    do {
      if (iVar2 != iVar4) {
        do {
          ...
          UNRECOVERED_JUMPTABLE = PTR_EVP_EncodeInit_006a8af4;
          if (piVar7[4] != 1) {
            piVar7[4] = 1;
            *piVar7 = 0;
            piVar7[1] = 0;
          ...
          if (0x5dd < piVar7[1]) {
            (*(code *)PTR_OpenSSLDie_006a7c5c)
                      ("bio_b64.c",0x17a,"ctx->buf_off < (int)sizeof(ctx->buf)");
          }
          iVar2 = *piVar7;
          if (0x5de < iVar2) {
            (*(code *)PTR_OpenSSLDie_006a7c5c)
                      ("bio_b64.c",0x17b,"ctx->buf_len <= (int)sizeof(ctx->buf)");
            iVar2 = *piVar7;
          }
          iVar4 = piVar7[1];
          if (iVar2 < iVar4) {
      ...
      UNRECOVERED_JUMPTABLE = PTR_EVP_EncodeFinal_006a8b00;
      if ((uVar3 & 0x100) == 0) {
...
LAB_0054050c:
      ...
      if (piVar6[2] == 0) goto LAB_0054050c;
      iVar2 = (*(code *)PTR_EVP_EncodeBlock_006a8af8)(piVar6 + 0x1f,(int)piVar6 + 0x65a);
      iVar4 = 0;
      piVar6[1] = 0;
      piVar6[2] = 0;
      *piVar6 = iVar2;
  ...
  if (param_2 < 0xc) {
    ...
    if (param_2 == 10) {
      ...
      iVar4 = piVar6[1];
      if (iVar2 < iVar4) {
        (*(code *)PTR_OpenSSLDie_006a7c5c)("bio_b64.c",0x1f9,"ctx->buf_len >= ctx->buf_off");
        iVar2 = *piVar6;
        iVar4 = piVar6[1];
      }
      if (0 < iVar2 - iVar4) {
    ...
    if (param_2 == 1) {
      ...
      piVar6[5] = 1;
      piVar6[4] = 0;
                    /* WARNING: Could not recover jumptable at 0x005401f4. Too many branches */
    ...
    if (param_2 == 0xd) {
      ...
      iVar4 = piVar6[1];
      if (iVar2 < iVar4) {
        (*(code *)PTR_OpenSSLDie_006a7c5c)("bio_b64.c",0x1f0,"ctx->buf_len >= ctx->buf_off");
        iVar2 = *piVar6;
        iVar4 = piVar6[1];
      }
      iVar2 = iVar2 - iVar4;
    ...
    if (param_2 == 0x65) {
      (*(code *)PTR_BIO_clear_flags_006a8138)(param_1,0xf);
      iVar2 = (*(code *)PTR_BIO_ctrl_006a6e18)(*(undefined4 *)(param_1 + 0x24),0x65,param_3,param_4)
      ;
      (*(code *)PTR_BIO_copy_next_retry_006a8434)(param_1);
      return iVar2;
    }
  ...
  uVar5 = *(undefined4 *)(param_1 + 0x24);
LAB_00540124:
                    /* WARNING: Could not recover jumptable at 0x00540148. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  iVar2 = (*(code *)PTR_BIO_ctrl_006a6e18)(uVar5,param_2,param_3,param_4);
  return iVar2;
}
