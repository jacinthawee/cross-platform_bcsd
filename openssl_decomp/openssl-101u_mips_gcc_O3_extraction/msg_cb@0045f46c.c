...

{
  ...
  if (param_1 != 0) {
    puVar5 = &UNK_0064057c;
    if (param_2 != 0x301) goto LAB_0045f4c4;
LAB_0045f5c4:
    pcVar6 = "TLS 1.0 ";
LAB_0045f4ec:
    pcVar2 = "";
  ...
  puVar5 = &DAT_00640580;
  if (param_2 == 0x301) goto LAB_0045f5c4;
LAB_0045f4c4:
  if (0x301 < param_2) {
    if (param_2 == 0x303) {
      pcVar6 = "TLS 1.2 ";
      ...
      if (param_2 != 0xfeff) goto LAB_0045f5e4;
      pcVar6 = "DTLS 1.0 ";
    }
    goto LAB_0045f4ec;
  }
    ...
    if (param_2 == 2) {
      if (param_5 == 0) {
        (*(code *)PTR_BIO_printf_006a6e38)
                  (param_7,"%s %s%s [length %04lx]%s%s\n",puVar5,&DAT_00640584,"",0,&DAT_00640584,""
                  );
        goto LAB_0045f574;
      }
      pcVar6 = "???";
...
LAB_0045f53c:
      ...
      if (param_5 == 0) {
        (*(code *)PTR_BIO_printf_006a6e38)
                  (param_7,"%s %s%s [length %04lx]%s%s\n",puVar5,pcVar6,pcVar3,0,", Heartbeat",
                   pcVar2);
                    /* WARNING: Could not recover jumptable at 0x0045f864. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*(code *)PTR_BIO_ctrl_006a6e18)(param_7,0xb,0,0);
        return;
      }
      if (*param_4 == '\x01') {
    ...
    if (param_3 != 0x16) goto LAB_0045f53c;
    if (param_5 == 0) {
LAB_0045f7a0:
      pcVar4 = "???";
    }
...
LAB_0045f548:
  ...
  if (param_5 == 0) {
LAB_0045f574:
                    /* WARNING: Could not recover jumptable at 0x0045f5a4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)PTR_BIO_ctrl_006a6e18)(param_7,0xb,0,0);
    return;
  }
LAB_0045f690:
  (*(code *)PTR_BIO_printf_006a6e38)(param_7,&DAT_00669e44);
  uVar7 = 0;
  do {
    if (((uVar7 & 0xf) == 0) && (uVar7 != 0)) {
      (*(code *)PTR_BIO_printf_006a6e38)(param_7,&DAT_00640ab8);
    }
    uVar7 = uVar7 + 1;
    cVar1 = *param_4;
    param_4 = param_4 + 1;
    (*(code *)PTR_BIO_printf_006a6e38)(param_7," %02x",cVar1);
  } while (uVar7 < param_5);
  (*(code *)PTR_BIO_printf_006a6e38)(param_7,"\n");
                    /* WARNING: Could not recover jumptable at 0x0045f74c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)PTR_BIO_ctrl_006a6e18)(param_7,0xb,0,0);
  return;
}
