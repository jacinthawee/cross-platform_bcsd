...

{
  ...
  (*(code *)PTR_CRYPTO_lock_006a8144)(9,0x1e,"eng_pkey.c",0xab);
  if (*(int *)(e + 0x5c) == 0) {
    (*(code *)PTR_CRYPTO_lock_006a8144)(10,0x1e,"eng_pkey.c",0xad);
    ERR_put_error(0x26,0xc2,0x75,"eng_pkey.c",0xaf);
  }
  else {
    (*(code *)PTR_CRYPTO_lock_006a8144)(10,0x1e,"eng_pkey.c",0xb2);
    if (*(code **)(e + 0x4c) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0051a82c. Too many branches */
