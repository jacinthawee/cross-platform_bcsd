...

{
  ...
  uStack_58 = *param_1;
  pppppAVar7 = *(ASN1_VALUE ******)PTR___stack_chk_guard_006a9ae8;
  if (*(uint *)(param_4 + 0x14) == uStack_58) {
    ...
    uVar3 = (*(code *)PTR_BN_num_bits_word_006a859c)(unaff_s0);
    uVar5 = unaff_s0;
    if ((uVar3 & 7) == 0) {
      iVar4 = (int)(uVar3 + 7) >> 3;
      if (param_2 == (byte *)0x0) {
        ...
        if (0 < iVar4) {
          ...
          if ((int)uStack_58 < 0) {
            do {
              ...
              uVar5 = unaff_s0 >> 8;
              if (param_2 == pbVar8 + -1) goto LAB_00552c60;
              uVar5 = unaff_s0 >> 8;
              pbVar8 = pbVar8 + -2;
...
LAB_00552c64:
  ...
  if (uVar5 == 0) {
    if (X509_NAME_ENTRY_it._16_4_ == (undefined4 *)0x0) {
      ...
      if (X509_NAME_ENTRY_it._8_4_ == (uint *)0x0) {
        ...
        if ((*X509_NAME_ENTRY_it._8_4_ & 6) == 0) {
          ...
          for (; iVar10 = (*(code *)PTR_sk_num_006a6e2c)(pppppAVar7), iVar4 < iVar10;
              iVar4 = iVar4 + 1) {
            uStack_68 = (*(code *)PTR_sk_value_006a6e24)(pppppAVar7,iVar4);
    ...
    puVar11 = (undefined1 *)X509_NAME_ENTRY_it._16_4_;
    if (pppppAVar7 == (ASN1_VALUE *****)0x0) goto switchD_0055c4c0_caseD_0;
    if (X509_NAME_ENTRY_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar5 & 0xff) < 7) {
                    /* WARNING: Could not recover jumptable at 0x0055c4c0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        iVar4 = (*(code *)(&switchD_0055c4c0::switchdataD_00669fb0)[uVar5 & 0xff])();
        return iVar4;
      }
      goto switchD_0055c4c0_caseD_0;
    }
  ...
  if (X509_NAME_ENTRY_it._16_4_[4] == 0) {
    ...
    if ((uVar5 & 0xff) < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      iVar4 = (*(code *)(&switchD_0055c6fc::switchdataD_00669fcc)[uVar5 & 0xff])();
      return iVar4;
    }
  }
  else {
    ...
    if ((uVar5 & 0xff) < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      iVar4 = (*(code *)(&switchD_0055c3bc::switchdataD_00669f94)[uVar5 & 0xff])();
      return iVar4;
    }
  }
switchD_0055c4c0_caseD_0:
  if (iStack_64 != *(int *)puVar2) {
    ...
    iVar4 = (*(code *)PTR_memcmp_006a9ad0)(*pppppAVar9,*(undefined4 *)puVar11,ppppAVar6);
    if (iVar4 == 0) {
