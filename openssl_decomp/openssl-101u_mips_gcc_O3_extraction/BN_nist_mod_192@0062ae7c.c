...

{
  ...
  if (uStack_90 == 0) {
    ...
    unaff_s5 = (BIGNUM *)a->d;
    local_5c = ctx;
    iVar3 = (*(code *)PTR_BN_ucmp_006a7fb4)(a,_bignum_nist_p_192_sqr_6121);
    ctx = local_5c;
    if (-1 < iVar3) goto LAB_0062aef0;
    iVar3 = (**(code **)(local_68 + -0x6e2c))(_bignum_nist_p_192);
    if (iVar3 == 0) {
      pBStack_118 = (BIGNUM *)0x0;
      uStack_90 = 1;
      (**(code **)(local_68 + -0x76b0))(r);
    }
    else if (iVar3 < 1) {
      pBVar9 = unaff_s5;
      if (a != r) {
        if (r->dmax < 6) {
          ...
          iVar3 = (**(code **)(local_68 + -0x68bc))(r);
          a = unaff_s5;
          if (iVar3 == 0) goto LAB_0062af10;
          puVar21 = unaff_s5->d;
        }
        else {
          puVar21 = unaff_s5->d;
...
LAB_0062b00c:
        ...
        (**(code **)(local_68 + -0x53ec))(puVar5 + (int)puVar18,0,iVar3);
      }
      else {
        puVar18 = (undefined *)((int)&unaff_s4[-1].neg + 2);
        puVar5 = (uint *)(**(code **)(local_68 + -0x52f4))
                                   (&local_54,&unaff_s5[1].top,(int)unaff_s4 * 4 + -0x18);
        bVar1 = (int)puVar18 < 6;
        if (bVar1) goto LAB_0062b00c;
      }
      uVar27 = pBVar9->top;
      ...
      if (iVar3 == 0) {
        ...
        iVar3 = (**(code **)(local_68 + -0x6860))(pBVar9,pBVar9,_nist_p_192 + (iVar3 + -1) * 0x18,6)
        ;
        unaff_s4 = (BIGNUM *)-iVar3;
      }
      ctx = (BN_CTX *)&DAT_00000006;
      pBStack_118 = pBVar9;
      iVar3 = (**(code **)(local_68 + -0x6860))(auStack_3c,pBVar9,_nist_p_192);
      puVar21 = r->d;
      ppuVar6 = (ulong **)
      ...
      pBStack_118 = a;
      iVar3 = (**(code **)(local_68 + -0x6990))(r);
      uStack_90 = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062aef0:
    uStack_90 = (**(code **)(local_68 + -0x6898))(r,a,_bignum_nist_p_192);
  }
LAB_0062af10:
  ...
  pBStack_9c = *(BIGNUM **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (uStack_114 == 0) {
    ...
    iVar3 = (*(code *)PTR_BN_ucmp_006a7fb4)(pBStack_118,_bignum_nist_p_224_sqr_6157);
    if (-1 < iVar3) goto LAB_0062b390;
    iVar3 = (*(code *)PTR_BN_ucmp_006a7fb4)(_bignum_nist_p_224);
    if (iVar3 == 0) {
      pBStack_1a8 = (BIGNUM *)0x0;
      uStack_114 = 1;
      (*(code *)PTR_BN_set_word_006a7730)(pBStack_10c);
    }
    else if (iVar3 < 1) {
      ...
      if (pBStack_118 != pBStack_10c) {
        if (pBStack_10c->dmax < 7) {
          ...
          iVar3 = (*(code *)PTR_bn_expand2_006a8524)(pBStack_10c);
...
LAB_0062b4b4:
      ...
      if (((int)uVar16 < 0) || (uVar16 == 0)) {
        if (((int)uVar16 >> 0x1f | uVar16) == 0) {
          ...
          pcVar15 = (code *)(((uint)pcVar15 ^ (uint)PTR_bn_add_words_006a8584) & (uint)pBStack_104 ^
      ...
      pBStack_1a8 = pBStack_118;
      iVar3 = (*(code *)PTR_BN_copy_006a8450)(pBStack_10c);
      uStack_114 = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062b390:
    uStack_114 = (*(code *)PTR_BN_nnmod_006a8548)(pBStack_10c,pBStack_118,_bignum_nist_p_224);
  }
LAB_0062b3b0:
  ...
  pBStack_11c = *(BIGNUM **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (uStack_1a4 == 0) {
    ...
    iVar3 = (*(code *)PTR_BN_ucmp_006a7fb4)(pBStack_1a8,_bignum_nist_p_256_sqr_6188);
    if (-1 < iVar3) goto LAB_0062b8f8;
    iVar3 = (*(code *)PTR_BN_ucmp_006a7fb4)(_bignum_nist_p_256);
    if (iVar3 == 0) {
      pBStack_250 = (BIGNUM *)0x0;
      uStack_1a4 = 1;
      (*(code *)PTR_BN_set_word_006a7730)(pBStack_19c);
    }
    else if (iVar3 < 1) {
      ...
      if (pBStack_1a8 != pBStack_19c) {
        if (pBStack_19c->dmax < 8) {
          ...
          iVar3 = (*(code *)PTR_bn_expand2_006a8524)(pBStack_19c);
...
LAB_0062ba28:
      ...
      if (((int)uVar16 < 0) || (uVar16 == 0)) {
        if (((int)uVar16 >> 0x1f | uVar16) == 0) {
          ...
          pcVar15 = (code *)(((uint)pcVar15 ^ (uint)PTR_bn_add_words_006a8584) & (uint)pBStack_194 ^
                            (uint)PTR_bn_add_words_006a8584);
        }
      }
      else {
      ...
      pBStack_250 = pBStack_1a8;
      iVar3 = (*(code *)PTR_BN_copy_006a8450)(pBStack_19c);
      uStack_1a4 = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062b8f8:
    uStack_1a4 = (*(code *)PTR_BN_nnmod_006a8548)(pBStack_19c,pBStack_1a8,_bignum_nist_p_256);
  }
LAB_0062b918:
  ...
  (*(code *)PTR___stack_chk_fail_006a9ab0)();
  puStack_258 = PTR___stack_chk_guard_006a9ae8;
  uStack_24c = pBStack_250->neg;
  puStack_220 = &_gp;
  pBStack_1ac = *(BIGNUM **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (uStack_24c == 0) {
    ...
    pBStack_214 = ctx;
    iVar3 = (*(code *)PTR_BN_ucmp_006a7fb4)(pBStack_250,_bignum_nist_p_384_sqr_6219);
    if (-1 < iVar3) goto LAB_0062c060;
    iVar3 = (**(code **)(puStack_220 + -0x6e2c))(_bignum_nist_p_384);
    if (iVar3 == 0) {
      pBVar9 = (BIGNUM *)0x0;
      uStack_24c = 1;
      (**(code **)(puStack_220 + -0x76b0))(pBStack_254);
    }
    else if (iVar3 < 1) {
      ...
      if (pBStack_250 != pBStack_254) {
        if (pBStack_254->dmax < 0xc) {
          ...
          iVar3 = (**(code **)(puStack_220 + -0x68bc))(pBStack_254);
...
LAB_0062c1b8:
        ...
        (**(code **)(puStack_220 + -0x53ec))(puVar5 + (int)piVar20,0,iVar3);
      }
      else {
        piVar20 = &pBStack_248[-1].dmax;
        puVar5 = (uint *)(**(code **)(puStack_220 + -0x52f4))
      ...
      pcVar15 = *(code **)(puStack_220 + -0x6860);
      ...
      if (((int)uVar16 < 0) || (uVar16 == 0)) {
        if (((int)uVar16 >> 0x1f | uVar16) == 0) {
          ...
          iVar3 = (**(code **)(puStack_220 + -0x685c))
                            (pBStack_250,pBStack_250,_nist_p_384 + ~uVar16 * 0x30,0xc);
          pBStack_244 = (BIGNUM *)-iVar3;
          pcVar15 = (code *)(((uint)pcVar15 ^ *(uint *)(puStack_220 + -0x685c)) & (uint)pBStack_244
                            ^ *(uint *)(puStack_220 + -0x685c));
        }
      }
      else {
        iVar3 = (**(code **)(puStack_220 + -0x6860))
      ...
      pBVar9 = pBStack_250;
      iVar3 = (**(code **)(puStack_220 + -0x6990))(pBStack_254);
      uStack_24c = (uint)(iVar3 != 0);
    }
  }
  else {
LAB_0062c060:
    uStack_24c = (**(code **)(puStack_220 + -0x6898))(pBStack_254,pBStack_250,_bignum_nist_p_384);
  }
LAB_0062c080:
  ...
  uVar16 = pBVar9->neg;
  iStack_25c = *(int *)PTR___stack_chk_guard_006a9ae8;
  uStack_240 = unaff_s6;
  uStack_23c = unaff_s7;
  uStack_238 = unaff_s8;
  if (uVar16 == 0) {
...
LAB_0062cb08:
        ...
        (*(code *)PTR_memset_006a99f4)(auStack_2a0 + iVar23,0,iVar3);
      }
      else {
        puVar25 = auStack_2a0;
        do {
      ...
      iVar3 = (*(code *)PTR_bn_sub_words_006a8580)(auStack_2a0,puVar14,_nist_p_521,0x11);
