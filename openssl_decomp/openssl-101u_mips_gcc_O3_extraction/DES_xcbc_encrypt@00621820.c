    ...
    if (-1 < (int)puVar3) {
      ...
      do {
        ...
        local_30 = uStack_98 ^
                   ...
                   uVar15;
        (*(code *)local_68[-0x1a46])(local_5c,schedule,1);
...
LAB_00621e8c:
      ...
      (*(code *)local_68[-0x1a46])(&local_34,schedule,1);
      uVar16 = uStack_90 ^ local_34;
      uVar15 = uStack_94 ^ local_30;
  ...
  if (iVar8 < 1) {
    ...
    puVar20 = puVar19;
    puVar23 = &local_34;
    if (iVar8 != -8) goto LAB_00621c98;
    goto switchD_00621d64_caseD_0;
  }
  local_5c = &local_34;
  local_58 = (uint *)iVar8;
  puVar3 = puVar19;
  do {
    ...
    (*(code *)local_68[-0x1a46])(local_5c,schedule,0);
...
LAB_00621c98:
  ...
  local_34 = uStack_90;
  local_30 = uStack_94;
  (*(code *)local_68[-0x1a46])(local_5c,schedule);
  ...
  case 5:
    ...
    break;
  case 6:
    goto switchD_00621d64_caseD_6;
  case 7:
    goto switchD_00621d64_caseD_7;
  case 8:
    pbVar11 = pbVar11 + -1;
    *pbVar11 = (byte)(uVar16 >> 0x18);
switchD_00621d64_caseD_7:
    pbVar11 = pbVar11 + -1;
    *pbVar11 = (byte)(uVar16 >> 0x10);
switchD_00621d64_caseD_6:
...
switchD_00621d64_caseD_2:
  pbVar12[-1] = (byte)(uVar15 >> 8);
  pbVar12[-2] = (byte)uVar15;
switchD_00621d64_caseD_0:
  input = (uchar *)puVar21;
...
LAB_00621dac:
  ...
  if (iStack_60 == 0) {
    for (; puStack_168 = &uStack_ac, puStack_dc != (uint *)0x0;
      ...
      if (uStack_f0 == 0) {
        ...
        (**(code **)((int)puVar21 + -0x68f4))(&uStack_ac);
    ...
    if (puVar3 != (uint *)0x0) {
      ...
      do {
        if (uStack_f0 == 0) {
          uStack_ac = *puStack_130;
          uStack_a8 = puStack_130[1];
          (*(code *)puStack_b8[-0x1a3d])(puStack_168,pbStack_e8);
          puVar3 = (uint *)(uStack_ac >> 0x10);
          *(byte *)((int)puStack_130 + 3) = (byte)uStack_ac;
          pbStack_170 = (byte *)(uStack_a8 >> 0x18);
          *(byte *)((int)puStack_130 + 7) = (byte)uStack_a8;
  ...
  if (puVar3 != (uint *)0x0) {
    ...
    do {
      if (uStack_134 == 0) {
        ...
        (**(code **)(puVar22 + -0x68f4))(puStack_64,pbStack_180);
  ...
  *puStack_10c = uStack_134;
  ...
  pbStack_13c = *(byte **)PTR___stack_chk_guard_006a9ae8;
  if (pbStack_1d0 == (byte *)0x0) {
    (*(code *)PTR_CAST_decrypt_006a98c8)(&uStack_144);
  }
  else {
    (*(code *)PTR_CAST_encrypt_006a98cc)(&uStack_144,puVar3);
  }
  ...
  if (iStack_148 == 0) {
    for (; puStack_1b8 = &uStack_194, uStack_1c4 != 0; uStack_1c4 = uStack_1c4 - 1) {
      ...
      if (uStack_1d8 == 0) {
        ...
        (**(code **)((int)puVar3 + -0x5514))(&uStack_194);
    ...
    if (uVar15 != 0) {
      ...
      do {
        if (uStack_1d8 == 0) {
          uStack_194 = *puStack_1d4;
          uStack_190 = puStack_1d4[1];
          (*(code *)puStack_1a0[-0x1545])(puStack_1b8,pbStack_1d0);
          uVar15 = uStack_194 >> 0x10;
          *(char *)((int)puStack_1d4 + 3) = (char)uStack_194;
          pbVar12 = (byte *)(uStack_190 >> 0x18);
          *(char *)((int)puStack_1d4 + 7) = (char)uStack_190;
  ...
  *puStack_14c = uStack_1d8;
  ...
  uVar17 = *puStack_19c;
  iStack_1dc = *(int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (uVar15 != 0) {
    ...
    do {
      if (uVar17 == 0) {
        iVar8 = iVar8 + 1;
        (*(code *)PTR_CAST_encrypt_006a98cc)(&uStack_1ec,pbVar13);
  ...
  *puStack_19c = uVar17;
  ...
  ppuVar4 = (uint **)(*(code *)PTR_BN_CTX_get_006a852c)(uVar15);
  ppuVar5 = (uint **)(*(code *)PTR_BN_CTX_get_006a852c)(uVar15);
  if (ppuVar5 == (uint **)0x0) {
    (*(code *)PTR_BN_CTX_end_006a8530)(uVar15);
    return;
  }
  iVar8 = (*(code *)PTR_BN_copy_006a8450)(ppuVar4,puStack_19c);
  if (iVar8 == 0) {
LAB_00622a04:
    (*(code *)PTR_BN_CTX_end_006a8530)(uVar15);
    return;
  }
  iVar8 = (*(code *)PTR_BN_copy_006a8450)(ppuVar5,uVar16);
  if (iVar8 != 0) {
    if (ppuVar5[1] != (uint *)0x0) {
      if (((int)ppuVar4[1] < 1) || (iVar8 = 0, (**ppuVar4 & 1) == 0)) {
        if (((int)ppuVar5[1] < 1) || ((**ppuVar5 & 1) == 0)) goto LAB_006229cc;
        iVar8 = 0;
      }
      while (iVar6 = (*(code *)PTR_BN_is_bit_set_006a8538)(ppuVar5,iVar8), iVar6 == 0) {
        iVar8 = iVar8 + 1;
      }
      iVar8 = (*(code *)PTR_BN_rshift_006a85d4)(ppuVar5,ppuVar5,iVar8);
      if (iVar8 != 0) {
        puVar3 = ppuVar4[1];
        ...
        while (ppuVar2 = ppuVar4, puVar3 != (uint *)0x0) {
          iVar8 = 0;
          while (iVar6 = (*(code *)PTR_BN_is_bit_set_006a8538)(ppuVar2,iVar8), iVar6 == 0) {
            iVar8 = iVar8 + 1;
          }
          iVar8 = (*(code *)PTR_BN_rshift_006a85d4)(ppuVar2,ppuVar2,iVar8);
          if (iVar8 == 0) goto LAB_00622a04;
          iVar8 = (*(code *)PTR_BN_nnmod_006a8548)(ppuVar5,ppuVar5,ppuVar2,uVar15);
          if (iVar8 == 0) break;
          puVar3 = ppuVar5[1];
          ppuVar2[3] = (uint *)0x0;
          ppuVar4 = ppuVar5;
