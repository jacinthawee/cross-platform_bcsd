...

{
  ...
  if ((uVar2 < 0x9c5) && (uVar2 = (*(code *)PTR_strlen_006a9a24)(param_4), uVar2 < 0x9c5)) {
    uVar4 = t_fromb64(auStack_9e8,param_4);
    iVar6 = (*(code *)PTR_BN_bin2bn_006a7904)(auStack_9e8,uVar4,0);
    *param_2 = iVar6;
    if (iVar6 != 0) {
...
LAB_005c8b9c:
  ...
  piVar3 = (int *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x14,"srp_vfy.c",0x10e);
  if (piVar3 != (int *)0x0) {
    ...
    *piVar3 = iVar5;
    if (iVar5 != 0) {
      ...
      if (iVar5 != 0) {
        ...
        iVar6 = (*(code *)PTR_BUF_strdup_006a6fdc)(iVar6);
        piVar3[2] = iVar6;
        if (iVar6 == 0) {
          (*(code *)PTR_sk_free_006a6e80)(*piVar3);
          (*(code *)PTR_sk_free_006a6e80)(piVar3[1]);
