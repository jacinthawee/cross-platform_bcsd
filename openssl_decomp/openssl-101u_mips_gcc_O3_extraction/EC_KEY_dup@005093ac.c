...

{
  ...
  dst = (undefined4 *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x24,"ec_key.c",0x4b);
  if (dst == (undefined4 *)0x0) {
    ...
    *dst = 1;
    ...
    if ((puVar1 == (undefined4 *)0x0) &&
       (iVar2 = (*(code *)PTR_CRYPTO_add_lock_006a805c)(dst + 6,0xffffffff,0x21,"ec_key.c",0x71),
      ...
      (*(code *)PTR_OPENSSL_cleanse_006a7074)(dst,0x24);
      (*(code *)PTR_CRYPTO_free_006a6e88)(dst);
    }
  }
