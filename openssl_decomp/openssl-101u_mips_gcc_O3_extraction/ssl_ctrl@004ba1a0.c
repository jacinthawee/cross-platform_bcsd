...

{
  ...
  pSVar11 = *ppSVar12;
  if (pSVar11 != (SSL *)0x0) {
    puVar2 = (&switchD_004ba1f4::switchdataD_006496f4)[param_2];
    switch(param_2) {
    default:
      pBVar7 = pSVar11->rbio;
      break;
    ...
    case 6:
      ...
      CRYPTO_add_lock((int *)(param_1->server + 0x2c),1,0x15,"bio_ssl.c",0x183);
      return (SSL *)0x1;
    case 7:
      if (param_1 != param_4) {
        return (SSL *)0x1;
      ...
      if (param_1->server != 0) {
        CRYPTO_add_lock((int *)(param_1->server + 0x2c),-1,0x15,"bio_ssl.c",400);
      }
    ...
    case 0xb:
      ...
      pSVar11 = (SSL *)(*(code *)PTR_BIO_ctrl_006a6e18)(pSVar11->wbio,0xb,param_3,param_4);
    ...
    case 0x6d:
      ...
      ppSVar12 = (SSL **)CRYPTO_malloc(0x18,"bio_ssl.c",0x6a);
      if (ppSVar12 == (SSL **)0x0) {
        (*(code *)PTR_ERR_put_error_006a7f34)(0x20,0x76,0x41,"bio_ssl.c",0x6c);
        return (SSL *)0x0;
      }
      (*(code *)PTR_memset_006a99f4)(ppSVar12,0,0x18);
      param_1->rbio = (BIO *)0x0;
    ...
    pSVar11 = (SSL *)(*(code *)PTR_BIO_ctrl_006a6e18)(pBVar7,param_2,param_3,param_4);
    return pSVar11;
  }
  if (param_2 != 0x6d) {
    return (SSL *)0x0;
...
LAB_004ba22c:
  ...
  *ppSVar12 = param_4;
  ...
  if (pBVar7 != (BIO *)0x0) {
    if (param_1->server != 0) {
      (*(code *)PTR_BIO_push_006a74c4)(pBVar7);
    }
    param_1->server = (int)pBVar7;
    CRYPTO_add_lock(&pBVar7->references,1,0x15,"bio_ssl.c",0x162);
  }
