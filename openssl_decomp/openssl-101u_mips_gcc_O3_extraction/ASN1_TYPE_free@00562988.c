...

{
  ...
  if (uVar3 == 0) {
      ...
      if (ASN1_ANY_it._8_4_ == (uint *)0x0) {
        ...
        if ((*ASN1_ANY_it._8_4_ & 6) == 0) {
          ...
          for (; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(a), iVar7 < iVar4; iVar7 = iVar7 + 1) {
            AStack_34.value.ptr = (char *)(*(code *)PTR_sk_value_006a6e24)(a,iVar7);
    ...
    puVar6 = (undefined1 *)ASN1_ANY_it._16_4_;
    if (a == (ASN1_TYPE *)0x0) goto switchD_0055c4c0_caseD_0;
    if (ASN1_ANY_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
...
switchD_0055c4c0_caseD_0:
  ...
  (*(code *)PTR_memcmp_006a9ad0)(pAVar5->type,*(undefined4 *)puVar6,iVar7,in_a3,&_gp);
  return;
}
