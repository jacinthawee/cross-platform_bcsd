...

{
  ...
  p8inf = (PKCS8_PRIV_KEY_INFO *)(*(code *)PTR_EVP_PKEY2PKCS8_006a8e9c)(param_2);
  if (p8inf == (PKCS8_PRIV_KEY_INFO *)0x0) {
    ...
    if (param_3 == 0) {
      iVar2 = PEM_ASN1_write_bio(PTR_i2d_PKCS8_PRIV_KEY_INFO_006a8ea4,"PRIVATE KEY",param_1,p8inf,
    ...
    if (param_6 == 0) {
      ...
      p8 = (X509_SIG *)
           (*(code *)PTR_PKCS8_encrypt_006a7cbc)(param_4,param_5,acStack_42c,iVar2,0,0,0,p8inf);
      (*(code *)PTR_OPENSSL_cleanse_006a7074)(acStack_42c,iVar2);
    }
    else {
      p8 = (X509_SIG *)
           (*(code *)PTR_PKCS8_encrypt_006a7cbc)(param_4,param_5,param_6,param_7,0,0,0,p8inf);
    }
    PKCS8_PRIV_KEY_INFO_free(p8inf);
    if (p8 == (X509_SIG *)0x0) {
      iVar2 = 0;
      ...
      if (param_3 == 0) {
        iVar2 = PEM_ASN1_write_bio(PTR_i2d_X509_SIG_006a8734,"ENCRYPTED PRIVATE KEY",param_1,p8,
                                   (EVP_CIPHER *)0x0,(uchar *)0x0,0,(undefined1 *)0x0,(void *)0x0);
      }
      else {
