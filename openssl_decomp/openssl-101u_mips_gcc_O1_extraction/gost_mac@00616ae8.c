...

{
  ...
  local_48 = (int **)PTR___stack_chk_guard_006a9ae8;
...
LAB_006173b0:
  ...
  ppuStack_b0 = (uint **)PTR___stack_chk_guard_006a9ae8;
  uStack_a0 = param_3[1];
  puVar10 = *(uint **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (local_58 < &DAT_00000008) {
    if (local_58 == (uint *)0x0) goto LAB_00617c8c;
    puVar10 = (uint *)0x0;
    puVar14 = (uint *)&DAT_00000008;
LAB_00617d20:
    uStack_9c = 0;
    uStack_98 = 0;
    uVar33 = (*(code *)PTR___memcpy_chk_006a9a48)
    ...
    if (puVar10 < local_58) goto LAB_00617d20;
  }
...
LAB_00617c8c:
  ...
  if ((int)puVar20 < 1) {
    ...
    puVar10 = &uStack_a4;
    (**(code **)(puStack_c0 + -0x52f4))(iStack_b4,puVar10,puVar20);
  }
  puStack_f8 = puVar20;
  if (uStack_f4 != 0) {
  ...
  puVar14 = (uint *)PTR___stack_chk_guard_006a9ae8;
  puVar32 = auStack_140;
  pbVar25 = &bStack_11c;
  puStack_130 = &_gp;
  ...
  *puVar10 = uStack_124;
  ...
  while( true ) {
    ...
    *(undefined4 *)(puVar32 + -0x24) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8;
    puVar11 = puVar5;
    puVar14 = puVar13;
    puVar3 = (uint *)(*(code *)PTR_DH_new_006a751c)();
    ...
    if (puVar3 == (uint *)0x0) {
      ...
      (**(code **)(puVar29 + -0x53ec))(puVar10,0,0x80);
      puVar20 = puVar32 + -0xa4;
      uVar2 = (**(code **)(*(int *)(puVar32 + -0x1a0) + -0x6bc8))(*(undefined4 *)(puVar5[5] + 0x14))
      ;
      iVar30 = *(int *)(puVar32 + -0x1a0);
      puVar3[3] = uVar2;
      uVar2 = (**(code **)(iVar30 + -0x6bc8))(*(undefined4 *)(puVar5[5] + 0xc));
      pcVar28 = *(code **)(*(int *)(puVar32 + -0x1a0) + -0x6bc8);
      puVar3[2] = uVar2;
      uVar2 = (*pcVar28)(uVar8);
      pcVar28 = *(code **)(*(int *)(puVar32 + -0x1a0) + -0x5808);
      puVar3[6] = uVar2;
      iVar4 = (*pcVar28)(puVar5);
      puVar11 = *(uint **)(iVar4 + 0x18);
      puVar14 = puVar3;
      puVar26 = (uint *)(**(code **)(*(int *)(puVar32 + -0x1a0) + -0x6e3c))(puVar20);
      puVar24 = puVar3;
      if (puVar26 == (uint *)0x0) {
        (**(code **)(*(int *)(puVar32 + -0x1a0) + -0x78d8))(puVar3);
        uVar2 = 0;
        puVar29 = *(undefined **)(puVar32 + -0x1a0);
      }
      else {
        (**(code **)(*(int *)(puVar32 + -0x1a0) + -0x53ec))(puVar10,0,0x80);
        ...
        (**(code **)(iVar31 + -0x78d8))(puVar3);
        init_gost_hash_ctx(puVar20,*(undefined4 *)(*(int *)(puVar32 + -0x1a0) + -0x5814));
        start_hash(puVar20);
    ...
    *(undefined **)(puVar32 + -0x1c8) = &_gp;
    puVar5 = (uint *)(*(code *)PTR_EVP_PKEY_CTX_get0_peerkey_006a9824)();
    uVar33 = (**(code **)(*(int *)(puVar32 + -0x1c8) + -0x580c))(iVar4);
    *puVar14 = 0x20;
    if (puVar11 == (uint *)0x0) {
      return 1;
    }
