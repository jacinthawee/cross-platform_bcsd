    ...
    *(undefined4 *)((int)register0x00000074 + -0x2c) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8
    ...
    if (hwcrhk_context == 0) {
      ...
      *(undefined4 *)((int)register0x00000074 + -0x478) = 0x39a;
      ...
      (*(code *)PTR_bn_expand2_006a8524)(param_2,*unaff_s3);
      iVar2 = *unaff_s8;
      iVar5 = *unaff_s3;
      piVar10 = *ppiVar6;
      pcVar9 = *param_4;
      ...
      *(undefined4 *)((int)register0x00000074 + -0x43c) = uVar8;
      ...
      if (iVar5 < 0) {
        if (iVar5 == -2) {
          if (HWCRHK_lib_error_code == 0) {
            HWCRHK_lib_error_code = (**(code **)(puVar14 + -0x58a8))();
            puVar14 = *(undefined **)((int)register0x00000074 + -0x460);
          }
          pcVar12 = *(code **)(puVar14 + -0x6eac);
