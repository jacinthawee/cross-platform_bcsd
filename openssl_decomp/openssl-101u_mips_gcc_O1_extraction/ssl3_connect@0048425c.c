...

{
  ...
  *puVar2 = 0;
  ...
  if (((uVar3 & 0x3000) == 0) ||
     (uVar3 = (*(code *)PTR_SSL_state_006a7808)(param_1), (uVar3 & 0x4000) != 0)) {
...
LAB_00484378:
  uVar13 = uVar3;
  if (0x1181 < (int)uVar3) goto LAB_0048442c;
LAB_00484388:
  puVar1 = PTR_BIO_ctrl_006a6e18;
  if (0x117f < (int)uVar13) {
    ...
    if (0 < iVar4) {
      ...
      param_1[0xd] = uVar14;
      if ((uVar3 & 0x10) == 0) goto LAB_00484930;
      param_1[0xd] = 0x11a0;
      param_1[0x11] = 0;
      goto LAB_00484830;
    }
  ...
  if ((int)uVar13 < 0x1132) {
    if ((int)uVar13 < 0x1130) {
      if (uVar13 == 0x1100) {
        ...
        if (0 < iVar4) {
          puVar5 = (uint *)param_1[0x16];
          param_1[6] = 1;
          param_1[0xd] = puVar5[0xd4];
          goto LAB_00484830;
        }
        goto LAB_00484ac8;
      }
      if ((int)uVar13 < 0x1101) {
        if (uVar13 == 0x1000) goto LAB_0048478c;
        if (uVar13 == 0x1003) goto LAB_0048478c;
        if (uVar13 == 3) {
          ...
          if ((*(uint *)param_1[0x16] & 4) == 0) {
            (*(code *)PTR_ssl_free_wbio_buffer_006a801c)(param_1);
          }
          puVar1 = PTR_ssl_update_cache_006a802c;
          param_1[0x11] = 0;
          param_1[100] = 0;
          param_1[10] = 0;
        ...
        if ((int)uVar13 < 0x1112) {
          ...
          if (0 < iVar4) {
            param_1[0x11] = 0;
            param_1[0xd] = 0x1120;
            if (param_1[5] == param_1[4]) goto LAB_00484650;
            uVar3 = (*(code *)PTR_BIO_push_006a74c4)();
            puVar5 = (uint *)param_1[0x16];
            param_1[4] = uVar3;
            goto LAB_00484830;
          }
          ...
          if (1 < uVar13 - 0x1120) goto LAB_004849b4;
          ...
          if (0 < iVar4) {
            ...
            if (*(int *)(uVar3 + 0x354) != 0) goto LAB_00484418;
            goto LAB_00484488;
          }
        }
        goto LAB_00484598;
    ...
    local_30 = 0;
    if ((((int)*param_1 < 0x301) || (param_1[0x5a] == 0)) || (*(int *)(param_1[0x30] + 0xe4) == 0))
    {
      puVar5 = (uint *)param_1[0x16];
LAB_00484ad4:
      if (((*(uint *)(puVar5[0xd1] + 0x10) & 0x404) != 0) ||
         ((*(uint *)(puVar5[0xd1] + 0xc) & 0x100) != 0)) {
        param_1[0x11] = 0;
        uVar13 = 0x1140;
        param_1[0xd] = 0x1140;
        goto LAB_00484620;
...
LAB_00484488:
          if ((param_1[0x3a] == 0) ||
             (iVar4 = (*(code *)PTR_BIO_ctrl_006a6e18)(param_1[4],0xb,0,0), 0 < iVar4)) {
            if (pcVar10 == (code *)0x0) {
LAB_00484418:
              uVar13 = param_1[0xd];
LAB_0048441c:
              do {
                if ((int)uVar13 < 0x1182) goto LAB_00484388;
LAB_0048442c:
                puVar1 = PTR_memcpy_006a9aec;
                if ((int)uVar13 < 0x11e2) {
                  if ((int)uVar13 < 0x11e0) {
                    if ((int)uVar13 < 0x11a2) {
                      if ((int)uVar13 < 0x11a0) goto code_r0x0048444c;
                      iVar4 = ssl3_send_change_cipher_spec(param_1,0x11a0,0x11a1);
                      if (iVar4 < 1) goto LAB_00484598;
                      uVar3 = param_1[0x16];
                      uVar14 = param_1[0x30];
                      iVar4 = *(int *)(uVar3 + 0x41c);
                      uVar8 = *(undefined4 *)(uVar3 + 0x344);
                      ...
                      *(undefined4 *)(uVar14 + 0xb4) = uVar8;
                      ...
                      uVar3 = param_1[2];
                      *(undefined4 *)(uVar14 + 0xb0) = uVar8;
                      iVar4 = (**(code **)(*(int *)(uVar3 + 100) + 8))(param_1);
                      if ((iVar4 == 0) ||
                         (iVar4 = (**(code **)(*(int *)(param_1[2] + 100) + 0x10))(param_1,0x12),
                         iVar4 == 0)) goto LAB_00484c84;
LAB_00484650:
                      puVar5 = (uint *)param_1[0x16];
                    }
                    else {
                      if ((int)uVar13 < 0x11b0) goto LAB_004849b4;
...
LAB_00484930:
                        ...
                        if (1 < uVar13 - 0x11d0) goto LAB_004849b4;
                        puVar5 = (uint *)param_1[0x16];
                        if (puVar5[0x60] == 0) {
                          *puVar5 = *puVar5 | 0x80;
                        }
                  ...
                  if ((int)uVar13 < 0x1200) {
                    if (1 < uVar13 - 0x11f0) goto LAB_004849b4;
                  ...
                  if ((uVar13 != 0x4000) && (uVar13 != 0x5000)) {
                    if (uVar13 != 0x3004) goto LAB_004849b4;
                    param_1[0xd] = 0x1000;
                    param_1[100] = 1;
...
LAB_0048478c:
                  ...
                  param_1[1] = 0x1000;
                  if (param_1[0xf] == 0) {
                    uVar3 = (*(code *)PTR_BUF_MEM_new_006a749c)();
                    if (uVar3 == 0) goto LAB_00484c84;
                    iVar4 = (*(code *)PTR_BUF_MEM_grow_006a74a0)(uVar3,0x4000);
                    puVar1 = PTR_BUF_MEM_free_006a7494;
                    if (iVar4 == 0) {
                      iVar4 = -1;
                      param_1[0xd] = 5;
                      param_1[7] = param_1[7] - 1;
                  ...
                  if (iVar4 == 0) goto LAB_00484ac8;
                  iVar4 = (*(code *)PTR_ssl_init_wbio_buffer_006a8010)(param_1,0);
                  if (iVar4 == 0) goto LAB_00484c84;
                  ...
                  *(int *)(param_1[0x39] + 0x34) = *(int *)(param_1[0x39] + 0x34) + 1;
                  param_1[0x11] = 0;
                  *puVar5 = uVar3 & 0xffffff7f;
                  puVar5[0x60] = 0;
                }
LAB_00484830:
                if (puVar5[0xd5] == 0) goto LAB_00484488;
                uVar13 = param_1[0xd];
              } while( true );
            }
            uVar14 = param_1[0xd];
      ...
      uVar3 = param_1[2];
      uVar14 = param_1[0x42];
      *(uint *)param_1[0x16] = *(uint *)param_1[0x16] | 0x80;
      (**(code **)(uVar3 + 0x30))(param_1,0x1130,0x1131,0xffffffff,uVar14,&local_30);
      puVar5 = (uint *)param_1[0x16];
      *puVar5 = *puVar5 & 0xffffff7f;
      if (local_30 != 0) {
        ...
        if (puVar5[0x60] == 0) goto LAB_00484ad4;
        (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x153,0x85,"s3_clnt.c",0xdb9);
        ...
        if ((int)uVar13 < 0x1162) {
          ...
          if (local_30 == 0) {
            ...
            if (0 < iVar4) {
              ...
              uVar8 = 0x91;
LAB_00484f50:
              (*(code *)PTR_ERR_put_error_006a7f34)(0x14,uVar8,uVar7,"s3_clnt.c",uVar15);
              goto LAB_00484c84;
            }
            puVar5 = (uint *)param_1[0x16];
            uVar3 = *(uint *)(puVar5[0xd1] + 0xc);
...
LAB_00484994:
          ...
          iVar4 = (*(code *)PTR_SRP_Calc_A_param_006a80a0)(param_1);
          if (0 < iVar4) {
            puVar5 = (uint *)param_1[0x16];
            goto LAB_00484994;
          }
          (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x84,0x169,"s3_clnt.c",0x192);
...
LAB_004849b4:
      iVar4 = -1;
      (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x84,0xff,"s3_clnt.c",0x281);
      param_1[7] = param_1[7] - 1;
      goto LAB_004845a4;
    }
    ...
    if (1 < uVar13 - 0x1140) goto LAB_004849b4;
LAB_00484620:
...
LAB_004845a4:
  ...
  (*(code *)PTR_memset_006a99f4)(puVar11 + uVar3 + 6,0,iVar12);
  puVar11[1] = 0;
  ...
  *(undefined4 *)(iVar4 + 0x34) = 0x1201;
  ...
  return iVar4;
code_r0x0048444c:
  if (1 < uVar13 - 0x1190) goto LAB_004849b4;
  iVar4 = ssl3_send_client_verify(param_1);
  if (iVar4 < 1) goto LAB_00484598;
  param_1[0x11] = 0;
  param_1[0xd] = 0x11a0;
  if (*(int *)(param_1[0x16] + 0x354) == 0) goto LAB_00484488;
  goto LAB_00484418;
}
