...

{
  ...
  if (x == (stack_st_X509_ATTRIBUTE **)0x0) {
    ...
    if ((psVar5 != (stack_st_X509_ATTRIBUTE *)0x0) ||
       (psVar5 = (stack_st_X509_ATTRIBUTE *)(*(code *)PTR_sk_new_null_006a6fa4)(),
       psVar5 != (stack_st_X509_ATTRIBUTE *)0x0)) {
      iVar1 = (*(code *)PTR_X509_ATTRIBUTE_dup_006a8f68)(attr);
      if (iVar1 != 0) {
        iVar2 = (*(code *)PTR_sk_push_006a6fa8)(psVar5,iVar1);
        if (iVar2 != 0) {
          if (*x != (stack_st_X509_ATTRIBUTE *)0x0) {
            return psVar5;
          }
  ...
  (*(code *)PTR_ERR_put_error_006a7f34)(0xb,0x87,uVar4,"x509_att.c",uVar3);
  return (stack_st_X509_ATTRIBUTE *)0x0;
}
