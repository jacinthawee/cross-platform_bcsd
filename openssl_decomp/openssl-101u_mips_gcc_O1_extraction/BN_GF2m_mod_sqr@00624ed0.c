...

{
  ...
  iVar1 = iVar1 + 1;
  iVar2 = (*(code *)PTR_CRYPTO_malloc_006a7008)(iVar1 * 4,"bn_gf2m.c",0x265);
  if (iVar2 == 0) {
    return 0;
  }
  iVar3 = param_3[1];
...
LAB_00625030:
    ...
    else if (iVar4 == 0) goto LAB_00624fb4;
    if (iVar4 <= iVar1) {
      iVar4 = BN_GF2m_mod_sqr_arr(param_1,param_2,iVar2,param_4);
      goto LAB_00624fdc;
    }
  }
  (*(code *)PTR_ERR_put_error_006a7f34)(3,0x88,0x6a,"bn_gf2m.c",0x269);
LAB_00624fdc:
