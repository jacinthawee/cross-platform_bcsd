...
LAB_0048bd88:
      ...
      *(undefined4 *)(iVar5 + 0x130) = 0x15;
      ...
      if ((param_1[0xd] == 0x1111) && (param_1[100] == 0)) {
        iVar7 = *param_1;
        if ((iVar7 >> 8 != 3) || (iVar7 < 0x302)) goto LAB_0048bdfc;
        uVar8 = 1;
      }
      else {
        iVar7 = *param_1;
...
LAB_0048be24:
        ...
        uVar6 = (*(code *)PTR_EVP_CIPHER_CTX_flags_006a8108)();
        if ((uVar6 & 0xf0007) == 2) {
          local_2c = (*(code *)PTR_EVP_CIPHER_CTX_iv_length_006a7ff8)(param_1[0x23]);
          if (local_2c < 2) goto LAB_0048be24;
        }
        else {
          if ((uVar6 & 0xf0007) != 6) goto LAB_0048be24;
          local_2c = 8;
        }
      }
      iVar7 = param_1[0x25];
      ...
      *(undefined4 *)(iVar5 + 0x134) = 2;
      if (iVar7 == 0) {
        ...
        *(undefined4 *)(iVar5 + 0x140) = *(undefined4 *)(iVar5 + 0x13c);
        ...
        iVar11 = param_1[0x16];
        iVar7 = (*(code *)PTR_COMP_compress_block_006a811c)
                          (iVar7,*(undefined4 *)(iVar11 + 0x13c),0x4400,
                           *(undefined4 *)(iVar11 + 0x140),*(undefined4 *)(iVar11 + 0x134));
        if (iVar7 < 0) {
          (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x68,0x8d,"s3_pkt.c",0x348);
          goto LAB_0048c0f0;
        }
      ...
      *(undefined **)(iVar5 + 0x13c) = puVar12;
      ...
      if (0 < iVar1) {
        ...
        *(undefined4 *)(iVar1 + 0x170) = 2;
        iVar9 = ssl3_write_pending(param_1,0x15,iVar10,2);
        goto joined_r0x0048c034;
      }
    }
LAB_0048c0f0:
    iVar9 = -1;
