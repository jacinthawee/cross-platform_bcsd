...
LAB_004e70e4:
  ...
  switch(uVar20) {
  default:
    goto switchD_004e6f6c_caseD_7;
  case 0xfffffff9:
    goto LAB_004e6fb8;
  case 0xfffffffa:
    goto switchD_004e6f6c_caseD_fffffffa;
  case 0xfffffffb:
    goto LAB_004e6fa0;
  case 0xfffffffc:
    goto switchD_004e6f6c_caseD_fffffffc;
  case 0xfffffffd:
    break;
  case 0xffffffff:
    puVar16 = local_44 + -1;
