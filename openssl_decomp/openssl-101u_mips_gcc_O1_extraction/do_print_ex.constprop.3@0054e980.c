...

{
  ...
  if ((param_2 & 0x40) == 0) {
    ...
    if ((param_1 != (ASN1_TYPE *)0x0) &&
       ((iVar3 = (*(code *)PTR_fwrite_006a9a74)(pcVar4,1,iVar6,param_1), iVar6 != iVar3 ||
        (iVar3 = (*(code *)PTR_fwrite_006a9a74)(":",1,1,param_1), iVar3 != 1)))) goto LAB_0054ea38;
    local_74 = iVar6 + 1;
  }
  if ((param_2 & 0x80) != 0) {
LAB_0054ea0c:
    if (param_1 == (ASN1_TYPE *)0x0) {
      ...
      iVar9 = (*(code *)PTR_fwrite_006a9a74)(&DAT_006695a8,1,1,param_1);
      if (iVar9 != 1) goto LAB_0054ea38;
      ...
      if ((byte *)param_3.ptr != pbVar13) {
        do {
          ...
          iVar6 = (*(code *)PTR_fwrite_006a9a74)(&local_38,1,2,param_1);
          if (iVar6 != 2) goto LAB_0054ea38;
          pbVar13 = pbVar13 + 1;
...
LAB_0054f4e4:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_0054f4e4;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f4c8:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_0054f4c8;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f500:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_0054f500;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f4ac:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_0054f4ac;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f524:
              ...
              if ((uVar7 & 0x61) == 0) goto LAB_0054f490;
LAB_0054ee00:
              if ((uVar7 & 8) == 0) {
                local_78 = local_78 + 2;
              }
...
LAB_0054f46c:
              ...
              if ((uVar5 & 0x61) == 0) goto LAB_0054f46c;
              if ((uVar5 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f670:
              ...
              uVar8 = uVar7 & (byte)char_type[local_40[1]];
              if ((uVar8 & 0x61) == 0) goto LAB_0054f670;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f64c:
              ...
              uVar8 = uVar7 & (byte)char_type[local_40[2]];
              if ((uVar8 & 0x61) == 0) goto LAB_0054f64c;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f628:
              ...
              uVar8 = uVar7 & (byte)char_type[local_40[3]];
              if ((uVar8 & 0x61) == 0) goto LAB_0054f628;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0054f604:
              ...
              uVar8 = uVar7 & (byte)char_type[local_3c];
              if ((uVar8 & 0x61) == 0) goto LAB_0054f604;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
            ...
            if (iVar9 != 5) {
              if ((char)local_3b < '\0') {
                ...
                uVar7 = uVar7 & (byte)char_type[local_3b];
                if ((uVar7 & 0x61) != 0) goto LAB_0054ee00;
              }
              iVar9 = 1;
              if ((uVar7 & 6) != 0) goto LAB_0054f524;
              if (local_3b == 0x5c) {
                iVar9 = 2;
              }
              local_78 = local_78 + iVar9;
...
LAB_0054ee18:
  ...
  if (local_4d == '\0') {
    iVar9 = local_78;
    if (param_1 == (ASN1_TYPE *)0x0) goto LAB_0054ea40;
  }
  else {
    local_78 = local_78 + 2;
    iVar9 = local_78;
    if (param_1 == (ASN1_TYPE *)0x0) goto LAB_0054ea40;
    iVar9 = (*(code *)PTR_fwrite_006a9a74)(&DAT_00679c10,1,1,param_1);
    if (iVar9 != 1) goto LAB_0054ea38;
  }
  pcVar4 = (param_3.object)->sn;
    ...
    do {
      while( true ) {
        ...
        if ((byte *)param_3.ptr == (byte *)0x1) {
          ...
          iVar9 = -1;
          if (param_3.ptr != &SUB_00000004) goto LAB_0054ea40;
          local_48.type =
               (uint)*(byte *)((int)puVar12 + 3) |
               (uint)*(byte *)(puVar12 + 1) << 8 |
               (uint)*(byte *)((int)puVar12 + 1) << 0x10 | (uint)*(byte *)puVar12 << 0x18;
        ...
        if (iVar9 < 0) goto LAB_0054ea38;
        if (puVar11 == puVar12) goto LAB_0054f004;
      }
      pbVar13 = local_40;
      ...
      if (0 < iVar9) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar18 & 0x61) == 0) goto LAB_0054f044;
            if ((uVar18 & 8) == 0) {
              iVar9 = (*(code *)PTR_fwrite_006a9a74)(&DAT_00669598,1,1,param_1);
              if (iVar9 != 1) goto LAB_0054ea38;
              iVar9 = (*(code *)PTR_fwrite_006a9a74)(&local_4c,1,1,param_1);
            }
            else {
LAB_0054efcc:
              iVar9 = (*(code *)PTR_fwrite_006a9a74)(&local_4c,1,1,param_1);
...
joined_r0x0054f204:
            pbVar13 = pbVar13 + 1;
            if (pbVar15 == pbVar13) goto LAB_0054eff8;
          }
          uVar18 = param_2 & 4;
LAB_0054f044:
          if ((uVar18 & 6) == 0) {
            if ((bVar1 != 0x5c) || (uVar16 == 0)) goto LAB_0054efcc;
            iVar9 = (*(code *)PTR_fwrite_006a9a74)(&DAT_006695a4,1,2,param_1);
            if (iVar9 == 2) goto joined_r0x0054f204;
            goto LAB_0054ea38;
          }
          (*(code *)PTR_BIO_snprintf_006a6f60)(&local_38,0xb,"\\%02X");
          iVar9 = (*(code *)PTR_fwrite_006a9a74)(&local_38,1,3,param_1);
          if (iVar9 != 3) goto LAB_0054ea38;
          pbVar13 = pbVar13 + 1;
...
LAB_0054f004:
  iVar9 = local_78;
  if (local_4d == '\0') goto LAB_0054ea40;
  iVar6 = (*(code *)PTR_fwrite_006a9a74)(&DAT_00679c10,1,1,param_1);
  if (iVar6 == 1) goto LAB_0054ea40;
LAB_0054ea38:
  do {
    iVar9 = -1;
LAB_0054ea40:
