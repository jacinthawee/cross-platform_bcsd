...

{
  ...
  puVar2 = (undefined4 *)(*(code *)PTR_CRYPTO_malloc_006a7008)(4,"eng_lib.c",0xa8);
  ...
  *puVar2 = param_1;
  ...
  if (iVar3 < p_Var1->num_alloc) {
    ...
    ppcVar4 = (char **)(*(code *)PTR_CRYPTO_realloc_006a7b58)
                                 (p_Var1->data,p_Var1->num_alloc << 3,"stack.c",0x99);
    if (ppcVar4 == (char **)0x0) {
      return 0;
    }
    iVar5 = p_Var1->num;
