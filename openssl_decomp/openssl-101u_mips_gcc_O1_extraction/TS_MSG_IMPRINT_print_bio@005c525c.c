...

{
  ...
  if (iVar2 == 0) {
    ...
    pcVar3 = (char *)(*(code *)PTR_OBJ_nid2ln_006a711c)(iVar2);
  }
  (*(code *)PTR_BIO_printf_006a6e38)(param_1,"Hash Algorithm: %s\n",pcVar3);
  (*(code *)PTR_BIO_printf_006a6e38)(param_1,"Message data:\n");
  puVar1 = (undefined4 *)TS_MSG_IMPRINT_get_msg(param_2);
  (*(code *)PTR_BIO_dump_indent_006a7334)(param_1,puVar1[2],*puVar1,4);
  return 1;
}
