...

{
  ...
  iVar1 = (*(code *)PTR_BN_copy_006a8450)(param_1 + 0x48);
  if (iVar1 != 0) {
    iVar1 = param_1 + 0x5c;
    uVar2 = (*(code *)PTR_BN_GF2m_poly2arr_006a9694)(param_1 + 0x48,iVar1,6);
    if ((uVar2 & 0xfffffffd) == 4) {
      iVar5 = param_1 + 0x74;
      iVar3 = (*(code *)PTR_BN_GF2m_mod_arr_006a9698)(iVar5,param_3,iVar1);
      if (iVar3 != 0) {
        ...
        if (*(int *)(param_1 + 0x7c) < iVar3 >> 5) {
          iVar3 = (*(code *)PTR_bn_expand2_006a8524)(iVar5);
          if (iVar3 == 0) {
            return 0;
          }
        }
        ...
        iVar1 = (*(code *)PTR_BN_GF2m_mod_arr_006a9698)(param_1 + 0x88,param_4,iVar1);
        if (iVar1 != 0) {
          ...
          if (iVar3 < iVar1 >> 5) {
            iVar1 = (*(code *)PTR_bn_expand2_006a8524)(param_1 + 0x88);
            if (iVar1 == 0) {
              return 0;
            }
            iVar3 = *(int *)(param_1 + 0x90);
      ...
      (*(code *)PTR_ERR_put_error_006a7f34)(0x10,0xc3,0x83,"ec2_smpl.c",0xdb);
    }
  }
  return 0;
}
