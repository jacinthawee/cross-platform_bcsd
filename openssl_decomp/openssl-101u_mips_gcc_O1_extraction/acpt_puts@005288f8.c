...
int acpt_puts(BIO *param_1,void *param_2,BIO *param_3,int param_4)
...
LAB_00528a7c:
    ...
    callback = (callback *)
               BIO_get_callback(param_1,iVar4,(char *)param_3,param_4,in_stack_ffffffc0,
                                in_stack_ffffffc4);
