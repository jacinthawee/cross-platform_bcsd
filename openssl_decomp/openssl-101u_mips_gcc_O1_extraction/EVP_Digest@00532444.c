...

{
  ...
  local_2c = *(EVP_MD_CTX **)PTR___stack_chk_guard_006a9ae8;
...
LAB_005324e4:
    ...
    if (iVar2 == 0) goto LAB_005324e4;
    if (0x40 < (local_44.digest)->md_size) {
      (*(code *)PTR_OpenSSLDie_006a7c5c)("digest.c",0x10c,"ctx->digest->md_size <= EVP_MAX_MD_SIZE")
      ;
    }
    ...
    uVar4 = (uint)(iVar2 != 0);
    (*(code *)PTR_OPENSSL_cleanse_006a7074)(local_44.md_data,(local_44.digest)->ctx_size);
  }
  if (local_44.digest != (EVP_MD *)0x0) {
    if ((local_44.digest)->cleanup != (_func_1082 *)0x0) {
      ...
      if (local_44.digest == (EVP_MD *)0x0) goto LAB_0053252c;
    }
    if (((local_44.digest)->ctx_size != 0) && (local_44.md_data != (void *)0x0)) {
      iVar2 = EVP_MD_CTX_test_flags(&local_44,4);
      if (iVar2 == 0) {
        (*(code *)PTR_OPENSSL_cleanse_006a7074)(local_44.md_data,(local_44.digest)->ctx_size);
        (*(code *)PTR_CRYPTO_free_006a6e88)(local_44.md_data);
      }
    }
  }
LAB_0053252c:
  ...
  ctx = local_2c;
  iVar2 = (*(code *)PTR___stack_chk_fail_006a9ab0)();
  ...
  if (pEVar3 != (EVP_MD *)0x0) {
    if (pEVar3->cleanup != (_func_1082 *)0x0) {
      ...
      pEVar3 = ctx->digest;
      if (pEVar3 == (EVP_MD *)0x0) goto LAB_00532728;
    }
...
LAB_00532728:
  ...
  iVar2 = (*(code *)PTR_CRYPTO_free_006a6e88)(ctx);
  return iVar2;
}
