...

{
  ...
  puVar13 = param_2;
  iVar2 = param_3;
  (*(code *)PTR_BN_init_006a857c)(puStack_d0);
...
LAB_005dae34:
      (*pcVar24)(puStack_dc);
      param_3 = iVar2;
      if (puStack_e0 != (undefined4 *)0x0) goto LAB_005dae44;
    }
    piStack_d8 = (int *)0x0;
  }
...
LAB_005dae44:
    ...
    if ((((int)puStack_dc[2] < 5) &&
        (iVar2 = (**(code **)(local_70 + -0x68bc))(puStack_dc,5), iVar2 == 0)) ||
       (((int)puStack_e0[2] < 5 &&
        (iVar2 = (**(code **)(local_70 + -0x68bc))(puStack_e0,5), iVar2 == 0)))) {
      if (UBSEC_lib_error_code == 0) {
        UBSEC_lib_error_code = (**(code **)(local_70 + -0x58a8))();
      }
      param_3 = 0x65;
      param_4 = "e_ubsec.c";
      local_a8 = 0x301;
      puVar13 = (undefined4 *)0x66;
      (**(code **)(local_70 + -0x6eac))(UBSEC_lib_error_code);
LAB_005dae30:
      pcVar24 = *(code **)(local_70 + -0x7dc4);
      iVar2 = param_3;
      goto LAB_005dae34;
    }
    iVar2 = (**(code **)(local_70 + -0x74dc))(param_1,param_2,puStack_d0);
    if (iVar2 == 0) {
      if (UBSEC_lib_error_code == 0) {
        UBSEC_lib_error_code = (**(code **)(local_70 + -0x58a8))();
      }
    ...
    unaff_s6 = (undefined *)(*p_UBSEC_ubsec_open)("/dev/ubskey");
    if ((int)unaff_s6 < 1) {
      unaff_s6 = &_gp_1;
      if (UBSEC_lib_error_code == 0) {
        UBSEC_lib_error_code = (**(code **)(local_70 + -0x58a8))();
      ...
      param_4 = "e_ubsec.c";
      local_a8 = 0x30d;
      (**(code **)(local_70 + -0x6eac))(UBSEC_lib_error_code,0x66,0x6c);
LAB_005dae04:
      iVar2 = (**(code **)(local_70 + -0x6694))();
      puVar13 = param_2;
      piStack_d8 = (int *)(**(code **)(iVar2 + 4))(param_1);
      if (piStack_d8 == (int *)0x0) goto LAB_005dae30;
    }
    else {
      ...
      if (iVar3 != 0) {
        ...
        param_4 = "e_ubsec.c";
        local_a8 = 0x324;
        (**(code **)(local_70 + -0x6eac))(UBSEC_lib_error_code,0x66,0x6a);
        (*p_UBSEC_ubsec_close)(unaff_s6);
        goto LAB_005dae04;
      }
      (*p_UBSEC_ubsec_close)(unaff_s6);
      puStack_dc[1] = 5;
      pcVar24 = *(code **)(local_70 + -0x6684);
      puStack_e0[1] = 5;
  ...
  (**(code **)(local_70 + -0x6e38))(puStack_d0);
  ...
  if ((((puVar25 == (undefined4 *)0x0) ||
    ...
    iStack_e8 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar25);
    iVar2 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar18);
    ...
    if (max_key_len < iStack_e8) {
      ...
      if (((int)puVar11[2] <= (int)(puVar25[1] + puVar18[1])) &&
         (iVar2 = (*(code *)PTR_bn_expand2_006a8524)(puVar11,puVar25[1] + puVar18[1] + 1),
         iVar2 == 0)) {
        if (UBSEC_lib_error_code == 0) {
          UBSEC_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006a9538)();
        }
      ...
      if (iVar2 < 1) {
        ...
        uVar14 = *puVar13;
        uVar4 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar13);
        uVar15 = *puVar23;
        uVar5 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar23);
        uVar20 = *puVar19;
        uVar6 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar19);
        uVar16 = *puVar25;
        uVar7 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar25);
        uVar22 = *puVar21;
        uVar8 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar21);
        uVar17 = *puVar18;
        uVar9 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar18);
        ...
        if (iVar3 == 0) {
          ...
          iVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar25);
          iVar10 = (*(code *)PTR_BN_num_bits_006a71f4)(puVar18);
          piVar12 = (int *)0x1;
...
LAB_005db27c:
  ...
  iVar3 = (*(code *)PTR_ENGINE_set_id_006a88c4)(iVar2,"ubsec");
  if (((((iVar3 != 0) &&
        (iVar3 = (*(code *)PTR_ENGINE_set_name_006a88c8)(iVar2,"UBSEC hardware engine support"),
        iVar3 != 0)) &&
       (iVar3 = (*(code *)PTR_ENGINE_set_RSA_006a9544)(iVar2,ubsec_rsa), iVar3 != 0)) &&
      ((((iVar3 = (*(code *)PTR_ENGINE_set_DSA_006a9558)(iVar2,ubsec_dsa), iVar3 != 0 &&
         (iVar3 = (*(code *)PTR_ENGINE_set_DH_006a955c)(iVar2,ubsec_dh), iVar3 != 0)) &&
        ((iVar3 = (*(code *)PTR_ENGINE_set_destroy_function_006a954c)(iVar2,ubsec_destroy),
         iVar3 != 0 &&
         ((iVar3 = (*(code *)PTR_ENGINE_set_init_function_006a88cc)(iVar2,ubsec_init), iVar3 != 0 &&
          (iVar3 = (*(code *)PTR_ENGINE_set_finish_function_006a88d0)(iVar2,ubsec_finish),
          iVar3 != 0)))))) &&
       (iVar3 = (*(code *)PTR_ENGINE_set_ctrl_function_006a88d4)(iVar2,ubsec_ctrl), iVar3 != 0))))
     && (iVar3 = (*(code *)PTR_ENGINE_set_cmd_defns_006a88dc)(iVar2,ubsec_cmd_defns), iVar3 != 0)) {
    ...
    piVar12 = (int *)(*(code *)PTR_ERR_clear_error_006a6ee0)();
    return piVar12;
  }
                    /* WARNING: Could not recover jumptable at 0x005db524. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  piVar12 = (int *)(*(code *)PTR_ENGINE_free_006a6e84)(iVar2);
  return piVar12;
}
