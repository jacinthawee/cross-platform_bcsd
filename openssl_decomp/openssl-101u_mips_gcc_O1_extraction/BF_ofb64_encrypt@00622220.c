...

{
  ...
  if (length != 0) {
    ...
    do {
      if (uStack_6c == 0) {
        ...
        (**(code **)(puVar17 + -0x68f4))(unaff_s3,schedule);
  ...
  *local_44 = uStack_6c;
  ...
  if (pbStack_108 == (byte *)0x0) {
    (*(code *)PTR_CAST_decrypt_006a98c8)(&uStack_7c);
  }
  else {
    (*(code *)PTR_CAST_encrypt_006a98cc)(&uStack_7c,length);
  }
  ...
  if (iStack_80 == 0) {
    for (; puStack_f0 = &uStack_cc, uStack_fc != 0; uStack_fc = uStack_fc - 1) {
      ...
      if (uStack_110 == 0) {
        ...
        (**(code **)((int)puVar18 + -0x5514))(&uStack_cc);
    ...
    if (uVar13 != 0) {
      ...
      do {
        if (uStack_110 == 0) {
          uStack_cc = *puStack_10c;
          uStack_c8 = puStack_10c[1];
          (*(code *)puStack_d8[-0x1545])(puStack_f0,pbStack_108);
          uVar13 = uStack_cc >> 0x10;
          *(char *)((int)puStack_10c + 3) = (char)uStack_cc;
          pbVar11 = (byte *)(uStack_c8 >> 0x18);
          *(char *)((int)puStack_10c + 7) = (char)uStack_c8;
  ...
  *puStack_84 = uStack_110;
  ...
  if (uVar13 != 0) {
    ...
    do {
      if (uVar15 == 0) {
        iVar5 = iVar5 + 1;
        (*(code *)PTR_CAST_encrypt_006a98cc)(&uStack_124,pbVar14);
  ...
  *puStack_d4 = uVar15;
  ...
  iVar5 = (*(code *)PTR_BN_copy_006a8450)(ppuVar6,puStack_d4);
  if (iVar5 == 0) {
LAB_00622a04:
    (*(code *)PTR_BN_CTX_end_006a8530)(uVar13);
    return;
