...

{
  ...
  if (uVar4 == 0) {
    ...
    uVar2 = uVar4;
    if (uVar4 < 8) {
      if (param_4 == 0) goto LAB_0061cb70;
      uVar2 = uVar4 + 1;
      *param_2 = *(byte *)(param_1 + uVar4 + 0x30) ^ *param_3;
      if (uVar2 == 8) {
        ...
        *(undefined4 *)(param_1 + 0x50) = 0;
        ...
        if (param_4 < 2) goto LAB_0061cb70;
        uVar3 = uVar4 + 2;
          ...
          *(undefined4 *)(param_1 + 0x50) = 0;
          ...
          if (uVar2 == 8) {
            ...
            *(undefined4 *)(param_1 + 0x50) = 0;
            ...
            if (param_4 == 3) goto LAB_0061cb70;
            uVar3 = uVar4 + 4;
            ...
            if (uVar3 == 8) {
              ...
              *(undefined4 *)(param_1 + 0x50) = 0;
              ...
              uVar2 = uVar3;
              if (param_4 == 4) goto LAB_0061cb70;
              uVar2 = uVar4 + 5;
              ...
              if (uVar2 == 8) {
                ...
                *(undefined4 *)(param_1 + 0x50) = 0;
                ...
                if (param_4 == 5) goto LAB_0061cb70;
                param_2[5] = *(byte *)(param_1 + uVar2 + 0x30) ^ param_3[5];
                if (uVar4 == 1) {
                  if (param_4 == 6) goto LAB_0061cbe0;
                  uVar3 = 7;
                  uVar4 = 0xf;
...
LAB_0061ca40:
    ...
    if (param_4 <= uVar3) goto LAB_0061ca40;
    gost_cnt_next(*(undefined4 *)(param_1 + 0x60),param_1 + 0x20,param_1 + 0x30);
    bVar1 = *param_3;
  }
