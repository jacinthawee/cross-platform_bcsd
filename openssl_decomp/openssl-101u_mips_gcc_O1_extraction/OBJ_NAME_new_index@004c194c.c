...

{
  ...
  if (name_funcs_stack == 0) {
    CRYPTO_mem_ctrl(3);
    name_funcs_stack = (*(code *)PTR_sk_new_null_006a6fa4)();
    CRYPTO_mem_ctrl(2);
    if (name_funcs_stack == 0) {
      return 0;
    }
  ...
  puVar3 = PTR_strcmp_006a9b18;
  puVar2 = PTR_lh_strhash_006a73ac;
  if (iVar4 < names_type_num) {
    do {
      iVar4 = iVar4 + 1;
      CRYPTO_mem_ctrl(3);
      puVar5 = (undefined4 *)CRYPTO_malloc(0xc,"o_names.c",0x57);
      CRYPTO_mem_ctrl(2);
      if (puVar5 == (undefined4 *)0x0) {
        (*(code *)PTR_ERR_put_error_006a7f34)(8,0x6a,0x41,"o_names.c",0x5a);
        return 0;
      }
      *puVar5 = puVar2;
      puVar5[1] = puVar3;
      puVar5[2] = 0;
      CRYPTO_mem_ctrl(3);
      (*(code *)PTR_sk_push_006a6fa8)(name_funcs_stack,puVar5);
      CRYPTO_mem_ctrl(2);
    } while (iVar4 < names_type_num);
  }
  pphVar6 = (hash_func **)(*(code *)PTR_sk_value_006a6e24)(name_funcs_stack,iVar1);
