...

{
  ...
  local_14 = *(X509_NAME **)PTR___stack_chk_guard_006a9ae8;
  iVar2 = 0;
  if (iVar10 == 0x10) goto LAB_0058923c;
  if (param_2 == (byte *)0x0) {
    if (*(int *)(param_3 + 0x14) == -1) {
      *(int *)(param_3 + 0x14) = iVar10;
    }
    else if (iVar10 != *(int *)(param_3 + 0x14)) goto LAB_00589238;
    iVar2 = 1;
    *(int *)(param_3 + 0x18) = *(int *)(param_3 + 0x18) + 1;
      ...
      do {
        ...
        if (9 < (uVar8 & 0xff)) {
          if (uVar6 - 0x41 < 6) {
            ...
            uVar8 = uVar6 - 0x57;
            if (5 < uVar6 - 0x61) goto LAB_00589238;
          }
        }
        param_2 = param_2 + -1;
        uVar7 = uVar8 | uVar7 << 4;
    ...
    iVar2 = 0;
    if (0xc < iVar10) goto LAB_0058923c;
    param_2 = param_1 + (int)param_2;
    iVar2 = 0;
    if (*param_2 != 0) goto LAB_0058923c;
    param_2 = (byte *)0x66ec80;
    iVar2 = (*(code *)PTR___isoc99_sscanf_006a9a04)
                      (param_1,"%d.%d.%d.%d",&local_24,&local_20,&local_1c,&local_18);
    if ((iVar2 == 4) && (local_24 < 0x100)) {
      iVar2 = 0;
      if (0xff < local_20) goto LAB_0058923c;
      param_2 = local_1c;
  ...
  do {
    do {
      ...
      pAVar3 = X509_NAME_ENTRY_get_data(ne);
            ...
            (pAVar3->length == 0));
    if (iVar10 == 0) {
      iVar10 = (*(code *)PTR_sk_new_006a806c)(sk_strcmp);
      if (iVar10 == 0) {
        return 0;
      }
      puVar9 = pAVar3->data;
    }
    iVar4 = (*(code *)PTR_sk_find_006a8044)(iVar10,puVar9);
  } while ((iVar4 != -1) ||
          ((iVar4 = (*(code *)PTR_BUF_strdup_006a6fdc)(pAVar3->data), iVar4 != 0 &&
           (iVar4 = (*(code *)PTR_sk_push_006a6fa8)(iVar10,iVar4), iVar4 != 0))));
LAB_005894cc:
  (*(code *)PTR_sk_pop_free_006a7058)(iVar10,str_free);
  return 0;
LAB_00589540:
  piVar5 = (int *)(*(code *)PTR_sk_value_006a6e24)(param_2,iVar4);
  if ((((*piVar5 == 1) && (piVar5 = (int *)piVar5[1], piVar5[1] == 0x16)) &&
    ...
    iVar2 = (*(code *)PTR_sk_find_006a8044)(iVar10,iVar2);
    if ((iVar2 == -1) &&
       ((iVar2 = (*(code *)PTR_BUF_strdup_006a6fdc)(piVar5[2]), iVar2 == 0 ||
        (iVar2 = (*(code *)PTR_sk_push_006a6fa8)(iVar10,iVar2), iVar2 == 0)))) goto LAB_005894cc;
  }
  iVar4 = iVar4 + 1;
  iVar2 = (*(code *)PTR_sk_num_006a6e2c)(param_2);
  if (iVar2 <= iVar4) {
