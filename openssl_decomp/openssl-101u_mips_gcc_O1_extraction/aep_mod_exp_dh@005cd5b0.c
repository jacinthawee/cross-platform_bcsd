...

{
  ...
  iVar2 = (*(code *)PTR_BN_num_bits_006a71f4)(param_5);
  if (iVar2 < 0x881) {
...
LAB_005cd720:
    ...
    pcVar13 = param_4;
    iVar2 = param_5;
    uVar4 = (**(code **)(local_38 + -0x7484))(param_2);
    local_30 = param_5;
  }
  ...
  pcStack_64 = param_4;
  iStack_5c = unaff_s7;
  iVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(local_40);
  if (iVar3 < 0x881) {
  ...
  uVar11 = (*(code *)PTR_BN_mod_exp_006a795c)(uVar11,pcVar13,iVar2,uVar4,uVar1);
LAB_005cda64:
  ...
  if (aep_dso == 0) {
    ...
    if (AEP_LIBNAME == (undefined *)0x0) {
      puVar12 = &DAT_00673488;
    }
    aep_dso = (*(code *)PTR_DSO_load_006a8884)(0,puVar12,0,0);
    if (aep_dso == 0) {
      if (AEPHK_lib_error_code == 0) {
        AEPHK_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006a9538)();
      }
