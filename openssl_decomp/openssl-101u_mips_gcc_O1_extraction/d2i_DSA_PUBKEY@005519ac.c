...

{
  ...
  local_24 = *(dsa_st **)PTR___stack_chk_guard_006a9ae8;
  val = (undefined4 *)
...
LAB_00551a54:
      ...
      if (pEVar8 != (EVP_PKEY *)0x0) {
        pDVar4 = EVP_PKEY_get1_DSA(pEVar8);
        EVP_PKEY_free(pEVar8);
        if (pDVar4 != (dsa_st *)0x0) {
          *pp = puVar3;
          if (a != (DSA **)0x0) {
            (*(code *)PTR_DSA_free_006a7530)(*a);
            *a = pDVar4;
          }
          goto LAB_00551ab8;
        }
...
LAB_00551ab8:
  ...
  pEVar8 = EVP_PKEY_new();
  if (pEVar8 == (EVP_PKEY *)0x0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0xa1,0x41,"x_pubkey.c",0x126);
    return (DSA *)0x0;
  }
  EVP_PKEY_set1_DSA(pEVar8,key);
  ...
  if (val_00 != (ASN1_VALUE *)0x0) {
    if (pEVar8->ameth == (EVP_PKEY_ASN1_METHOD *)0x0) {
      ...
      if (pcVar9 == (code *)0x0) {
        ...
        if (iVar5 != 0) {
          pDVar4 = (DSA *)ASN1_item_i2d(val_00,(uchar **)in,(ASN1_ITEM *)X509_PUBKEY_it);
