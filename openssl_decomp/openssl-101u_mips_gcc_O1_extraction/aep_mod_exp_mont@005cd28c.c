...

{
  ...
  if (iVar2 < 0x881) {
    ...
    local_40 = 0x265;
    (**(code **)(local_38 + -0x6eac))(AEPHK_lib_error_code,0x68,0x74,"e_aep.c");
LAB_005cd3fc:
    local_40 = param_5;
    uStack_bc = param_2;
    pcStack_b8 = param_3;
    pcStack_b4 = param_4;
    uVar4 = (**(code **)(local_38 + -0x7484))(param_1);
    local_30 = param_4;
  }
  ...
  pcStack_64 = param_3;
  iStack_5c = unaff_s7;
  iVar2 = (*(code *)PTR_BN_num_bits_006a71f4)(local_40);
  if (iVar2 < 0x881) {
    iVar2 = aep_get_connection(&iStack_80);
    if (iVar2 != 0) {
      pcStack_c4 = &_gp_1;
      if (AEPHK_lib_error_code == 0) {
        AEPHK_lib_error_code = (**(code **)(puStack_88 + -0x58a8))();
      }
      uStack_90 = 0x26e;
      (**(code **)(puStack_88 + -0x6eac))(AEPHK_lib_error_code,0x68,0x69,"e_aep.c");
      goto LAB_005cd720;
    }
    uStack_8c = 0;
    uStack_90 = uStack_bc;
    ...
    if (iVar2 != 0) {
      ...
      pcStack_c4 = "encrypt";
      uStack_90 = 0x279;
      (**(code **)(puStack_88 + -0x6eac))(AEPHK_lib_error_code,0x68,0x6e,"e_aep.c");
      (**(code **)(puStack_88 + -0x6c9c))(9,0x1e,"e_aep.c",0x3f2);
      ...
      (**(code **)(puStack_88 + -0x6c9c))(10,0x1e,"e_aep.c",0x403);
      goto LAB_005cd720;
    }
    pcStack_c4 = "encrypt";
    (**(code **)(puStack_88 + -0x6c9c))(9,0x1e,"e_aep.c",0x3dc);
    piVar11 = (int *)(aep_app_conn_table + 4);
    iVar2 = 0;
    do {
      iVar3 = iVar2 + 1;
    ...
    uStack_90 = 0x265;
    (**(code **)(puStack_88 + -0x6eac))(AEPHK_lib_error_code,0x68,0x74,"e_aep.c");
LAB_005cd720:
    uStack_90 = uStack_b0;
    pcVar12 = pcStack_b8;
    pcVar14 = pcStack_b4;
    iVar2 = iStack_c0;
    uVar4 = (**(code **)(puStack_88 + -0x7484))(uStack_bc);
  }
  ...
  iStack_ac = unaff_s7;
  iVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(uStack_90);
  if (iVar3 < 0x881) {
  ...
  uVar4 = (*(code *)PTR_BN_mod_exp_006a795c)(pcVar12,pcVar14,iVar2,uVar4,uVar1);
LAB_005cda64:
  ...
  if (aep_dso == 0) {
    ...
    if (AEP_LIBNAME == (undefined *)0x0) {
      puVar13 = &DAT_00673488;
    }
    aep_dso = (*(code *)PTR_DSO_load_006a8884)(0,puVar13,0,0);
    if (aep_dso == 0) {
      if (AEPHK_lib_error_code == 0) {
        AEPHK_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006a9538)();
      }
      ...
      pcVar5 = (code *)(*(code *)PTR_DSO_bind_func_006a888c)(aep_dso,"AEP_ModExp");
      if ((((pcVar5 != (code *)0x0) &&
         ...
         (((iVar6 = (*(code *)PTR_DSO_bind_func_006a888c)(aep_dso,"AEP_Initialize"), iVar6 != 0 &&
           (iVar7 = (*(code *)PTR_DSO_bind_func_006a888c)(aep_dso,"AEP_OpenConnection"), iVar7 != 0)
           ) && ((iVar8 = (*(code *)PTR_DSO_bind_func_006a888c)(aep_dso,"AEP_SetBNCallBacks"),
                 iVar8 != 0 &&
                 (pcVar9 = (code *)(*(code *)PTR_DSO_bind_func_006a888c)
