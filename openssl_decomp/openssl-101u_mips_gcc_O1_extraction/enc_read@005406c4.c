...

{
  ...
  if (*outl < 1) {
    if ((0 < param_3) && (iVar3 = 0, 0 < outl[2])) goto LAB_00540788;
    ...
    (*(code *)PTR_memcpy_006a9aec)(param_2,(int)outl + outl[1] + 0xa0,iVar3);
...
LAB_00540788:
      outm = outl + 0x28;
      do {
        iVar1 = (*(code *)PTR_BIO_read_006a74c0)(iVar1,outl + 0x38,0x1000);
        if (iVar1 < 1) {
          iVar2 = (*(code *)PTR_BIO_test_flags_006a7868)(*(undefined4 *)(param_1 + 0x24),8);
          if (iVar2 != 0) {
            if (iVar3 != 0) {
              (*(code *)PTR_BIO_clear_flags_006a8138)(param_1,0xf);
              (*(code *)PTR_BIO_copy_next_retry_006a8434)(param_1);
...
LAB_005407dc:
          if (param_3 < iVar2) {
            (*(code *)PTR_memcpy_006a9aec)(param_2,outm,param_3);
            iVar1 = iVar3 + param_3;
            outl[1] = param_3;
            break;
          }
          ...
          iVar1 = iVar3;
          if (iVar2 < 1) break;
          (*(code *)PTR_memcpy_006a9aec)(param_2,outm,iVar2);
          iVar3 = iVar3 + iVar2;
          outl[1] = iVar2;
