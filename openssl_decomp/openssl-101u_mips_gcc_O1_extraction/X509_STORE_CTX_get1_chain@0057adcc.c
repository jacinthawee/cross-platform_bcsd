...

{
  ...
  psVar1 = (stack_st_X509 *)(*(code *)PTR_sk_dup_006a7f54)();
  if (psVar1 == (stack_st_X509 *)0x0) {
    ...
    while( true ) {
      ...
      iVar2 = (*(code *)PTR_sk_value_006a6e24)(psVar1,iVar3);
      (*(code *)PTR_CRYPTO_add_lock_006a805c)(iVar2 + 0x10,1,3,"x509_vfy.c",0x7d4);
      iVar3 = iVar3 + 1;
    }
  }
  return psVar1;
