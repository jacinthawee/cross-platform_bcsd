...

{
  ...
  iVar2 = (*(code *)PTR_BIO_find_type_006a8320)(s->rbio,0x100);
  if (iVar2 != 0) {
  ...
  iVar2 = (*(code *)PTR_BIO_find_type_006a8320)(*(undefined4 *)(iVar2 + 0xc),0x100);
  if (iVar2 != 0) {
    (**(code **)(puStack_40 + -0x7fc8))(iVar2,0x69,0,&iStack_38);
  }
  if (iStack_34 != *(int *)puStack_58) {
    pcStack_54 = SSL_get_wfd;
    iVar2 = iStack_34;
    (**(code **)(puStack_40 + -0x5330))();
    puVar1 = PTR___stack_chk_guard_006a9ae8;
    uVar6 = 0x100;
    iStack_60 = -1;
    iStack_5c = *(int *)PTR___stack_chk_guard_006a9ae8;
    iVar2 = (*(code *)PTR_BIO_find_type_006a8320)(*(undefined4 *)(iVar2 + 0x10),0x100);
    if (iVar2 != 0) {
      uVar6 = 0x69;
      (*(code *)PTR_BIO_ctrl_006a6e18)(iVar2,0x69,0,&iStack_60);
    }
