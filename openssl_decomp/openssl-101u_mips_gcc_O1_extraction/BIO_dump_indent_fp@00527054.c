...

{
  ...
  if ((int)param_4 < 1) {
    ...
    pbVar8 = &DAT_00000020;
    param_3 = pbVar5;
    (*(code *)PTR___memset_chk_006a998c)(abStack_1d4);
...
LAB_00526950:
      ...
      param_3 = (byte *)0x1;
      param_4 = pbStack_20c;
      iVar10 = (**(code **)(puStack_230 + -0x536c))(unaff_s7);
  ...
  if (pbStack_1f0 != (byte *)0x0) {
    ...
    pbVar8 = (byte *)(**(code **)(puStack_230 + -0x53bc))(pbStack_270);
    param_3 = (byte *)0x1;
    param_4 = pbStack_20c;
    iVar10 = (**(code **)(puStack_230 + -0x536c))(pbStack_270);
    iStack_218 = iStack_218 + iVar10;
  }
