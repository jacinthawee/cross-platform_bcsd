...

{
  ...
  if (atalla_dso == 0) {
    ...
    if (ATALLA_lib_error_code == 0) {
      ATALLA_lib_error_code = (*(code *)PTR_ERR_get_next_error_library_006a9538)(0,param_2,iVar2);
    }
    uVar3 = 0x68;
    uVar1 = 0x21a;
  }
  (*(code *)PTR_ERR_put_error_006a7f34)(ATALLA_lib_error_code,0x68,uVar3,"e_atalla.c",uVar1);
  return 0;
}
