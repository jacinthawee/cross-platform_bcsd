...
LAB_004e3434:
  ...
  switch(uVar21) {
  default:
    goto switchD_004e32c0_caseD_7;
  case 0xfffffff9:
    goto LAB_004e330c;
  case 0xfffffffa:
    goto switchD_004e32c0_caseD_fffffffa;
  case 0xfffffffb:
    goto LAB_004e32f4;
  case 0xfffffffc:
    goto switchD_004e32c0_caseD_fffffffc;
  case 0xfffffffd:
    break;
  case 0xffffffff:
    puVar18 = puVar19 + -1;
