...

{
  ...
  if ((param_3->neg == 0) && (param_3->top != 0)) {
    ...
    if (iVar3 == 0) {
      ...
      if (iVar3 == 0) {
        while( true ) {
          ...
          if (-1 < iVar3) {
            iVar3 = (*(code *)PTR_BN_sub_006a85a8)(param_2,param_2,param_3);
            if (iVar3 == 0) {
              return 0;
            }
            iVar3 = BN_cmp(param_2,param_3);
            if ((-1 < iVar3) &&
               (iVar3 = (*(code *)PTR_BN_sub_006a85a8)(param_2,param_2,param_3), iVar3 == 0)) {
              return 0;
            }
          }
          if (iVar4 == 0) break;
    ...
    (*(code *)PTR_ERR_put_error_006a7f34)(3,0x7a,0x71,"bn_rand.c",0x110);
    return 0;
  }
  uVar5 = 0x73;
  uVar1 = 0xe2;
LAB_004f9098:
  (*(code *)PTR_ERR_put_error_006a7f34)(3,0x7a,uVar5,"bn_rand.c",uVar1);
  return 0;
}
