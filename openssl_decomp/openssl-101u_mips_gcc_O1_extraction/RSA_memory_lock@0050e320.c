...

{
  ...
  if (r->d == (BIGNUM *)0x0) {
    ...
    local_34 = &r->dmq1;
    local_30 = &r->iqmp;
    unaff_s0 = (BIGNUM *)(CAST_S_table3 + 0x110);
    unaff_s4 = (BIGNUM *)
               (*(code *)PTR_CRYPTO_malloc_locked_006a8730)
  ...
  if (iVar5 == 0x72) {
    ...
    aiStack_ac[0] = (*(code *)PTR_OBJ_nid2obj_006a7140)(iVar5);
    ...
    if (*piStack_bc == 0) {
      ...
      if (iVar5 < iVar8 + -10) {
        in_a2 = iVar8 + 1;
        in_a1 = (ulong *)(**(code **)(puStack_c8 + -0x7dd8))(in_a2,"rsa_sign.c",0x7e);
        if (in_a1 != (ulong *)0x0) {
          puStack_c0 = in_a1;
          (**(code **)(puStack_c8 + -0x66ac))(&piStack_bc,&puStack_c0);
          uVar6 = RSA_private_encrypt(iVar5,(uchar *)in_a1,(uchar *)in_a3,pRStack_54,1);
          if ((int)uVar6 < 1) goto LAB_0050e874;
          iVar5 = 1;
          *puVar3 = uVar6;
          goto LAB_0050e734;
        }
        iVar5 = 0;
        (**(code **)(puStack_c8 + -0x6eac))(4,0x75,0x41,"rsa_sign.c",0x80);
        goto LAB_0050e5f0;
      }
LAB_0050e7b8:
      uVar11 = 0x70;
      uVar7 = 0x7a;
      pcVar13 = *(code **)(puStack_c8 + -0x6eac);
    }
  }
  iVar5 = 0;
