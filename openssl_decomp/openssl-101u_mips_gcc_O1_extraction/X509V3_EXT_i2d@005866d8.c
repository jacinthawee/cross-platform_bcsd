...

{
  ...
  if (pXVar2 == (X509V3_EXT_METHOD *)0x0) {
    ...
    (*(code *)PTR_ERR_put_error_006a7f34)(0x22);
    pXVar4 = (X509_EXTENSION *)0x0;
    goto LAB_005867bc;
  }
  if (pXVar2->it == (ASN1_ITEM_EXP *)0x0) {
    iVar3 = (*pXVar2->i2d)(ext_struc,(uchar **)0x0);
    local_2c = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a7008)(iVar3,"v3_conf.c",0xc1);
    ...
    local_2c = (uchar *)0x0;
    iVar3 = (*(code *)PTR_ASN1_item_i2d_006a8678)(ext_struc,&local_2c);
    if (-1 < iVar3) {
LAB_00586760:
...
LAB_005867bc:
  ...
  if (psVar5 != (stack_st_CONF_VALUE *)0x0) {
    ...
    if ((ASN1_STRING *)x == (ASN1_STRING *)0x0) {
      while (iVar6 = (*(code *)PTR_sk_num_006a6e2c)(psVar5), iVar3 < iVar6) {
        iVar6 = (*(code *)PTR_sk_value_006a6e24)(psVar5,iVar3);
      ...
      while( true ) {
        iVar6 = (*(code *)PTR_sk_num_006a6e2c)(psVar5);
