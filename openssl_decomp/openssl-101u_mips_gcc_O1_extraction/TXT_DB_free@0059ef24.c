      ...
      if (-1 < iVar6) {
        ...
        do {
          ...
          if (*pplVar1 != (lhash_st_OPENSSL_STRING *)0x0) {
            (*(code *)PTR_lh_free_006a7418)(*pplVar1);
            pplVar4 = db->index;
          }
          pplVar1 = (lhash_st_OPENSSL_STRING **)((int)pplVar4 + iVar8);
        } while (iVar6 != -1);
      }
      (*(code *)PTR_CRYPTO_free_006a6e88)(pplVar4);
    }
    if (db->qual != (_func_4743 *)0x0) {
      (*(code *)PTR_CRYPTO_free_006a6e88)();
    }
    if (db->data != (stack_st_OPENSSL_PSTRING *)0x0) {
      iVar8 = (*(code *)PTR_sk_num_006a6e2c)();
      iVar6 = iVar8 + -1;
      if (-1 < iVar8 + -1) {
        do {
          ppiVar2 = (int **)(*(code *)PTR_sk_value_006a6e24)(db->data,iVar6);
          iVar8 = db->num_fields;
          ...
          if (piVar10 == (int *)0x0) {
            if (0 < iVar8) {
              ...
              do {
                ...
                ppiVar2 = ppiVar2 + 1;
                if (piVar10 != (int *)0x0) {
                  (*(code *)PTR_CRYPTO_free_006a6e88)(piVar10);
                  iVar8 = db->num_fields;
                }
              } while (iVar9 < iVar8);
            }
          ...
          iVar8 = iVar6 + -1;
          uVar3 = (*(code *)PTR_sk_value_006a6e24)(db->data,iVar6);
          (*(code *)PTR_CRYPTO_free_006a6e88)(uVar3);
          iVar6 = iVar8;
        } while (iVar8 != -1);
      }
      (*(code *)PTR_sk_free_006a6e80)(db->data);
    }
                    /* WARNING: Could not recover jumptable at 0x0059f0e4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)PTR_CRYPTO_free_006a6e88)(db);
    return;
  }
  return;
}
