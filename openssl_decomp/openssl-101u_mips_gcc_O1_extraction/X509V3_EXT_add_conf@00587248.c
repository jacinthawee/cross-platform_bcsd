...

{
  ...
  if (cert == (X509 *)0x0) {
    ...
    if (psStack_60 == (stack_st_CONF_VALUE *)0x0) goto LAB_0058737c;
LAB_005873b4:
    cert = (X509 *)0x0;
    while( true ) {
      ...
      if (pXVar4 == (X509_EXTENSION *)0x0) goto LAB_0058737c;
...
LAB_0058737c:
      ...
      if (unaff_s5 == (X509_PUBKEY **)0x0) goto LAB_005873b4;
      cert = (X509 *)0x0;
      while( true ) {
        iVar2 = (**(code **)(local_38 + -0x7fb4))(psStack_60);
        if (iVar2 <= (int)cert) break;
        ...
        if ((X509V3_CTX *)section == (X509V3_CTX *)0x0) goto LAB_0058737c;
  ...
  plStack_6c = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
  name = pXStack_b0;
  req = pXStack_b4;
  pXStack_68 = cert;
  ...
  if (pXStack_b4 == (X509 *)0x0) {
    ...
    if (psStack_ac == (stack_st_CONF_VALUE *)0x0) goto LAB_0058755c;
LAB_00587594:
    pXStack_b4 = (X509 *)0x0;
    while( true ) {
      iVar2 = (*(code *)PTR_sk_num_006a6e2c)(psStack_ac);
      if (iVar2 <= (int)pXStack_b4) break;
      iVar2 = (*(code *)PTR_sk_value_006a6e24)(psStack_ac,pXStack_b4);
      req = *(X509 **)(iVar2 + 8);
...
LAB_0058755c:
      ...
      if (unaff_s5 == (X509_PUBKEY **)0x0) goto LAB_00587594;
      pXStack_b4 = (X509 *)0x0;
      while( true ) {
        iVar2 = (*(code *)PTR_sk_num_006a6e2c)(psStack_ac);
        if (iVar2 <= (int)pXStack_b4) break;
  ...
  ppiStack_bc = *(int ***)PTR___stack_chk_guard_006a9ae8;
  ...
  if (req == (X509 *)0x0) {
    ...
    if (psVar3 != (stack_st_CONF_VALUE *)0x0) {
      ...
      (*(code *)PTR_sk_pop_free_006a7058)(psStack_cc);
      goto LAB_0058774c;
    }
  }
LAB_00587748:
