...

{
  ...
  if (((before_p == 0) && (puStack_88 = (undefined *)addr, addr != (void *)0x0)) &&
    ...
    if ((mh_mode & 2) == 0) {
      ...
      if (unaff_s4 == (char *)0x0) goto LAB_004bf31c;
    }
    else {
      in_a3 = (char *)0x122;
      in_a2 = "mem_dbg.c";
    ...
    if (mh != 0) {
      ...
      local_48[0].ptr = addr;
      ptr = (void *)(*(code *)PTR_lh_delete_006a8390)(mh,unaff_s5);
      if (ptr != (void *)0x0) {
...
LAB_004bf31c:
  ...
  puStackY_f0 = PTR___stack_chk_guard_006a9ae8;
  puStack_94 = *(undefined **)PTR___stack_chk_guard_006a9ae8;
  puVar7 = puStack_94;
  ...
  if ((iStack_54 == 1) &&
    ...
    if (puStackY_e8 == (undefined *)0x0) {
      ...
      if ((mh_mode & 1) != 0) {
        ...
        puVar3 = (undefined4 *)(*(code *)PTR_lh_delete_006a8390)(mh,aCStack_b8);
        iVar4 = mh;
        puVar7 = PTR_lh_insert_006a7414;
...
LAB_004bf63c:
  ...
  iStackY_f4 = *(int *)PTR___stack_chk_guard_006a9ae8;
  if ((mh != 0) || (amih != 0)) {
    CRYPTO_mem_ctrl_constprop_5();
    uStackY_f8 = 0;
    iStackY_fc = 0;
    puStackY_100 = puVar7;
    if ((mh == 0) ||
       ((*(code *)PTR_lh_doall_arg_006a83a0)(mh,print_leak_LHASH_DOALL_ARG,&puStackY_100),
       iStackY_fc == 0)) {
      ...
      (*(code *)PTR_BIO_printf_006a6e38)(puVar7,"%ld bytes leaked in %d chunks\n",uStackY_f8);
    }
    CRYPTO_lock(9,0x14,"mem_dbg.c",0xd4);
    if ((((mh_mode & 1) != 0) && (iVar4 = num_disable + -1, num_disable != 0)) &&
       (num_disable = iVar4, iVar4 == 0)) {
  ...
  if (mh != 0) {
    ...
    if (bio != (bio_st *)0x0) {
      (*(code *)PTR_BIO_ctrl_006a6e18)(bio,0x6a,0,puVar7);
