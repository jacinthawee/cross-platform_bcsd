...

{
  ...
  if (*piVar3 == 0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0x10,0xdb,0x8b,"ec_pmeth.c",0x109);
    return 0;
  }
  iVar1 = (*(code *)PTR_EC_KEY_new_006a71a8)();
  if (iVar1 != 0) {
    iVar2 = (*(code *)PTR_EC_KEY_set_group_006a71cc)(iVar1,*piVar3);
    if (iVar2 == 0) {
      (*(code *)PTR_EC_KEY_free_006a71d4)(iVar1);
      return 0;
    }
