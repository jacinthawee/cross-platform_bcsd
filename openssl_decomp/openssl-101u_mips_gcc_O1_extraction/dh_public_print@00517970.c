  ...
  if (*(int *)(iVar5 + 8) != 0) {
    ...
    if (uVar4 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        iVar1 = BIO_printf(param_1,"%s: (%d bit)\n","PKCS#3 DH Public-Key",uVar3);
        if (0 < iVar1) {
          param_3 = param_3 + 4;
          iVar1 = (*(code *)PTR_ASN1_bn_print_006a86b8)(param_1,"private-key:",0,iVar2,param_3);
          if (iVar1 != 0) {
            iVar1 = (*(code *)PTR_ASN1_bn_print_006a86b8)(param_1,"public-key:",iVar6,iVar2,param_3)
            ;
            if (iVar1 != 0) {
