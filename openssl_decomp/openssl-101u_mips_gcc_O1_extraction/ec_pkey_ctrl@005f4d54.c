...
undefined4 ec_pkey_ctrl(undefined4 param_1,int param_2,int param_3,undefined4 *param_4)
...
LAB_005f4da8:
  if (local_14 != *(int *)puVar1) {
    ...
    (*(code *)PTR___stack_chk_fail_006a9ab0)();
                    /* WARNING: Could not recover jumptable at 0x005f4ed0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar2 = (*(code *)PTR_EC_KEY_free_006a71d4)(*(undefined4 *)(iVar3 + 0x14));
    return uVar2;
  }
  return uVar2;
}
