...

{
  ...
  if (value == (void *)0x0) {
    if ((a->value).ptr != (char *)0x0) goto LAB_0054bcb0;
    a->type = type;
    local_28 = a;
    if (type == 1) {
      iVar4 = 1;
    ...
    if (type != 1) {
      if (type == 6) {
        pcVar5 = (char *)(*(code *)PTR_OBJ_dup_006a8494)(value);
        piVar7 = (int *)type;
        if (pcVar5 != (char *)0x0) {
          local_24 = a;
...
LAB_0054bc20:
  ...
  if (iVar4 != 6) {
    ...
    return piVar7[1] - *(int *)(type + 4);
  }
                    /* WARNING: Could not recover jumptable at 0x0054bd98. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  iVar4 = (*(code *)PTR_OBJ_cmp_006a8cc4)(piVar7[1],*(int *)(type + 4));
  return iVar4;
}
