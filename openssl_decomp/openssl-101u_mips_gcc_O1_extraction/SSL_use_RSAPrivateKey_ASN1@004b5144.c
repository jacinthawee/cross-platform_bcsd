...

{
  ...
  if (iVar2 == 0) {
    piVar8 = (int *)0xcd;
    piVar3 = (int *)0x0;
    (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0xcd,0xd,&DAT_00649450,0x116);
    goto LAB_004b522c;
  }
  piVar3 = (int *)ssl_cert_inst(&ssl->cert);
  if (piVar3 == (int *)0x0) {
    uVar9 = 0x41;
    uVar6 = 0x9a;
LAB_004b526c:
    piVar8 = (int *)&DAT_000000cc;
    (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0xcc,uVar9,&DAT_00649450,uVar6);
  }
  else {
    ...
    if (iVar5 < 1) {
      ...
      piVar8 = piVar4;
      piVar3 = (int *)ssl_set_pkey(ssl->cert);
...
LAB_004b522c:
  ...
  if (piVar8 == (int *)0x0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0xc9,0x43,&DAT_00649450,0x125);
    return 0;
  }
  iVar5 = ssl_cert_inst(iVar2 + 0x98);
  if (iVar5 == 0) {
