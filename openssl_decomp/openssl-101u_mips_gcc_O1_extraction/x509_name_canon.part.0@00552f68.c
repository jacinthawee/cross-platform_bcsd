...

{
  ...
  if (iVar2 == 0) {
    ...
    if (0 < iVar3) {
      do {
        puVar4 = (undefined4 *)(*(code *)PTR_sk_value_006a6e24)(*param_1,unaff_s2);
        if (puVar4[2] != local_50) {
          local_4c = (*(code *)PTR_sk_new_null_006a6fa4)();
          if ((local_4c == 0) ||
             (iVar3 = (*(code *)PTR_sk_push_006a6fa8)(iVar2,local_4c), iVar3 == 0))
          goto LAB_00553488;
          local_50 = puVar4[2];
        }
        unaff_s1 = ASN1_item_new((ASN1_ITEM *)X509_NAME_ENTRY_it);
        if ((undefined4 *)unaff_s1 == (undefined4 *)0x0) goto LAB_00553488;
        uVar5 = (*(code *)PTR_OBJ_dup_006a8494)(*puVar4);
...
LAB_00553140:
              ...
              pbVar11 = pbVar17;
              if (-1 < (char)bVar1) {
                piVar18 = (int *)(*(code *)PTR___ctype_b_loc_006a9938)();
                do {
                  unaff_s5 = (byte *)(uint)bVar1;
                  unaff_s7 = iVar3 + -1;
                  if ((*(ushort *)(*piVar18 + (int)unaff_s5 * 2) & 0x20) == 0) break;
                  pbVar11 = pbVar11 + 1;
                  if (unaff_s7 == 0) goto LAB_00553140;
                  bVar1 = *pbVar11;
                  iVar3 = unaff_s7;
                } while (-1 < (char)bVar1);
              }
              ...
              do {
                ...
                if ((char)bVar1 < '\0') {
                  ...
                  if ((*(ushort *)(*piVar18 + (int)unaff_s4 * 2) & 0x20) == 0) {
                    pbVar11 = pbVar11 + 1;
                    pbVar17 = pbVar17 + 1;
                    piVar18 = (int *)(*(code *)PTR___ctype_tolower_loc_006a9940)();
...
LAB_005530cc:
        ...
        if (iVar3 == 0) goto LAB_005530cc;
LAB_00553148:
        iVar3 = (*(code *)PTR_sk_push_006a6fa8)(local_4c,unaff_s1);
        if (iVar3 == 0) goto LAB_005530cc;
    ...
    for (iVar3 = 0; iVar7 = (*(code *)PTR_sk_num_006a6e2c)(iVar2), puVar4 = (undefined4 *)unaff_s1,
        iVar3 < iVar7; iVar3 = iVar3 + 1) {
      local_30 = (ASN1_VALUE *)(*(code *)PTR_sk_value_006a6e24)(iVar2,iVar3);
      puVar4 = (undefined4 *)
    ...
    puVar8 = PTR_CRYPTO_malloc_006a7008;
    param_3 = (undefined *)0x188;
    param_1[4] = puVar4;
...
LAB_00553488:
      ...
      for (iVar3 = 0; iVar7 = (*(code *)PTR_sk_num_006a6e2c)(iVar2), iVar3 < iVar7;
          iVar3 = iVar3 + 1) {
        local_30 = (ASN1_VALUE *)(*(code *)PTR_sk_value_006a6e24)(iVar2,iVar3);
        param_3 = unaff_s1;
...
LAB_005530e4:
    ...
    (*(code *)PTR_sk_pop_free_006a7058)(iVar2);
  }
  ...
  ppiStack_9c = *(int ***)PTR___stack_chk_guard_006a9ae8;
  pcVar15 = param_2;
...
joined_r0x005536e4:
    ...
    if ((int *)param_2 != (int *)0x0) {
      ...
      param_3 = puStack_ec;
      (*(code *)PTR_memcpy_006a9aec)(*(int *)param_2);
      iVar2 = *(int *)param_2;
    ...
    pAStack_a4 = (ASN1_VALUE *)(*(code *)PTR_sk_new_null_006a6fa4)();
    if (pAStack_a4 == (ASN1_VALUE *)0x0) {
      ...
      unaff_s2 = (undefined1 *)0x0;
      for (puStack_ec = (undefined *)0x0; iVar2 = (*(code *)PTR_sk_num_006a6e2c)(*puStack_e0),
          (int)puStack_ec < iVar2; puStack_ec = puStack_ec + 1) {
        unaff_s1 = (undefined1 *)(*(code *)PTR_sk_value_006a6e24)(*puStack_e0,puStack_ec);
        if (*(ASN1_VALUE ***)((int)unaff_s1 + 8) != unaff_s4) {
          unaff_s2 = (undefined1 *)(*(code *)PTR_sk_new_null_006a6fa4)();
          pAVar12 = pAStack_a4;
          if (((ASN1_VALUE **)unaff_s2 == (ASN1_VALUE **)0x0) ||
             (iVar2 = (*(code *)PTR_sk_push_006a6fa8)(pAStack_a4,unaff_s2), pAVar12 = pAStack_a4,
             iVar2 == 0)) goto LAB_005536f8;
          unaff_s4 = *(ASN1_VALUE ***)((int)unaff_s1 + 8);
        }
        iVar2 = (*(code *)PTR_sk_push_006a6fa8)(unaff_s2,unaff_s1);
        pAVar12 = pAStack_a4;
        if (iVar2 == 0) goto LAB_005536f8;
      }
      unaff_s1 = (undefined1 *)0xffffffff;
      unaff_s4 = (ASN1_VALUE **)(nid_objs + 0x24f4);
      ...
      iVar2 = (*(code *)PTR_BUF_MEM_grow_006a74a0)(puStack_e0[2],puStack_ec);
      pAVar12 = pAStack_a4;
      if (iVar2 != 0) {
        ...
        (*(code *)PTR_sk_pop_free_006a7058)(pAStack_a4);
        puStack_e0[1] = 0;
        puVar10 = puStack_ec;
        if (-1 < (int)puStack_ec) {
          if (puStack_e0[3] != 0) {
          ...
          iVar2 = (*(code *)PTR_sk_num_006a6e2c)(*puStack_e0);
          if (iVar2 == 0) {
            puVar4 = (undefined4 *)puStack_e0[2];
            puStack_e0[4] = 0;
            puStack_ec = (undefined *)*puVar4;
          ...
          if (-1 < (int)puVar10) goto LAB_00553504;
        }
        goto LAB_00553538;
      }
    }
LAB_005536f8:
    (*(code *)PTR_sk_pop_free_006a7058)(pAVar12,local_sk_X509_NAME_ENTRY_free);
    param_3 = &DAT_00000041;
    in_stack_ffffff48 = 0x143;
    pcVar15 = (code *)0xcb;
...
LAB_00553538:
  ...
  puVar8 = (undefined *)
           ASN1_item_ex_d2i(&pAStack_f8,(uchar **)pppppppuVar16,(long)param_3,
                            ...
                            pAStack_ac);
  if ((int)puVar8 < 1) goto LAB_00553928;
  piVar18 = *ppiVar13;
  if (piVar18 != (int *)0x0) {
    (*(code *)PTR_BUF_MEM_free_006a7494)(piVar18[2]);
    (*(code *)PTR_sk_pop_free_006a7058)(*piVar18,X509_NAME_ENTRY_free);
    if (piVar18[3] != 0) {
      (*(code *)PTR_CRYPTO_free_006a6e88)();
    }
    (*(code *)PTR_CRYPTO_free_006a6e88)(piVar18);
    *ppiVar13 = (int *)0x0;
  }
  piVar18 = (int *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x14,"x_name.c",0x8f);
  if (piVar18 == (int *)0x0) {
    ...
    *piVar18 = iVar2;
    if (iVar2 != 0) {
      ...
      piVar18[2] = iVar2;
      puVar8 = PTR_BUF_MEM_grow_006a74a0;
      if (iVar2 != 0) {
        piVar18[3] = 0;
        piVar18[4] = 0;
        piVar18[1] = 1;
        ...
        if (iVar2 != 0) {
          (*(code *)PTR_memcpy_006a9aec)(*(undefined4 *)(piVar18[2] + 4));
          for (pppppppuVar16 = (uchar *******)0x0;
              iVar2 = (*(code *)PTR_sk_num_006a6e2c)(pAStack_f8), (int)pppppppuVar16 < iVar2;
              pppppppuVar16 = (uchar *******)((int)pppppppuVar16 + 1)) {
            pppppppuVar19 = pppppppuVar16;
            uVar5 = (*(code *)PTR_sk_value_006a6e24)(pAStack_f8);
            for (iVar2 = 0; iVar3 = (*(code *)PTR_sk_num_006a6e2c)(uVar5), iVar2 < iVar3;
                iVar2 = iVar2 + 1) {
              pppppppuVar19 = (uchar *******)(*(code *)PTR_sk_value_006a6e24)(uVar5,iVar2);
              puVar8 = PTR_sk_push_006a6fa8;
              iVar3 = *piVar18;
          ...
          (*(code *)PTR_sk_free_006a6e80)(pAStack_f8);
          ...
          iVar2 = (*(code *)PTR_sk_num_006a6e2c)(*piVar18);
          if (iVar2 == 0) {
            ...
            if (puVar8 == (undefined *)0x0) goto LAB_005538e8;
          }
          piVar18[1] = 0;
          *ppiVar13 = piVar18;
...
LAB_00553928:
  ...
  (*(code *)PTR___stack_chk_fail_006a9ab0)();
  piVar18 = *(int **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (X509_NAME_ENTRY_it._16_4_ == 0) {
    if (uVar9 < 7) {
      ...
      puVar10 = (undefined *)(*(code *)(&switchD_005619f8::switchdataD_0066a17c)[uVar9])();
      return puVar10;
    }
  }
  else if (uVar9 < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    puVar10 = (undefined *)(*(code *)(&switchD_00561550::switchdataD_0066a160)[uVar9])();
    return puVar10;
  }
  if (piVar18 != *(int **)PTR___stack_chk_guard_006a9ae8) {
    (*(code *)PTR___stack_chk_fail_006a9ab0)();
