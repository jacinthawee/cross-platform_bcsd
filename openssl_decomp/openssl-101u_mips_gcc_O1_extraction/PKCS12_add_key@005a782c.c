...

{
  ...
  p8 = (PKCS8_PRIV_KEY_INFO *)(*(code *)PTR_EVP_PKEY2PKCS8_006a8e9c)(key);
  if ((p8 != (PKCS8_PRIV_KEY_INFO *)0x0) &&
    ...
    if (a != (PKCS12_SAFEBAG *)0x0) {
      ...
      if (*pbags == (stack_st_PKCS12_SAFEBAG *)0x0) {
        psVar2 = (stack_st_PKCS12_SAFEBAG *)(*(code *)PTR_sk_new_null_006a6fa4)();
        *pbags = psVar2;
        if (psVar2 != (stack_st_PKCS12_SAFEBAG *)0x0) {
          iVar1 = (*(code *)PTR_sk_push_006a6fa8)(psVar2,a);
          if (iVar1 != 0) {
            return a;
          }
        ...
        iVar1 = (*(code *)PTR_sk_push_006a6fa8)(*pbags,a);
        if (iVar1 != 0) {
          return a;
        }
      }
