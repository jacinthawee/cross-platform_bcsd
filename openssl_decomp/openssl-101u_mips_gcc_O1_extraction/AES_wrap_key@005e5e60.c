...

{
  ...
  local_44 = (AES_KEY **)PTR___stack_chk_guard_006a9ae8;
  local_50 = &_gp;
  local_2c = *(AES_KEY **)PTR___stack_chk_guard_006a9ae8;
  iVar6 = -1;
  pAVar13 = (AES_KEY *)out;
  if ((inlen & 7) == 0) {
    if (inlen < 8) {
      ...
      local_48 = (uint *)(out + 8);
      (*(code *)PTR_memcpy_006a9aec)(local_48,in,inlen);
      if (iv == (uchar *)0x0) {
        iv = (uchar *)&default_iv;
      }
      uVar17 = (uint)iv & 3;
  ...
  ppbStack_a4 = (byte **)PTR___stack_chk_guard_006a9ae8;
  puStack_d0 = (undefined8 *)(local_50 + -8);
  uStack_7c = inlen;
  puStack_b8 = &_gp;
  pbStack_8c = *(byte **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (((uint)puStack_d0 & 7) == 0) {
    if (puStack_d0 < &DAT_00000008) {
      ...
      (*(code *)PTR_memcpy_006a9aec)(pAVar13,(uint *)((int)in + 8),puStack_d0);
      ...
      do {
        ...
        do {
          ...
          (**(code **)(puStack_b8 + -0x6908))(puStack_10c,puStack_10c,pAVar11);
          *unaff_s0 = uStack_94;
      ...
      iv = (uchar *)puStack_a8;
      iVar6 = (**(code **)(puStack_b8 + -0x5310))(puStack_10c,puStack_a8,8);
      puVar8 = puStack_d0;
      pAStack_11c = pAVar13;
      pAStack_118 = pAVar11;
      if (iVar6 != 0) {
  ...
  pbStack_f0 = &_gp;
  pbStack_dc = *(byte **)PTR___stack_chk_guard_006a9ae8;
  ...
  puStack_d4 = unaff_s0;
  if ((uint *)in == (uint *)0x0) {
    (*(code *)PTR_RC2_decrypt_006a9678)(&uStack_e4);
  }
  else {
    (*(code *)PTR_RC2_encrypt_006a967c)(&uStack_e4,pAVar14);
  }
  *iv = (char)uStack_e4;
  ...
  if (iStack_e8 == 0) {
    for (; puStack_1b8 = (undefined8 *)&uStack_134, pbStack_170 != (byte *)0x0;
      ...
      if (uStack_178 == 0) {
        ...
        ;
        (**(code **)(pbVar19 + -0x5764))(&uStack_134);
      ...
      do {
        if (uStack_178 == 0) {
          ...
          uStack_130 = (uint)pbStack_1d4[7] << 0x18 |
                       ...
                       (uint)pbStack_1d4[4];
          (**(code **)(pbStack_140 + -0x5764))(puStack_1b8,in);
          pbVar15 = (byte *)(uStack_134 >> 0x10);
          *pbStack_1d4 = (byte)uStack_134;
          puStack_1c0 = (uint *)(uStack_130 >> 8);
          pbStack_1d4[4] = (byte)uStack_130;
  ...
  if (pbVar15 != (byte *)0x0) {
    ...
    do {
      if (uStack_1d8 == 0) {
        ...
        (**(code **)((int)puVar20 + -0x5764))(in,puStack_1d0);
  ...
  *puStack_194 = uStack_1d8;
  ...
  uStack_1b4 = 0x5e6858;
  puVar12 = puStack_194;
  (**(code **)((int)puVar20 + -0x5330))();
  puStack_224 = puStack_1a0;
  puStack_218 = PTR___stack_chk_guard_006a9ae8;
  ...
  if (iStack_198 == 0) {
    for (; puStack_208 = (undefined8 *)&uStack_1e4, pbStack_214 != (byte *)0x0;
      ...
      if (uStack_228 == 0) {
        ...
        (**(code **)((int)puVar21 + -0x68f8))(&uStack_1e4);
    ...
    if (pbVar15 != (byte *)0x0) {
      ...
      do {
        if (uStack_228 == 0) {
          uStack_1e4 = *puStack_224;
          uStack_1e0 = puStack_224[1];
          (*(code *)puStack_1f0[-0x1a3e])(puStack_208,pbStack_220);
          pbVar15 = (byte *)(uStack_1e4 >> 0x10);
          *(char *)((int)puStack_224 + 3) = (char)uStack_1e4;
          pbVar19 = (byte *)(uStack_1e0 >> 0x18);
          *(char *)((int)puStack_224 + 7) = (char)uStack_1e0;
  ...
  *puStack_19c = uStack_228;
  ...
  if (pbVar15 != (byte *)0x0) {
    ...
    do {
      if (uVar18 == 0) {
        iVar6 = iVar6 + 1;
        (*(code *)PTR_idea_encrypt_006a84e8)(&uStack_23c,pbVar16);
        abStack_234[3] = (char)uStack_23c;
        uStack_22d = (char)uStack_238;
        abStack_234[0] = (byte)((uint)uStack_23c >> 0x18);
        abStack_234[1] = (char)((uint)uStack_23c >> 0x10);
  ...
  *puStack_1ec = uVar18;
  ...
  if (uVar17 != 1) {
    ...
    iVar6 = (*(code *)PTR_Camellia_decrypt_006a8514)();
    return iVar6;
  }
                    /* WARNING: Could not recover jumptable at 0x005e6c90. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  iVar6 = (*(code *)PTR_Camellia_encrypt_006a8518)();
  return iVar6;
}
