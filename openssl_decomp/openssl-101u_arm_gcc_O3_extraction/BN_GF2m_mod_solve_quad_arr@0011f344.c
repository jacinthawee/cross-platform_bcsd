        ...
        if (2 < *param_3) {
          ...
          do {
            ...
            if (((iVar3 == 0) || (iVar3 = BN_GF2m_mod_sqr_arr(a,a,param_3,param_4), iVar3 == 0)) ||
               (iVar3 = BN_GF2m_add(a,a,b), iVar3 == 0)) goto LAB_0011f3e4;
...
LAB_0011f4c2:
        ...
        if ((iVar1 != 0) && (iVar1 = BN_GF2m_add(a_00,a,a_00), iVar1 != 0)) {
          ...
          if (iVar1 == 0) {
            ...
            local_2c = (BIGNUM *)0x0;
            ERR_put_error(3,0x87,0x74,"bn_gf2m.c",0x4b0);
          }
          goto LAB_0011f3e6;
        }
      }
      ...
      if (pBVar5 != (BIGNUM *)0x0) {
        ...
        do {
          ...
          if (pBVar6 == (BIGNUM *)0x0) goto LAB_0011f3e4;
          iVar1 = *param_3;
          if (1 < iVar1) {
            iVar3 = 1;
            do {
              ...
              if ((((iVar1 == 0) ||
                 ...
                 ((iVar1 = BN_GF2m_add(a,a,pBVar5), iVar1 == 0 ||
                  (iVar1 = BN_GF2m_add(a_00,pBVar4,pBVar2), iVar1 == 0)))) goto LAB_0011f3e4;
              iVar1 = *param_3;
            } while (iVar3 < iVar1);
          }
          if (a_00->top != 0) goto LAB_0011f4c2;
          local_2c = (BIGNUM *)((int)&local_2c[-1].flags + 3);
        } while (local_2c != (BIGNUM *)0x0);
        ERR_put_error(3,0x87,0x71,"bn_gf2m.c",0x4a6);
        goto LAB_0011f3e6;
      }
    }
  }
