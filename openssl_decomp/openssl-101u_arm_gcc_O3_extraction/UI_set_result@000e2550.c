...
LAB_000e2680:
    ...
    if (uVar3 != 0) {
      if (uVar3 < 3) {
          ...
          *(uint *)(ui + 0x14) = *(uint *)(ui + 0x14) | 1;
          ...
          if ((int)sVar1 <= *(int *)(uis + 0x14)) {
            if (*(char **)(uis + 0xc) == (char *)0x0) {
              ERR_put_error(0x28,0x69,0x69,"ui_lib.c",0x346);
              __c = (char *)0xffffffff;
            }
            else {
        ...
        ERR_add_error_data(5,"You must type in ",acStack_44,&DAT_0016acb4,acStack_34," characters");
        goto LAB_000e2680;
      }
      if (uVar3 == 3) {
        if (*(undefined **)(uis + 0xc) == (undefined *)0x0) {
          ERR_put_error(0x28,0x69,0x69,"ui_lib.c",0x352);
          __c = (char *)0xffffffff;
          goto LAB_000e2618;
        }
        **(undefined **)(uis + 0xc) = 0;
