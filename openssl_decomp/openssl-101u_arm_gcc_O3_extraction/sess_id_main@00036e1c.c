...

{
  ...
  if (param_1 < 1) {
    ...
    if (pBVar4 == (BIO *)0x0) goto LAB_000371d0;
    iVar9 = 3;
    uVar11 = 0;
    iVar10 = 3;
    local_38 = (char *)0x0;
...
LAB_00036e8a:
    do {
      ...
      if (iVar2 == 0) {
        param_1 = param_1 + -1;
        if (param_1 == 0) goto LAB_00036fec;
        ppcVar1 = ppcVar13 + 1;
        ppcVar13 = ppcVar13 + 1;
        ...
        if (iVar2 == 0) {
          if (param_1 == 1) goto LAB_00036fec;
          param_1 = param_1 + -2;
...
LAB_000371d0:
    ...
    if (local_3c == (char *)0x0) goto LAB_0003710c;
...
LAB_000370b2:
    if (pBVar4 == (BIO *)0x0) goto LAB_00036f4c;
  }
  else {
    pBVar3 = BIO_s_file();
    pBVar4 = BIO_new(pBVar3);
