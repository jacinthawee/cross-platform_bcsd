  ...
  *outl = 0;
  if ((pEVar8->flags & 0x100000) == 0) {
    ...
    if ((int)(ctx->flags << 0x17) < 0) {
      if (ctx->buf_len != 0) {
        ERR_put_error(6,0x65,0x8a,"evp_enc.c",0x1f1);
        return 0;
      }
    }
    else if (1 < uVar9) {
      if ((ctx->buf_len == 0) && (ctx->final_used != 0)) {
        if (0x20 < uVar9) {
          OpenSSLDie("evp_enc.c",0x1fc,"b <= sizeof ctx->final");
        }
        ...
        if (uVar6 == 0) {
          do {
            ...
            if ((int)uVar5 <= (int)uVar6) {
              ...
              if (0 < (int)uVar5) {
                uVar9 = (uint)(((uint)outm & 3) == 0);
                if (uVar5 < 9) {
                  uVar9 = 0;
                }
                uVar9 = (outm + 4 <= ctx->final || ctx->final + 4 <= outm) & uVar9;
                if (uVar9 == 0) {
                  do {
      ...
      ERR_put_error(6,0x65,0x6d,"evp_enc.c",0x1f9);
      return 0;
    }
    iVar7 = 1;
  }
