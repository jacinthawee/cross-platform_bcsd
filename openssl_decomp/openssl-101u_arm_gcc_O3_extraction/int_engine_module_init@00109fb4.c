...
LAB_0010a218:
                ...
                if (e == (ENGINE *)0x0) {
                  ...
                  if (uVar9 >> 5 != 0) goto LAB_0010a218;
                }
                ...
                if (iVar7 == 0) {
                  ...
                  if (iVar7 != 0) {
                    if (local_2c[0] == 1) {
                      ...
                      pcVar5 = pcVar1;
                      if (local_2c[0] == 0) goto LAB_0010a096;
...
LAB_0010a1fa:
          uVar10 = 1;
LAB_0010a172:
          if (e != (ENGINE *)0x0) goto LAB_0010a178;
        }
        else {
          iVar3 = ENGINE_init(e);
          if (iVar3 != 0) {
            if (((initialized_engines != (_STACK *)0x0) ||
               ...
               (iVar3 = sk_push(initialized_engines,e), iVar3 != 0)) goto LAB_0010a1fa;
            ENGINE_finish(e);
          }
          uVar10 = 0;
          ERR_put_error(0x26,0xbc,0x66,"eng_cnf.c",0xbf);
