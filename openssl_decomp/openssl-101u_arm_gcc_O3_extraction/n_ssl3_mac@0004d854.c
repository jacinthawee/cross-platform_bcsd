    ...
    *puVar8 = uVar9 & 0xff;
    ...
    if (((param_3 == 0) &&
      ...
      *(undefined4 *)((int)auStack_78 + iVar7 + 4) = uVar4;
      ...
      if (iVar7 < 1) goto LAB_0004dae2;
    }
    else {
      EVP_MD_CTX_init(&EStack_90);
      uVar6 = *puVar8;
      *param_2 = (uchar)(puVar8[1] >> 8);
      local_99 = (undefined)uVar6;
      param_2[1] = (uchar)puVar8[1];
      iVar7 = EVP_MD_CTX_copy_ex(&EStack_90,ctx);
      if ((((iVar7 < 1) || (iVar7 = EVP_DigestUpdate(&EStack_90,d_00,local_98), iVar7 < 1)) ||
          ((iVar7 = EVP_DigestUpdate(&EStack_90,&ssl3_pad_1,__n), iVar7 < 1 ||
           ((iVar7 = EVP_DigestUpdate(&EStack_90,d,8), iVar7 < 1 ||
            (iVar7 = EVP_DigestUpdate(&EStack_90,&local_99,1), iVar7 < 1)))))) ||
         ((iVar7 = EVP_DigestUpdate(&EStack_90,param_2,2), iVar7 < 1 ||
          (((((iVar7 = EVP_DigestUpdate(&EStack_90,(void *)puVar8[4],puVar8[1]), iVar7 < 1 ||
              (iVar7 = EVP_DigestFinal_ex(&EStack_90,param_2,(uint *)0x0), iVar7 < 1)) ||
             (iVar7 = EVP_MD_CTX_copy_ex(&EStack_90,ctx), iVar7 < 1)) ||
            ((iVar7 = EVP_DigestUpdate(&EStack_90,d_00,local_98), iVar7 < 1 ||
             (iVar7 = EVP_DigestUpdate(&EStack_90,PTR_ssl3_pad_2_0004daf8,__n), iVar7 < 1)))) ||
           ((iVar7 = EVP_DigestUpdate(&EStack_90,param_2,local_98), iVar7 < 1 ||
            (iVar7 = EVP_DigestFinal_ex(&EStack_90,param_2,&local_94), iVar7 < 1)))))))) {
