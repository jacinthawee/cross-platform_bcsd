...
LAB_0005cda8:
    ...
    if (ppVar5 == (pitem *)0x0) {
      ...
      uVar6 = *(ulong *)(puVar16 + 4);
      pEVar12 = *(EVP_CIPHER_CTX **)(puVar16 + 0x10);
      pdVar10 = param_1->d1;
      param_1->init_num = iVar17 + uVar6;
      uVar1 = *puVar16;
      uVar2 = *(undefined2 *)(puVar16 + 8);
      (pdVar10->w_msg_hdr).saved_retransmit_state.enc_write_ctx = pEVar12;
      *(undefined *)&(pdVar10->w_msg_hdr).seq = uVar1;
      ...
      uVar11 = uVar3 - 1;
      (pdVar10->w_msg_hdr).frag_off = uVar6;
      pCVar20 = param_1->compress;
      pSVar7 = *(SSL_SESSION **)(puVar16 + 0x24);
      *(undefined2 *)&(pdVar10->w_msg_hdr).frag_len = uVar2;
