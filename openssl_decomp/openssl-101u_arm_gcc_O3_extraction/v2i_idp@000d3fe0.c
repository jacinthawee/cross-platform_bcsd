...

{
  ...
  val = (ASN1_VALUE **)ASN1_item_new((ASN1_ITEM *)PTR_ISSUING_DIST_POINT_it_000d42d8);
  if (val == (ASN1_VALUE **)0x0) {
    ERR_put_error(0x22,0x9d,0x41,"v3_crld.c",0x1cb);
LAB_000d4132:
    ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)PTR_ISSUING_DIST_POINT_it_000d42d8);
...
LAB_000d40f2:
          ...
          if (pAVar5 == (ASN1_VALUE *)0x0) {
            ppAVar4 = (ASN1_VALUE **)ASN1_item_new((ASN1_ITEM *)PTR_DIST_POINT_NAME_it_000d42dc);
      ...
      if (nm != (X509_NAME *)0x0) {
        ...
        if (dn_sk != (stack_st_CONF_VALUE *)0x0) {
          ...
          if ((iVar1 != 0) && (iVar1 = sk_num(p_Var2), 0 < iVar1)) {
            ...
            if (st == (_STACK *)0x0) goto LAB_000d40f2;
