...

{
  ...
  if (param_1 < 0x10000) {
    if (param_1 < 0x100) {
      ...
      if ((uVar3 & 0x61) == 0) {
        if ((uVar3 & 6) == 0) {
          if (((param_1 & 0xff) != 0x5c) || ((param_2 & 0xf) == 0)) goto LAB_000b2b94;
          if ((param_4 == (FILE *)0x0) || (sVar1 = fwrite(&DAT_00160d98,1,2,param_4), sVar1 == 2))
          goto LAB_000b2bd0;
        }
        else {
...
LAB_000b2b94:
        if ((param_4 == (FILE *)0x0) || (sVar1 = fwrite(local_28,1,1,param_4), sVar1 == 1)) {
          ...
          goto LAB_000b2bfc;
              ...
              ((sVar1 = fwrite(&DAT_00160d8c,1,1,param_4), sVar1 == 1 &&
