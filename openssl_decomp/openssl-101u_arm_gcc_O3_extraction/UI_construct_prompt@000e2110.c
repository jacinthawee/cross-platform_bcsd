...

{
  ...
  if (*(code **)(*(int *)ui_method + 0x18) == (code *)0x0) {
    local_24 = s_Enter_0016ac90._0_4_;
    local_30[0] = 0x3a;
    local_20 = (undefined2)ram0x0016ac94;
    local_2c = DAT_0016ac98;
    local_1e = (undefined)((uint)ram0x0016ac94 >> 0x10);
    local_28 = (undefined2)DAT_0016ac9c;
    if (object_desc != (char *)0x0) {
      sVar1 = strlen(object_desc);
      if (object_name == (char *)0x0) {
        sVar1 = sVar1 + 8;
        pcVar3 = (char *)CRYPTO_malloc(sVar1,"ui_lib.c",0x19f);
