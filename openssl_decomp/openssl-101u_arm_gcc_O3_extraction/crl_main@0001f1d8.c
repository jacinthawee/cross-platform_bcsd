...
LAB_0001f56c:
        ...
        if (iVar5 != 0) {
          if ((((*pcVar12 == '-') && (pcVar12[1] == 'i')) && (pcVar12[2] == 'n')) &&
             (pcVar12[3] == '\0')) {
            param_1 = param_1 + -1;
            if (param_1 == 0) goto LAB_0001f56c;
            local_14c = ppcVar16[1];
            ppcVar16 = ppcVar16 + 1;
          }
          else {
                                ...
                                if (iVar5 == 0) {
                                  ...
                                  if (iVar5 == 0) {
                                    ...
                                    if (iVar5 == 0) {
                                      ...
                                      local_13c = EVP_get_digestbyname(pcVar12 + 1);
                                      if (local_13c == (EVP_MD *)0x0) {
...
LAB_0001f282:
        ...
        if (param_1 == 1) goto LAB_0001f56c;
        param_1 = param_1 + -2;
        local_148 = str2fmt(ppcVar16[1]);
        ppcVar16 = ppcVar16 + 2;
      } while (0 < param_1);
    }
...
LAB_0001f336:
            if (local_134 != 0) {
              ...
              do {
                ...
                pBVar7 = bio_out;
                if (local_114 == iVar4) {
                  uVar10 = X509_NAME_hash_old(a->crl->issuer);
                  BIO_printf(pBVar7,"%08lx\n",uVar10);
                }
                if (local_11c == iVar4) {
                ...
                if (local_110 == iVar4) {
                  pBVar7 = (BIO *)X509_CRL_digest(a,local_13c,local_6c,&local_100);
                  bio = bio_out;
                  if (pBVar7 == (BIO *)0x0) {
                    uVar15 = 1;
            ...
            if (pBVar7 == (BIO *)0x0) {
              ...
              if (local_144 == (char *)0x0) {
                ...
                lVar8 = BIO_ctrl(pBVar7,0x6c,5,local_144);
                if (lVar8 < 1) {
                  uVar15 = 1;
                  perror(local_144);
                  goto LAB_0001f408;
            ...
            if (pBVar7 != (BIO *)0x0) {
              iVar4 = X509_LOOKUP_ctrl((X509_LOOKUP *)pBVar7,1,local_130,1,(char **)0x0);
              if (iVar4 == 0) {
              ...
              pBVar7 = (BIO *)X509_STORE_add_lookup(v,pXVar9);
              if (pBVar7 != (BIO *)0x0) {
                iVar4 = X509_LOOKUP_ctrl((X509_LOOKUP *)pBVar7,2,local_138,1,(char **)0x0);
                if (iVar4 == 0) {
...
LAB_0001f408:
      ...
      lVar8 = BIO_ctrl(pBVar7,0x6c,3,local_14c);
      if (0 < lVar8) goto LAB_0001f308;
      perror(local_14c);
    }
LAB_0001f444:
    BIO_free(pBVar7);
