...
LAB_00037642:
  ...
  if (filename == (char *)0x0) {
    ...
    pBVar7 = x;
    if (filename_00 != (char *)0x0) goto LAB_000375ac;
LAB_00037708:
    pBVar3 = BIO_new_fp(stdout,(int)filename_00);
    pBVar7 = x;
    if (x_00 != (NETSCAPE_CERT_SEQUENCE **)0x0) goto LAB_0003769c;
LAB_000375c8:
    ...
    if (filename_00 == (char *)0x0) goto LAB_00037708;
LAB_000375ac:
    ...
    if (x_00 == (NETSCAPE_CERT_SEQUENCE **)0x0) goto LAB_000375c8;
LAB_0003769c:
