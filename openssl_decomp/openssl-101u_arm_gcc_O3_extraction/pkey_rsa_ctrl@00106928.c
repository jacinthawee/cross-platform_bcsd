...

{
  ...
  if (param_2 < 0xc) {
    ...
    if (param_2 != 1) {
      ...
      ERR_put_error(4,0x8f,0x94,"rsa_pmeth.c",0x21c);
      return 0xfffffffe;
    }
    if (param_4 != (EVP_MD *)0x0) {
      if (piVar5[4] == 3) {
...
LAB_00106b08:
  ...
  if (0x1004 < param_2) {
    ...
    if (0x1005 < param_2) {
      if (param_2 == 0x1007) goto LAB_00106a18;
      if (param_2 != 0x1008) {
        return 0xfffffffe;
      }
    }
    if (piVar5[4] != 6) {
      ERR_put_error(4,0x8f,0x9c,"rsa_pmeth.c",0x1f9);
      return 0xfffffffe;
    }
    if (param_2 != 0x1008) {
...
LAB_00106a18:
    if (piVar5[4] != 6) {
      ERR_put_error(4,0x8f,0x92,"rsa_pmeth.c",0x1d6);
      return 0xfffffffe;
    }
    if (param_2 != 0x1007) {
  ...
  if (0x1002 < param_2) {
    ...
    ERR_put_error(4,0x8f,0x91,"rsa_pmeth.c",0x1e4);
    return 0xfffffffe;
  }
  if (param_2 != 0x1001) {
    return 0xfffffffe;
  ...
  if (param_3 - 1U < 6) {
    ...
    if (pEVar3 != (EVP_MD *)0x0) {
      if (param_3 == 3) goto LAB_00106ad8;
      if (param_3 == 5) {
        iVar2 = EVP_MD_type(pEVar3);
        iVar2 = RSA_X931_hash_id(iVar2);
        if (iVar2 == -1) goto LAB_00106b08;
        goto LAB_00106984;
      }
    }
    if (param_3 == 6) {
      ...
      if (param_3 != 4) goto LAB_00106984;
...
LAB_00106984:
  ...
  ERR_put_error(4,0x8f,0x90,"rsa_pmeth.c",0x1cc);
  return 0xfffffffe;
}
