...

{
  ...
  if (param_2 == (EVP_MD *)0x0 || iVar9 == 1) {
    inl = uVar10;
    if ((param_2 == (EVP_MD *)0x0) &&
       ((uVar10 == 0 || (__aeabi_uidivmod(uVar10,iVar9), extraout_r1 != 0)))) {
      return 0;
    }
  }
  else {
    __aeabi_idivmod(uVar10,iVar9);
    ...
    inl = uVar10 + iVar6;
    if ((int)uVar10 < (int)inl) {
      do {
        *(char *)(*(int *)(iVar8 + 0x10) + uVar10) = (char)iVar4;
        uVar10 = uVar10 + 1;
      } while (uVar10 != inl);
    }
    *(int *)(iVar8 + 4) = iVar6 + *(int *)(iVar8 + 4);
  }
  iVar4 = EVP_Cipher(ctx,*(uchar **)(iVar8 + 0xc),*(uchar **)(iVar8 + 0x10),inl);
  if (iVar4 < 1) {
    return 0xffffffff;
  }
  if (param_2 == (EVP_MD *)0x0) {
  ...
  if (uVar7 != 0) {
    uVar5 = tls1_cbc_remove_padding(param_1,iVar8,iVar9,pEVar1);
    return uVar5;
  }
  return 1;
}
