...
joined_r0x00014438:
      do {
        if (param_1 < 1) goto LAB_000144a8;
        pcVar7 = *ppcVar18;
        ...
        if (iVar6 == 0) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_00014642;
          ppcVar15 = ppcVar18 + 1;
                ...
                if (iVar6 == 0) {
                  ...
                  if (iVar6 == 0) {
                    ...
                    if (param_1 != 0) {
                      ...
                      ppcVar15 = ppcVar18 + 1;
                      if (local_40 != 0) goto LAB_00014450;
                    }
                  }
                  else {
                    ...
                    if (iVar6 == 0) {
                      ...
                      if (param_1 != 0) {
                        ...
                        ppcVar15 = ppcVar18 + 1;
                        if (0 < local_34) goto LAB_00014450;
                      }
                    }
                    else {
...
LAB_00014642:
          ...
          if (((cVar1 == 'i') && (pcVar7[2] == 'n')) && (pcVar7[3] == '\0')) {
            ...
            iVar6 = strcmp(pcVar7,"-out");
            if (iVar6 == 0) goto LAB_00014488;
            if ((cVar1 != 'i') || (pcVar7[2] != '\0')) goto LAB_0001455e;
            local_48 = 1;
          }
        }
LAB_00014450:
...
LAB_00014964:
                      ...
                      if (pBVar14 != (BIO *)0x0) {
                        ...
                        for (iVar13 = 0; iVar6 = sk_num(p_Var2), iVar13 < iVar6; iVar13 = iVar13 + 1
                          ...
                          if (lVar4 == 0) {
                            ...
                            if ((iVar6 == 6 || iVar6 == 1) || (iVar6 == 5)) {
                              pBVar16 = (BIO *)p_Var10->num;
                              pcVar7 = ASN1_tag2str(iVar6);
                              BIO_printf(pBVar16,"Can\'t parse %s type\n",pcVar7);
                              ERR_print_errors(p_Var10->num);
                              local_4c = 1;
                              goto LAB_0001482c;
                            }
                ...
                if (a == (ASN1_TYPE *)0x0) {
                  ...
                  if ((local_38 != (ASN1_TYPE *)0x0) ||
                     ...
                     local_38 = a, a != (ASN1_TYPE *)0x0)) goto LAB_00014916;
...
LAB_000144f0:
    ...
    str = (BIO *)0x0;
    pBVar17 = (BIO *)0x0;
    if (pBVar12 != (BIO *)0x0) goto LAB_000144f0;
    local_4c = 1;
    pBVar17 = pBVar12;
    str = pBVar12;
  }
  ...
  if (local_4c == 0) goto LAB_000143c2;
  goto LAB_000143bc;
}
