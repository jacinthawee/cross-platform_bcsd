...

{
  ...
  local_68 = *(uint *)PTR_s_ENGINE_rand_bytes_000f384c;
  uStack_64 = *(undefined4 *)(PTR_s_ENGINE_rand_bytes_000f384c + 4);
  uStack_60 = *(undefined4 *)(PTR_s_ENGINE_rand_bytes_000f384c + 8);
  uStack_5c = *(undefined4 *)(PTR_s_ENGINE_rand_bytes_000f384c + 0xc);
  local_58 = (undefined2)*(undefined4 *)(PTR_s_ENGINE_rand_bytes_000f384c + 0x10);
