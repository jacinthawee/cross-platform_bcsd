...
LAB_000b2cc8:
      if ((param_1 == (FILE *)0x0) || (sVar1 = fwrite(&DAT_00160d9c,1,1,param_1), sVar1 == 1)) {
        if ((int)(param_2 << 0x16) < 0) {
          ...
          pbVar4 = (byte *)CRYPTO_malloc(iVar14,"a_strex.c",0x13d);
          if (pbVar4 != (byte *)0x0) {
            local_50[0] = pbVar4;
...
LAB_000b31b6:
              iVar14 = iVar14 * 2;
              CRYPTO_free(pbVar4);
              goto joined_r0x000b31a6;
            }
            pbVar18 = pbVar4;
            do {
              if (pbVar18 == pbVar4 + iVar14) goto LAB_000b31b6;
...
joined_r0x000b31a6:
            ...
            pbVar18 = pbVar4;
            do {
              if (pbVar18 == pbVar4 + (int)pcVar16) goto LAB_000b31a2;
...
LAB_000b2d08:
        ...
        if ((0x1d < iVar14 - 1U) || (bVar7 = tag2nbyte[iVar14], bVar7 == 0xff)) {
          if ((int)(param_2 << 0x17) < 0) goto LAB_000b2cc8;
          goto LAB_000b2d02;
        }
        if ((int)(param_2 << 0x1b) < 0) {
          if (bVar7 != 0) goto LAB_000b2dea;
          goto LAB_000b2d08;
        }
      }
      ...
      if (pbVar4 == pbVar18) {
        ...
        do {
          ...
          case 0:
            ...
            if (iVar3 < 0) goto switchD_000b2fe8_caseD_3;
...
LAB_000b3088:
                    iVar12 = iVar12 + iVar3;
                    if (pbVar15 == pbVar5) goto LAB_000b2f78;
                  }
                  if ((uVar9 & 6) != 0) {
                    BIO_snprintf(acStack_38,0xb,"\\%02X");
                    iVar3 = 3;
...
LAB_000b2f78:
      ...
      if (local_60[0] == '\0') {
        if (param_1 == (FILE *)0x0) goto LAB_000b2cec;
      }
      else {
        local_70 = local_70 + 2;
        if (param_1 == (FILE *)0x0) goto LAB_000b2cec;
        sVar1 = fwrite(&DAT_00175478,1,1,param_1);
        if (sVar1 != 1) goto switchD_000b2fe8_caseD_3;
      }
      iVar14 = (param_3.asn1_string)->length;
      pbVar4 = (param_3.asn1_string)->data;
      pbVar18 = pbVar4 + iVar14;
      if (pbVar4 != pbVar18) {
        ...
        do {
          ...
          case 0:
            ...
            if (iVar12 < 0) goto switchD_000b2fe8_caseD_3;
...
LAB_000b32ce:
            ...
            if (0 < iVar12) {
              ...
              do {
                ...
                if ((uVar9 & 0x61) == 0) {
                  if ((uVar9 & 6) == 0) {
                    if ((uVar11 != 0x5c) || (uVar8 == 0)) goto LAB_000b3312;
                    sVar1 = fwrite(&DAT_00160d98,1,2,param_1);
                    if (sVar1 != 2) goto switchD_000b2fe8_caseD_3;
                  }
                  else {
                    BIO_snprintf(acStack_38,0xb,"\\%02X");
                    sVar1 = fwrite(acStack_38,1,3,param_1);
                    if (sVar1 != 3) goto switchD_000b2fe8_caseD_3;
                  }
                }
                else {
                  if ((int)(uVar9 << 0x1c) < 0) {
LAB_000b3312:
                    ...
                    sVar1 = fwrite(&DAT_00160d8c,1,1,param_1);
                    if (sVar1 != 1) goto switchD_000b2fe8_caseD_3;
                  }
      ...
      if ((local_60[0] == '\0') || (sVar1 = fwrite(&DAT_00175478,1,1,param_1), sVar1 == 1))
      goto LAB_000b2cec;
    }
  }
  else {
