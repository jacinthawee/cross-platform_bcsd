...
LAB_0010a4e4:
  ...
  if (0 < param_2) {
    ...
    do {
      ...
      if ((int)cnt < 1) {
        EVP_DigestUpdate((EVP_MD_CTX *)auStack_60,PTR_state_0010a770 + iVar5,cnt_00);
      }
      else {
        EVP_DigestUpdate((EVP_MD_CTX *)auStack_60,PTR_state_0010a770 + iVar5,cnt_00 - cnt);
        EVP_DigestUpdate((EVP_MD_CTX *)auStack_60,PTR_state_0010a770,cnt);
      }
  ...
  if ((int)((uint)(entropy < DAT_0010a768) << 0x1f) < 0) {
