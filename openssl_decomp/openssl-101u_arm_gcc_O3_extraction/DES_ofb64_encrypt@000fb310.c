...

{
  ...
  local_40 = (uint)(*ivec)[0] | (uint)(*ivec)[2] << 0x10 | (uint)(*ivec)[1] << 8 |
             (uint)(*ivec)[3] << 0x18;
  local_3c = (uint)(*ivec)[6] << 0x10 | (uint)(*ivec)[5] << 8 | (uint)(*ivec)[4] |
             (uint)(*ivec)[7] << 0x18;
  local_38[0] = (*ivec)[0];
  ...
  bVar4 = local_2c == __stack_chk_guard;
  *num = uVar2;
  if (bVar4) {
    return;
  }
