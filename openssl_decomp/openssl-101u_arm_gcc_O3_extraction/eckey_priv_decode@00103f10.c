...
LAB_00103f64:
    ...
    if (pEVar3 == (EC_POINT *)0x0) {
      ERR_put_error(0x10,0xd5,0x10,"ec_ameth.c",0x107);
    }
    else {
      ...
      if (iVar1 == 0) {
        ...
        ERR_put_error(0x10,0xd5,0x10,"ec_ameth.c",0x10c);
      }
      else {
        ...
        if (iVar1 == 0) {
          EC_POINT_free(pEVar3);
          ERR_put_error(0x10,0xd5,0x10,"ec_ameth.c",0x112);
        }
        else {
          ...
          EC_POINT_free(pEVar3);
          ERR_put_error(0x10,0xd5,0x10,"ec_ameth.c",0x117);
        }
      }
    }
  }
