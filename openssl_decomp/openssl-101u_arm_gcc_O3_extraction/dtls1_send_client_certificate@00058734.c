...
LAB_00058778:
    ...
    if (iVar5 != 0x1171) {
      if (iVar5 != 0x1172) goto LAB_0005875c;
      goto LAB_00058778;
    }
LAB_000587b2:
    ppEVar4 = local_14;
    ...
    if (iVar1 == 1) {
      if ((local_14[0] == (EVP_PKEY *)0x0) || (local_18 == (X509 *)0x0)) {
        ...
        iVar1 = 0;
        ERR_put_error(0x14,0x105,0x6a,"d1_clnt.c",0x689);
      }
      else {
        param_1->state = 0x1171;
  ...
  if (iVar5 == 0) {
    ERR_put_error(0x14,0x105,0x44,"d1_clnt.c",0x6a4);
