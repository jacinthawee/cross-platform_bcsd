...
LAB_00098dc2:
    ...
    if (pBVar6 == (BIGNUM *)0x0) goto LAB_00098de8;
    pBVar3 = (BIGNUM *)0x0;
    pBVar4 = pBVar6;
    ...
    if (rnd == (BIGNUM *)0x0) {
      rnd = BN_new();
      bVar1 = true;
      if (rnd == (BIGNUM *)0x0) goto LAB_00098eb0;
    }
    ...
    if (((pBVar6 == (BIGNUM *)0x0) && (pBVar6 = BN_new(), pBVar6 == (BIGNUM *)0x0)) ||
       ((pBVar7 = (BN_MONT_CTX *)(*(uint *)(param_1 + 0x1c) & 1), pBVar7 != (BN_MONT_CTX *)0x0 &&
        ...
        pBVar7 == (BN_MONT_CTX *)0x0)))) goto LAB_00098dc2;
    if (bVar1) {
