...

{
  ...
  case '\0':
    pAVar7 = it->templates;
    if (pAVar7 == (ASN1_TEMPLATE *)0x0) goto switchD_000b8f1e_caseD_5;
    uVar6 = pAVar7->flags;
    if ((uVar6 & 1) != 0) {
      if ((uVar6 & 0x306) != 0) {
        return (ASN1_VALUE *)0;
...
LAB_000b90f8:
  ...
  case '\x06':
    if (ppcVar8 != (code **)0x0) {
      ...
      if (iVar2 == 0) goto LAB_000b90ac;
      if (iVar2 == 2) {
        return (ASN1_VALUE *)local_24;
      }
    }
    local_24 = (_STACK *)CRYPTO_malloc(it->size,"tasn_new.c",0xb3);
          ...
          if ((uVar6 & 1) == 0) {
            if ((uVar6 & 0x300) == 0) {
              if ((uVar6 & 6) == 0) {
                ...
                if (iVar5 == 0) goto LAB_000b8f3a;
              }
              else {
                p_Var4 = sk_new_null();
                if (p_Var4 == (_STACK *)0x0) goto LAB_000b90f8;
                *pp_Var3 = p_Var4;
              }
            }
            else {
...
LAB_000b90ac:
  ...
  case '\x02':
    ...
    local_24 = (_STACK *)CRYPTO_malloc(it->size,"tasn_new.c",0x9a);
    if (local_24 != (_STACK *)0x0) {
      memset(local_24,0,it->size);
      asn1_set_choice_selector((ASN1_VALUE **)&local_24,-1,it);
      goto joined_r0x000b9098;
    }
    break;
  case '\x03':
    if (ppcVar1 == (code **)0x0) {
