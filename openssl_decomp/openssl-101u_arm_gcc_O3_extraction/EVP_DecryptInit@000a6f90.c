...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher != (EVP_CIPHER *)0x0) {
      if (pEVar5 != (EVP_CIPHER *)0x0) goto LAB_000a6fc8;
      goto LAB_000a7000;
    }
    if (pEVar5 == (EVP_CIPHER *)0x0) goto LAB_000a7180;
LAB_000a703c:
...
LAB_000a707a:
      if (iVar1 == 0x10) goto LAB_000a7046;
...
LAB_000a7180:
      ...
      if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar5->nid)) goto LAB_000a703c;
LAB_000a6fc8:
      uVar6 = ctx->flags;
...
LAB_000a701e:
      ...
      ctx->flags = 0;
      ctx->key_len = iVar1;
      if (-1 < (int)(uVar6 << 0x19)) goto LAB_000a703c;
      if (pEVar5->ctrl == (_func_1094 *)0x0) {
        ...
        if (iVar1 == -1) {
          ...
          if (iVar1 != 1 && iVar1 != 8) goto LAB_000a707a;
          goto LAB_000a7046;
        }
      }
      iVar1 = 0xbd;
      ...
      iVar1 = 0x9d;
      if (cipher != (EVP_CIPHER *)0x0) goto LAB_000a701e;
    }
    ERR_put_error(6,0x7b,0x86,"evp_enc.c",iVar1);
switchD_000a70b4_caseD_6:
    iVar1 = 0;
  }
  return iVar1;
}
