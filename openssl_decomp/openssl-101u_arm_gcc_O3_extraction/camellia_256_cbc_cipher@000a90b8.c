...
undefined4 camellia_256_cbc_cipher(int param_1,uchar *param_2,uchar *param_3,size_t param_4)

{
  ...
  if (param_4 != 0) {
    Camellia_cbc_encrypt
              (param_3,param_2,param_4,*(CAMELLIA_KEY **)(param_1 + 0x60),(uchar *)(param_1 + 0x20),
               *(int *)(param_1 + 8));
  }
  return 1;
}
