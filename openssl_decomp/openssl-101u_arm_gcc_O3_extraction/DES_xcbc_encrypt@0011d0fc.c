...
LAB_0011d52a:
  ...
  case -2:
    ...
    break;
  default:
    goto switchD_0011d4a0_caseD_8;
  case -7:
    goto LAB_0011d4de;
  case -6:
    goto switchD_0011d4a0_caseD_fffffffa;
  case -5:
    puVar12 = local_50;
    goto LAB_0011d4ce;
  case -4:
    goto switchD_0011d4a0_caseD_fffffffc;
  case -3:
  }
  puVar12 = local_50 + -1;
  local_50[-1] = (uchar)uVar27;
switchD_0011d4a0_caseD_fffffffc:
  puVar12[-1] = (uchar)(uVar28 >> 0x18);
  puVar12 = puVar12 + -1;
LAB_0011d4ce:
  local_50 = puVar12 + -1;
  puVar12[-1] = (uchar)(uVar28 >> 0x10);
switchD_0011d4a0_caseD_fffffffa:
  local_50[-1] = (uchar)(uVar28 >> 8);
  local_50 = local_50 + -1;
LAB_0011d4de:
  local_50[-1] = (uchar)uVar28;
switchD_0011d4a0_caseD_8:
  (*ivec)[0] = bVar3;
  (*ivec)[1] = bVar2;
  (*ivec)[2] = bVar1;
  (*ivec)[4] = bVar8;
