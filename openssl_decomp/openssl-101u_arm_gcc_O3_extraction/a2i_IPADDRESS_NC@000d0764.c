...
LAB_000d082a:
          ...
          if (local_4c == 3) {
            if (local_54 < 1) {
LAB_000d07f0:
              if (local_50 < 0) goto LAB_000d08de;
LAB_000d07f4:
            ...
            if (local_50 == 0) goto LAB_000d07f4;
            if (local_50 == local_54) goto LAB_000d07f0;
          }
          else if ((local_50 != 0) && (local_50 != local_54)) goto LAB_000d07f0;
        }
      }
    }
    CRYPTO_free(__s);
