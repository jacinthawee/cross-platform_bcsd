...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (cipher == (EVP_CIPHER *)0x0) {
      if (pEVar4 == (EVP_CIPHER *)0x0) goto LAB_000a73ec;
      goto LAB_000a72c8;
    }
    if (pEVar4 != (EVP_CIPHER *)0x0) goto LAB_000a724e;
  }
...
LAB_000a73ec:
    ...
    if ((cipher == (EVP_CIPHER *)0x0) || (cipher->nid == pEVar4->nid)) goto LAB_000a72c8;
LAB_000a724e:
    uVar5 = ctx->flags;
  ...
  if (impl == (ENGINE *)0x0) {
    ...
    if (impl != (ENGINE *)0x0) goto LAB_000a729a;
  }
  else {
...
LAB_000a729a:
    ...
    if (cipher == (EVP_CIPHER *)0x0) {
      ERR_put_error(6,0x7b,0x86,"evp_enc.c",0x9d);
      return 0;
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    pvVar2 = CRYPTO_malloc(iVar1,"evp_enc.c",0xb1);
...
LAB_000a72c8:
    ...
    if ((key != (uchar *)0x0) || ((int)(pEVar4->flags << 0x1a) < 0)) {
      iVar1 = (*pEVar4->init)(ctx,key,iv,0);
      if (iVar1 == 0) {
        return 0;
      }
      pEVar4 = ctx->cipher;
  ...
  ERR_put_error(6,0x7b,0x86,"evp_enc.c",0xbd);
  return 0;
}
