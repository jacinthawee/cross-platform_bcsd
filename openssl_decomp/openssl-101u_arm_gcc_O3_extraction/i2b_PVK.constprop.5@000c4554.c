...
LAB_000c45aa:
    if (uVar1 != 0) {
      ...
      if (-1 < iVar16) {
        ...
        if (param_1 == (undefined4 *)0x0) goto LAB_000c4758;
        puVar2 = (undefined *)*param_1;
        if (puVar2 == (undefined *)0x0) {
          puVar2 = (undefined *)CRYPTO_malloc(iVar17,"pvkfmt.c",0x330);
          if (puVar2 == (undefined *)0x0) {
...
LAB_000c4686:
          ...
          if (param_3 == (uchar *)0x0) goto LAB_000c4758;
          if (param_4 == (code *)0x0) {
