...

{
  ...
  case 1:
    ...
    if (iVar8 != 0x32f) {
      ERR_GOST_error(0x80,0x6c,"gost_pmeth.c",0x1cb);
      return 0;
    }
  ...
  case 6:
    if (param_3 != 0x20) {
      ERR_GOST_error(0x80,0x6f,"gost_pmeth.c",0x1db);
      return 0;
    }
    iVar8 = 1;
  ...
  case 7:
    ...
    if (iVar8 != 0) {
LAB_000f8334:
                    /* WARNING: Could not recover jumptable at 0x000f8346. Too many branches */
    ...
    if (pkey == (EVP_PKEY *)0x0) {
      ERR_GOST_error(0x80,0x74,"gost_pmeth.c",0x1eb);
    }
    else {
      piVar1 = (int *)EVP_PKEY_get0(pkey);
      if (piVar1 != (int *)0x0) goto LAB_000f8334;
      ERR_GOST_error(0x80,0x74,"gost_pmeth.c",0x1f1);
    }
  }
  return iVar8;
}
