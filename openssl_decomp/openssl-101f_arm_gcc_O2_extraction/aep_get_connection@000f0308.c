...

{
  ...
  CRYPTO_lock(9,0x1e,"e_aep.c",0x365);
  _Var1 = getpid();
  if (recorded_pid == _Var1) {
      ...
      if (*(int *)(aep_app_conn_table + iVar3) == 0) {
        ...
        if (iVar2 == 0) {
          ...
          *(undefined4 *)(aep_app_conn_table + iVar5 + 4) = uVar4;
          ...
          ERR_put_error(AEPHK_lib_error_code,0x66,0x73,"e_aep.c",0x3b8);
        }
        goto LAB_000f03b8;
      }
    } while (iVar2 != 0x100);
    ...
    if (iVar2 == 0) {
      iVar2 = (*p_AEP_SetBNCallBacks)(0xf0015,0xf0021,0xf0059);
      if (iVar2 == 0) {
        do {
        ...
        if (iVar2 == 0) {
          ...
          ERR_put_error(AEPHK_lib_error_code,0x66,0x73,"e_aep.c",0x39a);
          recorded_pid = 0;
        }
      }
      else {
        ...
        ERR_put_error(AEPHK_lib_error_code,0x66,0x72,"e_aep.c",900);
        recorded_pid = 0;
      }
    }
    else {
      ...
      ERR_put_error(AEPHK_lib_error_code,0x66,0x6b,"e_aep.c",0x379);
      recorded_pid = 0;
    }
  }
LAB_000f03b8:
  CRYPTO_lock(10,0x1e,"e_aep.c",0x3c3);
  return iVar2;
}
