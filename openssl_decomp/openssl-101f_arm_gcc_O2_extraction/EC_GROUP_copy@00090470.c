...

{
  ...
  if (*(int *)(*(int *)dst + 0x14) == 0) {
    ERR_put_error(0x10,0x6a,0x42,"ec_lib.c",0xb1);
    return 0;
  }
  if (*(int *)dst != *(int *)src) {
    ERR_put_error(0x10,0x6a,0x65,"ec_lib.c",0xb6);
    return 0;
  }
  if (dst == src) {
    return 1;
  ...
  for (piVar10 = *(int **)(src + 0x44); piVar10 != (int *)0x0; piVar10 = (int *)*piVar10) {
    ...
    puVar2 = (undefined4 *)CRYPTO_malloc(0x14,"ec_lib.c",0x23a);
...
LAB_000906bc:
      ...
      piVar5 = (int *)CRYPTO_malloc(0x44,"ec_lib.c",0x2c4);
      if (piVar5 == (int *)0x0) {
  ...
  *(undefined4 *)(dst + 0x38) = uVar7;
  if (iVar1 == 0) {
    ...
    *(undefined4 *)(dst + 0x40) = 0;
    ...
    pvVar9 = CRYPTO_malloc(*(int *)(src + 0x40),"ec_lib.c",0xe6);
    ...
    *(undefined4 *)(dst + 0x40) = *(undefined4 *)(src + 0x40);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00090632. Too many branches */
