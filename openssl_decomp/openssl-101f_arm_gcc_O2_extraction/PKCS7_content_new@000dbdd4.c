...

{
  ...
  case 0x15:
    ...
    (a->d).data = pAVar6;
    goto joined_r0x000dbede;
  case 0x16:
    a->type = pAVar1;
    pPVar8 = PKCS7_SIGNED_new();
    (a->d).sign = pPVar8;
    if (pPVar8 == (PKCS7_SIGNED *)0x0) goto LAB_000dbe12;
  ...
  case 0x17:
    ...
    if ((pPVar4 == (PKCS7_ENVELOPE *)0x0) ||
       (iVar3 = ASN1_INTEGER_set(pPVar4->version,0), iVar3 == 0)) goto LAB_000dbe12;
  ...
  case 0x18:
    ...
    if (pPVar5 == (PKCS7_SIGN_ENVELOPE *)0x0) goto LAB_000dbe12;
    ASN1_INTEGER_set(pPVar5->version,1);
    iVar3 = ASN1_INTEGER_set(((a->d).sign)->version,1);
    if (iVar3 == 0) goto LAB_000dbe12;
  ...
  case 0x19:
    ...
    (a->d).digest = pPVar7;
    if (pPVar7 == (PKCS7_DIGEST *)0x0) goto LAB_000dbe12;
    pAVar6 = (ASN1_STRING *)ASN1_INTEGER_set(pPVar7->version,0);
joined_r0x000dbede:
    if (pAVar6 == (ASN1_STRING *)0x0) goto LAB_000dbe12;
    break;
  case 0x1a:
    a->type = pAVar1;
    ...
    if ((pPVar2 == (PKCS7_ENCRYPT *)0x0) ||
       (iVar3 = ASN1_INTEGER_set(pPVar2->version,0), iVar3 == 0)) goto LAB_000dbe12;
