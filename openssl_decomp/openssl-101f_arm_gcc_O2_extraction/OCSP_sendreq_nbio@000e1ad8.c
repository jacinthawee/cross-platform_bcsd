...
LAB_000e1b30:
        lVar6 = BIO_ctrl(*(BIO **)(rctx + 0x10),3,0,&local_30);
        pbVar9 = local_30;
        if (lVar6 < 2) goto LAB_000e1b74;
        if (*local_30 != 0x30) goto LAB_000e1cc4;
        ...
        if (bVar15) {
          *(uint *)(rctx + 0x14) = uVar12;
          ...
          pbVar9 = local_30 + 1;
          if (lVar6 < 6) goto LAB_000e1b74;
          uVar12 = uVar12 & 0x7f;
          if (3 < uVar12 - 1) goto LAB_000e1cc4;
          pbVar14 = local_30 + 2;
          uVar11 = 0;
          pbVar9 = pbVar14;
          do {
          ...
          if (0x19000 < uVar11) goto LAB_000e1cc4;
      ...
      while ((sVar2 = BIO_ctrl(*(BIO **)(rctx + 0x10),3,0,&local_30), 0 < (int)sVar2 &&
        ...
        if (iVar7 < 1) {
          ...
          pbVar9 = local_30;
          if (iVar7 != 0) goto LAB_000e1b74;
          goto LAB_000e1cc4;
        }
        if (*(int *)(rctx + 8) == iVar7) goto LAB_000e1cc4;
        pbVar9 = *(byte **)(rctx + 4);
        if (*(int *)rctx == 1) {
          uVar12 = (uint)*pbVar9;
          if (uVar12 == 0) {
...
LAB_000e1d8c:
          ...
          *pbVar14 = 0;
          ...
          if (*local_2c[0] != 0) goto LAB_000e1cc4;
          uVar12 = (uint)pbVar14[1];
          pbVar14 = pbVar14 + 1;
          if (uVar12 != 0) {
            puVar10 = *ppuVar5;
LAB_000e1c36:
            if ((int)((uint)puVar10[uVar12] << 0x12) < 0) goto LAB_000e1c30;
...
LAB_000e1c7a:
      ...
      if (*(int *)(rctx + 8) <= (int)sVar2) goto LAB_000e1cc4;
      uVar12 = *(uint *)rctx;
      goto joined_r0x000e1afa;
    }
    if (uVar12 != 0x1007) {
      if (uVar12 == 0x1008) {
        return 1;
