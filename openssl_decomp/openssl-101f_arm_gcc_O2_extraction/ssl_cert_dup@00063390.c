...

{
  ...
  iVar8 = param_1[5];
  r = (RSA *)param_1[6];
  *__s = (*param_1 - (int)(param_1 + 0xc) & 0xfffffffcU) + 0x30 + (int)__s;
  __s[1] = iVar11;
  __s[2] = iVar9;
  __s[3] = iVar6;
  __s[4] = iVar7;
  ...
  pDVar2 = (DH *)param_1[8];
  __s[7] = param_1[7];
  if (pDVar2 == (DH *)0x0) goto LAB_0006343e;
...
LAB_0006343e:
    ...
    do {
      while( true ) {
        ...
        if (iVar6 != 0) {
          piVar12[0xc] = iVar6;
          CRYPTO_add_lock((int *)(iVar6 + 0x10),1,3,"ssl_cert.c",0x119);
        }
        iVar6 = param_1[0xd];
        param_1 = param_1 + 3;
        if (iVar6 != 0) break;
LAB_0006346a:
        uVar10 = uVar10 + 1;
        piVar12 = piVar12 + 3;
        if (uVar10 == 8) goto LAB_000634da;
      }
      piVar12[0xd] = iVar6;
      CRYPTO_add_lock((int *)(iVar6 + 8),1,10,"ssl_cert.c",0x120);
      if (uVar10 < 6) goto LAB_0006346a;
      uVar10 = uVar10 + 1;
