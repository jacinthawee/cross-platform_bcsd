...

{
  ...
  if (param_3 == (X509_NAME *)0x0) goto LAB_000cf47a;
  local_130 = param_2;
  if (param_2 == 1) {
    local_12c = local_c8;
    ...
    local_4c = param_3;
    str = BUF_MEM_new();
    if (str != (BUF_MEM *)0x0) goto LAB_000cf4aa;
LAB_000cf72c:
    ERR_put_error(0xb,0x67,7,"by_dir.c",0x13f);
  }
  else {
    if (param_2 == 2) {
      local_12c = local_c8;
      ...
      local_74 = param_3;
      str = BUF_MEM_new();
      if (str == (BUF_MEM *)0x0) goto LAB_000cf72c;
LAB_000cf4aa:
      ...
      if (0 < iVar2) {
        do {
          ...
          if (param_3 == (X509_NAME *)0x0) {
            ERR_put_error(0xb,0x67,0x41,"by_dir.c",0x14f);
            goto LAB_000cf5a8;
          }
          if (param_2 == 2) {
            pcVar6 = ppcVar3[2];
            ...
            if (pcVar6 != (char *)0x0) {
              local_128[0] = uVar1;
              CRYPTO_lock(5,0xb,"by_dir.c",0x155);
              ...
              CRYPTO_lock(6,0xb,"by_dir.c",0x161);
            }
            while( true ) {
            ...
            while( true ) {
              ...
              if (local_13c == (char *)0x0) goto LAB_000cf53e;
              pcVar6 = pcVar6 + 1;
            }
            local_13c = (char *)0x0;
          }
...
LAB_000cf53e:
          CRYPTO_lock(9,0xb,"by_dir.c",0x1a7);
          ...
          CRYPTO_lock(10,0xb,"by_dir.c",0x1ab);
          if (param_2 == 2) {
            CRYPTO_lock(9,0xb,"by_dir.c",0x1b2);
            if ((local_13c == (char *)0x0) &&
              ...
              data = (ulong *)CRYPTO_malloc(8,"by_dir.c",0x1c0);
              *data = uVar1;
              data[1] = (ulong)pcVar6;
              param_3 = (X509_NAME *)sk_push((_STACK *)ppcVar3[2],data);
              if (param_3 == (X509_NAME *)0x0) {
                CRYPTO_lock(10,0xb,"by_dir.c",0x1c5);
                CRYPTO_free(data);
                goto LAB_000cf5a8;
              }
            }
            ...
            CRYPTO_lock(10,0xb,"by_dir.c",0x1ce);
          }
...
LAB_000cf5a8:
    ...
    ERR_put_error(0xb,0x67,0x70,"by_dir.c",0x139);
  }
  param_3 = (X509_NAME *)0x0;
LAB_000cf47a:
