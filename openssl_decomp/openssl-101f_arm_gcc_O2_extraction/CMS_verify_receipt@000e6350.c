...

{
  ...
  iVar3 = sk_num(p_Var2);
  if (iVar3 < 1) {
    ERR_put_error(0x2e,0x9d,0x87,"cms_smime.c",0x150);
  }
  else {
    iVar8 = 0;
    iVar3 = 0;
    ...
    if (iVar3 == iVar8) {
      ...
      if (st_00 == (_STACK *)0x0) {
        ...
        do {
          iVar8 = sk_num(p_Var2);
          if (iVar8 <= iVar3) goto LAB_000e640c;
...
LAB_000e640c:
        ...
        if ((flags & 8) == 0) {
          do {
            iVar3 = sk_num(p_Var2);
            uVar11 = uVar10 + 1;
            if (iVar3 <= (int)uVar10) goto LAB_000e649e;
...
LAB_000e649e:
          ...
          if ((chain != (BIO *)0x0) &&
            ...
            if ((flags & 4) == 0) {
              do {
                iVar3 = sk_num(p_Var2);
                if (iVar3 <= (int)uVar10) goto LAB_000e64c2;
                pCVar5 = (CMS_SignerInfo *)sk_value(p_Var2,uVar10);
...
LAB_000e64c2:
    ...
    ERR_put_error(0x2e,0x9d,0x8a,"cms_smime.c",0x161);
  }
