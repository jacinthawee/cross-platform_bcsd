...
switchD_0004eb7e_caseD_8:
  ...
  case 2:
    ...
    ERR_put_error(0x14,0x85,4,"s3_lib.c",0xd7f);
    goto switchD_0004eb7e_caseD_8;
  case 3:
    pRVar2 = (RSA *)DHparams_dup((DH *)param_4);
    if (pRVar2 == (RSA *)0x0) {
      ERR_put_error(0x14,0x85,5,"s3_lib.c",0xd9a);
    }
    else if ((*(int *)(param_1 + 0xa4) << 0xb < 0) ||
            (pRVar4 = (RSA *)DH_generate_key((DH *)pRVar2), pRVar4 != (RSA *)0x0)) {
  ...
  case 4:
    if (param_4 == (RSA *)0x0) {
      ERR_put_error(0x14,0x85,0x2b,"s3_lib.c",0xdba);
      pRVar2 = param_4;
    }
    else {
      pRVar2 = (RSA *)EC_KEY_dup((EC_KEY *)param_4);
      if (pRVar2 == (RSA *)0x0) {
        ERR_put_error(0x14,0x85,0x10,"s3_lib.c",0xdc0);
      }
        ...
        *(RSA **)(iVar8 + 0x28) = pRVar2;
        ...
        ERR_put_error(0x14,0x85,0x2b,"s3_lib.c",0xdc8);
        pRVar2 = pRVar4;
      }
    }
    break;
...
LAB_0004ed5c:
  ...
  case 0xe:
    ...
    if (st == (_STACK *)0x0) {
      ...
      *(_STACK **)(param_1 + 0x94) = st;
      if (st == (_STACK *)0x0) goto switchD_0004eb7e_caseD_8;
    }
    sk_push(st,param_4);
    pRVar2 = (RSA *)0x1;
    break;
  ...
  case 0x3b:
    ...
    if (param_4 != (RSA *)0x0) {
      if (param_3 == 0x30) {
        ...
        ERR_put_error(0x14,0x85,0x145,"s3_lib.c",0xde8);
        pRVar2 = (RSA *)0x0;
      }
    }
    break;
    ...
    *(undefined4 *)(param_1 + 0x174) = 0;
    if (param_4 != (RSA *)0x0) {
      ...
      if ((0xff < sVar1) || (*(char *)&param_4->pad == '\0')) {
        ERR_put_error(0x14,0x85,0x165,"s3_lib.c",0xe0f);
        return (RSA *)0x0;
      }
      pcVar3 = BUF_strdup((char *)param_4);
      *(char **)(param_1 + 0x174) = pcVar3;
      if (pcVar3 == (char *)0x0) {
        ERR_put_error(0x14,0x85,0x44,"s3_lib.c",0xe14);
        return (RSA *)0x0;
      }
    }
    goto LAB_0004edd2;
  ...
  case 0x51:
    ...
    *(undefined4 *)(param_1 + 0x170) = 0x4e475;
    pRVar2 = (RSA *)0x1;
    break;
  case 0x52:
