...

{
  ...
  if (ubsec_dso == (DSO *)0x0) {
    ...
    if (ubsec_dso == (DSO *)0x0) {
      ...
      ERR_put_error(UBSEC_lib_error_code,0x69,0x67,"e_ubsec.c",0x195);
    }
    else {
      ...
      if ((((((pDVar1 == (DSO_FUNC_TYPE)0x0) ||
        ...
        ERR_put_error(UBSEC_lib_error_code,0x69,0x67,"e_ubsec.c",0x1b1);
      }
      else {
        ...
        if ((0 < iVar14) &&
           (iVar15 = (*p_UBSEC_max_key_len_ioctl)(iVar14,PTR_max_key_len_000f7524), iVar15 == 0)) {
