...

{
  ...
  data = (void **)CRYPTO_malloc(0xc,"pcy_node.c",0x76);
  if (data != (void **)0x0) {
    *data = param_2;
    data[1] = param_3;
    data[2] = (void *)0x0;
    if (param_1 != 0) {
      ...
      if (iVar1 == 0x2ea) {
        if (*(int *)(param_1 + 8) != 0) goto LAB_001125d2;
        *(void ***)(param_1 + 8) = data;
      }
      else {
        p_Var2 = *(_STACK **)(param_1 + 4);
        if (p_Var2 == (_STACK *)0x0) {
          p_Var2 = sk_new(node_cmp + 1);
          *(_STACK **)(param_1 + 4) = p_Var2;
          if (p_Var2 == (_STACK *)0x0) goto LAB_001125d2;
        }
        iVar1 = sk_push(p_Var2,data);
        if (iVar1 == 0) goto LAB_001125d2;
      }
    }
    if (param_4 != 0) {
