...
LAB_00017dfe:
        param_1 = param_1 + -1;
        ppcVar13 = ppcVar13 + 1;
        if (param_1 < 1) goto LAB_00017e54;
      }
      ...
      if (iVar8 != 0) {
        ...
        if ((((cVar2 == '-') && (__s1[1] == 'i')) && (__s1[2] == 'n')) && (__s1[3] == '\0')) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_00017efe;
          local_4c = ppcVar13[1];
          ppcVar13 = ppcVar13 + 1;
        }
        else {
      ...
      if (param_1 == 1) goto LAB_00017efe;
      param_1 = param_1 + -2;
...
LAB_00017e54:
  ...
  if (dh == (DH *)0x0 || bp == (BIO *)0x0) {
    ...
    uVar12 = 1;
    if (dh == (DH *)0x0) goto LAB_0001809a;
    uVar12 = 1;
    x = (DH *)0x0;
  }
  else {
    ...
    if (x == (DH *)0x0) {
      ...
      if (bVar5) {
        ...
        to = (uchar *)CRYPTO_malloc(iVar7 >> 3,"dh.c",0x11e);
        if (to == (uchar *)0x0) {
          uVar12 = 1;
