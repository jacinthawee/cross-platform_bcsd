...
LAB_000616b4:
  ...
  __s = (SSL_CTX *)CRYPTO_malloc(0x1b8,"ssl_lib.c",0x6a6);
  if (__s == (SSL_CTX *)0x0) goto LAB_000616b4;
  memset(__s,0,0x1b8);
      ...
      if (pXVar5 != (X509_STORE *)0x0) {
        ...
        if (pXVar6 != (X509_VERIFY_PARAM *)0x0) {
          ...
          if (p_Var8 != (_STACK *)0x0) {
            ...
            puVar10 = (undefined4 *)CRYPTO_malloc(0xc,"ssl_lib.c",0x729);
            __s->rbuf_freelist = (ssl3_buf_freelist_st *)puVar10;
            if (puVar10 != (undefined4 *)0x0) {
              *puVar10 = 0;
              puVar10[1] = 0;
              puVar10[2] = 0;
              puVar10 = (undefined4 *)CRYPTO_malloc(0xc,"ssl_lib.c",0x72f);
