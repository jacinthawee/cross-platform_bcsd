    ...
    if (iVar2 != 0) {
      if (*local_4c == '\x04') {
        ...
        if ((a == (ASN1_OCTET_STRING *)0x0) || (a->length != 0x20)) {
          pBVar5 = (BIGNUM *)0x0;
          ERR_GOST_error(0x84,0x72,"gost_ameth.c",0x14f);
          goto LAB_0011a2e2;
        }
        piVar3 = &local_1c;
        do {
        ...
        if (ai == (ASN1_INTEGER *)0x0) goto LAB_0011a2e0;
        pBVar5 = ASN1_INTEGER_to_BN(ai,(BIGNUM *)0x0);
        ASN1_INTEGER_free(ai);
        prv = pBVar5;
        if (pBVar5 == (BIGNUM *)0x0) {
          ERR_GOST_error(0x84,0x72,"gost_ameth.c",0x162);
          goto LAB_0011a2e2;
        }
      }
