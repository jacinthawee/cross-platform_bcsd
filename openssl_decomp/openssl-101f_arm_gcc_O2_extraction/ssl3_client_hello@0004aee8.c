...

{
  ...
  if (param_1->state == 0x1110) {
    ...
    iVar2 = ssl_fill_hello_random(param_1,0,param_1->s3->client_random,0x20);
    if (iVar2 < 1) {
      return 0xffffffff;
    }
    ...
    *(undefined4 *)(pcVar14 + 0x22) = uVar6;
    ...
    iVar2 = ssl_cipher_list_to_bytes(param_1,psVar3,pcVar10,0);
    if (iVar2 == 0) {
      ERR_put_error(0x14,0x83,0xb5,"s3_clnt.c",0x2f1);
      return 0xffffffff;
    }
    pcVar11[1] = (char)iVar2;
    *pcVar11 = (char)((uint)iVar2 >> 8);
    pcVar11 = pcVar10 + iVar2 + 1;
    ...
    *pcVar11 = '\0';
    ...
    if (iVar2 < 1) {
      ERR_put_error(0x14,0x83,0xe2,"s3_clnt.c",0x317);
      return 0xffffffff;
    }
    iVar2 = ssl_add_clienthello_tlsext(param_1,pcVar11 + 1,pcVar14 + 0x4000);
    if (iVar2 == 0) {
      iVar2 = 0x31c;
LAB_0004b0cc:
      ERR_put_error(0x14,0x83,0x44,"s3_clnt.c",iVar2);
      return 0xffffffff;
    }
    iVar15 = iVar2 - (int)(pcVar14 + 4);
    pcVar14[3] = (char)iVar15;
    *pcVar14 = '\x01';
    pcVar14[1] = (char)((uint)iVar15 >> 0x10);
    pcVar14[2] = (char)((uint)iVar15 >> 8);
    param_1->init_num = iVar2 - (int)pcVar14;
    param_1->init_off = 0;
