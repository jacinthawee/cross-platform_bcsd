...

{
  ...
  if (iVar1 == 0) {
    ERR_put_error(0x27,0x68,0x6e,"ocsp_srv.c",0xd9);
    goto LAB_000e2a8c;
  }
  if ((int)(flags << 0x1f) < 0) {
LAB_000e29fc:
...
LAB_000e2a44:
    ...
    if (p_Var3 == (_STACK *)0x0) {
      ...
      if (p_Var3 != (_STACK *)0x0) goto LAB_000e2a82;
    }
    else {
LAB_000e2a82:
      ...
      if (iVar1 != 0) {
        iVar5 = 0;
        CRYPTO_add_lock(&signer->references,1,3,"ocsp_srv.c",0xcc);
        iVar1 = sk_num(&certs->stack);
        if (-1 < -iVar1) goto LAB_000e29fc;
        data = sk_value(&certs->stack,0);
        p_Var3 = (_STACK *)brsp->certs;
        if (p_Var3 == (_STACK *)0x0) goto LAB_000e2b26;
        do {
          do {
            iVar1 = sk_push(p_Var3,data);
            if (iVar1 == 0) goto LAB_000e2a8a;
            iVar5 = iVar5 + 1;
            CRYPTO_add_lock((int *)((int)data + 0x10),1,3,"ocsp_srv.c",0xcc);
            iVar1 = sk_num(&certs->stack);
            if (iVar1 <= iVar5) goto LAB_000e29fc;
