...
LAB_00107322:
  ...
  if ((bVar1 & 0xfa) == 0) {
    iVar5 = 0x144;
    if ((bVar1 & 1) != 0) goto LAB_00107322;
    if ((bVar1 & 0xfe) == 0) {
      if (param_4 != 1) {
        ERR_put_error(0x10,0xa0,0x66,"ec2_oct.c",0x14c);
        return uVar6;
      }
...
LAB_0010741a:
    ...
    if (uVar6 == 2) {
      ...
      if (pBVar4 == (BIGNUM *)0x0) goto LAB_00107448;
    ...
    if (iVar5 != 0) {
      uVar6 = EC_POINT_is_on_curve((EC_GROUP *)param_1,param_2,param_5);
      if (uVar6 == 0) {
        ERR_put_error(0x10,0xa0,0x6b,"ec2_oct.c",0x18b);
      }
      else {
        uVar6 = 1;
      }
