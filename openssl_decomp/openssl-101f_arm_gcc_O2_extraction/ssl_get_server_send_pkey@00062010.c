...
LAB_000621e6:
  ...
  if (((uVar13 & 0x60) == 0) && (-1 < (int)(uVar8 << 0x19))) {
    if ((int)(uVar13 << 0x1e) < 0) {
      uVar8 = 3;
    }
    else if ((int)(uVar13 << 0x1d) < 0) {
      uVar8 = 4;
    }
    else if ((int)(uVar8 << 0x1e) < 0) {
      uVar8 = 2;
    }
    else if ((uVar8 & 1) == 0) {
      if ((int)(uVar8 << 0x1a) < 0) {
