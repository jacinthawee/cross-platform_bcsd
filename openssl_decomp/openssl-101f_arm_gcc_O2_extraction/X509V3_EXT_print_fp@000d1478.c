...

{
  ...
  if (method == (X509V3_EXT_METHOD *)0x0) {
    ...
    if (Elf32_Ehdr_00010000.e_ident_magic_str <= pEVar2) goto joined_r0x000d15a4;
joined_r0x000d15f4:
    if ((flag & 0xf0000U) == 0) goto LAB_000d150a;
  }
  else {
    pAVar1 = ext->value;
    ...
    if (val != (Elf32_Ehdr *)0x0) {
      if (method->i2s == (X509V3_EXT_I2S)0x0) {
        ...
        if (st == (Elf32_Ehdr *)0x0) {
          if (method->i2r == (X509V3_EXT_I2R)0x0) goto LAB_000d1546;
...
LAB_000d1546:
    ...
    pEVar2 = val;
    if ((flag & 0xf0000U) < 0x10001) goto joined_r0x000d15f4;
joined_r0x000d15a4:
