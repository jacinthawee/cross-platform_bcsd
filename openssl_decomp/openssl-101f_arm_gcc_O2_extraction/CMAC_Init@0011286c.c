...

{
  ...
  if (key != (void *)0x0 || cipher != (EVP_CIPHER *)0x0) {
    if ((cipher == (EVP_CIPHER *)0x0) ||
      ...
      if (((pEVar2 != (EVP_CIPHER *)0x0) &&
         ...
         (iVar1 = EVP_EncryptInit_ex((EVP_CIPHER_CTX *)ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,
                                     (uchar *)key,&zero_iv_11111), iVar1 != 0)) {
        out = ctx + 0xcc;
        sVar3 = EVP_CIPHER_CTX_block_size((EVP_CIPHER_CTX *)ctx);
        iVar1 = EVP_Cipher((EVP_CIPHER_CTX *)ctx,(uchar *)out,&zero_iv_11111,sVar3);
        if (iVar1 != 0) {
          if (0 < (int)sVar3) {
            sVar7 = 0;
            pCVar6 = ctx + 0xcb;
    ...
    if ((*(int *)(ctx + 0x10c) != -1) &&
       (iVar1 = EVP_EncryptInit_ex((EVP_CIPHER_CTX *)ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,
                                   (uchar *)0x0,&zero_iv_11111), iVar1 != 0)) {
      sVar3 = EVP_CIPHER_CTX_block_size((EVP_CIPHER_CTX *)ctx);
