    ...
    if ((0xff << uVar8 & (uint)*EM) == 0) {
      ...
      if ((int)(cnt + sVar7 + 1) < iVar2) {
        if (*(byte *)((int)EM + iVar2 + -1) == 0xbc) {
          iVar2 = iVar2 - cnt;
          num = iVar2 - 1;
          mask = (uint *)CRYPTO_malloc(num,"rsa_pss.c",0x88);
          if (mask != (uint *)0x0) {
            iVar1 = PKCS1_MGF1((uchar *)mask,num,(byte *)((int)EM + num),cnt,Hash);
            if (iVar1 < 0) {
LAB_00120fb2:
              iVar1 = 0;
            }
...
LAB_00120f68:
                if (uVar8 == 1) {
                  if (((int)sVar7 < 0) || (sVar7 == num - uVar5)) {
                    ...
                    if (iVar1 == 0) {
                      ...
                      iVar1 = 0;
                      ERR_put_error(4,0x95,0x68,"rsa_pss.c",0xac);
                    }
                  }
                  else {
                    iVar1 = 0;
                    ERR_put_error(4,0x95,0x88,"rsa_pss.c",0x9c);
                  }
                  goto LAB_00120f90;
                }
              }
              iVar1 = 0;
              ERR_put_error(4,0x95,0x87,"rsa_pss.c",0x97);
            }
LAB_00120f90:
            CRYPTO_free(mask);
            goto LAB_00120dd0;
