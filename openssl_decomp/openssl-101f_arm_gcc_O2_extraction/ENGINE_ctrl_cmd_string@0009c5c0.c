...

{
  ...
  if (cmd_name == (char *)0x0 || e == (ENGINE *)0x0) {
    ERR_put_error(0x26,0xab,0x43,"eng_ctrl.c",0x129);
    return 0;
  }
  if (*(int *)(e + 0x40) != 0) {
      ...
      if (0 < iVar3) {
        ...
        if ((int)uVar1 < 0) {
          ...
          if ((int)uVar1 < 0) {
            ...
            if ((uVar1 & 4) != 0) {
              if (arg != (char *)0x0) {
                ERR_put_error(0x26,0xab,0x88,"eng_ctrl.c",0x154);
                return 0;
              }
            ...
            if (arg == (char *)0x0) {
              ERR_put_error(0x26,0xab,0x87,"eng_ctrl.c",0x164);
              return 0;
            }
            if ((int)(uVar1 << 0x1e) < 0) {
            ...
            if (uVar2 != 0) {
              ...
              ERR_put_error(0x26,0xab,0x85,"eng_ctrl.c",0x17d);
              return 0;
            }
            iVar3 = 0x176;
          }
        ...
        ERR_put_error(0x26,0xab,0x86,"eng_ctrl.c",0x142);
        return 0;
      }
    }
  }
  if (cmd_optional == 0) {
    ERR_put_error(0x26,0xab,0x89,"eng_ctrl.c",0x13c);
    return 0;
  }
  ERR_clear_error();
  return 1;
