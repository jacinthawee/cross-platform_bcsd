...
LAB_000cee52:
    if ((int)uVar3 < 8) {
      data = (int *)(PTR_trstandard_000cef78 + uVar3 * 0x18);
    }
    else {
...
LAB_000cee60:
    ...
    if (((trtable != (_STACK *)0x0) && (iVar2 = sk_find(trtable,local_38), iVar2 != -1)) &&
      ...
      if (-1 < (int)uVar3) goto LAB_000cee52;
      data = (int *)0x0;
      goto LAB_000cee60;
    }
    data = (int *)CRYPTO_malloc(0x18,"x509_trs.c",0xac);
    if (data == (int *)0x0) {
      ERR_put_error(0xb,0x85,0x41,"x509_trs.c",0xad);
      return 0;
    }
    uVar3 = 0xffffffff;
    data[1] = 1;
  ...
  *data = id;
  ...
  if (uVar3 == 0xffffffff) {
    if (trtable == (_STACK *)0x0) {
      ...
      iVar2 = 199;
      trtable = p_Var1;
      if (p_Var1 == (_STACK *)0x0) goto LAB_000ceede;
    }
