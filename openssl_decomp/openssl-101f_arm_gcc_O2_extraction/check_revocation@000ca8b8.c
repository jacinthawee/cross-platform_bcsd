...
LAB_000caa46:
        ...
        if (iVar2 == 0) {
          ...
          if ((st != (_STACK *)0x0) || (local_30 == (X509_CRL *)0x0)) {
            ...
            goto joined_r0x000caa44;
          }
        }
        else {
joined_r0x000caa44:
          if (local_30 == (X509_CRL *)0x0) goto LAB_000caa46;
        }
...
LAB_000ca9f0:
          ...
          goto LAB_000ca9f0;
          if (iVar2 != 2) goto LAB_000ca964;
        }
        X509_CRL_free(local_40);
        X509_CRL_free(a_00);
        iVar2 = *(int *)(param_1 + 0x78);
        local_40 = (X509_CRL *)0x0;
        if (iVar2 == iVar3) goto LAB_000caa46;
        iVar3 = iVar2;
      } while (iVar2 != 0x807f);
      X509_CRL_free((X509_CRL *)0x0);
      X509_CRL_free((X509_CRL *)0x0);
