...

{
  ...
  if (userKey == (uchar *)0x0) {
    ...
    if (bits == 0x80) {
      ...
      puVar7 = key->rd_key + 4;
      do {
        uVar2 = uVar2 ^ ((uint)(byte)(&DAT_0007e8e0)[uVar5 >> 0x18] |
                         (uint)(byte)(&DAT_0007e8e0)[uVar5 >> 0x10 & 0xff] << 0x18 |
                         (uint)(byte)(&DAT_0007e8e0)[uVar5 >> 8 & 0xff] << 0x10 |
                        (uint)(byte)(&DAT_0007e8e0)[uVar5 & 0xff] << 8) ^ *puVar6;
        uVar3 = uVar3 ^ uVar2;
        *puVar7 = uVar2;
        uVar4 = uVar4 ^ uVar3;
        puVar7[1] = uVar3;
      ...
      if (bits == 0xc0) {
        ...
        puVar7 = key->rd_key + 6;
        while( true ) {
          uVar2 = uVar2 ^ ((uint)(byte)(&DAT_0007e8e0)[uVar9 >> 0x18] |
                           (uint)(byte)(&DAT_0007e8e0)[uVar9 >> 0x10 & 0xff] << 0x18 |
                           (uint)(byte)(&DAT_0007e8e0)[uVar9 >> 8 & 0xff] << 0x10 |
                          (uint)(byte)(&DAT_0007e8e0)[uVar9 & 0xff] << 8) ^ *puVar6;
          uVar3 = uVar3 ^ uVar2;
          *puVar7 = uVar2;
          uVar4 = uVar4 ^ uVar3;
          puVar7[1] = uVar3;
