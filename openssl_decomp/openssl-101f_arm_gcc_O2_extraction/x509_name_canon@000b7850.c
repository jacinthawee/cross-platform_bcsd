          ...
          if ((int)pbVar9 < 1) {
            ...
            if (-1 < (int)(uVar16 << 0x18)) {
              ...
              do {
                ...
                pbVar9 = pbVar9 + -1;
                if (pbVar9 == (byte *)0x0) goto LAB_000b7946;
...
joined_r0x000b7a24:
                pbVar17 = pbVar13 + 1;
                if ((int)pbVar9 <= iVar5) goto LAB_000b7940;
              }
              ppuVar10 = __ctype_b_loc();
...
LAB_000b7948:
    ...
    do {
      ...
      p_Var12 = (_STACK *)
                ASN1_item_ex_i2d(local_2c,(uchar **)0x0,
                                 (ASN1_ITEM *)PTR_X509_NAME_ENTRIES_it_000b7b00,-1,-1);
      piVar2 = &num->num;
      num = p_Var12;
      iVar4 = iVar4 + 1;
    ...
    param_1[4] = num;
    local_30 = (_STACK *)CRYPTO_malloc((int)num,"x_name.c",0x16d);
    if (local_30 == (_STACK *)0x0) {
LAB_000b7a56:
      if (st == (_STACK *)0x0) goto LAB_000b7a5c;
      uVar15 = 0;
    }
    else {
      param_1[3] = local_30;
