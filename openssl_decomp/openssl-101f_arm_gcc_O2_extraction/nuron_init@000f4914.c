...

{
  ...
  if (pvDSOHandle == (DSO *)0x0) {
    ...
    if (pvDSOHandle == (DSO *)0x0) {
      ...
      ERR_put_error(NURON_lib_error_code,0x66,0x68,"e_nuron.c",0x88);
    }
    else {
      ...
      ERR_put_error(NURON_lib_error_code,0x66,0x67,"e_nuron.c",0x8f);
    }
  }
  else {
    if (NURON_lib_error_code == 0) {
    ...
    ERR_put_error(NURON_lib_error_code,0x66,100,"e_nuron.c",0x80);
  }
  return 0;
}
