...

{
  ...
  if (no_name == 0) {
    ...
    if (uVar1 == 0) {
      uVar1 = OBJ_ln2nid(s);
      if (uVar1 == 0) goto LAB_080d4c47;
    }
    if (uVar1 < 0x398) {
      pAVar3 = (ASN1_OBJECT *)(nid_objs + uVar1 * 0x18);
      if (*(int *)(nid_objs + uVar1 * 0x18 + 8) != 0) goto LAB_080d4cda;
      iVar2 = 0x140;
    }
    else {
      if (added == (_LHASH *)0x0) goto LAB_080d4d70;
      local_3c = local_38;
      local_40 = (uchar *)0x3;
      local_30 = uVar1;
...
LAB_080d4c47:
    ...
    if (0 < iVar2) {
      ...
      ptr = (uchar *)CRYPTO_malloc(num,"obj_dat.c",0x1d6);
      if (ptr != (uchar *)0x0) {
        local_40 = ptr;
