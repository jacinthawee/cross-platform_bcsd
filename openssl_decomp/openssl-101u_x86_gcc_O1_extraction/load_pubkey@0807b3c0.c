...

{
  ...
  if (param_2 == (UI_METHOD *)0x0) {
    if ((param_4 == 0) || (param_3 == 7)) {
      ...
      pBVar1 = BIO_s_file();
      bp = BIO_new(pBVar1);
      if (bp == (BIO *)0x0) goto LAB_0807b550;
...
LAB_0807b481:
      if (param_3 == 1) {
        ...
        if (key == (rsa_st *)0x0) goto LAB_0807b5f3;
LAB_0807b5ac:
        pkey = EVP_PKEY_new();
        ...
        if (key != (rsa_st *)0x0) goto LAB_0807b5ac;
LAB_0807b5f3:
        pkey = (EVP_PKEY *)0x0;
      }
      else if (param_3 == 3) {
...
LAB_0807b4c4:
      BIO_free(bp);
LAB_0807b423:
      if (pkey != (EVP_PKEY *)0x0) goto LAB_0807b42b;
    }
  }
  else if (param_3 == 7) {
    if (param_6 != (char *)0x0) {
