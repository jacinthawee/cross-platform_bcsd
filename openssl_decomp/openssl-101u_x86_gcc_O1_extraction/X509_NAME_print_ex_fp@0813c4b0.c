...
LAB_0813c6fc:
    ...
    if (indent < 0) {
      ...
      iVar8 = 0;
      do {
        sVar9 = fwrite(&DAT_081f8b67,1,1,fp);
        if (sVar9 != 1) goto LAB_0813c6fc;
        iVar8 = iVar8 + 1;
      } while (indent != iVar8);
    }
    uVar1 = flags & 0xf0000;
    if (uVar1 == 0x20000) {
      ...
      local_c4 = 3;
      local_c0 = 2;
      local_cc = &DAT_08226f24;
      local_b4 = ", ";
    }
    else if (uVar1 < 0x20001) {
      if (uVar1 != 0x10000) goto LAB_0813c6fc;
      local_b8 = 1;
      local_c8 = 1;
      iVar8 = 0;
      local_c4 = 1;
      local_c0 = 1;
      local_cc = &DAT_08223726;
      local_b4 = ",";
    }
      ...
      if (uVar1 != 0x40000) goto LAB_0813c6fc;
      local_b8 = 1;
      local_c8 = 3;
      local_c4 = 3;
      local_c0 = 1;
        ...
        if (local_88 != -1) {
          if (iVar10 == local_88) {
            if (fp != (FILE *)0x0) {
              ...
              if (local_c8 != sVar3) goto LAB_0813c6fc;
              iVar10 = ne->set;
            }
            ...
            if (fp != (FILE *)0x0) {
              ...
              if (sVar3 != local_b8) goto LAB_0813c6fc;
              if (iVar8 == 0) {
                iVar10 = ne->set;
              }
              else {
                iVar10 = 0;
                do {
                  sVar3 = fwrite(&DAT_081f8b67,1,1,fp);
                  if (sVar3 != 1) goto LAB_0813c6fc;
                  iVar10 = iVar10 + 1;
                } while (iVar8 != iVar10);
                iVar10 = ne->set;
              }
...
LAB_0813c9ed:
                ...
                if (fp != (FILE *)0x0) goto LAB_0813c870;
              }
            }
            else {
              sVar3 = fwrite(puVar6,1,local_a0,fp);
              if (sVar3 != local_a0) goto LAB_0813c6fc;
              if (((int)local_a0 < iVar11) && ((flags & 0x2000000) != 0)) goto LAB_0813c9ed;
LAB_0813c870:
              sVar3 = fwrite(__ptr,1,sVar9,fp);
              if (sVar9 != sVar3) goto LAB_0813c6fc;
            }
          }
          else {
            if (uVar2 == 0) {
            ...
            if (fp != (FILE *)0x0) {
              sVar3 = fwrite(&DAT_081eca46,1,0,fp);
              if (sVar3 == 0) {
                local_a0 = 0;
                goto LAB_0813c870;
              }
