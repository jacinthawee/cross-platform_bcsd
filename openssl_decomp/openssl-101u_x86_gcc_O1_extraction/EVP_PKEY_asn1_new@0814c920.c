...

{
  ...
  bVar4 = 0;
  ptr = (int *)CRYPTO_malloc(0x6c,"ameth_lib.c",0x11d);
  if (ptr == (int *)0x0) {
...
LAB_0814c9bc:
    ...
    ptr[3] = (int)pcVar1;
    if (pcVar1 != (char *)0x0) goto LAB_0814c9bc;
    ...
    ptr[4] = (int)pcVar1;
    if (pcVar1 != (char *)0x0) goto joined_r0x0814ca6d;
    if (((byte)*(EVP_PKEY_ASN1_METHOD *)(ptr + 2) & 2) == 0) {
      return (EVP_PKEY_ASN1_METHOD *)0x0;
    }
    if ((void *)ptr[3] == (void *)0x0) goto LAB_0814caac;
