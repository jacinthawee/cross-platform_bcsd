...

{
  ...
  iVar9 = (sVar3 + 1 >> 1) * 4 + 4;
  ptr = (char *)CRYPTO_malloc(sVar3 + 1,"apps.c",0x7ee);
  ptr_00 = CRYPTO_malloc(iVar9,"apps.c",0x7f0);
  ptr_01 = CRYPTO_malloc(iVar9,"apps.c",0x7f1);
  ptr_02 = (undefined4 *)CRYPTO_malloc(iVar9,"apps.c",0x7f2);
          ...
          *(char **)((int)ptr_00 + iVar9 * 4) = pcVar5;
          while( true ) {
            while( true ) {
              pcVar4 = pcVar5 + 1;
              cVar2 = *pcVar7;
              if (cVar2 == '\0') goto LAB_0807d098;
              if (cVar2 != '\\') break;
              pcVar1 = pcVar7 + 1;
              if (*pcVar1 == '\0') goto LAB_0807d208;
              pcVar7 = pcVar7 + 2;
              *pcVar5 = *pcVar1;
              pcVar5 = pcVar4;
            }
...
LAB_0807d098:
  ...
  if (ptr_01 == (void *)0x0) goto LAB_0807cfae;
LAB_0807cfa2:
  CRYPTO_free(ptr_01);
LAB_0807cfae:
  if (ptr_00 != (void *)0x0) {
