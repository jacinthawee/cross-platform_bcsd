...

{
  ...
  while( true ) {
    ...
    uVar3 = *(uint *)(&DAT_08236b00 + (uVar3 & 0xff) * 4) ^
            *(uint *)(&Camellia_SBOX + (uVar3 >> 0x18) * 4) ^
            *(uint *)(&DAT_08237300 + (uVar3 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_08236f00 + (uVar3 >> 0x10 & 0xff) * 4);
    ...
    uVar8 = *(uint *)(&DAT_08236b00 + (uVar8 & 0xff) * 4) ^
            *(uint *)(&Camellia_SBOX + (uVar8 >> 0x18) * 4) ^
            *(uint *)(&DAT_08237300 + (uVar8 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_08236f00 + (uVar8 >> 0x10 & 0xff) * 4);
    uVar3 = uVar8 ^ *(uint *)(&Camellia_SBOX + (uVar3 & 0xff) * 4) ^
                    *(uint *)(&DAT_08236f00 + (uVar3 >> 0x18) * 4) ^
                    *(uint *)(&DAT_08236b00 + (uVar3 >> 8 & 0xff) * 4) ^
                    *(uint *)(&DAT_08237300 + (uVar3 >> 0x10 & 0xff) * 4);
    uVar6 = uVar6 ^ uVar3;
    ...
    uVar10 = uVar8 ^ *(uint *)(&Camellia_SBOX + (uVar9 & 0xff) * 4) ^
                     *(uint *)(&DAT_08236f00 + (uVar9 >> 0x18) * 4) ^
                     *(uint *)(&DAT_08236b00 + (uVar9 >> 8 & 0xff) * 4) ^
                     *(uint *)(&DAT_08237300 + (uVar9 >> 0x10 & 0xff) * 4);
    uVar4 = uVar4 ^ uVar10;
