...
LAB_081c2a00:
    ...
    if (a_00 != (ASN1_STRING *)0x0) {
      ...
      a_00->length = iVar1;
      if (0 < iVar1) goto LAB_081c2a37;
      ERR_put_error(10,0x76,0x41,"dsa_ameth.c",0x92);
      if (local_24 != (uchar *)0x0) goto LAB_081c29f0;
      goto LAB_081c2a00;
    }
    ERR_put_error(10,0x76,0x41,"dsa_ameth.c",0x8d);
    if (local_24 != (uchar *)0x0) goto LAB_081c29f0;
  }
  uVar2 = 0;
LAB_081c2a0e:
