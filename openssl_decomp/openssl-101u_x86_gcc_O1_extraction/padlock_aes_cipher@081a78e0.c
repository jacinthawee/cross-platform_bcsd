...

{
  ...
  if (uVar6 != 0) {
    ...
    if ((uVar8 & 0xf0007) == 3) {
      uVar4 = 0;
      if (0xf < uVar6) goto LAB_081a7990;
      uVar16 = uVar6;
  ...
  uVar4 = 1;
  puVar19 = auStack_5c;
  if (param_4 == (undefined4 *)0x0) goto LAB_081a7990;
  ...
  *(undefined4 *)(puVar20 + -0x14) = 0x81a7a95;
...
LAB_081a7990:
  if (local_20 != *(int *)(in_GS_OFFSET + 0x14)) {
    ...
    *(undefined **)(puVar19 + -4) = &UNK_081a8396;
    __stack_chk_fail();
  }
  return uVar4;
}
