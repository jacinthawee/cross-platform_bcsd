...

{
  ...
  if (0 < iVar6) {
    ...
    if (lVar7 == 0) {
      puVar12 = rstat_tbl_13568;
LAB_08186fa8:
      pcVar11 = *(char **)(puVar12 + 4);
    }
    else {
      if (lVar7 == 1) {
        puVar12 = (undefined1 *)0x8230da8;
        goto LAB_08186fa8;
      }
      if (lVar7 == 2) {
        puVar12 = (undefined1 *)0x8230db0;
        goto LAB_08186fa8;
      }
      if (lVar7 == 3) {
        puVar12 = (undefined1 *)0x8230db8;
        goto LAB_08186fa8;
      }
      if (lVar7 == 5) {
        puVar12 = (undefined1 *)0x8230dc0;
        goto LAB_08186fa8;
      }
      pcVar11 = "(UNKNOWN)";
      if (lVar7 == 6) {
        puVar12 = (undefined1 *)0x8230dc8;
        goto LAB_08186fa8;
      }
    }
              ...
              for (; iVar6 = sk_num((_STACK *)pOVar2->responses), iVar13 < iVar6;
                ...
                if (pvVar9 != (void *)0x0) {
                  ...
                  if (0 < iVar6) {
                    ...
                    iVar6 = *piVar4;
                    if (iVar6 == 0) {
                      puVar12 = cstat_tbl_13572;
LAB_08187014:
                      pcVar11 = *(char **)(puVar12 + 4);
                    }
                    else {
                      if (iVar6 == 1) {
                        puVar12 = (undefined1 *)0x8230d88;
                        goto LAB_08187014;
                      }
                      pcVar11 = "(UNKNOWN)";
                      if (iVar6 == 2) {
                        puVar12 = (undefined1 *)0x8230d90;
                        goto LAB_08187014;
                      }
                    }
                    ...
                    if (0 < iVar6) {
                      if (*piVar4 == 1) {
                        ...
                        goto LAB_08186f8d;
                        a = ppAVar5[1];
                        if (a == (ASN1_ENUMERATED *)0x0) goto LAB_08186d7b;
                        lVar7 = ASN1_ENUMERATED_get(a);
                        if (lVar7 == 0) {
                          puVar12 = reason_tbl_13576;
LAB_081870bd:
                          pcVar11 = *(char **)(puVar12 + 4);
                        }
                        else {
                          if (lVar7 == 1) {
                            puVar12 = (undefined1 *)0x8230d48;
                            goto LAB_081870bd;
                          }
                          if (lVar7 == 2) {
                            puVar12 = (undefined1 *)0x8230d50;
                            goto LAB_081870bd;
                          }
                          if (lVar7 == 3) {
                            puVar12 = (undefined1 *)0x8230d58;
                            goto LAB_081870bd;
                          }
                          if (lVar7 == 4) {
                            puVar12 = (undefined1 *)0x8230d60;
                            goto LAB_081870bd;
                          }
                          if (lVar7 == 5) {
                            puVar12 = (undefined1 *)0x8230d68;
                            goto LAB_081870bd;
                          }
                          if (lVar7 == 6) {
                            puVar12 = (undefined1 *)0x8230d70;
                            goto LAB_081870bd;
                          }
                          pcVar11 = "(UNKNOWN)";
                          if (lVar7 == 8) {
                            puVar12 = (undefined1 *)0x8230d78;
                            goto LAB_081870bd;
                          }
                        }
                        iVar6 = BIO_printf(bp,"\n    Revocation Reason: %s (0x%lx)",pcVar11,lVar7);
                        if (iVar6 < 1) goto LAB_08186f8d;
                      }
LAB_08186d7b:
                      ...
                      if (((((0 < iVar6) &&
                          ...
                          (iVar6 = BIO_write(bp,&DAT_081f15cb,1), 0 < iVar6)) &&
                         ((iVar6 = X509V3_extensions_print
                                             (bp,"Response Single Extensions",
                                              *(stack_st_X509_EXTENSION **)((int)pvVar9 + 0x10),
                                              flags,8), iVar6 != 0 &&
                          (iVar6 = BIO_write(bp,&DAT_081f15cb,1), 0 < iVar6)))) goto LAB_08186e46;
                    }
                  }
LAB_08186f8d:
                  iVar13 = 0;
