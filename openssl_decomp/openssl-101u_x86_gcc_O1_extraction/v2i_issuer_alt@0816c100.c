...
LAB_0816c4c8:
      ...
      if (param_2->flags != 1) {
        if (param_2->issuer_cert == (X509 *)0x0) goto LAB_0816c4c8;
...
LAB_0816c392:
    ...
    __s = *(char **)((int)pvVar2 + 8);
    pcVar5 = *(char **)((int)pvVar2 + 4);
    if (__s == (char *)0x0) goto LAB_0816c290;
LAB_0816c187:
...
LAB_0816c1ba:
        a = GENERAL_NAME_new();
        goto joined_r0x0816c216;
      }
      iVar1 = 2;
      iVar3 = name_cmp(pcVar5,"DNS");
      if (iVar3 == 0) goto LAB_0816c1ba;
...
LAB_0816c590:
      ...
      if (iVar1 == 0) {
        a = GENERAL_NAME_new();
        if (a == (GENERAL_NAME *)0x0) goto LAB_0816c1c5;
        ...
        if (pcVar5 != (char *)0x0) {
          ...
          if (pOVar6 != (OTHERNAME *)0x0) {
            ...
            if (pAVar7 != (ASN1_TYPE *)0x0) {
              ...
              pcVar5 = (char *)CRYPTO_malloc(sVar4 + 1,"v3_alt.c",0x23f);
