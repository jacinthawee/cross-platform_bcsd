...
LAB_08143af0:
    ...
    puVar10 = &DAT_081eca46;
    if (a_01->type == 0x102) {
      lVar4 = -lVar4;
      puVar10 = &DAT_0823b914;
    }
    iVar3 = BIO_printf(bp_00," %s%lu (%s0x%lx)\n",puVar10,lVar4,puVar10,lVar4);
    if (iVar3 < 1) goto LAB_08143af0;
LAB_08143974:
...
LAB_081439d6:
    ...
    if (((iVar3 < 0) || (iVar3 = BIO_write(bp_00,&DAT_081f15cb,1), iVar3 < 1)) ||
       ((iVar3 = BIO_write(bp_00,"        Validity\n",0x11), iVar3 < 1 ||
        (iVar3 = BIO_write(bp_00,"            Not Before: ",0x18), iVar3 < 1)))) goto LAB_08143af0;
...
LAB_08143bad:
      if ((iVar3 != 0) && (iVar3 = BIO_write(bp_00,"\n            Not After : ",0x19), 0 < iVar3)) {
        ...
        if (a_00->type == 0x17) {
          ...
          if (a_00->type != 0x18) goto LAB_08143a7d;
          iVar3 = ASN1_GENERALIZEDTIME_print(bp_00,a_00);
        }
        if (((iVar3 != 0) && (iVar3 = BIO_write(bp_00,&DAT_081f15cb,1), 0 < iVar3)) &&
           (iVar3 = BIO_printf(bp_00,"        Subject:%c",0x20), 0 < iVar3)) {
          pXVar8 = X509_get_subject_name(x);
          iVar3 = X509_NAME_print_ex(bp_00,pXVar8,0x10,0);
          if ((((-1 < iVar3) && (iVar3 = BIO_write(bp_00,&DAT_081f15cb,1), 0 < iVar3)) &&
              ((iVar3 = BIO_write(bp_00,"        Subject Public Key Info:\n",0x21), 0 < iVar3 &&
               ((iVar3 = BIO_printf(bp_00,"%12sPublic Key Algorithm: ",&DAT_081eca46), 0 < iVar3 &&
