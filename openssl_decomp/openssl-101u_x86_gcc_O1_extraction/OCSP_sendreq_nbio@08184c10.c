...
joined_r0x08184c3d:
  ...
  if (uVar13 == 0) {
    ...
    if (iVar8 != iVar1) goto LAB_08184c71;
    uVar9 = *(uint *)rctx;
  }
  if (uVar9 == 4) {
LAB_08184ce2:
...
LAB_08184fc8:
        ...
        if (uVar9 != 0x1006) goto LAB_08184c6f;
        lVar7 = BIO_ctrl(*(BIO **)(rctx + 0x10),3,0,&local_28);
        ...
        if (0 < iVar8) {
          ...
          *(int *)(rctx + 0x14) = iVar1 - iVar8;
          pbVar4 = local_28;
          if (iVar1 - iVar8 != 0) goto LAB_08184cfd;
...
LAB_08184c71:
    ...
    if ((int)uVar9 < 1) goto LAB_08184c6f;
    if ((int)uVar9 < 3) {
LAB_08184d52:
      do {
        ...
        if (iVar8 < 1) {
          ...
          pbVar4 = local_28;
          if (iVar8 == 0) goto LAB_08184f21;
          uVar9 = *(uint *)rctx;
          goto joined_r0x08184c3d;
        }
        pbVar4 = local_28;
        if (iVar8 == *(int *)(rctx + 8)) goto LAB_08184f21;
        if (*(int *)rctx == 1) {
          pbVar15 = *(byte **)(rctx + 4);
          bVar11 = *pbVar15;
          if (bVar11 == 0) {
...
LAB_08185022:
          ...
          *pbVar14 = 0;
          ...
          pbVar4 = local_28;
          if (*local_24 != 0) goto LAB_08184f21;
          bVar11 = pbVar14[1];
          pbVar14 = pbVar14 + 1;
          if (bVar11 != 0) {
            puVar12 = *ppuVar6;
LAB_08184e7a:
            if ((*(byte *)((int)puVar12 + (uint)bVar11 * 2 + 1) & 0x20) != 0) goto LAB_08184e70;
...
LAB_08184df7:
          ...
          if ((bVar11 == 0xd) || (bVar11 == 10)) {
            ...
            do {
              ...
              local_28 = pbVar4;
              while( true ) {
                if (bVar11 == 0) goto LAB_08184df7;
                pbVar4 = local_28 + 1;
                if (bVar11 == 0xd) break;
                if (bVar11 != 10) goto LAB_08184d52;
                bVar11 = *pbVar4;
                local_28 = pbVar4;
              }
            } while( true );
    ...
    if (1 < lVar7) {
      pbVar4 = local_28 + 1;
      if (*local_28 != 0x30) goto LAB_08184f21;
      bVar11 = local_28[1];
      if ((char)bVar11 < '\0') {
        if (lVar7 < 6) goto LAB_08184cfd;
        uVar9 = bVar11 & 0x7f;
        if (3 < (byte)((char)uVar9 - 1U)) goto LAB_08184f21;
        pbVar4 = local_28 + 2;
        uVar13 = 0;
        pbVar15 = pbVar4;
        do {
        ...
        pbVar4 = local_28;
        if (0x19000 < uVar13) goto LAB_08184f21;
...
LAB_08185040:
  pbVar4 = local_28;
  if (*(int *)(rctx + 8) <= (int)sVar2) goto LAB_08184f21;
  uVar9 = *(uint *)rctx;
  goto joined_r0x08184c3d;
LAB_08184e70:
  pbVar14 = pbVar14 + 1;
  bVar11 = *pbVar14;
  if (bVar11 == 0) goto LAB_08184ece;
  goto LAB_08184e7a;
}
