...
void __regparm2 ssleay_rand_add_part_0(void *param_1_00,int param_2,double param_1)
...
LAB_081c7417:
  ...
  if (local_68 == 0) {
    ...
    if (0 < param_2) goto LAB_081c751b;
...
LAB_081c751b:
    ...
    iVar4 = EVP_MD_CTX_cleanup(&local_54);
    if (local_68 != 0) goto LAB_081c7637;
  }
