...
LAB_080b50c2:
  ...
  if ((*(int *)(iVar1 + 0x2c4) < local_18.tv_sec) ||
     ((*(int *)(iVar1 + 0x2c4) == local_18.tv_sec &&
      (*(int *)(iVar1 + 0x2c8) == local_18.tv_usec || *(int *)(iVar1 + 0x2c8) < local_18.tv_usec))))
  {
LAB_080b50b8:
    local_18.tv_usec = 0;
  }
    ...
    if (local_18.tv_sec == 0) {
      if (local_18.tv_usec < 15000) goto LAB_080b50b8;
    }
    else if (0 < local_18.tv_sec) goto LAB_080b50c2;
  }
