...
LAB_081927a2:
            ...
            if (param_3 == 0) {
              local_d0 = (undefined4 *)CRYPTO_malloc(**(int **)(iVar15 + 0xc),"cms_pwri.c",0x195);
              ...
              if (((uVar8 * 2 <= uVar4) && (uVar4 % uVar8 == 0)) &&
                 (pbVar10 = (byte *)CRYPTO_malloc(uVar4,"cms_pwri.c",0xec), pbVar10 != (byte *)0x0))
              {
...
LAB_08192845:
              ...
              if ((uVar8 * 2 <= uVar9) && (uVar4 < 0x100)) {
                local_d0 = (undefined4 *)CRYPTO_malloc(uVar9,"cms_pwri.c",0x18b);
                if (local_d0 == (undefined4 *)0x0) goto LAB_081925b9;
                ...
                if ((uVar8 * 2 <= uVar9) && (uVar4 < 0x100)) {
                  ...
                  *(byte *)((int)local_d0 + 3) = ~pbVar10[2];
                  ...
                  if ((uVar9 < uVar8 || uVar9 - uVar8 == 0) ||
                     (iVar14 = RAND_bytes((byte *)(uVar8 + (int)local_d0),(uVar9 - uVar4) + -4),
                     0 < iVar14)) {
