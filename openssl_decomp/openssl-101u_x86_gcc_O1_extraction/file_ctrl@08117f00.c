...
LAB_08118160:
    ...
    if (param_2 < 4) {
      if (param_2 == 1) goto LAB_081180a0;
      if (param_2 == 2) {
        iVar1 = feof(pFVar2);
        goto LAB_08117f78;
      }
    ...
    if (param_2 < 0x6c) {
      iVar1 = 1;
      if (param_2 == 0xc) goto LAB_08117f78;
      if (param_2 == 0x6a) {
...
LAB_081180a0:
    ...
    if (param_2 == 0x85) goto LAB_08118160;
    if (param_2 != 0x6c) goto LAB_08118138;
...
LAB_0811803e:
      ...
      ERR_add_error_data(5,"fopen(\'",param_4,&DAT_0822372b,local_14,&DAT_082003db);
      line = 400;
      iVar1 = 2;
    }
