...

{
  ...
  if (pOVar1->responses == (stack_st_OCSP_SINGLERESP *)0x0) {
    ...
    if (p_Var7 != (_STACK *)0x0) goto LAB_081863c0;
  }
  else {
LAB_081863c0:
        ...
        if (pOVar4 != (OCSP_CERTID *)0x0) {
          ...
          if (status == 1) {
            ...
            if ((out == (OCSP_REVOKEDINFO *)0x0) ||
               ...
               pAVar3 == (ASN1_GENERALIZEDTIME *)0x0)) goto LAB_0818642f;
            if (reason != -1) {
              a_00 = ASN1_ENUMERATED_new();
              out->revocationReason = a_00;
              if ((a_00 == (ASN1_ENUMERATED *)0x0) ||
                 (iVar6 = ASN1_ENUMERATED_set(a_00,reason), iVar6 == 0)) goto LAB_0818642f;
            }
          }
          else {
            if ((status != 2) && (status != 0)) goto LAB_0818642f;
