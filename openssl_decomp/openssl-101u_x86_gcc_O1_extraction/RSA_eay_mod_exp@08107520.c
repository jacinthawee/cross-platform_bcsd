...
joined_r0x08107975:
    if ((uVar9 & 2) != 0) {
      ...
      if (pBVar6 == (BN_MONT_CTX *)0x0) goto LAB_08107910;
      uVar9 = *(uint *)(param_3 + 0x3c);
    }
    if ((uVar9 & 0x100) == 0) {
    ...
    pBVar6 = BN_MONT_CTX_set_locked((BN_MONT_CTX **)(param_3 + 0x44),9,pBVar7,param_4);
    if ((pBVar6 != (BN_MONT_CTX *)0x0) &&
       (pBVar6 = BN_MONT_CTX_set_locked((BN_MONT_CTX **)(param_3 + 0x48),9,pBVar5,param_4),
       pBVar6 != (BN_MONT_CTX *)0x0)) {
      uVar9 = *(uint *)(param_3 + 0x3c);
      goto joined_r0x08107975;
    }
  }
LAB_08107910:
  bVar10 = false;
