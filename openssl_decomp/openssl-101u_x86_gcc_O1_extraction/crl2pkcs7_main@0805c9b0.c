...
LAB_0805cb36:
    ...
    do {
      ...
      if (bVar14) {
        param_1 = param_1 + -1;
        if (param_1 == 0) goto LAB_0805cc20;
        ppcVar1 = ppcVar10 + 1;
        ppcVar10 = ppcVar10 + 1;
...
LAB_0805cc20:
                ...
                if (param_1 == 0) goto LAB_0805cc20;
                if ((local_2c == (_STACK *)0x0) &&
                   (local_2c = sk_new_null(), local_2c == (_STACK *)0x0)) {
                  return 1;
                }
                ppcVar1 = ppcVar10 + 1;
                ppcVar10 = ppcVar10 + 1;
                iVar9 = sk_push(local_2c,*ppcVar1);
                if (iVar9 == 0) {
                  sk_free(local_2c);
                  return 1;
                }
        ...
        if (param_1 == 1) goto LAB_0805cc20;
    ...
    if ((local_20 != (BIO *)0x0) && (bp != (BIO *)0x0)) {
      ...
      if (local_30 == (char *)0x0) goto LAB_0805d001;
      lVar5 = BIO_ctrl(local_20,0x6c,3,local_30);
      if (0 < lVar5) goto LAB_0805cb01;
      uVar11 = 1;
      a_00 = (X509_CRL *)0x0;
      p7 = (PKCS7 *)0x0;
      perror(local_30);
