...

{
  ...
  iVar3 = UI_add_input_string(ui_method,pcVar2,2,param_1,4,param_2 - 1);
  if ((iVar3 < 0) || (param_3 == 0)) {
    local_24 = (char *)0x0;
    pcVar5 = extraout_EDX;
  }
  else {
    local_24 = (char *)CRYPTO_malloc(param_2,"apps.c",0x249);
    ...
    object_name = param_1;
    iVar3 = UI_add_verify_string(ui_method,pcVar2,2,local_24,4,param_2 - 1,param_1);
  ...
  if (-1 < iVar3) {
    do {
      ...
      if (-1 < iVar3) {
        if (local_24 != (char *)0x0) {
          OPENSSL_cleanse(local_24,param_2);
