  ...
  if (iVar9 != 0) {
    ...
    if (0 < param_1) {
      do {
        ...
        if (bVar20) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_08053388;
          ppbVar17 = param_2 + 2;
...
LAB_08053388:
                                ...
                                if ((iVar9 == 0) || (local_30 < 1)) goto LAB_08053388;
                              }
                            }
                          }
                          else {
                            bVar20 = pbVar3[1] == 0x35;
                            if ((!bVar20) || (bVar20 = pbVar3[2] == 0, !bVar20)) goto LAB_0805335c;
                            local_58 = 5;
                          }
                        }
                      }
...
LAB_0805320e:
    ...
    if (local_58 == 0) {
      if (bVar4) {
        if (local_30 != 0) goto LAB_080530f4;
LAB_08053508:
        pBVar12 = BIO_s_file();
        bp_00 = BIO_new(pBVar12);
        if (bp_00 == (BIO *)0x0) goto LAB_080531b6;
        if (local_68 != (byte *)0x0) {
          lVar13 = BIO_ctrl(bp_00,0x6c,3,local_68);
          if (0 < lVar13) goto LAB_08053548;
          dh = (DH *)0x0;
...
LAB_08053548:
        ...
        if (bVar4) {
          ...
          DSA_free(pDVar11);
          if (dh != (DH *)0x0) goto LAB_08053588;
          dh = (DH *)0x0;
...
LAB_080536c7:
          ...
          if (bVar7) {
            ...
            to = (uchar *)CRYPTO_malloc(iVar9 >> 3,"dhparam.c",0x1c0);
            if (to == (uchar *)0x0) {
              uVar10 = 1;
            ...
            if (0 < iVar9) {
              do {
                if (local_2c.ver == ((int)local_2c.ver / 0xc) * 0xc) {
                  __printf_chk(1,&DAT_081eca43,uVar16);
                }
...
LAB_08053728:
        ...
        if (local_30 == 0) goto LAB_08053508;
        local_58 = 2;
LAB_080530f4:
        local_2c.ver = 2;
...
LAB_08053131:
        ...
        else if (local_4c != (byte *)0x0) goto LAB_08053131;
        if (bVar4) {
          pDVar11 = DSA_new();
          ...
          if (pDVar11 != (DSA *)0x0) {
            ...
            if (iVar9 == 0) {
              ...
              dh = DSA_dup_DH(pDVar11);
              DSA_free(pDVar11);
              if (dh != (DH *)0x0) goto LAB_08053676;
            }
          }
LAB_080531b6:
          ERR_print_errors(bio_err);
        ...
        if ((dh == (DH *)0x0) ||
          ...
          ERR_print_errors(bio_err);
LAB_080535c0:
          if (dh == (DH *)0x0) goto LAB_080531d0;
          uVar10 = 1;
        }
        else {
LAB_08053676:
