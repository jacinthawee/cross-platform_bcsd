...

{
  ...
  if ((piVar3 == (int *)gost_cipher_list) && (iVar5 == 0)) {
  ...
  if (pkey_00 == (EVP_PKEY *)0x0) {
    if (local_10a0[0] == 0) {
      ...
      bVar2 = true;
      if (local_10a0[0] != 0) goto LAB_081d709b;
    }
LAB_081d72e8:
...
LAB_081d7113:
    ...
    if (iVar5 != 0) {
      bVar2 = false;
      if (local_10a0[0] == 0) goto LAB_081d72e8;
LAB_081d709b:
      gost_get0_priv_key(pkey_00);
      make_cp_exchange_key();
      puVar6 = *(undefined4 **)((int)pvVar4 + 8);
      iVar5 = local_10a0[0];
      if (puVar6 != (undefined4 *)0x0) goto LAB_081d70c6;
      if (local_10a0[0] == 0) goto LAB_081d7113;
