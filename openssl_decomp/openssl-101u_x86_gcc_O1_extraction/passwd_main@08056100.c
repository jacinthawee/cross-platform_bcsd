...
/* WARNING: Removing unreachable block (ram,0x08056366) */
/* WARNING: Removing unreachable block (ram,0x08056368) */
/* WARNING: Removing unreachable block (ram,0x0805636a) */
/* WARNING: Removing unreachable block (ram,0x0805636f) */
...
LAB_08056340:
    ...
    if (local_206c == (BIO *)0x0) goto LAB_08056340;
...
LAB_08056276:
          ...
          if (bVar21) {
            ...
            if (bVar21) {
              ...
              pbVar10 = (byte *)0x1;
              if ((iVar1 == 0) || (local_2028 != 0)) goto LAB_08056276;
              iVar18 = iVar8 + 2;
              bVar6 = 1;
              pbVar10 = (byte *)0x0;
              local_2028 = iVar1;
...
LAB_08056760:
                    ...
                    if (bVar21) {
                      ...
                      if (bVar21) {
                        ...
                        if (bVar21) {
                          ...
                          if ((bVar4) || (bVar2 == 0x2d)) goto LAB_08056760;
                          uVar15 = 1;
                          bVar4 = true;
                          pbVar10 = (byte *)0x0;
    ...
    if ((uVar15 + local_2060 + local_205c < 2) && ((char)pbVar10 == '\0')) {
      if ((local_2040 == (void *)0x0) && (bp = (BIO *)0x0, !bVar5)) goto LAB_080562c9;
      pBVar9 = BIO_s_file();
      bp = BIO_new(pBVar9);
      if (bp == (BIO *)0x0) goto LAB_08056348;
      if (local_2040 == (void *)0x0) {
        if (!bVar5) {
                    /* WARNING: Subroutine does not return */
          __assert_fail("in_stdin","passwd.c",0xbf,"passwd_main");
        }
...
LAB_080562c9:
        ...
        if (local_203c == (undefined8 *)0x0) {
          buf = (char *)CRYPTO_malloc(iVar18,"passwd.c",0xd1);
          if (buf != (char *)0x0) {
            if (bp == (BIO *)0x0) {
              iVar8 = EVP_read_pw_string(buf,iVar18,"Password: ",(uint)!(bool)(bVar7 | bVar6));
              if (iVar8 == 0) {
                local_203c = &passwds_static_16039;
                passwds_static_16039._0_4_ = buf;
                goto LAB_08056916;
              }
            }
            else {
...
LAB_080567c8:
          ...
          if (bp != (BIO *)0x0) {
                    /* WARNING: Subroutine does not return */
            __assert_fail("passwd != NULL","passwd.c",0xf4,"passwd_main");
          }
          if (*(int *)local_203c == 0) {
                    /* WARNING: Subroutine does not return */
            __assert_fail("*passwds != NULL","passwd.c",0xe5,"passwd_main");
          }
          buf = (char *)0x0;
LAB_08056916:
          do {
...
LAB_0805637f:
        ...
        if (bp == (BIO *)0x0) goto LAB_0805639b;
      }
      else {
        if (bVar5) {
                    /* WARNING: Subroutine does not return */
          __assert_fail("in_stdin == 0","passwd.c",0xbb,"passwd_main");
        }
        lVar12 = BIO_ctrl(bp,0x6c,3,local_2040);
        if (0 < lVar12) goto LAB_080562c9;
        ERR_print_errors(bio_err);
        uVar20 = 1;
      }
      BIO_free(bp);
