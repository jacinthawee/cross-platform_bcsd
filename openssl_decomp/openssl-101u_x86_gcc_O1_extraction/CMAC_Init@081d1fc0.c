...

{
  ...
  sVar4 = EVP_CIPHER_CTX_block_size((EVP_CIPHER_CTX *)ctx);
  out = ctx + 0xcc;
  iVar2 = EVP_Cipher((EVP_CIPHER_CTX *)ctx,(uchar *)out,zero_iv_8467,sVar4);
  if (iVar2 == 0) {
    return 0;
  }
  pCVar5 = ctx + 0x8c;
  if ((int)sVar4 < 1) {
    if (-1 < (char)ctx[0xcc]) goto LAB_081d2190;
    pCVar8 = pCVar5 + (sVar4 - 1);
    CVar6 = *pCVar8;
LAB_081d2209:
    *pCVar8 = (CMAC_CTX)((byte)CVar6 ^ 0x1b);
    if ((int)sVar4 < 1) goto LAB_081d2190;
  }
  else {
    sVar7 = 0;
    pCVar8 = out;
    ...
    if ((char)ctx[0xcc] < '\0') {
      pCVar8 = pCVar5 + (sVar4 - 1);
      CVar6 = *pCVar8;
      if (sVar4 != 0x10) goto LAB_081d2209;
