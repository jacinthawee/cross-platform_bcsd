...
LAB_0804c8b7:
      while( true ) {
        ...
        if (bVar13) {
          ...
          bVar13 = iVar1 == 0;
          if (!bVar13) goto code_r0x0804c935;
          iVar1 = 0xb;
          pbVar10 = *local_30[0];
          pbVar11 = pbVar10;
...
LAB_0804cea9:
      ...
      if (local_40 == (byte *)0x0) {
        ...
        if (local_4c == (_STACK *)0x0) goto LAB_0804c941;
      }
      if (local_38 == (byte *)0x0) {
        ...
        if (st_00 == (_STACK *)0x0) goto LAB_0804c94a;
      }
      if (local_34 == (byte *)0x0) {
        ...
        if (st == (_STACK *)0x0) goto LAB_0804c94a;
      }
      if (param_1 < 1) {
      ...
      if (local_24 != (X509_VERIFY_PARAM *)0x0) goto LAB_0804ca01;
      goto LAB_0804ca15;
    }
  }
LAB_0804c941:
...
LAB_0804ca01:
    ...
    if (ctx != (X509_STORE *)0x0) goto LAB_0804ca15;
LAB_0804ca24:
    sk_pop_free(local_4c,X509_free);
    sk_pop_free(st_00,X509_free);
    sk_pop_free(st,X509_CRL_free);
    iVar4 = 2;
    if (iVar1 == -1) goto LAB_0804ca5e;
  }
  iVar4 = iVar1;
LAB_0804ca5e:
  ...
  return iVar4;
code_r0x0804c935:
  if (local_28 != 0) goto LAB_0804c941;
  goto LAB_0804c8b7;
}
