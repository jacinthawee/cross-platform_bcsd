...
LAB_080ea9f6:
  ...
  switch(uVar9) {
  default:
    goto switchD_080ea8ff_caseD_7;
  case 0xfffffff9:
    goto LAB_080ea944;
  case 0xfffffffa:
    goto switchD_080ea8ff_caseD_fffffffa;
  case 0xfffffffb:
    puVar11 = local_3c;
    goto LAB_080ea92e;
  case 0xfffffffc:
    goto switchD_080ea8ff_caseD_fffffffc;
  case 0xfffffffd:
    puVar11 = local_3c;
    break;
  case 0xffffffff:
