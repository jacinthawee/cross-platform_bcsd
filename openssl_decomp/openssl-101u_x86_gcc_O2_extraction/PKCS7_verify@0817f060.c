...
LAB_0817f33e:
            ...
            if (iVar1 == 0x401) {
              ...
              bVar7 = indata == bio;
              if (b != (BIO *)0x0) goto LAB_0817f2fd;
              bio = (BIO *)0x0;
LAB_0817f4e0:
              if ((indata == (BIO *)0x0) || (!bVar7)) goto LAB_0817f4fb;
            }
            else {
