...
LAB_081b93c0:
      ...
      if (m_ctx == (BN_MONT_CTX *)0x0) {
        ...
        if (local_14c == (BN_MONT_CTX *)0x0) goto LAB_081b93c0;
        iVar6 = BN_MONT_CTX_set(local_14c,m,ctx);
        if (iVar6 != 0) goto LAB_081b92f8;
        uVar3 = 0;
      }
      else {
LAB_081b92f8:
...
LAB_081b95ba:
        if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_081b93c2;
      }
