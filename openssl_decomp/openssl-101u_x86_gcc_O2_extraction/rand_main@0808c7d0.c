...
LAB_0808c85f:
    do {
      ...
      if (bVar13) {
        ...
        if ((local_1040 != (void *)0x0) || (pvVar2 == (void *)0x0)) goto LAB_0808c8ac;
      ...
      if (bVar13) {
        ...
        if ((iVar5 == 0) || (local_1038 != 0)) goto LAB_0808c8ac;
        local_1044 = local_1044 + 2;
        local_1038 = iVar5;
      }
      else {
        ...
        if (bVar13) {
          iVar5 = *(int *)(param_2 + 4 + iVar7);
          if ((local_1034 != 0) || (iVar5 == 0)) goto LAB_0808c8ac;
          local_1044 = local_1044 + 2;
          local_1034 = iVar5;
        }
        else {
          ...
          local_1044 = iVar5;
          if (bVar13) {
            if (bVar4) goto LAB_0808c8ac;
            bVar4 = true;
          }
          else {
            iVar5 = 5;
            pbVar11 = pbVar1;
            pbVar12 = &DAT_081ec56e;
            do {
              if (iVar5 == 0) break;
              iVar5 = iVar5 + -1;
              bVar13 = *pbVar11 == *pbVar12;
            ...
            if (bVar13) {
              ...
              if (((((*(byte *)((int)*ppuVar8 + (uint)*pbVar1 * 2 + 1) & 8) == 0) ||
                 ...
                 (local_1024 < 0)) goto LAB_0808c8ac;
            }
          }
        }
      }
...
LAB_0808ccf1:
        ...
        if (bVar4) {
          pBVar6 = BIO_f_base64();
          b = BIO_new(pBVar6);
          if (b == (BIO *)0x0) goto LAB_0808ccf1;
          bp = BIO_push(b,bp);
        }
        if (0 < local_1024) {
          do {
            while( true ) {
              ...
              if (local_1024 < 1) goto LAB_0808cba5;
            }
...
LAB_0808cbd1:
        ERR_print_errors(bio_err);
        if (bp == (BIO *)0x0) goto LAB_0808c964;
      }
      BIO_free_all(bp);
      goto LAB_0808c964;
    }
