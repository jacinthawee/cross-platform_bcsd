  ...
  if (*(int *)(*(int *)dst + 0x14) == 0) {
    ...
    if (*(int *)dst == *(int *)src) {
      ...
      for (puVar1 = *(undefined4 **)(src + 0x44); puVar1 != (undefined4 *)0x0;
        ...
        puVar5 = (undefined4 *)CRYPTO_malloc(0x14,"ec_lib.c",0x21e);
      ...
      *(undefined4 *)(dst + 0x38) = *(undefined4 *)(src + 0x38);
      ...
      if (*(int *)(src + 0x3c) == 0) {
        ...
        *(undefined4 *)(dst + 0x40) = 0;
        ...
        pvVar8 = CRYPTO_malloc(*(int *)(src + 0x40),"ec_lib.c",0xdc);
        ...
        *(undefined4 *)(dst + 0x40) = *(undefined4 *)(src + 0x40);
                    ...
                    /* WARNING: Could not recover jumptable at 0x080ff056. Too many branches */
