...
LAB_08067b72:
  ...
  if (local_dc == (OCSP_REQUEST *)0x0) goto LAB_08067b72;
...
LAB_08067b95:
      ...
      if (cid == (OCSP_CERTID *)0x0) goto LAB_08067bd8;
    }
    OCSP_CERTID_free(cid);
LAB_08067bd8:
    if (local_dc != (OCSP_REQUEST *)0x0) goto LAB_08067bdf;
  }
  else {
...
LAB_08067b80:
      ERR_print_errors(bp);
      cid = (OCSP_CERTID *)0x0;
      if (sk != (_STACK *)0x0) goto LAB_08067b95;
      goto LAB_08067bd8;
    }
    uVar6 = 2;
    iVar1 = i2d_OCSP_RESPONSE(a,&local_b8);
    if (iVar1 < 1) goto LAB_08067b80;
