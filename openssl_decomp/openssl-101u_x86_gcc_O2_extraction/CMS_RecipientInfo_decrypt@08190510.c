...

{
  ...
  if (iVar4 != 2) {
    ...
    if (ctx == (EVP_PKEY_CTX *)0x0) goto LAB_08190573;
...
LAB_081908ef:
        ...
        iVar1 = EVP_PKEY_decrypt(ctx,(uchar *)0x0,&local_118,(uchar *)(*(size_t **)(iVar3 + 0xc))[2]
                                 ,**(size_t **)(iVar3 + 0xc));
        if (iVar1 < 1) goto LAB_08190778;
        puVar2 = (uchar *)CRYPTO_malloc(local_118,"cms_env.c",0x17c);
        if (puVar2 == (uchar *)0x0) {
          iVar5 = 0x17f;
          iVar3 = 0x41;
          goto LAB_081908ef;
...
LAB_0819075b:
  ...
  if (iVar1 - 0x314U < 3) {
    ...
    if (*(int *)(iVar4 + 0x14) != iVar5) goto LAB_0819074c;
  }
...
LAB_0819074c:
  ...
  if (**(int **)(iVar4 + 0xc) < 0x10) {
    ...
    if (iVar5 == 0) {
      puVar2 = (uchar *)CRYPTO_malloc(**(int **)(iVar4 + 0xc) + -8,"cms_env.c",0x2ba);
      if (puVar2 != (uchar *)0x0) {
