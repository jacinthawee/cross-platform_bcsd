...

{
  ...
  uVar2 = 2;
  if (local_34 != 6) goto LAB_081bf7eb;
...
LAB_081bfa70:
    ...
    if (a == (RSA_PSS_PARAMS *)0x0) goto LAB_081bfa70;
    if (local_28 == 0x14) {
LAB_081bf8cd:
...
LAB_081bf9ab:
        ...
        if (pAVar4 != (ASN1_STRING *)0x0) {
          ...
          if (pXVar5 != (X509_ALGOR *)0x0) {
            ...
            pAVar4 = ASN1_item_pack(a,(ASN1_ITEM *)RSA_PSS_PARAMS_it,&local_2c);
            if (pAVar4 != (ASN1_STRING *)0x0) goto LAB_081bf9ab;
            goto LAB_081bfa25;
          }
        }
        uVar2 = 0;
