...

{
  ...
  if (param_2 == (uint *)0x0) {
    ptr = (uint *)CRYPTO_malloc(0x28,"ts_verify_ctx.c",0x43);
    if (ptr == (uint *)0x0) {
  ...
  *ptr = 0x6e;
  ...
  if (pAVar1 == (ASN1_OBJECT *)0x0) {
    *ptr = *ptr & 0xfffffffb;
    ...
    ptr[3] = (uint)pAVar1;
    if (pAVar1 == (ASN1_OBJECT *)0x0) goto LAB_08196e18;
  }
  ...
  if (pXVar3 != (X509_ALGOR *)0x0) {
    ...
    ptr[6] = uVar6;
    pvVar5 = CRYPTO_malloc(uVar6,"ts_verify_ctx.c",0x90);
    ptr[5] = (uint)pvVar5;
    if (pvVar5 != (void *)0x0) {
      __n = ptr[6];
      ...
      if (pAVar4 == (ASN1_STRING *)0x0) {
        *ptr = *ptr & 0xffffffdf;
        ...
        ptr[8] = (uint)pAVar4;
        if (pAVar4 == (ASN1_STRING *)0x0) goto LAB_08196e18;
      }
      return ptr;
    }
  }
