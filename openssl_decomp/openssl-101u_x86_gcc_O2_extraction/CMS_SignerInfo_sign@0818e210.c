...

{
  ...
  iVar1 = 0;
  if (type == (EVP_MD *)0x0) goto LAB_0818e3e2;
...
LAB_0818e3a8:
    ...
    if (local_40 != (uchar *)0x0) {
      ...
      if (0 < iVar1) {
        ...
        if (0 < iVar1) {
          CRYPTO_free(local_40);
          local_40 = (uchar *)CRYPTO_malloc(local_3c,"cms_sd.c",0x2a4);
          if (local_40 == (uchar *)0x0) goto LAB_0818e3d4;
