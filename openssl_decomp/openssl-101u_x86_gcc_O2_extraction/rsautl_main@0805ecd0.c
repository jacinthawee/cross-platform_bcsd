...
LAB_0805ef10:
        ...
        if (!bVar15) {
          ...
          if (bVar15) {
            param_1 = param_1 + -1;
            if (param_1 == 0) goto LAB_0805ef10;
            local_48 = ppcVar11[1];
            ppcVar11 = ppcVar11 + 1;
          }
          else {
...
LAB_0805edb5:
        ...
        if (param_1 == 1) goto LAB_0805ef10;
        local_4c = ppcVar11[1];
        param_1 = param_1 + -2;
        ppcVar11 = ppcVar11 + 2;
      } while (0 < param_1);
      if ((!bVar3) || (local_37 == '\x01')) goto LAB_0805f0e8;
...
LAB_0805f321:
    if (pkey == (EVP_PKEY *)0x0) goto LAB_0805f2e6;
    ...
    if (local_50 != (BIO *)0x0) {
      a = BIO_new_file((char *)local_50,"rb");
      if (a != (BIO *)0x0) goto LAB_0805f36a;
...
LAB_0805f740:
    ...
    a = BIO_new_fp(stdin,0);
LAB_0805f36a:
    if (local_4c == (char *)0x0) {
      local_50 = BIO_new_fp(stdout,0);
    }
    else {
      local_50 = BIO_new_file(local_4c,"wb");
      if (local_50 == (BIO *)0x0) {
    ...
    iVar7 = RSA_size(rsa);
    from = (uchar *)CRYPTO_malloc(iVar7 * 2,"rsautl.c",0x10d);
    to = (uchar *)CRYPTO_malloc(iVar7,"rsautl.c",0x10e);
    if ((from == (uchar *)0x0) || (to == (uchar *)0x0)) {
      BIO_printf(bio_err,"Out of memory\n");
      uVar12 = 1;
      ERR_print_errors(bio_err);
      RSA_free(rsa);
      BIO_free(a);
      BIO_free_all(local_50);
      if (from != (uchar *)0x0) goto LAB_0805f4f3;
    }
    else {
      iVar7 = BIO_read(a,from,iVar7 * 2);
      if (iVar7 < 1) {
...
LAB_0805f494:
        if (iVar7 < 1) goto LAB_0805f76b;
        if (bVar5) {
          uVar12 = 0;
          iVar7 = ASN1_parse_dump(local_50,to,iVar7,1,-1);
          if (iVar7 == 0) {
            ERR_print_errors(bio_err);
          }
        }
          ...
          uVar12 = 0;
          BIO_dump(local_50,(char *)to,iVar7);
        }
        else {
          uVar12 = 0;
          BIO_write(local_50,to,iVar7);
        }
      }
      else {
        if (2 < local_35) {
          if (local_35 == 3) {
            ...
            if (local_35 != 4) goto LAB_0805f76b;
