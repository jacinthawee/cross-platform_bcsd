                    ...
                    if (iVar10 != 0) {
                      if (((initialized_engines != (_STACK *)0x0) ||
                         ...
                         && (e_00 = (_STACK *)sk_push(initialized_engines,local_48),
                            e_00 != (_STACK *)0x0)) goto LAB_081c6d90;
                      ENGINE_finish((ENGINE *)e_00);
                    }
                  }
                  else {
                    if (local_24 == 0) goto LAB_081c6d90;
        ...
        if (local_24 == -1) {
          ...
          if (iVar4 != 0) {
            if ((initialized_engines != (_STACK *)0x0) ||
              ...
              if (p_Var6 != (_STACK *)0x0) goto LAB_081c6ed4;
            }
