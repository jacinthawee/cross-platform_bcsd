...

{
  ...
  if (param_5 == (code **)0x0) {
    ...
    pcVar5 = (code *)0x0;
    if (param_4 != (UI_METHOD **)0x0) goto LAB_081a1a8e;
LAB_081a1b96:
    if (HWCRHK_lib_error_code == 0) {
      HWCRHK_lib_error_code = ERR_get_next_error_library();
    }
    ERR_put_error(HWCRHK_lib_error_code,0x66,0x6c,"e_chil.c",0x4b8);
    iVar1 = -1;
  }
  else {
    ...
    if (param_4 == (UI_METHOD **)0x0) {
      ...
      user_data = pUVar4;
LAB_081a1bdb:
      if ((method == (UI_METHOD *)0x0) && (bVar6)) goto LAB_081a1b96;
      if (method != (UI_METHOD *)0x0) goto LAB_081a1aa0;
