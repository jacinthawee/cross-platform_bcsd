...

{
  ...
  if (param_2 < 0x10) {
    ...
    if (param_2 < 10) {
      ...
      uVar2 = 1;
      if (param_2 == 0xb) goto LAB_08118f90;
      if (param_2 == 0xc) {
    ...
    if (param_2 < 0x67) {
      if (param_2 == 100) {
        ...
        if (param_2 != 0x65) goto LAB_08118fd7;
        if (*piVar1 != 6) {
          uVar2 = conn_state();
          goto LAB_08118f90;
        }
...
LAB_081191e8:
      ...
      if (*(int *)(param_1 + 0xc) != 0) {
        ...
        if (param_3 == 1) {
          ...
          uVar2 = 0;
          if (param_3 != 2) goto LAB_081191e8;
          param_4->method = (BIO_METHOD *)(piVar1 + 4);
        }
        goto LAB_08119050;
      }
      param_4->method = (BIO_METHOD *)0x82262ff;
    }
  }
LAB_08118fd7:
  uVar2 = 0;
