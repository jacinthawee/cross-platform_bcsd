...
LAB_080fa334:
    ...
    if (((rnd == (BIGNUM *)0x0) || (pBVar3 = BN_copy(a,pBVar1), pBVar3 == (BIGNUM *)0x0)) ||
       (iVar2 = BN_sub_word(a,1), iVar2 == 0)) goto LAB_080fa3c0;
    iVar2 = 1;
    if (a->top == 0) {
      iVar2 = 0;
      goto LAB_080fa3c5;
      ...
      if (0 < nchecks) {
        ...
        do {
          ...
          if (((iVar5 == 0) || (iVar5 = BN_add_word(rnd,1), iVar5 == 0)) ||
             (iVar5 = witness(r,iVar2,ctx_00,local_2c), iVar5 == -1)) goto LAB_080fa710;
          if (iVar5 != 0) {
            iVar2 = 0;
            goto LAB_080fa6d8;
          }
          if (cb != (BN_GENCB *)0x0) {
            if (cb->ver == 1) {
              ...
              if (cb->ver != 2) {
                iVar2 = -1;
                BN_CTX_end(ctx_00);
                goto joined_r0x080fa678;
              }
              iVar5 = (*(cb->cb).cb_1)(1,iVar4,cb);
              if (iVar5 == 0) goto LAB_080fa710;
            }
          }
          iVar4 = iVar4 + 1;
        } while (iVar4 != nchecks);
...
LAB_080fa6d8:
    BN_CTX_end(ctx_00);
joined_r0x080fa678:
    if (ctx != (BN_CTX *)0x0) goto LAB_080fa3fb;
  }
  else {
