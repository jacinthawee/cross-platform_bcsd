...

{
  ...
  if (param_1 == 5) {
    ...
    if (pIVar9 != (ISSUING_DIST_POINT *)0x0) {
      ...
      if (pIVar9->onlyCA < 1) {
        iVar17 = iVar15;
        if (0 < pIVar9->onlyattr) goto LAB_0813ff91;
      }
      else {
...
LAB_0813ff91:
    ...
    for (iVar17 = 0; iVar15 = sk_num(p_Var5), iVar17 < iVar15; iVar17 = iVar17 + 1) {
      ...
      if (0 < (int)pAVar6) {
        if ((iVar15 != 0x302 && iVar15 != 0x5a) && (iVar15 != 0x8c)) {
    ...
    for (iVar17 = 0; iVar15 = sk_num(p_Var5), iVar17 < iVar15; iVar17 = iVar17 + 1) {
      ...
      if (data_00 != (stack_st_GENERAL_NAME *)0x0) {
        ...
        if (p_Var14 == (_STACK *)0x0) {
          ...
          if (p_Var14 != (_STACK *)0x0) goto LAB_0814014c;
        }
        else {
LAB_0814014c:
          iVar15 = sk_push(p_Var14,data_00);
          psVar18 = data_00;
          if (iVar15 != 0) goto LAB_08140161;
        }
        uVar8 = 0;
        goto LAB_0813feb6;
      }
...
LAB_08140161:
      ...
      if (a == (ASN1_ENUMERATED *)0x0) {
        if (local_24 != -1) goto LAB_081402fc;
        x->reason = -1;
      }
      else {
