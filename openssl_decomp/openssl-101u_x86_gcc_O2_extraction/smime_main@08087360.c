...
LAB_080874c8:
      ppbVar13 = local_34;
      pbVar1 = *local_34;
      if (pbVar1 == (byte *)0x0) goto LAB_080875a6;
      bVar20 = *pbVar1 < 0x2d;
      bVar21 = *pbVar1 == 0x2d;
      if (!bVar21) goto LAB_080875a6;
      iVar4 = 9;
      pbVar17 = pbVar1;
...
joined_r0x08088e24:
                                                  ...
                                                  [1]);
                                                  iVar4 = local_2c;
                                                  if (local_78 != (EVP_MD *)0x0) goto LAB_08087597;
...
LAB_08087f00:
          ...
          local_a4 = (_STACK *)0x0;
          local_a8 = (_STACK *)0x0;
          if (*local_34 != (byte *)0x0) goto LAB_08087d3f;
          BIO_printf(bio_err,"No recipient(s) certificate(s) specified\n");
        }
        else {
          if (local_ac != 0) goto LAB_08087f00;
          local_a4 = (_STACK *)0x0;
        }
LAB_080875fc:
        local_2c = 1;
...
LAB_08087d3f:
      ...
      if ((local_ac & 0x10) == 0) {
        if (((uint)pEVar6 & 0x80) == 0) {
          local_40 = "w";
          if ((local_ac & 0x20) != 0) goto LAB_08088010;
          local_44 = "r";
          goto LAB_08087dd7;
        }
        local_40 = "wb";
...
LAB_08088065:
          ...
          if (bVar20 && local_98 != (BIO *)0x0) {
            ...
            if (local_94 != (X509 *)0x0) goto LAB_08088413;
            pkey_00 = (EVP_PKEY *)0x0;
            pXVar15 = (X509 *)0x0;
            p7 = (PKCS7 *)0x0;
            iVar4 = 2;
...
LAB_080884b9:
            ...
            if (pkey_00 != (EVP_PKEY *)0x0) goto LAB_080880a7;
            local_a0 = (BIO *)0x0;
            local_98 = (BIO *)0x0;
            pXVar15 = (X509 *)0x0;
            local_9c = (X509_STORE *)0x0;
...
LAB_0808803a:
          ...
          if (local_90 != (EVP_CIPHER *)0x0) goto LAB_08088065;
          ERR_print_errors(bio_err);
LAB_08087e71:
          local_98 = (BIO *)0x0;
          local_a0 = (BIO *)0x0;
...
LAB_08087dd7:
        ...
        uVar16 = 0;
        if (local_94 != (X509 *)0x0) goto LAB_0808803a;
        bVar20 = false;
        local_90 = (EVP_CIPHER *)0x0;
        pkey_00 = (EVP_PKEY *)0x0;
        local_94 = (X509 *)0x0;
...
LAB_08088210:
            ...
            local_9c = (X509_STORE *)0x0;
LAB_080885ef:
            if (p7 == (PKCS7 *)0x0) goto LAB_080885f7;
LAB_08088329:
...
LAB_080883a9:
            ...
            local_48 = (EVP_CIPHER *)local_6c;
            if (uVar14 != 0) {
              if (local_ac != 0x53) goto LAB_08088210;
...
LAB_0808862c:
                ...
                if ((pkey == (EVP_PKEY *)0x0) ||
                   ...
                   pPVar8 == (PKCS7_SIGNER_INFO *)0x0)) goto LAB_0808862c;
                X509_free(pXVar15);
                pkey_00 = (EVP_PKEY *)0x0;
                EVP_PKEY_free(pkey);
              }
...
LAB_080885f7:
              ...
              local_6c = (char *)local_48;
              if (local_ac != 0x35) goto LAB_08088329;
              pXVar15 = (X509 *)0x0;
              iVar4 = 0;
          ...
          if (local_98 != (BIO *)0x0) goto LAB_080880cf;
