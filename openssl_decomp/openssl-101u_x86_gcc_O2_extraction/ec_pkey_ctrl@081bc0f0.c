...
undefined4 ec_pkey_ctrl(EVP_PKEY *param_1,int param_2,int param_3,PKCS7_SIGNER_INFO *param_4)

{
  ...
  if (param_2 == 3) {
    ...
    if (param_2 == 5) {
      uVar2 = 1;
      if (param_3 != 0) goto LAB_081bc127;
      CMS_SignerInfo_get0_algs
                ((CMS_SignerInfo *)param_4,(EVP_PKEY **)0x0,(X509 **)0x0,&local_18,&local_14);
    }
    else {
      uVar2 = 0xfffffffe;
      if ((param_2 != 1) || (uVar2 = 1, param_3 != 0)) goto LAB_081bc127;
