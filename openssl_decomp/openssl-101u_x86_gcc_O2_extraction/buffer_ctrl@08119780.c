    ...
    if (param_2 < 0x75) {
      ...
      if (param_2 == 0x75) {
        ...
        if (((int)sVar8 < 0x1001) || (sVar8 == *psVar3)) {
          ...
          if (sVar10 == psVar3[1]) goto LAB_08119a10;
LAB_08119ae1:
          pvVar7 = CRYPTO_malloc(param_3,"bf_buff.c",0x176);
          if (pvVar7 == (void *)0x0) {
...
LAB_08119b20:
          ...
          local_24 = CRYPTO_malloc(param_3,"bf_buff.c",0x171);
          if (local_24 == (void *)0x0) goto LAB_08119b20;
          if ((0x1000 < (int)sVar10) && (sVar10 != psVar3[1])) goto LAB_08119ae1;
        }
        if ((void *)psVar3[2] == local_24) {
          pvVar6 = (void *)psVar3[5];
        }
...
LAB_08119a10:
      ...
      if (param_2 == 0x7a) {
        if ((int)*psVar3 < (int)param_3) {
          pvVar6 = CRYPTO_malloc(param_3,"bf_buff.c",0x153);
          if (pvVar6 == (void *)0x0) goto LAB_08119b20;
