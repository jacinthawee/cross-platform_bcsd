...
LAB_0805fb28:
        ...
        if (!bVar16) {
          ...
          if ((((bVar16) && (bVar16 = pcVar2[1] == 'i', bVar16)) &&
            ...
            param_1 = param_1 + -1;
            if (param_1 == 0) goto LAB_0805fb28;
            local_60 = ppcVar13[1];
            ppcVar13 = ppcVar13 + 1;
          }
          else {
...
LAB_0805f92e:
        ...
        if (param_1 == 1) goto LAB_0805fb28;
    ...
    if (iVar8 != 0) {
      ...
      if ((a == (BIO *)0x0) || (bp == (BIO *)0x0)) {
        ...
        if (bp == (BIO *)0x0) goto LAB_0805fc98;
        key = (dsa_st *)0x0;
        uVar9 = 1;
      }
      else {
...
LAB_0805ffe8:
          ...
          if (key == (dsa_st *)0x0) goto LAB_0805ffe8;
