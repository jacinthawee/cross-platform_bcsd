...
LAB_08091a47:
      ...
      if (bVar27) {
        ...
        if (bVar27) {
          if (local_9c != (BIO *)0x0) goto LAB_08091f0f;
          local_9c = (BIO *)0x1;
        }
        else {
          iVar8 = 6;
...
LAB_08091a3d:
      ...
      ppcVar22 = ppcVar22 + 1;
joined_r0x08091a82:
      if (param_1 < 1) goto LAB_08091a84;
      goto LAB_08091a47;
    }
LAB_08091f0f:
    conf = (CONF *)0x0;
...
LAB_08091f16:
  ...
  if (bio_err == (BIO *)0x0) goto LAB_080918e9;
...
LAB_08091e86:
    ...
    else if (local_84 != (char *)0x0) goto LAB_08091e86;
  }
    ...
    if (local_9c != (BIO *)0x1) {
      ...
      if (local_9c != (BIO *)0x2) {
        ...
        if ((((((local_7c == (char *)0x0) || (bVar27)) &&
           ...
           (local_74 == (char *)0x0)) goto LAB_08091f0f;
...
LAB_0809235e:
          ...
          if (bVar6) {
            ...
            local_a0 = (BIO *)0x0;
            if (local_9c == (BIO *)0x0) goto LAB_08092485;
          }
          else {
            local_a0 = (BIO *)d2i_TS_RESP_bio(pBVar9,0);
            if (local_a0 == (BIO *)0x0) goto LAB_08092485;
            local_9c = (BIO *)0x0;
          }
...
LAB_08091c4b:
          if (local_60 != (char *)0x0) {
            ...
            pXVar14 = X509_STORE_add_lookup(ctx,pXVar13);
            if (pXVar14 == (X509_LOOKUP *)0x0) goto LAB_08092b94;
          ...
          puVar11[1] = (uint)ctx;
          if (ctx == (X509_STORE *)0x0) goto LAB_0809232e;
          if (local_44 != (char *)0x0) {
            uVar12 = TS_CONF_load_certs(local_44);
            puVar11[2] = uVar12;
            if (uVar12 == 0) goto LAB_0809232e;
          }
          BIO_free_all(pBVar10);
          TS_REQ_free(iVar8);
          if (bVar6) {
...
LAB_080921e6:
              ...
              if (((ppAVar17 == (ASN1_INTEGER **)0x0) ||
                 ...
                 (iVar15 = TS_RESP_set_status_info(iVar8,ppAVar17), iVar15 == 0)) goto LAB_080921e6;
...
LAB_0809221a:
    ...
    if (local_94 != (X509_ALGOR *)0x0) {
      conf = (CONF *)0x0;
      bVar27 = true;
      if (local_90 != (char *)0x0) goto LAB_08091f16;
    }
    conf = (CONF *)load_config_file();
    if (local_74 == (char *)0x0) {
      local_9c = (BIO *)0x0;
      if (local_90 == (char *)0x0) {
        ...
        if (local_9c == (BIO *)0x0) goto LAB_080926bb;
      }
      local_38 = (void *)0x0;
      if (((local_70 == (EVP_MD *)0x0) &&
...
LAB_08092dae:
        ...
        if (pAVar24 == (ASN1_OBJECT *)0x0) goto LAB_08092dae;
        pAVar20 = ASN1_TYPE_new();
        local_94->parameter = pAVar20;
        if (pAVar20 == (ASN1_TYPE *)0x0) goto LAB_08092dae;
        pAVar20->type = 5;
        pAVar24 = (ASN1_OBJECT *)0x0;
        pAVar23 = (ASN1_INTEGER *)0x0;
        iVar8 = TS_MSG_IMPRINT_set_algo(local_98,local_94);
        if (((iVar8 == 0) || (iVar8 = create_digest(&local_38), iVar8 == 0)) ||
           (iVar8 = TS_MSG_IMPRINT_set_msg(local_98,local_38,iVar8), iVar8 == 0)) goto LAB_08092519;
        iVar8 = TS_REQ_set_msg_imprint(local_a0,local_98);
        if (iVar8 == 0) goto LAB_08092dae;
...
LAB_08092dea:
            ...
            a = ASN1_INTEGER_new();
            if (a == (ASN1_INTEGER *)0x0) goto LAB_08092dea;
            CRYPTO_free(a->data);
            a->length = 8 - iVar8;
            puVar21 = (uchar *)CRYPTO_malloc(9 - iVar8,"ts.c",0x279);
            a->data = puVar21;
            if (puVar21 != (uchar *)0x0) {
              memcpy(puVar21,local_34 + iVar8,a->length);
              iVar8 = TS_REQ_set_nonce(local_a0,a);
              pAVar23 = a;
              if (iVar8 == 0) goto LAB_08092519;
              goto LAB_08092834;
            }
          }
