...
LAB_0807fee0:
      ...
      cVar1 = pcVar8[1];
      if (cVar1 == 'v') {
        if (pcVar8[2] != '\0') goto LAB_0807fee0;
        bVar10 = true;
      }
      else if (cVar1 == 'b') {
        if (pcVar8[2] != '\0') goto LAB_0807fee0;
...
LAB_0807ff9f:
        ...
        if (cVar1 != 'd') {
          if ((cVar1 != 'a') || (pcVar8[2] != '\0')) goto LAB_0807fee0;
          bVar6 = true;
          bVar3 = true;
          bVar2 = true;
          bVar4 = true;
  ...
  if (uVar9 == 0x1000115f) {
    ...
    pcVar8 = SSLeay_version(0);
    __printf_chk(1,"%s (Library: %s)\n","OpenSSL 1.0.1u  22 Sep 2016",pcVar8);
  }
LAB_0807ff2b:
  if (bVar2) {
  ...
  if (bVar4) {
    ...
    pcVar8 = BN_options();
    __printf_chk(1,&DAT_081f6c21,pcVar8);
    pcVar8 = RC4_options();
    __printf_chk(1,&DAT_081f6c21,pcVar8);
    pcVar8 = DES_options();
    __printf_chk(1,&DAT_081f6c21,pcVar8);
