...
LAB_081c4894:
    ...
    local_50 = (BIGNUM *)0x0;
    sig = pEVar4;
    if (ctx != (BN_CTX *)0x0) goto LAB_081c48c6;
  }
  else {
    r_00 = BN_new();
...
LAB_081c4b55:
        ...
        if (((iVar1 >> 3) * 8 <= (int)uVar2) ||
           (iVar1 = BN_rshift(local_50,local_50,8 - (uVar2 & 7)), iVar1 != 0)) goto LAB_081c498f;
        iVar1 = 0x108;
      }
LAB_081c4870:
...
LAB_081c4953:
      ...
      if (pBVar3 == (BIGNUM *)0x0) goto LAB_081c4b55;
LAB_081c498f:
...
LAB_081c4c43:
        ...
        do {
          iVar1 = ECDSA_sign_setup(param_5,ctx,&local_24,&sig->r);
          pBVar3 = local_24;
          if (iVar1 == 0) goto LAB_081c4b35;
          iVar1 = BN_mod_mul(r_00,a,sig->r,order,ctx);
          if (iVar1 == 0) goto LAB_081c4c21;
          iVar1 = BN_mod_add_quick(r,r_00,local_50,order);
          if (iVar1 == 0) goto LAB_081c4c32;
          iVar1 = BN_mod_mul(r,r,pBVar3,order,ctx);
          if (iVar1 == 0) goto LAB_081c4c43;
        } while (r->top == 0);
      }
      else {
        if (param_4 != (BIGNUM *)0x0 && param_3 != (BIGNUM *)0x0) {
...
LAB_081c4a48:
        ...
        do {
          pBVar3 = BN_copy(sig->r,param_4);
          if (pBVar3 == (BIGNUM *)0x0) goto LAB_081c4a48;
          iVar1 = BN_mod_mul(r_00,a,sig->r,order,ctx);
          if (iVar1 == 0) goto LAB_081c4c21;
          iVar1 = BN_mod_add_quick(r,r_00,local_50,order);
          if (iVar1 == 0) goto LAB_081c4c32;
