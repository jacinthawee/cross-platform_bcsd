...
joined_r0x0815da21:
        if (pAVar2 != (ASN1_INTEGER *)0x0) goto LAB_0815d798;
      }
      else {
        if ((uVar6 & 0x40) == 0) {
          pAVar2 = pXVar4->base_crl_number;
          goto joined_r0x0815da21;
        }
        if ((pXVar4->idp_reasons & ~local_54) == 0) goto LAB_0815d798;
      }
      ...
      if (iVar3 == 0) {
        ...
        local_60 = 0;
        if ((*(byte *)&pXVar4->idp_flags & 0x20) == 0) goto LAB_0815d798;
        local_60 = 0x100;
        uVar6 = 0;
      }
      ...
      if (iVar3 < 0) {
        ...
        if (pXVar12->nextUpdate != (ASN1_TIME *)0x0) {
          ...
          if (iVar3 == 0) goto LAB_0815d6cc;
          if (iVar3 < 0) {
            if ((*(byte *)(param_1_00 + 0x74) & 2) == 0) goto LAB_0815d6cc;
            pXVar12 = pXVar4->crl;
          }
          else {
            pXVar12 = pXVar4->crl;
...
LAB_0815d6cc:
      ...
      if ((iVar3 == 0) && ((local_60 & 0x20) != 0)) {
        ...
        do {
          ...
          if (iVar3 <= iVar15) {
            iVar3 = 0;
            if ((*(byte *)(*(int *)(param_1_00 + 0x14) + 0xd) & 0x10) != 0) goto LAB_0815d803;
            goto LAB_0815d780;
          }
          pXVar8 = (X509 *)sk_value(*(_STACK **)(param_1_00 + 0x54),iVar15);
...
LAB_0815dc4b:
              if ((local_38 & ~local_54) == 0) goto LAB_0815d78b;
...
LAB_0815d798:
  ...
  if (local_4c != (X509_CRL *)0x0) {
    ...
    *param_2 = local_58;
    *param_3 = local_44;
    CRYPTO_add_lock(&local_4c->references,1,6,"x509_vfy.c",0x3de);
...
LAB_0815dbc8:
          CRYPTO_add_lock(&pXVar4->references,1,6,"x509_vfy.c",0x442);
          *param_3_00 = pXVar4;
          goto LAB_0815dbeb;
        }
      }
...
LAB_0815d803:
  ...
  if (iVar15 <= iVar3) goto LAB_0815d780;
