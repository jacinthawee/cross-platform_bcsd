...

{
  ...
  if (indent < 0) {
    ...
    if (!bVar11) goto LAB_0813bedc;
LAB_0813c1ed:
    local_c0 = 3;
    local_b0 = 2;
    local_c4 = &DAT_08226f24;
    local_b8 = ", ";
    local_ac = 0;
  }
  else {
    if ((indent != 0) && (out != (BIO *)0x0)) {
      iVar9 = 0;
      do {
        iVar1 = BIO_write(out,&DAT_081f8b67,1);
        if (iVar1 != 1) goto LAB_0813bea0;
        iVar9 = iVar9 + 1;
      } while (indent != iVar9);
    }
    bVar11 = (flags & 0xf0000) == 0x20000;
    if (bVar11) goto LAB_0813c1ed;
LAB_0813bedc:
    uVar2 = flags & 0xf0000;
...
LAB_0813bea0:
      ...
      if (uVar2 != 0x40000) goto LAB_0813bea0;
      local_c0 = 3;
      local_b0 = 1;
      local_c4 = &DAT_08226f24;
      local_b8 = "\n";
      ...
      if (local_88 != -1) {
        if (iVar1 == local_88) {
          if (out != (BIO *)0x0) {
            ...
            if (local_c0 != iVar1) goto LAB_0813bea0;
            iVar1 = ne->set;
          }
          ...
          if (out != (BIO *)0x0) {
            ...
            if (local_b0 != iVar1) goto LAB_0813bea0;
            if (local_ac != 0) {
              iVar1 = 0;
              do {
                iVar3 = BIO_write(out,&DAT_081f8b67,1);
                if (iVar3 != 1) goto LAB_0813bea0;
                iVar1 = iVar1 + 1;
...
LAB_0813c333:
          if (out == (BIO *)0x0) {
            if (((int)local_8c < iVar3) && ((flags & 0x2000000) != 0)) goto LAB_0813c377;
          }
          else {
            sVar6 = BIO_write(out,puVar8,local_8c);
            if (local_8c != sVar6) goto LAB_0813bea0;
...
LAB_0813c377:
              ...
              if ((0 < iVar3) && (out != (BIO *)0x0)) {
                iVar1 = 0;
                do {
                  iVar7 = BIO_write(out,&DAT_081f8b67,1);
                  if (iVar7 != 1) goto LAB_0813bea0;
                  iVar1 = iVar1 + 1;
                } while (iVar3 != iVar1);
              }
              indent = indent + iVar3;
              if (out == (BIO *)0x0) goto LAB_0813c15c;
            }
LAB_0813c139:
            iVar1 = BIO_write(out,data,iVar9);
            if (iVar9 != iVar1) goto LAB_0813bea0;
          }
        }
        else {
          if (uVar2 == 0) {
          ...
          if (out != (BIO *)0x0) {
            local_8c = BIO_write(out,&DAT_081eca46,0);
            if (local_8c == 0) goto LAB_0813c139;
            goto LAB_0813bea0;
          }
          local_8c = 0;
        }
