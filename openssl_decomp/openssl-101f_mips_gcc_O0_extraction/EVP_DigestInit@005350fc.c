...

{
  ...
  if (ctx->engine == (ENGINE *)0x0) {
    if (type != (EVP_MD *)0x0) goto LAB_0053518c;
    pEVar2 = ctx->digest;
    if (pEVar2 == (EVP_MD *)0x0) goto LAB_00535324;
LAB_005351d4:
...
LAB_0053518c:
      ...
      pEVar2 = ctx->digest;
      if (pEVar2 != type) {
        if (pEVar2 != (EVP_MD *)0x0) goto LAB_005351d4;
        goto LAB_005351e0;
      }
    }
    else if ((type != (EVP_MD *)0x0) && (type->type != ctx->digest->type)) goto LAB_00535178;
LAB_00535234:
    ctx_00 = ctx->pctx;
    if (ctx_00 != (EVP_PKEY_CTX *)0x0) goto LAB_00535244;
  }
  if ((ctx->flags & 0x100) != 0) {
    return 1;
  }
...
LAB_00535294:
                    /* WARNING: Could not recover jumptable at 0x005352a8. Too many branches */
