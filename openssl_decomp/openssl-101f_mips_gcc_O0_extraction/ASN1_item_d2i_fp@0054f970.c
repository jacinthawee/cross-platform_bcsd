...

{
  ...
  if (iVar5 == 0) {
    ...
    iStack_9c = 0;
    (*(code *)PTR_BIO_ctrl_006a7f18)(iVar5,0x6a,0,in);
    in_00 = &local_24;
    local_24 = (uchar *)0x0;
  ...
  pAStack_58 = it;
  uVar4 = (*(code *)PTR_BIO_s_file_006a7fa0)();
  puVar8 = (undefined *)(*(code *)PTR_BIO_new_006a7fa4)(uVar4);
  if (puVar8 == (undefined *)0x0) {
    ...
    unaff_s6 = "r";
    x = (void *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar6,"a_i2d_fp.c",0x5b);
    if (x == (void *)0x0) {
      iVar5 = 0x41;
      ...
      while( true ) {
        ...
        iVar5 = iVar6;
        iVar9 = (*(code *)PTR_BIO_write_006a7f14)(puVar8,pcStack_e4,iVar6);
      ...
      pvStack_b0 = (void *)0x1;
LAB_0054fbe4:
      (*(code *)PTR_CRYPTO_free_006a7f88)(x);
    }
  ...
  pAStack_b4 = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  puStack_a8 = puStack_124;
  pvStack_a4 = x;
  pcStack_98 = unaff_s6;
  pAStack_f0 = (ASN1_VALUE *)(*pcStack_ec)(iVar5,0);
  puVar8 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(pAStack_f0,"a_i2d_fp.c",0x5b);
  if (puVar8 == (undefined *)0x0) {
    ...
    while( true ) {
      ...
      pAVar16 = pAStack_f0;
      pAVar10 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(pcStack_e4,puVar14);
...
LAB_0054fd84:
  ...
  if (puVar8 == (undefined *)0x0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar8,0x6a,0,puVar14);
    ...
    if (puStack_f8 == (uchar *)0x0) {
      ...
      while( true ) {
        ...
        pAVar16 = pAVar10;
        pAVar11 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(puVar8);
...
LAB_0054fef0:
      (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_f8);
    }
    (*(code *)PTR_BIO_free_006a7f70)(puVar8);
    puStack_124 = puVar8;
  }
  ...
  if (puStack_138 == (uchar *)0x0) {
    ...
    while( true ) {
      ...
      iVar6 = (*(code *)PTR_BIO_write_006a7f14)(puStack_164,puVar15,iVar5);
...
LAB_00550050:
  ...
  if (*piVar12 < 5) {
    ...
    puVar14 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(5,"a_enum.c",0x51);
