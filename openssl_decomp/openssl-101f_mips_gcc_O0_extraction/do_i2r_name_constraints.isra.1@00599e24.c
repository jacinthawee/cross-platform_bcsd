...

{
  ...
  do {
    ...
    (*(code *)PTR_BIO_printf_006a7f38)(param_2,&DAT_0066df84,param_3 + 2,"");
    gen = *ppGVar4;
    if (gen->type == 7) {
      psVar6 = ((gen->d).directoryName)->entries;
      pBVar5 = ((gen->d).directoryName)->bytes;
      (*(code *)PTR_BIO_puts_006a8058)(param_2,&DAT_0066f580);
      if (psVar6 == (stack_st_X509_NAME_ENTRY *)0x8) {
        ...
        while( true ) {
          while( true ) {
            ...
            (*(code *)PTR_BIO_printf_006a7f38)(param_2,&DAT_0066ecb4,*(undefined2 *)psVar1);
            if (iVar3 != 7) break;
            iVar3 = 8;
            iVar7 = iVar7 + 1;
