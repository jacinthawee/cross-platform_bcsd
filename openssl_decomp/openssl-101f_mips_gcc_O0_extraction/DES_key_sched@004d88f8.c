...
LAB_004d8928:
  ...
  if (iVar1 != 0) {
    iVar1 = (*(code *)PTR_memcmp_006aabd8)(0x65b898,key,8);
    if (iVar1 != 0) {
      iVar1 = (*(code *)PTR_memcmp_006aabd8)(0x65b8a0,key,8);
      if (iVar1 != 0) {
        iVar1 = (*(code *)PTR_memcmp_006aabd8)(0x65b8a8,key,8);
        if (iVar1 != 0) {
          iVar1 = (*(code *)PTR_memcmp_006aabd8)(0x65b8b0,key,8);
          if (iVar1 != 0) {
                        ...
                        if (iVar1 != 0) {
                          ...
                          if (iVar1 != 0) {
                            ...
                            if (iVar1 != 0) {
                              ...
                              if ((iVar1 != 0) &&
                                 (iVar1 = (*(code *)PTR_memcmp_006aabd8)(0x65b908,key,8), iVar1 != 0
                                 )) goto LAB_004d8928;
                            }
                          }
                        }
