...

{
  ...
  local_74 = schedule;
  local_58 = (int *)PTR___stack_chk_guard_006aabf0;
  local_54 = (uchar *)ivec;
  local_80 = (code **)&_gp;
    ...
    if (enc == 0) {
      ...
      if (unaff_s5 <= (uint)length) {
        ...
        do {
          ...
          local_44 = ppppuVar26;
          local_40 = ppppuVar25;
          (*local_80[-0x1a3e])(ppppuVar21,local_74);
          if (unaff_s8 != 0) {
          ...
          if (local_64 != (undefined4 ****)&DAT_00000020) {
            if (local_64 == (undefined4 ****)&DAT_00000040) {
              ...
              if (local_6c == (undefined4 ****)0x0) {
                ...
                local_68 = ppppuVar27;
                (*local_80[-0x14b9])(unaff_s7,(int)unaff_s7 + unaff_s4);
      ...
      unaff_s7 = &switchD_005e64e8::switchdataD_00675570 + (int)unaff_s5;
      unaff_s6 = (code **)(&PTR_LAB_006755dc + (int)unaff_s5);
      ...
      while (ppppuVar27 = ppppuVar26, ppppuVar25 = ppppuVar21, unaff_s0 = in, unaff_s1 = (uint *)out
        ...
        local_44 = ppppuVar25;
        local_40 = ppppuVar27;
        (*local_80[-0x1a3e])(ppppuStack_dc,local_74);
        ppppuVar13 = local_64;
        ppppuVar19 = local_68;
...
LAB_005e6964:
        ...
        if ((local_64 != (undefined4 ****)&DAT_00000020) &&
          ...
          if (local_68 == (undefined4 ****)0x0) {
            ...
            (*local_80[-0x14b9])(&local_3c,(int)&local_3c + unaff_s4);
  ...
  if (ppcVar12 != (code **)0x0) {
    ...
    do {
      if (uStack_120 == 0) {
        ...
        (**(code **)(pbVar28 + -0x5764))(unaff_s1,ppppuStack_dc,ppcStack_118,uStack_7c);
        uVar22 = uStack_cc >> 8;
  ...
  if (iStack_bc != iVar6) {
    ...
    if (ppcVar12 != (code **)0x0) {
      ...
      do {
        if (uVar5 == 0) {
          (*(code *)PTR_DES_encrypt1_006a95e8)(&uStack_134,uVar15,1);
          iVar6 = iVar6 + 1;
    ...
    *puStack_e4 = uVar5;
    ...
    do {
      ...
      uVar5 = *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 >> 0x1a) + 0x1c0) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar17 & 0xfc) + 0x100) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar5;
      ...
      uVar15 = (uVar15 << 0x10 ^ uVar17) >> 4;
      uVar17 = uVar15 + uVar17 * 0x10000000;
      uVar18 = uVar16 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 >> 0x1a) + 0x1c0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar17 & 0xfc) + 0x100) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 * 0x100 >> 0x1a) + 0x140) * 4);
      ...
      uVar17 = uVar5 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar17 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar16 >> 0x1a) + 0x1c0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar16 & 0xfc) + 0x100) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 * 0x100 >> 0x1a) + 0x140) * 4);
      ...
      uVar16 = uVar18 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar16 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 >> 0x1a) + 0x1c0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar15 & 0xfc) + 0x100) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar5 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar5 * 0x100 >> 0x1a) + 0x140) * 4);
      ...
      uVar5 = (uVar5 << 0x10 ^ uVar15) >> 4;
      uVar15 = uVar5 + uVar15 * 0x10000000;
      uVar15 = uVar17 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar17 = uVar16 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar17 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar16 = uVar15 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar16 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar5 = (uVar5 << 0x10 ^ uVar15) >> 4;
      uVar15 = uVar5 + uVar15 * 0x10000000;
      uVar17 = uVar17 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar5 = (uVar5 << 0x10 ^ uVar15) >> 4;
      uVar15 = uVar5 + uVar15 * 0x10000000;
      uVar16 = uVar16 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar20 >> 0x1a) + 0x180) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar20 & 0xfc)) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar18 << 0x10) >> 0x1a) + 0x80) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 8) >> 0x1a) + 0x100) * 4) ^
               *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar15 >> 0x1a) + 0x1c0) * 4) ^
      ...
      uVar5 = uVar17 ^ *(uint *)(PTR_DES_SPtrans_006aa780 + ((uVar22 >> 0x1a) + 0x180) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + (uVar22 & 0xfc)) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar20 << 0x10) >> 0x1a) + 0x80) * 4) ^
              *(uint *)(PTR_DES_SPtrans_006aa780 + (((uVar22 << 8) >> 0x1a) + 0x100) * 4) ^
