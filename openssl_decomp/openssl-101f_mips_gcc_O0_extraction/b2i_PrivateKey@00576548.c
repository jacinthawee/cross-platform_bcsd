...
LAB_0057659c:
    ...
    uVar19 = 0x84;
    local_28 = 0xff;
    (**(code **)(local_20 + -0x6eb0))(9,0x84,0x7a,FUN_0066ce4c);
    pEVar4 = (EVP_PKEY *)0x0;
  }
  else {
    if (*puVar3 == '\x06') {
...
LAB_005766bc:
      local_18 = puVar3;
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x86,uVar20,FUN_0066ce4c);
      goto LAB_0057659c;
    }
...
LAB_0057680c:
    unaff_s1 = (RSA_METHOD *)0x670000;
    (*(code *)PTR_ERR_put_error_006a9030)(9,0x84,0x7a,FUN_0066ce4c);
    pEVar4 = (EVP_PKEY *)0x0;
  }
  else {
...
LAB_00576c0c:
      (*pcVar32)(9,0x86,uVar20,FUN_0066ce4c);
    }
    else if (cStack_a4 == '\a') {
      if (cStack_a3 == '\x02') {
          ...
          if (0x31535344 < uVar9) {
            ...
            unaff_s4 = (rsa_st *)
                       (**(code **)(auStack_ec._60_4_ + -0x7dd8))
                                 (auStack_ec._4_4_,FUN_0066ce4c,0x11f);
            if (unaff_s4 == (rsa_st *)0x0) {
              auStack_ec._52_4_ = (BN_MONT_CTX *)0x122;
              (**(code **)(auStack_ec._60_4_ + -0x6eb0))(9,0x85,0x41,FUN_0066ce4c);
              prVar7 = (rsa_st *)0x0;
            }
            else {
              prStack_a8 = unaff_s4;
              ...
              if (auStack_ec._4_4_ == prVar7) {
                ...
                prVar7 = (rsa_st *)0x0;
                (**(code **)(auStack_ec._60_4_ + -0x6eb0))(9,0x85,0x7b,FUN_0066ce4c);
              }
...
LAB_00576e9c:
          ...
          unaff_s6 = (rsa_st *)0x670000;
          prVar28 = (rsa_st *)(*(code *)PTR_CRYPTO_malloc_006a8108)(prVar11,FUN_0066ce4c,0x11f);
...
LAB_00576e34:
      prVar7 = (rsa_st *)0x86;
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x86,prVar21,FUN_0066ce4c);
    }
    else if (cStack_fc == '\a') {
      prVar21 = (rsa_st *)&DAT_00000078;
      goto LAB_00576e34;
...
LAB_00576d94:
  ...
  prVar11 = (rsa_st *)(*(code *)PTR_CRYPTO_malloc_006a8108)(prVar8,FUN_0066ce4c);
  prVar28 = prVar8;
