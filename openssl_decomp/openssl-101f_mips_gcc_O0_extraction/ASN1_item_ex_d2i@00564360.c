...

{
  ...
  if (pval != (ASN1_VALUE **)0x0) {
    ...
    if (bVar1 < 7) {
      ...
      iVar6 = (*(code *)(&PTR_LAB_0066ab68)[bVar1])();
      return iVar6;
    }
  }
...
LAB_005657fc:
              ...
              (*(code *)PTR_ERR_add_error_data_006a9264)
                        (4,&DAT_0066ab20,tt->field_name,", Type=",*(char **)((int)it_00 + 0x18));
              goto switchD_00565630_caseD_7;
            }
            goto LAB_0056529c;
          }
...
LAB_005652b4:
  ...
  (*(code *)PTR_ERR_add_error_data_006a9264)(2,s_Type__0066ab28,*(char **)((int)it_00 + 0x18));
