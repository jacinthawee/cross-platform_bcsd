...

{
  ...
  for (iVar7 = 0; iVar2 = (*(code *)PTR_sk_num_006a7f2c)(param_3), pSVar3 = local_20, iVar7 < iVar2;
      iVar7 = iVar7 + 1) {
    iVar2 = (*(code *)PTR_sk_value_006a7f24)(param_3,iVar7);
    user = *(char **)(iVar2 + 8);
  ...
  if (pAVar4 == (ASN1_INTEGER *)0x0) {
    ...
    iVar2 = 0;
    do {
      iVar6 = (*(code *)PTR_sk_num_006a7f2c)(*(undefined4 *)(iVar7 + 4));
      if (iVar6 <= iVar2) {
        uVar8 = 0;
        goto LAB_00593abc;
      }
      puVar5 = (undefined4 *)(*(code *)PTR_sk_value_006a7f24)(*(undefined4 *)(iVar7 + 4),iVar2);
      iVar6 = (*(code *)PTR_ASN1_STRING_cmp_006a8248)(*puVar5,pAVar4);
      iVar2 = iVar2 + 1;
    } while (iVar6 != 0);
    uVar8 = puVar5[1];
LAB_00593abc:
