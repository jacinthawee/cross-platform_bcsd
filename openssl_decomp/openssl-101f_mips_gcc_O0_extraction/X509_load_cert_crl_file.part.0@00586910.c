...

{
  ...
  bp = (BIO *)(*(code *)PTR_BIO_new_file_006a7fac)(param_2,"r");
  if (bp == (BIO *)0x0) {
    uVar5 = 2;
    uVar4 = 0x112;
  }
    ...
    if (psVar1 != (stack_st_X509_INFO *)0x0) {
      ...
      while( true ) {
        ...
        ppXVar3 = (X509 **)(*(code *)PTR_sk_value_006a7f24)(psVar1,iVar6);
        if (*ppXVar3 != (X509 *)0x0) {
          iVar8 = iVar8 + 1;
      ...
      (*(code *)PTR_sk_pop_free_006a8158)(psVar1,PTR_X509_INFO_free_006a86b8);
      return iVar8;
    }
    uVar5 = 9;
    uVar4 = 0x118;
  }
  (*(code *)PTR_ERR_put_error_006a9030)(0xb,0x84,uVar5,"by_file.c",uVar4);
  return 0;
}
