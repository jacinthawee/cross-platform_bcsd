...

{
  ...
  do {
    ...
    iVar8 = iVar1 - iVar2;
    if (param_3 <= iVar8) {
      (*(code *)PTR_memcpy_006aabf4)(*(int *)((int)pvVar5 + 0x14) + iVar2,param_2,param_3);
    ...
    if (iVar4 != 0) {
      ...
      if (0 < iVar8) {
        ...
        (*(code *)PTR_memcpy_006aabf4)(*(int *)((int)pvVar5 + 0x14) + iVar2,param_2,iVar8);
        iVar7 = iVar7 + iVar8;
        iVar3 = *(int *)((int)pvVar5 + 0x1c);
