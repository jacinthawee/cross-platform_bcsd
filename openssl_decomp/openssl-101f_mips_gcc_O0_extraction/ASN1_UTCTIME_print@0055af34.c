...

{
  ...
  if (iVar5 < 10) {
LAB_0055b194:
    (*(code *)PTR_BIO_write_006a7f14)(fp,"Bad time value",0xe);
    return 0;
  }
  puVar1 = a->data;
  if ((((((9 < ((int)(char)*puVar1 - 0x30U & 0xff)) || (9 < (byte)(puVar1[1] - 0x30))) ||
     ...
     ((9 < (byte)(puVar1[8] - 0x30) || (9 < (byte)(puVar1[9] - 0x30))))) goto LAB_0055b194;
  iVar3 = ((int)(char)*puVar1 - 0x30U) * 10 + (char)puVar1[1] + -0x30;
  uVar4 = (((char)puVar1[2] + -0x30) * 10 + (int)(char)puVar1[3]) - 0x31;
  if (iVar3 < 0x32) {
    iVar3 = iVar3 + 100;
  }
  if (0xb < uVar4) goto LAB_0055b194;
  if (0xb < iVar5) {
    iVar6 = 0;
    if (9 < ((int)(char)puVar1[10] - 0x30U & 0xff)) goto LAB_0055b12c;
...
LAB_0055b12c:
  ...
  iVar5 = (*(code *)PTR_BIO_printf_006a7f38)
