...

{
  ...
  puVar4 = c->data;
  uVar1 = c->num + 1;
  *(undefined *)((int)puVar4 + c->num) = 0x80;
  if (uVar1 < 0x39) {
    iVar3 = 0x38 - uVar1;
  }
  else {
    (*(code *)PTR_memset_006aab00)((int)puVar4 + uVar1,0,0x40 - uVar1);
    sha256_block_data_order(c,puVar4,1);
    iVar3 = 0x38;
    uVar1 = 0;
  }
  (*(code *)PTR_memset_006aab00)((int)puVar4 + uVar1,0,iVar3);
  uVar2 = c->Nh;
  uVar1 = c->Nl;
  ...
  *(char *)((int)c->data + 0x3e) = (char)(uVar1 >> 8);
  sha256_block_data_order(c,puVar4,1);
  c->num = 0;
  (*(code *)PTR_memset_006aab00)(puVar4,0,0x40);
  uVar1 = c->md_len;
  if (uVar1 == 0x1c) {
    uVar1 = c->h[0];
    md[3] = (uchar)uVar1;
