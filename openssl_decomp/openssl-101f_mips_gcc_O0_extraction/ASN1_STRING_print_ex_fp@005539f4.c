...
LAB_00551c7c:
    if (fp == (FILE *)0x0) {
      ...
      iVar11 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a058,1,1,fp);
...
LAB_00552088:
  ...
  if (cStack_4d == '\0') {
    ...
    pcVar4 = pcStack_78;
    if (fp == (FILE *)0x0) goto LAB_00551cb0;
    iVar11 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0067a4c0,1,1,fp);
    if (iVar11 != 1) goto LAB_00551ca8;
  }
  iVar11 = str->length;
      ...
      if (0 < iVar8) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar19 & 8) == 0) {
              iVar8 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a048,1,1,fp);
...
LAB_005522b4:
          if ((uVar19 & 6) == 0) {
            ...
            iVar8 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a054,1,2,fp);
