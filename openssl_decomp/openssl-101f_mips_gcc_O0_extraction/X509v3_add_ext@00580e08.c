...

{
  ...
  if (x == (stack_st_X509_EXTENSION **)0x0) {
    ...
    if ((psVar4 != (stack_st_X509_EXTENSION *)0x0) ||
      ...
      if (a != (X509_EXTENSION *)0x0) {
        iVar1 = (*(code *)PTR_sk_insert_006a98dc)(psVar4,a,iVar1);
        if (iVar1 != 0) {
          if (*x == (stack_st_X509_EXTENSION *)0x0) {
            *x = psVar4;
            return psVar4;
        ...
        (*(code *)PTR_ERR_put_error_006a9030)(0xb,0x68,0x41,"x509_v3.c",0xb0);
  ...
  (*(code *)PTR_ERR_put_error_006a9030)(0xb,0x68,uVar3,"x509_v3.c",uVar2);
  return (stack_st_X509_EXTENSION *)0x0;
}
