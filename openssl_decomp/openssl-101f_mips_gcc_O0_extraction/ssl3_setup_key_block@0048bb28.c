...

{
  ...
  if (iVar10 == 0) {
    iVar7 = (*(code *)PTR_ssl_cipher_get_evp_006a9038)
    ...
    if (iVar7 == 0) {
      ...
      *(undefined4 *)(iVar7 + 0x38c) = local_84;
      ...
      if (-1 < iVar7) {
        iVar3 = (*(code *)PTR_EVP_CIPHER_key_length_006a903c)(local_8c);
        iVar4 = (*(code *)PTR_EVP_CIPHER_iv_length_006a865c)(local_8c);
        ...
        if (*(int *)(iVar8 + 0x378) != 0) {
          ...
          (*(code *)PTR_CRYPTO_free_006a7f88)(*(undefined4 *)(*(int *)(param_1 + 0x58) + 0x378));
          iVar8 = *(int *)(param_1 + 0x58);
          *(undefined4 *)(iVar8 + 0x378) = 0;
        }
        puVar1 = PTR_CRYPTO_malloc_006a8108;
        *(undefined4 *)(iVar8 + 0x374) = 0;
        iVar3 = (*(code *)puVar1)(iVar7,"s3_enc.c",0x1a7);
        ...
        if (iVar3 == 0) {
          ...
          *(int *)(iVar4 + 0x378) = iVar3;
          ...
          (*(code *)PTR_EVP_MD_CTX_set_flags_006a8600)(auStack_80,8);
          (*(code *)PTR_EVP_MD_CTX_init_006a7f1c)(auStack_68);
          if (iVar7 < 1) {
LAB_0048c010:
            iVar10 = 1;
            (*(code *)PTR_OPENSSL_cleanse_006a8174)(auStack_40,0x14);
            (*(code *)PTR_EVP_MD_CTX_cleanup_006a7f34)(auStack_80);
            ...
            while( true ) {
              ...
              iVar5 = iVar3 + iVar4;
              iVar4 = iVar4 + 0x10;
              uVar6 = (*(code *)PTR_EVP_sha1_006a86c4)();
              (*(code *)PTR_EVP_DigestInit_ex_006a8670)(auStack_68,uVar6,0);
              (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_68,&local_50,iVar8);
              ...
              (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(auStack_68,auStack_40,0);
              uVar6 = (*(code *)PTR_EVP_md5_006a81c8)();
              (*(code *)PTR_EVP_DigestInit_ex_006a8670)(auStack_80,uVar6,0);
              (*(code *)PTR_EVP_DigestUpdate_006a8674)
                        (auStack_80,*(int *)(param_1 + 0xc0) + 0x14,
                         *(undefined4 *)(*(int *)(param_1 + 0xc0) + 0x10));
              (*(code *)PTR_EVP_DigestUpdate_006a8674)(auStack_80,auStack_40,0x14);
              if (iVar7 < iVar4) {
                (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(auStack_80,auStack_40,0);
                (*(code *)PTR_memcpy_006aabf4)(iVar5,auStack_40,(iVar7 + 0x10) - iVar4);
              }
              else {
                (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(auStack_80,iVar5);
              }
              if (iVar7 <= iVar4) goto LAB_0048c010;
              iVar8 = iVar8 + 1;
  ...
  (*(code *)PTR_OPENSSL_cleanse_006a8174)(*(int *)(iVar7 + 0x378),*(undefined4 *)(iVar7 + 0x374));
  (*(code *)PTR_CRYPTO_free_006a7f88)(*(undefined4 *)(*(int *)(iVar10 + 0x58) + 0x378));
