...

{
  ...
  if (((pXVar2->canon_enc == (uchar *)0x0) || (pXVar2->modified != 0)) &&
     (iVar1 = (*(code *)PTR_i2d_X509_NAME_006a87d8)(pXVar2,0), iVar1 < 0)) {
    iVar1 = -2;
  }
    ...
    if (iVar1 == 0) {
                    /* WARNING: Could not recover jumptable at 0x00578f80. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      iVar1 = (*(code *)PTR_memcmp_006aabd8)(pXVar2->canon_enc,pXVar3->canon_enc);
      return iVar1;
    }
  }
  return iVar1;
