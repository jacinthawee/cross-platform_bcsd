...

{
  ...
  if (iVar14 < 0) {
    (*(code *)PTR_ERR_put_error_006a9030)(3,0x73,100,"bn_add.c",0xb8);
    return 0;
  }
  if ((r->dmax < iVar13) && (iVar10 = (*(code *)PTR_bn_expand2_006a9680)(r,iVar13), iVar10 == 0)) {
    return 0;
  }
  puVar11 = r->d;
  puVar7 = a->d;
