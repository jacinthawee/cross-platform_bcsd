...

{
  ...
  if (param_2 == 0) {
    ...
    *param_3 = 4;
    ...
    puVar33 = &local_18;
    uVar26 = (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(param_4);
    *param_3 = local_18;
    param_3 = puVar33;
  }
  ...
  uVar32 = uVar31;
  piVar29 = param_4;
  piVar27 = (int *)(*(code *)PTR_EVP_PKEY_CTX_get_data_006aa6dc)();
  switch(param_2) {
  default:
    return 0xfffffffe;
  case 1:
    iVar28 = (*(code *)PTR_EVP_MD_type_006a84cc)(param_4);
    if (iVar28 != 0x32f) {
      (*(code *)PTR_ERR_GOST_error_006aa6f0)(0x80,0x6c,"gost_pmeth.c",0x1cb);
      return 0;
    }
  ...
  case 6:
    if (param_3 != (undefined4 *)&DAT_00000020) {
      (*(code *)PTR_ERR_GOST_error_006aa6f0)(0x80,0x6f,"gost_pmeth.c",0x1db);
      return 0;
    }
    ...
    piVar27[7] = (iVar10 << uVar5 * 8 |
                 (uint)(&switchD_005de8a4::switchdataD_006752e0 + param_2) &
  ...
  case 7:
    piVar29 = piVar27 + 2;
    if (*piVar27 == 0) {
      iVar28 = (*(code *)PTR_EVP_PKEY_CTX_get0_pkey_006aa6e0)(uVar31);
      if (iVar28 == 0) {
        uVar26 = 0x1eb;
      }
      else {
        piVar29 = (int *)(*(code *)PTR_EVP_PKEY_get0_006aa6e4)(iVar28);
        if (piVar29 != (int *)0x0) goto LAB_005de93c;
        uVar26 = 0x1f1;
      }
      (*(code *)PTR_ERR_GOST_error_006aa6f0)(0x80,0x74,"gost_pmeth.c",uVar26);
      return 0;
    }
LAB_005de93c:
                    /* WARNING: Could not recover jumptable at 0x005de968. Too many branches */
