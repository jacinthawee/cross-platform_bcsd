...
LAB_004e092c:
  ...
  uVar5 = uVar4 << 2;
  uVar14 = 0x20;
  if ((puVar16[-0x10] & 0x40) == 0) goto LAB_004e0964;
LAB_004e0a64:
  uVar5 = uVar5 | 1;
  if (uVar14 != 0) goto LAB_004e0a6c;
LAB_004e096c:
  iVar8 = iVar10 + 1;
  uVar4 = uVar5 << 1;
  ...
  uVar4 = uVar5 << 2;
  uVar15 = 0x20;
  if ((puVar16[-0x10] & 0x40) == 0) goto LAB_004e09a8;
LAB_004e0a28:
  uVar4 = uVar4 | 1;
LAB_004e09a8:
  if (uVar15 != 0) goto LAB_004e08e0;
  iVar8 = iVar8 + 1;
  uVar15 = 0x80;
...
LAB_004e0a38:
      uVar5 = uVar5 | 1;
      if (uVar12 == 0) goto LAB_004e087c;
LAB_004e0a44:
      uVar5 = uVar5 << 1;
      uVar14 = uVar12 >> 1;
      if ((uVar12 & (byte)puVar16[-0x10]) != 0) goto LAB_004e0a64;
LAB_004e0964:
      if (uVar14 == 0) goto LAB_004e096c;
LAB_004e0a6c:
      bVar2 = puVar16[-0x10];
      uVar12 = uVar14 >> 1;
    }
...
LAB_004e0a04:
    ...
    if (uVar12 != 0) {
      uVar4 = uVar4 << 1;
      uVar15 = uVar12 >> 1;
      if ((uVar12 & (byte)puVar16[-0x10]) != 0) goto LAB_004e0a28;
      goto LAB_004e09a8;
    }
    uVar4 = uVar4 << 1;
