...
LAB_00555e34:
  ...
  if (uVar5 == 0) {
    ...
    if (X509_NAME_ENTRY_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar5 & 0xff) < 7) {
        ...
        iVar4 = (*(code *)(&switchD_0055fb90::switchdataD_0066aa50)[uVar5 & 0xff])();
        return iVar4;
      }
      goto switchD_0055fb90_caseD_0;
    }
  ...
  if (X509_NAME_ENTRY_it._16_4_[4] == 0) {
    ...
    if ((uVar5 & 0xff) < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      iVar4 = (*(code *)(&switchD_0055fdcc::switchdataD_0066aa6c)[uVar5 & 0xff])();
      return iVar4;
    }
  }
  else {
    ...
    if ((uVar5 & 0xff) < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      iVar4 = (*(code *)(&switchD_0055fa8c::switchdataD_0066aa34)[uVar5 & 0xff])();
      return iVar4;
    }
  }
