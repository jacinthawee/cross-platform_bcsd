...

{
  ...
  local_50 = &_gp;
  local_2c = *(CRYPTO_THREADID **)PTR___stack_chk_guard_006aabf0;
  iStack_80 = 0;
  if ((mh_mode & 1) != 0) {
    unaff_s4 = aCStack_48;
    unaff_s8 = "Number";
    ...
    if (amih != 0) {
      ...
      do {
        while( true ) {
          CRYPTO_THREADID_current(unaff_s4);
          unaff_s0 = (void *)(**(code **)(local_50 + -0x6a34))(amih,unaff_s4);
          iVar4 = amih;
          if (unaff_s0 == (void *)0x0) goto LAB_004c1f60;
...
LAB_004c1e0c:
  ...
  pcStack_138 = &_ITM_registerTMCloneTable;
  pCStack_8c = pCVar11;
  pvStack_88 = unaff_s0;
  pCStack_84 = unaff_s1;
  pcStack_7c = unaff_s3;
  ...
  if ((((uint)local_50 & 0x7f) == 1) && (pCStack_e0 != (CRYPTO_THREADID *)0x0)) {
    ...
    if ((mh_mode & 1) != 0) {
      ...
      if ((mh_mode & 2) == 0) {
        ...
        CRYPTO_lock(6,0x14,"mem_dbg.c",299);
        if (unaff_s1 == (CRYPTO_THREADID *)0x0) goto LAB_004c20cc;
      }
      else {
        CRYPTO_lock(6,0x14,"mem_dbg.c",299);
      }
      CRYPTO_mem_ctrl_constprop_5();
      unaff_s1 = (CRYPTO_THREADID *)CRYPTO_malloc(0x24,"mem_dbg.c",0x1f2);
      if (unaff_s1 == (CRYPTO_THREADID *)0x0) {
        ...
        if ((mh == 0) &&
          ...
          uVar8 = options;
          puStack_ac = &_ITM_registerTMCloneTable;
          if ((options & 2) == 0) {
          ...
          if ((uVar8 & 1) == 0) {
            ...
            order = (void *)((int)order + 1);
            uVar3 = (**(code **)(puStack_b8 + -0x52fc))(0);
...
LAB_004c20cc:
  ...
  puStack_154 = PTR___stack_chk_guard_006aabf0;
  puStack_120 = &_gp;
  ...
  if (((pCVar6 == (CRYPTO_THREADID *)0x0) &&
     ...
     (pCStack_14c = (CRYPTO_THREADID *)&_ITM_registerTMCloneTable, (mh_mode & 1) != 0)) {
    ...
    if ((mh_mode & 2) == 0) {
      ...
      CRYPTO_lock(6,0x14,"mem_dbg.c",299);
      if (pCStack_144 == (CRYPTO_THREADID *)0x0) goto LAB_004c24ac;
    }
    else {
      file = (char *)0x12b;
      num = "mem_dbg.c";
    ...
    pCStack_144 = (CRYPTO_THREADID *)&_ITM_registerTMCloneTable;
    if (mh != 0) {
      CRYPTO_mem_ctrl_constprop_5();
      aCStack_110[0].ptr = pCVar11;
      pvVar5 = (void *)(**(code **)(puStack_120 + -0x6a34))(mh,pCStack_140);
      if (pvVar5 != (void *)0x0) {
...
LAB_004c24ac:
  ...
  (**(code **)(puStack_120 + -0x5328))();
  puStackY_1b8 = PTR___stack_chk_guard_006aabf0;
  pCStack_15c = *(CRYPTO_THREADID **)PTR___stack_chk_guard_006aabf0;
  pCVar11 = pCStack_15c;
  ...
  if ((iStack_11c == 1) && (pCStackY_1b4 = pCVar6, pCVar6 != (CRYPTO_THREADID *)0x0)) {
    ...
    if (pCStackY_1b0 == (CRYPTO_THREADID *)0x0) {
      ...
      pcStackY_1ac = &_ITM_registerTMCloneTable;
      if ((mh_mode & 1) != 0) {
        ...
        ppCVar7 = (CRYPTO_THREADID **)(*(code *)PTR_lh_delete_006a94ac)(mh,aCStack_180);
        uVar8 = mh;
...
LAB_004c27cc:
  ...
  iStackY_1bc = *(int *)PTR___stack_chk_guard_006aabf0;
  if ((mh != 0) || (amih != 0)) {
    CRYPTO_mem_ctrl_constprop_5();
    uStackY_1c0 = 0;
    iStackY_1c4 = 0;
    ...
    if ((mh == 0) ||
       ((*(code *)PTR_lh_doall_arg_006a94bc)(mh,print_leak_LHASH_DOALL_ARG,&pCStackY_1c8),
       iStackY_1c4 == 0)) {
