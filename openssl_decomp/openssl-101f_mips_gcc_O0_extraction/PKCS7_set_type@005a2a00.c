...

{
  ...
  pAVar2 = (ASN1_OBJECT *)(*(code *)PTR_OBJ_nid2obj_006a8240)(type);
  ...
  case 0x16:
    ...
    if (pPVar7 != (PKCS7_SIGNED *)0x0) {
      iVar5 = (*(code *)PTR_ASN1_INTEGER_set_006a8264)(pPVar7->version,1);
      if (iVar5 == 0) {
  ...
  case 0x17:
    ...
    if ((pPVar8 != (PKCS7_ENVELOPE *)0x0) &&
       (iVar5 = (*(code *)PTR_ASN1_INTEGER_set_006a8264)(pPVar8->version,0), iVar5 != 0)) {
  ...
  case 0x18:
    ...
    if (pPVar9 != (PKCS7_SIGN_ENVELOPE *)0x0) {
      (*(code *)PTR_ASN1_INTEGER_set_006a8264)(pPVar9->version,1);
      iVar5 = (*(code *)PTR_ASN1_INTEGER_set_006a8264)(((p7->d).data)->length,1);
      if (iVar5 != 0) {
        ppVar12 = ((p7->d).sign)->contents;
        puVar10 = (uchar *)(*(code *)PTR_OBJ_nid2obj_006a8240)(0x15);
  ...
  case 0x19:
    ...
    if (pPVar3 != (PKCS7_DIGEST *)0x0) {
      iVar5 = (*(code *)PTR_ASN1_INTEGER_set_006a8264)(pPVar3->version,0);
      return (uint)(iVar5 != 0);
    }
    break;
  case 0x1a:
