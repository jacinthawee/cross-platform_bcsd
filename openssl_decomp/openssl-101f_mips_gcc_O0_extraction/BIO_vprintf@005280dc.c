...

{
  ...
  puStack_90c = (uint *)(CAST_S_table6 + 0x370);
  local_8b8 = 0x660000;
...
LAB_00528454:
    ...
    if (uVar2 < 0x11) {
      do {
        pcVar11 = pcVar19;
        switch((&switchD_00528470::switchdataD_006680f0)[uVar2] & 0xfffffffe) {
        case 0x528478:
          pcVar11 = pcVar19 + 1;
          uVar16 = (uint)*pcVar19;
...
LAB_00528c9c:
    ...
    case 0x41:
      ...
      if (puVar12 == (uint *)0x0) {
        ...
        if (puVar12 == (uint *)0x1) {
          dVar20 = *(double *)(local_8a8 + -0x7d68);
        }
        else if (puVar12 == (uint *)&SUB_00000002) {
          dVar20 = *(double *)(local_8a4 + -0x7d60);
        }
        else {
          dVar20 = DAT_0063fad0;
          if (((((puVar12 != (uint *)0x3) &&
                (dVar20 = DAT_0063fac8, puVar12 != (uint *)&SUB_00000004)) &&
               (dVar20 = DAT_006682a8, puVar12 != (uint *)&DAT_00000005)) &&
              ((dVar20 = DAT_006682b0, puVar12 != (uint *)&DAT_00000006 &&
               (dVar20 = DAT_006682b8, puVar12 != (uint *)&DAT_00000007)))) &&
             (dVar20 = DAT_006682c0, puVar12 != (uint *)&DAT_00000008)) {
            dVar20 = DAT_00668290;
          }
        }
        iVar7 = (int)dVar20;
