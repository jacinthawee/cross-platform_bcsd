...

{
  ...
  pAStack_54 = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  pBStack_124 = in;
  puStack_4c = d2i;
  ppvStack_48 = x;
  ...
  puStack_1a4 = PTR___stack_chk_guard_006aabf0;
  puStack_98 = puStack_e8;
  pcStack_9c = *(code **)PTR___stack_chk_guard_006aabf0;
  pBStack_94 = in;
  uVar7 = (*(code *)PTR_BIO_s_file_006a7fa0)();
  puVar8 = (undefined *)(*(code *)PTR_BIO_new_006a7fa4)(uVar7);
  if (puVar8 == (undefined *)0x0) {
    ...
    iStack_11c = 0;
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar8,0x6a,0,ppuStack_e4);
    in_00 = &puStack_a4;
    ...
    (*(code *)PTR_BIO_free_006a7f70)(puVar8);
    puStack_e8 = puVar8;
  ...
  pcStack_ec = *(code **)PTR___stack_chk_guard_006aabf0;
  ...
  if (puVar8 == (undefined *)0x0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar8,0x6a,0,in_00);
    iVar11 = (*pcStack_12c)(iStack_11c,0);
    unaff_s6 = "r";
    pBStack_124 = (BIO *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar11,"a_i2d_fp.c",0x5b);
    if (pBStack_124 == (BIO *)0x0) {
      ...
      while( true ) {
        ...
        iVar9 = iVar11;
        iVar12 = (*(code *)PTR_BIO_write_006a7f14)(puVar8,pcStack_164,iVar11);
...
LAB_0054fbe4:
      (*(code *)PTR_CRYPTO_free_006a7f88)(pBStack_124);
    }
    (*(code *)PTR_BIO_free_006a7f70)(puVar8);
    puStack_1a4 = puVar8;
  }
  ...
  puVar8 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(pAStack_170,"a_i2d_fp.c",0x5b);
  if (puVar8 == (undefined *)0x0) {
    ...
    while( true ) {
      ...
      pAVar6 = pAStack_170;
      pAVar13 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(pcStack_164,puVar17);
...
LAB_0054fd84:
  ...
  if (puVar8 == (undefined *)0x0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(puVar8,0x6a,0,puVar17);
    ...
    if (puStack_178 == (uchar *)0x0) {
      ...
      while( true ) {
        ...
        pAVar6 = pAVar13;
        pAVar14 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(puVar8);
...
LAB_0054fef0:
  ...
  piStack_1b4 = *(int **)PTR___stack_chk_guard_006aabf0;
  ...
  if (puStack_1b8 == (uchar *)0x0) {
    ...
    while( true ) {
      ...
      iVar11 = (*(code *)PTR_BIO_write_006a7f14)(puStack_1e4,puVar18,iVar9);
    ...
    pvVar5 = (void *)0x1;
LAB_00550050:
    (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_1b8);
    pvStack_1ec = pvVar5;
  }
