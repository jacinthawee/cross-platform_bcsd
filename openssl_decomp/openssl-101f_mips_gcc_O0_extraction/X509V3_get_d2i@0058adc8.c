...

{
  ...
  local_24 = *(stack_st_X509_EXTENSION ***)PTR___stack_chk_guard_006aabf0;
  ppiVar12 = (int **)nid;
  piVar13 = crit;
  piVar5 = idx;
...
LAB_0058aecc:
    ...
    if (idx != (int *)0x0) {
      ...
      for (; iVar3 = (*(code *)PTR_sk_num_006a7f2c)(x), (int)ppiVar15 < iVar3;
          ppiVar15 = (int **)((int)ppiVar15 + 1)) {
        ppiVar12 = ppiVar15;
        pXVar4 = (X509_EXTENSION *)(*(code *)PTR_sk_value_006a7f24)(x);
...
LAB_0058ae80:
    ...
    iVar3 = (*(code *)PTR_sk_num_006a7f2c)(x);
    piVar5 = idx;
    if (0 < iVar3) {
      do {
        ppiVar12 = ppiVar15;
        pXVar7 = (X509_EXTENSION *)(*(code *)PTR_sk_value_006a7f24)(x);
...
LAB_0058aed8:
    ...
    local_70 = ext_cmp_BSEARCH_CMP_FN;
    local_5c[0] = piVar5;
    piVar5 = (int *)(*(code *)PTR_OBJ_bsearch__006a9488)(&local_60);
    if (piVar5 == (int *)0x0) {
    ...
    if (-1 < iVar3) {
      ...
      if (uVar16 != 5) {
        ...
        if (pXVar4 != (X509_EXTENSION *)0x0) {
          uVar14 = (*(code *)PTR_sk_value_006a7f24)(*ppsVar9,iVar3);
          (*(code *)PTR_X509_EXTENSION_free_006a8268)(uVar14);
          iVar3 = (*(code *)PTR_sk_set_006a9478)(*ppsVar9,iVar3,pXVar4);
          if (iVar3 == 0) {
      ...
      iVar3 = (*(code *)PTR_sk_delete_006a8398)(*ppsVar9,iVar3);
      goto joined_r0x0058b228;
    }
    if (uVar16 == 3) {
      uVar14 = 0x66;
LAB_0058b104:
      if (((uint)local_70 & 0x10) != 0) {
        return (void *)0x0;
      }
...
LAB_0058b238:
  ...
  if (psVar10 == (stack_st_X509_EXTENSION *)0x0) {
    psVar10 = (stack_st_X509_EXTENSION *)(*(code *)PTR_sk_new_null_006a80a4)();
    *ppsVar9 = psVar10;
    if (psVar10 == (stack_st_X509_EXTENSION *)0x0) {
      return (void *)0xffffffff;
    }
  }
  iVar3 = (*(code *)PTR_sk_push_006a80a8)(psVar10,pXVar4);
joined_r0x0058b228:
  if (iVar3 != 0) {
    return (void *)0x1;
  }
