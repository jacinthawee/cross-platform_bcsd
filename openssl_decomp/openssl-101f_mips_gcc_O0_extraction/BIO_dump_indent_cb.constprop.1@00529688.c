...
int BIO_dump_indent_cb_constprop_1
              (BIO *param_1,undefined4 *param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  byte **local_1ec;
  char acStack_1e8 [20];
  undefined4 local_1d4 [33];
  undefined local_150;
  undefined4 *local_2c;
  
  local_1ec = (byte **)PTR___stack_chk_guard_006aabf0;
  local_230 = &_gp;
  ...
  if ((int)param_4 < 1) {
    ...
    *(byte *)((int)local_1d4 + (int)puVar12) = 0;
    local_204 = (undefined4 *)
  ...
  if ((int)local_204 < 1) {
    ...
    do {
      ...
      param_4 = unaff_s2;
      BIO_snprintf(unaff_s8,0x14,local_200 + -0x7d30);
...
LAB_005298e0:
        ...
        if ((int)unaff_s2 < (int)puVar7) {
          unaff_s5 = 0x2e;
          unaff_s6 = (undefined4 *)((int)local_210 + (int)puVar7);
          puVar10 = (undefined4 *)((int)local_210 + (int)((int)unaff_s2 + iStack_264 + -1));
          unaff_s4 = (byte *)(local_1f4 + -0x5bd0);
          puVar12 = local_220;
          do {
      ...
      apbStack_270[0] = (byte *)((int)local_214 + 1);
      local_220 = (undefined4 *)((int)local_220 + iStack_264);
      local_214 = (undefined4 *)apbStack_270[0];
      param_3 = (undefined4 *)(**(code **)(local_230 + -0x53b0))(unaff_s7);
      puStack_458 = unaff_s7;
      iVar9 = BIO_write(local_20c,unaff_s7,(int)param_3);
      local_218 = local_218 + iVar9;
    } while ((undefined4 *)apbStack_270[0] != local_204);
  }
  apbStack_270[1] = (byte *)((int)local_1f0 + (int)puVar7);
  if (local_1f0 != (undefined4 *)0x0) {
    apbStack_270[0] = &local_150;
    param_4 = local_1d4;
    local_238 = apbStack_270[1];
    BIO_snprintf((char *)apbStack_270[0],0x121,"%s%04x - <SPACES/NULS>\n");
    param_3 = (undefined4 *)(**(code **)(local_230 + -0x53b0))(apbStack_270[0]);
    puStack_458 = (undefined4 *)apbStack_270[0];
    iVar9 = BIO_write(local_20c,apbStack_270[0],(int)param_3);
    local_218 = local_218 + iVar9;
  }
  if (local_2c == (undefined4 *)*local_1ec) {
    return local_218;
  }
  pcStack_24c = BIO_dump_indent_cb_constprop_0;
  puStack_454 = local_2c;
