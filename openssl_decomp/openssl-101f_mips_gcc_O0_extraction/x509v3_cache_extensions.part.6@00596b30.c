...

{
  ...
  type = (EVP_MD *)(*(code *)PTR_EVP_sha1_006a86c4)();
  ...
  iVar5 = (*(code *)PTR_ASN1_INTEGER_get_006a831c)(param_1->cert_info->version);
  if (iVar5 == 0) {
...
LAB_00596c48:
      if ((*(int *)(iVar22 + 4) == 0x102) || (iVar5 == 0)) {
        ...
        lVar8 = (*(code *)PTR_ASN1_INTEGER_get_006a831c)();
      ...
      if (iVar22 != 0) goto LAB_00596c48;
LAB_0059728c:
      param_1->ex_pathlen = -1;
    }
    (*(code *)PTR_BASIC_CONSTRAINTS_free_006aa190)(piVar6);
    param_1->ex_flags = param_1->ex_flags | 1;
  }
  a = (PROXY_CERT_INFO_EXTENSION *)X509_get_ext_d2i(param_1,0x297,(int *)0x0,(int *)0x0);
  if (a == (PROXY_CERT_INFO_EXTENSION *)0x0) goto LAB_00596d00;
  uVar7 = param_1->ex_flags;
  if ((uVar7 & 0x10) == 0) {
    iVar5 = X509_get_ext_by_NID(param_1,0x55,0);
    if (-1 < iVar5) {
      uVar7 = param_1->ex_flags;
      goto LAB_00596cc0;
    }
    iVar5 = X509_get_ext_by_NID(param_1,0x56,0);
    if (-1 < iVar5) {
      uVar7 = param_1->ex_flags;
      goto LAB_00596cc0;
    }
...
LAB_00596d00:
  ...
  if (piVar6 != (int *)0x0) {
    ...
    puVar2 = PTR_ASN1_BIT_STRING_free_006a9794;
  ...
  if (pvVar9 != (void *)0x0) {
    ...
    while (iVar5 = (*(code *)PTR_sk_num_006a7f2c)(pvVar9), (int)local_34 < iVar5) {
      uVar10 = (*(code *)PTR_sk_value_006a7f24)(pvVar9);
      iVar5 = (*(code *)PTR_OBJ_obj2nid_006a822c)(uVar10);
      if (iVar5 == 0x85) {
...
LAB_00597260:
        ...
        if (iVar5 == 0x89) goto LAB_00597260;
      }
      else if (iVar5 == 0xb4) {
    ...
    (*(code *)PTR_sk_pop_free_006a8158)(pvVar9,PTR_ASN1_OBJECT_free_006a8104);
  }
  ...
  iVar5 = (*(code *)PTR_sk_num_006a7f2c)(psVar15);
  if (0 < iVar5) {
    do {
      ppDVar16 = (DIST_POINT_NAME **)(*(code *)PTR_sk_value_006a7f24)(param_1->crldp,iVar25);
      pDVar17 = ppDVar16[1];
      ...
      if ((*ppDVar16 == (DIST_POINT_NAME *)0x0) || ((*ppDVar16)->type != 1)) {
        ...
        for (iVar5 = 0; iVar19 = (*(code *)PTR_sk_num_006a7f2c)(ppDVar16[2]), iVar5 < iVar19;
            iVar5 = iVar5 + 1) {
          piVar6 = (int *)(*(code *)PTR_sk_value_006a7f24)(ppDVar16[2],iVar5);
          if (*piVar6 == 4) {
            pXVar4 = (X509_NAME *)piVar6[1];
            if (pXVar4 != (X509_NAME *)0x0) goto LAB_0059719c;
            break;
          }
        }
...
LAB_00597108:
    ...
    iVar5 = (*(code *)PTR_OBJ_obj2nid_006a822c)(pAVar18);
    if (iVar5 == 0x359) {
    ...
    if (iVar5 != 0) {
      pAVar18 = X509_EXTENSION_get_object(ex);
      local_30 = (*(code *)PTR_OBJ_obj2nid_006a822c)(pAVar18);
      if (local_30 == 0) {
        uVar7 = param_1->ex_flags;
      }
      else {
        iVar22 = 0xb;
        puVar24 = supported_nids_13629;
        iVar5 = (*(code *)PTR_OBJ_bsearch__006a9488)
                          (&local_30,supported_nids_13629,0xb,4,nid_cmp_BSEARCH_CMP_FN);
        if (iVar5 != 0) goto LAB_00597060;
        uVar7 = param_1->ex_flags;
      }
      uVar7 = uVar7 | 0x200;
      goto LAB_00597108;
