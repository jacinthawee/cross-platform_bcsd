...

{
  ...
  psStack_2c = *(stack_st_X509_EXTENSION **)PTR___stack_chk_guard_006aabf0;
  pXVar6 = a;
  pXStack_34 = a;
  if (uVar3 == 0) {
      ...
      if (X509_REVOKED_it._8_4_ == (uint *)0x0) {
        ...
        if ((*X509_REVOKED_it._8_4_ & 6) == 0) {
          ...
          for (; iVar4 = (*(code *)PTR_sk_num_006a7f2c)(a), iVar8 < iVar4; iVar8 = iVar8 + 1) {
            pAStack_30 = (ASN1_TIME *)(*(code *)PTR_sk_value_006a7f24)(a,iVar8);
    ...
    puVar7 = (undefined1 *)X509_REVOKED_it._16_4_;
    if (a == (X509_REVOKED *)0x0) goto switchD_0055fb90_caseD_0;
    if (X509_REVOKED_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
...
switchD_0055fb90_caseD_0:
  ...
  (*(code *)PTR_memcmp_006aabd8)(pXVar6->serialNumber,*(undefined4 *)puVar7,pAVar5,in_a3,&_gp);
  return;
}
