...

{
  ...
  plVar2 = (lhash_st_OPENSSL_STRING *)(*(code *)PTR_lh_new_006a850c)(hash,cmp);
  if (plVar2 == (lhash_st_OPENSSL_STRING *)0x0) {
    ...
    if (0 < iVar3) {
      ...
      if (qual == (qual *)0x0) {
        do {
          uVar7 = (*(code *)PTR_sk_value_006a7f24)(db->data,lVar9);
          iVar5 = (*(code *)PTR_lh_insert_006a8514)(plVar2,uVar7);
          if (iVar5 != 0) goto LAB_005a1844;
          lVar9 = lVar9 + 1;
        } while (iVar3 != lVar9);
      }
      else {
        do {
          ppcVar4 = (OPENSSL_STRING *)(*(code *)PTR_sk_value_006a7f24)(db->data,lVar9);
          iVar5 = (*qual)(ppcVar4);
          if ((iVar5 != 0) &&
             (iVar5 = (*(code *)PTR_lh_insert_006a8514)(plVar2,ppcVar4), iVar5 != 0)) {
LAB_005a1844:
            puVar1 = PTR_sk_find_006a906c;
            db->error = 2;
            lVar8 = (*(code *)puVar1)(db->data,iVar5);
            db->arg1 = lVar8;
            puVar1 = PTR_lh_free_006a8518;
            db->arg2 = lVar9;
            (*(code *)puVar1)(plVar2);
            return 0;
          }
