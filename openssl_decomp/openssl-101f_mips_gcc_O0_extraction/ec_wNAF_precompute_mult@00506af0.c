...

{
  ...
  ppEVar2 = (EC_GROUP **)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x1c,"ec_mult.c",0x69);
  if (ppEVar2 == (EC_GROUP **)0x0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0x10,0xc4,0x41,"ec_mult.c",0x6c);
    return false;
  }
  *ppEVar2 = param_1;
  ...
  if (pEVar3 == (EC_POINT *)0x0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0x10,0xbc,0x71,"ec_mult.c",0x311);
...
LAB_00506f70:
    ...
    if (param_2 == (BN_CTX *)0x0) {
      param_2 = BN_CTX_new();
      local_58 = param_2;
      if (param_2 == (BN_CTX *)0x0) goto LAB_00506f70;
    }
    else {
      local_58 = (BN_CTX *)0x0;
    }
    ...
    if ((order == (BIGNUM *)0x0) || (iVar4 = EC_GROUP_get_order(param_1,order,param_2), iVar4 == 0))
    {
      ...
      bVar11 = false;
      (*(code *)PTR_ERR_put_error_006a9030)(0x10,0xbc,0x72,"ec_mult.c",0x323);
      points = (EC_POINT **)0x0;
      dst = (EC_POINT *)0x0;
      pEVar7 = (EC_POINT *)0x0;
    }
      ...
      points = (EC_POINT **)
               (*(code *)PTR_CRYPTO_malloc_006a8108)((int)(num + 1) * 4,"ec_mult.c",0x33c);
      if (points == (EC_POINT **)0x0) {
        uVar8 = 0x33f;
LAB_00506cf0:
        bVar11 = false;
        (*(code *)PTR_ERR_put_error_006a9030)(0x10,0xbc,0x41,"ec_mult.c",uVar8);
        dst = (EC_POINT *)0x0;
        pEVar7 = (EC_POINT *)0x0;
      }
      else {
        ...
        if ((pEVar7 == (EC_POINT *)0x0) || (dst = EC_POINT_new(param_1), dst == (EC_POINT *)0x0)) {
          bVar11 = false;
          (*(code *)PTR_ERR_put_error_006a9030)(0x10,0xbc,0x41,"ec_mult.c",0x350);
          dst = (EC_POINT *)0x0;
        }
        else {
...
LAB_00506d20:
    ...
    if (ppEVar2 == (EC_GROUP **)0x0) goto LAB_00506d78;
  }
  iVar4 = (*(code *)PTR_CRYPTO_add_lock_006a9080)(ppEVar2 + 6,0xffffffff,0x24,"ec_mult.c",0x8c);
  if (iVar4 < 1) {
    ...
    if (ppEVar12 != (EC_POINT **)0x0) {
      ...
      (*(code *)PTR_CRYPTO_free_006a7f88)(ppEVar12);
    }
...
LAB_00506d78:
  if (points != (EC_POINT **)0x0) {
    ...
    (*(code *)PTR_CRYPTO_free_006a7f88)(points);
  }
  if (pEVar7 != (EC_POINT *)0x0) {
