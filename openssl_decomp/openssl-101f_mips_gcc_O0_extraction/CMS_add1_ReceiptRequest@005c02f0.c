...

{
  ...
  local_28 = (undefined4 *)
             (*(code *)PTR_ASN1_item_i2d_006a979c)
                       (param_2,&local_18,PTR_CMS_ReceiptRequest_it_006aa4f8);
  if (-1 < (int)local_28) {
    piVar5 = (int *)&SUB_00000010;
    puVar4 = (undefined4 *)&DAT_000000d4;
    pcVar6 = (char *)local_18;
    iVar2 = (*(code *)PTR_CMS_signed_add1_attr_by_NID_006aa49c)(param_1);
    if (iVar2 != 0) {
  ...
  pcVar6 = s_cms_ess_c_00672aac;
  local_28 = (undefined4 *)&DAT_0000009d;
