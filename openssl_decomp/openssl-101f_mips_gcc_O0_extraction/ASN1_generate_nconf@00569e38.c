  ...
  do {
    ...
    if (puVar14 == (undefined *)0x0) {
      ...
      iVar7 = (*(code *)PTR_BIO_printf_006a7f38)
                        (bp,pcStack_130 + -0x4f00,pbVar12 + (in_a3 - unaff_s7->flags));
...
LAB_0056a6a8:
    ...
    if (uVar6 != 2) {
      if (uVar6 == 10) {
        ...
        if (0 < iVar7) {
          if ((a_00->type != 0x10a) ||
             (iVar7 = (*(code *)PTR_BIO_write_006a7f14)(bp,&DAT_00662b74,1), 0 < iVar7)) {
            iVar7 = a_00->length;
            iVar13 = 0;
            if (0 < iVar7) {
              do {
...
LAB_0056a204:
    ...
    if (iVar7 < 1) goto LAB_0056a204;
    if ((a_00->type == 0x102) &&
       (iVar7 = (*(code *)PTR_BIO_write_006a7f14)(bp,&DAT_00662b74,1), iVar7 < 1)) {
      bp = (BIO *)0x0;
      goto joined_r0x0056a074;
    }
    iVar7 = a_00->length;
