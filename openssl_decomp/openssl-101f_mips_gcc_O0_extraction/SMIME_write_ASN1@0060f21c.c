...

{
  ...
  if (((flags & 0x40U) != 0) && (data != (BIO *)0x0)) {
    ...
    (**(code **)(local_90 + -0x7e88))(bio,&DAT_0067a4b8);
    local_74 = 0;
    local_7c = ",";
    local_70 = "sha-256";
    local_64 = "Number";
...
LAB_0060f5e4:
        ...
        if ((int)unaff_s5 < 0x2a1) {
          ...
          if (unaff_s5 == (BIO *)&DAT_00000040) {
            unaff_s5 = (BIO *)0x1;
            (**(code **)(local_90 + -0x7e88))(bio,&DAT_0064e19c);
            iVar23 = iVar23 + 1;
            goto LAB_0060f3b8;
          }
        }
          ...
          if ((int)unaff_s5 < 0x2a2) {
            unaff_s5 = (BIO *)0x1;
            iVar23 = iVar23 + 1;
            (**(code **)(local_90 + -0x7e88))(bio,local_68 + -0x5b34);
            goto LAB_0060f3b8;
          }
...
LAB_0060f85c:
    ...
    (**(code **)(local_90 + -0x7fa8))(bio,"Content-Disposition: attachment;");
    pcStack_bc = &DAT_0067a408;
    (**(code **)(local_90 + -0x7fa8))(bio," filename=\"%s\"%s",&DAT_0067a408,pAStack_b8);
    (**(code **)(local_90 + -0x7fa8))(bio,"Content-Type: %smime;",pcStack_1274);
  }
...
LAB_0060fdfc:
      ...
      pcVar20 = (char *)&pbStack_1124[-0x166].shutdown;
