...

{
  ...
  file = (BIO *)local_1144;
  local_114c = (int *)PTR___stack_chk_guard_006aabf0;
  buf_01 = aBStack_112c;
  ...
  buf_00 = "%lu:%s:%s:%d:%s\n";
  piVar1 = (int *)(**(code **)(local_1158 + -0x693c))(auStack_1134);
  local_1150 = "s\n";
  do {
    parg = file;
