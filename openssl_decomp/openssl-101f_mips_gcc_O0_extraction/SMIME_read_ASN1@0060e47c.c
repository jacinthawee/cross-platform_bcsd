...

{
  ...
  iVar3 = (**(code **)(local_48 + -0x6e74))(pAStack_88,unaff_s7);
...
LAB_0060e9e0:
    ...
    if (unaff_s1 == 0) goto LAB_0060e9e0;
    iVar3 = (**(code **)(local_48 + -0x52c0))(unaff_s1,"multipart/signed");
    if (iVar3 != 0) {
      iVar3 = (**(code **)(local_48 + -0x52c0))(unaff_s1,"application/x-pkcs7-mime");
      if ((iVar3 == 0) ||
         (iVar3 = (**(code **)(local_48 + -0x52c0))(unaff_s1,"application/pkcs7-mime"), iVar3 == 0))
      {
        (**(code **)(local_48 + -0x7d88))(pAStack_88,mime_hdr_free);
        uVar4 = (**(code **)(local_48 + -0x7928))();
        unaff_s1 = (**(code **)(local_48 + -0x7f3c))(uVar4);
        if (unaff_s1 == 0) {
          local_50 = 0xbb;
          (**(code **)(local_48 + -0x6eb0))(0xd,0xd1,0x41,"asn_mime.c");
        }
        else {
          unaff_s2 = (char *)(**(code **)(local_48 + -0x7920))(unaff_s1,bio);
          pAVar5 = (ASN1_VALUE *)(**(code **)(local_48 + -0x727c))(it,unaff_s2,0);
          if (pAVar5 != (ASN1_VALUE *)0x0) {
            pcVar16 = (char *)0x0;
            pBVar14 = (BIO *)0x0;
            pcVar13 = (code *)&DAT_0000000b;
            (**(code **)(local_48 + -0x7fc8))(unaff_s2);
            (**(code **)(local_48 + -0x742c))(unaff_s2);
            (**(code **)(local_48 + -0x7f70))(unaff_s1);
            pAStack_88 = pAVar5;
            goto LAB_0060e648;
          }
          local_50 = 0xc1;
          (**(code **)(local_48 + -0x6eb0))(0xd,0xd1,0x6e,"asn_mime.c");
        ...
        pcVar16 = "asn_mime.c";
        local_50 = 0x207;
        (**(code **)(local_48 + -0x6eb0))(0xd,0xd4,0xcd);
        pBVar14 = *(BIO **)(unaff_s3 + 4);
        (**(code **)(local_48 + -0x6c7c))(2,"type: ");
    ...
    local_38[0] = "boundary";
    iVar3 = (**(code **)(local_48 + -0x6e74))(*(undefined4 *)(unaff_s3 + 8),unaff_s7);
    if (((-1 < iVar3) &&
...
LAB_0060e8c4:
        ...
        iVar3 = (**(code **)(local_48 + -0x52c0))(unaff_s2,"application/x-pkcs7-signature");
        if ((iVar3 == 0) ||
           (iVar3 = (**(code **)(local_48 + -0x52c0))(unaff_s2,"application/pkcs7-signature"),
           iVar3 == 0)) {
          (**(code **)(local_48 + -0x7d88))(pAStack_88,mime_hdr_free);
          uVar4 = (**(code **)(local_48 + -0x7928))();
          ...
          if ((_func_603 *)unaff_s2 == (_func_603 *)0x0) {
            ...
            unaff_s1 = (**(code **)(local_48 + -0x7920))(unaff_s2,unaff_s3);
            pAVar5 = (ASN1_VALUE *)(**(code **)(local_48 + -0x727c))(it,unaff_s1,0);
            if (pAVar5 != (ASN1_VALUE *)0x0) {
              pcVar16 = (char *)0x0;
              pBVar14 = (BIO *)0x0;
              (**(code **)(local_48 + -0x7fc8))(unaff_s1,0xb);
              (**(code **)(local_48 + -0x742c))(unaff_s1);
              (**(code **)(local_48 + -0x7f70))(unaff_s2);
              pAStack_88 = pAVar5;
              if (bcont == (BIO **)0x0) {
                pcVar13 = *(code **)(local_48 + -0x55dc);
        ...
        pcVar16 = "asn_mime.c";
        local_50 = 0x1ed;
        (**(code **)(local_48 + -0x6eb0))(0xd,0xd4,0xd5);
...
LAB_0060e648:
  ...
  pBStack_8c = *(BIO **)PTR___stack_chk_guard_006aabf0;
  ...
  pAStack_68 = it;
  uVar4 = (*(code *)PTR_BIO_f_buffer_006a8940)();
  iVar6 = (*(code *)PTR_BIO_new_006a7fa4)(uVar4);
  if (iVar6 == 0) {
    pAVar9 = (ASN1_VALUE *)0x0;
  }
  else {
    uVar4 = (*(code *)PTR_BIO_push_006a85c0)(iVar6,pcVar13);
    if (((uint)pBVar14 & 0x80) == 0) {
      if (((uint)pBVar14 & 1) != 0) {
        (*(code *)PTR_BIO_printf_006a7f38)(uVar4,"Content-Type: text/plain\r\n\r\n");
      }
      pcVar16 = acStack_48e + 2;
LAB_0060ecd4:
      iVar7 = (*(code *)PTR_BIO_gets_006a85d0)(iVar3,pcVar16,0x400);
      if (0 < iVar7) {
        do {
          iVar8 = iVar7 + -1;
...
LAB_0060ed28:
          ...
          (*(code *)PTR_BIO_write_006a7f14)(uVar4,pcVar16,iVar7);
LAB_0060ed4c:
          if (!bVar1) goto LAB_0060ecd4;
LAB_0060ed54:
          (*(code *)PTR_BIO_write_006a7f14)(uVar4,"\r\n",2);
          iVar7 = (*(code *)PTR_BIO_gets_006a85d0)(iVar3,pcVar16,0x400);
          if (iVar7 < 1) break;
        } while( true );
      }
      ...
      while (iVar7 = (*(code *)PTR_BIO_read_006a85bc)(iVar3,acStack_48e + 2,0x400), 0 < iVar7) {
        (*(code *)PTR_BIO_write_006a7f14)(uVar4,acStack_48e + 2,iVar7);
      }
    }
    pcVar16 = (char *)0x0;
    pBVar15 = (BIO *)0x0;
    pAVar5 = (ASN1_VALUE *)&DAT_0000000b;
    (*(code *)PTR_BIO_ctrl_006a7f18)(uVar4);
    (*(code *)PTR_BIO_pop_006a8ab4)(uVar4);
  ...
  if (((uint)pcVar16 & 0x1000) == 0) {
    (*(code *)PTR_ASN1_item_i2d_bio_006a8810)(&_gp,pBVar14,pAVar5);
    ...
    if (out != (BIO *)0x0) {
      ...
      do {
        pBVar15 = (BIO *)(*(code *)PTR_BIO_pop_006a8ab4)(out);
