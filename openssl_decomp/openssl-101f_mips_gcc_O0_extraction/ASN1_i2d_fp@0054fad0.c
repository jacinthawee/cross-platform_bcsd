...

{
  ...
  local_24 = *(code **)PTR___stack_chk_guard_006aabf0;
  ...
  if (iVar6 == 0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(iVar6,0x6a,0,out);
    iVar7 = (*(code *)i2d)(x,0);
    unaff_s6 = "r";
    unaff_s3 = (*(code *)PTR_CRYPTO_malloc_006a8108)(iVar7,"a_i2d_fp.c",0x5b);
    if (unaff_s3 == 0) {
      iVar11 = 0x41;
      ...
      while( true ) {
        ...
        iVar11 = iVar7;
        iVar8 = (*(code *)PTR_BIO_write_006a7f14)(iVar6,puStack_9c,iVar7);
...
LAB_0054fbe4:
  ...
  pAStack_6c = *(ASN1_ITEM **)PTR___stack_chk_guard_006aabf0;
  puStack_64 = i2d;
  iStack_60 = unaff_s2;
  iStack_5c = unaff_s3;
  pvStack_54 = x;
  ...
  iVar6 = (*(code *)PTR_CRYPTO_malloc_006a8108)(pAStack_a8,"a_i2d_fp.c",0x5b);
  if (iVar6 == 0) {
    ...
    while( true ) {
      ...
      pAVar18 = pAStack_a8;
      pAVar9 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(puStack_9c,pcVar16);
...
LAB_0054fd84:
  ...
  if (iVar6 == 0) {
    ...
    (*(code *)PTR_BIO_ctrl_006a7f18)(iVar6,0x6a,0,pcVar16);
    ...
    if (puStack_b0 == (uchar *)0x0) {
      ...
      while( true ) {
        ...
        pAVar18 = pAVar9;
        pAVar10 = (ASN1_VALUE *)(*(code *)PTR_BIO_write_006a7f14)(iVar6);
      ...
      iStack_124 = 1;
LAB_0054fef0:
      (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_b0);
    }
    (*(code *)PTR_BIO_free_006a7f70)(iVar6);
    unaff_s2 = iVar6;
  }
  ...
  if (puStack_f0 == (uchar *)0x0) {
    ...
    while( true ) {
      ...
      iVar11 = (*(code *)PTR_BIO_write_006a7f14)(puStack_11c,puVar17,iVar6);
    ...
    iVar6 = 1;
LAB_00550050:
    (*(code *)PTR_CRYPTO_free_006a7f88)(puStack_f0);
    iStack_124 = iVar6;
  }
  ...
  if (*piVar14 < 5) {
    ...
    puVar12 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(5,"a_enum.c",0x51);
...
LAB_005501c8:
        ...
        iVar6 = 0;
        if (puVar17 != (uchar *)0x0) goto LAB_0055018c;
      }
LAB_005501f0:
      iVar11 = 1;
      *piVar14 = iVar6;
