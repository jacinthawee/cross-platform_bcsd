...

{
  ...
  if (local_2c == 0) goto LAB_00483ca8;
  iVar31 = (*(code *)PTR_SSL_version_006a88d8)(param_1);
  if ((iVar31 == 0xfeff) || (iVar31 = (*(code *)PTR_SSL_version_006a88d8)(param_1), iVar31 == 0x100)
     ) {
    uVar35 = param_1[0x16];
...
LAB_004840a0:
    local_30 = pbVar40;
    (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x92,0x10a,"s3_clnt.c",0x364);
    local_28 = 0x46;
    *param_1 = *param_1 & 0xff00 | (uint)local_30[1];
    goto LAB_004840ec;
  }
  uVar32 = *param_1 & 0xff;
  if (pbVar40[1] != uVar32) goto LAB_004840a0;
  local_30 = pbVar40 + 0x23;
  ...
  *(uint *)(uVar35 + 0xbc) =
  ...
  if (((int)*param_1 < 0x301) || (pcVar41 = (code *)param_1[0x5a], pcVar41 == (code *)0x0)) {
    uVar38 = param_1[0x30];
    if (uVar36 != 0) goto LAB_00483e4c;
LAB_00483e58:
    iVar31 = *(int *)(uVar38 + 0x44);
    param_1[0x1b] = 0;
    if (iVar31 != 0) {
LAB_00484080:
      iVar31 = (*(code *)PTR_ssl_get_new_session_006a904c)(param_1,0);
      if (iVar31 == 0) goto LAB_00484264;
      uVar38 = param_1[0x30];
    }
    pbVar34 = local_30;
    puVar29 = PTR_memcpy_006aabf4;
    *(uint *)(uVar38 + 0x44) = uVar36;
    (*(code *)puVar29)(uVar38 + 0x48,local_30,uVar36);
  }
  else {
    uVar39 = param_1[0x30];
    uVar38 = param_1[0x5b];
    local_28 = 0;
    *(undefined4 *)(uVar39 + 0x10) = 0x30;
    iVar31 = (*pcVar41)(param_1,uVar39 + 0x14,uVar39 + 0x10,0,&local_28,uVar38);
    uVar39 = param_1[0x30];
    uVar38 = uVar39;
    if (iVar31 != 0) {
      if (local_28 == 0) {
        uVar37 = (**(code **)(param_1[2] + 0x48))(local_30 + uVar36);
        uVar38 = param_1[0x30];
    ...
    if (uVar36 == 0) goto LAB_00483e58;
LAB_00483e4c:
    pbVar34 = local_30;
    if (uVar36 != *(uint *)(uVar38 + 0x44)) goto LAB_00483e58;
    iVar31 = (*(code *)PTR_memcmp_006aabd8)(local_30,uVar38 + 0x48,uVar36);
    if (iVar31 != 0) {
      param_1[0x1b] = 0;
      goto LAB_00484080;
    }
    if ((param_1[0x27] != *(uint *)(uVar38 + 0x68)) ||
       (iVar31 = (*(code *)PTR_memcmp_006aabd8)(uVar38 + 0x6c,param_1 + 0x28), iVar31 != 0)) {
      uVar37 = 0x110;
      uVar42 = 0x393;
      local_28 = 0x2f;
      goto LAB_00484024;
  ...
  local_30 = pbVar34 + uVar36;
  iVar31 = (**(code **)(param_1[2] + 0x48))(local_30);
  if (iVar31 == 0) {
    uVar37 = 0xf8;
    uVar42 = 0x3ae;
    local_28 = 0x2f;
  ...
  local_30 = local_30 + iVar33;
  uVar37 = (*(code *)PTR_ssl_get_ciphers_by_id_006a9198)(param_1);
  iVar33 = (*(code *)PTR_sk_find_006a906c)(uVar37,iVar31);
  if (iVar33 < 0) {
    uVar37 = 0x105;
    uVar42 = 0x3c1;
    local_28 = 0x2f;
...
LAB_00484264:
  ...
  if (bVar1 != 0) {
    ...
    iVar31 = (*(code *)PTR_ssl3_comp_find_006a919c)(*(undefined4 *)(param_1[0x39] + 0x98));
    if (iVar31 == 0) goto LAB_004843a0;
  }
  uVar36 = *param_1;
  *(int *)(param_1[0x16] + 0x38c) = iVar31;
  if (0x2ff < (int)uVar36) {
    iVar31 = ssl_parse_serverhello_tlsext(param_1,&local_30,pbVar40,iVar30,&local_28);
    if (iVar31 == 0) {
      (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x92,0xe3,"s3_clnt.c",0x418);
      goto LAB_004840ec;
    }
    iVar31 = ssl_check_serverhello_tlsext(param_1);
    if (iVar31 < 1) {
      (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x92,0x113,"s3_clnt.c",0x41d);
      iVar30 = -1;
      goto LAB_00483ca8;
    }
  }
...
LAB_004843a0:
    ...
    local_28 = 0x2f;
LAB_00484024:
    (*(code *)PTR_ERR_put_error_006a9030)(0x14,0x92,uVar37,"s3_clnt.c",uVar42);
LAB_004840ec:
    ssl3_send_alert(param_1,2,local_28);
    iVar30 = -1;
  }
  return iVar30;
}
