...

{
  ...
  uVar2 = (uint)ASN1_UTCTIME_it[0];
  if (ASN1_UTCTIME_it._16_4_ == 0) {
    if (uVar2 < 7) {
                    /* WARNING: Could not recover jumptable at 0x00565630. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      pAVar3 = (ASN1_UTCTIME *)(*(code *)(&switchD_00565630::switchdataD_0066aba0)[uVar2])();
      return pAVar3;
    }
  }
  else if (uVar2 < 7) {
                    ...
                    /* WARNING: Treating indirect jump as call */
    pAVar3 = (ASN1_UTCTIME *)(*(code *)(&switchD_005651a0::switchdataD_0066ab84)[uVar2])();
    return pAVar3;
  }
  ...
  return *(ASN1_UTCTIME **)(in[1] + *piVar1);
}
