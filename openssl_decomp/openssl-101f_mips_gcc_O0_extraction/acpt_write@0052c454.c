...
int acpt_write(BIO *param_1,void *param_2,BIO *param_3,char *param_4)
...
LAB_0052c788:
    ...
    if ((((BIO *)piVar5[7] != (BIO *)0x0) &&
       ...
       (pBVar2 = BIO_push(param_1,b), pBVar4 = b, pBVar2 == (BIO *)0x0)) goto LAB_0052c788;
    *piVar5 = 3;
  } while( true );
}
