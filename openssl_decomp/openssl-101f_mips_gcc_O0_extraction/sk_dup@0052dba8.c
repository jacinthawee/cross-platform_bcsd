...

{
  ...
  p_Var6 = st->comp;
  p_Var2 = (_STACK *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x14,"stack.c",0x7d);
  if (p_Var2 != (_STACK *)0x0) {
    ppcVar3 = (char **)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x10,"stack.c",0x7f);
    p_Var2->data = ppcVar3;
    if (ppcVar3 != (char **)0x0) {
      *ppcVar3 = (char *)0x0;
      ...
      p_Var2->num_alloc = 4;
      p_Var2->sorted = 0;
      ppcVar3 = (char **)(*(code *)puVar1)(p_Var2->data,st->num_alloc << 2,"stack.c",99);
