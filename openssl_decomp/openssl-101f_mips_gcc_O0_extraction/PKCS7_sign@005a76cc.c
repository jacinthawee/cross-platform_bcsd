...

{
  ...
  p7 = PKCS7_new();
  if (p7 == (PKCS7 *)0x0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0x21,0x74,0x41,"pk7_smime.c",0x4c);
    return (PKCS7 *)0x0;
  }
  ...
  if ((iVar1 != 0) && (iVar1 = PKCS7_content_new(p7,0x15), iVar1 != 0)) {
    if ((pkey == (EVP_PKEY *)0x0) ||
      ...
      if ((flags & 2U) == 0) {
        iVar1 = 0;
        do {
          iVar3 = (*(code *)PTR_sk_num_006a7f2c)(certs);
          if (iVar3 <= iVar1) goto LAB_005a77d8;
          x509 = (X509 *)(*(code *)PTR_sk_value_006a7f24)(certs,iVar1);
...
LAB_005a77d8:
      ...
      (*(code *)PTR_ERR_put_error_006a9030)(0x21,0x74,0x99,"pk7_smime.c",0x58);
    }
  }
  PKCS7_free(p7);
  return (PKCS7 *)0x0;
