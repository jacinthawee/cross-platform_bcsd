...

{
  ...
  if (param_3[1] == (int *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0062693c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar6 = (*(code *)PTR_BN_set_word_006a8820)(param_1,1);
    return uVar6;
  }
  if ((param_3[1] == (int *)0x1) && (**param_3 == 1)) {
    iVar5 = (*(code *)PTR_BN_copy_006a9570)();
    return (uint)(iVar5 != 0);
  }
...
LAB_006268ac:
    ...
    if (*param_4 == 0) {
      ...
      if (param_2 != piVar1) {
        iVar5 = param_2[1];
        if (piVar1[2] < iVar5) {
          iVar5 = (*(code *)PTR_bn_expand2_006a9680)(piVar1);
          if (iVar5 == 0) goto LAB_006268ac;
          if (0 < param_2[1]) goto LAB_00626868;
          piVar1[1] = param_2[1];
        }
        else {
          if (0 < iVar5) {
LAB_00626868:
    ...
    iVar5 = (*(code *)PTR_BN_num_bits_006a82f4)(param_3);
    iVar5 = iVar5 + -2;
    if (-1 < iVar5) {
      do {
        while( true ) {
          ...
          iVar7 = iVar5 + -1;
          if (iVar3 == 0) goto LAB_006268ac;
          iVar3 = (*(code *)PTR_BN_is_bit_set_006a9650)(param_3,iVar5);
          iVar5 = iVar7;
          if (iVar3 != 0) break;
          if (iVar7 == -1) goto LAB_006269bc;
        }
...
LAB_006269bc:
    iVar5 = (*(code *)PTR_BN_copy_006a9570)(param_1,piVar1);
    uVar6 = (uint)(iVar5 != 0);
  }
