  ...
  if (local_2c != *(int *)puVar2) {
    ...
    for (iVar6 = 0; iVar7 = (*(code *)PTR_sk_num_006a7f2c)(iVar11), iVar6 < iVar7; iVar6 = iVar6 + 1
      ...
      (*(code *)PTR_BIO_printf_006a7f38)
                (puVar9,&DAT_0066df84,(undefined *)((int)&pBVar10->method + 2),"");
      pGVar5 = *ppGVar8;
      if (pGVar5->type == 7) {
        psVar14 = ((pGVar5->d).directoryName)->entries;
        pBVar12 = ((pGVar5->d).directoryName)->bytes;
        (*(code *)PTR_BIO_puts_006a8058)(puVar9,&DAT_0066f580);
        if (psVar14 == (stack_st_X509_NAME_ENTRY *)0x8) {
          ...
          while( true ) {
            while( true ) {
              ...
              (*(code *)PTR_BIO_printf_006a7f38)(puVar9,&DAT_0066ecb4,*(undefined2 *)psVar1);
              if (iVar7 != 7) break;
              iVar7 = 8;
              iVar13 = iVar13 + 1;
