...

{
  ...
  if (local_20 == (uchar *)0x0) {
    ...
    while( true ) {
      ...
      iVar6 = (*(code *)PTR_BIO_write_006a7f14)(out,puVar12,iVar5);
...
LAB_00550050:
  ...
  if (*piVar9 < 5) {
    ...
    puVar7 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(5,"a_enum.c",0x51);
    piVar9[2] = (int)puVar7;
...
LAB_005501c8:
        ...
        iVar5 = 0;
        if (puVar12 != (uchar *)0x0) goto LAB_0055018c;
      }
LAB_005501f0:
      iVar6 = 1;
      *piVar9 = iVar5;
