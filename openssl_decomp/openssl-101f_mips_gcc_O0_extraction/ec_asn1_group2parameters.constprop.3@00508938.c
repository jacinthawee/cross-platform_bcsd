...
LAB_00508dc8:
    ...
    if (bVar1) {
      ...
      unaff_s6 = (BIGNUM *)(*(code *)PTR_CRYPTO_malloc_006a8108)(puVar11,unaff_s4 + 0x738c,0x279);
      puVar16 = puVar4;
      local_44 = puVar11;
      if (unaff_s6 == (BIGNUM *)0x0) {
        (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0x41,unaff_s4 + 0x738c,0x27b);
        goto LAB_00508af0;
      }
      sVar12 = EC_POINT_point2oct(param_1,(EC_POINT *)unaff_s7,form,(uchar *)unaff_s6,
                                  (size_t)puVar11,(BN_CTX *)0x0);
      if (sVar12 == 0) {
        (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0x10,unaff_s4 + 0x738c,0x280);
        goto LAB_00508af0;
      }
      iVar6 = puVar4[3];
      if (iVar6 == 0) {
        ...
        puVar4[3] = iVar6;
        if (iVar6 == 0) {
          (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0x41,unaff_s4 + 0x738c,0x285);
          goto LAB_00508af0;
        }
      }
      iVar6 = (*(code *)PTR_ASN1_OCTET_STRING_set_006a9790)(iVar6,unaff_s6,puVar11);
      if (iVar6 == 0) {
        (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0xd,unaff_s4 + 0x738c,0x28a);
        goto LAB_00508af0;
      }
      iVar6 = EC_GROUP_get_order(param_1,a,(BN_CTX *)0x0);
      if (iVar6 == 0) {
        (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0x10,unaff_s4 + 0x738c,0x291);
        goto LAB_00508af0;
      }
      iVar6 = (*(code *)PTR_BN_to_ASN1_INTEGER_006a81f4)(a,puVar4[4]);
      puVar4[4] = iVar6;
      if (iVar6 == 0) {
        (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0xd,unaff_s4 + 0x738c,0x297);
        goto LAB_00508af0;
      }
      ...
      if (iVar6 != 0) {
        ...
        puVar4[5] = iVar6;
        if (iVar6 == 0) {
          (*(code *)PTR_ERR_put_error_006a9030)(0x10,0x9b,0xd,unaff_s4 + 0x738c,0x2a1);
          goto LAB_00508af0;
        }
      }
      BN_free(a);
