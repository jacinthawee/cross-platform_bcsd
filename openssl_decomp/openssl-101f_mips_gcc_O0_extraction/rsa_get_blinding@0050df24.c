...

{
  ...
  (*(code *)PTR_CRYPTO_lock_006a926c)(5,9,&DAT_006675b8,0x105);
  pBVar11 = param_1->blinding;
  if (pBVar11 == (BN_BLINDING *)0x0) {
    (*(code *)PTR_CRYPTO_lock_006a926c)(6,9,&DAT_006675b8,0x109);
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,9,&DAT_006675b8,0x10a);
    pBVar11 = param_1->blinding;
    if (pBVar11 != (BN_BLINDING *)0x0) {
      bVar1 = true;
      goto LAB_0050dfa0;
...
LAB_0050dfa0:
    ...
    if (iVar4 == 0) {
      ...
      *param_2 = 0;
      if (pBVar11 == (BN_BLINDING *)0x0) {
        if (!bVar1) {
          (*(code *)PTR_CRYPTO_lock_006a926c)(6,9,&DAT_006675b8,0x12a);
          (*(code *)PTR_CRYPTO_lock_006a926c)(9,9,&DAT_006675b8,299);
          pBVar11 = param_1->mt_blinding;
  ...
  if (0x4000 < iVar5) {
    ...
    uVar3 = 0x284;
LAB_0050e358:
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x67,uVar10,&DAT_006675b8,uVar3);
  ...
  iVar5 = iVar5 >> 3;
  to = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar5,&DAT_006675b8,0x29d);
  if (((ret == (BIGNUM *)0x0) || (a == (BIGNUM *)0x0)) || (to == (uchar *)0x0)) {
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x67,0x41,&DAT_006675b8,0x2a0);
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    if (to == (uchar *)0x0) {
      return (BN_BLINDING *)0xffffffff;
