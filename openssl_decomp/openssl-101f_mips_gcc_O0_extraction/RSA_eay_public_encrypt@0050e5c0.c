...

{
  ...
  if (0x4000 < iVar1) {
    ...
    uVar4 = 0xa3;
LAB_0050e7f8:
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x68,uVar7,&DAT_006675b8,uVar4);
    return -1;
  }
  ...
  iVar1 = iVar1 >> 3;
  to = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar1,&DAT_006675b8,0xbc);
  if (((ret == (BIGNUM *)0x0) || (a == (BIGNUM *)0x0)) || (to == (uchar *)0x0)) {
    iVar2 = -1;
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x68,0x41,&DAT_006675b8,0xbf);
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    if (to == (uchar *)0x0) {
      return -1;
  ...
  pcVar8 = (code *)PTR_RSA_padding_add_SSLv23_006a9814;
  if (param_5 == 2) {
LAB_0050e8dc:
...
LAB_0050e748:
    ...
    if ((((*(uint *)(param_4 + 0x3c) & 2) != 0) &&
       ...
       (iVar2 = (**(code **)(*(int *)(param_4 + 8) + 0x18))
                          (a,ret,*(undefined4 *)(param_4 + 0x14),*(undefined4 *)(param_4 + 0x10),ctx
                           ,*(undefined4 *)(param_4 + 0x40)), iVar2 == 0)) goto LAB_0050e7a4;
    iVar6 = BN_num_bits(a);
    iVar2 = iVar6 + 7;
    if (iVar6 + 7 < 0) {
      iVar2 = iVar6 + 0xe;
    ...
    iVar2 = iVar1;
    if (0 < iVar1 - iVar6) {
      (*(code *)PTR_memset_006aab00)(param_3,0);
    }
  }
  else {
    if (2 < param_5) {
      pcVar8 = (code *)PTR_RSA_padding_add_none_006a9818;
      if (param_5 == 3) goto LAB_0050e8dc;
      if (param_5 != 4) goto LAB_0050e910;
      iVar2 = RSA_padding_add_PKCS1_OAEP(to,iVar1,param_2,param_1,(uchar *)0x0,0);
      goto LAB_0050e748;
    }
    pcVar8 = (code *)PTR_RSA_padding_add_PKCS1_type_2_006a9820;
    if (param_5 == 1) goto LAB_0050e8dc;
LAB_0050e910:
    uVar7 = 0x76;
    uVar4 = 0xd4;
LAB_0050e794:
