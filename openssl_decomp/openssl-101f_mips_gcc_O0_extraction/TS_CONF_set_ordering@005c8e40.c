...
undefined4 TS_CONF_set_ordering(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  char *pcVar1;
  
  pcVar1 = (char *)(*(code *)PTR_NCONF_get_string_006a7fa8)(param_1,param_2,"ordering");
  if (pcVar1 == (char *)0x0) {
    return 1;
  }
  if (*pcVar1 == 'y') {
