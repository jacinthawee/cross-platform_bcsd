...

{
  ...
  if (pk->type == 0x74) {
    ...
    unaff_s2 = (undefined *)(*(code *)PTR_BN_num_bits_006a82f4)(unaff_s0->engine);
    if ((((((uint)unaff_s2 & 7) != 0) ||
         (iVar14 = (*(code *)PTR_BN_num_bits_006a82f4)(unaff_s0->n), iVar14 != 0xa0)) ||
        (iVar14 = (*(code *)PTR_BN_num_bits_006a82f4)(unaff_s0->e), (int)unaff_s2 < iVar14)) ||
       (iVar14 = (*(code *)PTR_BN_num_bits_006a82f4)(unaff_s0->p), 0xa0 < iVar14)) {
      in_a2 = (rsa_st *)0x7e;
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x82,0x7e,FUN_0066ce4c,0x23c);
      goto LAB_0057782c;
    }
    local_30 = 0x32535344;
    if (unaff_s2 == (undefined *)0x0) goto LAB_0057782c;
    ...
    if (pk->type != 6) goto LAB_00577790;
  ...
  in_a2 = (rsa_st *)0x1ff;
  unaff_s0 = (rsa_st *)(*(code *)PTR_CRYPTO_malloc_006a8108)(prVar3,FUN_0066ce4c);
  unaff_s1 = prVar3;
  if (unaff_s0 == (rsa_st *)0x0) goto LAB_0057782c;
  ...
  *(char *)((int)&unaff_s0->meth + 3) = (char)((uint)local_30 >> 0x18);
  if (unaff_s6 == (rsa_st *)0x2200) {
    prVar15 = (pk->pkey).rsa;
    iVar4 = (*(code *)PTR_BN_num_bits_006a82f4)(prVar15->engine);
    ...
    iVar14 = iVar14 >> 3;
    iVar12 = (*(code *)PTR_BN_num_bits_006a82f4)(pEVar10);
    iVar13 = iVar12 + 7;
    iVar4 = iVar12 + 0xe;
    if (-1 < iVar13) {
      iVar4 = iVar13;
    }
    (*(code *)PTR_BN_bn2bin_006a8300)(pEVar10,ppBVar16);
    iVar4 = iVar4 >> 3;
    iVar12 = iVar12 + 0x16;
    if (-1 < iVar13) {
      iVar12 = iVar13;
    ...
    if ((0 < iVar14) && (0 < iVar14 - iVar4)) {
      ...
      (*(code *)PTR_memset_006aab00)(puVar17,0);
    }
    pBVar11 = prVar15->n;
    iVar12 = (*(code *)PTR_BN_num_bits_006a82f4)(pBVar11);
    iVar13 = iVar12 + 7;
    iVar4 = iVar12 + 0xe;
    if (-1 < iVar13) {
      iVar4 = iVar13;
    }
    (*(code *)PTR_BN_bn2bin_006a8300)(pBVar11,puVar18);
    iVar4 = iVar4 >> 3;
    iVar12 = iVar12 + 0x16;
    if (-1 < iVar13) {
      iVar12 = iVar13;
    ...
    if (0 < 0x14 - iVar4) {
      ...
      (*(code *)PTR_memset_006aab00)(puVar18,0);
    }
    pBVar11 = prVar15->e;
    iVar13 = (*(code *)PTR_BN_num_bits_006a82f4)(pBVar11);
    iVar12 = iVar13 + 7;
    iVar4 = iVar13 + 0xe;
    if (-1 < iVar12) {
      iVar4 = iVar12;
    ...
    iVar4 = iVar4 >> 3;
    (*(code *)PTR_BN_bn2bin_006a8300)(pBVar11,puVar17);
    if (-1 >= iVar12) {
      iVar12 = iVar13 + 0x16;
    }
    if (0 < iVar12 >> 4) {
    ...
    if ((0 < iVar14) && (0 < iVar14 - iVar4)) {
      ...
      (*(code *)PTR_memset_006aab00)(prVar19,0);
    }
    pBVar11 = prVar15->p;
    iVar14 = (*(code *)PTR_BN_num_bits_006a82f4)(pBVar11);
    ...
    (*(code *)PTR_BN_bn2bin_006a8300)(pBVar11,unaff_s7);
    if (-1 >= (int)prVar15) {
      prVar15 = unaff_s6;
    }
    ...
    (*(code *)PTR_memset_006aab00)(unaff_s2,0xff);
    prVar15 = unaff_s0;
    goto LAB_00577758;
  }
  unaff_s6 = (pk->pkey).rsa;
  iVar4 = (*(code *)PTR_BN_num_bits_006a82f4)(unaff_s6->n);
  iVar14 = iVar4 + 7;
  if (iVar4 + 7 < 0) {
    iVar14 = iVar4 + 0xe;
  }
  pk = (EVP_PKEY *)(iVar14 >> 3);
  iVar14 = (*(code *)PTR_BN_num_bits_006a82f4)(unaff_s6->n);
  pBVar11 = unaff_s6->e;
  unaff_s2 = (undefined *)(iVar14 + 0xf >> 4);
  iVar4 = (*(code *)PTR_BN_num_bits_006a82f4)(pBVar11);
  iVar12 = iVar4 + 7;
  iVar14 = iVar4 + 0xe;
  if (-1 < iVar12) {
    iVar14 = iVar12;
  ...
  iVar14 = iVar14 >> 3;
  (*(code *)PTR_BN_bn2bin_006a8300)(pBVar11,ppBVar16);
  iVar4 = iVar4 + 0x16;
  if (-1 < iVar12) {
    iVar4 = iVar12;
  }
...
LAB_005775b8:
    ...
    if (0 < iVar14) {
      (*(code *)PTR_memset_006aab00)(puVar18,0,iVar14);
      puVar18 = puVar18 + iVar14;
    }
    pBVar11 = unaff_s6->q;
    iVar4 = (*(code *)PTR_BN_num_bits_006a82f4)(pBVar11);
...
LAB_0057740c:
      ...
      puVar18 = puVar18 + iVar14;
      if ((int)unaff_s2 < 1) goto LAB_00577bcc;
    }
    iVar14 = (int)unaff_s2 - iVar14;
    if (0 < iVar14) {
      (*(code *)PTR_memset_006aab00)(puVar18,0,iVar14);
...
LAB_005774d0:
      ...
      puVar18 = puVar18 + iVar14;
      if ((int)unaff_s2 < 1) goto LAB_00577c44;
    }
    iVar14 = (int)unaff_s2 - iVar14;
    if (0 < iVar14) {
      (*(code *)PTR_memset_006aab00)(puVar18,0,iVar14);
...
LAB_00577594:
  ...
  if (0 < iVar4) {
    (*(code *)PTR_memset_006aab00)(unaff_s7,0,iVar4);
...
LAB_005776a4:
    ...
    if ((0 < (int)pk) && (in_a2 = (rsa_st *)((int)pk - (int)unaff_s6), 0 < (int)in_a2)) {
      (*(code *)PTR_memset_006aab00)((undefined *)((int)&unaff_s6->pad + (int)&unaff_s7->pad),0);
    }
LAB_00577758:
    unaff_s0 = prVar15;
    unaff_s1 = prVar3;
...
LAB_0057782c:
      ...
      in_a2 = prVar3;
      unaff_s0 = (rsa_st *)(*(code *)PTR_BIO_write_006a7f14)(out,prVar15);
      (*(code *)PTR_CRYPTO_free_006a7f88)(prVar15);
      if (unaff_s0 != prVar3) goto LAB_0057782c;
    }
LAB_00577790:
