  ...
  if (iVar1 == 0) {
    ...
    if (param_2 == 0) {
      ...
      if (unaff_s2 == 0) {
        ...
        (*(code *)PTR_ERR_put_error_006a9030)(CSWIFT_lib_error_code,0x6c,0x6b,"e_cswift.c");
LAB_005d219c:
        (*(code *)PTR___sprintf_chk_006aaa40)(puVar4,1,0x14,&DAT_0066fa28);
...
LAB_005d4698:
        ...
        (*(code *)PTR___sprintf_chk_006aaa40)(auStack_7a4,1,0xd,&DAT_0066fa28,iVar7);
        puVar2 = (undefined4 *)0xffffffff;
