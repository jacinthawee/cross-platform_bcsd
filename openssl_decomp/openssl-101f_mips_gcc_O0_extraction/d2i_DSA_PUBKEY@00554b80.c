...

{
  ...
  local_24 = *(dsa_st **)PTR___stack_chk_guard_006aabf0;
  val = (undefined4 *)
...
LAB_00554c28:
      ...
      if (pEVar7 != (EVP_PKEY *)0x0) {
        pDVar3 = EVP_PKEY_get1_DSA(pEVar7);
        EVP_PKEY_free(pEVar7);
        if (pDVar3 != (dsa_st *)0x0) {
          *pp = local_28;
          if (a != (DSA **)0x0) {
            (*(code *)PTR_DSA_free_006a862c)(*a);
            *a = pDVar3;
          }
          goto LAB_00554c8c;
        }
...
LAB_00554c8c:
  ...
  pEVar7 = EVP_PKEY_new();
  if (pEVar7 == (EVP_PKEY *)0x0) {
    (*(code *)PTR_ERR_put_error_006a9030)(0xd,0xa1,0x41,"x_pubkey.c",0x12f);
    return (DSA *)0x0;
  }
  EVP_PKEY_set1_DSA(pEVar7,key);
  ...
  if (val_00 != (ASN1_VALUE *)0x0) {
    if (pEVar7->ameth == (EVP_PKEY_ASN1_METHOD *)0x0) {
      ...
      if (pcVar8 == (code *)0x0) {
        ...
        if (iVar4 != 0) {
          pDVar3 = (DSA *)ASN1_item_i2d(val_00,(uchar **)in,(ASN1_ITEM *)X509_PUBKEY_it);
