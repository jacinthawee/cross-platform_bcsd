...

{
  ...
  iVar4 = 0;
  if ((param_6 == 0) &&
     (param_6 = (*(code *)PTR_BN_CTX_new_006a8a38)(), iVar4 = param_6, param_6 == 0)) {
    return 0;
  }
  if (param_3 == 0) {
LAB_0062de74:
    if (param_4 != 0) {
      iVar5 = param_2 + 0x18;
      iVar1 = (*(code *)PTR_BN_nnmod_006a9664)(iVar5,param_4,param_1 + 0x12,param_6);
      if ((iVar1 == 0) ||
    ...
    if (param_5 == 0) {
      uVar3 = 1;
      goto joined_r0x0062df18;
    }
    iVar5 = param_2 + 0x2c;
    iVar1 = (*(code *)PTR_BN_nnmod_006a9664)(iVar5,param_5,param_1 + 0x12,param_6);
    if (iVar1 != 0) {
      if (((*(int *)(param_2 + 0x30) == 1) && (**(int **)(param_2 + 0x2c) == 1)) &&
        ...
        if (pcVar2 != (code *)0x0) {
          ...
          if (pcVar6 == (code *)0x0) goto LAB_0062df74;
          iVar1 = (*pcVar6)(param_1,iVar5,param_6);
          if (iVar1 == 0) goto LAB_0062de34;
        }
...
LAB_0062df74:
    ...
    iVar5 = param_2 + 4;
    iVar1 = (*(code *)PTR_BN_nnmod_006a9664)(iVar5,param_3,param_1 + 0x12,param_6);
    if ((iVar1 != 0) &&
       ((*(code **)(*param_1 + 0x90) == (code *)0x0 ||
        (iVar1 = (**(code **)(*param_1 + 0x90))(param_1,iVar5,iVar5,param_6), iVar1 != 0))))
    goto LAB_0062de74;
