...
LAB_00567df0:
          ...
          *(char **)((int)register0x00000074 + -0x214) = "r";
          ...
          *(int *)((int)register0x00000074 + -0x1fc) = iVar4;
          if (iVar4 == 0) {
            ...
            iVar4 = *(int *)((int)register0x00000074 + -0x214) + -0x5248;
            uVar2 = 0xae;
LAB_00567d58:
            ...
            *(int *)(iVar8 + 8) = iVar4;
            ...
            iVar4 = (**(code **)(*(int *)((int)register0x00000074 + -0x220) + -0x7dd8))
                               ...
                               *(int *)((int)register0x00000074 + -0x214) + -0x5248,0xb6);
            *(int *)((int)register0x00000074 + -0x1fc) = iVar4;
            if (iVar4 == 0) {
              puVar10 = &DAT_00000041;
              pcVar13 = *(code **)(*(int *)((int)register0x00000074 + -0x220) + -0x6eb0);
            ...
            *(cb **)((int)register0x00000074 + -0x204) = cb;
            if (*(int *)((int)register0x00000074 + 0xc) != 0) {
              ...
              *(undefined4 *)((int)register0x00000074 + -0x11c) = s_SGCKEYSALT_0066adc4._0_4_;
              *(undefined4 *)((int)register0x00000074 + -0x118) = s_SGCKEYSALT_0066adc4._4_4_;
              *(undefined2 *)((int)register0x00000074 + -0x114) = s_SGCKEYSALT_0066adc4._8_2_;
            }
