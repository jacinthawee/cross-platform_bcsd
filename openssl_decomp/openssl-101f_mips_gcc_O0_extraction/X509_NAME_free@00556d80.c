...

{
  ...
  pBStack_2c = *(BUF_MEM **)PTR___stack_chk_guard_006aabf0;
  pXVar5 = a;
  pXStack_34 = a;
  if (uVar3 == 0) {
    ...
    puVar6 = (undefined1 *)X509_NAME_it._16_4_;
    if (a == (X509_NAME *)0x0) goto switchD_0055fb90_caseD_0;
    if (X509_NAME_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
...
switchD_0055fb90_caseD_0:
  ...
  (*(code *)PTR_memcmp_006aabd8)(pXVar5->entries,*(undefined4 *)puVar6,iVar7,in_a3,&_gp);
  return;
}
