...

{
  ...
  if (param_1 == (lhash_st_CONF_VALUE *)0x0) {
    ...
    pcVar4 = param_2;
    if (pBVar2 == (BIO *)0x0) {
      pcStack_40 = (char *)0x14b;
      pcVar4 = &DAT_0000006d;
      (**(code **)(puStack_38 + -0x6eb0))(0xe,0x6d,0x6a,"conf_lib.c");
      pBVar2 = (BIO *)0x0;
    }
  }
  else {
    ...
    unaff_s3 = param_2;
    if (pBVar2 == (BIO *)0x0) {
      pcStack_40 = (char *)0x14f;
      pBStack_2c = pBVar2;
      (**(code **)(puStack_38 + -0x6eb0))(0xe,0x6d,0x6c,"conf_lib.c");
      pcVar4 = "group=";
      pcStack_40 = param_3;
      (**(code **)(puStack_38 + -0x6c7c))(4,"group=",param_2," name=");
      pBVar2 = pBStack_2c;
    }
  }
  ...
  pcStack_90 = unaff_s3;
  pBStack_e4 = (BIO *)(*(code *)PTR_BIO_new_fp_006a835c)(pcVar4,0);
