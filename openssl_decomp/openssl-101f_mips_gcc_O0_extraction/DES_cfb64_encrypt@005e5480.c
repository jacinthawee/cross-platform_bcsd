  ...
  if (length < 0x41) {
    ...
    if (iStack_88 == 0) {
      if (pDVar26 <= pDVar14) {
        ...
        ppDStack_114 = (DES_key_schedule **)(&PTR_LAB_00675504 + (int)pDVar26);
        puStack_110 = &UNK_0067554c + (int)pDVar26 * 4;
      ...
      pDStack_150 = (DES_key_schedule *)(&DAT_006754e0 + (int)pDVar26 * 4);
      puStack_110 = &UNK_00675528 + (int)pDVar26 * 4;
  ...
  if ((undefined *)((int)pDVar29[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_128 == 0) {
      ...
      if (pDStack_24c <= pDVar14) {
        ppcStack_19c = (code **)(&PTR_LAB_00675594 + (int)pDStack_24c);
        ...
        pDStack_248 = (DES_key_schedule *)(&PTR_LAB_006755b8 + (int)pDStack_24c);
      ...
      pDStack_1dc = (DES_key_schedule *)(&switchD_005e64e8::switchdataD_00675570 + (int)pDStack_24c)
      ;
      pDStack_248 = (DES_key_schedule *)(&PTR_LAB_006755dc + (int)pDStack_24c);
