...
switchD_005634b4_caseD_1:
                ...
                if ((local_3c == (ASN1_ITEM *)0x0) &&
                  ...
                  uVar12 = 0x3a;
LAB_00563954:
                  (*(code *)PTR_ERR_put_error_006a9030)(0xd,0x78,uVar12,s_tasn_dec_c_0066ab0c);
                  goto LAB_00563968;
                }
...
LAB_00563d8c:
                    ...
                    (*(code *)PTR_ERR_add_error_data_006a9264)
                              (4,&DAT_0066ab20,(char *)unaff_s7->tcount,", Type=");
                    goto switchD_005634b4_caseD_7;
                  }
                  goto LAB_00563968;
                }
...
LAB_0056397c:
                unaff_s2 = &local_3c;
                (*(code *)PTR_ERR_add_error_data_006a9264)(2,s_Type__0066ab28,unaff_s8->sname);
              default:
...
LAB_005657fc:
              ...
              (*(code *)PTR_ERR_add_error_data_006a9264)
                        (4,&DAT_0066ab20,tt->field_name,", Type=",*(char **)((int)pcVar16 + 0x18));
              goto switchD_00565630_caseD_7;
            }
            goto LAB_0056529c;
          }
...
LAB_005652b4:
  ...
  (*(code *)PTR_ERR_add_error_data_006a9264)(2,s_Type__0066ab28,*(char **)((int)pcVar16 + 0x18));
