...

{
  ...
  if ((param_2 == 0) ||
     (iVar1 = (*(code *)PTR_BN_copy_006a9570)(param_2,param_1 + 0x12), iVar1 != 0)) {
    if (param_3 == 0) {
      if (param_4 == 0) {
        return true;
      }
      ...
      if (*(int *)(iVar1 + 0x94) == 0) {
LAB_0062dd20:
        iVar1 = (*(code *)PTR_BN_copy_006a9570)(param_4,param_1 + 0x22);
        return iVar1 != 0;
      }
      if (param_5 == 0) goto LAB_0062dcc0;
      iVar3 = 0;
LAB_0062dc60:
...
LAB_0062dc80:
      ...
      if (*(code **)(*param_1 + 0x94) == (code *)0x0) {
        iVar1 = (*(code *)PTR_BN_copy_006a9570)(param_3,param_1 + 0x1d);
        if (iVar1 != 0) {
          if (param_4 == 0) {
            return true;
          }
...
LAB_0062dcc0:
      ...
      if (param_5 == 0) goto LAB_0062dcd4;
      iVar3 = param_5;
      if (param_3 == 0) {
        if (param_4 != 0) {
          iVar1 = *param_1;
        ...
        iVar1 = (**(code **)(*param_1 + 0x94))(param_1,param_3,param_1 + 0x1d,param_5);
        if (iVar1 != 0) {
          if (param_4 != 0) goto LAB_0062dc5c;
          bVar2 = true;
          goto LAB_0062dc80;
        }
        bVar2 = false;
