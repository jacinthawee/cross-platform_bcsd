...
LAB_00569024:
    ...
    (*(code *)PTR_ERR_add_error_data_006a9264)(2,&DAT_0066ae7c,param_1);
    uVar5 = 0xffffffff;
    goto LAB_00568fe4;
  }
  uVar5 = uVar6 & 0x10000;
...
LAB_00569194:
  ...
  case 0x10008:
    ...
    if (iVar11 == 0) {
      ...
      iVar11 = (*(code *)PTR_strncmp_006aaa7c)(pcVar10,&DAT_0066ae8c,4);
      if (iVar11 == 0) {
        uVar5 = 1;
        param_3[3] = 2;
      }
      else {
        iVar11 = (*(code *)PTR_strncmp_006aaa7c)(pcVar10,&DAT_0066ae94,3);
        if (iVar11 == 0) {
          uVar5 = 1;
          param_3[3] = 3;
        }
