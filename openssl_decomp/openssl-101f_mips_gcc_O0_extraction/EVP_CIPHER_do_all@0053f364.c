...

{
  ...
  local_14 = arg;
  local_10 = fn;
  (*(code *)PTR_OBJ_NAME_do_all_006a9b94)(2,do_all_cipher_fn,&local_14);
  ...
  (*(code *)PTR_OBJ_NAME_do_all_sorted_006a8640)(2,do_all_cipher_fn,&pcStack_44);
  ...
  (*(code *)PTR_OBJ_NAME_do_all_006a9b94)(1,do_all_md_fn,&pcStack_74);
