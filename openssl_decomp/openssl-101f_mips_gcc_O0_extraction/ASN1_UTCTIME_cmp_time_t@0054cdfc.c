...

{
  ...
  piVar3 = (int *)(*(code *)PTR_OPENSSL_gmtime_006a9dc0)(local_res4,auStack_40);
  pbVar9 = s->data;
...
LAB_0054d038:
  ...
  iVar5 = iVar6 + 3;
  if (iVar11 != 0x2e) goto LAB_0054d1a0;
  if (iVar8 < iVar5) {
    return 0;
  }
