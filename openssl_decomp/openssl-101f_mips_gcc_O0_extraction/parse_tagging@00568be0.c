...
LAB_00569024:
    ...
    (*(code *)PTR_ERR_add_error_data_006a9264)(2,&DAT_0066ae7c,pcVar7);
    uVar5 = 0xffffffff;
    goto LAB_00568fe4;
  }
...
LAB_00569194:
  ...
  case (uchar *)0x10008:
    ...
    if (iVar4 == 0) {
      ...
      iVar4 = (*(code *)PTR_strncmp_006aaa7c)(pcVar14,&DAT_0066ae8c,4);
      if (iVar4 == 0) {
        uVar5 = 1;
        pAVar11->flags = 2;
      }
      else {
        iVar4 = (*(code *)PTR_strncmp_006aaa7c)(pcVar14,&DAT_0066ae94,3);
        if (iVar4 == 0) {
          uVar5 = 1;
          pAVar11->flags = 3;
        }
