...

{
  ...
  do {
    ...
    *(undefined4 *)(local_c8 + -0xa14) = 0;
    (*(code *)puVar8)(10,0x12,local_c0 + -0x6338,0x1d5);
    iVar11 = param_2;
    do {
      iVar6 = 10;
      if (iVar11 < 0xb) {
...
LAB_0060610c:
    ...
    (*(code *)PTR_EVP_DigestUpdate_006a8674)(unaff_s2,local_e0,8);
    (*(code *)PTR_EVP_DigestUpdate_006a8674)(unaff_s2,&local_50,0x14);
    (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x12,local_c0 + -0x6338,0x20c);
    (*(code *)PTR_EVP_DigestUpdate_006a8674)(unaff_s2,md,0x14);
    (*(code *)PTR_EVP_DigestFinal_ex_006a8678)(unaff_s2,md,0);
    (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x12,local_c0 + -0x6338,0x212);
    (*(code *)PTR_EVP_MD_CTX_cleanup_006a7f34)(unaff_s2);
    param_1 = local_c0;
    if (in_f20_21 < *(double *)(local_bc + -0x6290)) {
      if (param_3 == 0) {
...
LAB_006061ac:
    ...
    local_e4 = 0x34;
    puVar8 = local_c0 + -0x6338;
    do {
      if (*(int *)(local_c8 + -0xa14) == 0) {
LAB_0060624c:
        bVar2 = false;
        ...
        iVar4 = (*(code *)PTR_CRYPTO_THREADID_cmp_006a95a0)(local_a4 + -0xa1c,auStack_70);
        bVar2 = iVar4 == 0;
...
LAB_00606300:
      ...
      if (*(double *)(local_cc + -0xa08) < dVar14) {
        entropy = *(double *)(local_cc + -0xa08) + 0.0;
      }
      if (!bVar2) {
    ...
    if (*(double *)(local_bc + -0x6290) <= in_f20_21) {
      *(undefined4 *)(local_a0 + -0xa20) = 1;
    }
  } while( true );
}
