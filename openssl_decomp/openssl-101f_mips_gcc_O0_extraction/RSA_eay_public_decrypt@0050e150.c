...

{
  ...
  if (0x4000 < iVar1) {
    ...
    uVar3 = 0x284;
LAB_0050e358:
    (*(code *)PTR_ERR_put_error_006a9030)(4,0x67,uVar6,&DAT_006675b8,uVar3);
    return -1;
  }
  ...
  iVar1 = iVar1 >> 3;
  to = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a8108)(iVar1,&DAT_006675b8,0x29d);
...
LAB_0050e2b4:
    ...
    if (iVar2 < 0) {
      (*(code *)PTR_ERR_put_error_006a9030)(4,0x67,0x72,&DAT_006675b8,0x2d1);
    }
  }
  BN_CTX_end(ctx);
  BN_CTX_free(ctx);
