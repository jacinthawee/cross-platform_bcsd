  ...
  if (group != (EC_GROUP *)0x0) {
    ...
    *(undefined4 *)(group + 0x44) = 0;
    if (piVar1 != (int *)0x0) {
      ...
      (*(code *)PTR_OPENSSL_cleanse_006a8174)(piVar1,0x44);
      (*(code *)PTR_CRYPTO_free_006a7f88)(piVar1);
    }
    BN_clear_free((BIGNUM *)(group + 8));
    BN_clear_free((BIGNUM *)(group + 0x1c));
    if (*(int *)(group + 0x3c) != 0) {
      (*(code *)PTR_OPENSSL_cleanse_006a8174)(*(int *)(group + 0x3c),*(undefined4 *)(group + 0x40));
      (*(code *)PTR_CRYPTO_free_006a7f88)(*(undefined4 *)(group + 0x3c));
    }
    (*(code *)PTR_OPENSSL_cleanse_006a8174)(group,0xac);
                    /* WARNING: Could not recover jumptable at 0x00503270. Too many branches */
