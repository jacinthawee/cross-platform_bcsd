...

{
  ...
  X509_ATTRIBUTE *pXStack_1f4;
  undefined *puStack_1f0;
  ASN1_VALUE **ppAStack_1ec;
  _union_330 _Stack_1e8;
  X509_ATTRIBUTE **ppXStack_1e4;
  int *piStack_1e0;
  code *pcStack_1dc;
  uchar *puStack_1b4;
  uchar *puStack_1b0;
  ...
  X509_ATTRIBUTE *pXStack_19c;
  char *pcStack_198;
  code *pcStack_194;
  undefined *puStack_180;
  X509_ATTRIBUTE *pXStack_174;
  undefined auStack_16c [8];
  _union_330 _Stack_164;
  undefined *puStack_160;
  int *piStack_15c;
  char *pcStack_158;
  code *pcStack_154;
  undefined *puStack_140;
  X509_ATTRIBUTE *pXStack_134;
  int iStack_12c;
  int iStack_128;
  ASN1_ITEM *pAStack_124;
  X509_ATTRIBUTE *pXStack_120;
  X509_ATTRIBUTE *pXStack_11c;
  undefined *puStack_118;
  code *pcStack_114;
  int iStack_ec;
  int iStack_e8;
  int iStack_e4;
  X509_ATTRIBUTE *pXStack_e0;
  X509_ATTRIBUTE *pXStack_dc;
  X509_ATTRIBUTE *pXStack_d8;
  ...
  int iStack_6c;
  X509_ATTRIBUTE *pXStack_68;
  undefined *puStack_64;
  ASN1_OBJECT *pAStack_1c;
  X509_ATTRIBUTE XStack_18;
  
  pXStack_dc = (X509_ATTRIBUTE *)PTR___stack_chk_guard_006aabf0;
  pAStack_1c = (ASN1_OBJECT *)0x0;
  XStack_18.single = *(int *)PTR___stack_chk_guard_006aabf0;
  if (xa == (X509_ATTRIBUTE *)0x0) {
    ...
    if (pAStack_1c == (ASN1_OBJECT *)0x0) {
      ...
      pXVar5 = (X509_ATTRIBUTE *)0x0;
      unaff_s0 = (X509_ATTRIBUTE *)X509_ATTRIBUTE_it;
    }
    else {
      xa = &XStack_18;
  ...
  if (XStack_18.single == *(int *)pXStack_dc) {
    return pXVar5;
  }
  iStack_d0 = XStack_18.single;
  ...
  if (pAVar6 != (ASN1_OBJECT *)0x0) {
    ...
    ERR_clear_error();
    unaff_s0 = (X509_ATTRIBUTE *)0x0;
    iStack_a8 = 0;
    pXStack_dc = (X509_ATTRIBUTE *)0x0;
    pXVar5 = (X509_ATTRIBUTE *)0x0;
LAB_0054f334:
    pXVar11 = unaff_s0;
    pXVar21 = pXVar5;
    unaff_s3 = pAVar6;
    if ((X509_ATTRIBUTE *)&DAT_00000008 < pXStack_dc) goto LAB_0054f39c;
    while ((unaff_s0 <= &pXVar21->value &&
      ...
      if (iVar4 < 0) {
        if (unaff_s0 == pXVar21) {
          pXStack_11c = (X509_ATTRIBUTE *)0x8e;
          iVar4 = 0xaf;
          goto LAB_0054f554;
        }
      }
      else {
        pXVar5 = (X509_ATTRIBUTE *)((int)&unaff_s0->object + iVar4);
        if (iVar4 != 0) {
          unaff_s0 = (X509_ATTRIBUTE *)(uint)(pXVar5 < unaff_s0);
          pXStack_dc = (X509_ATTRIBUTE *)((int)pXVar5 - (int)pXVar21);
          pXVar11 = pXVar5;
          if (unaff_s0 != (X509_ATTRIBUTE *)0x0) {
            pXStack_11c = (X509_ATTRIBUTE *)0x9b;
            iVar4 = 0xb6;
            goto LAB_0054f554;
          }
        }
...
LAB_0054f39c:
      ...
      ppcVar7 = pAVar6->ln;
      while( true ) {
        pXVar5 = (X509_ATTRIBUTE *)((int)&pXVar21->object + (int)ppcVar7);
        pXStack_19c = (X509_ATTRIBUTE *)(auStack_88 + 8);
        pXStack_11c = (X509_ATTRIBUTE *)auStack_88;
        pcStack_198 = (char *)unaff_s6;
        apXStack_98[0] = pXVar5;
        uStack_8c = ASN1_get_object((uchar **)unaff_s5,(long *)(X509_ATTRIBUTE *)(auStack_88 + 8),
                                    (int *)(X509_ATTRIBUTE *)auStack_88,unaff_s6,(long)pXStack_dc);
        if ((uStack_8c & 0x80) != 0) {
        ...
        pXStack_dc = (X509_ATTRIBUTE *)((int)apXStack_98[0] - (int)pXVar5);
        pXVar21 = (X509_ATTRIBUTE *)((int)pXVar21 + (int)pXStack_dc);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_a8 != 0) && (auStack_88._8_4_ == (char *)0x0)) {
            pXStack_dc = (X509_ATTRIBUTE *)((int)unaff_s0 - (int)pXVar21);
            pXVar5 = pXVar21;
            if ((auStack_88._0_4_ != (ASN1_OBJECT *)0x0) ||
               (iStack_a8 = iStack_a8 + -1, iStack_a8 != 0)) goto LAB_0054f334;
            goto LAB_0054f43c;
          }
          if (auStack_88._8_4_ <= (char *)((int)unaff_s0 - (int)pXVar21)) goto LAB_0054f4cc;
          pXStack_dc = (X509_ATTRIBUTE *)
                       ((int)(X509_ATTRIBUTE *)(auStack_88._8_4_ + (int)pXVar21) - (int)unaff_s0);
          if (((int)pXStack_dc < 0) ||
             ((X509_ATTRIBUTE *)(auStack_88._8_4_ + (int)pXVar21) < unaff_s0)) {
            pXStack_11c = (X509_ATTRIBUTE *)0x9b;
            iVar4 = 0xed;
          }
          else {
            ...
            pXStack_11c = (X509_ATTRIBUTE *)&DAT_00000041;
            iVar4 = 0xf2;
          }
          goto LAB_0054f554;
        }
        ...
        if (pXStack_dc < (X509_ATTRIBUTE *)&DAT_00000009) break;
        ppcVar7 = pAVar6->ln;
      }
    }
    pXStack_11c = (X509_ATTRIBUTE *)&DAT_00000041;
  ...
  pXStack_19c = (X509_ATTRIBUTE *)&DAT_0000006b;
  ERR_put_error(0xd,0x6b,0x41,"a_d2i_fp.c",0x9c);
  pXVar21 = (X509_ATTRIBUTE *)0xffffffff;
LAB_0054f57c:
  ...
  pXVar5 = (X509_ATTRIBUTE *)(*(code *)PTR_BIO_new_006a7fa4)(uVar9);
  if (pXVar5 == (X509_ATTRIBUTE *)0x0) {
    ...
    if ((int)ppAVar10 < 0) {
      ...
      pXVar11 = (X509_ATTRIBUTE *)(*(code *)pXStack_19c)(pcStack_198);
  ...
  if ((int)ppAVar10 < 0) {
    ...
    pXVar5 = (X509_ATTRIBUTE *)(*(code *)piStack_15c)(pcStack_158,piVar17);
    ppAStack_1a4 = ppAVar10;
  }
  if (iStack_12c != 0) {
    pXStack_134 = pXVar5;
  ...
  pXStack_1f4 = (X509_ATTRIBUTE *)auStack_16c;
  puStack_180 = &_gp;
  auStack_16c._0_4_ = (ASN1_OBJECT *)0x0;
  _Stack_164 = *(_union_330 *)PTR___stack_chk_guard_006aabf0;
  ...
  if ((int)ppAVar10 < 0) {
    ...
    pXStack_1f4 = (X509_ATTRIBUTE *)(auStack_16c + 4);
  ...
  if ((ASN1_ITEM *)_Stack_164.ptr == *(ASN1_ITEM **)puStack_1f8) {
    return pXVar5;
  }
  pcStack_194 = ASN1_item_d2i_fp;
  _Stack_1e8 = _Stack_164;
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar5 = (X509_ATTRIBUTE *)ASN1_item_d2i(ppAStack_234,in,iVar4,(ASN1_ITEM *)_Stack_1e8.set);
      iStack_22c = iVar4;
    }
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    pXStack_240 = (X509_ATTRIBUTE *)0x0;
    ...
    if (ppAStack_234 == (ASN1_VALUE **)0x0) {
      ...
      pXStack_240 = (X509_ATTRIBUTE *)0x1;
LAB_0054fbe4:
  ...
  pXStack_280 = (X509_ATTRIBUTE *)(*pcStack_27c)(iVar4,0);
  puVar12 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(pXStack_280,"a_i2d_fp.c",0x5b);
  if (puVar12 == (undefined *)0x0) {
    pXVar5 = (X509_ATTRIBUTE *)&DAT_00000041;
    ...
    while( true ) {
      ...
      pXVar5 = pXStack_280;
      pXVar11 = (X509_ATTRIBUTE *)(*(code *)PTR_BIO_write_006a7f14)(pcStack_274,puVar19);
      ...
      pXStack_280 = (X509_ATTRIBUTE *)((int)pXStack_280 - (int)pXVar11);
    }
    pXVar11 = (X509_ATTRIBUTE *)0x1;
LAB_0054fd84:
  ...
  if (puVar12 == (undefined *)0x0) {
    ...
    pXStack_2fc = (X509_ATTRIBUTE *)0x0;
    ...
    if (puStack_288 == (uchar *)0x0) {
      ...
      pXStack_2fc = (X509_ATTRIBUTE *)0x1;
LAB_0054fef0:
  ...
  if (piStack_304 != (int *)0x0) {
    ...
    if (pbVar18 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar5 = (X509_ATTRIBUTE *)(uint)*pbVar18;
        if (iVar4 != 1) {
          uVar1 = CONCAT11(*pbVar18,pbVar18[1]);
          pXVar5 = (X509_ATTRIBUTE *)(uint)uVar1;
          if (iVar4 != 2) {
            uVar2 = CONCAT21(uVar1,pbVar18[2]);
            pXVar5 = (X509_ATTRIBUTE *)(uint)uVar2;
            if (iVar4 == 4) {
              pXVar5 = (X509_ATTRIBUTE *)CONCAT31(uVar2,pbVar18[3]);
            }
          }
        }
      }
      ...
      return (X509_ATTRIBUTE *)-(int)pXVar5;
    }
  }
  return (X509_ATTRIBUTE *)0x0;
joined_r0x0054f494:
  if (pXStack_dc == (X509_ATTRIBUTE *)0x0) goto LAB_0054f4cc;
  ...
  pXStack_dc = (X509_ATTRIBUTE *)((int)pXStack_dc - iVar4);
  unaff_s0 = (X509_ATTRIBUTE *)((int)&unaff_s0->object + iVar4);
  goto joined_r0x0054f494;
LAB_0054f4cc:
  pXVar5 = (X509_ATTRIBUTE *)((int)&pXVar21->object + (int)auStack_88._8_4_);
  pXVar21 = (X509_ATTRIBUTE *)(uint)(pXVar5 < pXVar21);
  if (pXVar21 != (X509_ATTRIBUTE *)0x0) {
    pXStack_11c = (X509_ATTRIBUTE *)0x9b;
    iVar4 = 0x106;
    goto LAB_0054f554;
  }
  ...
  pXStack_dc = (X509_ATTRIBUTE *)((int)unaff_s0 - (int)pXVar5);
  goto LAB_0054f334;
LAB_0054f43c:
  pcStack_198 = "r";
  if ((int)pXVar21 < 0) {
