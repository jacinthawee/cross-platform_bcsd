  ...
  if (iVar3 == 0x18) {
    if ((((local_44[0] >> 0x10) << 0x18 | (local_44[0] >> 0x18) << 0x10) >> 0x10) +
      ...
      if ((local_38 == 0) || (unaff_s0 != (EVP_PKEY *)0x0)) {
        ...
        unaff_s1 = (**(code **)(local_50 + -0x7dd8))(iVar3,FUN_0066ce4c,0x336);
        if (unaff_s1 == 0) {
          local_58 = (void *)0x339;
          (**(code **)(local_50 + -0x6eb0))(9,0x80,0x41,FUN_0066ce4c);
          pEVar7 = (EVP_PKEY *)0x0;
        }
        else {
          ...
          if (iVar3 == iVar4) {
            ...
            local_58 = (void *)0x33f;
            pEVar7 = (EVP_PKEY *)0x0;
            (**(code **)(local_50 + -0x6eb0))(9,0x80,0x7c,FUN_0066ce4c);
          }
    ...
    (*pcVar9)(9,0x88,uVar6,FUN_0066ce4c);
    pEVar7 = (EVP_PKEY *)0x0;
  }
  else {
    local_58 = (void *)0x32e;
...
LAB_005786d8:
  ...
  if (-1 < (int)pEVar7) {
    ...
    if (pEVar7 == pEVar5) {
      (*(code *)PTR_ERR_put_error_006a9030)(9,0x8a,0x76,FUN_0066ce4c,0x3ae);
      goto LAB_00578864;
    }
  }
...
LAB_00578864:
  ...
  return (EVP_PKEY *)"/usr/local/openssl101fmipso0/private";
}
