...
LAB_00550470:
    ...
    iVar4 = (iVar2 >> 3) + 1;
    if ((iVar2 >> 3) + 4 < a->length) goto LAB_00550470;
  }
  puVar3 = (uchar *)(*(code *)PTR_CRYPTO_realloc_006a8c44)(a->data,iVar4 + 4,"a_enum.c",0x9e);
  if (puVar3 == (uchar *)0x0) {
  ...
  a->data = puVar3;
LAB_00550414:
  iVar2 = (*(code *)PTR_BN_bn2bin_006a8300)(bn,puVar3);
  a->length = iVar2;
  return a;
}
