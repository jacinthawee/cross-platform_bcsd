...

{
  ...
  if (pEVar2 == (EVP_CIPHER *)0x0) {
    ...
    piVar8 = &DAT_00669e90;
    iVar10 = 0x10b;
    ERR_put_error(6,0xa4,0x83,(char *)&DAT_00669e90,0x10b);
    ppiStack_c0 = (int **)0x0;
    ...
    if ((EVP_CIPHER *)&DAT_00000040 < pEStack_c8) {
      (*(code *)PTR_OpenSSLDie_006a8d4c)(&DAT_00669e90,0x10f,"keylen <= sizeof key");
    }
    if ((param_4 == (int *)0x0) || (*param_4 != 0x10)) {
      salt = (int *)0x72;
      piVar8 = &DAT_00669e90;
      iVar10 = 0x115;
      ERR_put_error(6,0xa4,0x72,(char *)&DAT_00669e90,0x115);
      ppiStack_c0 = (int **)0x0;
      iStack_bc = 0;
      param_7 = in_stack_ffffff6c;
    }
...
LAB_00547790:
      piVar8 = &DAT_00669e90;
      ERR_put_error(6,0xa4,(int)salt,(char *)&DAT_00669e90,iVar10);
      iStack_bc = 0;
      param_7 = in_stack_ffffff6c;
    }
  }
LAB_00547628:
  ...
  if (((piVar8 == (int *)0x0) || (*piVar8 != 0x10)) ||
    ...
    iVar9 = 0;
    ERR_put_error(6,0x76,0x72,(char *)&DAT_00669e90,0xcf);
    piVar8 = (int *)0x0;
    goto LAB_0054796c;
  }
  uStack_d0 = puVar4[2];
  ...
  pEVar2 = (EVP_CIPHER *)&DAT_00000076;
  iVar9 = 0;
  ERR_put_error(6,0x76,iVar5,(char *)&DAT_00669e90,iVar10);
LAB_0054796c:
