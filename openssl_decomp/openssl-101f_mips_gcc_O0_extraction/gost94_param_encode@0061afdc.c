...
LAB_0061b1a4:
  ...
  ppuVar7 = &switchD_0061b724::switchdataD_0067b060 + (int)puVar3;
  puVar8 = puStack_138;
  switch(puVar3) {
  default:
...
LAB_0061bd00:
  ...
  if (iVar9 != 0) {
    ...
    if (iVar12 != 0) {
      ...
      if (iVar12 != 0) {
        (*(code *)PTR_BIO_printf_006a7f38)(iVar14,&DAT_0067b044);
        (*(code *)PTR_BN_print_006a8024)(iVar14,uVar13);
        (*(code *)PTR_BIO_printf_006a7f38)(iVar14,"\n");
        (*(code *)PTR_BIO_indent_006a97d0)(iVar14,iVar5 + 3,0x80);
        (*(code *)PTR_BIO_printf_006a7f38)(iVar14,&DAT_0067b048);
