...

{
  ...
  if (crl == (X509_CRL *)0x0) {
    ...
    if (psStack_64 == (stack_st_CONF_VALUE *)0x0) goto LAB_0058a2cc;
LAB_0058a304:
    crl = (X509_CRL *)0x0;
    while( true ) {
      iVar2 = (*(code *)PTR_sk_num_006a7f2c)(psStack_64);
      if (iVar2 <= (int)crl) break;
      iVar2 = (*(code *)PTR_sk_value_006a7f24)(psStack_64,crl);
...
LAB_0058a2cc:
      ...
      if (unaff_s5 == (stack_st_X509_EXTENSION **)0x0) goto LAB_0058a304;
      crl = (X509_CRL *)0x0;
      while( true ) {
        iVar2 = (*(code *)PTR_sk_num_006a7f2c)(psStack_64);
        if (iVar2 <= (int)crl) break;
        ...
        if ((X509V3_CTX *)section == (X509V3_CTX *)0x0) goto LAB_0058a2cc;
        name = (X509V3_CTX *)0xffffffff;
        pXVar6 = (X509V3_CTX *)section;
        X509v3_add_ext(unaff_s5,(X509_EXTENSION *)section,-1);
        crl = (X509_CRL *)((int)&crl->crl + 1);
        (*(code *)PTR_X509_EXTENSION_free_006a8268)(section);
      }
      iVar2 = 1;
    }
  }
  ...
  ppiStack_74 = *(int ***)PTR___stack_chk_guard_006aabf0;
  pXStack_6c = crl;
  ...
  if (req == (X509_CRL *)0x0) {
    ...
    if (psVar3 != (stack_st_CONF_VALUE *)0x0) {
      ...
      (*(code *)PTR_sk_pop_free_006a8158)(psStack_84);
      goto LAB_0058a4bc;
    }
  }
LAB_0058a4b8:
