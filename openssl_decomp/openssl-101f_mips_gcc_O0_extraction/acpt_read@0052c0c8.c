...
int acpt_read(BIO *param_1,void *param_2,BIO *param_3,char *param_4)

{
  ...
  do {
    ...
    while( true ) {
      if (pBVar4 != (BIO *)0x0) {
        iVar1 = BIO_read(pBVar4,param_2,(int)param_3);
        BIO_copy_next_retry(param_1);
        return iVar1;
      }
      iVar1 = *piVar5;
      if (iVar1 == 2) goto LAB_0052c238;
      if (iVar1 == 3) break;
      if (iVar1 != 1) {
        return 0;
      }
...
LAB_0052c238:
    ...
    callback = (callback *)
               BIO_get_callback(param_1,iVar3,(char *)b,(int)param_4,in_stack_ffffffc0,
                                in_stack_ffffffc4);
...
LAB_0052c3fc:
    ...
    if ((((BIO *)piVar5[7] != (BIO *)0x0) &&
       ...
       (pBVar2 = BIO_push(param_1,b), pBVar4 = b, pBVar2 == (BIO *)0x0)) goto LAB_0052c3fc;
    *piVar5 = 3;
  } while( true );
}
