...

{
  ...
  iVar4 = (*(code *)PTR_BIO_gets_006a85d0)(in,oid,0x200);
  if (0 < iVar4) {
    while( true ) {
      acStack_225[iVar4] = '\0';
...
LAB_004c718c:
  ...
  ptr = (undefined4 *)(*(code *)PTR_ASN1_OBJECT_new_006a95cc)();
  ...
  if (piVar5[4] != 0) {
    (*(code *)PTR_memcpy_006aabf4)(ptr_00,piVar5[4],piVar5[3]);
  }
  iVar12 = piVar5[3];
  iVar4 = piVar5[2];
  ptr[1] = 0;
...
LAB_004c73c8:
    ...
    iVar4 = (*(code *)PTR_strlen_006aab30)();
    pvVar6 = CRYPTO_malloc(iVar4 + 1,"obj_lib.c",0x69);
    if (pvVar6 != (void *)0x0) {
      uVar7 = (*(code *)PTR_memcpy_006aabf4)(pvVar6,*piVar5,iVar4 + 1);
      *ptr = uVar7;
      goto LAB_004c73c8;
    }
    (*(code *)PTR_ERR_put_error_006a9030)(8,0x65,0x41,"obj_lib.c",0x72);
    ...
    iVar4 = (*(code *)PTR_strlen_006aab30)();
    ptr_01 = CRYPTO_malloc(iVar4 + 1,"obj_lib.c",0x60);
    if (ptr_01 != (void *)0x0) {
      (*(code *)PTR_memcpy_006aabf4)(ptr_01,piVar5[1],iVar4 + 1);
      ptr[1] = ptr_01;
      goto LAB_004c7378;
    }
    (*(code *)PTR_ERR_put_error_006a9030)(8,0x65,0x41,"obj_lib.c",0x72);
