...

{
  ...
  if (iVar1 == 0) {
    (*(code *)PTR_ERR_put_error_006a9030)(9,0x7f,0x41,FUN_0066ce4c,0x167);
    if (iVar2 == 0) {
      return 0;
    }
LAB_00575820:
    ...
    if (iVar2 != 0) {
      uVar11 = param_2 + 7U >> 3;
      iVar10 = uVar11 - 1;
      puVar3 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(uVar11,FUN_0066ce4c,0x60);
      if (puVar3 != (undefined *)0x0) {
        ...
        *(undefined4 *)(iVar1 + 0xc) = uVar5;
        ...
        if (*(int *)(iVar1 + 0xc) != 0) {
          iVar9 = iVar9 + uVar11;
          puVar3 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a8108)(0x14,FUN_0066ce4c,0x60);
          if (puVar3 != (undefined *)0x0) {
              ...
              if (puVar3 != (undefined *)0x0) {
                ...
                *(undefined4 *)(iVar1 + 0x14) = uVar5;
                ...
                if (*(int *)(iVar1 + 0x14) != 0) {
                  ...
                  if (param_3 == 0) {
                    puVar3 = (undefined *)
                             (*(code *)PTR_CRYPTO_malloc_006a8108)(0x14,FUN_0066ce4c,0x60);
                    if (puVar3 != (undefined *)0x0) {
                      puVar6 = puVar3;
