...

{
  ...
  if ((param_2 & 0x40) == 0) {
    ...
    if ((param_1 != (ASN1_TYPE *)0x0) &&
       ((iVar3 = (*(code *)PTR_BIO_write_006a7f14)(param_1,pcVar4,iVar6), iVar6 != iVar3 ||
        (iVar3 = (*(code *)PTR_BIO_write_006a7f14)(param_1,":",1), iVar3 != 1)))) goto LAB_00550980;
    local_74 = iVar6 + 1;
  }
  if ((param_2 & 0x80) != 0) {
LAB_00550958:
    if (param_1 == (ASN1_TYPE *)0x0) {
      ...
      iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0066a058,1);
      if (iVar9 != 1) goto LAB_00550980;
      if ((param_2 & 0x200) != 0) goto LAB_00551874;
      ...
      if ((byte *)param_3.ptr != pbVar13) {
        do {
          ...
          iVar6 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&local_38,2);
          if (iVar6 != 2) goto LAB_00550980;
          pbVar13 = pbVar13 + 1;
  ...
  if ((param_2 & 0x20) == 0) {
    if ((0x1d < iVar9 - 1U) || (uVar10 = (uint)(char)tag2nbyte[iVar9], uVar10 == 0xffffffff)) {
      if ((param_2 & 0x100) != 0) goto LAB_00550958;
      goto LAB_00550a94;
    }
    if ((param_2 & 0x10) != 0) {
      if (uVar10 == 0) {
...
LAB_00551408:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_00551408;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_005513ec:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_005513ec;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_00551424:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_00551424;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_005513d0:
              ...
              if ((uVar8 & 0x61) == 0) goto LAB_005513d0;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_00551448:
              ...
              if ((uVar7 & 0x61) == 0) goto LAB_005513b4;
LAB_00550d40:
              if ((uVar7 & 8) == 0) {
                local_78 = local_78 + 2;
              }
...
LAB_00551590:
              ...
              uVar8 = uVar7 & (byte)char_type[local_40[1]];
              if ((uVar8 & 0x61) == 0) goto LAB_00551590;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_0055156c:
              ...
              uVar8 = uVar7 & (byte)char_type[local_40[2]];
              if ((uVar8 & 0x61) == 0) goto LAB_0055156c;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_00551548:
              ...
              uVar8 = uVar7 & (byte)char_type[local_40[3]];
              if ((uVar8 & 0x61) == 0) goto LAB_00551548;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
...
LAB_00551524:
              ...
              uVar8 = uVar7 & (byte)char_type[local_3c];
              if ((uVar8 & 0x61) == 0) goto LAB_00551524;
              if ((uVar8 & 8) == 0) {
                iVar6 = 2;
              }
              else {
            ...
            if (iVar9 != 5) {
              if ((char)local_3b < '\0') {
                ...
                uVar7 = uVar7 & (byte)char_type[local_3b];
                if ((uVar7 & 0x61) != 0) goto LAB_00550d40;
              }
              iVar9 = 1;
              if ((uVar7 & 6) != 0) goto LAB_00551448;
              if (local_3b == 0x5c) {
                iVar9 = 2;
              }
              local_78 = local_78 + iVar9;
...
LAB_00550d58:
  ...
  if (local_4d == '\0') {
    iVar9 = local_78;
    if (param_1 == (ASN1_TYPE *)0x0) goto LAB_00550988;
  }
  else {
    local_78 = local_78 + 2;
    iVar9 = local_78;
    if (param_1 == (ASN1_TYPE *)0x0) goto LAB_00550988;
    iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0067a4c0,1);
    if (iVar9 != 1) goto LAB_00550980;
  }
  pcVar4 = (param_3.object)->sn;
    ...
    do {
      while( true ) {
        ...
        if ((byte *)param_3.ptr == (byte *)0x1) {
          ...
          iVar9 = -1;
          if (param_3.ptr != &SUB_00000004) goto LAB_00550988;
          local_48.type =
               (uint)*(byte *)((int)puVar12 + 3) |
               (uint)*(byte *)(puVar12 + 1) << 8 |
               (uint)*(byte *)((int)puVar12 + 1) << 0x10 | (uint)*(byte *)puVar12 << 0x18;
        ...
        if (iVar9 < 0) goto LAB_00550980;
        if (puVar11 == puVar12) goto LAB_00550f3c;
      }
      pbVar13 = local_40;
      ...
      if (0 < iVar9) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar18 & 8) == 0) {
              iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0066a048,1);
              if (iVar9 != 1) goto LAB_00550980;
              iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&local_4c,1);
            }
            else {
LAB_00550f08:
              iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&local_4c,1);
...
joined_r0x00551128:
            pbVar13 = pbVar13 + 1;
            if (pbVar15 == pbVar13) goto LAB_00550f30;
          }
          uVar18 = param_2 & 4;
LAB_00550f78:
          if ((uVar18 & 6) == 0) {
            if ((bVar1 != 0x5c) || (uVar16 == 0)) goto LAB_00550f08;
            iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0066a054,2);
            if (iVar9 == 2) goto joined_r0x00551128;
            goto LAB_00550980;
          }
          (*(code *)PTR_BIO_snprintf_006a8060)(&local_38,0xb,"\\%02X");
          iVar9 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&local_38,3);
          if (iVar9 != 3) goto LAB_00550980;
          pbVar13 = pbVar13 + 1;
...
LAB_00550f3c:
  iVar9 = local_78;
  if (local_4d == '\0') goto LAB_00550988;
  iVar6 = (*(code *)PTR_BIO_write_006a7f14)(param_1,&DAT_0067a4c0,1);
  if (iVar6 == 1) goto LAB_00550988;
LAB_00550980:
  do {
    iVar9 = -1;
LAB_00550988:
