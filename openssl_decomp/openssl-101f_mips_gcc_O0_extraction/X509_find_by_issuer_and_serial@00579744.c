...

{
  ...
  iVar3 = 0;
  iVar1 = (*(code *)PTR_sk_num_006a7f2c)(sk);
  if (0 < iVar1) {
    do {
      pXVar2 = (X509 *)(*(code *)PTR_sk_value_006a7f24)(sk,iVar3);
      ...
      if (iVar1 == 0) {
        ...
        if ((pXVar5->canon_enc == (uchar *)0x0) || (pXVar5->modified != 0)) {
          iVar1 = (*(code *)PTR_i2d_X509_NAME_006a87d8)(pXVar5,0);
          if (iVar1 < 0) goto LAB_005797cc;
        }
        if ((name->canon_enc == (uchar *)0x0) || (name->modified != 0)) {
          iVar1 = (*(code *)PTR_i2d_X509_NAME_006a87d8)(name,0);
          if (iVar1 < 0) goto LAB_005797cc;
        }
        if (pXVar5->canon_enclen == name->canon_enclen) {
          iVar1 = (*(code *)PTR_memcmp_006aabd8)(pXVar5->canon_enc,name->canon_enc);
          if (iVar1 == 0) {
            return pXVar2;
          }
        }
