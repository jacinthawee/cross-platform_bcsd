...
LAB_00551a38:
        if ((uVar2 & 6) == 0) {
          ...
          if (param_4 != 0) {
            ...
            param_2 = 1;
            iVar3 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a054,1,2,param_4);
...
LAB_00551a84:
        ...
        if ((uVar2 & 8) == 0) {
          ...
          param_3 = (char *)0x1;
          param_2 = 1;
          unaff_s2 = (undefined *)(*(code *)PTR_fwrite_006aab7c)(&DAT_0066a048);
...
LAB_00551c7c:
    if (a == (ASN1_TYPE *)0x0) {
      ...
      iVar3 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a058,1,1,a);
...
LAB_00552088:
  ...
  if (cStack_8d == '\0') {
    ...
    puVar5 = puStack_b8;
    if (a == (ASN1_TYPE *)0x0) goto LAB_00551cb0;
    iVar3 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0067a4c0,1,1,a);
    if (iVar3 != 1) goto LAB_00551ca8;
  }
  pcVar6 = *(char **)param_3;
      ...
      if (0 < iVar3) {
        ...
        do {
          while( true ) {
            ...
            if ((uVar20 & 8) == 0) {
              iVar3 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a048,1,1,a);
              if (iVar3 != 1) goto LAB_00551ca8;
...
LAB_005522b4:
          if ((uVar20 & 6) == 0) {
            ...
            iVar3 = (*(code *)PTR_fwrite_006aab7c)(&DAT_0066a054,1,2,a);
