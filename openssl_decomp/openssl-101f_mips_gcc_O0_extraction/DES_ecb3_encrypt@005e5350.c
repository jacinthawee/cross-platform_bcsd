  ...
  if ((int)pDStack_18c < 0x41) {
    ...
    if (iStack_c0 == 0) {
      if (pDVar27 <= pDVar15) {
        ...
        ppDStack_14c = (DES_key_schedule **)(&PTR_LAB_00675504 + (int)pDVar27);
        puStack_148 = &UNK_0067554c + (int)pDVar27 * 4;
      ...
      pDStack_188 = (DES_key_schedule *)(&DAT_006754e0 + (int)pDVar27 * 4);
      puStack_148 = &UNK_00675528 + (int)pDVar27 * 4;
  ...
  if ((undefined *)((int)pDVar29[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_160 == 0) {
      ...
      if (pDStack_284 <= pDVar15) {
        ppcStack_1d4 = (code **)(&PTR_LAB_00675594 + (int)pDStack_284);
        ...
        pDStack_280 = (DES_key_schedule *)(&PTR_LAB_006755b8 + (int)pDStack_284);
      ...
      pDStack_214 = (DES_key_schedule *)(&switchD_005e64e8::switchdataD_00675570 + (int)pDStack_284)
      ;
      pDStack_280 = (DES_key_schedule *)(&PTR_LAB_006755dc + (int)pDStack_284);
