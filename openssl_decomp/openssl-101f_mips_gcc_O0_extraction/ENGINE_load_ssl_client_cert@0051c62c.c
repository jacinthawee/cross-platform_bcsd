...

{
  ...
  (*(code *)PTR_CRYPTO_lock_006a926c)(9,0x1e,"eng_pkey.c",0xb3);
  if (*(int *)(e + 0x5c) == 0) {
    (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_pkey.c",0xb6);
    ERR_put_error(0x26,0xc2,0x75,"eng_pkey.c",0xb8);
  }
  else {
    (*(code *)PTR_CRYPTO_lock_006a926c)(10,0x1e,"eng_pkey.c",0xbb);
    if (*(code **)(e + 0x4c) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0051c71c. Too many branches */
