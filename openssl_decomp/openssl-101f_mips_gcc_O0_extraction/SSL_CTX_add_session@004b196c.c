...

{
  ...
  CRYPTO_add_lock((int *)(c->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x281);
  CRYPTO_lock(9,0xc,"ssl_sess.c",0x284);
  pSVar1 = (SSL_SESSION *)(*(code *)PTR_lh_insert_006a8514)(s->sessions,c);
  if (pSVar1 != (SSL_SESSION *)0x0) {
    if (c == pSVar1) {
      iVar3 = CRYPTO_add_lock((int *)(c->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
      if (iVar3 < 1) {
    ...
    iVar3 = CRYPTO_add_lock((int *)(pSVar1->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
    if (iVar3 < 1) {
  ...
  if (0 < lVar4) {
    while( true ) {
      ...
      if ((((lVar4 <= lVar5) || (psVar2 = s->session_cache_tail, psVar2 == (ssl_session_st *)0x0))
         ...
         (psVar7 = (ssl_session_st *)(*(code *)PTR_lh_retrieve_006a84b0)(s->sessions,psVar2),
         psVar2 != psVar7)) break;
      pSVar1 = (SSL_SESSION *)(*(code *)PTR_lh_delete_006a94ac)(s->sessions,psVar2);
