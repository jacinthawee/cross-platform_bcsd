  ...
  if (numbits < 0x41) {
    ...
    if (enc == 0) {
      if (pDVar27 <= (uint)length) {
        ...
        local_6c = (DES_key_schedule **)(&PTR_LAB_00675504 + (int)pDVar27);
        local_68 = &UNK_0067554c + (int)pDVar27 * 4;
      ...
      unaff_s6 = (DES_key_schedule *)(&DAT_006754e0 + (int)pDVar27 * 4);
      local_68 = &UNK_00675528 + (int)pDVar27 * 4;
      local_6c = &local_44;
  ...
  if ((undefined *)((int)ks1[-1].ks + 0x7f) < &DAT_00000040) {
    ...
    if (iStack_80 == 0) {
      ...
      if (pDStack_1a4 <= (uint)length) {
        ppcStack_f4 = (code **)(&PTR_LAB_00675594 + (int)pDStack_1a4);
        ...
        pDStack_1a0 = (DES_key_schedule *)(&PTR_LAB_006755b8 + (int)pDStack_1a4);
      ...
      pDStack_134 = (DES_key_schedule *)(&switchD_005e64e8::switchdataD_00675570 + (int)pDStack_1a4)
      ;
      pDStack_1a0 = (DES_key_schedule *)(&PTR_LAB_006755dc + (int)pDStack_1a4);
