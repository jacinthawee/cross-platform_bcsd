...

{
  ...
  local_2c = *(SSL_CTX **)PTR___stack_chk_guard_006aabf0;
  pSVar3 = (SSL_SESSION *)CRYPTO_malloc(0xf4,"ssl_sess.c",0xc0);
  if (pSVar3 == (SSL_SESSION *)0x0) {
    ...
    (*(code *)PTR_memset_006aab00)(pSVar3,0,0xf4);
    ...
    *(undefined4 *)(pSVar3->krb5_client_princ + 0x60) = 0;
    ...
    if (pSVar19 != (SSL_SESSION *)0x0) {
      iVar6 = CRYPTO_add_lock((int *)(pSVar19->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
      if (iVar6 < 1) {
...
joined_r0x004b1684:
      if (0x20 < uVar15) {
        ...
        uVar4 = 0x1af;
LAB_004b16a0:
        (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xb5,uVar16,"ssl_sess.c",uVar4);
        goto LAB_004b16b8;
      }
      psVar17 = (ssl_session_st *)param_1->sid_ctx;
      iVar6 = 1;
      (*(code *)PTR_memcpy_006aabf4)(pSVar3->sid_ctx);
...
joined_r0x004b1584:
      if (iVar6 == 0) {
        ...
        if (iVar7 == 0) {
          (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xb5,0x12d,"ssl_sess.c",0x166);
          goto LAB_004b16b8;
        }
        if (local_30 == 0) {
LAB_004b1800:
          ...
          if (uVar15 < local_30) goto LAB_004b1800;
          if ((local_30 < uVar15) && (param_1->version == 2)) {
            (*(code *)PTR_memset_006aab00)(puVar12 + local_30,0,uVar15 - local_30);
            uVar15 = pSVar3->session_id_length;
          }
          else {
          ...
          if (iVar7 == 0) goto LAB_004b1590;
          uVar16 = 0x12e;
          uVar4 = 0x17e;
        }
        (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xb5,uVar16,"ssl_sess.c",uVar4);
        psVar17 = (ssl_session_st *)0xffffffff;
        iVar7 = CRYPTO_add_lock((int *)(pSVar3->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4)
        ;
        if (iVar7 < 1) {
...
LAB_004b1618:
          if (param_1->tlsext_ellipticcurvelist_length == 0) goto LAB_004b14c0;
          if (*(void **)(pSVar3->krb5_client_princ + 0x50) != (void *)0x0) {
            CRYPTO_free(*(void **)(pSVar3->krb5_client_princ + 0x50));
          }
          pvVar5 = CRYPTO_malloc((int)param_1->tlsext_ecpointformatlist,"ssl_sess.c",0x19c);
          *(void **)(pSVar3->krb5_client_princ + 0x50) = pvVar5;
          ...
          pvVar5 = CRYPTO_malloc(param_1->tlsext_ticket_expected,"ssl_sess.c",400);
        ...
        (*(code *)PTR_ERR_put_error_006a9030)(0x14,0xb5,0x41,"ssl_sess.c",uVar4);
LAB_004b16b8:
        psVar17 = (ssl_session_st *)0xffffffff;
        iVar6 = CRYPTO_add_lock((int *)(pSVar3->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4)
        ;
        if (iVar6 < 1) {
          SSL_SESSION_free_part_2(pSVar3);
          iVar6 = 0;
...
LAB_004b1500:
  ...
  CRYPTO_add_lock((int *)((int)psVar17->krb5_client_princ + 0x14),1,0xe,"ssl_sess.c",0x281);
  CRYPTO_lock(9,0xc,"ssl_sess.c",0x284);
  psVar8 = (ssl_session_st *)(*(code *)PTR_lh_insert_006a8514)(ctx->sessions,psVar17);
  if (psVar8 != (ssl_session_st *)0x0) {
    ...
    iVar6 = CRYPTO_add_lock((int *)(psVar8->krb5_client_princ + 0x14),-1,0xe,"ssl_sess.c",0x2e4);
    if (iVar6 < 1) {
  ...
  if (0 < lVar10) {
    while( true ) {
      ...
      if ((((lVar10 <= lVar11) ||
         ...
         (psVar8 = (ssl_session_st *)(*(code *)PTR_lh_retrieve_006a84b0)(ctx->sessions,psVar17),
         psVar17 != psVar8)) break;
      pSVar3 = (SSL_SESSION *)(*(code *)PTR_lh_delete_006a94ac)(ctx->sessions,psVar17);
  ...
  iVar6 = 1;
LAB_004b1ba4:
  CRYPTO_lock(10,0xc,"ssl_sess.c",0x2b6);
  return iVar6;
}
