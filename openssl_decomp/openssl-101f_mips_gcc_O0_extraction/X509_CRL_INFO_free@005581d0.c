...

{
  ...
  undefined4 in_a3;
  int iVar8;
  X509_CRL_INFO *pXStack_34;
  X509_ALGOR *pXStack_30;
  X509_NAME *pXStack_2c;
  
  puVar2 = PTR___stack_chk_guard_006aabf0;
  puVar1 = X509_CRL_INFO_it._8_4_;
  puVar7 = X509_CRL_INFO_it;
  uVar3 = (uint)X509_CRL_INFO_it[0];
  pXStack_2c = *(X509_NAME **)PTR___stack_chk_guard_006aabf0;
  pXVar6 = a;
  pXStack_34 = a;
  if (uVar3 == 0) {
    if (X509_CRL_INFO_it._16_4_ == (undefined4 *)0x0) {
      pXVar6 = (X509_CRL_INFO *)&pXStack_34;
      if (X509_CRL_INFO_it._8_4_ == (uint *)0x0) {
        ASN1_primitive_free((ASN1_VALUE **)pXVar6,(ASN1_ITEM *)X509_CRL_INFO_it);
      }
      else {
        iVar8 = 0;
        if ((*X509_CRL_INFO_it._8_4_ & 6) == 0) {
          puVar7 = (undefined1 *)X509_CRL_INFO_it._8_4_[4];
          pXVar6 = (X509_CRL_INFO *)&pXStack_34;
          asn1_item_combine_free(pXVar6,puVar7,*X509_CRL_INFO_it._8_4_ & 0x400);
        }
        else {
          puVar7 = (undefined1 *)X509_CRL_INFO_it._16_4_;
    ...
    puVar7 = (undefined1 *)X509_CRL_INFO_it._16_4_;
    if (a == (X509_CRL_INFO *)0x0) goto switchD_0055fb90_caseD_0;
    if (X509_CRL_INFO_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
  ...
  if (X509_CRL_INFO_it._16_4_[4] == 0) {
    puVar7 = (undefined1 *)X509_CRL_INFO_it._16_4_;
    if ((uVar3 & 0xff) < 7) {
...
switchD_0055fb90_caseD_0:
  if (pXStack_2c == *(X509_NAME **)puVar2) {
    return;
  }
  ...
  (*(code *)PTR_memcmp_006aabd8)(pXVar6->version,*(undefined4 *)puVar7,pXVar5,in_a3,&_gp);
  return;
}
