...
LAB_0051cb20:
  ...
  if (pEVar3 != (ENGINE *)0x0) {
    do {
      e_00 = pEVar3;
      if (*(code **)(e_00 + 0x30) != (code *)0x0) {
        iVar2 = (**(code **)(e_00 + 0x30))(e_00,0,&uStack_58,0);
        if (0 < iVar2) {
          (*(code *)PTR_engine_table_register_006a8860)
                    (&pkey_asn1_meth_table,engine_unregister_all_pkey_asn1_meths,e_00,uStack_58);
        }
      }
  ...
  if (*(code **)(e_00 + 0x30) != (code *)0x0) {
    iVar4 = (**(code **)(e_00 + 0x30))();
    if (0 < iVar4) {
      iVar4 = (*(code *)PTR_engine_table_register_006a8860)
                        (&pkey_asn1_meth_table,engine_unregister_all_pkey_asn1_meths,e_00,uStack_90,
                         iVar4,1);
      goto LAB_0051ccc8;
    }
  }
...
LAB_0051ccc8:
  ...
  iVar2 = (*(code *)PTR_engine_table_select_006a8864)(&pkey_asn1_meth_table,iVar2);
  return iVar2;
}
