...

{
  ...
  case 3:
    if (num == 8) {
      (*(code *)PTR_memset_006a99f4)(param_5 + param_4,0,0x40);
      bVar1 = false;
      goto LAB_004f5654;
    }
    local_48 = param_5 + param_4 * 2;
    (*(code *)PTR_memset_006a99f4)(param_5 + param_4,0,param_4 * 4);
    bVar1 = false;
    goto LAB_004f52fc;
  case -2:
    bn_sub_words(param_5,ap_02,param_2,num);
...
LAB_004f52fc:
  ...
  case 3:
    if (num_00 == 4) {
      (*(code *)PTR_memset_006a99f4)(local_48 + num,0,0x20);
      bVar2 = false;
      goto LAB_004f59c8;
    }
    if (num_00 == 8) {
      (*(code *)PTR_memset_006a99f4)(local_48 + num,0,0x40);
      bVar2 = false;
      goto LAB_004f5a50;
    }
    local_2c = local_48 + num * 2;
    (*(code *)PTR_memset_006a99f4)(local_48 + num,0,num * 4);
    bVar2 = false;
    goto LAB_004f56d4;
  case -2:
    bn_sub_words(local_48,ap_00,ap_02,num_00);
...
LAB_004f59c8:
    ...
    pcVar13 = (code *)PTR_bn_mul_comba4_006a8598;
LAB_004f59ec:
...
LAB_004f5a50:
      ...
      pcVar13 = (code *)PTR_bn_mul_comba8_006a8594;
      goto LAB_004f59ec;
    }
    local_2c = local_48 + num * 2;
