...
uint aep_dsa_mod_exp(undefined4 param_1,undefined *param_2,undefined *param_3,char *param_4,
                    undefined *param_5,char *param_6,char *param_7,char *param_8)

{
  ...
  (*(code *)PTR_BN_init_006a857c)(pcStack_8c);
...
LAB_005cd130:
    ...
    if (iVar3 < 0x881) {
      ...
      if (iVar3 == 0) goto LAB_005cd0d8;
      pcVar6 = *(code **)(local_50 + -0x686c);
    }
    else {
      param_3 = &_gp_1;
      if (AEPHK_lib_error_code == 0) {
        AEPHK_lib_error_code = (**(code **)(local_50 + -0x58a8))();
      }
      local_58 = (char *)0x265;
      (**(code **)(local_50 + -0x6eac))(AEPHK_lib_error_code,0x68,0x74,"e_aep.c");
      local_58 = param_8;
      pcVar13 = param_7;
      iVar3 = (**(code **)(local_50 + -0x7484))(pcStack_8c);
      if (iVar3 == 0) goto LAB_005cd0d8;
      pcVar6 = *(code **)(local_50 + -0x686c);
    }
    local_58 = param_8;
    ...
    if (AEPHK_lib_error_code == 0) {
      local_44 = &_gp_1;
      iVar3 = (**(code **)(local_50 + -0x58a8))();
      *(int *)(local_44 + -0x1d78) = iVar3;
    }
    local_58 = (char *)0x265;
    (**(code **)(local_50 + -0x6eac))(iVar3,0x68,0x74,"e_aep.c");
    local_58 = param_8;
    iVar3 = (**(code **)(local_50 + -0x7484))(param_2);
    if (iVar3 != 0) {
      pcVar6 = *(code **)(local_50 + -0x7bec);
      goto LAB_005cd130;
    }
LAB_005cd0d8:
  ...
  puStack_7c = param_3;
  pcStack_70 = param_4;
  iVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(param_7);
  if (iVar3 < 0x881) {
    ...
    if (iVar3 != 0) {
      ...
      (**(code **)(puStack_a0 + -0x6eac))(AEPHK_lib_error_code,0x68,0x69,"e_aep.c");
      goto LAB_005cd3fc;
    }
    puStack_a4 = (undefined *)0x0;
    ...
    if (iVar3 != 0) {
      ...
      pcStack_dc = "encrypt";
      pcStack_a8 = (char *)0x279;
      (**(code **)(puStack_a0 + -0x6eac))(AEPHK_lib_error_code,0x68,0x6e,"e_aep.c");
      (**(code **)(puStack_a0 + -0x6c9c))(9,0x1e,"e_aep.c",0x3f2);
      ...
      do {
        ...
        if (pcStack_98 == *ppcVar11) {
          ...
          if (iVar3 == 0) {
            ...
            *(undefined4 *)(param_6 + 0x6ada88) = 0;
            *(undefined4 *)(param_6 + 0x6ada8c) = 0;
          }
          break;
        }
        ppcVar11 = ppcVar11 + 2;
      ...
      (**(code **)(puStack_a0 + -0x6c9c))(10,0x1e,"e_aep.c",0x403);
      param_4 = pcStack_98;
      goto LAB_005cd3fc;
    }
    pcStack_dc = "encrypt";
    (**(code **)(puStack_a0 + -0x6c9c))(9,0x1e,"e_aep.c",0x3dc);
    ppcVar11 = (char **)(aep_app_conn_table + 4);
    iVar3 = 0;
    do {
      iVar4 = iVar3 + 1;
    ...
    pcStack_11c = (char *)0x3e8;
    pcStack_120 = "e_aep.c";
    puStack_124 = (undefined *)0x1e;
    (**(code **)(puStack_a0 + -0x6c9c))(10);
    uVar5 = 1;
  }
  else {
    pcStack_dc = &_gp_1;
...
LAB_005cd3fc:
    ...
    pcStack_11c = param_7;
    uVar5 = (**(code **)(puStack_a0 + -0x7484))(pcStack_d4);
    pcStack_98 = param_7;
  }
  ...
  pcStack_c4 = param_6;
  pcStack_c0 = param_4;
  iVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(pcStack_a8);
  if (iVar3 < 0x881) {
...
LAB_005cd720:
    ...
    pcVar15 = pcStack_11c;
    pcVar16 = pcStack_128;
    uVar5 = (**(code **)(puStack_f0 + -0x7484))(puStack_124);
  }
  ...
  pcStack_114 = param_6;
  pcStack_110 = param_4;
  iVar3 = (*(code *)PTR_BN_num_bits_006a71f4)(puStack_f8);
  if (iVar3 < 0x881) {
  ...
  uVar5 = (*(code *)PTR_BN_mod_exp_006a795c)(pcVar13,pcVar15,pcVar16,puVar1,uVar2);
LAB_005cda64:
