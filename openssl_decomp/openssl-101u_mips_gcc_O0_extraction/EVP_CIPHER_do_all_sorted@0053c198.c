...

{
  ...
  local_14 = arg;
  local_10 = fn;
  (*(code *)PTR_OBJ_NAME_do_all_sorted_006a7548)(2,do_all_cipher_fn,&local_14);
  if (local_c == *(int *)puStack_38) {
    return;
  }
  pcStack_34 = EVP_MD_do_all;
  (**(code **)(local_20 + -0x5330))();
  puStack_68 = PTR___stack_chk_guard_006a9ae8;
  pcStack_74 = do_all_md_fn;
  uStack_70 = 1;
  puStack_50 = &_gp;
  iStack_3c = *(int *)PTR___stack_chk_guard_006a9ae8;
  (*(code *)PTR_OBJ_NAME_do_all_006a8a78)(1,do_all_md_fn,&pcStack_44);
  if (iStack_3c != *(int *)puStack_68) {
    pcStack_64 = EVP_MD_do_all_sorted;
