...

{
  ...
  pCStack_13c = (CRYPTO_THREADID *)&_gp_1;
...
LAB_004bec10:
      ...
      CRYPTO_THREADID_current(aCStack_40);
      pvVar5 = (void *)(*(code *)PTR_lh_delete_006a8390)(amih,aCStack_40);
      iVar4 = amih;
...
LAB_004be9f8:
  ...
  puStack_a8 = &_gp;
  pCStack_84 = *(CRYPTO_THREADID **)PTR___stack_chk_guard_006a9ae8;
  iStack_d8 = 0;
  pCStack_d0 = unaff_s4;
  pcStack_74 = unaff_s3;
  pCStack_70 = unaff_s4;
  ...
  if ((mh_mode & 1) != 0) {
    ...
    if (amih != 0) {
      ...
      do {
        while( true ) {
          CRYPTO_THREADID_current(pCStack_d0);
          puStack_e0 = (undefined *)(**(code **)(puStack_a8 + -0x6a50))(amih,pCStack_d0);
          iVar4 = amih;
          if (puStack_e0 == (undefined *)0x0) goto LAB_004bedd0;
  ...
  if ((((uint)puStack_a8 & 0x7f) == 1) && (pCStack_138 != (CRYPTO_THREADID *)0x0)) {
    ...
    if ((mh_mode & 1) != 0) {
      ...
      if ((mh_mode & 2) == 0) {
        ...
        CRYPTO_lock(6,0x14,"mem_dbg.c",0x122);
        if (pCStack_13c == (CRYPTO_THREADID *)0x0) goto LAB_004bef3c;
      }
      else {
        CRYPTO_lock(6,0x14,"mem_dbg.c",0x122);
      }
      CRYPTO_mem_ctrl_constprop_5();
      pCStack_13c = (CRYPTO_THREADID *)CRYPTO_malloc(0x24,"mem_dbg.c",0x1e1);
      if (pCStack_13c == (CRYPTO_THREADID *)0x0) {
        ...
        if ((mh == 0) &&
          ...
          if ((uVar8 & 1) == 0) {
            ...
            order = (void *)((int)order + 1);
            uVar3 = (**(code **)(puStack_110 + -0x5304))(0);
...
LAB_004bef3c:
  ...
  puStack_1ac = PTR___stack_chk_guard_006a9ae8;
  puStack_178 = &_gp;
  ...
  if (((pCVar6 == (CRYPTO_THREADID *)0x0) &&
     ...
     (pCStack_1a4 = (CRYPTO_THREADID *)&_gp_1, (mh_mode & 1) != 0)) {
    ...
    if ((mh_mode & 2) == 0) {
      ...
      CRYPTO_lock(6,0x14,"mem_dbg.c",0x122);
      if (pCStack_19c == (CRYPTO_THREADID *)0x0) goto LAB_004bf31c;
    }
    else {
      file = (char *)0x122;
      num = "mem_dbg.c";
    ...
    pCStack_19c = (CRYPTO_THREADID *)&_gp_1;
    if (mh != 0) {
      CRYPTO_mem_ctrl_constprop_5();
      aCStack_168[0].ptr = pCVar11;
      pvVar5 = (void *)(**(code **)(puStack_178 + -0x6a50))(mh,pCStack_198);
      if (pvVar5 != (void *)0x0) {
...
LAB_004bf31c:
  ...
  puStackY_210 = PTR___stack_chk_guard_006a9ae8;
  pCStack_1b4 = *(CRYPTO_THREADID **)PTR___stack_chk_guard_006a9ae8;
  pCVar11 = pCStack_1b4;
  ...
  if ((iStack_174 == 1) && (pCStackY_20c = pCVar6, pCVar6 != (CRYPTO_THREADID *)0x0)) {
    ...
    if (pCStackY_208 == (CRYPTO_THREADID *)0x0) {
      ...
      if ((mh_mode & 1) != 0) {
        ...
        ppCVar7 = (CRYPTO_THREADID **)(*(code *)PTR_lh_delete_006a8390)(mh,aCStack_1d8);
        uVar8 = mh;
        puVar1 = PTR_lh_insert_006a7414;
...
LAB_004bf63c:
  ...
  iStackY_214 = *(int *)PTR___stack_chk_guard_006a9ae8;
  if ((mh != 0) || (amih != 0)) {
    CRYPTO_mem_ctrl_constprop_5();
    uStackY_218 = 0;
    iStackY_21c = 0;
    ...
    if ((mh == 0) ||
       ((*(code *)PTR_lh_doall_arg_006a83a0)(mh,print_leak_LHASH_DOALL_ARG,&pCStackY_220),
       iStackY_21c == 0)) {
