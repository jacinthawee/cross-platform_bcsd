...

{
  ...
  puVar3 = (uint *)(*(code *)PTR_EVP_md5_006a70c8)();
  iVar4 = (*(code *)PTR_EVP_DigestInit_ex_006a757c)(auStack_44,puVar3,0);
  if (iVar4 != 0) {
    uVar5 = (*(code *)PTR_strlen_006a9a24)(puVar2);
    puVar3 = puVar2;
    iVar4 = (*(code *)PTR_EVP_DigestUpdate_006a7580)(auStack_44,puVar2,uVar5);
    if (iVar4 != 0) {
      (*(code *)PTR_CRYPTO_free_006a6e88)(puVar2);
      pAVar6 = a->cert_info->serialNumber;
      puVar3 = (uint *)pAVar6->data;
      iVar4 = (*(code *)PTR_EVP_DigestUpdate_006a7580)(auStack_44,puVar3,pAVar6->length);
      if (iVar4 != 0) {
        puVar3 = local_2c;
        iVar4 = (*(code *)PTR_EVP_DigestFinal_ex_006a7584)(auStack_44,puVar3,0);
        if (iVar4 != 0) {
...
LAB_00575458:
  ...
  if (((*(int *)(iVar4 + 0xc) == 0) || (*(int *)(iVar4 + 4) != 0)) &&
     (iVar7 = (*(code *)PTR_i2d_X509_NAME_006a76ec)(iVar4,0), iVar7 < 0)) {
    uVar10 = 0xfffffffe;
  }
  else if (((*(int *)(iVar9 + 0xc) == 0) || (*(int *)(iVar9 + 4) != 0)) &&
          (iVar7 = (*(code *)PTR_i2d_X509_NAME_006a76ec)(iVar9,0), iVar7 < 0)) {
    uVar10 = 0xfffffffe;
  }
  else {
    uVar10 = *(int *)(iVar4 + 0x10) - *(int *)(iVar9 + 0x10);
    if (uVar10 == 0) {
                    /* WARNING: Could not recover jumptable at 0x005755b0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      uVar10 = (*(code *)PTR_memcmp_006a9ad0)
