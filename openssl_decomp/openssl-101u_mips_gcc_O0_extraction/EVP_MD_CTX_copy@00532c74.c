...

{
  ...
  if ((in->md_data != (void *)0x0) && (iVar20 = out->digest->ctx_size, iVar20 != 0)) {
    if (pvVar26 == (void *)0x0) {
      pvVar26 = (void *)(*(code *)PTR_CRYPTO_malloc_006a7008)(iVar20,"digest.c",0x139);
      out->md_data = pvVar26;
      if (pvVar26 == (void *)0x0) {
    ...
    (*(code *)PTR_memcpy_006a9aec)(pvVar26,in->md_data,iVar20);
  }
  pEVar22 = in->pctx;
  ...
  if (UNRECOVERED_JUMPTABLE != (_func_1081 *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00532de0. Too many branches */
