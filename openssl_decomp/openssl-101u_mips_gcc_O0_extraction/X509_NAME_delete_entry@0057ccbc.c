...

{
  ...
  if ((loc < iVar1) && (-1 < loc)) {
    psVar4 = name->entries;
    pXVar2 = (X509_NAME_ENTRY *)(*(code *)PTR_sk_delete_006a7288)(psVar4,loc);
    ...
    if (loc != iVar1) {
      if (loc == 0) {
        ...
        iVar5 = (*(code *)PTR_sk_value_006a6e24)(psVar4,loc + -1);
        iVar5 = *(int *)(iVar5 + 8);
      }
      iVar3 = (*(code *)PTR_sk_value_006a6e24)(psVar4,loc);
      if ((iVar5 + 1 < *(int *)(iVar3 + 8)) && (loc < iVar1)) {
        do {
          iVar3 = loc + 1;
          iVar5 = (*(code *)PTR_sk_value_006a6e24)(psVar4,loc);
