...
LAB_00568440:
      ...
      uVar4 = (*(code *)PTR_strtoul_006a9a2c)(p + 5);
      if (*local_18 == '\0') goto LAB_00568484;
      iVar3 = 0;
    }
  }
  else {
    pcStack_a4 = "nombstr";
    iVar3 = (*(code *)PTR_strcmp_006a9b18)(p);
    if (iVar3 == 0) {
      uVar4 = 0xffffd7ff;
    }
    else {
      pcStack_a4 = &DAT_0066baec;
      iVar3 = (*(code *)PTR_strcmp_006a9b18)(p);
      if (iVar3 == 0) {
        uVar4 = 0xfffffffb;
      }
...
LAB_00568484:
  ...
  apuStack_68[0] = &_gp;
  pcStack_4c = p;
  iVar3 = (*(code *)PTR_OBJ_bsearch__006a8368)(ppuStack_f8,tbl_standard,0x13,0x14);
  if (iVar3 == 0) {
    unaff_s6 = &_gp_1;
    if (stable != 0) {
      iVar3 = (**(code **)(puStack_78 + -0x6d9c))(stable,ppuStack_f8);
      if (-1 < iVar3) {
    ...
    iVar3 = (**(code **)(puStack_78 + -0x610c))(piStack_ac,pcStack_a4,puStack_100,in_a3);
  }
  else {
LAB_005685c8:
    ...
    iVar3 = (**(code **)(puStack_78 + -0x5ff4))(piStack_ac,pcStack_a4,puStack_100,in_a3);
  }
  iVar5 = 0;
  if (0 < iVar3) {
    iVar5 = *piStack_ac;
  ...
  iStack_10c = (*(code *)PTR_OBJ_bsearch__006a8368)(piStack_104);
  if (iStack_10c == 0) {
    puStack_100 = &_gp_1;
    if (stable != 0) {
      puVar9 = (undefined1 *)piStack_104;
      piVar6 = (int *)(*(code *)PTR_sk_find_006a8044)();
      if (-1 < (int)piVar6) {
        iStack_10c = (*(code *)PTR_sk_value_006a6e24)(stable);
  ...
  aiStack_128[0] = iVar8;
  piVar6 = (int *)(*(code *)PTR_OBJ_bsearch__006a8368)
                            (aiStack_128,tbl_standard,0x13,0x14,table_cmp_BSEARCH_CMP_FN);
  if (piVar6 == (int *)0x0) {
    if (stable != 0) {
      iVar7 = (*(code *)PTR_sk_find_006a8044)(stable,aiStack_128);
      if (-1 < iVar7) {
        piVar6 = (int *)(*(code *)PTR_sk_value_006a6e24)(stable,iVar7);
        if (piVar6 != (int *)0x0) goto LAB_0056884c;
      }
    }
    piVar6 = (int *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x14,"a_strnid.c",0xf6);
    if (piVar6 == (int *)0x0) {
...
LAB_0056884c:
  ...
  piVar6[3] = iVar5;
  if (bVar1) {
    (*(code *)PTR_sk_push_006a6fa8)(stable,piVar6);
    iVar3 = 1;
  }
  else {
    iVar3 = 1;
...
LAB_00568888:
  ...
  if (stable != 0) {
    ...
    iVar3 = (*(code *)PTR_sk_pop_free_006a7058)(iVar3,st_free);
    return iVar3;
  }
  return (int)&_gp_1;
}
