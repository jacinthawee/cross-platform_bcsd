...

{
  ...
  pBVar2 = (BIO *)(*(code *)PTR_BIO_new_file_006a6eac)(file,&DAT_00633e40);
  if (pBVar2 == (BIO *)0x0) {
    plStack_98 = (long *)&SUB_00000002;
    local_38 = 0x69;
    pBVar6 = (BIO *)&DAT_00000064;
    plStack_60 = (lhash_st_CONF_VALUE *)0x0;
    (**(code **)(local_30 + -0x6eac))(0xe,100,2,"conf_lib.c");
  }
  else {
  ...
  plStack_54 = conf;
  plStack_50 = eline;
  pBVar2 = (BIO *)(*(code *)PTR_BIO_new_fp_006a7248)(pBVar6,0);
  if (pBVar2 == (BIO *)0x0) {
    plStack_120 = (long *)&DAT_00000007;
    uStack_80 = 0x7a;
    pBStack_1a8 = (BIO *)0x67;
    plStack_a8 = (lhash_st_CONF_VALUE *)0x0;
    (**(code **)(puStack_78 + -0x6eac))(0xe,0x67,7,"conf_lib.c");
  }
  else {
    if (default_CONF_method == (CONF_METHOD *)0x0) {
      default_CONF_method = NCONF_default();
  ...
  BStack_f8.retry_reason = (int)PTR___stack_chk_guard_006a9ae8;
  BStack_f8.ex_data.sk = (stack_st_void *)&_gp;
  pcStack_ac = *(char **)PTR___stack_chk_guard_006a9ae8;
  pBStack_a4 = unaff_s1;
  if (default_CONF_method == (CONF_METHOD *)0x0) {
    default_CONF_method = NCONF_default();
  }
  ...
  pcVar8 = pcStack_ac;
  (*(code *)BStack_f8.ex_data.sk[-0x429].stack.data)();
  puStack_130 = PTR___stack_chk_guard_006a9ae8;
  puStack_100 = &_gp;
  BStack_f8.init = *(int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (pcVar8 != (char *)0x0) {
    ...
    if (pBVar6 == (BIO *)0x0) {
      ...
      (**(code **)(puStack_100 + -0x6eac))(0xe,0x6c,0x6b,"conf_lib.c");
      psVar4 = (stack_st_CONF_VALUE *)0x0;
    }
    else {
  ...
  if ((BIO *)BStack_f8.init != *(BIO **)puStack_130) {
    ...
    puStack_150 = &_gp;
    pCStack_134 = *(CONF **)PTR___stack_chk_guard_006a9ae8;
    pCStack_178 = (CONF *)&_gp_1;
    ...
    if (pBVar2 == (BIO *)0x0) {
      ...
      if (plVar5 == (lhash_st_CONF_VALUE *)0x0) {
        plStack_158 = (long *)0x141;
        pcVar8 = &DAT_0000006d;
        (**(code **)(puStack_150 + -0x6eac))(0xe,0x6d,0x6a,"conf_lib.c");
      ...
      pBStack_1a8 = pBVar6;
      if (plVar5 == (lhash_st_CONF_VALUE *)0x0) {
        plStack_158 = (long *)0x144;
        plStack_144 = plVar5;
        (**(code **)(puStack_150 + -0x6eac))(0xe,0x6d,0x6c,"conf_lib.c");
        pcVar8 = "group=";
        plStack_158 = name;
        (**(code **)(puStack_150 + -0x6ca4))(4,"group=",pBVar6," name=");
        plVar5 = plStack_144;
      }
    }
    ...
    puStack_190 = &_gp;
    plStack_17c = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
    if (default_CONF_method == (CONF_METHOD *)0x0) {
      default_CONF_method = NCONF_default();
    }
    ...
    puStack_1d0 = &_gp;
    plStack_1bc = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
    pCStack_1ac = pCStack_1f4;
    pBStack_1fc = (BIO *)(*(code *)PTR_BIO_new_fp_006a7248)(pcVar8,0);
    if (pBStack_1fc == (BIO *)0x0) {
      uStack_1d8 = 0xcc;
      pBVar2 = (BIO *)&DAT_00000068;
      (**(code **)(puStack_1d0 + -0x6eac))(0xe,0x68,7,"conf_lib.c");
    }
    else {
      if (default_CONF_method == (CONF_METHOD *)0x0) {
        default_CONF_method = NCONF_default();
    ...
    if (plStack_1bc != *(lhash_st_CONF_VALUE **)puStack_1f8) {
      ...
      pCStack_204 = *(CONF_METHOD **)PTR___stack_chk_guard_006a9ae8;
      if (default_CONF_method == (CONF_METHOD *)0x0) {
        default_CONF_method = NCONF_default();
      }
