...

{
  ...
  if (enc == 0) {
    ...
    if (unaff_s5 != (DES_key_schedule **)0xfffffff8) {
      ...
      pDStack_88 = pDVar29;
      unaff_s7 = unaff_s3;
      if (&DAT_00000007 < unaff_s5 + 2) goto LAB_004dce3c;
      ppDVar23 = unaff_s4;
      switch(unaff_s5) {
      case (DES_key_schedule **)0xfffffff9:
        goto LAB_004dce30;
      case (DES_key_schedule **)0xfffffffa:
        goto switchD_004dcdf8_caseD_fffffffa;
...
switchD_004dcdf8_caseD_fffffffa:
      unaff_s4 = (DES_key_schedule **)((int)ppDVar23 + -1);
...
LAB_004dcf54:
  ...
  (*(code *)local_58[-0xa7].ks[10].deslong[0])();
  pDVar25 = local_58;
  pauStack_8c = ivec;
  piStack_a8 = (int *)PTR___stack_chk_guard_006a9ae8;
  puStack_c8 = &_gp;
  ...
  if (local_4c == (DES_key_schedule **)0x0) {
    ...
    if (uVar6 != 0xfffffff8) {
      ...
      pDVar26 = pDVar30;
      pDVar32 = pDVar29;
      if (7 < uVar6 + 8) goto LAB_004dd504;
      puVar34 = puVar18;
      switch(uVar6) {
      case 0xfffffff9:
        goto LAB_004dd4f8;
      case 0xfffffffa:
        goto switchD_004dd4c0_caseD_fffffffa;
      case 0xfffffffb:
        goto LAB_004dd4e0;
      case 0xfffffffd:
        puVar34 = puVar18 + -1;
...
switchD_004dd4c0_caseD_fffffffa:
      puVar18 = puVar34 + -1;
...
DES_fcrypt:
  ...
  *(undefined **)(puVar37 + -0xc0) = &_gp;
  uVar19 = *puVar18;
  *(undefined4 *)(puVar37 + -0x1c) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8;
  ...
  (*(code *)PTR_memset_006a99f4)(puVar37 + iVar5 + -0x30,0,8 - iVar5);
LAB_004dd844:
  pDVar29 = (DES_key_schedule *)(puVar37 + -0xb0);
  DES_set_key_unchecked((const_DES_cblock *)(puVar37 + -0x30),pDVar29);
  (**(code **)(*(int *)(puVar37 + -0xc0) + -0x6914))(puVar37 + -0xb8,pDVar29,pDVar30,unaff_s4);
...
LAB_004dd9dc:
  ...
  uVar7 = uVar10 << 2;
  uVar6 = 0x20;
  if ((puVar24[-0x10] & 0x40) == 0) goto LAB_004dda14;
LAB_004ddb14:
  uVar7 = uVar7 | 1;
  if (uVar6 != 0) goto LAB_004ddb1c;
LAB_004dda1c:
  iVar5 = iVar13 + 1;
  uVar10 = uVar7 << 1;
  ...
  uVar10 = uVar7 << 2;
  uVar22 = 0x20;
  if ((puVar24[-0x10] & 0x40) == 0) goto LAB_004dda58;
LAB_004ddad8:
  uVar10 = uVar10 | 1;
LAB_004dda58:
  if (uVar22 != 0) goto LAB_004dd990;
  iVar5 = iVar5 + 1;
  uVar22 = 0x80;
...
LAB_004ddb3c:
    ...
    iVar13 = iVar12;
    if ((uVar6 & bVar3) == 0) {
      if (uVar17 == 0) goto LAB_004dd92c;
LAB_004ddaf4:
      uVar7 = uVar7 << 1;
      uVar6 = uVar17 >> 1;
      if ((uVar17 & (byte)puVar24[-0x10]) != 0) goto LAB_004ddb14;
LAB_004dda14:
      if (uVar6 == 0) goto LAB_004dda1c;
LAB_004ddb1c:
      bVar3 = puVar24[-0x10];
      uVar17 = uVar6 >> 1;
    }
...
LAB_004ddab4:
    ...
    if (uVar17 != 0) {
      uVar10 = uVar10 << 1;
      uVar22 = uVar17 >> 1;
      if ((uVar17 & (byte)puVar24[-0x10]) == 0) goto LAB_004dda58;
      goto LAB_004ddad8;
    }
    uVar10 = uVar10 << 1;
