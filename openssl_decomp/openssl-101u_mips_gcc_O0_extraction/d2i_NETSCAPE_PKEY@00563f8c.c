...
LAB_00561954:
      if (*pval == (ASN1_VALUE *)0x0) {
        iVar7 = ASN1_item_ex_new(pval,(ASN1_ITEM *)NETSCAPE_PKEY_it);
        if (iVar7 == 0) {
          uVar12 = 0x3a;
          uVar4 = 0x13f;
          goto LAB_0056163c;
        ...
        iVar7 = asn1_get_choice_selector(pval,(ASN1_ITEM *)NETSCAPE_PKEY_it);
        if ((-1 < iVar7) && (iVar7 < (int)NETSCAPE_PKEY_it._12_4_)) {
          pAVar10 = NETSCAPE_PKEY_it._8_4_ + iVar7;
          ppAVar11 = asn1_get_field_ptr(pval,pAVar10);
          ASN1_template_free(ppAVar11,pAVar10);
          asn1_set_choice_selector(pval,-1,(ASN1_ITEM *)NETSCAPE_PKEY_it);
        }
      }
...
LAB_005615e0:
        if (ppAVar11 == NETSCAPE_PKEY_it._12_4_) {
LAB_00561a34:
          uVar12 = 0x8f;
          uVar4 = 0x15e;
          goto LAB_0056163c;
        ...
        pAVar10 = NETSCAPE_PKEY_it._8_4_;
        do {
          ...
          pAVar10 = pAVar10 + 1;
        } while ((int)ppAVar11 < (int)NETSCAPE_PKEY_it._12_4_);
        if (ppAVar11 == NETSCAPE_PKEY_it._12_4_) goto LAB_00561a34;
      }
      asn1_set_choice_selector(pval,(int)ppAVar11,(ASN1_ITEM *)NETSCAPE_PKEY_it);
    ...
    if (iVar6 == 0) {
      ...
      if (cStack_55 == '\0') {
        ...
        if ((pcStack_68 != (code *)0x0) &&
           (iVar7 = (*pcStack_68)(4,pval,NETSCAPE_PKEY_it,0), iVar7 == 0)) goto LAB_00561628;
        iVar7 = 0;
        ppAVar11 = NETSCAPE_PKEY_it._12_4_;
        pAVar8 = NETSCAPE_PKEY_it._8_4_;
        pAVar10 = NETSCAPE_PKEY_it._8_4_;
        if (0 < (int)NETSCAPE_PKEY_it._12_4_) {
          ...
          if (0 < (int)ppAVar11) {
            do {
              ...
              uVar9 = 0;
              if ((int)NETSCAPE_PKEY_it._12_4_ + -1 != iVar7) {
              ...
              iVar7 = iVar7 + 1;
              pAVar8 = pAVar8 + 1;
            } while (iVar7 < (int)NETSCAPE_PKEY_it._12_4_);
          }
        }
        if (cStack_56 != '\0') {
...
LAB_00561c3c:
          if (iVar7 < (int)NETSCAPE_PKEY_it._12_4_) {
LAB_00561c90:
            pAVar10 = asn1_do_adb(pval,pAVar8,1);
...
LAB_00561cf8:
              ...
              (*(code *)PTR_ERR_add_error_data_006a813c)
                        (4,&DAT_0066a0d0,pAVar10->field_name,", Type=",NETSCAPE_PKEY_it._24_4_);
              goto switchD_005619f8_caseD_7;
            }
            goto LAB_00561650;
          }
  ...
  case 2:
    if ((pcStack_68 == (code *)0x0) ||
       (iVar7 = (*pcStack_68)(4,pval,NETSCAPE_PKEY_it,0), iVar7 != 0)) goto LAB_00561954;
    goto LAB_00561628;
  case 3:
...
LAB_00561668:
  ...
  (*(code *)PTR_ERR_add_error_data_006a813c)(2,s_Type__0066a0d8,NETSCAPE_PKEY_it._24_4_);
...
LAB_00561c54:
  ...
  pAVar8 = pAVar8 + 1;
  ASN1_template_free(ppAVar11,pAVar10);
  if ((int)NETSCAPE_PKEY_it._12_4_ <= iVar7) goto LAB_00561a6c;
  goto LAB_00561c90;
LAB_00561a6c:
  ppAVar11 = *(ASN1_VALUE ***)param_2;
LAB_00561a70:
...
joined_r0x00561600:
    if ((pcStack_68 == (code *)0x0) ||
       (ppAVar11 = pval, iVar7 = (*pcStack_68)(5,pval,NETSCAPE_PKEY_it,0), iVar7 != 0)) {
