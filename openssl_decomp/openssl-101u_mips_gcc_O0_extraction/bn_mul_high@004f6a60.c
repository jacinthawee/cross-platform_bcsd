...
LAB_004f6b7c:
    ...
    if (param_4 != (ulong *)0x0) goto LAB_004f6bc8;
LAB_004f6e20:
    puVar15 = param_6 + param_5 + num;
    puVar16 = param_1;
    if (bVar1) goto LAB_004f6bf8;
  }
  else {
    if (iVar3 < -1) {
      if (iVar3 == -4) {
