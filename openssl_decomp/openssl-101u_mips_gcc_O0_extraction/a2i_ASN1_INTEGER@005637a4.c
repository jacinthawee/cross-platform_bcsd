...

{
  ...
  bs->type = 2;
  iVar3 = (*(code *)PTR_BIO_gets_006a74d4)(bp,buf,size);
  if (iVar3 < 1) {
    puVar19 = (uchar *)0x0;
  }
  else {
      ...
      *pbVar15 = 0;
      ...
      if (iVar18 < iVar10) {
        if (puVar19 == (uchar *)0x0) {
          puVar5 = (uchar *)(*(code *)PTR_CRYPTO_malloc_006a7008)
                                      (iVar3 + iVar10,s_f_int_c_0066a374,0xaa);
        }
        else {
          puVar5 = (uchar *)(*(code *)PTR_CRYPTO_realloc_clean_006a88e0)
                                      (puVar19,iVar18,iVar3 + iVar10,s_f_int_c_0066a374,0xac);
        }
        iVar18 = iVar3 + iVar10;
        if (puVar5 == (uchar *)0x0) {
...
LAB_005639cc:
        do {
          ...
          if (9 < uVar4) {
            ...
            uVar4 = uVar8 - 0x37;
            if (uVar8 - 0x41 < 6) goto LAB_0056396c;
LAB_00563a74:
            uVar12 = 0x8d;
            uVar7 = 0xbf;
            goto LAB_00563a88;
...
LAB_005639b4:
          ...
          if (5 < uVar11 - 0x61) {
            uVar8 = uVar11 - 0x37;
            if (5 < uVar11 - 0x41) goto LAB_00563a74;
            goto LAB_005639b4;
          }
          pbVar16 = pbVar9 + 1;
          pbVar17 = pbVar17 + 2;
  ...
  uVar7 = 0xd2;
LAB_00563a88:
  (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0x66,uVar12,s_f_int_c_0066a374,uVar7);
LAB_00563a9c:
