...

{
  ...
  if (((akid->keyid != (ASN1_OCTET_STRING *)0x0) && (issuer->skid != (ASN1_OCTET_STRING *)0x0)) &&
     (iVar1 = (*(code *)PTR_ASN1_OCTET_STRING_cmp_006a8ee0)(), iVar1 != 0)) {
    return 0x1e;
  }
  if (akid->serial != (ASN1_INTEGER *)0x0) {
    pAVar2 = X509_get_serialNumber(issuer);
    iVar1 = (*(code *)PTR_ASN1_INTEGER_cmp_006a8d38)(pAVar2,akid->serial);
    if (iVar1 != 0) {
      return 0x1f;
    }
  }
  ...
  if (pGVar5 != (GENERAL_NAMES *)0x0) {
    do {
      iVar4 = (*(code *)PTR_sk_num_006a6e2c)(pGVar5);
      if (iVar4 <= iVar1) {
        return 0;
      }
      piVar3 = (int *)(*(code *)PTR_sk_value_006a6e24)(pGVar5,iVar1);
      iVar1 = iVar1 + 1;
    } while (*piVar3 != 4);
