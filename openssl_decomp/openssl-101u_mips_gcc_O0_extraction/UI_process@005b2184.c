...

{
  ...
  if ((*(uint *)(ui + 0x14) & 0x100) != 0) {
    (*(code *)PTR_ERR_print_errors_cb_006a92bc)(print_error,ui);
  }
  iVar1 = 0;
  do {
    do {
      iVar2 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(ui + 4));
      if (iVar2 <= iVar1) {
        if (*(code **)(*(int *)ui + 0xc) != (code *)0x0) {
          iVar1 = (**(code **)(*(int *)ui + 0xc))(ui,iVar1);
          if (iVar1 == -1) goto LAB_005b2320;
          iVar2 = -1;
          if (iVar1 == 0) goto LAB_005b2230;
        }
        iVar1 = 0;
        goto LAB_005b22a8;
      }
    ...
    uVar3 = (*(code *)PTR_sk_value_006a6e24)(*(undefined4 *)(ui + 4));
...
LAB_005b2320:
  ...
  goto LAB_005b2230;
  while( true ) {
    uVar3 = (*(code *)PTR_sk_value_006a6e24)(*(undefined4 *)(ui + 4),iVar2);
    iVar4 = (*pcVar5)(ui,uVar3);
    if (iVar4 == -1) goto LAB_005b2320;
    if (iVar4 == 0) break;
LAB_005b22a8:
    do {
      iVar2 = iVar1;
