...

{
  ...
  *(undefined4 *)(iVar6 + 0x130) = param_2;
  ...
  if (((undefined4 *)param_1[0x23] == (undefined4 *)0x0) ||
    ...
    iVar9 = (*(code *)PTR_EVP_CIPHER_block_size_006a80f0)(*(undefined4 *)param_1[0x23]);
  }
  iVar4 = param_1[0x25];
  *(int *)(iVar6 + 0x134) = param_4;
  *(undefined4 *)(iVar6 + 0x140) = param_3;
  *(undefined **)(iVar6 + 0x13c) = puVar8 + iVar9;
  if (iVar4 == 0) {
    (*(code *)PTR_memcpy_006a9aec)(puVar8 + iVar9,param_3,param_4);
  ...
  if (iVar1 != 0) {
    iVar4 = (**(code **)(*(int *)(param_1[2] + 100) + 4))
                      (param_1,puVar8 + iVar9 + *(int *)(iVar6 + 0x134),1);
    if (iVar4 < 0) {
      return -1;
    }
  ...
  *(undefined **)(iVar6 + 0x13c) = puVar8;
  if (iVar9 != 0) {
    iVar1 = (*(code *)PTR_RAND_bytes_006a7574)(puVar8,iVar9);
    if (iVar1 < 1) {
      return -1;
    }
    *(int *)(iVar6 + 0x134) = *(int *)(iVar6 + 0x134) + iVar9;
  }
