...

{
  ...
  if (param_1 == 0) {
    iVar7 = 0;
    iVar1 = (*(code *)PTR_sk_num_006a6e2c)(0);
  }
  else {
    ...
    iVar1 = (*(code *)PTR_sk_num_006a6e2c)(iVar7);
  }
  if (param_2 != (undefined *)0x0) {
      ...
      if (iVar8 < param_4) {
        ...
        *param_2 = (char)((uint)(iVar8 + -2) >> 8);
        if (0 < iVar1) {
          ...
          puVar5 = puVar9;
          do {
            iVar2 = (*(code *)PTR_sk_value_006a6e24)(iVar7,iVar6);
            iVar6 = iVar6 + 1;
    ...
    (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x133,uVar4,"d1_srtp.c",uVar3);
    return 1;
  }
  iVar8 = (iVar1 + 1) * 2;
LAB_004a5a70:
