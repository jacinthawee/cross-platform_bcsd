...

{
  ...
  uVar6 = uVar1 + (uVar2 ^ param_2[0x1f]) * 0x10000000;
  uVar4 = uVar5 << 1 ^ uVar4;
  ...
  uVar5 = uVar1 + (uVar3 ^ param_2[0x1d]) * 0x10000000;
  ...
  uVar4 = uVar1 + (uVar5 ^ param_2[0x1b]) * 0x10000000;
  uVar2 = uVar3 ^ *(uint *)(DES_SPtrans + ((uVar2 >> 0x1a) + 0x180) * 4) ^
          ...
          *(uint *)(DES_SPtrans + ((uVar1 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
          *(uint *)(DES_SPtrans + ((uVar1 * 0x100 >> 0x1a) + 0x140) * 4);
  uVar3 = uVar2 ^ param_2[0x18];
  uVar1 = (uVar2 ^ param_2[0x19]) >> 4;
  uVar4 = uVar1 + (uVar2 ^ param_2[0x19]) * 0x10000000;
  ...
  uVar5 = uVar1 + (uVar3 ^ param_2[0x17]) * 0x10000000;
  ...
  uVar2 = uVar1 + (uVar4 ^ param_2[0x15]) * 0x10000000;
  ...
  uVar5 = uVar1 + (uVar3 ^ param_2[0x11]) * 0x10000000;
  uVar4 = uVar2 ^ *(uint *)(DES_SPtrans + ((uVar4 >> 0x1a) + 0x180) * 4) ^
          *(uint *)(DES_SPtrans + (uVar4 & 0xfc)) ^
          *(uint *)(DES_SPtrans + (((uVar4 << 0x10) >> 0x1a) + 0x80) * 4) ^
          *(uint *)(DES_SPtrans + (((uVar4 << 8) >> 0x1a) + 0x100) * 4) ^
  ...
  uVar2 = uVar1 + (uVar4 ^ param_2[0xf]) * 0x10000000;
  uVar2 = uVar3 ^ *(uint *)(DES_SPtrans + ((uVar5 >> 0x1a) + 0x180) * 4) ^
          *(uint *)(DES_SPtrans + (uVar5 & 0xfc)) ^
          *(uint *)(DES_SPtrans + (((uVar5 << 0x10) >> 0x1a) + 0x80) * 4) ^
          *(uint *)(DES_SPtrans + (((uVar5 << 8) >> 0x1a) + 0x100) * 4) ^
  ...
  uVar5 = uVar1 + (uVar3 ^ param_2[0xb]) * 0x10000000;
  uVar5 = uVar2 ^ *(uint *)(DES_SPtrans + ((uVar4 >> 0x1a) + 0x180) * 4) ^
          *(uint *)(DES_SPtrans + (uVar4 & 0xfc)) ^
          *(uint *)(DES_SPtrans + (((uVar4 << 0x10) >> 0x1a) + 0x80) * 4) ^
          *(uint *)(DES_SPtrans + (((uVar4 << 8) >> 0x1a) + 0x100) * 4) ^
  ...
  uVar2 = uVar1 + (uVar5 ^ param_2[9]) * 0x10000000;
  ...
  uVar3 = uVar1 + (uVar4 ^ param_2[7]) * 0x10000000;
  uVar5 = uVar5 ^ *(uint *)(DES_SPtrans + ((uVar2 >> 0x1a) + 0x180) * 4) ^
          ...
          *(uint *)(DES_SPtrans + ((uVar1 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
          *(uint *)(DES_SPtrans + ((uVar1 * 0x100 >> 0x1a) + 0x140) * 4);
  uVar3 = uVar5 ^ param_2[4];
  uVar1 = (uVar5 ^ param_2[5]) >> 4;
  uVar2 = uVar1 + (uVar5 ^ param_2[5]) * 0x10000000;
  ...
  uVar1 = (uVar2 ^ param_2[3]) >> 4;
  uVar4 = uVar1 + (uVar2 ^ param_2[3]) * 0x10000000;
  uVar3 = uVar5 ^ *(uint *)(DES_SPtrans + ((uVar3 >> 0x1a) + 0x180) * 4) ^
          *(uint *)(DES_SPtrans + (uVar3 & 0xfc)) ^
          *(uint *)(DES_SPtrans + (((uVar3 << 0x10) >> 0x1a) + 0x80) * 4) ^
          *(uint *)(DES_SPtrans + (((uVar3 << 8) >> 0x1a) + 0x100) * 4) ^
          ...
          *(uint *)(DES_SPtrans + ((uVar1 * 0x100 >> 0x1a) + 0x140) * 4);
  uVar4 = uVar3 ^ *param_2;
  uVar1 = (uVar3 ^ param_2[1]) >> 4;
  uVar5 = uVar1 + (uVar3 ^ param_2[1]) * 0x10000000;
