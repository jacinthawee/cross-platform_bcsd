...

{
  ...
  if (iVar5 < 1) {
    ...
    iVar5 = 0;
    iVar7 = 0;
    while (iVar6 = (*(code *)PTR_sk_num_006a6e2c)(psVar4), iVar7 < iVar6) {
      iVar6 = iVar7 + 1;
      pCVar9 = (CMS_SignerInfo *)(*(code *)PTR_sk_value_006a6e24)(psVar4,iVar7);
    ...
    iVar7 = (*(code *)PTR_sk_num_006a6e2c)(psVar4);
    if (iVar5 != iVar7) {
    ...
    if (iVar5 == iVar7) {
      ...
      if ((flags & 0x20) == 0) {
        ...
        for (iVar5 = 0; iVar7 = (*(code *)PTR_sk_num_006a6e2c)(psVar4), iVar5 < iVar7;
            iVar5 = iVar5 + 1) {
          uVar8 = (*(code *)PTR_sk_value_006a6e24)(psVar4,iVar5);
          iVar7 = cms_signerinfo_verify_cert_isra_1(uVar8,store,psVar12,psVar11);
          if (iVar7 == 0) goto LAB_005b6ff8;
        }
      }
      else {
      ...
      if ((flags & 8) == 0) {
        for (iVar5 = 0; iVar7 = (*(code *)PTR_sk_num_006a6e2c)(psVar4), iVar5 < iVar7;
            iVar5 = iVar5 + 1) {
          pCVar9 = (CMS_SignerInfo *)(*(code *)PTR_sk_value_006a6e24)(psVar4,iVar5);
          iVar7 = (*(code *)PTR_CMS_signed_get_attr_count_006a9334)(pCVar9);
          if ((-1 < iVar7) && (iVar7 = CMS_SignerInfo_verify(pCVar9), iVar7 < 1)) goto LAB_005b6ff8;
        }
      }
      chain = CMS_dataInit(rcms,(BIO *)0x0);
      if ((chain == (BIO *)0x0) ||
         (iVar5 = cms_copy_content(0,chain,flags & 0xffffffbe), iVar5 == 0)) goto LAB_005b6ffc;
      if ((flags & 4) == 0) {
        for (iVar5 = 0; iVar7 = (*(code *)PTR_sk_num_006a6e2c)(psVar4), iVar5 < iVar7;
            iVar5 = iVar5 + 1) {
          pCVar9 = (CMS_SignerInfo *)(*(code *)PTR_sk_value_006a6e24)(psVar4,iVar5);
  ...
  (*(code *)PTR_ERR_put_error_006a7f34)(0x2e,0x9d,uVar10,"cms_smime.c",uVar8);
...
LAB_005b7000:
  ...
  if (psVar12 != (stack_st_X509 *)0x0) {
    (*(code *)PTR_sk_pop_free_006a7058)(psVar12,PTR_X509_free_006a6e90);
  }
  if (psVar11 != (stack_st_X509_CRL *)0x0) {
    (*(code *)PTR_sk_pop_free_006a7058)(psVar11,PTR_X509_CRL_free_006a7060);
  }
