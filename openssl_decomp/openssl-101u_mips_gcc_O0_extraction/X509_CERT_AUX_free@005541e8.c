...

{
  ...
  pAStack_2c = *(ASN1_UTF8STRING **)PTR___stack_chk_guard_006a9ae8;
  pXVar6 = a;
  pXStack_34 = a;
  if (uVar3 == 0) {
      ...
      if (X509_CERT_AUX_it._8_4_ == (uint *)0x0) {
        ...
        if ((*X509_CERT_AUX_it._8_4_ & 6) == 0) {
          ...
          for (; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(a), iVar8 < iVar4; iVar8 = iVar8 + 1) {
            psStack_30 = (stack_st_ASN1_OBJECT *)(*(code *)PTR_sk_value_006a6e24)(a,iVar8);
    ...
    puVar7 = (undefined1 *)X509_CERT_AUX_it._16_4_;
    if (a == (X509_CERT_AUX *)0x0) goto switchD_0055c4c0_caseD_0;
    if (X509_CERT_AUX_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
...
switchD_0055c4c0_caseD_0:
  ...
  (*(code *)PTR_memcmp_006a9ad0)(pXVar6->trust,*(undefined4 *)puVar7,psVar5,in_a3,&_gp);
  return;
}
