...

{
  ...
  if ((a->neg == 0) || (a->top != 0)) {
    pcVar3 = (char *)(*(code *)PTR_CRYPTO_malloc_006a7008)(a->top * 8 + 2,"bn_print.c",0x4f);
  }
  else {
    pcVar3 = (char *)(*(code *)PTR_CRYPTO_malloc_006a7008)(3,"bn_print.c",0x4d);
  }
  if (pcVar3 == (char *)0x0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(3,0x69,0x41,"bn_print.c",0x52);
  }
  else {
    pcVar6 = pcVar3;
    if (a->neg != 0) {
...
LAB_004f7cd0:
          ...
          *pcVar6 = "0123456789ABCDEF"[(int)uVar5 >> 4];
          ...
          uVar5 = uVar4 >> 0x10;
          uVar10 = uVar5 & 0xff;
          if (uVar10 != 0) goto LAB_004f7c64;
          uVar5 = uVar4 >> 8;
          uVar10 = uVar5 & 0xff;
          if (uVar10 != 0) goto LAB_004f7c9c;
          uVar5 = uVar4 & 0xff;
          pcVar6 = pcVar7;
          if (uVar5 != 0) goto LAB_004f7cd0;
        }
        iVar9 = iVar9 + -1;
        iVar8 = iVar8 + -4;
      } while (iVar9 != -1);
