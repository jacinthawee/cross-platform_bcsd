...

{
  ...
  if (length != 0) {
    ...
    do {
      if (uVar12 == 0) {
        (*(code *)PTR_DES_encrypt1_006a84c8)(&local_3c,schedule,1);
        iVar14 = iVar14 + 1;
  ...
  *num = uVar12;
  ...
  do {
    ...
    uVar12 = *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 >> 0x1a) + 0x1c0) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar9 & 0xfc) + 0x100) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x100 >> 0x1a) + 0x140) * 4) ^ uVar12;
    ...
    uVar7 = (uVar7 << 0x10 ^ uVar9) >> 4;
    uVar9 = uVar7 + uVar9 * 0x10000000;
    uVar10 = uVar8 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 >> 0x1a) + 0x1c0) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar9 & 0xfc) + 0x100) ^
    ...
    uVar9 = uVar12 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar9 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar8 >> 0x1a) + 0x1c0) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar8 & 0xfc) + 0x100) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 * 0x100 >> 0x1a) + 0x140) * 4);
    ...
    uVar8 = uVar10 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar8 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 >> 0x1a) + 0x1c0) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar7 & 0xfc) + 0x100) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar12 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar12 * 0x100 >> 0x1a) + 0x140) * 4);
    ...
    uVar12 = (uVar12 << 0x10 ^ uVar7) >> 4;
    uVar7 = uVar12 + uVar7 * 0x10000000;
    uVar7 = uVar9 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 >> 0x1a) + 0x1c0) * 4) ^
    ...
    uVar9 = uVar8 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar9 >> 0x1a) + 0x1c0) * 4) ^
    ...
    uVar8 = uVar7 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar8 >> 0x1a) + 0x1c0) * 4) ^
    ...
    uVar12 = (uVar12 << 0x10 ^ uVar7) >> 4;
    uVar7 = uVar12 + uVar7 * 0x10000000;
    uVar9 = uVar9 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 >> 0x1a) + 0x1c0) * 4) ^
    ...
    uVar12 = (uVar12 << 0x10 ^ uVar7) >> 4;
    uVar7 = uVar12 + uVar7 * 0x10000000;
    uVar8 = uVar8 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar11 >> 0x1a) + 0x180) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar11 & 0xfc)) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar10 << 0x10) >> 0x1a) + 0x80) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 8) >> 0x1a) + 0x100) * 4) ^
            *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar7 >> 0x1a) + 0x1c0) * 4) ^
    ...
    uVar12 = uVar9 ^ *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar6 >> 0x1a) + 0x180) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar6 & 0xfc)) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar11 << 0x10) >> 0x1a) + 0x80) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (((uVar6 << 8) >> 0x1a) + 0x100) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar10 >> 0x1a) + 0x1c0) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + (uVar10 & 0xfc) + 0x100) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar12 * 0x10000 >> 0x1a) + 0xc0) * 4) ^
             *(uint *)(PTR_DES_SPtrans_006a9674 + ((uVar12 * 0x100 >> 0x1a) + 0x140) * 4);
  } while (iVar14 != 0);
