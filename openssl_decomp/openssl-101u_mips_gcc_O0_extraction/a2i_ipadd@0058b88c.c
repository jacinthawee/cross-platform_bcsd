...

{
  ...
  if (iVar7 == 0) {
    puVar12 = &local_48;
    iVar7 = (*(code *)PTR___isoc99_sscanf_006a9a04)(ipasc,"%d.%d.%d.%d",puVar12,&local_44);
    puVar13 = unaff_s2;
          ...
          if (local_20 == 2) {
            if (local_24 != (uint *)0x0) {
              ...
              if (local_24 == local_28) {
                local_3c = local_24;
                if ((int)local_24 < 0) goto LAB_0058ba10;
                (*(code *)PTR_memcpy_006a9aec)(ipout,unaff_s4);
                local_3c = (uint *)(0x10 - (int)puVar5);
                (*(code *)PTR_memset_006a99f4)(ipout + (int)puVar5,0);
                iVar7 = 0x10;
              }
              goto LAB_0058b9d0;
            }
LAB_0058bad0:
            (*(code *)PTR_memcpy_006a9aec)(ipout,unaff_s4,local_24);
            ...
            if ((local_24 == (uint *)0x0) || (local_24 == local_28)) goto LAB_0058b9cc;
            if ((int)local_24 < 0) goto LAB_0058ba10;
            (*(code *)PTR_memcpy_006a9aec)(ipout,unaff_s4,local_24);
            (*(code *)PTR_memset_006a99f4)(ipout + (int)puVar5,0,0x10 - (int)unaff_s2);
          }
    ...
    if (local_28 != (uint *)&SUB_00000010) goto LAB_0058b9cc;
LAB_0058ba10:
...
LAB_0058b9d0:
  ...
  puVar12 = (uint *)0x2f;
  pXStack_8c = *(X509_NAME **)PTR___stack_chk_guard_006a9ae8;
  puStack_84 = (uint *)ipasc;
  puStack_80 = unaff_s2;
  puStack_7c = ipout;
  puStack_78 = unaff_s4;
  iVar8 = (*(code *)PTR_strchr_006a9a28)();
  if ((iVar8 == 0) ||
...
LAB_0058bd14:
    ...
    if (iVar9 == 0) {
      local_3c = &uStack_d8;
      puVar13 = (uint *)0x66ec80;
      iVar9 = (*(code *)PTR___isoc99_sscanf_006a9a04)
...
LAB_0058bce0:
        ...
        if (((iVar7 != 0) && (iVar7 == iVar9)) &&
           (iVar7 = (*(code *)PTR_ASN1_OCTET_STRING_new_006a8668)(), local_3c = puStack_cc,
           iVar7 != 0)) {
          local_3c = (uint *)(iVar9 << 1);
          iVar8 = (*(code *)PTR_ASN1_OCTET_STRING_set_006a866c)(iVar7,puVar13);
          if (iVar8 == 0) {
            (*(code *)PTR_ASN1_OCTET_STRING_free_006a8cfc)(iVar7);
            iVar7 = 0;
          }
          goto LAB_0058bd7c;
        }
...
LAB_0058bcdc:
          ...
          if (iStack_b0 == 3) {
            if (iStack_b8 < 1) {
              if (iStack_b4 < 0) goto LAB_0058bdc4;
LAB_0058be80:
              (*(code *)PTR___memcpy_chk_006a9a48)(auStack_ac,auStack_c8,iStack_b4,0x20);
              puStack_cc = (uint *)(0x10 - iVar9);
              (*(code *)PTR_memset_006a99f4)((int)auStack_ac + iVar11,0);
              if (iVar11 == iVar9) goto LAB_0058bcdc;
LAB_0058bcc0:
              puStack_cc = (uint *)(iVar9 - iVar11);
              (*(code *)PTR_memcpy_006a9aec)(auStack_9c + (iVar11 - iVar9),(int)auStack_c8 + iVar11)
              ;
              goto LAB_0058bcdc;
            }
          }
          else if (iStack_b0 == 2) {
            if (iStack_b4 == 0) goto LAB_0058be80;
            ...
            if (iStack_b4 < 0) goto LAB_0058bdc4;
            (*(code *)PTR___memcpy_chk_006a9a48)(auStack_ac,auStack_c8,iStack_b4,0x20);
            (*(code *)PTR_memset_006a99f4)((int)auStack_ac + iVar11,0,0x10 - iVar9);
            goto LAB_0058bcc0;
          }
        }
      }
...
LAB_0058bd7c:
  ...
  iVar8 = 0;
  iVar7 = (*(code *)PTR_sk_num_006a6e2c)(puVar13);
  if (0 < iVar7) {
    do {
      iVar7 = (*(code *)PTR_sk_value_006a6e24)(puVar13,iVar8);
...
LAB_0058bffc:
          ...
          pbVar14 = pbVar15 + 2;
          if (pbVar15[2] != 0x2b) goto LAB_0058bffc;
          pbVar15 = pbVar15 + 3;
        }
LAB_0058c07c:
        iVar9 = -1;
