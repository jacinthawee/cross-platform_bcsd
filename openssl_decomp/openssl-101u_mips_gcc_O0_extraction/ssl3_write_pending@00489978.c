...

{
  ...
  if ((param_4 < *(int *)(iVar8 + 0x168)) ||
    ...
    (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x9f,0x7f,"s3_pkt.c",0x399);
    return -1;
  }
  ...
  while( true ) {
    ...
    *puVar2 = 0;
    ...
    if (iVar3 == iVar5) goto LAB_00489a78;
    if (iVar3 < 1) goto LAB_00489ac0;
    *(int *)(iVar8 + 0x108) = iVar5 - iVar3;
    *(int *)(iVar8 + 0x104) = *(int *)(iVar8 + 0x104) + iVar3;
  }
  (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x9f,0x80,"s3_pkt.c",0x3a5);
  iVar3 = -1;
...
LAB_00489a78:
    ...
    *(int *)(iVar8 + 0x104) = *(int *)(iVar8 + 0x104) + iVar5;
    if ((((uVar4 & 0x10) == 0) ||
        (iVar8 = (*(code *)PTR_SSL_version_006a77ec)(param_1), iVar8 == 0xfeff)) ||
       (iVar8 = (*(code *)PTR_SSL_version_006a77ec)(param_1), iVar8 == 0x100)) {
      iVar8 = param_1[0x16];
    }
    else {
