  ...
  if ((((pBVar1 != (BIGNUM *)0x0) && (r != (BIGNUM *)0x0)) && (dv != (BIGNUM *)0x0)) &&
    ...
    if (recp->shift != iVar2) {
      ...
      if (((a == (BIGNUM *)0x0) || (iVar4 = BN_set_bit(a,iVar2), iVar4 == 0)) ||
         (iVar4 = (*(code *)PTR_BN_div_006a855c)(&recp->Nr,0,a,recp,ctx), iVar4 == 0)) {
        iVar3 = -1;
      }
      BN_CTX_end(ctx);
      recp->shift = iVar3;
    ...
    if (((iVar3 != -1) && (iVar3 = BN_rshift(pBVar1,m,recp->num_bits), iVar3 != 0)) &&
      ...
      if ((iVar2 != 0) && (iVar2 = (*(code *)PTR_BN_usub_006a85b0)(rem,m,r), iVar2 != 0)) {
        iVar2 = 4;
        rem->neg = 0;
        do {
          iVar2 = iVar2 + -1;
          ...
          iVar3 = (*(code *)PTR_BN_usub_006a85b0)(rem,rem,recp);
          if (iVar3 == 0) goto LAB_004ff9e4;
