...

{
  ...
  if (conf != (lhash_st_CONF_VALUE *)0x0) {
    ...
    if (section == (char *)0x0) {
      ...
      (*(code *)PTR_ERR_put_error_006a7f34)(0xe,0x6c,0x6b,"conf_lib.c");
      psVar2 = (stack_st_CONF_VALUE *)0x0;
    }
    else {
  ...
  puStack_80 = &_gp;
  pCStack_64 = *(CONF **)PTR___stack_chk_guard_006a9ae8;
  pCStack_a8 = (CONF *)&_gp_1;
  ...
  if (plVar5 == (lhash_st_CONF_VALUE *)0x0) {
    ...
    if (psVar2 == (stack_st_CONF_VALUE *)0x0) {
      pcStack_88 = (char *)0x141;
      pcVar6 = &DAT_0000006d;
      (**(code **)(puStack_80 + -0x6eac))(0xe,0x6d,0x6a,"conf_lib.c");
      psVar2 = (stack_st_CONF_VALUE *)0x0;
    }
  }
  else {
    ...
    unaff_s3 = pCVar4;
    if (psVar2 == (stack_st_CONF_VALUE *)0x0) {
      pcStack_88 = (char *)0x144;
      psStack_74 = psVar2;
      (**(code **)(puStack_80 + -0x6eac))(0xe,0x6d,0x6c,"conf_lib.c");
      pcVar6 = "group=";
      pcStack_88 = in_a2;
      (**(code **)(puStack_80 + -0x6ca4))(4,"group=",pCVar4," name=");
      psVar2 = psStack_74;
    }
  }
  ...
  puStack_c0 = &_gp;
  psStack_ac = *(stack_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
  if (default_CONF_method == (CONF_METHOD *)0x0) {
    default_CONF_method = NCONF_default();
  }
  ...
  pCStack_d8 = unaff_s3;
  pBStack_12c = (BIO *)(*(code *)PTR_BIO_new_fp_006a7248)(pcVar6,0);
  if (pBStack_12c == (BIO *)0x0) {
    uStack_108 = 0xcc;
    bp = (BIO *)&DAT_00000068;
    (**(code **)(puStack_100 + -0x6eac))(0xe,0x68,7,"conf_lib.c");
  }
  else {
    if (default_CONF_method == (CONF_METHOD *)0x0) {
      default_CONF_method = NCONF_default();
  ...
  pCStack_134 = *(CONF_METHOD **)PTR___stack_chk_guard_006a9ae8;
  if (default_CONF_method == (CONF_METHOD *)0x0) {
    default_CONF_method = NCONF_default();
  }
