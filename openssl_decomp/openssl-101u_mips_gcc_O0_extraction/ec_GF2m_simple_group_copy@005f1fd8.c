...

{
  ...
  iVar1 = (*(code *)PTR_BN_copy_006a8450)(param_1 + 0x48,param_2 + 0x48);
  if (iVar1 != 0) {
    iVar1 = param_1 + 0x74;
    iVar2 = (*(code *)PTR_BN_copy_006a8450)(iVar1,param_2 + 0x74);
    if (iVar2 != 0) {
      iVar2 = param_1 + 0x88;
      iVar3 = (*(code *)PTR_BN_copy_006a8450)(iVar2,param_2 + 0x88);
      if (iVar3 != 0) {
        ...
        *(undefined4 *)(param_1 + 0x70) = *(undefined4 *)(param_2 + 0x70);
        if (*(int *)(param_1 + 0x7c) < iVar3 >> 5) {
          iVar1 = (*(code *)PTR_bn_expand2_006a8524)(iVar1);
        }
        if (iVar1 != 0) {
          ...
          if (*(int *)(param_1 + 0x90) < iVar1 >> 5) {
            iVar2 = (*(code *)PTR_bn_expand2_006a8524)(iVar2);
          }
          if (iVar2 != 0) {
