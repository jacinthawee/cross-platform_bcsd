...

{
  ...
  piStack_114c = (int *)PTR___stack_chk_guard_006a9ae8;
  buf_01 = aBStack_112c;
  ...
  buf_00 = "%lu:%s:%s:%d:%s\n";
  piVar1 = (int *)(**(code **)(puStack_1158 + -0x695c))(auStack_1134);
  pcStack_1150 = "-check_ss_sig";
  do {
    parg = file;
