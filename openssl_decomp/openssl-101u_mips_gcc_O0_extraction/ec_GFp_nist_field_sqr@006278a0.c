...

{
  ...
  if (((param_1 == 0) || (param_2 == 0)) || (param_3 == 0)) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0x10,0xc9,0x86,"ecp_nist.c",0xcb);
  }
  else if (param_4 == 0) {
    iVar1 = (*(code *)PTR_BN_CTX_new_006a794c)(param_1,param_3);
    if (iVar1 != 0) {
      bVar3 = false;
      iVar2 = (*(code *)PTR_BN_sqr_006a8534)(param_2,param_3,iVar1);
      if (iVar2 != 0) {
    ...
    iVar1 = (*(code *)PTR_BN_sqr_006a8534)(param_2,param_3,param_4);
    if (iVar1 != 0) {
