...

{
  ...
  local_14c = (uint **)PTR___stack_chk_guard_006a9ae8;
  local_158 = &_gp;
  ...
  puStack_190 = (undefined1 *)(**(code **)(local_158 + -0x7bd8))(*puStack_188);
  local_12c = 0;
  (**(code **)(local_158 + -0x53ec))(&local_128,0,0xfc);
...
LAB_005c4014:
      if ((uVar8 & 2) != 0) {
        ...
        pcVar13 = *(code **)(local_158 + -0x6eac);
        uVar6 = 0x71;
        local_168 = (undefined4 *)0x1be;
LAB_005c41f4:
        pcVar10 = (char *)0x95;
...
LAB_005c4050:
          ...
          if (((uVar8 & 0x80) == 0) ||
            ...
            (**(code **)(local_158 + -0x6f3c))(local_138);
        ...
        if (iVar4 == 0) {
          pcVar13 = *(code **)(local_158 + -0x6eac);
          uVar6 = 0x69;
          local_168 = (undefined4 *)0x2aa;
        }
        else {
          iVar4 = (**(code **)(local_158 + -0x60a8))(puStack_188,iVar4);
          if (iVar4 == 0) {
            uVar8 = *(uint *)param_1;
            goto LAB_005c4050;
          }
        ...
        iVar4 = (**(code **)(local_158 + -0x611c))(puStack_188,uVar6);
        if (iVar4 == 0) {
          uVar8 = *(uint *)param_1;
          goto LAB_005c402c;
        }
        local_168 = (undefined4 *)0x24a;
        pcVar10 = (char *)0x66;
        (**(code **)(local_158 + -0x6eac))(0x2f,0x66,0x6c,"ts_rsp_verify.c");
      }
      (**(code **)(local_158 + -0x7f50))(local_13c);
      (**(code **)(local_158 + -0x6f3c))(local_138);
      (**(code **)(local_158 + -0x7f58))(local_134);
...
LAB_005c411c:
    ...
    if (puStack_190 < &DAT_00000006) {
      ...
      if (0 < iVar4) goto LAB_005c3d30;
LAB_005c3e70:
      iVar4 = puStack_188[2];
      puStack_184 = (undefined4 *)0x0;
      local_148 = "encrypt";
      if (iVar4 != 0) goto LAB_005c3f60;
LAB_005c3e84:
    }
    else {
      local_144 = "unknown code";
      iVar4 = (**(code **)(local_158 + -0x7fb4))(puStack_188[1]);
      if (iVar4 < 1) goto LAB_005c3e70;
LAB_005c3d30:
      ...
      local_148 = "encrypt";
      puStack_184 = (undefined4 *)(**(code **)(local_158 + -0x7dd8))(iVar4,"ts_rsp_verify.c",0x232);
      if (puStack_184 == (undefined4 *)0x0) {
        pcVar10 = (char *)0x69;
        local_168 = (undefined4 *)0x233;
        (**(code **)(local_158 + -0x6eac))(0x2f,0x69,0x41,local_148 + 0x2de8);
        iVar4 = 0;
        goto LAB_005c3f10;
      }
      puVar12 = puStack_184;
      for (puStack_190 = (undefined1 *)0x0; iVar4 = (**(code **)(local_158 + -0x7fb4))(param_1),
        ...
        (**(code **)(local_158 + -0x5400))(puVar12,uVar6,iVar4);
        puVar12 = (undefined4 *)((int)puVar12 + iVar4);
      }
      *(char *)puVar12 = '\0';
      iVar4 = puStack_188[2];
      if (iVar4 == 0) goto LAB_005c3e84;
LAB_005c3f60:
      puStack_190 = TS_failure_info;
      param_1 = TS_status_text;
      bVar1 = true;
      while( true ) {
        iVar4 = (**(code **)(local_158 + -0x5d78))(iVar4,*(char **)puStack_190);
        if (iVar4 != 0) {
          pcVar13 = *(code **)(local_158 + -0x52bc);
          if (!bVar1) {
            (*pcVar13)(&local_12c,",",0x100);
            pcVar13 = *(code **)(local_158 + -0x52bc);
          }
          bVar1 = false;
          (*pcVar13)(&local_12c,*(char **)((int)puStack_190 + 4),0x100);
        }
    ...
    if (local_12c._0_1_ == '\0') {
      local_12c = s_unspecified_0063516c._0_4_;
      local_128 = s_unspecified_0063516c._4_4_;
      local_124 = s_unspecified_0063516c._8_4_;
    }
    local_168 = (undefined4 *)0x219;
    (**(code **)(local_158 + -0x6eac))(0x2f,0x68,0x6b,local_148 + 0x2de8);
    ...
    (**(code **)(local_158 + -0x6ca4))(6,"status code: ",local_144,", status text: ");
...
LAB_005c43fc:
    if ((uVar8 & 2) != 0) {
      ...
      uVar6 = 0x1be;
LAB_005c4544:
      (*(code *)PTR_ERR_put_error_006a7f34)(0x2f,0x95,uVar11,"ts_rsp_verify.c",uVar6);
      goto LAB_005c4558;
    }
joined_r0x005c44fc:
    if ((uVar8 & 4) == 0) {
...
LAB_005c4434:
        ...
        if (iVar7 == 0) {
          ...
          iVar7 = (*(code *)PTR_ASN1_INTEGER_cmp_006a8d38)(uVar8,iVar7);
          if (iVar7 == 0) {
            uVar8 = *puVar9;
            goto LAB_005c4434;
          }
        ...
        iVar5 = 0;
        (*(code *)PTR_ERR_put_error_006a7f34)(0x2f,0x65,uVar11,"ts_rsp_verify.c",uVar6);
      }
    }
    else {
      uVar8 = puVar9[3];
      uVar6 = TS_TST_INFO_get_policy_id(iVar4);
      iVar7 = (*(code *)PTR_OBJ_cmp_006a8cc4)(uVar8,uVar6);
      if (iVar7 == 0) {
        uVar8 = *puVar9;
...
LAB_005c4558:
  ...
  (*(code *)PTR_X509_free_006a6e90)(uStack_1a4);
  (*(code *)PTR_X509_ALGOR_free_006a7ea4)(uStack_1a0);
  (*(code *)PTR_CRYPTO_free_006a6e88)(uStack_19c);
...
LAB_005c44ac:
  ...
  iVar4 = (*(code *)PTR_CRYPTO_malloc_006a7008)(0x28,"ts_verify_ctx.c",0x43);
  if (iVar4 == 0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0x2f,0x90,0x41,"ts_verify_ctx.c",0x47);
    return 0;
  }
  (*(code *)PTR_memset_006a99f4)(iVar4,0,0x28);
  return iVar4;
}
