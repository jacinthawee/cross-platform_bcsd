...

{
  ...
  local_1c = *(ASN1_STRING **)PTR___stack_chk_guard_006a9ae8;
  local_2c.length = (*(code *)PTR_strlen_006a9a24)(str);
  local_2c.flags = 0;
  local_2c.type = 0x17;
  ...
  if (iVar2 == 0) {
    ...
    uVar3 = 1;
    if (s == (ASN1_TIME *)0x0) goto LAB_0054ab70;
  }
