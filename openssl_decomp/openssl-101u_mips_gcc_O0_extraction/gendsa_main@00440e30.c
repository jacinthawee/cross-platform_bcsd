...

{
  ...
  if (iVar4 == 0) {
    ...
    *(int *)puVar2 = iVar4;
    if (iVar4 != 0) {
      (**(code **)(local_60 + -0x7fc8))(iVar4,0x6a,0x10,**(undefined4 **)(local_60 + -0x52e8));
      iVar4 = *(int *)puVar2;
    }
  }
...
LAB_00440ffc:
    ...
    if (iStack_8c != 0) goto LAB_00441014;
  }
  else {
    local_54 = (byte *)0x0;
    local_40 = 0;
    ...
    local_48 = (byte *)0x0;
    pbVar9 = (byte *)0x0;
    local_44 = &DAT_0063a4ec;
    local_3c = "-check_ss_sig";
    do {
      while( true ) {
        pbVar8 = *ppbVar5;
        iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,&DAT_00632514);
        if (iVar4 == 0) {
          param_1 = param_1 + -1;
          if (param_1 != 0) {
            pbVar9 = ppbVar5[1];
        ...
        iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-passout");
        if (iVar4 == 0) break;
        iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-engine");
        if (iVar4 == 0) {
          param_1 = param_1 + -1;
          if (param_1 == 0) goto LAB_00441098;
          local_54 = ppbVar5[1];
          ppbVar5 = ppbVar5 + 1;
          pbVar8 = local_38;
LAB_00440f28:
          ...
          iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,local_50 + 0x2734);
          if (iVar4 == 0) {
            param_1 = param_1 + -1;
            if (param_1 != 0) {
              local_48 = ppbVar5[1];
          ...
          if ((local_34 == 0x2d) && (pbVar8[1] == 0)) goto LAB_00441098;
          iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,local_44);
          if (iVar4 == 0) {
            param_1 = param_1 + -1;
            local_40 = (**(code **)(local_60 + -0x7b3c))();
          }
          else {
            iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,local_3c + -0x5b0c);
            if (iVar4 == 0) {
              param_1 = param_1 + -1;
              local_40 = (**(code **)(local_60 + -0x7f98))();
            }
            else {
              iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-idea");
              if (iVar4 == 0) {
                param_1 = param_1 + -1;
                local_40 = (**(code **)(local_60 + -0x7b34))();
              }
              else {
                iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-seed");
                if (iVar4 == 0) {
                  param_1 = param_1 + -1;
                  local_40 = (**(code **)(local_60 + -0x7b30))();
                }
                else {
                  iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-aes128");
                  if (iVar4 == 0) {
                    param_1 = param_1 + -1;
                    local_40 = (**(code **)(local_60 + -0x7b38))();
                  }
                  else {
                    iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-aes192");
                    if (iVar4 == 0) {
                      param_1 = param_1 + -1;
                      local_40 = (**(code **)(local_60 + -0x7b20))();
                    }
                    else {
                      iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-aes256");
                      if (iVar4 == 0) {
                        param_1 = param_1 + -1;
                        local_40 = (**(code **)(local_60 + -0x7b24))();
                      }
                      else {
                        iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-camellia128");
                        if (iVar4 == 0) {
                          param_1 = param_1 + -1;
                          local_40 = (**(code **)(local_60 + -0x7b28))();
                        }
                        else {
                          iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-camellia192");
                          if (iVar4 == 0) {
                            param_1 = param_1 + -1;
                            local_40 = (**(code **)(local_60 + -0x7b2c))();
                          }
                          else {
                            iVar4 = (**(code **)(local_60 + -0x52c8))(pbVar8,"-camellia256");
                            if (iVar4 != 0) {
        ...
        ppbVar5 = ppbVar5 + 1;
        if (param_1 == 0) goto LAB_00440f84;
      }
      bVar1 = param_1 == 1;
      param_1 = param_1 + -2;
      if (bVar1) goto LAB_00441098;
      pbVar10 = ppbVar5[1];
      ppbVar5 = ppbVar5 + 2;
    } while (param_1 != 0);
LAB_00440f84:
    if (local_38 == (byte *)0x0) goto LAB_00441098;
    ...
    if (iVar4 == 0) {
      (**(code **)(local_60 + -0x5360))(pbStack_88);
LAB_004416a0:
      (**(code **)(local_60 + -0x7fa0))(*(undefined4 *)puVar2);
      if (iStack_8c == 0) {
        uStack_90 = 1;
    ...
    pbStack_88 = (byte *)(**(code **)(local_60 + -0x78a8))(iStack_8c,0,0,0);
    ...
    uVar3 = (**(code **)(local_60 + -0x7f40))();
    iStack_8c = (**(code **)(local_60 + -0x7f3c))(uVar3);
    if (iStack_8c == 0) goto LAB_00440ffc;
    if (pbVar9 == (byte *)0x0) {
      (**(code **)(local_60 + -0x7fc8))(iStack_8c,0x6a,0,**(undefined4 **)(local_60 + -0x5418));
    }
    else {
      iVar4 = (**(code **)(local_60 + -0x7fc8))(iStack_8c,0x6c,5,pbVar9);
      if (iVar4 < 1) {
        (**(code **)(local_60 + -0x5360))(pbVar9);
        goto LAB_00440ffc;
      }
    }
...
LAB_00441568:
    ...
    else if (local_48 != (byte *)0x0) goto LAB_00441568;
    uVar7 = *(undefined4 *)puVar2;
    uVar3 = (**(code **)(local_60 + -0x7bec))(*(undefined4 *)(pbStack_88 + 0xc));
    (**(code **)(local_60 + -0x7fa8))(uVar7,"Generating DSA key, %d bits\n",uVar3);
    iVar4 = (**(code **)(local_60 + -0x7764))(pbStack_88);
    if (iVar4 == 0) goto LAB_00440ffc;
    app_RAND_write_file(0,**(undefined4 **)(local_60 + -0x7fa4));
    local_6c = 0;
    local_70 = (int *)0x0;
    local_68 = local_30;
    iVar4 = (**(code **)(local_60 + -0x7770))(iStack_8c,pbStack_88,local_40,0);
    if (iVar4 == 0) goto LAB_00440ffc;
    uStack_90 = 0;
LAB_00441014:
  ...
  if (pbStack_88 != (byte *)0x0) {
    (**(code **)(local_60 + -0x78b0))(pbStack_88);
  }
LAB_00441038:
  if (local_30 != 0) {
  ...
  if (local_2c != *local_4c) {
    ...
    uVar3 = (*(code *)PTR_EVP_PKEY_CTX_get_app_data_006a6e0c)();
    iVar4 = (*(code *)PTR_EVP_PKEY_CTX_get_keygen_info_006a6e10)(iVar4,0);
    if (iVar4 == 0) {
      uStack_95 = 0x2e;
    }
    else if (iVar4 == 1) {
      ...
      if (iVar4 != 2) goto LAB_004418ec;
      uStack_95 = 0x2a;
    }
    while( true ) {
      (*(code *)PTR_BIO_write_006a6e14)(uVar3,&uStack_95,1);
      (*(code *)PTR_BIO_ctrl_006a6e18)(uVar3,0xb,0,0);
      if (iStack_94 == *(int *)puVar2) break;
      uVar11 = (*(code *)PTR___stack_chk_fail_006a9ab0)();
LAB_004418ec:
