...

{
  ...
  BStack_68.retry_reason = (int)PTR___stack_chk_guard_006a9ae8;
  ...
  pcVar7 = local_1c;
  (*(code *)BStack_68.ex_data.sk[-0x429].stack.data)();
  puStack_a0 = PTR___stack_chk_guard_006a9ae8;
  puStack_70 = &_gp;
  BStack_68.init = *(int *)PTR___stack_chk_guard_006a9ae8;
  ...
  if (pcVar7 != (char *)0x0) {
    ...
    if (pBVar8 == (BIO *)0x0) {
      ...
      (**(code **)(puStack_70 + -0x6eac))(0xe,0x6c,0x6b,"conf_lib.c");
      psVar3 = (stack_st_CONF_VALUE *)0x0;
    }
    else {
  ...
  puStack_c0 = &_gp;
  pCStack_a4 = *(CONF **)PTR___stack_chk_guard_006a9ae8;
  pCStack_e8 = (CONF *)&_gp_1;
  ...
  if (pBVar5 == (BIO *)0x0) {
    ...
    if (plVar4 == (lhash_st_CONF_VALUE *)0x0) {
      plStack_c8 = (long *)0x141;
      pcVar7 = &DAT_0000006d;
      (**(code **)(puStack_c0 + -0x6eac))(0xe,0x6d,0x6a,"conf_lib.c");
      plVar4 = (lhash_st_CONF_VALUE *)0x0;
    }
  }
  else {
    ...
    bp = pBVar8;
    if (plVar4 == (lhash_st_CONF_VALUE *)0x0) {
      plStack_c8 = (long *)0x144;
      plStack_b4 = plVar4;
      (**(code **)(puStack_c0 + -0x6eac))(0xe,0x6d,0x6c,"conf_lib.c");
      pcVar7 = "group=";
      plStack_c8 = name;
      (**(code **)(puStack_c0 + -0x6ca4))(4,"group=",pBVar8," name=");
      plVar4 = plStack_b4;
    }
  }
  if (pCStack_a4 != *(CONF **)puStack_e4) {
    ...
    puStack_100 = &_gp;
    plStack_ec = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
    if (default_CONF_method == (CONF_METHOD *)0x0) {
      default_CONF_method = NCONF_default();
    }
    ...
    puStack_140 = &_gp;
    plStack_12c = *(lhash_st_CONF_VALUE **)PTR___stack_chk_guard_006a9ae8;
    pCStack_11c = pCStack_164;
    pBStack_118 = bp;
    pBStack_16c = (BIO *)(*(code *)PTR_BIO_new_fp_006a7248)(pcVar7,0);
    if (pBStack_16c == (BIO *)0x0) {
      uStack_148 = 0xcc;
      pBVar8 = (BIO *)&DAT_00000068;
      (**(code **)(puStack_140 + -0x6eac))(0xe,0x68,7,"conf_lib.c");
    }
    else {
      if (default_CONF_method == (CONF_METHOD *)0x0) {
        default_CONF_method = NCONF_default();
    ...
    if (plStack_12c != *(lhash_st_CONF_VALUE **)puStack_168) {
      ...
      pCStack_174 = *(CONF_METHOD **)PTR___stack_chk_guard_006a9ae8;
      if (default_CONF_method == (CONF_METHOD *)0x0) {
        default_CONF_method = NCONF_default();
      }
