...

{
  ...
  uVar4 = c->C;
  do {
    uVar6 = (uint)b[1] << 8 | (uint)b[2] << 0x10 | (uint)*b | (uint)b[3] << 0x18;
    uVar2 = ((uVar4 ^ uVar1) & uVar3 ^ uVar1) + 0xd76aa478 + uVar6 + uStack_104;
    uVar13 = (uint)b[5] << 8 | (uint)b[6] << 0x10 | (uint)b[4] | (uint)b[7] << 0x18;
    uVar2 = (uVar2 >> 0x19) + uVar2 * 0x80 + uVar3;
    uVar5 = ((uVar3 ^ uVar4) & uVar2 ^ uVar4) + uVar1 + 0xe8c7b756 + uVar13;
    uVar19 = (uint)b[9] << 8 | (uint)b[10] << 0x10 | (uint)b[8] | (uint)b[0xb] << 0x18;
    uVar5 = uVar2 + (uVar5 >> 0x14) + uVar5 * 0x1000;
    uVar23 = (uint)b[0xd] << 8 | (uint)b[0xe] << 0x10 | (uint)b[0xc] | (uint)b[0xf] << 0x18;
    uVar16 = ((uVar2 ^ uVar3) & uVar5 ^ uVar3) + uVar4 + 0x242070db + uVar19;
    uVar17 = uVar5 + (uVar16 >> 0xf) + uVar16 * 0x20000;
    uVar7 = (uint)b[0x11] << 8 | (uint)b[0x12] << 0x10 | (uint)b[0x10] | (uint)b[0x13] << 0x18;
    ...
    uVar14 = (uint)b[0x15] << 8 | (uint)b[0x16] << 0x10 | (uint)b[0x14] | (uint)b[0x17] << 0x18;
    uVar8 = uVar9 + (uVar2 >> 0x19) + uVar2 * 0x80;
    uVar5 = ((uVar17 ^ uVar9) & uVar8 ^ uVar17) + uVar14 + 0x4787c62a + uVar5;
    uVar2 = (uint)b[0x19] << 8 | (uint)b[0x1a] << 0x10 | (uint)b[0x18] | (uint)b[0x1b] << 0x18;
    uVar16 = uVar8 + (uVar5 >> 0x14) + uVar5 * 0x1000;
    uVar5 = ((uVar9 ^ uVar8) & uVar16 ^ uVar9) + uVar2 + 0xa8304613 + uVar17;
    uVar11 = (uint)b[0x1d] << 8 | (uint)b[0x1e] << 0x10 | (uint)b[0x1c] | (uint)b[0x1f] << 0x18;
    uVar17 = uVar16 + (uVar5 >> 0xf) + uVar5 * 0x20000;
    uVar5 = ((uVar8 ^ uVar16) & uVar17 ^ uVar8) + uVar11 + 0xfd469501 + uVar9;
    uVar25 = (uint)b[0x21] << 8 | (uint)b[0x22] << 0x10 | (uint)b[0x20] | (uint)b[0x23] << 0x18;
    uVar9 = uVar17 + (uVar5 >> 10) + uVar5 * 0x400000;
    uVar5 = ((uVar16 ^ uVar17) & uVar9 ^ uVar16) + uVar25 + 0x698098d8 + uVar8;
    uVar20 = (uint)b[0x25] << 8 | (uint)b[0x26] << 0x10 | (uint)b[0x24] | (uint)b[0x27] << 0x18;
    uVar8 = uVar9 + (uVar5 >> 0x19) + uVar5 * 0x80;
    uVar5 = ((uVar17 ^ uVar9) & uVar8 ^ uVar17) + uVar20 + 0x8b44f7af + uVar16;
    uVar12 = (uint)b[0x29] << 8 | (uint)b[0x2a] << 0x10 | (uint)b[0x28] | (uint)b[0x2b] << 0x18;
    uVar16 = uVar8 + (uVar5 >> 0x14) + uVar5 * 0x1000;
    uVar22 = (uint)b[0x2d] << 8 | (uint)b[0x2e] << 0x10 | (uint)b[0x2c] | (uint)b[0x2f] << 0x18;
    uVar5 = ((uVar9 ^ uVar8) & uVar16 ^ uVar9) + (uVar12 - 0xa44f) + uVar17;
    uVar17 = uVar16 + (uVar5 >> 0xf) + uVar5 * 0x20000;
    uVar24 = (uint)b[0x31] << 8 | (uint)b[0x32] << 0x10 | (uint)b[0x30] | (uint)b[0x33] << 0x18;
    ...
    uVar15 = (uint)b[0x3f] << 0x18 | (uint)b[0x3d] << 8 | (uint)b[0x3e] << 0x10 | (uint)b[0x3c];
