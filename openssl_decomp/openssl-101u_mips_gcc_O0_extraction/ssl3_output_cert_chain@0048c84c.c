...

{
  ...
  if ((*(uint *)(param_1 + 0x104) & 8) == 0) {
    ...
    iVar3 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(iVar19);
    bVar1 = iVar17 != 0;
  }
  else {
    iVar19 = *(int *)(param_1 + 0x3c);
    bVar1 = true;
    iVar3 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(iVar19,10);
  }
  if (iVar3 == 0) {
    uVar13 = 7;
    pcVar15 = "s3_both.c";
  ...
  if (param_2 == 0) {
    ...
    iVar17 = (*(code *)PTR_i2d_X509_006a76e8)(param_2,0);
    iVar3 = iVar17 + 10;
    iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(iVar19,iVar3);
    puVar8 = PTR_i2d_X509_006a76e8;
    if (iVar4 == 0) {
LAB_0048cc30:
      uVar13 = 7;
      pcVar15 = "s3_both.c";
    ...
    *(char *)(iVar4 + 9) = (char)iVar17;
    ...
    iVar3 = 7;
    for (iVar17 = 0; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(local_60), iVar17 < iVar4;
        iVar17 = iVar17 + 1) {
      uVar7 = (*(code *)PTR_sk_value_006a6e24)(local_60,iVar17);
      iVar4 = (*(code *)PTR_i2d_X509_006a76e8)(uVar7,0);
      iVar16 = iVar4 + 3 + iVar3;
      iVar5 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(iVar19,iVar16);
      puVar8 = PTR_i2d_X509_006a76e8;
      if (iVar5 == 0) {
        uVar13 = 7;
        pcVar15 = "s3_both.c";
  ...
  for (iVar17 = 0;
    ...
    uVar7 = (*(code *)PTR_sk_value_006a6e24)
                      (*(undefined4 *)(*(int *)(param_1 + 0xe4) + 0x94),iVar17);
    iVar4 = (*(code *)PTR_i2d_X509_006a76e8)(uVar7,0);
    iVar16 = iVar4 + 3 + iVar3;
    iVar5 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(iVar19,iVar16);
    puVar8 = PTR_i2d_X509_006a76e8;
    if (iVar5 == 0) goto LAB_0048cc30;
    ...
    *(undefined4 *)(iVar3 + 0x354) = 0;
    if (((int)pcVar15 < 0) || (pcVar15 == *(char **)(iVar3 + 0x340))) {
      ...
      *puStack_cc = 1;
      ...
      uVar7 = 0x1a9;
LAB_0048d0ac:
      (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x8e,0xf4,"s3_both.c",uVar7);
      uVar7 = 10;
LAB_0048d0c4:
...
LAB_0048cf7c:
        ...
        *(char **)(iVar3 + 0x340) = pcVar6;
        ...
        if (local_d0 < uVar12) {
          (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x8e,0x98,"s3_both.c",499);
          uVar7 = 0x2f;
          goto LAB_0048d0c4;
        }
        if (uVar12 != 0) {
          iVar3 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(puVar11[0xf],uVar12 + 0x14);
          if (iVar3 == 0) {
            (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x8e,7,"s3_both.c",0x1fd);
            goto LAB_0048d0d8;
          }
          iVar3 = puVar11[0x16];
        }
      ...
      if (((pbVar18[1] != 0) || (pbVar18[2] != 0)) || (pbVar18[3] != 0)) {
        if (-1 < (int)pcVar15) goto LAB_0048cf74;
        goto LAB_0048cf7c;
      }
      puVar11[0x11] = 0;
