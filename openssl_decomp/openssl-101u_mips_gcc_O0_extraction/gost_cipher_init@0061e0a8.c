...

{
  ...
  if (*(int *)(param_1 + 0x54) != 0) goto LAB_0061e0e4;
...
LAB_0061e1b0:
    ...
    iVar4 = (*(code *)PTR_OBJ_txt2nid_006a6f5c)(pcVar2);
    if (iVar4 == 0) {
...
LAB_0061e0e4:
  ...
  if (param_3 != 0) {
    uVar1 = (*(code *)PTR_EVP_CIPHER_CTX_iv_length_006a7ff8)(param_1);
    (*(code *)PTR_memcpy_006a9aec)(param_1 + 0x10,param_3,uVar1);
  }
  uVar1 = (*(code *)PTR_EVP_CIPHER_CTX_iv_length_006a7ff8)(param_1);
  (*(code *)PTR_memcpy_006a9aec)(param_1 + 0x20,param_1 + 0x10,uVar1);
  return 1;
}
