...

{
  ...
  local_2c = *(cb **)PTR___stack_chk_guard_006a9ae8;
  pcVar5 = s + len;
  if (len < 1) {
  ...
  if (iVar3 < 1) {
    ...
    local_224 = (byte *)s;
    do {
      BUF_strlcpy(acStack_150,local_1d4,0x121);
      indent = (int)pcVar9;
      ...
      if (iVar8 < 1) {
        ...
        do {
          while ((int)(pcVar9 + iVar7) < len) {
            ...
            BUF_strlcat(acStack_150,acStack_1e8,0x121);
            if (iVar7 == iVar8) goto LAB_00526df4;
          }
          iVar7 = iVar7 + 1;
          pbVar10 = pbVar10 + 1;
          BUF_strlcat(acStack_150,"   ",0x121);
...
LAB_00526df4:
      ...
      u_00 = (undefined *)(*(code *)PTR_strlen_006a9a24)(acStack_150);
      pcVar5 = (char *)u;
      iVar7 = (*cb)(acStack_150,(size_t)u_00,u);
  ...
  if (local_1f0 != (undefined *)0x0) {
    ...
    u_00 = (undefined *)(*(code *)PTR_strlen_006a9a24)(acStack_150);
    iVar8 = (*cb)(acStack_150,(size_t)u_00,u);
