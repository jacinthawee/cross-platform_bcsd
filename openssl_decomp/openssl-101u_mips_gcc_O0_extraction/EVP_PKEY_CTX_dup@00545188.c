...

{
  ...
  if ((*(int *)(ctx + 4) == 0) || (iVar1 = (*(code *)PTR_ENGINE_init_006a7d78)(), iVar1 != 0)) {
    piVar2 = (int *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x28,"pmeth_lib.c",0x138);
    if (piVar2 != (int *)0x0) {
      iVar1 = *(int *)(ctx + 4);
      iVar3 = *(int *)(ctx + 8);
      *piVar2 = *(int *)ctx;
      piVar2[1] = iVar1;
      if (iVar3 != 0) {
        (*(code *)PTR_CRYPTO_add_lock_006a805c)(iVar3 + 8,1,10,"pmeth_lib.c",0x142);
        iVar3 = *(int *)(ctx + 8);
      }
      iVar1 = *(int *)(ctx + 0xc);
      piVar2[2] = iVar3;
      if (iVar1 != 0) {
        (*(code *)PTR_CRYPTO_add_lock_006a805c)(iVar1 + 8,1,10,"pmeth_lib.c",0x147);
        iVar1 = *(int *)(ctx + 0xc);
      }
      iVar3 = *(int *)ctx;
      iVar4 = *(int *)(ctx + 0x10);
