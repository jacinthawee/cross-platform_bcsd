    ...
    *(undefined4 *)(iVar1 + 0x354) = 0;
    if (((int)param_4 < 0) || (param_4 == *(uint *)(iVar1 + 0x340))) {
      ...
      *param_6 = 1;
      ...
      uVar3 = 0x1a9;
LAB_0048d0ac:
      (*(code *)PTR_ERR_put_error_006a7f34)(0x14,0x8e,0xf4,"s3_both.c",uVar3);
      uVar3 = 10;
LAB_0048d0c4:
...
LAB_0048cf7c:
      ...
      *(uint *)(iVar1 + 0x340) = uVar2;
      ...
      if (uVar2 != 0) {
        iVar1 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(param_1[0xf],uVar2 + 0x14);
        if (iVar1 == 0) {
    ...
    if (((pbVar9[1] != 0) || (pbVar9[2] != 0)) || (pbVar9[3] != 0)) {
      if (-1 < (int)param_4) goto LAB_0048cf74;
      goto LAB_0048cf7c;
    }
    param_1[0x11] = 0;
