...

{
  ...
  (*(code *)PTR_memset_006a99f4)(&local_ec,0,0x40);
  iVar18 = 0x10;
  if (len < 0x11) {
    iVar18 = len;
  }
  ...
  if (local_2c != *(int *)puVar2) {
    ...
    uVar3 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar4 * 0x10000 >> 0x18) * 4) ^
            *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar4 & 0xff) * 4)) +
            (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar4 * 0x100 >> 0x18) * 4) -
            *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar4 >> 0x18) * 4)) ^ *local_74;
    uVar4 = uVar3 ^ local_78[2];
    uVar4 = (uVar4 >> (-local_78[3] & 0x1fU)) + (uVar4 << 0x20 - (-local_78[3] & 0x1fU));
    uVar29 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar4 * 0x10000 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar4 & 0xff) * 4)) +
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar4 >> 0x18) * 4) ^
             local_74[1] ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar4 * 0x100 >> 0x18) * 4);
    uVar4 = local_78[4] - uVar29;
    uVar4 = (uVar4 >> (-local_78[5] & 0x1fU)) + (uVar4 << 0x20 - (-local_78[5] & 0x1fU));
    uVar3 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar4 * 0x10000 >> 0x18) * 4) +
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar4 & 0xff) * 4) ^
            *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar4 >> 0x18) * 4)) -
            *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar4 * 0x100 >> 0x18) * 4) ^ uVar3;
    uVar4 = uVar3 + local_78[6];
    uVar4 = (uVar4 >> (-local_78[7] & 0x1fU)) + (uVar4 << 0x20 - (-local_78[7] & 0x1fU));
    uVar29 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar4 * 0x10000 >> 0x18) * 4) ^
             *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar4 & 0xff) * 4)) +
             (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar4 * 0x100 >> 0x18) * 4) -
             *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar4 >> 0x18) * 4)) ^ uVar29;
    uVar4 = uVar29 ^ local_78[8];
    uVar4 = (uVar4 >> (-local_78[9] & 0x1fU)) + (uVar4 << 0x20 - (-local_78[9] & 0x1fU));
    uVar4 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar4 * 0x10000 >> 0x18) * 4) -
            *(int *)(PTR_CAST_S_table1_006a8500 + (uVar4 & 0xff) * 4)) +
            *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar4 >> 0x18) * 4) ^
            uVar3 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar4 * 0x100 >> 0x18) * 4);
    uVar3 = local_78[10] - uVar4;
    uVar3 = (uVar3 >> (-local_78[0xb] & 0x1fU)) + (uVar3 << 0x20 - (-local_78[0xb] & 0x1fU));
    uVar29 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar3 * 0x10000 >> 0x18) * 4) +
              *(int *)(PTR_CAST_S_table1_006a8500 + (uVar3 & 0xff) * 4) ^
             *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar3 >> 0x18) * 4)) -
             *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar3 * 0x100 >> 0x18) * 4) ^ uVar29;
    uVar3 = uVar29 + local_78[0xc];
    uVar3 = (uVar3 >> (-local_78[0xd] & 0x1fU)) + (uVar3 << 0x20 - (-local_78[0xd] & 0x1fU));
    uVar4 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar3 * 0x10000 >> 0x18) * 4) ^
            *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar3 & 0xff) * 4)) +
            (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar3 * 0x100 >> 0x18) * 4) -
            *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar3 >> 0x18) * 4)) ^ uVar4;
    uVar3 = uVar4 ^ local_78[0xe];
    uVar3 = (uVar3 >> (-local_78[0xf] & 0x1fU)) + (uVar3 << 0x20 - (-local_78[0xf] & 0x1fU));
    uVar3 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar3 * 0x10000 >> 0x18) * 4) -
            *(int *)(PTR_CAST_S_table1_006a8500 + (uVar3 & 0xff) * 4)) +
            *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar3 >> 0x18) * 4) ^
            uVar29 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar3 * 0x100 >> 0x18) * 4);
    uVar29 = local_78[0x10] - uVar3;
    uVar29 = (uVar29 >> (-local_78[0x11] & 0x1fU)) + (uVar29 << 0x20 - (-local_78[0x11] & 0x1fU));
    uVar4 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar29 * 0x10000 >> 0x18) * 4) +
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar29 & 0xff) * 4) ^
            *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar29 >> 0x18) * 4)) -
            *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar29 * 0x100 >> 0x18) * 4) ^ uVar4;
    uVar29 = uVar4 + local_78[0x12];
    uVar29 = (uVar29 >> (-local_78[0x13] & 0x1fU)) + (uVar29 << 0x20 - (-local_78[0x13] & 0x1fU));
    uVar3 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar29 * 0x10000 >> 0x18) * 4) ^
            *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar29 & 0xff) * 4)) +
            (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar29 * 0x100 >> 0x18) * 4) -
            *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar29 >> 0x18) * 4)) ^ uVar3;
    uVar29 = uVar3 ^ local_78[0x14];
    uVar29 = (uVar29 >> (-local_78[0x15] & 0x1fU)) + (uVar29 << 0x20 - (-local_78[0x15] & 0x1fU));
    uVar4 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar29 * 0x10000 >> 0x18) * 4) -
            *(int *)(PTR_CAST_S_table1_006a8500 + (uVar29 & 0xff) * 4)) +
            *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar29 >> 0x18) * 4) ^
            uVar4 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar29 * 0x100 >> 0x18) * 4);
    uVar29 = (local_78[0x16] - uVar4 >> (-local_78[0x17] & 0x1fU)) +
             (local_78[0x16] - uVar4 << 0x20 - (-local_78[0x17] & 0x1fU));
    uVar3 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar29 * 0x10000 >> 0x18) * 4) +
             *(int *)(PTR_CAST_S_table1_006a8500 + (uVar29 & 0xff) * 4) ^
            *(uint *)(PTR_CAST_S_table2_006a84f8 + (uVar29 >> 0x18) * 4)) -
            *(int *)(PTR_CAST_S_table3_006a84f4 + (uVar29 * 0x100 >> 0x18) * 4) ^ uVar3;
    if (local_78[0x20] == 0) {
      uVar29 = (uVar3 + local_78[0x18] >> (-local_78[0x19] & 0x1fU)) +
               (uVar3 + local_78[0x18] << 0x20 - (-local_78[0x19] & 0x1fU));
      uVar4 = (*(uint *)(PTR_CAST_S_table0_006a84fc + (uVar29 * 0x10000 >> 0x18) * 4) ^
              *(uint *)(PTR_CAST_S_table1_006a8500 + (uVar29 & 0xff) * 4)) +
              (*(int *)(PTR_CAST_S_table3_006a84f4 + (uVar29 * 0x100 >> 0x18) * 4) -
              *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar29 >> 0x18) * 4)) ^ uVar4;
      uVar29 = uVar4 ^ local_78[0x1a];
      uVar29 = (uVar29 >> (-local_78[0x1b] & 0x1fU)) + (uVar29 << 0x20 - (-local_78[0x1b] & 0x1fU));
      uVar3 = (*(int *)(PTR_CAST_S_table0_006a84fc + (uVar29 * 0x10000 >> 0x18) * 4) -
              *(int *)(PTR_CAST_S_table1_006a8500 + (uVar29 & 0xff) * 4)) +
              *(int *)(PTR_CAST_S_table2_006a84f8 + (uVar29 >> 0x18) * 4) ^
              uVar3 ^ *(uint *)(PTR_CAST_S_table3_006a84f4 + (uVar29 * 0x100 >> 0x18) * 4);
