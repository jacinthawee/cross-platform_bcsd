...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)PTR_bn_sqr_comba4_006a85e0;
  if ((param_3 == 4) || (UNRECOVERED_JUMPTABLE = (code *)PTR_bn_sqr_comba8_006a85e4, param_3 == 8))
  {
                    /* WARNING: Could not recover jumptable at 0x004fc6d0. Too many branches */
  ...
  if (iVar1 < 1) {
    if (iVar1 == 0) {
      (*(code *)PTR_memset_006a99f4)(param_4 + param_3,0,param_3 * 4);
