...

{
  ...
  if (policies != (stack_st_ASN1_OBJECT *)0x0) {
    psVar1 = (stack_st_ASN1_OBJECT *)(*(code *)PTR_sk_new_null_006a6fa4)();
    param->policies = psVar1;
    if (psVar1 != (stack_st_ASN1_OBJECT *)0x0) {
      iVar5 = 0;
      while( true ) {
        iVar4 = (*(code *)PTR_sk_num_006a6e2c)(policies);
        if (iVar4 <= iVar5) {
          param->flags = param->flags | 0x80;
          return 1;
        }
        uVar2 = (*(code *)PTR_sk_value_006a6e24)(policies,iVar5);
        iVar4 = (*(code *)PTR_OBJ_dup_006a8494)(uVar2);
        if (iVar4 == 0) break;
        iVar3 = (*(code *)PTR_sk_push_006a6fa8)(param->policies,iVar4);
        iVar5 = iVar5 + 1;
        if (iVar3 == 0) {
