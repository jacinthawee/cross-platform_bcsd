  ...
  if (param_2 < 0xd) {
    ...
    if (param_2 < 4) {
      if (param_2 == 1) {
        ...
        piVar9[7] = 0;
        piVar9[6] = 0;
        goto joined_r0x00524164;
      }
    }
    else {
      if (param_2 == 10) {
        uVar3 = piVar9[3];
        goto joined_r0x00523f60;
      }
      if (param_2 == 0xb) {
        pbVar8 = param_1->next_bio;
    ...
    if (0x74 < param_2) {
      if (param_2 == 0x75) {
        ...
        if ((iVar4 < 0x1001) || (iVar4 == *piVar9)) {
          ...
          iVar5 = piVar9[2];
          pcVar13 = (code *)PTR_CRYPTO_malloc_006a7008;
          if (iVar12 == piVar9[1]) goto LAB_0052402c;
LAB_005240cc:
          puVar14 = puVar15;
          iVar6 = (*pcVar13)(param_3,"bf_buff.c",0x176);
          if (iVar6 == 0) {
            if (piVar9[2] != iVar5) {
...
LAB_005240fc:
          ...
          iVar5 = (*(code *)PTR_CRYPTO_malloc_006a7008)(param_3,"bf_buff.c",0x171);
          if (iVar5 == 0) goto LAB_005240fc;
          puVar14 = puVar15;
...
LAB_0052402c:
      ...
      if (param_2 == 0x7a) {
        if (*piVar9 < param_3) {
          puVar14 = puVar15;
          iVar4 = (*(code *)PTR_CRYPTO_malloc_006a7008)(param_3,"bf_buff.c",0x153);
          if (iVar4 == 0) goto LAB_005240fc;
          if (piVar9[2] != 0) {
            (**(code **)(puVar14 + -0x7f58))();
          }
          piVar9[2] = iVar4;
