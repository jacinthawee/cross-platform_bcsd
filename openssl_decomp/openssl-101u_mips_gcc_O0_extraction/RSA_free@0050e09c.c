...

{
  ...
  if ((r != (RSA *)0x0) &&
     (iVar1 = (*(code *)PTR_CRYPTO_add_lock_006a805c)(&r->references,0xffffffff,9,"rsa_lib.c",0xd7),
     iVar1 < 1)) {
    ...
    (*(code *)PTR_CRYPTO_free_ex_data_006a82f8)(6,r,&r->ex_data);
    if (r->n != (BIGNUM *)0x0) {
      BN_clear_free(r->n);
    }
    if (r->e != (BIGNUM *)0x0) {
    ...
    if (r->bignum_data != (char *)0x0) {
      (*(code *)PTR_CRYPTO_free_locked_006a872c)();
    }
                    /* WARNING: Could not recover jumptable at 0x0050e260. Too many branches */
