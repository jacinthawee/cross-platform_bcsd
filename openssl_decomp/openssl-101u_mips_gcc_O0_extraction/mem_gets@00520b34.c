...

{
  ...
  if (uVar3 < uVar4) {
    if (param_2 == (undefined *)0x0) {
      if (uVar3 != 0) goto LAB_00520c98;
    }
    else if (uVar3 != 0) goto LAB_00520be4;
    uVar3 = param_1->num;
    if (uVar3 == 0) {
      return 0;
    }
    ...
    if (param_2 != (undefined *)0x0) {
LAB_00520be4:
      (*(code *)PTR_memcpy_006a9aec)(param_2,puVar5[1],uVar3);
      uVar4 = param_1->flags;
      *puVar5 = *puVar5 - uVar3;
      if ((uVar4 & 0x200) == 0) {
        (*(code *)PTR_memmove_006a9af4)(puVar5[1],puVar5[1] + uVar3);
