    ...
    if (-1 < (int)(pEVar8->flags << 0xb)) {
      if ((ctx->flags & 0x100) == 0) {
        ...
        if ((ctx->buf_len == 0) && (ctx->final_used != 0)) {
          if (0x20 < uVar10) {
            (*(code *)PTR_OpenSSLDie_006a7c5c)("evp_enc.c",0x1fc,"b <= sizeof ctx->final");
          }
...
LAB_00533b70:
  ...
  uVar10 = pEVar8->block_size;
  if (uVar10 < 0x21) {
    if (uVar10 == 1) goto LAB_00533ac8;
  }
  else {
    (*(code *)PTR_OpenSSLDie_006a7c5c)("evp_enc.c",0x186,"b <= sizeof ctx->buf");
  }
  uVar6 = ctx->buf_len;
  if ((ctx->flags & 0x100) == 0) {
    if (uVar6 < uVar10) {
      (*(code *)PTR_memset_006a99f4)(ctx->buf + uVar6,uVar10 - uVar6 & 0xff);
    }
