...

{
  ...
  pXVar2 = (X509_STORE *)(*(code *)PTR_CRYPTO_malloc_006a7008)(0x48,"x509_lu.c",0xba);
  if (pXVar2 != (X509_STORE *)0x0) {
    psVar3 = (stack_st_X509_OBJECT *)(*(code *)PTR_sk_new_006a806c)(x509_object_cmp);
    pXVar2->objs = psVar3;
    ...
    if (pXVar5 != (X509_VERIFY_PARAM *)0x0) {
      ...
      (*(code *)PTR_sk_free_006a6e80)(pXVar2->objs);
      (*(code *)PTR_CRYPTO_free_006a6e88)(pXVar2);
    }
  }
