...

{
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = (*(code *)PTR_strcmp_006a9b18)(local_434._0_4_,"PRIVATE KEY");
    if (iVar2 == 0) {
...
joined_r0x0056fffc:
      if ((PKCS8_PRIV_KEY_INFO *)cb == (PKCS8_PRIV_KEY_INFO *)0x0) goto LAB_0056feec;
      pEVar3 = (EVP_PKEY *)(*(code *)PTR_EVP_PKCS82PKEY_006a7220)(cb);
      if (x != (EVP_PKEY **)0x0) {
        if (*x != (EVP_PKEY *)0x0) {
...
joined_r0x0056ffd4:
      if (pEVar3 == (EVP_PKEY *)0x0) goto LAB_0056feec;
    }
    else {
      iVar2 = (*(code *)PTR_strcmp_006a9b18)(pBVar6,"ENCRYPTED PRIVATE KEY");
      if (iVar2 == 0) {
        ...
        if (a != (X509_SIG *)0x0) {
          ...
          if (0 < (int)pbStack_574) {
            cb = (undefined1 *)(*(code *)PTR_PKCS8_decrypt_006a7cb4)(a,unaff_s4);
            X509_SIG_free(a);
            goto joined_r0x0056fffc;
          }
          pbStack_574 = (bio_st *)&DAT_00000068;
          pcStack_518 = "pem_pkey.c";
          bp = (BIO *)0x72;
          (*(code *)PTR_ERR_put_error_006a7f34)(9,0x7b);
          pEVar3 = (EVP_PKEY *)0x0;
          X509_SIG_free(a);
          goto LAB_0056ff14;
        }
...
LAB_0056ff14:
    (*(code *)PTR_CRYPTO_free_006a6e88)(local_434._0_4_);
    (*(code *)PTR_OPENSSL_cleanse_006a7074)(local_42c);
    (*(code *)PTR_CRYPTO_free_006a6e88)(local_42c);
  ...
  puStack_524 = PTR___stack_chk_guard_006a9ae8;
  pEVar5 = (EVP_PKEY_ASN1_METHOD *)pbStack_520->init;
  pBStack_48c = *(BIO **)PTR___stack_chk_guard_006a9ae8;
  ...
  if ((pEVar5 == (EVP_PKEY_ASN1_METHOD *)0x0) || (*(int *)(pEVar5 + 0x28) != 0)) {
    ...
    pEVar3 = (EVP_PKEY *)
             PEM_ASN1_write_bio(PTR_i2d_PrivateKey_006a8eb0,(char *)pbStack_570,pBVar10,pbStack_520,
  ...
  pBVar10 = pBStack_48c;
  (*(code *)PTR___stack_chk_fail_006a9ab0)();
  puStack_578 = PTR___stack_chk_guard_006a9ae8;
  ...
  pBStack_538 = (BIO *)0x0;
  pBStack_534 = (BIO *)0x0;
  pBStack_52c = *(BIO **)PTR___stack_chk_guard_006a9ae8;
  ...
  if (((int)pbStack_574 < 1) ||
     (pBVar6 = (BIO_METHOD *)(*(code *)PTR_EVP_PKEY_new_006a7620)(), pBVar6 == (BIO_METHOD *)0x0)) {
LAB_005702e8:
    ...
    iVar2 = (*(code *)PTR_EVP_PKEY_set_type_str_006a8eb4)(pBVar6,pBStack_53c,pbStack_574);
    if ((iVar2 == 0) || (*(code **)((EVP_PKEY_ASN1_METHOD *)pBVar6->bread + 0x38) == (code *)0x0)) {
LAB_005702d8:
      (*(code *)PTR_EVP_PKEY_free_006a6e78)(pBVar6);
      goto LAB_005702e8;
    }
    x_00 = &pBStack_538;
  ...
  (*(code *)PTR_CRYPTO_free_006a6e88)(pBStack_53c);
  (*(code *)PTR_CRYPTO_free_006a6e88)(pBStack_534);
  pBVar9 = pBStack_530;
  pBStack_57c = pBVar6;
LAB_00570338:
  ...
  pBVar7 = x_00[3];
  iStack_584 = *(int *)PTR___stack_chk_guard_006a9ae8;
