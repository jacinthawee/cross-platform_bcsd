...

{
  ...
  if ((val != (undefined4 *)0x0) &&
     (pAVar2 = ASN1_STRING_type_new(4), puVar1 = PTR_CRYPTO_malloc_006a7008,
    ...
    puVar3[1] = pAVar2;
    *puVar3 = 4;
    puVar4 = (uchar *)(*(code *)puVar1)(saltlen,"p5_pbev2.c",0xdd);
    pAVar2->data = puVar4;
    if (puVar4 != (uchar *)0x0) {
      pAVar2->length = saltlen;
      if (salt == (uchar *)0x0) {
        iVar5 = (*(code *)PTR_RAND_bytes_006a7574)(puVar4,saltlen);
        if (iVar5 < 1) {
        ...
        (*(code *)PTR_memcpy_006a9aec)(puVar4,salt,saltlen);
      }
      v = 0x800;
      if (0 < iter) {
        v = iter;
      ...
      if (iVar5 != 0) {
        if (0 < keylen) {
          ...
          if ((pAVar2 == (ASN1_STRING *)0x0) ||
             (iVar5 = ASN1_INTEGER_set(pAVar2,keylen), iVar5 == 0)) goto LAB_00569864;
        }
        if ((0 < prf_nid) && (prf_nid != 0xa3)) {
          pXVar6 = X509_ALGOR_new();
          val[3] = pXVar6;
          if (pXVar6 == (X509_ALGOR *)0x0) goto LAB_00569864;
          pAVar7 = (ASN1_OBJECT *)(*(code *)PTR_OBJ_nid2obj_006a7140)(prf_nid);
          X509_ALGOR_set0(pXVar6,pAVar7,5,(void *)0x0);
        }
        pXVar6 = X509_ALGOR_new();
        if (pXVar6 != (X509_ALGOR *)0x0) {
          pAVar7 = (ASN1_OBJECT *)(*(code *)PTR_OBJ_nid2obj_006a7140)(0x45);
          pXVar6->algorithm = pAVar7;
          pAVar8 = ASN1_TYPE_new();
          pXVar6->parameter = pAVar8;
          if ((pAVar8 != (ASN1_TYPE *)0x0) &&
             (iVar5 = (*(code *)PTR_ASN1_item_pack_006a8df4)(val,PBKDF2PARAM_it,&pAVar8->value),
             iVar5 != 0)) {
...
LAB_00569864:
  pXVar6 = (X509_ALGOR *)0x0;
LAB_00569868:
  (*(code *)PTR_ERR_put_error_006a7f34)(0xd,0xdb,0x41,"p5_pbev2.c",0x114);
  ASN1_item_free((ASN1_VALUE *)val,(ASN1_ITEM *)PBKDF2PARAM_it);
