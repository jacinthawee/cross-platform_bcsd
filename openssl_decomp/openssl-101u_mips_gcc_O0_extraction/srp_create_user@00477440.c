...

{
  ...
  if (iVar2 < 1) {
    ...
    if (puVar3 == (undefined4 *)0x0) {
      (*(code *)PTR_BIO_printf_006a6e38)(param_7,"Internal error creating SRP verifier\n");
    }
    else {
      *param_3 = local_438;
    }
  ...
  if (local_2c != *(int *)puVar1) {
    ...
    if (puVar7 == (undefined4 *)0x49) {
      while (iVar4 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(*(int *)(iVar2 + 4) + 4)),
            (int)puVar3 < iVar4) {
        ppcVar5 = (char **)(*(code *)PTR_sk_value_006a6e24)
                                     (*(undefined4 *)(*(int *)(iVar2 + 4) + 4),puVar3);
        if (**ppcVar5 == 'I') {
          iVar4 = (*(code *)PTR_strcmp_006a9b18)(pcVar6,ppcVar5[3]);
          if (iVar4 == 0) {
            return puVar3;
          }
      ...
      for (; iVar4 = (*(code *)PTR_sk_num_006a6e2c)(*(undefined4 *)(*(int *)(iVar2 + 4) + 4)),
          (int)puVar3 < iVar4; puVar3 = (undefined4 *)((int)puVar3 + 1)) {
        ppcVar5 = (char **)(*(code *)PTR_sk_value_006a6e24)
                                     (*(undefined4 *)(*(int *)(iVar2 + 4) + 4),puVar3);
        if ((**ppcVar5 != 'I') &&
           (iVar4 = (*(code *)PTR_strcmp_006a9b18)(pcVar6,ppcVar5[3]), iVar4 == 0)) {
          return puVar3;
        }
      }
    }
