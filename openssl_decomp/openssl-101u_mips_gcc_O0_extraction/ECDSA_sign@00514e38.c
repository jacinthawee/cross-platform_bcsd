...

{
  ...
  iVar2 = (**(code **)(local_28 + -0x6674))(eckey);
  if (iVar2 != 0) {
    sig = (uchar *)0x0;
    ...
    if (iVar2 != 0) {
      buf = &local_20;
      uVar3 = (**(code **)(local_28 + -0x6670))(iVar2);
      pcVar6 = *(code **)(local_28 + -0x666c);
      *siglen = uVar3;
      (*pcVar6)(iVar2);
      iVar2 = 1;
      goto LAB_00514f04;
...
LAB_00514f04:
  ...
  puStack_34 = sig;
  RAND_seed(buf,iVar5);
  iVar2 = (*(code *)PTR_ecdsa_check_006a876c)(uStack_24);
  if (iVar2 != 0) {
    iVar5 = (**(code **)(*(int *)(iVar2 + 0xc) + 4))(buf,iVar5,uStack_2c,local_28,uStack_24);
    if (iVar5 != 0) {
      uVar4 = (*(code *)PTR_i2d_ECDSA_SIG_006a8770)(iVar5,&puStack_34);
      puVar1 = PTR_ECDSA_SIG_free_006a8774;
      *local_30 = uVar4;
      (*(code *)puVar1)(iVar5);
      return 1;
    }
