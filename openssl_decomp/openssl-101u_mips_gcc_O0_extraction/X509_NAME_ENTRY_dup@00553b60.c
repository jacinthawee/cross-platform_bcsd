...

{
  ...
  X509_NAME_ENTRY *pXVar19;
  ASN1_STRING *pAVar20;
  X509_NAME_ENTRY *pXVar21;
  X509_NAME_ENTRY *unaff_s3;
  X509_NAME_ENTRY **unaff_s4;
  X509_NAME_ENTRY *unaff_s5;
  ASN1_STRING **unaff_s6;
  X509_NAME_ENTRY *pXVar22;
  undefined auStack_316 [10];
  int *piStack_30c;
  X509_NAME_ENTRY *pXStack_304;
  ...
  X509_NAME_ENTRY *pXStack_248;
  code *pcStack_244;
  undefined *puStack_240;
  ASN1_VALUE **ppAStack_23c;
  undefined *puStack_238;
  int iStack_234;
  ASN1_STRING **ppAStack_230;
  code *pcStack_22c;
  ASN1_VALUE **ppAStack_208;
  code *pcStack_204;
  undefined *puStack_200;
  X509_NAME_ENTRY *pXStack_1fc;
  undefined *puStack_1f8;
  ASN1_VALUE **ppAStack_1f4;
  ASN1_ITEM *pAStack_1f0;
  X509_NAME_ENTRY *pXStack_1ec;
  ASN1_STRING **ppAStack_1e8;
  ...
  X509_NAME_ENTRY *pXStack_13c;
  int iStack_134;
  int iStack_130;
  ASN1_ITEM *pAStack_12c;
  ASN1_OBJECT *pAStack_128;
  X509_NAME_ENTRY *pXStack_124;
  ...
  X509_NAME_ENTRY *pXStack_e4;
  ASN1_STRING *pAStack_e0;
  X509_NAME_ENTRY *pXStack_dc;
  X509_NAME_ENTRY **ppXStack_d8;
  code *pcStack_d4;
  int iStack_b0;
  X509_NAME_ENTRY *pXStack_ac;
  X509_NAME_ENTRY *apXStack_98 [3];
  uint uStack_8c;
  X509_NAME_ENTRY XStack_88;
  int iStack_6c;
  ASN1_OBJECT *pAStack_68;
  undefined *puStack_64;
  ASN1_OBJECT *pAStack_1c;
  ASN1_OBJECT *pAStack_18;
  ASN1_STRING *pAStack_14;
  
  pXStack_e4 = (X509_NAME_ENTRY *)PTR___stack_chk_guard_006a9ae8;
  pAStack_1c = (ASN1_OBJECT *)0x0;
  pAStack_14 = *(ASN1_STRING **)PTR___stack_chk_guard_006a9ae8;
  if (ne == (X509_NAME_ENTRY *)0x0) {
    pAVar5 = (ASN1_OBJECT *)0x0;
  }
  else {
    iVar4 = ASN1_item_i2d((ASN1_VALUE *)ne,(uchar **)&pAStack_1c,(ASN1_ITEM *)X509_NAME_ENTRY_it);
    if (pAStack_1c == (ASN1_OBJECT *)0x0) {
      ne = (X509_NAME_ENTRY *)0xbf;
      ERR_put_error(0xd,0xbf,0x41,"a_dup.c",0x6e);
      pAVar5 = (ASN1_OBJECT *)0x0;
      unaff_s0 = (ASN1_OBJECT *)X509_NAME_ENTRY_it;
    }
    else {
      ne = (X509_NAME_ENTRY *)&pAStack_18;
      pAStack_18 = pAStack_1c;
      pAVar5 = (ASN1_OBJECT *)
               ASN1_item_d2i((ASN1_VALUE **)0x0,(uchar **)ne,iVar4,(ASN1_ITEM *)X509_NAME_ENTRY_it);
      (*(code *)PTR_CRYPTO_free_006a6e88)(pAStack_1c);
      unaff_s0 = pAVar5;
    }
  }
  if (pAStack_14 == *(ASN1_STRING **)pXStack_e4) {
    return (X509_NAME_ENTRY *)pAVar5;
  }
  pAStack_e0 = pAStack_14;
  ...
  if (pAVar5 != (ASN1_OBJECT *)0x0) {
    ...
    unaff_s6 = &XStack_88.value;
    ERR_clear_error();
    iStack_b0 = 0;
    pXVar22 = (X509_NAME_ENTRY *)0x0;
    unaff_s5 = (X509_NAME_ENTRY *)0x0;
    pXVar19 = (X509_NAME_ENTRY *)0x0;
LAB_0054c08c:
    unaff_s0 = pAVar5;
    if ((X509_NAME_ENTRY *)&DAT_00000008 < unaff_s5) goto LAB_0054c0f0;
    while ((unaff_s3 = (X509_NAME_ENTRY *)((int)&pXVar19->set - (int)pXVar22),
           pXVar22 <= &pXVar19->set &&
           (iVar4 = (*(code *)PTR_BUF_MEM_grow_clean_006a7b40)(pAVar5), iVar4 != 0))) {
      iVar4 = (*(code *)PTR_BIO_read_006a74c0)
                        (pAStack_e0,
                         (undefined *)
                         ((int)&pXVar22->object + (int)&((ASN1_STRING *)pAVar5->ln)->length),
                         unaff_s3);
      if (iVar4 < 0) {
        if (pXVar22 == pXVar19) {
          pXStack_124 = (X509_NAME_ENTRY *)0x8e;
          iVar4 = 0xad;
          goto LAB_0054c284;
        }
      }
      else {
        pXVar6 = (X509_NAME_ENTRY *)((int)&pXVar22->object + iVar4);
        if ((iVar4 != 0) &&
           (bVar1 = pXVar6 < pXVar22, unaff_s5 = (X509_NAME_ENTRY *)((int)pXVar6 - (int)pXVar19),
           pXVar22 = pXVar6, bVar1)) {
          pXStack_124 = (X509_NAME_ENTRY *)&DAT_0000009b;
          iVar4 = 0xb2;
          goto LAB_0054c284;
        }
      }
LAB_0054c0f0:
      pAVar20 = (ASN1_STRING *)pAVar5->ln;
      while( true ) {
        piStack_1a4 = &XStack_88.set;
        unaff_s3 = (X509_NAME_ENTRY *)((int)&pXVar19->object + (int)&pAVar20->length);
        pXStack_124 = &XStack_88;
        pcStack_1a0 = (char *)unaff_s6;
        apXStack_98[0] = unaff_s3;
        uStack_8c = ASN1_get_object((uchar **)unaff_s4,piStack_1a4,(int *)&XStack_88,(int *)unaff_s6
                                    ,(long)unaff_s5);
        if ((uStack_8c & 0x80) != 0) {
        ...
        unaff_s3 = (X509_NAME_ENTRY *)((int)apXStack_98[0] - (int)unaff_s3);
        pXVar19 = (X509_NAME_ENTRY *)((int)pXVar19 + (int)unaff_s3);
        if ((uStack_8c & 1) == 0) {
          if ((iStack_b0 != 0) && (XStack_88.set == 0)) {
            unaff_s5 = (X509_NAME_ENTRY *)((int)pXVar22 - (int)pXVar19);
            if ((XStack_88.object != (ASN1_OBJECT *)0x0) ||
               (iStack_b0 = iStack_b0 + -1, iStack_b0 != 0)) goto LAB_0054c08c;
            goto LAB_0054c324;
          }
          pXVar6 = (X509_NAME_ENTRY *)((int)&pXVar19->object + XStack_88.set);
          if ((uint)XStack_88.set <= (uint)((int)pXVar22 - (int)pXVar19)) goto LAB_0054c220;
          unaff_s5 = (X509_NAME_ENTRY *)((int)pXVar6 - (int)pXVar22);
          if ((-1 < (int)unaff_s5) && (pXVar22 <= pXVar6)) {
            pXStack_ac = (X509_NAME_ENTRY *)&DAT_00004000;
            if (unaff_s5 != (X509_NAME_ENTRY *)0x0) goto LAB_0054c1a0;
            goto LAB_0054c220;
          }
          pXStack_124 = (X509_NAME_ENTRY *)&DAT_0000009b;
          iVar4 = 0xe2;
        ...
        if (unaff_s5 < (X509_NAME_ENTRY *)&DAT_00000009) break;
        pAVar20 = (ASN1_STRING *)pAVar5->ln;
      }
    }
    pXStack_124 = (X509_NAME_ENTRY *)&DAT_00000041;
    iVar4 = 0xa8;
    goto LAB_0054c284;
  }
  pXStack_124 = (X509_NAME_ENTRY *)&DAT_00000041;
  pcStack_1a0 = "a_d2i_fp.c";
  piStack_1a4 = (int *)&DAT_0000006b;
  ERR_put_error(0xd,0x6b,0x41,"a_d2i_fp.c",0x9e);
  pXVar19 = (X509_NAME_ENTRY *)0xffffffff;
LAB_0054c2ac:
  ...
  if (pAVar5 == (ASN1_OBJECT *)0x0) {
    ...
    if ((int)ppAVar9 < 0) {
      ...
      pXVar19 = (X509_NAME_ENTRY *)(*(code *)piStack_1a4)(pcStack_1a0);
  ...
  if ((int)ppAVar9 < 0) {
    ...
    pXVar19 = (X509_NAME_ENTRY *)(*(code *)piStack_164)(pcStack_160,piVar15);
    ppAStack_1ac = ppAVar9;
  }
  if (iStack_134 != 0) {
    pXStack_13c = pXVar19;
  ...
  pXStack_1fc = (X509_NAME_ENTRY *)auStack_174;
  puStack_188 = &_gp;
  ...
  if ((int)ppAVar9 < 0) {
    ...
    pXStack_1fc = (X509_NAME_ENTRY *)(auStack_174 + 4);
    auStack_174._4_4_ = (ASN1_STRING *)(auStack_174._0_4_)->ln;
    pXVar19 = (X509_NAME_ENTRY *)
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    if (iVar4 < 0) {
      ...
      pXVar19 = (X509_NAME_ENTRY *)ASN1_item_d2i(ppAStack_23c,in,iVar4,pAStack_1f0);
      iStack_234 = iVar4;
    }
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    if (ppAStack_23c == (ASN1_VALUE **)0x0) {
      ...
      pXStack_248 = (X509_NAME_ENTRY *)0x1;
LAB_0054c974:
  ...
  ppAStack_230 = unaff_s6;
  pXStack_288 = (X509_NAME_ENTRY *)(*pcStack_284)(iVar4,0);
  puVar10 = (undefined *)(*(code *)PTR_CRYPTO_malloc_006a7008)(pXStack_288,"a_i2d_fp.c",0x5a);
  if (puVar10 == (undefined *)0x0) {
    pXVar19 = (X509_NAME_ENTRY *)&DAT_00000041;
    ...
    while( true ) {
      ...
      pXVar19 = pXStack_288;
      pXVar22 = (X509_NAME_ENTRY *)(*(code *)PTR_BIO_write_006a6e14)(pcStack_27c,puVar17);
      ...
      pXStack_288 = (X509_NAME_ENTRY *)((int)pXStack_288 - (int)pXVar22);
    }
    pXVar22 = (X509_NAME_ENTRY *)0x1;
LAB_0054cb14:
  ...
  if (puVar10 == (undefined *)0x0) {
    ...
    pXStack_304 = (X509_NAME_ENTRY *)0x0;
    ...
    if (puStack_290 == (uchar *)0x0) {
      ...
      pXStack_304 = (X509_NAME_ENTRY *)0x1;
LAB_0054cc80:
...
LAB_0054cf88:
  ...
  if (piStack_30c != (int *)0x0) {
    if (piStack_30c[1] == 0x10a) {
      ...
      bVar1 = false;
      if (piStack_30c[1] != 10) {
        return (X509_NAME_ENTRY *)0xffffffff;
      }
    }
    iVar4 = *piStack_30c;
    if (4 < iVar4) {
    ...
    if (pbVar16 != (byte *)0x0) {
      if (iVar4 < 1) {
        ...
        pXVar19 = (X509_NAME_ENTRY *)(uint)*pbVar16;
        if (iVar4 != 1) {
          uVar2 = CONCAT11(*pbVar16,pbVar16[1]);
          pXVar19 = (X509_NAME_ENTRY *)(uint)uVar2;
          if (iVar4 != 2) {
            uVar3 = CONCAT21(uVar2,pbVar16[2]);
            pXVar19 = (X509_NAME_ENTRY *)(uint)uVar3;
            if (iVar4 == 4) {
              pXVar19 = (X509_NAME_ENTRY *)CONCAT31(uVar3,pbVar16[3]);
            }
          }
        }
      }
      ...
      return (X509_NAME_ENTRY *)-(int)pXVar19;
    }
  }
  return (X509_NAME_ENTRY *)0x0;
  while( true ) {
    do {
      piStack_1a4 = (int *)((int)&pXVar22->object + (int)&((ASN1_STRING *)pAVar5->ln)->length);
      pXStack_124 = pXVar21;
      iVar4 = (*(code *)PTR_BIO_read_006a74c0)(pAStack_e0);
      if (iVar4 < 1) {
        pXStack_124 = (X509_NAME_ENTRY *)0x8e;
        iVar4 = 0xf7;
        unaff_s3 = pXVar21;
      ...
      unaff_s3 = (X509_NAME_ENTRY *)((int)pXVar21 - iVar4);
      pXVar22 = (X509_NAME_ENTRY *)((int)&pXVar22->object + iVar4);
      pXVar21 = unaff_s3;
    } while (unaff_s3 != (X509_NAME_ENTRY *)0x0);
    unaff_s5 = (X509_NAME_ENTRY *)((int)unaff_s5 - (int)pXVar6);
    pXStack_ac = (X509_NAME_ENTRY *)
                 ((int)pXStack_ac << (pXStack_ac < (X509_NAME_ENTRY *)0x3fffffff));
    if (unaff_s5 == (X509_NAME_ENTRY *)0x0) break;
LAB_0054c1a0:
    unaff_s3 = (X509_NAME_ENTRY *)(uint)(pXStack_ac < unaff_s5);
    pXVar6 = pXStack_ac;
    if (unaff_s3 == (X509_NAME_ENTRY *)0x0) {
      pXVar6 = unaff_s5;
    }
  ...
  pXVar6 = (X509_NAME_ENTRY *)((int)&pXVar19->object + XStack_88.set);
LAB_0054c220:
  pXVar19 = (X509_NAME_ENTRY *)(uint)(pXVar6 < pXVar19);
  if (pXVar19 != (X509_NAME_ENTRY *)0x0) {
    pXStack_124 = (X509_NAME_ENTRY *)&DAT_0000009b;
    iVar4 = 0x106;
    goto LAB_0054c284;
  }
  ...
  unaff_s5 = (X509_NAME_ENTRY *)((int)pXVar22 - (int)pXVar6);
  goto LAB_0054c08c;
LAB_0054c324:
  if ((int)pXVar19 < 0) {
    pXStack_124 = (X509_NAME_ENTRY *)&DAT_0000009b;
