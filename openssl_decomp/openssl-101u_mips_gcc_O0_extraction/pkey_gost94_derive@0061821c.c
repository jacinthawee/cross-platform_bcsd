...

{
  ...
  while( true ) {
    ...
    *(undefined **)((int)register0x00000074 + -0x18) = &_gp;
    puVar6 = (undefined4 *)(*(code *)PTR_EVP_PKEY_CTX_get0_peerkey_006a9824)();
    uVar7 = (**(code **)(*(int *)((int)register0x00000074 + -0x18) + -0x580c))(param_1);
    *param_3 = 0x20;
    if (puVar9 == (undefined4 *)0x0) {
      return 1;
    }
    uVar7 = gost_get0_priv_key(uVar7);
    unaff_s2 = PTR___stack_chk_guard_006a9ae8;
    ...
    *(undefined4 *)((int)register0x00000074 + -0x24) = *(undefined4 *)PTR___stack_chk_guard_006a9ae8
    ...
    param_2 = puVar6;
    param_3 = puVar9;
    puVar2 = (undefined4 *)(*(code *)PTR_DH_new_006a751c)();
    ...
    if (puVar2 == (undefined4 *)0x0) {
      ...
      (**(code **)(puVar11 + -0x53ec))(unaff_s3,0,0x80);
      unaff_s0 = (undefined *)((int)register0x00000074 + -0xa4);
      uVar3 = (**(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x6bc8))
                        (*(undefined4 *)(puVar6[5] + 0x14));
      iVar12 = *(int *)((int)register0x00000074 + -0x1a0);
      puVar2[3] = uVar3;
      uVar3 = (**(code **)(iVar12 + -0x6bc8))(*(undefined4 *)(puVar6[5] + 0xc));
      pcVar10 = *(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x6bc8);
      puVar2[2] = uVar3;
      uVar3 = (*pcVar10)(uVar7);
      pcVar10 = *(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x5808);
      puVar2[6] = uVar3;
      ...
      if (puVar6 == (undefined4 *)0x0) {
        (**(code **)(*(int *)((int)register0x00000074 + -0x1a0) + -0x78d8))(puVar2);
        uVar3 = 0;
        puVar11 = *(undefined **)((int)register0x00000074 + -0x1a0);
      }
      else {
