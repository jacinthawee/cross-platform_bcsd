...

{
  ...
  iVar1 = (*(code *)PTR_OBJ_txt2obj_006a7000)(atrname,0);
  if (iVar1 == 0) {
    (*(code *)PTR_ERR_put_error_006a7f34)(0xb,0x8c,0x77,"x509_att.c",0x116);
    (*(code *)PTR_ERR_add_error_data_006a813c)(2,"name=",atrname);
  ...
  if ((attr == (X509_ATTRIBUTE **)0x0) || (attr_00 = *attr, attr_00 == (X509_ATTRIBUTE *)0x0)) {
    ...
    if (iVar3 != 0) {
      if (attr == (X509_ATTRIBUTE **)0x0) goto LAB_0057fddc;
      goto LAB_0057fe84;
    }
    if ((attr == (X509_ATTRIBUTE **)0x0) || (attr_00 != *attr)) goto LAB_0057fdd0;
  }
  else {
    (*(code *)PTR_ASN1_OBJECT_free_006a7004)(attr_00->object);
    pAVar2 = (ASN1_OBJECT *)(*(code *)PTR_OBJ_dup_006a8494)(iVar1);
