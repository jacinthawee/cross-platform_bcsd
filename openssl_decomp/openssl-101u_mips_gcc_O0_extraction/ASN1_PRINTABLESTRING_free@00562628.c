...

{
  ...
  uint uVar3;
  int iVar4;
  ASN1_PRINTABLESTRING *pAVar5;
  undefined1 *puVar6;
  undefined4 in_a3;
  int iVar7;
  ASN1_PRINTABLESTRING *pAStack_34;
  int iStack_30;
  uchar *puStack_2c;
  
  puVar2 = PTR___stack_chk_guard_006a9ae8;
  puVar1 = ASN1_PRINTABLESTRING_it._8_4_;
  puVar6 = ASN1_PRINTABLESTRING_it;
  uVar3 = (uint)ASN1_PRINTABLESTRING_it[0];
  puStack_2c = *(uchar **)PTR___stack_chk_guard_006a9ae8;
  pAVar5 = a;
  pAStack_34 = a;
  if (uVar3 == 0) {
    if (ASN1_PRINTABLESTRING_it._16_4_ == (undefined4 *)0x0) {
      pAVar5 = (ASN1_PRINTABLESTRING *)&pAStack_34;
      if (ASN1_PRINTABLESTRING_it._8_4_ == (uint *)0x0) {
        ASN1_primitive_free((ASN1_VALUE **)pAVar5,(ASN1_ITEM *)ASN1_PRINTABLESTRING_it);
      }
      else {
        iVar7 = 0;
        if ((*ASN1_PRINTABLESTRING_it._8_4_ & 6) == 0) {
          puVar6 = (undefined1 *)ASN1_PRINTABLESTRING_it._8_4_[4];
          pAVar5 = (ASN1_PRINTABLESTRING *)&pAStack_34;
          asn1_item_combine_free(pAVar5,puVar6,*ASN1_PRINTABLESTRING_it._8_4_ & 0x400);
        }
        else {
          puVar6 = (undefined1 *)ASN1_PRINTABLESTRING_it._16_4_;
    ...
    puVar6 = (undefined1 *)ASN1_PRINTABLESTRING_it._16_4_;
    if (a == (ASN1_PRINTABLESTRING *)0x0) goto switchD_0055c4c0_caseD_0;
    if (ASN1_PRINTABLESTRING_it._16_4_ == (undefined4 *)0x0) {
      if ((uVar3 & 0xff) < 7) {
  ...
  if (ASN1_PRINTABLESTRING_it._16_4_[4] == 0) {
    puVar6 = (undefined1 *)ASN1_PRINTABLESTRING_it._16_4_;
    if ((uVar3 & 0xff) < 7) {
