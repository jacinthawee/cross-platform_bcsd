...

{
  ...
  if (iVar1 == 0) {
    ...
    if (((pXVar5->canon_enc == (uchar *)0x0) || (pXVar5->modified != 0)) &&
       (iVar1 = (*(code *)PTR_i2d_X509_NAME_006a76ec)(pXVar5,0), iVar1 < 0)) {
      iVar1 = -2;
    }
      ...
      if (iVar1 == 0) {
                    /* WARNING: Could not recover jumptable at 0x0057537c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        iVar1 = (*(code *)PTR_memcmp_006a9ad0)(pXVar5->canon_enc,pXVar3->canon_enc);
        return iVar1;
      }
    }
  }
